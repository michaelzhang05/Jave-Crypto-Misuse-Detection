...
public final class CompositeException extends RuntimeException {
    ...
    private final List<Throwable> f18515f;

    /* renamed from: g, reason: collision with root package name */
    private final String f18516g;

    /* renamed from: h, reason: collision with root package name */
    private Throwable f18517h;
    ...
    public synchronized Throwable getCause() {
        if (this.f18517h == null) {
            ...
            Iterator<Throwable> it = this.f18515f.iterator();
            Throwable th = aVar;
            while (it.hasNext()) {
    ...
    public CompositeException(Iterable<? extends Throwable> iterable) {
        ...
        if (!linkedHashSet.isEmpty()) {
            ...
            this.f18515f = unmodifiableList;
            this.f18516g = unmodifiableList.size() + " exceptions occurred. ";
            return;
        }
