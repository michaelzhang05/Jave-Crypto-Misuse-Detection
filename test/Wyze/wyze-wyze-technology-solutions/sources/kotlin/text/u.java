...
public class u extends t {
    ...
    public static Comparator<String> o(StringCompanionObject stringCompanionObject) {
        l.f(stringCompanionObject, "<this>");
    ...
    public static boolean p(CharSequence charSequence) {
        ...
        if (charSequence.length() != 0) {
            ...
            if (!(L instanceof Collection) || !((Collection) L).isEmpty()) {
                ...
                while (it.hasNext()) {
                    c2 = b.c(charSequence.charAt(((IntIterator) it).a()));
                    if (!c2) {
                        z = false;
                        break;
                    }
    ...
    public static /* synthetic */ boolean r(String str, int i2, String str2, int i3, int i4, boolean z, int i5, Object obj) {
        return q(str, i2, str2, i3, i4, (i5 & 16) != 0 ? false : z);
    }

    public static String s(CharSequence charSequence, int i2) {
        l.f(charSequence, "<this>");
        if (!(i2 >= 0)) {
    ...
    public static final String t(String str, char c2, char c3, boolean z) {
        l.f(str, "<this>");
        if (!z) {
    ...
    public static final String u(String str, String str2, String str3, boolean z) {
        ...
        if (length2 >= 0) {
            ...
            do {
                sb.append((CharSequence) str, i2, O);
                sb.append(str3);
                i2 = O + length;
                if (O >= str.length()) {
                    break;
                }
                O = v.O(str, str2, O + b2, z);
            } while (O > 0);
    ...
    public static /* synthetic */ String v(String str, char c2, char c3, boolean z, int i2, Object obj) {
        if ((i2 & 4) != 0) {
            z = false;
        }
    ...
    public static boolean x(String str, String str2, int i2, boolean z) {
        ...
        return q(str, i2, str2, 0, str2.length(), z);
    }
    ...
    public static boolean y(String str, String str2, boolean z) {
        ...
        return q(str, 0, str2, 0, str2.length(), z);
    }
