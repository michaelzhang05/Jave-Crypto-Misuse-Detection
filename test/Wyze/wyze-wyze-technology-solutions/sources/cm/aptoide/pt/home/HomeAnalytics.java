...
public class HomeAnalytics {
    ...
    private void sendAdInteractEvent(String str, int i2, String str2, int i3, String str3, HomeEvent.Type type, ApplicationAd.Network network) {
        ...
        hashMap.put("app_rating", Integer.valueOf(i2));
        hashMap.put("package_name", str2);
        hashMap.put(BUNDLE_TAG, str3);
        hashMap.put("bundle_position", Integer.valueOf(i3));
    ...
    public void sendTapOnAppInteractEvent(double d2, String str, int i2, int i3, String str2, int i4, String str3) {
        ...
        hashMap.put("app_rating", Double.valueOf(d2));
        hashMap.put("package_name", str);
        hashMap.put("app_position", Integer.valueOf(i2));
        hashMap.put(BUNDLE_TAG, str2);
        hashMap.put("bundle_position", Integer.valueOf(i3));
        hashMap.put("bundle_total_items", Integer.valueOf(i4));
        if (str3 != null) {
            hashMap.put(CHIP_TAG, str3);
        }
        this.analyticsManager.logEvent(hashMap, HOME_INTERACT, AnalyticsManager.Action.CLICK, this.navigationTracker.getViewName(true));
