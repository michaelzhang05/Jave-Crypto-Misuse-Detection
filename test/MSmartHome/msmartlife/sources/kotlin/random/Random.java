...
public abstract class Random {
    ...
    private static final Random f19480g = b.a.b();
    ...
    public static final class a extends Random implements Serializable {
        ...
        /* loaded from: classes2.dex */
        private static final class C0272a implements Serializable {

            /* renamed from: f, reason: collision with root package name */
            public static final C0272a f19481f = new C0272a();

            private C0272a() {
            }

            private final Object readResolve() {
                return Random.f19479f;
            }
        }
        ...
        private final Object writeReplace() {
            return C0272a.f19481f;
        }

        @Override // kotlin.random.Random
        public int b() {
            return Random.f19480g.b();
        }
    }
