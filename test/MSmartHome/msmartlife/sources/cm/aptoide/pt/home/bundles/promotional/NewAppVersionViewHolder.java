...
public final class NewAppVersionViewHolder extends AppBundleViewHolder {
    ...
    public static final void m173setBundle$lambda2$lambda0(NewAppVersionViewHolder newAppVersionViewHolder, HomeBundle homeBundle, View view) {
        l.f(newAppVersionViewHolder, "this$0");
    ...
    public static final void m174setBundle$lambda2$lambda1(NewAppVersionViewHolder newAppVersionViewHolder, HomeBundle homeBundle, View view) {
        l.f(newAppVersionViewHolder, "this$0");
        newAppVersionViewHolder.fireAppClickEvent((PromotionalBundle) homeBundle);
    }
            ...
            if ((z ? (VersionPromotionalBundle) homeBundle : null) != null) {
                ...
                ((Button) this.itemView.findViewById(R.id.action_button)).setOnClickListener(new View.OnClickListener() { // from class: cm.aptoide.pt.home.bundles.promotional.e
                    ...
                    public final void onClick(View view) {
                        NewAppVersionViewHolder.m173setBundle$lambda2$lambda0(NewAppVersionViewHolder.this, homeBundle, view);
                    }
                });
                this.itemView.setOnClickListener(new View.OnClickListener() { // from class: cm.aptoide.pt.home.bundles.promotional.d
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view) {
                        NewAppVersionViewHolder.m174setBundle$lambda2$lambda1(NewAppVersionViewHolder.this, homeBundle, view);
                    }
                });
