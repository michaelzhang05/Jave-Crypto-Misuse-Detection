...
public class a extends c<Boolean> {
    ...
    private static final String f1984i = n.f("BatteryChrgTracker");
    ...
    */
    public void h(android.content.Context r6, android.content.Intent r7) {
        /*
            ...
            return
        L7:
            androidx.work.n r7 = androidx.work.n.c()
            java.lang.String r0 = androidx.work.impl.m.f.a.f1984i
            r1 = 1
        ...
        L6c:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.work.impl.m.f.a.h(android.content.Context, android.content.Intent):void");
    }
    ...
    public Boolean b() {
        ...
        if (registerReceiver == null) {
            n.c().b(f1984i, "getInitialState - null intent received", new Throwable[0]);
            return null;
        }
