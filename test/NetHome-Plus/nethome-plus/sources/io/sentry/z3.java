...
public final class z3 implements x3 {
    ...
    public u3 b(v1 v1Var, x4 x4Var) {
        ...
        if (a != null && c(a, x4Var.getLogger())) {
            return a(new j3(v1Var, x4Var.getEnvelopeReader(), x4Var.getSerializer(), x4Var.getLogger(), x4Var.getFlushTimeoutMillis()), a, x4Var.getLogger());
        }
        x4Var.getLogger().c(s4.ERROR, "No outbox dir path is defined in options.", new Object[0]);
        return null;
    }
