...
public class c {
    ...
    public static boolean b(b[] bVarArr, b[] bVarArr2) {
        ...
        for (int i2 = 0; i2 < bVarArr.length; i2++) {
            if (bVarArr[i2].a != bVarArr2[i2].a || bVarArr[i2].f2656b.length != bVarArr2[i2].f2656b.length) {
                return false;
            }
        }
        return true;
    ...
    */
    ...
    public static void j(b[] bVarArr, b[] bVarArr2) {
        for (int i2 = 0; i2 < bVarArr2.length; i2++) {
            ...
            for (int i3 = 0; i3 < bVarArr2[i2].f2656b.length; i3++) {
                bVarArr[i2].f2656b[i3] = bVarArr2[i2].f2656b[i3];
            }
        }
    }
    ...
    public static class b {
        ...
        public static void e(b[] bVarArr, Path path) {
            ...
            char c2 = 'm';
            for (int i2 = 0; i2 < bVarArr.length; i2++) {
                a(path, fArr, c2, bVarArr[i2].a, bVarArr[i2].f2656b);
                c2 = bVarArr[i2].a;
            }
        }
        ...
        public void d(b bVar, b bVar2, float f2) {
            ...
            int i2 = 0;
            while (true) {
                float[] fArr = bVar.f2656b;
                if (i2 >= fArr.length) {
                    return;
                }
                this.f2656b[i2] = (fArr[i2] * (1.0f - f2)) + (bVar2.f2656b[i2] * f2);
                i2++;
            }
        }
        ...
        b(b bVar) {
            this.a = bVar.a;
            float[] fArr = bVar.f2656b;
            this.f2656b = c.c(fArr, 0, fArr.length);
        }
    }
}
