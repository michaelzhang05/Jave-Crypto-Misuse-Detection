        ...
        public final List<Header> http2HeadersList(Request request) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                ...
                if (name != null) {
                    ...
                    if (!Http2ExchangeCodec.HTTP_2_SKIPPED_REQUEST_HEADERS.contains(lowerCase) || (l.a(lowerCase, Http2ExchangeCodec.TE) && l.a(headers.value(i2), "trailers"))) {
