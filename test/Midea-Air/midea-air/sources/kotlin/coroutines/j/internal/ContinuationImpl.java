...
public abstract class ContinuationImpl extends BaseContinuationImpl {
    ...
    public final Continuation<Object> intercepted() {
        ...
        if (continuation == null) {
            ContinuationInterceptor continuationInterceptor = (ContinuationInterceptor) getContext().get(ContinuationInterceptor.f22100b);
    ...
    protected void releaseIntercepted() {
        ...
        if (continuation != null && continuation != this) {
            CoroutineContext.b bVar = getContext().get(ContinuationInterceptor.f22100b);
            l.c(bVar);
            ((ContinuationInterceptor) bVar).a(continuation);
        }
        this.intercepted = CompletedContinuation.f22114f;
    }
