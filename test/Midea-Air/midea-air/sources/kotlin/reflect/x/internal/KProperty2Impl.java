...
/* renamed from: kotlin.f0.x.e.s, reason: from Kotlin metadata */
...
public class KProperty2Impl<D, E, V> extends KPropertyImpl<V> implements KProperty, Function2 {
    ...
    /* renamed from: kotlin.f0.x.e.s$a */
    /* loaded from: classes2.dex */
    public static final class a<D, E, V> extends KPropertyImpl.c<V> implements KProperty.b, Function2 {
        private final KProperty2Impl<D, E, V> m;

        /* JADX WARN: Multi-variable type inference failed */
        public a(KProperty2Impl<D, E, ? extends V> kProperty2Impl) {
            l.f(kProperty2Impl, "property");
        ...
        public V invoke(D receiver1, E receiver2) {
            return E().K(receiver1, receiver2);
        }
    }
    ...
    public KProperty2Impl(KDeclarationContainerImpl kDeclarationContainerImpl, t0 t0Var) {
        ...
        c0.b<a<D, E, V>> b2 = c0.b(new t(this));
        l.e(b2, "lazy { Getter(this) }");
        this.r = b2;
        a2 = i.a(LazyThreadSafetyMode.PUBLICATION, new u(this));
        this.s = a2;
    }
