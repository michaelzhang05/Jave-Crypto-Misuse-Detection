...
public final class DynamiteModule {
    ...
    private static zzi f11025b = null;

    /* renamed from: c, reason: collision with root package name */
    private static zzk f11026c = null;

    /* renamed from: d, reason: collision with root package name */
    private static String f11027d = null;

    /* renamed from: e, reason: collision with root package name */
    private static int f11028e = -1;

    /* renamed from: f, reason: collision with root package name */
    private static final ThreadLocal<a> f11029f = new ThreadLocal<>();

    /* renamed from: g, reason: collision with root package name */
    private static final VersionPolicy.zza f11030g = new com.google.android.gms.dynamite.a();

    /* renamed from: h, reason: collision with root package name */
    @KeepForSdk
    public static final VersionPolicy f11031h = new com.google.android.gms.dynamite.b();

    /* renamed from: i, reason: collision with root package name */
    @KeepForSdk
    public static final VersionPolicy f11032i = new c();

    /* renamed from: j, reason: collision with root package name */
    @KeepForSdk
    public static final VersionPolicy f11033j = new d();

    /* renamed from: k, reason: collision with root package name */
    @KeepForSdk
    public static final VersionPolicy f11034k = new e();
    ...
    private DynamiteModule(Context context) {
        this.n = (Context) Preconditions.j(context);
    }
    ...
    public static DynamiteModule e(Context context, VersionPolicy versionPolicy, String str) throws LoadingException {
        ThreadLocal<a> threadLocal = f11029f;
        a aVar = threadLocal.get();
        com.google.android.gms.dynamite.a aVar2 = null;
        a aVar3 = new a(aVar2);
        threadLocal.set(aVar3);
        try {
            VersionPolicy.zzb a2 = versionPolicy.a(context, str, f11030g);
            int i2 = a2.a;
            int i3 = a2.f11035b;
            ...
            int i4 = a2.f11036c;
            if (i4 == 0 || ((i4 == -1 && a2.a == 0) || (i4 == 1 && a2.f11035b == 0))) {
                int i5 = a2.a;
                int i6 = a2.f11035b;
            ...
            if (i4 == 1) {
                try {
                    DynamiteModule g2 = g(context, str, a2.f11035b);
                    Cursor cursor2 = aVar3.a;
                    if (cursor2 != null) {
                        cursor2.close();
                    }
                    threadLocal.set(aVar);
                    ...
                    int i7 = a2.a;
                    if (i7 != 0 && versionPolicy.a(context, str, new b(i7, 0)).f11036c == -1) {
                        DynamiteModule m3 = m(context, str);
                        Cursor cursor3 = aVar3.a;
                        if (cursor3 != null) {
                            cursor3.close();
                        }
                        f11029f.set(aVar);
                        ...
                        if (classLoader != null) {
                            ...
                            try {
                                ...
                                if (str2 != null && !str2.isEmpty()) {
                                    h hVar = new h(f11027d, ClassLoader.getSystemClassLoader());
                                    h(hVar);
    ...
    private static DynamiteModule g(Context context, String str, int i2) throws LoadingException {
        ...
        try {
            ...
            if (bool != null) {
                ...
                if (n != null) {
                    if (n.O6() >= 2) {
                        o2 = n.i5(ObjectWrapper.i0(context), str, i2);
                    } else {
                        Log.w("DynamiteModule", "Dynamite loader version < 2, falling back to createModuleContext");
                        o2 = n.o2(ObjectWrapper.i0(context), str, i2);
                    }
                    if (ObjectWrapper.R(o2) != null) {
                        return new DynamiteModule((Context) ObjectWrapper.R(o2));
                    }
    ...
    private static Boolean i() {
        Boolean valueOf;
        synchronized (DynamiteModule.class) {
            valueOf = Boolean.valueOf(f11028e >= 2);
        }
        return valueOf;
    }
    ...
    private static int j(Context context, String str, boolean z) {
        ...
        try {
            if (n.O6() >= 2) {
                return n.Q3(ObjectWrapper.i0(context), str, z);
            }
            Log.w("DynamiteModule", "IDynamite loader version < 2, falling back to getModuleVersion2");
            return n.S4(ObjectWrapper.i0(context), str, z);
        } catch (RemoteException e2) {
            String valueOf = String.valueOf(e2.getMessage());
    ...
    private static DynamiteModule k(Context context, String str, int i2) throws LoadingException, RemoteException {
        ...
        if (zzkVar != null) {
            ...
            if (aVar2 != null && aVar2.a != null) {
                ...
                ObjectWrapper.i0(null);
                if (i().booleanValue()) {
                    Log.v("DynamiteModule", "Dynamite loader version >= 2, using loadModule2NoCrashUtils");
                    m1 = zzkVar.r1(ObjectWrapper.i0(applicationContext), str, i2, ObjectWrapper.i0(cursor));
                } else {
                    Log.w("DynamiteModule", "Dynamite loader version < 2, falling back to loadModule2");
                    m1 = zzkVar.m1(ObjectWrapper.i0(applicationContext), str, i2, ObjectWrapper.i0(cursor));
                }
                Context context2 = (Context) ObjectWrapper.R(m1);
                if (context2 != null) {
    ...
    */
    private static int l(android.content.Context r8, java.lang.String r9, boolean r10) throws com.google.android.gms.dynamite.DynamiteModule.LoadingException {
        ...
        Lc:
            ...
            com.google.android.gms.dynamite.DynamiteModule.f11027d = r1     // Catch: java.lang.Throwable -> L79
            java.lang.String r1 = "loaderVersion"
            int r1 = r8.getColumnIndex(r1)     // Catch: java.lang.Throwable -> L79
            if (r1 < 0) goto L67
            int r1 = r8.getInt(r1)     // Catch: java.lang.Throwable -> L79
            com.google.android.gms.dynamite.DynamiteModule.f11028e = r1     // Catch: java.lang.Throwable -> L79
        L67:
            monitor-exit(r10)     // Catch: java.lang.Throwable -> L79
            java.lang.ThreadLocal<com.google.android.gms.dynamite.DynamiteModule$a> r10 = com.google.android.gms.dynamite.DynamiteModule.f11029f     // Catch: java.lang.Throwable -> L92 java.lang.Exception -> L96
    ...
    private static zzi n(Context context) {
        ...
        synchronized (DynamiteModule.class) {
            ...
            if (GoogleApiAvailabilityLight.h().i(context) != 0) {
                return null;
            }
            try {
