...
public class ViewPager extends ViewGroup {
    ...
    public static class SavedState extends AbsSavedState {
        ...
        public String toString() {
            return "FragmentPager.SavedState{" + Integer.toHexString(System.identityHashCode(this)) + " position=" + this.f1741h + "}";
        }
        ...
        SavedState(Parcel parcel, ClassLoader classLoader) {
            ...
            this.f1742i = parcel.readParcelable(classLoader);
            this.f1743j = classLoader;
        }
    }
    ...
    static class a implements Comparator<f> {
        ...
        public int compare(f fVar, f fVar2) {
            return fVar.f1746b - fVar2.f1746b;
        }
    }
    ...
    public static class n implements Comparator<View> {
        ...
        public int compare(View view, View view2) {
            ...
            return gVar.f1753e - gVar2.f1753e;
        }
    }
    ...
    private void calculatePageOffsets(f fVar, int i2, f fVar2) {
        ...
        if (fVar2 != null) {
            ...
            int i6 = fVar.f1746b;
            if (i5 < i6) {
                float f3 = fVar2.f1749e + fVar2.f1748d + f2;
                int i7 = i5 + 1;
                int i8 = 0;
                while (i7 <= fVar.f1746b && i8 < this.mItems.size()) {
                    f fVar5 = this.mItems.get(i8);
                    while (true) {
                        fVar4 = fVar5;
                        if (i7 <= fVar4.f1746b || i8 >= this.mItems.size() - 1) {
                            break;
                        }
                        i8++;
                        fVar5 = this.mItems.get(i8);
                    }
                    while (i7 < fVar4.f1746b) {
                ...
                float f4 = fVar2.f1749e;
                while (true) {
                    i5--;
                    if (i5 < fVar.f1746b || size < 0) {
                        break;
                    }
                    f fVar6 = this.mItems.get(size);
                    while (true) {
                        fVar3 = fVar6;
                        if (i5 >= fVar3.f1746b || size <= 0) {
                            break;
                        }
                        size--;
                        fVar6 = this.mItems.get(size);
                    }
                    while (i5 > fVar3.f1746b) {
        ...
        float f5 = fVar.f1749e;
        int i9 = fVar.f1746b;
        int i10 = i9 - 1;
        this.mFirstOffset = i9 == 0 ? f5 : -3.4028235E38f;
        int i11 = count - 1;
        this.mLastOffset = i9 == i11 ? (fVar.f1748d + f5) - 1.0f : Float.MAX_VALUE;
        int i12 = i2 - 1;
        while (i12 >= 0) {
        ...
        float f6 = fVar.f1749e + fVar.f1748d + f2;
        int i13 = fVar.f1746b + 1;
        int i14 = i2 + 1;
        while (i14 < size2) {
            ...
            if (i3 == i11) {
                this.mLastOffset = (fVar8.f1748d + f6) - 1.0f;
            }
            fVar8.f1749e = f6;
            f6 += fVar8.f1748d + f2;
            i14++;
    ...
    private int determineTargetPage(int i2, float f2, int i3, int i4) {
        ...
        return Math.max(this.mItems.get(0).f1746b, Math.min(i2, this.mItems.get(r4.size() - 1).f1746b));
    }
    ...
    private f infoForCurrentScrollPosition() {
        ...
        while (i4 < this.mItems.size()) {
            ...
            if (!z && fVar2.f1746b != (i2 = i3 + 1)) {
                fVar2 = this.mTempItem;
                fVar2.f1749e = f2 + f4 + f3;
                fVar2.f1746b = i2;
                fVar2.f1748d = this.mAdapter.getPageWidth(i2);
                i4--;
            }
            f2 = fVar2.f1749e;
            float f5 = fVar2.f1748d + f2 + f3;
            if (!z && scrollX < f2) {
                return fVar;
            }
    ...
    private boolean pageScrolled(int i2) {
        ...
        int i5 = infoForCurrentScrollPosition.f1746b;
        float f3 = ((i2 / f2) - infoForCurrentScrollPosition.f1749e) / (infoForCurrentScrollPosition.f1748d + (i3 / f2));
        this.mCalledSuper = false;
    ...
    private boolean performDrag(float f2) {
        ...
        if (fVar.f1746b != 0) {
            f4 = fVar.f1749e * clientWidth;
            z = false;
        } else {
            z = true;
        }
        if (fVar2.f1746b != this.mAdapter.getCount() - 1) {
            f5 = fVar2.f1749e * clientWidth;
            z2 = false;
        } else {
            z2 = true;
        }
    ...
    private void recomputeScrollPosition(int i2, int i3, int i4, int i5) {
        ...
        int min = (int) ((infoForPosition != null ? Math.min(infoForPosition.f1749e, this.mLastOffset) : 0.0f) * ((i2 - getPaddingLeft()) - getPaddingRight()));
        if (min != getScrollX()) {
    ...
    private void scrollToItem(int i2, boolean z, int i3, boolean z2) {
        ...
        int clientWidth = infoForPosition != null ? (int) (getClientWidth() * Math.max(this.mFirstOffset, Math.min(infoForPosition.f1749e, this.mLastOffset))) : 0;
        if (z) {
    ...
    public void addFocusables(ArrayList<View> arrayList, int i2, int i3) {
        ...
        if (descendantFocusability != 393216) {
            for (int i4 = 0; i4 < getChildCount(); i4++) {
                ...
                if (childAt.getVisibility() == 0 && (infoForChild = infoForChild(childAt)) != null && infoForChild.f1746b == this.mCurItem) {
    ...
    f addNewItem(int i2, int i3) {
        ...
        fVar.f1748d = this.mAdapter.getPageWidth(i2);
    ...
    */
        ...
        while (i3 < this.mItems.size()) {
            ...
            if (itemPosition != -1) {
                if (itemPosition == -2) {
                    ...
                    this.mAdapter.destroyItem((ViewGroup) this, fVar.f1746b, fVar.a);
    ...
    public boolean dispatchPopulateAccessibilityEvent(AccessibilityEvent accessibilityEvent) {
        ...
        for (int i2 = 0; i2 < childCount; i2++) {
            View childAt = getChildAt(i2);
            if (childAt.getVisibility() == 0 && (infoForChild = infoForChild(childAt)) != null && infoForChild.f1746b == this.mCurItem && childAt.dispatchPopulateAccessibilityEvent(accessibilityEvent)) {
                return true;
            }
        }
        return false;
    ...
    public void endFakeDrag() {
        if (this.mFakeDragging) {
            if (this.mAdapter != null) {
                ...
                int scrollX = getScrollX();
                f infoForCurrentScrollPosition = infoForCurrentScrollPosition();
                setCurrentItemInternal(determineTargetPage(infoForCurrentScrollPosition.f1746b, ((scrollX / clientWidth) - infoForCurrentScrollPosition.f1749e) / infoForCurrentScrollPosition.f1748d, xVelocity, (int) (this.mLastMotionX - this.mInitialMotionX)), true, true, xVelocity);
            }
            endDrag();
    ...
    public void fakeDragBy(float f2) {
        if (this.mFakeDragging) {
            ...
            if (fVar.f1746b != 0) {
                f3 = fVar.f1749e * clientWidth;
            }
            if (fVar2.f1746b != this.mAdapter.getCount() - 1) {
                f4 = fVar2.f1749e * clientWidth;
            }
            if (scrollX < f3) {
                scrollX = f3;
            } else if (scrollX > f4) {
    ...
    protected int getChildDrawingOrder(int i2, int i3) {
        ...
        return ((g) this.mDrawingOrderedChildren.get(i3).getLayoutParams()).f1754f;
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        int i4 = fVar.f1746b;
        int i5 = this.mItems.get(size - 1).f1746b;
        while (i4 < i5) {
            while (true) {
                i2 = fVar.f1746b;
                if (i4 <= i2 || i3 >= size) {
            ...
            if (i4 == i2) {
                float f6 = fVar.f1749e;
                float f7 = fVar.f1748d;
                f2 = (f6 + f7) * width;
                f5 = f6 + f7 + f4;
            } else {
    ...
    */
    ...
    protected boolean onRequestFocusInDescendants(int i2, Rect rect) {
        ...
        while (i3 != i5) {
            ...
            if (childAt.getVisibility() == 0 && (infoForChild = infoForChild(childAt)) != null && infoForChild.f1746b == this.mCurItem && childAt.requestFocus(i2, rect)) {
                return true;
            }
            i3 += i4;
        }
    ...
    public void onRestoreInstanceState(Parcelable parcelable) {
        ...
        if (aVar != null) {
            aVar.restoreState(savedState.f1742i, savedState.f1743j);
            setCurrentItemInternal(savedState.f1741h, false, true);
        } else {
            this.mRestoredCurItem = savedState.f1741h;
            this.mRestoredAdapterState = savedState.f1742i;
            this.mRestoredClassLoader = savedState.f1743j;
        }
    }
    ...
    public Parcelable onSaveInstanceState() {
        ...
        savedState.f1741h = this.mCurItem;
        androidx.viewpager.widget.a aVar = this.mAdapter;
        if (aVar != null) {
            savedState.f1742i = aVar.saveState();
        }
        return savedState;
    }
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (action == 0) {
            ...
            setCurrentItemInternal(determineTargetPage(infoForCurrentScrollPosition.f1746b, ((scrollX / f3) - infoForCurrentScrollPosition.f1749e) / (infoForCurrentScrollPosition.f1748d + (this.mPageMargin / f3)), xVelocity, (int) (motionEvent.getX(motionEvent.findPointerIndex(this.mActivePointerId)) - this.mInitialMotionX)), true, true, xVelocity);
            z = resetTouch();
        }
        if (z) {
            u.Z(this);
    ...
    public static class g extends ViewGroup.LayoutParams {
        ...
        public g(Context context, AttributeSet attributeSet) {
            ...
            this.f1750b = obtainStyledAttributes.getInteger(0, 48);
        ...
        if (aVar != null && aVar.getCount() > 0) {
            ...
            if (i2 > i5 + i4 || i2 < i5 - i4) {
                for (int i6 = 0; i6 < this.mItems.size(); i6++) {
                    this.mItems.get(i6).f1747c = true;
                }
            }
