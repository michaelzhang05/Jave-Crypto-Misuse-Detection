...
public final class TypeVariableImpl implements TypeVariable<GenericDeclaration>, Type {
    ...
    private final KTypeParameter f19519f;

    public TypeVariableImpl(KTypeParameter kTypeParameter) {
        l.f(kTypeParameter, "typeParameter");
        this.f19519f = kTypeParameter;
    }

    public boolean equals(Object other) {
        if (other instanceof TypeVariable) {
            TypeVariable typeVariable = (TypeVariable) other;
            if (l.a(getName(), typeVariable.getName()) && l.a(getGenericDeclaration(), typeVariable.getGenericDeclaration())) {
                return true;
            }
        }
        return false;
    ...
    public Type[] getBounds() {
        int t;
        Type c2;
        List<KType> upperBounds = this.f19519f.getUpperBounds();
        t = u.t(upperBounds, 10);
        ArrayList arrayList = new ArrayList(t);
        Iterator<T> it = upperBounds.iterator();
        while (it.hasNext()) {
            c2 = v.c((KType) it.next(), true);
            arrayList.add(c2);
        }
    ...
    public GenericDeclaration getGenericDeclaration() {
        throw new NotImplementedError("An operation is not implemented: " + ("getGenericDeclaration() is not yet supported for type variables created from KType: " + this.f19519f));
    }

    @Override // java.lang.reflect.TypeVariable
    public String getName() {
        return this.f19519f.getName();
    }
