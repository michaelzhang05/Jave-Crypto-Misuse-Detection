...
public class g extends CheckBox implements androidx.core.widget.f0, androidx.core.widget.g0 {
    ...
    private final d1 f1011c;

    /* renamed from: d, reason: collision with root package name */
    private n f1012d;

    public g(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, d.a.f6128o);
    }

    private n getEmojiTextViewHelper() {
        if (this.f1012d == null) {
            this.f1012d = new n(this);
        }
        return this.f1012d;
    }
    ...
    public ColorStateList getSupportCompoundDrawablesTintList() {
        return this.f1011c.j();
    }

    public PorterDuff.Mode getSupportCompoundDrawablesTintMode() {
        return this.f1011c.k();
    }
