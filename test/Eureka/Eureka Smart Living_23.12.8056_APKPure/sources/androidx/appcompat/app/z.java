...
public abstract class z {
    ...
    public static class a implements Executor {
        ...
        final Queue f435b = new ArrayDeque();
        ...
        protected void d() {
            synchronized (this.f434a) {
                Runnable runnable = (Runnable) this.f435b.poll();
                this.f437d = runnable;
                if (runnable != null) {
                    this.f436c.execute(runnable);
                }
            }
        }
        ...
        public void execute(final Runnable runnable) {
            synchronized (this.f434a) {
                this.f435b.add(new Runnable() { // from class: androidx.appcompat.app.y
    ...
    public static void a(Context context, String str) {
        ...
        try {
            ...
            try {
                ...
                Log.w("AppLocalesStorageHelper", "Storing App Locales : Failed to persist app-locales: " + str, e6);
                if (openFileOutput == null) {
                    return;
                }
            }
    ...
    */
    public static java.lang.String b(android.content.Context r9) {
        ...
        L77:
            ...
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.appcompat.app.z.b(android.content.Context):java.lang.String");
    }
