...
public final class v extends com.google.crypto.tink.shaded.protobuf.x implements p0 {
    ...
    static /* synthetic */ class a {
        ...
        static {
            ...
            try {
                f9349a[x.d.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f9349a[x.d.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f9349a[x.d.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f9349a[x.d.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f9349a[x.d.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f9349a[x.d.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
    ...
    public static final class b extends x.a implements p0 {
        ...
        public b r(com.google.crypto.tink.shaded.protobuf.h hVar) {
            l();
            ((v) this.f5694b).e0(hVar);
            return this;
        }

        public b s(x xVar) {
            l();
            ((v) this.f5694b).f0(xVar);
            return this;
        }
