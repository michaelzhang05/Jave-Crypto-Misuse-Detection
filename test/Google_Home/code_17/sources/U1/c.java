...
abstract class c {
    ...
    public static a a(ECParameterSpec eCParameterSpec) {
        ...
        ECParameterSpec eCParameterSpec2 = f10285a;
        ...
        ECParameterSpec eCParameterSpec3 = f10286b;
        ...
        ECParameterSpec eCParameterSpec4 = f10287c;
        ...
        ECParameterSpec eCParameterSpec5 = f10288d;
    ...
    public static ECParameterSpec b(a aVar) {
        if (a.f10253d.equals(aVar)) {
            return f10285a;
        }
        if (a.f10254e.equals(aVar)) {
            return f10286b;
        }
        if (a.f10256g.equals(aVar)) {
            return f10287c;
        }
        if (a.f10257h.equals(aVar)) {
            return f10288d;
        }
        return null;
    }
