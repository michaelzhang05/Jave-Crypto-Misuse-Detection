...
class l implements h {
    ...
    private static long d(InterfaceC1288x interfaceC1288x, long j8, JSONObject jSONObject) {
        if (jSONObject.has("expires_at")) {
            return jSONObject.optLong("expires_at");
        }
        return interfaceC1288x.a() + (j8 * 1000);
    }
    ...
    public d a(InterfaceC1288x interfaceC1288x, JSONObject jSONObject) {
        ...
        return new d(d(interfaceC1288x, optInt2, jSONObject), c8, b(jSONObject.getJSONObject("features")), optInt, optInt2, optDouble, optDouble2, optInt3);
    }
}
