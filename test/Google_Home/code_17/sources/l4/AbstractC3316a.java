...
public abstract class AbstractC3316a {
    private static final void a(Map map, String str, Map map2) {
        for (Map.Entry entry : map.entrySet()) {
            ...
            if (value == null) {
                ...
                AbstractC3255y.g(value2, "null cannot be cast to non-null type kotlin.String");
                map2.put(b8, (String) value2);
            } else if (value instanceof Map) {
                Object value3 = entry.getValue();
                AbstractC3255y.g(value3, "null cannot be cast to non-null type kotlin.collections.Map<kotlin.String, kotlin.Any>");
    ...
    public static final Map c(Map paramMap) {
        AbstractC3255y.i(paramMap, "paramMap");
