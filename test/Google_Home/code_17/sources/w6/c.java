...
public final class c extends h {
    ...
    private final List f40379a;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public c(List missingFields, String str, Throwable th) {
        super(str, th);
        AbstractC3255y.i(missingFields, "missingFields");
        this.f40379a = missingFields;
    }
    ...
    */
    public c(java.util.List r3, java.lang.String r4) {
        ...
        L55:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: w6.c.<init>(java.util.List, java.lang.String):void");
    }
}
