...
public abstract class AbstractC1380v extends AbstractC1379u {
    ...
    public static final int j(List list, Comparable comparable, int i8, int i9) {
        ...
        while (i8 <= i10) {
            int i11 = (i8 + i10) >>> 1;
            int a8 = R5.a.a((Comparable) list.get(i11), comparable);
            if (a8 < 0) {
                i8 = i11 + 1;
            } else if (a8 > 0) {
                i10 = i11 - 1;
    ...
    public static /* synthetic */ int k(List list, int i8, int i9, Function1 function1, int i10, Object obj) {
        ...
        return AbstractC1378t.i(list, i8, i9, function1);
    }
    ...
    public static g6.i n(Collection collection) {
        AbstractC3255y.i(collection, "<this>");
        return new g6.i(0, collection.size() - 1);
    }
    ...
    public static List p(Object... elements) {
        AbstractC3255y.i(elements, "elements");
        if (elements.length > 0) {
            return AbstractC1371l.c(elements);
        }
    ...
    public static List r(Object... elements) {
        AbstractC3255y.i(elements, "elements");
        return AbstractC1371l.Z(elements);
    }
    ...
    public static final List t(List list) {
        ...
        if (size != 0) {
            if (size == 1) {
                return AbstractC1378t.e(list.get(0));
            }
            return list;
        }
        return AbstractC1378t.m();
