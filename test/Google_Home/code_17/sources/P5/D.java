...
public abstract class D extends C {
    ...
    public static final class a implements InterfaceC2998g {
        ...
        /* renamed from: a */
        final /* synthetic */ Iterable f8832a;

        public a(Iterable iterable) {
            this.f8832a = iterable;
        }

        @Override // i6.InterfaceC2998g
        public Iterator iterator() {
            return this.f8832a.iterator();
        }
    }
    ...
    public static final class b extends AbstractC3256z implements Function1 {
        ...
        public final Object invoke(int i8) {
            throw new IndexOutOfBoundsException("Collection doesn't contain element at index " + this.f8833a + '.');
        }
    ...
    public static List E0(Iterable iterable, Object obj) {
        AbstractC3255y.i(iterable, "<this>");
        ArrayList arrayList = new ArrayList(AbstractC1378t.x(iterable, 10));
        boolean z8 = false;
    ...
    public static List F0(Iterable iterable, Iterable elements) {
        ...
        if (iterable instanceof Collection) {
            return AbstractC1378t.G0((Collection) iterable, elements);
        }
        ArrayList arrayList = new ArrayList();
        AbstractC1378t.D(arrayList, iterable);
        AbstractC1378t.D(arrayList, elements);
        return arrayList;
    }
    ...
    public static List G0(Collection collection, Iterable elements) {
        ...
        AbstractC1378t.D(arrayList2, elements);
        return arrayList2;
    }
    ...
    public static List I0(Iterable iterable) {
        ...
        if ((iterable instanceof Collection) && ((Collection) iterable).size() <= 1) {
            return AbstractC1378t.W0(iterable);
        }
    ...
    public static List N0(List list, g6.i indices) {
        AbstractC3255y.i(list, "<this>");
        AbstractC3255y.i(indices, "indices");
        if (indices.isEmpty()) {
            return AbstractC1378t.m();
        }
        return AbstractC1378t.W0(list.subList(indices.getStart().intValue(), indices.getEndInclusive().intValue() + 1));
    }
    ...
    public static List O0(Iterable iterable) {
        ...
        if (iterable instanceof Collection) {
            ...
            AbstractC1371l.J((Comparable[]) array);
            return AbstractC1371l.c(array);
        }
        List Y02 = Y0(iterable);
        AbstractC1384z.A(Y02);
        return Y02;
    }
    ...
    public static List P0(Iterable iterable, Comparator comparator) {
        ...
        if (iterable instanceof Collection) {
            ...
            AbstractC1374o.K(array, comparator);
            return AbstractC1371l.c(array);
        }
        List Y02 = Y0(iterable);
        AbstractC1378t.B(Y02, comparator);
        return Y02;
    }
    ...
    public static List Q0(Iterable iterable, int i8) {
        ...
        if (i8 >= 0) {
            ...
            if (iterable instanceof Collection) {
                ...
                if (i8 == 1) {
                    return AbstractC1378t.e(AbstractC1378t.l0(iterable));
                }
            }
            ...
            return AbstractC1380v.t(arrayList);
        }
    ...
    public static HashSet U0(Iterable iterable) {
        AbstractC3255y.i(iterable, "<this>");
        return (HashSet) S0(iterable, new HashSet(Q.d(AbstractC1378t.x(iterable, 12))));
    }
    ...
    public static List W0(Iterable iterable) {
        ...
        if (iterable instanceof Collection) {
            ...
            if (size != 0) {
                if (size != 1) {
                    return AbstractC1378t.Z0(collection);
                }
                if (iterable instanceof List) {
        ...
        return AbstractC1380v.t(Y0(iterable));
    }
    ...
    public static final List Y0(Iterable iterable) {
        AbstractC3255y.i(iterable, "<this>");
        if (iterable instanceof Collection) {
            return AbstractC1378t.Z0((Collection) iterable);
        }
    ...
    public static InterfaceC2998g c0(Iterable iterable) {
        AbstractC3255y.i(iterable, "<this>");
    ...
    public static boolean d0(Iterable iterable, Object obj) {
        ...
        if (AbstractC1378t.q0(iterable, obj) >= 0) {
            return true;
        }
        return false;
    }
    ...
    public static List e0(Iterable iterable) {
        AbstractC3255y.i(iterable, "<this>");
        return AbstractC1378t.W0(AbstractC1378t.a1(iterable));
    }
    ...
    public static List e1(Iterable iterable, Iterable other) {
        ...
        ArrayList arrayList = new ArrayList(Math.min(AbstractC1378t.x(iterable, 10), AbstractC1378t.x(other, 10)));
        while (it.hasNext() && it2.hasNext()) {
            arrayList.add(O5.x.a(it.next(), it2.next()));
        }
        return arrayList;
    }
    ...
    public static List f0(Iterable iterable, int i8) {
        ...
        if (i8 >= 0) {
            ...
            if (iterable instanceof Collection) {
                ...
                if (size == 1) {
                    return AbstractC1378t.e(x0(iterable));
                }
    ...
    public static List g0(List list, int i8) {
        AbstractC3255y.i(list, "<this>");
        if (i8 >= 0) {
            return AbstractC1378t.Q0(list, g6.m.d(list.size() - i8, 0));
        }
        throw new IllegalArgumentException(("Requested element count " + i8 + " is less than zero.").toString());
    }
    ...
    public static final Object i0(Iterable iterable, int i8, Function1 defaultValue) {
        ...
        if (iterable instanceof List) {
            List list = (List) iterable;
            if (i8 >= 0 && i8 <= AbstractC1378t.o(list)) {
                return list.get(i8);
            }
    ...
    public static Object l0(Iterable iterable) {
        AbstractC3255y.i(iterable, "<this>");
        if (iterable instanceof List) {
            return AbstractC1378t.m0((List) iterable);
        }
        Iterator it = iterable.iterator();
        if (it.hasNext()) {
            return it.next();
    ...
    public static Set s0(Iterable iterable, Iterable other) {
        AbstractC3255y.i(iterable, "<this>");
        AbstractC3255y.i(other, "other");
        Set a12 = AbstractC1378t.a1(iterable);
        AbstractC1378t.S(a12, other);
        return a12;
    }
    ...
    public static /* synthetic */ Appendable u0(Iterable iterable, Appendable appendable, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i8, CharSequence charSequence4, Function1 function1, int i9, Object obj) {
        ...
        return t0(iterable, appendable, charSequence5, charSequence6, charSequence8, i10, charSequence7, function12);
    }
    ...
    public static final Object x0(Iterable iterable) {
        AbstractC3255y.i(iterable, "<this>");
        if (iterable instanceof List) {
            return AbstractC1378t.y0((List) iterable);
        }
        Iterator it = iterable.iterator();
        if (it.hasNext()) {
            Object next = it.next();
    ...
    public static Object y0(List list) {
        AbstractC3255y.i(list, "<this>");
        if (!list.isEmpty()) {
            return list.get(AbstractC1378t.o(list));
        }
        throw new NoSuchElementException("List is empty.");
    }
