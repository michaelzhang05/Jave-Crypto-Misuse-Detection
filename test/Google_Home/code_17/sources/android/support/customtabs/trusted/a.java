...
public interface a extends IInterface {
    ...
    public static final String f14381g = "android$support$customtabs$trusted$ITrustedWebActivityCallback".replace('$', '.');
    ...
    public static abstract class AbstractBinderC0275a extends Binder implements a {
        ...
        private static class C0276a implements a {
            ...
            private IBinder f14382a;

            C0276a(IBinder iBinder) {
                this.f14382a = iBinder;
            }
            ...
            public void onExtraCallback(String str, Bundle bundle) {
                ...
                try {
                    obtain.writeInterfaceToken(a.f14381g);
                    obtain.writeString(str);
                    b.d(obtain, bundle, 0);
                    this.f14382a.transact(2, obtain, obtain2, 0);
        ...
        public AbstractBinderC0275a() {
            attachInterface(this, a.f14381g);
        }
        ...
        public static a asInterface(IBinder iBinder) {
            ...
            IInterface queryLocalInterface = iBinder.queryLocalInterface(a.f14381g);
