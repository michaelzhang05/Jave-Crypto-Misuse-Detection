...
public interface a extends IInterface {
    ...
    public static final String f14385i = "android$support$v4$app$INotificationSideChannel".replace('$', '.');
    ...
    public static abstract class AbstractBinderC0279a extends Binder implements a {
        ...
        /* loaded from: classes.dex */
        private static class C0280a implements a {

            /* renamed from: a, reason: collision with root package name */
            private IBinder f14386a;

            C0280a(IBinder iBinder) {
                this.f14386a = iBinder;
            }
            ...
            public void cancel(String str, int i8, String str2) {
                ...
                try {
                    obtain.writeInterfaceToken(a.f14385i);
                    obtain.writeString(str);
                    obtain.writeInt(i8);
                    obtain.writeString(str2);
                    this.f14386a.transact(2, obtain, null, 1);
                } finally {
                    obtain.recycle();
                }
            }
            ...
            public void cancelAll(String str) {
                ...
                try {
                    obtain.writeInterfaceToken(a.f14385i);
                    obtain.writeString(str);
                    this.f14386a.transact(3, obtain, null, 1);
                } finally {
                    obtain.recycle();
                }
            }
            ...
            public void notify(String str, int i8, String str2, Notification notification) {
                ...
                try {
                    ...
                    this.f14386a.transact(1, obtain, null, 1);
                } finally {
                    obtain.recycle();
                }
            }
        ...
        public AbstractBinderC0279a() {
            attachInterface(this, a.f14385i);
        }
        ...
        public static a asInterface(IBinder iBinder) {
            ...
            IInterface queryLocalInterface = iBinder.queryLocalInterface(a.f14385i);
