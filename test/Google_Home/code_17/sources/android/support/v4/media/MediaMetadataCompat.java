...
public final class MediaMetadataCompat implements Parcelable {
    ...
    static final ArrayMap f14422d;

    /* renamed from: e, reason: collision with root package name */
    private static final String[] f14423e;

    /* renamed from: f, reason: collision with root package name */
    private static final String[] f14424f;

    /* renamed from: g, reason: collision with root package name */
    private static final String[] f14425g;

    /* renamed from: a, reason: collision with root package name */
    final Bundle f14426a;

    /* renamed from: b, reason: collision with root package name */
    private Object f14427b;

    /* renamed from: c, reason: collision with root package name */
    private MediaDescriptionCompat f14428c;
    ...
    static {
        ...
        f14423e = new String[]{"android.media.metadata.TITLE", "android.media.metadata.ARTIST", "android.media.metadata.ALBUM", "android.media.metadata.ALBUM_ARTIST", "android.media.metadata.WRITER", "android.media.metadata.AUTHOR", "android.media.metadata.COMPOSER"};
        f14424f = new String[]{"android.media.metadata.DISPLAY_ICON", "android.media.metadata.ART", "android.media.metadata.ALBUM_ART"};
        f14425g = new String[]{"android.media.metadata.DISPLAY_ICON_URI", "android.media.metadata.ART_URI", "android.media.metadata.ALBUM_ART_URI"};
        CREATOR = new a();
    }

    MediaMetadataCompat(Parcel parcel) {
        this.f14426a = parcel.readBundle(MediaSessionCompat.class.getClassLoader());
    }
    ...
    public Bitmap b(String str) {
        try {
            return (Bitmap) this.f14426a.getParcelable(str);
        } catch (Exception e8) {
    ...
    public MediaDescriptionCompat g() {
        ...
        Bitmap bitmap;
        Uri uri2;
        MediaDescriptionCompat mediaDescriptionCompat = this.f14428c;
        ...
        if (this.f14426a.containsKey("android.media.metadata.BT_FOLDER_TYPE")) {
            bundle.putLong("android.media.extra.BT_FOLDER_TYPE", h("android.media.metadata.BT_FOLDER_TYPE"));
        }
        if (this.f14426a.containsKey("android.media.metadata.DOWNLOAD_STATUS")) {
    ...
    public long h(String str) {
        return this.f14426a.getLong(str, 0L);
    }

    public String i(String str) {
        CharSequence charSequence = this.f14426a.getCharSequence(str);
    ...
    public CharSequence l(String str) {
        return this.f14426a.getCharSequence(str);
    }

    @Override // android.os.Parcelable
    public void writeToParcel(Parcel parcel, int i8) {
        parcel.writeBundle(this.f14426a);
    }
}
