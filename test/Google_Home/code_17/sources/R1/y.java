...
public abstract class y {
    public static Signature a(N1.p pVar, Provider provider) {
        Signature b8;
        Signature c8;
        Signature b9;
        Signature c9;
        ...
        Signature b12;
        Signature b13;
        if (pVar.equals(N1.p.f7606g) && (b13 = b("SHA256withRSA", provider)) != null) {
            return b13;
        }
        if (pVar.equals(N1.p.f7607h) && (b12 = b("SHA384withRSA", provider)) != null) {
            return b12;
        }
        if (pVar.equals(N1.p.f7608i) && (b11 = b("SHA512withRSA", provider)) != null) {
            return b11;
        }
        N1.p pVar2 = N1.p.f7613n;
        ...
        throw new N1.f(e.d(pVar, z.f9615c));
    }
        ...
        try {
            ...
            if (pSSParameterSpec != null) {
                try {
                    ...
                    throw new N1.f("Invalid RSASSA-PSS salt length parameter: " + e8.getMessage(), e8);
                }
            }
            return signature;
