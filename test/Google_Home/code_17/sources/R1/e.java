...
public abstract class e {
    ...
    public static String b(N1.d dVar, Collection collection) {
        return "Unsupported JWE encryption method " + dVar + ", must be " + a(collection);
    }

    public static String c(N1.i iVar, Collection collection) {
        return "Unsupported JWE algorithm " + iVar + ", must be " + a(collection);
    }

    public static String d(N1.p pVar, Collection collection) {
