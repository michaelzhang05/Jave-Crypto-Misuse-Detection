...
public abstract class b {
    ...
    static final Type[] f18630a = new Type[0];
    ...
    public static final class a implements GenericArrayType, Serializable {
        ...
        /* renamed from: a, reason: collision with root package name */
        private final Type f18631a;

        public a(Type type) {
            Objects.requireNonNull(type);
            this.f18631a = b.b(type);
        }
    ...
    /* loaded from: classes4.dex */
    public static final class C0378b implements ParameterizedType, Serializable {

        /* renamed from: a, reason: collision with root package name */
        private final Type f18632a;

        /* renamed from: b, reason: collision with root package name */
        private final Type f18633b;

        /* renamed from: c, reason: collision with root package name */
        private final Type[] f18634c;

        public C0378b(Type type, Type type2, Type... typeArr) {
            Type b8;
            boolean z8;
            ...
            this.f18632a = b8;
            this.f18633b = b.b(type2);
            Type[] typeArr2 = (Type[]) typeArr.clone();
            this.f18634c = typeArr2;
            int length = typeArr2.length;
            for (int i8 = 0; i8 < length; i8++) {
                Objects.requireNonNull(this.f18634c[i8]);
                b.c(this.f18634c[i8]);
                Type[] typeArr3 = this.f18634c;
        ...
        public Type[] getActualTypeArguments() {
            return (Type[]) this.f18634c.clone();
        }
        ...
        public int hashCode() {
            return (Arrays.hashCode(this.f18634c) ^ this.f18633b.hashCode()) ^ a(this.f18632a);
        }

        public String toString() {
            int length = this.f18634c.length;
            if (length == 0) {
                return b.t(this.f18633b);
            }
            StringBuilder sb = new StringBuilder((length + 1) * 30);
            sb.append(b.t(this.f18633b));
            sb.append("<");
            sb.append(b.t(this.f18634c[0]));
            for (int i8 = 1; i8 < length; i8++) {
                sb.append(", ");
                sb.append(b.t(this.f18634c[i8]));
            }
            sb.append(">");
            return sb.toString();
        }
    ...
    public static final class c implements WildcardType, Serializable {
        ...
        /* renamed from: a, reason: collision with root package name */
        private final Type f18635a;

        /* renamed from: b, reason: collision with root package name */
        private final Type f18636b;
        ...
        public c(Type[] typeArr, Type[] typeArr2) {
            ...
            if (typeArr2.length == 1) {
                ...
                this.f18636b = b.b(typeArr2[0]);
                this.f18635a = Object.class;
                return;
            }
            Objects.requireNonNull(typeArr[0]);
            b.c(typeArr[0]);
            this.f18636b = null;
            this.f18635a = b.b(typeArr[0]);
        }
        ...
        public int hashCode() {
            ...
            return i8 ^ (this.f18635a.hashCode() + 31);
        }

        public String toString() {
            if (this.f18636b != null) {
                return "? super " + b.t(this.f18636b);
            }
            if (this.f18635a == Object.class) {
                return "?";
            }
            return "? extends " + b.t(this.f18635a);
        }
    }
    ...
    public static Type b(Type type) {
        ...
        if (type instanceof ParameterizedType) {
            ...
            return new C0378b(parameterizedType.getOwnerType(), parameterizedType.getRawType(), parameterizedType.getActualTypeArguments());
        }
    ...
    public static ParameterizedType n(Type type, Type type2, Type... typeArr) {
        return new C0378b(type, type2, typeArr);
    }
