...
public enum Z {
    ...
    private static final Map f16457E0 = new HashMap();
    ...
    static {
        for (Z z8 : values()) {
            f16457E0.put(Integer.valueOf(z8.f16516a), z8);
        }
    }
    ...
    public static Z a(int i8) {
        return (Z) f16457E0.get(Integer.valueOf(i8));
    }

    @Override // java.lang.Enum
    public final String toString() {
        return Integer.valueOf(this.f16516a).toString();
    }
}
