...
public class ShapePath {
    ...
    static class InnerCornerShadowOperation extends ShadowCompatOperation {
        ...
        public void draw(Matrix matrix, ShadowRenderer shadowRenderer, int i8, Canvas canvas) {
            ...
            double hypot = Math.hypot(this.operation1.f18170x - this.startX, this.operation1.f18171y - this.startY);
            double hypot2 = Math.hypot(this.operation2.f18170x - this.operation1.f18170x, this.operation2.f18171y - this.operation1.f18171y);
            ...
            this.renderMatrix.set(matrix);
            this.renderMatrix.preTranslate(this.operation1.f18170x, this.operation1.f18171y);
            this.renderMatrix.preRotate(getStartAngle());
        ...
        float getEndAngle() {
            return (float) Math.toDegrees(Math.atan((this.operation2.f18171y - this.operation1.f18171y) / (this.operation2.f18170x - this.operation1.f18170x)));
        }

        float getStartAngle() {
            return (float) Math.toDegrees(Math.atan((this.operation1.f18171y - this.startY) / (this.operation1.f18170x - this.startX)));
        }
    ...
    public static class LineShadowOperation extends ShadowCompatOperation {
        ...
        @Override // com.google.android.material.shape.ShapePath.ShadowCompatOperation
        public void draw(Matrix matrix, @NonNull ShadowRenderer shadowRenderer, int i8, @NonNull Canvas canvas) {
            RectF rectF = new RectF(0.0f, 0.0f, (float) Math.hypot(this.operation.f18171y - this.startY, this.operation.f18170x - this.startX), 0.0f);
            this.renderMatrix.set(matrix);
            this.renderMatrix.preTranslate(this.startX, this.startY);
        ...
        float getAngle() {
            return (float) Math.toDegrees(Math.atan((this.operation.f18171y - this.startY) / (this.operation.f18170x - this.startX)));
        }
    }
    ...
    public static class PathLineOperation extends PathOperation {
        ...
        private float f18170x;

        /* renamed from: y, reason: collision with root package name */
        private float f18171y;
        ...
        public void applyToPath(@NonNull Matrix matrix, @NonNull Path path) {
            ...
            matrix.invert(matrix2);
            path.transform(matrix2);
            path.lineTo(this.f18170x, this.f18171y);
            path.transform(matrix);
        }
    }
    ...
    public void lineTo(float f8, float f9) {
        ...
        pathLineOperation.f18170x = f8;
        pathLineOperation.f18171y = f9;
    ...
    public void lineTo(float f8, float f9, float f10, float f11) {
        ...
        pathLineOperation2.f18170x = f10;
        pathLineOperation2.f18171y = f11;
