...
public class MaterialShapeDrawable extends Drawable implements TintAwareDrawable, Shapeable {
    ...
    @Nullable
    private PorterDuffColorFilter calculatePaintColorTintFilter(@NonNull Paint paint, boolean z8) {
        if (z8) {
    ...
    private void calculatePath(@NonNull RectF rectF, @NonNull Path path) {
        ...
        if (this.drawableState.scale != 1.0f) {
            ...
            float f8 = this.drawableState.scale;
    ...
    private void calculateStrokePath() {
        final float f8 = -getStrokeInsetLength();
    ...
    @NonNull
    private PorterDuffColorFilter calculateTintColorTintFilter(@NonNull ColorStateList colorStateList, @NonNull PorterDuff.Mode mode, boolean z8) {
    ...
    @NonNull
    private PorterDuffColorFilter calculateTintFilter(@Nullable ColorStateList colorStateList, @Nullable PorterDuff.Mode mode, @NonNull Paint paint, boolean z8) {
        if (colorStateList != null && mode != null) {
            return calculateTintColorTintFilter(colorStateList, mode, z8);
        }
        return calculatePaintColorTintFilter(paint, z8);
    }
    ...
    private void maybeDrawCompatShadow(@NonNull Canvas canvas) {
        ...
        if (width >= 0 && height >= 0) {
            ...
            float f8 = (getBounds().left - this.drawableState.shadowCompatRadius) - width;
            float f9 = (getBounds().top - this.drawableState.shadowCompatRadius) - height;
    ...
    private void updateZ() {
        float z8 = getZ();
        this.drawableState.shadowCompatRadius = (int) Math.ceil(0.75f * z8);
        this.drawableState.shadowCompatOffset = (int) Math.ceil(z8 * SHADOW_OFFSET_MULTIPLIER);
        updateTintFilter();
    ...
    public int compositeElevationOverlayIfNeeded(@ColorInt int i8) {
        ...
        if (elevationOverlayProvider != null) {
            return elevationOverlayProvider.compositeOverlayIfNeeded(i8, z8);
        }
        return i8;
    }
    ...
    public boolean requiresCompatShadow() {
        ...
        if (!isRoundRect() && !this.path.isConvex() && i8 < 29) {
            return true;
        }
        return false;
    }
    ...
    public void setCornerSize(float f8) {
        setShapeAppearanceModel(this.drawableState.shapeAppearanceModel.withCornerSize(f8));
    }

    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP})
    public void setEdgeIntersectionCheckEnable(boolean z8) {
        this.pathProvider.setEdgeIntersectionCheckEnable(z8);
    }

    public void setElevation(float f8) {
        MaterialShapeDrawableState materialShapeDrawableState = this.drawableState;
        if (materialShapeDrawableState.elevation != f8) {
            materialShapeDrawableState.elevation = f8;
            updateZ();
        }
    }
    ...
    public void setInterpolation(float f8) {
        MaterialShapeDrawableState materialShapeDrawableState = this.drawableState;
        if (materialShapeDrawableState.interpolation != f8) {
            materialShapeDrawableState.interpolation = f8;
            this.pathDirty = true;
            invalidateSelf();
        }
    }
    ...
    public void setParentAbsoluteElevation(float f8) {
        MaterialShapeDrawableState materialShapeDrawableState = this.drawableState;
        if (materialShapeDrawableState.parentAbsoluteElevation != f8) {
            materialShapeDrawableState.parentAbsoluteElevation = f8;
            updateZ();
        }
    }
    ...
    public void setScale(float f8) {
        MaterialShapeDrawableState materialShapeDrawableState = this.drawableState;
        if (materialShapeDrawableState.scale != f8) {
            materialShapeDrawableState.scale = f8;
            invalidateSelf();
        }
    }
    ...
    public void setStrokeWidth(float f8) {
        this.drawableState.strokeWidth = f8;
        invalidateSelf();
    }
    ...
    public void setTranslationZ(float f8) {
        MaterialShapeDrawableState materialShapeDrawableState = this.drawableState;
        if (materialShapeDrawableState.translationZ != f8) {
            materialShapeDrawableState.translationZ = f8;
            updateZ();
        }
    }
    ...
    public void setUseTintColorForShadow(boolean z8) {
        MaterialShapeDrawableState materialShapeDrawableState = this.drawableState;
        if (materialShapeDrawableState.useTintColorForShadow != z8) {
            materialShapeDrawableState.useTintColorForShadow = z8;
            invalidateSelf();
        }
    }
