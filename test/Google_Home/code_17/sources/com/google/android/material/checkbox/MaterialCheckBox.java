...
public class MaterialCheckBox extends AppCompatCheckBox {
    ...
    public interface OnErrorChangedListener {
        void onErrorChanged(@NonNull MaterialCheckBox materialCheckBox, boolean z8);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (this.centerIfNoTextEnabled && TextUtils.isEmpty(getText()) && (buttonDrawable = CompoundButtonCompat.getButtonDrawable(this)) != null) {
            ...
            int width = ((getWidth() - buttonDrawable.getIntrinsicWidth()) / 2) * i8;
    ...
    public void setCheckedState(int i8) {
        ...
        if (this.checkedState != i8) {
            ...
            if (Build.VERSION.SDK_INT >= 26) {
                systemService = getContext().getSystemService((Class<Object>) AbstractC2849c.a());
