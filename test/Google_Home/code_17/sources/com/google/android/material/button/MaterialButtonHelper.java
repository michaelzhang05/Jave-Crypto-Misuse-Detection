...
public class MaterialButtonHelper {
    ...
    private Drawable createBackground() {
        ...
        if (this.shouldDrawSurfaceColorStroke) {
            i8 = MaterialColors.getColor(this.materialButton, R.attr.colorSurface);
        } else {
            i8 = 0;
        }
        materialShapeDrawable2.setStroke(f8, i8);
        if (IS_MIN_LOLLIPOP) {
    ...
    @Nullable
    private MaterialShapeDrawable getMaterialShapeDrawable(boolean z8) {
        LayerDrawable layerDrawable = this.rippleDrawable;
        if (layerDrawable == null || layerDrawable.getNumberOfLayers() <= 0) {
            return null;
        }
        if (IS_MIN_LOLLIPOP) {
            return (MaterialShapeDrawable) ((LayerDrawable) ((InsetDrawable) this.rippleDrawable.getDrawable(0)).getDrawable()).getDrawable(!z8 ? 1 : 0);
        }
        return (MaterialShapeDrawable) this.rippleDrawable.getDrawable(!z8 ? 1 : 0);
    }
    ...
    private void updateStroke() {
        ...
        if (materialShapeDrawable != null) {
            ...
            if (surfaceColorStrokeDrawable != null) {
                ...
                surfaceColorStrokeDrawable.setStroke(f8, i8);
            }
        }
    }
    ...
    public void setRippleColor(@Nullable ColorStateList colorStateList) {
        if (this.rippleColor != colorStateList) {
            ...
            } else if (!z8 && (this.materialButton.getBackground() instanceof RippleDrawableCompat)) {
    ...
    public void setShouldDrawSurfaceColorStroke(boolean z8) {
        this.shouldDrawSurfaceColorStroke = z8;
        updateStroke();
    }
    ...
    public void setToggleCheckedStateOnClick(boolean z8) {
        this.toggleCheckedStateOnClick = z8;
    }
