...
public abstract class BaseProgressIndicator<S extends BaseProgressIndicatorSpec> extends ProgressBar {
    ...
    protected void applyNewVisibility(boolean z8) {
        ...
        ((DrawableWithAnimatedVisibilityChange) getCurrentDrawable()).setVisible(visibleToUser(), false, z8);
    }
    ...
    protected synchronized void onMeasure(int i8, int i9) {
        ...
        try {
            ...
            if (currentDrawingDelegate.getPreferredWidth() < 0) {
                preferredWidth = View.getDefaultSize(getSuggestedMinimumWidth(), i8);
            } else {
            ...
            if (currentDrawingDelegate.getPreferredHeight() < 0) {
                preferredHeight = View.getDefaultSize(getSuggestedMinimumHeight(), i9);
            } else {
    ...
    public void setIndicatorTrackGapSize(@Px int i8) {
        S s8 = this.spec;
        if (s8.indicatorTrackGapSize != i8) {
            s8.indicatorTrackGapSize = i8;
            s8.validateSpec();
            invalidate();
        }
    }
    ...
    public void setProgressCompat(int i8, boolean z8) {
        if (isIndeterminate()) {
            if (getProgressDrawable() != null) {
                ...
                this.storedProgressAnimated = z8;
    ...
    public void setTrackCornerRadius(@Px int i8) {
        S s8 = this.spec;
        if (s8.trackCornerRadius != i8) {
            s8.trackCornerRadius = Math.min(i8, s8.trackThickness / 2);
            invalidate();
        }
    }
    ...
    public void setTrackThickness(@Px int i8) {
        S s8 = this.spec;
        if (s8.trackThickness != i8) {
            s8.trackThickness = i8;
            requestLayout();
        }
    }
