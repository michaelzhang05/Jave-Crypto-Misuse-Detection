...
public class J {
    ...
    private final Bundle f18372a;

    public J(Bundle bundle) {
        if (bundle != null) {
            this.f18372a = new Bundle(bundle);
            return;
        }
    ...
    private String w(String str) {
        if (!this.f18372a.containsKey(str) && str.startsWith("gcm.n.")) {
            String v8 = v(str);
            if (this.f18372a.containsKey(v8)) {
                return v8;
            }
        }
        return str;
    ...
    public String p(String str) {
        return this.f18372a.getString(w(str));
    }
    ...
    public Bundle x() {
        Bundle bundle = new Bundle(this.f18372a);
        for (String str : this.f18372a.keySet()) {
            if (!s(str)) {
                bundle.remove(str);
            }
        }
