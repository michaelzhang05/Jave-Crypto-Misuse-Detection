...
public final class TosPreferences extends g {
    ...
    public static final class a extends PreferenceFragmentCompat {
        ...
        public static final boolean k(a this$0, Preference it) {
            ...
            AbstractC3255y.h(string2, "getString(R.string.url_tos)");
            C3671k c3671k = new C3671k();
            FragmentActivity requireActivity = this$0.requireActivity();
            AbstractC3255y.h(requireActivity, "requireActivity()");
            c3671k.q(requireActivity, string2, string);
        ...
        public void onCreatePreferences(Bundle bundle, String str) {
            ...
            findPreference.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() { // from class: F4.B
            ...
            findPreference2.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() { // from class: F4.C
                @Override // androidx.preference.Preference.OnPreferenceClickListener
                public final boolean onPreferenceClick(Preference preference) {
                    boolean k8;
