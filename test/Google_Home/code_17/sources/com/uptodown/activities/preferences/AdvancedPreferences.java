...
public final class AdvancedPreferences extends g {
    ...
    public static final class a extends PreferenceFragmentCompat {
        ...
        public static final boolean j(J4.a coreSettings, Preference it) {
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public static final boolean k(J4.a coreSettings, Preference it) {
            AbstractC3255y.i(coreSettings, "$coreSettings");
            AbstractC3255y.i(it, "it");
        ...
        public void onCreatePreferences(Bundle bundle, String str) {
            ...
            final J4.a aVar = new J4.a(requireContext);
            ...
            switchPreference.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() { // from class: F4.e
                @Override // androidx.preference.Preference.OnPreferenceClickListener
                public final boolean onPreferenceClick(Preference preference) {
                    boolean j8;
                    j8 = AdvancedPreferences.a.j(J4.a.this, preference);
                    return j8;
                }
            });
            Preference findPreference2 = findPreference("show_warning_installed");
            AbstractC3255y.g(findPreference2, "null cannot be cast to non-null type androidx.preference.SwitchPreference");
            SwitchPreference switchPreference2 = (SwitchPreference) findPreference2;
            switchPreference2.setChecked(aVar.N());
            switchPreference2.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() { // from class: F4.f
                @Override // androidx.preference.Preference.OnPreferenceClickListener
                public final boolean onPreferenceClick(Preference preference) {
                    boolean k8;
                    k8 = AdvancedPreferences.a.k(J4.a.this, preference);
                    return k8;
                }
            });
        }
