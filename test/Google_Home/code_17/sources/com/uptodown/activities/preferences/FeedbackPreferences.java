...
public final class FeedbackPreferences extends g {
    ...
    public static final class a extends PreferenceFragmentCompat {
        ...
        public void onCreatePreferences(Bundle bundle, String str) {
            ...
            findPreference.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() { // from class: F4.h
            ...
            findPreference2.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() { // from class: F4.i
                @Override // androidx.preference.Preference.OnPreferenceClickListener
                public final boolean onPreferenceClick(Preference preference) {
                    boolean k8;
