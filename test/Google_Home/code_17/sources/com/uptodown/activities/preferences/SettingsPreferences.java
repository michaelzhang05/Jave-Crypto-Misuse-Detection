...
public final class SettingsPreferences extends g {
    ...
    public static final class a {
        ...
        public final void K0(Context context, String language) {
            AbstractC3255y.i(context, "context");
            AbstractC3255y.i(language, "language");
            d1(context, "Language", language);
            new J4.a(context).C(language);
        }
        ...
        public final void M0(Context context, String timestamp) {
            AbstractC3255y.i(context, "context");
            AbstractC3255y.i(timestamp, "timestamp");
        ...
        public final C1643j g(Context context) {
            AbstractC3255y.i(context, "context");
            ...
            if (y8 > -1 && E8 != null && E9 != null) {
                C1643j c1643j = new C1643j(y8, E8, E9);
                c1643j.z(y(this, context, "banner_last_time_shown", 0L, 4, null));
                c1643j.v(o(context, "banner_download_id"));
                c1643j.x(y(this, context, "banner_last_time_clicked", 0L, 4, null));
                c1643j.u(o(context, "banner_counter_impressions"));
                c1643j.y(y(this, context, "banner_last_time_requested", 0L, 4, null));
                return c1643j;
            }
            return null;
        }
        ...
        public final C1653u p(Context context) {
            AbstractC3255y.i(context, "context");
            ...
            if (y8 > -1 && E8 != null && E9 != null) {
                C1653u c1653u = new C1653u(y8, E8, E9);
                c1653u.z(y(this, context, "interstitial_last_time_shown", 0L, 4, null));
                c1653u.v(o(context, "interstitial_download_id"));
                c1653u.x(y(this, context, "interstitial_last_time_clicked", 0L, 4, null));
                c1653u.u(o(context, "interstitial_counter_impressions"));
                c1653u.y(y(this, context, "interstitial_last_time_requested", 0L, 4, null));
                return c1653u;
            }
            return null;
        }
        ...
        public final void q0(Context context, C1643j bannerInfo) {
            AbstractC3255y.i(context, "context");
            AbstractC3255y.i(bannerInfo, "bannerInfo");
        ...
        public final void r0(Context context, C1653u interstitialInfo) {
            AbstractC3255y.i(context, "context");
            AbstractC3255y.i(interstitialInfo, "interstitialInfo");
        ...
        public final void s0(Context context, x notificationFCM) {
            AbstractC3255y.i(context, "context");
            AbstractC3255y.i(notificationFCM, "notificationFCM");
        ...
        public final void t0(Context context, P uploadInfo) {
            AbstractC3255y.i(context, "context");
            AbstractC3255y.i(uploadInfo, "uploadInfo");
    ...
    public static final class b extends PreferenceFragmentCompat {
        ...
        private final ActivityResultLauncher f30357c;

        public b() {
            ActivityResultLauncher registerForActivityResult = registerForActivityResult(new ActivityResultContracts.StartActivityForResult(), new ActivityResultCallback() { // from class: F4.n
            ...
            this.f30357c = registerForActivityResult;
        }
        ...
        public static final boolean A(b this$0, Preference it) {
            ...
            ActivityResultLauncher activityResultLauncher = this$0.f30357c;
            FragmentActivity activity = this$0.getActivity();
            if (activity != null) {
                activityOptionsCompat = UptodownApp.f29058B.b(activity);
            } else {
        ...
        public static final boolean B(b this$0, Preference preference, Object obj) {
            ...
            a aVar = SettingsPreferences.f30353b;
        ...
        public static final boolean F(b this$0, Preference it) {
            ...
            AbstractC3255y.h(string, "getString(R.string.privacy_policy_title)");
            String string2 = this$0.getString(R.string.url_advertising);
            AbstractC3255y.h(string2, "getString(R.string.url_advertising)");
        ...
        private final void v(String str, Preference preference) {
            String str2;
            if (!AbstractC3255y.d(str, MBridgeConstans.ENDCARD_URL_TYPE_PL)) {
                Long l8 = null;
                if (AbstractC3255y.d(str, "1")) {
                    str2 = getString(R.string.download_updates_option_1);
                } else if (AbstractC3255y.d(str, "2")) {
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public static final boolean z(J4.a coreSettings, Preference preference, Object obj) {
        ...
        */
        ...
        public void onResume() {
            ...
            findPreference.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() { // from class: F4.s
            ...
            AbstractC3255y.h(requireContext, "requireContext()");
            if (c3683w.a(requireContext)) {
                string = getString(R.string.enabled);
                AbstractC3255y.h(string, "getString(R.string.enabled)");
            } else {
                string = getString(R.string.disabled);
                AbstractC3255y.h(string, "getString(R.string.disabled)");
            }
            ...
            if (!aVar.W(requireContext2)) {
                ...
                AbstractC3255y.f(findPreference2);
                findPreference2.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() { // from class: F4.t
                    @Override // androidx.preference.Preference.OnPreferenceClickListener
                    public final boolean onPreferenceClick(Preference preference) {
                        boolean J8;
    ...
    @Override // F4.g, android.app.Activity
    public void finish() {
        M m8 = new M(this);
        if (!m8.b(this.f30354a)) {
