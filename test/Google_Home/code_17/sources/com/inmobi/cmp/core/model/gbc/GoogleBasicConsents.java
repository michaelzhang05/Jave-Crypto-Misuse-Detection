...
public final class GoogleBasicConsents {
    ...
    public GoogleBasicConsents(GBCConsentValue adStorage, GBCConsentValue adUserData, GBCConsentValue adPersonalization, GBCConsentValue analyticsStorage) {
        AbstractC3255y.i(adStorage, "adStorage");
        AbstractC3255y.i(adUserData, "adUserData");
        AbstractC3255y.i(adPersonalization, "adPersonalization");
        AbstractC3255y.i(analyticsStorage, "analyticsStorage");
    ...
    public String toString() {
        StringBuilder a8 = AbstractC4062a.a("GoogleBasicConsents(adStorage=");
