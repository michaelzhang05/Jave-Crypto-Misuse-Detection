...
public final class PublisherMap {
    ...
    public final PublisherMap copy(int i8, Map<String, Boolean> consents, Map<String, Boolean> legitimateInterests, ConsentMap customPurpose, Map<String, Map<String, k>> restrictions) {
        ...
        AbstractC3255y.i(customPurpose, "customPurpose");
        AbstractC3255y.i(restrictions, "restrictions");
    ...
    public boolean equals(Object obj) {
        ...
        return this.vendorId == publisherMap.vendorId && AbstractC3255y.d(this.consents, publisherMap.consents) && AbstractC3255y.d(this.legitimateInterests, publisherMap.legitimateInterests) && AbstractC3255y.d(this.customPurpose, publisherMap.customPurpose) && AbstractC3255y.d(this.restrictions, publisherMap.restrictions);
    }
    ...
    public String toString() {
        StringBuilder a8 = AbstractC4062a.a("PublisherMap(vendorId=");
    ...
    public /* synthetic */ PublisherMap(int i8, Map map, Map map2, ConsentMap consentMap, Map map3, int i9, AbstractC3247p abstractC3247p) {
