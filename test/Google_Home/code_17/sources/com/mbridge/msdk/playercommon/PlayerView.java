...
public class PlayerView extends LinearLayout {
    ...
    public class MySurfaceHoldeCallback implements SurfaceHolder.Callback {
        ...
        public void surfaceChanged(SurfaceHolder surfaceHolder, int i8, int i9, int i10) {
            try {
                ...
                if (PlayerView.this.mIsSurfaceHolderDestoryed && !PlayerView.this.mIsCovered && !PlayerView.this.isComplete() && !PlayerView.this.isBTVideo && !b.f20219c) {
    ...
    public JSONObject buildH5JsonObject(int i8) {
        ...
        try {
            jSONObject.put(a.f20475h, ai.b(c.m().c(), this.xInScreen));
            jSONObject.put(a.f20476i, ai.b(c.m().c(), this.yInScreen));
            ...
            jSONObject.put(a.f20478k, this.orientation);
