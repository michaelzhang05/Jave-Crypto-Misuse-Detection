...
public final class SubripDecoder extends SimpleSubtitleDecoder {
    ...
    private static long parseTimecode(Matcher matcher, int i8) {
        return ((Long.parseLong(matcher.group(i8 + 1)) * 3600000) + (Long.parseLong(matcher.group(i8 + 2)) * ChunkedTrackBlacklistUtil.DEFAULT_TRACK_BLACKLIST_MS) + (Long.parseLong(matcher.group(i8 + 3)) * 1000) + Long.parseLong(matcher.group(i8 + 4))) * 1000;
    }

    /* JADX INFO: Access modifiers changed from: protected */
    @Override // com.mbridge.msdk.playercommon.exoplayer2.text.SimpleSubtitleDecoder
    public final SubripSubtitle decode(byte[] bArr, int i8, boolean z8) {
