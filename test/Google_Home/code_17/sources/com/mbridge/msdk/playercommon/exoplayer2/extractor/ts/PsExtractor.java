...
public final class PsExtractor implements Extractor {
    ...
    public final int read(ExtractorInput extractorInput, PositionHolder positionHolder) throws IOException, InterruptedException {
        ...
        int i8 = readInt & 255;
        PesReader pesReader = this.psPayloadReaders.get(i8);
        if (!this.foundAllTracks) {
            if (pesReader == null) {
                ...
                if (elementaryStreamReader != null) {
                    elementaryStreamReader.createTracks(this.output, new TsPayloadReader.TrackIdGenerator(i8, 256));
                    pesReader = new PesReader(elementaryStreamReader, this.timestampAdjuster);
                    this.psPayloadReaders.put(i8, pesReader);
                }
            }
            if (this.foundAudioTrack && this.foundVideoTrack) {
                j8 = this.lastTrackPosition + MAX_SEARCH_LENGTH_AFTER_AUDIO_AND_VIDEO_FOUND;
            } else {
                j8 = MAX_SEARCH_LENGTH;
            }
    ...
    public final void seek(long j8, long j9) {
        ...
        for (int i8 = 0; i8 < this.psPayloadReaders.size(); i8++) {
            this.psPayloadReaders.valueAt(i8).seek();
        }
    }
