...
abstract class Atom {
    ...
    static final class ContainerAtom extends Atom {
        ...
        public final int getChildAtomOfTypeCount(int i8) {
            int size = this.leafChildren.size();
            int i9 = 0;
            for (int i10 = 0; i10 < size; i10++) {
                if (this.leafChildren.get(i10).type == i8) {
                    i9++;
                }
            }
            int size2 = this.containerChildren.size();
            for (int i11 = 0; i11 < size2; i11++) {
                if (this.containerChildren.get(i11).type == i8) {
                    i9++;
                }
            }
            return i9;
        ...
        public final ContainerAtom getContainerAtomOfType(int i8) {
            int size = this.containerChildren.size();
            for (int i9 = 0; i9 < size; i9++) {
                ContainerAtom containerAtom = this.containerChildren.get(i9);
                if (containerAtom.type == i8) {
        ...
        public final LeafAtom getLeafAtomOfType(int i8) {
            int size = this.leafChildren.size();
            for (int i9 = 0; i9 < size; i9++) {
                LeafAtom leafAtom = this.leafChildren.get(i9);
                if (leafAtom.type == i8) {
                    return leafAtom;
                }
            }
    ...
    public static String getAtomTypeString(int i8) {
        return "" + ((char) ((i8 >> 24) & 255)) + ((char) ((i8 >> 16) & 255)) + ((char) ((i8 >> 8) & 255)) + ((char) (i8 & 255));
    }

    public static int parseFullAtomFlags(int i8) {
        return i8 & ViewCompat.MEASURED_SIZE_MASK;
    }

    public static int parseFullAtomVersion(int i8) {
        return (i8 >> 24) & 255;
    }
