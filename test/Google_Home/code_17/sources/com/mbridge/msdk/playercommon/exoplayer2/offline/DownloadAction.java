...
public abstract class DownloadAction {
    ...
    public static abstract class Deserializer {
        ...
        public Deserializer(String str, int i8) {
            this.type = str;
            this.version = i8;
        }

        public abstract DownloadAction readFromStream(int i8, DataInputStream dataInputStream) throws IOException;
    }

    /* JADX INFO: Access modifiers changed from: protected */
    public DownloadAction(String str, int i8, Uri uri, boolean z8, byte[] bArr) {
        this.type = str;
        this.version = i8;
        this.uri = uri;
