...
public class a {
    ...
    private static final String f22717a = "com.mbridge.msdk.reward.c.a";
        ...
        if (context != null) {
            try {
                ...
                try {
                    ...
                    aVar.post(0, d.f().f20751c, a16, new com.mbridge.msdk.foundation.same.report.e.b() { // from class: com.mbridge.msdk.reward.c.a.1
    ...
    public static void a(final Context context, CampaignEx campaignEx, String str) {
        ...
        try {
            ...
            try {
                ...
                a9.a("r_stid", b.a().b().b());
                aVar.post(0, d.f().f20751c, a9, new com.mbridge.msdk.foundation.same.report.e.b() { // from class: com.mbridge.msdk.reward.c.a.2
                    @Override // com.mbridge.msdk.foundation.same.report.e.b
