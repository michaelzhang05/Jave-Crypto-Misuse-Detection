...
public final class a {
    ...
    private static final Class[] f19291f = {Context.class, AttributeSet.class};

    /* renamed from: g, reason: collision with root package name */
    private static final HashMap<String, Constructor> f19292g = new HashMap<>();

    /* renamed from: j, reason: collision with root package name */
    private static String f19293j = "com.mbridge.msdk.dycreator.baseview.MB";

    /* renamed from: a, reason: collision with root package name */
    protected final Context f19294a;

    /* renamed from: c, reason: collision with root package name */
    private InterfaceC0387a f19296c;

    /* renamed from: d, reason: collision with root package name */
    private b f19297d;

    /* renamed from: h, reason: collision with root package name */
    private HashMap<String, Boolean> f19299h;

    /* renamed from: i, reason: collision with root package name */
    private long f19300i;

    /* renamed from: b, reason: collision with root package name */
    private final boolean f19295b = true;

    /* renamed from: e, reason: collision with root package name */
    private final Object[] f19298e = new Object[2];
    ...
    */
    private void b(org.xmlpull.v1.XmlPullParser r6, android.view.View r7, android.util.AttributeSet r8) throws org.xmlpull.v1.XmlPullParserException, java.io.IOException {
        ...
        L1c:
            ...
            throw r7
        L38:
            android.content.Context r1 = r5.f19294a
    ...
    private View a(String str, String str2, AttributeSet attributeSet) throws ClassNotFoundException, InflateException {
        String str3;
        String str4;
        HashMap<String, Constructor> hashMap = f19292g;
        Constructor<?> constructor = hashMap.get(str);
        Class<?> cls = null;
        try {
            if (constructor == null) {
                ClassLoader classLoader = this.f19294a.getClassLoader();
                if (str2 != null) {
                    str4 = str2 + str;
                } else {
                    str4 = str;
                ...
                constructor = cls.getConstructor(f19291f);
                hashMap.put(str, constructor);
            } else if (this.f19297d != null) {
                Boolean bool = this.f19299h.get(str);
                if (bool == null) {
                    ClassLoader classLoader2 = this.f19294a.getClassLoader();
                    if (str2 != null) {
                        str3 = str2 + str;
                    } else {
                        str3 = str;
                    ...
                    boolean z8 = cls != null && this.f19297d.a(cls);
                    this.f19299h.put(str, Boolean.valueOf(z8));
                    if (!z8) {
                        b(str, str2, attributeSet);
                    }
    ...
    private View a(String str, AttributeSet attributeSet) {
        ...
        try {
            InterfaceC0387a interfaceC0387a = this.f19296c;
            View a9 = interfaceC0387a == null ? null : interfaceC0387a.a(str, this.f19294a, attributeSet);
            if (a9 == null) {
                if (-1 == str.indexOf(46)) {
                    if (!str.equals("MBStarLevelLayoutView") && !str.equals("LuckPan")) {
                        a8 = a(str, f19293j, attributeSet);
                        a9 = a8;
                    }
    ...
    public final View a(String str, ViewGroup viewGroup) {
        ...
        this.f19300i = System.currentTimeMillis();
