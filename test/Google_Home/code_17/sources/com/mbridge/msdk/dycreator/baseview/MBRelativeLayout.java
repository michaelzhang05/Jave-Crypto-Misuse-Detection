...
public class MBRelativeLayout extends RelativeLayout implements InterBase {
    ...
    private float f19418a;

    /* renamed from: b, reason: collision with root package name */
    private float f19419b;

    /* renamed from: c, reason: collision with root package name */
    private Map<String, String> f19420c;

    /* renamed from: d, reason: collision with root package name */
    private Map<String, Boolean> f19421d;
    ...
    public static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            try {
                f19423a[c.layout_height.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f19423a[c.layout_centerHorizontal.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f19423a[c.layout_alignParentBottom.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f19423a[c.layout_alignParentTop.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f19423a[c.layout_centerVertical.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f19423a[c.layout_below.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f19423a[c.layout_above.ordinal()] = 8;
            } catch (NoSuchFieldError unused8) {
            }
            try {
                f19423a[c.layout_toLeftOf.ordinal()] = 9;
            } catch (NoSuchFieldError unused9) {
            }
            try {
                f19423a[c.layout_toRightOf.ordinal()] = 10;
            } catch (NoSuchFieldError unused10) {
            }
            try {
                f19423a[c.layout_toEndOf.ordinal()] = 11;
            } catch (NoSuchFieldError unused11) {
            }
            try {
                f19423a[c.layout_margin.ordinal()] = 12;
            } catch (NoSuchFieldError unused12) {
            }
            try {
                f19423a[c.layout_marginLeft.ordinal()] = 13;
            } catch (NoSuchFieldError unused13) {
            }
            try {
                f19423a[c.layout_marginRight.ordinal()] = 14;
            } catch (NoSuchFieldError unused14) {
            }
            try {
                f19423a[c.layout_marginTop.ordinal()] = 15;
            } catch (NoSuchFieldError unused15) {
            }
            try {
                f19423a[c.layout_marginBottom.ordinal()] = 16;
            } catch (NoSuchFieldError unused16) {
            }
            try {
                f19423a[c.layout_alignParentRight.ordinal()] = 17;
            } catch (NoSuchFieldError unused17) {
            }
            try {
                f19423a[c.layout_alignParentLeft.ordinal()] = 18;
            } catch (NoSuchFieldError unused18) {
            }
            try {
                f19423a[c.layout_alignTop.ordinal()] = 19;
            } catch (NoSuchFieldError unused19) {
            }
            try {
                f19423a[c.layout_alignLeft.ordinal()] = 20;
            } catch (NoSuchFieldError unused20) {
            }
            try {
                f19423a[c.layout_alignRight.ordinal()] = 21;
            } catch (NoSuchFieldError unused21) {
            }
            try {
                f19423a[c.layout_alignBottom.ordinal()] = 22;
            } catch (NoSuchFieldError unused22) {
            }
            try {
                f19423a[c.layout_centerInParent.ordinal()] = 23;
            } catch (NoSuchFieldError unused23) {
            }
            try {
                f19423a[c.layout_alignParentEnd.ordinal()] = 24;
    ...
    public String getActionDes() {
        Map<String, String> map = this.f19420c;
        if (map != null && map.containsKey("mbridgeAction")) {
            return this.f19420c.get("mbridgeAction");
        }
        return "";
    }
    ...
    public String getBindDataDes() {
        ...
        if (map != null && map.containsKey("mbridgeData")) {
            return this.f19420c.get("mbridgeData");
        }
        return "";
    }
    ...
    public String getEffectDes() {
        ...
        if (map != null && map.containsKey("mbridgeEffect")) {
            return this.f19420c.get("mbridgeEffect");
        }
        return "";
    }
    ...
    public String getReportDes() {
        ...
        if (map != null && map.containsKey("mbridgeReport")) {
            return this.f19420c.get("mbridgeReport");
        }
        return "";
    }
    ...
    public String getStrategyDes() {
        ...
        if (map != null && map.containsKey("mbridgeStrategy")) {
            return this.f19420c.get("mbridgeStrategy");
        }
        return "";
    }
    ...
    public void onAttachedToWindow() {
        ...
        Map<String, Boolean> map = this.f19421d;
        if (map != null && map.containsKey("mbridgeAttached") && this.f19421d.get("mbridgeAttached").booleanValue()) {
            new m.a("mbridgeAttached").a().a(this.f19422e);
        }
    }
    ...
    protected void onDetachedFromWindow() {
        ...
        Map<String, Boolean> map = this.f19421d;
        if (map != null && map.containsKey("mbridgeDetached") && this.f19421d.get("mbridgeDetached").booleanValue()) {
            new m.a("mbridgeDetached").a().a(this.f19422e);
        }
    }

    @Override // android.view.ViewGroup
    public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        this.f19418a = motionEvent.getRawX();
        this.f19419b = motionEvent.getRawY();
    ...
    public void setDynamicReport(String str, CampaignEx campaignEx) {
        this.f19421d = com.mbridge.msdk.dycreator.e.c.a(str);
        if (campaignEx != null) {
            this.f19422e = campaignEx.getCampaignUnitId();
        }
    }
    ...
    public RelativeLayout.LayoutParams generateLayoutParams(AttributeSet attributeSet) {
        ...
        for (int i8 = 0; i8 < attributeCount; i8++) {
            ...
            if (cVar != null) {
                switch (AnonymousClass1.f19423a[cVar.ordinal()]) {
                    case 1:
    ...
    public MBRelativeLayout(Context context, AttributeSet attributeSet) {
        ...
        this.f19422e = "";
        try {
            this.f19420c = com.mbridge.msdk.dycreator.e.c.a(context, attributeSet);
            a.a(this, attributeSet);
            setLayoutParams(generateLayoutParams(attributeSet));
            com.mbridge.msdk.dycreator.e.c.a(this.f19420c, this);
        } catch (Exception e8) {
            ad.b("MBRelativeLayouts", e8.getMessage());
        }
    }
