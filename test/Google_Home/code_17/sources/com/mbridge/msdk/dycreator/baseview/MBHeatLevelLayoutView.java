...
public class MBHeatLevelLayoutView extends MBLinearLayout {
    ...
    public void setHeatCount(int i8) {
        try {
            removeAllViews();
            double a8 = c.a(i8, 10000.0d, 2);
            ...
            textView.setText(a8 + getResources().getString(getResources().getIdentifier("mbridge_reward_heat_count_unit", TypedValues.Custom.S_STRING, com.mbridge.msdk.foundation.controller.c.m().g())));
            addView(textView, layoutParams);
        } catch (Exception e8) {
            ad.b("MBHeatLevelLayoutView", e8.getMessage());
        }
    }
}
