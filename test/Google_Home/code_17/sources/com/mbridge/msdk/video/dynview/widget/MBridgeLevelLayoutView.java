...
public class MBridgeLevelLayoutView extends LinearLayout {
    ...
    private static int f23278d = 18;

    /* renamed from: a, reason: collision with root package name */
    private double f23279a;
    ...
    private void a() {
        ...
        if (this.f23281c) {
            LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(-2, dip2px(getContext(), f23278d));
        ...
        if (linearLayout2 != null) {
            LinearLayout.LayoutParams layoutParams2 = new LinearLayout.LayoutParams(-2, dip2px(getContext(), f23278d));
            ...
            textView2.setText(this.f23280b + " )");
            textView2.setEllipsize(TextUtils.TruncateAt.END);
            textView2.setLines(1);
            linearLayout2.addView(textView, layoutParams2);
            linearLayout2.addView(textView2, layoutParams2);
        }
        double d8 = this.f23279a;
        if (d8 == 0.0d) {
            d8 = 5.0d;
        }
        for (int i8 = 0; i8 < 5; i8++) {
            ImageView imageView = new ImageView(getContext());
            LinearLayout.LayoutParams layoutParams3 = new LinearLayout.LayoutParams(dip2px(getContext(), 15.0f), dip2px(getContext(), f23278d));
            if (i8 < d8) {
