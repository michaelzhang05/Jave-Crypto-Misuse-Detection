...
public abstract class MBridgeH5EndCardViewDiff extends MBridgeBaseView implements i, b, h {
    ...
    public void open(String str) {
        try {
            String clickURL = this.f23310b.getClickURL();
            if (!TextUtils.isEmpty(str)) {
                this.f23310b.setClickURL(str);
                reportOpen(str);
            }
            a aVar = new a(getContext(), this.unitId);
            aVar.a(this);
            aVar.a(this.f23310b);
            this.f23310b.setClickURL(clickURL);
            this.f23313e.a(126, "");
        } catch (Exception e8) {
    ...
    public void reportOpen(String str) {
        ...
        if (mraidCampaign != null) {
            new com.mbridge.msdk.foundation.same.report.i(getContext()).a(mraidCampaign.getRequestId(), mraidCampaign.getRequestIdNotice(), mraidCampaign.getId(), this.unitId, str, this.f23310b.isBidCampaign());
        }
    }
