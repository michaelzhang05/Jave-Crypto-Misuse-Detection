...
public class BannerUtils {
    ...
    public static String getCloseIds(String str) {
        ...
        try {
            Map<String, List<com.mbridge.msdk.foundation.same.d.a>> map = d.f20500a;
            ...
            try {
                ...
                if (!TextUtils.isEmpty(str)) {
                    ...
                    if (optJSONObject != null) {
                        str2 = String.valueOf(ai.a(c.m().c(), Integer.valueOf(optJSONObject.getString(com.mbridge.msdk.foundation.same.a.f20475h)).intValue()));
                        str3 = String.valueOf(ai.a(c.m().c(), Integer.valueOf(optJSONObject.getString(com.mbridge.msdk.foundation.same.a.f20476i)).intValue()));
                    } else {
                        str2 = "-999";
                        str3 = "-999";
                    }
