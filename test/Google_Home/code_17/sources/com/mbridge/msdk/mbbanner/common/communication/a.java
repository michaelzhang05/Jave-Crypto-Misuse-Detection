...
public final class a extends c {
    ...
    private WeakReference<Context> f21484b;

    /* renamed from: c, reason: collision with root package name */
    private List<CampaignEx> f21485c;
    ...
    private com.mbridge.msdk.mbbanner.common.b.a f21489g;

    /* renamed from: h, reason: collision with root package name */
    private BannerExpandDialog f21490h;

    /* renamed from: i, reason: collision with root package name */
    private boolean f21491i = false;

    public a(Context context, String str, String str2) {
        this.f21486d = str;
        this.f21487e = str2;
        this.f21484b = new WeakReference<>(context);
    }
    ...
    public final void b(Object obj, String str) {
        ...
        try {
            List<CampaignEx> list = this.f21485c;
            if (list == null) {
                return;
            }
            if (list != null && list.size() > 0) {
                campaignEx = this.f21485c.get(0);
            } else {
                campaignEx = null;
            }
            if (!TextUtils.isEmpty(str)) {
                ...
                com.mbridge.msdk.mbbanner.common.b.a aVar = this.f21489g;
                if (aVar != null) {
                    aVar.a(campaignEx);
                }
            }
    ...
    public final void expand(String str, boolean z8) {
        ...
        try {
            ...
            WeakReference<Context> weakReference = this.f21484b;
            if (weakReference != null && (context = weakReference.get()) != null) {
                BannerExpandDialog bannerExpandDialog = this.f21490h;
                if (bannerExpandDialog != null && bannerExpandDialog.isShowing()) {
                    return;
                }
                BannerExpandDialog bannerExpandDialog2 = new BannerExpandDialog(context, bundle, this.f21489g);
                this.f21490h = bannerExpandDialog2;
                bannerExpandDialog2.setCampaignList(this.f21487e, this.f21485c);
                this.f21490h.show();
            }
            com.mbridge.msdk.mbbanner.common.b.a aVar = this.f21489g;
            if (aVar != null) {
            ...
            com.mbridge.msdk.mbbanner.common.d.a.a(this.f21487e, getMraidCampaign(), str);
        } catch (Throwable th) {
        ...
        try {
            if (!TextUtils.isEmpty(str)) {
                ...
                for (int i8 = 0; i8 < jSONArray.length(); i8++) {
                    ...
                    for (CampaignEx campaignEx : this.f21485c) {
                        if (campaignEx.getId().equals(string)) {
                            com.mbridge.msdk.foundation.same.a.d.a(this.f21487e, campaignEx, "banner");
            ...
            try {
                ...
                for (int i8 = 0; i8 < jSONArray.length(); i8++) {
                    ...
                    if (optInt2 == 0) {
                        ...
                        List<CampaignEx> list2 = this.f21485c;
                        if (list2 != null) {
    ...
    public final void a(Object obj, String str) {
        ...
        try {
            ...
            jSONObject2.put("dev_close_state", this.f21488f);
            jSONObject.put("sdkSetting", jSONObject2);
            jSONObject.put("device", iVar.a());
            jSONObject.put("campaignList", CampaignEx.parseCamplistToJson(this.f21485c));
            com.mbridge.msdk.c.k d8 = com.mbridge.msdk.c.h.a().d(com.mbridge.msdk.foundation.controller.c.m().k(), this.f21487e);
            if (d8 == null) {
                d8 = com.mbridge.msdk.c.k.d(this.f21487e);
            }
            if (!TextUtils.isEmpty(this.f21486d)) {
                d8.a(this.f21486d);
            }
            ...
            jSONObject.put("sdk_info", com.mbridge.msdk.mbsignalcommon.base.d.f21536a);
