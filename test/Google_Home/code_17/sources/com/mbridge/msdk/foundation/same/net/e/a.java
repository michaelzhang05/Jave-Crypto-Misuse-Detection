...
public class a extends i<Void> {
    ...
    private static final String f20684c = "a";

    /* renamed from: d, reason: collision with root package name */
    private File f20685d;

    /* renamed from: e, reason: collision with root package name */
    private File f20686e;

    public a(File file, String str) {
        super(0, str);
        this.f20685d = file;
        this.f20686e = new File(file + ".tmp");
    }
    ...
    */
    public final byte[] a(com.mbridge.msdk.foundation.same.net.f.b r17, com.mbridge.msdk.foundation.same.net.c r18) throws java.io.IOException {
        ...
        L21:
            ...
            if (r0 > 0) goto L2c
            java.lang.String r1 = com.mbridge.msdk.foundation.same.net.e.a.f20684c
            java.lang.String r4 = "Response doesn't present Content-Length!"
            com.mbridge.msdk.foundation.tools.ad.c(r1, r4)
        L2c:
            r11 = 0
            if (r0 <= 0) goto L4a
            java.io.File r0 = r7.f20685d
            long r0 = r0.length()
            int r4 = (r0 > r9 ? 1 : (r0 == r9 ? 0 : -1))
            if (r4 != 0) goto L4a
            java.io.File r0 = r7.f20685d
            java.io.File r1 = r7.f20686e
            r0.renameTo(r1)
            r1 = r18
            r2 = r16
            r3 = r9
        ...
        La5:
            ...
            goto Lae
        La9:
            java.lang.String r0 = com.mbridge.msdk.foundation.same.net.e.a.f20684c
    ...
    public final k<Void> a(com.mbridge.msdk.foundation.same.net.f.c cVar) {
        if (!q()) {
            if (this.f20686e.canRead() && this.f20686e.length() > 0) {
                if (this.f20686e.renameTo(this.f20685d)) {
                    return k.a(null, cVar);
                }
                ad.c(f20684c, "Can't rename the download temporary file!");
                return k.a(new com.mbridge.msdk.foundation.same.net.b.a(4, cVar));
            }
            ad.c(f20684c, "Download temporary file was invalid!");
            return k.a(new com.mbridge.msdk.foundation.same.net.b.a(4, cVar));
        }
