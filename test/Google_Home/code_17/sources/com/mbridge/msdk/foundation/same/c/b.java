...
public final class b {
    ...
    private static b f20541a;

    /* renamed from: c, reason: collision with root package name */
    private com.mbridge.msdk.foundation.same.a.c<String, Bitmap> f20543c;

    /* renamed from: e, reason: collision with root package name */
    private com.mbridge.msdk.foundation.same.e.b f20545e;

    /* renamed from: b, reason: collision with root package name */
    private LinkedHashMap<String, List<c>> f20542b = new LinkedHashMap<>();

    /* renamed from: d, reason: collision with root package name */
    private Handler f20544d = new Handler(Looper.getMainLooper()) { // from class: com.mbridge.msdk.foundation.same.c.b.1
        ...
        public final void handleMessage(Message message) {
            try {
                ...
                if (i8 == 1) {
                    ...
                    b.this.a(string, a8);
                    LinkedList linkedList = (LinkedList) b.this.f20542b.get(string);
                    if (linkedList != null) {
    ...
    private b(Context context) {
        int i8;
        this.f20545e = new com.mbridge.msdk.foundation.same.e.b(context);
        ...
        this.f20543c = new com.mbridge.msdk.foundation.same.a.a(((int) Runtime.getRuntime().maxMemory()) / (i8 > 0 ? i8 : 10));
    }

    private Bitmap d(String str) {
        return this.f20543c.b(str);
    }
    ...
    public final void a(String str, Bitmap bitmap) {
        ...
        this.f20543c.a(str, bitmap);
    }

    private void a(String str, String str2, String str3, boolean z8, boolean z9, c cVar) {
        if (!this.f20542b.containsKey(str2)) {
            LinkedList linkedList = new LinkedList();
            linkedList.add(cVar);
            this.f20542b.put(str2, linkedList);
            e.a aVar = new e.a() { // from class: com.mbridge.msdk.foundation.same.c.b.6
                ...
                public final void a(String str4, String str5) {
                    Message obtainMessage = b.this.f20544d.obtainMessage();
                    obtainMessage.what = 1;
                    Bundle bundle = new Bundle();
                    bundle.putString("message_key", str4);
                    bundle.putString("message_bitmap", str5);
                    obtainMessage.setData(bundle);
                    b.this.f20544d.sendMessage(obtainMessage);
                }
        ...
        LinkedList linkedList2 = (LinkedList) this.f20542b.get(str2);
    ...
    public final void c() {
        ...
        this.f20543c.b();
        LinkedHashMap<String, List<c>> linkedHashMap = this.f20542b;
    ...
    public final void a(String str) {
        ...
        try {
            com.mbridge.msdk.foundation.same.a.c<String, Bitmap> cVar = this.f20543c;
    ...
    static /* synthetic */ void a(b bVar, final String str, final Bitmap bitmap, final c cVar) {
        ...
        bVar.f20544d.post(new Runnable() { // from class: com.mbridge.msdk.foundation.same.c.b.3
            @Override // java.lang.Runnable
            public final void run() {
                c cVar2 = cVar;
                if (cVar2 != null) {
                    ...
                    try {
                        LinkedList linkedList = (LinkedList) b.this.f20542b.get(str);
                        if (linkedList != null) {
    ...
    static /* synthetic */ void a(b bVar, final String str, final String str2, final c cVar) {
        ...
        bVar.f20544d.post(new Runnable() { // from class: com.mbridge.msdk.foundation.same.c.b.4
            @Override // java.lang.Runnable
            public final void run() {
                c cVar2 = cVar;
                if (cVar2 != null) {
    ...
    static /* synthetic */ void a(b bVar, final String str, String str2, String str3, boolean z8, boolean z9, final c cVar, final h hVar) {
        if (!bVar.f20542b.containsKey(str2)) {
            LinkedList linkedList = new LinkedList();
            linkedList.add(cVar);
            bVar.f20542b.put(str2, linkedList);
        ...
        LinkedList linkedList2 = (LinkedList) bVar.f20542b.get(str2);
        if (linkedList2 == null || linkedList2.contains(cVar)) {
            return;
        }
        linkedList2.add(cVar);
