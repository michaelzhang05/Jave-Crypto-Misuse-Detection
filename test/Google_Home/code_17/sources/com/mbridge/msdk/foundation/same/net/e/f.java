...
public class f extends i<String> {
    ...
    private static final String f20702c = "f";
    ...
    public final k<String> a(com.mbridge.msdk.foundation.same.net.f.c cVar) {
        try {
            return k.a(new String(cVar.f20710a, com.mbridge.msdk.foundation.same.net.g.b.a(cVar.f20711b)), cVar);
        } catch (UnsupportedEncodingException e8) {
            ad.b(f20702c, e8.getMessage());
    ...
    public final byte[] h() {
        try {
            ...
            ad.b(f20702c, "Unsupported Encoding while trying to get the bytes of " + this.f20703d + " using utf-8");
            return null;
        }
    }
}
