...
public final class a {
    ...
    private static final SparseArray<String> f20089a;
    ...
    public static String a(int i8, String str) {
        return i8 + "#" + f20089a.get(i8) + "#" + str;
    }

    public static b a(int i8, int i9, String str) {
        return new b(i8, i9, str);
    }
}
