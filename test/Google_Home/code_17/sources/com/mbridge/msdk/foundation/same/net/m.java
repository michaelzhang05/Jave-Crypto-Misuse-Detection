...
public final class m {
    ...
    private static volatile AtomicInteger f20817a = new AtomicInteger(1);

    /* renamed from: b, reason: collision with root package name */
    private ExecutorService f20818b;
    ...
    public static final class b {
        ...
        /* renamed from: a, reason: collision with root package name */
        private static m f20831a = new m();
    }
    ...
    private m() {
        this.f20818b = new ThreadPoolExecutor(5, 10, 5L, TimeUnit.MILLISECONDS, new LinkedBlockingQueue(), new ThreadFactory() { // from class: com.mbridge.msdk.foundation.same.net.m.1
    ...
    public final void a(String str, int i8, String str2, boolean z8, e eVar) {
        ...
        this.f20818b.execute(new Runnable() { // from class: com.mbridge.msdk.foundation.same.net.m.2
    ...
    public class a {
        ...
        private OutputStream f20827f;

        /* renamed from: g, reason: collision with root package name */
        private int f20828g;

        /* renamed from: h, reason: collision with root package name */
        private Socket f20829h;
        ...
        */
        ...
        private void a(String str) {
            if (this.f20826e != null) {
                ...
                this.f20826e.onError(new com.mbridge.msdk.foundation.same.net.b.a(13, new com.mbridge.msdk.foundation.same.net.f.c(MBridgeCommon.CampaignState.STATE_LOAD_FAILED_RESOURCE_DOWNLOAD_ERROR, str.getBytes(), null)));
            }
        }
    }
}
