...
public final class MIMManager {
    ...
    /* renamed from: a */
    private static volatile String f20994a;

    /* renamed from: b */
    private final AtomicBoolean f20995b;

    /* renamed from: c */
    private int f20996c;

    /* renamed from: d */
    private CopyOnWriteArrayList<CampaignEx> f20997d;

    /* renamed from: e */
    private Context f20998e;

    /* renamed from: f */
    private volatile Boolean f20999f;

    /* renamed from: g */
    private CampaignEx f21000g;

    /* renamed from: h */
    private volatile b f21001h;

    /* renamed from: i */
    private volatile MiOverseaMiniCardBroadcasterReceiver f21002i;
    ...
    public final class AnonymousClass1 implements Runnable {
        ...
        /* renamed from: a */
        final /* synthetic */ Context f21003a;
        ...
        public final void run() {
            if (MIMManager.this.f20995b.compareAndSet(false, true)) {
                try {
                    MIMManager mIMManager = MIMManager.this;
                    mIMManager.f20999f = mIMManager.g();
                } catch (Exception e8) {
                    ad.a("MIMManager", e8.getMessage());
                }
                if (MIMManager.this.f20999f != null && MIMManager.this.f20999f.booleanValue() && r2 != null) {
                    try {
                        MIMManager.this.f21001h = new b();
                        ...
                        r2.registerReceiver(MIMManager.this.f21001h, intentFilter);
                    } catch (Exception e9) {
    ...
    final class AnonymousClass2 implements Runnable {
        ...
        /* renamed from: b */
        final /* synthetic */ CampaignEx f21006b;
    ...
    final class AnonymousClass3 implements Runnable {
        ...
        /* renamed from: b */
        final /* synthetic */ CampaignEx f21009b;
    ...
    final class AnonymousClass4 implements Runnable {
        ...
        /* renamed from: b */
        final /* synthetic */ CampaignEx f21012b;
        ...
        public final void run() {
            ...
            try {
                try {
                    ...
                    if (MIMManager.this.f20997d == null || !MIMManager.this.f20997d.contains(r3)) {
                        return;
                    }
                } catch (Exception e9) {
                    ad.b("MIMManager", e9.getMessage());
                ...
                MIMManager.this.f20997d.remove(r3);
            } catch (Throwable th) {
                if (MIMManager.this.f20997d != null && MIMManager.this.f20997d.contains(r3)) {
                    MIMManager.this.f20997d.remove(r3);
                }
    ...
    final class AnonymousClass5 implements Runnable {
        ...
        /* renamed from: c */
        final /* synthetic */ CampaignEx f21016c;
            ...
            try {
                if (r2 != null && !TextUtils.isEmpty(r3) && r4 != null) {
                    ...
                    if (!TextUtils.isEmpty(r4.getCampaignUnitId())) {
                        ...
                        stringBuffer.append("&");
                        String str = com.mbridge.msdk.foundation.controller.a.f20108b.get(r4.getCampaignUnitId());
                    ...
                    try {
                        new com.mbridge.msdk.foundation.same.report.e.a(r2).post(0, com.mbridge.msdk.foundation.same.net.g.d.f().f20751c, com.mbridge.msdk.foundation.same.report.k.a(stringBuffer.toString(), r2), null);
                    } catch (Exception e8) {
                        e8.printStackTrace();
                        ad.b("MIMManager", e8.getMessage());
                    }
            ...
            if (x.a("DFKwWgtuDkKwLZPwD+z8H+N/xjK+n3eyNVx6ZVPn5jcincKZx5f5ncN=").equals(intent.getAction())) {
                ...
                if (intExtra == 1 || intExtra == 2 || intExtra == 3 || intExtra == 4 || intExtra == 7) {
                    try {
                        ...
                        CampaignEx a8 = a.f21019a.a(stringExtra);
                        if (a8 != null) {
                            ...
                            dVar.a("u_stid", com.mbridge.msdk.foundation.controller.a.f20108b.get(a8.getCampaignUnitId()));
                            bVar.a(a8);
                        }
    ...
    public static final class a {
        ...
        /* renamed from: a */
        private static final MIMManager f21019a = new MIMManager();
    }
                ...
                if (c8.getContentResolver() != null) {
                    ...
                    if (cursor != null) {
                        while (cursor.moveToNext()) {
                            ...
                            try {
                                f20994a = cursor.getString(cursor.getColumnIndex("detailStyle"));
                            } catch (Exception e9) {
                                ad.a("MIMManager", e9.getMessage());
                            }
                        }
    ...
    public final void f() {
        int i8 = this.f20996c - 1;
        this.f20996c = i8;
        if (i8 <= 0) {
            Context context = this.f20998e;
            if (context != null) {
                try {
                    try {
                        if (this.f21001h != null) {
                            context.unregisterReceiver(this.f21001h);
                        }
                        if (this.f21002i != null) {
                            context.unregisterReceiver(this.f21002i);
                        }
                    } catch (Exception e8) {
                        ad.a("MIMManager", e8.getMessage());
                    }
            ...
            try {
                try {
                    if (this.f21002i != null) {
                        Context c8 = com.mbridge.msdk.foundation.controller.c.m().c();
                        if (c8 != null) {
                            c8.unregisterReceiver(this.f21002i);
                        }
                        this.f21000g = null;
                        this.f20997d.clear();
                        this.f20997d = null;
    ...
    private MIMManager() {
        this.f20996c = 0;
        this.f20997d = new CopyOnWriteArrayList<>();
        this.f20995b = new AtomicBoolean(false);
    }
    ...
    public final String c() {
        try {
            return f20994a == null ? "" : String.format("[%s]", f20994a);
        } catch (Exception unused) {
            return "";
        }
    }
    ...
    public final void b(CampaignEx campaignEx) {
        try {
            if (this.f20999f == null || campaignEx == null || !this.f20999f.booleanValue()) {
                return;
            }
            this.f21000g = null;
            try {
                this.f20997d.remove(campaignEx);
            } catch (Exception e8) {
                ad.a("MIMManager", e8.getMessage());
            }
        } catch (Exception e9) {
    ...
    public CampaignEx a(String str) {
        try {
            CampaignEx campaignEx = this.f21000g;
            if (campaignEx != null && TextUtils.equals(campaignEx.getPackageName(), str)) {
                return this.f21000g;
            }
            CopyOnWriteArrayList<CampaignEx> copyOnWriteArrayList = this.f20997d;
            if (copyOnWriteArrayList == null || copyOnWriteArrayList.size() <= 0) {
                return null;
            }
            Iterator<CampaignEx> it = this.f20997d.iterator();
            while (it.hasNext()) {
