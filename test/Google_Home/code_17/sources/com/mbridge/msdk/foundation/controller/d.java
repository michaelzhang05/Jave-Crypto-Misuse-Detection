...
public class d {
    ...
    private static volatile d f20144e;

    /* renamed from: f, reason: collision with root package name */
    private int f20149f;

    /* renamed from: g, reason: collision with root package name */
    private Map<String, Object> f20150g;

    /* renamed from: h, reason: collision with root package name */
    private FastKV f20151h;
    ...
    private Context f20156m;

    /* renamed from: n, reason: collision with root package name */
    private String f20157n;

    /* renamed from: o, reason: collision with root package name */
    private com.mbridge.msdk.b.a f20158o;

    /* renamed from: p, reason: collision with root package name */
    private String f20159p;

    /* renamed from: a, reason: collision with root package name */
    public final int f20145a = 4;

    /* renamed from: b, reason: collision with root package name */
    public final int f20146b = 5;

    /* renamed from: c, reason: collision with root package name */
    public final int f20147c = 2;

    /* renamed from: i, reason: collision with root package name */
    private boolean f20152i = false;

    /* renamed from: d, reason: collision with root package name */
    Handler f20148d = new Handler(Looper.getMainLooper()) { // from class: com.mbridge.msdk.foundation.controller.d.6
                ...
                if (i8 != 2) {
                    if (i8 != 7) {
                        if (i8 != 9) {
                                ...
                                if (i8 == 5) {
                                    ...
                                    if (!TextUtils.isEmpty(str)) {
                                        if (com.mbridge.msdk.foundation.same.report.e.a().b()) {
                                            ...
                                            new i(d.this.f20156m, 0).a("load_duration", str, null, null);
                                            return;
                                        }
                                    }
                                    return;
                            ...
                            if (!TextUtils.isEmpty(str2)) {
                                if (com.mbridge.msdk.foundation.same.report.e.a().b()) {
                                    ...
                                    new i(d.this.f20156m, 0).a("click_duration", str2, null, null);
                                    return;
                                }
                            }
                            return;
                        ...
                        if (d8 != null && d8.b() && gVar != null && gVar.J() == 1) {
                            com.mbridge.msdk.foundation.same.report.b.d.a(d.this.f20156m).b();
                        }
                        if (d8 != null && d8.a()) {
        ...
        if (context != null) {
            ...
            if (map != null) {
                if (map.containsKey(MBridgeConstans.ID_MBRIDGE_APPID)) {
                    this.f20153j = (String) map.get(MBridgeConstans.ID_MBRIDGE_APPID);
                }
                if (map.containsKey(MBridgeConstans.ID_MBRIDGE_APPKEY)) {
                    this.f20154k = (String) map.get(MBridgeConstans.ID_MBRIDGE_APPKEY);
                }
                if (map.containsKey(MBridgeConstans.ID_MBRIDGE_WX_APPID)) {
                    this.f20159p = (String) map.get(MBridgeConstans.ID_MBRIDGE_WX_APPID);
                }
                if (map.containsKey(MBridgeConstans.PACKAGE_NAME_MANIFEST)) {
                    this.f20155l = (String) map.get(MBridgeConstans.PACKAGE_NAME_MANIFEST);
                }
                if (map.containsKey(MBridgeConstans.ID_MBRIDGE_STARTUPCRASH)) {
                    this.f20157n = (String) map.get(MBridgeConstans.ID_MBRIDGE_STARTUPCRASH);
                }
            }
            this.f20156m = context.getApplicationContext();
            c.m().b(this.f20156m);
            c.m().d(this.f20153j);
            c.m().e(this.f20154k);
            c.m().a(this.f20159p);
            c.m().c(this.f20155l);
            c.m().a(new a.InterfaceC0392a() { // from class: com.mbridge.msdk.foundation.controller.d.4
            }, this.f20148d);
            try {
            ...
            ag.a(this.f20156m);
            Context applicationContext = this.f20156m.getApplicationContext();
            try {
                if (this.f20151h == null) {
                    try {
                        this.f20151h = new FastKV.Builder(com.mbridge.msdk.foundation.same.b.e.a(com.mbridge.msdk.foundation.same.b.c.MBRIDGE_700_CONFIG), x.a("H+tU+FeXHM==")).build();
                    } catch (Exception unused) {
                        this.f20151h = null;
                    }
                }
                FastKV fastKV = this.f20151h;
                String str3 = "";
                if (fastKV != null) {
                    String string = fastKV.getString(x.a("H+tU+bfPhM=="), "");
                    String string2 = this.f20151h.getString(x.a("H+tU+Fz8"), "");
                    if (TextUtils.isEmpty(com.mbridge.msdk.foundation.same.a.f20465U) && TextUtils.isEmpty(com.mbridge.msdk.foundation.same.a.f20474g)) {
                    ...
                    if (TextUtils.isEmpty(string) && TextUtils.isEmpty(string2)) {
                        if (!TextUtils.isEmpty(com.mbridge.msdk.foundation.same.a.f20465U) || !TextUtils.isEmpty(com.mbridge.msdk.foundation.same.a.f20474g)) {
                            this.f20151h.putString(x.a("H+tU+bfPhM=="), com.mbridge.msdk.foundation.same.a.f20465U);
                            this.f20151h.putString(x.a("H+tU+Fz8"), com.mbridge.msdk.foundation.same.a.f20474g);
                        }
                    } else {
                        com.mbridge.msdk.foundation.same.a.f20465U = string;
                        com.mbridge.msdk.foundation.same.a.f20474g = string2;
                        com.mbridge.msdk.foundation.a.a.a.a().a(DownloadCommon.DOWNLOAD_REPORT_FIND_FILE_RESULT_VALUE_B, com.mbridge.msdk.foundation.same.a.f20465U);
                    ...
                    if (TextUtils.isEmpty(str3) && TextUtils.isEmpty(str)) {
                        if ((!TextUtils.isEmpty(com.mbridge.msdk.foundation.same.a.f20465U) || !TextUtils.isEmpty(com.mbridge.msdk.foundation.same.a.f20474g)) && sharedPreferences != null) {
                            SharedPreferences.Editor edit = sharedPreferences.edit();
                            edit.putString(x.a("H+tU+bfPhM=="), com.mbridge.msdk.foundation.same.a.f20465U);
                            edit.putString(x.a("H+tU+Fz8"), com.mbridge.msdk.foundation.same.a.f20474g);
                            edit.apply();
                        }
                    } else {
                        com.mbridge.msdk.foundation.same.a.f20465U = str3;
                        com.mbridge.msdk.foundation.same.a.f20474g = str;
                        com.mbridge.msdk.foundation.a.a.a.a().a(DownloadCommon.DOWNLOAD_REPORT_FIND_FILE_RESULT_VALUE_B, com.mbridge.msdk.foundation.same.a.f20465U);
                        com.mbridge.msdk.foundation.a.a.a.a().a("c", com.mbridge.msdk.foundation.same.a.f20474g);
                    }
                }
            ...
            try {
                ...
                com.mbridge.msdk.foundation.same.f.b.b().execute(new Runnable() { // from class: com.mbridge.msdk.foundation.controller.d.3
                    ...
                    public final void run() {
                        d dVar = d.this;
                        d.a(dVar, dVar.f20153j);
                        if (!TextUtils.isEmpty(d.this.f20153j)) {
                            com.mbridge.msdk.foundation.a.a.a.a().a(MBridgeConstans.SDK_APP_ID, d.this.f20153j);
                        }
                        new i(d.this.f20156m).a();
                        d.this.b();
                    }
                });
                k.c();
            ...
            this.f20152i = true;
            z.f(context);
            long az = h.a().a(this.f20153j).az();
            if (az != 1300) {
                this.f20148d.postDelayed(new Runnable() { // from class: com.mbridge.msdk.foundation.controller.d.1
                    @Override // java.lang.Runnable
                    public final void run() {
                        z.d(context);
                    }
    ...
    static /* synthetic */ void b(d dVar) {
        ...
        try {
            ...
            for (com.mbridge.msdk.foundation.entity.a aVar : k8) {
                if (aVar.a() == 287) {
                    if (dVar.f20156m != null && (newInstance = MBInterstitialVideoHandler.class.getConstructor(String.class, String.class).newInstance("", aVar.b())) != null) {
    ...
    public final void a(Map<String, Object> map, int i8) {
        ...
        if (map != null) {
            if (this.f20158o == null) {
                this.f20158o = new com.mbridge.msdk.b.a();
            }
            try {
                Map<String, Object> map2 = this.f20150g;
                if (map2 != null && map2.size() > 0 && this.f20150g.containsKey(MBridgeConstans.PROPERTIES_LAYOUT_TYPE)) {
                    int intValue = ((Integer) this.f20150g.get(MBridgeConstans.PROPERTIES_LAYOUT_TYPE)).intValue();
                    if (intValue == 0) {
                        Map<String, Object> map3 = this.f20150g;
                        int i9 = this.f20149f;
                        try {
        ...
        if (a8 != null) {
            ...
            if (b8 != null) {
                ...
                if (!TextUtils.isEmpty(b8.y())) {
                    com.mbridge.msdk.foundation.same.net.g.d.f().f20756h = b8.y();
                    com.mbridge.msdk.foundation.same.net.g.d.f().b();
                }
                if (!TextUtils.isEmpty(b8.z())) {
                    com.mbridge.msdk.foundation.same.net.g.d.f().f20760l = b8.z();
                    com.mbridge.msdk.foundation.same.net.g.d.f().c();
                }
            } else {
                MBridgeConstans.OMID_JS_SERVICE_URL = com.mbridge.msdk.c.a.b.f18937b;
                MBridgeConstans.OMID_JS_H5_URL = com.mbridge.msdk.c.a.b.f18936a;
            }
        }
            ...
            if (com.mbridge.msdk.foundation.a.a.a.a().a("is_first_init", 0) == 0) {
                try {
                    ...
                    if (TextUtils.isEmpty(com.mbridge.msdk.foundation.tools.e.c())) {
                        dVar.f20148d.postDelayed(new Runnable() { // from class: com.mbridge.msdk.foundation.controller.d.5
                            @Override // java.lang.Runnable
                            public final void run() {
                                new j().a(d.this.f20156m, str, d.this.f20154k);
                            }
                        }, 350L);
                    } else {
                        new j().a(dVar.f20156m, str, dVar.f20154k);
                    }
                    return;
