...
public final class MBDownloadManager {
    ...
    public final synchronized void updateZipResource(String str, String str2, long j8) {
        GlobalComponent.getInstance().getDatabaseHelper().updateUnzipResource(str, str2, j8);
    }
