...
public final class ai extends m {
    ...
    private static int f21059b = 1;

    /* renamed from: c, reason: collision with root package name */
    private static int f21060c = 2;

    /* renamed from: d, reason: collision with root package name */
    private static int f21061d = 3;

    /* renamed from: e, reason: collision with root package name */
    private static int f21062e = 0;

    /* renamed from: f, reason: collision with root package name */
    private static int f21063f = 7;

    /* renamed from: g, reason: collision with root package name */
    private static int f21064g = 14;

    /* renamed from: h, reason: collision with root package name */
    private static int f21065h = 19;

    /* renamed from: i, reason: collision with root package name */
    private static int f21066i = 16;

    /* renamed from: j, reason: collision with root package name */
    private static int f21067j = 26;

    /* renamed from: k, reason: collision with root package name */
    private static char[] f21068k = {'.', 'X'};

    /* renamed from: l, reason: collision with root package name */
    private static char[] f21069l = {'A', 'p', 'p', 'l', 'i', 'c', 'a', 't', 'i', 'o', 'n', 'I', 'n', 'f', 'o'};

    /* renamed from: m, reason: collision with root package name */
    private static int f21070m = 1;

    /* renamed from: n, reason: collision with root package name */
    private static boolean f21071n = true;

    /* renamed from: o, reason: collision with root package name */
    private static volatile Boolean f21072o = null;

    /* renamed from: p, reason: collision with root package name */
    private static String f21073p = "[一-龥]";

    /* renamed from: q, reason: collision with root package name */
    private static Pattern f21074q = Pattern.compile("[一-龥]");

    /* renamed from: r, reason: collision with root package name */
    private static Map<String, String> f21075r;

    /* renamed from: s, reason: collision with root package name */
    private static Map<String, String> f21076s;
    ...
    public static synchronized String d(String str) {
        synchronized (ai.class) {
            ...
            Map<String, String> map = f21076s;
            if (map == null || !map.containsKey(str2)) {
                return null;
            }
            return f21076s.get(str2);
        }
    }
    ...
    public static final synchronized String e(String str) {
        ...
        synchronized (ai.class) {
            try {
                ...
                if (z9 && i9 != 0) {
                    if (z8 && (map = f21075r) != null && map.containsKey(str2)) {
                        return f21075r.get(str2);
                    }
                    ...
                    if (stackTrace != null && stackTrace.length > 0) {
                        ...
                        if (jSONObject != null && jSONObject.length() > 0) {
                            String a9 = C2595a.a(jSONObject.toString());
    ...
    */
    ...
    private static final char[] c(int i8) {
        ...
        if (i8 == 0) {
            ...
            sb.append(String.valueOf(Arrays.copyOf(ah.f21055a, f21063f)));
            sb.append(f21068k[f21062e]);
            sb.append(String.valueOf(Arrays.copyOfRange(ah.f21055a, f21063f, f21064g)));
            sb.append(f21068k[f21062e]);
            sb.append(String.valueOf(Arrays.copyOfRange(ah.f21055a, f21064g, f21066i)));
            sb.append(f21068k[f21062e]);
            sb.append(String.valueOf(ag.f21047a));
        } else if (i8 == 1) {
            sb = new StringBuilder();
            sb.append(String.valueOf(Arrays.copyOf(ah.f21055a, f21063f)));
            sb.append(f21068k[f21062e]);
            sb.append(String.valueOf(Arrays.copyOfRange(ah.f21055a, f21063f, f21064g)));
            sb.append(f21068k[f21062e]);
            sb.append(String.valueOf(Arrays.copyOfRange(ah.f21055a, f21065h, f21067j)));
        } else if (i8 == 2) {
            sb = new StringBuilder();
            sb.append(String.valueOf(Arrays.copyOfRange(ah.f21055a, f21066i, f21065h)));
            sb.append(String.valueOf(f21069l));
        } else if (i8 != 3) {
            sb = null;
        } else {
            sb = new StringBuilder();
    ...
    public static String a(CampaignEx campaignEx) {
        ...
        return TextUtils.isEmpty(str) ? com.mbridge.msdk.foundation.same.net.g.d.f().f20754f : str;
    }

    private static Object b(String str, Context context) {
        try {
            return Class.forName(String.valueOf(c(f21058a))).getMethod(String.valueOf(c(f21060c)), String.class, Integer.TYPE).invoke(Class.forName(String.valueOf(c(f21059b))).getMethod(String.valueOf(c(f21061d)), null).invoke(context, null), str, 8192);
    ...
    public static synchronized void b(String str, String str2) {
        synchronized (ai.class) {
            try {
                ...
                f21076s.put(com.mbridge.msdk.foundation.controller.c.m().k() + "_" + str, str2);
            } catch (Throwable th) {
                throw th;
            }
        }
    ...
    */
    ...
    public static final int a() {
        if (f21072o == null) {
            try {
                f21072o = MIMManager.a.a().d();
            } catch (Exception e8) {
                ad.b("SameTools", e8.getMessage());
            }
        }
        if (f21072o != null) {
            return f21072o.booleanValue() ? 1 : 0;
        }
        return -1;
    }
