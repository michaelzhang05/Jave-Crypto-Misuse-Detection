...
public final class b {
    ...
    public static int f20217a = -2;

    /* renamed from: b, reason: collision with root package name */
    public static int f20218b = -2;

    /* renamed from: c, reason: collision with root package name */
    public static volatile boolean f20219c = false;

    /* renamed from: d, reason: collision with root package name */
    private final RelativeLayout.LayoutParams f20220d;

    /* renamed from: e, reason: collision with root package name */
    private final ConcurrentHashMap<String, com.mbridge.msdk.foundation.d.a.a> f20221e;
    ...
    public static class a {
        ...
        /* renamed from: a, reason: collision with root package name */
        private static final b f20223a = new b();
    }
    ...
    private com.mbridge.msdk.foundation.d.a.a d(String str) {
        ...
        if (this.f20221e.containsKey(str)) {
            return this.f20221e.get(str);
        }
        return null;
    }
    ...
    private b() {
        this.f20220d = new RelativeLayout.LayoutParams(f20218b, f20217a);
        this.f20221e = new ConcurrentHashMap<>();
    }
    ...
    public final void a(String str, Context context, ViewGroup viewGroup, ViewGroup.LayoutParams layoutParams, com.mbridge.msdk.foundation.d.a aVar) {
        if (b()) {
            ...
            if (aVar != null) {
                a8.a(new a.C0393a(str, aVar));
            }
            FeedBackButton d8 = a8.d();
            if (d8 != null) {
                if (layoutParams == null) {
                    int a9 = ai.a(c.m().c(), 10.0f);
                    this.f20220d.setMargins(a9, a9, a9, a9);
                    layoutParams = this.f20220d;
                }
