...
public final class f {
    public static void a(e eVar) {
        eVar.a("api_version", com.mbridge.msdk.foundation.same.a.f20471d);
    }
    ...
    public static void b(e eVar) {
        try {
            ...
            if (!TextUtils.isEmpty(com.mbridge.msdk.foundation.same.a.f20465U)) {
                eVar.a(DownloadCommon.DOWNLOAD_REPORT_FIND_FILE_RESULT_VALUE_B, com.mbridge.msdk.foundation.same.a.f20465U);
            }
            ...
            if (!TextUtils.isEmpty(com.mbridge.msdk.foundation.same.a.f20474g)) {
                eVar.a("c", com.mbridge.msdk.foundation.same.a.f20474g);
            }
        } catch (Exception e8) {
    ...
    public static void c(e eVar) {
        eVar.a("dyview_type", com.mbridge.msdk.foundation.same.a.f20490w);
    }
    ...
    private static void i(e eVar) {
        String str = com.mbridge.msdk.f.c.f20048a;
    ...
    public static void a(e eVar, Context context) {
        if (com.mbridge.msdk.foundation.controller.authoritycontroller.c.j().c(MBridgeConstans.AUTHORITY_GENERAL_DATA)) {
            ...
            eVar.a(e.f20783c, com.mbridge.msdk.foundation.controller.authoritycontroller.c.j().f() + "");
            eVar.a("adid_limit", com.mbridge.msdk.foundation.tools.e.a() + "");
        ...
        if (com.mbridge.msdk.foundation.controller.authoritycontroller.c.j().c(MBridgeConstans.AUTHORITY_OTHER)) {
            eVar.a(e.f20781a, ag.b() + "");
            eVar.a(e.f20782b, ag.a() + "");
            eVar.a(e.f20787g, z.n());
        }
