...
public class f extends a<Campaign> {
    ...
    private static final String f20236a = "com.mbridge.msdk.foundation.db.f";

    /* renamed from: b, reason: collision with root package name */
    private static f f20237b;
    ...
    private f(g gVar) {
        ...
        this.f20239d = "lrid";
        this.f20240e = "cid";
        this.f20241f = CampaignEx.JSON_KEY_PLCT;
        this.f20242g = CampaignEx.JSON_KEY_PLCTB;
        this.f20243h = CampaignEx.JSON_KEY_TIMESTAMP;
        this.f20244i = "ridCount";
        this.f20245j = " WHERE ";
        this.f20246k = " AND ";
        this.f20247l = "SELECT ";
        this.f20248m = "*";
        this.f20249n = " FROM ";
        this.f20250o = " AND readyState = '0'";
        this.f20251p = " AND is_bid_campaign = 1";
        this.f20252q = " order by ts ASC";
        this.f20253r = " group by request_id";
        this.f20254s = " group by bid_token";
    }
