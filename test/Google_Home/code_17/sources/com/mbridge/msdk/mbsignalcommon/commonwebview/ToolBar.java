...
public class ToolBar extends LinearLayout {
    ...
    public static class a {
        ...
        public static int f21593b = 40;

        /* renamed from: c, reason: collision with root package name */
        public static int f21594c = 10;
    ...
    public static class b {
        ...
        public View.OnClickListener f21599d;
    ...
    private void a(a aVar, List<b> list) {
        ...
        try {
            for (b bVar : list) {
                ...
                imageView.setTag(bVar.f21596a);
                imageView.setImageDrawable(getResources().getDrawable(getResources().getIdentifier(bVar.f21597b, "drawable", com.mbridge.msdk.foundation.controller.c.m().g())));
                LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(a.f21593b, -1);
                layoutParams.setMargins(32, 0, 32, 0);
                imageView.setLayoutParams(layoutParams);
                imageView.setOnClickListener(bVar.f21599d);
                if (!bVar.f21598c) {
