...
public final class b extends WebViewClient {
    ...
    private CopyOnWriteArrayList<WebViewClient> f21601a = new CopyOnWriteArrayList<>();

    public final void a(WebViewClient webViewClient) {
        this.f21601a.add(webViewClient);
    }

    public final void b(WebViewClient webViewClient) {
        this.f21601a.remove(webViewClient);
    }

    @Override // android.webkit.WebViewClient
    public final void doUpdateVisitedHistory(WebView webView, String str, boolean z8) {
        Iterator<WebViewClient> it = this.f21601a.iterator();
        while (it.hasNext()) {
