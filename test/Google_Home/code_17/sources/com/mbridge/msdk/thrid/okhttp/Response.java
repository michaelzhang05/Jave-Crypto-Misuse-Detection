...
public final class Response implements Closeable {
    ...
    public ResponseBody peekBody(long j8) throws IOException {
        ...
        source.request(j8);
        Buffer m5490clone = source.buffer().m5490clone();
        if (m5490clone.size() > j8) {
            Buffer buffer = new Buffer();
            buffer.write(m5490clone, j8);
            m5490clone.clear();
            m5490clone = buffer;
        }
        return ResponseBody.create(this.body.contentType(), m5490clone.size(), m5490clone);
    }
