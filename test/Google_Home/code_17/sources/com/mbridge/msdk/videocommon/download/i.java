...
public final class i {
    ...
    private com.mbridge.msdk.videocommon.listener.a f24175a;

    /* renamed from: b, reason: collision with root package name */
    private ConcurrentHashMap<String, com.mbridge.msdk.videocommon.listener.a> f24176b;
    ...
    private com.mbridge.msdk.videocommon.d.c f24179e;

    /* renamed from: f, reason: collision with root package name */
    private final int f24180f;

    /* renamed from: g, reason: collision with root package name */
    private final CopyOnWriteArrayList<CampaignEx> f24181g;

    /* renamed from: h, reason: collision with root package name */
    private final ConcurrentHashMap<String, com.mbridge.msdk.videocommon.download.a> f24182h;

    public i(List<CampaignEx> list, String str, int i8) {
        CopyOnWriteArrayList<CampaignEx> copyOnWriteArrayList = new CopyOnWriteArrayList<>();
        this.f24181g = copyOnWriteArrayList;
        this.f24182h = new ConcurrentHashMap<>();
        this.f24177c = com.mbridge.msdk.foundation.controller.c.m().c();
        this.f24178d = str;
        this.f24180f = i8;
        if (list != null) {
    ...
    private String b(CampaignEx campaignEx) {
        ...
        try {
            ...
            if (MBridgeConstans.DEBUG) {
                ad.a("RewardVideoRefactorManager", this.f24178d + " getVideoTemplateUrl error", e8);
            }
        }
        return "";
    }
    ...
    private com.mbridge.msdk.videocommon.download.a c(CampaignEx campaignEx) {
        ...
        try {
            aVar = new com.mbridge.msdk.videocommon.download.a(this.f24177c, campaignEx, this.f24178d, f());
        } catch (Exception e8) {
            e = e8;
        }
        try {
            ...
            aVar.e(d(campaignEx));
            aVar.a((c) null);
            aVar.a(new a(this.f24178d, this.f24176b, this.f24175a));
            return aVar;
        } catch (Exception e9) {
            e = e9;
            aVar2 = aVar;
            if (MBridgeConstans.DEBUG) {
                ad.a("RewardVideoRefactorManager", this.f24178d + " createAndStartCampaignDownloadTask error " + e.getMessage());
            }
            return aVar2;
        }
    }
    ...
    private int d(CampaignEx campaignEx) {
        ...
        try {
            ...
            ad.a("RewardVideoRefactorManager", this.f24178d + " getVideoCtnType error " + e8.getMessage());
            return 1;
        }
    }
    ...
    private boolean e(CampaignEx campaignEx) {
        ...
        try {
            ...
            ad.a("RewardVideoRefactorManager", this.f24178d + " isPlayerAbleAds error:" + th.getMessage());
            return false;
        }
    }
    ...
    private int g() {
        try {
            return c(this.f24178d).r();
        } catch (Throwable th) {
            if (MBridgeConstans.DEBUG) {
                ad.a("RewardVideoRefactorManager", this.f24178d + " getRewardReadyRate error:" + th.getMessage());
                return 100;
            }
            return 100;
        }
    ...
    public final void a(String str, com.mbridge.msdk.videocommon.listener.a aVar) {
        if (this.f24176b == null) {
            this.f24176b = new ConcurrentHashMap<>();
        }
        if (aVar == null || TextUtils.isEmpty(str)) {
            return;
        }
        this.f24176b.put(str, aVar);
    }
    ...
    private int f() {
        ...
        try {
            com.mbridge.msdk.videocommon.d.c c8 = c(this.f24178d);
            if (c8 != null) {
                return c8.w();
            }
        } catch (Exception e8) {
            if (MBridgeConstans.DEBUG) {
                ad.a("RewardVideoRefactorManager", this.f24178d + " getDlnet error " + e8.getMessage());
            }
        }
        return 1;
    }
    ...
    private int e() {
        ...
        try {
            ...
            ad.a("RewardVideoRefactorManager", this.f24178d + " getCDRate error " + e8.getMessage());
            return 0;
        }
    }
    ...
    public final void a(List<CampaignEx> list) {
        if (list != null) {
            try {
                this.f24181g.addAll(list);
            } catch (Exception e8) {
                if (MBridgeConstans.DEBUG) {
                    ad.a("RewardVideoRefactorManager", this.f24178d + " update error", e8);
                }
            }
        }
    }
    ...
    public final CopyOnWriteArrayList<Map<String, com.mbridge.msdk.videocommon.download.a>> d() {
        try {
            ...
            copyOnWriteArrayList.add(this.f24182h);
            return copyOnWriteArrayList;
        } catch (Exception e8) {
            if (!MBridgeConstans.DEBUG) {
                return null;
            }
            ad.b("RewardVideoRefactorManager", this.f24178d + " getCampaignDownLoadTaskList error:" + e8.getMessage());
            return null;
        }
    }
    ...
    public final com.mbridge.msdk.videocommon.download.a b() {
        ...
        if (this.f24181g.size() == 0) {
            ad.a("RewardVideoRefactorManager", this.f24178d + " isReady campaignExes is null");
            return null;
        }
        try {
            list = a((List<CampaignEx>) this.f24181g, false);
        } catch (Exception e8) {
            if (MBridgeConstans.DEBUG) {
                ad.a("RewardVideoRefactorManager", this.f24178d + " isReady error", e8);
            }
            list = null;
        }
    ...
    public static final class a implements com.mbridge.msdk.videocommon.listener.a {
        ...
        /* renamed from: b, reason: collision with root package name */
        private final ConcurrentHashMap<String, com.mbridge.msdk.videocommon.listener.a> f24184b;

        /* renamed from: c, reason: collision with root package name */
        private final com.mbridge.msdk.videocommon.listener.a f24185c;
        ...
        public a(String str, ConcurrentHashMap<String, com.mbridge.msdk.videocommon.listener.a> concurrentHashMap, com.mbridge.msdk.videocommon.listener.a aVar) {
            this.f24183a = str;
            this.f24184b = concurrentHashMap;
            this.f24185c = aVar;
        }

        @Override // com.mbridge.msdk.videocommon.listener.a
        public final void a(String str) {
            com.mbridge.msdk.videocommon.listener.a aVar = this.f24185c;
            if (aVar != null) {
                try {
                    aVar.a(str);
                } catch (Exception e8) {
                    if (MBridgeConstans.DEBUG) {
                        ad.b("RewardVideoRefactorManager", this.f24183a + " videoDownloadListener onDownLoadDone error: " + e8.getMessage());
                    }
                }
            }
            ConcurrentHashMap<String, com.mbridge.msdk.videocommon.listener.a> concurrentHashMap = this.f24184b;
            if (concurrentHashMap != null) {
                ...
                while (it.hasNext()) {
                    try {
                        ...
                        if (MBridgeConstans.DEBUG) {
                            ad.b("RewardVideoRefactorManager", this.f24183a + " videoDownloadListener onDownLoadDone error: " + e9.getMessage());
                        }
                    }
                }
            }
        ...
        public final void a(String str, String str2) {
            ...
            if (aVar != null) {
                try {
                    ...
                    if (MBridgeConstans.DEBUG) {
                        ad.b("RewardVideoRefactorManager", this.f24183a + " videoDownloadListener onDownLoadFailed error: " + e8.getMessage());
                    }
                }
            }
            ConcurrentHashMap<String, com.mbridge.msdk.videocommon.listener.a> concurrentHashMap = this.f24184b;
            if (concurrentHashMap != null) {
                ...
                while (it.hasNext()) {
                    try {
                        ...
                        if (MBridgeConstans.DEBUG) {
                            ad.b("RewardVideoRefactorManager", this.f24183a + " videoDownloadListener onDownLoadFailed error: " + e9.getMessage());
                        }
                    }
                }
            }
    ...
    public final void a() {
        CopyOnWriteArrayList<CampaignEx> copyOnWriteArrayList = this.f24181g;
            ...
            while (it.hasNext()) {
                ...
                if (next != null) {
                    try {
                        ...
                        if (!this.f24182h.containsKey(str)) {
                            a(next, str, (com.mbridge.msdk.videocommon.download.a) null);
                        }
                    } catch (Exception e8) {
                        if (MBridgeConstans.DEBUG) {
                            ad.a("RewardVideoRefactorManager", this.f24178d + " handlerCampaignLoadEvent error", e8);
                        }
                    }
                }
            }
        ...
        ad.a("RewardVideoRefactorManager", this.f24178d + " load campaignExes is null");
    }

    private com.mbridge.msdk.videocommon.d.c c(String str) {
        try {
            if (this.f24179e == null) {
                this.f24179e = com.mbridge.msdk.videocommon.d.b.a().a(com.mbridge.msdk.foundation.controller.c.m().k(), str, this.f24180f == 287);
            }
        } catch (Exception e8) {
            if (MBridgeConstans.DEBUG) {
                ad.a("RewardVideoRefactorManager", this.f24178d + " getRewardUnitSetting error " + e8.getMessage());
            }
        }
        return this.f24179e;
    }
    ...
    public final void b(String str) {
        ...
        try {
            if (!this.f24182h.containsKey(str) || (remove = this.f24182h.remove(str)) == null || (l8 = remove.l()) == null) {
                return;
            }
            this.f24181g.remove(l8);
            if (MBridgeConstans.DEBUG) {
                ad.a("RewardVideoRefactorManager", this.f24178d + " removeCampaignDownloadTask campaign name: " + l8.getAppName());
            }
        } catch (Exception e8) {
            if (MBridgeConstans.DEBUG) {
                ad.b("RewardVideoRefactorManager", this.f24178d + " removeCampaignDownloadTask error:" + e8.getMessage());
            }
        }
    }
    ...
    public final com.mbridge.msdk.videocommon.download.a c() {
        try {
            ...
            ad.b("RewardVideoRefactorManager", this.f24178d + " getCampaignDownLoadTask error:" + th.getMessage());
            return null;
        }
    }
    ...
    */
    private boolean a(java.lang.String r6, com.mbridge.msdk.foundation.entity.CampaignEx r7, com.mbridge.msdk.videocommon.download.a r8) {
        ...
        L9:
            ...
            java.lang.String r7 = r5.f24178d     // Catch: java.lang.Throwable -> L27
        ...
        Lae:
            ...
            r7.<init>()
            java.lang.String r8 = r5.f24178d
            r7.append(r8)
    ...
    public final com.mbridge.msdk.videocommon.download.a a(String str) {
        if (!TextUtils.isEmpty(str) && this.f24182h.containsKey(str)) {
            return this.f24182h.get(str);
        }
        return null;
    }
}
