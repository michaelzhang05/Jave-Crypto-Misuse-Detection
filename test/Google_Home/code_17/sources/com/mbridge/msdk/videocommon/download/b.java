...
public class b {
    ...
    private static volatile b f24150a;

    /* renamed from: b, reason: collision with root package name */
    private ThreadPoolExecutor f24151b;

    /* renamed from: c, reason: collision with root package name */
    private boolean f24152c = false;

    /* renamed from: d, reason: collision with root package name */
    private ConcurrentHashMap<String, j> f24153d = new ConcurrentHashMap<>();

    /* renamed from: e, reason: collision with root package name */
    private ConcurrentHashMap<String, CopyOnWriteArrayList<Map<String, a>>> f24154e;

    /* renamed from: f, reason: collision with root package name */
    private ConcurrentHashMap<String, CopyOnWriteArrayList<CampaignEx>> f24155f;

    /* renamed from: g, reason: collision with root package name */
    private ConcurrentHashMap<String, CopyOnWriteArrayList<a>> f24156g;
    ...
    private b() {
        ...
        this.f24151b = threadPoolExecutor;
    ...
    public final CopyOnWriteArrayList<a> b(String str) {
        ConcurrentHashMap<String, CopyOnWriteArrayList<a>> concurrentHashMap = this.f24156g;
    ...
    public final j c(String str) {
        ConcurrentHashMap<String, j> concurrentHashMap = this.f24153d;
        if (concurrentHashMap != null && concurrentHashMap.containsKey(str)) {
            return this.f24153d.get(str);
        }
        return null;
    }
    ...
    public j createUnitCache(Context context, String str, CopyOnWriteArrayList<CampaignEx> copyOnWriteArrayList, int i8, com.mbridge.msdk.videocommon.listener.a aVar) {
        ...
        if (this.f24153d.containsKey(str)) {
            jVar = this.f24153d.get(str);
            if (jVar == null) {
                jVar = new j(context, copyOnWriteArrayList, this.f24151b, str, i8);
                this.f24153d.put(str, jVar);
            }
            if (i8 != 94 && i8 != 287) {
                jVar.a(aVar);
            } else {
    ...
    public final CopyOnWriteArrayList<CampaignEx> a(String str) {
        ConcurrentHashMap<String, CopyOnWriteArrayList<CampaignEx>> concurrentHashMap = this.f24155f;
        if (concurrentHashMap == null || !concurrentHashMap.containsKey(str)) {
            return null;
        }
    ...
    public final void b(String str, CopyOnWriteArrayList<a> copyOnWriteArrayList) {
        ...
        if (concurrentHashMap == null) {
            this.f24156g = new ConcurrentHashMap<>();
        } else {
            concurrentHashMap.clear();
        }
        this.f24156g.put(str, copyOnWriteArrayList);
    }

    public final void a(String str, CopyOnWriteArrayList<CampaignEx> copyOnWriteArrayList) {
        ConcurrentHashMap<String, CopyOnWriteArrayList<CampaignEx>> concurrentHashMap = this.f24155f;
        if (concurrentHashMap == null) {
            this.f24155f = new ConcurrentHashMap<>();
        } else {
            concurrentHashMap.clear();
        }
        this.f24155f.put(str, copyOnWriteArrayList);
    }
    ...
    public j createUnitCache(Context context, String str, CampaignEx campaignEx, int i8, com.mbridge.msdk.videocommon.listener.a aVar) {
        ...
        if (this.f24153d.containsKey(str)) {
            jVar = this.f24153d.get(str);
            if (jVar == null) {
                jVar = new j(context, campaignEx, this.f24151b, str, i8);
                this.f24153d.put(str, jVar);
            }
            if (i8 != 94 && i8 != 287) {
                jVar.a(aVar);
    ...
    /* JADX WARN: Code restructure failed: missing block: B:141:0x0197, code lost:
        ...
        r14.f24154e = new j$.util.concurrent.ConcurrentHashMap<>();
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:144:0x01ae, code lost:
        ...
        r14.f24156g = new j$.util.concurrent.ConcurrentHashMap<>();
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:147:0x01c5, code lost:
        ...
        r14.f24155f = new j$.util.concurrent.ConcurrentHashMap<>();
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:156:0x0233, code lost:
        ...
        r14.f24154e.put(r16, r3);
        r14.f24155f.put(r16, r4);
        r14.f24156g.put(r16, r5);
     */
