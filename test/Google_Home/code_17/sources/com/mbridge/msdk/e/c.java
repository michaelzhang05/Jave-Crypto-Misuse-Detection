...
public final class c {
    ...
    private final Object f19920c = new Object();
    ...
    public final void b(List<i> list) {
        ...
        synchronized (this.f19920c) {
            if (y.a(this.f19918a) || y.a((List<?>) list)) {
                return;
            }
            try {
                sQLiteDatabase = this.f19918a.getWritableDatabase();
            } catch (Exception e8) {
                if (a.f19804a) {
            ...
            try {
                try {
                    ...
                    for (i iVar : list) {
                        ...
                        sQLiteDatabase.update(this.f19919b, contentValues, "uuid = ?", new String[]{iVar.f()});
                    }
                    c(sQLiteDatabase);
                } catch (Exception e9) {
                    if (a.f19804a) {
        ...
        synchronized (this.f19920c) {
            ...
            try {
                try {
                    ...
                    j8 = sQLiteDatabase.insert(this.f19919b, null, contentValues);
                    c(sQLiteDatabase);
                } catch (Exception e9) {
                    if (a.f19804a) {
    ...
    public final int b() {
        ...
        synchronized (this.f19920c) {
            ...
            try {
                try {
                    d(sQLiteDatabase);
                    i8 = sQLiteDatabase.delete(this.f19919b, "state = ? OR state = ?", new String[]{String.valueOf(-1), String.valueOf(2)});
                    c(sQLiteDatabase);
                } catch (Exception e9) {
                    if (a.f19804a) {
        ...
        synchronized (this.f19920c) {
            ...
            try {
                try {
                    ...
                    sQLiteDatabase.update(this.f19919b, contentValues, "state = ?", new String[]{String.valueOf(1)});
                    c(sQLiteDatabase);
                } catch (Exception e9) {
                    if (a.f19804a) {
    ...
    public final List<i> a(int i8) {
        ...
        synchronized (this.f19920c) {
            ...
            try {
                try {
                    d(sQLiteDatabase);
                    cursor = sQLiteDatabase.query(this.f19919b, null, "state = ? OR state = ?", new String[]{String.valueOf(0), String.valueOf(3)}, null, null, "priority DESC", String.valueOf(i8));
                } catch (Exception e9) {
                    e = e9;
                    list = null;
                }
    ...
    public final int a() {
        ...
        synchronized (this.f19920c) {
            ...
            try {
                ...
                try {
                    d(sQLiteDatabase);
                    cursor = sQLiteDatabase.query(this.f19919b, null, "state = ? OR state = ?", new String[]{String.valueOf(3), String.valueOf(0)}, null, null, null, null);
