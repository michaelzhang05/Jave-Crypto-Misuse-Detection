...
public abstract class MBBaseActivity extends Activity {
    ...
    private Display f18917a;

    /* renamed from: b, reason: collision with root package name */
    private OrientationEventListener f18918b;
    ...
    static /* synthetic */ void e(MBBaseActivity mBBaseActivity) {
        OrientationEventListener orientationEventListener = new OrientationEventListener(mBBaseActivity, 1) { // from class: com.mbridge.msdk.activity.MBBaseActivity.2
            ...
            public final void onOrientationChanged(int i8) {
                int i9;
                if (MBBaseActivity.this.f18917a != null) {
                    i9 = MBBaseActivity.this.f18917a.getRotation();
                } else {
                    i9 = 0;
                }
                if (i9 == 1 && MBBaseActivity.this.f18919c != 1) {
                    MBBaseActivity.this.f18919c = 1;
                    MBBaseActivity.this.getNotchParams();
                    ad.b("MBBaseActivity", "Orientation Left");
                    return;
                }
                if (i9 == 3 && MBBaseActivity.this.f18919c != 2) {
                    MBBaseActivity.this.f18919c = 2;
                    MBBaseActivity.this.getNotchParams();
                    ad.b("MBBaseActivity", "Orientation Right");
                } else if (i9 == 0 && MBBaseActivity.this.f18919c != 3) {
                    MBBaseActivity.this.f18919c = 3;
                    MBBaseActivity.this.getNotchParams();
                    ad.b("MBBaseActivity", "Orientation Top");
                } else if (i9 == 2 && MBBaseActivity.this.f18919c != 4) {
                    MBBaseActivity.this.f18919c = 4;
                    MBBaseActivity.this.getNotchParams();
                    ad.b("MBBaseActivity", "Orientation Bottom");
                }
            }
        };
        mBBaseActivity.f18918b = orientationEventListener;
        if (orientationEventListener.canDetectOrientation()) {
            mBBaseActivity.f18918b.enable();
        } else {
            mBBaseActivity.f18918b.disable();
            mBBaseActivity.f18918b = null;
        }
    }
    ...
    public void onDestroy() {
        super.onDestroy();
        OrientationEventListener orientationEventListener = this.f18918b;
    ...
    public int b() {
        ...
        if (this.f18917a == null) {
            if (Build.VERSION.SDK_INT >= 30) {
                ...
                this.f18917a = ((WindowManager) getSystemService("window")).getDefaultDisplay();
            }
        }
        Display display2 = this.f18917a;
        if (display2 != null) {
