...
public final class b {
    ...
    private Handler f22274g;

    /* renamed from: i, reason: collision with root package name */
    private com.mbridge.msdk.newreward.function.c.c f22276i;

    /* renamed from: l, reason: collision with root package name */
    private com.mbridge.msdk.newreward.a.d f22279l;

    /* renamed from: j, reason: collision with root package name */
    private volatile boolean f22277j = false;

    /* renamed from: k, reason: collision with root package name */
    private volatile boolean f22278k = false;

    /* renamed from: e, reason: collision with root package name */
    private int f22272e = af.a().a(MBridgeCommon.SettingConfig.KEY_SETTING_CONFIG_LOAD_CHECK_INTERVAL, 120000);

    /* renamed from: h, reason: collision with root package name */
    private long f22275h = af.a().a(MBridgeCommon.SettingConfig.KEY_SETTING_CONFIG_LOAD_TOKEN_VALIDITY_PERIOD, 1800000);

    /* renamed from: f, reason: collision with root package name */
    private boolean f22273f = af.a().a(MBridgeCommon.SettingConfig.KEY_SETTING_CONFIG_LOAD_CHECK_OPTIMIZED, false);
        ...
        if (cVar != null && dVar != null) {
            ...
            handler.postDelayed(new Runnable() { // from class: com.mbridge.msdk.newreward.function.f.b.1
                ...
                public final void run() {
                    ...
                    b.this.f22274g.postDelayed(this, b.this.f22272e);
                }
            }, this.f22272e);
            return;
        }
    ...
    private void a() {
        com.mbridge.msdk.newreward.function.e.c.a().b().b(this.f22268a, this.f22269b, this.f22270c);
    }
    ...
    private com.mbridge.msdk.newreward.a.e a(com.mbridge.msdk.newreward.function.d.a.b bVar) {
        com.mbridge.msdk.newreward.a.e eVar = new com.mbridge.msdk.newreward.a.e(false, this.f22268a, bVar.f(), this.f22270c, bVar.g());
        eVar.e(bVar.e());
        eVar.e(30000);
    ...
    static /* synthetic */ void a(b bVar) {
        if (bVar.f22279l.a() != null) {
            Iterator<com.mbridge.msdk.newreward.a.e> it = bVar.f22279l.a().iterator();
            while (it.hasNext()) {
                if (it.next().s() == 1) {
                    return;
                }
        ...
        bVar.f22277j = true;
        com.mbridge.msdk.newreward.function.e.c.a().b().a(bVar.f22268a, bVar.f22269b, bVar.f22270c, bVar.f22271d, new com.mbridge.msdk.newreward.function.e.b() { // from class: com.mbridge.msdk.newreward.function.f.b.2
    ...
    static /* synthetic */ void a(b bVar, List list) {
        ...
        while (it.hasNext()) {
            ...
            if (bVar4.g()) {
                ...
                if (G8 == 0) {
                    ...
                    com.mbridge.msdk.newreward.function.e.c.a().b().b(bVar4.a(), bVar4.b(), bVar4.c(), bVar4.e(), 8);
                } else if (System.currentTimeMillis() - G8 > bVar.f22275h && bVar4.s() == null) {
                    com.mbridge.msdk.newreward.function.e.c.a().b().b(bVar4.a(), bVar4.b(), bVar4.c(), bVar4.e(), 8);
        ...
        if (!bVar.f22278k && bVar2 != null) {
            bVar.f22278k = true;
            final com.mbridge.msdk.newreward.a.e a8 = bVar.a(bVar2);
            try {
                com.mbridge.msdk.newreward.function.c.c cVar = bVar.f22276i;
            ...
            bVar.a(a8, bVar2, new com.mbridge.msdk.newreward.a.b.b() { // from class: com.mbridge.msdk.newreward.function.f.b.4
                ...
                public final void a(Object obj) {
                    b.this.f22278k = false;
                    try {
                        b.this.f22276i.a(a8, com.mbridge.msdk.newreward.function.c.e.REPORT_LOAD_CHECK, b.this.f22276i.a("check_type", "download_success", "campaign", bVar2));
                    } catch (Exception e9) {
                ...
                public final void a(com.mbridge.msdk.foundation.c.b bVar6) {
                    b.this.f22278k = false;
                    try {
                        b.this.f22276i.a(a8, com.mbridge.msdk.newreward.function.c.e.REPORT_LOAD_CHECK, b.this.f22276i.a("check_type", "download_failed", "campaign", bVar2));
                    } catch (Exception e9) {
                        ad.b("LoadCheckController", "handlerAnthonyNeedDownloadCampaign error: " + e9.getMessage());
                    }
                }
        ...
        if (bVar3 != null) {
            ...
            if (C8 == null) {
                try {
                    com.mbridge.msdk.newreward.function.c.c cVar2 = bVar.f22276i;
                ...
                com.mbridge.msdk.newreward.function.c.c cVar3 = bVar.f22276i;
            ...
            try {
                com.mbridge.msdk.newreward.function.c.c cVar4 = bVar.f22276i;
    ...
    static /* synthetic */ void a(b bVar, com.mbridge.msdk.newreward.a.e eVar, com.mbridge.msdk.newreward.function.d.a.b bVar2) {
        ...
        try {
            if (bVar2 == null) {
                a8 = bVar.f22276i.a("check_type", "check_failed");
            } else {
                a8 = bVar.f22276i.a("check_type", "check_failed", "campaign", bVar2);
            }
            bVar.f22276i.a(eVar, com.mbridge.msdk.newreward.function.c.e.REPORT_LOAD_CHECK, a8);
        } catch (Exception e8) {
