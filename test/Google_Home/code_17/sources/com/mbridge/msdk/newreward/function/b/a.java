...
public final class a {
    ...
    private static String f21955a = "RewardCandidateController";

    /* renamed from: b, reason: collision with root package name */
    private final c f21956b;

    /* renamed from: c, reason: collision with root package name */
    private com.mbridge.msdk.newreward.function.a.c f21957c;
    ...
    public final com.mbridge.msdk.newreward.function.a.b a(com.mbridge.msdk.foundation.same.report.d.b bVar, com.mbridge.msdk.foundation.c.b bVar2, e eVar, int i8) {
        ...
        if (eVar == null) {
            ...
            try {
                ...
                bVar3.a(com.mbridge.msdk.foundation.b.c.f20078c);
                return bVar3;
            }
        }
        if (campaignEx == null) {
        ...
        com.mbridge.msdk.newreward.function.a.c cVar = this.f21957c;
        if (cVar == null) {
            ...
            if (c8.h() > com.mbridge.msdk.foundation.b.c.f20077b) {
                return c8;
            }
            ...
            if (a8 != null && a8.a() != null) {
                this.f21957c.a(a8.a().s(), bVar, requestId, i10, str3, i8, parseDouble);
            }
        }
        return a8;
    }
    ...
    private com.mbridge.msdk.newreward.function.a.b a(double d8, String str, com.mbridge.msdk.foundation.same.report.d.b bVar, String str2, e eVar, int i8, int i9, String str3) {
        ...
        com.mbridge.msdk.newreward.function.a.b a8 = bVar3.f21957c.a();
        try {
        } catch (Exception unused) {
            bVar3 = a8;
        }
                    ...
                    if (a10 != null && a10.size() > 0) {
                        ...
                        if (a10.size() == 0) {
                                    ...
                                    for (int i12 = 0; i12 < a10.size(); i12++) {
                                        ...
                                        if (bVar6 != null && (s8 = bVar6.s()) != null && s8.size() != 0) {
                                            ...
                                            while (true) {
                                                ...
                                                if (c8) {
                                                    bVar4.c(bVar6.d());
                                                    com.mbridge.msdk.newreward.function.a.c cVar = bVar3.f21957c;
                                                    if (cVar != null) {
                            ...
                            if (a10 == null || a10.size() <= 0) {
                                ...
                                while (i14 < size) {
                                    ...
                                    if (bVar8 != null) {
                                        ...
                                        try {
                                            ...
                                            arrayList3.add(new a.C0410a(pow, bVar8));
                                ...
                                if (bVar7 != null) {
                                    bVar4.a(bVar7);
                                    bVar4.a(com.mbridge.msdk.foundation.b.c.f20079d);
                                } else {
    ...
    public final void a(com.mbridge.msdk.foundation.same.report.d.b bVar, String str, com.mbridge.msdk.newreward.function.a.b bVar2, List<a.C0410a> list, JSONObject jSONObject, e eVar, int i8) {
        String str2;
        try {
            d dVar = new d();
            if (i8 == 1) {
            ...
            if (cVar != null) {
                ...
                try {
                    com.mbridge.msdk.newreward.function.a.c cVar2 = this.f21957c;
            ...
            if (bVar2 != null) {
                if (bVar2.h() == com.mbridge.msdk.foundation.b.c.f20079d) {
                    dVar.a("result", 1);
                } else {
                    dVar.a("result", 2);
