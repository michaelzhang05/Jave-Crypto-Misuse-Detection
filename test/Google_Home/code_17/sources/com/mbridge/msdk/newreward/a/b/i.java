...
public final class i implements a {
    ...
    private com.mbridge.msdk.newreward.function.c.c f21823a;

    /* renamed from: b, reason: collision with root package name */
    private com.mbridge.msdk.newreward.a.e f21824b;
    ...
    public static /* synthetic */ class AnonymousClass2 {
        ...
        static {
            ...
            try {
                f21828a[com.mbridge.msdk.newreward.function.c.e.REPORT_DOWNLOAD_END.ordinal()] = 2;
    ...
    public final void a(Object obj, final b bVar) throws IOException {
        ...
        if (aVar.h().F() != null) {
            if (aVar.h().F().containsKey("command_manager")) {
                this.f21823a = (com.mbridge.msdk.newreward.function.c.c) aVar.h().F().get("command_manager");
            }
            if (aVar.h().F().containsKey("adapter_model")) {
                this.f21824b = (com.mbridge.msdk.newreward.a.e) aVar.h().F().get("adapter_model");
            }
        }
        if (e8 == null) {
            bVar.a(aVar);
    ...
    public void a(com.mbridge.msdk.newreward.function.c.e eVar, int i8, com.mbridge.msdk.newreward.function.d.a.a aVar, MBridgeError mBridgeError) {
        com.mbridge.msdk.newreward.function.c.c cVar = this.f21823a;
        if (cVar == null || this.f21824b == null) {
            return;
        }
        try {
            Map a8 = cVar.a("resource_type", 7, "url", aVar.e().j(), "mraid_type", Integer.valueOf(aVar.i() ? 1 : 0));
            int i9 = AnonymousClass2.f21828a[eVar.ordinal()];
            if (i9 != 1) {
                if (i9 == 2 && this.f21825c == 2) {
                    a8.put("result", Integer.valueOf(i8));
                    if (i8 != 1 && mBridgeError != null) {
                        a8.put("reason", mBridgeError.getErrorMessage());
                    }
                    this.f21823a.a(this.f21824b, eVar, a8);
                    return;
                }
                return;
            }
            a8.put("cache", Integer.valueOf(this.f21825c));
            this.f21823a.a(this.f21824b, eVar, a8);
        } catch (Exception e8) {
