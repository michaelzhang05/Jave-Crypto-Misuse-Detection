...
public final class d {
    ...
    public static /* synthetic */ class AnonymousClass2 {
        ...
        static {
            ...
            try {
                f22027a[com.mbridge.msdk.newreward.function.c.e.REPORT_V3_RETRY_END.ordinal()] = 2;
    ...
    */
    ...
    public void a(com.mbridge.msdk.newreward.function.c.e eVar, e eVar2, String str, boolean z8) {
        ...
        try {
            Map a8 = d8.a("retry_count", Integer.valueOf(this.f22022a), "type", 3);
            int i8 = AnonymousClass2.f22027a[eVar.ordinal()];
            if (i8 == 1) {
            ...
            a8.put(TypedValues.TransitionType.S_DURATION, Long.valueOf(System.currentTimeMillis() - this.f22023b));
            if (!z8) {
                a8.put("reason", str);
            }
