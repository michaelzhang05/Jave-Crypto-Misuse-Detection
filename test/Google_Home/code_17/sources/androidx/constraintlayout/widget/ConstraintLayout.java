...
public class ConstraintLayout extends ViewGroup {
    ...
    public class Measurer implements BasicMeasure.Measurer {
        ...
        public final void measure(ConstraintWidget constraintWidget, BasicMeasure.Measure measure) {
                    ...
                    if (i17 != 3) {
                        if (i17 != 4) {
                            ...
                            if (i18 == BasicMeasure.Measure.TRY_GIVEN_DIMENSIONS || i18 == BasicMeasure.Measure.USE_GIVEN_DIMENSIONS) {
                                ...
                                if (measure.measureStrategy == BasicMeasure.Measure.USE_GIVEN_DIMENSIONS || !z18 || ((z18 && z19) || (view instanceof Placeholder) || constraintWidget.isResolvedHorizontally())) {
                    ...
                    if (i19 != 3) {
                        if (i19 != 4) {
                            ...
                            if (i20 == BasicMeasure.Measure.TRY_GIVEN_DIMENSIONS || i20 == BasicMeasure.Measure.USE_GIVEN_DIMENSIONS) {
                                ...
                                if (measure.measureStrategy == BasicMeasure.Measure.USE_GIVEN_DIMENSIONS || !z16 || ((z16 && z17) || (view instanceof Placeholder) || constraintWidget.isResolvedVertically())) {
            ...
            if (i21 != BasicMeasure.Measure.TRY_GIVEN_DIMENSIONS && i21 != BasicMeasure.Measure.USE_GIVEN_DIMENSIONS && z8 && constraintWidget.mMatchConstraintDefaultWidth == 0 && z9 && constraintWidget.mMatchConstraintDefaultHeight == 0) {
                i12 = -1;
                i10 = 0;
                baseline = 0;
                i8 = 0;
                ...
                if (!Optimizer.enabled(ConstraintLayout.this.mOptimizationLevel, 1)) {
                    if (z12 && z10) {
                        i8 = (int) ((i10 * constraintWidget.mDimensionRatio) + 0.5f);
                    } else if (z13 && z11) {
                        i10 = (int) ((i8 / constraintWidget.mDimensionRatio) + 0.5f);
                    }
                }
                if (measuredWidth != i8 || measuredHeight != i10) {
                    ...
                    constraintWidget.setLastMeasureSpec(i11, makeMeasureSpec2);
            ...
            if (i8 == measure.horizontalDimension && i10 == measure.verticalDimension) {
                z15 = false;
            } else {
                z15 = true;
            }
            measure.measuredNeedsSolverPass = z15;
    ...
    public void applyConstraintsFromLayoutParams(boolean z8, View view, ConstraintWidget constraintWidget, LayoutParams layoutParams, SparseArray<ConstraintWidget> sparseArray) {
        ...
        if (z8 && ((i8 = layoutParams.editorAbsoluteX) != -1 || layoutParams.editorAbsoluteY != -1)) {
    ...
    public void onLayout(boolean z8, int i8, int i9, int i10, int i11) {
        ...
        for (int i12 = 0; i12 < childCount; i12++) {
            ...
            if ((childAt.getVisibility() != 8 || layoutParams.isGuideline || layoutParams.isHelper || layoutParams.isVirtualGroup || isInEditMode) && !layoutParams.isInPlaceholder) {
                int x8 = constraintWidget.getX();
                int y8 = constraintWidget.getY();
                int width = constraintWidget.getWidth() + x8;
                int height = constraintWidget.getHeight() + y8;
    ...
    public void resolveMeasuredDimension(int i8, int i9, int i10, int i11, boolean z8, boolean z9) {
        ...
        int resolveSizeAndState = View.resolveSizeAndState(i10 + measurer.paddingWidth, i8, 0);
    ...
    public void resolveSystem(ConstraintWidgetContainer constraintWidgetContainer, int i8, int i9, int i10) {
        ...
        this.mMeasurer.captureLayoutInfo(i9, i10, max, max2, paddingWidth, i12);
        ...
        constraintWidgetContainer.measure(i8, mode, i13, mode2, i14, this.mLastMeasureWidth, this.mLastMeasureHeight, i11, max);
    }
