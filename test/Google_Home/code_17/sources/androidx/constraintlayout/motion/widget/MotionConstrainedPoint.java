...
public class MotionConstrainedPoint implements Comparable<MotionConstrainedPoint> {
    ...
    private float f14698x;

    /* renamed from: y, reason: collision with root package name */
    private float f14699y;
    ...
    void fillStandard(double[] dArr, int[] iArr) {
        int i8 = 0;
        float[] fArr = {this.position, this.f14698x, this.f14699y, this.width, this.height, this.alpha, this.elevation, this.rotation, this.rotationX, this.rotationY, this.scaleX, this.scaleY, this.mPivotX, this.mPivotY, this.translationX, this.translationY, this.translationZ, this.mPathRotate};
        for (int i9 : iArr) {
            if (i9 < 18) {
                dArr[i8] = fArr[r5];
                i8++;
    ...
    void different(MotionConstrainedPoint motionConstrainedPoint, boolean[] zArr, String[] strArr) {
        ...
        zArr[1] = zArr[1] | diff(this.f14698x, motionConstrainedPoint.f14698x);
        zArr[2] = zArr[2] | diff(this.f14699y, motionConstrainedPoint.f14699y);
