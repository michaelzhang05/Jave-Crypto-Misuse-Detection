...
public class Motion implements TypedValues {
    ...
    void getDpDt(float f8, float f9, float f10, float[] fArr) {
        ...
        float f12 = motionPaths.f14686x;
        MotionPaths motionPaths2 = this.mStartMotionPath;
        float f13 = f12 - motionPaths2.f14686x;
        float f14 = motionPaths.f14687y - motionPaths2.f14687y;
    ...
    public float getFinalX() {
        return this.mEndMotionPath.f14686x;
    }

    public float getFinalY() {
        return this.mEndMotionPath.f14687y;
    }
    ...
    float getKeyFrameParameter(int i8, float f8, float f9) {
        MotionPaths motionPaths = this.mEndMotionPath;
        float f10 = motionPaths.f14686x;
        MotionPaths motionPaths2 = this.mStartMotionPath;
        float f11 = motionPaths2.f14686x;
        float f12 = f10 - f11;
        float f13 = motionPaths.f14687y;
        float f14 = motionPaths2.f14687y;
        float f15 = f13 - f14;
    ...
    public float getStartX() {
        return this.mStartMotionPath.f14686x;
    }

    public float getStartY() {
        return this.mStartMotionPath.f14687y;
    }
    ...
    public boolean interpolate(MotionWidget motionWidget, float f8, long j8, KeyCache keyCache) {
        ...
        if (curveFitArr != null) {
            ...
            MotionPaths motionPaths = this.mStartMotionPath;
            float f13 = motionPaths.f14686x;
            MotionPaths motionPaths2 = this.mEndMotionPath;
            float f14 = f13 + ((motionPaths2.f14686x - f13) * f12);
            float f15 = motionPaths.f14687y;
            float f16 = f15 + ((motionPaths2.f14687y - f15) * f12);
    ...
    public String toString() {
        return " start: x: " + this.mStartMotionPath.f14686x + " y: " + this.mStartMotionPath.f14687y + " end: x: " + this.mEndMotionPath.f14686x + " y: " + this.mEndMotionPath.f14687y;
    }
