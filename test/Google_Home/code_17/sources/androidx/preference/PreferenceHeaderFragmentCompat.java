...
public abstract class PreferenceHeaderFragmentCompat extends Fragment implements PreferenceFragmentCompat.OnPreferenceStartFragmentCallback {
    ...
    private static final class InnerOnBackPressedCallback extends OnBackPressedCallback implements SlidingPaneLayout.PanelSlideListener {
        ...
        public InnerOnBackPressedCallback(PreferenceHeaderFragmentCompat caller) {
            super(true);
            AbstractC3255y.i(caller, "caller");
            this.caller = caller;
    ...
    public static final void m5475onViewCreated$lambda10(PreferenceHeaderFragmentCompat this$0) {
        boolean z8;
        AbstractC3255y.i(this$0, "this$0");
        OnBackPressedCallback onBackPressedCallback = this$0.onBackPressedCallback;
        AbstractC3255y.f(onBackPressedCallback);
    ...
    private final void openPreferenceHeader(Preference preference) {
        ...
        if (getChildFragmentManager().getBackStackEntryCount() > 0) {
            ...
            AbstractC3255y.h(backStackEntryAt, "childFragmentManager.getBackStackEntryAt(0)");
            getChildFragmentManager().popBackStack(backStackEntryAt.getId(), 1);
        }
        FragmentManager childFragmentManager = getChildFragmentManager();
        AbstractC3255y.h(childFragmentManager, "childFragmentManager");
    ...
    public void onAttach(Context context) {
        ...
        AbstractC3255y.h(parentFragmentManager, "parentFragmentManager");
    ...
    public Fragment onCreateInitialDetailFragment() {
        ...
        if (findFragmentById != null) {
            ...
            while (true) {
                ...
                AbstractC3255y.h(preference, "headerFragment.preferenc…reen.getPreference(index)");
                if (preference.getFragment() == null) {
                    i8 = i9;
                } else {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        if (childFragmentManager.findFragmentById(i8) == null) {
            ...
            AbstractC3255y.h(childFragmentManager2, "childFragmentManager");
    ...
    public boolean onPreferenceStartFragment(PreferenceFragmentCompat caller, Preference pref) {
        ...
        if (id == i8) {
            ...
            AbstractC3255y.h(instantiate, "childFragmentManager.fra….fragment!!\n            )");
    ...
    public void onViewCreated(View view, Bundle bundle) {
        ...
        getChildFragmentManager().addOnBackStackChangedListener(new FragmentManager.OnBackStackChangedListener() { // from class: androidx.preference.b
            ...
            public final void onBackStackChanged() {
                PreferenceHeaderFragmentCompat.m5475onViewCreated$lambda10(PreferenceHeaderFragmentCompat.this);
            }
        });
