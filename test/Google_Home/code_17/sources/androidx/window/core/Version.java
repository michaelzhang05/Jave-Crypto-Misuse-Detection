...
public final class Version implements Comparable<Version> {
    ...
    private final InterfaceC1355k bigInteger$delegate;
    ...
    public static final class Companion {
        ...
        public final Version parse(String str) {
            ...
            AbstractC3255y.h(description, "description");
    ...
    public /* synthetic */ Version(int i8, int i9, int i10, String str, AbstractC3247p abstractC3247p) {
        this(i8, i9, i10, str);
    }

    private final BigInteger getBigInteger() {
        Object value = this.bigInteger$delegate.getValue();
        AbstractC3255y.h(value, "<get-bigInteger>(...)");
    ...
    public String toString() {
        ...
        if (!n.u(this.description)) {
            str = AbstractC3255y.q("-", this.description);
        } else {
            str = "";
        }
