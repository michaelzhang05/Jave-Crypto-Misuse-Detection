...
public final class SplitRuleParser {
    private final ComponentName buildClassName(String str, CharSequence charSequence) {
        if (charSequence != null && charSequence.length() != 0) {
            ...
            if (obj.charAt(0) == '.') {
                return new ComponentName(str, AbstractC3255y.q(str, obj));
            }
            ...
            if (R8 > 0) {
                ...
                AbstractC3255y.h(obj, "this as java.lang.String).substring(startIndex)");
            }
            if (!AbstractC3255y.d(obj, "*") && n.R(obj, '.', 0, false, 6, null) < 0) {
    ...
    private final SplitPlaceholderRule parseSplitPlaceholderRule(Context context, XmlResourceParser xmlResourceParser) {
        ...
        AbstractC3255y.h(component, "Intent().setComponent(pl…eholderActivityClassName)");
    ...
    private final Set<EmbeddingRule> parseSplitXml(Context context, int i8) {
        ...
        try {
            ...
            AbstractC3255y.h(xml, "resources.getXml(splitResourceId)");
            ...
            while (next != 1 && (next != 3 || xml.getDepth() > depth)) {
                if (xml.getEventType() == 2 && !AbstractC3255y.d("split-config", xml.getName())) {
