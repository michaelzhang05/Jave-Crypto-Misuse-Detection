...
public class SplitRule extends EmbeddingRule {
    ...
    public static final class Api30Impl {
        ...
        public final Rect getBounds(WindowMetrics windowMetrics) {
            AbstractC3255y.i(windowMetrics, "windowMetrics");
            Rect bounds = windowMetrics.getBounds();
            AbstractC3255y.h(bounds, "windowMetrics.bounds");
            return bounds;
        }
    }
    ...
    public final boolean checkParentMetrics(WindowMetrics parentMetrics) {
        boolean z8;
        boolean z9;
        AbstractC3255y.i(parentMetrics, "parentMetrics");
    ...
    public /* synthetic */ SplitRule(int i8, int i9, float f8, int i10, int i11, AbstractC3247p abstractC3247p) {
