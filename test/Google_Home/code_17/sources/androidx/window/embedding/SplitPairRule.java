...
public final class SplitPairRule extends SplitRule {
    ...
    public /* synthetic */ SplitPairRule(Set set, boolean z8, boolean z9, boolean z10, int i8, int i9, float f8, int i10, int i11, AbstractC3247p abstractC3247p) {
    ...
    public boolean equals(Object obj) {
        ...
        if (AbstractC3255y.d(this.filters, splitPairRule.filters) && this.finishPrimaryWithSecondary == splitPairRule.finishPrimaryWithSecondary && this.finishSecondaryWithPrimary == splitPairRule.finishSecondaryWithPrimary && this.clearTop == splitPairRule.clearTop) {
            return true;
        }
        return false;
    }
    ...
    public final SplitPairRule plus$window_release(SplitPairFilter filter) {
        ...
        return new SplitPairRule(AbstractC1378t.b1(linkedHashSet), this.finishPrimaryWithSecondary, this.finishSecondaryWithPrimary, this.clearTop, getMinWidth(), getMinSmallestWidth(), getSplitRatio(), getLayoutDirection());
    }
