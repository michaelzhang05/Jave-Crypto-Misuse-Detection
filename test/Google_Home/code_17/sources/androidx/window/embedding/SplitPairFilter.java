...
public final class SplitPairFilter {
    ...
    public SplitPairFilter(ComponentName primaryActivityName, ComponentName secondaryActivityName, String str) {
        ...
        int i8;
        boolean z8;
        AbstractC3255y.i(primaryActivityName, "primaryActivityName");
        AbstractC3255y.i(secondaryActivityName, "secondaryActivityName");
        ...
        AbstractC3255y.h(packageName, "primaryActivityName.packageName");
        String className = primaryActivityName.getClassName();
        AbstractC3255y.h(className, "primaryActivityName.className");
        String packageName2 = secondaryActivityName.getPackageName();
        AbstractC3255y.h(packageName2, "secondaryActivityName.packageName");
        String className2 = secondaryActivityName.getClassName();
        AbstractC3255y.h(className2, "secondaryActivityName.className");
    ...
    public boolean equals(Object obj) {
        ...
        if (AbstractC3255y.d(this.primaryActivityName, splitPairFilter.primaryActivityName) && AbstractC3255y.d(this.secondaryActivityName, splitPairFilter.secondaryActivityName) && AbstractC3255y.d(this.secondaryActivityIntentAction, splitPairFilter.secondaryActivityIntentAction)) {
            return true;
        }
        return false;
    }
    ...
    public final boolean matchesActivityIntentPair(Activity primaryActivity, Intent secondaryActivityIntent) {
        AbstractC3255y.i(primaryActivity, "primaryActivity");
        AbstractC3255y.i(secondaryActivityIntent, "secondaryActivityIntent");
        ...
        String str = this.secondaryActivityIntentAction;
        if (str != null && !AbstractC3255y.d(str, secondaryActivityIntent.getAction())) {
            return false;
        }
        return true;
    }
    ...
    public final boolean matchesActivityPair(Activity primaryActivity, Activity secondaryActivity) {
        boolean z8;
        AbstractC3255y.i(primaryActivity, "primaryActivity");
        AbstractC3255y.i(secondaryActivity, "secondaryActivity");
        MatcherUtils matcherUtils = MatcherUtils.INSTANCE;
        boolean z9 = false;
        ...
        if (secondaryActivity.getIntent() != null) {
            if (z8) {
                ...
                AbstractC3255y.h(intent, "secondaryActivity.intent");
