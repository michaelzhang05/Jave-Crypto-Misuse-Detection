...
public final class SplitInfo {
    ...
    public SplitInfo(ActivityStack primaryActivityStack, ActivityStack secondaryActivityStack, float f8) {
        AbstractC3255y.i(primaryActivityStack, "primaryActivityStack");
        AbstractC3255y.i(secondaryActivityStack, "secondaryActivityStack");
    ...
    public boolean equals(Object obj) {
        ...
        if (AbstractC3255y.d(this.primaryActivityStack, splitInfo.primaryActivityStack) && AbstractC3255y.d(this.secondaryActivityStack, splitInfo.secondaryActivityStack) && this.splitRatio == splitInfo.splitRatio) {
            return true;
        }
        return false;
    }
