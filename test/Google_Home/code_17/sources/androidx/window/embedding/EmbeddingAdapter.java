...
public final class EmbeddingAdapter {
    ...
    public static final boolean m5478translateActivityIntentPredicates$lambda3(EmbeddingAdapter this$0, Set splitPairFilters, Pair pair) {
        AbstractC3255y.i(this$0, "this$0");
        AbstractC3255y.i(splitPairFilters, "$splitPairFilters");
        AbstractC3255y.h(pair, "(first, second)");
    ...
    public static final boolean m5479translateActivityPairPredicates$lambda1(EmbeddingAdapter this$0, Set splitPairFilters, Pair pair) {
        AbstractC3255y.i(this$0, "this$0");
        AbstractC3255y.i(splitPairFilters, "$splitPairFilters");
        AbstractC3255y.h(pair, "(first, second)");
        Activity activity = (Activity) this$0.component1(pair);
    ...
    public static final boolean m5480translateActivityPredicates$lambda6(Set activityFilters, Activity activity) {
        AbstractC3255y.i(activityFilters, "$activityFilters");
        Set<ActivityFilter> set = activityFilters;
        if ((set instanceof Collection) && set.isEmpty()) {
            return false;
        }
        for (ActivityFilter activityFilter : set) {
            AbstractC3255y.h(activity, "activity");
    ...
    public static final boolean m5481translateIntentPredicates$lambda8(Set activityFilters, Intent intent) {
        AbstractC3255y.i(activityFilters, "$activityFilters");
        Set<ActivityFilter> set = activityFilters;
        if ((set instanceof Collection) && set.isEmpty()) {
            return false;
    ...
    public static final boolean m5482translateParentMetricsPredicate$lambda4(SplitRule splitRule, WindowMetrics windowMetrics) {
        AbstractC3255y.i(splitRule, "$splitRule");
        AbstractC3255y.h(windowMetrics, "windowMetrics");
    ...
    public final Predicate<Pair<Activity, Intent>> translateActivityIntentPredicates(final Set<SplitPairFilter> splitPairFilters) {
        ...
        return new Predicate() { // from class: androidx.window.embedding.d
            ...
            public final boolean test(Object obj) {
                boolean m5478translateActivityIntentPredicates$lambda3;
                m5478translateActivityIntentPredicates$lambda3 = EmbeddingAdapter.m5478translateActivityIntentPredicates$lambda3(EmbeddingAdapter.this, splitPairFilters, (Pair) obj);
                return m5478translateActivityIntentPredicates$lambda3;
            }
        };
    }
    ...
    public final Predicate<Pair<Activity, Activity>> translateActivityPairPredicates(final Set<SplitPairFilter> splitPairFilters) {
        ...
        return new Predicate() { // from class: androidx.window.embedding.c
            ...
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                boolean m5479translateActivityPairPredicates$lambda1;
                m5479translateActivityPairPredicates$lambda1 = EmbeddingAdapter.m5479translateActivityPairPredicates$lambda1(EmbeddingAdapter.this, splitPairFilters, (Pair) obj);
                return m5479translateActivityPairPredicates$lambda1;
            }
        };
    }
    ...
    public final Predicate<Activity> translateActivityPredicates(final Set<ActivityFilter> activityFilters) {
        ...
        return new Predicate() { // from class: androidx.window.embedding.e
            ...
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                boolean m5480translateActivityPredicates$lambda6;
                m5480translateActivityPredicates$lambda6 = EmbeddingAdapter.m5480translateActivityPredicates$lambda6(activityFilters, (Activity) obj);
                return m5480translateActivityPredicates$lambda6;
            }
        };
    }
    ...
    public final Predicate<Intent> translateIntentPredicates(final Set<ActivityFilter> activityFilters) {
        ...
        return new Predicate() { // from class: androidx.window.embedding.a
            ...
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                boolean m5481translateIntentPredicates$lambda8;
                m5481translateIntentPredicates$lambda8 = EmbeddingAdapter.m5481translateIntentPredicates$lambda8(activityFilters, (Intent) obj);
                return m5481translateIntentPredicates$lambda8;
            }
        };
    }
    ...
    public final Predicate<WindowMetrics> translateParentMetricsPredicate(final SplitRule splitRule) {
        ...
        return new Predicate() { // from class: androidx.window.embedding.b
            ...
            @Override // java.util.function.Predicate
            public final boolean test(Object obj) {
                boolean m5482translateParentMetricsPredicate$lambda4;
                m5482translateParentMetricsPredicate$lambda4 = EmbeddingAdapter.m5482translateParentMetricsPredicate$lambda4(SplitRule.this, (WindowMetrics) obj);
                return m5482translateParentMetricsPredicate$lambda4;
            }
        };
    }
    ...
    private final SplitInfo translate(androidx.window.extensions.embedding.SplitInfo splitInfo) {
        ...
        AbstractC3255y.h(primaryActivityStack, "splitInfo.primaryActivityStack");
        boolean z9 = false;
        try {
        ...
        AbstractC3255y.h(activities, "primaryActivityStack.activities");
        ActivityStack activityStack = new ActivityStack(activities, z8);
        androidx.window.extensions.embedding.ActivityStack secondaryActivityStack = splitInfo.getSecondaryActivityStack();
        AbstractC3255y.h(secondaryActivityStack, "splitInfo.secondaryActivityStack");
        try {
            z9 = secondaryActivityStack.isEmpty();
        } catch (NoSuchMethodError unused2) {
        }
        List activities2 = secondaryActivityStack.getActivities();
        AbstractC3255y.h(activities2, "secondaryActivityStack.activities");
    ...
    public final Set<androidx.window.extensions.embedding.EmbeddingRule> translate(Set<? extends EmbeddingRule> rules) {
        ...
        for (EmbeddingRule embeddingRule : set) {
            if (embeddingRule instanceof SplitPairRule) {
                ...
                AbstractC3255y.h(build, "SplitPairRuleBuilder(\n  …                 .build()");
                ...
                AbstractC3255y.h(build, "SplitPlaceholderRuleBuil…                 .build()");
                ...
                AbstractC3255y.h(build, "ActivityRuleBuilder(\n   …                 .build()");
            } else {
