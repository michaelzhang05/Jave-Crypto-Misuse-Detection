...
public final class ActivityFilter {
    ...
    public ActivityFilter(ComponentName componentName, String str) {
        ...
        AbstractC3255y.h(packageName, "componentName.packageName");
        String className = componentName.getClassName();
        AbstractC3255y.h(className, "componentName.className");
    ...
    public boolean equals(Object obj) {
        ...
        if (AbstractC3255y.d(this.componentName, activityFilter.componentName) && AbstractC3255y.d(this.intentAction, activityFilter.intentAction)) {
            return true;
        }
        return false;
    }
    ...
    public final boolean matchesActivity(Activity activity) {
        ...
        if (MatcherUtils.INSTANCE.areActivityOrIntentComponentsMatching$window_release(activity, this.componentName)) {
            ...
            if (str != null) {
                ...
                if (AbstractC3255y.d(str, action)) {
                }
            }
            return true;
        }
    ...
    public final boolean matchesIntent(Intent intent) {
        ...
        String str = this.intentAction;
        if (str != null && !AbstractC3255y.d(str, intent.getAction())) {
            return false;
        }
        return true;
    }
