...
public final class HardwareFoldingFeature implements FoldingFeature {
    ...
    public HardwareFoldingFeature(Bounds featureBounds, Type type, FoldingFeature.State state) {
        AbstractC3255y.i(featureBounds, "featureBounds");
    ...
    public boolean equals(Object obj) {
        ...
        if (!AbstractC3255y.d(HardwareFoldingFeature.class, cls)) {
            return false;
        }
        if (obj != null) {
            HardwareFoldingFeature hardwareFoldingFeature = (HardwareFoldingFeature) obj;
            if (AbstractC3255y.d(this.featureBounds, hardwareFoldingFeature.featureBounds) && AbstractC3255y.d(this.type, hardwareFoldingFeature.type) && AbstractC3255y.d(getState(), hardwareFoldingFeature.getState())) {
                return true;
            }
            return false;
        }
    ...
    public boolean isSeparating() {
        ...
        if (AbstractC3255y.d(type, companion.getHINGE())) {
            return true;
        }
        if (AbstractC3255y.d(this.type, companion.getFOLD()) && AbstractC3255y.d(getState(), FoldingFeature.State.HALF_OPENED)) {
            return true;
        }
        return false;
    }
