...
public final class SafeWindowLayoutComponentProvider$isFoldingFeatureValid$1 extends AbstractC3256z implements Function0 {
    ...
    public final Boolean invoke() {
        ...
        AbstractC3255y.h(getBoundsMethod, "getBoundsMethod");
        ...
        if (doesReturn) {
            ...
            if (isPublic) {
                AbstractC3255y.h(getTypeMethod, "getTypeMethod");
                ...
                if (doesReturn2) {
                    ...
                    if (isPublic2) {
                        AbstractC3255y.h(getStateMethod, "getStateMethod");
