...
public final class SafeWindowLayoutComponentProvider$isWindowLayoutComponentValid$1 extends AbstractC3256z implements Function0 {
    ...
    public final Boolean invoke() {
        ...
        AbstractC3255y.h(addListenerMethod, "addListenerMethod");
        isPublic = safeWindowLayoutComponentProvider.isPublic(addListenerMethod);
        if (isPublic) {
            AbstractC3255y.h(removeListenerMethod, "removeListenerMethod");
