...
public final class SafeWindowLayoutComponentProvider$isWindowExtensionsValid$1 extends AbstractC3256z implements Function0 {
    ...
    public final Boolean invoke() {
        ...
        AbstractC3255y.h(getWindowLayoutComponentMethod, "getWindowLayoutComponentMethod");
        isPublic = safeWindowLayoutComponentProvider.isPublic(getWindowLayoutComponentMethod);
        if (isPublic) {
            AbstractC3255y.h(windowLayoutComponentClass, "windowLayoutComponentClass");
