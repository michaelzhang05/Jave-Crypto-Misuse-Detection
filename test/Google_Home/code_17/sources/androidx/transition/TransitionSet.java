...
public class TransitionSet extends Transition {
    ...
    @NonNull
    /* renamed from: clone */
    public Transition mo5477clone() {
        TransitionSet transitionSet = (TransitionSet) super.mo5477clone();
        transitionSet.mTransitions = new ArrayList<>();
        int size = this.mTransitions.size();
        for (int i8 = 0; i8 < size; i8++) {
            transitionSet.addTransitionInternal(this.mTransitions.get(i8).mo5477clone());
        }
