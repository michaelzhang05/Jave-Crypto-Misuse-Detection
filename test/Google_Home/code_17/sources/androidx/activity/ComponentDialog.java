...
public class ComponentDialog extends Dialog implements LifecycleOwner, OnBackPressedDispatcherOwner, SavedStateRegistryOwner {
    ...
    public void initializeViewTreeOwners() {
        ...
        AbstractC3255y.h(decorView, "window!!.decorView");
        ViewTreeLifecycleOwner.set(decorView, this);
        Window window2 = getWindow();
        AbstractC3255y.f(window2);
        View decorView2 = window2.getDecorView();
        AbstractC3255y.h(decorView2, "window!!.decorView");
        ViewTreeOnBackPressedDispatcherOwner.set(decorView2, this);
        Window window3 = getWindow();
        AbstractC3255y.f(window3);
        View decorView3 = window3.getDecorView();
        AbstractC3255y.h(decorView3, "window!!.decorView");
    ...
    public void onCreate(Bundle bundle) {
        ...
        if (Build.VERSION.SDK_INT >= 33) {
            ...
            AbstractC3255y.h(onBackInvokedDispatcher, "onBackInvokedDispatcher");
    ...
    public Bundle onSaveInstanceState() {
        ...
        AbstractC3255y.h(onSaveInstanceState, "super.onSaveInstanceState()");
    ...
    public /* synthetic */ ComponentDialog(Context context, int i8, int i9, AbstractC3247p abstractC3247p) {
