...
public final class FtsTableInfo {
    ...
    public static final class Companion {
            ...
            try {
                if (query.getColumnCount() > 0) {
                    ...
                    while (query.moveToNext()) {
                        ...
                        AbstractC3255y.h(string, "cursor.getString(nameIndex)");
                        b8.add(string);
                    }
                }
                I i8 = I.f8278a;
        ...
        public final Set<String> parseOptions(String createStatement) {
            ...
            boolean z8;
            Character ch;
            AbstractC3255y.i(createStatement, "createStatement");
            ...
            while (i10 < substring.length()) {
                ...
                if (charAt == '\'' || charAt == '\"' || charAt == '`') {
                    ...
                    while (i13 <= length) {
                        ...
                        if (AbstractC3255y.k(substring2.charAt(i8), 32) <= 0) {
                            z8 = true;
                        } else {
                            z8 = false;
                        }
    ...
    public boolean equals(Object obj) {
        ...
        if (!AbstractC3255y.d(this.name, ftsTableInfo.name) || !AbstractC3255y.d(this.columns, ftsTableInfo.columns)) {
            return false;
        }
        return AbstractC3255y.d(this.options, ftsTableInfo.options);
    }
    ...
    public FtsTableInfo(String name, Set<String> columns, String createSql) {
        ...
        AbstractC3255y.i(name, "name");
        AbstractC3255y.i(columns, "columns");
        AbstractC3255y.i(createSql, "createSql");
    }
}
