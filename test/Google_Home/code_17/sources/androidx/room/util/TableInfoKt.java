...
public final class TableInfoKt {
    ...
    private static final List<TableInfo.ForeignKeyWithSequence> readForeignKeyFieldMappings(Cursor cursor) {
        ...
        while (cursor.moveToNext()) {
            ...
            AbstractC3255y.h(string, "cursor.getString(fromColumnIndex)");
            String string2 = cursor.getString(columnIndex4);
            AbstractC3255y.h(string2, "cursor.getString(toColumnIndex)");
            c8.add(new TableInfo.ForeignKeyWithSequence(i8, i9, string, string2));
        }
        return AbstractC1378t.O0(AbstractC1378t.a(c8));
    }
        ...
        try {
            ...
            while (query.moveToNext()) {
                if (query.getInt(columnIndex2) == 0) {
                    ...
                    AbstractC3255y.h(string, "cursor.getString(tableColumnIndex)");
                    String string2 = query.getString(columnIndex4);
                    AbstractC3255y.h(string2, "cursor.getString(onDeleteColumnIndex)");
                    String string3 = query.getString(columnIndex5);
                    AbstractC3255y.h(string3, "cursor.getString(onUpdateColumnIndex)");
            ...
            if (columnIndex != -1 && columnIndex2 != -1 && columnIndex3 != -1 && columnIndex4 != -1) {
                ...
                while (query.moveToNext()) {
                    if (query.getInt(columnIndex2) >= 0) {
                        ...
                        AbstractC3255y.h(columnName, "columnName");
                        treeMap.put(valueOf, columnName);
                        treeMap2.put(Integer.valueOf(i8), str2);
                    }
                }
                Collection values = treeMap.values();
                AbstractC3255y.h(values, "columnsMap.values");
                List W02 = AbstractC1378t.W0(values);
                Collection values2 = treeMap2.values();
                AbstractC3255y.h(values2, "ordersMap.values");
                TableInfo.Index index = new TableInfo.Index(str, z8, W02, AbstractC1378t.W0(values2));
                b.a(query, null);
                return index;
            }
            b.a(query, null);
    ...
    private static final Set<TableInfo.Index> readIndices(SupportSQLiteDatabase supportSQLiteDatabase, String str) {
        ...
        try {
            ...
            if (columnIndex != -1 && columnIndex2 != -1 && columnIndex3 != -1) {
                Set b8 = a0.b();
                while (query.moveToNext()) {
                    if (AbstractC3255y.d("c", query.getString(columnIndex2))) {
                        String name = query.getString(columnIndex);
                        boolean z8 = true;
