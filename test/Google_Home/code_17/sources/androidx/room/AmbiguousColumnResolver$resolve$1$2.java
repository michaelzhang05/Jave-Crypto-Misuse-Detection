...
final class AmbiguousColumnResolver$resolve$1$2 extends AbstractC3256z implements Function1 {
    ...
    public final void invoke(List<Integer> indices) {
        ...
        if (it.hasNext()) {
            ...
            if (it2.hasNext()) {
                ...
                this.$mappingMatches.get(this.$mappingIndex).add(new AmbiguousColumnResolver.Match(new g6.i(intValue, intValue3), indices));
                return;
            }
