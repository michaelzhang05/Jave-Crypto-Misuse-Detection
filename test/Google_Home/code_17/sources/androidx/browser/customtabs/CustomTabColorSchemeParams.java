...
public final class CustomTabColorSchemeParams {
    ...
    public static final class Builder {
        ...
        public Builder setNavigationBarColor(@ColorInt int i8) {
            this.mNavigationBarColor = Integer.valueOf(i8 | ViewCompat.MEASURED_STATE_MASK);
            return this;
        }

        @NonNull
        public Builder setNavigationBarDividerColor(@ColorInt int i8) {
            this.mNavigationBarDividerColor = Integer.valueOf(i8);
            return this;
        }

        @NonNull
        public Builder setSecondaryToolbarColor(@ColorInt int i8) {
            this.mSecondaryToolbarColor = Integer.valueOf(i8);
            return this;
        }

        @NonNull
        public Builder setToolbarColor(@ColorInt int i8) {
            this.mToolbarColor = Integer.valueOf(i8 | ViewCompat.MEASURED_STATE_MASK);
            return this;
        }
    }
