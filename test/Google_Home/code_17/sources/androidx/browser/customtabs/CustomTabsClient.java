...
public class CustomTabsClient {
    ...
    private a.AbstractBinderC0269a createCallbackWrapper(@Nullable final CustomTabsCallback customTabsCallback) {
        return new a.AbstractBinderC0269a() { // from class: androidx.browser.customtabs.CustomTabsClient.2
    ...
    private CustomTabsSession newSessionInternal(@Nullable CustomTabsCallback customTabsCallback, @Nullable PendingIntent pendingIntent) {
        boolean newSession;
        a.AbstractBinderC0269a createCallbackWrapper = createCallbackWrapper(customTabsCallback);
        try {
