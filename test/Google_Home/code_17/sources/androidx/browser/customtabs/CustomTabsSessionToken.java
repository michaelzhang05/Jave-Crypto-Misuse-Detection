...
public class CustomTabsSessionToken {
    ...
    /* loaded from: classes.dex */
    static class MockCallback extends a.AbstractBinderC0269a {
        @Override // android.support.customtabs.a.AbstractBinderC0269a, android.os.IInterface
    ...
    public static CustomTabsSessionToken getSessionTokenFromIntent(@NonNull Intent intent) {
        ...
        if (binder != null) {
            aVar = a.AbstractBinderC0269a.asInterface(binder);
        }
