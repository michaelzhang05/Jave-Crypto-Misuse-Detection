...
public final class SparseIntArrayKt {
    ...
    public static final void forEach(SparseIntArray sparseIntArray, InterfaceC1668n interfaceC1668n) {
        int size = sparseIntArray.size();
        for (int i8 = 0; i8 < size; i8++) {
            interfaceC1668n.invoke(Integer.valueOf(sparseIntArray.keyAt(i8)), Integer.valueOf(sparseIntArray.valueAt(i8)));
        }
    }
