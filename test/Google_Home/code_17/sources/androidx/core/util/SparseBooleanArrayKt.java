...
public final class SparseBooleanArrayKt {
    ...
    public static final void forEach(SparseBooleanArray sparseBooleanArray, InterfaceC1668n interfaceC1668n) {
        int size = sparseBooleanArray.size();
        for (int i8 = 0; i8 < size; i8++) {
            interfaceC1668n.invoke(Integer.valueOf(sparseBooleanArray.keyAt(i8)), Boolean.valueOf(sparseBooleanArray.valueAt(i8)));
        }
    }
