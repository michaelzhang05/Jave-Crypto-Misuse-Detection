...
public final class SparseLongArrayKt {
    ...
    public static final void forEach(SparseLongArray sparseLongArray, InterfaceC1668n interfaceC1668n) {
        int size = sparseLongArray.size();
        for (int i8 = 0; i8 < size; i8++) {
            interfaceC1668n.invoke(Integer.valueOf(sparseLongArray.keyAt(i8)), Long.valueOf(sparseLongArray.valueAt(i8)));
        }
    }
