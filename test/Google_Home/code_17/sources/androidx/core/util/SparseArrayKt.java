...
public final class SparseArrayKt {
    ...
    public static final <T> void forEach(SparseArray<T> sparseArray, InterfaceC1668n interfaceC1668n) {
        int size = sparseArray.size();
        for (int i8 = 0; i8 < size; i8++) {
            interfaceC1668n.invoke(Integer.valueOf(sparseArray.keyAt(i8)), sparseArray.valueAt(i8));
        }
    }
    ...
    public static final <T> boolean remove(SparseArray<T> sparseArray, int i8, T t8) {
        ...
        if (indexOfKey >= 0 && AbstractC3255y.d(t8, sparseArray.valueAt(indexOfKey))) {
