...
public final class LongSparseArrayKt {
    ...
    public static final <T> void forEach(LongSparseArray<T> longSparseArray, InterfaceC1668n interfaceC1668n) {
        int size = longSparseArray.size();
        for (int i8 = 0; i8 < size; i8++) {
            interfaceC1668n.invoke(Long.valueOf(longSparseArray.keyAt(i8)), longSparseArray.valueAt(i8));
        }
    }
    ...
    public static final <T> boolean remove(LongSparseArray<T> longSparseArray, long j8, T t8) {
        ...
        if (indexOfKey >= 0 && AbstractC3255y.d(t8, longSparseArray.valueAt(indexOfKey))) {
