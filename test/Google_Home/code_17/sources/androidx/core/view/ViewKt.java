...
public final class ViewKt {
    ...
    public static final InterfaceC2998g getAllViews(View view) {
        return AbstractC3001j.b(new ViewKt$allViews$1(view, null));
    }

    public static final InterfaceC2998g getAncestors(View view) {
        return AbstractC3001j.h(view.getParent(), ViewKt$ancestors$1.INSTANCE);
    }
    ...
    public static final /* synthetic */ <T extends ViewGroup.LayoutParams> void updateLayoutParamsTyped(View view, Function1 function1) {
        ViewGroup.LayoutParams layoutParams = view.getLayoutParams();
        AbstractC3255y.n(1, ExifInterface.GPS_DIRECTION_TRUE);
        function1.invoke(layoutParams);
        view.setLayoutParams(layoutParams);
    }
