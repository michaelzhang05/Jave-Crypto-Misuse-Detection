...
public final class ViewGroupKt {
    ...
    public static final void forEachIndexed(ViewGroup viewGroup, InterfaceC1668n interfaceC1668n) {
        int childCount = viewGroup.getChildCount();
        for (int i8 = 0; i8 < childCount; i8++) {
            interfaceC1668n.invoke(Integer.valueOf(i8), viewGroup.getChildAt(i8));
        }
    }
    ...
    public static final InterfaceC2998g getChildren(final ViewGroup viewGroup) {
        return new InterfaceC2998g() { // from class: androidx.core.view.ViewGroupKt$children$1
    ...
    public static final InterfaceC2998g getDescendants(final ViewGroup viewGroup) {
        return new InterfaceC2998g() { // from class: androidx.core.view.ViewGroupKt$special$$inlined$Sequence$1
            @Override // i6.InterfaceC2998g
            public Iterator<View> iterator() {
    ...
    public static final g6.i getIndices(ViewGroup viewGroup) {
        return g6.m.s(0, viewGroup.getChildCount());
    }
