...
class FindAddress {
    ...
    public static class ZipRange {
        ...
        ZipRange(int i8, int i9, int i10, int i11) {
            this.mLow = i8;
            this.mHigh = i9;
    ...
    */
    ...
    public static MatchResult matchHouseNumber(String str, int i8) {
        ...
        Matcher region = sHouseNumberRe.matcher(str).region(i8, str.length());
        if (region.lookingAt()) {
    ...
    public static MatchResult matchState(String str, int i8) {
        ...
        Matcher region = sStateRe.matcher(str).region(i8, str.length());
        if (!region.lookingAt()) {
            return null;
        }
