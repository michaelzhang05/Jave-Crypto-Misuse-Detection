        ...
        for (r rVar : rVarArr) {
            ...
            if (b8 == null) {
                ...
                if (Parcelable.class.isAssignableFrom(componentType)) {
                    AbstractC3255y.g(b8, "null cannot be cast to non-null type kotlin.Array<android.os.Parcelable>");
                    bundle.putParcelableArray(str, (Parcelable[]) b8);
                } else if (String.class.isAssignableFrom(componentType)) {
                    AbstractC3255y.g(b8, "null cannot be cast to non-null type kotlin.Array<kotlin.String>");
                    bundle.putStringArray(str, (String[]) b8);
                } else if (CharSequence.class.isAssignableFrom(componentType)) {
                    AbstractC3255y.g(b8, "null cannot be cast to non-null type kotlin.Array<kotlin.CharSequence>");
