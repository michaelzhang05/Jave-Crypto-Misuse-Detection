...
public abstract class JobIntentService extends Service {
    ...
    public final class CompatWorkItem implements GenericWorkItem {
        ...
        CompatWorkItem(Intent intent, int i8) {
            this.mIntent = intent;
            this.mStartId = i8;
        }
    ...
    public static final class JobWorkEnqueuer extends WorkEnqueuer {
        ...
        JobWorkEnqueuer(Context context, ComponentName componentName, int i8) {
            super(componentName);
            ensureJobId(i8);
    ...
    static WorkEnqueuer getWorkEnqueuer(Context context, ComponentName componentName, boolean z8, int i8) {
    ...
    void ensureProcessorRunningLocked(boolean z8) {
        if (this.mCurProcessor == null) {
            this.mCurProcessor = new CommandProcessor();
            WorkEnqueuer workEnqueuer = this.mCompatWorkEnqueuer;
            if (workEnqueuer != null && z8) {
