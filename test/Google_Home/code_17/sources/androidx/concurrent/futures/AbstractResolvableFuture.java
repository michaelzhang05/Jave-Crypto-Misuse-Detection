...
public abstract class AbstractResolvableFuture<V> implements InterfaceFutureC4218d {
    ...
    public static final class SetFuture<V> implements Runnable {
        final InterfaceFutureC4218d future;
        final AbstractResolvableFuture<V> owner;

        SetFuture(AbstractResolvableFuture<V> abstractResolvableFuture, InterfaceFutureC4218d interfaceFutureC4218d) {
            this.owner = abstractResolvableFuture;
            this.future = interfaceFutureC4218d;
        }
    ...
    static Object getFutureValue(InterfaceFutureC4218d interfaceFutureC4218d) {
        if (interfaceFutureC4218d instanceof AbstractResolvableFuture) {
            Object obj = ((AbstractResolvableFuture) interfaceFutureC4218d).value;
            if (obj instanceof Cancellation) {
        ...
        boolean isCancelled = interfaceFutureC4218d.isCancelled();
        if ((!GENERATE_CANCELLATION_CAUSES) & isCancelled) {
            return Cancellation.CAUSELESS_CANCELLED;
        }
        try {
            Object uninterruptibly = getUninterruptibly(interfaceFutureC4218d);
            ...
            if (!isCancelled) {
                return new Failure(new IllegalArgumentException("get() threw CancellationException, despite reporting isCancelled() == false: " + interfaceFutureC4218d, e8));
            }
    ...
    @Override // z0.InterfaceFutureC4218d
        ...
        if (z9 | (obj instanceof SetFuture)) {
            ...
            while (true) {
                if (ATOMIC_HELPER.casValue(abstractResolvableFuture, obj, cancellation)) {
                    ...
                    InterfaceFutureC4218d interfaceFutureC4218d = ((SetFuture) obj).future;
                    if (interfaceFutureC4218d instanceof AbstractResolvableFuture) {
                        abstractResolvableFuture = (AbstractResolvableFuture) interfaceFutureC4218d;
                        ...
                        interfaceFutureC4218d.cancel(z8);
                        return true;
                    }
                } else {
                    obj = abstractResolvableFuture.value;
    ...
    public boolean setFuture(InterfaceFutureC4218d interfaceFutureC4218d) {
        Failure failure;
        checkNotNull(interfaceFutureC4218d);
        Object obj = this.value;
        if (obj == null) {
            if (interfaceFutureC4218d.isDone()) {
                if (!ATOMIC_HELPER.casValue(this, null, getFutureValue(interfaceFutureC4218d))) {
                    return false;
                }
                complete(this);
                return true;
            }
            SetFuture setFuture = new SetFuture(this, interfaceFutureC4218d);
            if (ATOMIC_HELPER.casValue(this, null, setFuture)) {
                try {
                    interfaceFutureC4218d.addListener(setFuture, DirectExecutor.INSTANCE);
                } catch (Throwable th) {
                    try {
        ...
        if (obj instanceof Cancellation) {
            interfaceFutureC4218d.cancel(((Cancellation) obj).wasInterrupted);
        }
        return false;
    }
