...
public class AlertDialog extends AppCompatDialog implements DialogInterface {
    ...
    public static class Builder {
        ...
        private final AlertController.AlertParams f14496P;
        ...
        public AlertDialog create() {
            AlertDialog alertDialog = new AlertDialog(this.f14496P.mContext, this.mTheme);
            this.f14496P.apply(alertDialog.mAlert);
            alertDialog.setCancelable(this.f14496P.mCancelable);
            if (this.f14496P.mCancelable) {
                alertDialog.setCanceledOnTouchOutside(true);
            }
            alertDialog.setOnCancelListener(this.f14496P.mOnCancelListener);
            alertDialog.setOnDismissListener(this.f14496P.mOnDismissListener);
            DialogInterface.OnKeyListener onKeyListener = this.f14496P.mOnKeyListener;
        ...
        public Context getContext() {
            return this.f14496P.mContext;
        }

        public Builder setAdapter(ListAdapter listAdapter, DialogInterface.OnClickListener onClickListener) {
            AlertController.AlertParams alertParams = this.f14496P;
        ...
        public Builder setCustomTitle(@Nullable View view) {
            this.f14496P.mCustomTitleView = view;
            return this;
        }

        public Builder setIcon(@DrawableRes int i8) {
            this.f14496P.mIconId = i8;
            return this;
        }

        public Builder setIconAttribute(@AttrRes int i8) {
            TypedValue typedValue = new TypedValue();
            this.f14496P.mContext.getTheme().resolveAttribute(i8, typedValue, true);
            this.f14496P.mIconId = typedValue.resourceId;
            return this;
        }

        @Deprecated
        public Builder setInverseBackgroundForced(boolean z8) {
            this.f14496P.mForceInverseBackground = z8;
            return this;
        }
        ...
        public Builder setItems(@ArrayRes int i8, DialogInterface.OnClickListener onClickListener) {
            ...
            this.f14496P.mOnClickListener = onClickListener;
            return this;
        }
        ...
        public Builder setMultiChoiceItems(@ArrayRes int i8, boolean[] zArr, DialogInterface.OnMultiChoiceClickListener onMultiChoiceClickListener) {
            AlertController.AlertParams alertParams = this.f14496P;
            alertParams.mItems = alertParams.mContext.getResources().getTextArray(i8);
            AlertController.AlertParams alertParams2 = this.f14496P;
        ...
        public Builder setNegativeButton(@StringRes int i8, DialogInterface.OnClickListener onClickListener) {
            ...
            this.f14496P.mNegativeButtonListener = onClickListener;
            return this;
        }

        public Builder setNegativeButtonIcon(Drawable drawable) {
            this.f14496P.mNegativeButtonIcon = drawable;
            return this;
        }
        ...
        public Builder setNeutralButton(@StringRes int i8, DialogInterface.OnClickListener onClickListener) {
            ...
            this.f14496P.mNeutralButtonListener = onClickListener;
            return this;
        }

        public Builder setNeutralButtonIcon(Drawable drawable) {
            this.f14496P.mNeutralButtonIcon = drawable;
            return this;
        }

        public Builder setOnCancelListener(DialogInterface.OnCancelListener onCancelListener) {
            this.f14496P.mOnCancelListener = onCancelListener;
            return this;
        }

        public Builder setOnDismissListener(DialogInterface.OnDismissListener onDismissListener) {
            this.f14496P.mOnDismissListener = onDismissListener;
            return this;
        }

        public Builder setOnItemSelectedListener(AdapterView.OnItemSelectedListener onItemSelectedListener) {
            this.f14496P.mOnItemSelectedListener = onItemSelectedListener;
            return this;
        }

        public Builder setOnKeyListener(DialogInterface.OnKeyListener onKeyListener) {
            this.f14496P.mOnKeyListener = onKeyListener;
            return this;
        }
        ...
        public Builder setPositiveButton(@StringRes int i8, DialogInterface.OnClickListener onClickListener) {
            ...
            this.f14496P.mPositiveButtonListener = onClickListener;
            return this;
        }

        public Builder setPositiveButtonIcon(Drawable drawable) {
            this.f14496P.mPositiveButtonIcon = drawable;
            return this;
        }

        @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP_PREFIX})
        public Builder setRecycleOnMeasureEnabled(boolean z8) {
            this.f14496P.mRecycleOnMeasure = z8;
            return this;
        }
        ...
        public Builder(@NonNull Context context, @StyleRes int i8) {
            this.f14496P = new AlertController.AlertParams(new ContextThemeWrapper(context, AlertDialog.resolveDialogTheme(context, i8)));
            this.mTheme = i8;
        }

        public Builder setIcon(@Nullable Drawable drawable) {
            this.f14496P.mIcon = drawable;
            return this;
        }

        public Builder setMessage(@Nullable CharSequence charSequence) {
            this.f14496P.mMessage = charSequence;
            return this;
        }

        public Builder setTitle(@Nullable CharSequence charSequence) {
            this.f14496P.mTitle = charSequence;
            return this;
        }
