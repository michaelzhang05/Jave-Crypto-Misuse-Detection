...
class TwilightCalculator {
    ...
    private static final float f14499C1 = 0.0334196f;

    /* renamed from: C2, reason: collision with root package name */
    private static final float f14500C2 = 3.49066E-4f;

    /* renamed from: C3, reason: collision with root package name */
    private static final float f14501C3 = 5.236E-6f;
    public static final int DAY = 0;
    private static final float DEGREES_TO_RADIANS = 0.017453292f;

    /* renamed from: J0, reason: collision with root package name */
    private static final float f14502J0 = 9.0E-4f;
    ...
    public void calculateTwilight(long j8, double d8, double d9) {
        ...
        double round = ((float) Math.round((r3 - f14502J0) - r7)) + f14502J0 + ((-d9) / 360.0d) + (Math.sin(d10) * 0.0053d) + (Math.sin(2.0d * sin) * (-0.0069d));
