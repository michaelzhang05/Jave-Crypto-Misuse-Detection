...
public class SupportMenuInflater extends MenuInflater {
    ...
    public class MenuState {
        ...
        private void setItem(MenuItem menuItem) {
            ...
            enabled.setCheckable(z8).setTitleCondensed(this.itemTitleCondensed).setIcon(this.itemIconResId);
        ...
        public void readItem(AttributeSet attributeSet) {
            ...
            if (obtainStyledAttributes.hasValue(i8)) {
                this.itemCheckable = obtainStyledAttributes.getBoolean(i8, false) ? 1 : 0;
            } else {
            ...
            if (obtainStyledAttributes.hasValue(i9)) {
                this.itemIconTintMode = DrawableUtils.parseTintMode(obtainStyledAttributes.getInt(i9, -1), this.itemIconTintMode);
            } else {
                this.itemIconTintMode = null;
            }
            int i10 = R.styleable.MenuItem_iconTint;
            if (obtainStyledAttributes.hasValue(i10)) {
                this.itemIconTintList = obtainStyledAttributes.getColorStateList(i10);
            } else {
