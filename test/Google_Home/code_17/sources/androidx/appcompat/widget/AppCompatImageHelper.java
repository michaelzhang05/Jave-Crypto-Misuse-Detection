    ...
    public void loadFromAttributes(AttributeSet attributeSet, int i8) {
        ...
        try {
            ...
            if (obtainStyledAttributes.hasValue(i9)) {
                ImageViewCompat.setImageTintList(this.mView, obtainStyledAttributes.getColorStateList(i9));
            }
            int i10 = R.styleable.AppCompatImageView_tintMode;
            if (obtainStyledAttributes.hasValue(i10)) {
                ImageViewCompat.setImageTintMode(this.mView, DrawableUtils.parseTintMode(obtainStyledAttributes.getInt(i10, -1), null));
            }
