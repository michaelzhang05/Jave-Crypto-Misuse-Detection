...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent, NestedScrollingParent2, NestedScrollingParent3 {
    ...
    */
    ...
    public void draw(@NonNull Canvas canvas) {
        ...
        if (this.mWindowContentOverlay != null) {
            if (this.mActionBarTop.getVisibility() == 0) {
                i8 = (int) (this.mActionBarTop.getBottom() + this.mActionBarTop.getTranslationY() + 0.5f);
            } else {
                i8 = 0;
            }
            this.mWindowContentOverlay.setBounds(0, i8, getWidth(), this.mWindowContentOverlay.getIntrinsicHeight() + i8);
    ...
    protected void onMeasure(int i8, int i9) {
        ...
        if (!this.mOverlayMode && !z8 && decorFitsSystemWindows()) {
    ...
    public boolean onNestedFling(View view, float f8, float f9, boolean z8) {
        if (this.mHideOnContentScroll && z8) {
    ...
    public void setHasNonEmbeddedTabs(boolean z8) {
        this.mHasNonEmbeddedTabs = z8;
    }

    public void setHideOnContentScrollEnabled(boolean z8) {
        if (z8 != this.mHideOnContentScroll) {
