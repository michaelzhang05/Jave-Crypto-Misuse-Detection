...
public class ActionMenuPresenter extends BaseMenuPresenter implements ActionProvider.SubUiVisibilityListener {
    ...
    public class OverflowPopup extends MenuPopupHelper {
        public OverflowPopup(Context context, MenuBuilder menuBuilder, View view, boolean z8) {
    ...
    public boolean flagActionItems() {
        ...
        while (i20 < i8) {
            ...
            if (menuItemImpl2.requiresActionButton()) {
                ...
                if ((i18 > 0 || z11) && i14 > 0 && (!actionMenuPresenter.mStrictWidthLimit || i10 > 0)) {
                    z8 = true;
                } else {
                    z8 = false;
                }
                ...
                if (z8) {
                    ...
                    if (!actionMenuPresenter.mStrictWidthLimit ? i14 + i21 > 0 : i14 >= 0) {
                        z9 = true;
                    } else {
                        z9 = false;
                    }
    ...
    public boolean onSubMenuSelected(SubMenuBuilder subMenuBuilder) {
        ...
        actionButtonSubmenu.setForceShowIcon(z8);
    ...
    public void updateMenuView(boolean z8) {
        ...
        if (this.mReserveOverflow && arrayList != null) {
            ...
            if (size2 == 1) {
                z9 = !arrayList.get(0).isActionViewExpanded();
            } else if (size2 > 0) {
                z9 = true;
            }
        }
