...
public final class SavedStateRegistry {
    ...
    public final SavedStateProvider getSavedStateProvider(String key) {
        ...
        while (it.hasNext()) {
            ...
            AbstractC3255y.h(components, "components");
            String key2 = components.getKey();
            SavedStateProvider value = components.getValue();
            if (AbstractC3255y.d(key2, key)) {
                return value;
            }
        }
        return null;
    ...
    public final void performSave(Bundle outBundle) {
        ...
        AbstractC3255y.h(iteratorWithAdditions, "this.components.iteratorWithAdditions()");
        ...
        if (this.isAllowingSavingState) {
            ...
            try {
                ...
                if (savedStateProvider2 != null) {
                    ...
                    AbstractC3255y.h(name, "clazz.name");
