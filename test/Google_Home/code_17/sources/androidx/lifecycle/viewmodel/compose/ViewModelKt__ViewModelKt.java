...
public final /* synthetic */ class ViewModelKt__ViewModelKt {
    public static final <VM extends ViewModel> VM get(ViewModelStoreOwner viewModelStoreOwner, InterfaceC2963c modelClass, String str, ViewModelProvider.Factory factory, CreationExtras extras) {
        ViewModelProvider create$default;
        AbstractC3255y.i(viewModelStoreOwner, "<this>");
    ...
    public static /* synthetic */ ViewModel get$default(ViewModelStoreOwner viewModelStoreOwner, InterfaceC2963c interfaceC2963c, String str, ViewModelProvider.Factory factory, CreationExtras creationExtras, int i8, Object obj) {
        if ((i8 & 2) != 0) {
            str = null;
        }
        if ((i8 & 4) != 0) {
        ...
        return ViewModelKt.get(viewModelStoreOwner, interfaceC2963c, str, factory, creationExtras);
    }
    ...
    @Composable
    public static final <VM extends ViewModel> VM viewModel(InterfaceC2963c modelClass, ViewModelStoreOwner viewModelStoreOwner, String str, ViewModelProvider.Factory factory, CreationExtras creationExtras, Composer composer, int i8, int i9) {
        AbstractC3255y.i(modelClass, "modelClass");
