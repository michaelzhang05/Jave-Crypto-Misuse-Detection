...
public final class ViewModelProviders {
    ...
    public final <VM extends ViewModel> VM createViewModelFromInitializers$lifecycle_viewmodel_release(InterfaceC2963c modelClass, CreationExtras extras, ViewModelInitializer<?>... initializers) {
        VM vm;
        ...
        while (true) {
            ...
            if (i8 < length) {
                ...
                if (AbstractC3255y.d(viewModelInitializer.getClazz$lifecycle_viewmodel_release(), modelClass)) {
                    break;
                }
                i8++;
            } else {
    ...
    public final <T extends ViewModel> String getDefaultKey$lifecycle_viewmodel_release(InterfaceC2963c modelClass) {
        AbstractC3255y.i(modelClass, "modelClass");
