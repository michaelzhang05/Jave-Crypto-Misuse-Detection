...
public class LifecycleRegistry extends Lifecycle {
    ...
    public static final class Companion {
        ...
        public final Lifecycle.State min$lifecycle_runtime_release(Lifecycle.State state1, Lifecycle.State state) {
            AbstractC3255y.i(state1, "state1");
    ...
    public static final class ObserverWithState {
        ...
        public ObserverWithState(LifecycleObserver lifecycleObserver, Lifecycle.State initialState) {
            AbstractC3255y.i(initialState, "initialState");
            AbstractC3255y.f(lifecycleObserver);
        ...
        public final void dispatchEvent(LifecycleOwner lifecycleOwner, Lifecycle.Event event) {
            ...
            AbstractC3255y.f(lifecycleOwner);
        ...
        public final void setLifecycleObserver(LifecycleEventObserver lifecycleEventObserver) {
            AbstractC3255y.i(lifecycleEventObserver, "<set-?>");
    ...
    public /* synthetic */ LifecycleRegistry(LifecycleOwner lifecycleOwner, boolean z8, AbstractC3247p abstractC3247p) {
    ...
    private final void backwardPass(LifecycleOwner lifecycleOwner) {
        ...
        AbstractC3255y.h(descendingIterator, "observerMap.descendingIterator()");
    ...
    private final void forwardPass(LifecycleOwner lifecycleOwner) {
        ...
        AbstractC3255y.h(iteratorWithAdditions, "observerMap.iteratorWithAdditions()");
    ...
    @Override // androidx.lifecycle.Lifecycle
    public InterfaceC3698L getCurrentStateFlow() {
        return AbstractC3708h.b(this._currentStateFlow);
    }
    ...
    private LifecycleRegistry(LifecycleOwner lifecycleOwner, boolean z8) {
        ...
        this._currentStateFlow = AbstractC3700N.a(state);
    }
