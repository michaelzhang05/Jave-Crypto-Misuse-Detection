...
public final class SavedStateHandle {
    ...
    public final <T> MutableLiveData<T> getLiveData(String key) {
        ...
        AbstractC3255y.g(liveDataInternal, "null cannot be cast to non-null type androidx.lifecycle.MutableLiveData<T of androidx.lifecycle.SavedStateHandle.getLiveData>");
        return liveDataInternal;
    }

    @MainThread
    public final <T> InterfaceC3698L getStateFlow(String key, T t8) {
        AbstractC3255y.i(key, "key");
        ...
        if (wVar == null) {
            ...
            wVar = AbstractC3700N.a(this.regular.get(key));
            this.flows.put(key, wVar);
            map.put(key, wVar);
        }
        InterfaceC3698L b8 = AbstractC3708h.b(wVar);
        AbstractC3255y.g(b8, "null cannot be cast to non-null type kotlinx.coroutines.flow.StateFlow<T of androidx.lifecycle.SavedStateHandle.getStateFlow>");
        return b8;
    }
    ...
    public static final class SavingStateLiveData<T> extends MutableLiveData<T> {
        ...
        public void setValue(T t8) {
            ...
            if (savedStateHandle != null) {
                ...
                w wVar = (w) savedStateHandle.flows.get(this.key);
                if (wVar != null) {
                    wVar.setValue(t8);
                }
            }
