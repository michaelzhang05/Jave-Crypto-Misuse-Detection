...
public final class FrameworkSQLiteOpenHelper implements SupportSQLiteOpenHelper {
    ...
    private final InterfaceC1355k lazyDelegate;
    ...
    public static final class OpenHelper extends SQLiteOpenHelper {
        ...
        public static final class CallbackException extends RuntimeException {
            ...
            public CallbackException(CallbackName callbackName, Throwable cause) {
                super(cause);
                AbstractC3255y.i(callbackName, "callbackName");
        ...
        public static final class Companion {
            ...
            public final FrameworkSQLiteDatabase getWrappedDb(DBRefHolder refHolder, SQLiteDatabase sqLiteDatabase) {
                AbstractC3255y.i(refHolder, "refHolder");
        ...
        public OpenHelper(Context context, String str, final DBRefHolder dbRef, final SupportSQLiteOpenHelper.Callback callback, boolean z8) {
            ...
            if (str == null) {
                ...
                AbstractC3255y.h(str, "randomUUID().toString()");
            }
            File cacheDir = context.getCacheDir();
            AbstractC3255y.h(cacheDir, "context.cacheDir");
        ...
        private final SQLiteDatabase getWritableOrReadableDatabase(boolean z8) {
            if (z8) {
                ...
                AbstractC3255y.h(writableDatabase, "{\n                super.…eDatabase()\n            }");
                return writableDatabase;
            }
            SQLiteDatabase readableDatabase = super.getReadableDatabase();
            AbstractC3255y.h(readableDatabase, "{\n                super.…eDatabase()\n            }");
    ...
    public /* synthetic */ FrameworkSQLiteOpenHelper(Context context, String str, SupportSQLiteOpenHelper.Callback callback, boolean z8, boolean z9, int i8, AbstractC3247p abstractC3247p) {
