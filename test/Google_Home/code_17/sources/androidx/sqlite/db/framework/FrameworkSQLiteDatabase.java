...
public final class FrameworkSQLiteDatabase implements SupportSQLiteDatabase {
    ...
    public static final Cursor query$lambda$0(InterfaceC1670p tmp0, SQLiteDatabase sQLiteDatabase, SQLiteCursorDriver sQLiteCursorDriver, String str, SQLiteQuery sQLiteQuery) {
    ...
    public SupportSQLiteStatement compileStatement(String sql) {
        ...
        AbstractC3255y.h(compileStatement, "delegate.compileStatement(sql)");
    ...
    public final boolean isDelegate(SQLiteDatabase sqLiteDatabase) {
        AbstractC3255y.i(sqLiteDatabase, "sqLiteDatabase");
        return AbstractC3255y.d(this.delegate, sqLiteDatabase);
    }
    ...
    public void m5476setMaximumSize(long j8) {
    ...
    public Cursor query(SupportSQLiteQuery query) {
        ...
        Cursor rawQueryWithFactory = this.delegate.rawQueryWithFactory(new SQLiteDatabase.CursorFactory() { // from class: androidx.sqlite.db.framework.b
            ...
            public final Cursor newCursor(SQLiteDatabase sQLiteDatabase, SQLiteCursorDriver sQLiteCursorDriver, String str, SQLiteQuery sQLiteQuery) {
                ...
                query$lambda$0 = FrameworkSQLiteDatabase.query$lambda$0(InterfaceC1670p.this, sQLiteDatabase, sQLiteCursorDriver, str, sQLiteQuery);
                return query$lambda$0;
            }
        }, query.getSql(), EMPTY_STRING_ARRAY, null);
        AbstractC3255y.h(rawQueryWithFactory, "delegate.rawQueryWithFac…EMPTY_STRING_ARRAY, null)");
    ...
    public Cursor query(final SupportSQLiteQuery query, CancellationSignal cancellationSignal) {
        ...
        AbstractC3255y.f(cancellationSignal);
