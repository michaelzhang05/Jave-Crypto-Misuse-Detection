...
public interface SupportSQLiteOpenHelper extends Closeable {
        ...
        private final void deleteDatabaseFile(String str) {
            ...
            if (!n.s(str, ":memory:", true)) {
                ...
                while (i9 <= length) {
                    ...
                    if (AbstractC3255y.k(str.charAt(i8), 32) <= 0) {
                        z8 = true;
                    } else {
                        z8 = false;
                    }
    ...
    public static final class Configuration {
        ...
        public /* synthetic */ Configuration(Context context, String str, Callback callback, boolean z8, boolean z9, int i8, AbstractC3247p abstractC3247p) {
