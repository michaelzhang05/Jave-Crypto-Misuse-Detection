...
class NonOverlappingLinearLayoutWithForeground extends LinearLayout {
    ...
    protected void onLayout(boolean z8, int i8, int i9, int i10, int i11) {
        ...
        this.mForegroundBoundsChanged = z8 | this.mForegroundBoundsChanged;
    }
    ...
    public NonOverlappingLinearLayoutWithForeground(Context context, AttributeSet attributeSet, int i8) {
