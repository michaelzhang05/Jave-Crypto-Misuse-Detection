...
public final class JobListenableFuture<R> implements InterfaceFutureC4218d {
    ...
    public JobListenableFuture(InterfaceC3390x0 job, SettableFuture<R> underlying) {
        AbstractC3255y.i(job, "job");
        AbstractC3255y.i(underlying, "underlying");
        this.job = job;
        this.underlying = underlying;
        job.s(new AnonymousClass1(this));
    }
    ...
    */
    public /* synthetic */ JobListenableFuture(l6.InterfaceC3390x0 r1, androidx.work.impl.utils.futures.SettableFuture r2, int r3, kotlin.jvm.internal.AbstractC3247p r4) {
        /*
            r0 = this;
            r3 = r3 & 2
            if (r3 == 0) goto Ld
        ...
        Ld:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.work.JobListenableFuture.<init>(l6.x0, androidx.work.impl.utils.futures.SettableFuture, int, kotlin.jvm.internal.p):void");
    }
}
