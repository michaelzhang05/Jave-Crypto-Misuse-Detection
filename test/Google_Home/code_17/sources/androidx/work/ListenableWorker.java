...
public abstract class ListenableWorker {
    ...
    @NonNull
    public final InterfaceFutureC4218d setForegroundAsync(@NonNull ForegroundInfo foregroundInfo) {
        return this.mWorkerParams.getForegroundUpdater().setForegroundAsync(getApplicationContext(), getId(), foregroundInfo);
    }

    @NonNull
    public InterfaceFutureC4218d setProgressAsync(@NonNull Data data) {
    ...
    @NonNull
    @MainThread
    public abstract InterfaceFutureC4218d startWork();
