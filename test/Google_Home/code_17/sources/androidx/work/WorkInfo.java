...
public final class WorkInfo {
    ...
    public static final class PeriodicityInfo {
        ...
        public boolean equals(Object obj) {
            ...
            if (obj == null || !AbstractC3255y.d(PeriodicityInfo.class, obj.getClass())) {
                return false;
            }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj == null || !AbstractC3255y.d(WorkInfo.class, obj.getClass())) {
            return false;
        }
        WorkInfo workInfo = (WorkInfo) obj;
        if (this.runAttemptCount != workInfo.runAttemptCount || this.generation != workInfo.generation || !AbstractC3255y.d(this.id, workInfo.id) || this.state != workInfo.state || !AbstractC3255y.d(this.outputData, workInfo.outputData) || !AbstractC3255y.d(this.constraints, workInfo.constraints) || this.initialDelayMillis != workInfo.initialDelayMillis || !AbstractC3255y.d(this.periodicityInfo, workInfo.periodicityInfo) || this.nextScheduleTimeMillis != workInfo.nextScheduleTimeMillis || this.stopReason != workInfo.stopReason || !AbstractC3255y.d(this.tags, workInfo.tags)) {
            return false;
        }
        return AbstractC3255y.d(this.progress, workInfo.progress);
    }
    ...
    public WorkInfo(UUID id, State state, Set<String> tags, Data outputData) {
        ...
        AbstractC3255y.i(state, "state");
        AbstractC3255y.i(tags, "tags");
        AbstractC3255y.i(outputData, "outputData");
    }
    ...
    */
    public /* synthetic */ WorkInfo(java.util.UUID r19, androidx.work.WorkInfo.State r20, java.util.Set r21, androidx.work.Data r22, androidx.work.Data r23, int r24, int r25, androidx.work.Constraints r26, long r27, androidx.work.WorkInfo.PeriodicityInfo r29, long r30, int r32, int r33, kotlin.jvm.internal.AbstractC3247p r34) {
        /*
            r18 = this;
            r0 = r33
            r1 = r0 & 8
