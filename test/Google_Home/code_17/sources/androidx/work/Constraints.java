...
public final class Constraints {
    ...
    public static final class Builder {
        ...
        public final Constraints build() {
            ...
            if (i8 >= 24) {
                f8 = AbstractC1378t.b1(this.contentUriTriggers);
        ...
        public final Builder setRequiredNetworkType(NetworkType networkType) {
            AbstractC3255y.i(networkType, "networkType");
        ...
        public Builder(Constraints constraints) {
            ...
            if (i8 >= 24) {
                ...
                this.contentUriTriggers = AbstractC1378t.a1(constraints.getContentUriTriggers());
            }
        }
    }
    ...
    public static final class ContentUriTrigger {
        ...
        public boolean equals(Object obj) {
            ...
            if (!AbstractC3255y.d(ContentUriTrigger.class, cls)) {
                return false;
            }
            AbstractC3255y.g(obj, "null cannot be cast to non-null type androidx.work.Constraints.ContentUriTrigger");
            ContentUriTrigger contentUriTrigger = (ContentUriTrigger) obj;
            if (AbstractC3255y.d(this.uri, contentUriTrigger.uri) && this.isTriggeredForDescendants == contentUriTrigger.isTriggeredForDescendants) {
                return true;
            }
            return false;
        }
    ...
    public /* synthetic */ Constraints(NetworkType networkType, boolean z8, boolean z9, boolean z10, int i8, AbstractC3247p abstractC3247p) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj == null || !AbstractC3255y.d(Constraints.class, obj.getClass())) {
            return false;
        }
        ...
        return AbstractC3255y.d(this.contentUriTriggers, constraints.contentUriTriggers);
    }
    ...
    public Constraints(NetworkType requiredNetworkType, boolean z8, boolean z9, boolean z10) {
        ...
        AbstractC3255y.i(requiredNetworkType, "requiredNetworkType");
    }

    public /* synthetic */ Constraints(NetworkType networkType, boolean z8, boolean z9, boolean z10, boolean z11, int i8, AbstractC3247p abstractC3247p) {
    ...
    public /* synthetic */ Constraints(NetworkType networkType, boolean z8, boolean z9, boolean z10, boolean z11, long j8, long j9, Set set, int i8, AbstractC3247p abstractC3247p) {
    ...
    public Constraints(NetworkType requiredNetworkType, boolean z8, boolean z9, boolean z10, boolean z11, long j8, long j9, Set<ContentUriTrigger> contentUriTriggers) {
        AbstractC3255y.i(requiredNetworkType, "requiredNetworkType");
        AbstractC3255y.i(contentUriTriggers, "contentUriTriggers");
