...
public class WorkerWrapper implements Runnable {
    ...
    public /* synthetic */ void lambda$runWorker$0(InterfaceFutureC4218d interfaceFutureC4218d) {
        if (this.mWorkerResultFuture.isCancelled()) {
            interfaceFutureC4218d.cancel(true);
        }
    }
    ...
    private void runWorker() {
        ...
        try {
            ...
            if (trySetRunning()) {
                ...
                final InterfaceFutureC4218d future = workForegroundRunnable.getFuture();
    ...
    @NonNull
    public InterfaceFutureC4218d getFuture() {
        return this.mFuture;
    }
