...
public final class WorkTypeConverters {
    ...
    public static final Set<Constraints.ContentUriTrigger> byteArrayToSetOfTriggers(byte[] bytes) {
        ...
        try {
            ...
            try {
                ...
                I i9 = I.f8278a;
                Y5.b.a(objectInputStream, null);
                I i10 = I.f8278a;
                Y5.b.a(byteArrayInputStream, null);
                return linkedHashSet;
            } finally {
            }
        } catch (Throwable th) {
            try {
                ...
                Y5.b.a(byteArrayInputStream, th);
                throw th2;
            }
        }
    }
    ...
    public static final byte[] setOfTriggersToByteArray(Set<Constraints.ContentUriTrigger> triggers) {
        AbstractC3255y.i(triggers, "triggers");
        if (triggers.isEmpty()) {
            return new byte[0];
        }
        ...
        try {
            ...
            try {
                ...
                I i8 = I.f8278a;
                Y5.b.a(objectOutputStream, null);
                Y5.b.a(byteArrayOutputStream, null);
                byte[] byteArray = byteArrayOutputStream.toByteArray();
                AbstractC3255y.h(byteArray, "outputStream.toByteArray()");
                return byteArray;
            } finally {
            }
        } catch (Throwable th) {
            try {
                ...
                Y5.b.a(byteArrayOutputStream, th);
                throw th2;
            }
        }
    }
