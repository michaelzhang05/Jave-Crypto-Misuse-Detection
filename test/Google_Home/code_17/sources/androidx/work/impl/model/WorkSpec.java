...
public final class WorkSpec {
    ...
    public static final class IdAndState {
        ...
        public boolean equals(Object obj) {
            ...
            return AbstractC3255y.d(this.id, idAndState.id) && this.state == idAndState.state;
        }
    ...
    static {
        ...
        AbstractC3255y.h(tagWithPrefix, "tagWithPrefix(\"WorkSpec\")");
        TAG = tagWithPrefix;
    ...
    public WorkSpec(String id, WorkInfo.State state, String workerClassName, String inputMergerClassName, Data input, Data output, long j8, long j9, long j10, Constraints constraints, @IntRange(from = 0) int i8, BackoffPolicy backoffPolicy, long j11, long j12, long j13, long j14, boolean z8, OutOfQuotaPolicy outOfQuotaPolicy, int i9, int i10, long j15, int i11, int i12) {
        AbstractC3255y.i(id, "id");
        AbstractC3255y.i(state, "state");
        AbstractC3255y.i(workerClassName, "workerClassName");
        AbstractC3255y.i(inputMergerClassName, "inputMergerClassName");
        AbstractC3255y.i(input, "input");
        AbstractC3255y.i(output, "output");
        AbstractC3255y.i(constraints, "constraints");
        AbstractC3255y.i(backoffPolicy, "backoffPolicy");
        AbstractC3255y.i(outOfQuotaPolicy, "outOfQuotaPolicy");
        this.id = id;
        this.state = state;
    ...
    public boolean equals(Object obj) {
        ...
        return AbstractC3255y.d(this.id, workSpec.id) && this.state == workSpec.state && AbstractC3255y.d(this.workerClassName, workSpec.workerClassName) && AbstractC3255y.d(this.inputMergerClassName, workSpec.inputMergerClassName) && AbstractC3255y.d(this.input, workSpec.input) && AbstractC3255y.d(this.output, workSpec.output) && this.initialDelay == workSpec.initialDelay && this.intervalDuration == workSpec.intervalDuration && this.flexDuration == workSpec.flexDuration && AbstractC3255y.d(this.constraints, workSpec.constraints) && this.runAttemptCount == workSpec.runAttemptCount && this.backoffPolicy == workSpec.backoffPolicy && this.backoffDelayDuration == workSpec.backoffDelayDuration && this.lastEnqueueTime == workSpec.lastEnqueueTime && this.minimumRetentionDuration == workSpec.minimumRetentionDuration && this.scheduleRequestedAt == workSpec.scheduleRequestedAt && this.expedited == workSpec.expedited && this.outOfQuotaPolicy == workSpec.outOfQuotaPolicy && this.periodCount == workSpec.periodCount && this.generation == workSpec.generation && this.nextScheduleTimeOverride == workSpec.nextScheduleTimeOverride && this.nextScheduleTimeOverrideGeneration == workSpec.nextScheduleTimeOverrideGeneration && this.stopReason == workSpec.stopReason;
    }
    ...
    public final boolean hasConstraints() {
        return !AbstractC3255y.d(Constraints.NONE, this.constraints);
    }
    ...
    public static final class WorkInfoPojo {
        ...
        public WorkInfoPojo(String id, WorkInfo.State state, Data output, long j8, long j9, long j10, Constraints constraints, int i8, BackoffPolicy backoffPolicy, long j11, long j12, int i9, int i10, long j13, int i11, List<String> tags, List<Data> progress) {
            ...
            AbstractC3255y.i(progress, "progress");
            this.id = id;
            this.state = state;
            this.output = output;
            this.initialDelay = j8;
        ...
        public boolean equals(Object obj) {
            ...
            return AbstractC3255y.d(this.id, workInfoPojo.id) && this.state == workInfoPojo.state && AbstractC3255y.d(this.output, workInfoPojo.output) && this.initialDelay == workInfoPojo.initialDelay && this.intervalDuration == workInfoPojo.intervalDuration && this.flexDuration == workInfoPojo.flexDuration && AbstractC3255y.d(this.constraints, workInfoPojo.constraints) && this.runAttemptCount == workInfoPojo.runAttemptCount && this.backoffPolicy == workInfoPojo.backoffPolicy && this.backoffDelayDuration == workInfoPojo.backoffDelayDuration && this.lastEnqueueTime == workInfoPojo.lastEnqueueTime && this.periodCount == workInfoPojo.periodCount && this.generation == workInfoPojo.generation && this.nextScheduleTimeOverride == workInfoPojo.nextScheduleTimeOverride && this.stopReason == workInfoPojo.stopReason && AbstractC3255y.d(this.tags, workInfoPojo.tags) && AbstractC3255y.d(this.progress, workInfoPojo.progress);
        }
        ...
        public final void setBackoffPolicy(BackoffPolicy backoffPolicy) {
            AbstractC3255y.i(backoffPolicy, "<set-?>");
            this.backoffPolicy = backoffPolicy;
        }
        ...
        public /* synthetic */ WorkInfoPojo(String str, WorkInfo.State state, Data data, long j8, long j9, long j10, Constraints constraints, int i8, BackoffPolicy backoffPolicy, long j11, long j12, int i9, int i10, long j13, int i11, List list, List list2, int i12, AbstractC3247p abstractC3247p) {
    ...
    */
    public /* synthetic */ WorkSpec(java.lang.String r35, androidx.work.WorkInfo.State r36, java.lang.String r37, java.lang.String r38, androidx.work.Data r39, androidx.work.Data r40, long r41, long r43, long r45, androidx.work.Constraints r47, int r48, androidx.work.BackoffPolicy r49, long r50, long r52, long r54, long r56, boolean r58, androidx.work.OutOfQuotaPolicy r59, int r60, int r61, long r62, int r64, int r65, int r66, kotlin.jvm.internal.AbstractC3247p r67) {
        /*
    ...
    public WorkSpec(String id, String workerClassName_) {
        ...
        AbstractC3255y.i(id, "id");
        AbstractC3255y.i(workerClassName_, "workerClassName_");
    }
