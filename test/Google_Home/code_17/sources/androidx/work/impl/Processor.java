...
public class Processor implements ForegroundProcessor {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$startWork$1(InterfaceFutureC4218d interfaceFutureC4218d, WorkerWrapper workerWrapper) {
        boolean z8;
        try {
            z8 = ((Boolean) interfaceFutureC4218d.get()).booleanValue();
    ...
    public boolean startWork(@NonNull StartStopToken startStopToken, @Nullable WorkerParameters.RuntimeExtras runtimeExtras) {
        ...
        synchronized (this.mLock) {
            try {
                ...
                final InterfaceFutureC4218d future = build.getFuture();
