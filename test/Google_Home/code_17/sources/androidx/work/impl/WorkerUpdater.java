...
public final class WorkerUpdater {
    ...
    public static final Operation enqueueUniquelyNamedPeriodic(final WorkManagerImpl workManagerImpl, final String name, final WorkRequest workRequest) {
        AbstractC3255y.i(workManagerImpl, "<this>");
        AbstractC3255y.i(name, "name");
        AbstractC3255y.i(workRequest, "workRequest");
    ...
    public static final void enqueueUniquelyNamedPeriodic$lambda$4(WorkManagerImpl this_enqueueUniquelyNamedPeriodic, String name, OperationImpl operation, Function0 enqueueNew, WorkRequest workRequest) {
        AbstractC3255y.i(this_enqueueUniquelyNamedPeriodic, "$this_enqueueUniquelyNamedPeriodic");
        AbstractC3255y.i(name, "$name");
        AbstractC3255y.i(operation, "$operation");
        AbstractC3255y.i(enqueueNew, "$enqueueNew");
        AbstractC3255y.i(workRequest, "$workRequest");
        ...
        WorkSpec.IdAndState idAndState = (WorkSpec.IdAndState) AbstractC1378t.o0(workSpecIdAndStatesForName);
        if (idAndState == null) {
            enqueueNew.invoke();
            return;
        }
    ...
    public static final void updateWorkImpl$lambda$2(WorkDatabase workDatabase, WorkSpec oldWorkSpec, WorkSpec newWorkSpec, List schedulers, String workSpecId, Set tags, boolean z8) {
        ...
        AbstractC3255y.i(oldWorkSpec, "$oldWorkSpec");
        AbstractC3255y.i(newWorkSpec, "$newWorkSpec");
        AbstractC3255y.i(schedulers, "$schedulers");
        AbstractC3255y.i(workSpecId, "$workSpecId");
    ...
    public static final void updateWorkImpl$lambda$3(SettableFuture settableFuture, WorkManagerImpl this_updateWorkImpl, WorkRequest workRequest) {
        AbstractC3255y.i(this_updateWorkImpl, "$this_updateWorkImpl");
        AbstractC3255y.i(workRequest, "$workRequest");
    ...
    public static final InterfaceFutureC4218d updateWorkImpl(final WorkManagerImpl workManagerImpl, final WorkRequest workRequest) {
        AbstractC3255y.i(workManagerImpl, "<this>");
        AbstractC3255y.i(workRequest, "workRequest");
