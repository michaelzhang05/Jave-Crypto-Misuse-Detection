...
public final class WorkManagerImplExtKt {
    ...
    public static final List<Scheduler> createSchedulers(Context context, Configuration configuration, TaskExecutor taskExecutor, WorkDatabase workDatabase, Trackers trackers, Processor processor) {
        ...
        AbstractC3255y.h(createBestAvailableBackgroundScheduler, "createBestAvailableBackg…kDatabase, configuration)");
        return AbstractC1378t.p(createBestAvailableBackgroundScheduler, new GreedyScheduler(context, configuration, trackers, processor, new WorkLauncherImpl(processor, taskExecutor), taskExecutor));
    }
    ...
    public static final WorkManagerImpl createTestWorkManager(Context context, Configuration configuration, TaskExecutor workTaskExecutor) {
        ...
        AbstractC3255y.i(workTaskExecutor, "workTaskExecutor");
        ...
        AbstractC3255y.h(serialTaskExecutor, "workTaskExecutor.serialTaskExecutor");
    ...
    public static /* synthetic */ WorkManagerImpl createWorkManager$default(Context context, Configuration configuration, TaskExecutor taskExecutor, WorkDatabase workDatabase, Trackers trackers, Processor processor, InterfaceC1672r interfaceC1672r, int i8, Object obj) {
        TaskExecutor taskExecutor2;
        WorkDatabase workDatabase2;
        Trackers trackers2;
        Processor processor2;
        InterfaceC1672r interfaceC1672r2;
        if ((i8 & 4) != 0) {
        ...
        if ((i8 & 16) != 0) {
            ...
            AbstractC3255y.h(applicationContext2, "context.applicationContext");
        ...
        if ((i8 & 64) != 0) {
            interfaceC1672r2 = WorkManagerImplExtKt$WorkManagerImpl$1.INSTANCE;
        } else {
            interfaceC1672r2 = interfaceC1672r;
        }
        return createWorkManager(context, configuration, taskExecutor2, workDatabase2, trackers2, processor2, interfaceC1672r2);
    }

    public static final InterfaceC1672r schedulers(Scheduler... schedulers) {
        AbstractC3255y.i(schedulers, "schedulers");
    ...
    public static final WorkManagerImpl createWorkManager(Context context, Configuration configuration, TaskExecutor workTaskExecutor, WorkDatabase workDatabase) {
        ...
        AbstractC3255y.i(configuration, "configuration");
        AbstractC3255y.i(workTaskExecutor, "workTaskExecutor");
        AbstractC3255y.i(workDatabase, "workDatabase");
    ...
    public static final WorkManagerImpl createWorkManager(Context context, Configuration configuration, TaskExecutor workTaskExecutor, WorkDatabase workDatabase, Trackers trackers, Processor processor) {
        ...
        AbstractC3255y.i(workDatabase, "workDatabase");
        AbstractC3255y.i(trackers, "trackers");
        AbstractC3255y.i(processor, "processor");
        return createWorkManager$default(context, configuration, workTaskExecutor, workDatabase, trackers, processor, null, 64, null);
    }

    public static final WorkManagerImpl createWorkManager(Context context, Configuration configuration, TaskExecutor workTaskExecutor, WorkDatabase workDatabase, Trackers trackers, Processor processor, InterfaceC1672r schedulersCreator) {
        AbstractC3255y.i(context, "context");
        AbstractC3255y.i(configuration, "configuration");
        AbstractC3255y.i(workTaskExecutor, "workTaskExecutor");
        AbstractC3255y.i(workDatabase, "workDatabase");
        AbstractC3255y.i(trackers, "trackers");
        AbstractC3255y.i(processor, "processor");
        AbstractC3255y.i(schedulersCreator, "schedulersCreator");
