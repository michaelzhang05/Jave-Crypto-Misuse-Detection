...
public final class RawQueries {
    ...
    public static final SupportSQLiteQuery toRawQuery(WorkQuery workQuery) {
        ...
        AbstractC3255y.h(ids, "ids");
        if (!ids.isEmpty()) {
            List<UUID> ids2 = workQuery.getIds();
            AbstractC3255y.h(ids2, "ids");
            List<UUID> list2 = ids2;
            ArrayList arrayList3 = new ArrayList(AbstractC1378t.x(list2, 10));
