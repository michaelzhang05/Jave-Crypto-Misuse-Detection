...
public final class ProcessUtils {
    ...
    static {
        ...
        AbstractC3255y.h(tagWithPrefix, "tagWithPrefix(\"ProcessUtils\")");
        TAG = tagWithPrefix;
    }
    ...
    public static final boolean isDefaultProcess(Context context, Configuration configuration) {
        ...
        if (defaultProcessName != null && defaultProcessName.length() != 0) {
            return AbstractC3255y.d(processName, configuration.getDefaultProcessName());
        }
        return AbstractC3255y.d(processName, context.getApplicationInfo().processName);
    }
}
