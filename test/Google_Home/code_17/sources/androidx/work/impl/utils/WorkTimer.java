...
public class WorkTimer {
    ...
    public void startTimer(@NonNull WorkGenerationalId workGenerationalId, long j8, @NonNull TimeLimitExceededListener timeLimitExceededListener) {
        synchronized (this.mLock) {
            ...
            this.mRunnableScheduler.scheduleWithDelay(j8, workTimerRunnable);
        }
    }
