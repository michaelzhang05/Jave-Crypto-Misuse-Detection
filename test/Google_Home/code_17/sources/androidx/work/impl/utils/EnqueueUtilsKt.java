...
public final class EnqueueUtilsKt {
    public static final void checkContentUriTriggerWorkerLimits(WorkDatabase workDatabase, Configuration configuration, WorkContinuationImpl continuation) {
        ...
        List s8 = AbstractC1378t.s(continuation);
        int i9 = 0;
        while (!s8.isEmpty()) {
            WorkContinuationImpl workContinuationImpl = (WorkContinuationImpl) AbstractC1378t.P(s8);
            List<? extends WorkRequest> work = workContinuationImpl.getWork();
            AbstractC3255y.h(work, "current.work");
    ...
    public static final WorkSpec tryDelegateConstrainedWorkSpec(WorkSpec workSpec) {
        ...
        if (AbstractC3255y.d(str, ConstraintTrackingWorker.class.getName())) {
            return workSpec;
        }
        ...
        AbstractC3255y.h(build, "Builder().putAll(workSpe…ame)\n            .build()");
