...
public abstract class AbstractFuture<V> implements InterfaceFutureC4218d {
    ...
    public static final class SetFuture<V> implements Runnable {
        ...
        SetFuture(AbstractFuture<V> abstractFuture, InterfaceFutureC4218d interfaceFutureC4218d) {
    ...
    static Object getFutureValue(InterfaceFutureC4218d interfaceFutureC4218d) {
        if (interfaceFutureC4218d instanceof AbstractFuture) {
            Object obj = ((AbstractFuture) interfaceFutureC4218d).value;
            if (obj instanceof Cancellation) {
        ...
        if (z9 | (obj instanceof SetFuture)) {
            ...
            while (true) {
                if (ATOMIC_HELPER.casValue(abstractFuture, obj, cancellation)) {
                    ...
                    if (interfaceFutureC4218d instanceof AbstractFuture) {
                        abstractFuture = (AbstractFuture) interfaceFutureC4218d;
