...
public final class DiagnosticsWorkerKt {
    ...
    static {
        ...
        AbstractC3255y.h(tagWithPrefix, "tagWithPrefix(\"DiagnosticsWrkr\")");
        TAG = tagWithPrefix;
    }
    ...
    public static final String workSpecRows(WorkNameDao workNameDao, WorkTagDao workTagDao, SystemIdInfoDao systemIdInfoDao, List<WorkSpec> list) {
        ...
        for (WorkSpec workSpec : list) {
            ...
            sb.append(workSpecRow(workSpec, AbstractC1378t.w0(workNameDao.getNamesForWorkSpecId(workSpec.id), ",", null, null, 0, null, null, 62, null), num, AbstractC1378t.w0(workTagDao.getTagsForWorkSpecId(workSpec.id), ",", null, null, 0, null, null, 62, null)));
        }
