...
public final class ArrayCreatingInputMerger extends InputMerger {
    private final Object concatenateArrayAndNonArray(Object obj, Object obj2, Class<?> cls) {
        ...
        AbstractC3255y.h(newArray, "newArray");
        return newArray;
    }
        ...
        while (it.hasNext()) {
            ...
            for (Map.Entry<String, Object> entry : keyValueMap.entrySet()) {
                ...
                if (obj == null) {
                    ...
                    if (AbstractC3255y.d(cls2, cls)) {
                        AbstractC3255y.h(value, "value");
                        value = concatenateArrays(obj, value);
                    } else if (AbstractC3255y.d(cls2.getComponentType(), cls)) {
                        value = concatenateArrayAndNonArray(obj, value, cls);
                    } else {
                        throw new IllegalArgumentException();
                    }
                }
                AbstractC3255y.h(value, "if (existingValue == nul…      }\n                }");
