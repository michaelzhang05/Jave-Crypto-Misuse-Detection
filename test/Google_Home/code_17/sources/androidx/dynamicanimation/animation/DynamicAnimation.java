...
public abstract class DynamicAnimation<T extends DynamicAnimation<T>> implements AnimationHandler.AnimationFrameCallback {
    ...
    public static final ViewProperty f14803X = new ViewProperty("x") { // from class: androidx.dynamicanimation.animation.DynamicAnimation.9
        @Override // androidx.dynamicanimation.animation.FloatPropertyCompat
        public float getValue(View view) {
            return view.getX();
        }
    ...
    public static final ViewProperty f14804Y = new ViewProperty("y") { // from class: androidx.dynamicanimation.animation.DynamicAnimation.10
        @Override // androidx.dynamicanimation.animation.FloatPropertyCompat
        public float getValue(View view) {
            return view.getY();
        }
    ...
    public static final ViewProperty f14805Z = new ViewProperty("z") { // from class: androidx.dynamicanimation.animation.DynamicAnimation.11
        @Override // androidx.dynamicanimation.animation.FloatPropertyCompat
        public float getValue(View view) {
    ...
    public interface OnAnimationEndListener {
        void onAnimationEnd(DynamicAnimation dynamicAnimation, boolean z8, float f8, float f9);
    }
    ...
    private void endAnimationInternal(boolean z8) {
        ...
        for (int i8 = 0; i8 < this.mEndListeners.size(); i8++) {
            if (this.mEndListeners.get(i8) != null) {
                this.mEndListeners.get(i8).onAnimationEnd(this, z8, this.mValue, this.mVelocity);
            }
        }
    ...
    public boolean doAnimationFrame(long j8) {
        ...
        this.mLastFrameTime = j8;
        boolean updateValueAndVelocity = updateValueAndVelocity(j8 - j9);
