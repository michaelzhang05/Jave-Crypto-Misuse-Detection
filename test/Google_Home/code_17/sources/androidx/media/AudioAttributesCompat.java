...
public class AudioAttributesCompat implements VersionedParcelable {
    ...
    public static void setForceLegacyBehavior(boolean z8) {
        sForceLegacyBehavior = z8;
    }

    static int toVolumeStreamType(boolean z8, AudioAttributesCompat audioAttributesCompat) {
        return toVolumeStreamType(z8, audioAttributesCompat.getFlags(), audioAttributesCompat.getUsage());
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static String usageToString(int i8) {
        switch (i8) {
            case 0:
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static int toVolumeStreamType(boolean z8, int i8, int i9) {
        if ((i8 & 1) == 1) {
            return z8 ? 1 : 7;
        }
        if ((i8 & 4) == 4) {
    ...
    public static class Builder {
        ...
        public Builder setFlags(int i8) {
            this.mFlags = (i8 & AudioAttributesCompat.FLAG_ALL) | this.mFlags;
            return this;
        }

        /* JADX WARN: Can't fix incorrect switch cases order, some code will duplicate */
        Builder setInternalLegacyStreamType(int i8) {
            switch (i8) {
                case 0:
                    this.mContentType = 1;
                    break;
                ...
                case 10:
                    ...
                    break;
                default:
                    Log.e(AudioAttributesCompat.TAG, "Invalid stream type " + i8 + " for AudioAttributesCompat");
                    break;
            }
            this.mUsage = AudioAttributesCompat.usageForStreamType(i8);
            return this;
        }
