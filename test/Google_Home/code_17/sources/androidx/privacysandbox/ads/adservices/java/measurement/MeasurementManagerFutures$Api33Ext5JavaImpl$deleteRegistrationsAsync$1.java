...
final class MeasurementManagerFutures$Api33Ext5JavaImpl$deleteRegistrationsAsync$1 extends l implements InterfaceC1668n {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i8 != 0) {
            ...
            this.label = 1;
            if (measurementManager.deleteRegistrations(deletionRequest, this) == e8) {
                return e8;
            }
        }
        return I.f8278a;
    ...
    public final Object invoke(M m8, d dVar) {
        return ((MeasurementManagerFutures$Api33Ext5JavaImpl$deleteRegistrationsAsync$1) create(m8, dVar)).invokeSuspend(I.f8278a);
    }
}
