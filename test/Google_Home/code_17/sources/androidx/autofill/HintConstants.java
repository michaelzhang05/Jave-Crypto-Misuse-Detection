...
public final class HintConstants {
    ...
    @NonNull
    public static String generateSmsOtpHintForCharacterPosition(int i8) {
        Preconditions.checkArgumentInRange(i8, 1, 8, "characterPosition");
        return (AUTOFILL_HINT_SMS_OTP + i8).intern();
    }
}
