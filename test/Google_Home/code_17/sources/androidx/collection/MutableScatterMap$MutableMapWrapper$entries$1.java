...
public final class MutableScatterMap$MutableMapWrapper$entries$1<K, V> implements Set<Map.Entry<K, V>>, InterfaceC1989e {
    ...
    public boolean containsAll(Collection<? extends Object> elements) {
        ...
        while (it.hasNext()) {
            ...
            if (!AbstractC3255y.d(mutableScatterMap.get(entry.getKey()), entry.getValue())) {
                return false;
            }
        }
        return true;
                    ...
                    for (int i10 = 0; i10 < i9; i10++) {
                        if ((255 & j8) < 128) {
                            ...
                            while (true) {
                                if (it.hasNext()) {
                                    Map.Entry entry = (Map.Entry) it.next();
                                    if (AbstractC3255y.d(entry.getKey(), mutableScatterMap.keys[i11]) && AbstractC3255y.d(entry.getValue(), mutableScatterMap.values[i11])) {
    ...
    */
    public boolean remove(java.util.Map.Entry<K, V> r20) {
        ...
        L54:
            ...
            r4 = r4[r15]
            boolean r4 = kotlin.jvm.internal.AbstractC3255y.d(r4, r3)
            if (r4 == 0) goto L6d
            goto L7e
        L6d:
            r17 = 1
        ...
        L7e:
            ...
            boolean r1 = kotlin.jvm.internal.AbstractC3255y.d(r1, r2)
            if (r1 == 0) goto L97
            androidx.collection.MutableScatterMap<K, V> r1 = r0.this$0
