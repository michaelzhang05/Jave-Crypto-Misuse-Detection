...
public final class CircularArray<E> {
    ...
    private final void doubleCapacity() {
        ...
        if (i10 >= 0) {
            ...
            AbstractC1371l.i(eArr, eArr2, 0, i8, length);
            AbstractC1371l.i(this.elements, eArr2, i9, 0, this.head);
            this.elements = eArr2;
            this.head = 0;
            this.tail = length;
    ...
    public /* synthetic */ CircularArray(int i8, int i9, AbstractC3247p abstractC3247p) {
        this((i9 & 1) != 0 ? 8 : i8);
    }
}
