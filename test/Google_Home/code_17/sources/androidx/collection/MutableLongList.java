...
public final class MutableLongList extends LongList {
    ...
    public final boolean addAll(@IntRange(from = 0) int i8, long[] elements) {
        ...
        if (i8 >= 0 && i8 <= (i9 = this._size)) {
            ...
            int i10 = this._size;
            if (i8 != i10) {
                AbstractC1371l.h(jArr, jArr, elements.length + i8, i8, i10);
            }
            AbstractC1371l.m(elements, jArr, i8, 0, 0, 12, null);
    ...
    public final long removeAt(@IntRange(from = 0) int i8) {
        ...
        if (i8 >= 0 && i8 < (i9 = this._size)) {
            ...
            long j8 = jArr[i8];
            if (i8 != i9 - 1) {
                AbstractC1371l.h(jArr, jArr, i8, i8 + 1, i9);
            }
            this._size--;
            return j8;
        }
        ...
        if (i8 >= 0 && i8 <= (i10 = this._size) && i9 >= 0 && i9 <= i10) {
            if (i9 >= i8) {
                if (i9 != i8) {
                    if (i9 < i10) {
                        long[] jArr = this.content;
                        AbstractC1371l.h(jArr, jArr, i8, i9, i10);
                    }
                    this._size -= i9 - i8;
                    return;
                }
    ...
    public final void sort() {
        AbstractC1371l.I(this.content, 0, this._size);
    }

    public final void sortDescending() {
        AbstractC1371l.O0(this.content, 0, this._size);
    }
    ...
    public /* synthetic */ MutableLongList(int i8, int i9, AbstractC3247p abstractC3247p) {
        this((i9 & 1) != 0 ? 16 : i8);
    }
    ...
    public final void add(@IntRange(from = 0) int i8, long j8) {
        ...
        if (i8 >= 0 && i8 <= (i9 = this._size)) {
            ...
            int i10 = this._size;
            if (i8 != i10) {
                AbstractC1371l.h(jArr, jArr, i8 + 1, i8, i10);
            }
            jArr[i8] = j8;
            this._size++;
            return;
    ...
    public final boolean addAll(@IntRange(from = 0) int i8, LongList elements) {
        ...
        if (i8 >= 0 && i8 <= this._size) {
            ...
            int i9 = this._size;
            if (i8 != i9) {
                AbstractC1371l.h(jArr, jArr, elements._size + i8, i8, i9);
            }
            AbstractC1371l.h(elements.content, jArr, i8, 0, elements._size);
