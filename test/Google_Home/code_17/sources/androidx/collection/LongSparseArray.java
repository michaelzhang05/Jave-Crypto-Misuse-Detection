...
public class LongSparseArray<E> implements Cloneable {
    ...
    public void put(long j8, E e8) {
        ...
        if (i13 - i8 != 0) {
            ...
            int i14 = i8 + 1;
            AbstractC1371l.h(jArr2, jArr2, i14, i8, i13);
            Object[] objArr2 = this.values;
            AbstractC1371l.i(objArr2, objArr2, i14, i8, this.size);
        }
        this.keys[i8] = j8;
        this.values[i8] = e8;
        this.size++;
    ...
    public LongSparseArray<E> m132clone() {
        Object clone = super.clone();
        AbstractC3255y.g(clone, "null cannot be cast to non-null type androidx.collection.LongSparseArray<E of androidx.collection.LongSparseArray>");
    ...
    public boolean replace(long j8, E e8, E e9) {
        int indexOfKey = indexOfKey(j8);
        if (indexOfKey < 0 || !AbstractC3255y.d(this.values[indexOfKey], e8)) {
            return false;
        }
    ...
    public boolean remove(long j8, E e8) {
        int indexOfKey = indexOfKey(j8);
        if (indexOfKey < 0 || !AbstractC3255y.d(e8, valueAt(indexOfKey))) {
            return false;
        }
        removeAt(indexOfKey);
        return true;
    ...
    public /* synthetic */ LongSparseArray(int i8, int i9, AbstractC3247p abstractC3247p) {
        this((i9 & 1) != 0 ? 10 : i8);
    }
}
