...
public abstract class ObjectLongMap<K> {
    ...
    public /* synthetic */ ObjectLongMap(AbstractC3247p abstractC3247p) {
        this();
    }
    ...
    public final long getOrElse(K k8, Function0 defaultValue) {
    ...
    public static /* synthetic */ String joinToString$default(ObjectLongMap objectLongMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i8, CharSequence charSequence4, InterfaceC1668n transform, int i9, Object obj) {
        long[] jArr;
        long[] jArr2;
        if (obj == null) {
