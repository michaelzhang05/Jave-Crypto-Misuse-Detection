...
public final class MutableIntList extends IntList {
    ...
    public final boolean addAll(@IntRange(from = 0) int i8, int[] elements) {
        ...
        if (i8 >= 0 && i8 <= (i9 = this._size)) {
            ...
            int i10 = this._size;
            if (i8 != i10) {
                AbstractC1371l.g(iArr, iArr, elements.length + i8, i8, i10);
            }
            AbstractC1371l.l(elements, iArr, i8, 0, 0, 12, null);
    ...
    public final int removeAt(@IntRange(from = 0) int i8) {
        ...
        if (i8 >= 0 && i8 < (i9 = this._size)) {
            ...
            int i10 = iArr[i8];
            if (i8 != i9 - 1) {
                AbstractC1371l.g(iArr, iArr, i8, i8 + 1, i9);
            }
            this._size--;
            return i10;
        }
        ...
        if (i8 >= 0 && i8 <= (i10 = this._size) && i9 >= 0 && i9 <= i10) {
            if (i9 >= i8) {
                if (i9 != i8) {
                    if (i9 < i10) {
                        int[] iArr = this.content;
                        AbstractC1371l.g(iArr, iArr, i8, i9, i10);
                    }
                    this._size -= i9 - i8;
                    return;
                }
    ...
    public final void sort() {
        AbstractC1371l.H(this.content, 0, this._size);
    }

    public final void sortDescending() {
        AbstractC1371l.N0(this.content, 0, this._size);
    }
    ...
    public /* synthetic */ MutableIntList(int i8, int i9, AbstractC3247p abstractC3247p) {
        this((i9 & 1) != 0 ? 16 : i8);
    }
    ...
    public final void add(@IntRange(from = 0) int i8, int i9) {
        ...
        if (i8 >= 0 && i8 <= (i10 = this._size)) {
            ...
            int i11 = this._size;
            if (i8 != i11) {
                AbstractC1371l.g(iArr, iArr, i8 + 1, i8, i11);
            }
            iArr[i8] = i9;
            this._size++;
            return;
    ...
    public final boolean addAll(@IntRange(from = 0) int i8, IntList elements) {
        ...
        if (i8 >= 0 && i8 <= this._size) {
            ...
            int i9 = this._size;
            if (i8 != i9) {
                AbstractC1371l.g(iArr, iArr, elements._size + i8, i8, i9);
            }
            AbstractC1371l.g(elements.content, iArr, i8, 0, elements._size);
