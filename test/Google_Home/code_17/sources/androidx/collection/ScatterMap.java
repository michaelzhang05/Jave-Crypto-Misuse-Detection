...
public abstract class ScatterMap<K, V> {
    ...
    /* loaded from: classes.dex */
    public class MapWrapper implements Map<K, V>, InterfaceC1985a, j$.util.Map {
        public MapWrapper() {
        }
    ...
    public /* synthetic */ ScatterMap(AbstractC3247p abstractC3247p) {
        this();
    }
    ...
    public static /* synthetic */ String joinToString$default(ScatterMap scatterMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i8, CharSequence charSequence4, InterfaceC1668n interfaceC1668n, int i9, Object obj) {
        ...
        if (obj == null) {
            ...
            return scatterMap.joinToString(charSequence, charSequence5, charSequence6, i10, charSequence7, interfaceC1668n);
        }
                ...
                if ((((~j8) << 7) & j8 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i10 = 0; i10 < i9; i10++) {
                        if ((255 & j8) < 128) {
                            ...
                            } else if (!AbstractC3255y.d(obj3, scatterMap.get(obj2))) {
                                return false;
                            }
                        }
                        j8 >>= 8;
    ...
    */
    ...
    public final String joinToString(CharSequence separator, CharSequence prefix, CharSequence postfix, int i8, CharSequence truncated, InterfaceC1668n interfaceC1668n) {
        Object[] objArr;
        Object[] objArr2;
        Object[] objArr3;
        Object[] objArr4;
                    ...
                    while (i13 < i12) {
                        if ((j8 & 255) < 128) {
                            ...
                            if (interfaceC1668n == null) {
                                ...
                                sb.append((CharSequence) interfaceC1668n.invoke(obj, obj2));
                            }
                            i10++;
                        } else {
                            objArr3 = objArr5;
