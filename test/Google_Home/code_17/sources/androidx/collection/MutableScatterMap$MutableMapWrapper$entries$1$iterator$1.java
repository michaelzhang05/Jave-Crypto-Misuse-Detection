...
public final class MutableScatterMap$MutableMapWrapper$entries$1$iterator$1<K, V> implements Iterator<Map.Entry<K, V>>, InterfaceC1985a {
    ...
    /* loaded from: classes.dex */
    static final class AnonymousClass1 extends k implements InterfaceC1668n {
        int I$0;
        int I$1;
        int I$2;
        int I$3;
        ...
        public final Object invoke(AbstractC3000i abstractC3000i, d dVar) {
            return ((AnonymousClass1) create(abstractC3000i, dVar)).invokeSuspend(I.f8278a);
        }
    ...
    public MutableScatterMap$MutableMapWrapper$entries$1$iterator$1(MutableScatterMap<K, V> mutableScatterMap) {
        this.this$0 = mutableScatterMap;
        this.iterator = AbstractC3001j.a(new AnonymousClass1(mutableScatterMap, this, null));
    }
