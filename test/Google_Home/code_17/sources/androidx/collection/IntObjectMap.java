...
public abstract class IntObjectMap<V> {
    ...
    public /* synthetic */ IntObjectMap(AbstractC3247p abstractC3247p) {
        this();
    }
                ...
                if ((((~j8) << 7) & j8 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i10 = 0; i10 < i9; i10++) {
                        if ((255 & j8) < 128) {
                            ...
                            } else if (!AbstractC3255y.d(obj2, intObjectMap.get(i12))) {
                                return false;
                            }
                        }
                        j8 >>= 8;
    ...
    */
    ...
    public static /* synthetic */ String joinToString$default(IntObjectMap intObjectMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i8, CharSequence charSequence4, InterfaceC1668n transform, int i9, Object obj) {
        long[] jArr;
        long[] jArr2;
        if (obj == null) {
