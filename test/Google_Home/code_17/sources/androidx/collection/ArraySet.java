...
public final class ArraySet<E> implements Collection<E>, Set<E>, InterfaceC1986b, InterfaceC1989e {
    private int _size;
    ...
    public boolean add(E e8) {
        ...
        if (i9 >= getHashes$collection().length) {
            ...
            if (i9 == get_size$collection()) {
                ...
                if (!z8) {
                    AbstractC1371l.l(hashes$collection, getHashes$collection(), 0, 0, hashes$collection.length, 6, null);
                    AbstractC1371l.n(array$collection, getArray$collection(), 0, 0, array$collection.length, 6, null);
                }
            } else {
        ...
        if (i10 < i9) {
            int i12 = i10 + 1;
            AbstractC1371l.g(getHashes$collection(), getHashes$collection(), i12, i10, i9);
            AbstractC1371l.i(getArray$collection(), getArray$collection(), i12, i10, i9);
        }
    ...
    public final void addAll(ArraySet<? extends E> array) {
        ...
        if (i8 > 0) {
            AbstractC1371l.l(array.getHashes$collection(), getHashes$collection(), 0, 0, i8, 6, null);
            AbstractC1371l.n(array.getArray$collection(), getArray$collection(), 0, 0, i8, 6, null);
            if (get_size$collection() == 0) {
    ...
    public final void ensureCapacity(int i8) {
        ...
        if (getHashes$collection().length < i8) {
            ...
            if (get_size$collection() > 0) {
                AbstractC1371l.l(hashes$collection, getHashes$collection(), 0, 0, get_size$collection(), 6, null);
                AbstractC1371l.n(array$collection, getArray$collection(), 0, 0, get_size$collection(), 6, null);
            }
        }
    ...
    public final E removeAt(int i8) {
        ...
        if (i9 <= 1) {
            ...
            if (getHashes$collection().length > 8 && get_size$collection() < getHashes$collection().length / 3) {
                ...
                ArraySetKt.allocArrays(this, i11);
                if (i8 > 0) {
                    AbstractC1371l.l(hashes$collection, getHashes$collection(), 0, 0, i8, 6, null);
                    AbstractC1371l.n(array$collection, getArray$collection(), 0, 0, i8, 6, null);
                }
                if (i8 < i10) {
                    int i12 = i8 + 1;
                    AbstractC1371l.g(hashes$collection, getHashes$collection(), i8, i12, i9);
                    AbstractC1371l.i(array$collection, getArray$collection(), i8, i12, i9);
                }
            } else {
                if (i8 < i10) {
                    int i13 = i8 + 1;
                    AbstractC1371l.g(getHashes$collection(), getHashes$collection(), i8, i13, i9);
                    AbstractC1371l.i(getArray$collection(), getArray$collection(), i8, i13, i9);
                }
    ...
    public boolean retainAll(Collection<? extends Object> elements) {
        ...
        for (int i8 = get_size$collection() - 1; -1 < i8; i8--) {
            if (!AbstractC1378t.d0(elements, getArray$collection()[i8])) {
                removeAt(i8);
                z8 = true;
            }
        }
    ...
    public final void setArray$collection(Object[] objArr) {
        AbstractC3255y.i(objArr, "<set-?>");
        this.array = objArr;
    }

    public final void setHashes$collection(int[] iArr) {
        AbstractC3255y.i(iArr, "<set-?>");
        this.hashes = iArr;
    }
    ...
    public final Object[] toArray() {
        return AbstractC1371l.p(this.array, 0, this._size);
    }
    ...
    public final <T> T[] toArray(T[] array) {
        ...
        AbstractC1371l.i(this.array, result, 0, 0, this._size);
    ...
    public /* synthetic */ ArraySet(int i8, int i9, AbstractC3247p abstractC3247p) {
        this((i9 & 1) != 0 ? 0 : i8);
    }
    ...
    public ArraySet(E[] eArr) {
        this(0);
        if (eArr != null) {
            Iterator a8 = AbstractC3237f.a(eArr);
            while (a8.hasNext()) {
                add(a8.next());
            }
        }
