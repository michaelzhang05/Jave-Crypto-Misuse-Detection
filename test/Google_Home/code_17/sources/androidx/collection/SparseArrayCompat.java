...
public class SparseArrayCompat<E> implements Cloneable {
    ...
    public void put(int i8, E e8) {
        ...
        if (i11 - i9 != 0) {
            int[] iArr = this.keys;
            int i12 = i9 + 1;
            AbstractC1371l.g(iArr, iArr, i12, i9, i11);
            Object[] objArr = this.values;
            AbstractC1371l.i(objArr, objArr, i12, i9, this.size);
        }
        this.keys[i9] = i8;
        this.values[i9] = e8;
        this.size++;
    ...
    public String toString() {
        ...
        AbstractC3255y.h(sb2, "buffer.toString()");
        return sb2;
    }
    ...
    public SparseArrayCompat<E> m133clone() {
        Object clone = super.clone();
        AbstractC3255y.g(clone, "null cannot be cast to non-null type androidx.collection.SparseArrayCompat<E of androidx.collection.SparseArrayCompat>");
    ...
    public boolean remove(int i8, Object obj) {
        int indexOfKey = indexOfKey(i8);
        if (indexOfKey < 0 || !AbstractC3255y.d(obj, valueAt(indexOfKey))) {
            return false;
        }
        removeAt(indexOfKey);
        return true;
    ...
    public /* synthetic */ SparseArrayCompat(int i8, int i9, AbstractC3247p abstractC3247p) {
        this((i9 & 1) != 0 ? 10 : i8);
    }
}
