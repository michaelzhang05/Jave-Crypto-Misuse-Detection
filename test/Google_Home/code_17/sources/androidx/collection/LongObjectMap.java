...
public abstract class LongObjectMap<V> {
    ...
    public /* synthetic */ LongObjectMap(AbstractC3247p abstractC3247p) {
        this();
    }
                ...
                if ((((~j8) << 7) & j8 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i12 < i11) {
                        if ((255 & j8) < 128) {
                            ...
                            } else if (!AbstractC3255y.d(obj2, longObjectMap.get(j9))) {
                                return false;
                            }
                            i10 = 8;
                        } else {
    ...
    */
    ...
    public static /* synthetic */ String joinToString$default(LongObjectMap longObjectMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i8, CharSequence charSequence4, InterfaceC1668n transform, int i9, Object obj) {
        long[] jArr;
        long[] jArr2;
        if (obj == null) {
