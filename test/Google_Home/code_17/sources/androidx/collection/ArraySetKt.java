...
public final class ArraySetKt {
    ...
    public static final <E> void addAllInternal(ArraySet<E> arraySet, ArraySet<? extends E> array) {
        AbstractC3255y.i(arraySet, "<this>");
        ...
        if (i8 > 0) {
            AbstractC1371l.l(array.getHashes$collection(), arraySet.getHashes$collection(), 0, 0, i8, 6, null);
            AbstractC1371l.n(array.getArray$collection(), arraySet.getArray$collection(), 0, 0, i8, 6, null);
            if (arraySet.get_size$collection() == 0) {
    ...
    public static final <E> boolean addInternal(ArraySet<E> arraySet, E e8) {
        ...
        if (i9 >= arraySet.getHashes$collection().length) {
            ...
            if (i9 == arraySet.get_size$collection()) {
                ...
                if (!z8) {
                    AbstractC1371l.l(hashes$collection, arraySet.getHashes$collection(), 0, 0, hashes$collection.length, 6, null);
                    AbstractC1371l.n(array$collection, arraySet.getArray$collection(), 0, 0, array$collection.length, 6, null);
                }
            } else {
                throw new ConcurrentModificationException();
            }
        ...
        if (i10 < i9) {
            int i12 = i10 + 1;
            AbstractC1371l.g(arraySet.getHashes$collection(), arraySet.getHashes$collection(), i12, i10, i9);
            AbstractC1371l.i(arraySet.getArray$collection(), arraySet.getArray$collection(), i12, i10, i9);
        }
    ...
    public static final <E> void ensureCapacityInternal(ArraySet<E> arraySet, int i8) {
        ...
        if (arraySet.getHashes$collection().length < i8) {
            ...
            if (arraySet.get_size$collection() > 0) {
                AbstractC1371l.l(hashes$collection, arraySet.getHashes$collection(), 0, 0, arraySet.get_size$collection(), 6, null);
                AbstractC1371l.n(array$collection, arraySet.getArray$collection(), 0, 0, arraySet.get_size$collection(), 6, null);
            }
        }
    ...
    public static final <E> int indexOf(ArraySet<E> arraySet, Object obj, int i8) {
        ...
        if (AbstractC3255y.d(obj, arraySet.getArray$collection()[binarySearchInternal])) {
            return binarySearchInternal;
        }
        int i10 = binarySearchInternal + 1;
        while (i10 < i9 && arraySet.getHashes$collection()[i10] == i8) {
            if (AbstractC3255y.d(obj, arraySet.getArray$collection()[i10])) {
                return i10;
            }
            i10++;
        }
        for (int i11 = binarySearchInternal - 1; i11 >= 0 && arraySet.getHashes$collection()[i11] == i8; i11--) {
            if (AbstractC3255y.d(obj, arraySet.getArray$collection()[i11])) {
                return i11;
            }
        }
        return ~i10;
    ...
    public static final <E> E removeAtInternal(ArraySet<E> arraySet, int i8) {
        ...
        if (i9 <= 1) {
            ...
            if (arraySet.getHashes$collection().length > 8 && arraySet.get_size$collection() < arraySet.getHashes$collection().length / 3) {
                ...
                allocArrays(arraySet, i11);
                if (i8 > 0) {
                    AbstractC1371l.l(hashes$collection, arraySet.getHashes$collection(), 0, 0, i8, 6, null);
                    AbstractC1371l.n(array$collection, arraySet.getArray$collection(), 0, 0, i8, 6, null);
                }
                if (i8 < i10) {
                    int i12 = i8 + 1;
                    AbstractC1371l.g(hashes$collection, arraySet.getHashes$collection(), i8, i12, i9);
                    AbstractC1371l.i(array$collection, arraySet.getArray$collection(), i8, i12, i9);
                }
            } else {
                if (i8 < i10) {
                    int i13 = i8 + 1;
                    AbstractC1371l.g(arraySet.getHashes$collection(), arraySet.getHashes$collection(), i8, i13, i9);
                    AbstractC1371l.i(arraySet.getArray$collection(), arraySet.getArray$collection(), i8, i13, i9);
                }
    ...
    public static final <E> boolean retainAllInternal(ArraySet<E> arraySet, Collection<? extends E> elements) {
        ...
        for (int i8 = arraySet.get_size$collection() - 1; -1 < i8; i8--) {
            if (!AbstractC1378t.d0(elements, arraySet.getArray$collection()[i8])) {
    ...
    public static final <E> String toStringInternal(ArraySet<E> arraySet) {
        ...
        AbstractC3255y.h(sb2, "StringBuilder(capacity).…builderAction).toString()");
        return sb2;
    }
