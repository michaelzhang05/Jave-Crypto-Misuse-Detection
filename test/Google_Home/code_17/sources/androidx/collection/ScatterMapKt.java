...
public final class ScatterMapKt {
    ...
    public static final <K, V> ScatterMap<K, V> emptyScatterMap() {
        ...
        AbstractC3255y.g(mutableScatterMap, "null cannot be cast to non-null type androidx.collection.ScatterMap<K of androidx.collection.ScatterMapKt.emptyScatterMap, V of androidx.collection.ScatterMapKt.emptyScatterMap>");
