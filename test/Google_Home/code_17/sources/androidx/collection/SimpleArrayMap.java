...
public class SimpleArrayMap<K, V> {
    ...
    private final int indexOf(K k8, int i8) {
        ...
        if (AbstractC3255y.d(k8, this.array[binarySearch << 1])) {
            return binarySearch;
        }
        int i10 = binarySearch + 1;
        while (i10 < i9 && this.hashes[i10] == i8) {
            if (AbstractC3255y.d(k8, this.array[i10 << 1])) {
                return i10;
            }
            i10++;
        }
        for (int i11 = binarySearch - 1; i11 >= 0 && this.hashes[i11] == i8; i11--) {
            if (AbstractC3255y.d(k8, this.array[i11 << 1])) {
                return i11;
            }
        }
        return ~i10;
    ...
    public final int __restricted$indexOfValue(V v8) {
        ...
        for (int i10 = 1; i10 < i8; i10 += 2) {
            if (AbstractC3255y.d(v8, objArr[i10])) {
                return i10 >> 1;
            }
        }
        return -1;
        ...
        try {
            if (obj instanceof SimpleArrayMap) {
                ...
                for (int i9 = 0; i9 < i8; i9++) {
                    ...
                    } else if (!AbstractC3255y.d(valueAt, obj2)) {
                        return false;
                    }
                }
                return true;
            ...
            for (int i11 = 0; i11 < i10; i11++) {
                ...
                } else if (!AbstractC3255y.d(valueAt2, obj3)) {
                    return false;
                }
            }
            return true;
    ...
    public V put(K k8, V v8) {
        ...
        if (i11 < i9) {
            ...
            int i13 = i11 + 1;
            AbstractC1371l.g(iArr2, iArr2, i13, i11, i9);
            Object[] objArr2 = this.array;
            AbstractC1371l.i(objArr2, objArr2, i13 << 1, i11 << 1, this.size << 1);
        }
        int i14 = this.size;
        if (i9 == i14) {
    ...
    public void putAll(SimpleArrayMap<? extends K, ? extends V> map) {
        ...
        if (this.size == 0) {
            if (i8 > 0) {
                AbstractC1371l.g(map.hashes, this.hashes, 0, 0, i8);
                AbstractC1371l.i(map.array, this.array, 0, 0, i8 << 1);
                this.size = i8;
                return;
            }
            return;
        ...
        if (i8 >= 0 && i8 < (i9 = this.size)) {
            ...
            if (i9 <= 1) {
                ...
                if (iArr.length > 8 && i9 < iArr.length / 3) {
                    ...
                    if (i9 == this.size) {
                        if (i8 > 0) {
                            AbstractC1371l.g(iArr, this.hashes, 0, 0, i8);
                            AbstractC1371l.i(objArr, this.array, 0, 0, i10);
                        }
                        if (i8 < i11) {
                            int i13 = i8 + 1;
                            AbstractC1371l.g(iArr, this.hashes, i8, i13, i9);
                            AbstractC1371l.i(objArr, this.array, i10, i13 << 1, i9 << 1);
                        }
                    } else {
                        throw new ConcurrentModificationException();
                    }
                    ...
                    if (i8 < i11) {
                        int i14 = i8 + 1;
                        AbstractC1371l.g(iArr, iArr, i8, i14, i9);
                        Object[] objArr2 = this.array;
                        AbstractC1371l.i(objArr2, objArr2, i10, i14 << 1, i9 << 1);
                    }
                    Object[] objArr3 = this.array;
                    int i15 = i11 << 1;
                    objArr3[i15] = null;
    ...
    public boolean remove(K k8, V v8) {
        int indexOfKey = indexOfKey(k8);
        if (indexOfKey < 0 || !AbstractC3255y.d(v8, valueAt(indexOfKey))) {
            return false;
        }
        removeAt(indexOfKey);
        return true;
    ...
    public /* synthetic */ SimpleArrayMap(int i8, int i9, AbstractC3247p abstractC3247p) {
        this((i9 & 1) != 0 ? 0 : i8);
    }
