...
public abstract class FloatFloatMap {
    ...
    public /* synthetic */ FloatFloatMap(AbstractC3247p abstractC3247p) {
        this();
    }
    ...
    public final float getOrDefault(float f8, float f9) {
        int findKeyIndex = findKeyIndex(f8);
        if (findKeyIndex >= 0) {
            return this.values[findKeyIndex];
        }
    ...
    public final float getOrElse(float f8, Function0 defaultValue) {
                ...
                if ((((~j8) << 7) & j8 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i12 = 0; i12 < i11; i12++) {
                        if ((255 & j8) < 128) {
                            int i13 = (i9 << 3) + i12;
                            float f8 = fArr[i13];
                            i10 += Float.floatToIntBits(fArr2[i13]) ^ Float.floatToIntBits(f8);
                        }
                        j8 >>= 8;
                    }
                    if (i11 != 8) {
            ...
            while (true) {
                ...
                if ((((~j8) << 7) & j8 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i12 = 0; i12 < i11; i12++) {
                        if ((255 & j8) < 128) {
                            int i13 = (i9 << 3) + i12;
                            if (((Boolean) predicate.invoke(Float.valueOf(fArr[i13]), Float.valueOf(fArr2[i13]))).booleanValue()) {
                                i10++;
                            }
                        }
                        j8 >>= 8;
    ...
    public static /* synthetic */ String joinToString$default(FloatFloatMap floatFloatMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i8, CharSequence charSequence4, InterfaceC1668n transform, int i9, Object obj) {
        long[] jArr;
        long[] jArr2;
        if (obj == null) {
                    ...
                    if ((((~j8) << 7) & j8 & (-9187201950435737472L)) != -9187201950435737472L) {
                        ...
                        while (i15 < i14) {
                            if ((j8 & 255) < 128) {
                                ...
                                jArr2 = jArr3;
                                sb.append((CharSequence) transform.invoke(valueOf, Float.valueOf(f9)));
                                i12++;
                            } else {
                                jArr2 = jArr3;
                            }
                ...
                if ((((~j8) << 7) & j8 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i13 < i12) {
                        if ((j8 & 255) < 128) {
                            ...
                            sb.append((CharSequence) transform.invoke(Float.valueOf(f8), Float.valueOf(f9)));
                            i10++;
                        }
                        j8 >>= 8;
                        i13++;
