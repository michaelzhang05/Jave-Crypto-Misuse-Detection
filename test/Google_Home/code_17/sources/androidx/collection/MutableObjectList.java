...
public final class MutableObjectList<E> extends ObjectList<E> {
    ...
    /* loaded from: classes.dex */
    private static final class MutableObjectListIterator<T> implements ListIterator<T>, InterfaceC1985a {
    ...
    /* loaded from: classes.dex */
    public static final class ObjectListMutableList<T> implements List<T>, InterfaceC1986b {
        private final MutableObjectList<T> objectList;

        public ObjectListMutableList(MutableObjectList<T> objectList) {
            AbstractC3255y.i(objectList, "objectList");
    ...
    public final boolean addAll(@IntRange(from = 0) int i8, E[] elements) {
        ...
        if (i8 >= 0 && i8 <= (i9 = this._size)) {
            ...
            int i10 = this._size;
            if (i8 != i10) {
                AbstractC1371l.i(objArr, objArr, elements.length + i8, i8, i10);
            }
            AbstractC1371l.n(elements, objArr, i8, 0, 0, 12, null);
    ...
    public final void clear() {
        AbstractC1371l.t(this.content, null, 0, this._size);
        this._size = 0;
    }
    ...
    public final void plusAssign(ObjectList<E> elements) {
        ...
        AbstractC1371l.i(elements.content, this.content, this._size, 0, elements._size);
    ...
    public final E removeAt(@IntRange(from = 0) int i8) {
        ...
        if (i8 >= 0 && i8 < (i9 = this._size)) {
            ...
            E e8 = (E) objArr[i8];
            if (i8 != i9 - 1) {
                AbstractC1371l.i(objArr, objArr, i8, i8 + 1, i9);
            }
    ...
    public final void removeIf(Function1 predicate) {
        ...
        if (e8 <= f8) {
            while (true) {
                objArr[e8 - i9] = objArr[e8];
                if (((Boolean) predicate.invoke(objArr[e8])).booleanValue()) {
                    i9++;
                }
                if (e8 == f8) {
                    break;
        ...
        AbstractC1371l.t(objArr, null, i8 - i9, i8);
        this._size -= i9;
    }
        ...
        if (i8 >= 0 && i8 <= (i10 = this._size) && i9 >= 0 && i9 <= i10) {
            if (i9 >= i8) {
                if (i9 != i8) {
                    if (i9 < i10) {
                        Object[] objArr = this.content;
                        AbstractC1371l.i(objArr, objArr, i8, i9, i10);
                    }
                    int i11 = this._size;
                    int i12 = i11 - (i9 - i8);
                    AbstractC1371l.t(this.content, null, i12, i11);
                    this._size = i12;
                    return;
                }
                return;
    ...
    public final boolean retainAll(E[] elements) {
        ...
        for (int i9 = i8 - 1; -1 < i9; i9--) {
            if (AbstractC1371l.p0(elements, objArr[i9]) < 0) {
                removeAt(i9);
            }
        }
        return i8 != this._size;
    ...
    public /* synthetic */ MutableObjectList(int i8, int i9, AbstractC3247p abstractC3247p) {
        this((i9 & 1) != 0 ? 16 : i8);
    }
    ...
    public final void add(@IntRange(from = 0) int i8, E e8) {
        ...
        if (i8 >= 0 && i8 <= (i9 = this._size)) {
            ...
            int i10 = this._size;
            if (i8 != i10) {
                AbstractC1371l.i(objArr, objArr, i8 + 1, i8, i10);
            }
            objArr[i8] = e8;
            this._size++;
            return;
    ...
    public final boolean addAll(@IntRange(from = 0) int i8, Collection<? extends E> elements) {
        ...
        if (i8 >= 0 && i8 <= this._size) {
            ...
            Object[] objArr = this.content;
            if (i8 != this._size) {
                AbstractC1371l.i(objArr, objArr, elements.size() + i8, i8, this._size);
            }
    ...
    public final void plusAssign(E[] elements) {
        ...
        AbstractC1371l.n(elements, this.content, this._size, 0, 0, 12, null);
        this._size += elements.length;
    }
    ...
    public final boolean retainAll(Iterable<? extends E> elements) {
        ...
        Object[] objArr = this.content;
        for (int i9 = i8 - 1; -1 < i9; i9--) {
            if (!AbstractC1378t.d0(elements, objArr[i9])) {
                removeAt(i9);
            }
        }
        return i8 != this._size;
    ...
    public final boolean addAll(@IntRange(from = 0) int i8, ObjectList<E> elements) {
        ...
        if (i8 >= 0 && i8 <= this._size) {
            ...
            int i9 = this._size;
            if (i8 != i9) {
                AbstractC1371l.i(objArr, objArr, elements._size + i8, i8, i9);
            }
            AbstractC1371l.i(elements.content, objArr, i8, 0, elements._size);
            this._size += elements._size;
            return true;
        }
        throw new IndexOutOfBoundsException("Index " + i8 + " must be in 0.." + this._size);
    ...
    public final boolean retainAll(InterfaceC2998g elements) {
        AbstractC3255y.i(elements, "elements");
        int i8 = this._size;
        Object[] objArr = this.content;
        for (int i9 = i8 - 1; -1 < i9; i9--) {
            if (!AbstractC3001j.n(elements, objArr[i9])) {
                removeAt(i9);
            }
        }
        return i8 != this._size;
