...
public final class CircularIntArray {
    ...
    private final void doubleCapacity() {
        ...
        if (i10 >= 0) {
            ...
            AbstractC1371l.g(iArr, iArr2, 0, i8, length);
            AbstractC1371l.g(this.elements, iArr2, i9, 0, this.head);
            this.elements = iArr2;
            this.head = 0;
            this.tail = length;
    ...
    public /* synthetic */ CircularIntArray(int i8, int i9, AbstractC3247p abstractC3247p) {
        this((i9 & 1) != 0 ? 8 : i8);
    }
}
