...
public final class MutableFloatList extends FloatList {
    ...
    public final boolean addAll(@IntRange(from = 0) int i8, float[] elements) {
        ...
        if (i8 >= 0 && i8 <= (i9 = this._size)) {
            ...
            int i10 = this._size;
            if (i8 != i10) {
                AbstractC1371l.f(fArr, fArr, elements.length + i8, i8, i10);
            }
            AbstractC1371l.k(elements, fArr, i8, 0, 0, 12, null);
    ...
    public final float removeAt(@IntRange(from = 0) int i8) {
        ...
        if (i8 >= 0 && i8 < (i9 = this._size)) {
            ...
            float f8 = fArr[i8];
            if (i8 != i9 - 1) {
                AbstractC1371l.f(fArr, fArr, i8, i8 + 1, i9);
            }
            this._size--;
            return f8;
        }
        ...
        if (i8 >= 0 && i8 <= (i10 = this._size) && i9 >= 0 && i9 <= i10) {
            if (i9 >= i8) {
                if (i9 != i8) {
                    if (i9 < i10) {
                        float[] fArr = this.content;
                        AbstractC1371l.f(fArr, fArr, i8, i9, i10);
                    }
                    this._size -= i9 - i8;
                    return;
                }
    ...
    public final void sort() {
        AbstractC1371l.G(this.content, 0, this._size);
    }

    public final void sortDescending() {
        AbstractC1371l.M0(this.content, 0, this._size);
    }
    ...
    public /* synthetic */ MutableFloatList(int i8, int i9, AbstractC3247p abstractC3247p) {
        this((i9 & 1) != 0 ? 16 : i8);
    }
    ...
    public final void add(@IntRange(from = 0) int i8, float f8) {
        ...
        if (i8 >= 0 && i8 <= (i9 = this._size)) {
            ...
            int i10 = this._size;
            if (i8 != i10) {
                AbstractC1371l.f(fArr, fArr, i8 + 1, i8, i10);
            }
            fArr[i8] = f8;
            this._size++;
            return;
    ...
    public final boolean addAll(@IntRange(from = 0) int i8, FloatList elements) {
        ...
        if (i8 >= 0 && i8 <= this._size) {
            ...
            int i9 = this._size;
            if (i8 != i9) {
                AbstractC1371l.f(fArr, fArr, elements._size + i8, i8, i9);
            }
            AbstractC1371l.f(elements.content, fArr, i8, 0, elements._size);
