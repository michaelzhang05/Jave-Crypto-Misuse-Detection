...
public final class DefaultSpecialEffectsController extends SpecialEffectsController {
    ...
    public static final void executeOperations$lambda$2(List awaitingContainerChanges, SpecialEffectsController.Operation operation, DefaultSpecialEffectsController this$0) {
        AbstractC3255y.i(awaitingContainerChanges, "$awaitingContainerChanges");
        AbstractC3255y.i(operation, "$operation");
    ...
    private final void retainMatchingViews(ArrayMap<String, View> arrayMap, Collection<String> collection) {
        ...
        AbstractC3255y.h(entries, "entries");
        AbstractC1378t.R(entries, new DefaultSpecialEffectsController$retainMatchingViews$1(collection));
    }
            ...
            if (animationInfo.isVisibilityUnchanged()) {
                ...
                if (animation == null) {
                    ...
                    if (animator == null) {
                        ...
                        if (AbstractC3255y.d(map.get(operation), Boolean.TRUE)) {
                            ...
                            animator.addListener(new AnimatorListenerAdapter() { // from class: androidx.fragment.app.DefaultSpecialEffectsController$startAnimations$1
                                ...
                                public void onAnimationEnd(Animator anim) {
                                    ...
                                    if (z9) {
                                        ...
                                        AbstractC3255y.h(viewToAnimate, "viewToAnimate");
    ...
    private final Map<SpecialEffectsController.Operation, Boolean> startTransitions(List<TransitionInfo> list, List<SpecialEffectsController.Operation> list2, boolean z8, final SpecialEffectsController.Operation operation, final SpecialEffectsController.Operation operation2) {
        ...
        while (true) {
            ...
            if (!next.hasSharedElementTransition() || operation == null || operation2 == null) {
                ...
                AbstractC3255y.h(sharedElementSourceNames, "lastIn.fragment.sharedElementSourceNames");
                ArrayList<String> sharedElementSourceNames2 = operation.getFragment().getSharedElementSourceNames();
                View view8 = view7;
                AbstractC3255y.h(sharedElementSourceNames2, "firstOut.fragment.sharedElementSourceNames");
                ArrayList<String> sharedElementTargetNames = operation.getFragment().getSharedElementTargetNames();
                LinkedHashMap linkedHashMap3 = linkedHashMap2;
                AbstractC3255y.h(sharedElementTargetNames, "firstOut.fragment.sharedElementTargetNames");
                ...
                AbstractC3255y.h(sharedElementTargetNames2, "lastIn.fragment.sharedElementTargetNames");
                if (!z9) {
                ...
                AbstractC3255y.h(view10, "firstOut.fragment.mView");
                    ...
                    if (size3 >= 0) {
                        while (true) {
                            ...
                            if (view11 == null) {
                                ...
                                fragmentTransitionImpl = fragmentTransitionImpl2;
                                if (!AbstractC3255y.d(str4, ViewCompat.getTransitionName(view11))) {
                ...
                AbstractC3255y.h(view12, "lastIn.fragment.mView");
                ...
                if (sharedElementCallback2 != null) {
                    ...
                    if (size4 >= 0) {
                        while (true) {
                            ...
                            } else if (!AbstractC3255y.d(name, ViewCompat.getTransitionName(view13))) {
                                AbstractC3255y.h(name, "name");
                ...
                AbstractC3255y.h(keySet, "sharedElementNameMapping.keys");
                defaultSpecialEffectsController.retainMatchingViews(arrayMap2, keySet);
                Collection<String> values = arrayMap.values();
                AbstractC3255y.h(values, "sharedElementNameMapping.values");
        ...
        for (TransitionInfo transitionInfo3 : list) {
            if (transitionInfo3.isVisibilityUnchanged()) {
                ...
                if (cloneTransition != null) {
                    ...
                    String str5 = str;
                    AbstractC3255y.h(view17, "operation.fragment.mView");
                    defaultSpecialEffectsController.captureTransitioningViews(arrayList10, view17);
                    if (z11) {
                        if (operation3 == operation) {
                            arrayList10.removeAll(AbstractC1378t.b1(arrayList8));
                        } else {
                            arrayList10.removeAll(AbstractC1378t.b1(arrayList7));
                        }
                    }
        ...
        if (FragmentManager.isLoggingEnabled(2)) {
            ...
            while (it4.hasNext()) {
                ...
                AbstractC3255y.h(sharedElementFirstOutViews, "sharedElementFirstOutViews");
            ...
            while (it5.hasNext()) {
                ...
                AbstractC3255y.h(sharedElementLastInViews, "sharedElementLastInViews");
    ...
    public static final void startTransitions$lambda$10(FragmentTransitionImpl impl, View view, Rect lastInEpicenterRect) {
        AbstractC3255y.i(impl, "$impl");
        AbstractC3255y.i(lastInEpicenterRect, "$lastInEpicenterRect");
    ...
    public static final void startTransitions$lambda$11(ArrayList transitioningViews) {
        AbstractC3255y.i(transitioningViews, "$transitioningViews");
    ...
    public static final void startTransitions$lambda$14$lambda$13(TransitionInfo transitionInfo, SpecialEffectsController.Operation operation) {
        AbstractC3255y.i(transitionInfo, "$transitionInfo");
        AbstractC3255y.i(operation, "$operation");
    ...
    public static final void startTransitions$lambda$9(SpecialEffectsController.Operation operation, SpecialEffectsController.Operation operation2, boolean z8, ArrayMap lastInViews) {
        AbstractC3255y.i(lastInViews, "$lastInViews");
    ...
    private final void syncAnimations(List<? extends SpecialEffectsController.Operation> list) {
        Fragment fragment = ((SpecialEffectsController.Operation) AbstractC1378t.y0(list)).getFragment();
    ...
    public void executeOperations(List<? extends SpecialEffectsController.Operation> operations, boolean z8) {
        ...
        Object obj;
        AbstractC3255y.i(operations, "operations");
        ...
        while (true) {
            ...
            AbstractC3255y.h(view2, "operation.fragment.mView");
        ...
        ArrayList arrayList2 = new ArrayList();
        final List<SpecialEffectsController.Operation> Z02 = AbstractC1378t.Z0(operations);
