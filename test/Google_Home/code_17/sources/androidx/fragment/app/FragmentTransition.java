...
public final class FragmentTransition {
    ...
    public static final void callSharedElementStartEnd(Fragment inFragment, Fragment outFragment, boolean z8, ArrayMap<String, View> sharedElements, boolean z9) {
        ...
        AbstractC3255y.i(inFragment, "inFragment");
        AbstractC3255y.i(outFragment, "outFragment");
        AbstractC3255y.i(sharedElements, "sharedElements");
        if (z8) {
    ...
    public static final String findKeyForValue(ArrayMap<String, String> arrayMap, String value) {
        AbstractC3255y.i(arrayMap, "<this>");
        AbstractC3255y.i(value, "value");
        LinkedHashMap linkedHashMap = new LinkedHashMap();
        for (Map.Entry<String, String> entry : arrayMap.entrySet()) {
            if (AbstractC3255y.d(entry.getValue(), value)) {
        ...
        return (String) AbstractC1378t.o0(arrayList);
    }

    private final FragmentTransitionImpl resolveSupportImpl() {
        try {
            AbstractC3255y.g(FragmentTransitionSupport.class, "null cannot be cast to non-null type java.lang.Class<androidx.fragment.app.FragmentTransitionImpl>");
    ...
    public static final void retainValues(ArrayMap<String, String> arrayMap, ArrayMap<String, View> namedViews) {
        AbstractC3255y.i(arrayMap, "<this>");
        AbstractC3255y.i(namedViews, "namedViews");
