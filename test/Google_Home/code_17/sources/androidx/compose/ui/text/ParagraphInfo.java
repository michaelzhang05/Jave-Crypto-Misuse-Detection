...
public final class ParagraphInfo {
    ...
    public final Rect toGlobal(Rect rect) {
        return rect.m2777translatek4lQ0M(OffsetKt.Offset(0.0f, this.top));
    }

    /* renamed from: toGlobal-GEjPoXI, reason: not valid java name */
    public final long m4586toGlobalGEjPoXI(long j8) {
        return TextRangeKt.TextRange(toGlobalIndex(TextRange.m4697getStartimpl(j8)), toGlobalIndex(TextRange.m4692getEndimpl(j8)));
    }
    ...
    public final long m4587toLocalMKHz9U(long j8) {
        return OffsetKt.Offset(Offset.m2740getXimpl(j8), Offset.m2741getYimpl(j8) - this.top);
    }
    ...
    public final Path toGlobal(Path path) {
        path.mo2877translatek4lQ0M(OffsetKt.Offset(0.0f, this.top));
        return path;
    }

    public /* synthetic */ ParagraphInfo(Paragraph paragraph, int i8, int i9, int i10, int i11, float f8, float f9, int i12, AbstractC3247p abstractC3247p) {
