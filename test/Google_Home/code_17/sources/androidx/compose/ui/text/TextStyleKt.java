...
public final class TextStyleKt {
    ...
    public static final int m4743resolveTextDirectionIhaHGbI(LayoutDirection layoutDirection, int i8) {
        TextDirection.Companion companion = TextDirection.Companion;
        if (TextDirection.m5097equalsimpl0(i8, companion.m5101getContents_7Xco())) {
            int i9 = WhenMappings.$EnumSwitchMapping$0[layoutDirection.ordinal()];
            if (i9 != 1) {
                if (i9 == 2) {
                    return companion.m5103getContentOrRtls_7Xco();
                }
                throw new p();
            }
            return companion.m5102getContentOrLtrs_7Xco();
        }
        if (TextDirection.m5097equalsimpl0(i8, companion.m5106getUnspecifieds_7Xco())) {
            int i10 = WhenMappings.$EnumSwitchMapping$0[layoutDirection.ordinal()];
            if (i10 != 1) {
                if (i10 == 2) {
                    return companion.m5105getRtls_7Xco();
                }
                throw new p();
            }
            return companion.m5104getLtrs_7Xco();
        }
        return i8;
    }
}
