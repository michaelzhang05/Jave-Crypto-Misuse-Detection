...
public final class RecordingInputConnection implements InputConnection {
    ...
    private final boolean endBatchEditInternal() {
        ...
        if (i8 == 0 && (!this.editCommands.isEmpty())) {
            this.eventCallback.onEditCommands(AbstractC1378t.Z0(this.editCommands));
    ...
    public int getCursorCapsMode(int i8) {
        return TextUtils.getCapsMode(this.mTextFieldValue.getText(), TextRange.m4695getMinimpl(this.mTextFieldValue.m4934getSelectiond9O1mEE()), i8);
    }
    ...
    public CharSequence getSelectedText(int i8) {
        if (TextRange.m4691getCollapsedimpl(this.mTextFieldValue.m4934getSelectiond9O1mEE())) {
            return null;
        }
    ...
    public boolean performEditorAction(int i8) {
        int m4872getDefaulteUduSuo;
        boolean z8 = this.isActive;
        if (z8) {
            if (i8 != 0) {
                switch (i8) {
                    case 2:
                        m4872getDefaulteUduSuo = ImeAction.Companion.m4874getGoeUduSuo();
                        break;
                    case 3:
                        m4872getDefaulteUduSuo = ImeAction.Companion.m4878getSearcheUduSuo();
                        break;
                    case 4:
                        m4872getDefaulteUduSuo = ImeAction.Companion.m4879getSendeUduSuo();
                        break;
                    case 5:
                        m4872getDefaulteUduSuo = ImeAction.Companion.m4875getNexteUduSuo();
                        break;
                    case 6:
                        m4872getDefaulteUduSuo = ImeAction.Companion.m4873getDoneeUduSuo();
                        break;
                    case 7:
                        m4872getDefaulteUduSuo = ImeAction.Companion.m4877getPreviouseUduSuo();
                        break;
                    default:
                        Log.w(RecordingInputConnection_androidKt.TAG, "IME sends unsupported Editor Action: " + i8);
                        m4872getDefaulteUduSuo = ImeAction.Companion.m4872getDefaulteUduSuo();
                        break;
                }
            } else {
                m4872getDefaulteUduSuo = ImeAction.Companion.m4872getDefaulteUduSuo();
            }
            this.eventCallback.mo4888onImeActionKlQnJC8(m4872getDefaulteUduSuo);
            return true;
        }
        return z8;
    }
    ...
    public final void updateInputState(TextFieldValue textFieldValue, InputMethodManager inputMethodManager) {
        ...
        inputMethodManager.updateSelection(TextRange.m4695getMinimpl(textFieldValue.m4934getSelectiond9O1mEE()), TextRange.m4694getMaximpl(textFieldValue.m4934getSelectiond9O1mEE()), i8, i9);
    }
}
