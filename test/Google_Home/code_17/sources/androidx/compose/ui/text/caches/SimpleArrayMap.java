...
public final class SimpleArrayMap<K, V> {
    ...
    protected final int indexOf(Object obj, int i8) {
        ...
        if (AbstractC3255y.d(obj, this.keyValues[binarySearchInternal << 1])) {
            return binarySearchInternal;
        }
        int i10 = binarySearchInternal + 1;
        while (i10 < i9 && this.hashes[i10] == i8) {
            if (AbstractC3255y.d(obj, this.keyValues[i10 << 1])) {
                return i10;
            }
            i10++;
        }
        for (int i11 = binarySearchInternal - 1; i11 >= 0 && this.hashes[i11] == i8; i11--) {
            if (AbstractC3255y.d(obj, this.keyValues[i11 << 1])) {
                return i11;
            }
        }
        return ~i10;
    ...
    public final V put(K k8, V v8) {
        ...
        if (i10 < i8) {
            ...
            int i12 = i10 + 1;
            AbstractC1371l.g(iArr2, iArr2, i12, i10, i8);
            Object[] objArr2 = this.keyValues;
            AbstractC1371l.i(objArr2, objArr2, i12 << 1, i10 << 1, this._size << 1);
        }
        int i13 = this._size;
        if (i8 == i13) {
    ...
    public final void putAll(SimpleArrayMap<? extends K, ? extends V> simpleArrayMap) {
        ...
        if (this._size == 0) {
            if (i8 > 0) {
                AbstractC1371l.g(simpleArrayMap.hashes, this.hashes, 0, 0, i8);
                AbstractC1371l.i(simpleArrayMap.keyValues, this.keyValues, 0, 0, i8 << 1);
                this._size = i8;
                return;
            }
            return;
    ...
    public final V removeAt(int i8) {
        ...
        if (i10 <= 1) {
            ...
            if (iArr.length > 8 && i10 < iArr.length / 3) {
                ...
                if (i8 > 0) {
                    AbstractC1371l.g(iArr, iArr2, 0, 0, i8);
                    AbstractC1371l.i(objArr, this.keyValues, 0, 0, i9);
                }
                if (i8 < i11) {
                    int i13 = i8 + 1;
                    AbstractC1371l.g(iArr, this.hashes, i8, i13, i10);
                    AbstractC1371l.i(objArr, this.keyValues, i9, i13 << 1, i10 << 1);
                }
            } else {
                if (i8 < i11) {
                    int i14 = i8 + 1;
                    AbstractC1371l.g(iArr, iArr, i8, i14, i10);
                    Object[] objArr2 = this.keyValues;
                    AbstractC1371l.i(objArr2, objArr2, i9, i14 << 1, i10 << 1);
                }
                Object[] objArr3 = this.keyValues;
                int i15 = i11 << 1;
                objArr3[i15] = null;
