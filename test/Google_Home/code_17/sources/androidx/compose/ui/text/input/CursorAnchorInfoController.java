...
public final class CursorAnchorInfoController {
    ...
    private final float[] matrix = Matrix.m3187constructorimpl$default(null, 1, null);
    ...
    private final void updateCursorAnchorInfo() {
        ...
        this.textFieldToRootTransform.invoke(Matrix.m3185boximpl(this.matrix));
        this.rootPositionCalculator.mo4091localToScreen58bKbWc(this.matrix);
        AndroidMatrixConversions_androidKt.m2852setFromEL8BTi8(this.androidMatrix, this.matrix);
        InputMethodManager inputMethodManager = this.inputMethodManager;
        CursorAnchorInfo.Builder builder = this.builder;
        TextFieldValue textFieldValue = this.textFieldValue;
        AbstractC3255y.f(textFieldValue);
        OffsetMapping offsetMapping = this.offsetMapping;
        AbstractC3255y.f(offsetMapping);
