...
final class SaversKt$AnnotationRangeSaver$1 extends AbstractC3256z implements InterfaceC1668n {
    ...
    public final Object invoke(SaverScope saverScope, AnnotatedString.Range<? extends Object> range) {
        ...
        if (i8 == 1) {
            ...
            AbstractC3255y.g(item2, "null cannot be cast to non-null type androidx.compose.ui.text.ParagraphStyle");
            save = SaversKt.save((ParagraphStyle) item2, SaversKt.getParagraphStyleSaver(), saverScope);
        } else if (i8 == 2) {
            Object item3 = range.getItem();
            AbstractC3255y.g(item3, "null cannot be cast to non-null type androidx.compose.ui.text.SpanStyle");
            save = SaversKt.save((SpanStyle) item3, SaversKt.getSpanStyleSaver(), saverScope);
        } else if (i8 == 3) {
            Object item4 = range.getItem();
            AbstractC3255y.g(item4, "null cannot be cast to non-null type androidx.compose.ui.text.VerbatimTtsAnnotation");
            ...
            AbstractC3255y.g(item5, "null cannot be cast to non-null type androidx.compose.ui.text.UrlAnnotation");
        ...
        return AbstractC1378t.g(SaversKt.save(annotationType), save, SaversKt.save(Integer.valueOf(range.getStart())), SaversKt.save(Integer.valueOf(range.getEnd())), SaversKt.save(range.getTag()));
    }
}
