...
final class SaversKt$AnnotationRangeListSaver$2 extends AbstractC3256z implements Function1 {
    ...
    public final List<AnnotatedString.Range<? extends Object>> invoke(Object obj) {
        ...
        for (int i8 = 0; i8 < size; i8++) {
            ...
            if (!AbstractC3255y.d(obj2, Boolean.FALSE) && obj2 != null) {
                range = (AnnotatedString.Range) saver.restore(obj2);
            }
            AbstractC3255y.f(range);
            arrayList.add(range);
        }
        return arrayList;
    }
