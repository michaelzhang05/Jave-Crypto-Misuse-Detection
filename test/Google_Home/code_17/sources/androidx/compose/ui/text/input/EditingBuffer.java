...
public final class EditingBuffer {
    ...
    public /* synthetic */ EditingBuffer(AnnotatedString annotatedString, long j8, AbstractC3247p abstractC3247p) {
    ...
    public final void delete$ui_text_release(int i8, int i9) {
        ...
        long m4856updateRangeAfterDeletepWDy79M = EditingBufferKt.m4856updateRangeAfterDeletepWDy79M(TextRangeKt.TextRange(this.selectionStart, this.selectionEnd), TextRange);
        setSelectionStart(TextRange.m4695getMinimpl(m4856updateRangeAfterDeletepWDy79M));
        setSelectionEnd(TextRange.m4694getMaximpl(m4856updateRangeAfterDeletepWDy79M));
        if (hasComposition$ui_text_release()) {
            long m4856updateRangeAfterDeletepWDy79M2 = EditingBufferKt.m4856updateRangeAfterDeletepWDy79M(TextRangeKt.TextRange(this.compositionStart, this.compositionEnd), TextRange);
            if (TextRange.m4691getCollapsedimpl(m4856updateRangeAfterDeletepWDy79M2)) {
                commitComposition$ui_text_release();
            } else {
                this.compositionStart = TextRange.m4695getMinimpl(m4856updateRangeAfterDeletepWDy79M2);
                this.compositionEnd = TextRange.m4694getMaximpl(m4856updateRangeAfterDeletepWDy79M2);
            }
        }
    }
    ...
    public final TextRange m4854getCompositionMzsxiRA$ui_text_release() {
        if (hasComposition$ui_text_release()) {
            return TextRange.m4685boximpl(TextRangeKt.TextRange(this.compositionStart, this.compositionEnd));
        }
        return null;
    }
    ...
    public final long m4855getSelectiond9O1mEE$ui_text_release() {
    ...
    public /* synthetic */ EditingBuffer(String str, long j8, AbstractC3247p abstractC3247p) {
        this(str, j8);
    }
    ...
    private EditingBuffer(AnnotatedString annotatedString, long j8) {
        ...
        this.selectionStart = TextRange.m4695getMinimpl(j8);
        this.selectionEnd = TextRange.m4694getMaximpl(j8);
        this.compositionStart = -1;
        this.compositionEnd = -1;
        int m4695getMinimpl = TextRange.m4695getMinimpl(j8);
        int m4694getMaximpl = TextRange.m4694getMaximpl(j8);
        if (m4695getMinimpl >= 0 && m4695getMinimpl <= annotatedString.length()) {
            if (m4694getMaximpl < 0 || m4694getMaximpl > annotatedString.length()) {
                throw new IndexOutOfBoundsException("end (" + m4694getMaximpl + ") offset is outside of text region " + annotatedString.length());
            }
            if (m4695getMinimpl <= m4694getMaximpl) {
                return;
            }
            throw new IllegalArgumentException("Do not set reversed range: " + m4695getMinimpl + " > " + m4694getMaximpl);
        }
        throw new IndexOutOfBoundsException("start (" + m4695getMinimpl + ") offset is outside of text region " + annotatedString.length());
    }

    private EditingBuffer(String str, long j8) {
        this(new AnnotatedString(str, null, null, 6, null), j8, (AbstractC3247p) null);
    }
}
