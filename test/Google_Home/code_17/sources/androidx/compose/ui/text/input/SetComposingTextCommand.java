...
public final class SetComposingTextCommand implements EditCommand {
    ...
    public void applyTo(EditingBuffer editingBuffer) {
        ...
        editingBuffer.setCursor$ui_text_release(g6.m.k(length, 0, editingBuffer.getLength$ui_text_release()));
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (AbstractC3255y.d(getText(), setComposingTextCommand.getText()) && this.newCursorPosition == setComposingTextCommand.newCursorPosition) {
            return true;
        }
        return false;
    }
