...
public final class FontWeight implements Comparable<FontWeight> {
    ...
    static {
        ...
        Black = fontWeight9;
        values = AbstractC1378t.p(fontWeight, fontWeight2, fontWeight3, fontWeight4, fontWeight5, fontWeight6, fontWeight7, fontWeight8, fontWeight9);
    }
    ...
    public int compareTo(FontWeight fontWeight) {
        return AbstractC3255y.k(this.weight, fontWeight.weight);
    }
}
