...
public abstract class FontFamily {
    ...
    public interface Resolver {
        Object preload(FontFamily fontFamily, S5.d dVar);

        /* renamed from: resolve-DPcqOEQ, reason: not valid java name */
        State<Object> mo4782resolveDPcqOEQ(FontFamily fontFamily, FontWeight fontWeight, int i8, int i9);
    }

    public /* synthetic */ FontFamily(boolean z8, AbstractC3247p abstractC3247p) {
        this(z8);
    }
