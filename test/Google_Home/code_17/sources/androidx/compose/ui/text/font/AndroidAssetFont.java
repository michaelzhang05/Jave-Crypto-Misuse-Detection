...
public final class AndroidAssetFont extends AndroidPreloadedFont {
    ...
    public /* synthetic */ AndroidAssetFont(AssetManager assetManager, String str, FontWeight fontWeight, int i8, FontVariation.Settings settings, AbstractC3247p abstractC3247p) {
    ...
    public boolean equals(Object obj) {
        ...
        if (AbstractC3255y.d(this.path, androidAssetFont.path) && AbstractC3255y.d(getVariationSettings(), androidAssetFont.getVariationSettings())) {
            return true;
        }
        return false;
    }
    ...
    public String toString() {
        return "Font(assetManager, path=" + this.path + ", weight=" + getWeight() + ", style=" + ((Object) FontStyle.m4809toStringimpl(mo4763getStyle_LCdwA())) + ')';
    }

    public /* synthetic */ AndroidAssetFont(AssetManager assetManager, String str, FontWeight fontWeight, int i8, FontVariation.Settings settings, int i9, AbstractC3247p abstractC3247p) {
        this(assetManager, str, (i9 & 4) != 0 ? FontWeight.Companion.getNormal() : fontWeight, (i9 & 8) != 0 ? FontStyle.Companion.m4814getNormal_LCdwA() : i8, settings, null);
    }
