...
public final class AndroidParagraph_androidKt {
    ...
    public static final Paragraph m4945ActualParagraphhBUhpc(ParagraphIntrinsics paragraphIntrinsics, int i8, boolean z8, long j8) {
        AbstractC3255y.g(paragraphIntrinsics, "null cannot be cast to non-null type androidx.compose.ui.text.platform.AndroidParagraphIntrinsics");
        return new AndroidParagraph((AndroidParagraphIntrinsics) paragraphIntrinsics, i8, z8, j8, null);
    }

    /* renamed from: ActualParagraph-O3s9Psw, reason: not valid java name */
    public static final Paragraph m4946ActualParagraphO3s9Psw(String str, TextStyle textStyle, List<AnnotatedString.Range<SpanStyle>> list, List<AnnotatedString.Range<Placeholder>> list2, int i8, boolean z8, long j8, Density density, FontFamily.Resolver resolver) {
