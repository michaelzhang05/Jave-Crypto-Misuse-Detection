...
public final class ShaderBrushSpan extends CharacterStyle implements UpdateAppearance {
    ...
    public ShaderBrushSpan(ShaderBrush shaderBrush, float f8) {
        ...
        this.alpha = f8;
        mutableStateOf$default = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Size.m2797boximpl(Size.Companion.m2817getUnspecifiedNHjbRc()), null, 2, null);
    ...
    public final long m4969getSizeNHjbRc() {
        return ((Size) this.size$delegate.getValue()).m2814unboximpl();
    }

    /* renamed from: setSize-uvyYCjk, reason: not valid java name */
    public final void m4970setSizeuvyYCjk(long j8) {
