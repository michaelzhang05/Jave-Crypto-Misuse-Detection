...
public final class TextLayoutInput {
    ...
    public /* synthetic */ TextLayoutInput(AnnotatedString annotatedString, TextStyle textStyle, List list, int i8, boolean z8, int i9, Density density, LayoutDirection layoutDirection, Font.ResourceLoader resourceLoader, long j8, AbstractC3247p abstractC3247p) {
    ...
    public static /* synthetic */ TextLayoutInput m4663copyhu1Yfo$default(TextLayoutInput textLayoutInput, AnnotatedString annotatedString, TextStyle textStyle, List list, int i8, boolean z8, int i9, Density density, LayoutDirection layoutDirection, Font.ResourceLoader resourceLoader, long j8, int i10, Object obj) {
        ...
        return textLayoutInput.m4664copyhu1Yfo(annotatedString2, textStyle2, list2, i11, z9, i12, density2, layoutDirection2, resourceLoader2, j9);
    }
    ...
    public final TextLayoutInput m4664copyhu1Yfo(AnnotatedString annotatedString, TextStyle textStyle, List<AnnotatedString.Range<Placeholder>> list, int i8, boolean z8, int i9, Density density, LayoutDirection layoutDirection, Font.ResourceLoader resourceLoader, long j8) {
    ...
    public boolean equals(Object obj) {
        ...
        if (AbstractC3255y.d(this.text, textLayoutInput.text) && AbstractC3255y.d(this.style, textLayoutInput.style) && AbstractC3255y.d(this.placeholders, textLayoutInput.placeholders) && this.maxLines == textLayoutInput.maxLines && this.softWrap == textLayoutInput.softWrap && TextOverflow.m5129equalsimpl0(this.overflow, textLayoutInput.overflow) && AbstractC3255y.d(this.density, textLayoutInput.density) && this.layoutDirection == textLayoutInput.layoutDirection && AbstractC3255y.d(this.fontFamilyResolver, textLayoutInput.fontFamilyResolver) && Constraints.m5144equalsimpl0(this.constraints, textLayoutInput.constraints)) {
            return true;
        }
        return false;
    }
    ...
    public final long m4665getConstraintsmsEJaDk() {
    ...
    public final int m4666getOverflowgIe3tQ8() {
    ...
    public int hashCode() {
        return (((((((((((((((((this.text.hashCode() * 31) + this.style.hashCode()) * 31) + this.placeholders.hashCode()) * 31) + this.maxLines) * 31) + androidx.compose.foundation.a.a(this.softWrap)) * 31) + TextOverflow.m5130hashCodeimpl(this.overflow)) * 31) + this.density.hashCode()) * 31) + this.layoutDirection.hashCode()) * 31) + this.fontFamilyResolver.hashCode()) * 31) + Constraints.m5154hashCodeimpl(this.constraints);
    }

    public String toString() {
        return "TextLayoutInput(text=" + ((Object) this.text) + ", style=" + this.style + ", placeholders=" + this.placeholders + ", maxLines=" + this.maxLines + ", softWrap=" + this.softWrap + ", overflow=" + ((Object) TextOverflow.m5131toStringimpl(this.overflow)) + ", density=" + this.density + ", layoutDirection=" + this.layoutDirection + ", fontFamilyResolver=" + this.fontFamilyResolver + ", constraints=" + ((Object) Constraints.m5156toStringimpl(this.constraints)) + ')';
    }

    public /* synthetic */ TextLayoutInput(AnnotatedString annotatedString, TextStyle textStyle, List list, int i8, boolean z8, int i9, Density density, LayoutDirection layoutDirection, FontFamily.Resolver resolver, long j8, AbstractC3247p abstractC3247p) {
