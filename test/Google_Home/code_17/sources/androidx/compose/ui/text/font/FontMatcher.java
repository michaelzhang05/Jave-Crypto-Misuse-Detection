...
public final class FontMatcher {
    ...
    public static /* synthetic */ List filterByClosestWeight$ui_text_release$default(FontMatcher fontMatcher, List list, FontWeight fontWeight, boolean z8, FontWeight fontWeight2, FontWeight fontWeight3, int i8, Object obj) {
        ...
        for (int i10 = 0; i10 < size2; i10++) {
            ...
            if (AbstractC3255y.d(((Font) obj2).getWeight(), fontWeight4)) {
                arrayList.add(obj2);
            }
        }
        return arrayList;
    ...
    public final List<Font> filterByClosestWeight$ui_text_release(List<? extends Font> list, FontWeight fontWeight, boolean z8, FontWeight fontWeight2, FontWeight fontWeight3) {
        ...
        for (int i9 = 0; i9 < size2; i9++) {
            ...
            if (AbstractC3255y.d(font.getWeight(), fontWeight4)) {
                arrayList.add(font);
            }
        }
        return arrayList;
    ...
    public final List<Font> m4801matchFontRetOiIg(FontFamily fontFamily, FontWeight fontWeight, int i8) {
        if (fontFamily instanceof FontListFontFamily) {
            return m4802matchFontRetOiIg((FontListFontFamily) fontFamily, fontWeight, i8);
        }
        throw new IllegalArgumentException("Only FontFamily instances that presents a list of Fonts can be used");
    }

    /* renamed from: matchFont-RetOiIg, reason: not valid java name */
    public final List<Font> m4802matchFontRetOiIg(FontListFontFamily fontListFontFamily, FontWeight fontWeight, int i8) {
        return m4803matchFontRetOiIg(fontListFontFamily.getFonts(), fontWeight, i8);
    }

    /* renamed from: matchFont-RetOiIg, reason: not valid java name */
    public final List<Font> m4803matchFontRetOiIg(List<? extends Font> list, FontWeight fontWeight, int i8) {
        ArrayList arrayList = new ArrayList(list.size());
        int size = list.size();
        int i9 = 0;
        for (int i10 = 0; i10 < size; i10++) {
            ...
            Font font2 = font;
            if (AbstractC3255y.d(font2.getWeight(), fontWeight) && FontStyle.m4807equalsimpl0(font2.mo4763getStyle_LCdwA(), i8)) {
                arrayList.add(font);
            }
        }
        ...
        for (int i11 = 0; i11 < size2; i11++) {
            ...
            if (FontStyle.m4807equalsimpl0(font3.mo4763getStyle_LCdwA(), i8)) {
        ...
        if (fontWeight.compareTo(companion.getW400()) < 0) {
            ...
            while (i9 < size4) {
                ...
                if (AbstractC3255y.d(font4.getWeight(), fontWeight3)) {
        ...
        if (fontWeight.compareTo(companion.getW500()) > 0) {
            ...
            while (i9 < size6) {
                ...
                if (AbstractC3255y.d(font5.getWeight(), fontWeight4)) {
        ...
        for (int i15 = 0; i15 < size8; i15++) {
            ...
            if (AbstractC3255y.d(font6.getWeight(), fontWeight5)) {
        ...
        while (i9 < size10) {
            ...
            if (AbstractC3255y.d(font7.getWeight(), fontWeight2)) {
