...
public final class DeviceFontFamilyNameFontKt {
    ...
    public static final Font m4780Fontvxs03AY(String str, FontWeight fontWeight, int i8, FontVariation.Settings settings) {
    ...
    public static /* synthetic */ Font m4781Fontvxs03AY$default(String str, FontWeight fontWeight, int i8, FontVariation.Settings settings, int i9, Object obj) {
        if ((i9 & 2) != 0) {
        ...
        return m4780Fontvxs03AY(str, fontWeight, i8, settings);
    }
}
