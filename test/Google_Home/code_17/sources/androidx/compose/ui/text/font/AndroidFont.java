...
public abstract class AndroidFont implements Font {
    ...
    public interface TypefaceLoader {
        Object awaitLoad(Context context, AndroidFont androidFont, S5.d dVar);

        android.graphics.Typeface loadBlocking(Context context, AndroidFont androidFont);
    }

    public /* synthetic */ AndroidFont(int i8, TypefaceLoader typefaceLoader, FontVariation.Settings settings, AbstractC3247p abstractC3247p) {
        this(i8, typefaceLoader, settings);
    }

    @Override // androidx.compose.ui.text.font.Font
    /* renamed from: getLoadingStrategy-PKNRLFQ, reason: not valid java name */
    public final int mo4753getLoadingStrategyPKNRLFQ() {
    ...
    public /* synthetic */ AndroidFont(int i8, TypefaceLoader typefaceLoader, AbstractC3247p abstractC3247p) {
