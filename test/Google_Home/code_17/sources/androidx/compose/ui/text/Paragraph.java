...
public interface Paragraph {
    ...
    void mo4546fillBoundingBoxes8ffj60Q(long j8, float[] fArr, @IntRange(from = 0) int i8);
    ...
    int mo4548getOffsetForPositionk4lQ0M(long j8);
    ...
    long mo4549getWordBoundaryjx7JFs(int i8);

    boolean isLineEllipsized(int i8);

    /* renamed from: paint-LG529CI */
    void mo4550paintLG529CI(Canvas canvas, long j8, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int i8);

    /* renamed from: paint-RPmYEkk */
    void mo4551paintRPmYEkk(Canvas canvas, long j8, Shadow shadow, TextDecoration textDecoration);

    /* renamed from: paint-hn5TExg */
    void mo4552painthn5TExg(Canvas canvas, Brush brush, float f8, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int i8);
}
