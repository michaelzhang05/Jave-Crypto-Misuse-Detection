...
public final class TextDrawStyleKt {
    public static final TextForegroundStyle lerp(TextForegroundStyle textForegroundStyle, TextForegroundStyle textForegroundStyle2, float f8) {
        ...
        if (!z8 && !(textForegroundStyle2 instanceof BrushStyle)) {
            return TextForegroundStyle.Companion.m5108from8_81llA(ColorKt.m3027lerpjxsXWHM(textForegroundStyle.mo4985getColor0d7_KjU(), textForegroundStyle2.mo4985getColor0d7_KjU(), f8));
        }
        if (z8 && (textForegroundStyle2 instanceof BrushStyle)) {
    ...
    public static final long m5107modulateDxMtmZc(long j8, float f8) {
