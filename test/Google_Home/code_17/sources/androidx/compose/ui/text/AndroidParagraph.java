...
public final class AndroidParagraph implements Paragraph {
    ...
    private final InterfaceC1355k wordBoundary$delegate;
    ...
    public /* synthetic */ AndroidParagraph(AndroidParagraphIntrinsics androidParagraphIntrinsics, int i8, boolean z8, long j8, AbstractC3247p abstractC3247p) {
    ...
    private final ShaderBrushSpan[] getShaderBrushSpans(TextLayout textLayout) {
        ...
        AbstractC3255y.g(text, "null cannot be cast to non-null type android.text.Spanned");
    ...
    public void mo4546fillBoundingBoxes8ffj60Q(long j8, float[] fArr, @IntRange(from = 0) int i8) {
        this.layout.fillBoundingBoxes(TextRange.m4695getMinimpl(j8), TextRange.m4694getMaximpl(j8), fArr, i8);
    }
    ...
    public final long m4547getConstraintsmsEJaDk() {
    ...
    public int mo4548getOffsetForPositionk4lQ0M(long j8) {
        return this.layout.getOffsetForHorizontal(this.layout.getLineForVertical((int) Offset.m2741getYimpl(j8)), Offset.m2740getXimpl(j8));
    }
    ...
    public float getWidth() {
        return Constraints.m5151getMaxWidthimpl(this.constraints);
    }

    @Override // androidx.compose.ui.text.Paragraph
    /* renamed from: getWordBoundary--jx7JFs, reason: not valid java name */
    public long mo4549getWordBoundaryjx7JFs(int i8) {
    ...
    public void mo4550paintLG529CI(Canvas canvas, long j8, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int i8) {
        int m4949getBlendMode0nO6VwU = getTextPaint$ui_text_release().m4949getBlendMode0nO6VwU();
        AndroidTextPaint textPaint$ui_text_release = getTextPaint$ui_text_release();
        textPaint$ui_text_release.m4952setColor8_81llA(j8);
        ...
        textPaint$ui_text_release.m4950setBlendModes9anfk8(i8);
        paint(canvas);
        getTextPaint$ui_text_release().m4950setBlendModes9anfk8(m4949getBlendMode0nO6VwU);
    }

    @Override // androidx.compose.ui.text.Paragraph
    /* renamed from: paint-RPmYEkk, reason: not valid java name */
    public void mo4551paintRPmYEkk(Canvas canvas, long j8, Shadow shadow, TextDecoration textDecoration) {
        AndroidTextPaint textPaint$ui_text_release = getTextPaint$ui_text_release();
        textPaint$ui_text_release.m4952setColor8_81llA(j8);
        textPaint$ui_text_release.setShadow(shadow);
        textPaint$ui_text_release.setTextDecoration(textDecoration);
    ...
    public void mo4552painthn5TExg(Canvas canvas, Brush brush, float f8, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int i8) {
        int m4949getBlendMode0nO6VwU = getTextPaint$ui_text_release().m4949getBlendMode0nO6VwU();
        AndroidTextPaint textPaint$ui_text_release = getTextPaint$ui_text_release();
        textPaint$ui_text_release.m4951setBrush12SF9DM(brush, SizeKt.Size(getWidth(), getHeight()), f8);
        textPaint$ui_text_release.setShadow(shadow);
        textPaint$ui_text_release.setTextDecoration(textDecoration);
        textPaint$ui_text_release.setDrawStyle(drawStyle);
        textPaint$ui_text_release.m4950setBlendModes9anfk8(i8);
    ...
    public /* synthetic */ AndroidParagraph(String str, TextStyle textStyle, List list, List list2, int i8, boolean z8, long j8, FontFamily.Resolver resolver, Density density, AbstractC3247p abstractC3247p) {
    ...
    private AndroidParagraph(AndroidParagraphIntrinsics androidParagraphIntrinsics, int i8, boolean z8, long j8) {
        ...
        int m4558toLayoutAlignaXe7zB0;
        int m4560toLayoutHyphenationFrequency3fSNIE;
        int m4559toLayoutBreakStrategyxImikfE;
        int m4561toLayoutLineBreakStylehpcqdu8;
        int m4562toLayoutLineBreakWordStylewPN0Rpw;
        List<Rect> list;
        Rect rect;
        ...
        this.ellipsis = z8;
        this.constraints = j8;
        if (Constraints.m5152getMinHeightimpl(j8) != 0 || Constraints.m5153getMinWidthimpl(j8) != 0) {
        ...
        if (i8 >= 1) {
            ...
            m4558toLayoutAlignaXe7zB0 = AndroidParagraph_androidKt.m4558toLayoutAlignaXe7zB0(style.m4738getTextAligne0LSkKk());
            boolean m5083equalsimpl0 = TextAlign.m5083equalsimpl0(style.m4738getTextAligne0LSkKk(), TextAlign.Companion.m5089getJustifye0LSkKk());
            m4560toLayoutHyphenationFrequency3fSNIE = AndroidParagraph_androidKt.m4560toLayoutHyphenationFrequency3fSNIE(style.getParagraphStyle$ui_text_release().m4607getHyphensvmbZdU8());
            m4559toLayoutBreakStrategyxImikfE = AndroidParagraph_androidKt.m4559toLayoutBreakStrategyxImikfE(LineBreak.m5007getStrategyfcGXIks(style.m4735getLineBreakrAG3T2k()));
            m4561toLayoutLineBreakStylehpcqdu8 = AndroidParagraph_androidKt.m4561toLayoutLineBreakStylehpcqdu8(LineBreak.m5008getStrictnessusljTpc(style.m4735getLineBreakrAG3T2k()));
            m4562toLayoutLineBreakWordStylewPN0Rpw = AndroidParagraph_androidKt.m4562toLayoutLineBreakWordStylewPN0Rpw(LineBreak.m5009getWordBreakjp8hJ3c(style.m4735getLineBreakrAG3T2k()));
            TextUtils.TruncateAt truncateAt = z8 ? TextUtils.TruncateAt.END : null;
            TextLayout constructTextLayout = constructTextLayout(m4558toLayoutAlignaXe7zB0, m5083equalsimpl0 ? 1 : 0, truncateAt, i8, m4560toLayoutHyphenationFrequency3fSNIE, m4559toLayoutBreakStrategyxImikfE, m4561toLayoutLineBreakStylehpcqdu8, m4562toLayoutLineBreakWordStylewPN0Rpw);
            if (z8 && constructTextLayout.getHeight() > Constraints.m5150getMaxHeightimpl(j8) && i8 > 1) {
                numberOfLinesThatFitMaxHeight = AndroidParagraph_androidKt.numberOfLinesThatFitMaxHeight(constructTextLayout, Constraints.m5150getMaxHeightimpl(j8));
                if (numberOfLinesThatFitMaxHeight >= 0 && numberOfLinesThatFitMaxHeight != i8) {
                    constructTextLayout = constructTextLayout(m4558toLayoutAlignaXe7zB0, m5083equalsimpl0 ? 1 : 0, truncateAt, m.d(numberOfLinesThatFitMaxHeight, 1), m4560toLayoutHyphenationFrequency3fSNIE, m4559toLayoutBreakStrategyxImikfE, m4561toLayoutLineBreakStylehpcqdu8, m4562toLayoutLineBreakWordStylewPN0Rpw);
                }
                this.layout = constructTextLayout;
            } else {
                this.layout = constructTextLayout;
            }
            getTextPaint$ui_text_release().m4951setBrush12SF9DM(style.getBrush(), SizeKt.Size(getWidth(), getHeight()), style.getAlpha());
            for (ShaderBrushSpan shaderBrushSpan : getShaderBrushSpans(this.layout)) {
                shaderBrushSpan.m4970setSizeuvyYCjk(SizeKt.Size(getWidth(), getHeight()));
            }
            ...
            this.wordBoundary$delegate = l.a(o.f8297c, new AndroidParagraph$wordBoundary$2(this));
            return;
        }
