...
public final class AndroidAccessibilitySpannableString_androidKt {
    private static final void setSpanStyle(SpannableString spannableString, SpanStyle spanStyle, int i8, int i9, Density density, FontFamily.Resolver resolver) {
        ...
        SpannableExtensions_androidKt.m4962setColorRPmYEkk(spannableString, spanStyle.m4656getColor0d7_KjU(), i8, i9);
        SpannableExtensions_androidKt.m4963setFontSizeKmRG4DE(spannableString, spanStyle.m4657getFontSizeXSAIIZE(), density, i8, i9);
        if (spanStyle.getFontWeight() != null || spanStyle.m4658getFontStyle4Lr2A7w() != null) {
            ...
            spannableString.setSpan(new StyleSpan(AndroidFontUtils_androidKt.m4762getAndroidTypefaceStyleFO1MlWM(fontWeight, m4814getNormal_LCdwA)), i8, i9, 33);
        }
        if (spanStyle.getFontFamily() != null) {
            if (spanStyle.getFontFamily() instanceof GenericFontFamily) {
                ...
                Object value = b.a(resolver, fontFamily, null, 0, m4824getAllGVVA2EU, 6, null).getValue();
        ...
        SpannableExtensions_androidKt.m4960setBackgroundRPmYEkk(spannableString, spanStyle.m4654getBackground0d7_KjU(), i8, i9);
    }
    ...
    public static final SpannableString toAccessibilitySpannableString(AnnotatedString annotatedString, Density density, FontFamily.Resolver resolver, URLSpanCache uRLSpanCache) {
        ...
        if (spanStylesOrNull$ui_text_release != null) {
            ...
            for (int i8 = 0; i8 < size; i8++) {
                ...
                setSpanStyle(spannableString, SpanStyle.m4647copyGSF8kmg$default(component1, 0L, 0L, null, null, null, null, null, 0L, null, null, null, 0L, null, null, null, null, 65503, null), range.component2(), range.component3(), density, resolver);
            }
        }
