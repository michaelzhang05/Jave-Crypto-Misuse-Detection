...
public final class MultiParagraph {
    ...
    public /* synthetic */ MultiParagraph(AnnotatedString annotatedString, TextStyle textStyle, long j8, Density density, FontFamily.Resolver resolver, List list, int i8, boolean z8, AbstractC3247p abstractC3247p) {
    ...
    public static /* synthetic */ void m4573paintLG529CI$default(MultiParagraph multiParagraph, Canvas canvas, long j8, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int i8, int i9, Object obj) {
        long j9;
        Shadow shadow2;
        ...
        multiParagraph.m4579paintLG529CI(canvas, j9, shadow2, textDecoration2, drawStyle2, i10);
    }

    /* renamed from: paint-RPmYEkk$default, reason: not valid java name */
    public static /* synthetic */ void m4574paintRPmYEkk$default(MultiParagraph multiParagraph, Canvas canvas, long j8, Shadow shadow, TextDecoration textDecoration, int i8, Object obj) {
        Shadow shadow2;
        TextDecoration textDecoration2;
        if ((i8 & 2) != 0) {
            j8 = Color.Companion.m3012getUnspecified0d7_KjU();
        }
        long j9 = j8;
        if ((i8 & 4) != 0) {
            shadow2 = null;
        ...
        multiParagraph.m4580paintRPmYEkk(canvas, j9, shadow2, textDecoration2);
    }

    /* renamed from: paint-hn5TExg$default, reason: not valid java name */
    public static /* synthetic */ void m4575painthn5TExg$default(MultiParagraph multiParagraph, Canvas canvas, Brush brush, float f8, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int i8, int i9, Object obj) {
        float f9;
        Shadow shadow2;
        TextDecoration textDecoration2;
        ...
        multiParagraph.m4581painthn5TExg(canvas, brush, f9, shadow2, textDecoration2, drawStyle2, i10);
    }
    ...
    public final float[] m4576fillBoundingBoxes8ffj60Q(long j8, float[] fArr, @IntRange(from = 0) int i8) {
        requireIndexInRange(TextRange.m4695getMinimpl(j8));
        requireIndexInRangeInclusiveEnd(TextRange.m4694getMaximpl(j8));
        Q q8 = new Q();
        q8.f34160a = i8;
        MultiParagraphKt.m4582findParagraphsByRangeSbBc2M(this.paragraphInfoList, j8, new MultiParagraph$fillBoundingBoxes$1(j8, fArr, q8, new P()));
        return fArr;
    }
    ...
    public final ResolvedTextDirection getBidiRunDirection(int i8) {
        ...
        if (i8 == getAnnotatedString().length()) {
            findParagraphByIndex = AbstractC1378t.o(this.paragraphInfoList);
        } else {
    ...
    public final float getLastBaseline() {
        ...
        ParagraphInfo paragraphInfo = (ParagraphInfo) AbstractC1378t.y0(this.paragraphInfoList);
    ...
    public final int getLineForVerticalPosition(float f8) {
        ...
        if (f8 <= 0.0f) {
            ...
            findParagraphByY = AbstractC1378t.o(this.paragraphInfoList);
        } else {
    ...
    public final int m4577getOffsetForPositionk4lQ0M(long j8) {
        int findParagraphByY;
        if (Offset.m2741getYimpl(j8) <= 0.0f) {
            findParagraphByY = 0;
        } else if (Offset.m2741getYimpl(j8) >= this.height) {
            findParagraphByY = AbstractC1378t.o(this.paragraphInfoList);
        } else {
            findParagraphByY = MultiParagraphKt.findParagraphByY(this.paragraphInfoList, Offset.m2741getYimpl(j8));
        }
        ParagraphInfo paragraphInfo = this.paragraphInfoList.get(findParagraphByY);
        if (paragraphInfo.getLength() == 0) {
            return paragraphInfo.getStartIndex();
        }
        return paragraphInfo.toGlobalIndex(paragraphInfo.getParagraph().mo4548getOffsetForPositionk4lQ0M(paragraphInfo.m4587toLocalMKHz9U(j8)));
    }
    ...
    public final Path getPathForRange(int i8, int i9) {
        if (i8 >= 0 && i8 <= i9 && i9 <= getAnnotatedString().getText().length()) {
            ...
            MultiParagraphKt.m4582findParagraphsByRangeSbBc2M(this.paragraphInfoList, TextRangeKt.TextRange(i8, i9), new MultiParagraph$getPathForRange$2(Path, i8, i9));
            return Path;
        }
    ...
    public final long m4578getWordBoundaryjx7JFs(int i8) {
        int findParagraphByIndex;
        requireIndexInRangeInclusiveEnd(i8);
        if (i8 == getAnnotatedString().length()) {
            findParagraphByIndex = AbstractC1378t.o(this.paragraphInfoList);
        ...
        ParagraphInfo paragraphInfo = this.paragraphInfoList.get(findParagraphByIndex);
        return paragraphInfo.m4586toGlobalGEjPoXI(paragraphInfo.getParagraph().mo4549getWordBoundaryjx7JFs(paragraphInfo.toLocalIndex(i8)));
    }
    ...
    public final void m4579paintLG529CI(Canvas canvas, long j8, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int i8) {
        canvas.save();
        List<ParagraphInfo> list = this.paragraphInfoList;
        int size = list.size();
        for (int i9 = 0; i9 < size; i9++) {
            ParagraphInfo paragraphInfo = list.get(i9);
            paragraphInfo.getParagraph().mo4550paintLG529CI(canvas, j8, shadow, textDecoration, drawStyle, i8);
    ...
    public final /* synthetic */ void m4580paintRPmYEkk(Canvas canvas, long j8, Shadow shadow, TextDecoration textDecoration) {
        canvas.save();
        List<ParagraphInfo> list = this.paragraphInfoList;
        int size = list.size();
        for (int i8 = 0; i8 < size; i8++) {
            ParagraphInfo paragraphInfo = list.get(i8);
            paragraphInfo.getParagraph().mo4551paintRPmYEkk(canvas, j8, shadow, textDecoration);
            canvas.translate(0.0f, paragraphInfo.getParagraph().getHeight());
        }
        canvas.restore();
    }
    ...
    public final void m4581painthn5TExg(Canvas canvas, Brush brush, float f8, Shadow shadow, TextDecoration textDecoration, DrawStyle drawStyle, int i8) {
        AndroidMultiParagraphDraw_androidKt.m4939drawMultiParagraph7AXcY_I(this, canvas, brush, f8, shadow, textDecoration, drawStyle, i8);
    }

    public /* synthetic */ MultiParagraph(MultiParagraphIntrinsics multiParagraphIntrinsics, long j8, int i8, boolean z8, AbstractC3247p abstractC3247p) {
    ...
    private MultiParagraph(MultiParagraphIntrinsics multiParagraphIntrinsics, long j8, int i8, boolean z8) {
        ...
        this.maxLines = i8;
        if (Constraints.m5153getMinWidthimpl(j8) == 0 && Constraints.m5152getMinHeightimpl(j8) == 0) {
            ...
            while (i10 < size) {
                ...
                if (Constraints.m5146getHasBoundedHeightimpl(j8)) {
                    m5150getMaxHeightimpl = m.d(Constraints.m5150getMaxHeightimpl(j8) - ParagraphKt.ceilToInt(f8), i9);
                } else {
                    m5150getMaxHeightimpl = Constraints.m5150getMaxHeightimpl(j8);
                }
                Paragraph m4590Paragraph_EkL_Y = ParagraphKt.m4590Paragraph_EkL_Y(intrinsics, ConstraintsKt.Constraints$default(0, m5151getMaxWidthimpl, 0, m5150getMaxHeightimpl, 5, null), this.maxLines - i11, z8);
                float height = f8 + m4590Paragraph_EkL_Y.getHeight();
                int lineCount = i11 + m4590Paragraph_EkL_Y.getLineCount();
                List<ParagraphIntrinsicInfo> list = infoList$ui_text_release;
                arrayList.add(new ParagraphInfo(m4590Paragraph_EkL_Y, paragraphIntrinsicInfo.getStartIndex(), paragraphIntrinsicInfo.getEndIndex(), i11, lineCount, f8, height));
                if (m4590Paragraph_EkL_Y.getDidExceedMaxLines() || (lineCount == this.maxLines && i10 != AbstractC1378t.o(this.intrinsics.getInfoList$ui_text_release()))) {
                    z9 = true;
                    i11 = lineCount;
                    f8 = height;
                    break;
            ...
            this.width = Constraints.m5151getMaxWidthimpl(j8);
            ...
            for (int i12 = 0; i12 < size2; i12++) {
                ...
                AbstractC1378t.D(arrayList2, arrayList3);
            }
            if (arrayList2.size() < this.intrinsics.getPlaceholders().size()) {
                ...
                arrayList2 = AbstractC1378t.G0(arrayList2, arrayList4);
            }
    ...
    public /* synthetic */ MultiParagraph(MultiParagraphIntrinsics multiParagraphIntrinsics, long j8, int i8, boolean z8, int i9, AbstractC3247p abstractC3247p) {
        this(multiParagraphIntrinsics, j8, (i9 & 4) != 0 ? Integer.MAX_VALUE : i8, (i9 & 8) != 0 ? false : z8, null);
    }

    public /* synthetic */ MultiParagraph(MultiParagraphIntrinsics multiParagraphIntrinsics, int i8, boolean z8, float f8, int i9, AbstractC3247p abstractC3247p) {
    ...
    public /* synthetic */ MultiParagraph(AnnotatedString annotatedString, TextStyle textStyle, List list, int i8, boolean z8, float f8, Density density, Font.ResourceLoader resourceLoader, int i9, AbstractC3247p abstractC3247p) {
        this(annotatedString, textStyle, (List<AnnotatedString.Range<Placeholder>>) ((i9 & 4) != 0 ? AbstractC1378t.m() : list), (i9 & 8) != 0 ? Integer.MAX_VALUE : i8, (i9 & 16) != 0 ? false : z8, f8, density, resourceLoader);
    }
    ...
    public /* synthetic */ MultiParagraph(AnnotatedString annotatedString, TextStyle textStyle, float f8, Density density, FontFamily.Resolver resolver, List list, int i8, boolean z8, int i9, AbstractC3247p abstractC3247p) {
        this(annotatedString, textStyle, f8, density, resolver, (List<AnnotatedString.Range<Placeholder>>) ((i9 & 32) != 0 ? AbstractC1378t.m() : list), (i9 & 64) != 0 ? Integer.MAX_VALUE : i8, (i9 & 128) != 0 ? false : z8);
    }
    ...
    public /* synthetic */ MultiParagraph(AnnotatedString annotatedString, TextStyle textStyle, long j8, Density density, FontFamily.Resolver resolver, List list, int i8, boolean z8, int i9, AbstractC3247p abstractC3247p) {
        this(annotatedString, textStyle, j8, density, resolver, (i9 & 32) != 0 ? AbstractC1378t.m() : list, (i9 & 64) != 0 ? Integer.MAX_VALUE : i8, (i9 & 128) != 0 ? false : z8, null);
    }
