...
public final class MultiParagraphKt {
    ...
    public static final void m4582findParagraphsByRangeSbBc2M(List<ParagraphInfo> list, long j8, Function1 function1) {
        int size = list.size();
        for (int findParagraphByIndex = findParagraphByIndex(list, TextRange.m4695getMinimpl(j8)); findParagraphByIndex < size; findParagraphByIndex++) {
            ParagraphInfo paragraphInfo = list.get(findParagraphByIndex);
            if (paragraphInfo.getStartIndex() < TextRange.m4694getMaximpl(j8)) {
