...
final class GapBuffer {
    ...
    private final void delete(int i8, int i9) {
        ...
        if (i8 < i10 && i9 <= i10) {
            ...
            AbstractC1371l.e(cArr, cArr, this.gapEnd - i11, i9, i10);
            this.gapStart = i8;
            this.gapEnd -= i11;
            return;
        }
        ...
        AbstractC1371l.e(cArr2, cArr2, this.gapStart, i12, gapLength);
    ...
    private final void makeSureAvailableSpace(int i8) {
        ...
        AbstractC1371l.e(this.buffer, cArr, 0, 0, this.gapStart);
        int i10 = this.capacity;
        int i11 = this.gapEnd;
        int i12 = i10 - i11;
        int i13 = i9 - i12;
        AbstractC1371l.e(this.buffer, cArr, i13, i11, i12 + i11);
        this.buffer = cArr;
        this.capacity = i9;
        this.gapEnd = i13;
    }
