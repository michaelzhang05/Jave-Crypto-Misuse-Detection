...
public final class PasswordVisualTransformation implements VisualTransformation {
    ...
    public TransformedText filter(AnnotatedString annotatedString) {
        return new TransformedText(new AnnotatedString(j6.n.w(String.valueOf(this.mask), annotatedString.getText().length()), null, null, 6, null), OffsetMapping.Companion.getIdentity());
    }
    ...
    public /* synthetic */ PasswordVisualTransformation(char c8, int i8, AbstractC3247p abstractC3247p) {
