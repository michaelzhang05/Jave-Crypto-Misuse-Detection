...
public final class PlatformTextStyle {
    ...
    public /* synthetic */ PlatformTextStyle(int i8, AbstractC3247p abstractC3247p) {
        this(i8);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (AbstractC3255y.d(this.paragraphStyle, platformTextStyle.paragraphStyle) && AbstractC3255y.d(this.spanStyle, platformTextStyle.spanStyle)) {
            return true;
        }
        return false;
    }
    ...
    public /* synthetic */ PlatformTextStyle(boolean z8, int i8, AbstractC3247p abstractC3247p) {
    ...
    private PlatformTextStyle(int i8) {
        this((PlatformSpanStyle) null, new PlatformParagraphStyle(i8, (AbstractC3247p) null));
    }
}
