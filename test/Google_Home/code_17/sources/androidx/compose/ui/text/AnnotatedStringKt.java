...
public final class AnnotatedStringKt {
    ...
    public static final AnnotatedString AnnotatedString(String str, SpanStyle spanStyle, ParagraphStyle paragraphStyle) {
        return new AnnotatedString(str, AbstractC1378t.e(new AnnotatedString.Range(spanStyle, 0, str.length())), paragraphStyle == null ? AbstractC1378t.m() : AbstractC1378t.e(new AnnotatedString.Range(paragraphStyle, 0, str.length())));
    }
    ...
    public static final <T> List<T> mapEachParagraphStyle(AnnotatedString annotatedString, ParagraphStyle paragraphStyle, InterfaceC1668n interfaceC1668n) {
        ...
        for (int i8 = 0; i8 < size; i8++) {
            ...
            arrayList.add(interfaceC1668n.invoke(substringWithoutParagraphStyles(annotatedString, range.getStart(), range.getEnd()), range));
        }
        return arrayList;
    }
    ...
    public static final List<AnnotatedString.Range<ParagraphStyle>> normalizedParagraphStyles(AnnotatedString annotatedString, ParagraphStyle paragraphStyle) {
        ...
        if (paragraphStylesOrNull$ui_text_release == null) {
            paragraphStylesOrNull$ui_text_release = AbstractC1378t.m();
        }
    ...
    public static final AnnotatedString AnnotatedString(String str, ParagraphStyle paragraphStyle) {
        return new AnnotatedString(str, AbstractC1378t.m(), AbstractC1378t.e(new AnnotatedString.Range(paragraphStyle, 0, str.length())));
    }
