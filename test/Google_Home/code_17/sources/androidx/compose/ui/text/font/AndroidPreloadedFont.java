...
public abstract class AndroidPreloadedFont extends AndroidFont {
    ...
    public /* synthetic */ AndroidPreloadedFont(FontWeight fontWeight, int i8, FontVariation.Settings settings, AbstractC3247p abstractC3247p) {
    ...
    public final int mo4763getStyle_LCdwA() {
        return this.style;
    }
    ...
    private AndroidPreloadedFont(FontWeight fontWeight, int i8, FontVariation.Settings settings) {
        super(FontLoadingStrategy.Companion.m4799getBlockingPKNRLFQ(), AndroidPreloadedFontTypefaceLoader.INSTANCE, settings, null);
