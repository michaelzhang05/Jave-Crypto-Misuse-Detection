...
public interface ModifierLocalProvider<T> extends Modifier.Element {
    ...
    public static final class DefaultImpls {
        ...
        @Deprecated
        public static <T, R> R foldIn(ModifierLocalProvider<T> modifierLocalProvider, R r8, InterfaceC1668n interfaceC1668n) {
            Object c8;
            c8 = androidx.compose.ui.b.c(modifierLocalProvider, r8, interfaceC1668n);
            return (R) c8;
        }

        @Deprecated
        public static <T, R> R foldOut(ModifierLocalProvider<T> modifierLocalProvider, R r8, InterfaceC1668n interfaceC1668n) {
            Object d8;
            d8 = androidx.compose.ui.b.d(modifierLocalProvider, r8, interfaceC1668n);
            return (R) d8;
        }
