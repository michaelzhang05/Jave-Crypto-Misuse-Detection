    ...
    public static float a(FontScaling fontScaling, long j8) {
        if (TextUnitType.m5398equalsimpl0(TextUnit.m5369getTypeUIouoOA(j8), TextUnitType.Companion.m5403getSpUIouoOA())) {
            ...
            if (fontScaleConverterFactory.isNonLinearFontScalingActive(fontScaling.getFontScale()) && !FontScalingKt.getDisableNonLinearFontScalingInCompose()) {
                ...
                if (forScale == null) {
                    return Dp.m5183constructorimpl(TextUnit.m5370getValueimpl(j8) * fontScaling.getFontScale());
                }
                return Dp.m5183constructorimpl(forScale.convertSpToDp(TextUnit.m5370getValueimpl(j8)));
            }
            return Dp.m5183constructorimpl(TextUnit.m5370getValueimpl(j8) * fontScaling.getFontScale());
        }
