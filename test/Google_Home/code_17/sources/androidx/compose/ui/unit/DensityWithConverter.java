...
public final class DensityWithConverter implements Density {
    ...
    public boolean equals(Object obj) {
        ...
        return Float.compare(this.density, densityWithConverter.density) == 0 && Float.compare(this.fontScale, densityWithConverter.fontScale) == 0 && AbstractC3255y.d(this.converter, densityWithConverter.converter);
    }
    ...
    public float mo448toDpGaN1DYA(long j8) {
        if (TextUnitType.m5398equalsimpl0(TextUnit.m5369getTypeUIouoOA(j8), TextUnitType.Companion.m5403getSpUIouoOA())) {
            return Dp.m5183constructorimpl(this.converter.convertSpToDp(TextUnit.m5370getValueimpl(j8)));
        }
