...
public final class IntRect {
    ...
    public static /* synthetic */ void m5325getSizeYbymL2g$annotations() {
    }
    ...
    public final boolean m5326containsgyyYBs(long j8) {
        if (IntOffset.m5307getXimpl(j8) >= this.left && IntOffset.m5307getXimpl(j8) < this.right && IntOffset.m5308getYimpl(j8) >= this.top && IntOffset.m5308getYimpl(j8) < this.bottom) {
            return true;
        }
        return false;
    }
    ...
    public final long m5333getSizeYbymL2g() {
    ...
    public final IntRect m5337translategyyYBs(long j8) {
        return new IntRect(this.left + IntOffset.m5307getXimpl(j8), this.top + IntOffset.m5308getYimpl(j8), this.right + IntOffset.m5307getXimpl(j8), this.bottom + IntOffset.m5308getYimpl(j8));
    }
}
