...
public final class PrimitiveResources_androidKt {
    ...
    public static final float dimensionResource(@DimenRes int i8, Composer composer, int i9) {
        ...
        float m5183constructorimpl = Dp.m5183constructorimpl(((Context) composer.consume(AndroidCompositionLocals_androidKt.getLocalContext())).getResources().getDimension(i8) / ((Density) composer.consume(CompositionLocalsKt.getLocalDensity())).getDensity());
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
