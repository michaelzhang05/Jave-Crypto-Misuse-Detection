...
public final class FocusTargetNode extends Modifier.Node implements CompositionLocalConsumerModifierNode, FocusTargetModifierNode, ObserverModifierNode, ModifierLocalModifierNode {
    ...
    public final void m2684fetchCustomEnteraToIllA$ui_release(int i8, Function1 function1) {
        if (!this.isProcessingCustomEnter) {
            this.isProcessingCustomEnter = true;
            try {
                FocusRequester focusRequester = (FocusRequester) fetchFocusProperties$ui_release().getEnter().invoke(FocusDirection.m2654boximpl(i8));
    ...
    public final void m2685fetchCustomExitaToIllA$ui_release(int i8, Function1 function1) {
        if (!this.isProcessingCustomExit) {
            this.isProcessingCustomExit = true;
            try {
                FocusRequester focusRequester = (FocusRequester) fetchFocusProperties$ui_release().getExit().invoke(FocusDirection.m2654boximpl(i8));
                if (focusRequester != FocusRequester.Companion.getDefault()) {
                    function1.invoke(focusRequester);
                }
            } finally {
    ...
    public final FocusProperties fetchFocusProperties$ui_release() {
        ...
        int m4348constructorimpl = NodeKind.m4348constructorimpl(2048);
        int m4348constructorimpl2 = NodeKind.m4348constructorimpl(1024);
        Modifier.Node node = getNode();
        int i8 = m4348constructorimpl | m4348constructorimpl2;
                ...
                if ((requireLayoutNode.getNodes$ui_release().getHead$ui_release().getAggregateChildKindSet$ui_release() & i8) != 0) {
                    while (node2 != null) {
                        if ((node2.getKindSet$ui_release() & i8) != 0) {
                            if (node2 != node && (node2.getKindSet$ui_release() & m4348constructorimpl2) != 0) {
                                break loop0;
                            }
    ...
    public final void invalidateFocus$ui_release() {
        ...
        if (i8 == 1 || i8 == 2) {
            ...
            if (obj == null) {
                AbstractC3255y.y("focusProperties");
    ...
    public final void scheduleInvalidationForFocusEvents$ui_release() {
        ...
        int m4348constructorimpl = NodeKind.m4348constructorimpl(4096);
        MutableVector mutableVector = null;
        while (node != 0) {
        ...
        int m4348constructorimpl2 = NodeKind.m4348constructorimpl(4096) | NodeKind.m4348constructorimpl(1024);
        if (getNode().isAttached()) {
            Modifier.Node parent$ui_release = getNode().getParent$ui_release();
            LayoutNode requireLayoutNode = DelegatableNodeKt.requireLayoutNode(this);
            while (requireLayoutNode != null) {
                if ((requireLayoutNode.getNodes$ui_release().getHead$ui_release().getAggregateChildKindSet$ui_release() & m4348constructorimpl2) != 0) {
                    while (parent$ui_release != null) {
                        if ((parent$ui_release.getKindSet$ui_release() & m4348constructorimpl2) != 0 && (NodeKind.m4348constructorimpl(1024) & parent$ui_release.getKindSet$ui_release()) == 0 && parent$ui_release.isAttached()) {
                            int m4348constructorimpl3 = NodeKind.m4348constructorimpl(4096);
                            ...
                            while (delegatingNode != 0) {
                                ...
                                } else if ((delegatingNode.getKindSet$ui_release() & m4348constructorimpl3) != 0 && (delegatingNode instanceof DelegatingNode)) {
                                    Modifier.Node delegate$ui_release2 = delegatingNode.getDelegate$ui_release();
                                    int i9 = 0;
                                    delegatingNode = delegatingNode;
                                    while (delegate$ui_release2 != null) {
                                        if ((delegate$ui_release2.getKindSet$ui_release() & m4348constructorimpl3) != 0) {
                                            i9++;
                                            if (i9 == 1) {
