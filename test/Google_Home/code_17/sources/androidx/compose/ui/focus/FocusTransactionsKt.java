...
public final class FocusTransactionsKt {
    ...
    public static final CustomDestinationResult m2687performCustomClearFocusMxy_nc0(FocusTargetNode focusTargetNode, int i8) {
        ...
        if (i9 != 1) {
            if (i9 != 2) {
                if (i9 != 3) {
                    ...
                    CustomDestinationResult m2687performCustomClearFocusMxy_nc0 = m2687performCustomClearFocusMxy_nc0(requireActiveChild(focusTargetNode), i8);
                    if (m2687performCustomClearFocusMxy_nc0 == CustomDestinationResult.None) {
                        m2687performCustomClearFocusMxy_nc0 = null;
                    }
                    if (m2687performCustomClearFocusMxy_nc0 == null) {
                        return m2689performCustomExitMxy_nc0(focusTargetNode, i8);
                    }
                    return m2687performCustomClearFocusMxy_nc0;
                }
            } else {
    ...
    private static final CustomDestinationResult m2688performCustomEnterMxy_nc0(FocusTargetNode focusTargetNode, int i8) {
        CustomDestinationResult customDestinationResult;
        if (!focusTargetNode.isProcessingCustomEnter) {
            focusTargetNode.isProcessingCustomEnter = true;
            try {
                FocusRequester focusRequester = (FocusRequester) focusTargetNode.fetchFocusProperties$ui_release().getEnter().invoke(FocusDirection.m2654boximpl(i8));
    ...
    private static final CustomDestinationResult m2689performCustomExitMxy_nc0(FocusTargetNode focusTargetNode, int i8) {
        CustomDestinationResult customDestinationResult;
        if (!focusTargetNode.isProcessingCustomExit) {
            focusTargetNode.isProcessingCustomExit = true;
            try {
                FocusRequester focusRequester = (FocusRequester) focusTargetNode.fetchFocusProperties$ui_release().getExit().invoke(FocusDirection.m2654boximpl(i8));
                FocusRequester.Companion companion = FocusRequester.Companion;
                if (focusRequester != companion.getDefault()) {
                    if (focusRequester == companion.getCancel()) {
                        return CustomDestinationResult.Cancelled;
    ...
    public static final CustomDestinationResult m2690performCustomRequestFocusMxy_nc0(FocusTargetNode focusTargetNode, int i8) {
        CustomDestinationResult customDestinationResult;
        Modifier.Node node;
        ...
        if (i9 != 1 && i9 != 2) {
                    ...
                    if (focusTargetNode.getNode().isAttached()) {
                        ...
                        if (i11 != 1) {
                            if (i11 != 2) {
                                if (i11 != 3) {
                                    if (i11 == 4) {
                                        CustomDestinationResult m2690performCustomRequestFocusMxy_nc0 = m2690performCustomRequestFocusMxy_nc0(focusTargetNode2, i8);
                                        if (m2690performCustomRequestFocusMxy_nc0 != CustomDestinationResult.None) {
                                            customDestinationResult = m2690performCustomRequestFocusMxy_nc0;
                                        }
                                        if (customDestinationResult == null) {
                                            return m2688performCustomEnterMxy_nc0(focusTargetNode2, i8);
                                        }
                                        return customDestinationResult;
                                    }
                                    throw new p();
                                }
                                return m2690performCustomRequestFocusMxy_nc0(focusTargetNode2, i8);
                            }
                            return CustomDestinationResult.Cancelled;
                        }
                        return m2688performCustomEnterMxy_nc0(focusTargetNode2, i8);
            ...
            return m2687performCustomClearFocusMxy_nc0(requireActiveChild(focusTargetNode), i8);
        }
        return CustomDestinationResult.None;
    }
    ...
    */
    ...
    public static final boolean requestFocus(FocusTargetNode focusTargetNode) {
        ...
        try {
            ...
            requireTransactionManager.beginTransaction();
            int i8 = WhenMappings.$EnumSwitchMapping$0[m2690performCustomRequestFocusMxy_nc0(focusTargetNode, FocusDirection.Companion.m2664getEnterdhqQ8s()).ordinal()];
            boolean z8 = true;
            if (i8 != 1) {
                if (i8 != 2) {
                    if (i8 != 3 && i8 != 4) {
    ...
    private static final boolean requestFocusForChild(FocusTargetNode focusTargetNode, FocusTargetNode focusTargetNode2) {
        ...
        if (focusTargetNode2.getNode().isAttached()) {
                        ...
                        while (parent$ui_release != null) {
                            if ((parent$ui_release.getKindSet$ui_release() & m4348constructorimpl) != 0) {
                                ...
                                while (node2 != null) {
                                    ...
                                    if ((node2.getKindSet$ui_release() & m4348constructorimpl) != 0 && (node2 instanceof DelegatingNode)) {
                                        int i8 = 0;
            ...
            if (AbstractC3255y.d(node2, focusTargetNode)) {
                int i9 = WhenMappings.$EnumSwitchMapping$1[focusTargetNode.getFocusState().ordinal()];
                if (i9 != 1) {
                    if (i9 != 2) {
                        if (i9 != 3) {
                                            ...
                                            while (parent$ui_release2 != null) {
                                                if ((parent$ui_release2.getKindSet$ui_release() & m4348constructorimpl2) != 0) {
                                                    ...
                                                    while (node3 != null) {
                                                        ...
                                                        if ((node3.getKindSet$ui_release() & m4348constructorimpl2) != 0 && (node3 instanceof DelegatingNode)) {
                                                            int i10 = 0;
