...
public final class FocusOwnerImpl$moveFocus$foundNextItem$1 extends AbstractC3256z implements Function1 {
    ...
    public final Boolean invoke(FocusTargetNode focusTargetNode) {
        ...
        if (AbstractC3255y.d(focusTargetNode, this.$source)) {
        ...
        if (focusTargetNode.getNode().isAttached()) {
            ...
            if (node != null) {
                ...
                try {
                    ...
                    int i10 = WhenMappings.$EnumSwitchMapping$0[FocusTransactionsKt.m2690performCustomRequestFocusMxy_nc0(focusTargetNode, i9).ordinal()];
                    if (i10 != 1) {
                        if (i10 != 2 && i10 != 3) {
                            if (i10 != 4) {
                                throw new p();
