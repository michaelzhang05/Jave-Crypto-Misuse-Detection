    ...
    public int compare(FocusTargetNode focusTargetNode, FocusTargetNode focusTargetNode2) {
        ...
        if (focusTargetNode2 != null) {
            ...
            if (FocusTraversalKt.isEligibleForFocusSearch(focusTargetNode) && FocusTraversalKt.isEligibleForFocusSearch(focusTargetNode2)) {
                ...
                if (AbstractC3255y.d(requireLayoutNode, requireLayoutNode2)) {
                    return 0;
                }
                ...
                if (min >= 0) {
                    while (AbstractC3255y.d(pathFromRoot.getContent()[i8], pathFromRoot2.getContent()[i8])) {
                        if (i8 != min) {
                            i8++;
                        }
                    }
                    return AbstractC3255y.k(pathFromRoot.getContent()[i8].getPlaceOrder$ui_release(), pathFromRoot2.getContent()[i8].getPlaceOrder$ui_release());
                }
