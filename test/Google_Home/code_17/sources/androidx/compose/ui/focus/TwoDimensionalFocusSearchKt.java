...
public final class TwoDimensionalFocusSearchKt {
    ...
    private static final boolean m2699beamBeatsI7lrPNg(Rect rect, Rect rect2, Rect rect3, int i8) {
        ...
        if (beamBeats_I7lrPNg$isInDirectionOfSearch(rect3, i8, rect)) {
            ...
            if (!FocusDirection.m2657equalsimpl0(i8, companion.m2666getLeftdhqQ8s()) && !FocusDirection.m2657equalsimpl0(i8, companion.m2669getRightdhqQ8s()) && beamBeats_I7lrPNg$majorAxisDistance$6(rect2, i8, rect) >= beamBeats_I7lrPNg$majorAxisDistanceToFarEdge(rect3, i8, rect)) {
                return false;
            }
        }
        return true;
    ...
    private static final boolean beamBeats_I7lrPNg$inSourceBeam(Rect rect, int i8, Rect rect2) {
        boolean m2657equalsimpl0;
        boolean m2657equalsimpl02;
        FocusDirection.Companion companion = FocusDirection.Companion;
        if (FocusDirection.m2657equalsimpl0(i8, companion.m2666getLeftdhqQ8s())) {
            m2657equalsimpl0 = true;
        } else {
            m2657equalsimpl0 = FocusDirection.m2657equalsimpl0(i8, companion.m2669getRightdhqQ8s());
        }
        if (m2657equalsimpl0) {
            ...
            if (FocusDirection.m2657equalsimpl0(i8, companion.m2670getUpdhqQ8s())) {
                m2657equalsimpl02 = true;
            } else {
                m2657equalsimpl02 = FocusDirection.m2657equalsimpl0(i8, companion.m2663getDowndhqQ8s());
            }
            if (m2657equalsimpl02) {
    ...
    private static final boolean beamBeats_I7lrPNg$isInDirectionOfSearch(Rect rect, int i8, Rect rect2) {
        ...
        } else if (FocusDirection.m2657equalsimpl0(i8, companion.m2670getUpdhqQ8s())) {
    ...
    private static final float beamBeats_I7lrPNg$majorAxisDistance$6(Rect rect, int i8, Rect rect2) {
        ...
        if (FocusDirection.m2657equalsimpl0(i8, companion.m2666getLeftdhqQ8s())) {
            ...
            if (FocusDirection.m2657equalsimpl0(i8, companion.m2669getRightdhqQ8s())) {
                top = rect.getLeft();
    ...
    private static final FocusTargetNode m2700findBestCandidate4WY_MpI(MutableVector<FocusTargetNode> mutableVector, Rect rect, int i8) {
        Rect translate;
        FocusDirection.Companion companion = FocusDirection.Companion;
        if (FocusDirection.m2657equalsimpl0(i8, companion.m2666getLeftdhqQ8s())) {
        ...
        if (size > 0) {
            ...
            do {
                ...
                if (FocusTraversalKt.isEligibleForFocusSearch(focusTargetNode2)) {
                    ...
                    if (m2703isBetterCandidateI7lrPNg(focusRect, translate, rect, i8)) {
    ...
    public static final boolean m2701findChildCorrespondingToFocusEnterOMvw8(FocusTargetNode focusTargetNode, int i8, Function1 function1) {
        boolean m2657equalsimpl0;
        Rect bottomRight;
        Object obj;
        ...
        FocusDirection.Companion companion = FocusDirection.Companion;
        if (FocusDirection.m2657equalsimpl0(i8, companion.m2664getEnterdhqQ8s())) {
            i8 = companion.m2669getRightdhqQ8s();
        }
        if (FocusDirection.m2657equalsimpl0(i8, companion.m2669getRightdhqQ8s())) {
            m2657equalsimpl0 = true;
        } else {
            m2657equalsimpl0 = FocusDirection.m2657equalsimpl0(i8, companion.m2663getDowndhqQ8s());
        }
        if (m2657equalsimpl0) {
            bottomRight = topLeft(FocusTraversalKt.focusRect(focusTargetNode));
        } else {
            if (!FocusDirection.m2657equalsimpl0(i8, companion.m2666getLeftdhqQ8s())) {
                z8 = FocusDirection.m2657equalsimpl0(i8, companion.m2670getUpdhqQ8s());
            }
            if (z8) {
        ...
        FocusTargetNode m2700findBestCandidate4WY_MpI = m2700findBestCandidate4WY_MpI(mutableVector, bottomRight, i8);
        if (m2700findBestCandidate4WY_MpI == null) {
            return false;
        }
        return ((Boolean) function1.invoke(m2700findBestCandidate4WY_MpI)).booleanValue();
    }

    /* renamed from: generateAndSearchChildren-4C6V_qg, reason: not valid java name */
    private static final boolean m2702generateAndSearchChildren4C6V_qg(FocusTargetNode focusTargetNode, FocusTargetNode focusTargetNode2, int i8, Function1 function1) {
        if (m2704searchChildren4C6V_qg(focusTargetNode, focusTargetNode2, i8, function1)) {
            return true;
        }
        Boolean bool = (Boolean) BeyondBoundsLayoutKt.m2653searchBeyondBoundsOMvw8(focusTargetNode, i8, new TwoDimensionalFocusSearchKt$generateAndSearchChildren$1(focusTargetNode, focusTargetNode2, i8, function1));
        if (bool != null) {
    ...
    private static final boolean m2703isBetterCandidateI7lrPNg(Rect rect, Rect rect2, Rect rect3, int i8) {
        if (!isBetterCandidate_I7lrPNg$isCandidate(rect, i8, rect3)) {
            return false;
        }
        if (isBetterCandidate_I7lrPNg$isCandidate(rect2, i8, rect3) && !m2699beamBeatsI7lrPNg(rect3, rect, rect2, i8) && (m2699beamBeatsI7lrPNg(rect3, rect2, rect, i8) || isBetterCandidate_I7lrPNg$weightedDistance(i8, rect3, rect) >= isBetterCandidate_I7lrPNg$weightedDistance(i8, rect3, rect2))) {
            return false;
        }
        return true;
    }
    ...
    private static final float isBetterCandidate_I7lrPNg$minorAxisDistance(Rect rect, int i8, Rect rect2) {
        ...
        if (m2657equalsimpl0) {
            ...
            if (!FocusDirection.m2657equalsimpl0(i8, companion.m2670getUpdhqQ8s())) {
                z8 = FocusDirection.m2657equalsimpl0(i8, companion.m2663getDowndhqQ8s());
            }
            if (z8) {
                f8 = 2;
    ...
    public static final boolean m2704searchChildren4C6V_qg(FocusTargetNode focusTargetNode, FocusTargetNode focusTargetNode2, int i8, Function1 function1) {
        FocusTargetNode m2700findBestCandidate4WY_MpI;
        MutableVector mutableVector = new MutableVector(new FocusTargetNode[16], 0);
        int m4348constructorimpl = NodeKind.m4348constructorimpl(1024);
        if (focusTargetNode.getNode().isAttached()) {
            ...
            while (mutableVector.isNotEmpty() && (m2700findBestCandidate4WY_MpI = m2700findBestCandidate4WY_MpI(mutableVector, FocusTraversalKt.focusRect(focusTargetNode2), i8)) != null) {
                if (m2700findBestCandidate4WY_MpI.fetchFocusProperties$ui_release().getCanFocus()) {
                    return ((Boolean) function1.invoke(m2700findBestCandidate4WY_MpI)).booleanValue();
                }
                if (m2702generateAndSearchChildren4C6V_qg(m2700findBestCandidate4WY_MpI, focusTargetNode2, i8, function1)) {
                    return true;
                }
                mutableVector.remove(m2700findBestCandidate4WY_MpI);
            }
            return false;
        }
        throw new IllegalStateException("visitChildren called on an unattached node".toString());
    ...
    public static final Boolean m2705twoDimensionalFocusSearchOMvw8(FocusTargetNode focusTargetNode, int i8, Function1 function1) {
        ...
        if (i9 != 1) {
            ...
            return Boolean.valueOf(m2701findChildCorrespondingToFocusEnterOMvw8(focusTargetNode, i8, function1));
        }
        ...
        if (activeChild != null) {
            ...
            if (i10 != 1) {
                ...
                return Boolean.valueOf(m2702generateAndSearchChildren4C6V_qg(focusTargetNode, activeChild, i8, function1));
            }
            Boolean m2705twoDimensionalFocusSearchOMvw8 = m2705twoDimensionalFocusSearchOMvw8(activeChild, i8, function1);
            if (!AbstractC3255y.d(m2705twoDimensionalFocusSearchOMvw8, Boolean.FALSE)) {
                return m2705twoDimensionalFocusSearchOMvw8;
            }
            return Boolean.valueOf(m2702generateAndSearchChildren4C6V_qg(focusTargetNode, activeNode(activeChild), i8, function1));
        }
        throw new IllegalStateException(NoActiveChild.toString());
    }
}
