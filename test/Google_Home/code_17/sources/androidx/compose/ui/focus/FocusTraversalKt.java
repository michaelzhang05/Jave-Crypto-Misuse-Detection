...
public final class FocusTraversalKt {
    ...
    public static final FocusRequester m2692customFocusSearchOMvw8(FocusTargetNode focusTargetNode, int i8, LayoutDirection layoutDirection) {
        FocusRequester end;
        ...
        if (FocusDirection.m2657equalsimpl0(i8, companion.m2668getPreviousdhqQ8s())) {
        ...
        if (FocusDirection.m2657equalsimpl0(i8, companion.m2663getDowndhqQ8s())) {
        ...
        if (FocusDirection.m2657equalsimpl0(i8, companion.m2666getLeftdhqQ8s())) {
            ...
            if (FocusDirection.m2657equalsimpl0(i8, companion.m2664getEnterdhqQ8s())) {
                return (FocusRequester) fetchFocusProperties$ui_release.getEnter().invoke(FocusDirection.m2654boximpl(i8));
            }
            if (FocusDirection.m2657equalsimpl0(i8, companion.m2665getExitdhqQ8s())) {
                return (FocusRequester) fetchFocusProperties$ui_release.getExit().invoke(FocusDirection.m2654boximpl(i8));
            }
    ...
    */
    public static final androidx.compose.ui.focus.FocusTargetNode findActiveFocusNode(androidx.compose.ui.focus.FocusTargetNode r10) {
        ...
        L20:
            ...
            int r0 = androidx.compose.ui.node.NodeKind.m4348constructorimpl(r0)
    ...
    public static final boolean m2693focusSearchsMXa3k8(FocusTargetNode focusTargetNode, int i8, LayoutDirection layoutDirection, Function1 function1) {
        boolean m2657equalsimpl0;
        boolean m2657equalsimpl02;
        boolean m2657equalsimpl03;
        boolean m2657equalsimpl04;
        FocusTargetNode focusTargetNode2;
        int m2669getRightdhqQ8s;
        Boolean m2705twoDimensionalFocusSearchOMvw8;
        FocusDirection.Companion companion = FocusDirection.Companion;
        if (FocusDirection.m2657equalsimpl0(i8, companion.m2667getNextdhqQ8s())) {
        ...
        if (m2657equalsimpl0) {
            return OneDimensionalFocusSearchKt.m2696oneDimensionalFocusSearchOMvw8(focusTargetNode, i8, function1);
        }
        if (FocusDirection.m2657equalsimpl0(i8, companion.m2666getLeftdhqQ8s())) {
            m2657equalsimpl02 = true;
        } else {
            m2657equalsimpl02 = FocusDirection.m2657equalsimpl0(i8, companion.m2669getRightdhqQ8s());
        }
        if (m2657equalsimpl02) {
            m2657equalsimpl03 = true;
        } else {
            m2657equalsimpl03 = FocusDirection.m2657equalsimpl0(i8, companion.m2670getUpdhqQ8s());
        }
        if (m2657equalsimpl03) {
            m2657equalsimpl04 = true;
        } else {
            m2657equalsimpl04 = FocusDirection.m2657equalsimpl0(i8, companion.m2663getDowndhqQ8s());
        }
        if (m2657equalsimpl04) {
            Boolean m2705twoDimensionalFocusSearchOMvw82 = TwoDimensionalFocusSearchKt.m2705twoDimensionalFocusSearchOMvw8(focusTargetNode, i8, function1);
            if (m2705twoDimensionalFocusSearchOMvw82 != null) {
                return m2705twoDimensionalFocusSearchOMvw82.booleanValue();
            }
        } else if (FocusDirection.m2657equalsimpl0(i8, companion.m2664getEnterdhqQ8s())) {
            int i9 = WhenMappings.$EnumSwitchMapping$0[layoutDirection.ordinal()];
            if (i9 != 1) {
                if (i9 == 2) {
                    m2669getRightdhqQ8s = companion.m2666getLeftdhqQ8s();
                } else {
                    throw new p();
                }
            } else {
                m2669getRightdhqQ8s = companion.m2669getRightdhqQ8s();
            }
            FocusTargetNode findActiveFocusNode = findActiveFocusNode(focusTargetNode);
            if (findActiveFocusNode != null && (m2705twoDimensionalFocusSearchOMvw8 = TwoDimensionalFocusSearchKt.m2705twoDimensionalFocusSearchOMvw8(findActiveFocusNode, m2669getRightdhqQ8s, function1)) != null) {
                return m2705twoDimensionalFocusSearchOMvw8.booleanValue();
            }
        } else if (FocusDirection.m2657equalsimpl0(i8, companion.m2665getExitdhqQ8s())) {
            ...
            if (focusTargetNode2 != null && !AbstractC3255y.d(focusTargetNode2, focusTargetNode)) {
                return ((Boolean) function1.invoke(focusTargetNode2)).booleanValue();
            }
        } else {
            throw new IllegalStateException(("Focus search invoked with invalid FocusDirection " + ((Object) FocusDirection.m2659toStringimpl(i8))).toString());
        }
        return false;
    }
