...
public final class FocusOwnerImpl implements FocusOwner {
    ...
    private final Modifier.Node lastLocalKeyInputNode(DelegatableNode delegatableNode) {
        int m4348constructorimpl = NodeKind.m4348constructorimpl(1024) | NodeKind.m4348constructorimpl(8192);
            ...
            if ((node.getAggregateChildKindSet$ui_release() & m4348constructorimpl) != 0) {
                for (Modifier.Node child$ui_release = node.getChild$ui_release(); child$ui_release != null; child$ui_release = child$ui_release.getChild$ui_release()) {
                    if ((child$ui_release.getKindSet$ui_release() & m4348constructorimpl) != 0) {
                        if ((NodeKind.m4348constructorimpl(1024) & child$ui_release.getKindSet$ui_release()) != 0) {
                            return node2;
                        }
    ...
    private final /* synthetic */ <T extends DelegatableNode> void m2675traverseAncestorsYYKmho(DelegatableNode delegatableNode, int i8, Function1 function1, Function1 function12) {
        int size;
    ...
    private final boolean m2676validateKeyEventZmokQxo(KeyEvent keyEvent) {
        long m3904getKeyZmokQxo = KeyEvent_androidKt.m3904getKeyZmokQxo(keyEvent);
        int m3905getTypeZmokQxo = KeyEvent_androidKt.m3905getTypeZmokQxo(keyEvent);
        KeyEventType.Companion companion = KeyEventType.Companion;
        if (KeyEventType.m3897equalsimpl0(m3905getTypeZmokQxo, companion.m3901getKeyDownCS__XNY())) {
            MutableLongSet mutableLongSet = this.keysCurrentlyDown;
            if (mutableLongSet == null) {
                mutableLongSet = new MutableLongSet(3);
                this.keysCurrentlyDown = mutableLongSet;
            }
            mutableLongSet.plusAssign(m3904getKeyZmokQxo);
        } else if (KeyEventType.m3897equalsimpl0(m3905getTypeZmokQxo, companion.m3902getKeyUpCS__XNY())) {
            MutableLongSet mutableLongSet2 = this.keysCurrentlyDown;
            if (mutableLongSet2 != null && mutableLongSet2.contains(m3904getKeyZmokQxo)) {
                MutableLongSet mutableLongSet3 = this.keysCurrentlyDown;
                if (mutableLongSet3 != null) {
                    mutableLongSet3.remove(m3904getKeyZmokQxo);
                }
            } else {
                return false;
            }
    ...
    private final boolean m2677wrapAroundFocus3ESFkO8(int i8) {
        ...
        if (this.rootFocusNode.getFocusState().getHasFocus() && !this.rootFocusNode.getFocusState().isFocused()) {
            ...
            if (FocusDirection.m2657equalsimpl0(i8, companion.m2667getNextdhqQ8s())) {
                m2657equalsimpl0 = true;
            } else {
                m2657equalsimpl0 = FocusDirection.m2657equalsimpl0(i8, companion.m2668getPreviousdhqQ8s());
            }
            if (m2657equalsimpl0) {
                clearFocus(false);
                ...
                return mo2672moveFocus3ESFkO8(i8);
            }
        }
        return false;
    }
    ...
    public boolean mo2673dispatchInterceptedSoftKeyboardEventZmokQxo(KeyEvent keyEvent) {
        ...
        if (findActiveFocusNode != null) {
            int m4348constructorimpl = NodeKind.m4348constructorimpl(131072);
                            ...
                            while (parent$ui_release != null) {
                                if ((parent$ui_release.getKindSet$ui_release() & m4348constructorimpl) != 0) {
                                    ...
                                    while (delegatingNode != 0) {
                                        ...
                                        if ((delegatingNode.getKindSet$ui_release() & m4348constructorimpl) != 0 && (delegatingNode instanceof DelegatingNode)) {
        ...
        if (softKeyboardInterceptionModifierNode != null) {
            int m4348constructorimpl2 = NodeKind.m4348constructorimpl(131072);
            if (softKeyboardInterceptionModifierNode.getNode().isAttached()) {
                ...
                while (requireLayoutNode2 != null) {
                    if ((requireLayoutNode2.getNodes$ui_release().getHead$ui_release().getAggregateChildKindSet$ui_release() & m4348constructorimpl2) != 0) {
                        while (parent$ui_release2 != null) {
                            if ((parent$ui_release2.getKindSet$ui_release() & m4348constructorimpl2) != 0) {
                                ...
                                while (node != null) {
                                    if (node instanceof SoftKeyboardInterceptionModifierNode) {
                                        ...
                                        arrayList.add(node);
                                    } else if ((node.getKindSet$ui_release() & m4348constructorimpl2) != 0 && (node instanceof DelegatingNode)) {
                                        int i9 = 0;
                ...
                if (arrayList != null && arrayList.size() - 1 >= 0) {
                    while (true) {
                        int i10 = size - 1;
                        if (((SoftKeyboardInterceptionModifierNode) arrayList.get(size)).mo3592onPreInterceptKeyBeforeSoftKeyboardZmokQxo(keyEvent)) {
                            return true;
                        }
                        if (i10 < 0) {
                            break;
                ...
                while (node2 != 0) {
                    if (node2 instanceof SoftKeyboardInterceptionModifierNode) {
                        if (((SoftKeyboardInterceptionModifierNode) node2).mo3592onPreInterceptKeyBeforeSoftKeyboardZmokQxo(keyEvent)) {
                            return true;
                        }
                    } else if ((node2.getKindSet$ui_release() & m4348constructorimpl2) != 0 && (node2 instanceof DelegatingNode)) {
                ...
                while (node3 != 0) {
                    if (node3 instanceof SoftKeyboardInterceptionModifierNode) {
                        if (((SoftKeyboardInterceptionModifierNode) node3).mo3591onInterceptKeyBeforeSoftKeyboardZmokQxo(keyEvent)) {
                            return true;
                        }
                ...
                if (arrayList != null) {
                    ...
                    for (int i13 = 0; i13 < size2; i13++) {
                        if (((SoftKeyboardInterceptionModifierNode) arrayList.get(i13)).mo3591onInterceptKeyBeforeSoftKeyboardZmokQxo(keyEvent)) {
                            return true;
                        }
                    }
                }
    ...
    public boolean mo2674dispatchKeyEventZmokQxo(KeyEvent keyEvent) {
        int size;
        NodeChain nodes$ui_release;
        DelegatingNode delegatingNode;
        NodeChain nodes$ui_release2;
        if (!m2676validateKeyEventZmokQxo(keyEvent)) {
            return false;
        }
        FocusTargetNode findActiveFocusNode = FocusTraversalKt.findActiveFocusNode(this.rootFocusNode);
        if (findActiveFocusNode != null) {
            ...
            if (lastLocalKeyInputNode == null) {
                int m4348constructorimpl = NodeKind.m4348constructorimpl(8192);
                if (findActiveFocusNode.getNode().isAttached()) {
                    Modifier.Node parent$ui_release = findActiveFocusNode.getNode().getParent$ui_release();
                    LayoutNode requireLayoutNode = DelegatableNodeKt.requireLayoutNode(findActiveFocusNode);
                    loop0: while (true) {
            ...
            if (lastLocalKeyInputNode != null) {
                int m4348constructorimpl2 = NodeKind.m4348constructorimpl(8192);
                if (lastLocalKeyInputNode.getNode().isAttached()) {
                    ...
                    if (arrayList != null && arrayList.size() - 1 >= 0) {
                        while (true) {
                            int i10 = size - 1;
                            if (((KeyInputModifierNode) arrayList.get(size)).mo271onPreKeyEventZmokQxo(keyEvent)) {
                                return true;
                            }
                            if (i10 < 0) {
                                break;
                    ...
                    while (node2 != 0) {
                        if (node2 instanceof KeyInputModifierNode) {
                            if (((KeyInputModifierNode) node2).mo271onPreKeyEventZmokQxo(keyEvent)) {
                                return true;
                            }
                        } else if ((node2.getKindSet$ui_release() & m4348constructorimpl2) != 0 && (node2 instanceof DelegatingNode)) {
                            Modifier.Node delegate$ui_release3 = node2.getDelegate$ui_release();
                    ...
                    while (node3 != 0) {
                        if (node3 instanceof KeyInputModifierNode) {
                            if (((KeyInputModifierNode) node3).mo269onKeyEventZmokQxo(keyEvent)) {
                                return true;
                            }
                        } else if ((node3.getKindSet$ui_release() & m4348constructorimpl2) != 0 && (node3 instanceof DelegatingNode)) {
                            Modifier.Node delegate$ui_release4 = node3.getDelegate$ui_release();
                    ...
                    if (arrayList != null) {
                        int size2 = arrayList.size();
                        for (int i13 = 0; i13 < size2; i13++) {
                            if (((KeyInputModifierNode) arrayList.get(i13)).mo269onKeyEventZmokQxo(keyEvent)) {
                                return true;
                            }
                        }
                    }
    ...
    public boolean dispatchRotaryEvent(RotaryScrollEvent rotaryScrollEvent) {
        ...
        FocusTargetNode findActiveFocusNode = FocusTraversalKt.findActiveFocusNode(this.rootFocusNode);
        if (findActiveFocusNode != null) {
            int m4348constructorimpl = NodeKind.m4348constructorimpl(16384);
            if (findActiveFocusNode.getNode().isAttached()) {
                Modifier.Node parent$ui_release = findActiveFocusNode.getNode().getParent$ui_release();
                LayoutNode requireLayoutNode = DelegatableNodeKt.requireLayoutNode(findActiveFocusNode);
                loop0: while (true) {
        ...
        if (rotaryInputModifierNode != null) {
            int m4348constructorimpl2 = NodeKind.m4348constructorimpl(16384);
    ...
    public LayoutDirection getLayoutDirection() {
        ...
        AbstractC3255y.y("layoutDirection");
        return null;
    }
    ...
    public boolean mo2672moveFocus3ESFkO8(int i8) {
        FocusTargetNode findActiveFocusNode = FocusTraversalKt.findActiveFocusNode(this.rootFocusNode);
        if (findActiveFocusNode == null) {
            return false;
        }
        FocusRequester m2692customFocusSearchOMvw8 = FocusTraversalKt.m2692customFocusSearchOMvw8(findActiveFocusNode, i8, getLayoutDirection());
        FocusRequester.Companion companion = FocusRequester.Companion;
        if (m2692customFocusSearchOMvw8 != companion.getDefault()) {
            if (m2692customFocusSearchOMvw8 == companion.getCancel() || !m2692customFocusSearchOMvw8.focus$ui_release()) {
                return false;
            }
            return true;
        }
        O o8 = new O();
        boolean m2693focusSearchsMXa3k8 = FocusTraversalKt.m2693focusSearchsMXa3k8(this.rootFocusNode, i8, getLayoutDirection(), new FocusOwnerImpl$moveFocus$foundNextItem$1(findActiveFocusNode, this, i8, o8));
        if (o8.f34158a) {
            return false;
        }
        if (!m2693focusSearchsMXa3k8 && !m2677wrapAroundFocus3ESFkO8(i8)) {
            return false;
        }
        return true;
    }
    ...
    public void clearFocus(boolean z8, boolean z9) {
        ...
        try {
            ...
            if (!z8) {
                int i8 = WhenMappings.$EnumSwitchMapping$0[FocusTransactionsKt.m2687performCustomClearFocusMxy_nc0(this.rootFocusNode, FocusDirection.Companion.m2665getExitdhqQ8s()).ordinal()];
                if (i8 == 1 || i8 == 2 || i8 == 3) {
