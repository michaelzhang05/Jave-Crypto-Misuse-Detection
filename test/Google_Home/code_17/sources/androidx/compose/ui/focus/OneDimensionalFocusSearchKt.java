...
public final class OneDimensionalFocusSearchKt {
        ...
        if (i8 != 1) {
            ...
            if (activeChild != null) {
                ...
                if (i9 != 1) {
                    ...
                    return m2695generateAndSearchChildren4C6V_qg(focusTargetNode, activeChild, FocusDirection.Companion.m2668getPreviousdhqQ8s(), function1);
                }
                if (!backwardFocusSearch(activeChild, function1) && !m2695generateAndSearchChildren4C6V_qg(focusTargetNode, activeChild, FocusDirection.Companion.m2668getPreviousdhqQ8s(), function1) && (!activeChild.fetchFocusProperties$ui_release().getCanFocus() || !((Boolean) function1.invoke(activeChild)).booleanValue())) {
                    return false;
                }
            } else {
                throw new IllegalStateException(NoActiveChild.toString());
    ...
    private static final <T> void forEachItemAfter(MutableVector<T> mutableVector, T t8, Function1 function1) {
        ...
        while (true) {
            if (z8) {
                function1.invoke(mutableVector.getContent()[e8]);
            }
            if (AbstractC3255y.d(mutableVector.getContent()[e8], t8)) {
                z8 = true;
            }
            if (e8 != f8) {
                e8++;
    ...
    private static final <T> void forEachItemBefore(MutableVector<T> mutableVector, T t8, Function1 function1) {
        ...
        while (true) {
            if (z8) {
                function1.invoke(mutableVector.getContent()[f8]);
            }
            if (AbstractC3255y.d(mutableVector.getContent()[f8], t8)) {
                z8 = true;
            }
            if (f8 != e8) {
                f8--;
    ...
    private static final boolean forwardFocusSearch(FocusTargetNode focusTargetNode, Function1 function1) {
        ...
        FocusTargetNode activeChild = FocusTraversalKt.getActiveChild(focusTargetNode);
        if (activeChild != null) {
            if (forwardFocusSearch(activeChild, function1) || m2695generateAndSearchChildren4C6V_qg(focusTargetNode, activeChild, FocusDirection.Companion.m2667getNextdhqQ8s(), function1)) {
                return true;
            }
            return false;
        }
    ...
    private static final boolean m2695generateAndSearchChildren4C6V_qg(FocusTargetNode focusTargetNode, FocusTargetNode focusTargetNode2, int i8, Function1 function1) {
        if (m2697searchChildren4C6V_qg(focusTargetNode, focusTargetNode2, i8, function1)) {
            return true;
        }
        Boolean bool = (Boolean) BeyondBoundsLayoutKt.m2653searchBeyondBoundsOMvw8(focusTargetNode, i8, new OneDimensionalFocusSearchKt$generateAndSearchChildren$1(focusTargetNode, focusTargetNode2, i8, function1));
        if (bool != null) {
    ...
    public static final boolean m2696oneDimensionalFocusSearchOMvw8(FocusTargetNode focusTargetNode, int i8, Function1 function1) {
    ...
    public static final boolean m2697searchChildren4C6V_qg(FocusTargetNode focusTargetNode, FocusTargetNode focusTargetNode2, int i8, Function1 function1) {
            ...
            if (focusTargetNode.getNode().isAttached()) {
                ...
                if (FocusDirection.m2657equalsimpl0(i8, companion.m2667getNextdhqQ8s())) {
                    ...
                    if (e8 <= f8) {
                        ...
                        while (true) {
                            if (z8) {
                                FocusTargetNode focusTargetNode3 = (FocusTargetNode) mutableVector.getContent()[e8];
                                if (FocusTraversalKt.isEligibleForFocusSearch(focusTargetNode3) && forwardFocusSearch(focusTargetNode3, function1)) {
                                    return true;
                                }
                            }
                            if (AbstractC3255y.d(mutableVector.getContent()[e8], focusTargetNode2)) {
                                z8 = true;
                            }
                            if (e8 == f8) {
                                break;
                    ...
                    if (e9 <= f9) {
                        ...
                        while (true) {
                            if (z9) {
                                FocusTargetNode focusTargetNode4 = (FocusTargetNode) mutableVector.getContent()[f9];
                                if (FocusTraversalKt.isEligibleForFocusSearch(focusTargetNode4) && backwardFocusSearch(focusTargetNode4, function1)) {
                                    return true;
                                }
                            }
                            if (AbstractC3255y.d(mutableVector.getContent()[f9], focusTargetNode2)) {
                                z9 = true;
                            }
                            if (f9 == e9) {
                                break;
                ...
                if (FocusDirection.m2657equalsimpl0(i8, FocusDirection.Companion.m2667getNextdhqQ8s()) || !focusTargetNode.fetchFocusProperties$ui_release().getCanFocus() || isRoot(focusTargetNode)) {
                    return false;
                }
                return ((Boolean) function1.invoke(focusTargetNode)).booleanValue();
            }
