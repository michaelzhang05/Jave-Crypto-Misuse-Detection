...
public final class CombinedModifier implements Modifier {
    ...
    public boolean equals(Object obj) {
        if (obj instanceof CombinedModifier) {
            ...
            if (AbstractC3255y.d(this.outer, combinedModifier.outer) && AbstractC3255y.d(this.inner, combinedModifier.inner)) {
                return true;
            }
        }
        return false;
    ...
    public <R> R foldIn(R r8, InterfaceC1668n interfaceC1668n) {
        return (R) this.inner.foldIn(this.outer.foldIn(r8, interfaceC1668n), interfaceC1668n);
    }

    /* JADX WARN: Multi-variable type inference failed */
    @Override // androidx.compose.ui.Modifier
    public <R> R foldOut(R r8, InterfaceC1668n interfaceC1668n) {
        return (R) this.outer.foldOut(this.inner.foldOut(r8, interfaceC1668n), interfaceC1668n);
    }
