...
final class PainterElement extends ModifierNodeElement<PainterNode> {
    ...
    public boolean equals(Object obj) {
        ...
        return AbstractC3255y.d(this.painter, painterElement.painter) && this.sizeToIntrinsics == painterElement.sizeToIntrinsics && AbstractC3255y.d(this.alignment, painterElement.alignment) && AbstractC3255y.d(this.contentScale, painterElement.contentScale) && Float.compare(this.alpha, painterElement.alpha) == 0 && AbstractC3255y.d(this.colorFilter, painterElement.colorFilter);
    }
    ...
    public void update(PainterNode painterNode) {
        ...
        boolean z9 = sizeToIntrinsics != z8 || (z8 && !Size.m2805equalsimpl0(painterNode.getPainter().mo3513getIntrinsicSizeNHjbRc(), this.painter.mo3513getIntrinsicSizeNHjbRc()));
