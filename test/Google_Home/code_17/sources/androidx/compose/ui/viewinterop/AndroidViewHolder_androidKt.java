...
public final class AndroidViewHolder_androidKt {
    ...
    public static final void layoutAccordingTo(View view, LayoutNode layoutNode) {
        ...
        int d8 = AbstractC2055a.d(Offset.m2740getXimpl(positionInRoot));
        int d9 = AbstractC2055a.d(Offset.m2741getYimpl(positionInRoot));
    ...
    public static final int toNestedScrollSource(int i8) {
        if (i8 == 0) {
            return NestedScrollSource.Companion.m3928getDragWNlRxjI();
        }
        return NestedScrollSource.Companion.m3929getFlingWNlRxjI();
    }
}
