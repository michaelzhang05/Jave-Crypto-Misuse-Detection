...
public final class SemanticsNode {
    ...
    private final void emitFakeNodes(List<SemanticsNode> list) {
        ...
        if (role != null && this.unmergedConfig.isMergingSemanticsOfDescendants() && (!list.isEmpty())) {
            list.add(m4535fakeSemanticsNodeypyhhiA(role, new SemanticsNode$emitFakeNodes$fakeNode$1(role)));
        }
        ...
        if (semanticsConfiguration.contains(semanticsProperties.getContentDescription()) && (!list.isEmpty()) && this.unmergedConfig.isMergingSemanticsOfDescendants()) {
            ...
            if (list2 != null) {
                str = (String) AbstractC1378t.o0(list2);
            } else {
                str = null;
            }
            if (str != null) {
                list.add(0, m4535fakeSemanticsNodeypyhhiA(null, new SemanticsNode$emitFakeNodes$fakeNode$2(str)));
            }
        }
    }

    /* renamed from: fakeSemanticsNode-ypyhhiA, reason: not valid java name */
    private final SemanticsNode m4535fakeSemanticsNodeypyhhiA(Role role, Function1 function1) {
        ...
        if (size > 0) {
            ...
            do {
                ...
                if (layoutNode2.isAttached()) {
                    if (layoutNode2.getNodes$ui_release().m4305hasH91voCI$ui_release(NodeKind.m4348constructorimpl(8))) {
    ...
    public final NodeCoordinator findCoordinatorToGetBounds$ui_release() {
        ...
        return DelegatableNodeKt.m4231requireCoordinator64DMado(outerMergingSemantics, NodeKind.m4348constructorimpl(8));
    }
    ...
    public final Rect getBoundsInParent$ui_release() {
        ...
        if (findCoordinatorToGetBounds$ui_release != null) {
            ...
            if (findCoordinatorToGetBounds$ui_release != null && (coordinates = findCoordinatorToGetBounds$ui_release.getCoordinates()) != null) {
                return c.c(DelegatableNodeKt.m4231requireCoordinator64DMado(parent.outerSemanticsNode, NodeKind.m4348constructorimpl(8)), coordinates, false, 2, null);
            }
        }
        return Rect.Companion.getZero();
    }
    ...
    public final long m4536getPositionInRootF1C5BW0() {
        NodeCoordinator findCoordinatorToGetBounds$ui_release = findCoordinatorToGetBounds$ui_release();
        if (findCoordinatorToGetBounds$ui_release != null) {
            if (!findCoordinatorToGetBounds$ui_release.isAttached()) {
                findCoordinatorToGetBounds$ui_release = null;
    ...
    public final long m4537getPositionInWindowF1C5BW0() {
        NodeCoordinator findCoordinatorToGetBounds$ui_release = findCoordinatorToGetBounds$ui_release();
        if (findCoordinatorToGetBounds$ui_release != null) {
            if (!findCoordinatorToGetBounds$ui_release.isAttached()) {
                findCoordinatorToGetBounds$ui_release = null;
    ...
    public final long m4538getSizeYbymL2g() {
        NodeCoordinator findCoordinatorToGetBounds$ui_release = findCoordinatorToGetBounds$ui_release();
        if (findCoordinatorToGetBounds$ui_release != null) {
            return findCoordinatorToGetBounds$ui_release.mo4143getSizeYbymL2g();
        }
