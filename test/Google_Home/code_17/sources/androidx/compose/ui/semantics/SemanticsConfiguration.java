...
public final class SemanticsConfiguration implements SemanticsPropertyReceiver, Iterable<Map.Entry<? extends SemanticsPropertyKey<?>, ? extends Object>>, InterfaceC1985a {
    ...
    public final void collapsePeer$ui_release(SemanticsConfiguration semanticsConfiguration) {
        ...
        for (Map.Entry<SemanticsPropertyKey<?>, Object> entry : semanticsConfiguration.props.entrySet()) {
            ...
            if (!this.props.containsKey(key)) {
                ...
                AbstractC3255y.g(obj, "null cannot be cast to non-null type androidx.compose.ui.semantics.AccessibilityAction<*>");
                ...
                InterfaceC1351g action = accessibilityAction.getAction();
                if (action == null) {
    ...
    public boolean equals(Object obj) {
        ...
        if (AbstractC3255y.d(this.props, semanticsConfiguration.props) && this.isMergingSemanticsOfDescendants == semanticsConfiguration.isMergingSemanticsOfDescendants && this.isClearingSemantics == semanticsConfiguration.isClearingSemantics) {
            return true;
        }
        return false;
    }
    ...
    public final void mergeChild$ui_release(SemanticsConfiguration semanticsConfiguration) {
        for (Map.Entry<SemanticsPropertyKey<?>, Object> entry : semanticsConfiguration.props.entrySet()) {
            ...
            Object value = entry.getValue();
            Object obj = this.props.get(key);
            AbstractC3255y.g(key, "null cannot be cast to non-null type androidx.compose.ui.semantics.SemanticsPropertyKey<kotlin.Any?>");
    ...
    public <T> void set(SemanticsPropertyKey<T> semanticsPropertyKey, T t8) {
        if ((t8 instanceof AccessibilityAction) && contains(semanticsPropertyKey)) {
            ...
            InterfaceC1351g action = accessibilityAction2.getAction();
            if (action == null) {
