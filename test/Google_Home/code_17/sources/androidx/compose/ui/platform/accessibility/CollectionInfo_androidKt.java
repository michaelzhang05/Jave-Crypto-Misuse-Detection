    ...
    private static final boolean calculateIfHorizontallyStacked(List<SemanticsNode> list) {
        ...
        if (list.size() != 0 && list.size() != 1) {
            ...
            while (i8 < o8) {
                ...
                m8.add(Offset.m2729boximpl(OffsetKt.Offset(Math.abs(Offset.m2740getXimpl(semanticsNode4.getBoundsInRoot().m2770getCenterF1C5BW0()) - Offset.m2740getXimpl(semanticsNode3.getBoundsInRoot().m2770getCenterF1C5BW0())), Math.abs(Offset.m2741getYimpl(semanticsNode4.getBoundsInRoot().m2770getCenterF1C5BW0()) - Offset.m2741getYimpl(semanticsNode3.getBoundsInRoot().m2770getCenterF1C5BW0())))));
        ...
        if (m8.size() == 1) {
            m2750unboximpl = ((Offset) AbstractC1378t.m0(m8)).m2750unboximpl();
        } else if (!m8.isEmpty()) {
            Object m02 = AbstractC1378t.m0(m8);
            int o9 = AbstractC1378t.o(m8);
            if (1 <= o9) {
                int i9 = 1;
                while (true) {
                    m02 = Offset.m2729boximpl(Offset.m2745plusMKHz9U(((Offset) m02).m2750unboximpl(), ((Offset) m8.get(i9)).m2750unboximpl()));
                    if (i9 == o9) {
                        break;
                    }
                    i9++;
            ...
            m2750unboximpl = ((Offset) m02).m2750unboximpl();
        } else {
            throw new UnsupportedOperationException("Empty collection can't be reduced.");
        }
        if (Offset.m2731component2impl(m2750unboximpl) < Offset.m2730component1impl(m2750unboximpl)) {
            return true;
        }
        return false;
    }
