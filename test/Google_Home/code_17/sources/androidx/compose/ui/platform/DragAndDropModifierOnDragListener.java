...
public final class DragAndDropModifierOnDragListener implements View.OnDragListener, DragAndDropManager {
    private final InterfaceC1669o startDrag;
    ...
    public DragAndDropModifierOnDragListener(InterfaceC1669o interfaceC1669o) {
        this.startDrag = interfaceC1669o;
    }

    @Override // androidx.compose.ui.draganddrop.DragAndDropManager
    /* renamed from: drag-12SF9DM */
    public boolean mo2625drag12SF9DM(DragAndDropTransferData dragAndDropTransferData, long j8, Function1 function1) {
        return ((Boolean) this.startDrag.invoke(dragAndDropTransferData, Size.m2797boximpl(j8), function1)).booleanValue();
    }
