...
public final class ComposeView extends AbstractComposeView {
    ...
    private final MutableState<InterfaceC1668n> content;
    ...
    public void Content(Composer composer, int i8) {
        ...
        InterfaceC1668n value = this.content.getValue();
        if (value != null) {
    ...
    public final void setContent(InterfaceC1668n interfaceC1668n) {
        ...
        this.content.setValue(interfaceC1668n);
    ...
    public /* synthetic */ ComposeView(Context context, AttributeSet attributeSet, int i8, int i9, AbstractC3247p abstractC3247p) {
        this(context, (i9 & 2) != 0 ? null : attributeSet, (i9 & 4) != 0 ? 0 : i8);
    }

    public ComposeView(Context context, AttributeSet attributeSet, int i8) {
        super(context, attributeSet, i8);
        MutableState<InterfaceC1668n> mutableStateOf$default;
