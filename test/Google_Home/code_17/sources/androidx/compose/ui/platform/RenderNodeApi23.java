...
public final class RenderNodeApi23 implements DeviceRenderNode {
    ...
    public RenderNodeApi23(AndroidComposeView androidComposeView) {
        ...
        this.internalCompositingStrategy = CompositingStrategy.Companion.m3064getAutoNrFUSI();
    ...
    public void drawInto(Canvas canvas) {
        AbstractC3255y.g(canvas, "null cannot be cast to non-null type android.view.DisplayListCanvas");
    ...
    public int mo4459getCompositingStrategyNrFUSI() {
    ...
    public final int getLayerType$ui_release() {
        if (CompositingStrategy.m3060equalsimpl0(this.internalCompositingStrategy, CompositingStrategy.Companion.m3066getOffscreenNrFUSI())) {
            return 2;
        }
        return 0;
    }
    ...
    public void mo4460setCompositingStrategyaDBOjCE(int i8) {
        CompositingStrategy.Companion companion = CompositingStrategy.Companion;
        if (CompositingStrategy.m3060equalsimpl0(i8, companion.m3066getOffscreenNrFUSI())) {
            this.renderNode.setLayerType(2);
            this.renderNode.setHasOverlappingRendering(true);
        } else if (CompositingStrategy.m3060equalsimpl0(i8, companion.m3065getModulateAlphaNrFUSI())) {
