...
public final class NestedScrollInteropConnectionKt {
    ...
    public static final int m4495getScrollAxesk4lQ0M(long j8) {
        int i8;
        if (Math.abs(Offset.m2740getXimpl(j8)) >= 0.5f) {
            i8 = 1;
        } else {
            i8 = 0;
        }
        if (Math.abs(Offset.m2741getYimpl(j8)) >= 0.5f) {
            return i8 | 2;
        }
        return i8;
    }
    ...
    public static final long m4496toOffsetUv8p0NA(int[] iArr, long j8) {
        float c8;
        float c9;
        if (Offset.m2740getXimpl(j8) >= 0.0f) {
            c8 = g6.m.f(reverseAxis(iArr[0]), Offset.m2740getXimpl(j8));
        } else {
            c8 = g6.m.c(reverseAxis(iArr[0]), Offset.m2740getXimpl(j8));
        }
        if (Offset.m2741getYimpl(j8) >= 0.0f) {
            c9 = g6.m.f(reverseAxis(iArr[1]), Offset.m2741getYimpl(j8));
        } else {
            c9 = g6.m.c(reverseAxis(iArr[1]), Offset.m2741getYimpl(j8));
        }
    ...
    public static final int m4497toViewTypeGyEprt8(int i8) {
        return !NestedScrollSource.m3923equalsimpl0(i8, NestedScrollSource.Companion.m3928getDragWNlRxjI()) ? 1 : 0;
    }
