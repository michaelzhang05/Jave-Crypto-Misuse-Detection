...
public final class MutableSpanStyle {
    ...
    public final long m4478getBackground0d7_KjU() {
        return this.background;
    }

    /* renamed from: getBaselineShift-5SSeXJ0, reason: not valid java name */
    public final BaselineShift m4479getBaselineShift5SSeXJ0() {
        return this.baselineShift;
    }

    /* renamed from: getColor-0d7_KjU, reason: not valid java name */
    public final long m4480getColor0d7_KjU() {
        return this.color;
    }
    ...
    public final long m4481getFontSizeXSAIIZE() {
        return this.fontSize;
    }

    /* renamed from: getFontStyle-4Lr2A7w, reason: not valid java name */
    public final FontStyle m4482getFontStyle4Lr2A7w() {
        return this.fontStyle;
    }

    /* renamed from: getFontSynthesis-ZQGJjVo, reason: not valid java name */
    public final FontSynthesis m4483getFontSynthesisZQGJjVo() {
    ...
    public final long m4484getLetterSpacingXSAIIZE() {
    ...
    public final void m4485setBackground8_81llA(long j8) {
        this.background = j8;
    }

    /* renamed from: setBaselineShift-_isdbwI, reason: not valid java name */
    public final void m4486setBaselineShift_isdbwI(BaselineShift baselineShift) {
        this.baselineShift = baselineShift;
    }

    /* renamed from: setColor-8_81llA, reason: not valid java name */
    public final void m4487setColor8_81llA(long j8) {
        this.color = j8;
    }
    ...
    public final void m4488setFontSizeR2X_6o(long j8) {
        this.fontSize = j8;
    }

    /* renamed from: setFontStyle-mLjRB2g, reason: not valid java name */
    public final void m4489setFontStylemLjRB2g(FontStyle fontStyle) {
        this.fontStyle = fontStyle;
    }

    /* renamed from: setFontSynthesis-tDdu0R4, reason: not valid java name */
    public final void m4490setFontSynthesistDdu0R4(FontSynthesis fontSynthesis) {
    ...
    public final void m4491setLetterSpacingR2X_6o(long j8) {
    ...
    public final SpanStyle toSpanStyle() {
        return new SpanStyle(this.color, this.fontSize, this.fontWeight, this.fontStyle, this.fontSynthesis, this.fontFamily, this.fontFeatureSettings, this.letterSpacing, this.baselineShift, this.textGeometricTransform, this.localeList, this.background, this.textDecoration, this.shadow, (PlatformSpanStyle) null, (DrawStyle) null, 49152, (AbstractC3247p) null);
    }
