...
public final class ViewLayer extends View implements OwnedLayer, GraphicLayerInfo {
    ...
    private static final InterfaceC1668n getMatrix = ViewLayer$Companion$getMatrix$1.INSTANCE;
    private static final ViewOutlineProvider OutlineProvider = new ViewOutlineProvider() { // from class: androidx.compose.ui.platform.ViewLayer$Companion$OutlineProvider$1
        ...
        public void getOutline(View view, Outline outline) {
            ...
            AbstractC3255y.g(view, "null cannot be cast to non-null type androidx.compose.ui.platform.ViewLayer");
            outlineResolver = ((ViewLayer) view).outlineResolver;
            Outline outline2 = outlineResolver.getOutline();
            AbstractC3255y.f(outline2);
    ...
    public ViewLayer(AndroidComposeView androidComposeView, DrawChildContainer drawChildContainer, Function1 function1, Function0 function0) {
        ...
        this.mTransformOrigin = TransformOrigin.Companion.m3344getCenterSzJe1aQ();
    ...
    public void mo4395inverseTransform58bKbWc(float[] fArr) {
        float[] m4476calculateInverseMatrixbWbORWo = this.matrixCache.m4476calculateInverseMatrixbWbORWo(this);
    ...
    public boolean mo4396isInLayerk4lQ0M(long j8) {
        ...
        if (this.clipToBounds) {
            if (0.0f <= m2740getXimpl && m2740getXimpl < getWidth() && 0.0f <= m2741getYimpl && m2741getYimpl < getHeight()) {
                return true;
            }
            return false;
        }
    ...
    public void mapBounds(MutableRect mutableRect, boolean z8) {
        ...
        Matrix.m3195mapimpl(this.matrixCache.m4477calculateMatrixGrdbGEg(this), mutableRect);
    }
    ...
    public long mo4397mapOffset8S9VItk(long j8, boolean z8) {
        ...
        return Matrix.m3193mapMKHz9U(this.matrixCache.m4477calculateMatrixGrdbGEg(this), j8);
    }
    ...
    public void mo4398movegyyYBs(long j8) {
        ...
        if (m5307getXimpl != getLeft()) {
            offsetLeftAndRight(m5307getXimpl - getLeft());
            this.matrixCache.invalidate();
        }
        int m5308getYimpl = IntOffset.m5308getYimpl(j8);
        if (m5308getYimpl != getTop()) {
            offsetTopAndBottom(m5308getYimpl - getTop());
            this.matrixCache.invalidate();
        }
    }
    ...
    public void mo4399resizeozmzZPI(long j8) {
        ...
        if (m5349getWidthimpl != getWidth() || m5348getHeightimpl != getHeight()) {
            float f8 = m5349getWidthimpl;
            setPivotX(TransformOrigin.m3339getPivotFractionXimpl(this.mTransformOrigin) * f8);
            float f9 = m5348getHeightimpl;
            setPivotY(TransformOrigin.m3340getPivotFractionYimpl(this.mTransformOrigin) * f9);
            this.outlineResolver.m4500updateuvyYCjk(SizeKt.Size(f8, f9));
            updateOutlineResolver();
            layout(getLeft(), getTop(), getLeft() + m5349getWidthimpl, getTop() + m5348getHeightimpl);
            resetClipBounds();
            this.matrixCache.invalidate();
        }
    }
    ...
    public void mo4400transform58bKbWc(float[] fArr) {
        Matrix.m3204timesAssign58bKbWc(fArr, this.matrixCache.m4477calculateMatrixGrdbGEg(this));
    }
    ...
    public void updateLayerProperties(ReusableGraphicsLayerScope reusableGraphicsLayerScope, LayoutDirection layoutDirection, Density density) {
        ...
        if ((mutatedFields$ui_release & 4096) != 0) {
            long mo3145getTransformOriginSzJe1aQ = reusableGraphicsLayerScope.mo3145getTransformOriginSzJe1aQ();
            this.mTransformOrigin = mo3145getTransformOriginSzJe1aQ;
            setPivotX(TransformOrigin.m3339getPivotFractionXimpl(mo3145getTransformOriginSzJe1aQ) * getWidth());
            setPivotY(TransformOrigin.m3340getPivotFractionYimpl(this.mTransformOrigin) * getHeight());
        }
        ...
        if (i8 >= 28) {
            if ((mutatedFields$ui_release & 64) != 0) {
                ViewLayerVerificationHelper28.INSTANCE.setOutlineAmbientShadowColor(this, ColorKt.m3030toArgb8_81llA(reusableGraphicsLayerScope.mo3141getAmbientShadowColor0d7_KjU()));
            }
            if ((mutatedFields$ui_release & 128) != 0) {
                ViewLayerVerificationHelper28.INSTANCE.setOutlineSpotShadowColor(this, ColorKt.m3030toArgb8_81llA(reusableGraphicsLayerScope.mo3144getSpotShadowColor0d7_KjU()));
            }
        }
        ...
        if ((mutatedFields$ui_release & 32768) != 0) {
            int mo3142getCompositingStrategyNrFUSI = reusableGraphicsLayerScope.mo3142getCompositingStrategyNrFUSI();
            CompositingStrategy.Companion companion = CompositingStrategy.Companion;
            if (CompositingStrategy.m3060equalsimpl0(mo3142getCompositingStrategyNrFUSI, companion.m3066getOffscreenNrFUSI())) {
                setLayerType(2, null);
            } else if (CompositingStrategy.m3060equalsimpl0(mo3142getCompositingStrategyNrFUSI, companion.m3065getModulateAlphaNrFUSI())) {
                setLayerType(0, null);
