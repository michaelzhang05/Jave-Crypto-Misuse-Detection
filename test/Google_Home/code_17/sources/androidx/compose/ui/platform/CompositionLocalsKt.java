...
public final class CompositionLocalsKt {
    ...
    public static final void ProvideCommonCompositionLocals(Owner owner, UriHandler uriHandler, InterfaceC1668n interfaceC1668n, Composer composer, int i8) {
        int i9;
        ...
        if ((i9 & 731) == 146 && startRestartGroup.getSkipping()) {
            ...
            interfaceC1668n2 = interfaceC1668n;
            composer2 = startRestartGroup;
            CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) providedValueArr, interfaceC1668n2, composer2, ((i9 >> 3) & 112) | 8);
            if (ComposerKt.isTraceInProgress()) {
        ...
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new CompositionLocalsKt$ProvideCommonCompositionLocals$1(owner, uriHandler, interfaceC1668n2, i8));
        }
    }
