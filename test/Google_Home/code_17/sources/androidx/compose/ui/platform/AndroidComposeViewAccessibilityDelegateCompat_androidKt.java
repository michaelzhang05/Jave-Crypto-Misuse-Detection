...
public final class AndroidComposeViewAccessibilityDelegateCompat_androidKt {
    ...
    public static final boolean accessibilityEquals(AccessibilityAction<?> accessibilityAction, Object obj) {
        ...
        if (!AbstractC3255y.d(accessibilityAction.getLabel(), accessibilityAction2.getLabel())) {
            return false;
        }
    ...
    public static final boolean excludeLineAndPageGranularities(SemanticsNode semanticsNode) {
        boolean z8;
        if (semanticsNode.getUnmergedConfig$ui_release().contains(SemanticsActions.INSTANCE.getSetText()) && !AbstractC3255y.d(SemanticsConfigurationKt.getOrNull(semanticsNode.getUnmergedConfig$ui_release(), SemanticsProperties.INSTANCE.getFocused()), Boolean.TRUE)) {
            return true;
        }
        ...
        if (findClosestParentNode != null) {
            ...
            if (collapsedSemantics$ui_release != null) {
                z8 = AbstractC3255y.d(SemanticsConfigurationKt.getOrNull(collapsedSemantics$ui_release, SemanticsProperties.INSTANCE.getFocused()), Boolean.TRUE);
            } else {
                z8 = false;
            }
            if (!z8) {
    ...
    public static final Map<Integer, SemanticsNodeWithAdjustedBounds> getAllUncoveredSemanticsNodesToMap(SemanticsOwner semanticsOwner) {
        ...
        if (unmergedRootSemanticsNode.getLayoutNode$ui_release().isPlaced() && unmergedRootSemanticsNode.getLayoutNode$ui_release().isAttached()) {
            ...
            getAllUncoveredSemanticsNodesToMap$findAllSemanticNodesRecursive(new Region(AbstractC2055a.d(boundsInRoot.getLeft()), AbstractC2055a.d(boundsInRoot.getTop()), AbstractC2055a.d(boundsInRoot.getRight()), AbstractC2055a.d(boundsInRoot.getBottom())), unmergedRootSemanticsNode, linkedHashMap, unmergedRootSemanticsNode, new Region());
        }
    ...
    private static final void getAllUncoveredSemanticsNodesToMap$findAllSemanticNodesRecursive(Region region, SemanticsNode semanticsNode, Map<Integer, SemanticsNodeWithAdjustedBounds> map, SemanticsNode semanticsNode2, Region region2) {
        ...
        if (!region.isEmpty() || semanticsNode2.getId() == semanticsNode.getId()) {
            ...
            int d8 = AbstractC2055a.d(touchBoundsInRoot.getLeft());
            int d9 = AbstractC2055a.d(touchBoundsInRoot.getTop());
            int d10 = AbstractC2055a.d(touchBoundsInRoot.getRight());
            int d11 = AbstractC2055a.d(touchBoundsInRoot.getBottom());
            ...
            if (semanticsNode2.isFake$ui_release()) {
                ...
                map.put(Integer.valueOf(id), new SemanticsNodeWithAdjustedBounds(semanticsNode2, new android.graphics.Rect(AbstractC2055a.d(rect.getLeft()), AbstractC2055a.d(rect.getTop()), AbstractC2055a.d(rect.getRight()), AbstractC2055a.d(rect.getBottom()))));
                return;
            }
            if (id == -1) {
                map.put(Integer.valueOf(id), new SemanticsNodeWithAdjustedBounds(semanticsNode2, region2.getBounds()));
    ...
    public static final String getInfoContentDescriptionOrNull(SemanticsNode semanticsNode) {
        ...
        if (list != null) {
            return (String) AbstractC1378t.o0(list);
        }
        return null;
    }
    ...
    public static final boolean isAncestorOf(LayoutNode layoutNode, LayoutNode layoutNode2) {
        ...
        if (!AbstractC3255y.d(parent$ui_release, layoutNode) && !isAncestorOf(layoutNode, parent$ui_release)) {
            return false;
        }
        return true;
    }
    ...
    public static final String m4440toLegacyClassNameV4PA4sw(int i8) {
        Role.Companion companion = Role.Companion;
        if (Role.m4524equalsimpl0(i8, companion.m4528getButtono7Vup1c())) {
            return "android.widget.Button";
        }
        if (Role.m4524equalsimpl0(i8, companion.m4529getCheckboxo7Vup1c())) {
            return "android.widget.CheckBox";
        }
        if (Role.m4524equalsimpl0(i8, companion.m4532getRadioButtono7Vup1c())) {
            return "android.widget.RadioButton";
        }
        if (Role.m4524equalsimpl0(i8, companion.m4531getImageo7Vup1c())) {
            return "android.widget.ImageView";
        }
        if (Role.m4524equalsimpl0(i8, companion.m4530getDropdownListo7Vup1c())) {
