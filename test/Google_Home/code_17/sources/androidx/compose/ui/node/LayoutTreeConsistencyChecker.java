...
public final class LayoutTreeConsistencyChecker {
    ...
    private final boolean consistentLayoutState(LayoutNode layoutNode) {
            ...
            if (layoutNode.getMeasurePending$ui_release()) {
                ...
                while (true) {
                    if (i8 < size) {
                        ...
                        if (AbstractC3255y.d(postponedRequest3.getNode(), layoutNode) && !postponedRequest3.isLookahead()) {
                            break;
                        }
                        i8++;
                    } else {
        ...
        if (AbstractC3255y.d(layoutNode.isPlacedInLookahead(), Boolean.TRUE)) {
            if (layoutNode.getLookaheadMeasurePending$ui_release()) {
                ...
                while (true) {
                    ...
                    if (AbstractC3255y.d(postponedRequest5.getNode(), layoutNode) && postponedRequest5.isLookahead()) {
            ...
            if (layoutNode.getLookaheadMeasurePending$ui_release()) {
                if (!this.relayoutNodes.contains(layoutNode, true) && ((parent$ui_release == null || !parent$ui_release.getLookaheadMeasurePending$ui_release()) && layoutState != LayoutNode.LayoutState.LookaheadMeasuring && (parent$ui_release == null || !parent$ui_release.getMeasurePending$ui_release() || !AbstractC3255y.d(layoutNode.getLookaheadRoot$ui_release(), layoutNode)))) {
                    return false;
                }
                return true;
            }
            if (layoutNode.getLookaheadLayoutPending$ui_release() && !this.relayoutNodes.contains(layoutNode, true) && parent$ui_release != null && !parent$ui_release.getLookaheadMeasurePending$ui_release() && !parent$ui_release.getLookaheadLayoutPending$ui_release() && layoutState != LayoutNode.LayoutState.LookaheadMeasuring && layoutState != LayoutNode.LayoutState.LookaheadLayingOut && (!parent$ui_release.getLayoutPending$ui_release() || !AbstractC3255y.d(layoutNode.getLookaheadRoot$ui_release(), layoutNode))) {
                return false;
            }
            return true;
        }
