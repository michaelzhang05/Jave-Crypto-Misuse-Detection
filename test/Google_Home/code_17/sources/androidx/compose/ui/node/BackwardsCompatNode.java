...
public final class BackwardsCompatNode extends Modifier.Node implements LayoutModifierNode, DrawModifierNode, SemanticsModifierNode, PointerInputModifierNode, ModifierLocalModifierNode, ModifierLocalReadScope, ParentDataModifierNode, LayoutAwareModifierNode, GlobalPositionAwareModifierNode, FocusEventModifierNode, FocusPropertiesModifierNode, FocusRequesterModifierNode, OwnerScope, BuildDrawCacheParams {
    ...
    private final void initializeModifier(boolean z8) {
        if (isAttached()) {
            ...
            if ((NodeKind.m4348constructorimpl(32) & getKindSet$ui_release()) != 0) {
            ...
            if ((NodeKind.m4348constructorimpl(4) & getKindSet$ui_release()) != 0) {
            ...
            if ((NodeKind.m4348constructorimpl(2) & getKindSet$ui_release()) != 0) {
            ...
            if ((NodeKind.m4348constructorimpl(128) & getKindSet$ui_release()) != 0) {
                        ...
                        DelegatableNodeKt.requireOwner(this).registerOnLayoutCompletedListener(new Owner.OnLayoutCompletedListener() { // from class: androidx.compose.ui.node.BackwardsCompatNode$initializeModifier$3
                            ...
                            public void onLayoutComplete() {
                                ...
                                if (layoutCoordinates == null) {
                                    ...
                                    backwardsCompatNode.onPlaced(DelegatableNodeKt.m4231requireCoordinator64DMado(backwardsCompatNode, NodeKind.m4348constructorimpl(128)));
                                }
                            }
                        });
                    }
            ...
            if ((NodeKind.m4348constructorimpl(256) & getKindSet$ui_release()) != 0 && (element instanceof OnGloballyPositionedModifier) && BackwardsCompatNodeKt.access$isChainUpdate(this)) {
                DelegatableNodeKt.requireLayoutNode(this).invalidateMeasurements$ui_release();
            }
            if (element instanceof FocusRequesterModifier) {
                ((FocusRequesterModifier) element).getFocusRequester().getFocusRequesterNodes$ui_release().add(this);
            }
            if ((NodeKind.m4348constructorimpl(16) & getKindSet$ui_release()) != 0 && (element instanceof PointerInputModifier)) {
                ((PointerInputModifier) element).getPointerInputFilter().setLayoutCoordinates$ui_release(getCoordinator$ui_release());
            }
            if ((NodeKind.m4348constructorimpl(8) & getKindSet$ui_release()) != 0) {
    ...
    public void applySemantics(SemanticsPropertyReceiver semanticsPropertyReceiver) {
        Modifier.Element element = this.element;
        AbstractC3255y.g(element, "null cannot be cast to non-null type androidx.compose.ui.semantics.SemanticsModifier");
        SemanticsConfiguration semanticsConfiguration = ((SemanticsModifier) element).getSemanticsConfiguration();
        AbstractC3255y.g(semanticsPropertyReceiver, "null cannot be cast to non-null type androidx.compose.ui.semantics.SemanticsConfiguration");
    ...
    public void draw(ContentDrawScope contentDrawScope) {
        Modifier.Element element = this.element;
        AbstractC3255y.g(element, "null cannot be cast to non-null type androidx.compose.ui.draw.DrawModifier");
    ...
    public <T> T getCurrent(ModifierLocal<T> modifierLocal) {
        ...
        int m4348constructorimpl = NodeKind.m4348constructorimpl(32);
    ...
    public boolean interceptOutOfBoundsChildEvents() {
        Modifier.Element element = this.element;
        AbstractC3255y.g(element, "null cannot be cast to non-null type androidx.compose.ui.input.pointer.PointerInputModifier");
    ...
    public int maxIntrinsicHeight(IntrinsicMeasureScope intrinsicMeasureScope, IntrinsicMeasurable intrinsicMeasurable, int i8) {
        Modifier.Element element = this.element;
        AbstractC3255y.g(element, "null cannot be cast to non-null type androidx.compose.ui.layout.LayoutModifier");
    ...
    public MeasureResult mo368measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j8) {
        Modifier.Element element = this.element;
        AbstractC3255y.g(element, "null cannot be cast to non-null type androidx.compose.ui.layout.LayoutModifier");
        return ((LayoutModifier) element).mo161measure3p2s80s(measureScope, measurable, j8);
    }
    ...
    public Object modifyParentData(Density density, Object obj) {
        Modifier.Element element = this.element;
        AbstractC3255y.g(element, "null cannot be cast to non-null type androidx.compose.ui.layout.ParentDataModifier");
    ...
    public void onGloballyPositioned(LayoutCoordinates layoutCoordinates) {
        Modifier.Element element = this.element;
        AbstractC3255y.g(element, "null cannot be cast to non-null type androidx.compose.ui.layout.OnGloballyPositionedModifier");
    ...
    public void mo270onPointerEventH0pRuoY(PointerEvent pointerEvent, PointerEventPass pointerEventPass, long j8) {
        Modifier.Element element = this.element;
        AbstractC3255y.g(element, "null cannot be cast to non-null type androidx.compose.ui.input.pointer.PointerInputModifier");
        ((PointerInputModifier) element).getPointerInputFilter().mo4045onPointerEventH0pRuoY(pointerEvent, pointerEventPass, j8);
    }

    @Override // androidx.compose.ui.node.LayoutAwareModifierNode
    /* renamed from: onRemeasured-ozmzZPI */
    public void mo342onRemeasuredozmzZPI(long j8) {
        Modifier.Element element = this.element;
        if (element instanceof OnRemeasuredModifier) {
            ((OnRemeasuredModifier) element).mo381onRemeasuredozmzZPI(j8);
        }
    }
