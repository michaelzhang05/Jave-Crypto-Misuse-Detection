...
public final class TraversableNodeKt {
    ...
    public static final TraversableNode findNearestAncestor(DelegatableNode delegatableNode, Object obj) {
        ...
        int m4348constructorimpl = NodeKind.m4348constructorimpl(262144);
                        ...
                        if ((parent$ui_release.getKindSet$ui_release() & m4348constructorimpl) != 0) {
                            ...
                            while (delegatingNode != 0) {
                                if (delegatingNode instanceof TraversableNode) {
                                    ...
                                    if (AbstractC3255y.d(obj, traversableNode.getTraverseKey())) {
                    ...
                    while (parent$ui_release != null) {
                        if ((parent$ui_release.getKindSet$ui_release() & m4348constructorimpl) != 0) {
                            ...
                            while (delegatingNode != 0) {
                                if (delegatingNode instanceof TraversableNode) {
                                    TraversableNode traversableNode = (TraversableNode) delegatingNode;
                                    if (!(AbstractC3255y.d(obj, traversableNode.getTraverseKey()) ? ((Boolean) function1.invoke(traversableNode)).booleanValue() : true)) {
                                        return;
                                    }
                                } else {
    ...
    */
    public static final void traverseChildren(androidx.compose.ui.node.DelegatableNode r10, java.lang.Object r11, kotlin.jvm.functions.Function1 r12) {
        ...
        L57:
            ...
            boolean r7 = kotlin.jvm.internal.AbstractC3255y.d(r11, r7)
            if (r7 == 0) goto L74
                        ...
                        if ((parent$ui_release.getKindSet$ui_release() & m4348constructorimpl) != 0) {
                            ...
                            while (delegatingNode != 0) {
                                if (delegatingNode instanceof TraversableNode) {
                                    ...
                                    if (AbstractC3255y.d(t8.getTraverseKey(), t9.getTraverseKey()) && Actual_jvmKt.areObjectsOfSameType(t8, t9)) {
                                        return t9;
                                    }
                                } else if ((delegatingNode.getKindSet$ui_release() & m4348constructorimpl) != 0 && (delegatingNode instanceof DelegatingNode)) {
                                    Modifier.Node delegate$ui_release = delegatingNode.getDelegate$ui_release();
                    ...
                    while (parent$ui_release != null) {
                        if ((parent$ui_release.getKindSet$ui_release() & m4348constructorimpl) != 0) {
                            ...
                            while (delegatingNode != 0) {
                                ...
                                if (delegatingNode instanceof TraversableNode) {
                                    TraversableNode traversableNode = (TraversableNode) delegatingNode;
                                    if (AbstractC3255y.d(t8.getTraverseKey(), traversableNode.getTraverseKey()) && Actual_jvmKt.areObjectsOfSameType(t8, traversableNode)) {
