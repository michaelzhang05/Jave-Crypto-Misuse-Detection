...
public abstract class LookaheadCapablePlaceable extends Placeable implements MeasureScopeWithLayoutNode {
    ...
    public final int get(AlignmentLine alignmentLine) {
        ...
        if (alignmentLine instanceof VerticalAlignmentLine) {
            m5308getYimpl = IntOffset.m5307getXimpl(m4169getApparentToRealOffsetnOccac());
        } else {
            m5308getYimpl = IntOffset.m5308getYimpl(m4169getApparentToRealOffsetnOccac());
        }
        return calculateAlignmentLine + m5308getYimpl;
    }
    ...
    public abstract long mo4289getPositionnOccac();
    ...
    public final void invalidateAlignmentLinesFromPositionChange(NodeCoordinator nodeCoordinator) {
        ...
        if (!AbstractC3255y.d(layoutNode, nodeCoordinator.getLayoutNode())) {
