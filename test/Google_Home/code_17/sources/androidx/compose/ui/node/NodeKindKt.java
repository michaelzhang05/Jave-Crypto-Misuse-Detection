...
public final class NodeKindKt {
    ...
    private static final void autoInvalidateNodeSelf(Modifier.Node node, int i8, int i9) {
        ...
        if ((NodeKind.m4348constructorimpl(2) & i8) != 0 && (node instanceof LayoutModifierNode)) {
            LayoutModifierNodeKt.invalidateMeasurement((LayoutModifierNode) node);
            if (i9 == 2) {
                DelegatableNodeKt.m4231requireCoordinator64DMado(node, NodeKind.m4348constructorimpl(2)).onRelease();
            }
        }
        if ((NodeKind.m4348constructorimpl(256) & i8) != 0 && (node instanceof GlobalPositionAwareModifierNode)) {
            DelegatableNodeKt.requireLayoutNode(node).invalidateMeasurements$ui_release();
        }
        if ((NodeKind.m4348constructorimpl(4) & i8) != 0 && (node instanceof DrawModifierNode)) {
            DrawModifierNodeKt.invalidateDraw((DrawModifierNode) node);
        }
        if ((NodeKind.m4348constructorimpl(8) & i8) != 0 && (node instanceof SemanticsModifierNode)) {
            SemanticsModifierNodeKt.invalidateSemantics((SemanticsModifierNode) node);
        }
        if ((NodeKind.m4348constructorimpl(64) & i8) != 0 && (node instanceof ParentDataModifierNode)) {
            ParentDataModifierNodeKt.invalidateParentData((ParentDataModifierNode) node);
        }
        if ((NodeKind.m4348constructorimpl(1024) & i8) != 0 && (node instanceof FocusTargetNode)) {
            if (i9 == 2) {
                node.onReset();
            } else {
        ...
        if ((NodeKind.m4348constructorimpl(2048) & i8) != 0 && (node instanceof FocusPropertiesModifierNode)) {
        ...
        if ((i8 & NodeKind.m4348constructorimpl(4096)) != 0 && (node instanceof FocusEventModifierNode)) {
    ...
    public static final int calculateNodeKindSetFrom(Modifier.Node node) {
        ...
        int m4348constructorimpl = NodeKind.m4348constructorimpl(1);
        if (node instanceof LayoutModifierNode) {
            m4348constructorimpl |= NodeKind.m4348constructorimpl(2);
        }
        if (node instanceof DrawModifierNode) {
            m4348constructorimpl |= NodeKind.m4348constructorimpl(4);
        }
        if (node instanceof SemanticsModifierNode) {
            m4348constructorimpl |= NodeKind.m4348constructorimpl(8);
        }
        if (node instanceof PointerInputModifierNode) {
            m4348constructorimpl |= NodeKind.m4348constructorimpl(16);
        }
        if (node instanceof ModifierLocalModifierNode) {
            m4348constructorimpl |= NodeKind.m4348constructorimpl(32);
        }
        if (node instanceof ParentDataModifierNode) {
            m4348constructorimpl |= NodeKind.m4348constructorimpl(64);
        }
        if (node instanceof LayoutAwareModifierNode) {
            m4348constructorimpl |= NodeKind.m4348constructorimpl(128);
        }
        if (node instanceof GlobalPositionAwareModifierNode) {
            m4348constructorimpl |= NodeKind.m4348constructorimpl(256);
        }
        if (node instanceof IntermediateLayoutModifierNode) {
            m4348constructorimpl |= NodeKind.m4348constructorimpl(512);
        }
        if (node instanceof FocusTargetNode) {
            m4348constructorimpl |= NodeKind.m4348constructorimpl(1024);
        }
        if (node instanceof FocusPropertiesModifierNode) {
            m4348constructorimpl |= NodeKind.m4348constructorimpl(2048);
        }
        if (node instanceof FocusEventModifierNode) {
            m4348constructorimpl |= NodeKind.m4348constructorimpl(4096);
        }
        if (node instanceof KeyInputModifierNode) {
            m4348constructorimpl |= NodeKind.m4348constructorimpl(8192);
        }
        if (node instanceof RotaryInputModifierNode) {
            m4348constructorimpl |= NodeKind.m4348constructorimpl(16384);
        }
        if (node instanceof CompositionLocalConsumerModifierNode) {
            m4348constructorimpl |= NodeKind.m4348constructorimpl(32768);
        }
        if (node instanceof SoftKeyboardInterceptionModifierNode) {
            m4348constructorimpl |= NodeKind.m4348constructorimpl(131072);
        }
        return node instanceof TraversableNode ? m4348constructorimpl | NodeKind.m4348constructorimpl(262144) : m4348constructorimpl;
    }
    ...
    public static final boolean m4356contains64DMado(int i8, int i9) {
        return (i8 & i9) != 0;
    }

    /* renamed from: getIncludeSelfInTraversal-H91voCI, reason: not valid java name */
    public static final boolean m4357getIncludeSelfInTraversalH91voCI(int i8) {
        if ((i8 & NodeKind.m4348constructorimpl(128)) != 0) {
            return true;
        }
        return false;
    }
    ...
    public static final int m4358or64DMado(int i8, int i9) {
        return i8 | i9;
    }
    ...
    public static final int calculateNodeKindSetFrom(Modifier.Element element) {
        ...
        return ((element instanceof OnPlacedModifier) || (element instanceof OnRemeasuredModifier)) ? m4348constructorimpl | NodeKind.m4348constructorimpl(128) : m4348constructorimpl;
    }
}
