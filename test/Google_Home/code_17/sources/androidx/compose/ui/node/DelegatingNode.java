...
public abstract class DelegatingNode extends Modifier.Node {
    ...
    private final void validateDelegateKindSet(int i8, Modifier.Node node) {
        int kindSet$ui_release = getKindSet$ui_release();
        if ((i8 & NodeKind.m4348constructorimpl(2)) != 0 && (NodeKind.m4348constructorimpl(2) & kindSet$ui_release) != 0 && !(this instanceof LayoutModifierNode)) {
    ...
    public final <T extends DelegatableNode> T delegate(T t8) {
        ...
        if (node2 != t8) {
            ...
            if (node2 == getNode() && AbstractC3255y.d(node3, this)) {
                return t8;
            }
        ...
        if (!node2.isAttached()) {
            ...
            if (isAttached()) {
                if ((calculateNodeKindSetFromIncludingDelegates & NodeKind.m4348constructorimpl(2)) != 0 && (kindSet$ui_release & NodeKind.m4348constructorimpl(2)) == 0) {
    ...
    protected final void undelegate(DelegatableNode delegatableNode) {
        ...
        for (Modifier.Node node2 = this.delegate; node2 != null; node2 = node2.getChild$ui_release()) {
            if (node2 == delegatableNode) {
                ...
                if (isAttached() && (kindSet$ui_release & NodeKind.m4348constructorimpl(2)) != 0 && (NodeKind.m4348constructorimpl(2) & calculateNodeKindSetFromIncludingDelegates) == 0) {
                    NodeChain nodes$ui_release = DelegatableNodeKt.requireLayoutNode(this).getNodes$ui_release();
                    getNode().updateCoordinator$ui_release(null);
                    nodes$ui_release.syncCoordinators();
                    return;
