...
public final class HitTestResult implements List<Modifier.Node>, InterfaceC1985a, j$.util.List {
    ...
    /* loaded from: classes.dex */
    private final class HitTestResultIterator implements ListIterator<Modifier.Node>, InterfaceC1985a {
        private int index;
        ...
        public Modifier.Node next() {
            ...
            AbstractC3255y.g(obj, "null cannot be cast to non-null type androidx.compose.ui.Modifier.Node");
        ...
        public /* synthetic */ HitTestResultIterator(HitTestResult hitTestResult, int i8, int i9, int i10, int i11, AbstractC3247p abstractC3247p) {
            this((i11 & 1) != 0 ? 0 : i8, (i11 & 2) != 0 ? 0 : i9, (i11 & 4) != 0 ? hitTestResult.size() : i10);
        }
    }

    /* loaded from: classes.dex */
    private final class SubList implements List<Modifier.Node>, InterfaceC1985a, j$.util.List {
        private final int maxIndex;
        private final int minIndex;
        ...
        public int indexOf(Modifier.Node node) {
            ...
            while (!AbstractC3255y.d(HitTestResult.this.values[i8], node)) {
                if (i8 == i9) {
                    return -1;
                }
                i8++;
    ...
    private final long m4251findBestHitDistanceptXAw2c() {
        ...
        int o8 = AbstractC1378t.o(this);
        if (i8 <= o8) {
            while (true) {
                long m4243constructorimpl = DistanceAndInLayer.m4243constructorimpl(this.distanceFromEdgeAndInLayer[i8]);
                if (DistanceAndInLayer.m4242compareToS_HNhKs(m4243constructorimpl, DistanceAndInLayer) < 0) {
                    DistanceAndInLayer = m4243constructorimpl;
                }
                if (DistanceAndInLayer.m4246getDistanceimpl(DistanceAndInLayer) < 0.0f && DistanceAndInLayer.m4248isInLayerimpl(DistanceAndInLayer)) {
    ...
    public final boolean hasHit() {
        long m4251findBestHitDistanceptXAw2c = m4251findBestHitDistanceptXAw2c();
        if (DistanceAndInLayer.m4246getDistanceimpl(m4251findBestHitDistanceptXAw2c) < 0.0f && DistanceAndInLayer.m4248isInLayerimpl(m4251findBestHitDistanceptXAw2c)) {
            return true;
        }
        return false;
    }
    ...
    public final boolean isHitInMinimumTouchTargetBetter(float f8, boolean z8) {
        long DistanceAndInLayer;
        if (this.hitDepth != AbstractC1378t.o(this)) {
            DistanceAndInLayer = HitTestResultKt.DistanceAndInLayer(f8, z8);
            if (DistanceAndInLayer.m4242compareToS_HNhKs(m4251findBestHitDistanceptXAw2c(), DistanceAndInLayer) > 0) {
                return true;
            }
            return false;
        }
    ...
    public final void speculativeHit(Modifier.Node node, float f8, boolean z8, Function0 function0) {
        if (this.hitDepth == AbstractC1378t.o(this)) {
            ...
            if (this.hitDepth + 1 == AbstractC1378t.o(this)) {
                resizeToHitDepth();
                return;
            }
            return;
        ...
        long m4251findBestHitDistanceptXAw2c = m4251findBestHitDistanceptXAw2c();
        int i8 = this.hitDepth;
        this.hitDepth = AbstractC1378t.o(this);
        hitInMinimumTouchTarget(node, f8, z8, function0);
        if (this.hitDepth + 1 < AbstractC1378t.o(this) && DistanceAndInLayer.m4242compareToS_HNhKs(m4251findBestHitDistanceptXAw2c, m4251findBestHitDistanceptXAw2c()) > 0) {
            int i9 = this.hitDepth + 1;
            int i10 = i8 + 1;
            Object[] objArr = this.values;
            AbstractC1371l.i(objArr, objArr, i10, i9, size());
            long[] jArr = this.distanceFromEdgeAndInLayer;
            AbstractC1371l.h(jArr, jArr, i10, i9, size());
    ...
    public int indexOf(Modifier.Node node) {
        ...
        int i8 = 0;
        while (!AbstractC3255y.d(this.values[i8], node)) {
            if (i8 == o8) {
                return -1;
            }
            i8++;
    ...
    public int lastIndexOf(Modifier.Node node) {
        for (int o8 = AbstractC1378t.o(this); -1 < o8; o8--) {
            if (AbstractC3255y.d(this.values[o8], node)) {
                return o8;
            }
        }
        return -1;
