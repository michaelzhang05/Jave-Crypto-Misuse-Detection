...
public final class LayoutNode implements ComposeNodeLifecycleCallback, Remeasurement, OwnerScope, LayoutInfo, ComposeUiNode, InteroperableComposeUiNode, Owner.OnLayoutCompletedListener {
    ...
    private static final NoIntrinsicsMeasurePolicy ErrorMeasurePolicy = new NoIntrinsicsMeasurePolicy() { // from class: androidx.compose.ui.node.LayoutNode$Companion$ErrorMeasurePolicy$1
        ...
        public /* bridge */ /* synthetic */ MeasureResult mo137measure3p2s80s(MeasureScope measureScope, List list, long j8) {
            return (MeasureResult) m4262measure3p2s80s(measureScope, (List<? extends Measurable>) list, j8);
        }

        /* renamed from: measure-3p2s80s, reason: not valid java name */
        public Void m4262measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j8) {
    ...
    private static final ViewConfiguration DummyViewConfiguration = new ViewConfiguration() { // from class: androidx.compose.ui.node.LayoutNode$Companion$DummyViewConfiguration$1
        ...
        public long mo4261getMinimumTouchTargetSizeMYxV2XQ() {
            return DpSize.Companion.m5291getZeroMYxV2XQ();
        }
    ...
    public static abstract class NoIntrinsicsMeasurePolicy implements MeasurePolicy {
        ...
        public /* bridge */ /* synthetic */ int maxIntrinsicHeight(IntrinsicMeasureScope intrinsicMeasureScope, List list, int i8) {
            return ((Number) m4263maxIntrinsicHeight(intrinsicMeasureScope, (List<? extends IntrinsicMeasurable>) list, i8)).intValue();
        }

        @Override // androidx.compose.ui.layout.MeasurePolicy
        public /* bridge */ /* synthetic */ int maxIntrinsicWidth(IntrinsicMeasureScope intrinsicMeasureScope, List list, int i8) {
            return ((Number) m4264maxIntrinsicWidth(intrinsicMeasureScope, (List<? extends IntrinsicMeasurable>) list, i8)).intValue();
        }

        @Override // androidx.compose.ui.layout.MeasurePolicy
        public /* bridge */ /* synthetic */ int minIntrinsicHeight(IntrinsicMeasureScope intrinsicMeasureScope, List list, int i8) {
            return ((Number) m4265minIntrinsicHeight(intrinsicMeasureScope, (List<? extends IntrinsicMeasurable>) list, i8)).intValue();
        }

        @Override // androidx.compose.ui.layout.MeasurePolicy
        public /* bridge */ /* synthetic */ int minIntrinsicWidth(IntrinsicMeasureScope intrinsicMeasureScope, List list, int i8) {
            return ((Number) m4266minIntrinsicWidth(intrinsicMeasureScope, (List<? extends IntrinsicMeasurable>) list, i8)).intValue();
        }

        /* renamed from: maxIntrinsicHeight */
        public Void m4263maxIntrinsicHeight(IntrinsicMeasureScope intrinsicMeasureScope, List<? extends IntrinsicMeasurable> list, int i8) {
            throw new IllegalStateException(this.error.toString());
        }

        /* renamed from: maxIntrinsicWidth */
        public Void m4264maxIntrinsicWidth(IntrinsicMeasureScope intrinsicMeasureScope, List<? extends IntrinsicMeasurable> list, int i8) {
            throw new IllegalStateException(this.error.toString());
        }

        /* renamed from: minIntrinsicHeight */
        public Void m4265minIntrinsicHeight(IntrinsicMeasureScope intrinsicMeasureScope, List<? extends IntrinsicMeasurable> list, int i8) {
            throw new IllegalStateException(this.error.toString());
        }

        /* renamed from: minIntrinsicWidth */
        public Void m4266minIntrinsicWidth(IntrinsicMeasureScope intrinsicMeasureScope, List<? extends IntrinsicMeasurable> list, int i8) {
            throw new IllegalStateException(this.error.toString());
        }
    }
    ...
    public static final int ZComparator$lambda$39(LayoutNode layoutNode, LayoutNode layoutNode2) {
        if (layoutNode.getZIndex() == layoutNode2.getZIndex()) {
            return AbstractC3255y.k(layoutNode.getPlaceOrder$ui_release(), layoutNode2.getPlaceOrder$ui_release());
        }
    ...
    private final NodeCoordinator getInnerLayerCoordinator() {
        ...
        if (this.innerLayerCoordinatorIsDirty) {
            ...
            while (true) {
                if (AbstractC3255y.d(innerCoordinator$ui_release, wrappedBy$ui_release)) {
                    break;
                }
    ...
    public static /* synthetic */ void m4253hitTestM_7yMNQ$ui_release$default(LayoutNode layoutNode, long j8, HitTestResult hitTestResult, boolean z8, boolean z9, int i8, Object obj) {
        boolean z10;
        boolean z11;
        if ((i8 & 4) != 0) {
            z10 = false;
        ...
        layoutNode.m4257hitTestM_7yMNQ$ui_release(j8, hitTestResult, z10, z11);
    }

    /* renamed from: hitTestSemantics-M_7yMNQ$ui_release$default */
    public static /* synthetic */ void m4254hitTestSemanticsM_7yMNQ$ui_release$default(LayoutNode layoutNode, long j8, HitTestResult hitTestResult, boolean z8, boolean z9, int i8, Object obj) {
        boolean z10;
        boolean z11;
        if ((i8 & 4) != 0) {
            z10 = true;
        ...
        layoutNode.m4258hitTestSemanticsM_7yMNQ$ui_release(j8, hitTestResult, z10, z11);
    }

    private final void invalidateFocusOnAttach() {
        boolean z8;
        boolean z9;
        if (this.nodes.has$ui_release(NodeKind.m4348constructorimpl(1024) | NodeKind.m4348constructorimpl(2048) | NodeKind.m4348constructorimpl(4096))) {
            for (Modifier.Node head$ui_release = this.nodes.getHead$ui_release(); head$ui_release != null; head$ui_release = head$ui_release.getChild$ui_release()) {
                boolean z10 = false;
                if ((NodeKind.m4348constructorimpl(1024) & head$ui_release.getKindSet$ui_release()) != 0) {
                    z8 = true;
                } else {
                    z8 = false;
                }
                if ((NodeKind.m4348constructorimpl(2048) & head$ui_release.getKindSet$ui_release()) != 0) {
                    z9 = true;
                } else {
                    z9 = false;
                }
                boolean z11 = z8 | z9;
                if ((NodeKind.m4348constructorimpl(4096) & head$ui_release.getKindSet$ui_release()) != 0) {
                    z10 = true;
                }
                if (z11 | z10) {
    ...
    private final void invalidateFocusOnDetach() {
        ...
        if ((nodeChain.getAggregateChildKindSet() & m4348constructorimpl) != 0) {
            for (Modifier.Node tail$ui_release = nodeChain.getTail$ui_release(); tail$ui_release != null; tail$ui_release = tail$ui_release.getParent$ui_release()) {
                if ((tail$ui_release.getKindSet$ui_release() & m4348constructorimpl) != 0) {
    ...
    public static /* synthetic */ boolean m4255lookaheadRemeasure_Sx5XlM$ui_release$default(LayoutNode layoutNode, Constraints constraints, int i8, Object obj) {
        if ((i8 & 1) != 0) {
            constraints = layoutNode.layoutDelegate.m4276getLastLookaheadConstraintsDWUhwKw();
        }
        return layoutNode.m4259lookaheadRemeasure_Sx5XlM$ui_release(constraints);
    }
    ...
    public static /* synthetic */ boolean m4256remeasure_Sx5XlM$ui_release$default(LayoutNode layoutNode, Constraints constraints, int i8, Object obj) {
        if ((i8 & 1) != 0) {
            constraints = layoutNode.layoutDelegate.m4275getLastConstraintsDWUhwKw();
        }
        return layoutNode.m4260remeasure_Sx5XlM$ui_release(constraints);
    }
    ...
    private final void setLookaheadRoot(LayoutNode layoutNode) {
        if (!AbstractC3255y.d(layoutNode, this.lookaheadRoot)) {
            ...
            if (layoutNode != null) {
                ...
                for (NodeCoordinator outerCoordinator$ui_release = getOuterCoordinator$ui_release(); !AbstractC3255y.d(outerCoordinator$ui_release, wrapped$ui_release) && outerCoordinator$ui_release != null; outerCoordinator$ui_release = outerCoordinator$ui_release.getWrapped$ui_release()) {
    ...
    private final boolean shouldInvalidateParentLayer() {
        if (this.nodes.m4305hasH91voCI$ui_release(NodeKind.m4348constructorimpl(4)) && !this.nodes.m4305hasH91voCI$ui_release(NodeKind.m4348constructorimpl(2))) {
            return true;
        }
        for (Modifier.Node head$ui_release = this.nodes.getHead$ui_release(); head$ui_release != null; head$ui_release = head$ui_release.getChild$ui_release()) {
            if ((NodeKind.m4348constructorimpl(2) & head$ui_release.getKindSet$ui_release()) != 0 && DelegatableNodeKt.m4231requireCoordinator64DMado(head$ui_release, NodeKind.m4348constructorimpl(2)).getLayer() != null) {
                return false;
            }
            if ((NodeKind.m4348constructorimpl(4) & head$ui_release.getKindSet$ui_release()) != 0) {
                return true;
            }
        }
        return true;
    ...
    public final void attach$ui_release(Owner owner) {
        ...
        if (this.owner == null) {
            ...
            if (layoutNode2 != null) {
                ...
                if (!AbstractC3255y.d(owner2, owner)) {
                    StringBuilder sb = new StringBuilder();
            ...
            this.depth = i8 + 1;
            if (this.nodes.m4305hasH91voCI$ui_release(NodeKind.m4348constructorimpl(8))) {
            ...
            NodeCoordinator wrapped$ui_release = getInnerCoordinator$ui_release().getWrapped$ui_release();
            for (NodeCoordinator outerCoordinator$ui_release2 = getOuterCoordinator$ui_release(); !AbstractC3255y.d(outerCoordinator$ui_release2, wrapped$ui_release) && outerCoordinator$ui_release2 != null; outerCoordinator$ui_release2 = outerCoordinator$ui_release2.getWrapped$ui_release()) {
    ...
    public final void dispatchOnPositionedCallbacks$ui_release() {
        ...
        NodeChain nodeChain = this.nodes;
        int m4348constructorimpl = NodeKind.m4348constructorimpl(256);
        if ((nodeChain.getAggregateChildKindSet() & m4348constructorimpl) != 0) {
            for (Modifier.Node head$ui_release = nodeChain.getHead$ui_release(); head$ui_release != null; head$ui_release = head$ui_release.getChild$ui_release()) {
                if ((head$ui_release.getKindSet$ui_release() & m4348constructorimpl) != 0) {
                    ...
                    while (delegatingNode != 0) {
                        if (delegatingNode instanceof GlobalPositionAwareModifierNode) {
                            ...
                            globalPositionAwareModifierNode.onGloballyPositioned(DelegatableNodeKt.m4231requireCoordinator64DMado(globalPositionAwareModifierNode, NodeKind.m4348constructorimpl(256)));
                ...
                if ((head$ui_release.getAggregateChildKindSet$ui_release() & m4348constructorimpl) == 0) {
                    return;
                }
            }
        }
    ...
    public final void forEachChildIndexed(InterfaceC1668n interfaceC1668n) {
        MutableVector<LayoutNode> mutableVector = get_children$ui_release();
        int size = mutableVector.getSize();
        if (size > 0) {
            LayoutNode[] content = mutableVector.getContent();
            int i8 = 0;
            do {
                interfaceC1668n.invoke(Integer.valueOf(i8), content[i8]);
                i8++;
            } while (i8 < size);
        }
    }
    ...
    public void forceRemeasure() {
        ...
        Constraints m4275getLastConstraintsDWUhwKw = this.layoutDelegate.m4275getLastConstraintsDWUhwKw();
        if (m4275getLastConstraintsDWUhwKw != null) {
            Owner owner = this.owner;
            if (owner != null) {
                owner.mo4404measureAndLayout0kLqBqw(this, m4275getLastConstraintsDWUhwKw.m5157unboximpl());
                return;
            }
            return;
        }
    ...
    public final SemanticsConfiguration getCollapsedSemantics$ui_release() {
        if (this.nodes.m4305hasH91voCI$ui_release(NodeKind.m4348constructorimpl(8)) && this._collapsedSemantics == null) {
            T t8 = new T();
            t8.f34162a = new SemanticsConfiguration();
    ...
    public final boolean getHasFixedInnerContentConstraints$ui_release() {
        long m4326getLastMeasurementConstraintsmsEJaDk$ui_release = getInnerCoordinator$ui_release().m4326getLastMeasurementConstraintsmsEJaDk$ui_release();
        if (Constraints.m5149getHasFixedWidthimpl(m4326getLastMeasurementConstraintsmsEJaDk$ui_release) && Constraints.m5148getHasFixedHeightimpl(m4326getLastMeasurementConstraintsmsEJaDk$ui_release)) {
            return true;
        }
        return false;
    }
    ...
    public final MutableVector<LayoutNode> get_children$ui_release() {
        ...
        MutableVector<LayoutNode> mutableVector = this._unfoldedChildren;
        AbstractC3255y.f(mutableVector);
        return mutableVector;
    }

    /* renamed from: hitTest-M_7yMNQ$ui_release */
    public final void m4257hitTestM_7yMNQ$ui_release(long j8, HitTestResult hitTestResult, boolean z8, boolean z9) {
        getOuterCoordinator$ui_release().m4329hitTestYqVAtuI(NodeCoordinator.Companion.getPointerInputSource(), getOuterCoordinator$ui_release().m4325fromParentPositionMKHz9U(j8), hitTestResult, z8, z9);
    }

    /* renamed from: hitTestSemantics-M_7yMNQ$ui_release */
    public final void m4258hitTestSemanticsM_7yMNQ$ui_release(long j8, HitTestResult hitTestResult, boolean z8, boolean z9) {
        getOuterCoordinator$ui_release().m4329hitTestYqVAtuI(NodeCoordinator.Companion.getSemanticsSource(), getOuterCoordinator$ui_release().m4325fromParentPositionMKHz9U(j8), hitTestResult, true, z9);
    }
                ...
                if ((head$ui_release.getKindSet$ui_release() & m4348constructorimpl) != 0) {
                    ...
                    while (delegatingNode != 0) {
                        if (delegatingNode instanceof LayoutModifierNode) {
                            OwnedLayer layer = DelegatableNodeKt.m4231requireCoordinator64DMado((LayoutModifierNode) delegatingNode, NodeKind.m4348constructorimpl(2)).getLayer();
                            if (layer != null) {
                                layer.invalidate();
                            }
                        } else if ((delegatingNode.getKindSet$ui_release() & m4348constructorimpl) != 0 && (delegatingNode instanceof DelegatingNode)) {
    ...
    public final boolean m4259lookaheadRemeasure_Sx5XlM$ui_release(Constraints constraints) {
        if (constraints != null && this.lookaheadRoot != null) {
            LayoutNodeLayoutDelegate.LookaheadPassDelegate lookaheadPassDelegate$ui_release = getLookaheadPassDelegate$ui_release();
            AbstractC3255y.f(lookaheadPassDelegate$ui_release);
            return lookaheadPassDelegate$ui_release.m4279remeasureBRTryo0(constraints.m5157unboximpl());
        }
        return false;
    }
    ...
    public void onLayoutComplete() {
        ...
        if (m4357getIncludeSelfInTraversalH91voCI || (tail = tail.getParent$ui_release()) != null) {
            for (Modifier.Node headNode = innerCoordinator$ui_release.headNode(m4357getIncludeSelfInTraversalH91voCI); headNode != null && (headNode.getAggregateChildKindSet$ui_release() & m4348constructorimpl) != 0; headNode = headNode.getChild$ui_release()) {
    ...
    public final boolean m4260remeasure_Sx5XlM$ui_release(Constraints constraints) {
        if (constraints != null) {
            if (this.intrinsicsUsageByParent == UsageByParent.NotUsed) {
                clearSubtreeIntrinsicsUsage$ui_release();
            }
            return getMeasurePassDelegate$ui_release().m4284remeasureBRTryo0(constraints.m5157unboximpl());
        }
        return false;
    }
    ...
    public void setCompositionLocalMap(CompositionLocalMap compositionLocalMap) {
        ...
        NodeChain nodeChain = this.nodes;
        int m4348constructorimpl = NodeKind.m4348constructorimpl(32768);
        if ((nodeChain.getAggregateChildKindSet() & m4348constructorimpl) != 0) {
            for (Modifier.Node head$ui_release = nodeChain.getHead$ui_release(); head$ui_release != null; head$ui_release = head$ui_release.getChild$ui_release()) {
                if ((head$ui_release.getKindSet$ui_release() & m4348constructorimpl) != 0) {
                    DelegatingNode delegatingNode = head$ui_release;
    ...
    public void setMeasurePolicy(MeasurePolicy measurePolicy) {
        if (!AbstractC3255y.d(this.measurePolicy, measurePolicy)) {
    ...
    public void setModifier(Modifier modifier) {
        ...
        if (!isDeactivated()) {
            ...
            this.layoutDelegate.updateParentData();
            if (this.nodes.m4305hasH91voCI$ui_release(NodeKind.m4348constructorimpl(512)) && this.lookaheadRoot == null) {
                setLookaheadRoot(this);
                return;
            }
            return;
    ...
    public void setViewConfiguration(ViewConfiguration viewConfiguration) {
        if (!AbstractC3255y.d(this.viewConfiguration, viewConfiguration)) {
    ...
    public /* synthetic */ LayoutNode(boolean z8, int i8, int i9, AbstractC3247p abstractC3247p) {
