...
public abstract class AlignmentLines {
    ...
    public /* synthetic */ AlignmentLines(AlignmentLinesOwner alignmentLinesOwner, AbstractC3247p abstractC3247p) {
    ...
    public final void addAlignmentLine(AlignmentLine alignmentLine, int i8, NodeCoordinator nodeCoordinator) {
        ...
        while (true) {
            Offset = mo4213calculatePositionInParentR5De75A(nodeCoordinator, Offset);
            nodeCoordinator = nodeCoordinator.getWrappedBy$ui_release();
            AbstractC3255y.f(nodeCoordinator);
            if (AbstractC3255y.d(nodeCoordinator, this.alignmentLinesOwner.getInnerCoordinator())) {
                break;
        ...
        if (alignmentLine instanceof HorizontalAlignmentLine) {
            d8 = AbstractC2055a.d(Offset.m2741getYimpl(Offset));
        } else {
            d8 = AbstractC2055a.d(Offset.m2740getXimpl(Offset));
        }
    ...
    protected abstract long mo4213calculatePositionInParentR5De75A(NodeCoordinator nodeCoordinator, long j8);
