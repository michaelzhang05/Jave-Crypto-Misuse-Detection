...
public final class DepthSortedSet {
    ...
    private final InterfaceC1355k mapOfOriginalDepth$delegate = l.a(o.f8297c, DepthSortedSet$mapOfOriginalDepth$2.INSTANCE);
    ...
    public DepthSortedSet(boolean z8) {
        ...
        Comparator<LayoutNode> comparator = new Comparator<LayoutNode>() { // from class: androidx.compose.ui.node.DepthSortedSet$DepthComparator$1
            ...
            public int compare(LayoutNode layoutNode, LayoutNode layoutNode2) {
                int k8 = AbstractC3255y.k(layoutNode.getDepth$ui_release(), layoutNode2.getDepth$ui_release());
                return k8 != 0 ? k8 : AbstractC3255y.k(layoutNode.hashCode(), layoutNode2.hashCode());
            }
        };
    ...
    public final boolean remove(LayoutNode layoutNode) {
        ...
        if (layoutNode.isAttached()) {
            ...
            if (this.extraAssertions) {
                ...
                if (!AbstractC3255y.d(remove2, num)) {
                    throw new IllegalStateException("invalid node depth".toString());
                }
            }
            return remove;
