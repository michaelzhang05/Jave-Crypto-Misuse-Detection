...
public final class LayoutNode$collapsedSemantics$1 extends AbstractC3256z implements Function0 {
    ...
    public final void m4268invoke() {
        ...
        int m4348constructorimpl = NodeKind.m4348constructorimpl(8);
        T t8 = this.$config;
        if ((nodes$ui_release.getAggregateChildKindSet() & m4348constructorimpl) != 0) {
                    ...
                    while (delegatingNode != 0) {
                        if (delegatingNode instanceof SemanticsModifierNode) {
                            ...
                            if (semanticsModifierNode.getShouldClearDescendantSemantics()) {
                                ...
                                t8.f34162a = semanticsConfiguration;
                                semanticsConfiguration.setClearingSemantics(true);
                            }
                            if (semanticsModifierNode.getShouldMergeDescendantSemantics()) {
                                ((SemanticsConfiguration) t8.f34162a).setMergingSemanticsOfDescendants(true);
                            }
                            semanticsModifierNode.applySemantics((SemanticsConfiguration) t8.f34162a);
