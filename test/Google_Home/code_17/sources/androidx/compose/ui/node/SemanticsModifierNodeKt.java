...
public final class SemanticsModifierNodeKt {
    ...
    public static final Rect touchBoundsInRoot(Modifier.Node node, boolean z8) {
        ...
        if (!z8) {
            return LayoutCoordinatesKt.boundsInRoot(DelegatableNodeKt.m4231requireCoordinator64DMado(node, NodeKind.m4348constructorimpl(8)));
        }
        return DelegatableNodeKt.m4231requireCoordinator64DMado(node, NodeKind.m4348constructorimpl(8)).touchBoundsInRoot();
    }
}
