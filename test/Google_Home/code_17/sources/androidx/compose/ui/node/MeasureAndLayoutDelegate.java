...
public final class MeasureAndLayoutDelegate {
    ...
    private final boolean m4296doLookaheadRemeasuresdFAvZA(LayoutNode layoutNode, Constraints constraints) {
        boolean m4255lookaheadRemeasure_Sx5XlM$ui_release$default;
        if (layoutNode.getLookaheadRoot$ui_release() == null) {
            return false;
        }
        if (constraints != null) {
            m4255lookaheadRemeasure_Sx5XlM$ui_release$default = layoutNode.m4259lookaheadRemeasure_Sx5XlM$ui_release(constraints);
        } else {
            m4255lookaheadRemeasure_Sx5XlM$ui_release$default = LayoutNode.m4255lookaheadRemeasure_Sx5XlM$ui_release$default(layoutNode, null, 1, null);
        }
        LayoutNode parent$ui_release = layoutNode.getParent$ui_release();
        if (m4255lookaheadRemeasure_Sx5XlM$ui_release$default && parent$ui_release != null) {
        ...
        return m4255lookaheadRemeasure_Sx5XlM$ui_release$default;
    }

    /* renamed from: doRemeasure-sdFAvZA */
    private final boolean m4297doRemeasuresdFAvZA(LayoutNode layoutNode, Constraints constraints) {
        boolean m4256remeasure_Sx5XlM$ui_release$default;
        if (constraints != null) {
            m4256remeasure_Sx5XlM$ui_release$default = layoutNode.m4260remeasure_Sx5XlM$ui_release(constraints);
        } else {
            m4256remeasure_Sx5XlM$ui_release$default = LayoutNode.m4256remeasure_Sx5XlM$ui_release$default(layoutNode, null, 1, null);
        }
        LayoutNode parent$ui_release = layoutNode.getParent$ui_release();
        if (m4256remeasure_Sx5XlM$ui_release$default && parent$ui_release != null) {
        ...
        return m4256remeasure_Sx5XlM$ui_release$default;
    }
    ...
    private final boolean remeasureAndRelayoutIfNeeded(LayoutNode layoutNode, boolean z8, boolean z9) {
        ...
        boolean z10;
        boolean m4297doRemeasuresdFAvZA;
        LayoutNode parent$ui_release;
        int i8 = 0;
        if (layoutNode.isDeactivated()) {
            return false;
        }
        if (!layoutNode.isPlaced() && !layoutNode.isPlacedByParent() && !getCanAffectParent(layoutNode) && !AbstractC3255y.d(layoutNode.isPlacedInLookahead(), Boolean.TRUE) && !getCanAffectParentInLookahead(layoutNode) && !layoutNode.getAlignmentLinesRequired$ui_release()) {
            return false;
        }
        if (!layoutNode.getLookaheadMeasurePending$ui_release() && !layoutNode.getMeasurePending$ui_release()) {
            m4297doRemeasuresdFAvZA = false;
            z10 = false;
        } else {
            ...
            if (layoutNode.getLookaheadMeasurePending$ui_release() && z8) {
                z10 = m4296doLookaheadRemeasuresdFAvZA(layoutNode, constraints);
            } else {
                z10 = false;
            }
            m4297doRemeasuresdFAvZA = m4297doRemeasuresdFAvZA(layoutNode, constraints);
        }
        if (z9) {
            if ((z10 || layoutNode.getLookaheadLayoutPending$ui_release()) && AbstractC3255y.d(layoutNode.isPlacedInLookahead(), Boolean.TRUE) && z8) {
        ...
        return m4297doRemeasuresdFAvZA;
    }
    ...
    private final void remeasureOnly(LayoutNode layoutNode, boolean z8) {
        ...
        if (z8) {
            m4296doLookaheadRemeasuresdFAvZA(layoutNode, constraints);
        } else {
            m4297doRemeasuresdFAvZA(layoutNode, constraints);
        }
    }
    ...
    */
    public final void m4298measureAndLayout0kLqBqw(androidx.compose.ui.node.LayoutNode r3, long r4) {
        /*
            r2 = this;
        ...
        L7:
            ...
            boolean r0 = kotlin.jvm.internal.AbstractC3255y.d(r3, r0)
            r1 = 1
            r0 = r0 ^ r1
            if (r0 == 0) goto La4
            androidx.compose.ui.node.LayoutNode r0 = r2.root
            ...
            androidx.compose.ui.unit.Constraints r1 = androidx.compose.ui.unit.Constraints.m5139boximpl(r4)     // Catch: java.lang.Throwable -> L4a
            boolean r1 = r2.m4296doLookaheadRemeasuresdFAvZA(r3, r1)     // Catch: java.lang.Throwable -> L4a
            androidx.compose.ui.unit.Constraints r4 = androidx.compose.ui.unit.Constraints.m5139boximpl(r4)     // Catch: java.lang.Throwable -> L4a
            r2.m4297doRemeasuresdFAvZA(r3, r4)     // Catch: java.lang.Throwable -> L4a
            if (r1 != 0) goto L4c
        ...
        L4c:
            ...
            boolean r4 = kotlin.jvm.internal.AbstractC3255y.d(r4, r5)     // Catch: java.lang.Throwable -> L4a
            if (r4 == 0) goto L5b
        ...
        La4:
            ...
            throw r3
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.node.MeasureAndLayoutDelegate.m4298measureAndLayout0kLqBqw(androidx.compose.ui.node.LayoutNode, long):void");
    }
    ...
    public final boolean requestLookaheadRelayout(LayoutNode layoutNode, boolean z8) {
        ...
        if (i8 != 1) {
            ...
            LayoutNode parent$ui_release = layoutNode.getParent$ui_release();
            if (AbstractC3255y.d(layoutNode.isPlacedInLookahead(), Boolean.TRUE) && ((parent$ui_release == null || !parent$ui_release.getLookaheadMeasurePending$ui_release()) && (parent$ui_release == null || !parent$ui_release.getLookaheadLayoutPending$ui_release()))) {
        ...
        if (layoutNode.getLookaheadRoot$ui_release() != null) {
            ...
            if (i8 != 2 && i8 != 3 && i8 != 4) {
                if (i8 == 5) {
                    ...
                    if ((!AbstractC3255y.d(layoutNode.isPlacedInLookahead(), Boolean.TRUE) && !getCanAffectParentInLookahead(layoutNode)) || ((parent$ui_release = layoutNode.getParent$ui_release()) != null && parent$ui_release.getLookaheadMeasurePending$ui_release())) {
    ...
    public final void m4299updateRootConstraintsBRTryo0(long j8) {
        ...
        if (!m5144equalsimpl0) {
            if (!this.duringMeasureLayout) {
                this.rootConstraints = Constraints.m5139boximpl(j8);
                if (this.root.getLookaheadRoot$ui_release() != null) {
