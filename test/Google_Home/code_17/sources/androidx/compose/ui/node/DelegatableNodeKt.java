...
public final class DelegatableNodeKt {
    ...
    public static final /* synthetic */ <T> List<T> m4227ancestors64DMado(DelegatableNode delegatableNode, int i8) {
    ...
    public static final LayoutModifierNode asLayoutModifierNode(Modifier.Node node) {
        if ((NodeKind.m4348constructorimpl(2) & node.getKindSet$ui_release()) != 0) {
            ...
            if (node instanceof DelegatingNode) {
                ...
                while (delegate$ui_release != 0) {
                    ...
                    if ((delegate$ui_release instanceof DelegatingNode) && (NodeKind.m4348constructorimpl(2) & delegate$ui_release.getKindSet$ui_release()) != 0) {
    ...
    public static final /* synthetic */ <T> void m4228dispatchForKind6rFNWt0(Modifier.Node node, int i8, Function1 function1) {
        while (node != null) {
            AbstractC3255y.n(3, ExifInterface.GPS_DIRECTION_TRUE);
    ...
    public static final boolean m4229has64DMado(DelegatableNode delegatableNode, int i8) {
    ...
    public static final /* synthetic */ <T> T m4230nearestAncestor64DMado(DelegatableNode delegatableNode, int i8) {
        NodeChain nodes$ui_release;
        if (delegatableNode.getNode().isAttached()) {
    ...
    public static final NodeCoordinator m4231requireCoordinator64DMado(DelegatableNode delegatableNode, int i8) {
        ...
        if (coordinator$ui_release.getTail() == delegatableNode && NodeKindKt.m4357getIncludeSelfInTraversalH91voCI(i8)) {
    ...
    public static final /* synthetic */ <T> void m4232visitAncestorsYYKmho(DelegatableNode delegatableNode, int i8, boolean z8, Function1 function1) {
        Modifier.Node parent$ui_release;
        NodeChain nodes$ui_release;
        if (delegatableNode.getNode().isAttached()) {
            if (z8) {
    ...
    public static /* synthetic */ void m4233visitAncestorsYYKmho$default(DelegatableNode delegatableNode, int i8, boolean z8, Function1 function1, int i9, Object obj) {
        Modifier.Node parent$ui_release;
        NodeChain nodes$ui_release;
        if ((i9 & 2) != 0) {
            z8 = false;
    ...
    public static final /* synthetic */ <T> void m4234visitChildren6rFNWt0(DelegatableNode delegatableNode, int i8, Function1 function1) {
        if (delegatableNode.getNode().isAttached()) {
            MutableVector mutableVector = new MutableVector(new Modifier.Node[16], 0);
            Modifier.Node child$ui_release = delegatableNode.getNode().getChild$ui_release();
            if (child$ui_release == null) {
    ...
    public static final /* synthetic */ <T> void m4235visitLocalAncestors6rFNWt0(DelegatableNode delegatableNode, int i8, Function1 function1) {
        if (delegatableNode.getNode().isAttached()) {
            for (Modifier.Node parent$ui_release = delegatableNode.getNode().getParent$ui_release(); parent$ui_release != null; parent$ui_release = parent$ui_release.getParent$ui_release()) {
                if ((parent$ui_release.getKindSet$ui_release() & i8) != 0) {
                    for (Modifier.Node node = parent$ui_release; node != null; node = pop(null)) {
    ...
    public static final /* synthetic */ <T> void m4236visitLocalDescendants6rFNWt0(DelegatableNode delegatableNode, int i8, Function1 function1) {
        if (delegatableNode.getNode().isAttached()) {
            Modifier.Node node = delegatableNode.getNode();
            if ((node.getAggregateChildKindSet$ui_release() & i8) != 0) {
                for (Modifier.Node child$ui_release = node.getChild$ui_release(); child$ui_release != null; child$ui_release = child$ui_release.getChild$ui_release()) {
    ...
    public static final /* synthetic */ <T> void m4237visitSelfAndAncestors5BbP62I(DelegatableNode delegatableNode, int i8, int i9, Function1 function1) {
        NodeChain nodes$ui_release;
        Modifier.Node node = delegatableNode.getNode();
        int i10 = i8 | i9;
        if (delegatableNode.getNode().isAttached()) {
    ...
    public static final /* synthetic */ <T> void m4238visitSelfAndChildren6rFNWt0(DelegatableNode delegatableNode, int i8, Function1 function1) {
    ...
    public static final /* synthetic */ <T> void m4239visitSubtree6rFNWt0(DelegatableNode delegatableNode, int i8, Function1 function1) {
        if (delegatableNode.getNode().isAttached()) {
            Modifier.Node child$ui_release = delegatableNode.getNode().getChild$ui_release();
            LayoutNode requireLayoutNode = requireLayoutNode(delegatableNode);
            NestedVectorStack nestedVectorStack = new NestedVectorStack();
    ...
    public static final /* synthetic */ <T> void m4240visitSubtreeIf6rFNWt0(DelegatableNode delegatableNode, int i8, Function1 function1) {
        if (delegatableNode.getNode().isAttached()) {
            MutableVector mutableVector = new MutableVector(new Modifier.Node[16], 0);
            Modifier.Node child$ui_release = delegatableNode.getNode().getChild$ui_release();
            if (child$ui_release == null) {
