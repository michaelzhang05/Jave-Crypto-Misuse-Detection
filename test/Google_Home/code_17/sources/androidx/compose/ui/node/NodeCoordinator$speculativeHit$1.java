...
public final class NodeCoordinator$speculativeHit$1 extends AbstractC3256z implements Function0 {
    ...
    public final void m4343invoke() {
        ...
        m4346nextUntilhw7D004 = NodeCoordinatorKt.m4346nextUntilhw7D004(this.$this_speculativeHit, this.$hitTestSource.mo4338entityTypeOLwlOKw(), NodeKind.m4348constructorimpl(2));
        nodeCoordinator.m4320speculativeHitJHbHoSQ(m4346nextUntilhw7D004, this.$hitTestSource, this.$pointerPosition, this.$hitTestResult, this.$isTouchEvent, this.$isInLayer, this.$distanceFromEdge);
    }
}
