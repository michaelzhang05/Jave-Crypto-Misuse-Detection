...
public final class AlignmentLines$recalculate$1 extends AbstractC3256z implements Function1 {
    ...
    public final void invoke(AlignmentLinesOwner alignmentLinesOwner) {
        ...
        if (alignmentLinesOwner.isPlaced()) {
            ...
            while (!AbstractC3255y.d(wrappedBy$ui_release, this.this$0.getAlignmentLinesOwner().getInnerCoordinator())) {
