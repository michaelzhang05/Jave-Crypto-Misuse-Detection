...
final class PointerInteropFilter_androidKt$motionEventSpy$1 extends l implements InterfaceC1668n {
    ...
    public static final class AnonymousClass1 extends k implements InterfaceC1668n {
        ...
        AnonymousClass1(Function1 function1, S5.d dVar) {
            super(2, dVar);
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public PointerInteropFilter_androidKt$motionEventSpy$1(Function1 function1, S5.d dVar) {
        super(2, dVar);
        this.$watcher = function1;
    }
    ...
    public final Object invoke(PointerInputScope pointerInputScope, S5.d dVar) {
        return ((PointerInteropFilter_androidKt$motionEventSpy$1) create(pointerInputScope, dVar)).invokeSuspend(I.f8278a);
    }
