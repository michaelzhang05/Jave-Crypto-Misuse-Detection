...
public final class PointerHoverIconModifierNode extends Modifier.Node implements TraversableNode, PointerInputModifierNode, CompositionLocalConsumerModifierNode {
    ...
    public /* synthetic */ PointerHoverIconModifierNode(PointerIcon pointerIcon, boolean z8, int i8, AbstractC3247p abstractC3247p) {
    ...
    private final void displayIconFromAncestorNodeWithCursorInBoundsOrDefaultIcon() {
        ...
        PointerHoverIconModifierNode pointerHoverIconModifierNode = (PointerHoverIconModifierNode) t8.f34162a;
    ...
    private final PointerHoverIconModifierNode findDescendantNodeWithCursorInBounds() {
        ...
        return (PointerHoverIconModifierNode) t8.f34162a;
    }
    ...
    public void mo270onPointerEventH0pRuoY(PointerEvent pointerEvent, PointerEventPass pointerEventPass, long j8) {
        if (pointerEventPass == PointerEventPass.Main) {
            ...
            } else if (PointerEventType.m3970equalsimpl0(pointerEvent.m3963getType7fucELk(), companion.m3975getExit7fucELk())) {
                this.cursorInBoundsOfNode = false;
                displayIconFromAncestorNodeWithCursorInBoundsOrDefaultIcon();
            }
        }
    ...
    public final void setIcon(PointerIcon pointerIcon) {
        if (!AbstractC3255y.d(this.icon, pointerIcon)) {
