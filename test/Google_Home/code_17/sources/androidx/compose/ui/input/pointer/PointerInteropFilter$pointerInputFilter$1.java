...
public final class PointerInteropFilter$pointerInputFilter$1 extends PointerInputFilter {
    ...
    private final void dispatchToView(PointerEvent pointerEvent) {
            ...
            if (changes.get(i8).isConsumed()) {
                if (this.state == PointerInteropFilter.DispatchToViewState.Dispatching) {
                    ...
                    if (layoutCoordinates$ui_release != null) {
                        PointerInteropUtils_androidKt.m4069toCancelMotionEventScoped4ec7I(pointerEvent, layoutCoordinates$ui_release.mo4145localToRootMKHz9U(Offset.Companion.m2756getZeroF1C5BW0()), new PointerInteropFilter$pointerInputFilter$1$dispatchToView$2(this.this$0));
                    } else {
        ...
        if (layoutCoordinates$ui_release2 != null) {
            PointerInteropUtils_androidKt.m4070toMotionEventScoped4ec7I(pointerEvent, layoutCoordinates$ui_release2.mo4145localToRootMKHz9U(Offset.Companion.m2756getZeroF1C5BW0()), new PointerInteropFilter$pointerInputFilter$1$dispatchToView$3(this, this.this$0));
            if (this.state == PointerInteropFilter.DispatchToViewState.Dispatching) {
    ...
    */
    public void mo4045onPointerEventH0pRuoY(androidx.compose.ui.input.pointer.PointerEvent r5, androidx.compose.ui.input.pointer.PointerEventPass r6, long r7) {
        /*
            r4 = this;
        ...
        L62:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.input.pointer.PointerInteropFilter$pointerInputFilter$1.mo4045onPointerEventH0pRuoY(androidx.compose.ui.input.pointer.PointerEvent, androidx.compose.ui.input.pointer.PointerEventPass, long):void");
    }
}
