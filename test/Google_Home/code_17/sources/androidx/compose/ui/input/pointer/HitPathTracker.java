...
public final class HitPathTracker {
    ...
    public final void m3949addHitPathKNwqfcY(long j8, List<? extends Modifier.Node> list) {
        Node node;
        ...
        for (int i8 = 0; i8 < size; i8++) {
            ...
            if (z8) {
                ...
                if (size2 > 0) {
                    ...
                    do {
                        node = content[i9];
                        if (AbstractC3255y.d(node.getModifierNode(), node2)) {
                            break;
                        } else {
                            i9++;
                        }
                ...
                if (node3 != null) {
                    node3.markIsIn();
                    node3.getPointerIds().m4103add0FcD4WY(j8);
                    nodeParent = node3;
                } else {
                    z8 = false;
                }
            ...
            node4.getPointerIds().m4103add0FcD4WY(j8);
