...
public final class PointerInputEventProcessor {
    ...
    public static /* synthetic */ int m4042processBIzXfog$default(PointerInputEventProcessor pointerInputEventProcessor, PointerInputEvent pointerInputEvent, PositionCalculator positionCalculator, boolean z8, int i8, Object obj) {
        if ((i8 & 4) != 0) {
            z8 = true;
        }
        return pointerInputEventProcessor.m4043processBIzXfog(pointerInputEvent, positionCalculator, z8);
    }
    ...
    public final int m4043processBIzXfog(PointerInputEvent pointerInputEvent, PositionCalculator positionCalculator, boolean z8) {
        boolean z9;
        ...
        try {
            ...
            for (int i9 = 0; i9 < size2; i9++) {
                ...
                if (z9 || PointerEventKt.changedToDownIgnoreConsumed(valueAt2)) {
                    LayoutNode.m4253hitTestM_7yMNQ$ui_release$default(this.root, valueAt2.m4021getPositionF1C5BW0(), this.hitResult, PointerType.m4082equalsimpl0(valueAt2.m4024getTypeT8wyACA(), PointerType.Companion.m4089getTouchT8wyACA()), false, 8, null);
                    if (!this.hitResult.isEmpty()) {
                        this.hitPathTracker.m3949addHitPathKNwqfcY(valueAt2.m4019getIdJ3iCeTQ(), this.hitResult);
