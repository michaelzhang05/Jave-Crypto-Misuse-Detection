...
public final class PointerIdArray {
    ...
    public final boolean m4103add0FcD4WY(long j8) {
        return add(j8);
    }
    ...
    public final boolean m4104contains0FcD4WY(long j8) {
        return contains(j8);
    }

    /* renamed from: get-_I2yYro, reason: not valid java name */
    public final long m4105get_I2yYro(int i8) {
        return PointerId.m4001constructorimpl(this.internalArray[i8]);
    }
    ...
    public final boolean m4106remove0FcD4WY(long j8) {
        return remove(j8);
    }
    ...
    public final void m4107setDmW0f2w(int i8, long j8) {
        set(i8, j8);
    }
}
