...
public final class VelocityTrackerKt {
    ...
    private static final void addPointerInputChangeLegacy(VelocityTracker velocityTracker, PointerInputChange pointerInputChange) {
        if (PointerEventKt.changedToDownIgnoreConsumed(pointerInputChange)) {
            velocityTracker.m4112setCurrentPointerPositionAccumulatork4lQ0M$ui_release(pointerInputChange.m4021getPositionF1C5BW0());
            velocityTracker.resetTracking();
        }
        long m4022getPreviousPositionF1C5BW0 = pointerInputChange.m4022getPreviousPositionF1C5BW0();
        List<HistoricalChange> historical = pointerInputChange.getHistorical();
        int size = historical.size();
        int i8 = 0;
        while (i8 < size) {
            HistoricalChange historicalChange = historical.get(i8);
            long m2744minusMKHz9U = Offset.m2744minusMKHz9U(historicalChange.m3948getPositionF1C5BW0(), m4022getPreviousPositionF1C5BW0);
            long m3948getPositionF1C5BW0 = historicalChange.m3948getPositionF1C5BW0();
            velocityTracker.m4112setCurrentPointerPositionAccumulatork4lQ0M$ui_release(Offset.m2745plusMKHz9U(velocityTracker.m4111getCurrentPointerPositionAccumulatorF1C5BW0$ui_release(), m2744minusMKHz9U));
            velocityTracker.m4108addPositionUv8p0NA(historicalChange.getUptimeMillis(), velocityTracker.m4111getCurrentPointerPositionAccumulatorF1C5BW0$ui_release());
            i8++;
            m4022getPreviousPositionF1C5BW0 = m3948getPositionF1C5BW0;
        }
        velocityTracker.m4112setCurrentPointerPositionAccumulatork4lQ0M$ui_release(Offset.m2745plusMKHz9U(velocityTracker.m4111getCurrentPointerPositionAccumulatorF1C5BW0$ui_release(), Offset.m2744minusMKHz9U(pointerInputChange.m4021getPositionF1C5BW0(), m4022getPreviousPositionF1C5BW0)));
        velocityTracker.m4108addPositionUv8p0NA(pointerInputChange.getUptimeMillis(), velocityTracker.m4111getCurrentPointerPositionAccumulatorF1C5BW0$ui_release());
    }
    ...
    private static final void addPointerInputChangeWithFix(VelocityTracker velocityTracker, PointerInputChange pointerInputChange) {
        ...
        if (!PointerEventKt.changedToUpIgnoreConsumed(pointerInputChange)) {
            ...
            for (int i8 = 0; i8 < size; i8++) {
                HistoricalChange historicalChange = historical.get(i8);
                velocityTracker.m4108addPositionUv8p0NA(historicalChange.getUptimeMillis(), historicalChange.m3947getOriginalEventPositionF1C5BW0$ui_release());
            }
            velocityTracker.m4108addPositionUv8p0NA(pointerInputChange.getUptimeMillis(), pointerInputChange.m4020getOriginalEventPositionF1C5BW0$ui_release());
        }
