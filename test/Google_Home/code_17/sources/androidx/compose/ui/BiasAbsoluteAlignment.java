...
public final class BiasAbsoluteAlignment implements Alignment {
    ...
    public static final class Horizontal implements Alignment.Horizontal {
        ...
        public int align(int i8, int i9, LayoutDirection layoutDirection) {
            return AbstractC2055a.d(((i9 - i8) / 2.0f) * (1 + this.bias));
        }
    ...
    public long mo2613alignKFBX0sM(long j8, long j9, LayoutDirection layoutDirection) {
        long IntSize = IntSizeKt.IntSize(IntSize.m5349getWidthimpl(j9) - IntSize.m5349getWidthimpl(j8), IntSize.m5348getHeightimpl(j9) - IntSize.m5348getHeightimpl(j8));
        float f8 = 1;
        return IntOffsetKt.IntOffset(AbstractC2055a.d((IntSize.m5349getWidthimpl(IntSize) / 2.0f) * (this.horizontalBias + f8)), AbstractC2055a.d((IntSize.m5348getHeightimpl(IntSize) / 2.0f) * (f8 + this.verticalBias)));
    }
