...
public interface SubcomposeSlotReusePolicy {
    ...
    /* loaded from: classes.dex */
    public static final class SlotIdsSet implements Collection<Object>, InterfaceC1985a, j$.util.Collection {
        ...
        public final boolean removeAll(Function1 function1) {
            return AbstractC1378t.I(this.set, function1);
        }

        public final boolean retainAll(Function1 function1) {
            return AbstractC1378t.R(this.set, function1);
        }
        ...
        public /* synthetic */ SlotIdsSet(Set set, int i8, AbstractC3247p abstractC3247p) {
