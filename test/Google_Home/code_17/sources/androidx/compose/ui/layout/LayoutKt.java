...
public final class LayoutKt {
    @Composable
    @UiComposable
    public static final void Layout(InterfaceC1668n interfaceC1668n, Modifier modifier, MeasurePolicy measurePolicy, Composer composer, int i8, int i9) {
        ...
        InterfaceC1669o modifierMaterializerOf = modifierMaterializerOf(modifier);
        int i10 = ((i8 << 9) & 7168) | 6;
        ...
        interfaceC1668n.invoke(composer, Integer.valueOf((i10 >> 9) & 14));
    ...
    @Composable
    @UiComposable
    public static final void MultiMeasureLayout(Modifier modifier, InterfaceC1668n interfaceC1668n, MeasurePolicy measurePolicy, Composer composer, int i8, int i9) {
        int i10;
        int i11;
        int i12;
        int i13;
        ...
        if ((i10 & 731) == 146 && startRestartGroup.getSkipping()) {
            ...
            Updater.m2508setimpl(m2501constructorimpl, measurePolicy, companion.getSetMeasurePolicy());
            Updater.m2508setimpl(m2501constructorimpl, currentCompositionLocalMap, companion.getSetResolvedCompositionLocals());
            Updater.m2505initimpl(m2501constructorimpl, LayoutKt$MultiMeasureLayout$1$1.INSTANCE);
            Updater.m2508setimpl(m2501constructorimpl, materializeModifier, companion.getSetModifier());
            InterfaceC1668n setCompositeKeyHash = companion.getSetCompositeKeyHash();
            if (m2501constructorimpl.getInserting() || !AbstractC3255y.d(m2501constructorimpl.rememberedValue(), Integer.valueOf(currentCompositeKeyHash))) {
                m2501constructorimpl.updateRememberedValue(Integer.valueOf(currentCompositeKeyHash));
                m2501constructorimpl.apply(Integer.valueOf(currentCompositeKeyHash), setCompositeKeyHash);
            }
            interfaceC1668n.invoke(startRestartGroup, Integer.valueOf((i15 >> 6) & 14));
        ...
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new LayoutKt$MultiMeasureLayout$2(modifier2, interfaceC1668n, measurePolicy, i8, i9));
        }
    }

    public static final InterfaceC1668n combineAsVirtualLayouts(List<? extends InterfaceC1668n> list) {
        return ComposableLambdaKt.composableLambdaInstance(-1953651383, true, new LayoutKt$combineAsVirtualLayouts$1(list));
    }

    public static final InterfaceC1669o materializerOf(Modifier modifier) {
    ...
    public static final InterfaceC1669o modifierMaterializerOf(Modifier modifier) {
    ...
    @Composable
    @UiComposable
    public static final void Layout(List<? extends InterfaceC1668n> list, Modifier modifier, MultiContentMeasurePolicy multiContentMeasurePolicy, Composer composer, int i8, int i9) {
        composer.startReplaceableGroup(1399185516);
        if ((i9 & 2) != 0) {
            modifier = Modifier.Companion;
        }
        InterfaceC1668n combineAsVirtualLayouts = combineAsVirtualLayouts(list);
