...
public final class SubcomposeLayoutKt {
    ...
    @Composable
    public static final void SubcomposeLayout(Modifier modifier, InterfaceC1668n interfaceC1668n, Composer composer, int i8, int i9) {
        int i10;
        ...
        if ((i10 & 91) == 18 && startRestartGroup.getSkipping()) {
            ...
            int i12 = i10 << 3;
            SubcomposeLayout(subcomposeLayoutState, modifier, interfaceC1668n, startRestartGroup, (i12 & 112) | 8 | (i12 & 896), 0);
            if (ComposerKt.isTraceInProgress()) {
        ...
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new SubcomposeLayoutKt$SubcomposeLayout$2(modifier, interfaceC1668n, i8, i9));
        }
    }
    ...
    @Composable
    @UiComposable
    public static final void SubcomposeLayout(SubcomposeLayoutState subcomposeLayoutState, Modifier modifier, InterfaceC1668n interfaceC1668n, Composer composer, int i8, int i9) {
        ...
        Updater.m2508setimpl(m2501constructorimpl, subcomposeLayoutState, subcomposeLayoutState.getSetRoot$ui_release());
        Updater.m2508setimpl(m2501constructorimpl, rememberCompositionContext, subcomposeLayoutState.getSetCompositionContext$ui_release());
        Updater.m2508setimpl(m2501constructorimpl, interfaceC1668n, subcomposeLayoutState.getSetMeasurePolicy$ui_release());
        ...
        ScopeUpdateScope endRestartGroup = startRestartGroup.endRestartGroup();
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new SubcomposeLayoutKt$SubcomposeLayout$5(subcomposeLayoutState, modifier2, interfaceC1668n, i8, i9));
        }
    }
}
