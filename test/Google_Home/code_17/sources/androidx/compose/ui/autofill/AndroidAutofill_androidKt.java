        ...
        for (Map.Entry<Integer, AutofillNode> entry : androidAutofill.getAutofillTree().getChildren().entrySet()) {
            ...
            if (newChild != null) {
                ...
                if (boundingBox == null) {
                    ...
                    int d8 = AbstractC2055a.d(boundingBox.getLeft());
                    int d9 = AbstractC2055a.d(boundingBox.getTop());
                    int d10 = AbstractC2055a.d(boundingBox.getRight());
                    int d11 = AbstractC2055a.d(boundingBox.getBottom()) - d9;
