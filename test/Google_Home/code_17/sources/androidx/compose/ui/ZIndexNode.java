...
public final class ZIndexNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo368measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j8) {
        ...
        return MeasureScope.CC.q(measureScope, mo4136measureBRTryo0.getWidth(), mo4136measureBRTryo0.getHeight(), null, new ZIndexNode$measure$1(mo4136measureBRTryo0, this), 4, null);
    }
