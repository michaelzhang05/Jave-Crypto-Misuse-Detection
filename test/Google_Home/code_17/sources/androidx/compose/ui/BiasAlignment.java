...
public final class BiasAlignment implements Alignment {
    ...
    public static final class Horizontal implements Alignment.Horizontal {
        ...
        public int align(int i8, int i9, LayoutDirection layoutDirection) {
            ...
            return AbstractC2055a.d(f9 * (1 + f8));
        }
    ...
    public long mo2613alignKFBX0sM(long j8, long j9, LayoutDirection layoutDirection) {
        float f8;
        float m5349getWidthimpl = (IntSize.m5349getWidthimpl(j9) - IntSize.m5349getWidthimpl(j8)) / 2.0f;
        float m5348getHeightimpl = (IntSize.m5348getHeightimpl(j9) - IntSize.m5348getHeightimpl(j8)) / 2.0f;
        if (layoutDirection == LayoutDirection.Ltr) {
        ...
        float f9 = 1;
        return IntOffsetKt.IntOffset(AbstractC2055a.d(m5349getWidthimpl * (f8 + f9)), AbstractC2055a.d(m5348getHeightimpl * (f9 + this.verticalBias)));
    }
