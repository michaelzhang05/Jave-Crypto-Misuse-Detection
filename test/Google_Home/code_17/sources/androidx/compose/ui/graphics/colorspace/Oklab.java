...
public final class Oklab extends ColorSpace {
    ...
    private static final float[] f14589M1;

    /* renamed from: M2, reason: collision with root package name */
    private static final float[] f14590M2;
    ...
    public float[] fromXyz(float[] fArr) {
        ColorSpaceKt.mul3x3Float3(f14589M1, fArr);
        ...
        ColorSpaceKt.mul3x3Float3(f14590M2, fArr);
        return fArr;
    }
    ...
    public long toXy$ui_graphics_release(float f8, float f9, float f10) {
        float j8 = g6.m.j(f8, 0.0f, 1.0f);
        float j9 = g6.m.j(f9, -0.5f, 0.5f);
        float j10 = g6.m.j(f10, -0.5f, 0.5f);
    ...
    public float[] toXyz(float[] fArr) {
        fArr[0] = g6.m.j(fArr[0], 0.0f, 1.0f);
        fArr[1] = g6.m.j(fArr[1], -0.5f, 0.5f);
        fArr[2] = g6.m.j(fArr[2], -0.5f, 0.5f);
