...
public final class GraphicsLayerElement extends ModifierNodeElement<SimpleGraphicsLayerModifier> {
    ...
    public /* synthetic */ GraphicsLayerElement(float f8, float f9, float f10, float f11, float f12, float f13, float f14, float f15, float f16, float f17, long j8, Shape shape, boolean z8, RenderEffect renderEffect, long j9, long j10, int i8, AbstractC3247p abstractC3247p) {
    ...
    public final long m3124component11SzJe1aQ() {
    ...
    public final long m3125component150d7_KjU() {
        return this.ambientShadowColor;
    }

    /* renamed from: component16-0d7_KjU, reason: not valid java name */
    public final long m3126component160d7_KjU() {
        return this.spotShadowColor;
    }

    /* renamed from: component17--NrFUSI, reason: not valid java name */
    public final int m3127component17NrFUSI() {
    ...
    public final GraphicsLayerElement m3128copyJVvOYNQ(float f8, float f9, float f10, float f11, float f12, float f13, float f14, float f15, float f16, float f17, long j8, Shape shape, boolean z8, RenderEffect renderEffect, long j9, long j10, int i8) {
    ...
    public final long m3129getAmbientShadowColor0d7_KjU() {
        return this.ambientShadowColor;
    }
    ...
    public final int m3130getCompositingStrategyNrFUSI() {
        return this.compositingStrategy;
    }
    ...
    public final long m3131getSpotShadowColor0d7_KjU() {
        return this.spotShadowColor;
    }

    /* renamed from: getTransformOrigin-SzJe1aQ, reason: not valid java name */
    public final long m3132getTransformOriginSzJe1aQ() {
        return this.transformOrigin;
    }
    ...
    public int hashCode() {
        int hashCode;
        int floatToIntBits = ((((((((((((((((((((((((Float.floatToIntBits(this.scaleX) * 31) + Float.floatToIntBits(this.scaleY)) * 31) + Float.floatToIntBits(this.alpha)) * 31) + Float.floatToIntBits(this.translationX)) * 31) + Float.floatToIntBits(this.translationY)) * 31) + Float.floatToIntBits(this.shadowElevation)) * 31) + Float.floatToIntBits(this.rotationX)) * 31) + Float.floatToIntBits(this.rotationY)) * 31) + Float.floatToIntBits(this.rotationZ)) * 31) + Float.floatToIntBits(this.cameraDistance)) * 31) + TransformOrigin.m3341hashCodeimpl(this.transformOrigin)) * 31) + this.shape.hashCode()) * 31) + androidx.compose.foundation.a.a(this.clip)) * 31;
        ...
        return ((((((floatToIntBits + hashCode) * 31) + Color.m2983hashCodeimpl(this.ambientShadowColor)) * 31) + Color.m2983hashCodeimpl(this.spotShadowColor)) * 31) + CompositingStrategy.m3061hashCodeimpl(this.compositingStrategy);
    }
    ...
    public void inspectableProperties(InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set("transformOrigin", TransformOrigin.m3331boximpl(this.transformOrigin));
        ...
        inspectorInfo.getProperties().set("ambientShadowColor", Color.m2966boximpl(this.ambientShadowColor));
        inspectorInfo.getProperties().set("spotShadowColor", Color.m2966boximpl(this.spotShadowColor));
        inspectorInfo.getProperties().set("compositingStrategy", CompositingStrategy.m3057boximpl(this.compositingStrategy));
    }

    public String toString() {
        return "GraphicsLayerElement(scaleX=" + this.scaleX + ", scaleY=" + this.scaleY + ", alpha=" + this.alpha + ", translationX=" + this.translationX + ", translationY=" + this.translationY + ", shadowElevation=" + this.shadowElevation + ", rotationX=" + this.rotationX + ", rotationY=" + this.rotationY + ", rotationZ=" + this.rotationZ + ", cameraDistance=" + this.cameraDistance + ", transformOrigin=" + ((Object) TransformOrigin.m3342toStringimpl(this.transformOrigin)) + ", shape=" + this.shape + ", clip=" + this.clip + ", renderEffect=" + this.renderEffect + ", ambientShadowColor=" + ((Object) Color.m2984toStringimpl(this.ambientShadowColor)) + ", spotShadowColor=" + ((Object) Color.m2984toStringimpl(this.spotShadowColor)) + ", compositingStrategy=" + ((Object) CompositingStrategy.m3062toStringimpl(this.compositingStrategy)) + ')';
    }
    ...
    public void update(SimpleGraphicsLayerModifier simpleGraphicsLayerModifier) {
        ...
        simpleGraphicsLayerModifier.m3287setTransformOrigin__ExYCQ(this.transformOrigin);
        ...
        simpleGraphicsLayerModifier.m3284setAmbientShadowColor8_81llA(this.ambientShadowColor);
        simpleGraphicsLayerModifier.m3286setSpotShadowColor8_81llA(this.spotShadowColor);
        simpleGraphicsLayerModifier.m3285setCompositingStrategyaDBOjCE(this.compositingStrategy);
