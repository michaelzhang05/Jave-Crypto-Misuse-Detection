...
public final class ImageVector {
    ...
    public static final class Builder {
        ...
        public static final class GroupParams {
            ...
            public /* synthetic */ GroupParams(String str, float f8, float f9, float f10, float f11, float f12, float f13, float f14, List list, List list2, int i8, AbstractC3247p abstractC3247p) {
        ...
        public /* synthetic */ Builder(String str, float f8, float f9, float f10, float f11, long j8, int i8, AbstractC3247p abstractC3247p) {
        ...
        public static /* synthetic */ Builder m3527addPathoIyEayM$default(Builder builder, List list, int i8, String str, Brush brush, float f8, Brush brush2, float f9, float f10, int i9, int i10, float f11, float f12, float f13, float f14, int i11, Object obj) {
            int i12;
            String str2;
            Brush brush3;
            float f15;
            ...
            return builder.m3528addPathoIyEayM(list, i12, str2, brush3, f15, brush4, f16, f17, i13, i14, f18, f19, f20, f21);
        }
        ...
        public final Builder m3528addPathoIyEayM(List<? extends PathNode> list, int i8, String str, Brush brush, float f8, Brush brush2, float f9, float f10, int i9, int i10, float f11, float f12, float f13, float f14) {
            ensureNotConsumed();
        ...
        public /* synthetic */ Builder(String str, float f8, float f9, float f10, float f11, long j8, int i8, boolean z8, AbstractC3247p abstractC3247p) {
        ...
        public /* synthetic */ Builder(String str, float f8, float f9, float f10, float f11, long j8, int i8, boolean z8, int i9, AbstractC3247p abstractC3247p) {
            this((i9 & 1) != 0 ? "" : str, f8, f9, f10, f11, (i9 & 32) != 0 ? Color.Companion.m3012getUnspecified0d7_KjU() : j8, (i9 & 64) != 0 ? BlendMode.Companion.m2922getSrcIn0nO6VwU() : i8, (i9 & 128) != 0 ? false : z8, (AbstractC3247p) null);
        }

        public /* synthetic */ Builder(String str, float f8, float f9, float f10, float f11, long j8, int i8, int i9, AbstractC3247p abstractC3247p) {
            this((i9 & 1) != 0 ? "" : str, f8, f9, f10, f11, (i9 & 32) != 0 ? Color.Companion.m3012getUnspecified0d7_KjU() : j8, (i9 & 64) != 0 ? BlendMode.Companion.m2922getSrcIn0nO6VwU() : i8, (AbstractC3247p) null);
        }

        private Builder(String str, float f8, float f9, float f10, float f11, long j8, int i8) {
            this(str, f8, f9, f10, f11, j8, i8, false, (AbstractC3247p) null);
        }
    }
    ...
    public /* synthetic */ ImageVector(String str, float f8, float f9, float f10, float f11, VectorGroup vectorGroup, long j8, int i8, boolean z8, int i9, AbstractC3247p abstractC3247p) {
    ...
    public boolean equals(Object obj) {
        ...
        if (AbstractC3255y.d(this.name, imageVector.name) && Dp.m5188equalsimpl0(this.defaultWidth, imageVector.defaultWidth) && Dp.m5188equalsimpl0(this.defaultHeight, imageVector.defaultHeight) && this.viewportWidth == imageVector.viewportWidth && this.viewportHeight == imageVector.viewportHeight && AbstractC3255y.d(this.root, imageVector.root) && Color.m2977equalsimpl0(this.tintColor, imageVector.tintColor) && BlendMode.m2893equalsimpl0(this.tintBlendMode, imageVector.tintBlendMode) && this.autoMirror == imageVector.autoMirror) {
            return true;
        }
        return false;
    }
    ...
    public final float m3523getDefaultHeightD9Ej5fM() {
        return this.defaultHeight;
    }

    /* renamed from: getDefaultWidth-D9Ej5fM, reason: not valid java name */
    public final float m3524getDefaultWidthD9Ej5fM() {
    ...
    public final int m3525getTintBlendMode0nO6VwU() {
        return this.tintBlendMode;
    }

    /* renamed from: getTintColor-0d7_KjU, reason: not valid java name */
    public final long m3526getTintColor0d7_KjU() {
    ...
    public int hashCode() {
        return (((((((((((((((this.name.hashCode() * 31) + Dp.m5189hashCodeimpl(this.defaultWidth)) * 31) + Dp.m5189hashCodeimpl(this.defaultHeight)) * 31) + Float.floatToIntBits(this.viewportWidth)) * 31) + Float.floatToIntBits(this.viewportHeight)) * 31) + this.root.hashCode()) * 31) + Color.m2983hashCodeimpl(this.tintColor)) * 31) + BlendMode.m2894hashCodeimpl(this.tintBlendMode)) * 31) + androidx.compose.foundation.a.a(this.autoMirror);
    }
    ...
    public /* synthetic */ ImageVector(String str, float f8, float f9, float f10, float f11, VectorGroup vectorGroup, long j8, int i8, boolean z8, int i9, int i10, AbstractC3247p abstractC3247p) {
