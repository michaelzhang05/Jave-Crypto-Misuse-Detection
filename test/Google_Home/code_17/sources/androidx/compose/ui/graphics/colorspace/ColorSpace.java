...
public abstract class ColorSpace {
    ...
    public /* synthetic */ ColorSpace(String str, long j8, int i8, AbstractC3247p abstractC3247p) {
        this(str, j8, i8);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (this.id != colorSpace.id || !AbstractC3255y.d(this.name, colorSpace.name)) {
            return false;
        }
        return ColorModel.m3360equalsimpl0(this.model, colorSpace.model);
    }

    @Size(min = 3)
    public final float[] fromXyz(float f8, float f9, float f10) {
        float[] fArr = new float[ColorModel.m3361getComponentCountimpl(this.model)];
        fArr[0] = f8;
        fArr[1] = f9;
        fArr[2] = f10;
        return fromXyz(fArr);
    ...
    public final int getComponentCount() {
        return ColorModel.m3361getComponentCountimpl(this.model);
    }
    ...
    public final long m3369getModelxdoWZVw() {
        return this.model;
    }
    ...
    public int hashCode() {
        return (((this.name.hashCode() * 31) + ColorModel.m3362hashCodeimpl(this.model)) * 31) + this.id;
    }
    ...
    public String toString() {
        return this.name + " (id=" + this.id + ", model=" + ((Object) ColorModel.m3363toStringimpl(this.model)) + ')';
    }
    ...
    public /* synthetic */ ColorSpace(String str, long j8, AbstractC3247p abstractC3247p) {
        this(str, j8);
    }
