...
public final class Api26Bitmap {
    ...
    public static final Bitmap m2889createBitmapx__hDU$ui_graphics_release(int i8, int i9, int i10, boolean z8, ColorSpace colorSpace) {
        Bitmap createBitmap;
        createBitmap = Bitmap.createBitmap((DisplayMetrics) null, i8, i9, AndroidImageBitmap_androidKt.m2851toBitmapConfig1JJdX4A(i10), z8, AndroidColorSpace_androidKt.toAndroidColorSpace(colorSpace));
        return createBitmap;
    }
}
