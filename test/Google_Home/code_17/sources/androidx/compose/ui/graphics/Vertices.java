...
public final class Vertices {
    ...
    public /* synthetic */ Vertices(int i8, List list, List list2, List list3, List list4, AbstractC3247p abstractC3247p) {
    ...
    private final int[] encodeColorList(List<Color> list) {
        ...
        for (int i8 = 0; i8 < size; i8++) {
            iArr[i8] = ColorKt.m3030toArgb8_81llA(list.get(i8).m2986unboximpl());
        }
        return iArr;
    }
    ...
    private final float[] encodePointList(List<Offset> list) {
        ...
        for (int i8 = 0; i8 < size; i8++) {
            long m2750unboximpl = list.get(i8 / 2).m2750unboximpl();
            if (i8 % 2 == 0) {
                m2741getYimpl = Offset.m2740getXimpl(m2750unboximpl);
            } else {
                m2741getYimpl = Offset.m2741getYimpl(m2750unboximpl);
            }
            fArr[i8] = m2741getYimpl;
        }
        return fArr;
    }
    ...
    public final int m3355getVertexModec2xauaI() {
