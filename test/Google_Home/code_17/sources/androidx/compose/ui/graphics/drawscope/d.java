...
public abstract /* synthetic */ class d {
    public static long a(DrawTransform drawTransform) {
        float f8 = 2;
        return OffsetKt.Offset(Size.m2809getWidthimpl(drawTransform.mo3430getSizeNHjbRc()) / f8, Size.m2806getHeightimpl(drawTransform.mo3430getSizeNHjbRc()) / f8);
    }
    ...
    public static /* synthetic */ void c(DrawTransform drawTransform, Path path, int i8, int i9, Object obj) {
        if (obj == null) {
            ...
            drawTransform.mo3427clipPathmtrdDE(path, i8);
            return;
        }
    ...
    public static /* synthetic */ void d(DrawTransform drawTransform, float f8, float f9, float f10, float f11, int i8, int i9, Object obj) {
        if (obj == null) {
            ...
            if ((i9 & 4) != 0) {
                f10 = Size.m2809getWidthimpl(drawTransform.mo3430getSizeNHjbRc());
            }
            if ((i9 & 8) != 0) {
                f11 = Size.m2806getHeightimpl(drawTransform.mo3430getSizeNHjbRc());
            }
            if ((i9 & 16) != 0) {
                i8 = ClipOp.Companion.m2965getIntersectrtfAjoo();
            }
            drawTransform.mo3428clipRectN_I0leg(f8, f9, f10, f11, i8);
            return;
        }
    ...
    public static /* synthetic */ void e(DrawTransform drawTransform, float f8, long j8, int i8, Object obj) {
        if (obj == null) {
            ...
            drawTransform.mo3431rotateUv8p0NA(f8, j8);
            return;
        }
    ...
    public static /* synthetic */ void f(DrawTransform drawTransform, float f8, float f9, long j8, int i8, Object obj) {
        if (obj == null) {
            ...
            drawTransform.mo3432scale0AR0LA0(f8, f9, j8);
            return;
        }
