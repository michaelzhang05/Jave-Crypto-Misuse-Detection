...
public final class ImageBitmapKt {
    ...
    public static final ImageBitmap m3181ImageBitmapx__hDU(int i8, int i9, int i10, boolean z8, ColorSpace colorSpace) {
        return AndroidImageBitmap_androidKt.m2850ActualImageBitmapx__hDU(i8, i9, i10, z8, colorSpace);
    }

    /* renamed from: ImageBitmap-x__-hDU$default, reason: not valid java name */
    public static /* synthetic */ ImageBitmap m3182ImageBitmapx__hDU$default(int i8, int i9, int i10, boolean z8, ColorSpace colorSpace, int i11, Object obj) {
        if ((i11 & 4) != 0) {
            i10 = ImageBitmapConfig.Companion.m3177getArgb8888_sVssgQ();
        }
        if ((i11 & 8) != 0) {
            z8 = true;
        }
        ...
        return m3181ImageBitmapx__hDU(i8, i9, i10, z8, colorSpace);
    }
