...
public final class VectorPainter extends Painter {
    ...
    public final int m3546getBitmapConfig_sVssgQ$ui_release() {
        return this.vector.m3537getCacheBitmapConfig_sVssgQ$ui_release();
    }
    ...
    public long mo3513getIntrinsicSizeNHjbRc() {
        return m3547getSizeNHjbRc$ui_release();
    }
    ...
    public final long m3547getSizeNHjbRc$ui_release() {
        return ((Size) this.size$delegate.getValue()).m2814unboximpl();
    }
    ...
    public final long m3548getViewportSizeNHjbRc$ui_release() {
        return this.vector.m3538getViewportSizeNHjbRc$ui_release();
    }
    ...
    public final void m3549setSizeuvyYCjk$ui_release(long j8) {
        this.size$delegate.setValue(Size.m2797boximpl(j8));
    }

    /* renamed from: setViewportSize-uvyYCjk$ui_release, reason: not valid java name */
    public final void m3550setViewportSizeuvyYCjk$ui_release(long j8) {
        this.vector.m3539setViewportSizeuvyYCjk$ui_release(j8);
    }

    public VectorPainter(GroupComponent groupComponent) {
        MutableState mutableStateOf$default;
        MutableState mutableStateOf$default2;
        mutableStateOf$default = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Size.m2797boximpl(Size.Companion.m2818getZeroNHjbRc()), null, 2, null);
    ...
    public /* synthetic */ VectorPainter(GroupComponent groupComponent, int i8, AbstractC3247p abstractC3247p) {
