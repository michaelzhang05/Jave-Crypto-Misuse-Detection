...
public final class ReusableGraphicsLayerScope implements GraphicsLayerScope {
    ...
    private int compositingStrategy = CompositingStrategy.Companion.m3064getAutoNrFUSI();
    private long size = Size.Companion.m2817getUnspecifiedNHjbRc();
    ...
    public long mo3141getAmbientShadowColor0d7_KjU() {
    ...
    public int mo3142getCompositingStrategyNrFUSI() {
    ...
    public long mo3143getSizeNHjbRc() {
        return this.size;
    }

    @Override // androidx.compose.ui.graphics.GraphicsLayerScope
    /* renamed from: getSpotShadowColor-0d7_KjU */
    public long mo3144getSpotShadowColor0d7_KjU() {
        return this.spotShadowColor;
    }

    @Override // androidx.compose.ui.graphics.GraphicsLayerScope
    /* renamed from: getTransformOrigin-SzJe1aQ */
    public long mo3145getTransformOriginSzJe1aQ() {
    ...
    public final void reset() {
        ...
        mo3146setAmbientShadowColor8_81llA(GraphicsLayerScopeKt.getDefaultShadowColor());
        mo3148setSpotShadowColor8_81llA(GraphicsLayerScopeKt.getDefaultShadowColor());
        setRotationX(0.0f);
        setRotationY(0.0f);
        setRotationZ(0.0f);
        setCameraDistance(8.0f);
        mo3149setTransformOrigin__ExYCQ(TransformOrigin.Companion.m3344getCenterSzJe1aQ());
        setShape(RectangleShapeKt.getRectangleShape());
        setClip(false);
        setRenderEffect(null);
        mo3147setCompositingStrategyaDBOjCE(CompositingStrategy.Companion.m3064getAutoNrFUSI());
        m3265setSizeuvyYCjk(Size.Companion.m2817getUnspecifiedNHjbRc());
    ...
    public void mo3146setAmbientShadowColor8_81llA(long j8) {
        if (!Color.m2977equalsimpl0(this.ambientShadowColor, j8)) {
    ...
    public void mo3147setCompositingStrategyaDBOjCE(int i8) {
        if (!CompositingStrategy.m3060equalsimpl0(this.compositingStrategy, i8)) {
    ...
    public void setRenderEffect(RenderEffect renderEffect) {
        if (!AbstractC3255y.d(this.renderEffect, renderEffect)) {
    ...
    public void setShape(Shape shape) {
        if (!AbstractC3255y.d(this.shape, shape)) {
    ...
    public void m3265setSizeuvyYCjk(long j8) {
        this.size = j8;
    }

    @Override // androidx.compose.ui.graphics.GraphicsLayerScope
    /* renamed from: setSpotShadowColor-8_81llA */
    public void mo3148setSpotShadowColor8_81llA(long j8) {
        if (!Color.m2977equalsimpl0(this.spotShadowColor, j8)) {
    ...
    public void mo3149setTransformOrigin__ExYCQ(long j8) {
        if (!TransformOrigin.m3338equalsimpl0(this.transformOrigin, j8)) {
