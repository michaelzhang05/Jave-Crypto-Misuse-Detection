...
public final class DrawCache {
    ...
    private long size = IntSize.Companion.m5354getZeroYbymL2g();
    private int config = ImageBitmapConfig.Companion.m3177getArgb8888_sVssgQ();
    private final CanvasDrawScope cacheScope = new CanvasDrawScope();

    private final void clear(DrawScope drawScope) {
        c.K(drawScope, Color.Companion.m3002getBlack0d7_KjU(), 0L, 0L, 0.0f, null, null, BlendMode.Companion.m2897getClear0nO6VwU(), 62, null);
    }
    ...
    public final void m3520drawCachedImageFqjB98A(int i8, long j8, Density density, LayoutDirection layoutDirection, Function1 function1) {
        this.scopeDensity = density;
        this.layoutDirection = layoutDirection;
        ImageBitmap imageBitmap = this.mCachedImage;
        Canvas canvas = this.cachedCanvas;
        if (imageBitmap == null || canvas == null || IntSize.m5349getWidthimpl(j8) > imageBitmap.getWidth() || IntSize.m5348getHeightimpl(j8) > imageBitmap.getHeight() || !ImageBitmapConfig.m3172equalsimpl0(this.config, i8)) {
            imageBitmap = ImageBitmapKt.m3182ImageBitmapx__hDU$default(IntSize.m5349getWidthimpl(j8), IntSize.m5348getHeightimpl(j8), i8, false, null, 24, null);
        ...
        drawParams2.m3424setSizeuvyYCjk(m5359toSizeozmzZPI);
        canvas.save();
