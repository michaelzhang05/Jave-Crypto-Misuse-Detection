...
public interface Path {
    ...
    public static final class Companion {
        ...
        public final Path m3225combinexh6zSI8(int i8, Path path, Path path2) {
            Path Path = AndroidPath_androidKt.Path();
            if (Path.mo2874opN5in7k0(path, path2, i8)) {
                return Path;
            }
    ...
    public static final class DefaultImpls {
        ...
        public static void m3227transform58bKbWc(Path path, float[] fArr) {
            V0.f(path, fArr);
        }
    }
    ...
    void mo2872addPathUv8p0NA(Path path, long j8);
    ...
    boolean mo2874opN5in7k0(Path path, Path path2, int i8);
    ...
    void mo2875setFillTypeoQ8Xj4U(int i8);

    /* renamed from: transform-58bKbWc */
    void mo2876transform58bKbWc(float[] fArr);

    /* renamed from: translate-k-4lQ0M */
    void mo2877translatek4lQ0M(long j8);
}
