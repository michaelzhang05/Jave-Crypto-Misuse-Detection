...
public final class GroupComponent extends VNode {
    ...
    public GroupComponent() {
        ...
        this.tintColor = Color.Companion.m3012getUnspecified0d7_KjU();
    ...
    private final void markTintForBrush(Brush brush) {
        if (this.isTintable && brush != null) {
            if (brush instanceof SolidColor) {
                m3521markTintForColor8_81llA(((SolidColor) brush).m3288getValue0d7_KjU());
            } else {
                markNotTintable();
            }
        }
    ...
    private final void m3521markTintForColor8_81llA(long j8) {
        if (!this.isTintable) {
            return;
        }
        Color.Companion companion = Color.Companion;
        if (j8 != companion.m3012getUnspecified0d7_KjU()) {
            if (this.tintColor == companion.m3012getUnspecified0d7_KjU()) {
                this.tintColor = j8;
            } else if (!VectorKt.m3545rgbEqualOWjLjI(this.tintColor, j8)) {
                markNotTintable();
            }
        }
    }
    ...
    public final void markTintForVNode(VNode vNode) {
        if (vNode instanceof PathComponent) {
            ...
            if (groupComponent.isTintable && this.isTintable) {
                m3521markTintForColor8_81llA(groupComponent.tintColor);
            } else {
                markNotTintable();
            }
        }
    ...
    private final void updateMatrix() {
        ...
        if (fArr == null) {
            fArr = Matrix.m3187constructorimpl$default(null, 1, null);
            this.groupMatrix = fArr;
        } else {
            Matrix.m3196resetimpl(fArr);
        }
        Matrix.m3207translateimpl$default(fArr, this.pivotX + this.translationX, this.pivotY + this.translationY, 0.0f, 4, null);
        Matrix.m3199rotateZimpl(fArr, this.rotation);
        Matrix.m3200scaleimpl(fArr, this.scaleX, this.scaleY, 1.0f);
        Matrix.m3207translateimpl$default(fArr, -this.pivotX, -this.pivotY, 0.0f, 4, null);
    }
    ...
    public void draw(DrawScope drawScope) {
        ...
        float[] fArr = this.groupMatrix;
        if (fArr != null) {
            transform.mo3433transform58bKbWc(Matrix.m3185boximpl(fArr).m3208unboximpl());
        }
        Path path = this.clipPath;
    ...
    public final long m3522getTintColor0d7_KjU() {
