...
public final class VectorComposeKt$Group$4 extends AbstractC3256z implements InterfaceC1668n {
    ...
    public VectorComposeKt$Group$4(String str, float f8, float f9, float f10, float f11, float f12, float f13, float f14, List<? extends PathNode> list, InterfaceC1668n interfaceC1668n, int i8, int i9) {
        super(2);
        this.$name = str;
        this.$rotation = f8;
        this.$pivotX = f9;
