...
public final class ColorSpaceKt {
    ...
    public static final Connector m3371connectYBCOT_4(ColorSpace colorSpace, ColorSpace colorSpace2, int i8) {
        ...
        if (colorSpace == colorSpaces.getSrgb()) {
            ...
            if (colorSpace2 == colorSpaces.getOklab() && RenderIntent.m3381equalsimpl0(i8, RenderIntent.Companion.m3386getPerceptualuksYyKA())) {
                return Connector.Companion.getSrgbToOklabPerceptual$ui_graphics_release();
            }
        } else if (colorSpace == colorSpaces.getOklab() && colorSpace2 == colorSpaces.getSrgb() && RenderIntent.m3381equalsimpl0(i8, RenderIntent.Companion.m3386getPerceptualuksYyKA())) {
        ...
        if (ColorModel.m3360equalsimpl0(m3369getModelxdoWZVw, companion.m3367getRgbxdoWZVw()) && ColorModel.m3360equalsimpl0(colorSpace2.m3369getModelxdoWZVw(), companion.m3367getRgbxdoWZVw())) {
            AbstractC3255y.g(colorSpace, "null cannot be cast to non-null type androidx.compose.ui.graphics.colorspace.Rgb");
            AbstractC3255y.g(colorSpace2, "null cannot be cast to non-null type androidx.compose.ui.graphics.colorspace.Rgb");
            return new Connector.RgbConnector((Rgb) colorSpace, (Rgb) colorSpace2, i8, abstractC3247p);
        }
        return new Connector(colorSpace, colorSpace2, i8, abstractC3247p);
    }

    /* renamed from: connect-YBCOT_4$default */
    public static /* synthetic */ Connector m3372connectYBCOT_4$default(ColorSpace colorSpace, ColorSpace colorSpace2, int i8, int i9, Object obj) {
        if ((i9 & 1) != 0) {
            colorSpace2 = ColorSpaces.INSTANCE.getSrgb();
        }
        if ((i9 & 2) != 0) {
            i8 = RenderIntent.Companion.m3386getPerceptualuksYyKA();
        }
        return m3371connectYBCOT_4(colorSpace, colorSpace2, i8);
    }
    ...
    public static final ColorSpace adapt(ColorSpace colorSpace, WhitePoint whitePoint, Adaptation adaptation) {
        if (!ColorModel.m3360equalsimpl0(colorSpace.m3369getModelxdoWZVw(), ColorModel.Companion.m3367getRgbxdoWZVw())) {
            return colorSpace;
        }
        AbstractC3255y.g(colorSpace, "null cannot be cast to non-null type androidx.compose.ui.graphics.colorspace.Rgb");
