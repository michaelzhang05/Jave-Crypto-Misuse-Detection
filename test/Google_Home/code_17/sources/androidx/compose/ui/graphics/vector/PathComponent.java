...
public final class PathComponent extends VNode {
    ...
    private final InterfaceC1355k pathMeasure$delegate;
    ...
    public PathComponent() {
        ...
        this.pathMeasure$delegate = l.a(o.f8297c, PathComponent$pathMeasure$2.INSTANCE);
    }
    ...
    private final void updateRenderPath() {
        ...
        if (AbstractC3255y.d(this.renderPath, this.path)) {
            this.renderPath = AndroidPath_androidKt.Path();
        } else {
            int mo2873getFillTypeRgk1Os = this.renderPath.mo2873getFillTypeRgk1Os();
            this.renderPath.rewind();
            this.renderPath.mo2875setFillTypeoQ8Xj4U(mo2873getFillTypeRgk1Os);
        }
    ...
    public final int m3531getPathFillTypeRgk1Os() {
    ...
    public final int m3532getStrokeLineCapKaPHkGw() {
        return this.strokeLineCap;
    }

    /* renamed from: getStrokeLineJoin-LxFBmk8, reason: not valid java name */
    public final int m3533getStrokeLineJoinLxFBmk8() {
    ...
    public final void m3534setPathFillTypeoQ8Xj4U(int i8) {
        this.pathFillType = i8;
        this.renderPath.mo2875setFillTypeoQ8Xj4U(i8);
        invalidate();
    }
    ...
    public final void m3535setStrokeLineCapBeK7IIE(int i8) {
    ...
    public final void m3536setStrokeLineJoinWw9F2mQ(int i8) {
