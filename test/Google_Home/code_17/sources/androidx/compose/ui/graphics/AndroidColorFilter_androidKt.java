...
public final class AndroidColorFilter_androidKt {
    ...
    public static final android.graphics.ColorFilter m2846actualColorMatrixColorFilterjHGOpc(float[] fArr) {
    ...
    public static final float[] actualColorMatrixFromFilter(android.graphics.ColorFilter colorFilter) {
        if ((colorFilter instanceof android.graphics.ColorMatrixColorFilter) && supportsColorMatrixQuery()) {
            return ColorMatrixFilterHelper.INSTANCE.m3056getColorMatrix8unuwjk((android.graphics.ColorMatrixColorFilter) colorFilter);
        }
        throw new IllegalArgumentException("Unable to obtain ColorMatrix from Android ColorMatrixColorFilter. This method was invoked on an unsupported Android version");
    }

    /* renamed from: actualLightingColorFilter--OWjLjI, reason: not valid java name */
    public static final android.graphics.ColorFilter m2847actualLightingColorFilterOWjLjI(long j8, long j9) {
        return new android.graphics.LightingColorFilter(ColorKt.m3030toArgb8_81llA(j8), ColorKt.m3030toArgb8_81llA(j9));
    }

    /* renamed from: actualTintColorFilter-xETnrds, reason: not valid java name */
    public static final android.graphics.ColorFilter m2848actualTintColorFilterxETnrds(long j8, int i8) {
        if (Build.VERSION.SDK_INT >= 29) {
            return BlendModeColorFilterHelper.INSTANCE.m2928BlendModeColorFilterxETnrds(j8, i8);
        }
        return new PorterDuffColorFilter(ColorKt.m3030toArgb8_81llA(j8), AndroidBlendMode_androidKt.m2833toPorterDuffModes9anfk8(i8));
    }
