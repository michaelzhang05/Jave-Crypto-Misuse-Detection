...
public final class ImageVectorKt {
    ...
    public static final ImageVector.Builder m3529pathR_LF3I(ImageVector.Builder builder, String str, Brush brush, float f8, Brush brush2, float f9, float f10, int i8, int i9, float f11, int i10, Function1 function1) {
        PathBuilder pathBuilder = new PathBuilder();
        function1.invoke(pathBuilder);
        return ImageVector.Builder.m3527addPathoIyEayM$default(builder, pathBuilder.getNodes(), i10, str, brush, f8, brush2, f9, f10, i8, i9, f11, 0.0f, 0.0f, 0.0f, 14336, null);
    }

    /* renamed from: path-R_LF-3I$default */
    public static /* synthetic */ ImageVector.Builder m3530pathR_LF3I$default(ImageVector.Builder builder, String str, Brush brush, float f8, Brush brush2, float f9, float f10, int i8, int i9, float f11, int i10, Function1 function1, int i11, Object obj) {
        String str2;
        Brush brush3;
        float f12;
        Brush brush4;
        ...
        PathBuilder pathBuilder = new PathBuilder();
        function1.invoke(pathBuilder);
        return ImageVector.Builder.m3527addPathoIyEayM$default(builder, pathBuilder.getNodes(), i14, str2, brush3, f12, brush4, f13, f14, i12, i13, f15, 0.0f, 0.0f, 0.0f, 14336, null);
    }
