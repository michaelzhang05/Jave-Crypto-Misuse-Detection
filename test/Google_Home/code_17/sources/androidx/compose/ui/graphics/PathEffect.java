...
public interface PathEffect {
    ...
    public static final class Companion {
        ...
        public final PathEffect m3228stampedPathEffect7aD1DOk(Path path, float f8, float f9, int i8) {
            return AndroidPathEffect_androidKt.m2878actualStampedPathEffect7aD1DOk(path, f8, f9, i8);
        }
    }
}
