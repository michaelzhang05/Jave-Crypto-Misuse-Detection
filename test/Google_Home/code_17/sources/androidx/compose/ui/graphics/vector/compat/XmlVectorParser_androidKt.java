...
public final class XmlVectorParser_androidKt {
                ...
                if (obtainAttributes.hasValue(androidVectorResources.getSTYLEABLE_VECTOR_DRAWABLE_TINT())) {
                    ...
                    if (typedValue.type == 2) {
                        ...
                        if (namedColorStateList != null) {
                            m3012getUnspecified0d7_KjU = ColorKt.Color(namedColorStateList.getDefaultColor());
                        } else {
                            m3012getUnspecified0d7_KjU = Color.Companion.m3012getUnspecified0d7_KjU();
                        }
                    }
                    ...
                    if (i8 != 3) {
                        if (i8 != 5) {
                            if (i8 != 9) {
                                switch (i8) {
                                    case 14:
                                        m2922getSrcIn0nO6VwU = BlendMode.Companion.m2913getModulate0nO6VwU();
                                        break;
                                    case 15:
                                        m2922getSrcIn0nO6VwU = BlendMode.Companion.m2918getScreen0nO6VwU();
                                        break;
                                    case 16:
                                        m2922getSrcIn0nO6VwU = BlendMode.Companion.m2916getPlus0nO6VwU();
                                        break;
                                    default:
                                        m2922getSrcIn0nO6VwU = BlendMode.Companion.m2922getSrcIn0nO6VwU();
                                        break;
                                }
                            } else {
                                m2922getSrcIn0nO6VwU = BlendMode.Companion.m2921getSrcAtop0nO6VwU();
                            }
                        } else {
                            m2922getSrcIn0nO6VwU = BlendMode.Companion.m2922getSrcIn0nO6VwU();
                        }
                    } else {
                        m2922getSrcIn0nO6VwU = BlendMode.Companion.m2924getSrcOver0nO6VwU();
                    }
                } else {
                    m2922getSrcIn0nO6VwU = BlendMode.Companion.m2922getSrcIn0nO6VwU();
                }
                int i9 = m2922getSrcIn0nO6VwU;
                float m5183constructorimpl = Dp.m5183constructorimpl(dimension / resources.getDisplayMetrics().density);
                float m5183constructorimpl2 = Dp.m5183constructorimpl(dimension2 / resources.getDisplayMetrics().density);
                obtainAttributes.recycle();
                return new ImageVector.Builder(null, m5183constructorimpl, m5183constructorimpl2, namedFloat, namedFloat2, j8, i9, namedBoolean, 1, null);
            }
    ...
    private static final int m3563getStrokeLineCapCSYIeUk(int i8, int i9) {
        if (i8 != 0) {
            if (i8 != 1) {
                if (i8 == 2) {
    ...
    static /* synthetic */ int m3564getStrokeLineCapCSYIeUk$default(int i8, int i9, int i10, Object obj) {
        if ((i10 & 2) != 0) {
            i9 = StrokeCap.Companion.m3306getButtKaPHkGw();
        }
        return m3563getStrokeLineCapCSYIeUk(i8, i9);
    }

    /* renamed from: getStrokeLineJoin-kLtJ_vA, reason: not valid java name */
    private static final int m3565getStrokeLineJoinkLtJ_vA(int i8, int i9) {
        if (i8 != 0) {
            if (i8 != 1) {
                if (i8 == 2) {
    ...
    static /* synthetic */ int m3566getStrokeLineJoinkLtJ_vA$default(int i8, int i9, int i10, Object obj) {
        if ((i10 & 2) != 0) {
            i9 = StrokeJoin.Companion.m3317getMiterLxFBmk8();
        }
        return m3565getStrokeLineJoinkLtJ_vA(i8, i9);
    }
    ...
    public static final int parseCurrentVectorNode(AndroidVectorParser androidVectorParser, Resources resources, AttributeSet attributeSet, Resources.Theme theme, ImageVector.Builder builder, int i8) {
        ...
        if (eventType != 2) {
            if (eventType == 3 && AbstractC3255y.d(SHAPE_GROUP, androidVectorParser.getXmlParser().getName())) {
                int i9 = i8 + 1;
    ...
    public static final void parsePath(AndroidVectorParser androidVectorParser, Resources resources, Resources.Theme theme, AttributeSet attributeSet, ImageVector.Builder builder) throws IllegalArgumentException {
        ...
        if (TypedArrayUtils.hasAttribute(androidVectorParser.getXmlParser(), "pathData")) {
            ...
            int m3563getStrokeLineCapCSYIeUk = m3563getStrokeLineCapCSYIeUk(androidVectorParser.getNamedInt(obtainAttributes, "strokeLineCap", androidVectorResources.getSTYLEABLE_VECTOR_DRAWABLE_PATH_STROKE_LINE_CAP(), -1), StrokeCap.Companion.m3306getButtKaPHkGw());
            int m3565getStrokeLineJoinkLtJ_vA = m3565getStrokeLineJoinkLtJ_vA(androidVectorParser.getNamedInt(obtainAttributes, "strokeLineJoin", androidVectorResources.getSTYLEABLE_VECTOR_DRAWABLE_PATH_STROKE_LINE_JOIN(), -1), StrokeJoin.Companion.m3316getBevelLxFBmk8());
            ...
            if (namedInt == 0) {
                m3236getEvenOddRgk1Os = companion.m3237getNonZeroRgk1Os();
            } else {
                m3236getEvenOddRgk1Os = companion.m3236getEvenOddRgk1Os();
            }
            builder.m3528addPathoIyEayM(addPathNodes, m3236getEvenOddRgk1Os, str, obtainBrushFromComplexColor, namedFloat, obtainBrushFromComplexColor2, namedFloat3, namedFloat4, m3563getStrokeLineCapCSYIeUk, m3565getStrokeLineJoinkLtJ_vA, namedFloat2, namedFloat7, namedFloat5, namedFloat6);
            return;
        }
