...
public final class SimpleGraphicsLayerModifier extends Modifier.Node implements LayoutModifierNode {
    ...
    public /* synthetic */ SimpleGraphicsLayerModifier(float f8, float f9, float f10, float f11, float f12, float f13, float f14, float f15, float f16, float f17, long j8, Shape shape, boolean z8, RenderEffect renderEffect, long j9, long j10, int i8, AbstractC3247p abstractC3247p) {
    ...
    public final long m3280getAmbientShadowColor0d7_KjU() {
    ...
    public final int m3281getCompositingStrategyNrFUSI() {
    ...
    public final long m3282getSpotShadowColor0d7_KjU() {
        return this.spotShadowColor;
    }

    /* renamed from: getTransformOrigin-SzJe1aQ, reason: not valid java name */
    public final long m3283getTransformOriginSzJe1aQ() {
    ...
    public final void invalidateLayerBlock() {
        NodeCoordinator wrapped$ui_release = DelegatableNodeKt.m4231requireCoordinator64DMado(this, NodeKind.m4348constructorimpl(2)).getWrapped$ui_release();
    ...
    public MeasureResult mo368measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j8) {
        ...
        return MeasureScope.CC.q(measureScope, mo4136measureBRTryo0.getWidth(), mo4136measureBRTryo0.getHeight(), null, new SimpleGraphicsLayerModifier$measure$1(mo4136measureBRTryo0, this), 4, null);
    }
    ...
    public final void m3284setAmbientShadowColor8_81llA(long j8) {
    ...
    public final void m3285setCompositingStrategyaDBOjCE(int i8) {
    ...
    public final void m3286setSpotShadowColor8_81llA(long j8) {
        this.spotShadowColor = j8;
    }

    /* renamed from: setTransformOrigin-__ExYCQ, reason: not valid java name */
    public final void m3287setTransformOrigin__ExYCQ(long j8) {
    ...
    public /* synthetic */ SimpleGraphicsLayerModifier(float f8, float f9, float f10, float f11, float f12, float f13, float f14, float f15, float f16, float f17, long j8, Shape shape, boolean z8, RenderEffect renderEffect, long j9, long j10, int i8, int i9, AbstractC3247p abstractC3247p) {
        this(f8, f9, f10, f11, f12, f13, f14, f15, f16, f17, j8, shape, z8, renderEffect, j9, j10, (i9 & 65536) != 0 ? CompositingStrategy.Companion.m3064getAutoNrFUSI() : i8, null);
    }
