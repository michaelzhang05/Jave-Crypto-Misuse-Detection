...
public final class PathNodeKt {
    ...
    private static final void pathNodesFromArgs(List<PathNode> list, float[] fArr, int i8, int i9, InterfaceC1668n interfaceC1668n) {
        int i10 = i8 - i9;
        int i11 = 0;
        while (i11 <= i10) {
            PathNode pathNode = (PathNode) interfaceC1668n.invoke(fArr, Integer.valueOf(i11));
