...
public final class PathParser {
    ...
    private final void resizeNodeData(int i8) {
        ...
        if (i8 >= fArr.length) {
            ...
            this.nodeData = fArr2;
            AbstractC1371l.f(fArr, fArr2, 0, 0, fArr.length);
        }
    }
    ...
    public final PathParser parsePathString(String str) {
        ...
        int i10 = 0;
        while (i10 < length && AbstractC3255y.k(str.charAt(i10), 32) <= 0) {
            i10++;
        }
        while (length > i10 && AbstractC3255y.k(str.charAt(length - 1), 32) <= 0) {
            length--;
        }
        int i11 = 0;
        while (i10 < length) {
            ...
            if (charAt != 0) {
                if ((charAt | ' ') != 122) {
                    i11 = 0;
                    while (true) {
                        if (i8 < length && AbstractC3255y.k(str.charAt(i8), 32) <= 0) {
                            i8++;
                        } else {
