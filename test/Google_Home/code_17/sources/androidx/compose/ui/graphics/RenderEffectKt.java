...
public final class RenderEffectKt {
    ...
    public static final BlurEffect m3261BlurEffect3YTHUZs(float f8, float f9, int i8) {
        return new BlurEffect(null, f8, f9, i8, null);
    }

    /* renamed from: BlurEffect-3YTHUZs$default, reason: not valid java name */
    public static /* synthetic */ BlurEffect m3262BlurEffect3YTHUZs$default(float f8, float f9, int i8, int i9, Object obj) {
        if ((i9 & 4) != 0) {
            i8 = TileMode.Companion.m3326getClamp3opZhB0();
        }
        return m3261BlurEffect3YTHUZs(f8, f9, i8);
    }
