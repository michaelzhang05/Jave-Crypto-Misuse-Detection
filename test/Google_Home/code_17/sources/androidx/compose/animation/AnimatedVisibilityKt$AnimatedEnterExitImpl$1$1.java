...
final class AnimatedVisibilityKt$AnimatedEnterExitImpl$1$1 extends l implements InterfaceC1668n {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i8 != 0) {
            ...
            t.b(obj);
            InterfaceC3706f snapshotFlow = SnapshotStateKt.snapshotFlow(new AnonymousClass1(this.$childTransition));
            final MutableState<Boolean> mutableState = this.$isAnimationVisible;
            InterfaceC3707g interfaceC3707g = new InterfaceC3707g() { // from class: androidx.compose.animation.AnimatedVisibilityKt$AnimatedEnterExitImpl$1$1.2
    ...
    public final Object invoke(M m8, d dVar) {
        return ((AnimatedVisibilityKt$AnimatedEnterExitImpl$1$1) create(m8, dVar)).invokeSuspend(I.f8278a);
    }
}
