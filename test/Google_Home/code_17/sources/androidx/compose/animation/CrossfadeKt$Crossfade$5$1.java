...
final class CrossfadeKt$Crossfade$5$1 extends AbstractC3256z implements InterfaceC1668n {
    ...
    public CrossfadeKt$Crossfade$5$1(Transition<T> transition, int i8, FiniteAnimationSpec<Float> finiteAnimationSpec, T t8, InterfaceC1669o interfaceC1669o) {
        super(2);
    ...
    public final void invoke(Composer composer, int i8) {
        ...
        float f8 = AbstractC3255y.d(currentState, t8) ? 1.0f : 0.0f;
        if (ComposerKt.isTraceInProgress()) {
        ...
        float f9 = AbstractC3255y.d(targetState, t8) ? 1.0f : 0.0f;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        ...
        InterfaceC1669o modifierMaterializerOf = LayoutKt.modifierMaterializerOf(graphicsLayer);
        ...
        interfaceC1669o.invoke(obj, composer, Integer.valueOf((i10 >> 9) & 112));
        composer.endReplaceableGroup();
        composer.endNode();
        composer.endReplaceableGroup();
        composer.endReplaceableGroup();
