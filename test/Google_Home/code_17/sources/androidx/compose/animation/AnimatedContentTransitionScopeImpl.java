...
public final class AnimatedContentTransitionScopeImpl<S> implements AnimatedContentTransitionScope<S> {
    ...
    public final class SizeModifier extends LayoutModifierWithPassThroughIntrinsics {
        ...
        public SizeModifier(AnimatedContentTransitionScopeImpl animatedContentTransitionScopeImpl, Transition<S>.DeferredAnimation<IntSize, AnimationVector2D> sizeAnimation, State<? extends SizeTransform> sizeTransform) {
            ...
            AbstractC3255y.i(sizeTransform, "sizeTransform");
        ...
        public MeasureResult mo161measure3p2s80s(MeasureScope measure, Measurable measurable, long j8) {
            ...
            return MeasureScope.CC.q(measure, IntSize.m5349getWidthimpl(animate.getValue().m5353unboximpl()), IntSize.m5348getHeightimpl(animate.getValue().m5353unboximpl()), null, new AnimatedContentTransitionScopeImpl$SizeModifier$measure$1(mo4136measureBRTryo0, this.this$0.getContentAlignment$animation_release().mo2613alignKFBX0sM(IntSizeKt.IntSize(mo4136measureBRTryo0.getWidth(), mo4136measureBRTryo0.getHeight()), animate.getValue().m5353unboximpl(), LayoutDirection.Ltr)), 4, null);
        }
    }
    ...
    public AnimatedContentTransitionScopeImpl(Transition<S> transition, Alignment contentAlignment, LayoutDirection layoutDirection) {
        ...
        AbstractC3255y.i(contentAlignment, "contentAlignment");
        AbstractC3255y.i(layoutDirection, "layoutDirection");
        this.transition = transition;
        this.contentAlignment = contentAlignment;
        this.layoutDirection = layoutDirection;
        mutableStateOf$default = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(IntSize.m5341boximpl(IntSize.Companion.m5354getZeroYbymL2g()), null, 2, null);
    ...
    public final long m155calculateOffsetemnUabE(long j8, long j9) {
        return this.contentAlignment.mo2613alignKFBX0sM(j8, j9, LayoutDirection.Ltr);
    }
    ...
    public final long m156getCurrentSizeYbymL2g() {
        State<IntSize> state = this.animatedSize;
        if (state != null) {
            return state.getValue().m5353unboximpl();
        }
        return m159getMeasuredSizeYbymL2g$animation_release();
    }

    /* renamed from: isLeft-gWo6LJ4, reason: not valid java name */
    private final boolean m157isLeftgWo6LJ4(int i8) {
        ...
        if (!AnimatedContentTransitionScope.SlideDirection.m143equalsimpl0(i8, companion.m149getLeftDKzdypw()) && ((!AnimatedContentTransitionScope.SlideDirection.m143equalsimpl0(i8, companion.m151getStartDKzdypw()) || this.layoutDirection != LayoutDirection.Ltr) && (!AnimatedContentTransitionScope.SlideDirection.m143equalsimpl0(i8, companion.m148getEndDKzdypw()) || this.layoutDirection != LayoutDirection.Rtl))) {
            return false;
        }
        return true;
    }
    ...
    private final boolean m158isRightgWo6LJ4(int i8) {
        AnimatedContentTransitionScope.SlideDirection.Companion companion = AnimatedContentTransitionScope.SlideDirection.Companion;
        if (!AnimatedContentTransitionScope.SlideDirection.m143equalsimpl0(i8, companion.m150getRightDKzdypw()) && ((!AnimatedContentTransitionScope.SlideDirection.m143equalsimpl0(i8, companion.m151getStartDKzdypw()) || this.layoutDirection != LayoutDirection.Rtl) && (!AnimatedContentTransitionScope.SlideDirection.m143equalsimpl0(i8, companion.m148getEndDKzdypw()) || this.layoutDirection != LayoutDirection.Ltr))) {
            return false;
        }
        return true;
    }
    ...
    public final Modifier createSizeAnimationModifier$animation_release(ContentTransform contentTransform, Composer composer, int i8) {
        ...
        AbstractC3255y.i(contentTransform, "contentTransform");
        ...
        if (AbstractC3255y.d(this.transition.getCurrentState(), this.transition.getTargetState())) {
    ...
    public final long m159getMeasuredSizeYbymL2g$animation_release() {
        return ((IntSize) this.measuredSize$delegate.getValue()).m5353unboximpl();
    }
    ...
    public final void setContentAlignment$animation_release(Alignment alignment) {
        AbstractC3255y.i(alignment, "<set-?>");
    ...
    public final void m160setMeasuredSizeozmzZPI$animation_release(long j8) {
        this.measuredSize$delegate.setValue(IntSize.m5341boximpl(j8));
    }

    @Override // androidx.compose.animation.AnimatedContentTransitionScope
    /* renamed from: slideIntoContainer-mOhB8PU */
    public EnterTransition mo138slideIntoContainermOhB8PU(int i8, FiniteAnimationSpec<IntOffset> animationSpec, Function1 initialOffset) {
        AbstractC3255y.i(animationSpec, "animationSpec");
        AbstractC3255y.i(initialOffset, "initialOffset");
        if (m157isLeftgWo6LJ4(i8)) {
        ...
        AnimatedContentTransitionScope.SlideDirection.Companion companion = AnimatedContentTransitionScope.SlideDirection.Companion;
        if (AnimatedContentTransitionScope.SlideDirection.m143equalsimpl0(i8, companion.m152getUpDKzdypw())) {
        ...
        if (AnimatedContentTransitionScope.SlideDirection.m143equalsimpl0(i8, companion.m147getDownDKzdypw())) {
    ...
    public ExitTransition mo139slideOutOfContainermOhB8PU(int i8, FiniteAnimationSpec<IntOffset> animationSpec, Function1 targetOffset) {
        AbstractC3255y.i(animationSpec, "animationSpec");
    ...
    public ContentTransform using(ContentTransform contentTransform, SizeTransform sizeTransform) {
        AbstractC3255y.i(contentTransform, "<this>");
