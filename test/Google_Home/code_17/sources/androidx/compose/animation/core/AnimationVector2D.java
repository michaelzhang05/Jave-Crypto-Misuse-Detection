...
public final class AnimationVector2D extends AnimationVector {
    ...
    private float f14540v1;

    /* renamed from: v2, reason: collision with root package name */
    private float f14541v2;
    ...
    public boolean equals(Object obj) {
        if (obj instanceof AnimationVector2D) {
            ...
            if (animationVector2D.f14540v1 == this.f14540v1 && animationVector2D.f14541v2 == this.f14541v2) {
                return true;
            }
        }
        return false;
    ...
    public float get$animation_core_release(int i8) {
        if (i8 != 0) {
            ...
            return this.f14541v2;
        }
        return this.f14540v1;
    }
    ...
    public int hashCode() {
        return (Float.floatToIntBits(this.f14540v1) * 31) + Float.floatToIntBits(this.f14541v2);
    }
    ...
    public String toString() {
        return "AnimationVector2D: v1 = " + this.f14540v1 + ", v2 = " + this.f14541v2;
    }
