...
public final class Transition<S> {
    ...
    public final class DeferredAnimation<T, V extends AnimationVector> {
        ...
        public final class DeferredAnimationData<T, V extends AnimationVector> implements State<T> {
            ...
            public DeferredAnimationData(DeferredAnimation deferredAnimation, Transition<S>.TransitionAnimationState<T, V> animation, Function1 transitionSpec, Function1 targetValueByState) {
                ...
                AbstractC3255y.i(transitionSpec, "transitionSpec");
    ...
    public static final class SegmentImpl<S> implements Segment<S> {
        ...
        public boolean equals(Object obj) {
            if (obj instanceof Segment) {
                ...
                if (AbstractC3255y.d(getInitialState(), segment.getInitialState()) && AbstractC3255y.d(getTargetState(), segment.getTargetState())) {
                    return true;
                }
            }
            return false;
    ...
    public final class TransitionAnimationState<T, V extends AnimationVector> implements State<T> {
        ...
        public TransitionAnimationState(Transition transition, T t8, V initialVelocityVector, TwoWayConverter<T, V> typeConverter, String label) {
            ...
            Object obj;
            AbstractC3255y.i(initialVelocityVector, "initialVelocityVector");
            AbstractC3255y.i(typeConverter, "typeConverter");
            AbstractC3255y.i(label, "label");
            this.this$0 = transition;
            this.typeConverter = typeConverter;
        ...
        public final void updateInitialAndTargetValue$animation_core_release(T t8, T t9, FiniteAnimationSpec<T> animationSpec) {
            ...
            if (AbstractC3255y.d(getAnimation().getInitialValue(), t8) && AbstractC3255y.d(getAnimation().getTargetValue(), t9)) {
                return;
            }
        ...
        public final void updateTargetValue$animation_core_release(T t8, FiniteAnimationSpec<T> animationSpec) {
            AbstractC3255y.i(animationSpec, "animationSpec");
            if (!AbstractC3255y.d(getTargetValue(), t8) || getNeedsReset()) {
                setTargetValue(t8);
                setAnimationSpec(animationSpec);
    ...
    public final void animateTo$animation_core_release(S s8, Composer composer, int i8) {
        ...
        if ((i9 & 91) == 18 && startRestartGroup.getSkipping()) {
            ...
            if (!isSeeking()) {
                ...
                if (!AbstractC3255y.d(s8, getCurrentState()) || isRunning() || getUpdateChildrenNeeded$animation_core_release()) {
                    int i12 = (i9 >> 3) & 14;
                    ...
                    EffectsKt.LaunchedEffect(this, (InterfaceC1668n) rememberedValue, startRestartGroup, i12 | 64);
                }
            }
            if (ComposerKt.isTraceInProgress()) {
    ...
    public final void onFrame$animation_core_release(long j8, float f8) {
        ...
        for (Transition<?> transition : this._transitions) {
            if (!AbstractC3255y.d(transition.getTargetState(), transition.getCurrentState())) {
    ...
    public final void seek(S s8, S s9, long j8) {
        setStartTimeNanos(Long.MIN_VALUE);
        this.transitionState.setRunning$animation_core_release(false);
        if (!isSeeking() || !AbstractC3255y.d(getCurrentState(), s8) || !AbstractC3255y.d(getTargetState(), s9)) {
        ...
        for (Transition<?> transition : this._transitions) {
            AbstractC3255y.g(transition, "null cannot be cast to non-null type androidx.compose.animation.core.Transition<kotlin.Any>");
    ...
    public final void updateTarget$animation_core_release(S s8, Composer composer, int i8) {
        ...
        if ((i9 & 91) == 18 && startRestartGroup.getSkipping()) {
            ...
            if (!isSeeking() && !AbstractC3255y.d(getTargetState(), s8)) {
    ...
    public final void removeAnimation$animation_core_release(Transition<S>.DeferredAnimation<?, ?> deferredAnimation) {
        ...
        AbstractC3255y.i(deferredAnimation, "deferredAnimation");
    ...
    public /* synthetic */ Transition(MutableTransitionState mutableTransitionState, String str, int i8, AbstractC3247p abstractC3247p) {
