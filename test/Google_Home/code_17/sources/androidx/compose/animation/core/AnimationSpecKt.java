...
public final class AnimationSpecKt {
    ...
    public static final /* synthetic */ InfiniteRepeatableSpec infiniteRepeatable(DurationBasedAnimationSpec animation, RepeatMode repeatMode) {
        ...
        return new InfiniteRepeatableSpec(animation, repeatMode, StartOffset.m237constructorimpl$default(0, 0, 2, null), (AbstractC3247p) null);
    }
    ...
    public static final <T> InfiniteRepeatableSpec<T> m215infiniteRepeatable9IiC70o(DurationBasedAnimationSpec<T> animation, RepeatMode repeatMode, long j8) {
        AbstractC3255y.i(animation, "animation");
        AbstractC3255y.i(repeatMode, "repeatMode");
        return new InfiniteRepeatableSpec<>(animation, repeatMode, j8, (AbstractC3247p) null);
    }

    /* renamed from: infiniteRepeatable-9IiC70o$default, reason: not valid java name */
    public static /* synthetic */ InfiniteRepeatableSpec m216infiniteRepeatable9IiC70o$default(DurationBasedAnimationSpec durationBasedAnimationSpec, RepeatMode repeatMode, long j8, int i8, Object obj) {
        if ((i8 & 2) != 0) {
            repeatMode = RepeatMode.Restart;
        }
        if ((i8 & 4) != 0) {
            j8 = StartOffset.m237constructorimpl$default(0, 0, 2, null);
        }
        return m215infiniteRepeatable9IiC70o(durationBasedAnimationSpec, repeatMode, j8);
    }
    ...
    public static final /* synthetic */ RepeatableSpec repeatable(int i8, DurationBasedAnimationSpec animation, RepeatMode repeatMode) {
        AbstractC3255y.i(animation, "animation");
        AbstractC3255y.i(repeatMode, "repeatMode");
        return new RepeatableSpec(i8, animation, repeatMode, StartOffset.m237constructorimpl$default(0, 0, 2, null), (AbstractC3247p) null);
    }
    ...
    public static final <T> RepeatableSpec<T> m217repeatable91I0pcU(int i8, DurationBasedAnimationSpec<T> animation, RepeatMode repeatMode, long j8) {
        AbstractC3255y.i(animation, "animation");
        AbstractC3255y.i(repeatMode, "repeatMode");
        return new RepeatableSpec<>(i8, animation, repeatMode, j8, (AbstractC3247p) null);
    }

    /* renamed from: repeatable-91I0pcU$default, reason: not valid java name */
    public static /* synthetic */ RepeatableSpec m218repeatable91I0pcU$default(int i8, DurationBasedAnimationSpec durationBasedAnimationSpec, RepeatMode repeatMode, long j8, int i9, Object obj) {
        if ((i9 & 4) != 0) {
            repeatMode = RepeatMode.Restart;
        }
        if ((i9 & 8) != 0) {
        ...
        return m217repeatable91I0pcU(i8, durationBasedAnimationSpec, repeatMode, j8);
    }
