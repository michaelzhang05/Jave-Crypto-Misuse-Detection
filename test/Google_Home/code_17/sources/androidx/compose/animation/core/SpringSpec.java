...
public final class SpringSpec<T> implements FiniteAnimationSpec<T> {
    ...
    public boolean equals(Object obj) {
        ...
        if (springSpec.dampingRatio != this.dampingRatio || springSpec.stiffness != this.stiffness || !AbstractC3255y.d(springSpec.visibilityThreshold, this.visibilityThreshold)) {
            return false;
        }
        return true;
    }
    ...
    public /* synthetic */ SpringSpec(float f8, float f9, Object obj, int i8, AbstractC3247p abstractC3247p) {
