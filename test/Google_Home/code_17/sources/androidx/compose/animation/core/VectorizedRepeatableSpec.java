...
public final class VectorizedRepeatableSpec<V extends AnimationVector> implements VectorizedFiniteAnimationSpec<V> {
    ...
    public /* synthetic */ VectorizedRepeatableSpec(int i8, VectorizedDurationBasedAnimationSpec vectorizedDurationBasedAnimationSpec, RepeatMode repeatMode, long j8, AbstractC3247p abstractC3247p) {
    ...
    public /* synthetic */ VectorizedRepeatableSpec(int i8, VectorizedDurationBasedAnimationSpec vectorizedDurationBasedAnimationSpec, RepeatMode repeatMode, long j8, int i9, AbstractC3247p abstractC3247p) {
        this(i8, vectorizedDurationBasedAnimationSpec, (i9 & 4) != 0 ? RepeatMode.Restart : repeatMode, (i9 & 8) != 0 ? StartOffset.m237constructorimpl$default(0, 0, 2, null) : j8, (AbstractC3247p) null);
    }

    public /* synthetic */ VectorizedRepeatableSpec(int i8, VectorizedDurationBasedAnimationSpec vectorizedDurationBasedAnimationSpec, RepeatMode repeatMode, int i9, AbstractC3247p abstractC3247p) {
