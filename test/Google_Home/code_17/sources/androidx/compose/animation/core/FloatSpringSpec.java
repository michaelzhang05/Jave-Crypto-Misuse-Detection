...
public final class FloatSpringSpec implements FloatAnimationSpec {
    ...
    public float getValueFromNanos(long j8, float f8, float f9, float f10) {
        ...
        return Motion.m227getValueimpl(this.spring.m233updateValuesIJZedt4$animation_core_release(f8, f10, j8 / 1000000));
    }

    @Override // androidx.compose.animation.core.FloatAnimationSpec
    public float getVelocityFromNanos(long j8, float f8, float f9, float f10) {
        this.spring.setFinalPosition(f9);
        return Motion.m228getVelocityimpl(this.spring.m233updateValuesIJZedt4$animation_core_release(f8, f10, j8 / 1000000));
    }
    ...
    public /* synthetic */ FloatSpringSpec(float f8, float f9, float f10, int i8, AbstractC3247p abstractC3247p) {
