...
public final class VectorizedKeyframesSpec<V extends AnimationVector> implements VectorizedDurationBasedAnimationSpec<V> {
    ...
    public VectorizedKeyframesSpec(Map<Integer, ? extends r> keyframes, int i8, int i9) {
        AbstractC3255y.i(keyframes, "keyframes");
    ...
    public V getVelocityFromNanos(long j8, V initialValue, V targetValue, V initialVelocity) {
        ...
        while (true) {
            ...
            if (v9 == null) {
                AbstractC3255y.y("velocityVector");
            } else {
                v8 = v9;
            }
    ...
    public /* synthetic */ VectorizedKeyframesSpec(Map map, int i8, int i9, int i10, AbstractC3247p abstractC3247p) {
