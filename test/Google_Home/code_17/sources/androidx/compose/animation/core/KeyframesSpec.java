...
public final class KeyframesSpec<T> implements DurationBasedAnimationSpec<T> {
    ...
    public static final class KeyframesSpecConfig<T> {
        ...
        public final KeyframeEntity<T> atFraction(T t8, float f8) {
            return at(t8, AbstractC2055a.d(this.durationMillis * f8));
        }

        public boolean equals(Object obj) {
            if (obj instanceof KeyframesSpecConfig) {
                KeyframesSpecConfig keyframesSpecConfig = (KeyframesSpecConfig) obj;
                if (this.delayMillis == keyframesSpecConfig.delayMillis && this.durationMillis == keyframesSpecConfig.durationMillis && AbstractC3255y.d(this.keyframes, keyframesSpecConfig.keyframes)) {
                    return true;
                }
            }
            return false;
        ...
        public final void with(KeyframeEntity<T> keyframeEntity, Easing easing) {
            AbstractC3255y.i(keyframeEntity, "<this>");
    ...
    public boolean equals(Object obj) {
        if ((obj instanceof KeyframesSpec) && AbstractC3255y.d(this.config, ((KeyframesSpec) obj).config)) {
            return true;
        }
        return false;
    }
    ...
    public static final class KeyframeEntity<T> {
        ...
        public boolean equals(Object obj) {
            if (obj instanceof KeyframeEntity) {
                ...
                if (AbstractC3255y.d(keyframeEntity.value, this.value) && AbstractC3255y.d(keyframeEntity.easing, this.easing)) {
                    return true;
                }
            }
            return false;
        ...
        public /* synthetic */ KeyframeEntity(Object obj, Easing easing, int i8, AbstractC3247p abstractC3247p) {
