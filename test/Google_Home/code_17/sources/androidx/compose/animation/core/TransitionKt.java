...
public final class TransitionKt {
    ...
    public static final <S> State<Dp> animateDp(Transition<S> transition, InterfaceC1669o interfaceC1669o, String str, InterfaceC1669o targetValueByState, Composer composer, int i8, int i9) {
        ...
        if ((i9 & 1) != 0) {
            interfaceC1669o = TransitionKt$animateDp$1.INSTANCE;
        }
        if ((i9 & 2) != 0) {
            str = "DpAnimation";
        }
        ...
        int i13 = (i12 >> 9) & 112;
        State<Dp> createTransitionAnimation = createTransitionAnimation(transition, targetValueByState.invoke(transition.getCurrentState(), composer, Integer.valueOf(i13)), targetValueByState.invoke(transition.getTargetState(), composer, Integer.valueOf(i13)), (FiniteAnimationSpec) interfaceC1669o.invoke(transition.getSegment(), composer, Integer.valueOf((i12 >> 3) & 112)), vectorConverter, str2, composer, (i12 & 14) | ((i12 << 6) & 458752));
    ...
    @Composable
    @ComposableInferredTarget(scheme = "[0[0][0]]")
    public static final <S> State<Float> animateFloat(Transition<S> transition, InterfaceC1669o interfaceC1669o, String str, InterfaceC1669o targetValueByState, Composer composer, int i8, int i9) {
        AbstractC3255y.i(transition, "<this>");
        AbstractC3255y.i(targetValueByState, "targetValueByState");
        composer.startReplaceableGroup(-1338768149);
        if ((i9 & 1) != 0) {
            interfaceC1669o = TransitionKt$animateFloat$1.INSTANCE;
        }
        if ((i9 & 2) != 0) {
            str = "FloatAnimation";
        }
        String str2 = str;
        TwoWayConverter<Float, AnimationVector1D> vectorConverter = VectorConvertersKt.getVectorConverter(r.f34191a);
        int i10 = i8 & 14;
        int i11 = i8 << 3;
        int i12 = i10 | (i11 & 896) | (i11 & 7168) | (i11 & 57344);
        composer.startReplaceableGroup(-142660079);
    ...
    @Composable
    @ComposableInferredTarget(scheme = "[0[0][0]]")
    public static final <S> State<Integer> animateInt(Transition<S> transition, InterfaceC1669o interfaceC1669o, String str, InterfaceC1669o targetValueByState, Composer composer, int i8, int i9) {
        AbstractC3255y.i(transition, "<this>");
        AbstractC3255y.i(targetValueByState, "targetValueByState");
        composer.startReplaceableGroup(1318902782);
        if ((i9 & 1) != 0) {
            interfaceC1669o = TransitionKt$animateInt$1.INSTANCE;
        }
        if ((i9 & 2) != 0) {
            str = "IntAnimation";
        }
        ...
        composer.startReplaceableGroup(-142660079);
        int i13 = (i12 >> 9) & 112;
        State<Integer> createTransitionAnimation = createTransitionAnimation(transition, targetValueByState.invoke(transition.getCurrentState(), composer, Integer.valueOf(i13)), targetValueByState.invoke(transition.getTargetState(), composer, Integer.valueOf(i13)), (FiniteAnimationSpec) interfaceC1669o.invoke(transition.getSegment(), composer, Integer.valueOf((i12 >> 3) & 112)), vectorConverter, str2, composer, (i12 & 14) | ((i12 << 6) & 458752));
        composer.endReplaceableGroup();
        composer.endReplaceableGroup();
        return createTransitionAnimation;
    }
    ...
    @Composable
    @ComposableInferredTarget(scheme = "[0[0][0]]")
    public static final <S> State<IntOffset> animateIntOffset(Transition<S> transition, InterfaceC1669o interfaceC1669o, String str, InterfaceC1669o targetValueByState, Composer composer, int i8, int i9) {
        AbstractC3255y.i(transition, "<this>");
        AbstractC3255y.i(targetValueByState, "targetValueByState");
        composer.startReplaceableGroup(776131825);
        if ((i9 & 1) != 0) {
            interfaceC1669o = TransitionKt$animateIntOffset$1.INSTANCE;
        }
        if ((i9 & 2) != 0) {
        ...
        composer.startReplaceableGroup(-142660079);
        int i13 = (i12 >> 9) & 112;
        State<IntOffset> createTransitionAnimation = createTransitionAnimation(transition, targetValueByState.invoke(transition.getCurrentState(), composer, Integer.valueOf(i13)), targetValueByState.invoke(transition.getTargetState(), composer, Integer.valueOf(i13)), (FiniteAnimationSpec) interfaceC1669o.invoke(transition.getSegment(), composer, Integer.valueOf((i12 >> 3) & 112)), vectorConverter, str2, composer, (i12 & 14) | ((i12 << 6) & 458752));
        composer.endReplaceableGroup();
        composer.endReplaceableGroup();
        return createTransitionAnimation;
    }
    ...
    @Composable
    @ComposableInferredTarget(scheme = "[0[0][0]]")
    public static final <S> State<IntSize> animateIntSize(Transition<S> transition, InterfaceC1669o interfaceC1669o, String str, InterfaceC1669o targetValueByState, Composer composer, int i8, int i9) {
        AbstractC3255y.i(transition, "<this>");
        AbstractC3255y.i(targetValueByState, "targetValueByState");
        composer.startReplaceableGroup(-2104123233);
        if ((i9 & 1) != 0) {
            interfaceC1669o = TransitionKt$animateIntSize$1.INSTANCE;
        }
        if ((i9 & 2) != 0) {
    ...
    @Composable
    @ComposableInferredTarget(scheme = "[0[0][0]]")
    public static final <S> State<Offset> animateOffset(Transition<S> transition, InterfaceC1669o interfaceC1669o, String str, InterfaceC1669o targetValueByState, Composer composer, int i8, int i9) {
        AbstractC3255y.i(transition, "<this>");
        AbstractC3255y.i(targetValueByState, "targetValueByState");
        composer.startReplaceableGroup(2078477582);
        if ((i9 & 1) != 0) {
            interfaceC1669o = TransitionKt$animateOffset$1.INSTANCE;
        }
        if ((i9 & 2) != 0) {
            str = "OffsetAnimation";
        }
        ...
        composer.startReplaceableGroup(-142660079);
        int i13 = (i12 >> 9) & 112;
        State<Offset> createTransitionAnimation = createTransitionAnimation(transition, targetValueByState.invoke(transition.getCurrentState(), composer, Integer.valueOf(i13)), targetValueByState.invoke(transition.getTargetState(), composer, Integer.valueOf(i13)), (FiniteAnimationSpec) interfaceC1669o.invoke(transition.getSegment(), composer, Integer.valueOf((i12 >> 3) & 112)), vectorConverter, str2, composer, (i12 & 14) | ((i12 << 6) & 458752));
        composer.endReplaceableGroup();
        composer.endReplaceableGroup();
        return createTransitionAnimation;
    }
    ...
    @Composable
    @ComposableInferredTarget(scheme = "[0[0][0]]")
    public static final <S> State<Rect> animateRect(Transition<S> transition, InterfaceC1669o interfaceC1669o, String str, InterfaceC1669o targetValueByState, Composer composer, int i8, int i9) {
        AbstractC3255y.i(transition, "<this>");
        AbstractC3255y.i(targetValueByState, "targetValueByState");
        composer.startReplaceableGroup(1496278239);
        if ((i9 & 1) != 0) {
            interfaceC1669o = TransitionKt$animateRect$1.INSTANCE;
        }
        if ((i9 & 2) != 0) {
            str = "RectAnimation";
        }
        ...
        composer.startReplaceableGroup(-142660079);
        int i13 = (i12 >> 9) & 112;
        State<Rect> createTransitionAnimation = createTransitionAnimation(transition, targetValueByState.invoke(transition.getCurrentState(), composer, Integer.valueOf(i13)), targetValueByState.invoke(transition.getTargetState(), composer, Integer.valueOf(i13)), (FiniteAnimationSpec) interfaceC1669o.invoke(transition.getSegment(), composer, Integer.valueOf((i12 >> 3) & 112)), vectorConverter, str2, composer, (i12 & 14) | ((i12 << 6) & 458752));
        composer.endReplaceableGroup();
        composer.endReplaceableGroup();
        return createTransitionAnimation;
    }
    ...
    @Composable
    @ComposableInferredTarget(scheme = "[0[0][0]]")
    public static final <S> State<Size> animateSize(Transition<S> transition, InterfaceC1669o interfaceC1669o, String str, InterfaceC1669o targetValueByState, Composer composer, int i8, int i9) {
        AbstractC3255y.i(transition, "<this>");
        AbstractC3255y.i(targetValueByState, "targetValueByState");
        composer.startReplaceableGroup(-802210820);
        if ((i9 & 1) != 0) {
            interfaceC1669o = TransitionKt$animateSize$1.INSTANCE;
        }
        if ((i9 & 2) != 0) {
            str = "SizeAnimation";
        }
        ...
        composer.startReplaceableGroup(-142660079);
        int i13 = (i12 >> 9) & 112;
        State<Size> createTransitionAnimation = createTransitionAnimation(transition, targetValueByState.invoke(transition.getCurrentState(), composer, Integer.valueOf(i13)), targetValueByState.invoke(transition.getTargetState(), composer, Integer.valueOf(i13)), (FiniteAnimationSpec) interfaceC1669o.invoke(transition.getSegment(), composer, Integer.valueOf((i12 >> 3) & 112)), vectorConverter, str2, composer, (i12 & 14) | ((i12 << 6) & 458752));
        composer.endReplaceableGroup();
        composer.endReplaceableGroup();
        return createTransitionAnimation;
    }
    ...
    @Composable
    @ComposableInferredTarget(scheme = "[0[0][0]]")
    public static final <S, T, V extends AnimationVector> State<T> animateValue(Transition<S> transition, TwoWayConverter<T, V> typeConverter, InterfaceC1669o interfaceC1669o, String str, InterfaceC1669o targetValueByState, Composer composer, int i8, int i9) {
        AbstractC3255y.i(transition, "<this>");
        AbstractC3255y.i(typeConverter, "typeConverter");
        AbstractC3255y.i(targetValueByState, "targetValueByState");
        composer.startReplaceableGroup(-142660079);
        if ((i9 & 2) != 0) {
            interfaceC1669o = TransitionKt$animateValue$1.INSTANCE;
        }
        if ((i9 & 4) != 0) {
            str = "ValueAnimation";
        }
        int i10 = (i8 >> 9) & 112;
        State<T> createTransitionAnimation = createTransitionAnimation(transition, targetValueByState.invoke(transition.getCurrentState(), composer, Integer.valueOf(i10)), targetValueByState.invoke(transition.getTargetState(), composer, Integer.valueOf(i10)), (FiniteAnimationSpec) interfaceC1669o.invoke(transition.getSegment(), composer, Integer.valueOf((i8 >> 3) & 112)), typeConverter, str, composer, (i8 & 14) | (57344 & (i8 << 9)) | ((i8 << 6) & 458752));
        composer.endReplaceableGroup();
        return createTransitionAnimation;
    }
    ...
    public static final <S, T> Transition<T> createChildTransition(Transition<S> transition, String str, InterfaceC1669o transformToChildState, Composer composer, int i8, int i9) {
        AbstractC3255y.i(transition, "<this>");
        AbstractC3255y.i(transformToChildState, "transformToChildState");
    ...
    public static final <S, T> Transition<T> createChildTransitionInternal(Transition<S> transition, T t8, T t9, String childLabel, Composer composer, int i8) {
        AbstractC3255y.i(transition, "<this>");
        AbstractC3255y.i(childLabel, "childLabel");
    ...
    public static final <T> Transition<T> updateTransition(MutableTransitionState<T> transitionState, String str, Composer composer, int i8, int i9) {
        AbstractC3255y.i(transitionState, "transitionState");
