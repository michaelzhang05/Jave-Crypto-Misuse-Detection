...
final class AnimatedEnterExitMeasurePolicy implements MeasurePolicy {
    ...
    public int maxIntrinsicHeight(IntrinsicMeasureScope intrinsicMeasureScope, List<? extends IntrinsicMeasurable> measurables, int i8) {
        ...
        Integer num = (Integer) AbstractC3001j.A(AbstractC3001j.y(AbstractC1378t.c0(measurables), new AnimatedEnterExitMeasurePolicy$maxIntrinsicHeight$1(i8)));
        if (num != null) {
            return num.intValue();
        }
        return 0;
    ...
    public int maxIntrinsicWidth(IntrinsicMeasureScope intrinsicMeasureScope, List<? extends IntrinsicMeasurable> measurables, int i8) {
        AbstractC3255y.i(intrinsicMeasureScope, "<this>");
        AbstractC3255y.i(measurables, "measurables");
        Integer num = (Integer) AbstractC3001j.A(AbstractC3001j.y(AbstractC1378t.c0(measurables), new AnimatedEnterExitMeasurePolicy$maxIntrinsicWidth$1(i8)));
        if (num != null) {
            return num.intValue();
        }
        return 0;
    ...
    public MeasureResult mo137measure3p2s80s(MeasureScope measure, List<? extends Measurable> measurables, long j8) {
        ...
        this.scope.getTargetSize$animation_release().setValue(IntSize.m5341boximpl(IntSizeKt.IntSize(i8, i9)));
    ...
    public int minIntrinsicHeight(IntrinsicMeasureScope intrinsicMeasureScope, List<? extends IntrinsicMeasurable> measurables, int i8) {
        AbstractC3255y.i(intrinsicMeasureScope, "<this>");
        AbstractC3255y.i(measurables, "measurables");
        Integer num = (Integer) AbstractC3001j.A(AbstractC3001j.y(AbstractC1378t.c0(measurables), new AnimatedEnterExitMeasurePolicy$minIntrinsicHeight$1(i8)));
        if (num != null) {
            return num.intValue();
        }
        return 0;
    ...
    public int minIntrinsicWidth(IntrinsicMeasureScope intrinsicMeasureScope, List<? extends IntrinsicMeasurable> measurables, int i8) {
        AbstractC3255y.i(intrinsicMeasureScope, "<this>");
        AbstractC3255y.i(measurables, "measurables");
        Integer num = (Integer) AbstractC3001j.A(AbstractC3001j.y(AbstractC1378t.c0(measurables), new AnimatedEnterExitMeasurePolicy$minIntrinsicWidth$1(i8)));
        if (num != null) {
            return num.intValue();
        }
        return 0;
