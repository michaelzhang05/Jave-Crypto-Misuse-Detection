...
public final class AnimatedContentKt$AnimatedContent$6$1 extends AbstractC3256z implements InterfaceC1668n {
    ...
    public static final class AnonymousClass1 extends AbstractC3256z implements InterfaceC1669o {
        ...
        /* loaded from: classes.dex */
        public static final class C02891 extends AbstractC3256z implements Function1 {
            final /* synthetic */ Placeable $placeable;
            final /* synthetic */ ContentTransform $specOnEnter;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C02891(Placeable placeable, ContentTransform contentTransform) {
                super(1);
        ...
        public /* bridge */ /* synthetic */ Object invoke(Object obj, Object obj2, Object obj3) {
            return m135invoke3p2s80s((MeasureScope) obj, (Measurable) obj2, ((Constraints) obj3).m5157unboximpl());
        }

        /* renamed from: invoke-3p2s80s, reason: not valid java name */
        public final MeasureResult m135invoke3p2s80s(MeasureScope layout, Measurable measurable, long j8) {
            AbstractC3255y.i(layout, "$this$layout");
            AbstractC3255y.i(measurable, "measurable");
            Placeable mo4136measureBRTryo0 = measurable.mo4136measureBRTryo0(j8);
            return MeasureScope.CC.q(layout, mo4136measureBRTryo0.getWidth(), mo4136measureBRTryo0.getHeight(), null, new C02891(mo4136measureBRTryo0, this.$specOnEnter), 4, null);
        }
    }
    ...
    public static final class AnonymousClass3 extends AbstractC3256z implements Function1 {
        ...
        public final Boolean invoke(S s8) {
            return Boolean.valueOf(AbstractC3255y.d(s8, this.$stateForContent));
        }
    }
    ...
    public static final class AnonymousClass4 extends AbstractC3256z implements InterfaceC1669o {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        AnonymousClass4(AnimatedContentTransitionScopeImpl<S> animatedContentTransitionScopeImpl, S s8, SnapshotStateList<S> snapshotStateList, InterfaceC1670p interfaceC1670p, int i8) {
            super(3);
            this.$rootScope = animatedContentTransitionScopeImpl;
            this.$stateForContent = s8;
            this.$currentlyVisible = snapshotStateList;
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public AnimatedContentKt$AnimatedContent$6$1(Transition<S> transition, S s8, int i8, Function1 function1, AnimatedContentTransitionScopeImpl<S> animatedContentTransitionScopeImpl, SnapshotStateList<S> snapshotStateList, InterfaceC1670p interfaceC1670p) {
        super(2);
    ...
    public final void invoke(Composer composer, int i8) {
        ...
        Boolean valueOf = Boolean.valueOf(AbstractC3255y.d(this.$this_AnimatedContent.getSegment().getTargetState(), this.$stateForContent));
        ...
        if (changed || rememberedValue2 == companion.getEmpty()) {
            if (AbstractC3255y.d(transition.getSegment().getTargetState(), s8)) {
        ...
        if (rememberedValue3 == companion.getEmpty()) {
            rememberedValue3 = new AnimatedContentTransitionScopeImpl.ChildData(AbstractC3255y.d(s9, transition2.getTargetState()));
        ...
        childData.setTarget(AbstractC3255y.d(this.$stateForContent, this.$this_AnimatedContent.getTargetState()));
