...
public final class AnimatedContentMeasurePolicy implements MeasurePolicy {
    ...
    public AnimatedContentMeasurePolicy(AnimatedContentTransitionScopeImpl<?> rootScope) {
        AbstractC3255y.i(rootScope, "rootScope");
    ...
    public int maxIntrinsicHeight(IntrinsicMeasureScope intrinsicMeasureScope, List<? extends IntrinsicMeasurable> measurables, int i8) {
        ...
        Integer num = (Integer) AbstractC3001j.A(AbstractC3001j.y(AbstractC1378t.c0(measurables), new AnimatedContentMeasurePolicy$maxIntrinsicHeight$1(i8)));
        if (num != null) {
            return num.intValue();
        }
        return 0;
    ...
    public int maxIntrinsicWidth(IntrinsicMeasureScope intrinsicMeasureScope, List<? extends IntrinsicMeasurable> measurables, int i8) {
        AbstractC3255y.i(intrinsicMeasureScope, "<this>");
        AbstractC3255y.i(measurables, "measurables");
        Integer num = (Integer) AbstractC3001j.A(AbstractC3001j.y(AbstractC1378t.c0(measurables), new AnimatedContentMeasurePolicy$maxIntrinsicWidth$1(i8)));
        if (num != null) {
            return num.intValue();
        }
        return 0;
    ...
    public MeasureResult mo137measure3p2s80s(MeasureScope measure, List<? extends Measurable> measurables, long j8) {
        ...
        while (true) {
            ...
            if (childData != null && childData.isTarget()) {
                placeableArr[i14] = measurable.mo4136measureBRTryo0(j8);
            }
            i14++;
        }
        ...
        for (int i15 = 0; i15 < size3; i15++) {
            ...
            if (placeableArr[i15] == null) {
                placeableArr[i15] = measurable2.mo4136measureBRTryo0(j8);
            }
        }
        if (size == 0) {
            placeable2 = null;
            ...
            int i02 = AbstractC1371l.i0(placeableArr);
            if (i02 != 0) {
                if (placeable2 != null) {
        ...
        if (size != 0) {
            ...
            int i03 = AbstractC1371l.i0(placeableArr);
            if (i03 != 0) {
                if (placeable != null) {
        ...
        this.rootScope.m160setMeasuredSizeozmzZPI$animation_release(IntSizeKt.IntSize(i10, i11));
    ...
    public int minIntrinsicHeight(IntrinsicMeasureScope intrinsicMeasureScope, List<? extends IntrinsicMeasurable> measurables, int i8) {
        AbstractC3255y.i(intrinsicMeasureScope, "<this>");
        AbstractC3255y.i(measurables, "measurables");
        Integer num = (Integer) AbstractC3001j.A(AbstractC3001j.y(AbstractC1378t.c0(measurables), new AnimatedContentMeasurePolicy$minIntrinsicHeight$1(i8)));
        if (num != null) {
            return num.intValue();
        }
        return 0;
    ...
    public int minIntrinsicWidth(IntrinsicMeasureScope intrinsicMeasureScope, List<? extends IntrinsicMeasurable> measurables, int i8) {
        AbstractC3255y.i(intrinsicMeasureScope, "<this>");
        AbstractC3255y.i(measurables, "measurables");
        Integer num = (Integer) AbstractC3001j.A(AbstractC3001j.y(AbstractC1378t.c0(measurables), new AnimatedContentMeasurePolicy$minIntrinsicWidth$1(i8)));
        if (num != null) {
            return num.intValue();
        }
        return 0;
