...
public final class SlideModifier extends LayoutModifierWithPassThroughIntrinsics {
    ...
    public SlideModifier(Transition<EnterExitState>.DeferredAnimation<IntOffset, AnimationVector2D> lazyAnimation, State<Slide> slideIn, State<Slide> slideOut) {
        AbstractC3255y.i(lazyAnimation, "lazyAnimation");
        AbstractC3255y.i(slideIn, "slideIn");
        AbstractC3255y.i(slideOut, "slideOut");
    ...
    public MeasureResult mo161measure3p2s80s(MeasureScope measure, Measurable measurable, long j8) {
        ...
        return MeasureScope.CC.q(measure, mo4136measureBRTryo0.getWidth(), mo4136measureBRTryo0.getHeight(), null, new SlideModifier$measure$1(this, mo4136measureBRTryo0, IntSizeKt.IntSize(mo4136measureBRTryo0.getWidth(), mo4136measureBRTryo0.getHeight())), 4, null);
    }

    /* renamed from: targetValueByState-oFUgxo0, reason: not valid java name */
    public final long m200targetValueByStateoFUgxo0(EnterExitState targetState, long j8) {
        long m5317getZeronOccac;
        long m5317getZeronOccac2;
        ...
        if (value != null && (slideOffset2 = value.getSlideOffset()) != null) {
            m5317getZeronOccac = ((IntOffset) slideOffset2.invoke(IntSize.m5341boximpl(j8))).m5316unboximpl();
        } else {
        ...
        if (value2 != null && (slideOffset = value2.getSlideOffset()) != null) {
            m5317getZeronOccac2 = ((IntOffset) slideOffset.invoke(IntSize.m5341boximpl(j8))).m5316unboximpl();
        } else {
            m5317getZeronOccac2 = IntOffset.Companion.m5317getZeronOccac();
        }
