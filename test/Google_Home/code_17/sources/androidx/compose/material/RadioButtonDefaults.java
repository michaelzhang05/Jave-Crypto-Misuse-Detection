...
public final class RadioButtonDefaults {
    ...
    public final RadioButtonColors m1324colorsRGew2ao(long j8, long j9, long j10, Composer composer, int i8, int i9) {
        long j11;
        long j12;
        long j13;
        composer.startReplaceableGroup(1370708026);
        if ((i9 & 1) != 0) {
            j11 = MaterialTheme.INSTANCE.getColors(composer, 6).m1185getSecondary0d7_KjU();
        } else {
            j11 = j8;
        }
        if ((i9 & 2) != 0) {
            j12 = Color.m2975copywmQWz5c$default(MaterialTheme.INSTANCE.getColors(composer, 6).m1182getOnSurface0d7_KjU(), 0.6f, 0.0f, 0.0f, 0.0f, 14, null);
        } else {
            j12 = j9;
        }
        if ((i9 & 4) != 0) {
        ...
        Color m2966boximpl2 = Color.m2966boximpl(j12);
        Color m2966boximpl3 = Color.m2966boximpl(j13);
