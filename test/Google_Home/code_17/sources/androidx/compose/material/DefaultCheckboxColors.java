...
public final class DefaultCheckboxColors implements CheckboxColors {
    ...
    public /* synthetic */ DefaultCheckboxColors(long j8, long j9, long j10, long j11, long j12, long j13, long j14, long j15, long j16, long j17, long j18, AbstractC3247p abstractC3247p) {
    ...
    public State<Color> borderColor(boolean z8, ToggleableState state, Composer composer, int i8) {
        ...
        if (z8) {
            ...
            rememberUpdatedState = SingleValueAnimationKt.m192animateColorAsStateeuL9pac(j9, AnimationSpecKt.tween$default(i9, 0, null, 6, null), null, null, composer, 0, 12);
    ...
    public State<Color> checkmarkColor(ToggleableState state, Composer composer, int i8) {
        ...
        State<Color> m192animateColorAsStateeuL9pac = SingleValueAnimationKt.m192animateColorAsStateeuL9pac(j9, AnimationSpecKt.tween$default(i9, 0, null, 6, null), null, null, composer, 0, 12);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
