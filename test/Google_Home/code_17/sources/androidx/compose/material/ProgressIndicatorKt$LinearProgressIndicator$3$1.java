...
public final class ProgressIndicatorKt$LinearProgressIndicator$3$1 extends AbstractC3256z implements Function1 {
    ...
    public final void invoke(DrawScope Canvas) {
        ...
        if (LinearProgressIndicator_2cYBFYY$lambda$1 - LinearProgressIndicator_2cYBFYY$lambda$2 > 0.0f) {
            ...
            ProgressIndicatorKt.m1322drawLinearIndicatorqYKTg0g(Canvas, LinearProgressIndicator_2cYBFYY$lambda$12, LinearProgressIndicator_2cYBFYY$lambda$22, this.$color, m2806getHeightimpl, this.$strokeCap);
        }
        ...
        if (LinearProgressIndicator_2cYBFYY$lambda$3 - LinearProgressIndicator_2cYBFYY$lambda$4 > 0.0f) {
            ...
            ProgressIndicatorKt.m1322drawLinearIndicatorqYKTg0g(Canvas, LinearProgressIndicator_2cYBFYY$lambda$32, LinearProgressIndicator_2cYBFYY$lambda$42, this.$color, m2806getHeightimpl, this.$strokeCap);
        }
    }
}
