...
public final class DefaultButtonElevation implements ButtonElevation {
    ...
    public /* synthetic */ DefaultButtonElevation(float f8, float f9, float f10, float f11, float f12, AbstractC3247p abstractC3247p) {
    ...
    public State<Dp> elevation(boolean z8, InteractionSource interactionSource, Composer composer, int i8) {
        ...
        if (rememberedValue3 == companion.getEmpty()) {
            rememberedValue3 = new Animatable(Dp.m5181boximpl(f9), VectorConvertersKt.getVectorConverter(Dp.Companion), null, null, 12, null);
        ...
        if (!z8) {
            ...
            EffectsKt.LaunchedEffect(Dp.m5181boximpl(f9), new DefaultButtonElevation$elevation$2(animatable, f9, null), composer, 64);
            composer.endReplaceableGroup();
        } else {
            composer.startReplaceableGroup(-1598807146);
            EffectsKt.LaunchedEffect(Dp.m5181boximpl(f9), new DefaultButtonElevation$elevation$3(animatable, this, f9, interaction, null), composer, 64);
            composer.endReplaceableGroup();
        }
