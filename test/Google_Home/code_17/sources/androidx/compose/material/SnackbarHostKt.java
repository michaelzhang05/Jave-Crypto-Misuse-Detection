...
public final class SnackbarHostKt {
    ...
    */
    public static final void FadeInFadeOutWithScale(androidx.compose.material.SnackbarData r16, androidx.compose.ui.Modifier r17, a6.InterfaceC1669o r18, androidx.compose.runtime.Composer r19, int r20, int r21) {
        /*
            Method dump skipped, instructions count: 555
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.SnackbarHostKt.FadeInFadeOutWithScale(androidx.compose.material.SnackbarData, androidx.compose.ui.Modifier, a6.o, androidx.compose.runtime.Composer, int, int):void");
    }
    ...
    public static final void SnackbarHost(SnackbarHostState hostState, Modifier modifier, InterfaceC1669o interfaceC1669o, Composer composer, int i8, int i9) {
        ...
        if ((i10 & 731) == 146 && startRestartGroup.getSkipping()) {
            ...
            if (i15 != 0) {
                interfaceC1669o = ComposableSingletons$SnackbarHostKt.INSTANCE.m1213getLambda1$material_release();
            }
