...
public final class ModalBottomSheetKt {
    private static final float ModalBottomSheetPositionalThreshold = Dp.m5183constructorimpl(56);
    private static final float ModalBottomSheetVelocityThreshold = Dp.m5183constructorimpl(125);
    private static final float MaxModalBottomSheetWidth = Dp.m5183constructorimpl(640);
    ...
    public static final AnchoredDraggableState.AnchorChangedCallback<ModalBottomSheetValue> ModalBottomSheetAnchorChangeCallback(final ModalBottomSheetState modalBottomSheetState, final M m8) {
        return new AnchoredDraggableState.AnchorChangedCallback<ModalBottomSheetValue>() { // from class: androidx.compose.material.ModalBottomSheetKt$ModalBottomSheetAnchorChangeCallback$1
            ...
            public final void onAnchorsChanged(ModalBottomSheetValue prevTarget, Map<ModalBottomSheetValue, Float> prevAnchors, Map<ModalBottomSheetValue, Float> newAnchors) {
                ...
                if (AbstractC3255y.a(((Number) Q.i(newAnchors, modalBottomSheetValue)).floatValue(), f8)) {
                    return;
                }
                if (ModalBottomSheetState.this.isAnimationRunning$material_release()) {
                    AbstractC3364k.d(m8, null, null, new ModalBottomSheetKt$ModalBottomSheetAnchorChangeCallback$1$onAnchorsChanged$1(ModalBottomSheetState.this, modalBottomSheetValue, null), 3, null);
                } else {
                    if (ModalBottomSheetState.this.trySnapTo$material_release(modalBottomSheetValue)) {
                        return;
                    }
                    AbstractC3364k.d(m8, null, null, new ModalBottomSheetKt$ModalBottomSheetAnchorChangeCallback$1$onAnchorsChanged$2(ModalBottomSheetState.this, modalBottomSheetValue, null), 3, null);
                }
            }
        };
    }
    ...
    */
    public static final void m1282ModalBottomSheetLayoutGs3lGvM(a6.InterfaceC1669o r33, androidx.compose.ui.Modifier r34, androidx.compose.material.ModalBottomSheetState r35, boolean r36, androidx.compose.ui.graphics.Shape r37, float r38, long r39, long r41, long r43, a6.InterfaceC1668n r45, androidx.compose.runtime.Composer r46, int r47, int r48) {
        /*
            Method dump skipped, instructions count: 814
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.ModalBottomSheetKt.m1282ModalBottomSheetLayoutGs3lGvM(a6.o, androidx.compose.ui.Modifier, androidx.compose.material.ModalBottomSheetState, boolean, androidx.compose.ui.graphics.Shape, float, long, long, long, a6.n, androidx.compose.runtime.Composer, int, int):void");
    }
    ...
    public static final void m1283Scrim3JVO9M(long j8, Function0 function0, boolean z8, Composer composer, int i8) {
        int i9;
        float f8;
        Modifier modifier;
        int i10;
        ...
        if ((i9 & 731) == 146 && startRestartGroup.getSkipping()) {
            ...
            if (j8 != Color.Companion.m3012getUnspecified0d7_KjU()) {
                ...
                String m1356getString4foXLRw = Strings_androidKt.m1356getString4foXLRw(Strings.Companion.m1350getCloseSheetUdPEhr4(), startRestartGroup, 6);
                ...
                if (z8) {
                    ...
                    if (changed2 || rememberedValue2 == Composer.Companion.getEmpty()) {
                        rememberedValue2 = new ModalBottomSheetKt$Scrim$dismissModifier$2$1(m1356getString4foXLRw, function0);
    ...
    public static final ModalBottomSheetState rememberModalBottomSheetState(ModalBottomSheetValue initialValue, AnimationSpec<Float> animationSpec, Function1 function1, boolean z8, Composer composer, int i8, int i9) {
        ...
        ModalBottomSheetState modalBottomSheetState = (ModalBottomSheetState) RememberSaveableKt.m2588rememberSaveable(new Object[]{initialValue, animationSpec2, Boolean.valueOf(z9), function12, density}, (Saver) ModalBottomSheetState.Companion.Saver(animationSpec2, function12, z9, density), (String) null, (Function0) new ModalBottomSheetKt$rememberModalBottomSheetState$2(initialValue, density, animationSpec2, function12, z9), composer, 72, 4);
