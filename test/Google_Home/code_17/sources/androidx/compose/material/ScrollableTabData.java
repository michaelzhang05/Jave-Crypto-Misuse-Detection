...
final class ScrollableTabData {
    ...
    private final int calculateTabOffset(TabPosition tabPosition, Density density, int i8, List<TabPosition> list) {
        int mo447roundToPx0680j_4 = density.mo447roundToPx0680j_4(((TabPosition) AbstractC1378t.y0(list)).m1381getRightD9Ej5fM()) + i8;
        int maxValue = mo447roundToPx0680j_4 - this.scrollState.getMaxValue();
        return m.k(density.mo447roundToPx0680j_4(tabPosition.m1380getLeftD9Ej5fM()) - ((maxValue / 2) - (density.mo447roundToPx0680j_4(tabPosition.m1382getWidthD9Ej5fM()) / 2)), 0, m.d(mo447roundToPx0680j_4 - maxValue, 0));
    }
