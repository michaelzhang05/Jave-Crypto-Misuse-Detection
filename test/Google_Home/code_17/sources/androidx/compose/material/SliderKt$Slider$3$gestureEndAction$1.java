...
final class SliderKt$Slider$3$gestureEndAction$1 extends AbstractC3256z implements Function1 {
    ...
    public final void invoke(float f8) {
        ...
        if (floatValue != snapValueToTick) {
            AbstractC3364k.d(this.$scope, null, null, new AnonymousClass1(this.$draggableState, floatValue, snapValueToTick, f8, this.$onValueChangeFinished, null), 3, null);
        } else {
