...
public final class AnchoredDraggableKt {
    ...
    public static final <T> Object animateTo(AnchoredDraggableState<T> anchoredDraggableState, T t8, float f8, d dVar) {
        ...
        if (anchoredDrag$default == T5.b.e()) {
