...
public final class PullRefreshDefaults {
    ...
    private static final float RefreshThreshold = Dp.m5183constructorimpl(80);
    private static final float RefreshingOffset = Dp.m5183constructorimpl(56);

    private PullRefreshDefaults() {
    }

    /* renamed from: getRefreshThreshold-D9Ej5fM, reason: not valid java name */
    public final float m1431getRefreshThresholdD9Ej5fM() {
        return RefreshThreshold;
    }

    /* renamed from: getRefreshingOffset-D9Ej5fM, reason: not valid java name */
    public final float m1432getRefreshingOffsetD9Ej5fM() {
