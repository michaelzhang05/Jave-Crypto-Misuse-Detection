...
public final class PullRefreshStateKt {
    ...
    public static final PullRefreshState m1438rememberPullRefreshStateUuyPYSY(boolean z8, Function0 onRefresh, float f8, float f9, Composer composer, int i8, int i9) {
        AbstractC3255y.i(onRefresh, "onRefresh");
        composer.startReplaceableGroup(-174977512);
        if ((i9 & 4) != 0) {
            f8 = PullRefreshDefaults.INSTANCE.m1431getRefreshThresholdD9Ej5fM();
        }
        if ((i9 & 8) != 0) {
            f9 = PullRefreshDefaults.INSTANCE.m1432getRefreshingOffsetD9Ej5fM();
        }
        ...
        if (Dp.m5182compareTo0680j_4(f8, Dp.m5183constructorimpl(0)) > 0) {
            ...
            p8.f34159a = density.mo453toPx0680j_4(f8);
            p9.f34159a = density.mo453toPx0680j_4(f9);
            composer.startReplaceableGroup(1157296644);
            boolean changed = composer.changed(coroutineScope);
            Object rememberedValue2 = composer.rememberedValue();
            if (changed || rememberedValue2 == companion.getEmpty()) {
                rememberedValue2 = new PullRefreshState(coroutineScope, rememberUpdatedState, p9.f34159a, p8.f34159a);
