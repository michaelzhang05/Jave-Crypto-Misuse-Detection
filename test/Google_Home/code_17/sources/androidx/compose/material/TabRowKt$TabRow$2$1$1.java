...
public final class TabRowKt$TabRow$2$1$1 extends AbstractC3256z implements InterfaceC1668n {
    ...
    @Override // a6.InterfaceC1668n
    public /* bridge */ /* synthetic */ Object invoke(Object obj, Object obj2) {
        return m1391invoke0kLqBqw((SubcomposeMeasureScope) obj, ((Constraints) obj2).m5157unboximpl());
    }

    /* renamed from: invoke-0kLqBqw, reason: not valid java name */
    public final MeasureResult m1391invoke0kLqBqw(SubcomposeMeasureScope SubcomposeLayout, long j8) {
        Object next;
        int i8;
        ...
        int i9 = m5151getMaxWidthimpl / size;
        List<Measurable> list = subcompose;
        ArrayList arrayList = new ArrayList(AbstractC1378t.x(list, 10));
        Iterator<T> it = list.iterator();
        while (it.hasNext()) {
            arrayList.add(((Measurable) it.next()).mo4136measureBRTryo0(Constraints.m5142copyZbe2FdA$default(j8, i9, i9, 0, 0, 12, null)));
        }
        ...
        for (int i10 = 0; i10 < size; i10++) {
            arrayList2.add(new TabPosition(Dp.m5183constructorimpl(SubcomposeLayout.mo450toDpu2uoSUM(i9) * i10), SubcomposeLayout.mo450toDpu2uoSUM(i9), null));
        }
        return MeasureScope.CC.q(SubcomposeLayout, m5151getMaxWidthimpl, i8, null, new AnonymousClass1(arrayList, SubcomposeLayout, this.$divider, i9, j8, i8, this.$indicator, arrayList2, this.$$dirty, m5151getMaxWidthimpl), 4, null);
    }
}
