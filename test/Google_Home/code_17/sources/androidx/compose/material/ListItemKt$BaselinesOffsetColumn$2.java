...
public final class ListItemKt$BaselinesOffsetColumn$2 extends AbstractC3256z implements InterfaceC1668n {
    ...
    public ListItemKt$BaselinesOffsetColumn$2(List<Dp> list, Modifier modifier, InterfaceC1668n interfaceC1668n, int i8, int i9) {
        super(2);
        this.$offsets = list;
