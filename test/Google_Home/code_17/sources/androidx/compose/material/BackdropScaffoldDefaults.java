...
public final class BackdropScaffoldDefaults {
    ...
    private static final float PeekHeight = Dp.m5183constructorimpl(56);
    private static final float HeaderHeight = Dp.m5183constructorimpl(48);
    private static final float FrontLayerElevation = Dp.m5183constructorimpl(1);

    private BackdropScaffoldDefaults() {
    }

    /* renamed from: getFrontLayerElevation-D9Ej5fM, reason: not valid java name */
    public final float m1114getFrontLayerElevationD9Ej5fM() {
    ...
    public final long getFrontLayerScrimColor(Composer composer, int i8) {
        ...
        long m2975copywmQWz5c$default = Color.m2975copywmQWz5c$default(MaterialTheme.INSTANCE.getColors(composer, 6).m1187getSurface0d7_KjU(), 0.6f, 0.0f, 0.0f, 0.0f, 14, null);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final Shape getFrontLayerShape(Composer composer, int i8) {
        ...
        float f8 = 16;
        CornerBasedShape copy$default = CornerBasedShape.copy$default(MaterialTheme.INSTANCE.getShapes(composer, 6).getLarge(), CornerSizeKt.m849CornerSize0680j_4(Dp.m5183constructorimpl(f8)), CornerSizeKt.m849CornerSize0680j_4(Dp.m5183constructorimpl(f8)), null, null, 12, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final float m1115getHeaderHeightD9Ej5fM() {
        return HeaderHeight;
    }

    /* renamed from: getPeekHeight-D9Ej5fM, reason: not valid java name */
    public final float m1116getPeekHeightD9Ej5fM() {
        return PeekHeight;
    }
}
