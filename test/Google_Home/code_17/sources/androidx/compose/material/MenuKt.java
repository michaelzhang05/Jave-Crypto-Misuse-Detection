...
public final class MenuKt {
    ...
    private static final float DropdownMenuItemHorizontalPadding = Dp.m5183constructorimpl(16);
    ...
    static {
        float f8 = 8;
        MenuElevation = Dp.m5183constructorimpl(f8);
        float f9 = 48;
        MenuVerticalMargin = Dp.m5183constructorimpl(f9);
        DropdownMenuVerticalPadding = Dp.m5183constructorimpl(f8);
        DropdownMenuItemDefaultMinHeight = Dp.m5183constructorimpl(f9);
    }
