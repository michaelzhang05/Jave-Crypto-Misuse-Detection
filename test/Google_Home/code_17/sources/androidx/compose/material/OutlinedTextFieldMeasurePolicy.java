...
public final class OutlinedTextFieldMeasurePolicy implements MeasurePolicy {
    ...
    private final int intrinsicHeight(IntrinsicMeasureScope intrinsicMeasureScope, List<? extends IntrinsicMeasurable> list, int i8, InterfaceC1668n interfaceC1668n) {
        ...
        int i11;
        int i12;
        int m1301calculateHeightO3s9Psw;
        ...
        for (Object obj5 : list2) {
            if (AbstractC3255y.d(TextFieldImplKt.getLayoutId((IntrinsicMeasurable) obj5), "TextField")) {
                ...
                m1301calculateHeightO3s9Psw = OutlinedTextFieldKt.m1301calculateHeightO3s9Psw(i11, i10, intValue, i9, i12, this.animationProgress, TextFieldImplKt.getZeroConstraints(), intrinsicMeasureScope.getDensity(), this.paddingValues);
                return m1301calculateHeightO3s9Psw;
            }
        }
    ...
    private final int intrinsicWidth(IntrinsicMeasureScope intrinsicMeasureScope, List<? extends IntrinsicMeasurable> list, int i8, InterfaceC1668n interfaceC1668n) {
        ...
        int i11;
        int i12;
        int m1302calculateWidthO3s9Psw;
        List<? extends IntrinsicMeasurable> list2 = list;
        for (Object obj5 : list2) {
            if (AbstractC3255y.d(TextFieldImplKt.getLayoutId((IntrinsicMeasurable) obj5), "TextField")) {
                int intValue = ((Number) interfaceC1668n.invoke(obj5, Integer.valueOf(i8))).intValue();
                ...
                m1302calculateWidthO3s9Psw = OutlinedTextFieldKt.m1302calculateWidthO3s9Psw(i11, i10, intValue, i9, i12, this.animationProgress, TextFieldImplKt.getZeroConstraints(), intrinsicMeasureScope.getDensity(), this.paddingValues);
                return m1302calculateWidthO3s9Psw;
            }
        }
        throw new NoSuchElementException("Collection contains no element matching the predicate.");
    }
    ...
    public MeasureResult mo137measure3p2s80s(MeasureScope measure, List<? extends Measurable> measurables, long j8) {
        ...
        int i9 = -widthOrZero2;
        int i10 = -mo447roundToPx0680j_4;
        long m5167offsetNN6EwU = ConstraintsKt.m5167offsetNN6EwU(m5142copyZbe2FdA$default, MathHelpersKt.lerp(i9 - mo447roundToPx0680j_42, -mo447roundToPx0680j_42, this.animationProgress), i10);
        ...
        long m5142copyZbe2FdA$default2 = Constraints.m5142copyZbe2FdA$default(ConstraintsKt.m5167offsetNN6EwU(j8, i9, i10 - Math.max(TextFieldImplKt.heightOrZero(placeable3) / 2, measure.mo447roundToPx0680j_4(this.paddingValues.mo558calculateTopPaddingD9Ej5fM()))), 0, 0, 0, 0, 11, null);
        for (Measurable measurable4 : list) {
            if (AbstractC3255y.d(LayoutIdKt.getLayoutId(measurable4), "TextField")) {
                ...
                m1302calculateWidthO3s9Psw = OutlinedTextFieldKt.m1302calculateWidthO3s9Psw(TextFieldImplKt.widthOrZero(placeable), TextFieldImplKt.widthOrZero(placeable2), mo4136measureBRTryo0.getWidth(), TextFieldImplKt.widthOrZero(placeable3), TextFieldImplKt.widthOrZero(placeable4), this.animationProgress, j8, measure.getDensity(), this.paddingValues);
                m1301calculateHeightO3s9Psw = OutlinedTextFieldKt.m1301calculateHeightO3s9Psw(TextFieldImplKt.heightOrZero(placeable), TextFieldImplKt.heightOrZero(placeable2), mo4136measureBRTryo0.getHeight(), TextFieldImplKt.heightOrZero(placeable3), TextFieldImplKt.heightOrZero(placeable4), this.animationProgress, j8, measure.getDensity(), this.paddingValues);
                for (Measurable measurable6 : list) {
                    if (AbstractC3255y.d(LayoutIdKt.getLayoutId(measurable6), OutlinedTextFieldKt.BorderId)) {
                        int i11 = 0;
                        if (m1302calculateWidthO3s9Psw != Integer.MAX_VALUE) {
                            i8 = m1302calculateWidthO3s9Psw;
                        } else {
                            i8 = 0;
                        }
                        if (m1301calculateHeightO3s9Psw != Integer.MAX_VALUE) {
                            i11 = m1301calculateHeightO3s9Psw;
                        }
                        return MeasureScope.CC.q(measure, m1302calculateWidthO3s9Psw, m1301calculateHeightO3s9Psw, null, new OutlinedTextFieldMeasurePolicy$measure$2(m1301calculateHeightO3s9Psw, m1302calculateWidthO3s9Psw, placeable, placeable2, mo4136measureBRTryo0, placeable3, placeable4, measurable6.mo4136measureBRTryo0(ConstraintsKt.Constraints(i8, m1302calculateWidthO3s9Psw, i11, m1301calculateHeightO3s9Psw)), this, measure), 4, null);
                    }
                }
                throw new NoSuchElementException("Collection contains no element matching the predicate.");
            }
