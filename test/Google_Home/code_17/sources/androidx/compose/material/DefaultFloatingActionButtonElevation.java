...
final class DefaultFloatingActionButtonElevation implements FloatingActionButtonElevation {
    ...
    public /* synthetic */ DefaultFloatingActionButtonElevation(float f8, float f9, float f10, float f11, AbstractC3247p abstractC3247p) {
        this(f8, f9, f10, f11);
    }
    ...
    public State<Dp> elevation(InteractionSource interactionSource, Composer composer, int i8) {
        ...
        EffectsKt.LaunchedEffect(Dp.m5181boximpl(f9), new DefaultFloatingActionButtonElevation$elevation$2(animatable, this, f9, interaction, null), composer, 64);
