...
public final class BottomNavigationKt {
    ...
    private static final float BottomNavigationHeight = Dp.m5183constructorimpl(56);
    private static final float BottomNavigationItemHorizontalPadding;
    private static final float CombinedItemTextBaseline;

    static {
        float f8 = 12;
        BottomNavigationItemHorizontalPadding = Dp.m5183constructorimpl(f8);
        CombinedItemTextBaseline = Dp.m5183constructorimpl(f8);
    }
    ...
    */
    public static final void m1128BottomNavigationPEIptTM(androidx.compose.ui.Modifier r24, long r25, long r27, float r29, a6.InterfaceC1669o r30, androidx.compose.runtime.Composer r31, int r32, int r33) {
        /*
            Method dump skipped, instructions count: 362
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.BottomNavigationKt.m1128BottomNavigationPEIptTM(androidx.compose.ui.Modifier, long, long, float, a6.o, androidx.compose.runtime.Composer, int, int):void");
    }

    @Composable
    @ComposableInferredTarget(scheme = "[androidx.compose.ui.UiComposable[androidx.compose.ui.UiComposable][androidx.compose.ui.UiComposable]]")
    /* renamed from: BottomNavigationItem-jY6E1Zs, reason: not valid java name */
    public static final void m1129BottomNavigationItemjY6E1Zs(RowScope BottomNavigationItem, boolean z8, Function0 onClick, InterfaceC1668n icon, Modifier modifier, boolean z9, InterfaceC1668n interfaceC1668n, boolean z10, MutableInteractionSource mutableInteractionSource, long j8, long j9, Composer composer, int i8, int i9, int i10) {
        int i11;
        Modifier modifier2;
        ...
        boolean z14;
        Modifier modifier4;
        AbstractC3255y.i(BottomNavigationItem, "$this$BottomNavigationItem");
        ...
        if (i15 != 0) {
            ...
            interfaceC1668n2 = interfaceC1668n;
            if ((i8 & 3670016) == 0) {
                i11 |= startRestartGroup.changedInstance(interfaceC1668n2) ? 1048576 : 524288;
            }
        }
        int i16 = i10 & 64;
        if (i16 != 0) {
        ...
        if ((1533916891 & i11) == 306783378 && (i12 & 11) == 2 && startRestartGroup.getSkipping()) {
            ...
            if ((i8 & 1) != 0 && !startRestartGroup.getDefaultsInvalid()) {
                ...
                if ((256 & i10) != 0) {
                    j10 = ((Color) startRestartGroup.consume(ContentColorKt.getLocalContentColor())).m2986unboximpl();
                    i11 &= -1879048193;
                } else {
                    j10 = j8;
                }
                if ((i10 & 512) != 0) {
                    j11 = Color.m2975copywmQWz5c$default(j10, ContentAlpha.INSTANCE.getMedium(startRestartGroup, 6), 0.0f, 0.0f, 0.0f, 14, null);
                    i12 &= -15;
                } else {
                    j11 = j9;
                }
            ...
            ComposableLambda composableLambda = interfaceC1668n2 != null ? ComposableLambdaKt.composableLambda(startRestartGroup, 1343298261, true, new BottomNavigationKt$BottomNavigationItem$styledLabel$1$1(interfaceC1668n2, i11)) : null;
            Modifier a8 = e.a(BottomNavigationItem, SelectableKt.m827selectableO2vRcR0(modifier3, z8, mutableInteractionSource2, RippleKt.m1449rememberRipple9IZ8Weo(false, 0.0f, j10, startRestartGroup, ((i11 >> 21) & 896) | 6, 2), z11, Role.m4521boximpl(Role.Companion.m4534getTabo7Vup1c()), onClick), 1.0f, false, 2, null);
            ...
            InterfaceC1669o modifierMaterializerOf = LayoutKt.modifierMaterializerOf(a8);
            ...
            m1130BottomNavigationTransitionKlgxPg(j10, j11, z8, ComposableLambdaKt.composableLambda(startRestartGroup, -1411872801, true, new BottomNavigationKt$BottomNavigationItem$2$1(z12, icon, composableLambda, i11)), startRestartGroup, ((i12 << 3) & 112) | ((i11 >> 27) & 14) | 3072 | ((i11 << 3) & 896));
            startRestartGroup.endReplaceableGroup();
        ...
        endRestartGroup.updateScope(new BottomNavigationKt$BottomNavigationItem$3(BottomNavigationItem, z8, onClick, icon, modifier4, z13, interfaceC1668n3, z14, mutableInteractionSource3, j10, j12, i8, i9, i10));
    }

    /* JADX INFO: Access modifiers changed from: private */
    @Composable
    @ComposableInferredTarget(scheme = "[androidx.compose.ui.UiComposable[androidx.compose.ui.UiComposable][androidx.compose.ui.UiComposable]]")
    public static final void BottomNavigationItemBaselineLayout(InterfaceC1668n interfaceC1668n, final InterfaceC1668n interfaceC1668n2, final float f8, Composer composer, int i8) {
        int i9;
        int i10;
        int i11;
        int i12;
        ...
        if ((i9 & 731) == 146 && startRestartGroup.getSkipping()) {
            ...
            MeasurePolicy measurePolicy = new MeasurePolicy() { // from class: androidx.compose.material.BottomNavigationKt$BottomNavigationItemBaselineLayout$2
                ...
                public final MeasureResult mo137measure3p2s80s(MeasureScope Layout, List<? extends Measurable> measurables, long j8) {
                    Placeable placeable;
                    MeasureResult m1135placeLabelAndIconDIyivk0;
                    MeasureResult m1134placeIcon3p2s80s;
                    ...
                    for (Measurable measurable : list) {
                        if (AbstractC3255y.d(LayoutIdKt.getLayoutId(measurable), RewardPlus.ICON)) {
                            ...
                            placeable = null;
                            if (InterfaceC1668n.this == null) {
                                m1134placeIcon3p2s80s = BottomNavigationKt.m1134placeIcon3p2s80s(Layout, mo4136measureBRTryo0, j8);
                                return m1134placeIcon3p2s80s;
                            }
                            AbstractC3255y.f(placeable);
                            m1135placeLabelAndIconDIyivk0 = BottomNavigationKt.m1135placeLabelAndIconDIyivk0(Layout, placeable, mo4136measureBRTryo0, j8, f8);
                            return m1135placeLabelAndIconDIyivk0;
                        }
                    }
                    throw new NoSuchElementException("Collection contains no element matching the predicate.");
                }
            ...
            if (interfaceC1668n2 != null) {
                Modifier m607paddingVpY3zN4$default = PaddingKt.m607paddingVpY3zN4$default(AlphaKt.alpha(LayoutIdKt.layoutId(companion, "label"), f8), BottomNavigationItemHorizontalPadding, 0.0f, 2, null);
                startRestartGroup.startReplaceableGroup(733328855);
                ...
                InterfaceC1669o modifierMaterializerOf3 = LayoutKt.modifierMaterializerOf(m607paddingVpY3zN4$default);
                if (!(startRestartGroup.getApplier() instanceof Applier)) {
                    ComposablesKt.invalidApplier();
                }
                startRestartGroup.startReusableNode();
        ...
        ScopeUpdateScope endRestartGroup = startRestartGroup.endRestartGroup();
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new BottomNavigationKt$BottomNavigationItemBaselineLayout$3(interfaceC1668n, interfaceC1668n2, f8, i8));
        }
    }
    ...
    public static final void m1130BottomNavigationTransitionKlgxPg(long j8, long j9, boolean z8, InterfaceC1669o interfaceC1669o, Composer composer, int i8) {
        int i9;
        float f8;
        Composer composer2;
        int i10;
        ...
        if ((i14 & 5851) == 1170 && startRestartGroup.getSkipping()) {
            ...
            long m3027lerpjxsXWHM = ColorKt.m3027lerpjxsXWHM(j9, j8, BottomNavigationTransition_Klgx_Pg$lambda$3(animateFloatAsState));
            CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m2966boximpl(Color.m2975copywmQWz5c$default(m3027lerpjxsXWHM, 1.0f, 0.0f, 0.0f, 0.0f, 14, null))), ContentAlphaKt.getLocalContentAlpha().provides(Float.valueOf(Color.m2978getAlphaimpl(m3027lerpjxsXWHM)))}, ComposableLambdaKt.composableLambda(composer2, -138092754, true, new BottomNavigationKt$BottomNavigationTransition$1(interfaceC1669o, i14, animateFloatAsState)), composer2, 56);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        }
        ...
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new BottomNavigationKt$BottomNavigationTransition$2(j8, j9, z8, interfaceC1669o, i8));
        }
    }
    ...
    public static final MeasureResult m1134placeIcon3p2s80s(MeasureScope measureScope, Placeable placeable, long j8) {
        int m5150getMaxHeightimpl = Constraints.m5150getMaxHeightimpl(j8);
        return MeasureScope.CC.q(measureScope, placeable.getWidth(), m5150getMaxHeightimpl, null, new BottomNavigationKt$placeIcon$1(placeable, (m5150getMaxHeightimpl - placeable.getHeight()) / 2), 4, null);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: placeLabelAndIcon-DIyivk0, reason: not valid java name */
    public static final MeasureResult m1135placeLabelAndIconDIyivk0(MeasureScope measureScope, Placeable placeable, Placeable placeable2, long j8, float f8) {
        int m5150getMaxHeightimpl = Constraints.m5150getMaxHeightimpl(j8);
        int mo447roundToPx0680j_4 = measureScope.mo447roundToPx0680j_4(CombinedItemTextBaseline) - placeable.get(AlignmentLineKt.getFirstBaseline());
        int d8 = m.d((m5150getMaxHeightimpl - ((placeable2.getHeight() + placeable.getHeight()) + mo447roundToPx0680j_4)) / 2, 0);
        int height = (m5150getMaxHeightimpl - placeable2.getHeight()) / 2;
        int height2 = placeable2.getHeight() + d8 + mo447roundToPx0680j_4;
        int max = Math.max(placeable.getWidth(), placeable2.getWidth());
        return MeasureScope.CC.q(measureScope, max, m5150getMaxHeightimpl, null, new BottomNavigationKt$placeLabelAndIcon$1(f8, placeable, (max - placeable.getWidth()) / 2, height2, AbstractC2055a.d((height - d8) * (1 - f8)), placeable2, (max - placeable2.getWidth()) / 2, d8), 4, null);
    }
}
