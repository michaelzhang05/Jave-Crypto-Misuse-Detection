...
public final class IconKt {
    private static final Modifier DefaultIconSizeModifier = SizeKt.m652size3ABfNKs(Modifier.Companion, Dp.m5183constructorimpl(24));

    @ComposableTarget(applier = "androidx.compose.ui.UiComposable")
    @Composable
    /* renamed from: Icon-ww6aTOc, reason: not valid java name */
    public static final void m1272Iconww6aTOc(ImageVector imageVector, String str, Modifier modifier, long j8, Composer composer, int i8, int i9) {
        AbstractC3255y.i(imageVector, "imageVector");
        composer.startReplaceableGroup(-800853103);
        Modifier modifier2 = (i9 & 4) != 0 ? Modifier.Companion : modifier;
        long m2975copywmQWz5c$default = (i9 & 8) != 0 ? Color.m2975copywmQWz5c$default(((Color) composer.consume(ContentColorKt.getLocalContentColor())).m2986unboximpl(), ((Number) composer.consume(ContentAlphaKt.getLocalContentAlpha())).floatValue(), 0.0f, 0.0f, 0.0f, 14, null) : j8;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-800853103, i8, -1, "androidx.compose.material.Icon (Icon.kt:61)");
        }
        m1271Iconww6aTOc(VectorPainterKt.rememberVectorPainter(imageVector, composer, i8 & 14), str, modifier2, m2975copywmQWz5c$default, composer, VectorPainter.$stable | (i8 & 112) | (i8 & 896) | (i8 & 7168), 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    private static final Modifier defaultSizeFor(Modifier modifier, Painter painter) {
        Modifier modifier2;
        if (!Size.m2805equalsimpl0(painter.mo3513getIntrinsicSizeNHjbRc(), Size.Companion.m2817getUnspecifiedNHjbRc()) && !m1273isInfiniteuvyYCjk(painter.mo3513getIntrinsicSizeNHjbRc())) {
    ...
    private static final boolean m1273isInfiniteuvyYCjk(long j8) {
    ...
    @Composable
    /* renamed from: Icon-ww6aTOc, reason: not valid java name */
    public static final void m1270Iconww6aTOc(ImageBitmap bitmap, String str, Modifier modifier, long j8, Composer composer, int i8, int i9) {
        ...
        composer.endReplaceableGroup();
        m1271Iconww6aTOc((BitmapPainter) rememberedValue, str, modifier2, m2975copywmQWz5c$default, composer, (i8 & 112) | 8 | (i8 & 896) | (i8 & 7168), 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    @Composable
    /* renamed from: Icon-ww6aTOc, reason: not valid java name */
    public static final void m1271Iconww6aTOc(Painter painter, String str, Modifier modifier, long j8, Composer composer, int i8, int i9) {
        long j9;
        int i10;
        Modifier modifier2;
        ...
        if ((i9 & 8) != 0) {
            i10 = i8 & (-7169);
            j9 = Color.m2975copywmQWz5c$default(((Color) startRestartGroup.consume(ContentColorKt.getLocalContentColor())).m2986unboximpl(), ((Number) startRestartGroup.consume(ContentAlphaKt.getLocalContentAlpha())).floatValue(), 0.0f, 0.0f, 0.0f, 14, null);
        } else {
            j9 = j8;
            i10 = i8;
        }
