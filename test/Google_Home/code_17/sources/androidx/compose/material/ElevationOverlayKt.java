...
public final class ElevationOverlayKt {
    ...
    public static final long m1246calculateForegroundColorCLU3JFs(long j8, float f8, Composer composer, int i8) {
        ...
        long m2975copywmQWz5c$default = Color.m2975copywmQWz5c$default(ColorsKt.m1201contentColorForek8zF_U(j8, composer, i8 & 14), ((((float) Math.log(f8 + 1)) * 4.5f) + 2.0f) / 100.0f, 0.0f, 0.0f, 0.0f, 14, null);
        if (ComposerKt.isTraceInProgress()) {
