...
public final class TabRowDefaults$Indicator$1 extends AbstractC3256z implements InterfaceC1668n {
    ...
    public final void invoke(Composer composer, int i8) {
        this.$tmp0_rcvr.m1384Indicator9IZ8Weo(this.$modifier, this.$height, this.$color, composer, RecomposeScopeImplKt.updateChangedFlags(this.$$changed | 1), this.$$default);
    }
}
