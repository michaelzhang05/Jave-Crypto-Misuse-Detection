...
public final class TabPosition {
    ...
    public final float m1380getLeftD9Ej5fM() {
        return this.left;
    }

    /* renamed from: getRight-D9Ej5fM, reason: not valid java name */
    public final float m1381getRightD9Ej5fM() {
        return Dp.m5183constructorimpl(this.left + this.width);
    }

    /* renamed from: getWidth-D9Ej5fM, reason: not valid java name */
    public final float m1382getWidthD9Ej5fM() {
        return this.width;
    }
    ...
    public String toString() {
        return "TabPosition(left=" + ((Object) Dp.m5194toStringimpl(this.left)) + ", right=" + ((Object) Dp.m5194toStringimpl(m1381getRightD9Ej5fM())) + ", width=" + ((Object) Dp.m5194toStringimpl(this.width)) + ')';
    }
