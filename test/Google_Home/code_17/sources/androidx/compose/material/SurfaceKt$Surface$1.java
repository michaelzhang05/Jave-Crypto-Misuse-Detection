...
public final class SurfaceKt$Surface$1 extends AbstractC3256z implements InterfaceC1668n {
    ...
    public final void invoke(Composer composer, int i8) {
        ...
        m1365surfaceColorAtElevationcq6XJ1M = SurfaceKt.m1365surfaceColorAtElevationcq6XJ1M(this.$color, (ElevationOverlay) composer.consume(ElevationOverlayKt.getLocalElevationOverlay()), this.$absoluteElevation, composer, (this.$$dirty >> 6) & 14);
        m1364surface8ww4TTg = SurfaceKt.m1364surface8ww4TTg(modifier, shape, m1365surfaceColorAtElevationcq6XJ1M, this.$border, this.$elevation);
        Modifier pointerInput = SuspendingPointerInputFilterKt.pointerInput(SemanticsModifierKt.semantics(m1364surface8ww4TTg, false, AnonymousClass1.INSTANCE), I.f8278a, new AnonymousClass2(null));
        ...
        InterfaceC1669o modifierMaterializerOf = LayoutKt.modifierMaterializerOf(pointerInput);
