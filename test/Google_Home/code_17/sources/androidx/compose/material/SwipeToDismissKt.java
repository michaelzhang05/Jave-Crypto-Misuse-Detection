...
public final class SwipeToDismissKt {
    private static final float DISMISS_THRESHOLD = Dp.m5183constructorimpl(56);
    ...
    */
    public static final void SwipeToDismiss(androidx.compose.material.DismissState r21, androidx.compose.ui.Modifier r22, java.util.Set<? extends androidx.compose.material.DismissDirection> r23, kotlin.jvm.functions.Function1 r24, a6.InterfaceC1669o r25, a6.InterfaceC1669o r26, androidx.compose.runtime.Composer r27, int r28, int r29) {
        /*
            Method dump skipped, instructions count: 341
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.SwipeToDismissKt.SwipeToDismiss(androidx.compose.material.DismissState, androidx.compose.ui.Modifier, java.util.Set, kotlin.jvm.functions.Function1, a6.o, a6.o, androidx.compose.runtime.Composer, int, int):void");
    }
    ...
    public static final DismissState rememberDismissState(DismissValue dismissValue, Function1 function1, Composer composer, int i8, int i9) {
        ...
        DismissState dismissState = (DismissState) RememberSaveableKt.m2588rememberSaveable(objArr, (Saver) Saver, (String) null, (Function0) rememberedValue, composer, 72, 4);
        if (ComposerKt.isTraceInProgress()) {
