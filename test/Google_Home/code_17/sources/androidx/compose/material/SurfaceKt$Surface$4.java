...
public final class SurfaceKt$Surface$4 extends AbstractC3256z implements InterfaceC1668n {
    ...
    public SurfaceKt$Surface$4(Modifier modifier, Shape shape, long j8, float f8, int i8, BorderStroke borderStroke, float f9, MutableInteractionSource mutableInteractionSource, boolean z8, Function0 function0, InterfaceC1668n interfaceC1668n) {
        super(2);
    ...
    public final void invoke(Composer composer, int i8) {
        ...
        m1365surfaceColorAtElevationcq6XJ1M = SurfaceKt.m1365surfaceColorAtElevationcq6XJ1M(this.$color, (ElevationOverlay) composer.consume(ElevationOverlayKt.getLocalElevationOverlay()), this.$absoluteElevation, composer, (this.$$dirty >> 12) & 14);
        ...
        Modifier m318clickableO2vRcR0$default = ClickableKt.m318clickableO2vRcR0$default(m1364surface8ww4TTg, this.$interactionSource, RippleKt.m1449rememberRipple9IZ8Weo(false, 0.0f, 0L, composer, 0, 7), this.$enabled, null, null, this.$onClick, 24, null);
        ...
        interfaceC1668n.invoke(composer, Integer.valueOf((i9 >> 27) & 14));
