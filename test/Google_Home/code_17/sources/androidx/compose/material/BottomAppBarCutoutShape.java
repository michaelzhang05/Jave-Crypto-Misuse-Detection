...
public final class BottomAppBarCutoutShape implements Shape {
    ...
    public BottomAppBarCutoutShape(Shape cutoutShape, FabPlacement fabPlacement) {
        AbstractC3255y.i(cutoutShape, "cutoutShape");
        AbstractC3255y.i(fabPlacement, "fabPlacement");
    ...
    private final void addCutoutShape(Path path, LayoutDirection layoutDirection, Density density) {
        ...
        float f10 = 2 * mo453toPx0680j_4;
        long Size = SizeKt.Size(this.fabPlacement.getWidth() + f10, this.fabPlacement.getHeight() + f10);
        float left = this.fabPlacement.getLeft() - mo453toPx0680j_4;
        float m2809getWidthimpl = left + Size.m2809getWidthimpl(Size);
        float m2806getHeightimpl = Size.m2806getHeightimpl(Size) / 2.0f;
        OutlineKt.addOutline(path, this.cutoutShape.mo336createOutlinePq9zytI(Size, layoutDirection, density));
        path.mo2877translatek4lQ0M(OffsetKt.Offset(left, -m2806getHeightimpl));
        if (AbstractC3255y.d(this.cutoutShape, RoundedCornerShapeKt.getCircleShape())) {
            f9 = AppBarKt.BottomAppBarRoundedEdgeRadius;
            addRoundedEdges(path, left, m2809getWidthimpl, m2806getHeightimpl, density.mo453toPx0680j_4(f9), 0.0f);
        }
    }
    ...
    public Outline mo336createOutlinePq9zytI(long j8, LayoutDirection layoutDirection, Density density) {
        ...
        Path.addRect(new Rect(0.0f, 0.0f, Size.m2809getWidthimpl(j8), Size.m2806getHeightimpl(j8)));
        Path Path2 = AndroidPath_androidKt.Path();
        addCutoutShape(Path2, layoutDirection, density);
        Path2.mo2874opN5in7k0(Path, Path2, PathOperation.Companion.m3245getDifferenceb3I0S0c());
    ...
    public boolean equals(Object obj) {
        ...
        return AbstractC3255y.d(this.cutoutShape, bottomAppBarCutoutShape.cutoutShape) && AbstractC3255y.d(this.fabPlacement, bottomAppBarCutoutShape.fabPlacement);
    }
