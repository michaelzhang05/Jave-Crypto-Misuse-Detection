...
public final class ContentAlpha {
    ...
    private final float contentAlpha(float f8, float f9, Composer composer, int i8) {
        ...
        long m2986unboximpl = ((Color) composer.consume(ContentColorKt.getLocalContentColor())).m2986unboximpl();
        if (!MaterialTheme.INSTANCE.getColors(composer, 6).isLight() ? ColorKt.m3028luminance8_81llA(m2986unboximpl) >= 0.5d : ColorKt.m3028luminance8_81llA(m2986unboximpl) <= 0.5d) {
            f8 = f9;
        }
        if (ComposerKt.isTraceInProgress()) {
