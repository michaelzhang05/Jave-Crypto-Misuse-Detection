...
public final class OutlinedTextFieldKt {
    ...
    private static final float OutlinedTextFieldInnerPadding = Dp.m5183constructorimpl(4);
    private static final float OutlinedTextFieldTopPadding = Dp.m5183constructorimpl(8);
    ...
    */
    public static final void OutlinedTextField(java.lang.String r73, kotlin.jvm.functions.Function1 r74, androidx.compose.ui.Modifier r75, boolean r76, boolean r77, androidx.compose.ui.text.TextStyle r78, a6.InterfaceC1668n r79, a6.InterfaceC1668n r80, a6.InterfaceC1668n r81, a6.InterfaceC1668n r82, boolean r83, androidx.compose.ui.text.input.VisualTransformation r84, androidx.compose.foundation.text.KeyboardOptions r85, androidx.compose.foundation.text.KeyboardActions r86, boolean r87, int r88, int r89, androidx.compose.foundation.interaction.MutableInteractionSource r90, androidx.compose.ui.graphics.Shape r91, androidx.compose.material.TextFieldColors r92, androidx.compose.runtime.Composer r93, int r94, int r95, int r96) {
        /*
            Method dump skipped, instructions count: 1581
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.OutlinedTextFieldKt.OutlinedTextField(java.lang.String, kotlin.jvm.functions.Function1, androidx.compose.ui.Modifier, boolean, boolean, androidx.compose.ui.text.TextStyle, a6.n, a6.n, a6.n, a6.n, boolean, androidx.compose.ui.text.input.VisualTransformation, androidx.compose.foundation.text.KeyboardOptions, androidx.compose.foundation.text.KeyboardActions, boolean, int, int, androidx.compose.foundation.interaction.MutableInteractionSource, androidx.compose.ui.graphics.Shape, androidx.compose.material.TextFieldColors, androidx.compose.runtime.Composer, int, int, int):void");
    }
    ...
    public static final void OutlinedTextFieldLayout(Modifier modifier, InterfaceC1668n textField, InterfaceC1669o interfaceC1669o, InterfaceC1668n interfaceC1668n, InterfaceC1668n interfaceC1668n2, InterfaceC1668n interfaceC1668n3, boolean z8, float f8, Function1 onLabelMeasured, InterfaceC1668n border, PaddingValues paddingValues, Composer composer, int i8, int i9) {
        int i10;
        int i11;
        int i12;
        int i13;
        ...
        if ((i24 & 1533916891) == 306783378 && (i11 & 11) == 2 && startRestartGroup.getSkipping()) {
            ...
            Updater.m2508setimpl(m2501constructorimpl, outlinedTextFieldMeasurePolicy, companion.getSetMeasurePolicy());
            ...
            if (interfaceC1668n2 != null) {
                ...
                interfaceC1668n2.invoke(startRestartGroup, Integer.valueOf((i24 >> 12) & 14));
                startRestartGroup.endReplaceableGroup();
            ...
            if (interfaceC1668n3 != null) {
                ...
                interfaceC1668n3.invoke(startRestartGroup, Integer.valueOf((i24 >> 15) & 14));
                startRestartGroup.endReplaceableGroup();
                startRestartGroup.endNode();
                startRestartGroup.endReplaceableGroup();
                startRestartGroup.endReplaceableGroup();
            ...
            if (interfaceC1669o != null) {
                interfaceC1669o.invoke(LayoutIdKt.layoutId(companion2, "Hint").then(m609paddingqDBjuR0$default), startRestartGroup, Integer.valueOf((i24 >> 3) & 112));
            }
            startRestartGroup.endReplaceableGroup();
            Modifier then3 = LayoutIdKt.layoutId(companion2, "TextField").then(m609paddingqDBjuR0$default);
            startRestartGroup.startReplaceableGroup(733328855);
            ...
            if (interfaceC1668n != null) {
                ...
                InterfaceC1669o modifierMaterializerOf5 = LayoutKt.modifierMaterializerOf(layoutId);
                if (!(startRestartGroup.getApplier() instanceof Applier)) {
                    ComposablesKt.invalidApplier();
                }
                startRestartGroup.startReusableNode();
                ...
                startRestartGroup.startReplaceableGroup(2058660585);
                interfaceC1668n.invoke(startRestartGroup, Integer.valueOf((i24 >> 9) & 14));
                startRestartGroup.endReplaceableGroup();
                startRestartGroup.endNode();
                startRestartGroup.endReplaceableGroup();
                startRestartGroup.endReplaceableGroup();
        ...
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new OutlinedTextFieldKt$OutlinedTextFieldLayout$2(modifier, textField, interfaceC1669o, interfaceC1668n, interfaceC1668n2, interfaceC1668n3, z8, f8, onLabelMeasured, border, paddingValues, i8, i9));
        }
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: calculateHeight-O3s9Psw, reason: not valid java name */
    public static final int m1301calculateHeightO3s9Psw(int i8, int i9, int i10, int i11, int i12, float f8, long j8, float f9, PaddingValues paddingValues) {
        int max = Math.max(i10, Math.max(i12, MathHelpersKt.lerp(i11, 0, f8)));
        float mo558calculateTopPaddingD9Ej5fM = paddingValues.mo558calculateTopPaddingD9Ej5fM() * f9;
        return Math.max(Constraints.m5152getMinHeightimpl(j8), Math.max(i8, Math.max(i9, AbstractC2055a.d(MathHelpersKt.lerp(mo558calculateTopPaddingD9Ej5fM, Math.max(mo558calculateTopPaddingD9Ej5fM, i11 / 2.0f), f8) + max + (paddingValues.mo555calculateBottomPaddingD9Ej5fM() * f9)))));
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: calculateWidth-O3s9Psw, reason: not valid java name */
    public static final int m1302calculateWidthO3s9Psw(int i8, int i9, int i10, int i11, int i12, float f8, long j8, float f9, PaddingValues paddingValues) {
        int max = i8 + Math.max(i10, Math.max(MathHelpersKt.lerp(i11, 0, f8), i12)) + i9;
        LayoutDirection layoutDirection = LayoutDirection.Ltr;
        return Math.max(max, Math.max(AbstractC2055a.d((i11 + (Dp.m5183constructorimpl(paddingValues.mo556calculateLeftPaddingu2uoSUM(layoutDirection) + paddingValues.mo557calculateRightPaddingu2uoSUM(layoutDirection)) * f9)) * f8), Constraints.m5153getMinWidthimpl(j8)));
    }
    ...
    public static final Modifier m1303outlineCutout12SF9DM(Modifier outlineCutout, long j8, PaddingValues paddingValues) {
        AbstractC3255y.i(outlineCutout, "$this$outlineCutout");
        AbstractC3255y.i(paddingValues, "paddingValues");
    ...
    public static final void place(Placeable.PlacementScope placementScope, int i8, int i9, Placeable placeable, Placeable placeable2, Placeable placeable3, Placeable placeable4, Placeable placeable5, Placeable placeable6, float f8, boolean z8, float f9, LayoutDirection layoutDirection, PaddingValues paddingValues) {
        ...
        int i11;
        float widthOrZero;
        int d8 = AbstractC2055a.d(paddingValues.mo558calculateTopPaddingD9Ej5fM() * f9);
        int d9 = AbstractC2055a.d(PaddingKt.calculateStartPadding(paddingValues, layoutDirection) * f9);
        ...
        if (placeable4 != null) {
            ...
            Placeable.PlacementScope.placeRelative$default(placementScope, placeable4, AbstractC2055a.d(widthOrZero) + d9, lerp, 0.0f, 4, null);
        }
        if (z8) {
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static final /* synthetic */ void OutlinedTextField(java.lang.String r72, kotlin.jvm.functions.Function1 r73, androidx.compose.ui.Modifier r74, boolean r75, boolean r76, androidx.compose.ui.text.TextStyle r77, a6.InterfaceC1668n r78, a6.InterfaceC1668n r79, a6.InterfaceC1668n r80, a6.InterfaceC1668n r81, boolean r82, androidx.compose.ui.text.input.VisualTransformation r83, androidx.compose.foundation.text.KeyboardOptions r84, androidx.compose.foundation.text.KeyboardActions r85, boolean r86, int r87, androidx.compose.foundation.interaction.MutableInteractionSource r88, androidx.compose.ui.graphics.Shape r89, androidx.compose.material.TextFieldColors r90, androidx.compose.runtime.Composer r91, int r92, int r93, int r94) {
        /*
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static final void OutlinedTextField(androidx.compose.ui.text.input.TextFieldValue r73, kotlin.jvm.functions.Function1 r74, androidx.compose.ui.Modifier r75, boolean r76, boolean r77, androidx.compose.ui.text.TextStyle r78, a6.InterfaceC1668n r79, a6.InterfaceC1668n r80, a6.InterfaceC1668n r81, a6.InterfaceC1668n r82, boolean r83, androidx.compose.ui.text.input.VisualTransformation r84, androidx.compose.foundation.text.KeyboardOptions r85, androidx.compose.foundation.text.KeyboardActions r86, boolean r87, int r88, int r89, androidx.compose.foundation.interaction.MutableInteractionSource r90, androidx.compose.ui.graphics.Shape r91, androidx.compose.material.TextFieldColors r92, androidx.compose.runtime.Composer r93, int r94, int r95, int r96) {
        /*
            Method dump skipped, instructions count: 1619
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.OutlinedTextFieldKt.OutlinedTextField(androidx.compose.ui.text.input.TextFieldValue, kotlin.jvm.functions.Function1, androidx.compose.ui.Modifier, boolean, boolean, androidx.compose.ui.text.TextStyle, a6.n, a6.n, a6.n, a6.n, boolean, androidx.compose.ui.text.input.VisualTransformation, androidx.compose.foundation.text.KeyboardOptions, androidx.compose.foundation.text.KeyboardActions, boolean, int, int, androidx.compose.foundation.interaction.MutableInteractionSource, androidx.compose.ui.graphics.Shape, androidx.compose.material.TextFieldColors, androidx.compose.runtime.Composer, int, int, int):void");
    }
