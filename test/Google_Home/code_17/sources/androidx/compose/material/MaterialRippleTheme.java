...
public final class MaterialRippleTheme implements RippleTheme {
    ...
    public long mo43defaultColorWaAFU9c(Composer composer, int i8) {
        ...
        long m1451defaultRippleColor5vOe2sY = RippleTheme.Companion.m1451defaultRippleColor5vOe2sY(((Color) composer.consume(ContentColorKt.getLocalContentColor())).m2986unboximpl(), MaterialTheme.INSTANCE.getColors(composer, 6).isLight());
        if (ComposerKt.isTraceInProgress()) {
    ...
    public RippleAlpha rippleAlpha(Composer composer, int i8) {
        ...
        RippleAlpha m1450defaultRippleAlphaDxMtmZc = RippleTheme.Companion.m1450defaultRippleAlphaDxMtmZc(((Color) composer.consume(ContentColorKt.getLocalContentColor())).m2986unboximpl(), MaterialTheme.INSTANCE.getColors(composer, 6).isLight());
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
