...
public final class ProgressIndicatorKt$LinearProgressIndicator$4 extends AbstractC3256z implements InterfaceC1668n {
    ...
    public final void invoke(Composer composer, int i8) {
        ProgressIndicatorKt.m1309LinearProgressIndicator2cYBFYY(this.$modifier, this.$color, this.$backgroundColor, this.$strokeCap, composer, RecomposeScopeImplKt.updateChangedFlags(this.$$changed | 1), this.$$default);
    }
}
