...
public final class Typography {
    ...
    private final TextStyle f14567h1;

    /* renamed from: h2, reason: collision with root package name */
    private final TextStyle f14568h2;

    /* renamed from: h3, reason: collision with root package name */
    private final TextStyle f14569h3;

    /* renamed from: h4, reason: collision with root package name */
    private final TextStyle f14570h4;

    /* renamed from: h5, reason: collision with root package name */
    private final TextStyle f14571h5;

    /* renamed from: h6, reason: collision with root package name */
    private final TextStyle f14572h6;
    ...
    public Typography(TextStyle h12, TextStyle h22, TextStyle h32, TextStyle h42, TextStyle h52, TextStyle h62, TextStyle subtitle1, TextStyle subtitle2, TextStyle body1, TextStyle body2, TextStyle button, TextStyle caption, TextStyle overline) {
        AbstractC3255y.i(h12, "h1");
        AbstractC3255y.i(h22, "h2");
        AbstractC3255y.i(h32, "h3");
        AbstractC3255y.i(h42, "h4");
        AbstractC3255y.i(h52, "h5");
        AbstractC3255y.i(h62, "h6");
        AbstractC3255y.i(subtitle1, "subtitle1");
        AbstractC3255y.i(subtitle2, "subtitle2");
        AbstractC3255y.i(body1, "body1");
        AbstractC3255y.i(body2, "body2");
        AbstractC3255y.i(button, "button");
        AbstractC3255y.i(caption, "caption");
        AbstractC3255y.i(overline, "overline");
        this.f14567h1 = h12;
        this.f14568h2 = h22;
        this.f14569h3 = h32;
        this.f14570h4 = h42;
    ...
    public static /* synthetic */ Typography copy$default(Typography typography, TextStyle textStyle, TextStyle textStyle2, TextStyle textStyle3, TextStyle textStyle4, TextStyle textStyle5, TextStyle textStyle6, TextStyle textStyle7, TextStyle textStyle8, TextStyle textStyle9, TextStyle textStyle10, TextStyle textStyle11, TextStyle textStyle12, TextStyle textStyle13, int i8, Object obj) {
        ...
        if ((i8 & 1) != 0) {
            textStyle14 = typography.f14567h1;
        } else {
            textStyle14 = textStyle;
        }
        if ((i8 & 2) != 0) {
            textStyle15 = typography.f14568h2;
        } else {
            textStyle15 = textStyle2;
        }
        if ((i8 & 4) != 0) {
            textStyle16 = typography.f14569h3;
        } else {
            textStyle16 = textStyle3;
        }
        if ((i8 & 8) != 0) {
            textStyle17 = typography.f14570h4;
        } else {
            textStyle17 = textStyle4;
        }
        if ((i8 & 16) != 0) {
            textStyle18 = typography.f14571h5;
        } else {
            textStyle18 = textStyle5;
        }
        if ((i8 & 32) != 0) {
            textStyle19 = typography.f14572h6;
        } else {
    ...
    public boolean equals(Object obj) {
        ...
        if (AbstractC3255y.d(this.f14567h1, typography.f14567h1) && AbstractC3255y.d(this.f14568h2, typography.f14568h2) && AbstractC3255y.d(this.f14569h3, typography.f14569h3) && AbstractC3255y.d(this.f14570h4, typography.f14570h4) && AbstractC3255y.d(this.f14571h5, typography.f14571h5) && AbstractC3255y.d(this.f14572h6, typography.f14572h6) && AbstractC3255y.d(this.subtitle1, typography.subtitle1) && AbstractC3255y.d(this.subtitle2, typography.subtitle2) && AbstractC3255y.d(this.body1, typography.body1) && AbstractC3255y.d(this.body2, typography.body2) && AbstractC3255y.d(this.button, typography.button) && AbstractC3255y.d(this.caption, typography.caption) && AbstractC3255y.d(this.overline, typography.overline)) {
            return true;
        }
        return false;
    }
    ...
    public final TextStyle getH1() {
        return this.f14567h1;
    }

    public final TextStyle getH2() {
        return this.f14568h2;
    }

    public final TextStyle getH3() {
        return this.f14569h3;
    }

    public final TextStyle getH4() {
        return this.f14570h4;
    }

    public final TextStyle getH5() {
        return this.f14571h5;
    }

    public final TextStyle getH6() {
        return this.f14572h6;
    }
    ...
    public int hashCode() {
        return (((((((((((((((((((((((this.f14567h1.hashCode() * 31) + this.f14568h2.hashCode()) * 31) + this.f14569h3.hashCode()) * 31) + this.f14570h4.hashCode()) * 31) + this.f14571h5.hashCode()) * 31) + this.f14572h6.hashCode()) * 31) + this.subtitle1.hashCode()) * 31) + this.subtitle2.hashCode()) * 31) + this.body1.hashCode()) * 31) + this.body2.hashCode()) * 31) + this.button.hashCode()) * 31) + this.caption.hashCode()) * 31) + this.overline.hashCode();
    }

    public String toString() {
        return "Typography(h1=" + this.f14567h1 + ", h2=" + this.f14568h2 + ", h3=" + this.f14569h3 + ", h4=" + this.f14570h4 + ", h5=" + this.f14571h5 + ", h6=" + this.f14572h6 + ", subtitle1=" + this.subtitle1 + ", subtitle2=" + this.subtitle2 + ", body1=" + this.body1 + ", body2=" + this.body2 + ", button=" + this.button + ", caption=" + this.caption + ", overline=" + this.overline + ')';
    }
    ...
    */
    public Typography(androidx.compose.ui.text.font.FontFamily r2, androidx.compose.ui.text.TextStyle r3, androidx.compose.ui.text.TextStyle r4, androidx.compose.ui.text.TextStyle r5, androidx.compose.ui.text.TextStyle r6, androidx.compose.ui.text.TextStyle r7, androidx.compose.ui.text.TextStyle r8, androidx.compose.ui.text.TextStyle r9, androidx.compose.ui.text.TextStyle r10, androidx.compose.ui.text.TextStyle r11, androidx.compose.ui.text.TextStyle r12, androidx.compose.ui.text.TextStyle r13, androidx.compose.ui.text.TextStyle r14, androidx.compose.ui.text.TextStyle r15) {
        /*
            ...
            kotlin.jvm.internal.AbstractC3255y.i(r14, r0)
            java.lang.String r0 = "overline"
            kotlin.jvm.internal.AbstractC3255y.i(r15, r0)
