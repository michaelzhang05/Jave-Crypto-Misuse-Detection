...
public final class DrawerKt {
    ...
    static {
        float f8 = 56;
        EndDrawerPadding = Dp.m5183constructorimpl(f8);
        DrawerPositionalThreshold = Dp.m5183constructorimpl(f8);
    }
    ...
    */
    public static final void m1224BottomDrawerGs3lGvM(a6.InterfaceC1669o r32, androidx.compose.ui.Modifier r33, androidx.compose.material.BottomDrawerState r34, boolean r35, androidx.compose.ui.graphics.Shape r36, float r37, long r38, long r40, long r42, a6.InterfaceC1668n r44, androidx.compose.runtime.Composer r45, int r46, int r47) {
        /*
            Method dump skipped, instructions count: 768
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.DrawerKt.m1224BottomDrawerGs3lGvM(a6.o, androidx.compose.ui.Modifier, androidx.compose.material.BottomDrawerState, boolean, androidx.compose.ui.graphics.Shape, float, long, long, long, a6.n, androidx.compose.runtime.Composer, int, int):void");
    }
    ...
    public static final AnchoredDraggableState.AnchorChangedCallback<BottomDrawerValue> BottomDrawerAnchorChangeCallback(final BottomDrawerState bottomDrawerState, final M m8) {
        return new AnchoredDraggableState.AnchorChangedCallback<BottomDrawerValue>() { // from class: androidx.compose.material.DrawerKt$BottomDrawerAnchorChangeCallback$1
            ...
            public final void onAnchorsChanged(BottomDrawerValue previousTarget, Map<BottomDrawerValue, Float> previousAnchors, Map<BottomDrawerValue, Float> newAnchors) {
                ...
                AbstractC3255y.i(previousTarget, "previousTarget");
                AbstractC3255y.i(previousAnchors, "previousAnchors");
                ...
                if (AbstractC3255y.a(((Number) Q.i(newAnchors, bottomDrawerValue)).floatValue(), f8)) {
                    return;
                }
                if (BottomDrawerState.this.isAnimationRunning$material_release()) {
                    AbstractC3364k.d(m8, null, null, new DrawerKt$BottomDrawerAnchorChangeCallback$1$onAnchorsChanged$1(BottomDrawerState.this, bottomDrawerValue, null), 3, null);
                } else {
                    if (BottomDrawerState.this.trySnapTo$material_release(bottomDrawerValue)) {
                        return;
                    }
                    AbstractC3364k.d(m8, null, null, new DrawerKt$BottomDrawerAnchorChangeCallback$1$onAnchorsChanged$2(BottomDrawerState.this, bottomDrawerValue, null), 3, null);
                }
            }
        };
    }
    ...
    public static final void m1225BottomDrawerScrim3JVO9M(long j8, Function0 function0, boolean z8, Composer composer, int i8) {
        int i9;
        float f8;
        Modifier modifier;
        int i10;
        ...
        if ((i9 & 731) == 146 && startRestartGroup.getSkipping()) {
            ...
            if (j8 != Color.Companion.m3012getUnspecified0d7_KjU()) {
                ...
                String m1356getString4foXLRw = Strings_androidKt.m1356getString4foXLRw(Strings.Companion.m1349getCloseDrawerUdPEhr4(), startRestartGroup, 6);
                ...
                if (z8) {
                    ...
                    boolean changed2 = startRestartGroup.changed(m1356getString4foXLRw) | startRestartGroup.changed(function0);
                    Object rememberedValue2 = startRestartGroup.rememberedValue();
                    if (changed2 || rememberedValue2 == Composer.Companion.getEmpty()) {
                        rememberedValue2 = new DrawerKt$BottomDrawerScrim$dismissModifier$2$1(m1356getString4foXLRw, function0);
                ...
                startRestartGroup.startReplaceableGroup(511388516);
                boolean changed3 = startRestartGroup.changed(m2966boximpl) | startRestartGroup.changed(animateFloatAsState);
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static final void m1226ModalDrawerGs3lGvM(a6.InterfaceC1669o r33, androidx.compose.ui.Modifier r34, androidx.compose.material.DrawerState r35, boolean r36, androidx.compose.ui.graphics.Shape r37, float r38, long r39, long r41, long r43, a6.InterfaceC1668n r45, androidx.compose.runtime.Composer r46, int r47, int r48) {
        /*
            Method dump skipped, instructions count: 760
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.DrawerKt.m1226ModalDrawerGs3lGvM(a6.o, androidx.compose.ui.Modifier, androidx.compose.material.DrawerState, boolean, androidx.compose.ui.graphics.Shape, float, long, long, long, a6.n, androidx.compose.runtime.Composer, int, int):void");
    }

    @ComposableTarget(applier = "androidx.compose.ui.UiComposable")
    @Composable
    /* renamed from: Scrim-Bx497Mc */
    public static final void m1227ScrimBx497Mc(boolean z8, Function0 function0, Function0 function02, long j8, Composer composer, int i8) {
        int i9;
        Modifier modifier;
        int i10;
        int i11;
        ...
        if ((i9 & 5851) == 1170 && startRestartGroup.getSkipping()) {
            ...
            if (z8) {
                ...
                Object rememberedValue2 = startRestartGroup.rememberedValue();
                if (changed2 || rememberedValue2 == Composer.Companion.getEmpty()) {
                    rememberedValue2 = new DrawerKt$Scrim$dismissDrawer$2$1(m1356getString4foXLRw, function0);
                    startRestartGroup.updateRememberedValue(rememberedValue2);
                }
                startRestartGroup.endReplaceableGroup();
                modifier = SemanticsModifierKt.semantics(pointerInput, true, (Function1) rememberedValue2);
    ...
    public static final BottomDrawerState rememberBottomDrawerState(BottomDrawerValue initialValue, Function1 function1, Composer composer, int i8, int i9) {
        ...
        BottomDrawerState bottomDrawerState = (BottomDrawerState) RememberSaveableKt.m2588rememberSaveable(objArr, (Saver) Saver, (String) null, (Function0) rememberedValue, composer, 72, 4);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
