...
public final class NavigationRailKt$NavigationRailTransition$1 extends AbstractC3256z implements InterfaceC1668n {
    ...
    public NavigationRailKt$NavigationRailTransition$1(InterfaceC1669o interfaceC1669o, int i8, State<Float> state) {
        super(2);
    ...
    public final void invoke(Composer composer, int i8) {
        ...
        interfaceC1669o.invoke(Float.valueOf(NavigationRailTransition_Klgx_Pg$lambda$3), composer, Integer.valueOf((this.$$dirty >> 6) & 112));
        if (ComposerKt.isTraceInProgress()) {
