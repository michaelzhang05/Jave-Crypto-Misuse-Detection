...
public final class PlatformRipple extends Ripple {
    public /* synthetic */ PlatformRipple(boolean z8, float f8, State state, AbstractC3247p abstractC3247p) {
        this(z8, f8, state);
    }
    ...
    private final ViewGroup findNearestViewGroup(Composer composer, int i8) {
        ...
        while (!(consume instanceof ViewGroup)) {
            ...
            if (parent instanceof View) {
                AbstractC3255y.h(parent, "parent");
                consume = parent;
            } else {
    ...
    public RippleIndicationInstance mo1441rememberUpdatedRippleInstance942rkJo(InteractionSource interactionSource, boolean z8, float f8, State<Color> color, State<RippleAlpha> rippleAlpha, Composer composer, int i8) {
        View view;
