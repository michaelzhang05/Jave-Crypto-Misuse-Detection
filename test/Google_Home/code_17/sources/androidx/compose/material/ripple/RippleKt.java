...
public final class RippleKt {
    ...
    public static final Indication m1449rememberRipple9IZ8Weo(boolean z8, float f8, long j8, Composer composer, int i8, int i9) {
        ...
        State rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m2966boximpl(j8), composer, (i8 >> 6) & 14);
        Boolean valueOf = Boolean.valueOf(z8);
        Dp m5181boximpl = Dp.m5181boximpl(f8);
        composer.startReplaceableGroup(511388516);
        boolean changed = composer.changed(valueOf) | composer.changed(m5181boximpl);
