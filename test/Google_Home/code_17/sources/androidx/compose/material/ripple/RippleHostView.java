...
public final class RippleHostView extends View {
    ...
    public final void m1446addRippleKOepWvA(PressInteraction.Press interaction, boolean z8, long j8, int i8, long j9, float f8, Function0 onInvalidateRipple) {
        AbstractC3255y.i(interaction, "interaction");
        AbstractC3255y.i(onInvalidateRipple, "onInvalidateRipple");
        if (this.ripple == null || !AbstractC3255y.d(Boolean.valueOf(z8), this.bounded)) {
            createRipple(z8);
            this.bounded = Boolean.valueOf(z8);
        }
        UnprojectedRipple unprojectedRipple = this.ripple;
        AbstractC3255y.f(unprojectedRipple);
        this.onInvalidateRipple = onInvalidateRipple;
        m1447updateRipplePropertiesbiQXAtU(j8, i8, j9, f8);
        if (z8) {
            unprojectedRipple.setHotspot(Offset.m2740getXimpl(interaction.m486getPressPositionF1C5BW0()), Offset.m2741getYimpl(interaction.m486getPressPositionF1C5BW0()));
        } else {
    ...
    public final void m1447updateRipplePropertiesbiQXAtU(long j8, int i8, long j9, float f8) {
        UnprojectedRipple unprojectedRipple = this.ripple;
        if (unprojectedRipple == null) {
            return;
        }
        unprojectedRipple.trySetRadius(i8);
        unprojectedRipple.m1454setColorDxMtmZc(j9, f8);
        Rect rect = new Rect(0, 0, AbstractC2055a.d(Size.m2809getWidthimpl(j8)), AbstractC2055a.d(Size.m2806getHeightimpl(j8)));
        setLeft(rect.left);
        setTop(rect.top);
        setRight(rect.right);
