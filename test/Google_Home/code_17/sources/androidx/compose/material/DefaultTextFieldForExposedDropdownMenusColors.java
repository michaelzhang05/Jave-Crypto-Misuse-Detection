...
final class DefaultTextFieldForExposedDropdownMenusColors implements TextFieldColorsWithIcons {
    ...
    public /* synthetic */ DefaultTextFieldForExposedDropdownMenusColors(long j8, long j9, long j10, long j11, long j12, long j13, long j14, long j15, long j16, long j17, long j18, long j19, long j20, long j21, long j22, long j23, long j24, long j25, long j26, long j27, long j28, long j29, AbstractC3247p abstractC3247p) {
    ...
    public State<Color> backgroundColor(boolean z8, Composer composer, int i8) {
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m2966boximpl(this.backgroundColor), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public boolean equals(Object obj) {
        ...
        if (Color.m2977equalsimpl0(this.textColor, defaultTextFieldForExposedDropdownMenusColors.textColor) && Color.m2977equalsimpl0(this.disabledTextColor, defaultTextFieldForExposedDropdownMenusColors.disabledTextColor) && Color.m2977equalsimpl0(this.cursorColor, defaultTextFieldForExposedDropdownMenusColors.cursorColor) && Color.m2977equalsimpl0(this.errorCursorColor, defaultTextFieldForExposedDropdownMenusColors.errorCursorColor) && Color.m2977equalsimpl0(this.focusedIndicatorColor, defaultTextFieldForExposedDropdownMenusColors.focusedIndicatorColor) && Color.m2977equalsimpl0(this.unfocusedIndicatorColor, defaultTextFieldForExposedDropdownMenusColors.unfocusedIndicatorColor) && Color.m2977equalsimpl0(this.errorIndicatorColor, defaultTextFieldForExposedDropdownMenusColors.errorIndicatorColor) && Color.m2977equalsimpl0(this.disabledIndicatorColor, defaultTextFieldForExposedDropdownMenusColors.disabledIndicatorColor) && Color.m2977equalsimpl0(this.leadingIconColor, defaultTextFieldForExposedDropdownMenusColors.leadingIconColor) && Color.m2977equalsimpl0(this.disabledLeadingIconColor, defaultTextFieldForExposedDropdownMenusColors.disabledLeadingIconColor) && Color.m2977equalsimpl0(this.errorLeadingIconColor, defaultTextFieldForExposedDropdownMenusColors.errorLeadingIconColor) && Color.m2977equalsimpl0(this.trailingIconColor, defaultTextFieldForExposedDropdownMenusColors.trailingIconColor) && Color.m2977equalsimpl0(this.focusedTrailingIconColor, defaultTextFieldForExposedDropdownMenusColors.focusedTrailingIconColor) && Color.m2977equalsimpl0(this.disabledTrailingIconColor, defaultTextFieldForExposedDropdownMenusColors.disabledTrailingIconColor) && Color.m2977equalsimpl0(this.errorTrailingIconColor, defaultTextFieldForExposedDropdownMenusColors.errorTrailingIconColor) && Color.m2977equalsimpl0(this.backgroundColor, defaultTextFieldForExposedDropdownMenusColors.backgroundColor) && Color.m2977equalsimpl0(this.focusedLabelColor, defaultTextFieldForExposedDropdownMenusColors.focusedLabelColor) && Color.m2977equalsimpl0(this.unfocusedLabelColor, defaultTextFieldForExposedDropdownMenusColors.unfocusedLabelColor) && Color.m2977equalsimpl0(this.disabledLabelColor, defaultTextFieldForExposedDropdownMenusColors.disabledLabelColor) && Color.m2977equalsimpl0(this.errorLabelColor, defaultTextFieldForExposedDropdownMenusColors.errorLabelColor) && Color.m2977equalsimpl0(this.placeholderColor, defaultTextFieldForExposedDropdownMenusColors.placeholderColor) && Color.m2977equalsimpl0(this.disabledPlaceholderColor, defaultTextFieldForExposedDropdownMenusColors.disabledPlaceholderColor)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (((((((((((((((((((((((((((((((((((((((((Color.m2983hashCodeimpl(this.textColor) * 31) + Color.m2983hashCodeimpl(this.disabledTextColor)) * 31) + Color.m2983hashCodeimpl(this.cursorColor)) * 31) + Color.m2983hashCodeimpl(this.errorCursorColor)) * 31) + Color.m2983hashCodeimpl(this.focusedIndicatorColor)) * 31) + Color.m2983hashCodeimpl(this.unfocusedIndicatorColor)) * 31) + Color.m2983hashCodeimpl(this.errorIndicatorColor)) * 31) + Color.m2983hashCodeimpl(this.disabledIndicatorColor)) * 31) + Color.m2983hashCodeimpl(this.leadingIconColor)) * 31) + Color.m2983hashCodeimpl(this.disabledLeadingIconColor)) * 31) + Color.m2983hashCodeimpl(this.errorLeadingIconColor)) * 31) + Color.m2983hashCodeimpl(this.trailingIconColor)) * 31) + Color.m2983hashCodeimpl(this.focusedTrailingIconColor)) * 31) + Color.m2983hashCodeimpl(this.disabledTrailingIconColor)) * 31) + Color.m2983hashCodeimpl(this.errorTrailingIconColor)) * 31) + Color.m2983hashCodeimpl(this.backgroundColor)) * 31) + Color.m2983hashCodeimpl(this.focusedLabelColor)) * 31) + Color.m2983hashCodeimpl(this.unfocusedLabelColor)) * 31) + Color.m2983hashCodeimpl(this.disabledLabelColor)) * 31) + Color.m2983hashCodeimpl(this.errorLabelColor)) * 31) + Color.m2983hashCodeimpl(this.placeholderColor)) * 31) + Color.m2983hashCodeimpl(this.disabledPlaceholderColor);
    }
    ...
    public State<Color> indicatorColor(boolean z8, boolean z9, InteractionSource interactionSource, Composer composer, int i8) {
        ...
        if (z8) {
            ...
            rememberUpdatedState = SingleValueAnimationKt.m192animateColorAsStateeuL9pac(j9, AnimationSpecKt.tween$default(150, 0, null, 6, null), null, null, composer, 48, 12);
            composer.endReplaceableGroup();
        } else {
