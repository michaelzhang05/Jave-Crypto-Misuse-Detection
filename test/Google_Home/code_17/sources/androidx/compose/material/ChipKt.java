...
public final class ChipKt {
    ...
    private static final float HorizontalPadding = Dp.m5183constructorimpl(12);
    private static final float LeadingIconStartSpacing = Dp.m5183constructorimpl(4);
    private static final float SelectedIconContainerSize = Dp.m5183constructorimpl(24);

    static {
        float f8 = 8;
        LeadingIconEndSpacing = Dp.m5183constructorimpl(f8);
        TrailingIconSpacing = Dp.m5183constructorimpl(f8);
    }
    ...
    */
    public static final void Chip(kotlin.jvm.functions.Function0 r34, androidx.compose.ui.Modifier r35, boolean r36, androidx.compose.foundation.interaction.MutableInteractionSource r37, androidx.compose.ui.graphics.Shape r38, androidx.compose.foundation.BorderStroke r39, androidx.compose.material.ChipColors r40, a6.InterfaceC1668n r41, a6.InterfaceC1669o r42, androidx.compose.runtime.Composer r43, int r44, int r45) {
        /*
            Method dump skipped, instructions count: 707
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.ChipKt.Chip(kotlin.jvm.functions.Function0, androidx.compose.ui.Modifier, boolean, androidx.compose.foundation.interaction.MutableInteractionSource, androidx.compose.ui.graphics.Shape, androidx.compose.foundation.BorderStroke, androidx.compose.material.ChipColors, a6.n, a6.o, androidx.compose.runtime.Composer, int, int):void");
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static final void FilterChip(boolean r43, kotlin.jvm.functions.Function0 r44, androidx.compose.ui.Modifier r45, boolean r46, androidx.compose.foundation.interaction.MutableInteractionSource r47, androidx.compose.ui.graphics.Shape r48, androidx.compose.foundation.BorderStroke r49, androidx.compose.material.SelectableChipColors r50, a6.InterfaceC1668n r51, a6.InterfaceC1668n r52, a6.InterfaceC1668n r53, a6.InterfaceC1669o r54, androidx.compose.runtime.Composer r55, int r56, int r57, int r58) {
        /*
            Method dump skipped, instructions count: 896
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.ChipKt.FilterChip(boolean, kotlin.jvm.functions.Function0, androidx.compose.ui.Modifier, boolean, androidx.compose.foundation.interaction.MutableInteractionSource, androidx.compose.ui.graphics.Shape, androidx.compose.foundation.BorderStroke, androidx.compose.material.SelectableChipColors, a6.n, a6.n, a6.n, a6.o, androidx.compose.runtime.Composer, int, int, int):void");
    }
}
