...
public final class AnchoredDraggableState<T> {
    ...
    public static final class Companion {
        ...
        public final <T> Saver<AnchoredDraggableState<T>, T> Saver(AnimationSpec<Float> animationSpec, Function1 confirmValueChange, Function1 positionalThreshold, Function0 velocityThreshold) {
            ...
            AbstractC3255y.i(positionalThreshold, "positionalThreshold");
            AbstractC3255y.i(velocityThreshold, "velocityThreshold");
    ...
    public static /* synthetic */ Object anchoredDrag$default(AnchoredDraggableState anchoredDraggableState, MutatePriority mutatePriority, InterfaceC1669o interfaceC1669o, d dVar, int i8, Object obj) {
        if ((i8 & 1) != 0) {
            mutatePriority = MutatePriority.Default;
        }
        return anchoredDraggableState.anchoredDrag(mutatePriority, interfaceC1669o, dVar);
    }
    ...
    public final T computeTarget(float f8, T t8, float f9) {
        ...
        if (!AbstractC3255y.b(f10, f8) && f10 != null) {
    ...
    public final T computeTargetWithoutThresholds(float f8, T t8) {
        ...
        if (!AbstractC3255y.b(f9, f8) && f9 != null) {
            if (f9.floatValue() < f8) {
                return (T) AnchoredDraggableKt.access$closestAnchor(anchors$material_release, f8, true);
            }
            return (T) AnchoredDraggableKt.access$closestAnchor(anchors$material_release, f8, false);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public final Object doAnchoredDrag(T t8, MutatePriority mutatePriority, InterfaceC1669o interfaceC1669o, d dVar) {
        Object e8 = N.e(new AnchoredDraggableState$doAnchoredDrag$2(t8, this, mutatePriority, interfaceC1669o, null), dVar);
        if (e8 == T5.b.e()) {
            return e8;
        }
        return I.f8278a;
    ...
    public final Object anchoredDrag(MutatePriority mutatePriority, InterfaceC1669o interfaceC1669o, d dVar) {
        Object doAnchoredDrag = doAnchoredDrag(null, mutatePriority, interfaceC1669o, dVar);
        return doAnchoredDrag == T5.b.e() ? doAnchoredDrag : I.f8278a;
    }
    ...
    public final void updateAnchors$material_release(Map<T, Float> newAnchors, AnchorChangedCallback<T> anchorChangedCallback) {
        ...
        if (!AbstractC3255y.d(getAnchors$material_release(), newAnchors)) {
            Map<T, Float> anchors$material_release = getAnchors$material_release();
    ...
    public final Object anchoredDrag(T t8, MutatePriority mutatePriority, InterfaceC1669o interfaceC1669o, d dVar) {
        Object doAnchoredDrag = doAnchoredDrag(t8, mutatePriority, interfaceC1669o, dVar);
        return doAnchoredDrag == T5.b.e() ? doAnchoredDrag : I.f8278a;
    }

    public static /* synthetic */ Object anchoredDrag$default(AnchoredDraggableState anchoredDraggableState, Object obj, MutatePriority mutatePriority, InterfaceC1669o interfaceC1669o, d dVar, int i8, Object obj2) {
        if ((i8 & 2) != 0) {
            mutatePriority = MutatePriority.Default;
        }
        return anchoredDraggableState.anchoredDrag(obj, mutatePriority, interfaceC1669o, dVar);
    }

    public /* synthetic */ AnchoredDraggableState(Object obj, Function1 function1, Function0 function0, AnimationSpec animationSpec, Function1 function12, int i8, AbstractC3247p abstractC3247p) {
