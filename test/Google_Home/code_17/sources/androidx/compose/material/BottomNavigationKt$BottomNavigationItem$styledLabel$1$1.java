...
public final class BottomNavigationKt$BottomNavigationItem$styledLabel$1$1 extends AbstractC3256z implements InterfaceC1668n {
    final /* synthetic */ int $$dirty;
    final /* synthetic */ InterfaceC1668n $label;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public BottomNavigationKt$BottomNavigationItem$styledLabel$1$1(InterfaceC1668n interfaceC1668n, int i8) {
        super(2);
    ...
    public final void invoke(Composer composer, int i8) {
        ...
        TextKt.ProvideTextStyle(m4724copyv2rsoow, this.$label, composer, (this.$$dirty >> 15) & 112);
        if (ComposerKt.isTraceInProgress()) {
