...
public final class SliderKt$sliderTapModifier$2 extends AbstractC3256z implements InterfaceC1669o {
    ...
    public static final class AnonymousClass1 extends l implements InterfaceC1668n {
        ...
        /* loaded from: classes.dex */
        public static final class C03231 extends l implements InterfaceC1669o {
            final /* synthetic */ boolean $isRtl;
            final /* synthetic */ float $maxPx;
            final /* synthetic */ MutableState<Float> $pressOffset;
            final /* synthetic */ State<Float> $rawOffset;
            ...
            C03231(boolean z8, float f8, MutableState<Float> mutableState, State<Float> state, d dVar) {
                super(3, dVar);
                this.$isRtl = z8;
                this.$maxPx = f8;
            ...
            public /* bridge */ /* synthetic */ Object invoke(Object obj, Object obj2, Object obj3) {
                return m1335invoked4ec7I((PressGestureScope) obj, ((Offset) obj2).m2750unboximpl(), (d) obj3);
            }

            /* renamed from: invoke-d-4ec7I, reason: not valid java name */
            public final Object m1335invoked4ec7I(PressGestureScope pressGestureScope, long j8, d dVar) {
                C03231 c03231 = new C03231(this.$isRtl, this.$maxPx, this.$pressOffset, this.$rawOffset, dVar);
                c03231.L$0 = pressGestureScope;
                c03231.J$0 = j8;
                return c03231.invokeSuspend(I.f8278a);
            }
        ...
        public static final class AnonymousClass2 extends AbstractC3256z implements Function1 {
            ...
            /* loaded from: classes.dex */
            public static final class C03241 extends l implements InterfaceC1668n {
                final /* synthetic */ DraggableState $draggableState;
                final /* synthetic */ State<Function1> $gestureEndAction;
                int label;
                ...
                /* loaded from: classes.dex */
                public static final class C03251 extends l implements InterfaceC1668n {
                    private /* synthetic */ Object L$0;
                    int label;
                    ...
                    public final Object invoke(DragScope dragScope, d dVar) {
                        return ((C03251) create(dragScope, dVar)).invokeSuspend(I.f8278a);
                    }
                ...
                C03241(DraggableState draggableState, State<? extends Function1> state, d dVar) {
                    super(2, dVar);
                ...
                @Override // kotlin.coroutines.jvm.internal.a
                public final d create(Object obj, d dVar) {
                    return new C03241(this.$draggableState, this.$gestureEndAction, dVar);
                }
                ...
                public final Object invokeSuspend(Object obj) {
                    ...
                    if (i8 != 0) {
                        ...
                        this.label = 1;
                        if (draggableState.drag(mutatePriority, c03251, this) == e8) {
                            return e8;
                        }
                    }
                ...
                public final Object invoke(M m8, d dVar) {
                    return ((C03241) create(m8, dVar)).invokeSuspend(I.f8278a);
                }
            }
            ...
            public /* bridge */ /* synthetic */ Object invoke(Object obj) {
                m1336invokek4lQ0M(((Offset) obj).m2750unboximpl());
                return I.f8278a;
            }

            /* renamed from: invoke-k-4lQ0M, reason: not valid java name */
            public final void m1336invokek4lQ0M(long j8) {
                AbstractC3364k.d(this.$scope, null, null, new C03241(this.$draggableState, this.$gestureEndAction, null), 3, null);
            }
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i8 != 0) {
                ...
                C03231 c03231 = new C03231(this.$isRtl, this.$maxPx, this.$pressOffset, this.$rawOffset, null);
                AnonymousClass2 anonymousClass2 = new AnonymousClass2(this.$scope, this.$draggableState, this.$gestureEndAction);
                this.label = 1;
                if (TapGestureDetectorKt.detectTapGestures$default(pointerInputScope, null, null, c03231, anonymousClass2, this, 3, null) == e8) {
                    return e8;
                }
            }
            return I.f8278a;
    ...
    public final Modifier invoke(Modifier composed, Composer composer, int i8) {
        ...
        if (this.$enabled) {
            ...
            composer.endReplaceableGroup();
            composed = SuspendingPointerInputFilterKt.pointerInput(composed, new Object[]{this.$draggableState, this.$interactionSource, Float.valueOf(this.$maxPx), Boolean.valueOf(this.$isRtl)}, (InterfaceC1668n) new AnonymousClass1(this.$isRtl, this.$maxPx, this.$pressOffset, this.$rawOffset, coroutineScope, this.$draggableState, this.$gestureEndAction, null));
        }
        if (ComposerKt.isTraceInProgress()) {
