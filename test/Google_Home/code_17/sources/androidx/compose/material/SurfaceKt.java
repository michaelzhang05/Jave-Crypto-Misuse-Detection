...
public final class SurfaceKt {
    ...
    */
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static final void m1358SurfaceFjzlyU(androidx.compose.ui.Modifier r26, androidx.compose.ui.graphics.Shape r27, long r28, long r30, androidx.compose.foundation.BorderStroke r32, float r33, a6.InterfaceC1668n r34, androidx.compose.runtime.Composer r35, int r36, int r37) {
        /*
            Method dump skipped, instructions count: 522
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.SurfaceKt.m1358SurfaceFjzlyU(androidx.compose.ui.Modifier, androidx.compose.ui.graphics.Shape, long, long, androidx.compose.foundation.BorderStroke, float, a6.n, androidx.compose.runtime.Composer, int, int):void");
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static final void m1359SurfaceLPr_se0(kotlin.jvm.functions.Function0 r30, androidx.compose.ui.Modifier r31, boolean r32, androidx.compose.ui.graphics.Shape r33, long r34, long r36, androidx.compose.foundation.BorderStroke r38, float r39, androidx.compose.foundation.interaction.MutableInteractionSource r40, a6.InterfaceC1668n r41, androidx.compose.runtime.Composer r42, int r43, int r44) {
        /*
            Method dump skipped, instructions count: 741
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.SurfaceKt.m1359SurfaceLPr_se0(kotlin.jvm.functions.Function0, androidx.compose.ui.Modifier, boolean, androidx.compose.ui.graphics.Shape, long, long, androidx.compose.foundation.BorderStroke, float, androidx.compose.foundation.interaction.MutableInteractionSource, a6.n, androidx.compose.runtime.Composer, int, int):void");
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static final void m1360SurfaceNy5ogXk(boolean r33, kotlin.jvm.functions.Function0 r34, androidx.compose.ui.Modifier r35, boolean r36, androidx.compose.ui.graphics.Shape r37, long r38, long r40, androidx.compose.foundation.BorderStroke r42, float r43, androidx.compose.foundation.interaction.MutableInteractionSource r44, a6.InterfaceC1668n r45, androidx.compose.runtime.Composer r46, int r47, int r48, int r49) {
        /*
            Method dump skipped, instructions count: 781
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.SurfaceKt.m1360SurfaceNy5ogXk(boolean, kotlin.jvm.functions.Function0, androidx.compose.ui.Modifier, boolean, androidx.compose.ui.graphics.Shape, long, long, androidx.compose.foundation.BorderStroke, float, androidx.compose.foundation.interaction.MutableInteractionSource, a6.n, androidx.compose.runtime.Composer, int, int, int):void");
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: surface-8ww4TTg, reason: not valid java name */
    public static final Modifier m1364surface8ww4TTg(Modifier modifier, Shape shape, long j8, BorderStroke borderStroke, float f8) {
        Modifier modifier2;
    ...
    public static final long m1365surfaceColorAtElevationcq6XJ1M(long j8, ElevationOverlay elevationOverlay, float f8, Composer composer, int i8) {
        composer.startReplaceableGroup(1561611256);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1561611256, i8, -1, "androidx.compose.material.surfaceColorAtElevation (Surface.kt:630)");
        }
        if (Color.m2977equalsimpl0(j8, MaterialTheme.INSTANCE.getColors(composer, 6).m1187getSurface0d7_KjU()) && elevationOverlay != null) {
            j8 = elevationOverlay.mo1217apply7g2Lkgo(j8, f8, composer, (i8 & 14) | ((i8 >> 3) & 112) | ((i8 << 3) & 896));
        }
        if (ComposerKt.isTraceInProgress()) {
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static final void m1361SurfaceNy5ogXk(boolean r33, kotlin.jvm.functions.Function1 r34, androidx.compose.ui.Modifier r35, boolean r36, androidx.compose.ui.graphics.Shape r37, long r38, long r40, androidx.compose.foundation.BorderStroke r42, float r43, androidx.compose.foundation.interaction.MutableInteractionSource r44, a6.InterfaceC1668n r45, androidx.compose.runtime.Composer r46, int r47, int r48, int r49) {
        /*
            Method dump skipped, instructions count: 781
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.SurfaceKt.m1361SurfaceNy5ogXk(boolean, kotlin.jvm.functions.Function1, androidx.compose.ui.Modifier, boolean, androidx.compose.ui.graphics.Shape, long, long, androidx.compose.foundation.BorderStroke, float, androidx.compose.foundation.interaction.MutableInteractionSource, a6.n, androidx.compose.runtime.Composer, int, int, int):void");
    }
}
