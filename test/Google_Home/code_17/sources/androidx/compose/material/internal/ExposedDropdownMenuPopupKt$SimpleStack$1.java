        ...
        if (size != 0) {
            ...
            if (size != 1) {
                ...
                for (int i11 = 0; i11 < size2; i11++) {
                    arrayList.add(measurables.get(i11).mo4136measureBRTryo0(j8));
                }
            ...
            Placeable mo4136measureBRTryo0 = measurables.get(0).mo4136measureBRTryo0(j8);
            return MeasureScope.CC.q(Layout, mo4136measureBRTryo0.getWidth(), mo4136measureBRTryo0.getHeight(), null, new ExposedDropdownMenuPopupKt$SimpleStack$1$measure$2(mo4136measureBRTryo0), 4, null);
        }
