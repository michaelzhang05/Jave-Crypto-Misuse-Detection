...
public final class PopupLayout extends AbstractComposeView implements ViewRootForInspector, ViewTreeObserver.OnGlobalLayoutListener {
    ...
    private final InterfaceC1668n dismissOnOutsideClick;
    ...
    */
    public PopupLayout(kotlin.jvm.functions.Function0 r8, java.lang.String r9, android.view.View r10, androidx.compose.ui.unit.Density r11, androidx.compose.ui.window.PopupPositionProvider r12, java.util.UUID r13) {
        /*
            ...
            kotlin.jvm.internal.AbstractC3255y.g(r8, r9)
            ...
            r12 = 8
            float r12 = (float) r12
            float r12 = androidx.compose.ui.unit.Dp.m5183constructorimpl(r12)
            ...
            float r10 = r11.mo453toPx0680j_4(r12)
            r7.setElevation(r10)
            ...
            a6.n r10 = r10.m1425getLambda1$material_release()
    ...
    public void Content(Composer composer, int i8) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1288867704, i8, -1, "androidx.compose.material.internal.PopupLayout.Content (ExposedDropdownMenuPopup.kt:301)");
        }
    ...
    public final IntSize m1428getPopupContentSizebOM6tXw() {
    ...
    public void onGlobalLayout() {
        ...
        if (!AbstractC3255y.d(this.tmpWindowVisibleFrame, this.previousWindowVisibleFrame)) {
            updatePosition();
        }
    }
    ...
    */
    public boolean onTouchEvent(android.view.MotionEvent r6) {
        ...
        L3f:
            ...
            if (r0 == 0) goto L81
            a6.n r2 = r5.dismissOnOutsideClick
            float r3 = r6.getX()
        ...
        L59:
            ...
            androidx.compose.ui.geometry.Offset r1 = androidx.compose.ui.geometry.Offset.m2729boximpl(r3)
        L75:
    ...
    public final void m1429setPopupContentSizefhxjrPA(IntSize intSize) {
        this.popupContentSize$delegate.setValue(intSize);
    }

    public final void setPositionProvider(PopupPositionProvider popupPositionProvider) {
        AbstractC3255y.i(popupPositionProvider, "<set-?>");
    ...
    public final void updateParameters(Function0 function0, String testTag, LayoutDirection layoutDirection) {
        AbstractC3255y.i(testTag, "testTag");
    ...
    public final void updatePosition() {
        IntSize m1428getPopupContentSizebOM6tXw;
        IntRect parentBounds = getParentBounds();
        if (parentBounds != null && (m1428getPopupContentSizebOM6tXw = m1428getPopupContentSizebOM6tXw()) != null) {
            long m5353unboximpl = m1428getPopupContentSizebOM6tXw.m5353unboximpl();
            Rect rect = this.previousWindowVisibleFrame;
            this.composeView.getWindowVisibleDisplayFrame(rect);
            IntRect intBounds = toIntBounds(rect);
            long mo1015calculatePositionllwVHH4 = this.positionProvider.mo1015calculatePositionllwVHH4(parentBounds, IntSizeKt.IntSize(intBounds.getWidth(), intBounds.getHeight()), this.parentLayoutDirection, m5353unboximpl);
            this.params.x = IntOffset.m5307getXimpl(mo1015calculatePositionllwVHH4);
            this.params.y = IntOffset.m5308getYimpl(mo1015calculatePositionllwVHH4);
            this.windowManager.updateViewLayout(this, this.params);
        }
    }

    public final void setContent(CompositionContext parent, InterfaceC1668n content) {
