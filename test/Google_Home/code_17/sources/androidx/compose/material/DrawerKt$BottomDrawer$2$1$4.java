...
final class DrawerKt$BottomDrawer$2$1$4 extends AbstractC3256z implements Function1 {
    ...
    public static final class AnonymousClass1 extends AbstractC3256z implements Function0 {
        ...
        /* loaded from: classes.dex */
        public static final class C03161 extends l implements InterfaceC1668n {
            final /* synthetic */ BottomDrawerState $drawerState;
            int label;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C03161(BottomDrawerState bottomDrawerState, d dVar) {
                super(2, dVar);
            ...
            public final d create(Object obj, d dVar) {
                return new C03161(this.$drawerState, dVar);
            }
            ...
            public final Object invoke(M m8, d dVar) {
                return ((C03161) create(m8, dVar)).invokeSuspend(I.f8278a);
            }
        }
        ...
        public final Boolean invoke() {
            if (this.$drawerState.confirmStateChange$material_release(BottomDrawerValue.Closed)) {
                AbstractC3364k.d(this.$scope, null, null, new C03161(this.$drawerState, null), 3, null);
            }
            return Boolean.TRUE;
        }
    }
