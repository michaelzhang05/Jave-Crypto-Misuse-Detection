...
final class AnchoredDraggableState$draggableState$1$drag$2 extends l implements InterfaceC1669o {
    ...
    public AnchoredDraggableState$draggableState$1$drag$2(AnchoredDraggableState$draggableState$1 anchoredDraggableState$draggableState$1, InterfaceC1668n interfaceC1668n, d dVar) {
        super(3, dVar);
    ...
    public final Object invoke(AnchoredDragScope anchoredDragScope, Map<T, Float> map, d dVar) {
        return new AnchoredDraggableState$draggableState$1$drag$2(this.this$0, this.$block, dVar).invokeSuspend(I.f8278a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i8 != 0) {
            ...
            this.label = 1;
            if (interfaceC1668n.invoke(anchoredDraggableState$draggableState$1$dragScope$1, this) == e8) {
                return e8;
            }
        }
        return I.f8278a;
