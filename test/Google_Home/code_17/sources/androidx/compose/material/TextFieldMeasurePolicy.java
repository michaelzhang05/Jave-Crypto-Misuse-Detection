...
public final class TextFieldMeasurePolicy implements MeasurePolicy {
    ...
    private final int intrinsicHeight(IntrinsicMeasureScope intrinsicMeasureScope, List<? extends IntrinsicMeasurable> list, int i8, InterfaceC1668n interfaceC1668n) {
        ...
        int i12;
        boolean z8;
        int m1415calculateHeightO3s9Psw;
        ...
        for (Object obj5 : list2) {
            if (AbstractC3255y.d(TextFieldImplKt.getLayoutId((IntrinsicMeasurable) obj5), "TextField")) {
                ...
                m1415calculateHeightO3s9Psw = TextFieldKt.m1415calculateHeightO3s9Psw(intValue, z8, i9, i11, i10, i12, TextFieldImplKt.getZeroConstraints(), intrinsicMeasureScope.getDensity(), this.paddingValues);
                return m1415calculateHeightO3s9Psw;
            }
        }
    ...
    private final int intrinsicWidth(List<? extends IntrinsicMeasurable> list, int i8, InterfaceC1668n interfaceC1668n) {
        ...
        int i11;
        int i12;
        int m1416calculateWidthVsPV1Ek;
        List<? extends IntrinsicMeasurable> list2 = list;
        for (Object obj5 : list2) {
            if (AbstractC3255y.d(TextFieldImplKt.getLayoutId((IntrinsicMeasurable) obj5), "TextField")) {
                int intValue = ((Number) interfaceC1668n.invoke(obj5, Integer.valueOf(i8))).intValue();
                ...
                m1416calculateWidthVsPV1Ek = TextFieldKt.m1416calculateWidthVsPV1Ek(i11, i10, intValue, i9, i12, TextFieldImplKt.getZeroConstraints());
                return m1416calculateWidthVsPV1Ek;
            }
        }
        throw new NoSuchElementException("Collection contains no element matching the predicate.");
    }
    ...
    public MeasureResult mo137measure3p2s80s(MeasureScope measure, List<? extends Measurable> measurables, long j8) {
        ...
        AbstractC3255y.i(measurables, "measurables");
        int mo447roundToPx0680j_4 = measure.mo447roundToPx0680j_4(this.paddingValues.mo558calculateTopPaddingD9Ej5fM());
        int mo447roundToPx0680j_42 = measure.mo447roundToPx0680j_4(this.paddingValues.mo555calculateBottomPaddingD9Ej5fM());
        ...
        int i10 = -mo447roundToPx0680j_42;
        int i11 = -(widthOrZero + TextFieldImplKt.widthOrZero(placeable2));
        long m5167offsetNN6EwU = ConstraintsKt.m5167offsetNN6EwU(m5142copyZbe2FdA$default, i11, i10);
        ...
        if (placeable3 != null) {
            i9 = (i10 - mo447roundToPx0680j_43) - max;
        } else {
            i9 = (-mo447roundToPx0680j_4) - mo447roundToPx0680j_42;
        }
        long m5167offsetNN6EwU2 = ConstraintsKt.m5167offsetNN6EwU(Constraints.m5142copyZbe2FdA$default(j8, 0, 0, 0, 0, 11, null), i11, i9);
        for (Measurable measurable4 : list) {
            if (AbstractC3255y.d(LayoutIdKt.getLayoutId(measurable4), "TextField")) {
                ...
                m1416calculateWidthVsPV1Ek = TextFieldKt.m1416calculateWidthVsPV1Ek(TextFieldImplKt.widthOrZero(placeable), TextFieldImplKt.widthOrZero(placeable2), mo4136measureBRTryo0.getWidth(), TextFieldImplKt.widthOrZero(placeable3), TextFieldImplKt.widthOrZero(placeable4), j8);
                ...
                m1415calculateHeightO3s9Psw = TextFieldKt.m1415calculateHeightO3s9Psw(height, z8, max, TextFieldImplKt.heightOrZero(placeable), TextFieldImplKt.heightOrZero(placeable2), TextFieldImplKt.heightOrZero(placeable4), j8, measure.getDensity(), this.paddingValues);
                return MeasureScope.CC.q(measure, m1416calculateWidthVsPV1Ek, m1415calculateHeightO3s9Psw, null, new TextFieldMeasurePolicy$measure$1(placeable3, mo447roundToPx0680j_4, i8, m1416calculateWidthVsPV1Ek, m1415calculateHeightO3s9Psw, mo4136measureBRTryo0, placeable4, placeable, placeable2, this, max, mo447roundToPx0680j_43, measure), 4, null);
            }
        }
        throw new NoSuchElementException("Collection contains no element matching the predicate.");
    }
