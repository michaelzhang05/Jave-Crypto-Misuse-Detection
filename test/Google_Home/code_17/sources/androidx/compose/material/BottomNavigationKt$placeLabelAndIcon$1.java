...
final class BottomNavigationKt$placeLabelAndIcon$1 extends AbstractC3256z implements Function1 {
    ...
    public BottomNavigationKt$placeLabelAndIcon$1(float f8, Placeable placeable, int i8, int i9, int i10, Placeable placeable2, int i11, int i12) {
        super(1);
