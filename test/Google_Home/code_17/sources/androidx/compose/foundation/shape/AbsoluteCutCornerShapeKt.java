...
public final class AbsoluteCutCornerShapeKt {
    ...
    public static final AbsoluteCutCornerShape m841AbsoluteCutCornerShape0680j_4(float f8) {
        return AbsoluteCutCornerShape(CornerSizeKt.m849CornerSize0680j_4(f8));
    }

    /* renamed from: AbsoluteCutCornerShape-a9UjIt4, reason: not valid java name */
    public static final AbsoluteCutCornerShape m842AbsoluteCutCornerShapea9UjIt4(float f8, float f9, float f10, float f11) {
        return new AbsoluteCutCornerShape(CornerSizeKt.m849CornerSize0680j_4(f8), CornerSizeKt.m849CornerSize0680j_4(f9), CornerSizeKt.m849CornerSize0680j_4(f10), CornerSizeKt.m849CornerSize0680j_4(f11));
    }

    /* renamed from: AbsoluteCutCornerShape-a9UjIt4$default, reason: not valid java name */
    public static /* synthetic */ AbsoluteCutCornerShape m843AbsoluteCutCornerShapea9UjIt4$default(float f8, float f9, float f10, float f11, int i8, Object obj) {
        if ((i8 & 1) != 0) {
        ...
        return m842AbsoluteCutCornerShapea9UjIt4(f8, f9, f10, f11);
    }
