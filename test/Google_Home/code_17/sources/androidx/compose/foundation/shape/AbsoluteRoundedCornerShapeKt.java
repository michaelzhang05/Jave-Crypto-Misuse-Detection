...
public final class AbsoluteRoundedCornerShapeKt {
    public static final AbsoluteRoundedCornerShape AbsoluteRoundedCornerShape(CornerSize corner) {
        AbstractC3255y.i(corner, "corner");
    ...
    public static final AbsoluteRoundedCornerShape m845AbsoluteRoundedCornerShape0680j_4(float f8) {
        return AbsoluteRoundedCornerShape(CornerSizeKt.m849CornerSize0680j_4(f8));
    }

    /* renamed from: AbsoluteRoundedCornerShape-a9UjIt4, reason: not valid java name */
    public static final AbsoluteRoundedCornerShape m846AbsoluteRoundedCornerShapea9UjIt4(float f8, float f9, float f10, float f11) {
        return new AbsoluteRoundedCornerShape(CornerSizeKt.m849CornerSize0680j_4(f8), CornerSizeKt.m849CornerSize0680j_4(f9), CornerSizeKt.m849CornerSize0680j_4(f10), CornerSizeKt.m849CornerSize0680j_4(f11));
    }

    /* renamed from: AbsoluteRoundedCornerShape-a9UjIt4$default, reason: not valid java name */
    public static /* synthetic */ AbsoluteRoundedCornerShape m847AbsoluteRoundedCornerShapea9UjIt4$default(float f8, float f9, float f10, float f11, int i8, Object obj) {
        if ((i8 & 1) != 0) {
        ...
        return m846AbsoluteRoundedCornerShapea9UjIt4(f8, f9, f10, f11);
    }
