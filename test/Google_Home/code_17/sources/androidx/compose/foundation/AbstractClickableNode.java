...
abstract class AbstractClickableNode extends DelegatingNode implements PointerInputModifierNode, KeyInputModifierNode {
    ...
    public static final class InteractionData {
        ...
        private long centreOffset = Offset.Companion.m2756getZeroF1C5BW0();

        /* renamed from: getCentreOffset-F1C5BW0, reason: not valid java name */
        public final long m273getCentreOffsetF1C5BW0() {
        ...
        public final void m274setCentreOffsetk4lQ0M(long j8) {
    ...
    public /* synthetic */ AbstractClickableNode(MutableInteractionSource mutableInteractionSource, boolean z8, String str, Role role, Function0 function0, AbstractC3247p abstractC3247p) {
        this(mutableInteractionSource, z8, str, role, function0);
    }

    /* renamed from: updateCommon-XHw0xAI$default, reason: not valid java name */
    public static /* synthetic */ void m268updateCommonXHw0xAI$default(AbstractClickableNode abstractClickableNode, MutableInteractionSource mutableInteractionSource, boolean z8, String str, Role role, Function0 function0, int i8, Object obj) {
        if (obj == null) {
            if ((i8 & 8) != 0) {
                role = null;
            }
            abstractClickableNode.m272updateCommonXHw0xAI(mutableInteractionSource, z8, str, role, function0);
            return;
        }
    ...
    public boolean mo269onKeyEventZmokQxo(KeyEvent event) {
        AbstractC3255y.i(event, "event");
        if (this.enabled && Clickable_androidKt.m335isPressZmokQxo(event)) {
            if (this.interactionData.getCurrentKeyPressInteractions().containsKey(Key.m3593boximpl(KeyEvent_androidKt.m3904getKeyZmokQxo(event)))) {
                return false;
            }
            PressInteraction.Press press = new PressInteraction.Press(this.interactionData.m273getCentreOffsetF1C5BW0(), null);
            this.interactionData.getCurrentKeyPressInteractions().put(Key.m3593boximpl(KeyEvent_androidKt.m3904getKeyZmokQxo(event)), press);
            AbstractC3364k.d(getCoroutineScope(), null, null, new AbstractClickableNode$onKeyEvent$1(this, press, null), 3, null);
        } else {
            if (!this.enabled || !Clickable_androidKt.m333isClickZmokQxo(event)) {
                return false;
            }
            PressInteraction.Press remove = this.interactionData.getCurrentKeyPressInteractions().remove(Key.m3593boximpl(KeyEvent_androidKt.m3904getKeyZmokQxo(event)));
            if (remove != null) {
                AbstractC3364k.d(getCoroutineScope(), null, null, new AbstractClickableNode$onKeyEvent$2$1(this, remove, null), 3, null);
            }
            this.onClick.invoke();
        }
        return true;
    ...
    public void mo270onPointerEventH0pRuoY(PointerEvent pointerEvent, PointerEventPass pass, long j8) {
        ...
        getClickablePointerInputNode().mo270onPointerEventH0pRuoY(pointerEvent, pass, j8);
    }

    @Override // androidx.compose.ui.input.key.KeyInputModifierNode
    /* renamed from: onPreKeyEvent-ZmokQxo, reason: not valid java name */
    public boolean mo271onPreKeyEventZmokQxo(KeyEvent event) {
        AbstractC3255y.i(event, "event");
        return false;
    }
    ...
    public final void m272updateCommonXHw0xAI(MutableInteractionSource interactionSource, boolean z8, String str, Role role, Function0 onClick) {
        AbstractC3255y.i(interactionSource, "interactionSource");
        AbstractC3255y.i(onClick, "onClick");
        if (!AbstractC3255y.d(this.interactionSource, interactionSource)) {
            disposeInteractionSource();
