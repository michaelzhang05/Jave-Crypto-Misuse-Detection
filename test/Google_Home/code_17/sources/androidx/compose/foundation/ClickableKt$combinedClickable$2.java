...
public final class ClickableKt$combinedClickable$2 extends AbstractC3256z implements InterfaceC1669o {
    ...
    public final Modifier invoke(Modifier composed, Composer composer, int i8) {
        ...
        Modifier m321combinedClickableXVZzFYc = ClickableKt.m321combinedClickableXVZzFYc(companion, (MutableInteractionSource) rememberedValue, indication, this.$enabled, this.$onClickLabel, this.$role, this.$onLongClickLabel, this.$onLongClick, this.$onDoubleClick, this.$onClick);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return m321combinedClickableXVZzFYc;
    }
}
