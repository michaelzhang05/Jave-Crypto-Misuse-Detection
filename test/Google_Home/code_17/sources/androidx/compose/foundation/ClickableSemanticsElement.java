...
final class ClickableSemanticsElement extends ModifierNodeElement<ClickableSemanticsNode> {
    ...
    public /* synthetic */ ClickableSemanticsElement(boolean z8, Role role, String str, Function0 function0, String str2, Function0 function02, AbstractC3247p abstractC3247p) {
    ...
    public boolean equals(Object obj) {
        ...
        if (this.enabled == clickableSemanticsElement.enabled && AbstractC3255y.d(this.role, clickableSemanticsElement.role) && AbstractC3255y.d(this.onLongClickLabel, clickableSemanticsElement.onLongClickLabel) && AbstractC3255y.d(this.onLongClick, clickableSemanticsElement.onLongClick) && AbstractC3255y.d(this.onClickLabel, clickableSemanticsElement.onClickLabel) && AbstractC3255y.d(this.onClick, clickableSemanticsElement.onClick)) {
            return true;
        }
        return false;
    }
    ...
    public void update(ClickableSemanticsNode node) {
        ...
        node.m332updateUMe6uN4(this.enabled, this.onClickLabel, this.role, this.onClick, this.onLongClickLabel, this.onLongClick);
    }
}
