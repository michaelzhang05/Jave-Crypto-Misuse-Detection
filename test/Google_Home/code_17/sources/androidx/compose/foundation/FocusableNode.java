...
final class FocusableNode extends DelegatingNode implements FocusEventModifierNode, LayoutAwareModifierNode, SemanticsModifierNode, GlobalPositionAwareModifierNode {
    ...
    public void onFocusEvent(FocusState focusState) {
        ...
        if (!AbstractC3255y.d(this.focusState, focusState)) {
            boolean isFocused = focusState.isFocused();
            if (isFocused) {
                AbstractC3364k.d(getCoroutineScope(), null, null, new FocusableNode$onFocusEvent$1(this, null), 3, null);
            }
            if (isAttached()) {
    ...
    public /* synthetic */ void mo342onRemeasuredozmzZPI(long j8) {
