...
public final class AndroidSelectionHandles_androidKt$SelectionHandle$1 extends AbstractC3256z implements InterfaceC1668n {
    ...
    public AndroidSelectionHandles_androidKt$SelectionHandle$1(InterfaceC1668n interfaceC1668n, Modifier modifier, boolean z8, long j8, int i8, ResolvedTextDirection resolvedTextDirection, boolean z9) {
        super(2);
    ...
    public final void invoke(Composer composer, int i8) {
        ...
        if (this.$content == null) {
            ...
            Offset m2729boximpl = Offset.m2729boximpl(this.$position);
            boolean z8 = this.$isStartHandle;
            long j8 = this.$position;
            composer.startReplaceableGroup(511388516);
            boolean changed = composer.changed(valueOf) | composer.changed(m2729boximpl);
