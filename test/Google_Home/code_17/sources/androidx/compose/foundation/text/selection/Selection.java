...
public final class Selection {
    ...
    public boolean equals(Object obj) {
        ...
        return AbstractC3255y.d(this.start, selection.start) && AbstractC3255y.d(this.end, selection.end) && this.handlesCrossed == selection.handlesCrossed;
    }
    ...
    public final long m1024toTextRanged9O1mEE() {
        return TextRangeKt.TextRange(this.start.getOffset(), this.end.getOffset());
    }

    public /* synthetic */ Selection(AnchorInfo anchorInfo, AnchorInfo anchorInfo2, boolean z8, int i8, AbstractC3247p abstractC3247p) {
