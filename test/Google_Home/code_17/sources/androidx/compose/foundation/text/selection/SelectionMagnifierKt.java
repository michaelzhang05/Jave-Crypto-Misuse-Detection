...
public final class SelectionMagnifierKt {
    ...
    static {
        ...
        MagnifierSpringSpec = new SpringSpec<>(0.0f, 0.0f, Offset.m2729boximpl(Offset), 3, null);
    }
    ...
    public static final Modifier animatedSelectionMagnifier(Modifier modifier, Function0 magnifierCenter, Function1 platformMagnifier) {
        ...
        AbstractC3255y.i(magnifierCenter, "magnifierCenter");
        AbstractC3255y.i(platformMagnifier, "platformMagnifier");
    ...
    public static final State<Offset> rememberAnimatedMagnifierPosition(Function0 function0, Composer composer, int i8) {
        ...
        if (rememberedValue2 == companion.getEmpty()) {
            rememberedValue2 = new Animatable(Offset.m2729boximpl(rememberAnimatedMagnifierPosition$lambda$1(state)), UnspecifiedSafeOffsetVectorConverter, Offset.m2729boximpl(OffsetDisplacementThreshold), null, 8, null);
            composer.updateRememberedValue(rememberedValue2);
        }
        composer.endReplaceableGroup();
        Animatable animatable = (Animatable) rememberedValue2;
        EffectsKt.LaunchedEffect(I.f8278a, new SelectionMagnifierKt$rememberAnimatedMagnifierPosition$1(state, animatable, null), composer, 70);
