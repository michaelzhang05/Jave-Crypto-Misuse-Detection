...
public final class TextStringSimpleNode extends Modifier.Node implements LayoutModifierNode, DrawModifierNode, SemanticsModifierNode {
    ...
    public /* synthetic */ TextStringSimpleNode(String str, TextStyle textStyle, FontFamily.Resolver resolver, int i8, boolean z8, int i9, int i10, ColorProducer colorProducer, AbstractC3247p abstractC3247p) {
    ...
    public final ParagraphLayoutCache getLayoutCache() {
        ...
        AbstractC3255y.f(paragraphLayoutCache);
    ...
    public final void doInvalidations(boolean z8, boolean z9, boolean z10) {
        ...
        if (z9 || z10) {
            getLayoutCache().m996updateL6sJoHM(this.text, this.style, this.fontFamilyResolver, this.overflow, this.softWrap, this.maxLines, this.minLines);
    ...
    public void draw(ContentDrawScope contentDrawScope) {
        ...
        if (paragraph$foundation_release != null) {
            ...
            if (didOverflow$foundation_release) {
                Rect m2780Recttz77jQw = RectKt.m2780Recttz77jQw(Offset.Companion.m2756getZeroF1C5BW0(), SizeKt.Size(IntSize.m5349getWidthimpl(getLayoutCache().m993getLayoutSizeYbymL2g$foundation_release()), IntSize.m5348getHeightimpl(getLayoutCache().m993getLayoutSizeYbymL2g$foundation_release())));
                canvas.save();
            ...
            try {
                ...
                if (brush != null) {
                    ...
                    a.b(paragraph$foundation_release, canvas, m3012getUnspecified0d7_KjU, shadow2, textDecoration2, drawStyle2, 0, 32, null);
                }
                if (didOverflow$foundation_release) {
                    canvas.restore();
                    return;
    ...
    public MeasureResult mo368measure3p2s80s(MeasureScope measure, Measurable measurable, long j8) {
        ...
        boolean m994layoutWithConstraintsK40F9xA = layoutCache.m994layoutWithConstraintsK40F9xA(j8, measure.getLayoutDirection());
        ...
        AbstractC3255y.f(paragraph$foundation_release);
        long m993getLayoutSizeYbymL2g$foundation_release = layoutCache.m993getLayoutSizeYbymL2g$foundation_release();
        if (m994layoutWithConstraintsK40F9xA) {
            LayoutModifierNodeKt.invalidateLayer(this);
            Map<AlignmentLine, Integer> map = this.baselineCache;
            if (map == null) {
                map = new LinkedHashMap<>(2);
            }
            map.put(AlignmentLineKt.getFirstBaseline(), Integer.valueOf(AbstractC2055a.d(paragraph$foundation_release.getFirstBaseline())));
            map.put(AlignmentLineKt.getLastBaseline(), Integer.valueOf(AbstractC2055a.d(paragraph$foundation_release.getLastBaseline())));
            this.baselineCache = map;
        }
        Placeable mo4136measureBRTryo0 = measurable.mo4136measureBRTryo0(Constraints.Companion.m5159fixedJhjzzOo(IntSize.m5349getWidthimpl(m993getLayoutSizeYbymL2g$foundation_release), IntSize.m5348getHeightimpl(m993getLayoutSizeYbymL2g$foundation_release)));
        int m5349getWidthimpl = IntSize.m5349getWidthimpl(m993getLayoutSizeYbymL2g$foundation_release);
        int m5348getHeightimpl = IntSize.m5348getHeightimpl(m993getLayoutSizeYbymL2g$foundation_release);
        Map<AlignmentLine, Integer> map2 = this.baselineCache;
        AbstractC3255y.f(map2);
        return measure.layout(m5349getWidthimpl, m5348getHeightimpl, map2, new TextStringSimpleNode$measure$1(mo4136measureBRTryo0));
    }
    ...
    public final boolean m1009updateLayoutRelatedArgsHuAbxIM(TextStyle style, int i8, int i9, boolean z8, FontFamily.Resolver fontFamilyResolver, int i10) {
        AbstractC3255y.i(style, "style");
    ...
    public /* synthetic */ TextStringSimpleNode(String str, TextStyle textStyle, FontFamily.Resolver resolver, int i8, boolean z8, int i9, int i10, ColorProducer colorProducer, int i11, AbstractC3247p abstractC3247p) {
        this(str, textStyle, resolver, (i11 & 8) != 0 ? TextOverflow.Companion.m5136getClipgIe3tQ8() : i8, (i11 & 16) != 0 ? true : z8, (i11 & 32) != 0 ? Integer.MAX_VALUE : i9, (i11 & 64) != 0 ? 1 : i10, (i11 & 128) != 0 ? null : colorProducer, null);
    }
