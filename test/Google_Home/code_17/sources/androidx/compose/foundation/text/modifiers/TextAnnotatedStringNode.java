...
public final class TextAnnotatedStringNode extends Modifier.Node implements LayoutModifierNode, DrawModifierNode, SemanticsModifierNode {
    ...
    public /* synthetic */ TextAnnotatedStringNode(AnnotatedString annotatedString, TextStyle textStyle, FontFamily.Resolver resolver, Function1 function1, int i8, boolean z8, int i9, int i10, List list, Function1 function12, SelectionController selectionController, ColorProducer colorProducer, AbstractC3247p abstractC3247p) {
    ...
    public final MultiParagraphLayoutCache getLayoutCache() {
        ...
        AbstractC3255y.f(multiParagraphLayoutCache);
    ...
    public final void doInvalidations(boolean z8, boolean z9, boolean z10, boolean z11) {
        ...
        if (z9 || z10 || z11) {
            getLayoutCache().m990updateZNqEYIc(this.text, this.style, this.fontFamilyResolver, this.overflow, this.softWrap, this.maxLines, this.minLines, this.placeholders);
    ...
    public void draw(ContentDrawScope contentDrawScope) {
        ...
        if (textLayoutResult.getHasVisualOverflow() && !TextOverflow.m5129equalsimpl0(this.overflow, TextOverflow.Companion.m5138getVisiblegIe3tQ8())) {
            z8 = true;
        } else {
            z8 = false;
        }
        if (z8) {
            Rect m2780Recttz77jQw = RectKt.m2780Recttz77jQw(Offset.Companion.m2756getZeroF1C5BW0(), SizeKt.Size(IntSize.m5349getWidthimpl(textLayoutResult.m4670getSizeYbymL2g()), IntSize.m5348getHeightimpl(textLayoutResult.m4670getSizeYbymL2g())));
            canvas.save();
            T.o(canvas, m2780Recttz77jQw, 0, 2, null);
        }
        try {
            ...
            if (brush != null) {
                MultiParagraph.m4575painthn5TExg$default(multiParagraph, canvas, brush, this.style.getAlpha(), shadow2, textDecoration2, drawStyle2, 0, 64, null);
            } else {
                ColorProducer colorProducer = this.overrideColor;
                if (colorProducer != null) {
                    m3012getUnspecified0d7_KjU = colorProducer.mo1422invoke0d7_KjU();
                } else {
                    m3012getUnspecified0d7_KjU = Color.Companion.m3012getUnspecified0d7_KjU();
                }
                Color.Companion companion = Color.Companion;
                if (m3012getUnspecified0d7_KjU == companion.m3012getUnspecified0d7_KjU()) {
                    if (this.style.m4727getColor0d7_KjU() != companion.m3012getUnspecified0d7_KjU()) {
                        m3012getUnspecified0d7_KjU = this.style.m4727getColor0d7_KjU();
                    } else {
                        m3012getUnspecified0d7_KjU = companion.m3002getBlack0d7_KjU();
                    }
                }
                MultiParagraph.m4573paintLG529CI$default(multiParagraph, canvas, m3012getUnspecified0d7_KjU, shadow2, textDecoration2, drawStyle2, 0, 32, null);
            }
            if (z8) {
                canvas.restore();
            }
    ...
    public final void drawNonExtension(ContentDrawScope contentDrawScope) {
        AbstractC3255y.i(contentDrawScope, "contentDrawScope");
    ...
    public final int maxIntrinsicHeightNonExtension(IntrinsicMeasureScope intrinsicMeasureScope, IntrinsicMeasurable measurable, int i8) {
        AbstractC3255y.i(intrinsicMeasureScope, "intrinsicMeasureScope");
        AbstractC3255y.i(measurable, "measurable");
    ...
    public MeasureResult mo368measure3p2s80s(MeasureScope measure, Measurable measurable, long j8) {
        ...
        if (m989layoutWithConstraintsK40F9xA) {
            ...
            this.baselineCache = Q.k(x.a(AlignmentLineKt.getFirstBaseline(), Integer.valueOf(AbstractC2055a.d(textLayoutResult.getFirstBaseline()))), x.a(AlignmentLineKt.getLastBaseline(), Integer.valueOf(AbstractC2055a.d(textLayoutResult.getLastBaseline()))));
        }
        Function1 function12 = this.onPlaceholderLayout;
        if (function12 != null) {
            function12.invoke(textLayoutResult.getPlaceholderRects());
        }
        Placeable mo4136measureBRTryo0 = measurable.mo4136measureBRTryo0(Constraints.Companion.m5159fixedJhjzzOo(IntSize.m5349getWidthimpl(textLayoutResult.m4670getSizeYbymL2g()), IntSize.m5348getHeightimpl(textLayoutResult.m4670getSizeYbymL2g())));
        int m5349getWidthimpl = IntSize.m5349getWidthimpl(textLayoutResult.m4670getSizeYbymL2g());
        int m5348getHeightimpl = IntSize.m5348getHeightimpl(textLayoutResult.m4670getSizeYbymL2g());
        Map<AlignmentLine, Integer> map = this.baselineCache;
        AbstractC3255y.f(map);
        return measure.layout(m5349getWidthimpl, m5348getHeightimpl, map, new TextAnnotatedStringNode$measure$1(mo4136measureBRTryo0));
    }

    /* renamed from: measureNonExtension-3p2s80s, reason: not valid java name */
    public final MeasureResult m1007measureNonExtension3p2s80s(MeasureScope measureScope, Measurable measurable, long j8) {
        AbstractC3255y.i(measureScope, "measureScope");
        AbstractC3255y.i(measurable, "measurable");
        return mo368measure3p2s80s(measureScope, measurable, j8);
    }
    ...
    public final boolean updateCallbacks(Function1 function1, Function1 function12, SelectionController selectionController) {
        boolean z8;
        if (!AbstractC3255y.d(this.onTextLayout, function1)) {
            this.onTextLayout = function1;
            z8 = true;
        } else {
            z8 = false;
        }
        if (!AbstractC3255y.d(this.onPlaceholderLayout, function12)) {
            this.onPlaceholderLayout = function12;
            z8 = true;
        }
        if (!AbstractC3255y.d(this.selectionController, selectionController)) {
    ...
    public final boolean updateDraw(ColorProducer colorProducer, TextStyle style) {
        ...
        boolean z8 = !AbstractC3255y.d(colorProducer, this.overrideColor);
    ...
    public final boolean m1008updateLayoutRelatedArgsMPT68mk(TextStyle style, List<AnnotatedString.Range<Placeholder>> list, int i8, int i9, boolean z8, FontFamily.Resolver fontFamilyResolver, int i10) {
        AbstractC3255y.i(style, "style");
        AbstractC3255y.i(fontFamilyResolver, "fontFamilyResolver");
        boolean z9 = !this.style.hasSameLayoutAffectingAttributes(style);
        this.style = style;
        if (!AbstractC3255y.d(this.placeholders, list)) {
        ...
        if (!AbstractC3255y.d(this.fontFamilyResolver, fontFamilyResolver)) {
            this.fontFamilyResolver = fontFamilyResolver;
            z9 = true;
        }
        if (!TextOverflow.m5129equalsimpl0(this.overflow, i10)) {
            this.overflow = i10;
            return true;
        }
        return z9;
    ...
    public final boolean updateText(AnnotatedString text) {
        ...
        if (AbstractC3255y.d(this.text, text)) {
            return false;
        }
        this.text = text;
        return true;
    ...
    public /* synthetic */ TextAnnotatedStringNode(AnnotatedString annotatedString, TextStyle textStyle, FontFamily.Resolver resolver, Function1 function1, int i8, boolean z8, int i9, int i10, List list, Function1 function12, SelectionController selectionController, ColorProducer colorProducer, int i11, AbstractC3247p abstractC3247p) {
        this(annotatedString, textStyle, resolver, (i11 & 8) != 0 ? null : function1, (i11 & 16) != 0 ? TextOverflow.Companion.m5136getClipgIe3tQ8() : i8, (i11 & 32) != 0 ? true : z8, (i11 & 64) != 0 ? Integer.MAX_VALUE : i9, (i11 & 128) != 0 ? 1 : i10, (i11 & 256) != 0 ? null : list, (i11 & 512) != 0 ? null : function12, (i11 & 1024) != 0 ? null : selectionController, (i11 & 2048) != 0 ? null : colorProducer, null);
    }
