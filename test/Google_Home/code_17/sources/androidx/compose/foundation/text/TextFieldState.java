...
public final class TextFieldState {
    ...
    public TextFieldState(TextDelegate textDelegate, RecomposeScope recomposeScope) {
        ...
        AbstractC3255y.i(recomposeScope, "recomposeScope");
        ...
        mutableStateOf$default2 = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Dp.m5181boximpl(Dp.m5183constructorimpl(0)), null, 2, null);
    ...
    public final float m956getMinHeightForSingleLineFieldD9Ej5fM() {
        return ((Dp) this.minHeightForSingleLineField$delegate.getValue()).m5197unboximpl();
    }
    ...
    public final void setHandleState(HandleState handleState) {
        AbstractC3255y.i(handleState, "<set-?>");
    ...
    public final void m957setMinHeightForSingleLineField0680j_4(float f8) {
        this.minHeightForSingleLineField$delegate.setValue(Dp.m5181boximpl(f8));
    }
    ...
    public final void setTextDelegate(TextDelegate textDelegate) {
        AbstractC3255y.i(textDelegate, "<set-?>");
        this.textDelegate = textDelegate;
    }
    ...
    public final void m958updatefnh65Uc(AnnotatedString untransformedText, AnnotatedString visualText, TextStyle textStyle, boolean z8, Density density, FontFamily.Resolver fontFamilyResolver, Function1 onValueChange, KeyboardActions keyboardActions, FocusManager focusManager, long j8) {
        AbstractC3255y.i(untransformedText, "untransformedText");
        AbstractC3255y.i(visualText, "visualText");
        AbstractC3255y.i(textStyle, "textStyle");
        ...
        AbstractC3255y.i(keyboardActions, "keyboardActions");
        AbstractC3255y.i(focusManager, "focusManager");
        this.onValueChangeOriginal = onValueChange;
        this.selectionPaint.mo2861setColor8_81llA(j8);
        ...
        TextDelegate m929updateTextDelegaterm0N8CA$default = TextDelegateKt.m929updateTextDelegaterm0N8CA$default(this.textDelegate, visualText, textStyle, density, fontFamilyResolver, z8, 0, 0, 0, AbstractC1378t.m(), 448, null);
        if (this.textDelegate != m929updateTextDelegaterm0N8CA$default) {
            this.isLayoutResultStale = true;
        }
        this.textDelegate = m929updateTextDelegaterm0N8CA$default;
    }
}
