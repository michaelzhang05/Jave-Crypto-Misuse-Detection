...
public final class SelectableTextAnnotatedStringElement extends ModifierNodeElement<SelectableTextAnnotatedStringNode> {
    ...
    public /* synthetic */ SelectableTextAnnotatedStringElement(AnnotatedString annotatedString, TextStyle textStyle, FontFamily.Resolver resolver, Function1 function1, int i8, boolean z8, int i9, int i10, List list, Function1 function12, SelectionController selectionController, ColorProducer colorProducer, AbstractC3247p abstractC3247p) {
    ...
    private final int m997component5gIe3tQ8() {
    ...
    public final SelectableTextAnnotatedStringElement m999copyVhcvRP8(AnnotatedString text, TextStyle style, FontFamily.Resolver fontFamilyResolver, Function1 function1, int i8, boolean z8, int i9, int i10, List<AnnotatedString.Range<Placeholder>> list, Function1 function12, SelectionController selectionController, ColorProducer colorProducer) {
    ...
    public boolean equals(Object obj) {
        ...
        if (AbstractC3255y.d(this.color, selectableTextAnnotatedStringElement.color) && AbstractC3255y.d(this.text, selectableTextAnnotatedStringElement.text) && AbstractC3255y.d(this.style, selectableTextAnnotatedStringElement.style) && AbstractC3255y.d(this.placeholders, selectableTextAnnotatedStringElement.placeholders) && AbstractC3255y.d(this.fontFamilyResolver, selectableTextAnnotatedStringElement.fontFamilyResolver) && AbstractC3255y.d(this.onTextLayout, selectableTextAnnotatedStringElement.onTextLayout) && TextOverflow.m5129equalsimpl0(this.overflow, selectableTextAnnotatedStringElement.overflow) && this.softWrap == selectableTextAnnotatedStringElement.softWrap && this.maxLines == selectableTextAnnotatedStringElement.maxLines && this.minLines == selectableTextAnnotatedStringElement.minLines && AbstractC3255y.d(this.onPlaceholderLayout, selectableTextAnnotatedStringElement.onPlaceholderLayout) && AbstractC3255y.d(this.selectionController, selectableTextAnnotatedStringElement.selectionController)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        int m5130hashCodeimpl = (((((((((hashCode + i8) * 31) + TextOverflow.m5130hashCodeimpl(this.overflow)) * 31) + a.a(this.softWrap)) * 31) + this.maxLines) * 31) + this.minLines) * 31;
        ...
        int i13 = (m5130hashCodeimpl + i9) * 31;
    ...
    public String toString() {
        return "SelectableTextAnnotatedStringElement(text=" + ((Object) this.text) + ", style=" + this.style + ", fontFamilyResolver=" + this.fontFamilyResolver + ", onTextLayout=" + this.onTextLayout + ", overflow=" + ((Object) TextOverflow.m5131toStringimpl(this.overflow)) + ", softWrap=" + this.softWrap + ", maxLines=" + this.maxLines + ", minLines=" + this.minLines + ", placeholders=" + this.placeholders + ", onPlaceholderLayout=" + this.onPlaceholderLayout + ", selectionController=" + this.selectionController + ", color=" + this.color + ')';
    }
    ...
    public void update(SelectableTextAnnotatedStringNode node) {
        ...
        node.m1000updateL09Iy8E(this.text, this.style, this.placeholders, this.minLines, this.maxLines, this.softWrap, this.fontFamilyResolver, this.overflow, this.onTextLayout, this.onPlaceholderLayout, this.selectionController, this.color);
    }
