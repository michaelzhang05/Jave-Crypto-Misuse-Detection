...
public class StaticTextSelectionParams {
    ...
    public boolean getShouldClip() {
        ...
        if (textLayoutResult != null && (layoutInput = textLayoutResult.getLayoutInput()) != null) {
            textOverflow = TextOverflow.m5126boximpl(layoutInput.m4666getOverflowgIe3tQ8());
        } else {
            textOverflow = null;
        }
        int m5138getVisiblegIe3tQ8 = TextOverflow.Companion.m5138getVisiblegIe3tQ8();
        if (textOverflow == null) {
            return false;
        }
        return TextOverflow.m5129equalsimpl0(textOverflow.m5132unboximpl(), m5138getVisiblegIe3tQ8);
    }
