...
public final class HorizontalScrollLayoutModifier implements LayoutModifier {
    ...
    public HorizontalScrollLayoutModifier(TextFieldScrollerPosition scrollerPosition, int i8, TransformedText transformedText, Function0 textLayoutResultProvider) {
        ...
        AbstractC3255y.i(transformedText, "transformedText");
    ...
    public boolean equals(Object obj) {
        ...
        return AbstractC3255y.d(this.scrollerPosition, horizontalScrollLayoutModifier.scrollerPosition) && this.cursorOffset == horizontalScrollLayoutModifier.cursorOffset && AbstractC3255y.d(this.transformedText, horizontalScrollLayoutModifier.transformedText) && AbstractC3255y.d(this.textLayoutResultProvider, horizontalScrollLayoutModifier.textLayoutResultProvider);
    }
    ...
    public MeasureResult mo161measure3p2s80s(MeasureScope measure, Measurable measurable, long j8) {
        ...
        if (measurable.maxIntrinsicWidth(Constraints.m5150getMaxHeightimpl(j8)) < Constraints.m5151getMaxWidthimpl(j8)) {
            m5142copyZbe2FdA$default = j8;
        } else {
            m5142copyZbe2FdA$default = Constraints.m5142copyZbe2FdA$default(j8, 0, Integer.MAX_VALUE, 0, 0, 13, null);
        }
        Placeable mo4136measureBRTryo0 = measurable.mo4136measureBRTryo0(m5142copyZbe2FdA$default);
        int min = Math.min(mo4136measureBRTryo0.getWidth(), Constraints.m5151getMaxWidthimpl(j8));
        return MeasureScope.CC.q(measure, min, mo4136measureBRTryo0.getHeight(), null, new HorizontalScrollLayoutModifier$measure$1(measure, this, mo4136measureBRTryo0, min), 4, null);
    }
