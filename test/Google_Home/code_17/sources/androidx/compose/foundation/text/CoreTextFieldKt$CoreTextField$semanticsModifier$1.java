...
public final class CoreTextFieldKt$CoreTextField$semanticsModifier$1 extends AbstractC3256z implements Function1 {
    ...
    /* loaded from: classes.dex */
    public static final class AnonymousClass10 extends AbstractC3256z implements Function0 {
        final /* synthetic */ TextFieldSelectionManager $manager;
        ...
        public final Boolean invoke(AnnotatedString text) {
            ...
            if (!this.$readOnly && this.$enabled) {
                ...
                if (inputSession != null) {
                    ...
                    TextFieldDelegate.Companion.onEditCommand$foundation_release(AbstractC1378t.p(new DeleteAllCommand(), new CommitTextCommand(text, 1)), textFieldState.getProcessor(), textFieldState.getOnValueChange(), inputSession);
                    i8 = I.f8278a;
                } else {
                    i8 = null;
                }
                if (i8 == null) {
                    this.$state.getOnValueChange().invoke(new TextFieldValue(text.getText(), TextRangeKt.TextRange(text.getText().length()), (TextRange) null, 4, (AbstractC3247p) null));
                }
                return Boolean.TRUE;
            }
    ...
    public static final class AnonymousClass3 extends AbstractC3256z implements Function1 {
        ...
        public final Boolean invoke(AnnotatedString text) {
            ...
            if (!this.$readOnly && this.$enabled) {
                ...
                if (inputSession != null) {
                    TextFieldState textFieldState = this.$state;
                    TextFieldDelegate.Companion.onEditCommand$foundation_release(AbstractC1378t.p(new FinishComposingTextCommand(), new CommitTextCommand(text, 1)), textFieldState.getProcessor(), textFieldState.getOnValueChange(), inputSession);
                    i8 = I.f8278a;
                } else {
                    i8 = null;
                }
                if (i8 == null) {
                    ...
                    this.$state.getOnValueChange().invoke(new TextFieldValue(n.m0(textFieldValue.getText(), TextRange.m4697getStartimpl(textFieldValue.m4934getSelectiond9O1mEE()), TextRange.m4692getEndimpl(textFieldValue.m4934getSelectiond9O1mEE()), text).toString(), TextRangeKt.TextRange(TextRange.m4697getStartimpl(textFieldValue.m4934getSelectiond9O1mEE()) + text.length()), (TextRange) null, 4, (AbstractC3247p) null));
                }
                return Boolean.TRUE;
            }
            return Boolean.FALSE;
    ...
    /* loaded from: classes.dex */
    public static final class AnonymousClass4 extends AbstractC3256z implements InterfaceC1669o {
        final /* synthetic */ boolean $enabled;
        final /* synthetic */ TextFieldSelectionManager $manager;
        final /* synthetic */ OffsetMapping $offsetMapping;
        final /* synthetic */ TextFieldState $state;
        ...
        public final Boolean invoke(int i8, int i9, boolean z8) {
            ...
            boolean z9 = false;
            if (this.$enabled && (i8 != TextRange.m4697getStartimpl(this.$value.m4934getSelectiond9O1mEE()) || i9 != TextRange.m4692getEndimpl(this.$value.m4934getSelectiond9O1mEE()))) {
                if (m.g(i8, i9) >= 0 && m.d(i8, i9) <= this.$value.getAnnotatedString().length()) {
                    ...
                    this.$state.getOnValueChange().invoke(new TextFieldValue(this.$value.getAnnotatedString(), TextRangeKt.TextRange(i8, i9), (TextRange) null, 4, (AbstractC3247p) null));
                    z9 = true;
                } else {
                    this.$manager.exitSelectionMode$foundation_release();
                }
    ...
    /* loaded from: classes.dex */
    public static final class AnonymousClass5 extends AbstractC3256z implements Function0 {
        final /* synthetic */ ImeOptions $imeOptions;
        final /* synthetic */ TextFieldState $state;
        ...
        @Override // kotlin.jvm.functions.Function0
        public final Boolean invoke() {
            this.$state.getOnImeActionPerformed().invoke(ImeAction.m4857boximpl(this.$imeOptions.m4885getImeActioneUduSuo()));
            return Boolean.TRUE;
        }
    }
    ...
    /* loaded from: classes.dex */
    public static final class AnonymousClass6 extends AbstractC3256z implements Function0 {
        final /* synthetic */ FocusRequester $focusRequester;
        final /* synthetic */ boolean $readOnly;
        final /* synthetic */ TextFieldState $state;
    ...
    /* loaded from: classes.dex */
    public static final class AnonymousClass7 extends AbstractC3256z implements Function0 {
        final /* synthetic */ TextFieldSelectionManager $manager;
    ...
    /* loaded from: classes.dex */
    public static final class AnonymousClass8 extends AbstractC3256z implements Function0 {
        final /* synthetic */ TextFieldSelectionManager $manager;
    ...
    /* loaded from: classes.dex */
    public static final class AnonymousClass9 extends AbstractC3256z implements Function0 {
        final /* synthetic */ TextFieldSelectionManager $manager;
    ...
    public final void invoke(SemanticsPropertyReceiver semantics) {
        ...
        SemanticsPropertiesKt.m4542setImeAction4L7nppU(semantics, this.$imeOptions.m4885getImeActioneUduSuo());
        SemanticsPropertiesKt.setEditableText(semantics, this.$transformedText.getText());
        SemanticsPropertiesKt.m4545setTextSelectionRangeFDrldGo(semantics, this.$value.m4934getSelectiond9O1mEE());
        if (!this.$enabled) {
        ...
        if (!TextRange.m4691getCollapsedimpl(this.$value.m4934getSelectiond9O1mEE()) && !this.$isPassword) {
