...
public final class MultiWidgetSelectionDelegate implements Selectable {
    ...
    public MultiWidgetSelectionDelegate(long j8, Function0 coordinatesCallback, Function0 layoutResultCallback) {
        AbstractC3255y.i(coordinatesCallback, "coordinatesCallback");
        AbstractC3255y.i(layoutResultCallback, "layoutResultCallback");
        ...
        try {
            if (this._previousTextLayoutResult != textLayoutResult) {
                if (textLayoutResult.getDidOverflowHeight() && !textLayoutResult.getMultiParagraph().getDidExceedMaxLines()) {
                    lineCount = m.g(textLayoutResult.getLineForVerticalPosition(IntSize.m5348getHeightimpl(textLayoutResult.m4670getSizeYbymL2g())), textLayoutResult.getLineCount() - 1);
                    while (textLayoutResult.getLineTop(lineCount) >= IntSize.m5348getHeightimpl(textLayoutResult.m4670getSizeYbymL2g())) {
                        lineCount--;
                    }
    ...
    public long mo1016getHandlePositiondBAh8RU(Selection selection, boolean z8) {
    ...
    public long mo1017getRangeOfLineContainingjx7JFs(int i8) {
        TextLayoutResult textLayoutResult = (TextLayoutResult) this.layoutResultCallback.invoke();
        if (textLayoutResult == null) {
    ...
    public Selection getSelectAllSelection() {
        ...
        return MultiWidgetSelectionDelegateKt.m1019access$getAssembledSelectionInfovJH6DeI(TextRangeKt.TextRange(0, textLayoutResult.getLayoutInput().getText().length()), false, getSelectableId(), textLayoutResult);
    }
    ...
    public r mo1018updateSelectionqCDeeow(long j8, long j9, Offset offset, boolean z8, LayoutCoordinates containerLayoutCoordinates, SelectionAdjustment adjustment, Selection selection) {
        Offset offset2;
        AbstractC3255y.i(containerLayoutCoordinates, "containerLayoutCoordinates");
        ...
        long mo4144localPositionOfR5De75A = containerLayoutCoordinates.mo4144localPositionOfR5De75A(layoutCoordinates, Offset.Companion.m2756getZeroF1C5BW0());
        long m2744minusMKHz9U = Offset.m2744minusMKHz9U(j8, mo4144localPositionOfR5De75A);
        long m2744minusMKHz9U2 = Offset.m2744minusMKHz9U(j9, mo4144localPositionOfR5De75A);
        if (offset != null) {
            offset2 = Offset.m2729boximpl(Offset.m2744minusMKHz9U(offset.m2750unboximpl(), mo4144localPositionOfR5De75A));
        } else {
            offset2 = null;
        }
        return MultiWidgetSelectionDelegateKt.m1022getTextSelectionInfoyM0VcXU(textLayoutResult, m2744minusMKHz9U, m2744minusMKHz9U2, offset2, getSelectableId(), adjustment, selection, z8);
    }
