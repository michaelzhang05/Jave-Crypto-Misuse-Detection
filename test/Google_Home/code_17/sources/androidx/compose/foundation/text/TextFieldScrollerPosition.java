...
public final class TextFieldScrollerPosition {
    ...
    public TextFieldScrollerPosition(Orientation initialOrientation, float f8) {
        AbstractC3255y.i(initialOrientation, "initialOrientation");
        ...
        this.previousSelection = TextRange.Companion.m4702getZerod9O1mEE();
    ...
    public final int m950getOffsetToFollow5zctL8(long j8) {
        if (TextRange.m4697getStartimpl(j8) != TextRange.m4697getStartimpl(this.previousSelection)) {
            return TextRange.m4697getStartimpl(j8);
        }
        if (TextRange.m4692getEndimpl(j8) != TextRange.m4692getEndimpl(this.previousSelection)) {
            return TextRange.m4692getEndimpl(j8);
        }
        return TextRange.m4695getMinimpl(j8);
    }
    ...
    public final long m951getPreviousSelectiond9O1mEE() {
    ...
    public final void setOrientation(Orientation orientation) {
        AbstractC3255y.i(orientation, "<set-?>");
        this.orientation$delegate.setValue(orientation);
    }

    /* renamed from: setPreviousSelection-5zc-tL8, reason: not valid java name */
    public final void m952setPreviousSelection5zctL8(long j8) {
    ...
    public final void update(Orientation orientation, Rect cursorRect, int i8, int i9) {
        ...
        AbstractC3255y.i(cursorRect, "cursorRect");
        float f8 = i9 - i8;
        setMaximum(f8);
    ...
    public /* synthetic */ TextFieldScrollerPosition(Orientation orientation, float f8, int i8, AbstractC3247p abstractC3247p) {
