...
@f(c = "androidx.compose.foundation.text.CoreTextFieldKt$CoreTextField$focusModifier$1$1$1", f = "CoreTextField.kt", l = {TypedValues.AttributesType.TYPE_PIVOT_TARGET}, m = "invokeSuspend")
/* loaded from: classes.dex */
final class CoreTextFieldKt$CoreTextField$focusModifier$1$1$1 extends l implements InterfaceC1668n {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i8 != 0) {
            ...
            this.label = 1;
            if (CoreTextFieldKt.bringSelectionEndIntoView(bringIntoViewRequester, textFieldValue, textDelegate, value, offsetMapping, this) == e8) {
                return e8;
            }
        }
        return I.f8278a;
    ...
    public final Object invoke(M m8, d dVar) {
        return ((CoreTextFieldKt$CoreTextField$focusModifier$1$1$1) create(m8, dVar)).invokeSuspend(I.f8278a);
    }
}
