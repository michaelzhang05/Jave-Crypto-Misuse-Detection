...
public final class SelectionRegistrarImpl implements SelectionRegistrar {
    ...
    private InterfaceC1671q onSelectionUpdateCallback;
    private Function0 onSelectionUpdateEndCallback;
    private Function1 onSelectionUpdateSelectAll;
    private InterfaceC1669o onSelectionUpdateStartCallback;
    ...
    public static final int sort$lambda$2(InterfaceC1668n tmp0, Object obj, Object obj2) {
    ...
    public final InterfaceC1671q getOnSelectionUpdateCallback$foundation_release() {
    ...
    public final InterfaceC1669o getOnSelectionUpdateStartCallback$foundation_release() {
    ...
    public boolean mo1077notifySelectionUpdate5iVPX68(LayoutCoordinates layoutCoordinates, long j8, long j9, boolean z8, SelectionAdjustment adjustment) {
        AbstractC3255y.i(layoutCoordinates, "layoutCoordinates");
        AbstractC3255y.i(adjustment, "adjustment");
        InterfaceC1671q interfaceC1671q = this.onSelectionUpdateCallback;
        if (interfaceC1671q != null) {
            return ((Boolean) interfaceC1671q.invoke(layoutCoordinates, Offset.m2729boximpl(j8), Offset.m2729boximpl(j9), Boolean.valueOf(z8), adjustment)).booleanValue();
        }
        return true;
    }
    ...
    public void mo1078notifySelectionUpdateStartd4ec7I(LayoutCoordinates layoutCoordinates, long j8, SelectionAdjustment adjustment) {
        AbstractC3255y.i(layoutCoordinates, "layoutCoordinates");
        AbstractC3255y.i(adjustment, "adjustment");
        InterfaceC1669o interfaceC1669o = this.onSelectionUpdateStartCallback;
        if (interfaceC1669o != null) {
            interfaceC1669o.invoke(layoutCoordinates, Offset.m2729boximpl(j8), adjustment);
        }
    }
    ...
    public final void setOnSelectionUpdateCallback$foundation_release(InterfaceC1671q interfaceC1671q) {
        this.onSelectionUpdateCallback = interfaceC1671q;
    }
    ...
    public final void setOnSelectionUpdateStartCallback$foundation_release(InterfaceC1669o interfaceC1669o) {
        this.onSelectionUpdateStartCallback = interfaceC1669o;
    }
    ...
    public final List<Selectable> sort(LayoutCoordinates containerLayoutCoordinates) {
        ...
        if (!this.sorted) {
            ...
            AbstractC1378t.B(list, new Comparator() { // from class: androidx.compose.foundation.text.selection.b
                @Override // java.util.Comparator
                public final int compare(Object obj, Object obj2) {
                    int sort$lambda$2;
                    sort$lambda$2 = SelectionRegistrarImpl.sort$lambda$2(InterfaceC1668n.this, obj, obj2);
