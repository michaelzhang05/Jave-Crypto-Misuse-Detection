...
public final class SimpleLayoutKt {
    ...
    public static final void SimpleLayout(Modifier modifier, InterfaceC1668n content, Composer composer, int i8, int i9) {
        int i10;
        int i11;
        int i12;
        ...
        if ((i10 & 91) == 18 && startRestartGroup.getSkipping()) {
            ...
            SimpleLayoutKt$SimpleLayout$1 simpleLayoutKt$SimpleLayout$1 = new MeasurePolicy() { // from class: androidx.compose.foundation.text.selection.SimpleLayoutKt$SimpleLayout$1
                ...
                public final MeasureResult mo137measure3p2s80s(MeasureScope Layout, List<? extends Measurable> measurables, long j8) {
                    ...
                    for (int i14 = 0; i14 < size; i14++) {
                        arrayList.add(measurables.get(i14).mo4136measureBRTryo0(j8));
                    }
            ...
            Updater.m2508setimpl(m2501constructorimpl, simpleLayoutKt$SimpleLayout$1, companion.getSetMeasurePolicy());
