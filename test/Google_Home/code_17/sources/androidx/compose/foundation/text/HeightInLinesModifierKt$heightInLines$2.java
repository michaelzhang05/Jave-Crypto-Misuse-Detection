...
public final class HeightInLinesModifierKt$heightInLines$2 extends AbstractC3256z implements InterfaceC1669o {
    ...
    public final Modifier invoke(Modifier composed, Composer composer, int i8) {
        ...
        if (changed2 || rememberedValue2 == Composer.Companion.getEmpty()) {
            ...
            FontStyle m4729getFontStyle4Lr2A7w = textStyle2.m4729getFontStyle4Lr2A7w();
            int m4810unboximpl = m4729getFontStyle4Lr2A7w != null ? m4729getFontStyle4Lr2A7w.m4810unboximpl() : FontStyle.Companion.m4814getNormal_LCdwA();
            FontSynthesis m4730getFontSynthesisZQGJjVo = textStyle2.m4730getFontSynthesisZQGJjVo();
            rememberedValue2 = resolver.mo4782resolveDPcqOEQ(fontFamily, fontWeight, m4810unboximpl, m4730getFontSynthesisZQGJjVo != null ? m4730getFontSynthesisZQGJjVo.m4823unboximpl() : FontSynthesis.Companion.m4824getAllGVVA2EU());
        ...
        if (z8 || rememberedValue3 == Composer.Companion.getEmpty()) {
            rememberedValue3 = Integer.valueOf(IntSize.m5348getHeightimpl(TextFieldDelegateKt.computeSizeForDefaultText(textStyle2, density, resolver, TextFieldDelegateKt.getEmptyTextReplacement(), 1)));
        ...
        if (z9 || rememberedValue4 == Composer.Companion.getEmpty()) {
            rememberedValue4 = Integer.valueOf(IntSize.m5348getHeightimpl(TextFieldDelegateKt.computeSizeForDefaultText(textStyle2, density, resolver, TextFieldDelegateKt.getEmptyTextReplacement() + '\n' + TextFieldDelegateKt.getEmptyTextReplacement(), 2)));
        ...
        Modifier m639heightInVpY3zN4 = SizeKt.m639heightInVpY3zN4(Modifier.Companion, valueOf != null ? density.mo450toDpu2uoSUM(valueOf.intValue()) : Dp.Companion.m5203getUnspecifiedD9Ej5fM(), valueOf2 != null ? density.mo450toDpu2uoSUM(valueOf2.intValue()) : Dp.Companion.m5203getUnspecifiedD9Ej5fM());
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return m639heightInVpY3zN4;
    }
}
