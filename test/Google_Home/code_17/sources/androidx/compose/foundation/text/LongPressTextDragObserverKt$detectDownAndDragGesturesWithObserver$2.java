...
public final class LongPressTextDragObserverKt$detectDownAndDragGesturesWithObserver$2 extends l implements InterfaceC1668n {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (this.label == 0) {
            ...
            M m8 = (M) this.L$0;
            O o8 = O.UNDISPATCHED;
            AbstractC3364k.d(m8, null, o8, new AnonymousClass1(this.$this_detectDownAndDragGesturesWithObserver, this.$observer, null), 1, null);
            d8 = AbstractC3364k.d(m8, null, o8, new AnonymousClass2(this.$this_detectDownAndDragGesturesWithObserver, this.$observer, null), 1, null);
            return d8;
        }
        throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
    }
    ...
    @Override // a6.InterfaceC1668n
    public final Object invoke(M m8, d dVar) {
        return ((LongPressTextDragObserverKt$detectDownAndDragGesturesWithObserver$2) create(m8, dVar)).invokeSuspend(I.f8278a);
    }
}
