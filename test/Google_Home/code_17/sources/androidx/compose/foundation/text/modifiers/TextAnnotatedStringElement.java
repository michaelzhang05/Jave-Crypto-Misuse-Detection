...
public final class TextAnnotatedStringElement extends ModifierNodeElement<TextAnnotatedStringNode> {
    ...
    public /* synthetic */ TextAnnotatedStringElement(AnnotatedString annotatedString, TextStyle textStyle, FontFamily.Resolver resolver, Function1 function1, int i8, boolean z8, int i9, int i10, List list, Function1 function12, SelectionController selectionController, ColorProducer colorProducer, AbstractC3247p abstractC3247p) {
    ...
    public boolean equals(Object obj) {
        ...
        if (AbstractC3255y.d(this.color, textAnnotatedStringElement.color) && AbstractC3255y.d(this.text, textAnnotatedStringElement.text) && AbstractC3255y.d(this.style, textAnnotatedStringElement.style) && AbstractC3255y.d(this.placeholders, textAnnotatedStringElement.placeholders) && AbstractC3255y.d(this.fontFamilyResolver, textAnnotatedStringElement.fontFamilyResolver) && AbstractC3255y.d(this.onTextLayout, textAnnotatedStringElement.onTextLayout) && TextOverflow.m5129equalsimpl0(this.overflow, textAnnotatedStringElement.overflow) && this.softWrap == textAnnotatedStringElement.softWrap && this.maxLines == textAnnotatedStringElement.maxLines && this.minLines == textAnnotatedStringElement.minLines && AbstractC3255y.d(this.onPlaceholderLayout, textAnnotatedStringElement.onPlaceholderLayout) && AbstractC3255y.d(this.selectionController, textAnnotatedStringElement.selectionController)) {
            return true;
        }
        return false;
    }
