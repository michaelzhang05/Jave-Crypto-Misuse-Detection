...
public final class AndroidSelectionHandles_androidKt$drawSelectionHandle$1 extends AbstractC3256z implements InterfaceC1669o {
    ...
    public final Modifier invoke(Modifier composed, Composer composer, int i8) {
        ...
        long m1099getHandleColor0d7_KjU = ((TextSelectionColors) composer.consume(TextSelectionColorsKt.getLocalTextSelectionColors())).m1099getHandleColor0d7_KjU();
        Modifier.Companion companion = Modifier.Companion;
        Object[] objArr = {Color.m2966boximpl(m1099getHandleColor0d7_KjU), Boolean.valueOf(this.$isStartHandle), this.$direction, Boolean.valueOf(this.$handlesCrossed)};
        ...
        if (z10 || rememberedValue == Composer.Companion.getEmpty()) {
            rememberedValue = new AndroidSelectionHandles_androidKt$drawSelectionHandle$1$1$1(m1099getHandleColor0d7_KjU, z8, resolvedTextDirection, z9);
