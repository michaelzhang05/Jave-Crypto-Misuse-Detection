...
public final class VerticalScrollLayoutModifier implements LayoutModifier {
    ...
    public boolean equals(Object obj) {
        ...
        return AbstractC3255y.d(this.scrollerPosition, verticalScrollLayoutModifier.scrollerPosition) && this.cursorOffset == verticalScrollLayoutModifier.cursorOffset && AbstractC3255y.d(this.transformedText, verticalScrollLayoutModifier.transformedText) && AbstractC3255y.d(this.textLayoutResultProvider, verticalScrollLayoutModifier.textLayoutResultProvider);
    }
    ...
    public MeasureResult mo161measure3p2s80s(MeasureScope measure, Measurable measurable, long j8) {
        ...
        Placeable mo4136measureBRTryo0 = measurable.mo4136measureBRTryo0(Constraints.m5142copyZbe2FdA$default(j8, 0, 0, 0, Integer.MAX_VALUE, 7, null));
        int min = Math.min(mo4136measureBRTryo0.getHeight(), Constraints.m5150getMaxHeightimpl(j8));
        return MeasureScope.CC.q(measure, mo4136measureBRTryo0.getWidth(), min, null, new VerticalScrollLayoutModifier$measure$1(measure, this, mo4136measureBRTryo0, min), 4, null);
    }
