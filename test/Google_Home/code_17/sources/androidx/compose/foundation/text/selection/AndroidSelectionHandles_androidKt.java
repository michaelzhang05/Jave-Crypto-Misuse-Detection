...
public final class AndroidSelectionHandles_androidKt {
    ...
    public static final void DefaultSelectionHandle(Modifier modifier, boolean z8, ResolvedTextDirection direction, boolean z9, Composer composer, int i8) {
        ...
        if ((i9 & 5851) == 1170 && startRestartGroup.getSkipping()) {
            ...
            SpacerKt.Spacer(drawSelectionHandle(SizeKt.m654sizeVpY3zN4(modifier, SelectionHandlesKt.getHandleWidth(), SelectionHandlesKt.getHandleHeight()), z8, direction, z9), startRestartGroup, 0);
            if (ComposerKt.isTraceInProgress()) {
    ...
    public static final void m1010HandlePopupULxng0E(long j8, HandleReferencePoint handleReferencePoint, InterfaceC1668n content, Composer composer, int i8) {
        int i9;
        int i10;
        int i11;
        int i12;
        ...
        if ((i9 & 731) == 146 && startRestartGroup.getSkipping()) {
            ...
            IntOffset m5298boximpl = IntOffset.m5298boximpl(IntOffset);
            startRestartGroup.startReplaceableGroup(511388516);
            boolean changed = startRestartGroup.changed(m5298boximpl) | startRestartGroup.changed(handleReferencePoint);
    ...
    public static final void m1011SelectionHandle8fL75g(long j8, boolean z8, ResolvedTextDirection direction, boolean z9, Modifier modifier, InterfaceC1668n interfaceC1668n, Composer composer, int i8) {
        int i9;
        ...
        if ((374491 & i16) == 74898 && startRestartGroup.getSkipping()) {
            ...
            m1010HandlePopupULxng0E(j8, handleReferencePoint, ComposableLambdaKt.composableLambda(startRestartGroup, 732099485, true, new AndroidSelectionHandles_androidKt$SelectionHandle$1(interfaceC1668n, modifier, z8, j8, i16, direction, z9)), startRestartGroup, (i16 & 14) | 384);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        }
        ScopeUpdateScope endRestartGroup = startRestartGroup.endRestartGroup();
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new AndroidSelectionHandles_androidKt$SelectionHandle$2(j8, z8, direction, z9, modifier, interfaceC1668n, i8));
        }
    }

    public static final ImageBitmap createHandleImage(CacheDrawScope cacheDrawScope, float f8) {
        AbstractC3255y.i(cacheDrawScope, "<this>");
        ...
        if (imageBitmap == null || canvas == null || ceil > imageBitmap.getWidth() || ceil > imageBitmap.getHeight()) {
            imageBitmap = ImageBitmapKt.m3182ImageBitmapx__hDU$default(ceil, ceil, ImageBitmapConfig.Companion.m3176getAlpha8_sVssgQ(), false, null, 24, null);
        ...
        drawParams2.m3424setSizeuvyYCjk(Size);
        canvas2.save();
        c.K(canvasDrawScope2, Color.Companion.m3002getBlack0d7_KjU(), 0L, canvasDrawScope2.mo3419getSizeNHjbRc(), 0.0f, null, null, BlendMode.Companion.m2897getClear0nO6VwU(), 58, null);
        c.K(canvasDrawScope2, ColorKt.Color(4278190080L), Offset.Companion.m2756getZeroF1C5BW0(), androidx.compose.ui.geometry.SizeKt.Size(f8, f8), 0.0f, null, null, 0, 120, null);
