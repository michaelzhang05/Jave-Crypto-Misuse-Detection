...
final class TextFieldDelegate$Companion$restartInput$1 extends AbstractC3256z implements Function1 {
    ...
    public final void invoke(List<? extends EditCommand> it) {
        ...
        TextFieldDelegate.Companion.onEditCommand$foundation_release(it, this.$editProcessor, this.$onValueChange, (TextInputSession) this.$session.f34162a);
    }
}
