...
public final class AndroidCursorHandle_androidKt$drawCursorHandle$1 extends AbstractC3256z implements InterfaceC1669o {
    ...
    public final Modifier invoke(Modifier composed, Composer composer, int i8) {
        ...
        Color m2966boximpl = Color.m2966boximpl(m1099getHandleColor0d7_KjU);
        composer.startReplaceableGroup(1157296644);
        boolean changed = composer.changed(m2966boximpl);
        Object rememberedValue = composer.rememberedValue();
        if (changed || rememberedValue == Composer.Companion.getEmpty()) {
            rememberedValue = new AndroidCursorHandle_androidKt$drawCursorHandle$1$1$1(m1099getHandleColor0d7_KjU);
