...
public final class CoreTextFieldKt$CoreTextField$5 extends AbstractC3256z implements InterfaceC1668n {
    ...
    public static final class AnonymousClass1 extends AbstractC3256z implements InterfaceC1668n {
        ...
        /* loaded from: classes.dex */
        public static final class C03051 extends AbstractC3256z implements InterfaceC1668n {
            final /* synthetic */ Density $density;
            final /* synthetic */ TextFieldSelectionManager $manager;
            final /* synthetic */ int $maxLines;
            final /* synthetic */ OffsetMapping $offsetMapping;
            ...
            C03051(TextFieldSelectionManager textFieldSelectionManager, TextFieldState textFieldState, boolean z8, boolean z9, Function1 function1, TextFieldValue textFieldValue, OffsetMapping offsetMapping, Density density, int i8) {
                super(2);
                    ...
                    public MeasureResult mo137measure3p2s80s(MeasureScope measure, List<? extends Measurable> measurables, long j8) {
                        ...
                        try {
                            ...
                            try {
                                ...
                                w m937layout_EkL_Y$foundation_release = TextFieldDelegate.Companion.m937layout_EkL_Y$foundation_release(TextFieldState.this.getTextDelegate(), j8, measure.getLayoutDirection(), textLayoutResult);
                                int intValue = ((Number) m937layout_EkL_Y$foundation_release.a()).intValue();
                                int intValue2 = ((Number) m937layout_EkL_Y$foundation_release.b()).intValue();
                                TextLayoutResult textLayoutResult2 = (TextLayoutResult) m937layout_EkL_Y$foundation_release.c();
                                if (!AbstractC3255y.d(textLayoutResult, textLayoutResult2)) {
                                ...
                                textFieldState3.m957setMinHeightForSingleLineField0680j_4(density2.mo450toDpu2uoSUM(i10));
                                return measure.layout(intValue, intValue2, Q.k(x.a(AlignmentLineKt.getFirstBaseline(), Integer.valueOf(AbstractC2055a.d(textLayoutResult2.getFirstBaseline()))), x.a(AlignmentLineKt.getLastBaseline(), Integer.valueOf(AbstractC2055a.d(textLayoutResult2.getLastBaseline())))), CoreTextFieldKt$CoreTextField$5$1$1$2$measure$2.INSTANCE);
                            } finally {
        ...
        public final void invoke(Composer composer, int i8) {
            ...
            SimpleLayoutKt.SimpleLayout(BringIntoViewRequesterKt.bringIntoViewRequester(TextFieldSizeKt.textFieldMinSize(TextFieldScrollKt.textFieldScroll(HeightInLinesModifierKt.heightInLines(SizeKt.m640heightInVpY3zN4$default(Modifier.Companion, this.$state.m956getMinHeightForSingleLineFieldD9Ej5fM(), 0.0f, 2, null), this.$textStyle, this.$minLines, this.$maxLines), this.$scrollerPosition, this.$value, this.$visualTransformation, new CoreTextFieldKt$CoreTextField$5$1$coreTextFieldModifier$1(this.$state)).then(this.$cursorModifier).then(this.$drawModifier), this.$textStyle).then(this.$onPositionedModifier).then(this.$magnifierModifier), this.$bringIntoViewRequester), ComposableLambdaKt.composableLambda(composer, -363167407, true, new C03051(this.$manager, this.$state, this.$showHandleAndMagnifier, this.$readOnly, this.$onTextLayout, this.$value, this.$offsetMapping, this.$density, this.$maxLines)), composer, 48, 0);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        }
