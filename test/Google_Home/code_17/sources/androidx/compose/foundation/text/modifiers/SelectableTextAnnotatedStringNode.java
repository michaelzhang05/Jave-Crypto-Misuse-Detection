...
public final class SelectableTextAnnotatedStringNode extends DelegatingNode implements LayoutModifierNode, DrawModifierNode, GlobalPositionAwareModifierNode {
    ...
    public /* synthetic */ SelectableTextAnnotatedStringNode(AnnotatedString annotatedString, TextStyle textStyle, FontFamily.Resolver resolver, Function1 function1, int i8, boolean z8, int i9, int i10, List list, Function1 function12, SelectionController selectionController, ColorProducer colorProducer, AbstractC3247p abstractC3247p) {
    ...
    public MeasureResult mo368measure3p2s80s(MeasureScope measure, Measurable measurable, long j8) {
        ...
        AbstractC3255y.i(measurable, "measurable");
        return this.delegate.m1007measureNonExtension3p2s80s(measure, measurable, j8);
    }
    ...
    public final void m1000updateL09Iy8E(AnnotatedString text, TextStyle style, List<AnnotatedString.Range<Placeholder>> list, int i8, int i9, boolean z8, FontFamily.Resolver fontFamilyResolver, int i10, Function1 function1, Function1 function12, SelectionController selectionController, ColorProducer colorProducer) {
        ...
        textAnnotatedStringNode.doInvalidations(textAnnotatedStringNode.updateDraw(colorProducer, style), this.delegate.updateText(text), this.delegate.m1008updateLayoutRelatedArgsMPT68mk(style, list, i8, i9, z8, fontFamilyResolver, i10), this.delegate.updateCallbacks(function1, function12, selectionController));
