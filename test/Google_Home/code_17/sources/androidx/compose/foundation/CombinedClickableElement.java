...
public final class CombinedClickableElement extends ModifierNodeElement<CombinedClickableNode> {
    ...
    public /* synthetic */ CombinedClickableElement(MutableInteractionSource mutableInteractionSource, boolean z8, String str, Role role, Function0 function0, String str2, Function0 function02, Function0 function03, AbstractC3247p abstractC3247p) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!AbstractC3255y.d(CombinedClickableElement.class, cls)) {
            return false;
        }
        AbstractC3255y.g(obj, "null cannot be cast to non-null type androidx.compose.foundation.CombinedClickableElement");
        CombinedClickableElement combinedClickableElement = (CombinedClickableElement) obj;
        if (AbstractC3255y.d(this.interactionSource, combinedClickableElement.interactionSource) && this.enabled == combinedClickableElement.enabled && AbstractC3255y.d(this.onClickLabel, combinedClickableElement.onClickLabel) && AbstractC3255y.d(this.role, combinedClickableElement.role) && AbstractC3255y.d(this.onClick, combinedClickableElement.onClick) && AbstractC3255y.d(this.onLongClickLabel, combinedClickableElement.onLongClickLabel) && AbstractC3255y.d(this.onLongClick, combinedClickableElement.onLongClick) && AbstractC3255y.d(this.onDoubleClick, combinedClickableElement.onDoubleClick)) {
            return true;
        }
        return false;
    }
    ...
    public /* synthetic */ CombinedClickableElement(MutableInteractionSource mutableInteractionSource, boolean z8, String str, Role role, Function0 function0, String str2, Function0 function02, Function0 function03, int i8, AbstractC3247p abstractC3247p) {
    ...
    public void update(CombinedClickableNode node) {
        ...
        node.m337updatecJG_KMw(this.interactionSource, this.enabled, this.onClickLabel, this.role, this.onClick, this.onLongClickLabel, this.onLongClick, this.onDoubleClick);
    }
