...
public final class CheckScrollableContainerConstraintsKt {
    ...
    public static final void m315checkScrollableContainerConstraintsK40F9xA(long j8, Orientation orientation) {
        ...
        } else if (Constraints.m5151getMaxWidthimpl(j8) != Integer.MAX_VALUE) {
        } else {
