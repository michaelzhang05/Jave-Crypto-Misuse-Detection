...
public final class ImageKt {
    ...
    public static final /* synthetic */ void Image(ImageBitmap bitmap, String str, Modifier modifier, Alignment alignment, ContentScale contentScale, float f8, ColorFilter colorFilter, Composer composer, int i8, int i9) {
        ...
        m344Image5hnEew(bitmap, str, modifier2, center, fit, f9, colorFilter2, FilterQuality.Companion.m3075getLowfv9h1I(), composer, (i8 & 112) | 8 | (i8 & 896) | (i8 & 7168) | (57344 & i8) | (458752 & i8) | (i8 & 3670016), 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public static final void m344Image5hnEew(ImageBitmap bitmap, String str, Modifier modifier, Alignment alignment, ContentScale contentScale, float f8, ColorFilter colorFilter, int i8, Composer composer, int i9, int i10) {
        Modifier modifier2;
        ...
        if (changed || rememberedValue == Composer.Companion.getEmpty()) {
            rememberedValue = BitmapPainterKt.m3516BitmapPainterQZhYCtY$default(bitmap, 0L, 0L, i11, 6, null);
    ...
    public static final void Image(Painter painter, String str, Modifier modifier, Alignment alignment, ContentScale contentScale, float f8, ColorFilter colorFilter, Composer composer, int i8, int i9) {
        ...
        ImageKt$Image$2 imageKt$Image$2 = new MeasurePolicy() { // from class: androidx.compose.foundation.ImageKt$Image$2
            ...
            public final MeasureResult mo137measure3p2s80s(MeasureScope Layout, List<? extends Measurable> list, long j8) {
                ...
                return MeasureScope.CC.q(Layout, Constraints.m5153getMinWidthimpl(j8), Constraints.m5152getMinHeightimpl(j8), null, ImageKt$Image$2$measure$1.INSTANCE, 4, null);
            }
        ...
        InterfaceC1669o modifierMaterializerOf = LayoutKt.modifierMaterializerOf(paint$default);
        ...
        Updater.m2508setimpl(m2501constructorimpl, imageKt$Image$2, companion2.getSetMeasurePolicy());
