...
final class ScrollingLayoutElement extends ModifierNodeElement<ScrollingLayoutNode> {
    ...
    public boolean equals(Object obj) {
        ...
        if (!AbstractC3255y.d(this.scrollState, scrollingLayoutElement.scrollState) || this.isReversed != scrollingLayoutElement.isReversed || this.isVertical != scrollingLayoutElement.isVertical) {
            return false;
        }
        return true;
    }
