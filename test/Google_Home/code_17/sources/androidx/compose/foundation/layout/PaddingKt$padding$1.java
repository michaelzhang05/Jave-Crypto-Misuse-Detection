...
final class PaddingKt$padding$1 extends AbstractC3256z implements Function1 {
    ...
    public final void invoke(InspectorInfo $receiver) {
        ...
        $receiver.getProperties().set("start", Dp.m5181boximpl(this.$start));
        $receiver.getProperties().set("top", Dp.m5181boximpl(this.$top));
        $receiver.getProperties().set(TtmlNode.END, Dp.m5181boximpl(this.$end));
