...
final class AlignmentLineOffsetDpElement extends ModifierNodeElement<AlignmentLineOffsetDpNode> {
    ...
    public /* synthetic */ AlignmentLineOffsetDpElement(AlignmentLine alignmentLine, float f8, float f9, Function1 function1, AbstractC3247p abstractC3247p) {
    ...
    public boolean equals(Object obj) {
        ...
        if (alignmentLineOffsetDpElement != null && AbstractC3255y.d(this.alignmentLine, alignmentLineOffsetDpElement.alignmentLine) && Dp.m5188equalsimpl0(this.before, alignmentLineOffsetDpElement.before) && Dp.m5188equalsimpl0(this.after, alignmentLineOffsetDpElement.after)) {
            return true;
        }
        return false;
    }
    ...
    public final float m497getAfterD9Ej5fM() {
        return this.after;
    }
    ...
    public final float m498getBeforeD9Ej5fM() {
        return this.before;
    }
    ...
    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return (((this.alignmentLine.hashCode() * 31) + Dp.m5189hashCodeimpl(this.before)) * 31) + Dp.m5189hashCodeimpl(this.after);
    }
    ...
    private AlignmentLineOffsetDpElement(AlignmentLine alignmentLine, float f8, float f9, Function1 inspectorInfo) {
        ...
        if ((f8 < 0.0f && !Dp.m5188equalsimpl0(f8, Dp.Companion.m5203getUnspecifiedD9Ej5fM())) || (f9 < 0.0f && !Dp.m5188equalsimpl0(f9, Dp.Companion.m5203getUnspecifiedD9Ej5fM()))) {
    ...
    public void update(AlignmentLineOffsetDpNode node) {
        ...
        node.m502setBefore0680j_4(this.before);
        node.m501setAfter0680j_4(this.after);
    }
}
