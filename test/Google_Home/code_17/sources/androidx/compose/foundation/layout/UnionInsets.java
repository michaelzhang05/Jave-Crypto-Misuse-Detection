...
final class UnionInsets implements WindowInsets {
    ...
    public UnionInsets(WindowInsets first, WindowInsets second) {
        AbstractC3255y.i(first, "first");
        AbstractC3255y.i(second, "second");
        this.first = first;
        this.second = second;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (AbstractC3255y.d(unionInsets.first, this.first) && AbstractC3255y.d(unionInsets.second, this.second)) {
            return true;
        }
        return false;
    }
