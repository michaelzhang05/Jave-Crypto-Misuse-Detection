...
public final class InsetsPaddingModifier extends InspectorValueInfo implements LayoutModifier, ModifierLocalConsumer, ModifierLocalProvider<WindowInsets> {
    ...
    public boolean equals(Object obj) {
        ...
        return AbstractC3255y.d(((InsetsPaddingModifier) obj).insets, this.insets);
    }
    ...
    public MeasureResult mo161measure3p2s80s(MeasureScope measure, Measurable measurable, long j8) {
        ...
        Placeable mo4136measureBRTryo0 = measurable.mo4136measureBRTryo0(ConstraintsKt.m5167offsetNN6EwU(j8, -right, -bottom));
        return MeasureScope.CC.q(measure, ConstraintsKt.m5165constrainWidthK40F9xA(j8, mo4136measureBRTryo0.getWidth() + right), ConstraintsKt.m5164constrainHeightK40F9xA(j8, mo4136measureBRTryo0.getHeight() + bottom), null, new InsetsPaddingModifier$measure$1(mo4136measureBRTryo0, left, top), 4, null);
    }
    ...
    public /* synthetic */ InsetsPaddingModifier(WindowInsets windowInsets, Function1 function1, int i8, AbstractC3247p abstractC3247p) {
