...
public final class WindowInsetsNestedScrollConnection$fling$3 extends kotlin.coroutines.jvm.internal.l implements InterfaceC1668n {
    ...
    public static final class AnonymousClass1 extends kotlin.coroutines.jvm.internal.l implements InterfaceC1668n {
        ...
        /* loaded from: classes.dex */
        public static final class C03011 extends AbstractC3256z implements Function1 {
            final /* synthetic */ WindowInsetsNestedScrollConnection this$0;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C03011(WindowInsetsNestedScrollConnection windowInsetsNestedScrollConnection) {
                super(1);
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        AnonymousClass1(int i8, int i9, float f8, WindowInsetsAnimationController windowInsetsAnimationController, boolean z8, WindowInsetsNestedScrollConnection windowInsetsNestedScrollConnection, S5.d dVar) {
            super(2, dVar);
            this.$current = i8;
            this.$target = i9;
            this.$flingAmount = f8;
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i8 != 0) {
                ...
                this.label = 1;
                if (Animatable.animateTo$default(Animatable$default, b8, null, b9, c03011, this, 2, null) == e8) {
                    return e8;
                }
            }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public WindowInsetsNestedScrollConnection$fling$3(WindowInsetsNestedScrollConnection windowInsetsNestedScrollConnection, int i8, int i9, float f8, WindowInsetsAnimationController windowInsetsAnimationController, boolean z8, S5.d dVar) {
        super(2, dVar);
        this.this$0 = windowInsetsNestedScrollConnection;
        this.$current = i8;
        this.$target = i9;
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (this.label == 0) {
            ...
            d8 = AbstractC3364k.d(m8, null, null, new AnonymousClass1(this.$current, this.$target, this.$flingAmount, this.$animationController, this.$targetShown, windowInsetsNestedScrollConnection, null), 3, null);
    ...
    @Override // a6.InterfaceC1668n
    public final Object invoke(M m8, S5.d dVar) {
        return ((WindowInsetsNestedScrollConnection$fling$3) create(m8, dVar)).invokeSuspend(I.f8278a);
    }
}
