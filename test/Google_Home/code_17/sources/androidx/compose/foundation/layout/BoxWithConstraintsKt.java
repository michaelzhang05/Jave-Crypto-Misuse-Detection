...
public final class BoxWithConstraintsKt {
    @Composable
    @UiComposable
    public static final void BoxWithConstraints(Modifier modifier, Alignment alignment, boolean z8, InterfaceC1669o content, Composer composer, int i8, int i9) {
        int i10;
        int i11;
        int i12;
        int i13;
        ...
        if ((i10 & 5851) == 1170 && startRestartGroup.getSkipping()) {
            ...
            SubcomposeLayoutKt.SubcomposeLayout(modifier, (InterfaceC1668n) rememberedValue, startRestartGroup, i10 & 14, 0);
            if (ComposerKt.isTraceInProgress()) {
