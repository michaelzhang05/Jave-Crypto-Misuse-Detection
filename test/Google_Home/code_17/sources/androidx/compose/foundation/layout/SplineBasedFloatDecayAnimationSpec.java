...
public final class SplineBasedFloatDecayAnimationSpec implements FloatDecayAnimationSpec {
    ...
    public float getValueFromNanos(long j8, float f8, float f9) {
        ...
        return f8 + (flingDistance(f9) * AndroidFlingSpline.FlingResult.m514getDistanceCoefficientimpl(AndroidFlingSpline.INSTANCE.m509flingPositionLfoxSSI(f10)));
    }
    ...
    public float getVelocityFromNanos(long j8, float f8, float f9) {
        ...
        return ((AndroidFlingSpline.FlingResult.m515getVelocityCoefficientimpl(AndroidFlingSpline.INSTANCE.m509flingPositionLfoxSSI(f10)) * flingDistance(f9)) / ((float) durationNanos)) * 1.0E9f;
    }
}
