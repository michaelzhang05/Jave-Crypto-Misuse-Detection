...
public final class WindowInsetsKt {
    ...
    public static final WindowInsets m676WindowInsetsa9UjIt4(float f8, float f9, float f10, float f11) {
        return new FixedDpInsets(f8, f9, f10, f11, null);
    }

    /* renamed from: WindowInsets-a9UjIt4$default, reason: not valid java name */
    public static /* synthetic */ WindowInsets m677WindowInsetsa9UjIt4$default(float f8, float f9, float f10, float f11, int i8, Object obj) {
        if ((i8 & 1) != 0) {
    ...
    public static final WindowInsets m678onlybOOhFvg(WindowInsets only, int i8) {
        AbstractC3255y.i(only, "$this$only");
