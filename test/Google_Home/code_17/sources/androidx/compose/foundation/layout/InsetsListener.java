...
public final class InsetsListener extends WindowInsetsAnimationCompat.Callback implements Runnable, OnApplyWindowInsetsListener, View.OnAttachStateChangeListener {
    ...
    public InsetsListener(WindowInsetsHolder composeInsets) {
        ...
        AbstractC3255y.i(composeInsets, "composeInsets");
    ...
    public WindowInsetsCompat onApplyWindowInsets(View view, WindowInsetsCompat insets) {
        ...
        if (this.composeInsets.getConsumes()) {
            ...
            AbstractC3255y.h(CONSUMED, "CONSUMED");
            return CONSUMED;
        }
        return insets;
    }
    ...
    public WindowInsetsCompat onProgress(WindowInsetsCompat insets, List<WindowInsetsAnimationCompat> runningAnimations) {
        AbstractC3255y.i(insets, "insets");
        AbstractC3255y.i(runningAnimations, "runningAnimations");
        WindowInsetsHolder.update$default(this.composeInsets, insets, 0, 2, null);
        if (this.composeInsets.getConsumes()) {
            WindowInsetsCompat CONSUMED = WindowInsetsCompat.CONSUMED;
            AbstractC3255y.h(CONSUMED, "CONSUMED");
    ...
    public WindowInsetsAnimationCompat.BoundsCompat onStart(WindowInsetsAnimationCompat animation, WindowInsetsAnimationCompat.BoundsCompat bounds) {
        ...
        AbstractC3255y.h(onStart, "super.onStart(animation, bounds)");
        return onStart;
    }
