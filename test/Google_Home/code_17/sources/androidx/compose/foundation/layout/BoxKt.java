...
public final class BoxKt {
    ...
    private static final MeasurePolicy EmptyBoxMeasurePolicy = new MeasurePolicy() { // from class: androidx.compose.foundation.layout.BoxKt$EmptyBoxMeasurePolicy$1
        ...
        public final MeasureResult mo137measure3p2s80s(MeasureScope MeasurePolicy, List<? extends Measurable> list, long j8) {
            AbstractC3255y.i(MeasurePolicy, "$this$MeasurePolicy");
            AbstractC3255y.i(list, "<anonymous parameter 0>");
            return MeasureScope.CC.q(MeasurePolicy, Constraints.m5153getMinWidthimpl(j8), Constraints.m5152getMinHeightimpl(j8), null, BoxKt$EmptyBoxMeasurePolicy$1$measure$1.INSTANCE, 4, null);
        }
    ...
    public static final void Box(Modifier modifier, Alignment alignment, boolean z8, InterfaceC1669o content, Composer composer, int i8, int i9) {
    ...
    public static final MeasurePolicy boxMeasurePolicy(final Alignment alignment, final boolean z8) {
        ...
        return new MeasurePolicy() { // from class: androidx.compose.foundation.layout.BoxKt$boxMeasurePolicy$1
            ...
            @Override // androidx.compose.ui.layout.MeasurePolicy
            /* renamed from: measure-3p2s80s */
            public final MeasureResult mo137measure3p2s80s(MeasureScope MeasurePolicy, List<? extends Measurable> measurables, long j8) {
                ...
                if (measurables.isEmpty()) {
                    return MeasureScope.CC.q(MeasurePolicy, Constraints.m5153getMinWidthimpl(j8), Constraints.m5152getMinHeightimpl(j8), null, BoxKt$boxMeasurePolicy$1$measure$1.INSTANCE, 4, null);
                }
                if (z8) {
                    m5142copyZbe2FdA$default = j8;
                } else {
                    m5142copyZbe2FdA$default = Constraints.m5142copyZbe2FdA$default(j8, 0, 0, 0, 0, 10, null);
                }
                if (measurables.size() == 1) {
                    Measurable measurable = measurables.get(0);
                    matchesParentSize3 = BoxKt.getMatchesParentSize(measurable);
                    if (!matchesParentSize3) {
                        Placeable mo4136measureBRTryo02 = measurable.mo4136measureBRTryo0(m5142copyZbe2FdA$default);
                        int max = Math.max(Constraints.m5153getMinWidthimpl(j8), mo4136measureBRTryo02.getWidth());
                        i10 = Math.max(Constraints.m5152getMinHeightimpl(j8), mo4136measureBRTryo02.getHeight());
                        mo4136measureBRTryo0 = mo4136measureBRTryo02;
                        m5153getMinWidthimpl = max;
                    } else {
                        m5153getMinWidthimpl = Constraints.m5153getMinWidthimpl(j8);
                        int m5152getMinHeightimpl = Constraints.m5152getMinHeightimpl(j8);
                        mo4136measureBRTryo0 = measurable.mo4136measureBRTryo0(Constraints.Companion.m5159fixedJhjzzOo(Constraints.m5153getMinWidthimpl(j8), Constraints.m5152getMinHeightimpl(j8)));
                        i10 = m5152getMinHeightimpl;
                    }
                    return MeasureScope.CC.q(MeasurePolicy, m5153getMinWidthimpl, i10, null, new BoxKt$boxMeasurePolicy$1$measure$2(mo4136measureBRTryo0, measurable, MeasurePolicy, m5153getMinWidthimpl, i10, alignment), 4, null);
                }
                Placeable[] placeableArr = new Placeable[measurables.size()];
                Q q8 = new Q();
                q8.f34160a = Constraints.m5153getMinWidthimpl(j8);
                Q q9 = new Q();
                q9.f34160a = Constraints.m5152getMinHeightimpl(j8);
                ...
                for (int i11 = 0; i11 < size; i11++) {
                    ...
                    if (!matchesParentSize2) {
                        Placeable mo4136measureBRTryo03 = measurable2.mo4136measureBRTryo0(m5142copyZbe2FdA$default);
                        placeableArr[i11] = mo4136measureBRTryo03;
                        q8.f34160a = Math.max(q8.f34160a, mo4136measureBRTryo03.getWidth());
                        q9.f34160a = Math.max(q9.f34160a, mo4136measureBRTryo03.getHeight());
                    } else {
                        z9 = true;
                    }
                }
                if (z9) {
                    ...
                    for (int i14 = 0; i14 < size2; i14++) {
                        ...
                        if (matchesParentSize) {
                            placeableArr[i14] = measurable3.mo4136measureBRTryo0(Constraints);
                        }
                    }
                }
                return MeasureScope.CC.q(MeasurePolicy, q8.f34160a, q9.f34160a, null, new BoxKt$boxMeasurePolicy$1$measure$5(placeableArr, measurables, MeasurePolicy, q8, q9, alignment), 4, null);
            }
    ...
    public static final void placeInBox(Placeable.PlacementScope placementScope, Placeable placeable, Measurable measurable, LayoutDirection layoutDirection, int i8, int i9, Alignment alignment) {
        ...
        Placeable.PlacementScope.m4174place70tqf50$default(placementScope, placeable, alignment2.mo2613alignKFBX0sM(IntSizeKt.IntSize(placeable.getWidth(), placeable.getHeight()), IntSizeKt.IntSize(i8, i9), layoutDirection), 0.0f, 2, null);
    }
    ...
    public static final MeasurePolicy rememberBoxMeasurePolicy(Alignment alignment, boolean z8, Composer composer, int i8) {
        ...
        if (AbstractC3255y.d(alignment, Alignment.Companion.getTopStart()) && !z8) {
