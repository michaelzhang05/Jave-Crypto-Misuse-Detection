...
public final class WindowInsetsHolder {
    ...
    public static final class Companion {
        ...
        public final ValueInsets valueInsetsIgnoringVisibility(WindowInsetsCompat windowInsetsCompat, int i8, String str) {
            ...
            AbstractC3255y.h(insets, "windowInsets?.getInsetsI…e) ?: AndroidXInsets.NONE");
    ...
    public /* synthetic */ WindowInsetsHolder(WindowInsetsCompat windowInsetsCompat, View view, AbstractC3247p abstractC3247p) {
    ...
    public final void update(WindowInsetsCompat windowInsets, int i8) {
        ...
        if (testInsets) {
            ...
            AbstractC3255y.f(windowInsets2);
            windowInsets = WindowInsetsCompat.toWindowInsetsCompat(windowInsets2);
        }
        AbstractC3255y.h(windowInsets, "if (testInsets) {\n      …   windowInsets\n        }");
        ...
        if (i8 == 0) {
            ...
            AbstractC3255y.h(insetsIgnoringVisibility, "insets.getInsetsIgnoring…aptionBar()\n            )");
            ...
            AbstractC3255y.h(insetsIgnoringVisibility2, "insets.getInsetsIgnoring…ationBars()\n            )");
            ...
            AbstractC3255y.h(insetsIgnoringVisibility3, "insets.getInsetsIgnoring…tatusBars()\n            )");
            ...
            AbstractC3255y.h(insetsIgnoringVisibility4, "insets.getInsetsIgnoring…ystemBars()\n            )");
            ...
            AbstractC3255y.h(insetsIgnoringVisibility5, "insets.getInsetsIgnoring…leElement()\n            )");
            ...
            if (displayCutout != null) {
                ...
                AbstractC3255y.h(waterfallInsets, "cutout.waterfallInsets");
    ...
    public final void updateImeAnimationSource(WindowInsetsCompat windowInsets) {
        ...
        AbstractC3255y.h(insets, "windowInsets.getInsets(W…wInsetsCompat.Type.ime())");
    ...
    private WindowInsetsHolder(WindowInsetsCompat windowInsetsCompat, View view) {
        ...
        AbstractC3255y.h(insets, "insets?.displayCutout?.w…ts ?: AndroidXInsets.NONE");
