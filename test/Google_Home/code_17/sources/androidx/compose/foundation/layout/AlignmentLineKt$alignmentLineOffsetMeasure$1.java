...
public final class AlignmentLineKt$alignmentLineOffsetMeasure$1 extends AbstractC3256z implements Function1 {
    ...
    public final void invoke(Placeable.PlacementScope layout) {
        ...
        if (horizontal) {
            ...
            width = !Dp.m5188equalsimpl0(this.$before, Dp.Companion.m5203getUnspecifiedD9Ej5fM()) ? this.$paddingBefore : (this.$width - this.$paddingAfter) - this.$placeable.getWidth();
        }
        horizontal2 = AlignmentLineKt.getHorizontal(this.$alignmentLine);
        if (horizontal2) {
            height = !Dp.m5188equalsimpl0(this.$before, Dp.Companion.m5203getUnspecifiedD9Ej5fM()) ? this.$paddingBefore : (this.$height - this.$paddingAfter) - this.$placeable.getHeight();
        } else {
            height = 0;
        }
