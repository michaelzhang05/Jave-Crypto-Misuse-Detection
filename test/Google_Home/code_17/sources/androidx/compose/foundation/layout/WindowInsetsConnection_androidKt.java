...
public final class WindowInsetsConnection_androidKt {
    ...
    private static final float f14557P1 = 0.175f;

    /* renamed from: P2, reason: collision with root package name */
    private static final float f14558P2 = 0.35000002f;
    ...
    public static final NestedScrollConnection m675rememberWindowInsetsConnectionVRgvIgI(AndroidWindowInsets windowInsets, int i8, Composer composer, int i9) {
        ...
        SideCalculator m635chooseCalculatorni1skBw = SideCalculator.Companion.m635chooseCalculatorni1skBw(i8, (LayoutDirection) composer.consume(CompositionLocalsKt.getLocalLayoutDirection()));
        View view = (View) composer.consume(AndroidCompositionLocals_androidKt.getLocalView());
        Density density = (Density) composer.consume(CompositionLocalsKt.getLocalDensity());
        Object[] objArr = {windowInsets, view, m635chooseCalculatorni1skBw, density};
        ...
        if (z8 || rememberedValue == Composer.Companion.getEmpty()) {
            rememberedValue = new WindowInsetsNestedScrollConnection(windowInsets, view, m635chooseCalculatorni1skBw, density);
