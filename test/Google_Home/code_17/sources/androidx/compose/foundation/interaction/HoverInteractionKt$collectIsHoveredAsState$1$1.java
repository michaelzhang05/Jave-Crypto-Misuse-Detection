...
public final class HoverInteractionKt$collectIsHoveredAsState$1$1 extends l implements InterfaceC1668n {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i8 != 0) {
            ...
            InterfaceC3706f interactions = this.$this_collectIsHoveredAsState.getInteractions();
            final MutableState<Boolean> mutableState = this.$isHovered;
            InterfaceC3707g interfaceC3707g = new InterfaceC3707g() { // from class: androidx.compose.foundation.interaction.HoverInteractionKt$collectIsHoveredAsState$1$1.1
    ...
    public final Object invoke(M m8, d dVar) {
        return ((HoverInteractionKt$collectIsHoveredAsState$1$1) create(m8, dVar)).invokeSuspend(I.f8278a);
    }
}
