...
public final class LazyStaggeredGridMeasureResult implements LazyStaggeredGridLayoutInfo, MeasureResult {
    ...
    public /* synthetic */ LazyStaggeredGridMeasureResult(int[] iArr, int[] iArr2, float f8, MeasureResult measureResult, boolean z8, boolean z9, boolean z10, int i8, List list, long j8, int i9, int i10, int i11, int i12, int i13, AbstractC3247p abstractC3247p) {
    ...
    public long mo772getViewportSizeYbymL2g() {
    ...
    private LazyStaggeredGridMeasureResult(int[] firstVisibleItemIndices, int[] firstVisibleItemScrollOffsets, float f8, MeasureResult measureResult, boolean z8, boolean z9, boolean z10, int i8, List<? extends LazyStaggeredGridItemInfo> visibleItemsInfo, long j8, int i9, int i10, int i11, int i12, int i13) {
        AbstractC3255y.i(firstVisibleItemIndices, "firstVisibleItemIndices");
        AbstractC3255y.i(firstVisibleItemScrollOffsets, "firstVisibleItemScrollOffsets");
        AbstractC3255y.i(measureResult, "measureResult");
        AbstractC3255y.i(visibleItemsInfo, "visibleItemsInfo");
