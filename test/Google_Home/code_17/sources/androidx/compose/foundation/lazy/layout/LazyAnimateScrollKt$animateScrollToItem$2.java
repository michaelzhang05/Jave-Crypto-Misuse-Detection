...
public final class LazyAnimateScrollKt$animateScrollToItem$2 extends l implements InterfaceC1668n {
    ...
    public static final class AnonymousClass3 extends AbstractC3256z implements Function1 {
        ...
        public final void invoke(AnimationScope<Float, AnimationVector1D> animateTo) {
            ...
            if (targetItemOffset == null) {
                ...
                float f8 = c8 - this.$prevValue.f34159a;
                ...
                if (targetItemOffset2 == null && !LazyAnimateScrollKt$animateScrollToItem$2.invokeSuspend$isOvershot(this.$forward, this.$this_animateScrollToItem, this.$index, this.$scrollOffset)) {
                    if (f8 == scrollBy) {
                        ...
                        if (this.$forward) {
                            if (this.$loops.f34160a >= 2 && this.$index - this.$this_animateScrollToItem.getLastVisibleItemIndex() > this.$this_animateScrollToItem.getNumOfItemsForTeleport()) {
                        ...
                        } else if (this.$loops.f34160a >= 2 && this.$this_animateScrollToItem.getFirstVisibleItemIndex() - this.$index > this.$this_animateScrollToItem.getNumOfItemsForTeleport()) {
            ...
            if (!LazyAnimateScrollKt$animateScrollToItem$2.invokeSuspend$isOvershot(this.$forward, this.$this_animateScrollToItem, this.$index, this.$scrollOffset)) {
                if (targetItemOffset != null) {
                    throw new ItemFoundInScroll(targetItemOffset.intValue(), (AnimationState) this.$anim.f34162a);
                }
                return;
            }
    ...
    public final Object invoke(ScrollScope scrollScope, d dVar) {
        return ((LazyAnimateScrollKt$animateScrollToItem$2) create(scrollScope, dVar)).invokeSuspend(I.f8278a);
    }
