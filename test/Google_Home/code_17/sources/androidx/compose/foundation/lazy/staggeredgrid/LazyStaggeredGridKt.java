...
public final class LazyStaggeredGridKt {
    ...
    public static final void m779LazyStaggeredGridLJWHXA8(LazyStaggeredGridState state, Orientation orientation, InterfaceC1668n slots, Modifier modifier, PaddingValues paddingValues, boolean z8, FlingBehavior flingBehavior, boolean z9, float f8, float f9, Function1 content, Composer composer, int i8, int i9, int i10) {
        Modifier modifier2;
        ...
        if ((i10 & 16) != 0) {
            paddingValues2 = PaddingKt.m598PaddingValues0680j_4(Dp.m5183constructorimpl(0));
        } else {
        ...
        InterfaceC1668n m788rememberStaggeredGridMeasurePolicynbWgWpA = LazyStaggeredGridMeasurePolicyKt.m788rememberStaggeredGridMeasurePolicynbWgWpA(state, rememberStaggeredGridItemProviderLambda, paddingValues2, z10, orientation, f10, f11, slots, startRestartGroup, (i12 & 7168) | (i12 & 896) | 8 | ((i11 << 9) & 57344) | (i13 & 458752) | (3670016 & i13) | ((i11 << 15) & 29360128));
