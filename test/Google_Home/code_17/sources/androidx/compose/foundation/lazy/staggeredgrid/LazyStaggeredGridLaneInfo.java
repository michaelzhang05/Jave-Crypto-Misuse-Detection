...
public final class LazyStaggeredGridLaneInfo {
    ...
    private final C1370k spannedItems = new C1370k();
    ...
    private final void ensureCapacity(int i8, int i9) {
        if (i8 <= 131072) {
            ...
            if (iArr.length < i8) {
                ...
                this.lanes = AbstractC1371l.l(this.lanes, new int[length], i9, 0, 0, 12, null);
                return;
            }
            return;
        }
    ...
    public final void ensureValidIndex(int i8) {
        ...
        if (i10 >= 0 && i10 < 131072) {
            ...
            if (i11 >= 0) {
                int[] iArr = this.lanes;
                if (i11 < iArr.length) {
                    AbstractC1371l.g(iArr, iArr, 0, i11, iArr.length);
                }
                int[] iArr2 = this.lanes;
                AbstractC1371l.r(iArr2, 0, Math.max(0, iArr2.length - i11), this.lanes.length);
            } else {
                int i12 = -i11;
                ...
                if (iArr3.length + i12 < 131072) {
                    ...
                    if (i12 < iArr3.length) {
                        AbstractC1371l.g(iArr3, iArr3, i12, 0, iArr3.length - i12);
                    }
                    int[] iArr4 = this.lanes;
                    AbstractC1371l.r(iArr4, 0, 0, Math.min(iArr4.length, i12));
                }
            }
        }
    ...
    public final int[] getGaps(int i8) {
        C1370k c1370k = this.spannedItems;
        SpannedItem spannedItem = (SpannedItem) AbstractC1378t.p0(this.spannedItems, AbstractC1378t.i(c1370k, 0, c1370k.size(), new LazyStaggeredGridLaneInfo$getGaps$$inlined$binarySearchBy$default$1(Integer.valueOf(i8))));
        if (spannedItem != null) {
    ...
    public final void reset() {
        AbstractC1371l.v(this.lanes, 0, 0, 0, 6, null);
        this.spannedItems.clear();
    }

    public final void setGaps(int i8, int[] iArr) {
        C1370k c1370k = this.spannedItems;
        int i9 = AbstractC1378t.i(c1370k, 0, c1370k.size(), new LazyStaggeredGridLaneInfo$setGaps$$inlined$binarySearchBy$default$1(Integer.valueOf(i8)));
        if (i9 < 0) {
            if (iArr == null) {
                return;
            }
