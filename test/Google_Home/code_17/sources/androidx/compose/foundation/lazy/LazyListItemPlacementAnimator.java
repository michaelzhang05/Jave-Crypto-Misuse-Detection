...
public final class LazyListItemPlacementAnimator {
    ...
    private final void forEachNode(LazyListMeasuredItem lazyListMeasuredItem, InterfaceC1668n interfaceC1668n) {
        ...
        for (int i8 = 0; i8 < placeablesCount; i8++) {
            ...
            if (node != null) {
                interfaceC1668n.invoke(Integer.valueOf(i8), node);
            }
        }
    }
    ...
    private final void initializeNode(LazyListMeasuredItem lazyListMeasuredItem, int i8) {
        ...
        long m713getOffsetBjo55l4 = lazyListMeasuredItem.m713getOffsetBjo55l4(0);
        if (lazyListMeasuredItem.isVertical()) {
            m5303copyiSbpLlY$default = IntOffset.m5303copyiSbpLlY$default(m713getOffsetBjo55l4, 0, i8, 1, null);
        } else {
            m5303copyiSbpLlY$default = IntOffset.m5303copyiSbpLlY$default(m713getOffsetBjo55l4, i8, 0, 2, null);
        }
        int placeablesCount = lazyListMeasuredItem.getPlaceablesCount();
        for (int i9 = 0; i9 < placeablesCount; i9++) {
            LazyLayoutAnimateItemModifierNode node = getNode(lazyListMeasuredItem.getParentData(i9));
            if (node != null) {
                long m713getOffsetBjo55l42 = lazyListMeasuredItem.m713getOffsetBjo55l4(i9);
                long IntOffset = IntOffsetKt.IntOffset(IntOffset.m5307getXimpl(m713getOffsetBjo55l42) - IntOffset.m5307getXimpl(m713getOffsetBjo55l4), IntOffset.m5308getYimpl(m713getOffsetBjo55l42) - IntOffset.m5308getYimpl(m713getOffsetBjo55l4));
    ...
    private final void startAnimationsIfNeeded(LazyListMeasuredItem lazyListMeasuredItem) {
        ...
        for (int i8 = 0; i8 < placeablesCount; i8++) {
            LazyLayoutAnimateItemModifierNode node = getNode(lazyListMeasuredItem.getParentData(i8));
            if (node != null) {
                long m713getOffsetBjo55l4 = lazyListMeasuredItem.m713getOffsetBjo55l4(i8);
                long m749getRawOffsetnOccac = node.m749getRawOffsetnOccac();
                if (!IntOffset.m5306equalsimpl0(m749getRawOffsetnOccac, LazyLayoutAnimateItemModifierNode.Companion.m751getNotInitializednOccac()) && !IntOffset.m5306equalsimpl0(m749getRawOffsetnOccac, m713getOffsetBjo55l4)) {
                    node.m747animatePlacementDeltagyyYBs(IntOffsetKt.IntOffset(IntOffset.m5307getXimpl(m713getOffsetBjo55l4) - IntOffset.m5307getXimpl(m749getRawOffsetnOccac), IntOffset.m5308getYimpl(m713getOffsetBjo55l4) - IntOffset.m5308getYimpl(m749getRawOffsetnOccac)));
                }
                node.m750setRawOffsetgyyYBs(m713getOffsetBjo55l4);
            }
        }
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:109:0x020a, code lost:
        ...
        P5.AbstractC1378t.B(r1, new androidx.compose.foundation.lazy.LazyListItemPlacementAnimator$onMeasured$$inlined$sortByDescending$2(r18));
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:116:0x0249, code lost:
        ...
        P5.AbstractC1378t.B(r1, new androidx.compose.foundation.lazy.LazyListItemPlacementAnimator$onMeasured$$inlined$sortBy$2(r18));
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:32:0x00c2, code lost:
        ...
        r15 = r14.m713getOffsetBjo55l4(0);
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:34:0x00cd, code lost:
        ...
        r13 = androidx.compose.ui.unit.IntOffset.m5308getYimpl(r15);
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:36:0x00d2, code lost:
        ...
        r13 = androidx.compose.ui.unit.IntOffset.m5307getXimpl(r15);
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:42:0x00fc, code lost:
        ...
        if (androidx.compose.ui.unit.IntOffset.m5306equalsimpl0(r7.m749getRawOffsetnOccac(), androidx.compose.foundation.lazy.layout.LazyLayoutAnimateItemModifierNode.Companion.m751getNotInitializednOccac()) != false) goto L111;
     */
    /* JADX WARN: Code restructure failed: missing block: B:43:0x00fe, code lost:
    
        r1 = r7.m749getRawOffsetnOccac();
        r7.m750setRawOffsetgyyYBs(androidx.compose.ui.unit.IntOffsetKt.IntOffset(androidx.compose.ui.unit.IntOffset.m5307getXimpl(r1) + androidx.compose.ui.unit.IntOffset.m5307getXimpl(r10), androidx.compose.ui.unit.IntOffset.m5308getYimpl(r1) + androidx.compose.ui.unit.IntOffset.m5308getYimpl(r10)));
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:56:0x014e, code lost:
        ...
        P5.AbstractC1378t.B(r1, new androidx.compose.foundation.lazy.LazyListItemPlacementAnimator$onMeasured$$inlined$sortByDescending$1(r8));
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:63:0x017e, code lost:
        ...
        P5.AbstractC1378t.B(r1, new androidx.compose.foundation.lazy.LazyListItemPlacementAnimator$onMeasured$$inlined$sortBy$1(r8));
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:7:0x003a, code lost:
        ...
        r8 = (androidx.compose.foundation.lazy.LazyListMeasuredItem) P5.AbstractC1378t.o0(r22);
     */
