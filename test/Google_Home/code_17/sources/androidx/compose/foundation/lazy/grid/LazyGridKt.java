...
public final class LazyGridKt {
    ...
    */
    public static final void LazyGrid(androidx.compose.ui.Modifier r31, androidx.compose.foundation.lazy.grid.LazyGridState r32, a6.InterfaceC1668n r33, androidx.compose.foundation.layout.PaddingValues r34, boolean r35, boolean r36, androidx.compose.foundation.gestures.FlingBehavior r37, boolean r38, androidx.compose.foundation.layout.Arrangement.Vertical r39, androidx.compose.foundation.layout.Arrangement.Horizontal r40, kotlin.jvm.functions.Function1 r41, androidx.compose.runtime.Composer r42, int r43, int r44, int r45) {
        /*
            Method dump skipped, instructions count: 777
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.lazy.grid.LazyGridKt.LazyGrid(androidx.compose.ui.Modifier, androidx.compose.foundation.lazy.grid.LazyGridState, a6.n, androidx.compose.foundation.layout.PaddingValues, boolean, boolean, androidx.compose.foundation.gestures.FlingBehavior, boolean, androidx.compose.foundation.layout.Arrangement$Vertical, androidx.compose.foundation.layout.Arrangement$Horizontal, kotlin.jvm.functions.Function1, androidx.compose.runtime.Composer, int, int, int):void");
    }
    ...
    @Composable
    private static final InterfaceC1668n rememberLazyGridMeasurePolicy(Function0 function0, LazyGridState lazyGridState, InterfaceC1668n interfaceC1668n, PaddingValues paddingValues, boolean z8, boolean z9, Arrangement.Horizontal horizontal, Arrangement.Vertical vertical, Composer composer, int i8, int i9) {
        ...
        Object[] objArr = {lazyGridState, interfaceC1668n, paddingValues, Boolean.valueOf(z8), Boolean.valueOf(z9), horizontal2, vertical2};
        ...
        if (z10 || rememberedValue == Composer.Companion.getEmpty()) {
            rememberedValue = new LazyGridKt$rememberLazyGridMeasurePolicy$1$1(z9, paddingValues, z8, function0, interfaceC1668n, lazyGridState, vertical2, horizontal2);
            composer.updateRememberedValue(rememberedValue);
        }
        composer.endReplaceableGroup();
        InterfaceC1668n interfaceC1668n2 = (InterfaceC1668n) rememberedValue;
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return interfaceC1668n2;
    }
}
