    ...
    */
    ...
    private final void cancelPrefetchIfVisibleItemsChanged(LazyListLayoutInfo lazyListLayoutInfo) {
        ...
        if (this.indexToPrefetch != -1 && (!lazyListLayoutInfo.getVisibleItemsInfo().isEmpty())) {
            if (this.wasScrollingForward) {
                index = ((LazyListItemInfo) AbstractC1378t.y0(lazyListLayoutInfo.getVisibleItemsInfo())).getIndex() + 1;
            } else {
                index = ((LazyListItemInfo) AbstractC1378t.m0(lazyListLayoutInfo.getVisibleItemsInfo())).getIndex() - 1;
            }
    ...
    private final void notifyPrefetch(float f8) {
        ...
        if (!layoutInfo.getVisibleItemsInfo().isEmpty()) {
            ...
            if (z8) {
                index = ((LazyListItemInfo) AbstractC1378t.y0(layoutInfo.getVisibleItemsInfo())).getIndex() + 1;
            } else {
                index = ((LazyListItemInfo) AbstractC1378t.m0(layoutInfo.getVisibleItemsInfo())).getIndex() - 1;
            }
    ...
    public final long m715getPremeasureConstraintsmsEJaDk$foundation_release() {
    ...
    */
    public java.lang.Object scroll(androidx.compose.foundation.MutatePriority r6, a6.InterfaceC1668n r7, S5.d r8) {
        ...
        L6c:
            ...
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.lazy.LazyListState.scroll(androidx.compose.foundation.MutatePriority, a6.n, S5.d):java.lang.Object");
    }
    ...
    public final void m716setPremeasureConstraintsBRTryo0$foundation_release(long j8) {
    ...
    public /* synthetic */ LazyListState(int i8, int i9, int i10, AbstractC3247p abstractC3247p) {
