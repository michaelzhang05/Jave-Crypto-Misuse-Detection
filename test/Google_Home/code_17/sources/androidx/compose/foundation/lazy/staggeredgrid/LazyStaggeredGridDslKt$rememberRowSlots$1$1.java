...
final class LazyStaggeredGridDslKt$rememberRowSlots$1$1 extends AbstractC3256z implements InterfaceC1668n {
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object obj, Object obj2) {
        return m776invoke0kLqBqw((Density) obj, ((Constraints) obj2).m5157unboximpl());
    }

    /* renamed from: invoke-0kLqBqw, reason: not valid java name */
    public final LazyStaggeredGridSlots m776invoke0kLqBqw(Density $receiver, long j8) {
        ...
        if (Constraints.m5150getMaxHeightimpl(j8) != Integer.MAX_VALUE) {
            ...
            int[] calculateCrossAxisCellSizes = staggeredGridCells.calculateCrossAxisCellSizes($receiver, m5150getMaxHeightimpl, $receiver.mo447roundToPx0680j_4(vertical.mo525getSpacingD9Ej5fM()));
            int[] iArr = new int[calculateCrossAxisCellSizes.length];
            vertical.arrange($receiver, m5150getMaxHeightimpl, calculateCrossAxisCellSizes, iArr);
