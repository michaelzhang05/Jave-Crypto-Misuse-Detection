...
public final class LazyListAnimateScrollScope implements LazyAnimateScrollScope {
    ...
    public int getLastVisibleItemIndex() {
        LazyListItemInfo lazyListItemInfo = (LazyListItemInfo) AbstractC1378t.z0(this.state.getLayoutInfo().getVisibleItemsInfo());
    ...
    public Object scroll(InterfaceC1668n interfaceC1668n, d dVar) {
        Object e8 = androidx.compose.foundation.gestures.c.e(this.state, null, interfaceC1668n, dVar, 1, null);
        if (e8 == T5.b.e()) {
            return e8;
        }
        return I.f8278a;
