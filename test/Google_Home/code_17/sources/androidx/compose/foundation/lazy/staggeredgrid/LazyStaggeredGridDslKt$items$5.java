...
public final class LazyStaggeredGridDslKt$items$5 extends AbstractC3256z implements InterfaceC1670p {
    final /* synthetic */ InterfaceC1670p $itemContent;
    final /* synthetic */ List<T> $items;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public LazyStaggeredGridDslKt$items$5(InterfaceC1670p interfaceC1670p, List<? extends T> list) {
        super(4);
