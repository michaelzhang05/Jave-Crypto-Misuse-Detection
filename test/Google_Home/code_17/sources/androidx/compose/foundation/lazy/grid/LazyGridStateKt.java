...
public final class LazyGridStateKt {
    ...
    public static final LazyGridState rememberLazyGridState(int i8, int i9, Composer composer, int i10, int i11) {
        ...
        LazyGridState lazyGridState = (LazyGridState) RememberSaveableKt.m2588rememberSaveable(objArr, (Saver) saver, (String) null, (Function0) rememberedValue, composer, 72, 4);
        if (ComposerKt.isTraceInProgress()) {
