...
public final class LazyStaggeredGridScrollPosition implements SnapshotMutationPolicy<int[]> {
    private final InterfaceC1668n fillIndices;
    ...
    public LazyStaggeredGridScrollPosition(int[] initialIndices, int[] initialOffsets, InterfaceC1668n fillIndices) {
        int i8;
        AbstractC3255y.i(initialIndices, "initialIndices");
        AbstractC3255y.i(initialOffsets, "initialOffsets");
        AbstractC3255y.i(fillIndices, "fillIndices");
        ...
        Integer E02 = AbstractC1371l.E0(initialIndices);
        if (E02 != null) {
            i8 = E02.intValue();
        } else {
            i8 = 0;
    ...
    public final void updateFromMeasureResult(LazyStaggeredGridMeasureResult measureResult) {
        ...
        if (firstVisibleItemIndices.length != 0) {
            ...
            int g02 = AbstractC1371l.g0(firstVisibleItemIndices);
            if (g02 != 0) {
                if (i11 == -1) {
    ...
    public final int[] updateScrollPositionIfTheFirstItemWasMoved(LazyLayoutItemProvider itemProvider, int[] indices) {
        ...
        int i8 = 0;
        Integer j02 = AbstractC1371l.j0(indices, 0);
        if (j02 != null) {
            i8 = j02.intValue();
        }
        int findIndexByKey = LazyLayoutItemProviderKt.findIndexByKey(itemProvider, obj, i8);
        if (!AbstractC1371l.U(indices, findIndexByKey)) {
