...
public final class LazyListMeasureKt {
        ...
        if (z10) {
            if (list2.isEmpty() && list3.isEmpty()) {
                ...
                if ((j8 > 0 && e8 <= f8) || (j8 < 0 && f8 <= e8)) {
                    while (true) {
                        int i16 = iArr2[e8];
                        LazyListMeasuredItem lazyListMeasuredItem = list.get(calculateItemsOffsets$reverseAware(e8, z9, size));
                        if (z9) {
                            i16 = (i13 - i16) - lazyListMeasuredItem.getSize();
                        }
                        lazyListMeasuredItem.position(i16, i8, i9);
            ...
            for (int i18 = 0; i18 < size2; i18++) {
                ...
                lazyListMeasuredItem2.position(i17, i8, i9);
                arrayList.add(lazyListMeasuredItem2);
            }
            int size3 = list.size();
            int i19 = i12;
            for (int i20 = 0; i20 < size3; i20++) {
                LazyListMeasuredItem lazyListMeasuredItem3 = list.get(i20);
                lazyListMeasuredItem3.position(i19, i8, i9);
                arrayList.add(lazyListMeasuredItem3);
                i19 += lazyListMeasuredItem3.getSizeWithSpacings();
            }
            int size4 = list3.size();
            for (int i21 = 0; i21 < size4; i21++) {
                LazyListMeasuredItem lazyListMeasuredItem4 = list3.get(i21);
                lazyListMeasuredItem4.position(i19, i8, i9);
                arrayList.add(lazyListMeasuredItem4);
                i19 += lazyListMeasuredItem4.getSizeWithSpacings();
            }
        }
        return arrayList;
    }
    ...
    private static final List<LazyListMeasuredItem> createItemsAfterList(List<LazyListMeasuredItem> list, LazyListMeasuredItemProvider lazyListMeasuredItemProvider, int i8, int i9, List<Integer> list2) {
        int min = Math.min(((LazyListMeasuredItem) AbstractC1378t.y0(list)).getIndex() + i9, i8 - 1);
        int index = ((LazyListMeasuredItem) AbstractC1378t.y0(list)).getIndex() + 1;
    ...
    public static final LazyListMeasureResult m710measureLazyListCD5nmq0(int i8, LazyListMeasuredItemProvider measuredItemProvider, int i9, int i10, int i11, int i12, int i13, int i14, float f8, long j8, boolean z8, List<Integer> headerIndexes, Arrangement.Vertical vertical, Arrangement.Horizontal horizontal, boolean z9, Density density, LazyListItemPlacementAnimator placementAnimator, int i15, List<Integer> pinnedItems, InterfaceC1669o layout) {
        int i16;
        int i17;
        int i18;
        int i19;
        ...
        AbstractC3255y.i(headerIndexes, "headerIndexes");
        AbstractC3255y.i(density, "density");
        AbstractC3255y.i(placementAnimator, "placementAnimator");
        ...
        if (i8 <= 0) {
            return new LazyListMeasureResult(null, 0, false, 0.0f, (MeasureResult) layout.invoke(Integer.valueOf(Constraints.m5153getMinWidthimpl(j8)), Integer.valueOf(Constraints.m5152getMinHeightimpl(j8)), LazyListMeasureKt$measureLazyList$1.INSTANCE), AbstractC1378t.m(), -i10, i9 + i11, 0, z9, z8 ? Orientation.Vertical : Orientation.Horizontal, i11, i12);
        }
        int i26 = i13;
        if (i26 >= i8) {
            i26 = i8 - 1;
        ...
        int d9 = m.d(i34, 0);
        int i37 = -i33;
        int size = c1370k.size();
        int i38 = i36;
        int i39 = i33;
        for (int i40 = 0; i40 < size; i40++) {
            i38++;
            i37 += ((LazyListMeasuredItem) c1370k.get(i40)).getSizeWithSpacings();
        }
        int i41 = i35;
        int i42 = i37;
        int i43 = i38;
        while (i43 < i8 && (i42 < d9 || i42 <= 0 || c1370k.isEmpty())) {
            int i44 = d9;
        ...
        int i52 = i41;
        float f9 = (AbstractC2055a.a(AbstractC2055a.d(f8)) != AbstractC2055a.a(i20) || Math.abs(AbstractC2055a.d(f8)) < Math.abs(i20)) ? f8 : i20;
        if (i21 >= 0) {
            int i53 = -i21;
            LazyListMeasuredItem lazyListMeasuredItem3 = (LazyListMeasuredItem) c1370k.first();
            if (i10 > 0 || i12 < 0) {
                int size2 = c1370k.size();
                int i54 = i21;
                int i55 = 0;
                while (true) {
                    if (i55 >= size2) {
                    ...
                    lazyListMeasuredItem = lazyListMeasuredItem3;
                    int sizeWithSpacings = ((LazyListMeasuredItem) c1370k.get(i55)).getSizeWithSpacings();
                    if (i54 == 0 || sizeWithSpacings > i54) {
                        break;
                    }
                    int i56 = size2;
                    if (i55 == AbstractC1378t.o(c1370k)) {
                        break;
                    }
                    i54 -= sizeWithSpacings;
                    i55++;
                    lazyListMeasuredItem3 = (LazyListMeasuredItem) c1370k.get(i55);
                    size2 = i56;
                }
                i23 = i54;
            ...
            List<LazyListMeasuredItem> createItemsAfterList = createItemsAfterList(c1370k, measuredItemProvider, i8, i15, pinnedItems);
            ...
            boolean z10 = AbstractC3255y.d(lazyListMeasuredItem2, c1370k.first()) && createItemsBeforeList.isEmpty() && createItemsAfterList.isEmpty();
            int m5165constrainWidthK40F9xA = ConstraintsKt.m5165constrainWidthK40F9xA(j8, z8 ? i57 : i19);
            if (z8) {
                i57 = i19;
            }
            int m5164constrainHeightK40F9xA = ConstraintsKt.m5164constrainHeightK40F9xA(j8, i57);
            int i60 = i17;
            int i61 = i18;
            List<LazyListMeasuredItem> calculateItemsOffsets = calculateItemsOffsets(c1370k, createItemsBeforeList, createItemsAfterList, m5165constrainWidthK40F9xA, m5164constrainHeightK40F9xA, i19, i9, i53, z8, vertical, horizontal, z9, density);
            int i62 = i19;
            float f10 = f9;
            LazyListMeasuredItem lazyListMeasuredItem4 = lazyListMeasuredItem2;
            placementAnimator.onMeasured((int) f9, m5165constrainWidthK40F9xA, m5164constrainHeightK40F9xA, calculateItemsOffsets, measuredItemProvider, z8);
            LazyListMeasuredItem findOrComposeLazyListHeader = headerIndexes.isEmpty() ^ true ? LazyListHeadersKt.findOrComposeLazyListHeader(calculateItemsOffsets, measuredItemProvider, headerIndexes, i10, m5165constrainWidthK40F9xA, m5164constrainHeightK40F9xA) : null;
            boolean z11 = i61 < i8 || i62 > i9;
            MeasureResult measureResult = (MeasureResult) layout.invoke(Integer.valueOf(m5165constrainWidthK40F9xA), Integer.valueOf(m5164constrainHeightK40F9xA), new LazyListMeasureKt$measureLazyList$5(calculateItemsOffsets, findOrComposeLazyListHeader));
            if (z10) {
                ...
                for (int i63 = 0; i63 < size5; i63++) {
                    ...
                    if ((lazyListMeasuredItem6.getIndex() >= ((LazyListMeasuredItem) c1370k.first()).getIndex() && lazyListMeasuredItem6.getIndex() <= ((LazyListMeasuredItem) c1370k.last()).getIndex()) || lazyListMeasuredItem6 == findOrComposeLazyListHeader) {
