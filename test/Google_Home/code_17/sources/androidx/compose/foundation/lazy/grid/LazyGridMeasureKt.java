...
public final class LazyGridMeasureKt {
    ...
    private static final List<LazyGridMeasuredItem> calculateExtraItems(List<Integer> list, LazyGridMeasuredItemProvider lazyGridMeasuredItemProvider, Function1 function1, Function1 function12) {
        ...
        for (int i8 = 0; i8 < size; i8++) {
            ...
            if (((Boolean) function12.invoke(Integer.valueOf(intValue))).booleanValue()) {
                LazyGridMeasuredItem m741getAndMeasure3p2s80s$default = LazyGridMeasuredItemProvider.m741getAndMeasure3p2s80s$default(lazyGridMeasuredItemProvider, intValue, 0, ((Constraints) function1.invoke(Integer.valueOf(intValue))).m5157unboximpl(), 2, null);
                if (arrayList == null) {
                    arrayList = new ArrayList();
                }
                arrayList.add(m741getAndMeasure3p2s80s$default);
            }
        }
        if (arrayList == null) {
    ...
    private static final List<LazyGridMeasuredItem> calculateItemsOffsets(List<LazyGridMeasuredLine> list, List<LazyGridMeasuredItem> list2, List<LazyGridMeasuredItem> list3, int i8, int i9, int i10, int i11, int i12, boolean z8, Arrangement.Vertical vertical, Arrangement.Horizontal horizontal, boolean z9, Density density) {
        ...
        if (z10) {
            if (list2.isEmpty() && list3.isEmpty()) {
                ...
                if ((j8 > 0 && e8 <= f8) || (j8 < 0 && f8 <= e8)) {
                    while (true) {
                        ...
                        AbstractC1378t.E(arrayList, lazyGridMeasuredLine.position(i18, i8, i9));
                        if (e8 == f8) {
                            break;
                        }
                        e8 += j8;
            ...
            for (int i22 = 0; i22 < size4; i22++) {
                ...
                AbstractC1378t.E(arrayList, lazyGridMeasuredLine2.position(i21, i8, i9));
    ...
    */
    public static final androidx.compose.foundation.lazy.grid.LazyGridMeasureResult m738measureLazyGridZRKPzZ8(int r34, androidx.compose.foundation.lazy.grid.LazyGridMeasuredLineProvider r35, androidx.compose.foundation.lazy.grid.LazyGridMeasuredItemProvider r36, int r37, int r38, int r39, int r40, int r41, int r42, float r43, long r44, boolean r46, androidx.compose.foundation.layout.Arrangement.Vertical r47, androidx.compose.foundation.layout.Arrangement.Horizontal r48, boolean r49, androidx.compose.ui.unit.Density r50, androidx.compose.foundation.lazy.grid.LazyGridItemPlacementAnimator r51, androidx.compose.foundation.lazy.grid.LazyGridSpanLayoutProvider r52, java.util.List<java.lang.Integer> r53, a6.InterfaceC1669o r54) {
        /*
            Method dump skipped, instructions count: 972
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.lazy.grid.LazyGridMeasureKt.m738measureLazyGridZRKPzZ8(int, androidx.compose.foundation.lazy.grid.LazyGridMeasuredLineProvider, androidx.compose.foundation.lazy.grid.LazyGridMeasuredItemProvider, int, int, int, int, int, int, float, long, boolean, androidx.compose.foundation.layout.Arrangement$Vertical, androidx.compose.foundation.layout.Arrangement$Horizontal, boolean, androidx.compose.ui.unit.Density, androidx.compose.foundation.lazy.grid.LazyGridItemPlacementAnimator, androidx.compose.foundation.lazy.grid.LazyGridSpanLayoutProvider, java.util.List, a6.o):androidx.compose.foundation.lazy.grid.LazyGridMeasureResult");
    }
}
