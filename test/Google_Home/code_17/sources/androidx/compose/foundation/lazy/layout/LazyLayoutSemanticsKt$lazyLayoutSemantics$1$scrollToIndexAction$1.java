...
public final class LazyLayoutSemanticsKt$lazyLayoutSemantics$1$scrollToIndexAction$1 extends AbstractC3256z implements Function1 {
    ...
    public final Boolean invoke(int i8) {
        ...
        if (i8 >= 0 && i8 < lazyLayoutItemProvider.getItemCount()) {
            AbstractC3364k.d(this.$coroutineScope, null, null, new AnonymousClass2(this.$state, i8, null), 3, null);
            return Boolean.TRUE;
        }
