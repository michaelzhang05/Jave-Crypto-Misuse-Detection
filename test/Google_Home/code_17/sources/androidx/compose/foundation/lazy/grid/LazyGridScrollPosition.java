...
public final class LazyGridScrollPosition {
    ...
    */
    ...
    public final void updateFromMeasureResult(LazyGridMeasureResult measureResult) {
        ...
        if (firstVisibleLine != null && (items2 = firstVisibleLine.getItems()) != null && (lazyGridMeasuredItem2 = (LazyGridMeasuredItem) AbstractC1371l.d0(items2)) != null) {
        ...
        if (this.hadFirstNotEmptyLayout || measureResult.getTotalItemsCount() > 0) {
            ...
            if (firstVisibleLineScrollOffset >= 0.0f) {
                ...
                if (firstVisibleLine2 != null && (items = firstVisibleLine2.getItems()) != null && (lazyGridMeasuredItem = (LazyGridMeasuredItem) AbstractC1371l.d0(items)) != null) {
    ...
    public /* synthetic */ LazyGridScrollPosition(int i8, int i9, int i10, AbstractC3247p abstractC3247p) {
