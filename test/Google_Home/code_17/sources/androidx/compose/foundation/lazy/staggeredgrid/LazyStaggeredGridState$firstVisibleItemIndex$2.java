...
public final class LazyStaggeredGridState$firstVisibleItemIndex$2 extends AbstractC3256z implements Function0 {
    ...
    public final Integer invoke() {
        ...
        if (indices.length == 0) {
            ...
            N it = new i(1, AbstractC1371l.g0(indices)).iterator();
            while (it.hasNext()) {
