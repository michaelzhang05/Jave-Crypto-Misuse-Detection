...
final class ParentSizeElement extends ModifierNodeElement<ParentSizeNode> {
    ...
    public /* synthetic */ ParentSizeElement(float f8, State state, State state2, String str, int i8, AbstractC3247p abstractC3247p) {
    ...
    public boolean equals(Object obj) {
        ...
        if (this.fraction == parentSizeNode.getFraction() && AbstractC3255y.d(this.widthState, parentSizeNode.getWidthState()) && AbstractC3255y.d(this.heightState, parentSizeNode.getHeightState())) {
            return true;
        }
        return false;
    }
