...
public abstract class LazyStaggeredGridMeasureProvider {
    ...
    private final long m790childConstraintsJhjzzOo(int i8, int i9) {
        int i10;
        ...
        if (this.isVertical) {
            return Constraints.Companion.m5161fixedWidthOenEA2s(i10);
        }
        return Constraints.Companion.m5160fixedHeightOenEA2s(i10);
    }
    ...
    public final LazyStaggeredGridMeasuredItem m791getAndMeasurejy6DScQ(int i8, long j8) {
        int i9 = (int) (j8 >> 32);
        int i10 = ((int) (j8 & 4294967295L)) - i9;
        return createItem(i8, i9, i10, this.itemProvider.getKey(i8), this.itemProvider.getContentType(i8), this.measureScope.mo761measure0kLqBqw(i8, m790childConstraintsJhjzzOo(i9, i10)));
    }
