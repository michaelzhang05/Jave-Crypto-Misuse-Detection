...
public final class LazyGridKt$rememberLazyGridMeasurePolicy$1$1 extends AbstractC3256z implements InterfaceC1668n {
    ...
    public static final class AnonymousClass1 extends AbstractC3256z implements Function1 {
        ...
        public final ArrayList<r> invoke(int i8) {
            ...
            for (int i10 = 0; i10 < size; i10++) {
                int m722getCurrentLineSpanimpl = GridItemSpan.m722getCurrentLineSpanimpl(spans.get(i10).m725unboximpl());
                arrayList.add(x.a(Integer.valueOf(firstItemIndex), Constraints.m5139boximpl(lazyGridKt$rememberLazyGridMeasurePolicy$1$1$measuredLineProvider$1.m743childConstraintsJhjzzOo$foundation_release(i9, m722getCurrentLineSpanimpl))));
                firstItemIndex++;
                i9 += m722getCurrentLineSpanimpl;
            }
            return arrayList;
        }
    }
    ...
    /* loaded from: classes.dex */
    public static final class AnonymousClass3 extends AbstractC3256z implements InterfaceC1669o {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public LazyGridKt$rememberLazyGridMeasurePolicy$1$1(boolean z8, PaddingValues paddingValues, boolean z9, Function0 function0, InterfaceC1668n interfaceC1668n, LazyGridState lazyGridState, Arrangement.Vertical vertical, Arrangement.Horizontal horizontal) {
        super(2);
        this.$isVertical = z8;
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object obj, Object obj2) {
        return m737invoke0kLqBqw((LazyLayoutMeasureScope) obj, ((Constraints) obj2).m5157unboximpl());
    }
    ...
    public final LazyGridMeasureResult m737invoke0kLqBqw(final LazyLayoutMeasureScope lazyLayoutMeasureScope, long j8) {
        ...
        int i11 = mo447roundToPx0680j_43 + mo447roundToPx0680j_44;
        int i12 = mo447roundToPx0680j_4 + mo447roundToPx0680j_42;
        ...
        final int i13 = i8 - i9;
        long m5167offsetNN6EwU = ConstraintsKt.m5167offsetNN6EwU(j8, -i12, -i11);
        ...
        final LazyGridSlots lazyGridSlots = (LazyGridSlots) this.$slots.invoke(lazyLayoutMeasureScope, Constraints.m5139boximpl(j8));
        ...
        if (this.$isVertical) {
            m5151getMaxWidthimpl = Constraints.m5150getMaxHeightimpl(j8) - i11;
        } else {
            m5151getMaxWidthimpl = Constraints.m5151getMaxWidthimpl(j8) - i12;
        }
        int i14 = m5151getMaxWidthimpl;
        if (this.$reverseLayout && i14 <= 0) {
            boolean z9 = this.$isVertical;
            if (!z9) {
                mo447roundToPx0680j_4 += i14;
            }
            if (z9) {
                mo447roundToPx0680j_43 += i14;
            }
        ...
        final int i15 = i9;
        final ?? r32 = new LazyGridMeasuredItemProvider(lazyGridItemProvider, lazyLayoutMeasureScope, mo447roundToPx0680j_45, z10, z11, i15, i13, j9) { // from class: androidx.compose.foundation.lazy.grid.LazyGridKt$rememberLazyGridMeasurePolicy$1$1$measuredItemProvider$1
        ...
        ?? r9 = new LazyGridMeasuredLineProvider(z12, lazyGridSlots, itemCount, mo447roundToPx0680j_45, r32, spanLayoutProvider) { // from class: androidx.compose.foundation.lazy.grid.LazyGridKt$rememberLazyGridMeasurePolicy$1$1$measuredLineProvider$1
            final /* synthetic */ boolean $isVertical;
            ...
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(z12, lazyGridSlots, itemCount, mo447roundToPx0680j_45, r32, spanLayoutProvider);
                this.$isVertical = z12;
        ...
        try {
            ...
            try {
                ...
                if (updateScrollPositionIfTheFirstItemWasMoved$foundation_release >= itemCount && itemCount > 0) {
                    ...
                    LazyGridMeasureResult m738measureLazyGridZRKPzZ8 = LazyGridMeasureKt.m738measureLazyGridZRKPzZ8(itemCount, r9, r32, i14, i9, i13, mo447roundToPx0680j_45, i10, firstVisibleItemScrollOffset, this.$state.getScrollToBeConsumed$foundation_release(), m5167offsetNN6EwU, this.$isVertical, this.$verticalArrangement, this.$horizontalArrangement, this.$reverseLayout, lazyLayoutMeasureScope, this.$state.getPlacementAnimator$foundation_release(), spanLayoutProvider, LazyLayoutBeyondBoundsStateKt.calculateLazyLayoutPinnedIndices(lazyGridItemProvider, this.$state.getPinnedItems$foundation_release(), this.$state.getBeyondBoundsInfo$foundation_release()), new AnonymousClass3(lazyLayoutMeasureScope, j8, i12, i11));
                    this.$state.applyMeasureResult$foundation_release(m738measureLazyGridZRKPzZ8);
                    return m738measureLazyGridZRKPzZ8;
                }
                ...
                createNonObservableSnapshot.restoreCurrent(makeCurrent);
                createNonObservableSnapshot.dispose();
                LazyGridMeasureResult m738measureLazyGridZRKPzZ82 = LazyGridMeasureKt.m738measureLazyGridZRKPzZ8(itemCount, r9, r32, i14, i9, i13, mo447roundToPx0680j_45, i10, firstVisibleItemScrollOffset, this.$state.getScrollToBeConsumed$foundation_release(), m5167offsetNN6EwU, this.$isVertical, this.$verticalArrangement, this.$horizontalArrangement, this.$reverseLayout, lazyLayoutMeasureScope, this.$state.getPlacementAnimator$foundation_release(), spanLayoutProvider, LazyLayoutBeyondBoundsStateKt.calculateLazyLayoutPinnedIndices(lazyGridItemProvider, this.$state.getPinnedItems$foundation_release(), this.$state.getBeyondBoundsInfo$foundation_release()), new AnonymousClass3(lazyLayoutMeasureScope, j8, i12, i11));
                this.$state.applyMeasureResult$foundation_release(m738measureLazyGridZRKPzZ82);
                return m738measureLazyGridZRKPzZ82;
            } catch (Throwable th) {
                createNonObservableSnapshot.restoreCurrent(makeCurrent);
                throw th;
            }
