...
public final class LazyStaggeredGridMeasureContext {
    ...
    public final long m780getConstraintsmsEJaDk() {
        return this.constraints;
    }

    /* renamed from: getContentOffset-nOcc-ac, reason: not valid java name */
    public final long m781getContentOffsetnOccac() {
    ...
    public final int m782getLaneInfoSZVOQXA(long j8) {
        int i8 = (int) (j8 >> 32);
    ...
    public final long m783getSpanRangelOCCd4c(LazyStaggeredGridItemProvider getSpanRange, int i8, int i9) {
        int i10;
        AbstractC3255y.i(getSpanRange, "$this$getSpanRange");
        ...
        return SpanRange.m796constructorimpl(i9, i10);
    }
    ...
    public final boolean isFullSpan(LazyStaggeredGridItemProvider lazyStaggeredGridItemProvider, int i8) {
        AbstractC3255y.i(lazyStaggeredGridItemProvider, "<this>");
    ...
    public final boolean m784isFullSpanSZVOQXA(long j8) {
