...
public interface StaggeredGridCells {
    ...
    public static final class Adaptive implements StaggeredGridCells {
        ...
        public int[] calculateCrossAxisCellSizes(Density density, int i8, int i9) {
            ...
            calculateCellsCrossAxisSizeImpl = LazyStaggeredGridCellsKt.calculateCellsCrossAxisSizeImpl(i8, Math.max((i8 + i9) / (density.mo447roundToPx0680j_4(this.minSize) + i9), 1), i9);
        ...
        public int[] calculateCrossAxisCellSizes(Density density, int i8, int i9) {
            ...
            if (i10 < i11) {
                ...
                for (int i13 = 0; i13 < i12; i13++) {
                    iArr[i13] = mo447roundToPx0680j_4;
                }
                return iArr;
            }
            return new int[]{i8};
