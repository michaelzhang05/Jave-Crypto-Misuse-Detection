...
public final class LazySaveableStateHolderKt {
    ...
    public static final void LazySaveableStateHolderProvider(InterfaceC1669o content, Composer composer, int i8) {
        int i9;
        int i10;
        ...
        if ((i9 & 11) == 2 && startRestartGroup.getSkipping()) {
            ...
            LazySaveableStateHolder lazySaveableStateHolder = (LazySaveableStateHolder) RememberSaveableKt.m2588rememberSaveable(new Object[]{saveableStateRegistry}, (Saver) LazySaveableStateHolder.Companion.saver(saveableStateRegistry), (String) null, (Function0) new LazySaveableStateHolderKt$LazySaveableStateHolderProvider$holder$1(saveableStateRegistry), startRestartGroup, 72, 4);
