...
public final class LazyStaggeredGridDslKt$itemsIndexed$10 extends AbstractC3256z implements InterfaceC1670p {
    final /* synthetic */ InterfaceC1671q $itemContent;
    final /* synthetic */ T[] $items;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public LazyStaggeredGridDslKt$itemsIndexed$10(InterfaceC1671q interfaceC1671q, T[] tArr) {
        super(4);
    ...
    public final void invoke(LazyStaggeredGridItemScope items, int i8, Composer composer, int i9) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-804487775, i10, -1, "androidx.compose.foundation.lazy.staggeredgrid.itemsIndexed.<anonymous> (LazyStaggeredGridDsl.kt:453)");
        }
