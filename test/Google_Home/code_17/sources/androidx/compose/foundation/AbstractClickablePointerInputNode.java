...
public abstract class AbstractClickablePointerInputNode extends DelegatingNode implements ModifierLocalModifierNode, CompositionLocalConsumerModifierNode, PointerInputModifierNode {
    ...
    public /* synthetic */ AbstractClickablePointerInputNode(boolean z8, MutableInteractionSource mutableInteractionSource, Function0 function0, AbstractClickableNode.InteractionData interactionData, AbstractC3247p abstractC3247p) {
    ...
    public final Object m275handlePressInteractiond4ec7I(PressGestureScope pressGestureScope, long j8, d dVar) {
        Object m316access$handlePressInteractionEPk0efs;
        MutableInteractionSource mutableInteractionSource = this.interactionSource;
        if (mutableInteractionSource != null && (m316access$handlePressInteractionEPk0efs = ClickableKt.m316access$handlePressInteractionEPk0efs(pressGestureScope, j8, mutableInteractionSource, this.interactionData, this.delayPressInteraction, dVar)) == T5.b.e()) {
            return m316access$handlePressInteractionEPk0efs;
        }
        return I.f8278a;
    }
