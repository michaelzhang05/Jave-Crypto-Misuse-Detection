...
public interface PageSize {
    ...
    public static final class Fixed implements PageSize {
        ...
        public /* synthetic */ Fixed(float f8, AbstractC3247p abstractC3247p) {
            this(f8);
        }
        ...
        public int calculateMainAxisPageSize(Density density, int i8, int i9) {
            AbstractC3255y.i(density, "<this>");
            return density.mo447roundToPx0680j_4(this.pageSize);
        }

        /* renamed from: getPageSize-D9Ej5fM, reason: not valid java name */
        public final float m811getPageSizeD9Ej5fM() {
