...
public final class PagerState$targetPage$2 extends AbstractC3256z implements Function0 {
    ...
    public final Integer invoke() {
        ...
        if (this.this$0.isScrollInProgress()) {
            ...
            if (animationTargetPage != -1) {
                ...
                d8 = AbstractC2055a.d(snapRemainingScrollOffset$foundation_release / pageAvailableSpace) + this.this$0.getCurrentPage();
            }
        } else {
            d8 = this.this$0.getCurrentPage();
        }
