...
public abstract class PagerState implements ScrollableState {
    ...
    private final void cancelPrefetchIfVisibleItemsChanged(PagerLayoutInfo pagerLayoutInfo) {
        ...
        if (this.indexToPrefetch != -1 && (!pagerLayoutInfo.getVisiblePagesInfo().isEmpty())) {
            if (this.wasScrollingForward) {
                index = ((PageInfo) AbstractC1378t.y0(pagerLayoutInfo.getVisiblePagesInfo())).getIndex() + 1;
            } else {
                index = ((PageInfo) AbstractC1378t.m0(pagerLayoutInfo.getVisiblePagesInfo())).getIndex() - 1;
            }
    ...
    public final float getPositionThresholdFraction() {
        return Math.min(this.density.mo453toPx0680j_4(PagerStateKt.getDefaultPositionThreshold()), getPageSize$foundation_release() / 2.0f) / getPageSize$foundation_release();
    }
    ...
    private final void notifyPrefetch(float f8) {
        ...
        if (!layoutInfo$foundation_release.getVisiblePagesInfo().isEmpty()) {
            ...
            if (z8) {
                index = ((PageInfo) AbstractC1378t.y0(layoutInfo$foundation_release.getVisiblePagesInfo())).getIndex() + 1;
            } else {
                index = ((PageInfo) AbstractC1378t.m0(layoutInfo$foundation_release.getVisiblePagesInfo())).getIndex() - 1;
            }
            if (index != this.indexToPrefetch && index >= 0 && index < layoutInfo$foundation_release.getPagesCount()) {
                ...
                this.currentPrefetchHandle = this.prefetchState.m762schedulePrefetch0kLqBqw(index, this.premeasureConstraints);
            }
        }
    }
    ...
    */
    public static /* synthetic */ java.lang.Object scroll$suspendImpl(androidx.compose.foundation.pager.PagerState r5, androidx.compose.foundation.MutatePriority r6, a6.InterfaceC1668n r7, S5.d r8) {
        /*
        ...
        L6a:
            ...
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.pager.PagerState.scroll$suspendImpl(androidx.compose.foundation.pager.PagerState, androidx.compose.foundation.MutatePriority, a6.n, S5.d):java.lang.Object");
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final java.lang.Object animateScrollToPage(int r11, float r12, androidx.compose.animation.core.AnimationSpec<java.lang.Float> r13, S5.d r14) {
        /*
            Method dump skipped, instructions count: 363
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.pager.PagerState.animateScrollToPage(int, float, androidx.compose.animation.core.AnimationSpec, S5.d):java.lang.Object");
    }
    ...
    public final long m823getPremeasureConstraintsmsEJaDk$foundation_release() {
    ...
    public final long m824getUpDownDifferenceF1C5BW0$foundation_release() {
        return ((Offset) this.upDownDifference$delegate.getValue()).m2750unboximpl();
    }
    ...
    @Override // androidx.compose.foundation.gestures.ScrollableState
    public Object scroll(MutatePriority mutatePriority, InterfaceC1668n interfaceC1668n, d dVar) {
        return scroll$suspendImpl(this, mutatePriority, interfaceC1668n, dVar);
    }
    ...
    public final void m825setPremeasureConstraintsBRTryo0$foundation_release(long j8) {
    ...
    public final void m826setUpDownDifferencek4lQ0M$foundation_release(long j8) {
        this.upDownDifference$delegate.setValue(Offset.m2729boximpl(j8));
    }
    ...
    public PagerState(int i8, float f8) {
        ...
        double d8 = f8;
        if (-0.5d <= d8 && d8 <= 0.5d) {
            mutableStateOf$default = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Offset.m2729boximpl(Offset.Companion.m2756getZeroF1C5BW0()), null, 2, null);
    ...
    public /* synthetic */ PagerState(int i8, float f8, int i9, AbstractC3247p abstractC3247p) {
