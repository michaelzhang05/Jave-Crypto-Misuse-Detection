...
public final class ScrollingLogic {
    ...
    public ScrollingLogic(Orientation orientation, boolean z8, State<NestedScrollDispatcher> nestedScrollDispatcher, ScrollableState scrollableState, FlingBehavior flingBehavior, OverscrollEffect overscrollEffect) {
        ...
        AbstractC3255y.i(nestedScrollDispatcher, "nestedScrollDispatcher");
        AbstractC3255y.i(scrollableState, "scrollableState");
        AbstractC3255y.i(flingBehavior, "flingBehavior");
    ...
    public final long m464dispatchScroll3eAAhYA(ScrollScope dispatchScroll, long j8, int i8) {
        AbstractC3255y.i(dispatchScroll, "$this$dispatchScroll");
        long m469singleAxisOffsetMKHz9U = m469singleAxisOffsetMKHz9U(j8);
        ...
        if (this.overscrollEffect != null && getShouldDispatchOverscroll()) {
            return this.overscrollEffect.mo282applyToScrollRhakbz0(m469singleAxisOffsetMKHz9U, i8, scrollingLogic$dispatchScroll$performScroll$1);
        }
        return ((Offset) scrollingLogic$dispatchScroll$performScroll$1.invoke(Offset.m2729boximpl(m469singleAxisOffsetMKHz9U))).m2750unboximpl();
    }
    ...
    */
    public final java.lang.Object m465doFlingAnimationQWom1Mo(long r12, S5.d r14) {
        /*
            r11 = this;
        ...
        L5b:
            r12 = r14
        L5c:
            long r12 = r12.f34161a
            androidx.compose.ui.unit.Velocity r12 = androidx.compose.ui.unit.Velocity.m5405boximpl(r12)
            return r12
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.gestures.ScrollingLogic.m465doFlingAnimationQWom1Mo(long, S5.d):java.lang.Object");
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final java.lang.Object m466onDragStoppedsFctU(long r6, S5.d r8) {
        /*
            r5 = this;
        ...
        L39:
            ...
            long r6 = r5.m470singleAxisVelocityAH228Gc(r6)
            ...
            r0.L$0 = r5
            r0.label = r4
            java.lang.Object r6 = r2.mo281applyToFlingBMRW4eQ(r6, r8, r0)
            if (r6 != r1) goto L60
            return r1
        L60:
            r6 = r5
            goto L71
        L62:
            androidx.compose.ui.unit.Velocity r6 = androidx.compose.ui.unit.Velocity.m5405boximpl(r6)
            r0.L$0 = r5
            r0.label = r3
        ...
        L71:
            ...
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.gestures.ScrollingLogic.m466onDragStoppedsFctU(long, S5.d):java.lang.Object");
    }

    /* renamed from: performRawScroll-MK-Hz9U, reason: not valid java name */
    public final long m467performRawScrollMKHz9U(long j8) {
        if (this.scrollableState.isScrollInProgress()) {
            return Offset.Companion.m2756getZeroF1C5BW0();
        }
        return m473toOffsettuRUvjQ(reverseIfNeeded(this.scrollableState.dispatchRawDelta(reverseIfNeeded(m472toFloatk4lQ0M(j8)))));
    }
    ...
    public final long m468reverseIfNeededMKHz9U(long j8) {
        if (this.reverseDirection) {
            return Offset.m2747timestuRUvjQ(j8, -1.0f);
        }
        return j8;
    }
    ...
    public final long m469singleAxisOffsetMKHz9U(long j8) {
    ...
    public final long m470singleAxisVelocityAH228Gc(long j8) {
        if (this.orientation == Orientation.Horizontal) {
    ...
    public final float m471toFloatTH1AsA0(long j8) {
        if (this.orientation == Orientation.Horizontal) {
    ...
    public final float m472toFloatk4lQ0M(long j8) {
        if (this.orientation == Orientation.Horizontal) {
    ...
    public final long m473toOffsettuRUvjQ(float f8) {
        if (f8 == 0.0f) {
            return Offset.Companion.m2756getZeroF1C5BW0();
        }
        if (this.orientation == Orientation.Horizontal) {
    ...
    public final long m474updateQWom1Mo(long j8, float f8) {
        if (this.orientation == Orientation.Horizontal) {
            return Velocity.m5410copyOhffZ5M$default(j8, f8, 0.0f, 2, null);
        }
        return Velocity.m5410copyOhffZ5M$default(j8, 0.0f, f8, 1, null);
    }
}
