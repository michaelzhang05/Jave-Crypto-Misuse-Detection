...
public final class UpdatableAnimationState$animateToZero$3 extends AbstractC3256z implements Function1 {
    ...
    public final void invoke(long j8) {
        ...
        if (this.$durationScale == 0.0f) {
            ...
            f8 = AbstractC2055a.f(((float) (j8 - j10)) / this.$durationScale);
        }
        long j11 = f8;
