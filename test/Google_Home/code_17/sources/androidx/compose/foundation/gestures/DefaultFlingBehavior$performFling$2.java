...
final class DefaultFlingBehavior$performFling$2 extends l implements InterfaceC1668n {
    ...
    public static final class AnonymousClass1 extends AbstractC3256z implements Function1 {
        ...
        public final void invoke(AnimationScope<Float, AnimationVector1D> animateDecay) {
            ...
            this.$velocityLeft.f34159a = animateDecay.getVelocity().floatValue();
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public DefaultFlingBehavior$performFling$2(float f8, DefaultFlingBehavior defaultFlingBehavior, ScrollScope scrollScope, S5.d dVar) {
        super(2, dVar);
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i8 != 0) {
            ...
            if (Math.abs(this.$initialVelocity) > 1.0f) {
                P p9 = new P();
                p9.f34159a = this.$initialVelocity;
                P p10 = new P();
    ...
    public final Object invoke(M m8, S5.d dVar) {
        return ((DefaultFlingBehavior$performFling$2) create(m8, dVar)).invokeSuspend(I.f8278a);
    }
}
