...
final class TransformableStateKt$animatePanBy$2 extends l implements InterfaceC1668n {
    ...
    public static final class AnonymousClass1 extends AbstractC3256z implements Function1 {
        ...
        public final void invoke(AnimationScope<Offset, AnimationVector2D> animateTo) {
            ...
            d.a(this.$$this$transform, 0.0f, Offset.m2744minusMKHz9U(animateTo.getValue().m2750unboximpl(), this.$previous.f34161a), 0.0f, 5, null);
            this.$previous.f34161a = animateTo.getValue().m2750unboximpl();
        }
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public TransformableStateKt$animatePanBy$2(S s8, long j8, AnimationSpec<Offset> animationSpec, S5.d dVar) {
        super(2, dVar);
        this.$previous = s8;
        this.$offset = j8;
    ...
    public final Object invoke(TransformScope transformScope, S5.d dVar) {
        return ((TransformableStateKt$animatePanBy$2) create(transformScope, dVar)).invokeSuspend(I.f8278a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i8 != 0) {
            ...
            AnimationState animationState = new AnimationState(VectorConvertersKt.getVectorConverter(Offset.Companion), Offset.m2729boximpl(this.$previous.f34161a), null, 0L, 0L, false, 60, null);
            Offset m2729boximpl = Offset.m2729boximpl(this.$offset);
            ...
            this.label = 1;
            if (SuspendAnimationKt.animateTo$default(animationState, m2729boximpl, animationSpec, false, anonymousClass1, this, 4, null) == e8) {
                return e8;
            }
        }
        return I.f8278a;
