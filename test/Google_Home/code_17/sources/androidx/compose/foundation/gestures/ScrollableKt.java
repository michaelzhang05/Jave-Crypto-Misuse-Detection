...
public final class ScrollableKt {
    ...
    private static final InterfaceC1669o NoOpOnDragStarted = new ScrollableKt$NoOpOnDragStarted$1(null);
    ...
    */
    public static final java.lang.Object awaitScrollEvent(androidx.compose.ui.input.pointer.AwaitPointerEventScope r5, S5.d r6) {
        /*
        ...
        L44:
            ...
            int r4 = r4.m3979getScroll7fucELk()
            boolean r2 = androidx.compose.ui.input.pointer.PointerEventType.m3970equalsimpl0(r2, r4)
            if (r2 == 0) goto L38
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.gestures.ScrollableKt.awaitScrollEvent(androidx.compose.ui.input.pointer.AwaitPointerEventScope, S5.d):java.lang.Object");
    }
    ...
    public static final Modifier pointerScrollable(Modifier modifier, MutableInteractionSource mutableInteractionSource, Orientation orientation, boolean z8, ScrollableState scrollableState, FlingBehavior flingBehavior, OverscrollEffect overscrollEffect, boolean z9, Composer composer, int i8) {
        ...
        InterfaceC1669o interfaceC1669o = NoOpOnDragStarted;
        ...
        composer.endReplaceableGroup();
        Modifier nestedScroll = NestedScrollModifierKt.nestedScroll(modifier.then(new DraggableElement(scrollDraggableState, scrollableKt$pointerScrollable$1, orientation, z9, mutableInteractionSource, function0, interfaceC1669o, (InterfaceC1669o) rememberedValue5, false)).then(new MouseWheelScrollElement(rememberUpdatedState, platformScrollConfig)), nestedScrollConnection, (NestedScrollDispatcher) mutableState.getValue());
        if (ComposerKt.isTraceInProgress()) {
