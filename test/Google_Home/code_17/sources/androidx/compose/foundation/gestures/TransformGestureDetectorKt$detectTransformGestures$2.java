...
public final class TransformGestureDetectorKt$detectTransformGestures$2 extends k implements InterfaceC1668n {
    final /* synthetic */ InterfaceC1670p $onGesture;
    ...
    public TransformGestureDetectorKt$detectTransformGestures$2(boolean z8, InterfaceC1670p interfaceC1670p, S5.d dVar) {
        super(2, dVar);
        this.$panZoomLock = z8;
        this.$onGesture = interfaceC1670p;
    }
    ...
    public final Object invoke(AwaitPointerEventScope awaitPointerEventScope, S5.d dVar) {
        return ((TransformGestureDetectorKt$detectTransformGestures$2) create(awaitPointerEventScope, dVar)).invokeSuspend(I.f8278a);
    }

    /* JADX WARN: Code restructure failed: missing block: B:32:0x0142, code lost:
    
        if (androidx.compose.ui.geometry.Offset.m2737equalsimpl0(r11, androidx.compose.ui.geometry.Offset.Companion.m2756getZeroF1C5BW0()) == false) goto L56;
     */
