...
final class ScrollExtensionsKt$stopScroll$2 extends l implements InterfaceC1668n {
    int label;

    /* JADX INFO: Access modifiers changed from: package-private */
    public ScrollExtensionsKt$stopScroll$2(S5.d dVar) {
        super(2, dVar);
    }
    ...
    public final Object invoke(ScrollScope scrollScope, S5.d dVar) {
        return ((ScrollExtensionsKt$stopScroll$2) create(scrollScope, dVar)).invokeSuspend(I.f8278a);
    }
