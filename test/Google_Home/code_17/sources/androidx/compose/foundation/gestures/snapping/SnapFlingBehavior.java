...
public final class SnapFlingBehavior implements FlingBehavior {
    ...
    public /* synthetic */ SnapFlingBehavior(SnapLayoutInfoProvider snapLayoutInfoProvider, AnimationSpec animationSpec, DecayAnimationSpec decayAnimationSpec, AnimationSpec animationSpec2, Density density, float f8, AbstractC3247p abstractC3247p) {
    ...
    */
    public final java.lang.Object fling(androidx.compose.foundation.gestures.ScrollScope r11, float r12, kotlin.jvm.functions.Function1 r13, S5.d r14) {
        /*
            r10 = this;
        ...
        L51:
            ...
            return r14
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.gestures.snapping.SnapFlingBehavior.fling(androidx.compose.foundation.gestures.ScrollScope, float, kotlin.jvm.functions.Function1, S5.d):java.lang.Object");
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final java.lang.Object longSnap(androidx.compose.foundation.gestures.ScrollScope r26, float r27, kotlin.jvm.functions.Function1 r28, S5.d r29) {
        /*
            Method dump skipped, instructions count: 217
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.gestures.snapping.SnapFlingBehavior.longSnap(androidx.compose.foundation.gestures.ScrollScope, float, kotlin.jvm.functions.Function1, S5.d):java.lang.Object");
    }
    ...
    public final Object shortSnap(ScrollScope scrollScope, float f8, Function1 function1, d dVar) {
        ...
        P p8 = new P();
        p8.f34159a = calculateSnappingOffset;
    ...
    public boolean equals(Object obj) {
        ...
        if (!AbstractC3255y.d(snapFlingBehavior.snapAnimationSpec, this.snapAnimationSpec) || !AbstractC3255y.d(snapFlingBehavior.highVelocityAnimationSpec, this.highVelocityAnimationSpec) || !AbstractC3255y.d(snapFlingBehavior.lowVelocityAnimationSpec, this.lowVelocityAnimationSpec) || !AbstractC3255y.d(snapFlingBehavior.snapLayoutInfoProvider, this.snapLayoutInfoProvider) || !AbstractC3255y.d(snapFlingBehavior.density, this.density) || !Dp.m5188equalsimpl0(snapFlingBehavior.shortSnapVelocityThreshold, this.shortSnapVelocityThreshold)) {
            return false;
        }
        return true;
    }
    ...
    public int hashCode() {
        return (((((((((this.snapAnimationSpec.hashCode() * 31) + this.highVelocityAnimationSpec.hashCode()) * 31) + this.lowVelocityAnimationSpec.hashCode()) * 31) + this.snapLayoutInfoProvider.hashCode()) * 31) + this.density.hashCode()) * 31) + Dp.m5189hashCodeimpl(this.shortSnapVelocityThreshold);
    }
    ...
    public final void setMotionScaleDuration$foundation_release(MotionDurationScale motionDurationScale) {
        AbstractC3255y.i(motionDurationScale, "<set-?>");
    ...
    private SnapFlingBehavior(SnapLayoutInfoProvider snapLayoutInfoProvider, AnimationSpec<Float> lowVelocityAnimationSpec, DecayAnimationSpec<Float> highVelocityAnimationSpec, AnimationSpec<Float> snapAnimationSpec, Density density, float f8) {
        ...
        AbstractC3255y.i(lowVelocityAnimationSpec, "lowVelocityAnimationSpec");
        AbstractC3255y.i(highVelocityAnimationSpec, "highVelocityAnimationSpec");
        AbstractC3255y.i(snapAnimationSpec, "snapAnimationSpec");
        ...
        this.velocityThreshold = density.mo453toPx0680j_4(f8);
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final java.lang.Object performFling(androidx.compose.foundation.gestures.ScrollScope r5, float r6, kotlin.jvm.functions.Function1 r7, S5.d r8) {
        /*
            r4 = this;
        ...
        L5d:
            ...
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.gestures.snapping.SnapFlingBehavior.performFling(androidx.compose.foundation.gestures.ScrollScope, float, kotlin.jvm.functions.Function1, S5.d):java.lang.Object");
    }

    public /* synthetic */ SnapFlingBehavior(SnapLayoutInfoProvider snapLayoutInfoProvider, AnimationSpec animationSpec, DecayAnimationSpec decayAnimationSpec, AnimationSpec animationSpec2, Density density, float f8, int i8, AbstractC3247p abstractC3247p) {
