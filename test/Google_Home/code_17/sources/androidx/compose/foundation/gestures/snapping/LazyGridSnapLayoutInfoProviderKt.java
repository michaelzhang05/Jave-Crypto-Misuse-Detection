...
public final class LazyGridSnapLayoutInfoProviderKt {
    ...
    public static final SnapLayoutInfoProvider SnapLayoutInfoProvider(final LazyGridState lazyGridState, final SnapPositionInLayout positionInLayout) {
        AbstractC3255y.i(lazyGridState, "lazyGridState");
        AbstractC3255y.i(positionInLayout, "positionInLayout");
            ...
            public float calculateSnapStepSize(Density density) {
                ...
                if (!getSingleAxisItems().isEmpty()) {
                    ...
                    if (getLayoutInfo().getOrientation() == Orientation.Vertical) {
                        ...
                        i8 = 0;
                        while (i9 < size) {
                            i8 += IntSize.m5348getHeightimpl(singleAxisItems.get(i9).mo736getSizeYbymL2g());
                            i9++;
                        }
                    } else {
                        ...
                        i8 = 0;
                        while (i9 < size2) {
                            i8 += IntSize.m5349getWidthimpl(singleAxisItems2.get(i9).mo736getSizeYbymL2g());
                            i9++;
                        }
                    }
    ...
    public static final int getSingleAxisViewportSize(LazyGridLayoutInfo lazyGridLayoutInfo) {
        AbstractC3255y.i(lazyGridLayoutInfo, "<this>");
        if (lazyGridLayoutInfo.getOrientation() == Orientation.Vertical) {
            return IntSize.m5348getHeightimpl(lazyGridLayoutInfo.mo717getViewportSizeYbymL2g());
        }
        return IntSize.m5349getWidthimpl(lazyGridLayoutInfo.mo717getViewportSizeYbymL2g());
    }

    public static final int offsetOnMainAxis(LazyGridItemInfo lazyGridItemInfo, Orientation orientation) {
        AbstractC3255y.i(lazyGridItemInfo, "<this>");
        AbstractC3255y.i(orientation, "orientation");
        if (orientation == Orientation.Vertical) {
            return IntOffset.m5308getYimpl(lazyGridItemInfo.mo735getOffsetnOccac());
        }
        return IntOffset.m5307getXimpl(lazyGridItemInfo.mo735getOffsetnOccac());
    }
    ...
    public static final int sizeOnMainAxis(LazyGridItemInfo lazyGridItemInfo, Orientation orientation) {
        ...
        AbstractC3255y.i(orientation, "orientation");
        if (orientation == Orientation.Vertical) {
            return IntSize.m5348getHeightimpl(lazyGridItemInfo.mo736getSizeYbymL2g());
        }
        return IntSize.m5349getWidthimpl(lazyGridItemInfo.mo736getSizeYbymL2g());
    }
}
