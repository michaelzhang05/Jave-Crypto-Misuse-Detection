...
public final class DraggableElement extends ModifierNodeElement<DraggableNode> {
    ...
    private final InterfaceC1669o onDragStarted;
    private final InterfaceC1669o onDragStopped;
    private final Orientation orientation;
    private final boolean reverseDirection;
    private final Function0 startDragImmediately;
    private final DraggableState state;

    public DraggableElement(DraggableState state, Function1 canDrag, Orientation orientation, boolean z8, MutableInteractionSource mutableInteractionSource, Function0 startDragImmediately, InterfaceC1669o onDragStarted, InterfaceC1669o onDragStopped, boolean z9) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!AbstractC3255y.d(DraggableElement.class, cls)) {
            return false;
        }
        AbstractC3255y.g(obj, "null cannot be cast to non-null type androidx.compose.foundation.gestures.DraggableElement");
        DraggableElement draggableElement = (DraggableElement) obj;
        if (AbstractC3255y.d(this.state, draggableElement.state) && AbstractC3255y.d(this.canDrag, draggableElement.canDrag) && this.orientation == draggableElement.orientation && this.enabled == draggableElement.enabled && AbstractC3255y.d(this.interactionSource, draggableElement.interactionSource) && AbstractC3255y.d(this.startDragImmediately, draggableElement.startDragImmediately) && AbstractC3255y.d(this.onDragStarted, draggableElement.onDragStarted) && AbstractC3255y.d(this.onDragStopped, draggableElement.onDragStopped) && this.reverseDirection == draggableElement.reverseDirection) {
            return true;
        }
        return false;
    }
