...
final class DefaultDebugIndication implements Indication {
    ...
    private static final class DefaultDebugIndicationInstance implements IndicationInstance {
        ...
        public DefaultDebugIndicationInstance(State<Boolean> isPressed, State<Boolean> isHovered, State<Boolean> isFocused) {
            AbstractC3255y.i(isPressed, "isPressed");
            AbstractC3255y.i(isHovered, "isHovered");
            AbstractC3255y.i(isFocused, "isFocused");
        ...
        public void drawIndication(ContentDrawScope contentDrawScope) {
            ...
            if (this.isPressed.getValue().booleanValue()) {
                androidx.compose.ui.graphics.drawscope.c.K(contentDrawScope, Color.m2975copywmQWz5c$default(Color.Companion.m3002getBlack0d7_KjU(), 0.3f, 0.0f, 0.0f, 0.0f, 14, null), 0L, contentDrawScope.mo3419getSizeNHjbRc(), 0.0f, null, null, 0, 122, null);
            } else if (this.isHovered.getValue().booleanValue() || this.isFocused.getValue().booleanValue()) {
                androidx.compose.ui.graphics.drawscope.c.K(contentDrawScope, Color.m2975copywmQWz5c$default(Color.Companion.m3002getBlack0d7_KjU(), 0.1f, 0.0f, 0.0f, 0.0f, 14, null), 0L, contentDrawScope.mo3419getSizeNHjbRc(), 0.0f, null, null, 0, 122, null);
            }
        }
    }
