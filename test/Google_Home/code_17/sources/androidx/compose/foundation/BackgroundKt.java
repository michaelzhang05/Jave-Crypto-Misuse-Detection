...
public final class BackgroundKt {
    ...
    public static final Modifier m286backgroundbw27NRU(Modifier background, long j8, Shape shape) {
        Function1 noInspectorInfo;
        AbstractC3255y.i(background, "$this$background");
        AbstractC3255y.i(shape, "shape");
        if (InspectableValueKt.isDebugInspectorInfoEnabled()) {
    ...
    public static /* synthetic */ Modifier m287backgroundbw27NRU$default(Modifier modifier, long j8, Shape shape, int i8, Object obj) {
        if ((i8 & 2) != 0) {
            shape = RectangleShapeKt.getRectangleShape();
        }
        return m286backgroundbw27NRU(modifier, j8, shape);
    }
}
