...
public final class BasicMarqueeKt {
    ...
    private static final float DefaultMarqueeVelocity = Dp.m5183constructorimpl(30);

    @ExperimentalFoundationApi
    /* renamed from: MarqueeSpacing-0680j_4, reason: not valid java name */
    public static final MarqueeSpacing m290MarqueeSpacing0680j_4(final float f8) {
        return new MarqueeSpacing() { // from class: androidx.compose.foundation.BasicMarqueeKt$MarqueeSpacing$1
            ...
            public final int calculateSpacing(Density MarqueeSpacing, int i8, int i9) {
                AbstractC3255y.i(MarqueeSpacing, "$this$MarqueeSpacing");
                return MarqueeSpacing.mo447roundToPx0680j_4(f8);
            }
        };
    }
    ...
    public static final Modifier m292basicMarquee1Mj1MLw(Modifier basicMarquee, int i8, int i9, int i10, int i11, MarqueeSpacing spacing, float f8) {
        AbstractC3255y.i(basicMarquee, "$this$basicMarquee");
    ...
    public static /* synthetic */ Modifier m293basicMarquee1Mj1MLw$default(Modifier modifier, int i8, int i9, int i10, int i11, MarqueeSpacing marqueeSpacing, float f8, int i12, Object obj) {
        if ((i12 & 1) != 0) {
            i8 = DefaultMarqueeIterations;
        }
        if ((i12 & 2) != 0) {
            i9 = MarqueeAnimationMode.Companion.m361getImmediatelyZbEOnfQ();
        }
        int i13 = i9;
        if ((i12 & 4) != 0) {
        ...
        int i14 = i10;
        if ((i12 & 8) != 0) {
            if (MarqueeAnimationMode.m355equalsimpl0(i13, MarqueeAnimationMode.Companion.m361getImmediatelyZbEOnfQ())) {
                i11 = i14;
            } else {
                i11 = 0;
            }
        ...
        return m292basicMarquee1Mj1MLw(modifier, i8, i13, i14, i15, marqueeSpacing2, f8);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: createMarqueeAnimationSpec-Z4HSEVQ, reason: not valid java name */
    public static final AnimationSpec<Float> m294createMarqueeAnimationSpecZ4HSEVQ(int i8, float f8, int i9, int i10, float f9, Density density) {
        TweenSpec<Float> velocityBasedTween = velocityBasedTween(Math.abs(density.mo453toPx0680j_4(f9)), f8, i10);
        long m237constructorimpl$default = StartOffset.m237constructorimpl$default((-i10) + i9, 0, 2, null);
        if (i8 == Integer.MAX_VALUE) {
            return AnimationSpecKt.m216infiniteRepeatable9IiC70o$default(velocityBasedTween, null, m237constructorimpl$default, 2, null);
        }
        return AnimationSpecKt.m218repeatable91I0pcU$default(i8, velocityBasedTween, null, m237constructorimpl$default, 4, null);
    }
