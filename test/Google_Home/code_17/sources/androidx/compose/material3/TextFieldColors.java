...
public final class TextFieldColors {
    ...
    private static final boolean m1845indicatorColor$lambda2(State<Boolean> state) {
        return state.getValue().booleanValue();
    }

    /* renamed from: labelColor$lambda-3, reason: not valid java name */
    private static final boolean m1846labelColor$lambda3(State<Boolean> state) {
        return state.getValue().booleanValue();
    }

    /* renamed from: leadingIconColor$lambda-0, reason: not valid java name */
    private static final boolean m1847leadingIconColor$lambda0(State<Boolean> state) {
        return state.getValue().booleanValue();
    }

    /* renamed from: supportingTextColor$lambda-4, reason: not valid java name */
    private static final boolean m1848supportingTextColor$lambda4(State<Boolean> state) {
        return state.getValue().booleanValue();
    }

    /* renamed from: trailingIconColor$lambda-1, reason: not valid java name */
    private static final boolean m1849trailingIconColor$lambda1(State<Boolean> state) {
        return state.getValue().booleanValue();
    }
    ...
    public final State<Color> containerColor$material3_release(Composer composer, int i8) {
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m2966boximpl(this.containerColor), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final State<Color> cursorColor$material3_release(boolean z8, Composer composer, int i8) {
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m2966boximpl(j8), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public boolean equals(Object obj) {
        ...
        if (Color.m2977equalsimpl0(this.textColor, textFieldColors.textColor) && Color.m2977equalsimpl0(this.disabledTextColor, textFieldColors.disabledTextColor) && Color.m2977equalsimpl0(this.cursorColor, textFieldColors.cursorColor) && Color.m2977equalsimpl0(this.errorCursorColor, textFieldColors.errorCursorColor) && AbstractC3255y.d(this.textSelectionColors, textFieldColors.textSelectionColors) && Color.m2977equalsimpl0(this.focusedIndicatorColor, textFieldColors.focusedIndicatorColor) && Color.m2977equalsimpl0(this.unfocusedIndicatorColor, textFieldColors.unfocusedIndicatorColor) && Color.m2977equalsimpl0(this.errorIndicatorColor, textFieldColors.errorIndicatorColor) && Color.m2977equalsimpl0(this.disabledIndicatorColor, textFieldColors.disabledIndicatorColor) && Color.m2977equalsimpl0(this.focusedLeadingIconColor, textFieldColors.focusedLeadingIconColor) && Color.m2977equalsimpl0(this.unfocusedLeadingIconColor, textFieldColors.unfocusedLeadingIconColor) && Color.m2977equalsimpl0(this.disabledLeadingIconColor, textFieldColors.disabledLeadingIconColor) && Color.m2977equalsimpl0(this.errorLeadingIconColor, textFieldColors.errorLeadingIconColor) && Color.m2977equalsimpl0(this.focusedTrailingIconColor, textFieldColors.focusedTrailingIconColor) && Color.m2977equalsimpl0(this.unfocusedTrailingIconColor, textFieldColors.unfocusedTrailingIconColor) && Color.m2977equalsimpl0(this.disabledTrailingIconColor, textFieldColors.disabledTrailingIconColor) && Color.m2977equalsimpl0(this.errorTrailingIconColor, textFieldColors.errorTrailingIconColor) && Color.m2977equalsimpl0(this.containerColor, textFieldColors.containerColor) && Color.m2977equalsimpl0(this.focusedLabelColor, textFieldColors.focusedLabelColor) && Color.m2977equalsimpl0(this.unfocusedLabelColor, textFieldColors.unfocusedLabelColor) && Color.m2977equalsimpl0(this.disabledLabelColor, textFieldColors.disabledLabelColor) && Color.m2977equalsimpl0(this.errorLabelColor, textFieldColors.errorLabelColor) && Color.m2977equalsimpl0(this.placeholderColor, textFieldColors.placeholderColor) && Color.m2977equalsimpl0(this.disabledPlaceholderColor, textFieldColors.disabledPlaceholderColor) && Color.m2977equalsimpl0(this.focusedSupportingTextColor, textFieldColors.focusedSupportingTextColor) && Color.m2977equalsimpl0(this.unfocusedSupportingTextColor, textFieldColors.unfocusedSupportingTextColor) && Color.m2977equalsimpl0(this.disabledSupportingTextColor, textFieldColors.disabledSupportingTextColor) && Color.m2977equalsimpl0(this.errorSupportingTextColor, textFieldColors.errorSupportingTextColor)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (((((((((((((((((((((((((((((((((((((((((((((((((((((Color.m2983hashCodeimpl(this.textColor) * 31) + Color.m2983hashCodeimpl(this.disabledTextColor)) * 31) + Color.m2983hashCodeimpl(this.cursorColor)) * 31) + Color.m2983hashCodeimpl(this.errorCursorColor)) * 31) + this.textSelectionColors.hashCode()) * 31) + Color.m2983hashCodeimpl(this.focusedIndicatorColor)) * 31) + Color.m2983hashCodeimpl(this.unfocusedIndicatorColor)) * 31) + Color.m2983hashCodeimpl(this.errorIndicatorColor)) * 31) + Color.m2983hashCodeimpl(this.disabledIndicatorColor)) * 31) + Color.m2983hashCodeimpl(this.focusedLeadingIconColor)) * 31) + Color.m2983hashCodeimpl(this.unfocusedLeadingIconColor)) * 31) + Color.m2983hashCodeimpl(this.disabledLeadingIconColor)) * 31) + Color.m2983hashCodeimpl(this.errorLeadingIconColor)) * 31) + Color.m2983hashCodeimpl(this.focusedTrailingIconColor)) * 31) + Color.m2983hashCodeimpl(this.unfocusedTrailingIconColor)) * 31) + Color.m2983hashCodeimpl(this.disabledTrailingIconColor)) * 31) + Color.m2983hashCodeimpl(this.errorTrailingIconColor)) * 31) + Color.m2983hashCodeimpl(this.containerColor)) * 31) + Color.m2983hashCodeimpl(this.focusedLabelColor)) * 31) + Color.m2983hashCodeimpl(this.unfocusedLabelColor)) * 31) + Color.m2983hashCodeimpl(this.disabledLabelColor)) * 31) + Color.m2983hashCodeimpl(this.errorLabelColor)) * 31) + Color.m2983hashCodeimpl(this.placeholderColor)) * 31) + Color.m2983hashCodeimpl(this.disabledPlaceholderColor)) * 31) + Color.m2983hashCodeimpl(this.focusedSupportingTextColor)) * 31) + Color.m2983hashCodeimpl(this.unfocusedSupportingTextColor)) * 31) + Color.m2983hashCodeimpl(this.disabledSupportingTextColor)) * 31) + Color.m2983hashCodeimpl(this.errorSupportingTextColor);
    }
    ...
    public final State<Color> indicatorColor$material3_release(boolean z8, boolean z9, InteractionSource interactionSource, Composer composer, int i8) {
        ...
        } else if (m1845indicatorColor$lambda2(collectIsFocusedAsState)) {
        ...
        if (z8) {
            ...
            rememberUpdatedState = SingleValueAnimationKt.m191animateColorAsStateKTwxG1Y(j9, AnimationSpecKt.tween$default(150, 0, null, 6, null), null, composer, 48, 4);
            composer.endReplaceableGroup();
        } else {
            composer.startReplaceableGroup(715731095);
            rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m2966boximpl(j9), composer, 0);
            composer.endReplaceableGroup();
        }
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
    ...
    public final State<Color> labelColor$material3_release(boolean z8, boolean z9, InteractionSource interactionSource, Composer composer, int i8) {
        ...
        } else if (m1846labelColor$lambda3(collectIsFocusedAsState)) {
    ...
    public final State<Color> leadingIconColor$material3_release(boolean z8, boolean z9, InteractionSource interactionSource, Composer composer, int i8) {
        ...
        } else if (m1847leadingIconColor$lambda0(collectIsFocusedAsState)) {
    ...
    public final State<Color> supportingTextColor$material3_release(boolean z8, boolean z9, InteractionSource interactionSource, Composer composer, int i8) {
        ...
        } else if (m1848supportingTextColor$lambda4(collectIsFocusedAsState)) {
    ...
    public final State<Color> trailingIconColor$material3_release(boolean z8, boolean z9, InteractionSource interactionSource, Composer composer, int i8) {
        ...
        } else if (m1849trailingIconColor$lambda1(collectIsFocusedAsState)) {
