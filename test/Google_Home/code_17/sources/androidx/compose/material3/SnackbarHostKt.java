...
public final class SnackbarHostKt {
    ...
    */
    public static final void FadeInFadeOutWithScale(androidx.compose.material3.SnackbarData r16, androidx.compose.ui.Modifier r17, a6.InterfaceC1669o r18, androidx.compose.runtime.Composer r19, int r20, int r21) {
        /*
            Method dump skipped, instructions count: 574
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.SnackbarHostKt.FadeInFadeOutWithScale(androidx.compose.material3.SnackbarData, androidx.compose.ui.Modifier, a6.o, androidx.compose.runtime.Composer, int, int):void");
    }

    @Composable
    @ComposableInferredTarget(scheme = "[androidx.compose.ui.UiComposable[androidx.compose.ui.UiComposable]]")
    public static final void SnackbarHost(SnackbarHostState hostState, Modifier modifier, InterfaceC1669o interfaceC1669o, Composer composer, int i8, int i9) {
        int i10;
        int i11;
        int i12;
        int i13;
        AbstractC3255y.i(hostState, "hostState");
        ...
        if ((i10 & 731) == 146 && startRestartGroup.getSkipping()) {
            ...
            if (i15 != 0) {
                interfaceC1669o = ComposableSingletons$SnackbarHostKt.INSTANCE.m1594getLambda1$material3_release();
            }
            ...
            FadeInFadeOutWithScale(hostState.getCurrentSnackbarData(), modifier, interfaceC1669o, startRestartGroup, i10 & PointerIconCompat.TYPE_TEXT, 0);
            if (ComposerKt.isTraceInProgress()) {
        ...
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new SnackbarHostKt$SnackbarHost$2(hostState, modifier2, interfaceC1669o2, i8, i9));
        }
    }
    ...
    public static final long toMillis(SnackbarDuration snackbarDuration, boolean z8, AccessibilityManager accessibilityManager) {
        long j8;
        AbstractC3255y.i(snackbarDuration, "<this>");
