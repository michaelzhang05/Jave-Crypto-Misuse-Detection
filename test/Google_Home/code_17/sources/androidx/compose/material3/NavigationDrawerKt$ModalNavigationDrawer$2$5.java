...
public final class NavigationDrawerKt$ModalNavigationDrawer$2$5 extends AbstractC3256z implements Function1 {
    ...
    public static final class AnonymousClass1 extends AbstractC3256z implements Function0 {
        ...
        /* loaded from: classes.dex */
        public static final class C03361 extends l implements InterfaceC1668n {
            final /* synthetic */ DrawerState $drawerState;
            int label;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C03361(DrawerState drawerState, d dVar) {
                super(2, dVar);
            ...
            public final d create(Object obj, d dVar) {
                return new C03361(this.$drawerState, dVar);
            }
            ...
            public final Object invoke(M m8, d dVar) {
                return ((C03361) create(m8, dVar)).invokeSuspend(I.f8278a);
            }
        }
        ...
        public final Boolean invoke() {
            if (((Boolean) this.$drawerState.getSwipeableState$material3_release().getConfirmStateChange$material3_release().invoke(DrawerValue.Closed)).booleanValue()) {
                AbstractC3364k.d(this.$scope, null, null, new C03361(this.$drawerState, null), 3, null);
            }
            return Boolean.TRUE;
        }
    }
