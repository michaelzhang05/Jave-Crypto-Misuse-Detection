...
public final class ChipColors {
    ...
    public /* synthetic */ ChipColors(long j8, long j9, long j10, long j11, long j12, long j13, long j14, long j15, AbstractC3247p abstractC3247p) {
    ...
    public boolean equals(Object obj) {
        ...
        if (Color.m2977equalsimpl0(this.containerColor, chipColors.containerColor) && Color.m2977equalsimpl0(this.labelColor, chipColors.labelColor) && Color.m2977equalsimpl0(this.leadingIconContentColor, chipColors.leadingIconContentColor) && Color.m2977equalsimpl0(this.trailingIconContentColor, chipColors.trailingIconContentColor) && Color.m2977equalsimpl0(this.disabledContainerColor, chipColors.disabledContainerColor) && Color.m2977equalsimpl0(this.disabledLabelColor, chipColors.disabledLabelColor) && Color.m2977equalsimpl0(this.disabledLeadingIconContentColor, chipColors.disabledLeadingIconContentColor) && Color.m2977equalsimpl0(this.disabledTrailingIconContentColor, chipColors.disabledTrailingIconContentColor)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (((((((((((((Color.m2983hashCodeimpl(this.containerColor) * 31) + Color.m2983hashCodeimpl(this.labelColor)) * 31) + Color.m2983hashCodeimpl(this.leadingIconContentColor)) * 31) + Color.m2983hashCodeimpl(this.trailingIconContentColor)) * 31) + Color.m2983hashCodeimpl(this.disabledContainerColor)) * 31) + Color.m2983hashCodeimpl(this.disabledLabelColor)) * 31) + Color.m2983hashCodeimpl(this.disabledLeadingIconContentColor)) * 31) + Color.m2983hashCodeimpl(this.disabledTrailingIconContentColor);
    }
