...
public final class CardElevation {
    ...
    public /* synthetic */ CardElevation(float f8, float f9, float f10, float f11, float f12, float f13, AbstractC3247p abstractC3247p) {
    ...
    private final State<Dp> animateElevation(boolean z8, InteractionSource interactionSource, Composer composer, int i8) {
        ...
        EffectsKt.LaunchedEffect(Dp.m5181boximpl(f9), new CardElevation$animateElevation$2(z8, animatable, this, f9, interaction, null), composer, 64);
    ...
    public boolean equals(Object obj) {
        ...
        if (Dp.m5188equalsimpl0(this.defaultElevation, cardElevation.defaultElevation) && Dp.m5188equalsimpl0(this.pressedElevation, cardElevation.pressedElevation) && Dp.m5188equalsimpl0(this.focusedElevation, cardElevation.focusedElevation) && Dp.m5188equalsimpl0(this.hoveredElevation, cardElevation.hoveredElevation) && Dp.m5188equalsimpl0(this.disabledElevation, cardElevation.disabledElevation)) {
            return true;
        }
        return false;
    }
    ...
    public final State<Dp> shadowElevation$material3_release(boolean z8, InteractionSource interactionSource, Composer composer, int i8) {
        ...
        if (interactionSource == null) {
            ...
            if (rememberedValue == Composer.Companion.getEmpty()) {
                rememberedValue = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Dp.m5181boximpl(this.defaultElevation), null, 2, null);
                composer.updateRememberedValue(rememberedValue);
            }
            composer.endReplaceableGroup();
