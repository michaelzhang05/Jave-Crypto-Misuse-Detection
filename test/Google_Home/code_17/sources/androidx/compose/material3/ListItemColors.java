...
public final class ListItemColors {
    ...
    public /* synthetic */ ListItemColors(long j8, long j9, long j10, long j11, long j12, long j13, long j14, long j15, long j16, AbstractC3247p abstractC3247p) {
    ...
    public final State<Color> overlineColor$material3_release(Composer composer, int i8) {
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m2966boximpl(this.overlineColor), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final State<Color> supportingColor$material3_release(Composer composer, int i8) {
        ...
        State<Color> rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m2966boximpl(this.supportingTextColor), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
