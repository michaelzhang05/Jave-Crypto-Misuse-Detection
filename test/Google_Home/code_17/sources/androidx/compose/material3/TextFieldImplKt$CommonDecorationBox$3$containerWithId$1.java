...
public final class TextFieldImplKt$CommonDecorationBox$3$containerWithId$1 extends AbstractC3256z implements InterfaceC1668n {
    final /* synthetic */ int $$dirty1;
    final /* synthetic */ InterfaceC1668n $container;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public TextFieldImplKt$CommonDecorationBox$3$containerWithId$1(InterfaceC1668n interfaceC1668n, int i8) {
        super(2);
        this.$container = interfaceC1668n;
        this.$$dirty1 = i8;
    }
    ...
    public final void invoke(Composer composer, int i8) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1566950173, i8, -1, "androidx.compose.material3.CommonDecorationBox.<anonymous>.<anonymous> (TextFieldImpl.kt:170)");
        }
        Modifier layoutId = LayoutIdKt.layoutId(Modifier.Companion, TextFieldImplKt.ContainerId);
        InterfaceC1668n interfaceC1668n = this.$container;
        int i9 = this.$$dirty1;
        ...
        InterfaceC1669o materializerOf = LayoutKt.materializerOf(layoutId);
        ...
        interfaceC1668n.invoke(composer, Integer.valueOf((i9 >> 15) & 14));
