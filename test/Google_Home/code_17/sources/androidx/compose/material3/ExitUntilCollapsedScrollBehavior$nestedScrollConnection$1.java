...
public final class ExitUntilCollapsedScrollBehavior$nestedScrollConnection$1 implements NestedScrollConnection {
    ...
    */
    public java.lang.Object mo460onPostFlingRZ2iAVY(long r10, long r12, S5.d r14) {
        /*
            r9 = this;
        ...
        L55:
            ...
            float r12 = androidx.compose.ui.unit.Velocity.m5415getYimpl(r12)
        ...
        L80:
            androidx.compose.ui.unit.Velocity r14 = (androidx.compose.ui.unit.Velocity) r14
            long r12 = r14.m5423unboximpl()
            long r10 = androidx.compose.ui.unit.Velocity.m5418plusAH228Gc(r10, r12)
            androidx.compose.ui.unit.Velocity r10 = androidx.compose.ui.unit.Velocity.m5405boximpl(r10)
            return r10
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.ExitUntilCollapsedScrollBehavior$nestedScrollConnection$1.mo460onPostFlingRZ2iAVY(long, long, S5.d):java.lang.Object");
    }
    ...
    public long mo461onPostScrollDzOQY0M(long j8, long j9, int i8) {
        ...
        state.setContentOffset(state.getContentOffset() + Offset.m2741getYimpl(j8));
        if (Offset.m2741getYimpl(j9) >= 0.0f && Offset.m2741getYimpl(j8) >= 0.0f) {
            if (Offset.m2741getYimpl(j8) == 0.0f && Offset.m2741getYimpl(j9) > 0.0f) {
                this.this$0.getState().setContentOffset(0.0f);
            }
            if (Offset.m2741getYimpl(j9) > 0.0f) {
                float heightOffset = this.this$0.getState().getHeightOffset();
                this.this$0.getState().setHeightOffset(this.this$0.getState().getHeightOffset() + Offset.m2741getYimpl(j9));
        ...
        this.this$0.getState().setHeightOffset(this.this$0.getState().getHeightOffset() + Offset.m2741getYimpl(j8));
    ...
    public long mo463onPreScrollOzD1aCk(long j8, int i8) {
        if (((Boolean) this.this$0.getCanScroll().invoke()).booleanValue() && Offset.m2741getYimpl(j8) <= 0.0f) {
            float heightOffset = this.this$0.getState().getHeightOffset();
            this.this$0.getState().setHeightOffset(this.this$0.getState().getHeightOffset() + Offset.m2741getYimpl(j8));
