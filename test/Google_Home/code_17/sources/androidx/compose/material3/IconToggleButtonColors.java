...
public final class IconToggleButtonColors {
    ...
    public /* synthetic */ IconToggleButtonColors(long j8, long j9, long j10, long j11, long j12, long j13, AbstractC3247p abstractC3247p) {
    ...
    public boolean equals(Object obj) {
        ...
        if (Color.m2977equalsimpl0(this.containerColor, iconToggleButtonColors.containerColor) && Color.m2977equalsimpl0(this.contentColor, iconToggleButtonColors.contentColor) && Color.m2977equalsimpl0(this.disabledContainerColor, iconToggleButtonColors.disabledContainerColor) && Color.m2977equalsimpl0(this.disabledContentColor, iconToggleButtonColors.disabledContentColor) && Color.m2977equalsimpl0(this.checkedContainerColor, iconToggleButtonColors.checkedContainerColor) && Color.m2977equalsimpl0(this.checkedContentColor, iconToggleButtonColors.checkedContentColor)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (((((((((Color.m2983hashCodeimpl(this.containerColor) * 31) + Color.m2983hashCodeimpl(this.contentColor)) * 31) + Color.m2983hashCodeimpl(this.disabledContainerColor)) * 31) + Color.m2983hashCodeimpl(this.disabledContentColor)) * 31) + Color.m2983hashCodeimpl(this.checkedContainerColor)) * 31) + Color.m2983hashCodeimpl(this.checkedContentColor);
    }
