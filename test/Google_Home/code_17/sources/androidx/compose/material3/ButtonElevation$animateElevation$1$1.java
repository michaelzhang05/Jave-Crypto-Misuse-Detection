...
final class ButtonElevation$animateElevation$1$1 extends l implements InterfaceC1668n {
    ...
    public ButtonElevation$animateElevation$1$1(InteractionSource interactionSource, SnapshotStateList<Interaction> snapshotStateList, d dVar) {
        super(2, dVar);
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i8 != 0) {
            ...
            InterfaceC3707g interfaceC3707g = new InterfaceC3707g() { // from class: androidx.compose.material3.ButtonElevation$animateElevation$1$1.1
    ...
    public final Object invoke(M m8, d dVar) {
        return ((ButtonElevation$animateElevation$1$1) create(m8, dVar)).invokeSuspend(I.f8278a);
    }
}
