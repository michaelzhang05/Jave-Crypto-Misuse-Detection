...
public final class NavigationBarItemColors {
    ...
    public /* synthetic */ NavigationBarItemColors(long j8, long j9, long j10, long j11, long j12, AbstractC3247p abstractC3247p) {
    ...
    public boolean equals(Object obj) {
        ...
        if (Color.m2977equalsimpl0(this.selectedIconColor, navigationBarItemColors.selectedIconColor) && Color.m2977equalsimpl0(this.unselectedIconColor, navigationBarItemColors.unselectedIconColor) && Color.m2977equalsimpl0(this.selectedTextColor, navigationBarItemColors.selectedTextColor) && Color.m2977equalsimpl0(this.unselectedTextColor, navigationBarItemColors.unselectedTextColor) && Color.m2977equalsimpl0(this.selectedIndicatorColor, navigationBarItemColors.selectedIndicatorColor)) {
            return true;
        }
        return false;
    }
    ...
    public final long m1701getIndicatorColor0d7_KjU$material3_release() {
        return this.selectedIndicatorColor;
    }

    public int hashCode() {
        return (((((((Color.m2983hashCodeimpl(this.selectedIconColor) * 31) + Color.m2983hashCodeimpl(this.unselectedIconColor)) * 31) + Color.m2983hashCodeimpl(this.selectedTextColor)) * 31) + Color.m2983hashCodeimpl(this.unselectedTextColor)) * 31) + Color.m2983hashCodeimpl(this.selectedIndicatorColor);
    }
    ...
    public final State<Color> iconColor$material3_release(boolean z8, Composer composer, int i8) {
        ...
        State<Color> m191animateColorAsStateKTwxG1Y = SingleValueAnimationKt.m191animateColorAsStateKTwxG1Y(j8, AnimationSpecKt.tween$default(100, 0, null, 6, null), null, composer, 48, 4);
        if (ComposerKt.isTraceInProgress()) {
