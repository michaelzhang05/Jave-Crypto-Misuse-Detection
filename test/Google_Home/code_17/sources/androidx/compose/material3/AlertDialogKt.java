...
public final class AlertDialogKt {
    ...
    private static final float MaxWidth = Dp.m5183constructorimpl(560);

    static {
        float f8 = 24;
        DialogPadding = PaddingKt.m598PaddingValues0680j_4(Dp.m5183constructorimpl(f8));
        float f9 = 16;
        IconPadding = PaddingKt.m602PaddingValuesa9UjIt4$default(0.0f, 0.0f, 0.0f, Dp.m5183constructorimpl(f9), 7, null);
        TitlePadding = PaddingKt.m602PaddingValuesa9UjIt4$default(0.0f, 0.0f, 0.0f, Dp.m5183constructorimpl(f9), 7, null);
        TextPadding = PaddingKt.m602PaddingValuesa9UjIt4$default(0.0f, 0.0f, 0.0f, Dp.m5183constructorimpl(f8), 7, null);
    }
    ...
    */
    public static final void m1456AlertDialogContent4hvqGtA(a6.InterfaceC1668n r23, androidx.compose.ui.Modifier r24, a6.InterfaceC1668n r25, a6.InterfaceC1668n r26, a6.InterfaceC1668n r27, androidx.compose.ui.graphics.Shape r28, long r29, float r31, long r32, long r34, long r36, long r38, androidx.compose.runtime.Composer r40, int r41, int r42, int r43) {
        /*
            Method dump skipped, instructions count: 573
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.AlertDialogKt.m1456AlertDialogContent4hvqGtA(a6.n, androidx.compose.ui.Modifier, a6.n, a6.n, a6.n, androidx.compose.ui.graphics.Shape, long, float, long, long, long, long, androidx.compose.runtime.Composer, int, int, int):void");
    }

    @Composable
    @ComposableInferredTarget(scheme = "[androidx.compose.ui.UiComposable[androidx.compose.ui.UiComposable]]")
    /* renamed from: AlertDialogFlowRow-ixp7dh8, reason: not valid java name */
    public static final void m1457AlertDialogFlowRowixp7dh8(final float f8, final float f9, InterfaceC1668n content, Composer composer, int i8) {
        int i9;
        int i10;
        int i11;
        int i12;
        ...
        if ((i9 & 731) == 146 && startRestartGroup.getSkipping()) {
            ...
            MeasurePolicy measurePolicy = new MeasurePolicy() { // from class: androidx.compose.material3.AlertDialogKt$AlertDialogFlowRow$1
                ...
                private static final void measure_3p2s80s$startNewSequence(List<List<Placeable>> list, Q q8, MeasureScope measureScope, float f10, List<Placeable> list2, List<Integer> list3, Q q9, List<Integer> list4, Q q10, Q q11) {
                    ...
                    list5.add(AbstractC1378t.W0(list2));
                ...
                public final MeasureResult mo137measure3p2s80s(MeasureScope Layout, List<? extends Measurable> measurables, long j8) {
                    ...
                    while (it.hasNext()) {
                        Placeable mo4136measureBRTryo0 = it.next().mo4136measureBRTryo0(j8);
                        Q q14 = q13;
                    ...
                    int max = Math.max(q10.f34160a, Constraints.m5153getMinWidthimpl(j8));
                    return MeasureScope.CC.q(Layout, max, Math.max(q16.f34160a, Constraints.m5152getMinHeightimpl(j8)), null, new AlertDialogKt$AlertDialogFlowRow$1$measure$1(arrayList2, Layout, f8, max, arrayList4), 4, null);
                }
