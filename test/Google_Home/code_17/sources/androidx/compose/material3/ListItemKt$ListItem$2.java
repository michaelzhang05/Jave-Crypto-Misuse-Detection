...
public final class ListItemKt$ListItem$2 extends AbstractC3256z implements InterfaceC1669o {
    ...
    public ListItemKt$ListItem$2(InterfaceC1668n interfaceC1668n, ListItemColors listItemColors, int i8, InterfaceC1668n interfaceC1668n2, InterfaceC1668n interfaceC1668n3, InterfaceC1668n interfaceC1668n4) {
        super(3);
        ...
        this.$supportingText = interfaceC1668n4;
    }
    ...
    public final void invoke(RowScope ListItem, Composer composer, int i8) {
        ...
        InterfaceC1668n interfaceC1668n3 = this.$supportingText;
        ...
        long m2986unboximpl = listItemColors.headlineColor$material3_release(true, composer, ((i10 >> 15) & 112) | 6).getValue().m2986unboximpl();
        ListTokens listTokens = ListTokens.INSTANCE;
        ListItemKt.m1687ProvideTextStyleFromToken3JVO9M(m2986unboximpl, listTokens.getListItemLabelTextFont(), interfaceC1668n2, composer, ((i10 << 6) & 896) | 48);
        long m2986unboximpl2 = listItemColors.supportingColor$material3_release(composer, (i10 >> 18) & 14).getValue().m2986unboximpl();
        TypographyKeyTokens listItemSupportingTextFont = listTokens.getListItemSupportingTextFont();
        AbstractC3255y.f(interfaceC1668n3);
        ListItemKt.m1687ProvideTextStyleFromToken3JVO9M(m2986unboximpl2, listItemSupportingTextFont, interfaceC1668n3, composer, 48);
        composer.endReplaceableGroup();
        composer.endReplaceableGroup();
        composer.endReplaceableGroup();
        composer.endNode();
        ...
        composer.endReplaceableGroup();
        composer.endReplaceableGroup();
        InterfaceC1668n interfaceC1668n4 = this.$trailingContent;
        if (interfaceC1668n4 != null) {
            m1693trailingContentiJQMabo = ListItemKt.m1693trailingContentiJQMabo(interfaceC1668n4, this.$colors.trailingIconColor$material3_release(true, composer, ((this.$$dirty >> 15) & 112) | 6).getValue().m2986unboximpl(), false, composer, ((this.$$dirty >> 15) & 14) | 384);
