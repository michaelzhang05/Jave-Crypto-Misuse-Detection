...
public final class BottomAppBarDefaults {
    ...
    private static final float ContainerElevation = BottomAppBarTokens.INSTANCE.m1978getContainerElevationD9Ej5fM();
    ...
    static {
        ...
        ContentPadding = PaddingKt.m602PaddingValuesa9UjIt4$default(f8, bottomAppBarVerticalPadding, f9, 0.0f, 8, null);
    }
    ...
    public final float m1478getContainerElevationD9Ej5fM() {
    ...
    public final WindowInsets getWindowInsets(Composer composer, int i8) {
        ...
        WindowInsets m678onlybOOhFvg = WindowInsetsKt.m678onlybOOhFvg(systemBarsForVisualComponents, WindowInsetsSides.m688plusgK_yJZ4(companion.m698getHorizontalJoeWqyM(), companion.m696getBottomJoeWqyM()));
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
