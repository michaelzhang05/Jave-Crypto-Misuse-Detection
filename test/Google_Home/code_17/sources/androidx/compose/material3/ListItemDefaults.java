...
public final class ListItemDefaults {
    ...
    private static final float Elevation = ListTokens.INSTANCE.m2208getListItemContainerElevationD9Ej5fM();
    ...
    public final ListItemColors m1683colorsJ08w3E(long j8, long j9, long j10, long j11, long j12, long j13, long j14, long j15, long j16, Composer composer, int i8, int i9) {
        long j17;
        long j18;
        long j19;
        long j20;
        ...
        if ((i9 & 64) != 0) {
            j23 = Color.m2975copywmQWz5c$default(ColorSchemeKt.toColor(ListTokens.INSTANCE.getListItemDisabledLabelTextColor(), composer, 6), 0.3f, 0.0f, 0.0f, 0.0f, 14, null);
        } else {
            j23 = j14;
        }
        if ((i9 & 128) != 0) {
            j24 = Color.m2975copywmQWz5c$default(ColorSchemeKt.toColor(ListTokens.INSTANCE.getListItemDisabledLeadingIconColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, null);
        } else {
            j24 = j15;
        }
        if ((i9 & 256) != 0) {
            j25 = Color.m2975copywmQWz5c$default(ColorSchemeKt.toColor(ListTokens.INSTANCE.getListItemDisabledTrailingIconColor(), composer, 6), 0.38f, 0.0f, 0.0f, 0.0f, 14, null);
        } else {
            j25 = j16;
        }
    ...
    public final float m1684getElevationD9Ej5fM() {
        return Elevation;
    }
