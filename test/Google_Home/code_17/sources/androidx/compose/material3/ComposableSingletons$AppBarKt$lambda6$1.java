...
final class ComposableSingletons$AppBarKt$lambda6$1 extends AbstractC3256z implements InterfaceC1669o {
    ...
    public final void invoke(RowScope rowScope, Composer composer, int i8) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(319435933, i8, -1, "androidx.compose.material3.ComposableSingletons$AppBarKt.lambda-6.<anonymous> (AppBar.kt:227)");
        }
        if (ComposerKt.isTraceInProgress()) {
