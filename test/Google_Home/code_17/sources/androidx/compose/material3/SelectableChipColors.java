...
public final class SelectableChipColors {
    ...
    public /* synthetic */ SelectableChipColors(long j8, long j9, long j10, long j11, long j12, long j13, long j14, long j15, long j16, long j17, long j18, long j19, long j20, AbstractC3247p abstractC3247p) {
    ...
    public boolean equals(Object obj) {
        ...
        if (Color.m2977equalsimpl0(this.containerColor, selectableChipColors.containerColor) && Color.m2977equalsimpl0(this.labelColor, selectableChipColors.labelColor) && Color.m2977equalsimpl0(this.leadingIconColor, selectableChipColors.leadingIconColor) && Color.m2977equalsimpl0(this.trailingIconColor, selectableChipColors.trailingIconColor) && Color.m2977equalsimpl0(this.disabledContainerColor, selectableChipColors.disabledContainerColor) && Color.m2977equalsimpl0(this.disabledLabelColor, selectableChipColors.disabledLabelColor) && Color.m2977equalsimpl0(this.disabledLeadingIconColor, selectableChipColors.disabledLeadingIconColor) && Color.m2977equalsimpl0(this.disabledTrailingIconColor, selectableChipColors.disabledTrailingIconColor) && Color.m2977equalsimpl0(this.selectedContainerColor, selectableChipColors.selectedContainerColor) && Color.m2977equalsimpl0(this.disabledSelectedContainerColor, selectableChipColors.disabledSelectedContainerColor) && Color.m2977equalsimpl0(this.selectedLabelColor, selectableChipColors.selectedLabelColor) && Color.m2977equalsimpl0(this.selectedLeadingIconColor, selectableChipColors.selectedLeadingIconColor) && Color.m2977equalsimpl0(this.selectedTrailingIconColor, selectableChipColors.selectedTrailingIconColor)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (((((((((((((((((((((((Color.m2983hashCodeimpl(this.containerColor) * 31) + Color.m2983hashCodeimpl(this.labelColor)) * 31) + Color.m2983hashCodeimpl(this.leadingIconColor)) * 31) + Color.m2983hashCodeimpl(this.trailingIconColor)) * 31) + Color.m2983hashCodeimpl(this.disabledContainerColor)) * 31) + Color.m2983hashCodeimpl(this.disabledLabelColor)) * 31) + Color.m2983hashCodeimpl(this.disabledLeadingIconColor)) * 31) + Color.m2983hashCodeimpl(this.disabledTrailingIconColor)) * 31) + Color.m2983hashCodeimpl(this.selectedContainerColor)) * 31) + Color.m2983hashCodeimpl(this.disabledSelectedContainerColor)) * 31) + Color.m2983hashCodeimpl(this.selectedLabelColor)) * 31) + Color.m2983hashCodeimpl(this.selectedLeadingIconColor)) * 31) + Color.m2983hashCodeimpl(this.selectedTrailingIconColor);
    }
