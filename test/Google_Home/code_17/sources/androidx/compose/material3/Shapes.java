...
public final class Shapes {
    ...
    public final Shapes copy(CornerBasedShape extraSmall, CornerBasedShape small, CornerBasedShape medium, CornerBasedShape large, CornerBasedShape extraLarge) {
        AbstractC3255y.i(extraSmall, "extraSmall");
        AbstractC3255y.i(small, "small");
        AbstractC3255y.i(medium, "medium");
        AbstractC3255y.i(large, "large");
        AbstractC3255y.i(extraLarge, "extraLarge");
    ...
    public boolean equals(Object obj) {
        ...
        if (AbstractC3255y.d(this.extraSmall, shapes.extraSmall) && AbstractC3255y.d(this.small, shapes.small) && AbstractC3255y.d(this.medium, shapes.medium) && AbstractC3255y.d(this.large, shapes.large) && AbstractC3255y.d(this.extraLarge, shapes.extraLarge)) {
            return true;
        }
        return false;
    }
    ...
    public /* synthetic */ Shapes(CornerBasedShape cornerBasedShape, CornerBasedShape cornerBasedShape2, CornerBasedShape cornerBasedShape3, CornerBasedShape cornerBasedShape4, CornerBasedShape cornerBasedShape5, int i8, AbstractC3247p abstractC3247p) {
