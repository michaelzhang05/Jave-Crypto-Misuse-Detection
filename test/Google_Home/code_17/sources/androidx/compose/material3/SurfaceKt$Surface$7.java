...
public final class SurfaceKt$Surface$7 extends AbstractC3256z implements InterfaceC1668n {
    ...
    public SurfaceKt$Surface$7(Modifier modifier, Shape shape, long j8, float f8, int i8, BorderStroke borderStroke, float f9, boolean z8, MutableInteractionSource mutableInteractionSource, boolean z9, Function1 function1, InterfaceC1668n interfaceC1668n, int i9) {
        super(2);
    ...
    public final void invoke(Composer composer, int i8) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(712720927, i8, -1, "androidx.compose.material3.Surface.<anonymous> (Surface.kt:442)");
        }
        Modifier minimumTouchTargetSize = TouchTargetKt.minimumTouchTargetSize(this.$modifier);
        Shape shape = this.$shape;
        m1815surfaceColorAtElevationCLU3JFs = SurfaceKt.m1815surfaceColorAtElevationCLU3JFs(this.$color, this.$absoluteElevation, composer, (this.$$changed >> 15) & 14);
        ...
        Modifier m831toggleableO2vRcR0 = ToggleableKt.m831toggleableO2vRcR0(m1814surface8ww4TTg, this.$checked, this.$interactionSource, RippleKt.m1449rememberRipple9IZ8Weo(false, 0.0f, 0L, composer, 0, 7), this.$enabled, Role.m4521boximpl(Role.Companion.m4533getSwitcho7Vup1c()), this.$onCheckedChange);
        ...
        InterfaceC1669o materializerOf = LayoutKt.materializerOf(m831toggleableO2vRcR0);
        ...
        composer.startReplaceableGroup(-1621564071);
