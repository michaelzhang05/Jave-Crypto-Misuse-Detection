...
public final class TouchTargetKt$minimumTouchTargetSize$2 extends AbstractC3256z implements InterfaceC1669o {
    ...
    public final Modifier invoke(Modifier composed, Composer composer, int i8) {
        ...
        if (((Boolean) composer.consume(TouchTargetKt.getLocalMinimumTouchTargetEnforcement())).booleanValue()) {
            modifier = new MinimumTouchTargetModifier(((ViewConfiguration) composer.consume(CompositionLocalsKt.getLocalViewConfiguration())).mo4261getMinimumTouchTargetSizeMYxV2XQ(), null);
        } else {
