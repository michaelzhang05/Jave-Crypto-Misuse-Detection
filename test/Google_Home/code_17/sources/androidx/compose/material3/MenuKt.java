...
public final class MenuKt {
    ...
    private static final float MenuVerticalMargin = Dp.m5183constructorimpl(48);
    private static final float DropdownMenuItemHorizontalPadding = Dp.m5183constructorimpl(12);
    private static final float DropdownMenuVerticalPadding = Dp.m5183constructorimpl(8);
    private static final float DropdownMenuItemDefaultMinWidth = Dp.m5183constructorimpl(112);
    private static final float DropdownMenuItemDefaultMaxWidth = Dp.m5183constructorimpl(280);
    ...
    */
    public static final void DropdownMenuContent(androidx.compose.animation.core.MutableTransitionState<java.lang.Boolean> r21, androidx.compose.runtime.MutableState<androidx.compose.ui.graphics.TransformOrigin> r22, androidx.compose.ui.Modifier r23, a6.InterfaceC1669o r24, androidx.compose.runtime.Composer r25, int r26, int r27) {
        /*
            Method dump skipped, instructions count: 629
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.MenuKt.DropdownMenuContent(androidx.compose.animation.core.MutableTransitionState, androidx.compose.runtime.MutableState, androidx.compose.ui.Modifier, a6.o, androidx.compose.runtime.Composer, int, int):void");
    }

    /* renamed from: DropdownMenuContent$lambda-1 */
    public static final float m1695DropdownMenuContent$lambda1(State<Float> state) {
        return state.getValue().floatValue();
    }

    /* renamed from: DropdownMenuContent$lambda-3 */
    public static final float m1696DropdownMenuContent$lambda3(State<Float> state) {
        return state.getValue().floatValue();
    }

    @Composable
    @ComposableInferredTarget(scheme = "[androidx.compose.ui.UiComposable[androidx.compose.ui.UiComposable][androidx.compose.ui.UiComposable][androidx.compose.ui.UiComposable]]")
    public static final void DropdownMenuItemContent(InterfaceC1668n text, Function0 onClick, Modifier modifier, InterfaceC1668n interfaceC1668n, InterfaceC1668n interfaceC1668n2, boolean z8, MenuItemColors colors, PaddingValues contentPadding, MutableInteractionSource interactionSource, Composer composer, int i8) {
        int i9;
        Composer composer2;
        int i10;
        int i11;
        ...
        if ((191739611 & i19) == 38347922 && startRestartGroup.getSkipping()) {
            ...
            Modifier fillMaxWidth$default = SizeKt.fillMaxWidth$default(ClickableKt.m318clickableO2vRcR0$default(modifier, interactionSource, RippleKt.m1449rememberRipple9IZ8Weo(true, 0.0f, 0L, startRestartGroup, 6, 6), z8, null, null, onClick, 24, null), 0.0f, 1, null);
            ...
            Modifier padding = PaddingKt.padding(SizeKt.m656sizeInqDBjuR0$default(fillMaxWidth$default, f8, menuTokens.m2220getListItemContainerHeightD9Ej5fM(), f9, 0.0f, 8, null), contentPadding);
            ...
            composer2 = startRestartGroup;
            TextKt.ProvideTextStyle(TypographyKt.fromToken(MaterialTheme.INSTANCE.getTypography(startRestartGroup, 6), menuTokens.getListItemLabelTextFont()), ComposableLambdaKt.composableLambda(composer2, 1065051884, true, new MenuKt$DropdownMenuItemContent$1$1(interfaceC1668n, colors, z8, i19, interfaceC1668n2, rowScopeInstance, text)), composer2, 48);
        ...
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new MenuKt$DropdownMenuItemContent$2(text, onClick, modifier, interfaceC1668n, interfaceC1668n2, z8, colors, contentPadding, interactionSource, i8));
        }
    }
