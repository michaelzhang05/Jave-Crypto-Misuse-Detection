...
final class ComposableSingletons$AppBarKt$lambda4$1 extends AbstractC3256z implements InterfaceC1669o {
    ...
    public final void invoke(RowScope rowScope, Composer composer, int i8) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(2098467925, i8, -1, "androidx.compose.material3.ComposableSingletons$AppBarKt.lambda-4.<anonymous> (AppBar.kt:186)");
        }
        if (ComposerKt.isTraceInProgress()) {
