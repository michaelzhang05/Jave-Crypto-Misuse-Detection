...
public class FloatingActionButtonElevation {
    ...
    public /* synthetic */ FloatingActionButtonElevation(float f8, float f9, float f10, float f11, AbstractC3247p abstractC3247p) {
        this(f8, f9, f10, f11);
    }
    ...
    private final State<Dp> animateElevation(InteractionSource interactionSource, Composer composer, int i8) {
        ...
        EffectsKt.LaunchedEffect(Dp.m5181boximpl(f9), new FloatingActionButtonElevation$animateElevation$2(animatable, this, f9, interaction, null), composer, 64);
    ...
    public boolean equals(Object obj) {
        ...
        if (Dp.m5188equalsimpl0(this.defaultElevation, floatingActionButtonElevation.defaultElevation) && Dp.m5188equalsimpl0(this.pressedElevation, floatingActionButtonElevation.pressedElevation) && Dp.m5188equalsimpl0(this.focusedElevation, floatingActionButtonElevation.focusedElevation) && Dp.m5188equalsimpl0(this.hoveredElevation, floatingActionButtonElevation.hoveredElevation)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (((((Dp.m5189hashCodeimpl(this.defaultElevation) * 31) + Dp.m5189hashCodeimpl(this.pressedElevation)) * 31) + Dp.m5189hashCodeimpl(this.focusedElevation)) * 31) + Dp.m5189hashCodeimpl(this.hoveredElevation);
    }
