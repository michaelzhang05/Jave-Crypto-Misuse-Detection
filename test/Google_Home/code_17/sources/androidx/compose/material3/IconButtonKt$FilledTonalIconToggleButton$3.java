...
final class IconButtonKt$FilledTonalIconToggleButton$3 extends AbstractC3256z implements InterfaceC1668n {
    final /* synthetic */ int $$dirty;
    final /* synthetic */ InterfaceC1668n $content;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public IconButtonKt$FilledTonalIconToggleButton$3(InterfaceC1668n interfaceC1668n, int i8) {
        super(2);
    ...
    public final void invoke(Composer composer, int i8) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-58218680, i8, -1, "androidx.compose.material3.FilledTonalIconToggleButton.<anonymous> (IconButton.kt:396)");
        }
        Modifier m652size3ABfNKs = SizeKt.m652size3ABfNKs(Modifier.Companion, FilledTonalIconButtonTokens.INSTANCE.m2177getContainerSizeD9Ej5fM());
        ...
        composer.startReplaceableGroup(2083239118);
