...
public final class RadioButtonKt$RadioButton$2$1 extends AbstractC3256z implements Function1 {
    ...
    public final void invoke(DrawScope Canvas) {
        ...
        float f9 = 2;
        float f10 = mo453toPx0680j_4 / f9;
        c.x(Canvas, this.$radioColor.getValue().m2986unboximpl(), Canvas.mo453toPx0680j_4(Dp.m5183constructorimpl(RadioButtonTokens.INSTANCE.m2358getIconSizeD9Ej5fM() / f9)) - f10, 0L, 0.0f, new Stroke(mo453toPx0680j_4, 0.0f, 0, 0, null, 30, null), null, 0, 108, null);
