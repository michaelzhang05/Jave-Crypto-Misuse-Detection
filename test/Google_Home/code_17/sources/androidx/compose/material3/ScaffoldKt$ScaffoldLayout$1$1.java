...
public final class ScaffoldKt$ScaffoldLayout$1$1 extends AbstractC3256z implements InterfaceC1668n {
    ...
    public static final class AnonymousClass1 extends AbstractC3256z implements Function1 {
        ...
        AnonymousClass1(SubcomposeMeasureScope subcomposeMeasureScope, InterfaceC1668n interfaceC1668n, InterfaceC1668n interfaceC1668n2, InterfaceC1668n interfaceC1668n3, int i8, int i9, WindowInsets windowInsets, long j8, InterfaceC1668n interfaceC1668n4, int i10, InterfaceC1669o interfaceC1669o, int i11) {
            super(1);
        ...
        public final void invoke(Placeable.PlacementScope layout) {
            ...
            while (it.hasNext()) {
                arrayList.add(((Measurable) it.next()).mo4136measureBRTryo0(j8));
            }
            ...
            ArrayList arrayList2 = new ArrayList(AbstractC1378t.x(subcompose2, 10));
            Iterator<T> it3 = subcompose2.iterator();
            while (it3.hasNext()) {
                arrayList2.add(((Measurable) it3.next()).mo4136measureBRTryo0(ConstraintsKt.m5167offsetNN6EwU(j9, (-windowInsets.getLeft(subcomposeMeasureScope, subcomposeMeasureScope.getLayoutDirection())) - windowInsets.getRight(subcomposeMeasureScope, subcomposeMeasureScope.getLayoutDirection()), -windowInsets.getBottom(subcomposeMeasureScope))));
            }
            ...
            while (it6.hasNext()) {
                Placeable mo4136measureBRTryo0 = ((Measurable) it6.next()).mo4136measureBRTryo0(ConstraintsKt.m5167offsetNN6EwU(j10, (-windowInsets2.getLeft(subcomposeMeasureScope2, subcomposeMeasureScope2.getLayoutDirection())) - windowInsets2.getRight(subcomposeMeasureScope2, subcomposeMeasureScope2.getLayoutDirection()), -windowInsets2.getBottom(subcomposeMeasureScope2)));
                if (mo4136measureBRTryo0.getHeight() == 0 || mo4136measureBRTryo0.getWidth() == 0) {
                    mo4136measureBRTryo0 = null;
                }
                if (mo4136measureBRTryo0 != null) {
                    arrayList3.add(mo4136measureBRTryo0);
                }
            }
            if (!arrayList3.isEmpty()) {
                ...
                AbstractC3255y.f(next6);
                int height9 = ((Placeable) next6).getHeight();
                if (FabPosition.m1639equalsimpl0(this.$fabPosition, FabPosition.Companion.m1644getEndERTFSPs())) {
                    if (this.$this_SubcomposeLayout.getLayoutDirection() == LayoutDirection.Ltr) {
                        ...
                        i9 = (i10 - subcomposeMeasureScope3.mo447roundToPx0680j_4(f11)) - width6;
                    } else {
                        SubcomposeMeasureScope subcomposeMeasureScope4 = this.$this_SubcomposeLayout;
                        f10 = ScaffoldKt.FabSpacing;
                        i9 = subcomposeMeasureScope4.mo447roundToPx0680j_4(f10);
                    }
                } else {
            ...
            ArrayList arrayList4 = new ArrayList(AbstractC1378t.x(subcompose4, 10));
            Iterator<T> it9 = subcompose4.iterator();
            while (it9.hasNext()) {
                arrayList4.add(((Measurable) it9.next()).mo4136measureBRTryo0(j11));
            }
            ...
            if (fabPlacement != null) {
                ...
                if (valueOf == null) {
                    ...
                    mo447roundToPx0680j_4 = height12 + subcomposeMeasureScope5.mo447roundToPx0680j_4(f9) + windowInsets3.getBottom(subcomposeMeasureScope5);
                } else {
                    int intValue2 = valueOf.intValue() + fabPlacement.getHeight();
                    f8 = ScaffoldKt.FabSpacing;
                    mo447roundToPx0680j_4 = intValue2 + subcomposeMeasureScope5.mo447roundToPx0680j_4(f8);
                }
                num = Integer.valueOf(mo447roundToPx0680j_4);
            } else {
                num = null;
            }
            if (height6 != 0) {
            ...
            ArrayList arrayList5 = new ArrayList(AbstractC1378t.x(subcompose5, 10));
            Iterator<T> it11 = subcompose5.iterator();
            while (it11.hasNext()) {
                arrayList5.add(((Measurable) it11.next()).mo4136measureBRTryo0(j12));
            }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ScaffoldKt$ScaffoldLayout$1$1(InterfaceC1668n interfaceC1668n, InterfaceC1668n interfaceC1668n2, InterfaceC1668n interfaceC1668n3, int i8, WindowInsets windowInsets, InterfaceC1668n interfaceC1668n4, int i9, InterfaceC1669o interfaceC1669o) {
        super(2);
        this.$topBar = interfaceC1668n;
        this.$snackbar = interfaceC1668n2;
        this.$fab = interfaceC1668n3;
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object obj, Object obj2) {
        return m1761invoke0kLqBqw((SubcomposeMeasureScope) obj, ((Constraints) obj2).m5157unboximpl());
    }

    /* renamed from: invoke-0kLqBqw, reason: not valid java name */
    public final MeasureResult m1761invoke0kLqBqw(SubcomposeMeasureScope SubcomposeLayout, long j8) {
