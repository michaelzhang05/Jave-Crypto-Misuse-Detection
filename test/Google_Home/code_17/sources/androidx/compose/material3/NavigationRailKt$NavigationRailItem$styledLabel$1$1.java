...
public final class NavigationRailKt$NavigationRailItem$styledLabel$1$1 extends AbstractC3256z implements InterfaceC1668n {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public NavigationRailKt$NavigationRailItem$styledLabel$1$1(NavigationRailItemColors navigationRailItemColors, boolean z8, int i8, InterfaceC1668n interfaceC1668n) {
        super(2);
    ...
    private static final long m1737invoke$lambda0(State<Color> state) {
    ...
    public final void invoke(Composer composer, int i8) {
        ...
        int i9 = this.$$dirty;
        CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m2966boximpl(m1737invoke$lambda0(navigationRailItemColors.textColor$material3_release(z8, composer, ((i9 >> 18) & 112) | (i9 & 14)))))}, ComposableLambdaKt.composableLambda(composer, -288191647, true, new AnonymousClass1(fromToken, this.$label, this.$$dirty)), composer, 56);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
    }
