...
final class ListItemKt$ListItem$6 extends AbstractC3256z implements InterfaceC1668n {
    ...
    public ListItemKt$ListItem$6(float f8, PaddingValues paddingValues, InterfaceC1669o interfaceC1669o, int i8) {
        super(2);
        this.$minHeight = f8;
    ...
    public final void invoke(Composer composer, int i8) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1393735016, i8, -1, "androidx.compose.material3.ListItem.<anonymous> (ListItem.kt:298)");
        }
        Modifier padding = PaddingKt.padding(SizeKt.m640heightInVpY3zN4$default(Modifier.Companion, this.$minHeight, 0.0f, 2, null), this.$paddingValues);
