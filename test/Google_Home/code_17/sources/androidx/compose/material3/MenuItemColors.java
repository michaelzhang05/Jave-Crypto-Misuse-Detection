...
public final class MenuItemColors {
    ...
    public /* synthetic */ MenuItemColors(long j8, long j9, long j10, long j11, long j12, long j13, AbstractC3247p abstractC3247p) {
    ...
    public boolean equals(Object obj) {
        ...
        if (Color.m2977equalsimpl0(this.textColor, menuItemColors.textColor) && Color.m2977equalsimpl0(this.leadingIconColor, menuItemColors.leadingIconColor) && Color.m2977equalsimpl0(this.trailingIconColor, menuItemColors.trailingIconColor) && Color.m2977equalsimpl0(this.disabledTextColor, menuItemColors.disabledTextColor) && Color.m2977equalsimpl0(this.disabledLeadingIconColor, menuItemColors.disabledLeadingIconColor) && Color.m2977equalsimpl0(this.disabledTrailingIconColor, menuItemColors.disabledTrailingIconColor)) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (((((((((Color.m2983hashCodeimpl(this.textColor) * 31) + Color.m2983hashCodeimpl(this.leadingIconColor)) * 31) + Color.m2983hashCodeimpl(this.trailingIconColor)) * 31) + Color.m2983hashCodeimpl(this.disabledTextColor)) * 31) + Color.m2983hashCodeimpl(this.disabledLeadingIconColor)) * 31) + Color.m2983hashCodeimpl(this.disabledTrailingIconColor);
    }
