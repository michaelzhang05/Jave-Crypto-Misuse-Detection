...
public final class ShapesKt {
    ...
    public static final CornerBasedShape end(CornerBasedShape cornerBasedShape) {
        AbstractC3255y.i(cornerBasedShape, "<this>");
        float f8 = (float) 0.0d;
        return CornerBasedShape.copy$default(cornerBasedShape, CornerSizeKt.m849CornerSize0680j_4(Dp.m5183constructorimpl(f8)), null, null, CornerSizeKt.m849CornerSize0680j_4(Dp.m5183constructorimpl(f8)), 6, null);
    }

    public static final Shape fromToken(Shapes shapes, ShapeKeyTokens value) {
        AbstractC3255y.i(shapes, "<this>");
    ...
    public static final Shape toShape(ShapeKeyTokens shapeKeyTokens, Composer composer, int i8) {
        AbstractC3255y.i(shapeKeyTokens, "<this>");
    ...
    public static final CornerBasedShape top(CornerBasedShape cornerBasedShape) {
        AbstractC3255y.i(cornerBasedShape, "<this>");
        float f8 = (float) 0.0d;
        return CornerBasedShape.copy$default(cornerBasedShape, null, null, CornerSizeKt.m849CornerSize0680j_4(Dp.m5183constructorimpl(f8)), CornerSizeKt.m849CornerSize0680j_4(Dp.m5183constructorimpl(f8)), 3, null);
    }
}
