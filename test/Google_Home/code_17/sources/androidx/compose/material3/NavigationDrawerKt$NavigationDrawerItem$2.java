...
public final class NavigationDrawerKt$NavigationDrawerItem$2 extends AbstractC3256z implements InterfaceC1668n {
    ...
    public NavigationDrawerKt$NavigationDrawerItem$2(InterfaceC1668n interfaceC1668n, NavigationDrawerItemColors navigationDrawerItemColors, boolean z8, int i8, InterfaceC1668n interfaceC1668n2, InterfaceC1668n interfaceC1668n3) {
        super(2);
        this.$icon = interfaceC1668n;
        this.$colors = navigationDrawerItemColors;
        this.$selected = z8;
        this.$$dirty = i8;
        this.$badge = interfaceC1668n2;
    ...
    public final void invoke(Composer composer, int i8) {
        ...
        Modifier m609paddingqDBjuR0$default = PaddingKt.m609paddingqDBjuR0$default(companion, Dp.m5183constructorimpl(16), 0.0f, Dp.m5183constructorimpl(24), 0.0f, 10, null);
        ...
        int i9 = this.$$dirty;
        InterfaceC1668n interfaceC1668n2 = this.$badge;
        ...
        if (interfaceC1668n != null) {
            CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m2966boximpl(navigationDrawerItemColors.iconColor(z8, composer, ((i9 >> 3) & 14) | ((i9 >> 18) & 112)).getValue().m2986unboximpl()))}, interfaceC1668n, composer, ((i9 >> 9) & 112) | 8);
            SpacerKt.Spacer(SizeKt.m657width3ABfNKs(companion, Dp.m5183constructorimpl(12)), composer, 6);
        }
        ...
        InterfaceC1669o materializerOf2 = LayoutKt.materializerOf(a8);
        if (!(composer.getApplier() instanceof Applier)) {
            ComposablesKt.invalidApplier();
        }
        composer.startReusableNode();
        ...
        CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m2966boximpl(navigationDrawerItemColors.textColor(z8, composer, ((i9 >> 3) & 14) | ((i9 >> 18) & 112)).getValue().m2986unboximpl()))}, interfaceC1668n3, composer, ((i9 << 3) & 112) | 8);
        composer.endReplaceableGroup();
        composer.endReplaceableGroup();
        composer.endReplaceableGroup();
        composer.endNode();
        ...
        if (interfaceC1668n2 != null) {
            SpacerKt.Spacer(SizeKt.m657width3ABfNKs(companion, Dp.m5183constructorimpl(12)), composer, 6);
            CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m2966boximpl(navigationDrawerItemColors.badgeColor(z8, composer, ((i9 >> 3) & 14) | ((i9 >> 18) & 112)).getValue().m2986unboximpl()))}, interfaceC1668n2, composer, ((i9 >> 12) & 112) | 8);
        }
        composer.endReplaceableGroup();
        composer.endReplaceableGroup();
        composer.endReplaceableGroup();
