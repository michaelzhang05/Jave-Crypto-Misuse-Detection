...
public final class OutlinedTextFieldKt {
    ...
    */
    public static final void OutlinedTextField(java.lang.String r89, kotlin.jvm.functions.Function1 r90, androidx.compose.ui.Modifier r91, boolean r92, boolean r93, androidx.compose.ui.text.TextStyle r94, a6.InterfaceC1668n r95, a6.InterfaceC1668n r96, a6.InterfaceC1668n r97, a6.InterfaceC1668n r98, a6.InterfaceC1668n r99, boolean r100, androidx.compose.ui.text.input.VisualTransformation r101, androidx.compose.foundation.text.KeyboardOptions r102, androidx.compose.foundation.text.KeyboardActions r103, boolean r104, int r105, androidx.compose.foundation.interaction.MutableInteractionSource r106, androidx.compose.ui.graphics.Shape r107, androidx.compose.material3.TextFieldColors r108, androidx.compose.runtime.Composer r109, int r110, int r111, int r112) {
        /*
            Method dump skipped, instructions count: 1509
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.OutlinedTextFieldKt.OutlinedTextField(java.lang.String, kotlin.jvm.functions.Function1, androidx.compose.ui.Modifier, boolean, boolean, androidx.compose.ui.text.TextStyle, a6.n, a6.n, a6.n, a6.n, a6.n, boolean, androidx.compose.ui.text.input.VisualTransformation, androidx.compose.foundation.text.KeyboardOptions, androidx.compose.foundation.text.KeyboardActions, boolean, int, androidx.compose.foundation.interaction.MutableInteractionSource, androidx.compose.ui.graphics.Shape, androidx.compose.material3.TextFieldColors, androidx.compose.runtime.Composer, int, int, int):void");
    }
    ...
    public static final void OutlinedTextFieldLayout(Modifier modifier, InterfaceC1668n textField, InterfaceC1669o interfaceC1669o, InterfaceC1668n interfaceC1668n, InterfaceC1668n interfaceC1668n2, InterfaceC1668n interfaceC1668n3, boolean z8, float f8, Function1 onLabelMeasured, InterfaceC1668n container, InterfaceC1668n interfaceC1668n4, PaddingValues paddingValues, Composer composer, int i8, int i9) {
        int i10;
        ...
        if ((i8 & 896) == 0) {
            i11 |= startRestartGroup.changed(interfaceC1669o) ? 256 : 128;
        }
        if ((i8 & 7168) == 0) {
            i11 |= startRestartGroup.changed(interfaceC1668n) ? 2048 : 1024;
        }
        if ((57344 & i8) == 0) {
            i11 |= startRestartGroup.changed(interfaceC1668n2) ? 16384 : 8192;
        }
        if ((458752 & i8) == 0) {
            i11 |= startRestartGroup.changed(interfaceC1668n3) ? 131072 : 65536;
        }
        if ((3670016 & i8) == 0) {
        ...
        int i12 = i11;
        int i13 = (i9 & 14) == 0 ? i9 | (startRestartGroup.changed(interfaceC1668n4) ? 4 : 2) : i9;
        if ((i9 & 112) == 0) {
        ...
        if ((i12 & 1533916891) == 306783378 && (i14 & 91) == 18 && startRestartGroup.getSkipping()) {
            ...
            if (interfaceC1668n2 != null) {
                ...
                interfaceC1668n2.invoke(startRestartGroup, Integer.valueOf((i12 >> 12) & 14));
                startRestartGroup.endReplaceableGroup();
                startRestartGroup.endReplaceableGroup();
                startRestartGroup.endReplaceableGroup();
            ...
            if (interfaceC1668n3 != null) {
                ...
                interfaceC1668n3.invoke(startRestartGroup, Integer.valueOf((i12 >> 15) & 14));
                startRestartGroup.endReplaceableGroup();
                startRestartGroup.endReplaceableGroup();
                startRestartGroup.endReplaceableGroup();
                startRestartGroup.endNode();
            ...
            if (interfaceC1669o != null) {
                interfaceC1669o.invoke(LayoutIdKt.layoutId(companion2, "Hint").then(m609paddingqDBjuR0$default), startRestartGroup, Integer.valueOf((i12 >> 3) & 112));
            }
            startRestartGroup.endReplaceableGroup();
            ...
            if (interfaceC1668n != null) {
                ...
                InterfaceC1669o materializerOf5 = LayoutKt.materializerOf(layoutId);
                if (!(startRestartGroup.getApplier() instanceof Applier)) {
                    ComposablesKt.invalidApplier();
                }
                startRestartGroup.startReusableNode();
                ...
                interfaceC1668n.invoke(startRestartGroup, Integer.valueOf((i12 >> 9) & 14));
                startRestartGroup.endReplaceableGroup();
                startRestartGroup.endReplaceableGroup();
                startRestartGroup.endReplaceableGroup();
                startRestartGroup.endNode();
            ...
            if (interfaceC1668n4 != null) {
                ...
                interfaceC1668n4.invoke(startRestartGroup, Integer.valueOf(i14 & 14));
                startRestartGroup.endReplaceableGroup();
                startRestartGroup.endReplaceableGroup();
                startRestartGroup.endReplaceableGroup();
                startRestartGroup.endNode();
        ...
        endRestartGroup.updateScope(new OutlinedTextFieldKt$OutlinedTextFieldLayout$2(modifier, textField, interfaceC1669o, interfaceC1668n, interfaceC1668n2, interfaceC1668n3, z8, f8, onLabelMeasured, container, interfaceC1668n4, paddingValues, i8, i9));
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: calculateHeight-O3s9Psw, reason: not valid java name */
    public static final int m1740calculateHeightO3s9Psw(int i8, int i9, int i10, int i11, int i12, int i13, long j8, float f8, PaddingValues paddingValues) {
        return Math.max(Constraints.m5152getMinHeightimpl(j8), Math.max(i8, Math.max(i9, AbstractC2055a.d(Math.max(i10, i12) + (paddingValues.mo555calculateBottomPaddingD9Ej5fM() * f8) + Math.max(paddingValues.mo558calculateTopPaddingD9Ej5fM() * f8, i11 / 2.0f)))) + i13);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: calculateWidth-O3s9Psw, reason: not valid java name */
    public static final int m1741calculateWidthO3s9Psw(int i8, int i9, int i10, int i11, int i12, boolean z8, long j8, float f8, PaddingValues paddingValues) {
        int i13;
        int i14 = 0;
        if (z8) {
            i13 = i11;
        ...
        if (!z8) {
            ...
            i14 = i11 + AbstractC2055a.d(Dp.m5183constructorimpl(paddingValues.mo556calculateLeftPaddingu2uoSUM(layoutDirection) + paddingValues.mo557calculateRightPaddingu2uoSUM(layoutDirection)) * f8);
        }
        return Math.max(max, Math.max(i14, Constraints.m5153getMinWidthimpl(j8)));
    }
    ...
    public static final Modifier m1742outlineCutout12SF9DM(Modifier outlineCutout, long j8, PaddingValues paddingValues) {
    ...
    public static final void place(Placeable.PlacementScope placementScope, int i8, int i9, Placeable placeable, Placeable placeable2, Placeable placeable3, Placeable placeable4, Placeable placeable5, Placeable placeable6, Placeable placeable7, float f8, boolean z8, float f9, LayoutDirection layoutDirection, PaddingValues paddingValues) {
        ...
        if (placeable4 != null) {
            ...
            Placeable.PlacementScope.placeRelative$default(placementScope, placeable4, AbstractC2055a.d(widthOrZero) + d9, AbstractC2055a.d(height), 0.0f, 4, null);
        }
        if (z8) {
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static final void OutlinedTextField(androidx.compose.ui.text.input.TextFieldValue r89, kotlin.jvm.functions.Function1 r90, androidx.compose.ui.Modifier r91, boolean r92, boolean r93, androidx.compose.ui.text.TextStyle r94, a6.InterfaceC1668n r95, a6.InterfaceC1668n r96, a6.InterfaceC1668n r97, a6.InterfaceC1668n r98, a6.InterfaceC1668n r99, boolean r100, androidx.compose.ui.text.input.VisualTransformation r101, androidx.compose.foundation.text.KeyboardOptions r102, androidx.compose.foundation.text.KeyboardActions r103, boolean r104, int r105, androidx.compose.foundation.interaction.MutableInteractionSource r106, androidx.compose.ui.graphics.Shape r107, androidx.compose.material3.TextFieldColors r108, androidx.compose.runtime.Composer r109, int r110, int r111, int r112) {
        /*
            Method dump skipped, instructions count: 1509
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.OutlinedTextFieldKt.OutlinedTextField(androidx.compose.ui.text.input.TextFieldValue, kotlin.jvm.functions.Function1, androidx.compose.ui.Modifier, boolean, boolean, androidx.compose.ui.text.TextStyle, a6.n, a6.n, a6.n, a6.n, a6.n, boolean, androidx.compose.ui.text.input.VisualTransformation, androidx.compose.foundation.text.KeyboardOptions, androidx.compose.foundation.text.KeyboardActions, boolean, int, androidx.compose.foundation.interaction.MutableInteractionSource, androidx.compose.ui.graphics.Shape, androidx.compose.material3.TextFieldColors, androidx.compose.runtime.Composer, int, int, int):void");
    }
}
