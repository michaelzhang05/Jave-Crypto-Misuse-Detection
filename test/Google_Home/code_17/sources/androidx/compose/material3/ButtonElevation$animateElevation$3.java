...
public final class ButtonElevation$animateElevation$3 extends l implements InterfaceC1668n {
    ...
    public ButtonElevation$animateElevation$3(Animatable<Dp, AnimationVector1D> animatable, ButtonElevation buttonElevation, float f8, Interaction interaction, d dVar) {
        super(2, dVar);
    ...
    public final d create(Object obj, d dVar) {
        return new ButtonElevation$animateElevation$3(this.$animatable, this.this$0, this.$target, this.$interaction, dVar);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i8 != 0) {
            ...
            this.label = 1;
            if (ElevationKt.m1621animateElevationrAjV9yQ(animatable, f11, interaction, interaction2, this) == e8) {
                return e8;
            }
        }
        return I.f8278a;
    ...
    public final Object invoke(M m8, d dVar) {
        return ((ButtonElevation$animateElevation$3) create(m8, dVar)).invokeSuspend(I.f8278a);
    }
}
