...
final class FloatingActionButtonKt$FloatingActionButton$2 extends AbstractC3256z implements InterfaceC1668n {
    ...
    public static final class AnonymousClass1 extends AbstractC3256z implements InterfaceC1668n {
        ...
        /* loaded from: classes.dex */
        public static final class C03341 extends AbstractC3256z implements InterfaceC1668n {
            final /* synthetic */ int $$dirty;
            final /* synthetic */ InterfaceC1668n $content;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C03341(InterfaceC1668n interfaceC1668n, int i8) {
                super(2);
            ...
            public final void invoke(Composer composer, int i8) {
                ...
                Modifier m636defaultMinSizeVpY3zN4 = SizeKt.m636defaultMinSizeVpY3zN4(companion, fabPrimaryTokens.m2117getContainerWidthD9Ej5fM(), fabPrimaryTokens.m2116getContainerHeightD9Ej5fM());
                ...
                InterfaceC1669o materializerOf = LayoutKt.materializerOf(m636defaultMinSizeVpY3zN4);
        ...
        public final void invoke(Composer composer, int i8) {
            ...
            TextKt.ProvideTextStyle(TypographyKt.fromToken(MaterialTheme.INSTANCE.getTypography(composer, 6), ExtendedFabPrimaryTokens.INSTANCE.getLabelTextFont()), ComposableLambdaKt.composableLambda(composer, 167946739, true, new C03341(this.$content, this.$$dirty)), composer, 48);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public FloatingActionButtonKt$FloatingActionButton$2(long j8, InterfaceC1668n interfaceC1668n, int i8) {
        super(2);
    ...
    public final void invoke(Composer composer, int i8) {
        ...
        CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m2966boximpl(this.$contentColor))}, ComposableLambdaKt.composableLambda(composer, -945978686, true, new AnonymousClass1(this.$content, this.$$dirty)), composer, 56);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
    }
