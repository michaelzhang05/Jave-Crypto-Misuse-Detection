...
public final class SliderKt$rangeSliderPressDragModifier$1 extends l implements InterfaceC1668n {
    ...
    public static final class AnonymousClass1 extends l implements InterfaceC1668n {
        ...
        /* loaded from: classes.dex */
        public static final class C03371 extends l implements InterfaceC1668n {
            ...
            /* loaded from: classes.dex */
            public static final class C03381 extends k implements InterfaceC1668n {
                final /* synthetic */ M $$this$coroutineScope;
                final /* synthetic */ State<Function1> $gestureEndAction;
                final /* synthetic */ boolean $isRtl;
                final /* synthetic */ float $maxPx;
                ...
                C03381(boolean z8, float f8, RangeSliderLogic rangeSliderLogic, State<Float> state, M m8, State<? extends Function1> state2, State<Float> state3, State<? extends InterfaceC1668n> state4, d dVar) {
                    super(2, dVar);
                    this.$isRtl = z8;
                    this.$maxPx = f8;
                    this.$rangeSliderLogic = rangeSliderLogic;
                ...
                @Override // kotlin.coroutines.jvm.internal.a
                public final d create(Object obj, d dVar) {
                    C03381 c03381 = new C03381(this.$isRtl, this.$maxPx, this.$rangeSliderLogic, this.$rawOffsetStart, this.$$this$coroutineScope, this.$gestureEndAction, this.$rawOffsetEnd, this.$onDrag, dVar);
                    c03381.L$0 = obj;
                    return c03381;
                }
                ...
                public final Object invoke(AwaitPointerEventScope awaitPointerEventScope, d dVar) {
                    return ((C03381) create(awaitPointerEventScope, dVar)).invokeSuspend(I.f8278a);
                }
                ...
                */
                public final java.lang.Object invokeSuspend(java.lang.Object r17) {
                    ...
                    */
                    throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.SliderKt$rangeSliderPressDragModifier$1.AnonymousClass1.C03371.C03381.invokeSuspend(java.lang.Object):java.lang.Object");
                }
            }

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            C03371(boolean z8, float f8, RangeSliderLogic rangeSliderLogic, State<Float> state, M m8, State<? extends Function1> state2, State<Float> state3, State<? extends InterfaceC1668n> state4, d dVar) {
                super(2, dVar);
                this.$isRtl = z8;
                this.$maxPx = f8;
                this.$rangeSliderLogic = rangeSliderLogic;
            ...
            @Override // kotlin.coroutines.jvm.internal.a
            public final d create(Object obj, d dVar) {
                C03371 c03371 = new C03371(this.$isRtl, this.$maxPx, this.$rangeSliderLogic, this.$rawOffsetStart, this.$$this$coroutineScope, this.$gestureEndAction, this.$rawOffsetEnd, this.$onDrag, dVar);
                c03371.L$0 = obj;
                return c03371;
            }
            ...
            public final Object invoke(PointerInputScope pointerInputScope, d dVar) {
                return ((C03371) create(pointerInputScope, dVar)).invokeSuspend(I.f8278a);
            }
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                if (i8 != 0) {
                    ...
                    C03381 c03381 = new C03381(this.$isRtl, this.$maxPx, this.$rangeSliderLogic, this.$rawOffsetStart, this.$$this$coroutineScope, this.$gestureEndAction, this.$rawOffsetEnd, this.$onDrag, null);
                    this.label = 1;
                    if (pointerInputScope.awaitPointerEventScope(c03381, this) == e8) {
                        return e8;
                    }
                }
                return I.f8278a;
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i8 != 0) {
                ...
                C03371 c03371 = new C03371(this.$isRtl, this.$maxPx, this.$rangeSliderLogic, this.$rawOffsetStart, m8, this.$gestureEndAction, this.$rawOffsetEnd, this.$onDrag, null);
                this.label = 1;
                if (ForEachGestureKt.forEachGesture(pointerInputScope, c03371, this) == e8) {
                    return e8;
                }
            }
            return I.f8278a;
