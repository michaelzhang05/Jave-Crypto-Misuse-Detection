...
public final class NavigationRailKt$NavigationRailItemBaselineLayout$3 extends AbstractC3256z implements InterfaceC1668n {
    ...
    public NavigationRailKt$NavigationRailItemBaselineLayout$3(InterfaceC1668n interfaceC1668n, InterfaceC1668n interfaceC1668n2, InterfaceC1668n interfaceC1668n3, InterfaceC1668n interfaceC1668n4, boolean z8, float f8, int i8) {
        super(2);
    ...
    public final void invoke(Composer composer, int i8) {
        NavigationRailKt.NavigationRailItemBaselineLayout(this.$indicatorRipple, this.$indicator, this.$icon, this.$label, this.$alwaysShowLabel, this.$animationProgress, composer, this.$$changed | 1);
    }
}
