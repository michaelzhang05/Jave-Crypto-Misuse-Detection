    ...
    */
    public static final float computeTarget(float r3, float r4, java.util.Set<java.lang.Float> r5, a6.InterfaceC1668n r6, float r7, float r8) {
        ...
        L6c:
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.SwipeableKt.computeTarget(float, float, java.util.Set, a6.n, float, float):float");
    }
    ...
    public static final <T> Modifier m1818swipeablepPrIpRY(Modifier swipeable, SwipeableState<T> state, Map<Float, ? extends T> anchors, Orientation orientation, boolean z8, boolean z9, MutableInteractionSource mutableInteractionSource, InterfaceC1668n thresholds, ResistanceConfig resistanceConfig, float f8) {
    ...
    public static /* synthetic */ Modifier m1819swipeablepPrIpRY$default(Modifier modifier, SwipeableState swipeableState, Map map, Orientation orientation, boolean z8, boolean z9, MutableInteractionSource mutableInteractionSource, InterfaceC1668n interfaceC1668n, ResistanceConfig resistanceConfig, float f8, int i8, Object obj) {
        boolean z10;
        boolean z11;
        ...
        if ((i8 & 256) != 0) {
            f9 = SwipeableDefaults.INSTANCE.m1817getVelocityThresholdD9Ej5fM$material3_release();
        } else {
            f9 = f8;
        }
        return m1818swipeablepPrIpRY(modifier, swipeableState, map, orientation, z10, z11, mutableInteractionSource2, interfaceC1668n2, resistanceConfig2, f9);
    }
}
