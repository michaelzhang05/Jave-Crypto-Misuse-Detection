...
public final class TabRowKt$ScrollableTabRow$3 extends AbstractC3256z implements InterfaceC1668n {
    ...
    public final void invoke(Composer composer, int i8) {
        TabRowKt.m1841ScrollableTabRowsKfQg0A(this.$selectedTabIndex, this.$modifier, this.$containerColor, this.$contentColor, this.$edgePadding, this.$indicator, this.$divider, this.$tabs, composer, this.$$changed | 1, this.$$default);
    }
}
