...
public final class NavigationBarKt$NavigationBarItem$styledIcon$1 extends AbstractC3256z implements InterfaceC1668n {
    ...
    public NavigationBarKt$NavigationBarItem$styledIcon$1(NavigationBarItemColors navigationBarItemColors, boolean z8, int i8, InterfaceC1668n interfaceC1668n, boolean z9, InterfaceC1668n interfaceC1668n2) {
        super(2);
    ...
    private static final long m1714invoke$lambda0(State<Color> state) {
    ...
    public final void invoke(Composer composer, int i8) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1419576100, i8, -1, "androidx.compose.material3.NavigationBarItem.<anonymous> (NavigationBar.kt:170)");
        }
        NavigationBarItemColors navigationBarItemColors = this.$colors;
        boolean z8 = this.$selected;
        int i9 = this.$$dirty;
        State<Color> iconColor$material3_release = navigationBarItemColors.iconColor$material3_release(z8, composer, ((i9 >> 21) & 112) | ((i9 >> 3) & 14));
        ...
        CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m2966boximpl(m1714invoke$lambda0(iconColor$material3_release)))}, interfaceC1668n, composer, ((i10 >> 6) & 112) | 8);
