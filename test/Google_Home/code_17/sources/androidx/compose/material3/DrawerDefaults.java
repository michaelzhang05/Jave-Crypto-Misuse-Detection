...
public final class DrawerDefaults {
    ...
    static {
        ...
        ModalDrawerElevation = navigationDrawerTokens.m2232getModalContainerElevationD9Ej5fM();
        PermanentDrawerElevation = navigationDrawerTokens.m2233getStandardContainerElevationD9Ej5fM();
        DismissibleDrawerElevation = navigationDrawerTokens.m2233getStandardContainerElevationD9Ej5fM();
        MaximumDrawerWidth = navigationDrawerTokens.m2230getContainerWidthD9Ej5fM();
    }
    ...
    public final long getScrimColor(Composer composer, int i8) {
        ...
        long m2975copywmQWz5c$default = Color.m2975copywmQWz5c$default(ColorSchemeKt.toColor(ScrimTokens.INSTANCE.getContainerColor(), composer, 6), 0.32f, 0.0f, 0.0f, 0.0f, 14, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public final WindowInsets getWindowInsets(Composer composer, int i8) {
        ...
        WindowInsets m678onlybOOhFvg = WindowInsetsKt.m678onlybOOhFvg(systemBarsForVisualComponents, WindowInsetsSides.m688plusgK_yJZ4(companion.m703getVerticalJoeWqyM(), companion.m701getStartJoeWqyM()));
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
