...
final class ExposedDropdownMenuKt$ExposedDropdownMenuBox$scope$1$1$menuAnchor$2 extends AbstractC3256z implements InterfaceC1669o {
    ...
    public static final class AnonymousClass1 extends AbstractC3256z implements Function1 {
        ...
        /* loaded from: classes.dex */
        public static final class C03311 extends AbstractC3256z implements Function1 {
            final /* synthetic */ MutableState<Integer> $menuHeight$delegate;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            C03311(MutableState<Integer> mutableState) {
                super(1);
        ...
        public final void invoke(LayoutCoordinates it) {
            ...
            ExposedDropdownMenuKt.m1626ExposedDropdownMenuBox$lambda2(this.$width$delegate, IntSize.m5349getWidthimpl(it.mo4143getSizeYbymL2g()));
            this.$coordinates.setValue(it);
            View rootView = this.$view.getRootView();
            AbstractC3255y.h(rootView, "view.rootView");
            ExposedDropdownMenuKt.updateHeight(rootView, this.$coordinates.getValue(), this.$verticalMarginInPx, new C03311(this.$menuHeight$delegate));
        }
    }
