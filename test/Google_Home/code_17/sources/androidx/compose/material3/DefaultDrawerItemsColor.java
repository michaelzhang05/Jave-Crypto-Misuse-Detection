...
public final class DefaultDrawerItemsColor implements NavigationDrawerItemColors {
    ...
    public /* synthetic */ DefaultDrawerItemsColor(long j8, long j9, long j10, long j11, long j12, long j13, long j14, long j15, AbstractC3247p abstractC3247p) {
    ...
    public boolean equals(Object obj) {
        ...
        if (Color.m2977equalsimpl0(this.selectedIconColor, defaultDrawerItemsColor.selectedIconColor) && Color.m2977equalsimpl0(this.unselectedIconColor, defaultDrawerItemsColor.unselectedIconColor) && Color.m2977equalsimpl0(this.selectedTextColor, defaultDrawerItemsColor.selectedTextColor) && Color.m2977equalsimpl0(this.unselectedTextColor, defaultDrawerItemsColor.unselectedTextColor) && Color.m2977equalsimpl0(this.selectedContainerColor, defaultDrawerItemsColor.selectedContainerColor) && Color.m2977equalsimpl0(this.unselectedContainerColor, defaultDrawerItemsColor.unselectedContainerColor) && Color.m2977equalsimpl0(this.selectedBadgeColor, defaultDrawerItemsColor.selectedBadgeColor) && Color.m2977equalsimpl0(this.unselectedBadgeColor, defaultDrawerItemsColor.unselectedBadgeColor)) {
            return true;
        }
        return false;
    }
    ...
    public final long m1599getSelectedBadgeColor0d7_KjU() {
        return this.selectedBadgeColor;
    }

    /* renamed from: getSelectedContainerColor-0d7_KjU, reason: not valid java name */
    public final long m1600getSelectedContainerColor0d7_KjU() {
        return this.selectedContainerColor;
    }

    /* renamed from: getSelectedIconColor-0d7_KjU, reason: not valid java name */
    public final long m1601getSelectedIconColor0d7_KjU() {
        return this.selectedIconColor;
    }

    /* renamed from: getSelectedTextColor-0d7_KjU, reason: not valid java name */
    public final long m1602getSelectedTextColor0d7_KjU() {
        return this.selectedTextColor;
    }

    /* renamed from: getUnselectedBadgeColor-0d7_KjU, reason: not valid java name */
    public final long m1603getUnselectedBadgeColor0d7_KjU() {
        return this.unselectedBadgeColor;
    }

    /* renamed from: getUnselectedContainerColor-0d7_KjU, reason: not valid java name */
    public final long m1604getUnselectedContainerColor0d7_KjU() {
        return this.unselectedContainerColor;
    }

    /* renamed from: getUnselectedIconColor-0d7_KjU, reason: not valid java name */
    public final long m1605getUnselectedIconColor0d7_KjU() {
        return this.unselectedIconColor;
    }

    /* renamed from: getUnselectedTextColor-0d7_KjU, reason: not valid java name */
    public final long m1606getUnselectedTextColor0d7_KjU() {
        return this.unselectedTextColor;
    }

    public int hashCode() {
        return (((((((((((((Color.m2983hashCodeimpl(this.selectedIconColor) * 31) + Color.m2983hashCodeimpl(this.unselectedIconColor)) * 31) + Color.m2983hashCodeimpl(this.selectedTextColor)) * 31) + Color.m2983hashCodeimpl(this.unselectedTextColor)) * 31) + Color.m2983hashCodeimpl(this.selectedContainerColor)) * 31) + Color.m2983hashCodeimpl(this.unselectedContainerColor)) * 31) + Color.m2983hashCodeimpl(this.selectedBadgeColor)) * 31) + Color.m2983hashCodeimpl(this.unselectedBadgeColor);
    }
