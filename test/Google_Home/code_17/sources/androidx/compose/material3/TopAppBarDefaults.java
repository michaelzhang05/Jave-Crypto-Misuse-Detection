...
public final class TopAppBarDefaults {
    ...
    public final TopAppBarColors m1954centerAlignedTopAppBarColorszjMxDiM(long j8, long j9, long j10, long j11, long j12, Composer composer, int i8, int i9) {
        long j13;
        long j14;
        long j15;
        long j16;
        ...
        if ((i9 & 2) != 0) {
            j14 = ColorSchemeKt.m1570applyTonalElevationHht5A8o(MaterialTheme.INSTANCE.getColorScheme(composer, 6), j13, TopAppBarSmallTokens.INSTANCE.m2419getOnScrollContainerElevationD9Ej5fM());
        } else {
            j14 = j9;
        }
        if ((i9 & 4) != 0) {
    ...
    public final WindowInsets getWindowInsets(Composer composer, int i8) {
        ...
        WindowInsets m678onlybOOhFvg = WindowInsetsKt.m678onlybOOhFvg(systemBarsForVisualComponents, WindowInsetsSides.m688plusgK_yJZ4(companion.m698getHorizontalJoeWqyM(), companion.m702getTopJoeWqyM()));
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return m678onlybOOhFvg;
    }

    @Composable
    /* renamed from: largeTopAppBarColors-zjMxDiM, reason: not valid java name */
    public final TopAppBarColors m1955largeTopAppBarColorszjMxDiM(long j8, long j9, long j10, long j11, long j12, Composer composer, int i8, int i9) {
        long j13;
        long j14;
        long j15;
        long j16;
    ...
    public final TopAppBarColors m1956mediumTopAppBarColorszjMxDiM(long j8, long j9, long j10, long j11, long j12, Composer composer, int i8, int i9) {
        long j13;
        long j14;
        long j15;
        long j16;
    ...
    public final TopAppBarColors m1957smallTopAppBarColorszjMxDiM(long j8, long j9, long j10, long j11, long j12, Composer composer, int i8, int i9) {
        long j13;
        long j14;
        long j15;
        long j16;
