...
public final class TopAppBarLargeTokens {
    ...
    private static final float ContainerElevation = ElevationTokens.INSTANCE.m2077getLevel0D9Ej5fM();
    private static final float ContainerHeight = Dp.m5183constructorimpl((float) 152.0d);
    ...
    public final float m2402getContainerElevationD9Ej5fM() {
        return ContainerElevation;
    }

    /* renamed from: getContainerHeight-D9Ej5fM, reason: not valid java name */
    public final float m2403getContainerHeightD9Ej5fM() {
    ...
    public final float m2404getLeadingIconSizeD9Ej5fM() {
    ...
    public final float m2405getTrailingIconSizeD9Ej5fM() {
