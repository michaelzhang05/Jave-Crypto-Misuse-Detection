...
public final class NavigationDrawerTokens {
    ...
    static {
        ...
        ActiveIndicatorHeight = Dp.m5183constructorimpl((float) 56.0d);
        ActiveIndicatorShape = ShapeKeyTokens.CornerFull;
        ActiveIndicatorWidth = Dp.m5183constructorimpl((float) 336.0d);
        ...
        ContainerWidth = Dp.m5183constructorimpl((float) 360.0d);
        ...
        ModalContainerElevation = elevationTokens.m2078getLevel1D9Ej5fM();
        StandardContainerElevation = elevationTokens.m2077getLevel0D9Ej5fM();
    }
    ...
    public final float m2228getActiveIndicatorHeightD9Ej5fM() {
    ...
    public final float m2229getActiveIndicatorWidthD9Ej5fM() {
    ...
    public final float m2230getContainerWidthD9Ej5fM() {
    ...
    public final float m2232getModalContainerElevationD9Ej5fM() {
        return ModalContainerElevation;
    }

    /* renamed from: getStandardContainerElevation-D9Ej5fM, reason: not valid java name */
    public final float m2233getStandardContainerElevationD9Ej5fM() {
