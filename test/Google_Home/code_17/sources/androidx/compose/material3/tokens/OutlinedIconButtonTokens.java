...
public final class OutlinedIconButtonTokens {
    ...
    private static final float ContainerSize = Dp.m5183constructorimpl((float) 40.0d);
    ...
    static {
        ...
        Size = Dp.m5183constructorimpl((float) 24.0d);
    ...
    public final float m2262getContainerSizeD9Ej5fM() {
    ...
    public final float m2263getSizeD9Ej5fM() {
        return Size;
    }
    ...
    public final float m2264getUnselectedOutlineWidthD9Ej5fM() {
