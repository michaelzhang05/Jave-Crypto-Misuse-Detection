...
public final class SliderTokens {
    ...
    static {
        ...
        float f8 = (float) 4.0d;
        ActiveTrackHeight = Dp.m5183constructorimpl(f8);
        ...
        DisabledHandleElevation = elevationTokens.m2077getLevel0D9Ej5fM();
        DisabledInactiveTrackColor = colorSchemeKeyTokens2;
        FocusHandleColor = colorSchemeKeyTokens;
        HandleColor = colorSchemeKeyTokens;
        HandleElevation = elevationTokens.m2078getLevel1D9Ej5fM();
        float f9 = (float) 20.0d;
        HandleHeight = Dp.m5183constructorimpl(f9);
        HandleShape = shapeKeyTokens;
        HandleWidth = Dp.m5183constructorimpl(f9);
        HoverHandleColor = colorSchemeKeyTokens;
        InactiveTrackColor = ColorSchemeKeyTokens.SurfaceVariant;
        InactiveTrackHeight = Dp.m5183constructorimpl(f8);
        InactiveTrackShape = shapeKeyTokens;
        LabelContainerColor = colorSchemeKeyTokens;
        LabelContainerElevation = elevationTokens.m2077getLevel0D9Ej5fM();
        LabelContainerHeight = Dp.m5183constructorimpl((float) 28.0d);
        ...
        TrackElevation = elevationTokens.m2077getLevel0D9Ej5fM();
        OverlapHandleOutlineColor = colorSchemeKeyTokens3;
        OverlapHandleOutlineWidth = Dp.m5183constructorimpl((float) 1.0d);
        TickMarksActiveContainerColor = colorSchemeKeyTokens3;
        TickMarksContainerShape = shapeKeyTokens;
        TickMarksContainerSize = Dp.m5183constructorimpl((float) 2.0d);
    ...
    public final float m2360getActiveTrackHeightD9Ej5fM() {
    ...
    public final float m2361getDisabledHandleElevationD9Ej5fM() {
    ...
    public final float m2362getHandleElevationD9Ej5fM() {
        return HandleElevation;
    }

    /* renamed from: getHandleHeight-D9Ej5fM, reason: not valid java name */
    public final float m2363getHandleHeightD9Ej5fM() {
        return HandleHeight;
    }
    ...
    public final float m2364getHandleWidthD9Ej5fM() {
        return HandleWidth;
    }
    ...
    public final float m2365getInactiveTrackHeightD9Ej5fM() {
    ...
    public final float m2366getLabelContainerElevationD9Ej5fM() {
        return LabelContainerElevation;
    }

    /* renamed from: getLabelContainerHeight-D9Ej5fM, reason: not valid java name */
    public final float m2367getLabelContainerHeightD9Ej5fM() {
    ...
    public final float m2368getOverlapHandleOutlineWidthD9Ej5fM() {
    ...
    public final float m2369getStateLayerSizeD9Ej5fM() {
    ...
    public final float m2370getTickMarksContainerSizeD9Ej5fM() {
    ...
    public final float m2371getTrackElevationD9Ej5fM() {
