...
public final class NavigationRailItemColors {
    ...
    public /* synthetic */ NavigationRailItemColors(long j8, long j9, long j10, long j11, long j12, AbstractC3247p abstractC3247p) {
    ...
    public boolean equals(Object obj) {
        ...
        if (Color.m2977equalsimpl0(this.selectedIconColor, navigationRailItemColors.selectedIconColor) && Color.m2977equalsimpl0(this.unselectedIconColor, navigationRailItemColors.unselectedIconColor) && Color.m2977equalsimpl0(this.selectedTextColor, navigationRailItemColors.selectedTextColor) && Color.m2977equalsimpl0(this.unselectedTextColor, navigationRailItemColors.unselectedTextColor) && Color.m2977equalsimpl0(this.selectedIndicatorColor, navigationRailItemColors.selectedIndicatorColor)) {
            return true;
        }
        return false;
    }
    ...
    public final State<Color> iconColor$material3_release(boolean z8, Composer composer, int i8) {
        ...
        State<Color> m191animateColorAsStateKTwxG1Y = SingleValueAnimationKt.m191animateColorAsStateKTwxG1Y(j8, AnimationSpecKt.tween$default(150, 0, null, 6, null), null, composer, 48, 4);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
