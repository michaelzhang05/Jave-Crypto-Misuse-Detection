...
public final class NavigationBarKt$NavigationBar$1 extends AbstractC3256z implements InterfaceC1668n {
    ...
    public NavigationBarKt$NavigationBar$1(WindowInsets windowInsets, InterfaceC1669o interfaceC1669o, int i8) {
        super(2);
    ...
    public final void invoke(Composer composer, int i8) {
        ...
        Modifier selectableGroup = SelectableGroupKt.selectableGroup(SizeKt.m638height3ABfNKs(windowInsetsPadding, f8));
        Arrangement.HorizontalOrVertical m519spacedBy0680j_4 = Arrangement.INSTANCE.m519spacedBy0680j_4(NavigationBarKt.getNavigationBarItemHorizontalPadding());
        InterfaceC1669o interfaceC1669o = this.$content;
        int i9 = ((this.$$dirty >> 6) & 7168) | 48;
        composer.startReplaceableGroup(693286680);
        MeasurePolicy rowMeasurePolicy = RowKt.rowMeasurePolicy(m519spacedBy0680j_4, Alignment.Companion.getTop(), composer, 6);
