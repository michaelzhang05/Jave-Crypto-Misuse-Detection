...
public final class ExposedDropdownMenuPopupKt$ExposedDropdownMenuPopup$popupLayout$1$1$1 extends AbstractC3256z implements InterfaceC1668n {
    ...
    public static final class AnonymousClass2 extends AbstractC3256z implements Function1 {
        ...
        @Override // kotlin.jvm.functions.Function1
        public /* bridge */ /* synthetic */ Object invoke(Object obj) {
            m1962invokeozmzZPI(((IntSize) obj).m5353unboximpl());
            return I.f8278a;
        }

        /* renamed from: invoke-ozmzZPI, reason: not valid java name */
        public final void m1962invokeozmzZPI(long j8) {
            this.$this_apply.m1964setPopupContentSizefhxjrPA(IntSize.m5341boximpl(j8));
    ...
    public static final class AnonymousClass3 extends AbstractC3256z implements InterfaceC1668n {
        ...
        public final void invoke(Composer composer, int i8) {
            InterfaceC1668n m1959ExposedDropdownMenuPopup$lambda0;
            ...
            m1959ExposedDropdownMenuPopup$lambda0 = ExposedDropdownMenuPopupKt.m1959ExposedDropdownMenuPopup$lambda0(this.$currentContent$delegate);
            m1959ExposedDropdownMenuPopup$lambda0.invoke(composer, 0);
            if (ComposerKt.isTraceInProgress()) {
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public ExposedDropdownMenuPopupKt$ExposedDropdownMenuPopup$popupLayout$1$1$1(PopupLayout popupLayout, State<? extends InterfaceC1668n> state) {
        super(2);
        this.$this_apply = popupLayout;
        this.$currentContent$delegate = state;
    }
