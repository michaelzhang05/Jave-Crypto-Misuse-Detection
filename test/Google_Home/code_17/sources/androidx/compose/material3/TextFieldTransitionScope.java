...
public final class TextFieldTransitionScope {
    ...
    private static final float m1878Transition_DTcfvLk$lambda1(State<Float> state) {
        return state.getValue().floatValue();
    }

    /* renamed from: Transition_DTcfvLk$lambda-3, reason: not valid java name */
    private static final float m1879Transition_DTcfvLk$lambda3(State<Float> state) {
        return state.getValue().floatValue();
    }

    /* renamed from: Transition_DTcfvLk$lambda-5, reason: not valid java name */
    private static final long m1880Transition_DTcfvLk$lambda5(State<Color> state) {
        return state.getValue().m2986unboximpl();
    }

    /* renamed from: Transition_DTcfvLk$lambda-6, reason: not valid java name */
    private static final long m1881Transition_DTcfvLk$lambda6(State<Color> state) {
        return state.getValue().m2986unboximpl();
    }
    ...
    */
    public final void m1882TransitionDTcfvLk(androidx.compose.material3.InputPhase r26, long r27, long r29, a6.InterfaceC1669o r31, boolean r32, a6.InterfaceC1672r r33, androidx.compose.runtime.Composer r34, int r35) {
        /*
            Method dump skipped, instructions count: 1048
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.TextFieldTransitionScope.m1882TransitionDTcfvLk(androidx.compose.material3.InputPhase, long, long, a6.o, boolean, a6.r, androidx.compose.runtime.Composer, int):void");
    }
}
