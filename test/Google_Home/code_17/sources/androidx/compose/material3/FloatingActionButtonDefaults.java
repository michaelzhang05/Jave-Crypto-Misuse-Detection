...
public final class FloatingActionButtonDefaults {
    ...
    private static final float LargeIconSize = FabPrimaryLargeTokens.INSTANCE.m2098getIconSizeD9Ej5fM();

    private FloatingActionButtonDefaults() {
    }

    /* renamed from: bottomAppBarFabElevation-a9UjIt4$default, reason: not valid java name */
    public static /* synthetic */ FloatingActionButtonElevation m1655bottomAppBarFabElevationa9UjIt4$default(FloatingActionButtonDefaults floatingActionButtonDefaults, float f8, float f9, float f10, float f11, int i8, Object obj) {
        if ((i8 & 1) != 0) {
        ...
        return floatingActionButtonDefaults.m1656bottomAppBarFabElevationa9UjIt4(f8, f9, f10, f11);
    }

    /* renamed from: bottomAppBarFabElevation-a9UjIt4, reason: not valid java name */
    public final FloatingActionButtonElevation m1656bottomAppBarFabElevationa9UjIt4(float f8, float f9, float f10, float f11) {
        return new FloatingActionButtonElevation(f8, f9, f10, f11, null);
    }

    @Composable
    /* renamed from: elevation-xZ9-QkE, reason: not valid java name */
    public final FloatingActionButtonElevation m1657elevationxZ9QkE(float f8, float f9, float f10, float f11, Composer composer, int i8, int i9) {
        composer.startReplaceableGroup(-241106249);
        if ((i9 & 1) != 0) {
            f8 = FabPrimaryTokens.INSTANCE.m2115getContainerElevationD9Ej5fM();
        }
        float f12 = f8;
        if ((i9 & 2) != 0) {
            f9 = FabPrimaryTokens.INSTANCE.m2125getPressedContainerElevationD9Ej5fM();
        }
        float f13 = f9;
        if ((i9 & 4) != 0) {
            f10 = FabPrimaryTokens.INSTANCE.m2118getFocusContainerElevationD9Ej5fM();
        }
        float f14 = f10;
        if ((i9 & 8) != 0) {
            f11 = FabPrimaryTokens.INSTANCE.m2119getHoverContainerElevationD9Ej5fM();
        }
        float f15 = f11;
    ...
    public final float m1658getLargeIconSizeD9Ej5fM() {
    ...
    public final FloatingActionButtonElevation m1659loweredElevationxZ9QkE(float f8, float f9, float f10, float f11, Composer composer, int i8, int i9) {
        composer.startReplaceableGroup(-285065125);
        if ((i9 & 1) != 0) {
            f8 = FabPrimaryTokens.INSTANCE.m2121getLoweredContainerElevationD9Ej5fM();
        }
        float f12 = f8;
        if ((i9 & 2) != 0) {
            f9 = FabPrimaryTokens.INSTANCE.m2124getLoweredPressedContainerElevationD9Ej5fM();
        }
        float f13 = f9;
        if ((i9 & 4) != 0) {
            f10 = FabPrimaryTokens.INSTANCE.m2122getLoweredFocusContainerElevationD9Ej5fM();
        }
        float f14 = f10;
        if ((i9 & 8) != 0) {
            f11 = FabPrimaryTokens.INSTANCE.m2123getLoweredHoverContainerElevationD9Ej5fM();
        }
        float f15 = f11;
        if (ComposerKt.isTraceInProgress()) {
