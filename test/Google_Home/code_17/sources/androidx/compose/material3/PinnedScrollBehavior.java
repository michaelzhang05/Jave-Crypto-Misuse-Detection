...
final class PinnedScrollBehavior implements TopAppBarScrollBehavior {
        ...
        this.nestedScrollConnection = new NestedScrollConnection() { // from class: androidx.compose.material3.PinnedScrollBehavior$nestedScrollConnection$1
            ...
            public long mo461onPostScrollDzOQY0M(long j8, long j9, int i8) {
                ...
                if (Offset.m2741getYimpl(j8) == 0.0f && Offset.m2741getYimpl(j9) > 0.0f) {
                    ...
                    state2.setContentOffset(state2.getContentOffset() + Offset.m2741getYimpl(j8));
                }
                return Offset.Companion.m2756getZeroF1C5BW0();
            }
    ...
    public /* synthetic */ PinnedScrollBehavior(TopAppBarState topAppBarState, Function0 function0, int i8, AbstractC3247p abstractC3247p) {
