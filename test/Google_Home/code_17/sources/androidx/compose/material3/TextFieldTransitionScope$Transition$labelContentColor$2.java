...
public final class TextFieldTransitionScope$Transition$labelContentColor$2 extends AbstractC3256z implements InterfaceC1669o {
    ...
    public final FiniteAnimationSpec<Color> invoke(Transition.Segment<InputPhase> animateColor, Composer composer, int i8) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-172466157, i8, -1, "androidx.compose.material3.TextFieldTransitionScope.Transition.<anonymous> (TextFieldImpl.kt:323)");
        }
