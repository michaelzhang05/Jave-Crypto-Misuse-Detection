...
final class Recomposer$runRecomposeConcurrentlyAndApplyChanges$2 extends kotlin.coroutines.jvm.internal.l implements InterfaceC1669o {
    final /* synthetic */ S5.g $recomposeCoroutineContext;
    ...
    public Recomposer$runRecomposeConcurrentlyAndApplyChanges$2(S5.g gVar, Recomposer recomposer, S5.d dVar) {
        super(3, dVar);
    ...
    */
    ...
    public final Object invoke(M m8, MonotonicFrameClock monotonicFrameClock, S5.d dVar) {
        ...
        return recomposer$runRecomposeConcurrentlyAndApplyChanges$2.invokeSuspend(I.f8278a);
    }
}
