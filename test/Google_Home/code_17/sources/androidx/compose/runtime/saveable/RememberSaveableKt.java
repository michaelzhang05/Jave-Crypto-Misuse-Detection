...
public final class RememberSaveableKt {
    ...
    private static final <T> Saver<MutableState<T>, MutableState<Object>> mutableStateSaver(Saver<T, ? extends Object> saver) {
        AbstractC3255y.g(saver, "null cannot be cast to non-null type androidx.compose.runtime.saveable.Saver<T of androidx.compose.runtime.saveable.RememberSaveableKt.mutableStateSaver, kotlin.Any>");
    ...
    public static final <T> T m2588rememberSaveable(Object[] objArr, Saver<T, ? extends Object> saver, String str, Function0 function0, Composer composer, int i8, int i9) {
        ...
        if (str == null || str.length() == 0) {
            str = Integer.toString(currentCompositeKeyHash, AbstractC3202a.a(MaxSupportedRadix));
            AbstractC3255y.h(str, "toString(this, checkRadix(radix))");
        }
        AbstractC3255y.g(saver, "null cannot be cast to non-null type androidx.compose.runtime.saveable.Saver<T of androidx.compose.runtime.saveable.RememberSaveableKt.rememberSaveable, kotlin.Any>");
    ...
    public static final <T> MutableState<T> rememberSaveable(Object[] objArr, Saver<T, ? extends Object> saver, String str, Function0 function0, Composer composer, int i8, int i9) {
        ...
        MutableState<T> mutableState = (MutableState) m2588rememberSaveable(Arrays.copyOf(objArr, objArr.length), mutableStateSaver(saver), str2, function0, composer, (i8 & 896) | 8 | (i8 & 7168), 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
