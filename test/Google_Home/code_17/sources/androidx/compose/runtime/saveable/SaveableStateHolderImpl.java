...
public final class SaveableStateHolderImpl implements SaveableStateHolder {
    ...
    @Composable
    public void SaveableStateProvider(Object obj, InterfaceC1668n interfaceC1668n, Composer composer, int i8) {
        boolean z8;
        ...
        CompositionLocalKt.CompositionLocalProvider(SaveableStateRegistryKt.getLocalSaveableStateRegistry().provides(registryHolder.getRegistry()), interfaceC1668n, startRestartGroup, i8 & 112);
        EffectsKt.DisposableEffect(I.f8278a, new SaveableStateHolderImpl$SaveableStateProvider$1$1(this, obj, registryHolder), startRestartGroup, 6);
        ...
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new SaveableStateHolderImpl$SaveableStateProvider$2(this, obj, interfaceC1668n, i8));
        }
    }
    ...
    public /* synthetic */ SaveableStateHolderImpl(Map map, int i8, AbstractC3247p abstractC3247p) {
