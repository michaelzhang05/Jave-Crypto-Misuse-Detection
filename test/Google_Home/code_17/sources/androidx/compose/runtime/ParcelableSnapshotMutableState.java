...
public final class ParcelableSnapshotMutableState<T> extends SnapshotMutableStateImpl<T> implements Parcelable {
    ...
    public void writeToParcel(Parcel parcel, int i8) {
        ...
        if (AbstractC3255y.d(policy, SnapshotStateKt.neverEqualPolicy())) {
            i9 = 0;
        } else if (AbstractC3255y.d(policy, SnapshotStateKt.structuralEqualityPolicy())) {
            i9 = 1;
        } else if (AbstractC3255y.d(policy, SnapshotStateKt.referentialEqualityPolicy())) {
            i9 = 2;
        } else {
