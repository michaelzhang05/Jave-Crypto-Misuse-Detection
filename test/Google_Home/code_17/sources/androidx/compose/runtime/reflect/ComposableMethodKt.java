...
public final class ComposableMethodKt {
    ...
    private static final ComposableInfo getComposableInfo(Method method) {
        ...
        if (length >= 0) {
            while (true) {
                int i9 = length - 1;
                if (AbstractC3255y.d(parameterTypes[length], Composer.class)) {
                    break;
                }
                if (i9 < 0) {
                    break;
    ...
    public static final ComposableMethod getDeclaredComposableMethod(Class<?> cls, String str, Class<?>... clsArr) throws NoSuchMethodException {
        ...
        try {
            ...
            try {
                ...
                ArrayList arrayList2 = new ArrayList(AbstractC1378t.x(s9, 10));
                ...
                ArrayList arrayList3 = new ArrayList(AbstractC1378t.x(s10, 10));
        ...
        if (method != null) {
            ...
            AbstractC3255y.f(asComposableMethod);
