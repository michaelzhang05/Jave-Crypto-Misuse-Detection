...
public final class ComposableMethod {
    ...
    public boolean equals(Object obj) {
        if (obj instanceof ComposableMethod) {
            return AbstractC3255y.d(this.method, ((ComposableMethod) obj).method);
        }
        return false;
    }
    ...
    public final Class<?>[] getParameterTypes() {
        return (Class[]) AbstractC1371l.p(this.method.getParameterTypes(), 0, this.composableInfo.getRealParamsCount());
    }

    public final Parameter[] getParameters() {
        Parameter[] parameters;
        parameters = this.method.getParameters();
        return (Parameter[]) AbstractC1371l.p(parameters, 0, this.composableInfo.getRealParamsCount());
    }
    ...
    public final Object invoke(Composer composer, Object obj, Object... objArr) {
        ...
        for (int i16 = 0; i16 < length; i16++) {
            if (i16 >= 0 && i16 < component2) {
                if (i16 < 0 || i16 > AbstractC1371l.i0(objArr)) {
