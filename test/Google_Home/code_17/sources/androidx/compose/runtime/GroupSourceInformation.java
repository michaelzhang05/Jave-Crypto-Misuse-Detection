...
public final class GroupSourceInformation {
    ...
    private final boolean hasAnchor(Anchor anchor) {
        ...
        for (int i8 = 0; i8 < size; i8++) {
            ...
            if (AbstractC3255y.d(obj, anchor) || ((obj instanceof GroupSourceInformation) && ((GroupSourceInformation) obj).hasAnchor(anchor))) {
                return true;
            }
        }
        return false;
        ...
        if (i8 >= 0 && (tryAnchor$runtime_release = slotWriter.tryAnchor$runtime_release(i8)) != null) {
            ...
            while (true) {
                if (i10 < size) {
                    ...
                    if (AbstractC3255y.d(obj, tryAnchor$runtime_release) || ((obj instanceof GroupSourceInformation) && ((GroupSourceInformation) obj).hasAnchor(tryAnchor$runtime_release))) {
                        break;
                    } else {
                        i10++;
                    }
        ...
        if (arrayList != null) {
            for (int size = arrayList.size() - 1; size >= 0; size--) {
                ...
                if (obj instanceof Anchor) {
                    if (AbstractC3255y.d(obj, anchor)) {
