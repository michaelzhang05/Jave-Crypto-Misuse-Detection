...
public final class CompositionImpl implements ControlledComposition, ReusableComposition, RecomposeScopeOwner, CompositionServices {
    ...
    private final S5.g _recomposeContext;
    ...
    public CompositionImpl(CompositionContext compositionContext, Applier<?> applier, S5.g gVar) {
        ...
        this.composable = ComposableSingletons$CompositionKt.INSTANCE.m2467getLambda1$runtime_release();
    }
    ...
    */
                ...
                if ((((~j9) << 7) & j9 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i12 < i11) {
                        if ((j9 & 255) < 128) {
                            ...
                            if (obj2 instanceof MutableScatterSet) {
                                AbstractC3255y.g(obj2, "null cannot be cast to non-null type androidx.collection.MutableScatterSet<T of androidx.compose.runtime.collection.ScopeMap.removeScopeIf$lambda$1>");
                                MutableScatterSet mutableScatterSet = (MutableScatterSet) obj2;
                                ...
                                i9 = i11;
                                j8 = j10;
                                AbstractC3255y.g(obj2, "null cannot be cast to non-null type T of androidx.compose.runtime.collection.ScopeMap.removeScopeIf$lambda$1");
    ...
    private final void composeInitial(InterfaceC1668n interfaceC1668n) {
        if (!this.disposed) {
            this.composable = interfaceC1668n;
            this.parent.composeInitial$runtime_release(this, interfaceC1668n);
            return;
        }
    ...
    private final void drainPendingModificationsForCompositionLocked() {
        ...
        if (andSet != null) {
            ...
            if (!AbstractC3255y.d(andSet, obj2)) {
    ...
    private final void drainPendingModificationsLocked() {
        ...
        obj = CompositionKt.PendingApplyNoModifications;
        if (!AbstractC3255y.d(andSet, obj)) {
            if (andSet instanceof Set) {
    ...
    private final CompositionObserver observer() {
        ...
        if (!AbstractC3255y.d(compositionObserver, compositionObserverHolder.getObserver())) {
    ...
    private final void validateRecomposeScopeAnchors(SlotTable slotTable) {
        ...
        for (int i8 = 0; i8 < size; i8++) {
            ...
            if (anchor != null && !slotTable.slotsOf$runtime_release(anchor.toIndexFor(slotTable)).contains(recomposeScopeImpl2)) {
                throw new IllegalStateException(("Misaligned anchor " + anchor + " in scope " + recomposeScopeImpl2 + " encountered, scope found at " + AbstractC1371l.p0(slotTable.getSlots(), recomposeScopeImpl2)).toString());
            }
        }
    }
    ...
    @Override // androidx.compose.runtime.ControlledComposition
    public void composeContent(InterfaceC1668n interfaceC1668n) {
            ...
            synchronized (this.lock) {
                try {
                    ...
                    if (observer != null) {
                        ...
                        AbstractC3255y.g(asMap, "null cannot be cast to non-null type kotlin.collections.Map<androidx.compose.runtime.RecomposeScope, kotlin.collections.Set<kotlin.Any>?>");
                        observer.onBeginComposition(this, asMap);
                    }
                    this.composer.composeContent$runtime_release(takeInvalidations, interfaceC1668n);
                    if (observer != null) {
    ...
    public <R> R delegateInvalidations(ControlledComposition controlledComposition, int i8, Function0 function0) {
        if (controlledComposition != null && !AbstractC3255y.d(controlledComposition, this) && i8 >= 0) {
        ...
        synchronized (this.lock) {
            try {
                if (!this.composer.isComposing$runtime_release()) {
                    if (!this.disposed) {
                        this.disposed = true;
                        this.composable = ComposableSingletons$CompositionKt.INSTANCE.m2468getLambda2$runtime_release();
    ...
    public final InterfaceC1668n getComposable() {
    ...
    public <T> T getCompositionService(CompositionServiceKey<T> compositionServiceKey) {
        if (AbstractC3255y.d(compositionServiceKey, CompositionKt.getCompositionImplServiceKey())) {
            return this;
        }
        return null;
    }
    ...
    public final List<RecomposeScopeImpl> getConditionalScopes$runtime_release() {
        return AbstractC1378t.W0(this.conditionallyInvalidatedScopes);
    }
    ...
    public final S5.g getRecomposeContext() {
        S5.g gVar = this._recomposeContext;
        if (gVar == null) {
    ...
    public void insertMovableContent(List<r> list) {
        ...
        while (true) {
            if (i8 < size) {
                if (!AbstractC3255y.d(((MovableContentStateReference) list.get(i8).c()).getComposition$runtime_release(), this)) {
                    break;
                } else {
                    i8++;
                }
    ...
    public final CompositionObserverHandle observe$runtime_release(final CompositionObserver compositionObserver) {
        ...
        return new CompositionObserverHandle() { // from class: androidx.compose.runtime.CompositionImpl$observe$2
            ...
            public void dispose() {
                ...
                synchronized (obj) {
                    try {
                        if (AbstractC3255y.d(compositionImpl.getObserverHolder$runtime_release().getObserver(), compositionObserver2)) {
    ...
    public void recordModificationsOf(Set<? extends Object> set) {
        ...
        do {
            ...
            if (d8) {
                ...
                AbstractC3255y.g(obj, "null cannot be cast to non-null type kotlin.Array<kotlin.collections.Set<kotlin.Any>>");
                set2 = AbstractC1371l.D((Set[]) obj, set);
            } else {
        ...
        if (!getAreChildrenComposing() && (currentRecomposeScope$runtime_release = this.composer.getCurrentRecomposeScope$runtime_release()) != null) {
            ...
            if (!currentRecomposeScope$runtime_release.recordRead(obj)) {
                if (obj instanceof StateObjectImpl) {
                    ((StateObjectImpl) obj).m2612recordReadInh_f27i8$runtime_release(ReaderKind.m2596constructorimpl(1));
                }
                                ...
                                for (int i10 = 0; i10 < i9; i10++) {
                                    if ((255 & j8) < 128) {
                                        ...
                                        if (stateObject instanceof StateObjectImpl) {
                                            ((StateObjectImpl) stateObject).m2612recordReadInh_f27i8$runtime_release(ReaderKind.m2596constructorimpl(1));
                                        }
    ...
    public final void setComposable(InterfaceC1668n interfaceC1668n) {
        this.composable = interfaceC1668n;
    }

    @Override // androidx.compose.runtime.Composition
    public void setContent(InterfaceC1668n interfaceC1668n) {
        composeInitial(interfaceC1668n);
    }

    @Override // androidx.compose.runtime.ReusableComposition
    public void setContentWithReuse(InterfaceC1668n interfaceC1668n) {
    ...
    public /* synthetic */ CompositionImpl(CompositionContext compositionContext, Applier applier, S5.g gVar, int i8, AbstractC3247p abstractC3247p) {
