...
public final class MonotonicFrameClockKt {
    public static final MonotonicFrameClock getMonotonicFrameClock(S5.g gVar) {
    ...
    public static final <R> Object withFrameMillis(MonotonicFrameClock monotonicFrameClock, Function1 function1, S5.d dVar) {
        return monotonicFrameClock.withFrameNanos(new MonotonicFrameClockKt$withFrameMillis$2(function1), dVar);
    }

    private static final <R> Object withFrameMillis$$forInline(MonotonicFrameClock monotonicFrameClock, Function1 function1, S5.d dVar) {
    ...
    public static final <R> Object withFrameNanos(Function1 function1, S5.d dVar) {
        return getMonotonicFrameClock(dVar.getContext()).withFrameNanos(function1, dVar);
    }

    public static final <R> Object withFrameMillis(Function1 function1, S5.d dVar) {
    ...
    public static /* synthetic */ void getMonotonicFrameClock$annotations(S5.g gVar) {
    }
}
