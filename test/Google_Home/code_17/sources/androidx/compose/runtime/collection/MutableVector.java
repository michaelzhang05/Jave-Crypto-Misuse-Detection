...
public final class MutableVector<T> implements RandomAccess {
    ...
    /* loaded from: classes.dex */
    private static final class MutableVectorList<T> implements List<T>, InterfaceC1986b {
    ...
    /* loaded from: classes.dex */
    private static final class SubList<T> implements List<T>, InterfaceC1986b {
        private int end;
        ...
        public boolean contains(Object obj) {
            ...
            for (int i9 = this.start; i9 < i8; i9++) {
                if (AbstractC3255y.d(this.list.get(i9), obj)) {
                    return true;
                }
            }
            return false;
        ...
        public int lastIndexOf(Object obj) {
            ...
            int i9 = this.start;
            if (i9 <= i8) {
                while (!AbstractC3255y.d(this.list.get(i8), obj)) {
                    if (i8 != i9) {
                        i8--;
                    } else {
                        return -1;
    ...
    /* loaded from: classes.dex */
    private static final class VectorListIterator<T> implements ListIterator<T>, InterfaceC1985a {
        private int index;
        private final List<T> list;
    ...
    public final boolean addAll(int i8, List<? extends T> list) {
        ...
        T[] tArr = this.content;
        if (i8 != this.size) {
            AbstractC1371l.i(tArr, tArr, list.size() + i8, i8, this.size);
        }
        int size = list.size();
    ...
    public final boolean contains(T t8) {
        int size = getSize() - 1;
        if (size >= 0) {
            for (int i8 = 0; !AbstractC3255y.d(getContent()[i8], t8); i8++) {
                if (i8 != size) {
                }
            }
            return true;
    ...
    public final boolean contentEquals(MutableVector<T> mutableVector) {
        ...
        int size = getSize() - 1;
        if (size >= 0) {
            for (int i8 = 0; AbstractC3255y.d(mutableVector.getContent()[i8], getContent()[i8]); i8++) {
                if (i8 != size) {
                }
            }
            return false;
    ...
    public final void ensureCapacity(int i8) {
        ...
        if (tArr.length < i8) {
            ...
            AbstractC3255y.h(tArr2, "copyOf(this, newSize)");
            this.content = tArr2;
        }
    }
    ...
    public final <R> R fold(R r8, InterfaceC1668n interfaceC1668n) {
        int size = getSize();
        if (size > 0) {
            T[] content = getContent();
            int i8 = 0;
            do {
                r8 = (R) interfaceC1668n.invoke(r8, content[i8]);
                i8++;
            } while (i8 < size);
        }
        return r8;
    ...
    public final <R> R foldIndexed(R r8, InterfaceC1669o interfaceC1669o) {
        int size = getSize();
        if (size > 0) {
            T[] content = getContent();
            int i8 = 0;
            do {
                r8 = (R) interfaceC1669o.invoke(Integer.valueOf(i8), r8, content[i8]);
                i8++;
            } while (i8 < size);
        }
        return r8;
    ...
    public final <R> R foldRight(R r8, InterfaceC1668n interfaceC1668n) {
        int size = getSize();
        if (size > 0) {
            int i8 = size - 1;
            T[] content = getContent();
            do {
                r8 = (R) interfaceC1668n.invoke(content[i8], r8);
                i8--;
            } while (i8 >= 0);
        }
        return r8;
    ...
    public final <R> R foldRightIndexed(R r8, InterfaceC1669o interfaceC1669o) {
        int size = getSize();
        if (size > 0) {
            int i8 = size - 1;
            T[] content = getContent();
            do {
                r8 = (R) interfaceC1669o.invoke(Integer.valueOf(i8), content[i8], r8);
                i8--;
            } while (i8 >= 0);
        }
        return r8;
    ...
    public final void forEachIndexed(InterfaceC1668n interfaceC1668n) {
        int size = getSize();
        if (size > 0) {
            T[] content = getContent();
            int i8 = 0;
    ...
    public final void forEachReversedIndexed(InterfaceC1668n interfaceC1668n) {
        if (getSize() > 0) {
            int size = getSize() - 1;
            T[] content = getContent();
            do {
                interfaceC1668n.invoke(Integer.valueOf(size), content[size]);
                size--;
            } while (size >= 0);
        }
    }
    ...
    public final int indexOf(T t8) {
        ...
        if (i8 > 0) {
            T[] tArr = this.content;
            int i9 = 0;
            while (!AbstractC3255y.d(t8, tArr[i9])) {
                i9++;
                if (i9 >= i8) {
                    return -1;
                }
    ...
    /* JADX WARN: Multi-variable type inference failed */
    public final /* synthetic */ <R> R[] mapIndexed(InterfaceC1668n interfaceC1668n) {
        int size = getSize();
        AbstractC3255y.n(0, "R");
        R[] rArr = (R[]) new Object[size];
        for (int i8 = 0; i8 < size; i8++) {
            rArr[i8] = interfaceC1668n.invoke(Integer.valueOf(i8), getContent()[i8]);
        }
        return rArr;
    }

    public final /* synthetic */ <R> MutableVector<R> mapIndexedNotNull(InterfaceC1668n interfaceC1668n) {
        int size = getSize();
        int i8 = 0;
        AbstractC3255y.n(0, "R?");
        ...
        if (size > 0) {
            ...
            int i9 = 0;
            do {
                Object invoke = interfaceC1668n.invoke(Integer.valueOf(i8), content[i8]);
                if (invoke != null) {
                    objArr[i9] = invoke;
                    i9++;
                }
    ...
    public final T removeAt(int i8) {
        ...
        T t8 = tArr[i8];
        if (i8 != getSize() - 1) {
            AbstractC1371l.i(tArr, tArr, i8, i8 + 1, this.size);
        }
        int i9 = this.size - 1;
        this.size = i9;
        tArr[i9] = null;
    ...
    public final void removeIf(Function1 function1) {
        ...
        int i10 = size - i8;
        AbstractC1371l.t(getContent(), null, i10, size);
        setSize(i10);
    }
    ...
    public final void removeRange(int i8, int i9) {
        if (i9 > i8) {
            ...
            if (i9 < i10) {
                T[] tArr = this.content;
                AbstractC1371l.i(tArr, tArr, i8, i9, i10);
            }
    ...
    public final void sortWith(Comparator<T> comparator) {
        AbstractC1371l.L(this.content, comparator, 0, this.size);
    }
    ...
    public final void add(int i8, T t8) {
        ...
        int i9 = this.size;
        if (i8 != i9) {
            AbstractC1371l.i(tArr, tArr, i8 + 1, i8, i9);
        }
        tArr[i8] = t8;
        this.size++;
    }
    ...
    public final boolean containsAll(MutableVector<T> mutableVector) {
        ...
        int f8 = iVar.f();
        if (e8 <= f8) {
            while (contains(mutableVector.getContent()[e8])) {
                if (e8 != f8) {
                    e8++;
                }
            }
    ...
    public final boolean addAll(int i8, MutableVector<T> mutableVector) {
        ...
        int i9 = this.size;
        if (i8 != i9) {
            AbstractC1371l.i(tArr, tArr, mutableVector.size + i8, i8, i9);
        }
        AbstractC1371l.i(mutableVector.content, tArr, i8, 0, mutableVector.size);
    ...
    public final boolean addAll(T[] tArr) {
        ...
        AbstractC1371l.n(tArr, this.content, this.size, 0, 0, 12, null);
    ...
    public final boolean addAll(int i8, Collection<? extends T> collection) {
        ...
        T[] tArr = this.content;
        if (i8 != this.size) {
            AbstractC1371l.i(tArr, tArr, collection.size() + i8, i8, this.size);
        }
        for (T t8 : collection) {
            int i10 = i9 + 1;
            if (i9 < 0) {
