...
public final class IdentityArrayMap<Key, Value> {
    ...
    public final void clear() {
        this.size = 0;
        AbstractC1371l.x(this.keys, null, 0, 0, 6, null);
        AbstractC1371l.x(this.values, null, 0, 0, 6, null);
    }
    ...
    public final void forEach(InterfaceC1668n interfaceC1668n) {
        int size = getSize();
        for (int i8 = 0; i8 < size; i8++) {
            ...
            interfaceC1668n.invoke(obj, getValues()[i8]);
        }
    }
    ...
    public final Value remove(Key key) {
        ...
        int i9 = find + 1;
        AbstractC1371l.i(objArr2, objArr2, find, i9, i8);
        AbstractC1371l.i(objArr, objArr, find, i9, i8);
        int i10 = i8 - 1;
        objArr2[i10] = null;
        objArr[i10] = null;
        this.size = i10;
    ...
    public final void removeIf(InterfaceC1668n interfaceC1668n) {
        int size = getSize();
        int i8 = 0;
        for (int i9 = 0; i9 < size; i9++) {
            Object obj = getKeys()[i9];
            AbstractC3255y.g(obj, "null cannot be cast to non-null type Key of androidx.compose.runtime.collection.IdentityArrayMap");
            if (!((Boolean) interfaceC1668n.invoke(obj, getValues()[i9])).booleanValue()) {
                if (i8 != i9) {
                    getKeys()[i8] = obj;
    ...
    public final void set(Key key, Value value) {
        ...
        int i10 = i9 + 1;
        AbstractC1371l.i(objArr3, objArr, i10, i9, i8);
        if (z8) {
            AbstractC1371l.n(objArr3, objArr, 0, 0, i9, 6, null);
        }
        objArr[i9] = key;
        this.keys = objArr;
        if (z8) {
        ...
        AbstractC1371l.i(objArr4, objArr2, i10, i9, i8);
        if (z8) {
            AbstractC1371l.n(objArr4, objArr2, 0, 0, i9, 6, null);
        }
        objArr2[i9] = value;
        this.values = objArr2;
        this.size++;
    ...
    public /* synthetic */ IdentityArrayMap(int i8, int i9, AbstractC3247p abstractC3247p) {
        this((i9 & 1) != 0 ? 16 : i8);
    }
}
