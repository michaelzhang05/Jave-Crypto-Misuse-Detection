...
final class IdentityArrayMap$asMap$1$entries$1$iterator$1 extends k implements InterfaceC1668n {
    int I$0;
    int I$1;
    ...
    /* loaded from: classes.dex */
    public static final class AnonymousClass1<Key, Value> implements Map.Entry<Key, Value>, InterfaceC1985a {
        private final Key key;
        private final Value value;

        AnonymousClass1(IdentityArrayMap<Key, Value> identityArrayMap, int i8) {
            Key key = (Key) identityArrayMap.getKeys()[i8];
            AbstractC3255y.g(key, "null cannot be cast to non-null type Key of androidx.compose.runtime.collection.IdentityArrayMap");
            this.key = key;
    ...
    public final Object invoke(AbstractC3000i abstractC3000i, d dVar) {
        return ((IdentityArrayMap$asMap$1$entries$1$iterator$1) create(abstractC3000i, dVar)).invokeSuspend(I.f8278a);
    }
