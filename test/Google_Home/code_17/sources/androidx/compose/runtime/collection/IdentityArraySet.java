...
public final class IdentityArraySet<T> implements Set<T>, InterfaceC1985a {
    ...
    public final boolean add(T t8) {
        ...
        if (size == objArr.length) {
            ...
            AbstractC1371l.i(objArr, objArr2, i9 + 1, i9, size);
            AbstractC1371l.n(objArr, objArr2, 0, 0, i9, 6, null);
            this.values = objArr2;
        } else {
            AbstractC1371l.i(objArr, objArr, i9 + 1, i9, size);
        }
        this.values[i9] = t8;
        this.size = size() + 1;
        return true;
    ...
    public final T get(int i8) {
        ...
        AbstractC3255y.g(t8, "null cannot be cast to non-null type T of androidx.compose.runtime.collection.IdentityArraySet");
        return t8;
    }
    ...
    public final boolean remove(T t8) {
        ...
        int i8 = size - 1;
        if (find < i8) {
            AbstractC1371l.i(objArr, objArr, find, find + 1, size);
        }
        objArr[i8] = null;
        this.size = size() - 1;
        return true;
    ...
    public String toString() {
        return AbstractC1378t.w0(this, null, "[", "]", 0, null, IdentityArraySet$toString$1.INSTANCE, 25, null);
    }
    ...
    public final void addAll(Collection<? extends T> collection) {
        ...
        if (!z8 && z9) {
            AbstractC1371l.i(objArr3, objArr2, size, 0, size2);
        ...
        if (i12 >= 0) {
            AbstractC1371l.i(objArr, objArr, 0, i12 + 1, i9);
        }
        int i15 = i9 - (i12 + 1);
        AbstractC1371l.t(objArr, null, i15, i9);
        this.values = objArr;
        this.size = i15;
    }
