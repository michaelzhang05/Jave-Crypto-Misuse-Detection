...
public final class IdentityArrayMap$asMap$1$entries$1<Key, Value> implements Set<Map.Entry<? extends Key, ? extends Value>>, InterfaceC1985a {
    ...
    public Iterator<Map.Entry<Key, Value>> iterator() {
        return AbstractC3001j.b(new IdentityArrayMap$asMap$1$entries$1$iterator$1(this.this$0, null)).iterator();
    }
