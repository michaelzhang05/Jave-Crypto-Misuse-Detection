...
public final class IdentityArrayMap$asMap$1$keys$1<Key> implements Set<Key>, InterfaceC1985a {
    ...
    public Iterator<Key> iterator() {
        return AbstractC3001j.b(new IdentityArrayMap$asMap$1$keys$1$iterator$1(this.this$0, null)).iterator();
    }
