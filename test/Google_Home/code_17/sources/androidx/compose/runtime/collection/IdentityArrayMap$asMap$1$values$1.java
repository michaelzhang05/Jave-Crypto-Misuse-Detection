...
public final class IdentityArrayMap$asMap$1$values$1<Value> implements Collection<Value>, InterfaceC1985a, j$.util.Collection {
    ...
    public boolean contains(Object obj) {
        ...
        for (int i8 = 0; i8 < size; i8++) {
            if (AbstractC3255y.d(this.this$0.getValues()[i8], obj)) {
                return true;
            }
        }
        return false;
    ...
    public Iterator<Value> iterator() {
        return AbstractC3001j.b(new IdentityArrayMap$asMap$1$values$1$iterator$1(this.this$0, null)).iterator();
    }
