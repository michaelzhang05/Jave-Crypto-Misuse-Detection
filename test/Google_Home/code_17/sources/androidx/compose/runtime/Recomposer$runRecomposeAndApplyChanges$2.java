...
public final class Recomposer$runRecomposeAndApplyChanges$2 extends kotlin.coroutines.jvm.internal.l implements InterfaceC1669o {
                            ...
                            if (list.isEmpty()) {
                                try {
                                    ...
                                    while (!list2.isEmpty()) {
                                        ...
                                        AbstractC1378t.D(set, performInsertValues);
                                        Recomposer$runRecomposeAndApplyChanges$2.invokeSuspend$fillToInsert(list2, recomposer2);
                                    }
                                } catch (Exception e8) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public Recomposer$runRecomposeAndApplyChanges$2(Recomposer recomposer, S5.d dVar) {
        super(3, dVar);
        this.this$0 = recomposer;
    }
    ...
    */
    ...
    public final Object invoke(M m8, MonotonicFrameClock monotonicFrameClock, S5.d dVar) {
        ...
        return recomposer$runRecomposeAndApplyChanges$2.invokeSuspend(I.f8278a);
    }
}
