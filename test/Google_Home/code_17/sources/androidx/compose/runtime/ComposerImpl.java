...
public final class ComposerImpl implements Composer {
    ...
    public final class CompositionContextImpl extends CompositionContext {
        ...
        public void composeInitial$runtime_release(ControlledComposition controlledComposition, InterfaceC1668n interfaceC1668n) {
            ComposerImpl.this.parentContext.composeInitial$runtime_release(controlledComposition, interfaceC1668n);
        }
        ...
        @Override // androidx.compose.runtime.CompositionContext
        public S5.g getEffectCoroutineContext() {
        ...
        @Override // androidx.compose.runtime.CompositionContext
        public S5.g getRecomposeCoroutineContext$runtime_release() {
        ...
        public void registerComposer$runtime_release(Composer composer) {
            AbstractC3255y.g(composer, "null cannot be cast to non-null type androidx.compose.runtime.ComposerImpl");
    ...
    */
    private final void addRecomposeScope() {
        /*
            ...
            kotlin.jvm.internal.AbstractC3255y.g(r2, r1)
        ...
        L24:
            ...
            kotlin.jvm.internal.AbstractC3255y.g(r3, r1)
    ...
    private final void doCompose(IdentityArrayMap<RecomposeScopeImpl, IdentityArraySet<Object>> identityArrayMap, InterfaceC1668n interfaceC1668n) {
        ...
        if (!this.isComposing) {
            ...
            try {
                ...
                for (int i8 = 0; i8 < size; i8++) {
                    ...
                    AbstractC3255y.g(obj, "null cannot be cast to non-null type Key of androidx.compose.runtime.collection.IdentityArrayMap");
                ...
                AbstractC1378t.B(list, comparator);
                this.nodeIndex = 0;
                this.isComposing = true;
                try {
                    startRoot();
                    Object nextSlot = nextSlot();
                    if (nextSlot != interfaceC1668n && interfaceC1668n != null) {
                        updateValue(interfaceC1668n);
                    }
                    ...
                    try {
                        ...
                        if (interfaceC1668n != null) {
                            ...
                            ActualJvm_jvmKt.invokeComposable(this, interfaceC1668n);
                            endGroup();
                        } else if ((this.forciblyRecompose || this.providersInvalid) && nextSlot != null && !AbstractC3255y.d(nextSlot, Composer.Companion.getEmpty())) {
                            startGroup(200, ComposerKt.getInvocation());
                            ActualJvm_jvmKt.invokeComposable(this, (InterfaceC1668n) Z.d(nextSlot, 2));
                            endGroup();
                        } else {
                            skipCurrentGroup();
                        }
    ...
    private final int groupCompoundKeyPart(SlotReader slotReader, int i8) {
        ...
        if (groupKey == 207 && (groupAux = slotReader.groupAux(i8)) != null && !AbstractC3255y.d(groupAux, Composer.Companion.getEmpty())) {
            ...
            while (i12 < size) {
                try {
                    ...
                    if (movableContentStateReference2 == null) {
                        if (AbstractC3255y.d(movableContentStateReference.getSlotTable$runtime_release(), this.insertTable)) {
                            createFreshInsertTable();
                        }
                        ...
                        if (!collectNodesFrom.isEmpty()) {
                            ...
                            if (AbstractC3255y.d(movableContentStateReference.getSlotTable$runtime_release(), this.slotTable)) {
    ...
    */
    public final void invokeMovableContentLambda(androidx.compose.runtime.MovableContent<java.lang.Object> r12, androidx.compose.runtime.PersistentCompositionLocalMap r13, java.lang.Object r14, boolean r15) {
        ...
        L28:
            ...
            boolean r0 = kotlin.jvm.internal.AbstractC3255y.d(r0, r13)     // Catch: java.lang.Throwable -> L1e
            if (r0 != 0) goto L35
            r3 = 1
        L35:
            if (r3 == 0) goto L3a
        ...
        L3a:
            ...
            int r5 = r5.m2483getGroupULZAiWs()     // Catch: java.lang.Throwable -> L1e
            r6 = 202(0xca, float:2.83E-43)
            r11.m2470startBaiHCIY(r6, r0, r5, r13)     // Catch: java.lang.Throwable -> L1e
            ...
            java.util.List r9 = P5.AbstractC1378t.m()     // Catch: java.lang.Throwable -> L1e
    ...
    private static final int reportFreeMovableContent$reportGroup(ComposerImpl composerImpl, int i8, boolean z8, int i9) {
        ...
        if (slotReader.hasMark(i8)) {
            ...
            if (groupKey == 206 && AbstractC3255y.d(groupObjectKey, ComposerKt.getReference())) {
    ...
    private final void m2470startBaiHCIY(int i8, Object obj, int i9, Object obj2) {
        boolean z8;
        boolean z9;
        Object obj3 = obj;
        ...
        int i10 = 0;
        if (i9 != companion.m2483getGroupULZAiWs()) {
            z8 = true;
        } else {
            z8 = false;
        }
        ...
        if (i9 == companion.m2484getNodeULZAiWs() && this.reusing) {
            z9 = true;
        } else {
            z9 = false;
        }
        if (this.pending == null) {
            ...
            if (!z9 && groupKey == i8 && AbstractC3255y.d(obj, this.reader.getGroupObjectKey())) {
    ...
    private final void startGroup(int i8) {
        m2470startBaiHCIY(i8, null, GroupKind.Companion.m2483getGroupULZAiWs(), null);
    }
    ...
    private final void updateCompoundKeyWhenWeEnterGroup(int i8, Object obj, Object obj2) {
        if (obj == null) {
            if (obj2 != null && i8 == 207 && !AbstractC3255y.d(obj2, Composer.Companion.getEmpty())) {
    ...
    private final void updateNodeCount(int i8, int i9) {
        if (updatedNodeCount(i8) != i9) {
            ...
            if (iArr == null) {
                ...
                AbstractC1371l.v(iArr, -1, 0, 0, 6, null);
                this.nodeCountOverrides = iArr;
            }
            iArr[i8] = i9;
        }
    ...
    public <V, T> void apply(V v8, InterfaceC1668n interfaceC1668n) {
        if (getInserting()) {
            this.insertFixups.updateNode(v8, interfaceC1668n);
        } else {
            this.changeListWriter.updateNode(v8, interfaceC1668n);
        }
    }
    ...
    public boolean changed(Object obj) {
        if (AbstractC3255y.d(nextSlot(), obj)) {
            return false;
        }
        updateValue(obj);
        return true;
    ...
    public final void composeContent$runtime_release(IdentityArrayMap<RecomposeScopeImpl, IdentityArraySet<Object>> identityArrayMap, InterfaceC1668n interfaceC1668n) {
        if (this.changes.isEmpty()) {
            doCompose(identityArrayMap, interfaceC1668n);
        } else {
    ...
    @Override // androidx.compose.runtime.Composer
    public S5.g getApplyCoroutineContext() {
    ...
    public void insertMovableContent(MovableContent<?> movableContent, Object obj) {
        AbstractC3255y.g(movableContent, "null cannot be cast to non-null type androidx.compose.runtime.MovableContent<kotlin.Any?>");
    ...
    public void startDefaults() {
        m2470startBaiHCIY(-127, null, GroupKind.Companion.m2483getGroupULZAiWs(), null);
    }

    @Override // androidx.compose.runtime.Composer
    @ComposeCompilerApi
    public void startMovableGroup(int i8, Object obj) {
        m2470startBaiHCIY(i8, obj, GroupKind.Companion.m2483getGroupULZAiWs(), null);
    }

    @Override // androidx.compose.runtime.Composer
    public void startNode() {
        m2470startBaiHCIY(125, null, GroupKind.Companion.m2484getNodeULZAiWs(), null);
    ...
    public void startProvider(ProvidedValue<?> providedValue) {
        ...
        if (AbstractC3255y.d(rememberedValue, Composer.Companion.getEmpty())) {
            state = null;
        } else {
            AbstractC3255y.g(rememberedValue, "null cannot be cast to non-null type androidx.compose.runtime.State<kotlin.Any?>");
            state = (State) rememberedValue;
        }
        CompositionLocal<?> compositionLocal = providedValue.getCompositionLocal();
        AbstractC3255y.g(compositionLocal, "null cannot be cast to non-null type androidx.compose.runtime.CompositionLocal<kotlin.Any?>");
        State<?> updatedStateOf$runtime_release = compositionLocal.updatedStateOf$runtime_release(providedValue.getValue(), state);
        boolean z8 = true;
        boolean z9 = !AbstractC3255y.d(updatedStateOf$runtime_release, state);
        if (z9) {
        ...
        if (getInserting()) {
            ...
            AbstractC3255y.g(groupAux, "null cannot be cast to non-null type androidx.compose.runtime.PersistentCompositionLocalMap");
        ...
        m2470startBaiHCIY(ComposerKt.compositionLocalMapKey, ComposerKt.getCompositionLocalMap(), GroupKind.Companion.m2483getGroupULZAiWs(), putValue);
    }
    ...
    public void startProviders(ProvidedValue<?>[] providedValueArr) {
        ...
        if (getInserting()) {
            ...
            AbstractC3255y.g(groupGet, "null cannot be cast to non-null type androidx.compose.runtime.PersistentCompositionLocalMap");
            ...
            AbstractC3255y.g(groupGet2, "null cannot be cast to non-null type androidx.compose.runtime.PersistentCompositionLocalMap");
            ...
            if (getSkipping() && !this.reusing && AbstractC3255y.d(persistentCompositionLocalMap2, updateCompositionMap)) {
                skipGroup();
                ...
                if (!this.reusing && AbstractC3255y.d(updateProviderMapGroup, persistentCompositionLocalMap)) {
                    z8 = false;
                }
                z9 = z8;
            }
        ...
        m2470startBaiHCIY(ComposerKt.compositionLocalMapKey, ComposerKt.getCompositionLocalMap(), GroupKind.Companion.m2483getGroupULZAiWs(), updateProviderMapGroup);
    }
    ...
    public void startReusableGroup(int i8, Object obj) {
        if (!getInserting() && this.reader.getGroupKey() == i8 && !AbstractC3255y.d(this.reader.getGroupAux(), obj) && this.reusingGroup < 0) {
            this.reusingGroup = this.reader.getCurrentGroup();
            this.reusing = true;
        }
        m2470startBaiHCIY(i8, null, GroupKind.Companion.m2483getGroupULZAiWs(), obj);
    }

    @Override // androidx.compose.runtime.Composer
    public void startReusableNode() {
        m2470startBaiHCIY(125, null, GroupKind.Companion.m2485getReusableNodeULZAiWs(), null);
        this.nodeExpected = true;
    }
    ...
    private final PersistentCompositionLocalMap currentCompositionLocalScope(int i8) {
        ...
        if (getInserting() && this.writerHasAProvider) {
            int parent = this.writer.getParent();
            while (parent > 0) {
                if (this.writer.groupKey(parent) == 202 && AbstractC3255y.d(this.writer.groupObjectKey(parent), ComposerKt.getCompositionLocalMap())) {
        ...
        if (this.reader.getSize() > 0) {
            while (i8 > 0) {
                if (this.reader.groupKey(i8) == 202 && AbstractC3255y.d(this.reader.groupObjectKey(i8), ComposerKt.getCompositionLocalMap())) {
                    IntMap<PersistentCompositionLocalMap> intMap = this.providerUpdates;
                    if (intMap == null || (persistentCompositionLocalMap = intMap.get(i8)) == null) {
                        Object groupAux2 = this.reader.groupAux(i8);
                        AbstractC3255y.g(groupAux2, "null cannot be cast to non-null type androidx.compose.runtime.PersistentCompositionLocalMap");
