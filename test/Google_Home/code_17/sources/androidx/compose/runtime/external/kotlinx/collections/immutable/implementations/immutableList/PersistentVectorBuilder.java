...
public final class PersistentVectorBuilder<E> extends AbstractC1365f implements PersistentList.Builder<E> {
    ...
    private final Object[] insertIntoRoot(Object[] objArr, int i8, int i9, Object obj, ObjectRef objectRef) {
        ...
        if (i8 == 0) {
            ...
            Object[] i10 = AbstractC1371l.i(objArr, makeMutable(objArr), indexSegment + 1, indexSegment, 31);
        ...
        AbstractC3255y.g(obj3, "null cannot be cast to non-null type kotlin.Array<kotlin.Any?>");
    ...
    private final void insertIntoTail(Object[] objArr, int i8, E e8) {
        ...
        if (tailSize < 32) {
            AbstractC1371l.i(this.tail, makeMutable, i8 + 1, i8, tailSize);
            makeMutable[i8] = e8;
            this.root = objArr;
        ...
        AbstractC1371l.i(objArr2, makeMutable, i8 + 1, i8, 31);
        makeMutable[i8] = e8;
    ...
    private final Object[] makeMutable(Object[] objArr) {
        ...
        return AbstractC1371l.n(objArr, mutableBuffer(), 0, 0, m.g(objArr.length, 32), 6, null);
    }

    private final Object[] makeMutableShiftingRight(Object[] objArr, int i8) {
        if (isMutable(objArr)) {
            return AbstractC1371l.i(objArr, objArr, i8, 0, 32 - i8);
        }
        return AbstractC1371l.i(objArr, mutableBuffer(), i8, 0, 32 - i8);
    }
    ...
    private final Object[] nullifyAfter(Object[] objArr, int i8, int i9) {
        if (i9 >= 0) {
            ...
            if (indexSegment < 31) {
                ...
                if (objArr[i10] != null) {
                    if (isMutable(objArr)) {
                        AbstractC1371l.t(objArr, null, i10, 32);
                    }
                    objArr = AbstractC1371l.i(objArr, mutableBuffer(), 0, 0, i10);
                }
            }
    ...
    private final Object[] pushBuffersIncreasingHeightIfNeeded(Object[] objArr, int i8, Object[][] objArr2) {
        Object[] makeMutable;
        Iterator<Object[]> a8 = AbstractC3237f.a(objArr2);
        int i9 = i8 >> 5;
    ...
    private final int removeAllFromTail(Function1 function1, int i8, ObjectRef objectRef) {
        ...
        AbstractC1371l.t(objArr, null, removeAll, i8);
        this.tail = objArr;
    ...
    private final Object[] removeFromRootAt(Object[] objArr, int i8, int i9, ObjectRef objectRef) {
        ...
        if (i8 == 0) {
            Object obj = objArr[indexSegment];
            Object[] i11 = AbstractC1371l.i(objArr, makeMutable(objArr), indexSegment, indexSegment + 1, 32);
    ...
    private final Object removeFromTailAt(Object[] objArr, int i8, int i9, int i10) {
        ...
        Object[] i11 = AbstractC1371l.i(objArr2, makeMutable(objArr2), i10, i10 + 1, size);
        i11[size - 1] = null;
        this.root = objArr;
        this.tail = i11;
        this.size = (i8 + size) - 1;
    ...
    private final Object[] shiftLeafBuffers(int i8, int i9, Object[][] objArr, int i10, Object[] objArr2) {
        if (this.root != null) {
            ...
            while (leafBufferIterator.previousIndex() != i8) {
                ...
                AbstractC1371l.i(previous, objArr2, 0, 32 - i9, 32);
    ...
    private final void splitToBuffers(Collection<? extends E> collection, int i8, Object[] objArr, int i9, Object[][] objArr2, int i10, Object[] objArr3) {
        ...
        if (i10 >= 1) {
            ...
            int i12 = (i9 - i11) + size;
            if (i12 < 32) {
                AbstractC1371l.i(makeMutable, objArr3, size + 1, i11, i9);
            } else {
                int i13 = i12 - 31;
                if (i10 == 1) {
                ...
                int i14 = i9 - i13;
                AbstractC1371l.i(makeMutable, objArr3, 0, i14, i9);
                AbstractC1371l.i(makeMutable, mutableBuffer, size + 1, i11, i14);
                objArr3 = mutableBuffer;
            }
    ...
    private final boolean removeAll(Function1 function1) {
        ...
        if (i8 == 32) {
            CommonFunctionsKt.m2587assert(!leafBufferIterator.hasNext());
        ...
        AbstractC3255y.g(value, "null cannot be cast to non-null type kotlin.Array<kotlin.Any?>");
        Object[] objArr = (Object[]) value;
        AbstractC1371l.t(objArr, null, recyclableRemoveAll, 32);
        if (arrayList.isEmpty()) {
            pushBuffers = this.root;
            AbstractC3255y.f(pushBuffers);
        } else {
    ...
    public boolean addAll(int i8, Collection<? extends E> collection) {
        ...
        if (size == 0) {
            CommonFunctionsKt.m2587assert(i8 >= rootSize());
            int i11 = i8 & 31;
            int size2 = ((i8 + collection.size()) - 1) & 31;
            Object[] objArr = this.tail;
            Object[] i12 = AbstractC1371l.i(objArr, makeMutable(objArr), size2 + 1, i11, tailSize());
        ...
        if (i8 >= rootSize()) {
            ...
            i9 = AbstractC1371l.i(this.tail, mutableBuffer(), 0, i14, tailSize);
            int i15 = 32 - i14;
