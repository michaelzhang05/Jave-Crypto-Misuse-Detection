...
public final class TrieNodeKt {
    ...
    public static final <K, V> Object[] insertEntryAtIndex(Object[] objArr, int i8, K k8, V v8) {
        ...
        AbstractC1371l.n(objArr, objArr2, 0, 0, i8, 6, null);
        AbstractC1371l.i(objArr, objArr2, i8 + 2, i8, objArr.length);
        objArr2[i8] = k8;
        objArr2[i8 + 1] = v8;
        return objArr2;
    }
    ...
    public static final Object[] removeEntryAtIndex(Object[] objArr, int i8) {
        Object[] objArr2 = new Object[objArr.length - 2];
        AbstractC1371l.n(objArr, objArr2, 0, 0, i8, 6, null);
        AbstractC1371l.i(objArr, objArr2, i8, i8 + 2, objArr.length);
        return objArr2;
    }
    ...
    public static final Object[] removeNodeAtIndex(Object[] objArr, int i8) {
        ...
        AbstractC1371l.n(objArr, objArr2, 0, 0, i8, 6, null);
        AbstractC1371l.i(objArr, objArr2, i8, i8 + 1, objArr.length);
        return objArr2;
    }
    ...
    public static final Object[] replaceEntryWithNode(Object[] objArr, int i8, int i9, TrieNode<?, ?> trieNode) {
        Object[] objArr2 = new Object[objArr.length - 1];
        AbstractC1371l.n(objArr, objArr2, 0, 0, i8, 6, null);
        AbstractC1371l.i(objArr, objArr2, i8, i8 + 2, i9);
        objArr2[i9 - 2] = trieNode;
        AbstractC1371l.i(objArr, objArr2, i9 - 1, i9, objArr.length);
        return objArr2;
    }
    ...
    public static final <K, V> Object[] replaceNodeWithEntry(Object[] objArr, int i8, int i9, K k8, V v8) {
        ...
        AbstractC1371l.i(copyOf, copyOf, i8 + 2, i8 + 1, objArr.length);
        AbstractC1371l.i(copyOf, copyOf, i9 + 2, i9, i8);
        copyOf[i9] = k8;
        copyOf[i9 + 1] = v8;
        return copyOf;
    }
