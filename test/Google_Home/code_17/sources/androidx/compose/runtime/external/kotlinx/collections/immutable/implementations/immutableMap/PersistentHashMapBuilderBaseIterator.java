...
public class PersistentHashMapBuilderBaseIterator<K, V, T> extends PersistentHashMapBaseIterator<K, V, T> implements Iterator<T>, InterfaceC1985a {
    ...
    private final void resetPath(int i8, TrieNode<?, ?> trieNode, K k8, int i9) {
        ...
        if (i10 > 30) {
            ...
            while (!AbstractC3255y.d(getPath()[i9].currentKey(), k8)) {
