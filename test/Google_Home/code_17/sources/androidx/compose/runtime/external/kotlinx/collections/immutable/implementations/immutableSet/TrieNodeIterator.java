...
public final class TrieNodeIterator<E> {
    ...
    public final E currentElement() {
        CommonFunctionsKt.m2587assert(hasNextElement());
        return (E) this.buffer[this.index];
    }

    public final TrieNode<? extends E> currentNode() {
        CommonFunctionsKt.m2587assert(hasNextNode());
        Object obj = this.buffer[this.index];
        AbstractC3255y.g(obj, "null cannot be cast to non-null type androidx.compose.runtime.external.kotlinx.collections.immutable.implementations.immutableSet.TrieNode<E of androidx.compose.runtime.external.kotlinx.collections.immutable.implementations.immutableSet.TrieNodeIterator>");
        return (TrieNode) obj;
    }
    ...
    public final void moveToNextCell() {
        CommonFunctionsKt.m2587assert(hasNextCell());
        this.index++;
    }
