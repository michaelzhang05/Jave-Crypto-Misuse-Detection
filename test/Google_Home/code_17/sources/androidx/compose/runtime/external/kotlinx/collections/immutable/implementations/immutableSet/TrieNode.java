...
public final class TrieNode<E> {
    ...
    private final boolean collisionContainsElement(E e8) {
        return AbstractC1371l.W(this.buffer, e8);
    }

    private final TrieNode<E> collisionRemove(E e8) {
        int p02 = AbstractC1371l.p0(this.buffer, e8);
        if (p02 != -1) {
    ...
    private final TrieNode<E> mutableCollisionAddAll(TrieNode<E> trieNode, DeltaCounter deltaCounter, MutabilityOwnership mutabilityOwnership) {
        ...
        if (AbstractC3255y.d(this.ownedBy, mutabilityOwnership)) {
            this.buffer = copyOf;
            return this;
        }
    ...
    private final Object mutableCollisionRemoveAll(TrieNode<E> trieNode, DeltaCounter deltaCounter, MutabilityOwnership mutabilityOwnership) {
        ...
        if (AbstractC3255y.d(mutabilityOwnership, this.ownedBy)) {
            objArr = this.buffer;
        } else {
    ...
    private final TrieNode<E> nodeAtIndex(int i8) {
        ...
        AbstractC3255y.g(obj, "null cannot be cast to non-null type androidx.compose.runtime.external.kotlinx.collections.immutable.implementations.immutableSet.TrieNode<E of androidx.compose.runtime.external.kotlinx.collections.immutable.implementations.immutableSet.TrieNode>");
        return (TrieNode) obj;
    }
    ...
    public final boolean contains(int i8, E e8, int i9) {
        ...
        return AbstractC3255y.d(e8, obj);
    }
    ...
    public final boolean containsAll(TrieNode<E> trieNode, int i8) {
        ...
        if (i8 > 30) {
            for (Object obj : trieNode.buffer) {
                if (!AbstractC1371l.W(this.buffer, obj)) {
                    return false;
                }
            }
            return true;
        ...
        while (i12 != 0) {
            ...
            if (z8 && z9) {
                AbstractC3255y.g(obj2, "null cannot be cast to non-null type androidx.compose.runtime.external.kotlinx.collections.immutable.implementations.immutableSet.TrieNode<E of androidx.compose.runtime.external.kotlinx.collections.immutable.implementations.immutableSet.TrieNode.containsAll$lambda$13>");
                AbstractC3255y.g(obj3, "null cannot be cast to non-null type androidx.compose.runtime.external.kotlinx.collections.immutable.implementations.immutableSet.TrieNode<E of androidx.compose.runtime.external.kotlinx.collections.immutable.implementations.immutableSet.TrieNode.containsAll$lambda$13>");
            ...
            } else if (z9 || !AbstractC3255y.d(obj2, obj3)) {
                return false;
            }
            i12 ^= lowestOneBit;
        }
    ...
    public final TrieNode<E> mutableAddAll(TrieNode<E> trieNode, int i8, DeltaCounter deltaCounter, PersistentHashSetBuilder<?> persistentHashSetBuilder) {
        ...
        if (i15 == i14 && AbstractC3255y.d(this.ownedBy, persistentHashSetBuilder.getOwnership$runtime_release())) {
            trieNode2 = this;
        } else {
        ...
        while (i16 != 0) {
            ...
            if (hasNoCellAt(lowestOneBit)) {
                ...
                if (z8 && z9) {
                    AbstractC3255y.g(obj, "null cannot be cast to non-null type androidx.compose.runtime.external.kotlinx.collections.immutable.implementations.immutableSet.TrieNode<E of androidx.compose.runtime.external.kotlinx.collections.immutable.implementations.immutableSet.TrieNode.mutableAddAll$lambda$6>");
                    AbstractC3255y.g(obj2, "null cannot be cast to non-null type androidx.compose.runtime.external.kotlinx.collections.immutable.implementations.immutableSet.TrieNode<E of androidx.compose.runtime.external.kotlinx.collections.immutable.implementations.immutableSet.TrieNode.mutableAddAll$lambda$6>");
                    ...
                    if (z8) {
                        ...
                        I i19 = I.f8278a;
                    } else if (AbstractC3255y.d(obj, obj2)) {
                        deltaCounter.setCount(deltaCounter.getCount() + 1);
                        I i20 = I.f8278a;
                        makeNode = obj;
                    } else {
    ...
    */
    ...
    public final Object mutableRetainAll(TrieNode<E> trieNode, int i8, DeltaCounter deltaCounter, PersistentHashSetBuilder<?> persistentHashSetBuilder) {
        ...
        if (AbstractC3255y.d(this.ownedBy, persistentHashSetBuilder.getOwnership$runtime_release()) && i11 == this.bitmap) {
            trieNode2 = this;
        } else {
        ...
        while (i12 != 0) {
            ...
            if (z10 && z11) {
                ...
                AbstractC3255y.g(obj2, "null cannot be cast to non-null type androidx.compose.runtime.external.kotlinx.collections.immutable.implementations.immutableSet.TrieNode<E of androidx.compose.runtime.external.kotlinx.collections.immutable.implementations.immutableSet.TrieNode.mutableRetainAll$lambda$9$lambda$8>");
