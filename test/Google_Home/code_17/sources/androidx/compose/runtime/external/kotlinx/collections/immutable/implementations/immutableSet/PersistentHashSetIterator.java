...
public class PersistentHashSetIterator<E> implements Iterator<E>, InterfaceC1985a {
    ...
    public PersistentHashSetIterator(TrieNode<E> trieNode) {
        List<TrieNodeIterator<E>> s8 = AbstractC1378t.s(new TrieNodeIterator());
        this.path = s8;
        this.hasNext = true;
    ...
    public final E currentElement() {
        CommonFunctionsKt.m2587assert(hasNext());
