...
public final class PersistentOrderedMapBuilder<K, V> extends AbstractC1366g implements PersistentMap.Builder<K, V>, Map {
    ...
    public V put(K k8, V v8) {
        ...
        CommonFunctionsKt.m2587assert(!r2.getHasNext());
    ...
    public final boolean remove(Object obj, Object obj2) {
        LinkedValue<V> linkedValue = this.hashMapBuilder.get(obj);
        if (linkedValue == null || !AbstractC3255y.d(linkedValue.getValue(), obj2)) {
            return false;
        }
        remove(obj);
        return true;
