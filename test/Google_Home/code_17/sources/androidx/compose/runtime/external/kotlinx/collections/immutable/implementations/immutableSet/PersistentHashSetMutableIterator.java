...
public final class PersistentHashSetMutableIterator<E> extends PersistentHashSetIterator<E> implements Iterator<E>, InterfaceC1985a {
    ...
    private final void resetPath(int i8, TrieNode<?> trieNode, E e8, int i9) {
        ...
        if (isCollision(trieNode)) {
            int p02 = AbstractC1371l.p0(trieNode.getBuffer(), e8);
            if (p02 == -1) {
                z8 = false;
            }
