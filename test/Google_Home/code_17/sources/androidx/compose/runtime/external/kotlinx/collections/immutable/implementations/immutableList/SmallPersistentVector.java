...
public final class SmallPersistentVector<E> extends AbstractPersistentList<E> implements ImmutableList<E> {
    ...
    public int indexOf(Object obj) {
        return AbstractC1371l.p0(this.buffer, obj);
    }

    @Override // P5.AbstractC1362c, java.util.List
    public int lastIndexOf(Object obj) {
        return AbstractC1371l.B0(this.buffer, obj);
    }
    ...
    public PersistentList<E> removeAt(int i8) {
        ...
        AbstractC1371l.i(this.buffer, copyOf, i8, i8 + 1, size());
    ...
    public PersistentList<E> removeAll(Function1 function1) {
        ...
        for (int i8 = 0; i8 < size2; i8++) {
            ...
            if (((Boolean) function1.invoke(obj)).booleanValue()) {
                if (!z8) {
                    ...
                    AbstractC3255y.h(objArr, "copyOf(this, size)");
                    z8 = true;
                    size = i8;
                }
            } else if (z8) {
        ...
        return new SmallPersistentVector(AbstractC1371l.p(objArr, 0, size));
    }
    ...
    public PersistentList<E> add(int i8, E e8) {
        ...
        if (size() < 32) {
            ...
            AbstractC1371l.n(this.buffer, bufferOfSize, 0, 0, i8, 6, null);
            AbstractC1371l.i(this.buffer, bufferOfSize, i8 + 1, i8, size());
            bufferOfSize[i8] = e8;
        ...
        Object[] copyOf = Arrays.copyOf(objArr, objArr.length);
        AbstractC3255y.h(copyOf, "copyOf(this, size)");
        AbstractC1371l.i(this.buffer, copyOf, i8 + 1, i8, size() - 1);
        copyOf[i8] = e8;
    ...
    public PersistentList<E> addAll(int i8, Collection<? extends E> collection) {
        ...
        if (size() + collection.size() <= 32) {
            ...
            AbstractC1371l.n(this.buffer, bufferOfSize, 0, 0, i8, 6, null);
            AbstractC1371l.i(this.buffer, bufferOfSize, collection.size() + i8, i8, size());
            Iterator<? extends E> it = collection.iterator();
            while (it.hasNext()) {
