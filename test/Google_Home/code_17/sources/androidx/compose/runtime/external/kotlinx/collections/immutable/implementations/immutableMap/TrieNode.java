...
public final class TrieNode<K, V> {
    ...
    private final void accept(InterfaceC1671q interfaceC1671q, int i8, int i9) {
        interfaceC1671q.invoke(this, Integer.valueOf(i9), Integer.valueOf(i8), Integer.valueOf(this.dataMap), Integer.valueOf(this.nodeMap));
        int i10 = this.nodeMap;
        while (i10 != 0) {
            int lowestOneBit = Integer.lowestOneBit(i10);
            nodeAtIndex$runtime_release(nodeIndex$runtime_release(lowestOneBit)).accept(interfaceC1671q, (Integer.numberOfTrailingZeros(lowestOneBit) << i9) + i8, i9 + 5);
            i10 -= lowestOneBit;
        }
    }
    ...
    private final boolean collisionContainsKey(K k8) {
        C2887g r8 = m.r(m.s(0, this.buffer.length), 2);
        int e8 = r8.e();
        int f8 = r8.f();
        int j8 = r8.j();
        if ((j8 > 0 && e8 <= f8) || (j8 < 0 && f8 <= e8)) {
            while (!AbstractC3255y.d(k8, this.buffer[e8])) {
                if (e8 != f8) {
                    e8 += j8;
                }
            }
    ...
    private final V collisionGet(K k8) {
        ...
        int j8 = r8.j();
        if ((j8 > 0 && e8 <= f8) || (j8 < 0 && f8 <= e8)) {
            while (!AbstractC3255y.d(k8, keyAtIndex(e8))) {
                if (e8 != f8) {
                    e8 += j8;
                } else {
                    return null;
    ...
    private final TrieNode<K, V> collisionRemove(K k8) {
        ...
        if ((j8 > 0 && e8 <= f8) || (j8 < 0 && f8 <= e8)) {
            ...
            return collisionRemoveEntryAtIndex(e8);
        }
        return this;
    }
    ...
    private final TrieNode<K, V> mutableCollisionPut(K k8, V v8, PersistentHashMapBuilder<K, V> persistentHashMapBuilder) {
        ...
        if ((j8 > 0 && e8 <= f8) || (j8 < 0 && f8 <= e8)) {
            ...
            persistentHashMapBuilder.setOperationResult$runtime_release(valueAtKeyIndex(e8));
    ...
    private final TrieNode<K, V> mutableCollisionPutAll(TrieNode<K, V> trieNode, DeltaCounter deltaCounter, MutabilityOwnership mutabilityOwnership) {
        ...
        CommonFunctionsKt.m2587assert(z9);
        if (trieNode.nodeMap == 0) {
            z10 = true;
        } else {
            z10 = false;
        }
        CommonFunctionsKt.m2587assert(z10);
        if (trieNode.dataMap == 0) {
            z11 = true;
        } else {
            z11 = false;
        }
        CommonFunctionsKt.m2587assert(z11);
        Object[] objArr = this.buffer;
        Object[] copyOf = Arrays.copyOf(objArr, objArr.length + trieNode.buffer.length);
        AbstractC3255y.h(copyOf, "copyOf(this, newSize)");
        int length = this.buffer.length;
        C2887g r8 = m.r(m.s(0, trieNode.buffer.length), 2);
        int e8 = r8.e();
        int f8 = r8.f();
        int j8 = r8.j();
        if ((j8 > 0 && e8 <= f8) || (j8 < 0 && f8 <= e8)) {
            while (true) {
                if (!collisionContainsKey(trieNode.buffer[e8])) {
    ...
    private final TrieNode<K, V> mutableCollisionRemove(K k8, PersistentHashMapBuilder<K, V> persistentHashMapBuilder) {
        ...
        if ((j8 > 0 && e8 <= f8) || (j8 < 0 && f8 <= e8)) {
            ...
            return mutableCollisionRemoveEntryAtIndex(e8, persistentHashMapBuilder);
        }
        return this;
    }
    ...
    public final void accept$runtime_release(InterfaceC1671q interfaceC1671q) {
        accept(interfaceC1671q, 0, 0);
    }
    ...
    public final boolean containsKey(int i8, K k8, int i9) {
        ...
        if (hasEntryAt$runtime_release(indexSegment)) {
            return AbstractC3255y.d(k8, keyAtIndex(entryKeyIndex$runtime_release(indexSegment)));
        }
    ...
    public final V get(int i8, K k8, int i9) {
        ...
        if (hasEntryAt$runtime_release(indexSegment)) {
            ...
            if (!AbstractC3255y.d(k8, keyAtIndex(entryKeyIndex$runtime_release))) {
                return null;
            }
    ...
    public final TrieNode<K, V> mutablePutAll(TrieNode<K, V> trieNode, int i8, DeltaCounter deltaCounter, PersistentHashMapBuilder<K, V> persistentHashMapBuilder) {
        ...
        while (i13 != 0) {
            ...
            if (AbstractC3255y.d(keyAtIndex(entryKeyIndex$runtime_release(lowestOneBit)), trieNode.keyAtIndex(trieNode.entryKeyIndex$runtime_release(lowestOneBit)))) {
                i14 |= lowestOneBit;
            } else {
                i9 |= lowestOneBit;
            }
        ...
        if ((i9 & i14) == 0) {
            if (AbstractC3255y.d(this.ownedBy, persistentHashMapBuilder.getOwnership()) && this.dataMap == i14 && this.nodeMap == i9) {
                trieNode2 = this;
            } else {
    ...
    public final TrieNode<K, V> mutableRemove(int i8, K k8, int i9, PersistentHashMapBuilder<K, V> persistentHashMapBuilder) {
        ...
        if (hasEntryAt$runtime_release(indexSegment)) {
            int entryKeyIndex$runtime_release = entryKeyIndex$runtime_release(indexSegment);
            return AbstractC3255y.d(k8, keyAtIndex(entryKeyIndex$runtime_release)) ? mutableRemoveEntryAtIndex(entryKeyIndex$runtime_release, indexSegment, persistentHashMapBuilder) : this;
        }
        if (!hasNodeAt(indexSegment)) {
            return this;
        }
    ...
    public final TrieNode<K, V> nodeAtIndex$runtime_release(int i8) {
        ...
        AbstractC3255y.g(obj, "null cannot be cast to non-null type androidx.compose.runtime.external.kotlinx.collections.immutable.implementations.immutableMap.TrieNode<K of androidx.compose.runtime.external.kotlinx.collections.immutable.implementations.immutableMap.TrieNode, V of androidx.compose.runtime.external.kotlinx.collections.immutable.implementations.immutableMap.TrieNode>");
        return (TrieNode) obj;
    }
    ...
    public final TrieNode<K, V> remove(int i8, K k8, int i9) {
        ...
        if (hasEntryAt$runtime_release(indexSegment)) {
            int entryKeyIndex$runtime_release = entryKeyIndex$runtime_release(indexSegment);
            return AbstractC3255y.d(k8, keyAtIndex(entryKeyIndex$runtime_release)) ? removeEntryAtIndex(entryKeyIndex$runtime_release, indexSegment) : this;
        }
        if (!hasNodeAt(indexSegment)) {
            return this;
        }
    ...
    private final TrieNode<K, V> collisionRemove(K k8, V v8) {
        ...
        if ((j8 > 0 && e8 <= f8) || (j8 < 0 && f8 <= e8)) {
            while (true) {
                if (!AbstractC3255y.d(k8, keyAtIndex(e8)) || !AbstractC3255y.d(v8, valueAtKeyIndex(e8))) {
                    if (e8 == f8) {
                        break;
                    }
                    e8 += j8;
    ...
    public final TrieNode<K, V> mutableRemove(int i8, K k8, V v8, int i9, PersistentHashMapBuilder<K, V> persistentHashMapBuilder) {
        ...
        if (hasEntryAt$runtime_release(indexSegment)) {
            int entryKeyIndex$runtime_release = entryKeyIndex$runtime_release(indexSegment);
            return (AbstractC3255y.d(k8, keyAtIndex(entryKeyIndex$runtime_release)) && AbstractC3255y.d(v8, valueAtKeyIndex(entryKeyIndex$runtime_release))) ? mutableRemoveEntryAtIndex(entryKeyIndex$runtime_release, indexSegment, persistentHashMapBuilder) : this;
        }
        if (!hasNodeAt(indexSegment)) {
            return this;
        }
    ...
    public final TrieNode<K, V> remove(int i8, K k8, V v8, int i9) {
        ...
        if (hasEntryAt$runtime_release(indexSegment)) {
            int entryKeyIndex$runtime_release = entryKeyIndex$runtime_release(indexSegment);
            return (AbstractC3255y.d(k8, keyAtIndex(entryKeyIndex$runtime_release)) && AbstractC3255y.d(v8, valueAtKeyIndex(entryKeyIndex$runtime_release))) ? removeEntryAtIndex(entryKeyIndex$runtime_release, indexSegment) : this;
        }
        if (!hasNodeAt(indexSegment)) {
            return this;
        }
