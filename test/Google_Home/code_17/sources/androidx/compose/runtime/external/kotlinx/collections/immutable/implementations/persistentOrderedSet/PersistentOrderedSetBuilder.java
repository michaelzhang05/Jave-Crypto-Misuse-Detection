...
public final class PersistentOrderedSetBuilder<E> extends AbstractC1367h implements PersistentSet.Builder<E> {
    ...
    public PersistentSet<E> build() {
        ...
        if (build2 == this.set.getHashMap$runtime_release()) {
            CommonFunctionsKt.m2587assert(this.firstElement == this.set.getFirstElement$runtime_release());
            CommonFunctionsKt.m2587assert(this.lastElement == this.set.getLastElement$runtime_release());
