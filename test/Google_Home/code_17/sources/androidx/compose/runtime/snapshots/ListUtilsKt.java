...
public final class ListUtilsKt {
    ...
    public static final <T> List<T> fastFilterIndexed(List<? extends T> list, InterfaceC1668n interfaceC1668n) {
        ArrayList arrayList = new ArrayList(list.size());
        int size = list.size();
        for (int i8 = 0; i8 < size; i8++) {
            T t8 = list.get(i8);
            if (((Boolean) interfaceC1668n.invoke(Integer.valueOf(i8), t8)).booleanValue()) {
                arrayList.add(t8);
            }
        }
        return arrayList;
