...
public final class SnapshotStateObserver {
    ...
    private final InterfaceC1668n applyObserver = new SnapshotStateObserver$applyObserver$1(this);
    ...
    public final void addChanges(Set<? extends Object> set) {
        ...
        do {
            ...
            if (obj == null) {
                ...
                G02 = AbstractC1378t.p(obj, set);
            } else if (obj instanceof List) {
                G02 = AbstractC1378t.G0((Collection) obj, AbstractC1378t.e(set));
            } else {
                report();
                throw new C1352h();
            }
    ...
    private final <T> ObservedScopeMap ensureMap(Function1 function1) {
        ...
        if (observedScopeMap2 == null) {
            AbstractC3255y.g(function1, "null cannot be cast to non-null type kotlin.Function1<kotlin.Any, kotlin.Unit>");
    ...
    private final void removeScopeMapIf(Function1 function1) {
        synchronized (this.observedScopeMaps) {
            try {
                ...
                int i10 = size - i8;
                AbstractC1371l.t(mutableVector.getContent(), null, i10, size);
    ...
    public static final class ObservedScopeMap {
        ...
        public ObservedScopeMap(Function1 function1) {
            ...
            this.scopeToValues = new MutableScatterMap<>(i8, i9, abstractC3247p);
            this.invalidated = new MutableScatterSet<>(i8, i9, abstractC3247p);
        }
            ...
            if (obj != null) {
                ...
                if (obj instanceof MutableScatterSet) {
                                ...
                                while (i12 < i11) {
                                    if ((j8 & 255) < 128) {
                                        ...
                                        if (mutableObjectIntMap2 == null) {
                                            mutableObjectIntMap = new MutableObjectIntMap<>(i9, i8, abstractC3247p);
                    ...
                    if (mutableObjectIntMap3 == null) {
                        mutableObjectIntMap3 = new MutableObjectIntMap<>(i9, i8, abstractC3247p);
        ...
        private final void recordRead(Object obj, int i8, Object obj2, MutableObjectIntMap<Object> mutableObjectIntMap) {
                            ...
                            for (int i11 = 0; i11 < i10; i11++) {
                                if ((j8 & 255) < 128) {
                                    ...
                                    if (stateObject instanceof StateObjectImpl) {
                                        ((StateObjectImpl) stateObject).m2612recordReadInh_f27i8$runtime_release(ReaderKind.m2596constructorimpl(2));
                                    }
            ...
            if (put == -1) {
                if (obj instanceof StateObjectImpl) {
                    ((StateObjectImpl) obj).m2612recordReadInh_f27i8$runtime_release(ReaderKind.m2596constructorimpl(2));
                }
