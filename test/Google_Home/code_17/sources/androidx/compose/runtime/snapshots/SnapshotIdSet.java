...
public final class SnapshotIdSet implements Iterable<Integer>, InterfaceC1985a {
    ...
    public final SnapshotIdSet and(SnapshotIdSet snapshotIdSet) {
        ...
        if (AbstractC3255y.d(snapshotIdSet, snapshotIdSet2)) {
            return snapshotIdSet2;
        }
        if (AbstractC3255y.d(this, snapshotIdSet2)) {
            return snapshotIdSet2;
        }
    ...
    public final SnapshotIdSet clear(int i8) {
        ...
        if (i10 >= 0 && i10 < 64) {
            ...
            if (binarySearch > 0) {
                AbstractC1371l.g(iArr, iArr2, 0, 0, binarySearch);
            }
            if (binarySearch < i11) {
                AbstractC1371l.g(iArr, iArr2, binarySearch, binarySearch + 1, length);
            }
    ...
    public Iterator<Integer> iterator() {
        return AbstractC3001j.b(new SnapshotIdSet$iterator$1(this, null)).iterator();
    }
    ...
    public final SnapshotIdSet set(int i8) {
        ...
        if (i11 >= 0 && i11 < 64) {
            ...
            if (!get(i8)) {
                ...
                if (arrayList == null || (iArr = AbstractC1378t.V0(arrayList)) == null) {
            ...
            if (binarySearch < 0) {
                ...
                AbstractC1371l.g(iArr3, iArr4, 0, 0, i16);
                AbstractC1371l.g(iArr3, iArr4, i16 + 1, i16, length);
                iArr4[i16] = i8;
    ...
    public String toString() {
        ...
        sb.append(" [");
        ArrayList arrayList = new ArrayList(AbstractC1378t.x(this, 10));
        Iterator<Integer> it = iterator();
        while (it.hasNext()) {
