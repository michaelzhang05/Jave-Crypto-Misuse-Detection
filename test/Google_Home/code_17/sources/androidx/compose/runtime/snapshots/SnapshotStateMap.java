...
public final class SnapshotStateMap<K, V> implements StateObject, Map<K, V>, InterfaceC1988d {
    ...
    public static final class StateMapStateRecord<K, V> extends StateRecord {
        ...
        public void assign(StateRecord stateRecord) {
            Object obj;
            AbstractC3255y.g(stateRecord, "null cannot be cast to non-null type androidx.compose.runtime.snapshots.SnapshotStateMap.StateMapStateRecord<K of androidx.compose.runtime.snapshots.SnapshotStateMap.StateMapStateRecord, V of androidx.compose.runtime.snapshots.SnapshotStateMap.StateMapStateRecord>");
    ...
    private final <R> R mutate(Function1 function1) {
        ...
        do {
            ...
            if (AbstractC3255y.d(build, map$runtime_release)) {
                break;
            }
    ...
    public void prependStateRecord(StateRecord stateRecord) {
        AbstractC3255y.g(stateRecord, "null cannot be cast to non-null type androidx.compose.runtime.snapshots.SnapshotStateMap.StateMapStateRecord<K of androidx.compose.runtime.snapshots.SnapshotStateMap, V of androidx.compose.runtime.snapshots.SnapshotStateMap>");
    ...
    public final boolean removeValue$runtime_release(V v8) {
        ...
        while (true) {
            if (it.hasNext()) {
                obj = it.next();
                if (AbstractC3255y.d(((Map.Entry) obj).getValue(), v8)) {
                    break;
                }
            } else {
                obj = null;
