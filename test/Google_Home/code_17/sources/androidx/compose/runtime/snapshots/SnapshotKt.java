...
public final class SnapshotKt {
    ...
    private static List<? extends InterfaceC1668n> applyObservers;
    ...
    static {
        ...
        applyObservers = AbstractC1378t.m();
        globalWriteObservers = AbstractC1378t.m();
    ...
    public static final <T> T advanceGlobalSnapshot(Function1 function1) {
        ...
        AbstractC3255y.g(snapshot, "null cannot be cast to non-null type androidx.compose.runtime.snapshots.GlobalSnapshot");
        ...
        if (modified$runtime_release != null) {
            try {
                List<? extends InterfaceC1668n> list = applyObservers;
                int size = list.size();
    ...
    public static final Function1 mergedReadObserver(Function1 function1, Function1 function12, boolean z8) {
        ...
        if (function1 != null && function12 != null && !AbstractC3255y.d(function1, function12)) {
    ...
    public static final <T extends StateRecord> T newOverwritableRecordLocked(T t8, StateObject stateObject) {
        ...
        AbstractC3255y.g(t10, "null cannot be cast to non-null type T of androidx.compose.runtime.snapshots.SnapshotKt.newOverwritableRecordLocked$lambda$15");
        stateObject.prependStateRecord(t10);
        AbstractC3255y.g(t10, "null cannot be cast to non-null type T of androidx.compose.runtime.snapshots.SnapshotKt.newOverwritableRecordLocked");
        return t10;
    }
    ...
    public static final Map<StateRecord, StateRecord> optimisticMerges(MutableSnapshot mutableSnapshot, MutableSnapshot mutableSnapshot2, SnapshotIdSet snapshotIdSet) {
        ...
        for (int i8 = 0; i8 < size; i8++) {
            ...
            if (readable2 != null && (readable = readable(firstStateRecord, id, or)) != null && !AbstractC3255y.d(readable2, readable)) {
    ...
    public static final <T extends StateRecord> T overwritableRecord(T t8, StateObject stateObject, Snapshot snapshot, T t9) {
        ...
        if (snapshot.getReadOnly()) {
            snapshot.mo2593recordModified$runtime_release(stateObject);
        }
    ...
    public static final <T extends StateRecord> T readable(T t8, StateObject stateObject) {
        ...
        synchronized (getLock()) {
            Snapshot current2 = companion.getCurrent();
            StateRecord firstStateRecord = stateObject.getFirstStateRecord();
            AbstractC3255y.g(firstStateRecord, "null cannot be cast to non-null type T of androidx.compose.runtime.snapshots.SnapshotKt.readable$lambda$9");
