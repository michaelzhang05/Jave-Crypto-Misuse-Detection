...
public abstract class Snapshot {
    ...
    public static final class Companion {
        ...
        public static final void registerApplyObserver$lambda$6(InterfaceC1668n interfaceC1668n) {
            synchronized (SnapshotKt.getLock()) {
                SnapshotKt.access$setApplyObservers$p(AbstractC1378t.E0(SnapshotKt.access$getApplyObservers$p(), interfaceC1668n));
                I i8 = I.f8278a;
            }
        }
        ...
        public static final void registerGlobalWriteObserver$lambda$9(Function1 function1) {
            synchronized (SnapshotKt.getLock()) {
                SnapshotKt.access$setGlobalWriteObservers$p(AbstractC1378t.E0(SnapshotKt.access$getGlobalWriteObservers$p(), function1));
                I i8 = I.f8278a;
            }
        ...
        public final int openSnapshotCount() {
            return AbstractC1378t.W0(SnapshotKt.access$getOpenSnapshots$p()).size();
        }

        public final ObserverHandle registerApplyObserver(final InterfaceC1668n interfaceC1668n) {
            SnapshotKt.access$advanceGlobalSnapshot(SnapshotKt.access$getEmptyLambda$p());
            synchronized (SnapshotKt.getLock()) {
                SnapshotKt.access$setApplyObservers$p(AbstractC1378t.H0(SnapshotKt.access$getApplyObservers$p(), interfaceC1668n));
                I i8 = I.f8278a;
            }
            return new ObserverHandle() { // from class: androidx.compose.runtime.snapshots.a
                @Override // androidx.compose.runtime.snapshots.ObserverHandle
                public final void dispose() {
                    Snapshot.Companion.registerApplyObserver$lambda$6(InterfaceC1668n.this);
                }
            };
        }
        ...
        public final ObserverHandle registerGlobalWriteObserver(final Function1 function1) {
            synchronized (SnapshotKt.getLock()) {
                SnapshotKt.access$setGlobalWriteObservers$p(AbstractC1378t.H0(SnapshotKt.access$getGlobalWriteObservers$p(), function1));
                I i8 = I.f8278a;
            }
            SnapshotKt.access$advanceGlobalSnapshot();
    ...
    public /* synthetic */ Snapshot(int i8, SnapshotIdSet snapshotIdSet, AbstractC3247p abstractC3247p) {
    ...
    public abstract void mo2590nestedActivated$runtime_release(Snapshot snapshot);

    /* renamed from: nestedDeactivated$runtime_release */
    public abstract void mo2591nestedDeactivated$runtime_release(Snapshot snapshot);

    public abstract void notifyObjectsInitialized$runtime_release();

    /* renamed from: recordModified$runtime_release */
    public abstract void mo2593recordModified$runtime_release(StateObject stateObject);
