...
public final class CompositionLocalKt {
    ...
    public static final void CompositionLocalProvider(ProvidedValue<?>[] providedValueArr, InterfaceC1668n interfaceC1668n, Composer composer, int i8) {
        ...
        interfaceC1668n.invoke(startRestartGroup, Integer.valueOf((i8 >> 3) & 14));
        ...
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new CompositionLocalKt$CompositionLocalProvider$1(providedValueArr, interfaceC1668n, i8));
        }
    }
    ...
    @Composable
    @ComposableInferredTarget(scheme = "[0[0]]")
    public static final void CompositionLocalProvider(ProvidedValue<?> providedValue, InterfaceC1668n interfaceC1668n, Composer composer, int i8) {
        ...
        ScopeUpdateScope endRestartGroup = startRestartGroup.endRestartGroup();
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new CompositionLocalKt$CompositionLocalProvider$2(providedValue, interfaceC1668n, i8));
        }
    }

    @Composable
    @ComposableInferredTarget(scheme = "[0[0]]")
    public static final void CompositionLocalProvider(CompositionLocalContext compositionLocalContext, InterfaceC1668n interfaceC1668n, Composer composer, int i8) {
        ...
        if ((i8 & 112) == 0) {
            i9 |= startRestartGroup.changedInstance(interfaceC1668n) ? 32 : 16;
        }
        if ((i9 & 91) == 18 && startRestartGroup.getSkipping()) {
            ...
            for (Map.Entry<CompositionLocal<Object>, State<? extends Object>> entry : compositionLocals$runtime_release.entrySet()) {
                ...
                AbstractC3255y.g(key, "null cannot be cast to non-null type androidx.compose.runtime.ProvidableCompositionLocal<kotlin.Any?>");
            ...
            CompositionLocalProvider((ProvidedValue<?>[]) Arrays.copyOf(providedValueArr, providedValueArr.length), interfaceC1668n, startRestartGroup, (i9 & 112) | 8);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        }
        ScopeUpdateScope endRestartGroup = startRestartGroup.endRestartGroup();
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new CompositionLocalKt$CompositionLocalProvider$4(compositionLocalContext, interfaceC1668n, i8));
        }
    }
}
