...
public final class Pending {
    ...
    private final InterfaceC1355k keyMap$delegate;
    ...
    public Pending(List<KeyInfo> list, int i8) {
        ...
        if (i8 >= 0) {
            ...
            this.keyMap$delegate = O5.l.b(new Pending$keyMap$2(this));
            return;
        }
    ...
    public final boolean updateNodeCount(int i8, int i9) {
        ...
        if (groupInfo != null) {
            ...
            if (nodeCount != 0) {
                for (GroupInfo groupInfo2 : this.groupInfos.values()) {
                    if (groupInfo2.getNodeIndex() >= nodeIndex2 && !AbstractC3255y.d(groupInfo2, groupInfo) && (nodeIndex = groupInfo2.getNodeIndex() + nodeCount) >= 0) {
