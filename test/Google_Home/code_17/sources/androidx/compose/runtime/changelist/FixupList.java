...
public final class FixupList implements OperationsDebugStringFormattable {
    ...
    public final void createAndInsertNode(Function0 function0, int i8, Anchor anchor) {
        ...
        Operations m2578constructorimpl = Operations.WriteScope.m2578constructorimpl(operations2);
        Operations.WriteScope.m2584setObjectDKhxnng(m2578constructorimpl, Operation.ObjectParameter.m2550constructorimpl(0), function0);
        ...
        if (operations2.pushedIntMask == operations2.createExpectedArgMask(insertNodeFixup.getInts()) && operations2.pushedObjectMask == operations2.createExpectedArgMask(insertNodeFixup.getObjects())) {
            ...
            Operations m2578constructorimpl2 = Operations.WriteScope.m2578constructorimpl(operations3);
            Operations.WriteScope.m2583setIntA6tL2VI(m2578constructorimpl2, Operation.IntParameter.m2539constructorimpl(0), i8);
            Operations.WriteScope.m2584setObjectDKhxnng(m2578constructorimpl2, Operation.ObjectParameter.m2550constructorimpl(0), anchor);
            ...
            for (int i11 = 0; i11 < ints; i11++) {
                if (((1 << i11) & operations3.pushedIntMask) != 0) {
                    ...
                    sb.append(postInsertNodeFixup.mo2513intParamNamew8GmfQM(Operation.IntParameter.m2539constructorimpl(i11)));
                    i10++;
                }
            }
            ...
            while (i13 < objects) {
                if (((1 << i13) & operations3.pushedObjectMask) != 0) {
                    ...
                    sb3.append(postInsertNodeFixup.mo2514objectParamName31yXWZQ(Operation.ObjectParameter.m2550constructorimpl(i13)));
                    i12++;
                } else {
                    operations = operations3;
                }
        ...
        for (int i15 = 0; i15 < ints2; i15++) {
            if ((operations2.pushedIntMask & (1 << i15)) != 0) {
                ...
                sb5.append(insertNodeFixup.mo2513intParamNamew8GmfQM(Operation.IntParameter.m2539constructorimpl(i15)));
                i14++;
            }
        }
        String sb6 = sb5.toString();
        AbstractC3255y.h(sb6, "StringBuilder().apply(builderAction).toString()");
        ...
        while (i16 < objects2) {
            if (((1 << i16) & operations2.pushedObjectMask) != 0) {
                ...
                i9 = objects2;
                sb7.append(insertNodeFixup.mo2514objectParamName31yXWZQ(Operation.ObjectParameter.m2550constructorimpl(i16)));
                i17++;
            } else {
                i9 = objects2;
            }
        ...
        AbstractC3255y.h(sb8, "StringBuilder().apply(builderAction).toString()");
    ...
    public final <V, T> void updateNode(V v8, InterfaceC1668n interfaceC1668n) {
