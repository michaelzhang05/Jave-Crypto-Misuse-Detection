...
public final class Operations implements OperationsDebugStringFormattable {
    ...
    public static final class WriteScope {
        ...
        public static final /* synthetic */ WriteScope m2577boximpl(Operations operations) {
            return new WriteScope(operations);
        }

        /* renamed from: constructor-impl, reason: not valid java name */
        public static Operations m2578constructorimpl(Operations operations) {
            return operations;
        }

        /* renamed from: equals-impl, reason: not valid java name */
        public static boolean m2579equalsimpl(Operations operations, Object obj) {
            return (obj instanceof WriteScope) && AbstractC3255y.d(operations, ((WriteScope) obj).m2586unboximpl());
        }

        /* renamed from: equals-impl0, reason: not valid java name */
        public static final boolean m2580equalsimpl0(Operations operations, Operations operations2) {
            return AbstractC3255y.d(operations, operations2);
        }

        /* renamed from: getOperation-impl, reason: not valid java name */
        public static final Operation m2581getOperationimpl(Operations operations) {
            return operations.peekOperation();
        }

        /* renamed from: hashCode-impl, reason: not valid java name */
        public static int m2582hashCodeimpl(Operations operations) {
            return operations.hashCode();
        }

        /* renamed from: setInt-A6tL2VI, reason: not valid java name */
        public static final void m2583setIntA6tL2VI(Operations operations, int i8, int i9) {
            int i10 = 1 << i8;
            if ((operations.pushedIntMask & i10) == 0) {
                operations.pushedIntMask = i10 | operations.pushedIntMask;
                operations.intArgs[operations.m2575topIntIndexOfw8GmfQM(i8)] = i9;
            } else {
                throw new IllegalStateException(("Already pushed argument " + m2581getOperationimpl(operations).mo2513intParamNamew8GmfQM(i8)).toString());
            }
        }

        /* renamed from: setObject-DKhxnng, reason: not valid java name */
        public static final <T> void m2584setObjectDKhxnng(Operations operations, int i8, T t8) {
            int i9 = 1 << i8;
            if ((operations.pushedObjectMask & i9) == 0) {
                operations.pushedObjectMask = i9 | operations.pushedObjectMask;
                operations.objectArgs[operations.m2576topObjectIndexOf31yXWZQ(i8)] = t8;
            } else {
                throw new IllegalStateException(("Already pushed argument " + m2581getOperationimpl(operations).mo2514objectParamName31yXWZQ(i8)).toString());
            }
        }

        /* renamed from: toString-impl, reason: not valid java name */
        public static String m2585toStringimpl(Operations operations) {
            return "WriteScope(stack=" + operations + ')';
        }

        public boolean equals(Object obj) {
            return m2579equalsimpl(this.stack, obj);
        }

        public int hashCode() {
            return m2582hashCodeimpl(this.stack);
        }

        public String toString() {
            return m2585toStringimpl(this.stack);
        }

        /* renamed from: unbox-impl, reason: not valid java name */
        public final /* synthetic */ Operations m2586unboximpl() {
            return this.stack;
        }
    }
    ...
    private final String currentOpToDebugString(OpIterator opIterator, String str) {
        ...
        for (int i8 = 0; i8 < ints; i8++) {
            int m2539constructorimpl = Operation.IntParameter.m2539constructorimpl(i8);
            String mo2513intParamNamew8GmfQM = operation.mo2513intParamNamew8GmfQM(m2539constructorimpl);
            if (!z8) {
                sb.append(", ");
            } else {
                z8 = false;
            ...
            sb.append(indent);
            sb.append(mo2513intParamNamew8GmfQM);
            sb.append(" = ");
            sb.append(opIterator.mo2571getIntw8GmfQM(m2539constructorimpl));
        }
        int objects = operation.getObjects();
        for (int i9 = 0; i9 < objects; i9++) {
            int m2550constructorimpl = Operation.ObjectParameter.m2550constructorimpl(i9);
            String mo2514objectParamName31yXWZQ = operation.mo2514objectParamName31yXWZQ(m2550constructorimpl);
            if (!z8) {
                sb.append(", ");
            } else {
                z8 = false;
            ...
            AbstractC3255y.h(sb, "append('\\n')");
            sb.append(indent);
            sb.append(mo2514objectParamName31yXWZQ);
            sb.append(" = ");
            sb.append(formatOpArgumentToString(opIterator.mo2572getObject31yXWZQ(m2550constructorimpl), indent));
        }
        sb.append('\n');
        AbstractC3255y.h(sb, "append('\\n')");
        sb.append(str);
    ...
    public final String formatOpArgumentToString(Object obj, String str) {
        ...
        if (obj instanceof Object[]) {
            return toCollectionString(AbstractC1371l.Q((Object[]) obj), str);
        }
        if (obj instanceof int[]) {
            return toCollectionString(AbstractC1371l.O((int[]) obj), str);
        }
        if (obj instanceof long[]) {
            return toCollectionString(AbstractC1371l.P((long[]) obj), str);
        }
        if (obj instanceof float[]) {
            return toCollectionString(AbstractC1371l.N((float[]) obj), str);
        }
        if (obj instanceof double[]) {
            return toCollectionString(AbstractC1371l.M((double[]) obj), str);
        }
    ...
    private final <T> String toCollectionString(Iterable<? extends T> iterable, String str) {
        return AbstractC1378t.w0(iterable, ", ", "[", "]", 0, null, new Operations$toCollectionString$1(this, str), 24, null);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: topIntIndexOf-w8GmfQM, reason: not valid java name */
    public final int m2575topIntIndexOfw8GmfQM(int i8) {
        return (this.intArgsSize - peekOperation().getInts()) + i8;
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: topObjectIndexOf-31yXWZQ, reason: not valid java name */
    public final int m2576topObjectIndexOf31yXWZQ(int i8) {
    ...
    public final void clear() {
        this.opCodesSize = 0;
        this.intArgsSize = 0;
        AbstractC1371l.t(this.objectArgs, null, 0, this.objectArgsSize);
    ...
    public final void push(Operation operation, Function1 function1) {
        pushOp(operation);
        function1.invoke(WriteScope.m2577boximpl(WriteScope.m2578constructorimpl(this)));
        ...
        for (int i9 = 0; i9 < ints; i9++) {
            if (((1 << i9) & this.pushedIntMask) != 0) {
                ...
                sb.append(operation.mo2513intParamNamew8GmfQM(Operation.IntParameter.m2539constructorimpl(i9)));
                i8++;
            }
        }
        String sb2 = sb.toString();
        ...
        for (int i11 = 0; i11 < objects; i11++) {
            if (((1 << i11) & this.pushedObjectMask) != 0) {
                ...
                sb3.append(operation.mo2514objectParamName31yXWZQ(Operation.ObjectParameter.m2550constructorimpl(i11)));
                i10++;
            }
        }
