...
public final class LiveLiteralKt {
    ...
    public static final <T> State<T> liveLiteral(String str, T t8) {
        ...
        AbstractC3255y.g(mutableState, "null cannot be cast to non-null type androidx.compose.runtime.State<T of androidx.compose.runtime.internal.LiveLiteralKt.liveLiteral>");
        return mutableState;
    }
