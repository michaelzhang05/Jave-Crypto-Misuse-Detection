...
public final class ComposableLambdaNImpl implements ComposableLambdaN {
    ...
    @Override // androidx.compose.runtime.internal.ComposableLambdaN, kotlin.jvm.internal.InterfaceC3250t
    public int getArity() {
        return this.arity;
    }
    ...
    @Override // androidx.compose.runtime.internal.ComposableLambdaN, a6.InterfaceC1676v
    public Object invoke(Object... objArr) {
        int sameBits;
        int realParamCount = realParamCount(objArr.length);
        Object obj = objArr[realParamCount];
        AbstractC3255y.g(obj, "null cannot be cast to non-null type androidx.compose.runtime.Composer");
        Object[] array = AbstractC1371l.L0(objArr, m.s(0, objArr.length - 1)).toArray(new Object[0]);
        ...
        AbstractC3255y.g(obj3, "null cannot be cast to non-null type kotlin.jvm.functions.FunctionN<*>");
        X x8 = new X(2);
        x8.b(array);
        x8.a(Integer.valueOf(i8));
        Object invoke = ((InterfaceC1676v) obj3).invoke(x8.d(new Object[x8.c()]));
    ...
    public final void update(Object obj) {
        boolean z8;
        if (!AbstractC3255y.d(obj, this._block)) {
            if (this._block == null) {
                z8 = true;
            } else {
                z8 = false;
            }
            AbstractC3255y.g(obj, "null cannot be cast to non-null type kotlin.jvm.functions.FunctionN<*>");
            this._block = (InterfaceC1676v) obj;
            if (!z8) {
                trackWrite();
            }
        }
