...
public final class ComposableLambdaKt {
    ...
    public static final ComposableLambda composableLambda(Composer composer, int i8, boolean z8, Object obj) {
        ...
        if (rememberedValue == Composer.Companion.getEmpty()) {
            ...
            AbstractC3255y.g(rememberedValue, "null cannot be cast to non-null type androidx.compose.runtime.internal.ComposableLambdaImpl");
    ...
    public static final boolean replacableWith(RecomposeScope recomposeScope, RecomposeScope recomposeScope2) {
        if (recomposeScope != null) {
            if ((recomposeScope instanceof RecomposeScopeImpl) && (recomposeScope2 instanceof RecomposeScopeImpl)) {
                ...
                if (!recomposeScopeImpl.getValid() || AbstractC3255y.d(recomposeScope, recomposeScope2) || AbstractC3255y.d(recomposeScopeImpl.getAnchor(), ((RecomposeScopeImpl) recomposeScope2).getAnchor())) {
                }
            }
            return false;
        }
