...
public final class RecomposeScopeImpl$end$1$2 extends AbstractC3256z implements Function1 {
    ...
    public final void invoke(Composition composition) {
        ...
        if (i8 == this.$token) {
            ...
            if (AbstractC3255y.d(mutableObjectIntMap2, mutableObjectIntMap) && (composition2 instanceof CompositionImpl)) {
