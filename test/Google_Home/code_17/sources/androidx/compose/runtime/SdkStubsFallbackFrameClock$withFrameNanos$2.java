...
final class SdkStubsFallbackFrameClock$withFrameNanos$2 extends kotlin.coroutines.jvm.internal.l implements InterfaceC1668n {
    final /* synthetic */ Function1 $onFrame;
    int label;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public SdkStubsFallbackFrameClock$withFrameNanos$2(Function1 function1, S5.d dVar) {
        super(2, dVar);
    ...
    public final Object invoke(M m8, S5.d dVar) {
        return ((SdkStubsFallbackFrameClock$withFrameNanos$2) create(m8, dVar)).invokeSuspend(I.f8278a);
    }
}
