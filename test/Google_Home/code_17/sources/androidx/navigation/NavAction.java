...
public final class NavAction {
    ...
    public boolean equals(Object obj) {
        ...
        if (this.destinationId == navAction.destinationId && AbstractC3255y.d(this.navOptions, navAction.navOptions)) {
            if (AbstractC3255y.d(this.defaultArguments, navAction.defaultArguments)) {
                return true;
            }
    ...
    public /* synthetic */ NavAction(int i8, NavOptions navOptions, Bundle bundle, int i9, AbstractC3247p abstractC3247p) {
