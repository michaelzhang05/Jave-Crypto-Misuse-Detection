...
public final class NavHostKt$NavHost$12 extends AbstractC3256z implements Function1 {
    ...
    public final ContentTransform invoke(AnimatedContentTransitionScope<NavBackStackEntry> animatedContentTransitionScope) {
        ...
        if (NavHost$lambda$6.contains(animatedContentTransitionScope.getInitialState())) {
            ...
            if (!AbstractC3255y.d(animatedContentTransitionScope.getTargetState().getId(), animatedContentTransitionScope.getInitialState().getId())) {
