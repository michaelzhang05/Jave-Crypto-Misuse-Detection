...
public final class NavHostKt$NavHost$visibleEntries$2$1 extends AbstractC3256z implements Function0 {
    ...
    public final List<NavBackStackEntry> invoke() {
        ...
        for (Object obj : NavHost$lambda$4) {
            if (AbstractC3255y.d(((NavBackStackEntry) obj).getDestination().getNavigatorName(), ComposeNavigator.NAME)) {
                arrayList.add(obj);
            }
        }
        return arrayList;
