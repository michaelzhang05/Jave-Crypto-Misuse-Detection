...
public final class NavHostKt$NavHost$15 extends l implements InterfaceC1668n {
        ...
        if (this.label == 0) {
            ...
            if (AbstractC3255y.d(this.$transition.getCurrentState(), this.$transition.getTargetState())) {
                ...
                for (Map.Entry<String, Float> entry : map.entrySet()) {
                    if (!AbstractC3255y.d(entry.getKey(), transition.getTargetState().getId())) {
    ...
    public final Object invoke(M m8, d dVar) {
        return ((NavHostKt$NavHost$15) create(m8, dVar)).invokeSuspend(I.f8278a);
    }
}
