...
public final class NavGraphBuilderKt {
    public static final /* synthetic */ void composable(NavGraphBuilder navGraphBuilder, String str, List list, List list2, InterfaceC1669o interfaceC1669o) {
        ComposeNavigator.Destination destination = new ComposeNavigator.Destination((ComposeNavigator) navGraphBuilder.getProvider().getNavigator(ComposeNavigator.class), (InterfaceC1670p) ComposableLambdaKt.composableLambdaInstance(484185514, true, new NavGraphBuilderKt$composable$1(interfaceC1669o)));
    ...
    public static /* synthetic */ void composable$default(NavGraphBuilder navGraphBuilder, String str, List list, List list2, InterfaceC1669o interfaceC1669o, int i8, Object obj) {
        if ((i8 & 2) != 0) {
        ...
        composable(navGraphBuilder, str, list, list2, interfaceC1669o);
    }

    public static final void dialog(NavGraphBuilder navGraphBuilder, String str, List<NamedNavArgument> list, List<NavDeepLink> list2, DialogProperties dialogProperties, InterfaceC1669o interfaceC1669o) {
        DialogNavigator.Destination destination = new DialogNavigator.Destination((DialogNavigator) navGraphBuilder.getProvider().getNavigator(DialogNavigator.class), dialogProperties, interfaceC1669o);
        destination.setRoute(str);
    ...
    public static /* synthetic */ void dialog$default(NavGraphBuilder navGraphBuilder, String str, List list, List list2, DialogProperties dialogProperties, InterfaceC1669o interfaceC1669o, int i8, Object obj) {
        List list3;
        List list4;
        DialogProperties dialogProperties2;
        if ((i8 & 2) != 0) {
            list3 = AbstractC1378t.m();
        } else {
            list3 = list;
        }
        if ((i8 & 4) != 0) {
            list4 = AbstractC1378t.m();
        } else {
            list4 = list2;
        }
        if ((i8 & 8) != 0) {
            dialogProperties2 = new DialogProperties(false, false, (SecureFlagPolicy) null, 7, (AbstractC3247p) null);
        } else {
            dialogProperties2 = dialogProperties;
        }
        dialog(navGraphBuilder, str, list3, list4, dialogProperties2, interfaceC1669o);
    }
    ...
    public static /* synthetic */ void composable$default(NavGraphBuilder navGraphBuilder, String str, List list, List list2, Function1 function1, Function1 function12, Function1 function13, Function1 function14, InterfaceC1670p interfaceC1670p, int i8, Object obj) {
        List m8 = (i8 & 2) != 0 ? AbstractC1378t.m() : list;
        List m9 = (i8 & 4) != 0 ? AbstractC1378t.m() : list2;
        Function1 function15 = (i8 & 8) != 0 ? null : function1;
        Function1 function16 = (i8 & 16) != 0 ? null : function12;
        composable(navGraphBuilder, str, m8, m9, function15, function16, (i8 & 32) != 0 ? function15 : function13, (i8 & 64) != 0 ? function16 : function14, interfaceC1670p);
    }
    ...
    public static /* synthetic */ void navigation$default(NavGraphBuilder navGraphBuilder, String str, String str2, List list, List list2, Function1 function1, Function1 function12, Function1 function13, Function1 function14, Function1 function15, int i8, Object obj) {
        List m8 = (i8 & 4) != 0 ? AbstractC1378t.m() : list;
        List m9 = (i8 & 8) != 0 ? AbstractC1378t.m() : list2;
    ...
    public static final void composable(NavGraphBuilder navGraphBuilder, String str, List<NamedNavArgument> list, List<NavDeepLink> list2, Function1 function1, Function1 function12, Function1 function13, Function1 function14, InterfaceC1670p interfaceC1670p) {
        ComposeNavigator.Destination destination = new ComposeNavigator.Destination((ComposeNavigator) navGraphBuilder.getProvider().getNavigator(ComposeNavigator.class), interfaceC1670p);
        destination.setRoute(str);
        for (NamedNavArgument namedNavArgument : list) {
            destination.addArgument(namedNavArgument.component1(), namedNavArgument.component2());
        }
