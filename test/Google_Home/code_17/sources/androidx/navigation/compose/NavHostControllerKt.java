...
public final class NavHostControllerKt {
    ...
    public static final NavHostController rememberNavController(Navigator<? extends NavDestination>[] navigatorArr, Composer composer, int i8) {
        ...
        NavHostController navHostController = (NavHostController) RememberSaveableKt.m2588rememberSaveable(Arrays.copyOf(navigatorArr, navigatorArr.length), (Saver) NavControllerSaver(context), (String) null, (Function0) new NavHostControllerKt$rememberNavController$1(context), composer, 72, 4);
