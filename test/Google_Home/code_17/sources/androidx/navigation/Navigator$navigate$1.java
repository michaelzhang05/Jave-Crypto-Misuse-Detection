...
public final class Navigator$navigate$1 extends AbstractC3256z implements Function1 {
    ...
    public final NavBackStackEntry invoke(NavBackStackEntry backStackEntry) {
        ...
        if (destination != null && (navigate = this.this$0.navigate(destination, backStackEntry.getArguments(), this.$navOptions, this.$navigatorExtras)) != null) {
            return AbstractC3255y.d(navigate, destination) ? backStackEntry : this.this$0.getState().createBackStackEntry(navigate, navigate.addInDefaultArgs(backStackEntry.getArguments()));
        }
        return null;
    }
}
