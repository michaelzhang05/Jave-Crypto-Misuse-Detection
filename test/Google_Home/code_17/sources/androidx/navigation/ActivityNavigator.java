...
public class ActivityNavigator extends Navigator<Destination> {
    ...
    public static class Destination extends NavDestination {
        ...
        public Destination(Navigator<? extends Destination> activityNavigator) {
            ...
            AbstractC3255y.i(activityNavigator, "activityNavigator");
        }
        ...
        public boolean equals(Object obj) {
            ...
            if (obj != null && (obj instanceof Destination) && super.equals(obj)) {
                ...
                if (z8 && AbstractC3255y.d(this.dataPattern, ((Destination) obj).dataPattern)) {
                    return true;
                }
            }
            return false;
        ...
        public void onInflate(Context context, AttributeSet attrs) {
            ...
            AbstractC3255y.h(obtainAttributes, "context.resources.obtain…tyNavigator\n            )");
    ...
    public static final class Extras implements Navigator.Extras {
        ...
        public static final class Builder {
            ...
            public final Builder setActivityOptions(ActivityOptionsCompat activityOptions) {
                AbstractC3255y.i(activityOptions, "activityOptions");
    ...
    public ActivityNavigator(Context context) {
        ...
        Iterator it = AbstractC3001j.h(context, ActivityNavigator$hostActivity$1.INSTANCE).iterator();
        while (true) {
            if (it.hasNext()) {
                obj = it.next();
    ...
    public NavDestination navigate(Destination destination, Bundle bundle, NavOptions navOptions, Navigator.Extras extras) {
        ...
        if (destination.getIntent() != null) {
            ...
            if (navOptions != null) {
                ...
                if ((popEnterAnim > 0 && AbstractC3255y.d(resources.getResourceTypeName(popEnterAnim), "animator")) || (popExitAnim > 0 && AbstractC3255y.d(resources.getResourceTypeName(popExitAnim), "animator"))) {
            ...
            if ((enterAnim <= 0 || !AbstractC3255y.d(resources.getResourceTypeName(enterAnim), "animator")) && (exitAnim <= 0 || !AbstractC3255y.d(resources.getResourceTypeName(exitAnim), "animator"))) {
