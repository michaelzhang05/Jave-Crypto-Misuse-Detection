...
public final class NavArgument {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj == null || !AbstractC3255y.d(NavArgument.class, obj.getClass())) {
            return false;
        }
        NavArgument navArgument = (NavArgument) obj;
        if (this.isNullable != navArgument.isNullable || this.isDefaultValuePresent != navArgument.isDefaultValuePresent || !AbstractC3255y.d(this.type, navArgument.type)) {
            return false;
        }
        Object obj2 = this.defaultValue;
        if (obj2 != null) {
            return AbstractC3255y.d(obj2, navArgument.defaultValue);
        }
