...
public final class Navigation {
    ...
    public static final NavController findNavController(Activity activity, @IdRes int i8) {
        ...
        AbstractC3255y.h(requireViewById, "requireViewById<View>(activity, viewId)");
    ...
    private final NavController findViewNavController(View view) {
        return (NavController) AbstractC3001j.s(AbstractC3001j.z(AbstractC3001j.h(view, Navigation$findViewNavController$1.INSTANCE), Navigation$findViewNavController$2.INSTANCE));
    }
