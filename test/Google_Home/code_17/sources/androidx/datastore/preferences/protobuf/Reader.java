...
public interface Reader {
    ...
    <T> void mergeGroupField(T t8, Schema<T> schema, ExtensionRegistryLite extensionRegistryLite) throws IOException;

    <T> void mergeMessageField(T t8, Schema<T> schema, ExtensionRegistryLite extensionRegistryLite) throws IOException;
