...
public final class PreferencesProto {
    ...
    public static final class PreferenceMap extends GeneratedMessageLite<PreferenceMap, Builder> implements PreferenceMapOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.Builder<PreferenceMap, Builder> implements PreferenceMapOrBuilder {
            ...
            public Map<String, Value> getPreferencesMap() {
                return DesugarCollections.unmodifiableMap(((PreferenceMap) this.instance).getPreferencesMap());
            }
    ...
    public static final class StringSet extends GeneratedMessageLite<StringSet, Builder> implements StringSetOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.Builder<StringSet, Builder> implements StringSetOrBuilder {
            ...
            public String getStrings(int i8) {
                return ((StringSet) this.instance).getStrings(i8);
            }

            @Override // androidx.datastore.preferences.PreferencesProto.StringSetOrBuilder
            public ByteString getStringsBytes(int i8) {
                return ((StringSet) this.instance).getStringsBytes(i8);
            }
            ...
            public List<String> getStringsList() {
                return DesugarCollections.unmodifiableList(((StringSet) this.instance).getStringsList());
            }

            public Builder setStrings(int i8, String str) {
                copyOnWrite();
                ((StringSet) this.instance).setStrings(i8, str);
                return this;
            }
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public void setStrings(int i8, String str) {
            str.getClass();
            ensureStringsIsMutable();
            this.strings_.set(i8, str);
        }
        ...
        @Override // androidx.datastore.preferences.PreferencesProto.StringSetOrBuilder
        public ByteString getStringsBytes(int i8) {
            return ByteString.copyFromUtf8(this.strings_.get(i8));
        }
    ...
    public interface StringSetOrBuilder extends MessageLiteOrBuilder {
        ...
        ByteString getStringsBytes(int i8);
    ...
    public static final class Value extends GeneratedMessageLite<Value, Builder> implements ValueOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.Builder<Value, Builder> implements ValueOrBuilder {
            ...
            public Builder setBoolean(boolean z8) {
                copyOnWrite();
                ((Value) this.instance).setBoolean(z8);
                return this;
            }
            ...
            public Builder setDouble(double d8) {
                copyOnWrite();
                ((Value) this.instance).setDouble(d8);
                return this;
            }

            public Builder setFloat(float f8) {
                copyOnWrite();
                ((Value) this.instance).setFloat(f8);
                return this;
            }

            public Builder setInteger(int i8) {
                copyOnWrite();
                ((Value) this.instance).setInteger(i8);
                return this;
            }

            public Builder setLong(long j8) {
                copyOnWrite();
                ((Value) this.instance).setLong(j8);
                return this;
            }
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public void setBoolean(boolean z8) {
            this.valueCase_ = 1;
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public void setDouble(double d8) {
            this.valueCase_ = 7;
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public void setInteger(int i8) {
            this.valueCase_ = 3;
            this.value_ = Integer.valueOf(i8);
        }

        /* JADX INFO: Access modifiers changed from: private */
        public void setLong(long j8) {
            this.valueCase_ = 4;
        ...
        protected final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            ...
            switch (AnonymousClass1.$SwitchMap$com$google$protobuf$GeneratedMessageLite$MethodToInvoke[methodToInvoke.ordinal()]) {
                ...
                case 2:
                    return new Builder(anonymousClass1);
                case 3:
                    return GeneratedMessageLite.newMessageInfo(DEFAULT_INSTANCE, "\u0001\b\u0001\u0001\u0001\b\b\u0000\u0000\u0000\u0001်\u0000\u0002ဴ\u0000\u0003့\u0000\u0004ဵ\u0000\u0005ျ\u0000\u0006ြ\u0000\u0007ဳ\u0000\bွ\u0000", new Object[]{"value_", "valueCase_", "bitField0_", StringSet.class});
                case 4:
                    return DEFAULT_INSTANCE;
                case 5:
