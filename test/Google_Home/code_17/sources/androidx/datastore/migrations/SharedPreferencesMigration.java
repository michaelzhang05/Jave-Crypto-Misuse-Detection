...
public final class SharedPreferencesMigration<T> implements DataMigration<T> {
    ...
    private final InterfaceC1669o migrate;
    private final String name;
    private final InterfaceC1355k sharedPrefs$delegate;
    private final InterfaceC1668n shouldRunMigration;
    ...
    /* loaded from: classes3.dex */
    static final class AnonymousClass1 extends l implements InterfaceC1668n {
        int label;
        ...
        public final Object invoke(T t8, d dVar) {
            return ((AnonymousClass1) create(t8, dVar)).invokeSuspend(I.f8278a);
        }
    ...
    public static final class AnonymousClass2 extends l implements InterfaceC1668n {
        ...
        public final Object invoke(T t8, d dVar) {
            return ((AnonymousClass2) create(t8, dVar)).invokeSuspend(I.f8278a);
        }
    ...
    public static final class AnonymousClass3 extends l implements InterfaceC1668n {
        ...
        public final Object invoke(T t8, d dVar) {
            return ((AnonymousClass3) create(t8, dVar)).invokeSuspend(I.f8278a);
        }
    ...
    static final class AnonymousClass4 extends AbstractC3256z implements Function0 {
        ...
        public final SharedPreferences invoke() {
            ...
            AbstractC3255y.h(sharedPreferences, "context.getSharedPrefere…me, Context.MODE_PRIVATE)");
    ...
    public SharedPreferencesMigration(Context context, String sharedPreferencesName, InterfaceC1669o migrate) {
        this(context, sharedPreferencesName, null, null, migrate, 12, null);
        AbstractC3255y.i(context, "context");
        AbstractC3255y.i(sharedPreferencesName, "sharedPreferencesName");
        AbstractC3255y.i(migrate, "migrate");
    }
    ...
    */
    public java.lang.Object shouldMigrate(T r5, S5.d r6) {
        /*
            r4 = this;
        ...
        L54:
            ...
            kotlin.jvm.internal.AbstractC3255y.h(r5, r6)
        ...
        L98:
            ...
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.datastore.migrations.SharedPreferencesMigration.shouldMigrate(java.lang.Object, S5.d):java.lang.Object");
    }

    /* JADX WARN: 'this' call moved to the top of the method (can break code semantics) */
    public SharedPreferencesMigration(Context context, String sharedPreferencesName, Set<String> keysToMigrate, InterfaceC1669o migrate) {
    ...
    /* JADX WARN: 'this' call moved to the top of the method (can break code semantics) */
    public SharedPreferencesMigration(Function0 produceSharedPreferences, InterfaceC1669o migrate) {
        this(produceSharedPreferences, (Set) null, (InterfaceC1668n) null, migrate, 6, (AbstractC3247p) null);
        AbstractC3255y.i(produceSharedPreferences, "produceSharedPreferences");
        AbstractC3255y.i(migrate, "migrate");
    }

    /* JADX WARN: 'this' call moved to the top of the method (can break code semantics) */
    public SharedPreferencesMigration(Function0 produceSharedPreferences, Set<String> keysToMigrate, InterfaceC1669o migrate) {
        this(produceSharedPreferences, keysToMigrate, (InterfaceC1668n) null, migrate, 4, (AbstractC3247p) null);
        AbstractC3255y.i(produceSharedPreferences, "produceSharedPreferences");
        AbstractC3255y.i(keysToMigrate, "keysToMigrate");
        AbstractC3255y.i(migrate, "migrate");
    }

    private SharedPreferencesMigration(Function0 function0, Set<String> set, InterfaceC1668n interfaceC1668n, InterfaceC1669o interfaceC1669o, Context context, String str) {
        this.shouldRunMigration = interfaceC1668n;
        this.migrate = interfaceC1669o;
        this.context = context;
        this.name = str;
        this.sharedPrefs$delegate = O5.l.b(function0);
        this.keySet = set == SharedPreferencesMigration_androidKt.getMIGRATE_ALL_KEYS() ? null : AbstractC1378t.a1(set);
    }

    /* synthetic */ SharedPreferencesMigration(Function0 function0, Set set, InterfaceC1668n interfaceC1668n, InterfaceC1669o interfaceC1669o, Context context, String str, int i8, AbstractC3247p abstractC3247p) {
        this(function0, (Set<String>) set, (i8 & 4) != 0 ? new AnonymousClass1(null) : interfaceC1668n, interfaceC1669o, context, str);
    }

    public /* synthetic */ SharedPreferencesMigration(Function0 function0, Set set, InterfaceC1668n interfaceC1668n, InterfaceC1669o interfaceC1669o, int i8, AbstractC3247p abstractC3247p) {
        this(function0, (Set<String>) ((i8 & 2) != 0 ? SharedPreferencesMigration_androidKt.getMIGRATE_ALL_KEYS() : set), (i8 & 4) != 0 ? new AnonymousClass2(null) : interfaceC1668n, interfaceC1669o);
    }

    /* JADX WARN: 'this' call moved to the top of the method (can break code semantics) */
    public SharedPreferencesMigration(Function0 produceSharedPreferences, Set<String> keysToMigrate, InterfaceC1668n shouldRunMigration, InterfaceC1669o migrate) {
        this(produceSharedPreferences, keysToMigrate, shouldRunMigration, migrate, (Context) null, (String) null);
        AbstractC3255y.i(produceSharedPreferences, "produceSharedPreferences");
        AbstractC3255y.i(keysToMigrate, "keysToMigrate");
        AbstractC3255y.i(shouldRunMigration, "shouldRunMigration");
        AbstractC3255y.i(migrate, "migrate");
    }

    public /* synthetic */ SharedPreferencesMigration(Context context, String str, Set set, InterfaceC1668n interfaceC1668n, InterfaceC1669o interfaceC1669o, int i8, AbstractC3247p abstractC3247p) {
        this(context, str, (i8 & 4) != 0 ? SharedPreferencesMigration_androidKt.getMIGRATE_ALL_KEYS() : set, (i8 & 8) != 0 ? new AnonymousClass3(null) : interfaceC1668n, interfaceC1669o);
    }

    /* JADX WARN: 'this' call moved to the top of the method (can break code semantics) */
    public SharedPreferencesMigration(Context context, String sharedPreferencesName, Set<String> keysToMigrate, InterfaceC1668n shouldRunMigration, InterfaceC1669o migrate) {
