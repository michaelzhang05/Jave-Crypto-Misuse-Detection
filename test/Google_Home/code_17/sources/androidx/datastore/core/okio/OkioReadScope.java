...
public class OkioReadScope<T> implements ReadScope<T> {
    ...
    public OkioReadScope(AbstractC1423k fileSystem, Q path, OkioSerializer<T> serializer) {
    ...
    */
    public static /* synthetic */ <T> java.lang.Object readData$suspendImpl(androidx.datastore.core.okio.OkioReadScope<T> r6, S5.d r7) {
        /*
        ...
        L18:
            ...
            O5.t.b(r7)     // Catch: java.lang.Throwable -> L32
            goto L61
        L32:
            r7 = move-exception
            goto L6f
        ...
        L3c:
            O5.t.b(r7)
            r6.checkClose()
            S6.k r7 = r6.fileSystem     // Catch: java.io.FileNotFoundException -> L86
            S6.Q r2 = r6.path     // Catch: java.io.FileNotFoundException -> L86
            S6.Z r7 = r7.l(r2)     // Catch: java.io.FileNotFoundException -> L86
            S6.g r7 = S6.L.d(r7)     // Catch: java.io.FileNotFoundException -> L86
        ...
        L75:
            r6 = move-exception
            O5.AbstractC1349e.a(r7, r6)     // Catch: java.io.FileNotFoundException -> L7a
            goto L7c
        L7a:
            r6 = move-exception
            goto L8b
        ...
        L80:
            if (r4 != 0) goto L8a
            kotlin.jvm.internal.AbstractC3255y.f(r7)     // Catch: java.io.FileNotFoundException -> L86
            goto L9b
        L86:
            r7 = move-exception
            r0 = r6
        ...
        L9c:
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.datastore.core.okio.OkioReadScope.readData$suspendImpl(androidx.datastore.core.okio.OkioReadScope, S5.d):java.lang.Object");
    }
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public final AbstractC1423k getFileSystem() {
