...
public final class DataMigrationInitializer$Companion$getInitializer$1 extends l implements InterfaceC1668n {
    ...
    public final Object invoke(InitializerApi<T> initializerApi, d dVar) {
        return ((DataMigrationInitializer$Companion$getInitializer$1) create(initializerApi, dVar)).invokeSuspend(I.f8278a);
    }
