...
final class StorageConnectionKt$writeData$2 extends l implements InterfaceC1668n {
    ...
    public final Object invoke(WriteScope<T> writeScope, d dVar) {
        return ((StorageConnectionKt$writeData$2) create(writeScope, dVar)).invokeSuspend(I.f8278a);
    }
