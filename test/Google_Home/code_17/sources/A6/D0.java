...
public final class D0 extends j0 implements w6.b {

    /* renamed from: c, reason: collision with root package name */
    public static final D0 f504c = new D0();

    private D0() {
        super(AbstractC4193a.t(O5.F.f8273b));
    }

    protected int A(short[] collectionSize) {
        AbstractC3255y.i(collectionSize, "$this$collectionSize");
        return O5.G.p(collectionSize);
    }
    ...
    public void m(z6.c decoder, int i8, C0 builder, boolean z8) {
        AbstractC3255y.i(decoder, "decoder");
        AbstractC3255y.i(builder, "builder");
        builder.e(O5.F.b(decoder.D(a(), i8).E()));
    }
    ...
    protected void E(z6.d encoder, short[] content, int i8) {
        AbstractC3255y.i(encoder, "encoder");
        AbstractC3255y.i(content, "content");
        for (int i9 = 0; i9 < i8; i9++) {
            encoder.v(a(), i9).i(O5.G.n(content, i9));
        }
    }
