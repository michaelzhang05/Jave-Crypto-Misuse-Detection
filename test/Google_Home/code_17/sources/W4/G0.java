...
public final class G0 implements ViewBinding {
    ...
    private final RelativeLayout f11773a;

    /* renamed from: b, reason: collision with root package name */
    public final K f11774b;

    /* renamed from: c, reason: collision with root package name */
    public final RecyclerView f11775c;

    /* renamed from: d, reason: collision with root package name */
    public final Toolbar f11776d;
    ...
    private G0(RelativeLayout relativeLayout, K k8, RecyclerView recyclerView, Toolbar toolbar, TextView textView, TextView textView2, TextView textView3) {
        this.f11773a = relativeLayout;
        this.f11774b = k8;
        this.f11775c = recyclerView;
        this.f11776d = toolbar;
        this.f11777e = textView;
        this.f11778f = textView2;
        this.f11779g = textView3;
    }
