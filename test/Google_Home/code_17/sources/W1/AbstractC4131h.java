...
public abstract class AbstractC4131h {

    /* renamed from: a, reason: collision with root package name */
    private static Pattern f40345a = Pattern.compile("^[0-1]*$", 2);

    public static List a(String str) {
        if (f40345a.matcher(str).matches()) {
            int i8 = 12;
            if (str.length() >= 12) {
                ...
                for (int i10 = 0; i10 < a8; i10++) {
                    int i11 = i8 + 1;
                    if (AbstractC4127d.a(str.substring(i8, i11))) {
                        int indexOf = str.indexOf("11", i11) + 2;
                        int a9 = AbstractC4130g.a(str.substring(i11, indexOf)) + i9;
                        int indexOf2 = str.indexOf("11", indexOf) + 2;
                        int a10 = AbstractC4130g.a(str.substring(indexOf, indexOf2)) + a9;
                        while (a9 <= a10) {
                        ...
                        int a11 = AbstractC4130g.a(str.substring(i11, i8)) + i9;
        ...
        throw new C4185a("Undecodable FibonacciIntegerRange '" + str + "'");
    }
    ...
    public static String b(List list) {
        ...
        for (int i13 = 0; i13 < arrayList.size(); i13++) {
            if (((List) arrayList.get(i13)).size() == 1) {
                ...
                b8 = b8 + MBridgeConstans.ENDCARD_URL_TYPE_PL + AbstractC4130g.b(intValue);
            } else {
                ...
                b8 = b8 + "1" + AbstractC4130g.b(intValue2) + AbstractC4130g.b(intValue3);
            }
        }
        return b8;
    }
