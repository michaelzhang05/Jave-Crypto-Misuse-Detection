...
public abstract class AbstractC4130g {

    /* renamed from: a, reason: collision with root package name */
    private static Pattern f40344a = Pattern.compile("^[0-1]*$", 2);

    public static int a(String str) {
        if (f40344a.matcher(str).matches() && str.length() >= 2 && str.indexOf("11") == str.length() - 2) {
        ...
        throw new C4185a("Undecodable FibonacciInteger '" + str + "'");
    }
