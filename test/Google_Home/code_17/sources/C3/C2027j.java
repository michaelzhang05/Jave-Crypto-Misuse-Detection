...
final class C2027j implements InterfaceC1974h.c {

    /* renamed from: a, reason: collision with root package name */
    public static final C2027j f15659a = new C2027j();
    ...
    public List f(C1970d metadata, H0 sharedDataSpec, C1626h transformSpecToElements) {
        ...
        p4.G g8 = null;
        Object[] objArr = 0;
        if (C2026i.f15655a.c(metadata)) {
            m8 = AbstractC1378t.e(new h4.u0(g8, e4.n.f31722b, 1, (AbstractC3247p) (objArr == true ? 1 : 0)));
        } else {
            m8 = AbstractC1378t.m();
        }
    ...
    public C1625g i(H0 sharedDataSpec) {
        AbstractC3255y.i(sharedDataSpec, "sharedDataSpec");
        return new C1625g(C2026i.f15655a, sharedDataSpec, e4.n.f31709P, e4.k.f31670i, false, null, 48, null);
    }
}
