...
final class e0 implements InterfaceC1974h.c {

    /* renamed from: a, reason: collision with root package name */
    public static final e0 f15642a = new e0();
    ...
    public List f(C1970d metadata, H0 sharedDataSpec, C1626h transformSpecToElements) {
        ...
        p4.G g8 = null;
        Object[] objArr = 0;
        if (d0.f15636a.c(metadata)) {
            m8 = AbstractC1378t.e(new h4.u0(g8, e4.n.f31769y0, 1, (AbstractC3247p) (objArr == true ? 1 : 0)));
        } else {
            m8 = AbstractC1378t.m();
        }
    ...
    public C1625g i(H0 sharedDataSpec) {
        AbstractC3255y.i(sharedDataSpec, "sharedDataSpec");
        return new C1625g(d0.f15636a, sharedDataSpec, e4.n.f31745m0, e4.k.f31652C, false, null, 48, null);
    }
}
