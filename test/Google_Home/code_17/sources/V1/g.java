...
public abstract class g {
    ...
    public static TimeZone f10610d;

    /* renamed from: a, reason: collision with root package name */
    static TreeMap f10607a = new TreeMap(new a());

    /* renamed from: b, reason: collision with root package name */
    static TreeMap f10608b = new TreeMap(new a());

    /* renamed from: c, reason: collision with root package name */
    private static HashSet f10609c = new HashSet();

    /* renamed from: e, reason: collision with root package name */
    static TreeMap f10611e = new TreeMap();
    ...
    static {
        ...
        f10609c.add("MEZ");
        f10609c.add("Uhr");
        f10609c.add(com.mbridge.msdk.c.h.f19072a);
        f10609c.add("pm");
        f10609c.add("PM");
        f10609c.add("am");
        f10609c.add("AM");
        ...
        for (String str : TimeZone.getAvailableIDs()) {
            f10611e.put(str, DesugarTimeZone.getTimeZone(str));
        }
            ...
            if (!"ja".equals(locale.getLanguage()) && !"ko".equals(locale.getLanguage()) && !"zh".equals(locale.getLanguage())) {
                ...
                for (int i8 = 0; i8 < months.length; i8++) {
                    if (months[i8].length() != 0) {
                        d(f10607a, months[i8], Integer.valueOf(i8));
                    }
                }
                ...
                for (int i9 = 0; i9 < shortMonths.length; i9++) {
                    ...
                    if (str2.length() != 0 && !Character.isDigit(str2.charAt(str2.length() - 1))) {
                        d(f10607a, shortMonths[i9], Integer.valueOf(i9));
                        d(f10607a, shortMonths[i9].replace(".", ""), Integer.valueOf(i9));
                    }
                }
                ...
                for (int i10 = 0; i10 < weekdays.length; i10++) {
                    ...
                    if (str3.length() != 0) {
                        d(f10608b, str3, Integer.valueOf(i10));
                        d(f10608b, str3.replace(".", ""), Integer.valueOf(i10));
                    }
                }
                ...
                for (int i11 = 0; i11 < shortWeekdays.length; i11++) {
                    ...
                    if (str4.length() != 0) {
                        d(f10608b, str4, Integer.valueOf(i11));
                        d(f10608b, str4.replace(".", ""), Integer.valueOf(i11));
                    }
                }
            }
        }
    ...
    public static Date c(Object obj) {
        ...
        if (obj instanceof String) {
            ...
            if (f10608b.containsKey(nextToken)) {
                if (!stringTokenizer.hasMoreTokens()) {
                    return null;
                }
                nextToken = stringTokenizer.nextToken();
            }
            if (f10607a.containsKey(nextToken)) {
    ...
    private static Date f(StringTokenizer stringTokenizer, String str) {
        GregorianCalendar i8 = i();
        Integer num = (Integer) f10607a.get(str);
        if (num != null) {
    ...
    private static String k(StringTokenizer stringTokenizer, String str, Calendar calendar) {
        while (true) {
            TimeZone timeZone = (TimeZone) f10611e.get(str);
            if (timeZone != null) {
