...
public final class l implements j {
    ...
    public ChoiceCmpCallback f8905a;
    ...
    public l(ChoiceCmpCallback choiceCmpCallback, c coreUiLabelsResolver) {
        ...
        this.f8905a = choiceCmpCallback;
        this.f8906b = coreUiLabelsResolver;
    }
    ...
    public Object a(String jsonString) {
        ...
        try {
            this.f8907c = new JSONObject(jsonString);
            return new H6.f(c(), a(), b(), this.f8906b.a(jsonString), null, d(), 16);
        } catch (JSONException unused) {
            ChoiceCmpCallback choiceCmpCallback = this.f8905a;
            if (choiceCmpCallback != null) {
                choiceCmpCallback.onCmpError(ChoiceError.UNKNOWN_CONFIG);
            }
            return new H6.f(null, null, null, null, null, null, 63);
        }
    }

    public final H6.e b() {
        JSONObject jSONObject = this.f8907c;
        if (jSONObject == null) {
        ...
        if (optJSONArray != null) {
            ...
            while (i8 < length) {
                ...
                AbstractC3255y.h(optString2, "nonIABVendor.optString(\"description\", EMPTY)");
                String optString3 = nonIABVendor.optString("privacyPolicyUrl", "");
                AbstractC3255y.h(optString3, "nonIABVendor.optString(\"privacyPolicyUrl\", EMPTY)");
                AbstractC3255y.h(nonIABVendor, "nonIABVendor");
                arrayList.add(new H6.d(optInt, optString, a8, optString2, optString3, i.a(nonIABVendor, "nonIabPurposeConsentIds"), i.a(nonIABVendor, "nonIabPurposeLegitimateInterestIds")));
                i8 = i9;
            }
        }
        String optString4 = jSONObject2.optString("updateAt");
        return new H6.e(arrayList, optString4, d.a(optString4, "nonIabVendors.optString(\"updateAt\")", jSONObject2, "nonIabVendorsHash", "nonIabVendors.optString(\"nonIabVendorsHash\")"));
    }
    ...
    public final H6.g c() {
        ...
        AbstractC3255y.h(premiumProperties, "premiumProperties");
        return new H6.g(i.a(premiumProperties, "vendorBlacklist"), i.a(premiumProperties, "vendorWhitelist"), i.a(premiumProperties, "googleWhitelist"));
    }
    ...
    public final M7.n d() {
        ...
        if (optJSONObject != null) {
            ...
            AbstractC3255y.h(optString2, "optString(\"uspDnsTitle\")");
            AbstractC3255y.h(optString5, "optString(\"uspPrivacyPolicyLinkText\")");
            AbstractC3255y.h(optString3, "optString(\"uspDeleteDataLinkText\")");
            AbstractC3255y.h(optString4, "optString(\"uspAccessDataLinkText\")");
            nVar = new M7.n(null, null, optString2, b8, null, optString5, optString3, optString4, null, arrayList, 275);
        }
        if (nVar == null) {
            return new M7.n(null, null, null, null, null, null, null, null, null, null, 1023);
        }
        return nVar;
    }
    ...
    public final H6.a a() {
        ...
        AbstractC3255y.h(optString, "coreConfig.optString(\"inmobiAccountId\")");
        AbstractC3255y.h(coreConfig, "coreConfig");
        ...
        AbstractC3255y.h(optString5, "coreConfig.optString(\"displayUi\")");
        ...
        AbstractC3255y.h(optString6, "coreConfig.optString(\"publisherLogo\")");
        ...
        AbstractC3255y.h(optString7, "coreConfig.optString(\"thirdPartyStorageType\")");
        ...
        AbstractC3255y.h(optString9, "coreConfig.optString(\"uspPrivacyPolicyLink\")");
        ...
        if (optJSONObject == null) {
            str = a24;
            cVar = new H6.c(false, null, null, 7);
            str2 = optString8;
            list3 = a11;
            list2 = a12;
            list = a13;
            ...
            if (optJSONArray == null) {
                ...
                while (i8 < length) {
                    ...
                    AbstractC3255y.h(optString14, "gbcPurpose.optString(\"defaultValue\")");
                    arrayList.add(new H6.b(optInt3, GBCConsentValue.valueOf(optString14)));
                    i8 = i9;
