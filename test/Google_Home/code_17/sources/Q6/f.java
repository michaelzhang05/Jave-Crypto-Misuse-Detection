...
public class f {
    ...
    private static final f f9501a = h();

    /* renamed from: b, reason: collision with root package name */
    private static final Logger f9502b = Logger.getLogger(u.class.getName());
    ...
    public static byte[] e(List list) {
        ...
        for (int i8 = 0; i8 < size; i8++) {
            v vVar = (v) list.get(i8);
            if (vVar != v.HTTP_1_0) {
                c1417e.writeByte(vVar.toString().length());
                c1417e.writeUtf8(vVar.toString());
            }
        }
        return c1417e.readByteArray();
    }
    ...
    public R6.c c(X509TrustManager x509TrustManager) {
        return new R6.a(d(x509TrustManager));
    }

    public R6.e d(X509TrustManager x509TrustManager) {
        return new R6.b(x509TrustManager.getAcceptedIssuers());
    }
    ...
    public Object m(String str) {
        if (f9502b.isLoggable(Level.FINE)) {
