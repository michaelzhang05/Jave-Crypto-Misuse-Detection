...
public abstract class AbstractC2059b implements b7.e {

    /* renamed from: g, reason: collision with root package name */
    private static long[] f15749g = {1, 32898, -9223372036854742902L, -9223372034707259392L, 32907, 2147483649L, -9223372034707259263L, -9223372036854743031L, 138, 136, 2147516425L, 2147483658L, 2147516555L, -9223372036854775669L, -9223372036854742903L, -9223372036854743037L, -9223372036854743038L, -9223372036854775680L, 32778, -9223372034707292150L, -9223372034707259263L, -9223372036854742912L, 2147483649L, -9223372034707259384L};

    /* renamed from: a, reason: collision with root package name */
    protected long[] f15750a = new long[25];

    /* renamed from: b, reason: collision with root package name */
    protected byte[] f15751b = new byte[PsExtractor.AUDIO_STREAM];

    /* renamed from: c, reason: collision with root package name */
    protected int f15752c;

    /* renamed from: d, reason: collision with root package name */
    protected int f15753d;

    /* renamed from: e, reason: collision with root package name */
    protected int f15754e;

    /* renamed from: f, reason: collision with root package name */
    protected boolean f15755f;

    public AbstractC2059b(int i8) {
        n(i8);
    }

    private void g(byte[] bArr, int i8) {
        int i9 = this.f15752c >>> 6;
        for (int i10 = 0; i10 < i9; i10++) {
            long[] jArr = this.f15750a;
            jArr[i10] = jArr[i10] ^ H7.f.g(bArr, i8);
            i8 += 8;
        }
        I7.b.c(m()).toLowerCase();
        i();
    }
    ...
    private void h() {
        i();
        m();
        H7.f.l(this.f15750a, 0, this.f15752c >>> 6, this.f15751b, 0);
        this.f15753d = this.f15752c;
    }
        ...
        if (i8 > 0 && i8 < 1600 && i8 % 64 == 0) {
            ...
            while (true) {
                ...
                if (i9 < jArr.length) {
                    ...
                    H7.a.i(this.f15751b, (byte) 0);
                    this.f15753d = 0;
                    this.f15755f = false;
                    this.f15754e = (1600 - i8) / 2;
                    return;
                }
            }
        } else {
    ...
    private void p() {
        ...
        if (i10 == this.f15752c) {
            ...
            for (int i14 = 0; i14 < i11; i14++) {
                long[] jArr = this.f15750a;
                jArr[i14] = jArr[i14] ^ H7.f.g(this.f15751b, i13);
                i13 += 8;
            }
            m();
            if (i12 > 0) {
                long[] jArr2 = this.f15750a;
                jArr2[i11] = (((1 << i12) - 1) & H7.f.g(this.f15751b, i13)) ^ jArr2[i11];
            }
        }
        long[] jArr3 = this.f15750a;
        int i15 = (this.f15752c - 1) >>> 6;
    ...
    protected void k(byte[] bArr, int i8, int i9) {
        ...
        if (i12 % 8 == 0) {
            if (!this.f15755f) {
                int i13 = i12 >>> 3;
                int i14 = this.f15752c >>> 3;
                int i15 = i14 - i13;
                if (i9 < i15) {
                    System.arraycopy(bArr, i8, this.f15751b, i13, i9);
                    i11 = this.f15753d + (i9 << 3);
                } else {
                    if (i13 > 0) {
                        System.arraycopy(bArr, i8, this.f15751b, i13, i15);
                        g(this.f15751b, 0);
                    } else {
                        i15 = 0;
                    }
                    ...
                    System.arraycopy(bArr, i8 + i15, this.f15751b, 0, i10);
                    i11 = i10 << 3;
                }
                this.f15753d = i11;
                return;
    ...
    public void l(int i8, int i9) {
        if (i9 >= 1 && i9 <= 7) {
            ...
            if (i10 % 8 == 0) {
                if (!this.f15755f) {
                    this.f15751b[i10 >>> 3] = (byte) (i8 & ((1 << i9) - 1));
                    this.f15753d = i10 + i9;
                    return;
                }
                throw new IllegalStateException("attempt to absorb while squeezing");
    ...
    protected byte[] m() {
        byte[] bArr = new byte[this.f15750a.length * 8];
        int i8 = 0;
        int i9 = 0;
        while (true) {
            long[] jArr = this.f15750a;
            if (i8 != jArr.length) {
                H7.f.k(jArr[i8], bArr, i9);
                i9 += 8;
                i8++;
            } else {
                return bArr;
    ...
    public void r(byte[] bArr, int i8, long j8) {
        ...
        if (j8 % 8 == 0) {
            while (j9 < j8) {
                ...
                int min = (int) Math.min(this.f15753d, j8 - j9);
                System.arraycopy(this.f15751b, (this.f15752c - this.f15753d) / 8, bArr, ((int) (j9 / 8)) + i8, min / 8);
                this.f15753d -= min;
                j9 += min;
            }
            m();
