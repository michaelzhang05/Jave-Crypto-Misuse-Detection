...
public final class C3854c {
    ...
    public static final C3854c f38326a = new C3854c();
    ...
    public static final void d(ImageView imageView, ValueAnimator valueAnimator) {
        AbstractC3255y.i(imageView, "$imageView");
    ...
    public final void c(ProgressBar progressBar, final ImageView imageView) {
        ...
        if (progressBar.getVisibility() == 0) {
            ...
            endDownloadAnimation$lambda$4.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: q5.a
                @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                    C3854c.d(imageView, valueAnimator);
                }
            });
    ...
    public final void e(ProgressBar progressBar, final ImageView imageView) {
        ...
        if (progressBar.getVisibility() == 8) {
            ...
            ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: q5.b
                @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                    C3854c.f(imageView, valueAnimator);
                }
            });
            ofFloat.start();
        }
    ...
    public static final class a implements Animator.AnimatorListener {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ ProgressBar f38327a;

        public a(ProgressBar progressBar) {
            this.f38327a = progressBar;
        }
