...
public class a {
    ...
    private final Map f7492b;

    /* renamed from: c, reason: collision with root package name */
    private final Map f7493c = new HashMap();
    ...
    public c c() {
        ...
        inputStream = null;
        try {
            String b8 = b(this.f7491a, this.f7492b);
            h.f().i("GET Request URL: " + b8);
            httpsURLConnection = (HttpsURLConnection) new URL(b8).openConnection();
            try {
                httpsURLConnection.setReadTimeout(10000);
                httpsURLConnection.setConnectTimeout(10000);
                httpsURLConnection.setRequestMethod(ShareTarget.METHOD_GET);
                for (Map.Entry entry : this.f7493c.entrySet()) {
