...
public class i implements f {
    ...
    static final long[] f33135f = {0, 10, 100, 1000, WorkRequest.MIN_BACKOFF_MILLIS, 100000, 1000000, 10000000, 100000000, C.NANOS_PER_SECOND, 10000000000L};

    /* renamed from: a, reason: collision with root package name */
    final j$.time.temporal.r f33136a;
    ...
    public i b() {
        ...
        return new i(this.f33136a, this.f33137b, this.f33138c, this.f33139d, -1);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public i c(int i8) {
        int i9 = this.f33140e + i8;
        return new i(this.f33136a, this.f33137b, this.f33138c, this.f33139d, i9);
    }
    ...
    public boolean j(p pVar, StringBuilder sb) {
        ...
        u uVar = this.f33139d;
        if (longValue >= 0) {
            int i10 = c.f33130a[uVar.ordinal()];
            if (i10 == 1 ? !(i9 >= 19 || longValue < f33135f[i9]) : i10 == 2) {
                sb.append('+');
            }
        } else {
            int i11 = c.f33130a[uVar.ordinal()];
