...
public final class Instant implements j$.time.temporal.m, j$.time.temporal.p, Comparable<Instant>, Serializable {
    ...
    public static final Instant f33034c = new Instant(0, 0);
    public static final Instant MIN = H(-31557014167219200L, 0);
    public static final Instant MAX = H(31556889864403199L, 999999999);
    ...
    private Instant I(long j8, long j9) {
        ...
        return H(j$.com.android.tools.r8.a.f(j$.com.android.tools.r8.a.f(this.f33035a, j8), j9 / C.NANOS_PER_SECOND), this.f33036b + (j9 % C.NANOS_PER_SECOND));
    }
    ...
    public final Instant e(long j8, j$.time.temporal.u uVar) {
        ...
        switch (f.f33120b[((j$.time.temporal.b) uVar).ordinal()]) {
            case 1:
                return I(0L, j8);
            case 2:
    ...
    public final void K(DataOutput dataOutput) {
        dataOutput.writeLong(this.f33035a);
        dataOutput.writeInt(this.f33036b);
    }
    ...
    public final int compareTo(Instant instant) {
        ...
        int compare = Long.compare(this.f33035a, instant2.f33035a);
        return compare != 0 ? compare : this.f33036b - instant2.f33036b;
    }
    ...
    */
    ...
    public final boolean equals(Object obj) {
        ...
        return this.f33035a == instant.f33035a && this.f33036b == instant.f33036b;
    }
    ...
    public int hashCode() {
        long j8 = this.f33035a;
        return (this.f33036b * 51) + ((int) (j8 ^ (j8 >>> 32)));
    }
    ...
    public final int j(j$.time.temporal.r rVar) {
        ...
        int i8 = f.f33119a[((j$.time.temporal.a) rVar).ordinal()];
        int i9 = this.f33036b;
        if (i8 == 1) {
            return i9;
        }
        ...
        if (i8 == 4) {
            j$.time.temporal.a.INSTANT_SECONDS.z(this.f33035a);
        }
    ...
    public final j$.time.temporal.m l(h hVar) {
        return (Instant) AbstractC3020i.a(hVar, this);
    }
    ...
    public final long r(j$.time.temporal.r rVar) {
        ...
        int i9 = f.f33119a[((j$.time.temporal.a) rVar).ordinal()];
    ...
    public final String toString() {
        return DateTimeFormatter.f33121f.a(this);
    }
    ...
    public final j$.time.temporal.m v(j$.time.temporal.m mVar) {
        return mVar.d(this.f33035a, j$.time.temporal.a.INSTANT_SECONDS).d(this.f33036b, j$.time.temporal.a.NANO_OF_SECOND);
    }
