...
public final class x extends ZoneId {
    ...
    public static final /* synthetic */ int f33244d = 0;
    ...
    private final transient j$.time.zone.f f33246c;
    ...
    public final j$.time.zone.f D() {
        j$.time.zone.f fVar = this.f33246c;
        return fVar != null ? fVar : j$.time.zone.j.a(this.f33245b, false);
    }
    ...
    public final void H(DataOutput dataOutput) {
        ...
        dataOutput.writeUTF(this.f33245b);
    }
