...
public final class e extends b implements Set, j$.util.Set {
    ...
    public final boolean add(Object obj) {
        ...
        return this.f33345a.f(entry.getKey(), entry.getValue(), false) == null;
    }
    ...
    public final boolean addAll(Collection collection) {
        ...
        while (it.hasNext()) {
            ...
            if (this.f33345a.f(entry.getKey(), entry.getValue(), false) == null) {
                z8 = true;
            }
        }
        return z8;
    ...
    public final boolean contains(Object obj) {
        ...
        Object obj2;
        Object value;
        return (!(obj instanceof Map.Entry) || (key = (entry = (Map.Entry) obj).getKey()) == null || (obj2 = this.f33345a.get(key)) == null || (value = entry.getValue()) == null || (value != obj2 && !value.equals(obj2))) ? false : true;
    }
    ...
    public final void forEach(Consumer consumer) {
        ...
        while (true) {
            ...
            if (a8 == null) {
                ...
                consumer.o(new k(a8.f33356b, a8.f33357c, this.f33345a));
            }
        }
    }
    ...
    public final Iterator iterator() {
        ...
        return new AbstractC3026a(lVarArr, length, length, concurrentHashMap);
    }
    ...
    public final boolean remove(Object obj) {
        ...
        Object key;
        Object value;
        return (obj instanceof Map.Entry) && (key = (entry = (Map.Entry) obj).getKey()) != null && (value = entry.getValue()) != null && this.f33345a.remove(key, value);
    }
