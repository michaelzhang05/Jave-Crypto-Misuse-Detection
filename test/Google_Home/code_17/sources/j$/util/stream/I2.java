...
final class I2 extends C {
    ...
    public final L0 K(AbstractC3047b abstractC3047b, Spliterator spliterator, IntFunction intFunction) {
        ...
        double[] dArr = (double[]) ((F0) abstractC3047b.y(spliterator, true, intFunction)).d();
        Arrays.sort(dArr);
        return new Y0(dArr);
    }
    ...
    public final InterfaceC3125q2 N(int i8, InterfaceC3125q2 interfaceC3125q2) {
        ...
        return EnumC3066e3.SORTED.r(i8) ? interfaceC3125q2 : EnumC3066e3.SIZED.r(i8) ? new AbstractC3090j2(interfaceC3125q2) : new AbstractC3090j2(interfaceC3125q2);
    }
}
