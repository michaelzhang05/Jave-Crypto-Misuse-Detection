...
public final class P0 implements L0 {
    ...
    private final Collection f33573a;

    /* JADX INFO: Access modifiers changed from: package-private */
    public P0(Collection collection) {
        this.f33573a = collection;
    }
    ...
    public final void forEach(Consumer consumer) {
        Collection.EL.a(this.f33573a, consumer);
    }
    ...
    public final Object[] n(IntFunction intFunction) {
        java.util.Collection collection = this.f33573a;
    ...
    public final Spliterator spliterator() {
        return Collection.EL.stream(this.f33573a).spliterator();
    }
