...
public interface Stream<T> extends InterfaceC3077h {

    /* renamed from: j$.util.stream.Stream$-CC */
    /* loaded from: classes2.dex */
    public final /* synthetic */ class CC {
        public static <T> Stream<T> of(T... tArr) {
            return AbstractC3163z0.g0(j$.util.u0.m(tArr, 0, tArr.length), false);
        }
    }
    ...
    public final /* synthetic */ class Wrapper implements java.util.stream.Stream {
        ...
        public static /* synthetic */ java.util.stream.Stream convert(Stream stream) {
            ...
            return stream instanceof C3051b3 ? ((C3051b3) stream).f33686a : new Wrapper();
        }
        ...
        public final /* synthetic */ Object collect(java.util.stream.Collector collector) {
            return Stream.this.collect(C3087j.a(collector));
        }
        ...
        public final /* synthetic */ Optional findAny() {
            return AbstractC3027d.m(Stream.this.findAny());
        }

        @Override // java.util.stream.Stream
        public final /* synthetic */ Optional findFirst() {
            return AbstractC3027d.m(Stream.this.findFirst());
        }

        @Override // java.util.stream.Stream
        public final /* synthetic */ java.util.stream.Stream flatMap(Function function) {
            return convert(Stream.this.b(AbstractC3163z0.S(function)));
        }

        @Override // java.util.stream.Stream
        public final /* synthetic */ DoubleStream flatMapToDouble(Function function) {
            return F.w(Stream.this.v(AbstractC3163z0.S(function)));
        }

        @Override // java.util.stream.Stream
        public final /* synthetic */ java.util.stream.IntStream flatMapToInt(Function function) {
            return IntStream.Wrapper.convert(Stream.this.p(AbstractC3163z0.S(function)));
        }

        @Override // java.util.stream.Stream
        public final /* synthetic */ LongStream flatMapToLong(Function function) {
            return C3113o0.w(Stream.this.k(AbstractC3163z0.S(function)));
        }
        ...
        public final /* synthetic */ LongStream mapToLong(ToLongFunction toLongFunction) {
            return C3113o0.w(Stream.this.mapToLong(toLongFunction));
        }

        @Override // java.util.stream.Stream
        public final /* synthetic */ Optional max(Comparator comparator) {
            return AbstractC3027d.m(Stream.this.max(comparator));
        }

        @Override // java.util.stream.Stream
        public final /* synthetic */ Optional min(Comparator comparator) {
            return AbstractC3027d.m(Stream.this.min(comparator));
        }
        ...
        public final /* synthetic */ BaseStream onClose(Runnable runnable) {
            return C3072g.w(Stream.this.onClose(runnable));
        }

        @Override // java.util.stream.BaseStream
        public final /* synthetic */ BaseStream parallel() {
            return C3072g.w(Stream.this.parallel());
        }
        ...
        public final /* synthetic */ Optional reduce(BinaryOperator binaryOperator) {
            return AbstractC3027d.m(Stream.this.reduce(binaryOperator));
        }

        @Override // java.util.stream.BaseStream
        public final /* synthetic */ BaseStream sequential() {
            return C3072g.w(Stream.this.sequential());
        }
        ...
        public final /* synthetic */ BaseStream unordered() {
            return C3072g.w(Stream.this.unordered());
        }
    }
    ...
    InterfaceC3118p0 k(C3042a c3042a);
    ...
    InterfaceC3118p0 mapToLong(ToLongFunction toLongFunction);
