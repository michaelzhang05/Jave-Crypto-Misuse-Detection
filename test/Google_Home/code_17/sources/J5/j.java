...
public final class j extends RowHeaderPresenter {
    ...
    public void onBindViewHolder(Presenter.ViewHolder viewHolder, Object item) {
        ...
        AbstractC3255y.g(headerItem, "null cannot be cast to non-null type com.uptodown.tv.model.IconHeaderItem");
        C2960a c2960a = (C2960a) headerItem;
        View view = viewHolder.view;
        view.setFocusable(true);
        View findViewById = view.findViewById(R.id.iv_icon_header_item);
        AbstractC3255y.h(findViewById, "rootView.findViewById(R.id.iv_icon_header_item)");
        ((ImageView) findViewById).setImageDrawable(ContextCompat.getDrawable(view.getContext(), c2960a.a()));
        View findViewById2 = view.findViewById(R.id.tv_name_header_item);
        AbstractC3255y.h(findViewById2, "rootView.findViewById(R.id.tv_name_header_item)");
        TextView textView = (TextView) findViewById2;
        textView.setTypeface(H4.j.f3824g.t());
        textView.setText(c2960a.getName());
    }
}
