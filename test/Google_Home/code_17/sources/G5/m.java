...
public final class m implements ViewModelProvider.Factory {
    ...
    public ViewModel create(Class modelClass) {
        ...
        return new l(dVar.n(), dVar.j(), ChoiceCmp.INSTANCE.getGoogleVendorList$app_release(), dVar.j().f3925b.b(), dVar.k(), dVar.c(), dVar.j().f3925b.f3899q, dVar.p().c(), dVar.e(), dVar.f());
    }
}
