...
public abstract class AbstractC4221b implements InterfaceC4222c {

    /* renamed from: a, reason: collision with root package name */
    protected Map f41069a;

    /* renamed from: b, reason: collision with root package name */
    protected String[][] f41070b;

    @Override // z1.InterfaceC4222c
    public void a(String str, Object obj) {
        if (this.f41069a.containsKey(str)) {
            ((AbstractC4086a) this.f41069a.get(str)).d(obj);
            return;
        }
    ...
    public Object c(String str) {
        if (this.f41069a.containsKey(str)) {
            return ((AbstractC4086a) this.f41069a.get(str)).c();
        }
        return null;
    }
    ...
    */
    public void d(java.util.List r9) {
        /*
            ...
            r1 = 0
        L2:
            java.lang.String[][] r2 = r8.f41070b
            int r2 = r2.length
            if (r1 >= r2) goto L7c
            int r2 = r9.size()
            if (r1 >= r2) goto L7c
            ...
            r4 = 0
        L1d:
            java.lang.String[][] r5 = r8.f41070b
            r5 = r5[r1]
            int r6 = r5.length
            if (r3 >= r6) goto L79
            r5 = r5[r3]
            java.util.Map r6 = r8.f41069a
            boolean r6 = r6.containsKey(r5)
            if (r6 == 0) goto L5d
            java.util.Map r6 = r8.f41069a     // Catch: java.lang.Exception -> L45
            java.lang.Object r6 = r6.get(r5)     // Catch: java.lang.Exception -> L45
            v1.a r6 = (v1.AbstractC4086a) r6     // Catch: java.lang.Exception -> L45
        ...
        L7c:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: z1.AbstractC4221b.d(java.util.List):void");
    }
    ...
    */
    public java.util.List e() {
        /*
            ...
            r2 = 0
        L7:
            java.lang.String[][] r3 = r8.f41070b
            int r3 = r3.length
            if (r2 >= r3) goto L78
            java.lang.String r3 = ""
            r4 = 0
        Lf:
            ...
            boolean r6 = r6.containsKey(r5)
            if (r6 == 0) goto L56
            java.util.Map r6 = r8.f41069a     // Catch: java.lang.Exception -> L3e
            java.lang.Object r6 = r6.get(r5)     // Catch: java.lang.Exception -> L3e
            v1.a r6 = (v1.AbstractC4086a) r6     // Catch: java.lang.Exception -> L3e
        ...
        L78:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: z1.AbstractC4221b.e():java.util.List");
    }
}
