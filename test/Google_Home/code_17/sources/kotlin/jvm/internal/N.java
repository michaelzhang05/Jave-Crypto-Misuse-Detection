...
public abstract class N extends AbstractC3242k implements h6.i {
    ...
    */
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof N) {
            N n8 = (N) obj;
            if (getOwner().equals(n8.getOwner()) && getName().equals(n8.getName()) && getSignature().equals(n8.getSignature()) && AbstractC3255y.d(getBoundReceiver(), n8.getBoundReceiver())) {
                return true;
            }
            return false;
        }
    ...
    @Override // kotlin.jvm.internal.AbstractC3242k
    public h6.i getReflected() {
        if (!this.syntheticJavaProperty) {
            return (h6.i) super.getReflected();
        }
