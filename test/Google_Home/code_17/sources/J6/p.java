...
public abstract class p extends o {
    ...
    private static final int c(String str) {
        ...
        while (true) {
            if (i8 < length) {
                if (!AbstractC3202a.c(str.charAt(i8))) {
                    break;
                }
                i8++;
            } else {
    ...
    public static final String d(String str, String newIndent) {
        ...
        AbstractC3255y.i(newIndent, "newIndent");
        List a02 = x.a0(str);
        ...
        Integer num = (Integer) AbstractC1378t.C0(arrayList2);
        int i9 = 0;
        if (num != null) {
            i8 = num.intValue();
        } else {
        ...
        String sb = ((StringBuilder) AbstractC1378t.u0(arrayList3, new StringBuilder(length), "\n", null, null, 0, null, null, 124, null)).toString();
