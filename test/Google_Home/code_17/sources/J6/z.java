...
public abstract class z extends y {
    ...
    public static String P0(String str, int i8) {
        ...
        if (i8 >= 0) {
            String substring = str.substring(g6.m.g(i8, str.length()));
    ...
    public static String T0(String str, g6.i indices) {
        AbstractC3255y.i(str, "<this>");
    ...
    public static String U0(String str, int i8) {
        AbstractC3255y.i(str, "<this>");
        if (i8 >= 0) {
            String substring = str.substring(0, g6.m.g(i8, str.length()));
            AbstractC3255y.h(substring, "substring(...)");
            return substring;
        }
        throw new IllegalArgumentException(("Requested character count " + i8 + " is less than zero.").toString());
    ...
    public static String V0(String str, int i8) {
        ...
        if (i8 >= 0) {
            ...
            String substring = str.substring(length - g6.m.g(i8, length));
            AbstractC3255y.h(substring, "substring(...)");
            return substring;
        }
        throw new IllegalArgumentException(("Requested character count " + i8 + " is less than zero.").toString());
    ...
    public static final List X0(CharSequence charSequence, int i8, int i9, boolean z8) {
        AbstractC3255y.i(charSequence, "<this>");
        return Y0(charSequence, i8, i9, z8, a.f34071a);
    }
