...
public abstract class w extends v {
    ...
    public static String o(char[] cArr, int i8, int i9) {
        AbstractC3255y.i(cArr, "<this>");
        AbstractC1362c.Companion.a(i8, i9, cArr.length);
    ...
    public static boolean u(CharSequence charSequence) {
        ...
        if (charSequence.length() != 0) {
            ...
            if (!(L8 instanceof Collection) || !((Collection) L8).isEmpty()) {
                ...
                while (it.hasNext()) {
                    if (!AbstractC3202a.c(charSequence.charAt(((N) it).nextInt()))) {
                        return false;
                    }
                }
            }
        ...
        if (i8 >= 0) {
            ...
            if (i8 != 1) {
                ...
                if (length != 1) {
                    ...
                    N it = new g6.i(1, i8).iterator();
                    while (it.hasNext()) {
                        it.nextInt();
                        sb.append(charSequence);
                    }
                    String sb2 = sb.toString();
                    AbstractC3255y.f(sb2);
                    return sb2;
                }
    ...
    public static final String x(String str, char c8, char c9, boolean z8) {
        ...
        if (!z8) {
            ...
            AbstractC3255y.h(replace, "replace(...)");
            return replace;
        }
        StringBuilder sb = new StringBuilder(str.length());
        for (int i8 = 0; i8 < str.length(); i8++) {
            char charAt = str.charAt(i8);
            if (AbstractC3204c.h(charAt, c8, z8)) {
                charAt = c9;
            }
            sb.append(charAt);
        }
