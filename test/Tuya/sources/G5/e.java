...
public final class e extends Presenter {
    ...
    public void onBindViewHolder(Presenter.ViewHolder viewHolder, Object item) {
        ...
        if (item instanceof C1498h) {
            ...
            if (textView != null) {
                ...
                textView.setTextColor(this.f31270c);
                textView.setTypeface(E4.j.f2274g.t());
            }
            TextView textView2 = (TextView) imageCardView.findViewById(R.id.content_text);
            if (textView2 != null) {
                textView2.setVisibility(0);
                textView2.setTextColor(this.f31270c);
    ...
    public Presenter.ViewHolder onCreateViewHolder(ViewGroup parent) {
        ...
        if (parent.getContext() != null) {
            this.f31269b = ContextCompat.getColor(parent.getContext(), R.color.white);
            this.f31268a = ContextCompat.getColor(parent.getContext(), R.color.main_blue_pressed);
            this.f31270c = ContextCompat.getColor(parent.getContext(), R.color.white);
            this.f31271d = ContextCompat.getColor(parent.getContext(), R.color.white);
