...
public final class C3307A {
    ...
    public static final C3307A f34473a = new C3307A();

    /* renamed from: b, reason: collision with root package name */
    private static ArrayList f34474b = new ArrayList();

    /* renamed from: c, reason: collision with root package name */
    private static Y4.f f34475c = new Y4.f(null);

    /* renamed from: d, reason: collision with root package name */
    private static Y4.e f34476d = new Y4.e(null);

    /* renamed from: e, reason: collision with root package name */
    private static ConcurrentHashMap f34477e = new ConcurrentHashMap();

    /* renamed from: f, reason: collision with root package name */
    private static ArrayList f34478f = new ArrayList();

    /* renamed from: g, reason: collision with root package name */
    private static ArrayList f34479g = new ArrayList();

    private C3307A() {
    }

    public final void a(long j8) {
        f34479g.add(Long.valueOf(j8));
    }

    public final void b(long j8) {
        f34478f.add(Long.valueOf(j8));
    }
    ...
    public final String e() {
        ...
        return N4.d.f7201a.c("$(=a%·!45J&S" + timeInMillis);
    }
    ...
    public final boolean h(long j8) {
        return f34479g.contains(Long.valueOf(j8));
    }

    public final boolean i(long j8) {
        return f34478f.contains(Long.valueOf(j8));
    }
    ...
    public final Drawable k(Context context, String str, int i8) {
        AbstractC3159y.i(context, "context");
        if (str != null) {
            Drawable drawable = (Drawable) f34477e.get(str);
            if (drawable == null) {
                try {
    ...
    public final Drawable l(Context context, String pathFile, int i8) {
        ...
        Drawable drawable = (Drawable) f34477e.get(pathFile);
        if (drawable == null) {
    ...
    public final void m(long j8) {
        f34478f.remove(Long.valueOf(j8));
    }
    ...
    public final void n(HttpsURLConnection mHttpsURLConnection) {
        ...
        mHttpsURLConnection.setRequestProperty("Identificador-Version", "627");
