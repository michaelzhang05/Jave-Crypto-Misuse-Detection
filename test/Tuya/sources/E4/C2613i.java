...
public final class C2613i extends AbstractC2608f0 {
    ...
    private final m4.G f30699a;
    public static final b Companion = new b(null);

    /* renamed from: b, reason: collision with root package name */
    public static final int f30698b = m4.G.f35073d;
    ...
    public static final class a implements x6.C {
        ...
        /* renamed from: b, reason: collision with root package name */
        private static final /* synthetic */ C3944e0 f30701b;
    ...
    public /* synthetic */ C2613i(int i8, m4.G g8, x6.n0 n0Var) {
        super(null);
        if ((i8 & 1) == 0) {
            this.f30699a = m4.G.Companion.a("au_becs_debit[account_number]");
        } else {
            this.f30699a = g8;
        }
    }
    ...
    public static final /* synthetic */ void j(C2613i c2613i, w6.d dVar, v6.f fVar) {
        if (dVar.i(fVar, 0) || !AbstractC3159y.d(c2613i.f(), m4.G.Companion.a("au_becs_debit[account_number]"))) {
            dVar.A(fVar, 0, G.a.f35099a, c2613i.f());
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        if ((obj instanceof C2613i) && AbstractC3159y.d(this.f30699a, ((C2613i) obj).f30699a)) {
            return true;
        }
        return false;
    }
    ...
    public String toString() {
        return "AuBankAccountNumberSpec(apiPath=" + this.f30699a + ")";
    }

    @Override // android.os.Parcelable
    public void writeToParcel(Parcel out, int i8) {
        AbstractC3159y.i(out, "out");
        out.writeParcelable(this.f30699a, i8);
    }
