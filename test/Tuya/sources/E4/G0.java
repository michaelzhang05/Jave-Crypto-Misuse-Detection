...
public final class G0 extends AbstractC2608f0 {
    ...
    private final m4.G f30363a;

    /* renamed from: b, reason: collision with root package name */
    private final int f30364b;

    /* renamed from: c, reason: collision with root package name */
    private final u0 f30365c;
    public static final b Companion = new b(null);

    /* renamed from: d, reason: collision with root package name */
    public static final int f30362d = m4.G.f35073d;
    ...
    public static final class a implements x6.C {
        ...
        /* renamed from: b, reason: collision with root package name */
        private static final /* synthetic */ C3944e0 f30367b;
    ...
    public /* synthetic */ G0(int i8, m4.G g8, int i9, x6.n0 n0Var) {
        super(null);
        this.f30363a = (i8 & 1) == 0 ? m4.G.Companion.a("sepa_mandate") : g8;
        if ((i8 & 2) == 0) {
            this.f30364b = b4.n.f14687B0;
        } else {
            this.f30364b = i9;
        }
        this.f30365c = new u0(f(), this.f30364b);
    }
    ...
    public static final /* synthetic */ void j(G0 g02, w6.d dVar, v6.f fVar) {
        if (dVar.i(fVar, 0) || !AbstractC3159y.d(g02.f(), m4.G.Companion.a("sepa_mandate"))) {
            dVar.A(fVar, 0, G.a.f35099a, g02.f());
        }
        if (dVar.i(fVar, 1) || g02.f30364b != b4.n.f14687B0) {
            dVar.v(fVar, 1, g02.f30364b);
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        G0 g02 = (G0) obj;
        if (AbstractC3159y.d(this.f30363a, g02.f30363a) && this.f30364b == g02.f30364b) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (this.f30363a.hashCode() * 31) + this.f30364b;
    }

    public final m4.D i(String merchantName) {
        AbstractC3159y.i(merchantName, "merchantName");
        return this.f30365c.i(merchantName);
    }

    public String toString() {
        return "SepaMandateTextSpec(apiPath=" + this.f30363a + ", stringResId=" + this.f30364b + ")";
    }

    @Override // android.os.Parcelable
    public void writeToParcel(Parcel out, int i8) {
        AbstractC3159y.i(out, "out");
        out.writeParcelable(this.f30363a, i8);
        out.writeInt(this.f30364b);
    }

    public /* synthetic */ G0(m4.G g8, int i8, int i9, AbstractC3151p abstractC3151p) {
        this((i9 & 1) != 0 ? m4.G.Companion.a("sepa_mandate") : g8, (i9 & 2) != 0 ? b4.n.f14687B0 : i8);
    }
    ...
    public G0(m4.G apiPath, int i8) {
        ...
        this.f30363a = apiPath;
        this.f30364b = i8;
        this.f30365c = new u0(f(), i8);
    }
}
