...
final class C3016t extends C3019w {
    ...
    public final boolean contains(Object obj) {
        ...
        return this.f32249a.contains(new r((Map.Entry) obj));
    }
    ...
    public final void forEach(Consumer consumer) {
        ...
        Collection.EL.a(this.f32249a, new C2890q(consumer));
    }
    ...
    public final Spliterator spliterator() {
        return new C2891s(Collection.EL.c(this.f32249a));
    }
    ...
    public final Object[] toArray() {
        Object[] array = this.f32249a.toArray();
    ...
    public final Object[] toArray(Object[] objArr) {
        Object[] array = this.f32249a.toArray(objArr.length == 0 ? objArr : Arrays.copyOf(objArr, 0));
        for (int i8 = 0; i8 < array.length; i8++) {
            array[i8] = new r((Map.Entry) array[i8]);
        }
