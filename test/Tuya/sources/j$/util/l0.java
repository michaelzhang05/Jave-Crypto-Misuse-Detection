...
final class l0 implements Spliterator {
    ...
    public final long estimateSize() {
        return this.f32241c - this.f32240b;
    }
    ...
    public final void forEachRemaining(Consumer consumer) {
        int i8;
        consumer.getClass();
        Object[] objArr = this.f32239a;
        int length = objArr.length;
        int i9 = this.f32241c;
        if (length < i9 || (i8 = this.f32240b) < 0) {
            return;
        }
        this.f32240b = i9;
        if (i8 >= i9) {
    ...
    public final boolean tryAdvance(Consumer consumer) {
        consumer.getClass();
        int i8 = this.f32240b;
        if (i8 < 0 || i8 >= this.f32241c) {
            return false;
        }
        this.f32240b = i8 + 1;
        consumer.accept(this.f32239a[i8]);
        return true;
    }
    ...
    public final Spliterator trySplit() {
        int i8 = this.f32240b;
        int i9 = (this.f32241c + i8) >>> 1;
        if (i8 >= i9) {
            return null;
        }
        this.f32240b = i9;
        return new l0(this.f32239a, i8, i9, this.f32242d);
    }
}
