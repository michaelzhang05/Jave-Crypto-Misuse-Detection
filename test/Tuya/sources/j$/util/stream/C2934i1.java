...
public final class C2934i1 extends C2929h1 implements B0 {
    ...
    public final H0 a() {
        int i8 = this.f32555b;
        int[] iArr = this.f32554a;
        if (i8 >= iArr.length) {
            return this;
        }
        throw new IllegalStateException(String.format("Current size %d is less than fixed size %d", Integer.valueOf(this.f32555b), Integer.valueOf(iArr.length)));
    }
    ...
    public final void j() {
        ...
        int[] iArr = this.f32554a;
        if (i8 < iArr.length) {
            throw new IllegalStateException(String.format("End size %d is less than fixed size %d", Integer.valueOf(this.f32555b), Integer.valueOf(iArr.length)));
        }
    }
    ...
    public final String toString() {
        int[] iArr = this.f32554a;
        return String.format("IntFixedNodeBuilder[%d][%s]", Integer.valueOf(iArr.length - this.f32555b), Arrays.toString(iArr));
    }
}
