...
public class C2929h1 implements H0 {
    ...
    public final void e(Object obj) {
        ...
        for (int i8 = 0; i8 < this.f32555b; i8++) {
            intConsumer.accept(this.f32554a[i8]);
        }
    }
    ...
    public final void q(int i8, Object obj) {
        int i9 = this.f32555b;
        System.arraycopy(this.f32554a, 0, (int[]) obj, i8, i9);
    }
    ...
    public final Spliterator spliterator() {
        return j$.util.u0.k(this.f32554a, 0, this.f32555b);
    }
    ...
    public String toString() {
        int[] iArr = this.f32554a;
        return String.format("IntArrayNode[%d][%s]", Integer.valueOf(iArr.length - this.f32555b), Arrays.toString(iArr));
    }
}
