...
public abstract /* synthetic */ class AbstractC3013z0 implements K3 {
    ...
    private static final C2914e1 f32667a = new Object();

    /* renamed from: b, reason: collision with root package name */
    private static final H0 f32668b = new Object();

    /* renamed from: c, reason: collision with root package name */
    private static final J0 f32669c = new Object();

    /* renamed from: d, reason: collision with root package name */
    private static final F0 f32670d = new Object();

    /* renamed from: e, reason: collision with root package name */
    private static final int[] f32671e = new int[0];

    /* renamed from: f, reason: collision with root package name */
    private static final long[] f32672f = new long[0];

    /* renamed from: g, reason: collision with root package name */
    private static final double[] f32673g = new double[0];
    ...
    public static Spliterator C(EnumC2921f3 enumC2921f3, Spliterator spliterator, long j8, long j9) {
        ...
        int i8 = AbstractC3015z2.f32674a[enumC2921f3.ordinal()];
        if (i8 == 1) {
    ...
    public static N0 I(EnumC2921f3 enumC2921f3, L0 l02, L0 l03) {
        int i8 = M0.f32352a[enumC2921f3.ordinal()];
        if (i8 == 1) {
    ...
    private static int M(long j8) {
        return (j8 != -1 ? EnumC2916e3.f32530u : 0) | EnumC2916e3.f32529t;
    }
