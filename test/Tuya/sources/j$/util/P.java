...
public final /* synthetic */ class P implements PrimitiveIterator.OfLong {
    ...
    public static /* synthetic */ PrimitiveIterator.OfLong a(Q q8) {
        ...
        return q8 instanceof O ? ((O) q8).f32105a : new P(q8);
    }
    ...
    public final /* synthetic */ void forEachRemaining(LongConsumer longConsumer) {
        this.f32106a.forEachRemaining((Object) longConsumer);
    }

    @Override // java.util.PrimitiveIterator.OfLong, java.util.Iterator
    public final /* synthetic */ void forEachRemaining(Consumer consumer) {
        this.f32106a.forEachRemaining(consumer);
    }

    @Override // java.util.PrimitiveIterator.OfLong
    /* renamed from: forEachRemaining, reason: avoid collision after fix types in other method */
    public final /* synthetic */ void forEachRemaining2(LongConsumer longConsumer) {
        this.f32106a.forEachRemaining(longConsumer);
    }

    @Override // java.util.Iterator
    public final /* synthetic */ boolean hasNext() {
        return this.f32106a.hasNext();
    }
