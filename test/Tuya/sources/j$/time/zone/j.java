...
public abstract class j {
    ...
    private static final CopyOnWriteArrayList f32085a;

    /* renamed from: b, reason: collision with root package name */
    private static final ConcurrentHashMap f32086b;

    static {
        CopyOnWriteArrayList copyOnWriteArrayList = new CopyOnWriteArrayList();
        f32085a = copyOnWriteArrayList;
        f32086b = new ConcurrentHashMap(512, 0.75f, 2);
    ...
    public static f a(String str, boolean z8) {
        ...
        ConcurrentHashMap concurrentHashMap = f32086b;
        ...
        synchronized (j.class) {
            try {
                for (String str : jVar.c()) {
                    Objects.requireNonNull(str, "zoneId");
                    if (((j) f32086b.putIfAbsent(str, jVar)) != null) {
                ...
                Collections.unmodifiableSet(new HashSet(f32086b.keySet()));
            } catch (Throwable th) {
                throw th;
            }
        }
