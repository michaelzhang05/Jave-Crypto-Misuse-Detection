...
public final class f implements Serializable {
    ...
    private static final long[] f32071i = new long[0];

    /* renamed from: j, reason: collision with root package name */
    private static final e[] f32072j = new e[0];

    /* renamed from: k, reason: collision with root package name */
    private static final LocalDateTime[] f32073k = new LocalDateTime[0];

    /* renamed from: l, reason: collision with root package name */
    private static final b[] f32074l = new b[0];
    ...
    private final ZoneOffset[] f32076b;

    /* renamed from: c, reason: collision with root package name */
    private final long[] f32077c;

    /* renamed from: d, reason: collision with root package name */
    private final LocalDateTime[] f32078d;

    /* renamed from: e, reason: collision with root package name */
    private final ZoneOffset[] f32079e;

    /* renamed from: f, reason: collision with root package name */
    private final e[] f32080f;

    /* renamed from: g, reason: collision with root package name */
    private final TimeZone f32081g;

    /* renamed from: h, reason: collision with root package name */
    private final transient ConcurrentHashMap f32082h = new ConcurrentHashMap();
    ...
    private f(ZoneOffset zoneOffset) {
        ...
        this.f32075a = jArr;
        this.f32077c = jArr;
        this.f32078d = f32073k;
        this.f32079e = zoneOffsetArr;
        this.f32080f = f32072j;
        this.f32081g = null;
    }
    ...
    public f(TimeZone timeZone) {
        ...
        this.f32079e = zoneOffsetArr;
        this.f32080f = f32072j;
        this.f32081g = timeZone;
    }

    private f(long[] jArr, ZoneOffset[] zoneOffsetArr, long[] jArr2, ZoneOffset[] zoneOffsetArr2, e[] eVarArr) {
        LocalDateTime l8;
        this.f32075a = jArr;
        this.f32076b = zoneOffsetArr;
        this.f32077c = jArr2;
        this.f32079e = zoneOffsetArr2;
        this.f32080f = eVarArr;
        if (jArr2.length == 0) {
            this.f32078d = f32073k;
        } else {
            ...
            this.f32078d = (LocalDateTime[]) arrayList.toArray(new LocalDateTime[arrayList.size()]);
        }
        this.f32081g = null;
    }
    ...
    private b[] b(int i8) {
        ...
        ConcurrentHashMap concurrentHashMap = this.f32082h;
        b[] bVarArr = (b[]) concurrentHashMap.get(valueOf);
        if (bVarArr != null) {
            return bVarArr;
        }
        TimeZone timeZone = this.f32081g;
        if (timeZone == null) {
            e[] eVarArr = this.f32080f;
        ...
        long n8 = AbstractC2870i.n(LocalDateTime.M(i8 - 1), this.f32076b[0]);
    ...
    private Object e(LocalDateTime localDateTime) {
        Object obj = null;
        ZoneOffset[] zoneOffsetArr = this.f32076b;
        int i8 = 0;
        TimeZone timeZone = this.f32081g;
        if (timeZone != null) {
            b[] b8 = b(localDateTime.J());
            if (b8.length == 0) {
                return j(timeZone.getOffset(AbstractC2870i.n(localDateTime, zoneOffsetArr[0]) * 1000));
            }
        ...
        if (this.f32077c.length == 0) {
            return zoneOffsetArr[0];
        }
        int length2 = this.f32080f.length;
        LocalDateTime[] localDateTimeArr = this.f32078d;
        ...
        ZoneOffset[] zoneOffsetArr2 = this.f32079e;
        if (binarySearch == -1) {
    ...
    public static f k(DataInput dataInput) {
        ...
        e[] eVarArr = readByte == 0 ? f32072j : new e[readByte];
    ...
    private Object writeReplace() {
        return new a(this.f32081g != null ? (byte) 100 : (byte) 1, this);
    }
    ...
    public final ZoneOffset d(Instant instant) {
        ...
        long[] jArr = this.f32077c;
        if (jArr.length == 0) {
            return this.f32076b[0];
        }
        long E8 = instant.E();
        int length = this.f32080f.length;
        ZoneOffset[] zoneOffsetArr = this.f32079e;
    ...
    public final boolean equals(Object obj) {
        ...
        f fVar = (f) obj;
        return Objects.equals(this.f32081g, fVar.f32081g) && Arrays.equals(this.f32075a, fVar.f32075a) && Arrays.equals(this.f32076b, fVar.f32076b) && Arrays.equals(this.f32077c, fVar.f32077c) && Arrays.equals(this.f32079e, fVar.f32079e) && Arrays.equals(this.f32080f, fVar.f32080f);
    }
    ...
    public final int hashCode() {
        TimeZone timeZone = this.f32081g;
        return (((((timeZone != null ? timeZone.hashCode() : 0) ^ Arrays.hashCode(this.f32075a)) ^ Arrays.hashCode(this.f32076b)) ^ Arrays.hashCode(this.f32077c)) ^ Arrays.hashCode(this.f32079e)) ^ Arrays.hashCode(this.f32080f);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public final void l(DataOutput dataOutput) {
        long[] jArr = this.f32075a;
        dataOutput.writeInt(jArr.length);
        for (long j8 : jArr) {
            a.c(j8, dataOutput);
        }
        for (ZoneOffset zoneOffset : this.f32076b) {
            a.d(zoneOffset, dataOutput);
        }
        long[] jArr2 = this.f32077c;
        dataOutput.writeInt(jArr2.length);
        for (long j9 : jArr2) {
            a.c(j9, dataOutput);
        }
        for (ZoneOffset zoneOffset2 : this.f32079e) {
    ...
    public final void m(DataOutput dataOutput) {
        dataOutput.writeUTF(this.f32081g.getID());
    }
    ...
    public final String toString() {
        ...
        if (timeZone != null) {
            ...
            ZoneOffset zoneOffset = this.f32076b[r1.length - 1];
