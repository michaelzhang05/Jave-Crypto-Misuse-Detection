...
public final class o implements j$.time.temporal.o, j$.time.temporal.p, Comparable, Serializable {
    ...
    public final void E(DataOutput dataOutput) {
        dataOutput.writeByte(this.f31999a);
        dataOutput.writeByte(this.f32000b);
    }

    @Override // java.lang.Comparable
    public final int compareTo(Object obj) {
        o oVar = (o) obj;
        int i8 = this.f31999a - oVar.f31999a;
        return i8 == 0 ? this.f32000b - oVar.f32000b : i8;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        o oVar = (o) obj;
        return this.f31999a == oVar.f31999a && this.f32000b == oVar.f32000b;
    }
    ...
    public final int hashCode() {
        return (this.f31999a << 6) + this.f32000b;
    }
    ...
    public final j$.time.temporal.w m(j$.time.temporal.r rVar) {
        ...
        m G8 = m.G(this.f31999a);
        G8.getClass();
        int i8 = l.f31995a[G8.ordinal()];
    ...
    public final long r(j$.time.temporal.r rVar) {
        ...
        int i9 = n.f31998a[((j$.time.temporal.a) rVar).ordinal()];
        if (i9 == 1) {
            i8 = this.f32000b;
        } else {
            if (i9 != 2) {
    ...
    public final Object u(j$.time.temporal.t tVar) {
        return tVar == j$.time.temporal.n.e() ? j$.time.chrono.t.f31909d : j$.time.temporal.n.c(this, tVar);
    }
    ...
    public final j$.time.temporal.m v(j$.time.temporal.m mVar) {
        ...
        j$.time.temporal.m d8 = mVar.d(this.f31999a, j$.time.temporal.a.MONTH_OF_YEAR);
        j$.time.temporal.a aVar = j$.time.temporal.a.DAY_OF_MONTH;
        return d8.d(Math.min(d8.m(aVar).d(), this.f32000b), aVar);
    }
}
