...
public final class ZoneOffset extends ZoneId implements j$.time.temporal.o, j$.time.temporal.p, Comparable<ZoneOffset>, Serializable {
    ...
    private final transient String f31855c;

    /* renamed from: d, reason: collision with root package name */
    private static final ConcurrentHashMap f31850d = new ConcurrentHashMap(16, 0.75f, 4);

    /* renamed from: e, reason: collision with root package name */
    private static final ConcurrentHashMap f31851e = new ConcurrentHashMap(16, 0.75f, 4);
    public static final ZoneOffset UTC = M(0);

    /* renamed from: f, reason: collision with root package name */
    public static final ZoneOffset f31852f = M(-64800);

    /* renamed from: g, reason: collision with root package name */
    public static final ZoneOffset f31853g = M(64800);
    ...
    */
    public static j$.time.ZoneOffset K(java.lang.String r7) {
        /*
            ...
            j$.util.concurrent.ConcurrentHashMap r0 = j$.time.ZoneOffset.f31851e
    ...
    public static ZoneOffset M(int i8) {
        ...
        ConcurrentHashMap concurrentHashMap = f31850d;
        ...
        f31851e.putIfAbsent(zoneOffset2.f31855c, zoneOffset2);
        return zoneOffset2;
    }
    ...
    public final int compareTo(ZoneOffset zoneOffset) {
        return zoneOffset.f31854b - this.f31854b;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof ZoneOffset) {
            return this.f31854b == ((ZoneOffset) obj).f31854b;
        }
        return false;
    }
    ...
    public final j$.time.temporal.m v(j$.time.temporal.m mVar) {
        return mVar.d(this.f31854b, j$.time.temporal.a.OFFSET_SECONDS);
    }
}
