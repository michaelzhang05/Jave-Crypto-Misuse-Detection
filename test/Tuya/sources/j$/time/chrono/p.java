...
public final class p extends AbstractC2862a implements Serializable {
    ...
    public static final p f31891o;
    private static final long serialVersionUID = 3127340209035924785L;

    /* renamed from: d, reason: collision with root package name */
    private final transient String f31892d = "Hijrah-umalqura";

    /* renamed from: e, reason: collision with root package name */
    private final transient String f31893e = LocalePreferences.CalendarType.ISLAMIC_UMALQURA;

    /* renamed from: f, reason: collision with root package name */
    private volatile transient boolean f31894f;

    /* renamed from: g, reason: collision with root package name */
    private transient int[] f31895g;

    /* renamed from: h, reason: collision with root package name */
    private transient int f31896h;

    /* renamed from: i, reason: collision with root package name */
    private transient int f31897i;

    /* renamed from: j, reason: collision with root package name */
    private transient int f31898j;

    /* renamed from: k, reason: collision with root package name */
    private transient int f31899k;

    /* renamed from: l, reason: collision with root package name */
    private transient int f31900l;

    /* renamed from: m, reason: collision with root package name */
    private transient int f31901m;

    /* renamed from: n, reason: collision with root package name */
    private transient int f31902n;
    ...
    private void m() {
        ...
        try {
            ...
            if (!this.f31893e.equals(LocalePreferences.CalendarType.ISLAMIC_UMALQURA)) {
            ...
            int[] u8 = u(s8, hashMap);
            this.f31895g = u8;
            this.f31897i = u8[3612];
            for (int i9 = 1300; i9 < 1600; i9++) {
                int i10 = (i9 * 12) - this.f31898j;
                int[] iArr2 = this.f31895g;
                int i11 = iArr2[i10 + 12] - iArr2[i10];
                this.f31901m = Math.min(this.f31901m, i11);
                this.f31902n = Math.max(this.f31902n, i11);
            }
            this.f31894f = true;
        } catch (Exception e8) {
    ...
    private int[] u(int i8, HashMap hashMap) {
        ...
        this.f31899k = Integer.MAX_VALUE;
        this.f31900l = Integer.MIN_VALUE;
        int i9 = 0;
        for (int i10 = 1300; i10 <= 1600; i10++) {
            ...
            while (i11 < 12) {
                ...
                i8 += i12;
                this.f31899k = Math.min(this.f31899k, i12);
                this.f31900l = Math.max(this.f31900l, i12);
                i11++;
                i9 = i13;
            }
        }
    ...
    public final int[] D(int i8) {
        m();
        if (i8 < this.f31896h || i8 >= this.f31897i) {
            throw new RuntimeException("Hijrah date out of range");
        }
        int binarySearch = Arrays.binarySearch(this.f31895g, i8);
        if (binarySearch < 0) {
            binarySearch = (-binarySearch) - 2;
        }
        int i9 = this.f31898j;
        return new int[]{(binarySearch + i9) / 12, ((i9 + binarySearch) % 12) + 1, (i8 - this.f31895g[binarySearch]) + 1};
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public final int E(int i8, int i9) {
        int i10 = (i9 - 1) + ((i8 * 12) - this.f31898j);
        if (i10 >= 0) {
            int[] iArr = this.f31895g;
            if (i10 < iArr.length) {
    ...
    public final j$.time.temporal.w H(j$.time.temporal.a aVar) {
        ...
        switch (o.f31890a[aVar.ordinal()]) {
            case 1:
                return j$.time.temporal.w.k(this.f31899k, this.f31900l);
            case 2:
                return j$.time.temporal.w.j(1L, this.f31902n);
            case 3:
                return j$.time.temporal.w.j(1L, 5L);
            case 4:
            case 5:
                int i8 = this.f31898j;
                return j$.time.temporal.w.j(i8 / 12, (((this.f31895g.length - 1) + i8) / 12) - 1);
            case 6:
    ...
    public final int r(long j8) {
        int i8 = this.f31898j;
        if (j8 >= i8 / 12 && j8 <= (((this.f31895g.length - 1) + i8) / 12) - 1) {
            return (int) j8;
        }
    ...
    public final long z(int i8, int i9, int i10) {
        ...
        int i11 = (i9 - 1) + ((i8 * 12) - this.f31898j);
        if (i11 < 0 || i11 >= this.f31895g.length) {
            throw new RuntimeException("Invalid Hijrah date, year: " + i8 + ", month: " + i9);
        }
        if (i10 >= 1 && i10 <= E(i8, i9)) {
            return (i10 - 1) + this.f31895g[i11];
        }
