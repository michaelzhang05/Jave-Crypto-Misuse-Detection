...
public abstract class c {
    ...
    private static WindowManager f1921a;

    /* renamed from: b, reason: collision with root package name */
    private static String[] f1922b = {"x", "y", "width", "height"};

    /* renamed from: c, reason: collision with root package name */
    static float f1923c = Resources.getSystem().getDisplayMetrics().density;
    ...
    private static b b(JSONObject jSONObject) {
        ...
        if (f1921a != null) {
            ...
            f1921a.getDefaultDisplay().getRealSize(point);
            f8 = a(point.x);
            f9 = a(point.y);
        } else {
            f8 = 0.0f;
    ...
    public static void d(Context context) {
        if (context != null) {
            f1923c = context.getResources().getDisplayMetrics().density;
            f1921a = (WindowManager) context.getSystemService("window");
        }
    }
    ...
    private static boolean l(EnumC3977j enumC3977j) {
        if (a.f1924a[enumC3977j.ordinal()] == 1) {
            return true;
        }
        return false;
    }
    ...
    public static void m(JSONObject jSONObject) {
        b b8 = b(jSONObject);
        try {
            jSONObject.put("width", b8.f1925a);
            jSONObject.put("height", b8.f1926b);
        } catch (JSONException e8) {
            e8.printStackTrace();
        }
    }
