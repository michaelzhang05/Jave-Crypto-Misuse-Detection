...
public abstract class A {
    ...
    private static final SimpleArrayMap f8449a = new SimpleArrayMap();

    /* renamed from: b, reason: collision with root package name */
    private static Locale f8450b;

    public static String a(Context context) {
        String packageName = context.getPackageName();
        try {
            return Y.e.a(context).d(packageName).toString();
    ...
    public static String b(Context context, int i8) {
        ...
        if (i8 != 1) {
            if (i8 != 2) {
                ...
                return resources.getString(M.b.f6835a);
            }
            return resources.getString(M.b.f6844j);
        }
        return resources.getString(M.b.f6838d);
    }
    ...
    public static String c(Context context, int i8) {
        ...
        if (i8 != 1) {
            if (i8 != 2) {
                            ...
                            if (i8 != 9) {
                                if (i8 != 20) {
                                    switch (i8) {
                                        ...
                                        case 18:
                                            return resources.getString(M.b.f6847m, a8);
                                        default:
                                            return resources.getString(AbstractC1270n.f7679a, a8);
                                    }
                                }
                                return g(context, "common_google_play_services_restricted_profile_text", a8);
                            }
                            return resources.getString(M.b.f6843i, a8);
                        }
                ...
                return resources.getString(M.b.f6836b, a8);
            }
            if (W.h.d(context)) {
                return resources.getString(M.b.f6848n);
            }
            return resources.getString(M.b.f6845k, a8);
        }
        return resources.getString(M.b.f6839e, a8);
    }
    ...
    public static String e(Context context, int i8) {
        ...
        if (f8 == null) {
            return context.getResources().getString(M.b.f6842h);
        }
        return f8;
    }
    ...
    public static String f(Context context, int i8) {
        ...
        switch (i8) {
            case 1:
                return resources.getString(M.b.f6840f);
            case 2:
                return resources.getString(M.b.f6846l);
            case 3:
                return resources.getString(M.b.f6837c);
            case 4:
            case 6:
            case 18:
                return null;
    ...
    private static String g(Context context, String str, String str2) {
        ...
        if (h8 == null) {
            h8 = resources.getString(AbstractC1270n.f7679a);
        }
        return String.format(resources.getConfiguration().locale, h8, str2);
    }

    private static String h(Context context, String str) {
        SimpleArrayMap simpleArrayMap = f8449a;
        synchronized (simpleArrayMap) {
            try {
                Locale locale = ConfigurationCompat.getLocales(context.getResources().getConfiguration()).get(0);
                if (!locale.equals(f8450b)) {
                ...
                Resources e8 = AbstractC1267k.e(context);
                if (e8 == null) {
                    return null;
                }
