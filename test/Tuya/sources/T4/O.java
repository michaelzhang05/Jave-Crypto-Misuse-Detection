...
public final class O implements ViewBinding {
    ...
    private final RelativeLayout f10288a;

    /* renamed from: b, reason: collision with root package name */
    public final K f10289b;

    /* renamed from: c, reason: collision with root package name */
    public final RecyclerView f10290c;

    /* renamed from: d, reason: collision with root package name */
    public final Toolbar f10291d;
    ...
    private O(RelativeLayout relativeLayout, K k8, RecyclerView recyclerView, Toolbar toolbar, TextView textView) {
        this.f10288a = relativeLayout;
        this.f10289b = k8;
        this.f10290c = recyclerView;
        this.f10291d = toolbar;
