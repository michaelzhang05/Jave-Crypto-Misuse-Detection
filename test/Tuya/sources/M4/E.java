...
public abstract class E {
    ...
    public static final class a extends AbstractC3160z implements X5.n {
        ...
        final /* synthetic */ Modifier f35059b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ boolean f35060c;

        /* renamed from: d, reason: collision with root package name */
        final /* synthetic */ int f35061d;

        /* renamed from: e, reason: collision with root package name */
        final /* synthetic */ int f35062e;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        a(String str, Modifier modifier, boolean z8, int i8, int i9) {
            super(2);
            this.f35058a = str;
            this.f35059b = modifier;
            this.f35060c = z8;
            this.f35061d = i8;
            this.f35062e = i9;
        }
        ...
        public final void invoke(Composer composer, int i8) {
            E.a(this.f35058a, this.f35059b, this.f35060c, composer, RecomposeScopeImplKt.updateChangedFlags(this.f35061d | 1), this.f35062e);
        }
    }
