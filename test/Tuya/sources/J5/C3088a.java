...
public final class C3088a {
    ...
    private final CropImageViewTv f33281a;

    public C3088a(CropImageViewTv cropImageView) {
        AbstractC3159y.i(cropImageView, "cropImageView");
        this.f33281a = cropImageView;
    }

    private final Matrix b() {
        Matrix imageMatrix = this.f33281a.getImageMatrix();
    ...
    public final void a() {
        boolean z8;
        int width = (this.f33281a.getWidth() - this.f33281a.getPaddingLeft()) - this.f33281a.getPaddingRight();
        int height = (this.f33281a.getHeight() - this.f33281a.getPaddingTop()) - this.f33281a.getPaddingBottom();
        int cropType = this.f33281a.getCropType();
        Drawable drawable = this.f33281a.getDrawable();
        if (cropType != -1 && height > 0 && width > 0 && drawable != null) {
            ...
            this.f33281a.setImageMatrix(b8);
        }
    }
}
