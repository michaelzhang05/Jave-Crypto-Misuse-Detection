...
public interface b extends IInterface {
    ...
    public static abstract class a extends Binder implements b {
        ...
        private static class C0280a implements b {
            ...
            private IBinder f13681a;

            C0280a(IBinder iBinder) {
                this.f13681a = iBinder;
            }
            ...
            public void F(android.support.v4.media.session.a aVar) {
                ...
                try {
                    ...
                    this.f13681a.transact(4, obtain, obtain2, 0);
            ...
            public PlaybackStateCompat getPlaybackState() {
                ...
                try {
                    obtain.writeInterfaceToken("android.support.v4.media.session.IMediaSession");
                    this.f13681a.transact(28, obtain, obtain2, 0);
                    obtain2.readException();
            ...
            public void n(android.support.v4.media.session.a aVar) {
                ...
                try {
                    ...
                    obtain.writeStrongBinder(iBinder);
                    this.f13681a.transact(3, obtain, obtain2, 0);
                    obtain2.readException();
                    obtain2.recycle();
                    obtain.recycle();
                } catch (Throwable th) {
