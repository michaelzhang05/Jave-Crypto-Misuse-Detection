...
class p {
    ...
    private short f12906f;

    /* renamed from: g, reason: collision with root package name */
    private short f12907g;
    ...
    private void b(int i8) {
        if (this.f12909i == null) {
            this.f12909i = new int[2];
        }
        int length = this.f12909i.length;
        int i9 = this.f12908h;
        if (i9 >= length) {
            int[] iArr = new int[Math.max(i9 + 1, length * 2)];
            System.arraycopy(this.f12909i, 0, iArr, 0, length);
            this.f12909i = iArr;
        }
        int[] iArr2 = this.f12909i;
        int i10 = this.f12908h;
        this.f12908h = i10 + 1;
        iArr2[i10] = i8;
    }
    ...
    public static int e(C c8, Object obj) {
        ...
        return c8.K("", ((s) obj).f12925d) | 12582912;
    }
    ...
    private int h(int i8, int i9) {
        ...
        int i11 = 62914560 & i8;
        if (i11 == 16777216) {
            int i12 = i10 + this.f12902b[i8 & 1048575];
        ...
        if (i11 == 20971520) {
            int i13 = i10 + this.f12903c[i9 - (i8 & 1048575)];
    ...
    */
    private int i(Y1.C r9, int r10) {
        ...
        L45:
            r10 = r10 & r5
            Y1.B r10 = r9.T(r10)
            java.lang.String r10 = r10.f12770e
            int r9 = r9.I(r10)
            goto L43
        L51:
            int r1 = r1 + 1
    ...
    private int n() {
        short s8 = this.f12907g;
        if (s8 > 0) {
            int[] iArr = this.f12905e;
            short s9 = (short) (s8 - 1);
            this.f12907g = s9;
            return iArr[s9];
        }
        short s10 = (short) (this.f12906f - 1);
        this.f12906f = s10;
        return (-s10) | 20971520;
    }
    ...
    private void o(int i8) {
        short s8 = this.f12907g;
        if (s8 >= i8) {
            this.f12907g = (short) (s8 - i8);
        } else {
            this.f12906f = (short) (this.f12906f - (i8 - s8));
            this.f12907g = (short) 0;
        }
    }
    ...
    private void q(int i8) {
        if (this.f12905e == null) {
            this.f12905e = new int[10];
        }
        int length = this.f12905e.length;
        short s8 = this.f12907g;
        if (s8 >= length) {
            int[] iArr = new int[Math.max(s8 + 1, length * 2)];
            System.arraycopy(this.f12905e, 0, iArr, 0, length);
            this.f12905e = iArr;
        }
        int[] iArr2 = this.f12905e;
        short s9 = this.f12907g;
        short s10 = (short) (s9 + 1);
        this.f12907g = s10;
        iArr2[s9] = i8;
        short s11 = (short) (this.f12906f + s10);
        s sVar = this.f12901a;
        if (s11 > sVar.f12929h) {
            sVar.f12929h = s11;
        }
    ...
    public static void s(C c8, int i8, C1515d c1515d) {
        ...
        if (i9 == 0) {
            ...
            if (i11 != 4194304) {
                if (i11 != 8388608) {
                    if (i11 == 12582912) {
                        c1515d.g(8).k((int) c8.T(i10).f12771f);
                        return;
                    }
                    throw new AssertionError();
                }
                c1515d.g(7).k(c8.e(c8.T(i10).f12770e).f12766a);
                return;
            }
            c1515d.g(i10);
            return;
        ...
        if ((i8 & 62914560) == 8388608) {
            sb.append('L');
            sb.append(c8.T(i8 & 1048575).f12770e);
            sb.append(';');
        } else {
            int i13 = i8 & 1048575;
            if (i13 != 1) {
        ...
        c1515d.g(7).k(c8.e(sb.toString()).f12766a);
    }

    private void v(int i8, int i9) {
        if (this.f12904d == null) {
            this.f12904d = new int[10];
        }
        int length = this.f12904d.length;
        if (i8 >= length) {
            int[] iArr = new int[Math.max(i8 + 1, length * 2)];
            System.arraycopy(this.f12904d, 0, iArr, 0, length);
            this.f12904d = iArr;
        }
        this.f12904d[i8] = i9;
    }
    ...
    public final void a(v vVar) {
        ...
        int V7 = vVar.V(this.f12901a.f12925d, i13, i18);
        int i20 = 0;
        while (true) {
            int i21 = i13 - 1;
            if (i13 <= 0) {
    ...
    public final void c(p pVar) {
        this.f12902b = pVar.f12902b;
        this.f12903c = pVar.f12903c;
        this.f12906f = (short) 0;
        this.f12904d = pVar.f12904d;
        this.f12905e = pVar.f12905e;
        this.f12907g = pVar.f12907g;
        this.f12908h = pVar.f12908h;
        this.f12909i = pVar.f12909i;
    }
    ...
    */
    ...
    public final boolean m(C c8, p pVar, int i8) {
        boolean z8;
        int i9;
        int length = this.f12902b.length;
        int length2 = this.f12903c.length;
        boolean z9 = true;
        if (pVar.f12902b == null) {
            pVar.f12902b = new int[length];
            z8 = true;
        } else {
            z8 = false;
        }
        for (int i10 = 0; i10 < length; i10++) {
            ...
            z8 |= l(c8, i9, pVar.f12902b, i10);
        }
        if (i8 > 0) {
            for (int i12 = 0; i12 < length; i12++) {
                z8 |= l(c8, this.f12902b[i12], pVar.f12902b, i12);
            }
            if (pVar.f12903c == null) {
                pVar.f12903c = new int[1];
            } else {
                z9 = z8;
            }
            return l(c8, i8, pVar.f12903c, 0) | z9;
        }
        int length3 = this.f12903c.length + this.f12906f;
        if (pVar.f12903c == null) {
            pVar.f12903c = new int[this.f12907g + length3];
        } else {
            z9 = z8;
        }
        for (int i13 = 0; i13 < length3; i13++) {
            int i14 = this.f12903c[i13];
            if (this.f12909i != null) {
                i14 = i(c8, i14);
            }
            z9 |= l(c8, i14, pVar.f12903c, i13);
        }
        for (int i15 = 0; i15 < this.f12907g; i15++) {
            int h8 = h(this.f12905e[i15], length2);
            if (this.f12909i != null) {
                h8 = i(c8, h8);
            }
            z9 |= l(c8, h8, pVar.f12903c, length3 + i15);
        }
        return z9;
    }
    ...
    public final void t(C c8, int i8, Object[] objArr, int i9, Object[] objArr2) {
        ...
        for (int i11 = 0; i11 < i8; i11++) {
            int i12 = i10 + 1;
            this.f12902b[i10] = e(c8, objArr[i11]);
            Object obj = objArr[i11];
            if (obj != y.f13017e && obj != y.f13016d) {
                i10 = i12;
            } else {
                i10 += 2;
                this.f12902b[i12] = 4194304;
            }
        }
        while (true) {
            int[] iArr = this.f12902b;
        ...
        for (int i14 = 0; i14 < i9; i14++) {
            ...
            if (obj2 == y.f13017e || obj2 == y.f13016d) {
                i13++;
            }
        }
        this.f12903c = new int[i13 + i9];
        int i15 = 0;
        for (int i16 = 0; i16 < i9; i16++) {
            int i17 = i15 + 1;
            this.f12903c[i15] = e(c8, objArr2[i16]);
            Object obj3 = objArr2[i16];
            if (obj3 != y.f13017e && obj3 != y.f13016d) {
                i15 = i17;
            } else {
                i15 += 2;
                this.f12903c[i17] = 4194304;
            }
        }
        this.f12907g = (short) 0;
        this.f12908h = 0;
