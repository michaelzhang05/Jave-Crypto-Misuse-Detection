...
public abstract class u {
    ...
    public abstract AbstractC1512a A(int i8, E e8, String str, boolean z8);

    public abstract void B(s sVar, s sVar2, s sVar3, String str);

    public abstract AbstractC1512a C(int i8, E e8, String str, boolean z8);
    ...
    public abstract AbstractC1512a c();

    public abstract void d(C1514c c1514c);
    ...
    public abstract AbstractC1512a k(int i8, E e8, String str, boolean z8);
    ...
    public abstract AbstractC1512a s(int i8, E e8, s[] sVarArr, s[] sVarArr2, int[] iArr, String str, boolean z8);
    ...
    public abstract AbstractC1512a y(int i8, String str, boolean z8);
