...
public final class C2801t extends RowsSupportFragment {
    ...
    private ArrayObjectAdapter f31660a;

    public C2801t() {
        ListRowPresenter listRowPresenter = new ListRowPresenter(4);
        listRowPresenter.setShadowEnabled(false);
        this.f31660a = new ArrayObjectAdapter(listRowPresenter);
    }
    ...
    public void onCreate(Bundle bundle) {
        ...
        if (getContext() != null) {
            ...
            this.f31660a.add(new ListRow(headerItem, arrayObjectAdapter));
            setAdapter(this.f31660a);
