...
public class N {
    ...
    private static final AtomicIntegerFieldUpdater f36250b = AtomicIntegerFieldUpdater.newUpdater(N.class, "_size");
    ...
    */
    private final void k(int r6) {
        ...
        L3f:
            ...
            goto L0
        */
        throw new UnsupportedOperationException("Method not decompiled: n6.N.k(int):void");
    }

    private final void l(int i8) {
        while (i8 > 0) {
            O[] oArr = this.f36251a;
            AbstractC3159y.f(oArr);
            int i9 = (i8 - 1) / 2;
            O o8 = oArr[i9];
            AbstractC3159y.f(o8);
            O o9 = oArr[i8];
