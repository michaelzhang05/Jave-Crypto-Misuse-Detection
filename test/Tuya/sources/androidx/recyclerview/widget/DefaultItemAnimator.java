...
public class DefaultItemAnimator extends SimpleItemAnimator {
    ...
    void animateMoveImpl(final RecyclerView.ViewHolder viewHolder, int i8, int i9, int i10, int i11) {
        final View view = viewHolder.itemView;
    ...
    public void runPendingAnimations() {
        ...
        if (z11) {
            ...
            ViewCompat.postOnAnimationDelayed(arrayList3.get(0).itemView, runnable3, j8 + Math.max(j9, j10));
        }
    }
