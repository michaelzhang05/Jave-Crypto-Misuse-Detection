...
class VersionedParcelStream extends VersionedParcel {
    ...
    public static class FieldBuffer {
        ...
        FieldBuffer(int i8, DataOutputStream dataOutputStream) {
        ...
        void flushField() throws IOException {
            ...
            int i9 = this.mFieldId << 16;
            if (size >= 65535) {
                i8 = 65535;
            } else {
                i8 = size;
            }
            this.mTarget.writeInt(i9 | i8);
            if (size >= 65535) {
    ...
    private void readObject(int i8, String str, Bundle bundle) {
        switch (i8) {
            ...
            case 14:
                ...
                return;
            default:
                throw new RuntimeException("Unknown type " + i8);
        }
    }
    ...
    public void writeBoolean(boolean z8) {
        try {
            this.mCurrentOutput.writeBoolean(z8);
        } catch (IOException e8) {
            throw new VersionedParcel.ParcelException(e8);
        }
    }
    ...
    public void writeFloat(float f8) {
        try {
            this.mCurrentOutput.writeFloat(f8);
        } catch (IOException e8) {
            throw new VersionedParcel.ParcelException(e8);
        }
    }
