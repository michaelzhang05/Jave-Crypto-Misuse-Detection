...
public final class Trackers {
    ...
    public Trackers(Context context, TaskExecutor taskExecutor, ConstraintTracker<Boolean> batteryChargingTracker) {
        ...
        AbstractC3159y.i(context, "context");
        AbstractC3159y.i(taskExecutor, "taskExecutor");
        AbstractC3159y.i(batteryChargingTracker, "batteryChargingTracker");
    }
    ...
    public Trackers(Context context, TaskExecutor taskExecutor, ConstraintTracker<Boolean> batteryChargingTracker, BatteryNotLowTracker batteryNotLowTracker) {
        ...
        AbstractC3159y.i(taskExecutor, "taskExecutor");
        AbstractC3159y.i(batteryChargingTracker, "batteryChargingTracker");
        AbstractC3159y.i(batteryNotLowTracker, "batteryNotLowTracker");
    }
    ...
    public Trackers(Context context, TaskExecutor taskExecutor, ConstraintTracker<Boolean> batteryChargingTracker, BatteryNotLowTracker batteryNotLowTracker, ConstraintTracker<NetworkState> networkStateTracker) {
        ...
        AbstractC3159y.i(batteryChargingTracker, "batteryChargingTracker");
        AbstractC3159y.i(batteryNotLowTracker, "batteryNotLowTracker");
        AbstractC3159y.i(networkStateTracker, "networkStateTracker");
    }
    ...
    public Trackers(Context context, TaskExecutor taskExecutor, ConstraintTracker<Boolean> batteryChargingTracker, BatteryNotLowTracker batteryNotLowTracker, ConstraintTracker<NetworkState> networkStateTracker, ConstraintTracker<Boolean> storageNotLowTracker) {
        ...
        AbstractC3159y.i(batteryNotLowTracker, "batteryNotLowTracker");
        AbstractC3159y.i(networkStateTracker, "networkStateTracker");
        AbstractC3159y.i(storageNotLowTracker, "storageNotLowTracker");
    ...
    */
    public /* synthetic */ Trackers(android.content.Context r8, androidx.work.impl.utils.taskexecutor.TaskExecutor r9, androidx.work.impl.constraints.trackers.ConstraintTracker r10, androidx.work.impl.constraints.trackers.BatteryNotLowTracker r11, androidx.work.impl.constraints.trackers.ConstraintTracker r12, androidx.work.impl.constraints.trackers.ConstraintTracker r13, int r14, kotlin.jvm.internal.AbstractC3151p r15) {
        /*
            r7 = this;
            r0 = r14 & 4
            ...
            kotlin.jvm.internal.AbstractC3159y.h(r3, r1)
            r0.<init>(r3, r9)
            r3 = r0
            goto L15
        L14:
