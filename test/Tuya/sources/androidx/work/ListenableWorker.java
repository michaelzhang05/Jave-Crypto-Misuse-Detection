...
public abstract class ListenableWorker {
    ...
    @NonNull
    public InterfaceFutureC3857a getForegroundInfoAsync() {
    ...
    @NonNull
    public final InterfaceFutureC3857a setForegroundAsync(@NonNull ForegroundInfo foregroundInfo) {
        return this.mWorkerParams.getForegroundUpdater().setForegroundAsync(getApplicationContext(), getId(), foregroundInfo);
    }

    @NonNull
    public InterfaceFutureC3857a setProgressAsync(@NonNull Data data) {
    ...
    @NonNull
    @MainThread
    public abstract InterfaceFutureC3857a startWork();
