...
public abstract class WorkManager {
    ...
    @NonNull
    public abstract InterfaceFutureC3857a getLastCancelAllTimeMillis();

    @NonNull
    public abstract LiveData<Long> getLastCancelAllTimeMillisLiveData();

    @NonNull
    public abstract InterfaceFutureC3857a getWorkInfoById(@NonNull UUID uuid);

    @NonNull
    public abstract InterfaceC3358f getWorkInfoByIdFlow(@NonNull UUID uuid);
    ...
    @NonNull
    public abstract InterfaceFutureC3857a getWorkInfosByTag(@NonNull String str);

    @NonNull
    public abstract InterfaceC3358f getWorkInfosByTagFlow(@NonNull String str);

    @NonNull
    public abstract LiveData<List<WorkInfo>> getWorkInfosByTagLiveData(@NonNull String str);

    @NonNull
    public abstract InterfaceC3358f getWorkInfosFlow(@NonNull WorkQuery workQuery);

    @NonNull
    public abstract InterfaceFutureC3857a getWorkInfosForUniqueWork(@NonNull String str);

    @NonNull
    public abstract InterfaceC3358f getWorkInfosForUniqueWorkFlow(@NonNull String str);
    ...
    @NonNull
    public abstract InterfaceFutureC3857a updateWork(@NonNull WorkRequest workRequest);
