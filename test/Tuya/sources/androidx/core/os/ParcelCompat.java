...
public final class ParcelCompat {
    ...
    public static <T extends Parcelable> T readParcelable(@NonNull Parcel parcel, @Nullable ClassLoader classLoader, @NonNull Class<T> cls) {
        ...
        T t8 = (T) parcel.readParcelable(classLoader);
        if (t8 != null && !cls.isInstance(t8)) {
            throw new BadParcelableException("Parcelable " + t8.getClass() + " is not a subclass of required class " + cls.getName() + " provided in the parameter");
        }
        return t8;
    }
    ...
    public static void writeBoolean(@NonNull Parcel parcel, boolean z8) {
