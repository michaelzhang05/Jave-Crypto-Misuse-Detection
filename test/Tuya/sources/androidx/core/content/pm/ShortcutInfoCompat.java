...
public class ShortcutInfoCompat {
    ...
    private static class Api33Impl {
        ...
        static void setExcludedFromSurfaces(@NonNull ShortcutInfo.Builder builder, int i8) {
    ...
    private PersistableBundle buildLegacyExtrasBundle() {
        ...
        if (personArr != null && personArr.length > 0) {
            ...
            while (i8 < this.mPersons.length) {
                ...
                int i9 = i8 + 1;
                sb.append(i9);
                persistableBundle.putPersistableBundle(sb.toString(), this.mPersons[i8].toPersistableBundle());
                i8 = i9;
            }
        }
    ...
    public static List<ShortcutInfoCompat> fromShortcuts(@NonNull Context context, @NonNull List<ShortcutInfo> list) {
        ...
        while (it.hasNext()) {
            arrayList.add(new Builder(context, AbstractC1730f.a(it.next())).build());
        }
        return arrayList;
    }
    ...
    public boolean isExcludedFromSurfaces(int i8) {
        if ((i8 & this.mExcludedSurfaces) != 0) {
            return true;
        }
        return false;
    }
    ...
    public ShortcutInfo toShortcutInfo() {
        ...
        ShortcutInfo build;
        AbstractC1736l.a();
        shortLabel = AbstractC1735k.a(this.mContext, this.mId).setShortLabel(this.mLabel);
