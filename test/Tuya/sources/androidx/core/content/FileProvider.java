...
public class FileProvider extends ContentProvider {
    ...
    @VisibleForTesting
    static XmlResourceParser getFileProviderPathsMetaData(Context context, String str, @Nullable ProviderInfo providerInfo, int i8) {
    ...
    private static PathStrategy parsePathStrategy(Context context, String str, int i8) throws IOException, XmlPullParserException {
    ...
    protected FileProvider(@XmlRes int i8) {
