...
public final class ComplexColorCompat {
    ...
    @NonNull
    private static ComplexColorCompat createFromXml(@NonNull Resources resources, @ColorRes int i8, @Nullable Resources.Theme theme) throws IOException, XmlPullParserException {
        int next;
