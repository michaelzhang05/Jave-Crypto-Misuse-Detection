...
public class NotificationCompat {
    ...
    public static class Action {
        ...
        public static final class Builder {
            ...
            private Builder(@Nullable IconCompat iconCompat, @Nullable CharSequence charSequence, @Nullable PendingIntent pendingIntent, @NonNull Bundle bundle, @Nullable RemoteInput[] remoteInputArr, boolean z8, int i8, boolean z9, boolean z10, boolean z11) {
        ...
        public static final class WearableExtender implements Extender {
            ...
            private void setFlag(int i8, boolean z8) {
                if (z8) {
            ...
            public WearableExtender m5443clone() {
    ...
    public static class BigPictureStyle extends Style {
        ...
        private static class Api31Impl {
            ...
            @RequiresApi(31)
            static void showBigPictureWhenCollapsed(Notification.BigPictureStyle bigPictureStyle, boolean z8) {
        ...
        private static IconCompat asIconCompat(@Nullable Parcelable parcelable) {
            if (parcelable != null) {
                if (Build.VERSION.SDK_INT >= 23 && k.a(parcelable)) {
                    return IconCompat.createFromIcon(l.a(parcelable));
                }
        ...
        public BigPictureStyle showBigPictureWhenCollapsed(boolean z8) {
            this.mShowBigPictureWhenCollapsed = z8;
            return this;
        }
    ...
    public static final class BubbleMetadata {
        ...
        public static final class Builder {
            ...
            @NonNull
            private Builder setFlag(int i8, boolean z8) {
                if (z8) {
                    this.mFlags = i8 | this.mFlags;
                } else {
                    this.mFlags = (~i8) & this.mFlags;
    ...
    public static class Builder {
        ...
        public static class Api21Impl {
            ...
            @DoNotInline
            static AudioAttributes.Builder setContentType(AudioAttributes.Builder builder, int i8) {
                return builder.setContentType(i8);
            }

            @DoNotInline
            static AudioAttributes.Builder setLegacyStreamType(AudioAttributes.Builder builder, int i8) {
                return builder.setLegacyStreamType(i8);
            }

            @DoNotInline
            static AudioAttributes.Builder setUsage(AudioAttributes.Builder builder, int i8) {
        ...
        public Builder(@NonNull Context context, @NonNull Notification notification) {
            ...
            int i8 = Build.VERSION.SDK_INT;
            if (i8 >= 24 && bundle.containsKey(NotificationCompat.EXTRA_CHRONOMETER_COUNT_DOWN)) {
                setChronometerCountDown(bundle.getBoolean(NotificationCompat.EXTRA_CHRONOMETER_COUNT_DOWN));
            }
            if (i8 < 26 || !bundle.containsKey(NotificationCompat.EXTRA_COLORIZED)) {
                return;
            }
        ...
        public Builder setAllowSystemGeneratedContextualActions(boolean z8) {
            this.mAllowSystemGeneratedContextualActions = z8;
            return this;
        }
        ...
        @NonNull
        public Builder setFullScreenIntent(@Nullable PendingIntent pendingIntent, boolean z8) {
        ...
        public Builder setProgress(int i8, int i9, boolean z8) {
            ...
            this.mProgress = i9;
            this.mProgressIndeterminate = z8;
            return this;
        }
    ...
    public static class CallStyle extends Style {
        ...
        static class Api20Impl {
            ...
            @DoNotInline
            static Notification.Action.Builder createActionBuilder(int i8, CharSequence charSequence, PendingIntent pendingIntent) {
        ...
        static class Api31Impl {
            ...
            @DoNotInline
            static Notification.CallStyle setAnswerButtonColorHint(Notification.CallStyle callStyle, @ColorInt int i8) {
            ...
            @DoNotInline
            static Notification.CallStyle setDeclineButtonColorHint(Notification.CallStyle callStyle, @ColorInt int i8) {
                return callStyle.setDeclineButtonColorHint(i8);
            }

            @DoNotInline
            static Notification.CallStyle setIsVideo(Notification.CallStyle callStyle, boolean z8) {
        ...
        private Action makeAnswerAction() {
            ...
            if (z8) {
                i9 = R.string.call_notification_answer_video_action;
            } else {
                i9 = R.string.call_notification_answer_action;
            }
            return makeAction(i8, i9, this.mAnswerButtonColor, R.color.call_notification_answer_color, pendingIntent);
        }
        ...
        private Action makeNegativeAction() {
            ...
            if (pendingIntent == null) {
                return makeAction(i8, R.string.call_notification_hang_up_action, this.mDeclineButtonColor, R.color.call_notification_decline_color, this.mHangUpIntent);
            }
            return makeAction(i8, R.string.call_notification_decline_action, this.mDeclineButtonColor, R.color.call_notification_decline_color, pendingIntent);
        }
        ...
        protected void restoreFromCompatExtras(@NonNull Bundle bundle) {
            ...
            int i8 = Build.VERSION.SDK_INT;
            if (i8 >= 28 && bundle.containsKey(NotificationCompat.EXTRA_CALL_PERSON)) {
            ...
            if (i8 >= 23 && bundle.containsKey(NotificationCompat.EXTRA_VERIFICATION_ICON)) {
                this.mVerificationIcon = IconCompat.createFromIcon(l.a(bundle.getParcelable(NotificationCompat.EXTRA_VERIFICATION_ICON)));
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        private RemoteViews createRemoteViews(RemoteViews remoteViews, boolean z8) {
            int min;
            int i8 = 0;
            RemoteViews applyStandardTemplate = applyStandardTemplate(true, R.layout.notification_template_custom_big, false);
            applyStandardTemplate.removeAllViews(R.id.actions);
            List<Action> nonContextualActions = getNonContextualActions(this.mBuilder.mActions);
            if (z8 && nonContextualActions != null && (min = Math.min(nonContextualActions.size(), 3)) > 0) {
                for (int i9 = 0; i9 < min; i9++) {
                    applyStandardTemplate.addView(R.id.actions, generateActionButton(nonContextualActions.get(i9)));
                }
            } else {
                i8 = 8;
            }
        ...
        private RemoteViews generateActionButton(Action action) {
            ...
            if (z8) {
                i8 = R.layout.notification_action_tombstone;
            } else {
                i8 = R.layout.notification_action;
            }
    ...
    public static abstract class Style {
        ...
        public static class Api24Impl {
            ...
            @DoNotInline
            static void setChronometerCountDown(RemoteViews remoteViews, int i8, boolean z8) {
        ...
        private Bitmap createIconWithBackground(int i8, int i9, int i10, int i11) {
            ...
            Bitmap createColoredBitmap = createColoredBitmap(i12, i11, i9);
        ...
        */
        ...
        Bitmap createColoredBitmap(@NonNull IconCompat iconCompat, int i8) {
    ...
    public static final class WearableExtender implements Extender {
        ...
        @NonNull
        /* renamed from: clone, reason: merged with bridge method [inline-methods] */
        public WearableExtender m5444clone() {
            WearableExtender wearableExtender = new WearableExtender();
    ...
    static Action getActionCompatFromAction(@NonNull Notification.Action action) {
        ...
        if (remoteInputs == null) {
            ...
            for (int i11 = 0; i11 < remoteInputs.length; i11++) {
                ...
                if (Build.VERSION.SDK_INT >= 29) {
                    i8 = Api29Impl.getEditChoicesBeforeSending(remoteInput);
                } else {
                    i8 = 0;
                }
                remoteInputArr2[i11] = new RemoteInput(resultKey, label, choices, allowFreeFormInput, i8, Api20Impl.getExtras(remoteInput), null);
            }
        ...
        if (i12 >= 24) {
            ...
            z8 = Api20Impl.getExtras(action).getBoolean("android.support.allowGeneratedReplies");
        }
        boolean z11 = z8;
        boolean z12 = Api20Impl.getExtras(action).getBoolean("android.support.action.showsUserInterface", true);
        if (i12 >= 28) {
            i9 = Api28Impl.getSemanticAction(action);
        } else {
            i9 = Api20Impl.getExtras(action).getInt("android.support.action.semanticAction", 0);
        }
        int i13 = i9;
        if (i12 >= 29) {
            z9 = Api29Impl.isContextual(action);
        } else {
            z9 = false;
        }
        if (i12 >= 31) {
            z10 = Api31Impl.isAuthenticationRequired(action);
        } else {
            z10 = false;
        }
        if (i12 >= 23) {
            if (Api23Impl.getIcon(action) == null && (i10 = action.icon) != 0) {
                return new Action(i10, action.title, action.actionIntent, Api20Impl.getExtras(action), remoteInputArr, (RemoteInput[]) null, z11, i13, z12, z9, z10);
            }
            if (Api23Impl.getIcon(action) != null) {
                iconCompat = IconCompat.createFromIconOrNullIfZeroResId(Api23Impl.getIcon(action));
            }
            return new Action(iconCompat, action.title, action.actionIntent, Api20Impl.getExtras(action), remoteInputArr, (RemoteInput[]) null, z11, i13, z12, z9, z10);
        }
        return new Action(action.icon, action.title, action.actionIntent, Api20Impl.getExtras(action), remoteInputArr, (RemoteInput[]) null, z11, i13, z12, z9, z10);
    }
    ...
    public static List<Action> getInvisibleActions(@NonNull Notification notification) {
        ...
        if (bundle2 != null) {
            for (int i8 = 0; i8 < bundle2.size(); i8++) {
                arrayList.add(NotificationCompatJellybean.getActionFromBundle(bundle2.getBundle(Integer.toString(i8))));
            }
        }
        return arrayList;
    }
    ...
    public static final class CarExtender implements Extender {
        ...
        public static class Api20Impl {
            ...
            @DoNotInline
            static RemoteInput.Builder setAllowFreeFormInput(RemoteInput.Builder builder, boolean z8) {
        ...
        public static class UnreadConversation {
            ...
            UnreadConversation(@Nullable String[] strArr, @Nullable RemoteInput remoteInput, @Nullable PendingIntent pendingIntent, @Nullable PendingIntent pendingIntent2, @Nullable String[] strArr2, long j8) {
        ...
        private static Bundle getBundleForUnreadConversation(@NonNull UnreadConversation unreadConversation) {
            ...
            for (int i8 = 0; i8 < length; i8++) {
                ...
                bundle2.putString("text", unreadConversation.getMessages()[i8]);
        ...
        private static UnreadConversation getUnreadConversationFromBundle(@Nullable Bundle bundle) {
            ...
            if (remoteInput2 != null) {
                ...
                if (Build.VERSION.SDK_INT >= 29) {
                    i8 = Api29Impl.getEditChoicesBeforeSending(remoteInput2);
                } else {
                    i8 = 0;
                }
                remoteInput = new RemoteInput(resultKey, label, choices, allowFreeFormInput, i8, Api20Impl.getExtras(remoteInput2), null);
            }
    ...
    public static class MessagingStyle extends Style {
        ...
        static class Api28Impl {
            ...
            @DoNotInline
            static Notification.MessagingStyle setGroupConversation(Notification.MessagingStyle messagingStyle, boolean z8) {
        ...
        private CharSequence makeMessageLine(@NonNull Message message) {
            ...
            if (isEmpty) {
                ...
                if (this.mBuilder.getColor() != 0) {
                    i8 = this.mBuilder.getColor();
                }
            }
            CharSequence unicodeWrap = bidiFormatter.unicodeWrap(name);
            spannableStringBuilder.append(unicodeWrap);
            spannableStringBuilder.setSpan(makeFontColorSpan(i8), spannableStringBuilder.length() - unicodeWrap.length(), spannableStringBuilder.length(), 33);
        ...
        public void apply(NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor) {
            ...
            if (i8 >= 24) {
                ...
                while (it.hasNext()) {
                    Api24Impl.addMessage(n.a(createMessagingStyle), it.next().toAndroidMessage());
                }
                if (Build.VERSION.SDK_INT >= 26) {
                    Iterator<Message> it2 = this.mHistoricMessages.iterator();
                    while (it2.hasNext()) {
                        Api26Impl.addHistoricMessage(n.a(createMessagingStyle), it2.next().toAndroidMessage());
                    }
                }
                if (this.mIsGroupConversation.booleanValue() || Build.VERSION.SDK_INT >= 28) {
                    Api24Impl.setConversationTitle(n.a(createMessagingStyle), this.mConversationTitle);
                }
                if (Build.VERSION.SDK_INT >= 28) {
                    Api28Impl.setGroupConversation(n.a(createMessagingStyle), this.mIsGroupConversation.booleanValue());
                }
        ...
        public MessagingStyle setGroupConversation(boolean z8) {
            this.mIsGroupConversation = Boolean.valueOf(z8);
            return this;
        }
        ...
        public static final class Message {
            ...
            public static class Api24Impl {
                ...
                @DoNotInline
                static Notification.MessagingStyle.Message createMessage(CharSequence charSequence, long j8, CharSequence charSequence2) {
            ...
            public static class Api28Impl {
                ...
                @DoNotInline
                static Notification.MessagingStyle.Message createMessage(CharSequence charSequence, long j8, android.app.Person person) {
