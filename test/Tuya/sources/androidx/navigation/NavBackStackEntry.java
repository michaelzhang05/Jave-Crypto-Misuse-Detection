...
public final class NavBackStackEntry implements LifecycleOwner, ViewModelStoreOwner, HasDefaultViewModelProviderFactory, SavedStateRegistryOwner {
    ...
    private final InterfaceC1227k defaultFactory$delegate;
    ...
    private final InterfaceC1227k savedStateHandle$delegate;
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ NavBackStackEntry create$default(Companion companion, Context context, NavDestination navDestination, Bundle bundle, Lifecycle.State state, NavViewModelStoreProvider navViewModelStoreProvider, String str, Bundle bundle2, int i8, Object obj) {
            ...
            if ((i8 & 32) != 0) {
                ...
                AbstractC3159y.h(uuid, "randomUUID().toString()");
                str2 = uuid;
            } else {
                str2 = str;
            }
    ...
    public /* synthetic */ NavBackStackEntry(Context context, NavDestination navDestination, Bundle bundle, Lifecycle.State state, NavViewModelStoreProvider navViewModelStoreProvider, String str, Bundle bundle2, AbstractC3151p abstractC3151p) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!AbstractC3159y.d(this.id, navBackStackEntry.id) || !AbstractC3159y.d(this.destination, navBackStackEntry.destination) || !AbstractC3159y.d(getLifecycle(), navBackStackEntry.getLifecycle()) || !AbstractC3159y.d(getSavedStateRegistry(), navBackStackEntry.getSavedStateRegistry())) {
            return false;
        }
        if (!AbstractC3159y.d(this.immutableArgs, navBackStackEntry.immutableArgs)) {
    ...
    public final void setDestination(NavDestination navDestination) {
        AbstractC3159y.i(navDestination, "<set-?>");
        this.destination = navDestination;
    }

    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP})
    public final void setMaxLifecycle(Lifecycle.State maxState) {
        AbstractC3159y.i(maxState, "maxState");
    ...
    */
    /* synthetic */ NavBackStackEntry(android.content.Context r11, androidx.navigation.NavDestination r12, android.os.Bundle r13, androidx.lifecycle.Lifecycle.State r14, androidx.navigation.NavViewModelStoreProvider r15, java.lang.String r16, android.os.Bundle r17, int r18, kotlin.jvm.internal.AbstractC3151p r19) {
        /*
            r10 = this;
            r0 = r18 & 4
            r1 = 0
    ...
    public /* synthetic */ NavBackStackEntry(NavBackStackEntry navBackStackEntry, Bundle bundle, int i8, AbstractC3151p abstractC3151p) {
