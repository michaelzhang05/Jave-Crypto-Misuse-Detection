...
public class NavController {
    ...
    private final v _currentBackStack;
    private final u _currentBackStackEntryFlow;
    private NavGraph _graph;
    private NavigatorProvider _navigatorProvider;
    private final v _visibleEntries;
    private Activity activity;
    private Function1 addToBackStackHandler;
    private final C1238k backQueue;
    private final List<NavBackStackEntry> backStackEntriesToDispatch;
    private final Map<Integer, String> backStackMap;
    private final Map<String, C1238k> backStackStates;
    private Parcelable[] backStackToRestore;
    private final Map<NavBackStackEntry, NavBackStackEntry> childToParentEntries;
    private final Context context;

    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP})
    private final InterfaceC3349K currentBackStack;
    private final InterfaceC3358f currentBackStackEntryFlow;
    ...
    private final InterfaceC1227k navInflater$delegate;
    ...
    private final InterfaceC3349K visibleEntries;
    ...
    public final class NavControllerNavigatorState extends NavigatorState {
        ...
        public void markTransitionComplete(NavBackStackEntry entry) {
            ...
            boolean d8 = AbstractC3159y.d(this.this$0.entrySavedState.get(entry), Boolean.TRUE);
            ...
            if (!this.this$0.backQueue.contains(entry)) {
                ...
                C1238k c1238k = this.this$0.backQueue;
                if (!(c1238k instanceof Collection) || !c1238k.isEmpty()) {
                    Iterator<E> it = c1238k.iterator();
                    while (it.hasNext()) {
                        if (AbstractC3159y.d(((NavBackStackEntry) it.next()).getId(), entry.getId())) {
                            break;
                        }
                    }
                }
            ...
            if (!isNavigating()) {
                this.this$0.updateBackStackLifecycle$navigation_runtime_release();
                this.this$0._currentBackStack.d(AbstractC1246t.Z0(this.this$0.backQueue));
                this.this$0._visibleEntries.d(this.this$0.populateVisibleEntries$navigation_runtime_release());
            }
        }
        ...
        public void pop(NavBackStackEntry popUpTo, boolean z8) {
            ...
            if (AbstractC3159y.d(navigator, this.navigator)) {
    ...
    public NavController(Context context) {
        ...
        Iterator it = AbstractC2683j.h(context, NavController$activity$1.INSTANCE).iterator();
        while (true) {
            if (it.hasNext()) {
                obj = it.next();
        ...
        this.backQueue = new C1238k();
        v a8 = AbstractC3351M.a(AbstractC1246t.m());
        this._currentBackStack = a8;
        this.currentBackStack = AbstractC3360h.b(a8);
        v a9 = AbstractC3351M.a(AbstractC1246t.m());
        this._visibleEntries = a9;
        this.visibleEntries = AbstractC3360h.b(a9);
        ...
        u b8 = AbstractC3340B.b(1, 0, EnumC3132a.DROP_OLDEST, 2, null);
        this._currentBackStackEntryFlow = b8;
        this.currentBackStackEntryFlow = AbstractC3360h.a(b8);
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:111:0x02a6, code lost:
        ...
        r0 = M5.AbstractC1246t.H0(r9, r8).iterator();
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:22:0x0079, code lost:
        ...
        if (kotlin.jvm.internal.AbstractC3159y.d(r1.getDestination(), r3) == false) goto L116;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:54:0x0153, code lost:
        ...
        if (kotlin.jvm.internal.AbstractC3159y.d(r2.getDestination(), r0) == false) goto L126;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:76:0x01ab, code lost:
        ...
        kotlin.jvm.internal.AbstractC3159y.g(r0, "null cannot be cast to non-null type androidx.navigation.NavGraph");
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:80:0x01dc, code lost:
        ...
        r0 = (androidx.navigation.NavBackStackEntry) r32.backQueue.q();
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:82:0x01e6, code lost:
        ...
        r0 = (androidx.navigation.NavBackStackEntry) r9.q();
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:86:0x01fb, code lost:
        ...
        if (kotlin.jvm.internal.AbstractC3159y.d(r0, r32._graph) != false) goto L93;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:91:0x021f, code lost:
        ...
        if (kotlin.jvm.internal.AbstractC3159y.d(r2, r3) == false) goto L133;
     */
    ...
    */
    ...
    private final boolean dispatchOnDestinationChanged() {
        ...
        NavBackStackEntry navBackStackEntry = (NavBackStackEntry) this.backQueue.t();
        ...
        if (i8 == 0) {
            List<NavBackStackEntry> Z02 = AbstractC1246t.Z0(this.backStackEntriesToDispatch);
            ...
            this._currentBackStack.d(AbstractC1246t.Z0(this.backQueue));
    ...
    private final boolean executePopOperations(List<? extends Navigator<?>> list, NavDestination navDestination, boolean z8, boolean z9) {
        ...
        while (it.hasNext()) {
            ...
            O o9 = new O();
            popBackStackInternal(navigator, (NavBackStackEntry) this.backQueue.last(), z9, new NavController$executePopOperations$1(o9, o8, this, z9, c1238k));
            if (!o9.f33757a) {
                break;
            }
        }
        if (z9) {
            if (!z8) {
                for (NavDestination navDestination2 : AbstractC2683j.C(AbstractC2683j.h(navDestination, NavController$executePopOperations$2.INSTANCE), new NavController$executePopOperations$3(this))) {
                    Map<Integer, String> map = this.backStackMap;
                    Integer valueOf = Integer.valueOf(navDestination2.getId());
                    NavBackStackEntryState navBackStackEntryState = (NavBackStackEntryState) c1238k.q();
            ...
            if (!c1238k.isEmpty()) {
                NavBackStackEntryState navBackStackEntryState2 = (NavBackStackEntryState) c1238k.first();
                Iterator it2 = AbstractC2683j.C(AbstractC2683j.h(findDestination(navBackStackEntryState2.getDestinationId()), NavController$executePopOperations$5.INSTANCE), new NavController$executePopOperations$6(this)).iterator();
                while (it2.hasNext()) {
                    this.backStackMap.put(Integer.valueOf(((NavDestination) it2.next()).getId()), navBackStackEntryState2.getId());
                }
                this.backStackStates.put(navBackStackEntryState2.getId(), c1238k);
            }
        }
    ...
    private final boolean executeRestoreState(List<NavBackStackEntry> list, Bundle bundle, NavOptions navOptions, Navigator.Extras extras) {
        ...
        for (NavBackStackEntry navBackStackEntry2 : arrayList2) {
            List list2 = (List) AbstractC1246t.z0(arrayList);
            if (list2 != null && (navBackStackEntry = (NavBackStackEntry) AbstractC1246t.y0(list2)) != null && (destination = navBackStackEntry.getDestination()) != null) {
                str = destination.getNavigatorName();
            } else {
                str = null;
            }
            if (AbstractC3159y.d(str, navBackStackEntry2.getDestination().getNavigatorName())) {
                list2.add(navBackStackEntry2);
            } else {
                arrayList.add(AbstractC1246t.s(navBackStackEntry2));
            }
        }
        O o8 = new O();
        for (List<NavBackStackEntry> list3 : arrayList) {
            navigateInternal(this._navigatorProvider.getNavigator(((NavBackStackEntry) AbstractC1246t.m0(list3)).getDestination().getNavigatorName()), list3, navOptions, extras, new NavController$executeRestoreState$3(o8, list, new Q(), this, bundle));
        }
        return o8.f33757a;
    }
    ...
    private final String findInvalidDestinationDisplayNameInDeepLink(int[] iArr) {
        ...
        while (true) {
            ...
            if (i8 == 0) {
                ...
                AbstractC3159y.f(navGraph3);
                if (navGraph3.getId() == i9) {
                    navDestination = this._graph;
                }
            } else {
                AbstractC3159y.f(navGraph2);
    ...
    private final List<NavBackStackEntry> instantiateBackStack(C1238k c1238k) {
    ...
    private final boolean launchSingleTopInternal(NavDestination navDestination, Bundle bundle) {
        ...
        if (currentBackStackEntry != null && (destination = currentBackStackEntry.getDestination()) != null && id == destination.getId()) {
            C1238k<NavBackStackEntry> c1238k = new C1238k();
            C1238k c1238k2 = this.backQueue;
            ListIterator<E> listIterator = c1238k2.listIterator(c1238k2.size());
            while (true) {
            ...
            while (AbstractC1246t.o(this.backQueue) >= i8) {
                ...
                c1238k.a(new NavBackStackEntry(navBackStackEntry, navBackStackEntry.getDestination().addInDefaultArgs(bundle)));
            }
            for (NavBackStackEntry navBackStackEntry2 : c1238k) {
            ...
            for (NavBackStackEntry navBackStackEntry3 : c1238k) {
    ...
    private final void linkChildToParent(NavBackStackEntry navBackStackEntry, NavBackStackEntry navBackStackEntry2) {
        ...
        AbstractC3159y.f(atomicInteger);
    ...
    private final void onGraphCreated(Bundle bundle) {
        ...
        if (parcelableArr != null) {
            for (Parcelable parcelable : parcelableArr) {
                AbstractC3159y.g(parcelable, "null cannot be cast to non-null type androidx.navigation.NavBackStackEntryState");
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public final void popEntryFromBackStack(NavBackStackEntry navBackStackEntry, boolean z8, C1238k c1238k) {
        NavControllerViewModel navControllerViewModel;
        InterfaceC3349K transitionsInProgress;
        Set set;
        NavBackStackEntry navBackStackEntry2 = (NavBackStackEntry) this.backQueue.last();
        if (AbstractC3159y.d(navBackStackEntry2, navBackStackEntry)) {
            this.backQueue.y();
            ...
            if (currentState.isAtLeast(state)) {
                if (z8) {
                    ...
                    c1238k.a(new NavBackStackEntryState(navBackStackEntry2));
                }
                if (!z9) {
    ...
    static /* synthetic */ void popEntryFromBackStack$default(NavController navController, NavBackStackEntry navBackStackEntry, boolean z8, C1238k c1238k, int i8, Object obj) {
        if (obj == null) {
            if ((i8 & 2) != 0) {
                z8 = false;
            }
            ...
            navController.popEntryFromBackStack(navBackStackEntry, z8, c1238k);
            return;
        }
    ...
    private final boolean restoreStateInternal(int i8, Bundle bundle, NavOptions navOptions, Navigator.Extras extras) {
        ...
        AbstractC1246t.I(this.backStackMap.values(), new NavController$restoreStateInternal$1(str));
        return executeRestoreState(instantiateBackStack((C1238k) Z.c(this.backStackStates).remove(str)), bundle, navOptions, extras);
    }
    ...
    private final boolean tryRelaunchUpToExplicitStack() {
        ...
        AbstractC3159y.f(intArray);
        List X02 = AbstractC1239l.X0(intArray);
        ArrayList parcelableArrayList = extras.getParcelableArrayList(KEY_DEEP_LINK_ARGS);
        int intValue = ((Number) AbstractC1246t.P(X02)).intValue();
    ...
    private final boolean tryRelaunchUpToGeneratedStack() {
        Bundle bundle;
        NavDestination currentDestination = getCurrentDestination();
        AbstractC3159y.f(currentDestination);
            ...
            if (parent.getStartDestinationId() != id) {
                ...
                if (activity != null) {
                    ...
                    if (activity.getIntent() != null) {
                        Activity activity2 = this.activity;
                        AbstractC3159y.f(activity2);
                        if (activity2.getIntent().getData() != null) {
                            Activity activity3 = this.activity;
                            AbstractC3159y.f(activity3);
                            bundle2.putParcelable(KEY_DEEP_LINK_INTENT, activity3.getIntent());
                            NavGraph navGraph = this._graph;
                            AbstractC3159y.f(navGraph);
                            Activity activity4 = this.activity;
                            AbstractC3159y.f(activity4);
                            Intent intent = activity4.getIntent();
                            AbstractC3159y.h(intent, "activity!!.intent");
    ...
    */
    ...
    public final NavDestination findDestination(@IdRes int i8) {
        ...
        if (navBackStackEntry == null || (navDestination = navBackStackEntry.getDestination()) == null) {
            navDestination = this._graph;
            AbstractC3159y.f(navDestination);
        }
    ...
    public NavBackStackEntry getBackStackEntry(@IdRes int i8) {
        Object obj;
        C1238k c1238k = this.backQueue;
        ListIterator<E> listIterator = c1238k.listIterator(c1238k.size());
        while (true) {
            if (!listIterator.hasPrevious()) {
                obj = null;
                break;
    ...
    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP})
    public final InterfaceC3349K getCurrentBackStack() {
        return this.currentBackStack;
    }

    public NavBackStackEntry getCurrentBackStackEntry() {
        return (NavBackStackEntry) this.backQueue.t();
    }

    public final InterfaceC3358f getCurrentBackStackEntryFlow() {
    ...
    public NavGraph getGraph() {
        NavGraph navGraph = this._graph;
        if (navGraph != null) {
            AbstractC3159y.g(navGraph, "null cannot be cast to non-null type androidx.navigation.NavGraph");
            return navGraph;
        }
    ...
    public NavBackStackEntry getPreviousBackStackEntry() {
        Object obj;
        Iterator it = AbstractC1246t.I0(this.backQueue).iterator();
        if (it.hasNext()) {
            it.next();
        }
        Iterator it2 = AbstractC2683j.c(it).iterator();
        while (true) {
            if (it2.hasNext()) {
                obj = it2.next();
                if (!(((NavBackStackEntry) obj).getDestination() instanceof NavGraph)) {
    ...
    public final InterfaceC3349K getVisibleEntries() {
    ...
    */
        ...
        if (stringArrayList2 != null) {
            for (String id : stringArrayList2) {
                ...
                if (parcelableArray != null) {
                    Map<String, C1238k> map = this.backStackStates;
                    AbstractC3159y.h(id, "id");
                    C1238k c1238k = new C1238k(parcelableArray.length);
                    Iterator a8 = AbstractC3141f.a(parcelableArray);
                    while (a8.hasNext()) {
                        Parcelable parcelable = (Parcelable) a8.next();
                        AbstractC3159y.g(parcelable, "null cannot be cast to non-null type androidx.navigation.NavBackStackEntryState");
                        c1238k.add((NavBackStackEntryState) parcelable);
                    }
                    map.put(id, c1238k);
                }
            }
    ...
    public Bundle saveState() {
        ...
        if (!this.backStackStates.isEmpty()) {
            ...
            for (Map.Entry<String, C1238k> entry3 : this.backStackStates.entrySet()) {
                String key2 = entry3.getKey();
                C1238k value2 = entry3.getValue();
                arrayList3.add(key2);
    ...
    public void setLifecycleOwner(LifecycleOwner owner) {
        ...
        if (AbstractC3159y.d(owner, this.lifecycleOwner)) {
            return;
        }
    ...
    public void setOnBackPressedDispatcher(OnBackPressedDispatcher dispatcher) {
        ...
        if (AbstractC3159y.d(dispatcher, this.onBackPressedDispatcher)) {
            return;
        }
        LifecycleOwner lifecycleOwner = this.lifecycleOwner;
    ...
    public void setViewModelStore(ViewModelStore viewModelStore) {
        ...
        if (AbstractC3159y.d(navControllerViewModel, companion.getInstance(viewModelStore))) {
            return;
        }
        if (this.backQueue.isEmpty()) {
    ...
    public final void updateBackStackLifecycle$navigation_runtime_release() {
        ...
        InterfaceC3349K transitionsInProgress;
        Set set;
        List<NavBackStackEntry> Z02 = AbstractC1246t.Z0(this.backQueue);
        if (Z02.isEmpty()) {
            return;
        }
        NavDestination destination = ((NavBackStackEntry) AbstractC1246t.y0(Z02)).getDestination();
        ArrayList arrayList = new ArrayList();
        if (destination instanceof FloatingWindow) {
            Iterator it = AbstractC1246t.I0(Z02).iterator();
            while (it.hasNext()) {
        ...
        for (NavBackStackEntry navBackStackEntry : AbstractC1246t.I0(Z02)) {
            ...
            if (destination != null && destination3.getId() == destination.getId()) {
                ...
                if (maxLifecycle != state) {
                    ...
                    if (!AbstractC3159y.d(bool, Boolean.TRUE) && ((atomicInteger = this.parentToChildCount.get(navBackStackEntry)) == null || atomicInteger.get() != 0)) {
                        hashMap.put(navBackStackEntry, state);
                    } else {
                        hashMap.put(navBackStackEntry, Lifecycle.State.STARTED);
                    }
                }
                NavDestination navDestination = (NavDestination) AbstractC1246t.o0(arrayList);
                if (navDestination != null && navDestination.getId() == destination3.getId()) {
                    AbstractC1246t.N(arrayList);
                }
                destination = destination.getParent();
            } else if ((!arrayList.isEmpty()) && destination3.getId() == ((NavDestination) AbstractC1246t.m0(arrayList)).getId()) {
                NavDestination navDestination2 = (NavDestination) AbstractC1246t.N(arrayList);
    ...
    public void setGraph(NavGraph graph, Bundle bundle) {
        AbstractC3159y.i(graph, "graph");
        if (!AbstractC3159y.d(this._graph, graph)) {
            NavGraph navGraph = this._graph;
            if (navGraph != null) {
        ...
        for (NavBackStackEntry navBackStackEntry : this.backQueue) {
            List<NavDestination> W7 = AbstractC1246t.W(AbstractC2683j.D(NavDestination.Companion.getHierarchy(navBackStackEntry.getDestination())));
            NavDestination navDestination = this._graph;
            AbstractC3159y.f(navDestination);
            for (NavDestination navDestination2 : W7) {
                if (!AbstractC3159y.d(navDestination2, this._graph) || !AbstractC3159y.d(navDestination, graph)) {
                    if (navDestination instanceof NavGraph) {
    ...
    private final boolean restoreStateInternal(String str) {
        ...
        if (findDestination != null) {
            ...
            AbstractC1246t.I(this.backStackMap.values(), new NavController$restoreStateInternal$3(str2));
            C1238k c1238k = (C1238k) Z.c(this.backStackStates).remove(str2);
            NavDestination.DeepLinkMatch matchDeepLink = findDestination.matchDeepLink(str);
            AbstractC3159y.f(matchDeepLink);
            if (matchDeepLink.hasMatchingArgs((c1238k == null || (navBackStackEntryState = (NavBackStackEntryState) c1238k.q()) == null) ? null : navBackStackEntryState.getArgs())) {
                return executeRestoreState(instantiateBackStack(c1238k), null, null, null);
            }
            return false;
        }
    ...
    public final NavDestination findDestination(String route) {
        ...
        AbstractC3159y.f(navGraph2);
        if (!AbstractC3159y.d(navGraph2.getRoute(), route)) {
            NavGraph navGraph3 = this._graph;
            AbstractC3159y.f(navGraph3);
    ...
    */
    ...
    public void navigate(NavDirections directions, Navigator.Extras navigatorExtras) {
        AbstractC3159y.i(directions, "directions");
        AbstractC3159y.i(navigatorExtras, "navigatorExtras");
    ...
    public final void navigate(String route, NavOptions navOptions, Navigator.Extras extras) {
        ...
        AbstractC3159y.e(parse, "Uri.parse(this)");
