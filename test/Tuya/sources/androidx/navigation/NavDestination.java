...
public class NavDestination {
    ...
    public static final class Companion {
        ...
        public final String getDisplayName(Context context, int i8) {
            ...
            AbstractC3159y.h(valueOf, "try {\n                co….toString()\n            }");
            return valueOf;
        }

        public final InterfaceC2680g getHierarchy(NavDestination navDestination) {
            AbstractC3159y.i(navDestination, "<this>");
            return AbstractC2683j.h(navDestination, NavDestination$Companion$hierarchy$1.INSTANCE);
        }
        ...
        protected final <C> Class<? extends C> parseClassFromName(Context context, String name, Class<? extends C> expectedClassType) {
            ...
            AbstractC3159y.i(expectedClassType, "expectedClassType");
            if (name.charAt(0) == '.') {
    ...
    public static final class DeepLinkMatch implements Comparable<DeepLinkMatch> {
        ...
        public final boolean hasMatchingArgs(Bundle bundle) {
            ...
            AbstractC3159y.h(keySet, "matchingArgs.keySet()");
    ...
    public NavDestination(String navigatorName) {
        AbstractC3159y.i(navigatorName, "navigatorName");
    ...
    public static final InterfaceC2680g getHierarchy(NavDestination navDestination) {
    ...
    public final void addArgument(String argumentName, NavArgument argument) {
        AbstractC3159y.i(argumentName, "argumentName");
    ...
    */
    public boolean equals(java.lang.Object r9) {
        ...
        Ld:
            ...
            boolean r2 = kotlin.jvm.internal.AbstractC3159y.d(r2, r3)
            ...
            if (r3 != r4) goto L58
            androidx.collection.SparseArrayCompat<androidx.navigation.NavAction> r3 = r8.actions
            M5.N r3 = androidx.collection.SparseArrayKt.keyIterator(r3)
            f6.g r3 = f6.AbstractC2683j.c(r3)
        ...
        L33:
            ...
            boolean r4 = kotlin.jvm.internal.AbstractC3159y.d(r5, r4)
            if (r4 != 0) goto L33
            goto L58
        L56:
            r3 = 1
        ...
        L71:
            ...
            boolean r5 = kotlin.jvm.internal.AbstractC3159y.d(r6, r5)
            if (r5 == 0) goto La0
            goto L71
        L9e:
            r4 = 1
        ...
        La1:
            ...
            boolean r9 = kotlin.jvm.internal.AbstractC3159y.d(r5, r9)
            if (r9 == 0) goto Lb8
            if (r2 == 0) goto Lb8
            if (r3 == 0) goto Lb8
            if (r4 == 0) goto Lb8
    ...
    public final String fillInLabel(Context context, Bundle bundle) {
        ...
        while (matcher.find()) {
            ...
            if (bundle != null && bundle.containsKey(group)) {
                ...
                if (AbstractC3159y.d(navType, NavType.ReferenceType)) {
                    String string = context.getString(bundle.getInt(group));
                    AbstractC3159y.h(string, "context.getString(bundle.getInt(argName))");
    ...
    public final boolean hasRoute(String route, Bundle bundle) {
        ...
        if (AbstractC3159y.d(this.route, route)) {
            return true;
        }
        ...
        if (!AbstractC3159y.d(this, navDestination)) {
            return false;
        }
    ...
    public int hashCode() {
        ...
        while (valueIterator.hasNext()) {
            ...
            if (defaultArguments != null && (keySet = defaultArguments.keySet()) != null) {
                AbstractC3159y.h(keySet, "keySet()");
                for (String str2 : keySet) {
                    int i20 = i16 * 31;
                    Bundle defaultArguments2 = navAction.getDefaultArguments();
                    AbstractC3159y.f(defaultArguments2);
    ...
    public void onInflate(Context context, AttributeSet attrs) {
        ...
        AbstractC3159y.h(obtainAttributes, "context.resources.obtain…s, R.styleable.Navigator)");
    ...
    public final void setRoute(String str) {
        ...
        while (true) {
            if (it.hasNext()) {
                obj = it.next();
                if (AbstractC3159y.d(((NavDeepLink) obj).getUriPattern(), Companion.createRoute(this.route))) {
                    break;
                }
            } else {
                obj = null;
    ...
    public final int[] buildDeepLinkIds(NavDestination navDestination) {
        ...
        while (true) {
            AbstractC3159y.f(navDestination2);
            ...
            if (AbstractC3159y.d(navGraph, navDestination) || navGraph == null) {
                break;
            }
            navDestination2 = navGraph;
        }
        List W02 = AbstractC1246t.W0(c1238k);
        ArrayList arrayList = new ArrayList(AbstractC1246t.x(W02, 10));
        Iterator it = W02.iterator();
        while (it.hasNext()) {
            arrayList.add(Integer.valueOf(((NavDestination) it.next()).id));
        }
        return AbstractC1246t.V0(arrayList);
    }
    ...
    public DeepLinkMatch matchDeepLink(NavDeepLinkRequest navDeepLinkRequest) {
        AbstractC3159y.i(navDeepLinkRequest, "navDeepLinkRequest");
        ...
        for (NavDeepLink navDeepLink : this.deepLinks) {
            ...
            boolean z8 = action != null && AbstractC3159y.d(action, navDeepLink.getAction());
