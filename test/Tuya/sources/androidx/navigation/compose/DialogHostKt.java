    ...
    public static final void DialogHost(DialogNavigator dialogNavigator, Composer composer, int i8) {
        ...
        if ((i9 & 11) == 2 && startRestartGroup.getSkipping()) {
            ...
            for (NavBackStackEntry navBackStackEntry : rememberVisibleList) {
                ...
                AbstractC3159y.g(destination, "null cannot be cast to non-null type androidx.navigation.compose.DialogNavigator.Destination");
            ...
            startRestartGroup.endReplaceableGroup();
            EffectsKt.LaunchedEffect(DialogHost$lambda$1, snapshotStateList2, (n) rememberedValue2, startRestartGroup, 568);
            if (ComposerKt.isTraceInProgress()) {
