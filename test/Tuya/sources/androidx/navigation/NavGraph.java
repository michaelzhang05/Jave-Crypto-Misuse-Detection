...
public class NavGraph extends NavDestination implements Iterable<NavDestination>, Y5.a {
    ...
    public static final class Companion {
        ...
        public final NavDestination findStartDestination(NavGraph navGraph) {
            ...
            return (NavDestination) AbstractC2683j.x(AbstractC2683j.h(navGraph.findNode(navGraph.getStartDestinationId()), NavGraph$Companion$findStartDestination$1.INSTANCE));
        }
    ...
    public NavGraph(Navigator<? extends NavGraph> navGraphNavigator) {
        ...
        AbstractC3159y.i(navGraphNavigator, "navGraphNavigator");
    ...
    private final void setStartDestinationRoute(String str) {
        ...
        if (str == null) {
            hashCode = 0;
        } else if (!AbstractC3159y.d(str, getRoute())) {
            if (!n.u(str)) {
    ...
    public final void addDestination(NavDestination node) {
        ...
        if (getRoute() != null && !(!AbstractC3159y.d(route, getRoute()))) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj != null && (obj instanceof NavGraph) && super.equals(obj)) {
            ...
            if (this.nodes.size() == navGraph.nodes.size() && getStartDestinationId() == navGraph.getStartDestinationId()) {
                for (NavDestination navDestination : AbstractC2683j.c(SparseArrayKt.valueIterator(this.nodes))) {
                    if (!AbstractC3159y.d(navDestination, navGraph.nodes.get(navDestination.getId()))) {
                    }
                }
                return true;
            }
    ...
    public NavDestination.DeepLinkMatch matchDeepLink(NavDeepLinkRequest navDeepLinkRequest) {
        ...
        return (NavDestination.DeepLinkMatch) AbstractC1246t.A0(AbstractC1246t.r(matchDeepLink, (NavDestination.DeepLinkMatch) AbstractC1246t.A0(arrayList)));
    }
    ...
    public void onInflate(Context context, AttributeSet attrs) {
        ...
        AbstractC3159y.h(obtainAttributes, "context.resources.obtain…vGraphNavigator\n        )");
    ...
    public final void setStartDestination(String startDestRoute) {
        AbstractC3159y.i(startDestRoute, "startDestRoute");
    ...
    public final NavDestination findNode(String route, boolean z8) {
        ...
        if (navDestination2 == null) {
            Iterator it = AbstractC2683j.c(SparseArrayKt.valueIterator(this.nodes)).iterator();
            while (true) {
                if (!it.hasNext()) {
                    navDestination = 0;
                    break;
