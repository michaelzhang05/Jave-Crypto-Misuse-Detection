...
public final class PreferencesSerializer implements OkioSerializer<Preferences> {
    ...
    private final void addProtoEntryToPreferences(String str, PreferencesProto.Value value, MutablePreferences mutablePreferences) {
        ...
        switch (i8) {
            ...
            case 6:
                ...
                AbstractC3159y.h(string, "value.string");
            ...
            case 7:
                ...
                AbstractC3159y.h(stringsList, "value.stringSet.stringsList");
                mutablePreferences.set(stringSetKey, AbstractC1246t.b1(stringsList));
                return;
            case 8:
                Preferences.Key<byte[]> byteArrayKey = PreferencesKeys.byteArrayKey(str);
                byte[] byteArray = value.getBytes().toByteArray();
                AbstractC3159y.h(byteArray, "value.bytes.toByteArray()");
    ...
    private final PreferencesProto.Value getValueProto(Object obj) {
        ...
        if (obj instanceof Set) {
            ...
            AbstractC3159y.g(obj, "null cannot be cast to non-null type kotlin.collections.Set<kotlin.String>");
            PreferencesProto.Value build7 = newBuilder.setStringSet(newBuilder2.addAllStrings((Set) obj)).build();
            AbstractC3159y.h(build7, "newBuilder().setStringSe…                ).build()");
            return build7;
        }
        if (obj instanceof byte[]) {
            PreferencesProto.Value build8 = PreferencesProto.Value.newBuilder().setBytes(ByteString.copyFrom((byte[]) obj)).build();
            AbstractC3159y.h(build8, "newBuilder().setBytes(By….copyFrom(value)).build()");
            return build8;
        }
    ...
    public Object readFrom(InterfaceC1281g interfaceC1281g, d dVar) throws IOException, CorruptionException {
        PreferencesProto.PreferenceMap readFrom = PreferencesMapCompat.Companion.readFrom(interfaceC1281g.inputStream());
        ...
        AbstractC3159y.h(preferencesMap, "preferencesProto.preferencesMap");
    ...
    @Override // androidx.datastore.core.okio.OkioSerializer
    public Object writeTo(Preferences preferences, InterfaceC1280f interfaceC1280f, d dVar) throws IOException, CorruptionException {
        ...
        newBuilder.build().writeTo(interfaceC1280f.outputStream());
        return I.f6487a;
    }
}
