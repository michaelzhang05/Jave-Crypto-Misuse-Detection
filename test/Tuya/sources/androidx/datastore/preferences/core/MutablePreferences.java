...
public final class MutablePreferences extends Preferences {
    ...
    public Map<Preferences.Key<?>, Object> asMap() {
        ...
        LinkedHashMap linkedHashMap = new LinkedHashMap(m.d(Q.d(AbstractC1246t.x(entrySet, 10)), 16));
    ...
    */
    public boolean equals(java.lang.Object r6) {
        ...
        L2f:
            ...
            goto L65
        L5f:
            boolean r0 = kotlin.jvm.internal.AbstractC3159y.d(r0, r2)
            goto L65
        L64:
            r0 = 0
        L65:
    ...
    public <T> T get(Preferences.Key<T> key) {
        ...
        if (t8 instanceof byte[]) {
            ...
            AbstractC3159y.h(t9, "copyOf(this, size)");
            return t9;
        }
        return t8;
    }
    ...
    public String toString() {
        return AbstractC1246t.w0(this.preferencesMap.entrySet(), ",\n", "{\n", "\n}", 0, null, MutablePreferences$toString$1.INSTANCE, 24, null);
    }

    public /* synthetic */ MutablePreferences(Map map, boolean z8, int i8, AbstractC3151p abstractC3151p) {
    ...
    public MutablePreferences(Map<Preferences.Key<?>, Object> preferencesMap, boolean z8) {
        AbstractC3159y.i(preferencesMap, "preferencesMap");
