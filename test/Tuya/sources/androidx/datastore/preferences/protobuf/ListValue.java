...
public final class ListValue extends GeneratedMessageLite<ListValue, Builder> implements ListValueOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<ListValue, Builder> implements ListValueOrBuilder {
        ...
        public Value getValues(int i8) {
            return ((ListValue) this.instance).getValues(i8);
        }
        ...
        public Builder removeValues(int i8) {
            copyOnWrite();
            ((ListValue) this.instance).removeValues(i8);
            return this;
        }

        public Builder setValues(int i8, Value value) {
            copyOnWrite();
            ((ListValue) this.instance).setValues(i8, value);
            return this;
        }
        ...
        public Builder addValues(int i8, Value value) {
            copyOnWrite();
            ((ListValue) this.instance).addValues(i8, value);
            return this;
        }

        public Builder setValues(int i8, Value.Builder builder) {
            copyOnWrite();
            ((ListValue) this.instance).setValues(i8, builder.build());
            return this;
        }
        ...
        public Builder addValues(int i8, Value.Builder builder) {
            copyOnWrite();
            ((ListValue) this.instance).addValues(i8, builder.build());
            return this;
        }
    }
