...
public abstract class GeneratedMessageLite<MessageType extends GeneratedMessageLite<MessageType, BuilderType>, BuilderType extends Builder<MessageType, BuilderType>> extends AbstractMessageLite<MessageType, BuilderType> {
    ...
    public static abstract class Builder<MessageType extends GeneratedMessageLite<MessageType, BuilderType>, BuilderType extends Builder<MessageType, BuilderType>> extends AbstractMessageLite.Builder<MessageType, BuilderType> {
        ...
        public BuilderType mo5448clone() {
    ...
    public static abstract class ExtendableBuilder<MessageType extends ExtendableMessage<MessageType, BuilderType>, BuilderType extends ExtendableBuilder<MessageType, BuilderType>> extends Builder<MessageType, BuilderType> implements ExtendableMessageOrBuilder<MessageType, BuilderType> {
        ...
        private FieldSet<ExtensionDescriptor> ensureExtensionsAreMutable() {
            ...
            if (fieldSet.isImmutable()) {
                FieldSet<ExtensionDescriptor> m5449clone = fieldSet.m5449clone();
                ((ExtendableMessage) this.instance).extensions = m5449clone;
                return m5449clone;
            }
            return fieldSet;
        }
        ...
        protected void copyOnWriteInternal() {
            ...
            if (((ExtendableMessage) this.instance).extensions != FieldSet.emptySet()) {
                ...
                ((ExtendableMessage) messagetype).extensions = ((ExtendableMessage) messagetype).extensions.m5449clone();
            }
        }
        ...
        */
        ...
        public FieldSet<ExtensionDescriptor> ensureExtensionsAreMutable() {
            if (this.extensions.isImmutable()) {
                this.extensions = this.extensions.m5449clone();
            }
