...
public final class Field extends GeneratedMessageLite<Field, Builder> implements FieldOrBuilder {
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<Field, Builder> implements FieldOrBuilder {
        ...
        public Builder setOptions(int i8, Option.Builder builder) {
            copyOnWrite();
            ((Field) this.instance).setOptions(i8, builder.build());
            return this;
        }
        ...
        public Builder addOptions(int i8, Option.Builder builder) {
            copyOnWrite();
            ((Field) this.instance).addOptions(i8, builder.build());
            return this;
        }
    }
    ...
    public enum Cardinality implements Internal.EnumLite {
        ...
        private static final class CardinalityVerifier implements Internal.EnumVerifier {
            ...
            public boolean isInRange(int i8) {
                if (Cardinality.forNumber(i8) != null) {
                    return true;
                }
                return false;
            }
