...
public class MockView extends View {
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (this.mDrawDiagonals) {
            ...
            float f8 = width;
            float f9 = height;
            canvas.drawLine(0.0f, 0.0f, f8, f9, this.mPaintDiagonals);
            canvas.drawLine(0.0f, f9, f8, 0.0f, this.mPaintDiagonals);
            canvas.drawLine(0.0f, 0.0f, f8, 0.0f, this.mPaintDiagonals);
            canvas.drawLine(f8, 0.0f, f8, f9, this.mPaintDiagonals);
            canvas.drawLine(f8, f9, 0.0f, f9, this.mPaintDiagonals);
            canvas.drawLine(0.0f, f9, 0.0f, 0.0f, this.mPaintDiagonals);
        }
