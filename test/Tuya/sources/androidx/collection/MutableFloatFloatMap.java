...
public final class MutableFloatFloatMap extends FloatFloatMap {
    ...
    private final void resizeStorage(int i8) {
        ...
        while (i10 < i9) {
            if (((jArr2[i10 >> 3] >> ((i10 & 7) << 3)) & 255) < 128) {
                ...
                fArr4[findFirstAvailableSlot] = f8;
                fArr5[findFirstAvailableSlot] = fArr3[i10];
            } else {
                jArr = jArr2;
                fArr = fArr2;
            }
    ...
    public final float getOrPut(float f8, Function0 defaultValue) {
    ...
    public final void put(float f8, float f9) {
        set(f8, f9);
    }
    ...
    public final void set(float f8, float f9) {
        ...
        this.values[findInsertIndex] = f9;
    }
    ...
    public /* synthetic */ MutableFloatFloatMap(int i8, int i9, AbstractC3151p abstractC3151p) {
        this((i9 & 1) != 0 ? 6 : i8);
    }
    ...
    public final float put(float f8, float f9, float f10) {
        int findInsertIndex = findInsertIndex(f8);
        if (findInsertIndex < 0) {
            findInsertIndex = ~findInsertIndex;
        } else {
    ...
    public final boolean remove(float f8, float f9) {
        int findKeyIndex = findKeyIndex(f8);
        if (findKeyIndex < 0 || this.values[findKeyIndex] != f9) {
            return false;
        }
        removeValueAt(findKeyIndex);
        return true;
