...
final class MutableScatterMap$MutableMapWrapper$values$1$iterator$1$iterator$1 extends k implements n {
    int I$0;
    int I$1;
    int I$2;
    int I$3;
    ...
    public final Object invoke(AbstractC2682i abstractC2682i, d dVar) {
        return ((MutableScatterMap$MutableMapWrapper$values$1$iterator$1$iterator$1) create(abstractC2682i, dVar)).invokeSuspend(I.f6487a);
    }
