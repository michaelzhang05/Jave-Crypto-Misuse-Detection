...
public final class MutableScatterMap<K, V> extends ScatterMap<K, V> {
    ...
    /* loaded from: classes.dex */
    private final class MutableMapWrapper extends ScatterMap<K, V>.MapWrapper implements Map<K, V>, d, j$.util.Map {
    ...
    public final V compute(K k8, n computeBlock) {
        boolean z8;
        Object obj;
        AbstractC3159y.i(computeBlock, "computeBlock");
    ...
    */
    ...
    public /* synthetic */ MutableScatterMap(int i8, int i9, AbstractC3151p abstractC3151p) {
        this((i9 & 1) != 0 ? 6 : i8);
    }
    ...
    public final void plusAssign(InterfaceC2680g pairs) {
        AbstractC3159y.i(pairs, "pairs");
        putAll(pairs);
    }
    ...
    /* JADX WARN: Multi-variable type inference failed */
    public final void putAll(InterfaceC2680g pairs) {
        AbstractC3159y.i(pairs, "pairs");
