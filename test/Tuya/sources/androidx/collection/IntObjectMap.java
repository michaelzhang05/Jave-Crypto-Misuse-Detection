...
public abstract class IntObjectMap<V> {
    ...
    public /* synthetic */ IntObjectMap(AbstractC3151p abstractC3151p) {
        this();
    }
    ...
    */
                ...
                if ((((~j8) << 7) & j8 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i10 = 0; i10 < i9; i10++) {
                        if ((255 & j8) < 128) {
                            ...
                            } else if (!AbstractC3159y.d(obj2, intObjectMap.get(i12))) {
                                return false;
                            }
                        }
                        j8 >>= 8;
    ...
    public final int findKeyIndex$collection(int i8) {
    ...
    */
    ...
    public final V getOrElse(int i8, Function0 defaultValue) {
            ...
            while (true) {
                ...
                if ((((~j8) << 7) & j8 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i12 = 0; i12 < i11; i12++) {
                        if ((255 & j8) < 128) {
                            int i13 = (i9 << 3) + i12;
                            if (((Boolean) predicate.invoke(Integer.valueOf(iArr[i13]), objArr[i13])).booleanValue()) {
                                i10++;
                            }
                        }
                        j8 >>= 8;
    ...
    public static /* synthetic */ String joinToString$default(IntObjectMap intObjectMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i8, CharSequence charSequence4, n transform, int i9, Object obj) {
        long[] jArr;
        long[] jArr2;
        if (obj == null) {
                    ...
                    if ((((~j8) << 7) & j8 & (-9187201950435737472L)) != -9187201950435737472L) {
                        ...
                        while (i15 < i14) {
                            if ((j8 & 255) < 128) {
                                ...
                                jArr2 = jArr3;
                                sb.append((CharSequence) transform.invoke(Integer.valueOf(i17), obj2));
                                i12++;
                            } else {
                                jArr2 = jArr3;
                            }
                ...
                if ((((~j8) << 7) & j8 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i13 < i12) {
                        if ((j8 & 255) < 128) {
                            ...
                            sb.append((CharSequence) transform.invoke(Integer.valueOf(i15), obj));
                            i10++;
                        } else {
                            iArr2 = iArr3;
                        }
                ...
                if ((((~j8) << 7) & j8 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i12 = 0; i12 < i11; i12++) {
                        if ((j8 & 255) < 128) {
                            ...
                            sb.append((CharSequence) transform.invoke(Integer.valueOf(i14), obj));
                            i10++;
                        }
                        j8 >>= 8;
                    }
                ...
                if ((((~j8) << 7) & j8 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i11 = 0; i11 < i10; i11++) {
                        if ((j8 & 255) < 128) {
                            ...
                            sb.append((CharSequence) transform.invoke(Integer.valueOf(i13), obj));
                            i9++;
                        }
                        j8 >>= 8;
                    }
