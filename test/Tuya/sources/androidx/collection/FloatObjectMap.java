...
public abstract class FloatObjectMap<V> {
    ...
    public /* synthetic */ FloatObjectMap(AbstractC3151p abstractC3151p) {
        this();
    }
                ...
                if ((((~j8) << 7) & j8 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    for (int i10 = 0; i10 < i9; i10++) {
                        if ((255 & j8) < 128) {
                            ...
                            } else if (!AbstractC3159y.d(obj2, floatObjectMap.get(f8))) {
                                return false;
                            }
                        }
                        j8 >>= 8;
    ...
    */
    ...
    public static /* synthetic */ String joinToString$default(FloatObjectMap floatObjectMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i8, CharSequence charSequence4, n transform, int i9, Object obj) {
        long[] jArr;
        long[] jArr2;
        if (obj == null) {
