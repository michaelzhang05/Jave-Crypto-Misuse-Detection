...
public final class MutableLongFloatMap extends LongFloatMap {
    ...
    public final float getOrPut(long j8, Function0 defaultValue) {
    ...
    public final void put(long j8, float f8) {
        set(j8, f8);
    }
    ...
    public final void set(long j8, float f8) {
    ...
    public /* synthetic */ MutableLongFloatMap(int i8, int i9, AbstractC3151p abstractC3151p) {
        this((i9 & 1) != 0 ? 6 : i8);
    }
    ...
    public final float put(long j8, float f8, float f9) {
        int findInsertIndex = findInsertIndex(j8);
        if (findInsertIndex < 0) {
            findInsertIndex = ~findInsertIndex;
        } else {
    ...
    public final boolean remove(long j8, float f8) {
        int findKeyIndex = findKeyIndex(j8);
