...
public class PlaybackSupportFragmentGlueHost extends PlaybackGlueHost implements PlaybackSeekUi {
    ...
    final PlaybackGlueHost.PlayerCallback mPlayerCallback = new PlaybackGlueHost.PlayerCallback() { // from class: androidx.leanback.app.PlaybackSupportFragmentGlueHost.2
        ...
        public void onBufferingStateChanged(boolean z8) {
            PlaybackSupportFragmentGlueHost.this.mFragment.onBufferingStateChanged(z8);
        }

        @Override // androidx.leanback.media.PlaybackGlueHost.PlayerCallback
        public void onError(int i8, CharSequence charSequence) {
            PlaybackSupportFragmentGlueHost.this.mFragment.onError(i8, charSequence);
        }

        @Override // androidx.leanback.media.PlaybackGlueHost.PlayerCallback
        public void onVideoSizeChanged(int i8, int i9) {
            PlaybackSupportFragmentGlueHost.this.mFragment.onVideoSizeChanged(i8, i9);
        }
    };
