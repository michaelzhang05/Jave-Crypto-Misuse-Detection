...
public class ViewModelProvider {
    ...
    public interface Factory {
        ...
        <T extends ViewModel> T create(InterfaceC2643c interfaceC2643c, CreationExtras creationExtras);
    ...
    public static class NewInstanceFactory implements Factory {
        ...
        public static final class Companion {
            ...
            public final NewInstanceFactory getInstance() {
                ...
                AbstractC3159y.f(newInstanceFactory);
        ...
        public <T extends ViewModel> T create(InterfaceC2643c modelClass, CreationExtras extras) {
            AbstractC3159y.i(modelClass, "modelClass");
            AbstractC3159y.i(extras, "extras");
            return (T) create(W5.a.a(modelClass), extras);
        }
    }
    ...
    @MainThread
    public final <T extends ViewModel> T get(InterfaceC2643c modelClass) {
        AbstractC3159y.i(modelClass, "modelClass");
    ...
    public static class AndroidViewModelFactory extends NewInstanceFactory {
        ...
        public static final class Companion {
            ...
            public final AndroidViewModelFactory getInstance(Application application) {
                ...
                AbstractC3159y.f(androidViewModelFactory);
    ...
    public <T extends ViewModel> T get(Class<T> modelClass) {
        AbstractC3159y.i(modelClass, "modelClass");
        return (T) get(W5.a.c(modelClass));
    }

    @MainThread
    public final <T extends ViewModel> T get(String key, InterfaceC2643c modelClass) {
        AbstractC3159y.i(key, "key");
        AbstractC3159y.i(modelClass, "modelClass");
        return (T) this.impl.getViewModel$lifecycle_viewmodel_release(modelClass, key);
    }

    public /* synthetic */ ViewModelProvider(ViewModelStore viewModelStore, Factory factory, CreationExtras creationExtras, int i8, AbstractC3151p abstractC3151p) {
    ...
    public <T extends ViewModel> T get(String key, Class<T> modelClass) {
        AbstractC3159y.i(key, "key");
        AbstractC3159y.i(modelClass, "modelClass");
        return (T) this.impl.getViewModel$lifecycle_viewmodel_release(W5.a.c(modelClass), key);
    }
    ...
    public ViewModelProvider(ViewModelStore store, Factory factory, CreationExtras defaultCreationExtras) {
        ...
        AbstractC3159y.i(store, "store");
        AbstractC3159y.i(factory, "factory");
        AbstractC3159y.i(defaultCreationExtras, "defaultCreationExtras");
    }
