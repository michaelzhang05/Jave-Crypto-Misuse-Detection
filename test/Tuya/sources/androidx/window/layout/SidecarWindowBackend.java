...
public final class SidecarWindowBackend implements WindowBackend {
    ...
    public static final class Companion {
        ...
        public final SidecarWindowBackend getInstance(Context context) {
            ...
            AbstractC3159y.f(sidecarWindowBackend);
    ...
    public static final class WindowLayoutChangeCallbackWrapper {
        ...
        public static final void m5479accept$lambda0(WindowLayoutChangeCallbackWrapper this$0, WindowLayoutInfo newLayoutInfo) {
            AbstractC3159y.i(this$0, "this$0");
            AbstractC3159y.i(newLayoutInfo, "$newLayoutInfo");
        ...
        public final void accept(final WindowLayoutInfo newLayoutInfo) {
            ...
            this.executor.execute(new Runnable() { // from class: androidx.window.layout.i
                ...
                public final void run() {
                    SidecarWindowBackend.WindowLayoutChangeCallbackWrapper.m5479accept$lambda0(SidecarWindowBackend.WindowLayoutChangeCallbackWrapper.this, newLayoutInfo);
                }
            });
        }
    ...
    private final void callbackRemovedForActivity(Activity activity) {
        ...
        if (!(copyOnWriteArrayList instanceof Collection) || !copyOnWriteArrayList.isEmpty()) {
            ...
            while (it.hasNext()) {
                if (AbstractC3159y.d(((WindowLayoutChangeCallbackWrapper) it.next()).getActivity(), activity)) {
                    return;
                }
            }
        }
    ...
    public void registerLayoutChangeCallback(Activity activity, Executor executor, Consumer<WindowLayoutInfo> callback) {
        ...
        try {
            ...
            if (windowExtension == null) {
                callback.accept(new WindowLayoutInfo(AbstractC1246t.m()));
                return;
            }
            ...
            if (!isActivityRegistered) {
                ...
                while (true) {
                    ...
                    if (it.hasNext()) {
                        obj = it.next();
                        if (AbstractC3159y.d(activity, ((WindowLayoutChangeCallbackWrapper) obj).getActivity())) {
                            break;
                        }
                    } else {
                        obj = null;
            ...
            try {
                ...
                while (it.hasNext()) {
                    ...
                    if (callbackWrapper.getCallback() == callback) {
                        AbstractC3159y.h(callbackWrapper, "callbackWrapper");
