...
public abstract class MediaBrowserServiceCompat extends Service {
    ...
    class MediaBrowserServiceImplApi21 implements MediaBrowserServiceImpl, MediaBrowserServiceCompatApi21.ServiceCompatProxy {
        ...
        public MediaBrowserServiceCompatApi21.BrowserRoot onGetRoot(String str, int i8, Bundle bundle) {
            Bundle bundle2;
            IBinder asBinder;
            if (bundle != null && bundle.getInt(MediaBrowserProtocol.EXTRA_CLIENT_VERSION, 0) != 0) {
                ...
                if (token != null) {
                    android.support.v4.media.session.b e8 = token.e();
                    if (e8 == null) {
                        asBinder = null;
                    } else {
                        asBinder = e8.asBinder();
                    }
            ...
            mediaBrowserServiceCompat.mCurConnection = new ConnectionRecord(str, -1, i8, bundle, null);
            BrowserRoot onGetRoot = MediaBrowserServiceCompat.this.onGetRoot(str, i8, bundle);
                ...
                public void run() {
                    if (!MediaBrowserServiceImplApi21.this.mRootExtrasList.isEmpty()) {
                        ...
                        if (e8 != null) {
                            ...
                            while (it.hasNext()) {
                                BundleCompat.putBinder(it.next(), MediaBrowserProtocol.EXTRA_SESSION_BINDER, e8.asBinder());
                            }
                        }
                        MediaBrowserServiceImplApi21.this.mRootExtrasList.clear();
                    }
                    MediaBrowserServiceCompatApi21.setSessionToken(MediaBrowserServiceImplApi21.this.mServiceObj, token.f());
                }
            });
        }
    ...
    public static class Result<T> {
        ...
        private void checkExtraFields(Bundle bundle) {
            if (bundle != null && bundle.containsKey("android.media.browse.extra.DOWNLOAD_PROGRESS")) {
                float f8 = bundle.getFloat("android.media.browse.extra.DOWNLOAD_PROGRESS");
    ...
    private class ServiceBinderImpl {
            ...
            if (MediaBrowserServiceCompat.this.isValidPackage(str, i9)) {
                MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable() { // from class: androidx.media.MediaBrowserServiceCompat.ServiceBinderImpl.1
                    ...
                    public void run() {
                        ...
                        ConnectionRecord connectionRecord = new ConnectionRecord(str, i8, i9, bundle, serviceCallbacks);
                        MediaBrowserServiceCompat mediaBrowserServiceCompat = MediaBrowserServiceCompat.this;
        ...
        public void getMediaItem(final String str, final C2528b c2528b, final ServiceCallbacks serviceCallbacks) {
            if (!TextUtils.isEmpty(str) && c2528b != null) {
                MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable() { // from class: androidx.media.MediaBrowserServiceCompat.ServiceBinderImpl.5
                    ...
                    public void run() {
                        ...
                        MediaBrowserServiceCompat.this.performLoadItem(str, connectionRecord, c2528b);
                    }
                });
            }
        }
        ...
        public void search(final String str, final Bundle bundle, final C2528b c2528b, final ServiceCallbacks serviceCallbacks) {
            if (!TextUtils.isEmpty(str) && c2528b != null) {
                MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable() { // from class: androidx.media.MediaBrowserServiceCompat.ServiceBinderImpl.8
                    ...
                    public void run() {
                        ...
                        MediaBrowserServiceCompat.this.performSearch(str, bundle, connectionRecord, c2528b);
                    }
                });
            }
        }

        public void sendCustomAction(final String str, final Bundle bundle, final C2528b c2528b, final ServiceCallbacks serviceCallbacks) {
            if (!TextUtils.isEmpty(str) && c2528b != null) {
                MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable() { // from class: androidx.media.MediaBrowserServiceCompat.ServiceBinderImpl.9
                    ...
                    public void run() {
                        ...
                        MediaBrowserServiceCompat.this.performCustomAction(str, bundle, connectionRecord, c2528b);
                    }
                });
            }
        }
    ...
    private static class ServiceCallbacksCompat implements ServiceCallbacks {
        ...
        private void sendRequest(int i8, Bundle bundle) throws RemoteException {
        ...
        public void handleMessage(Message message) {
            ...
            switch (message.what) {
                ...
                case 4:
                    ...
                    return;
                case 5:
                    this.mServiceBinderImpl.getMediaItem(data.getString(MediaBrowserProtocol.DATA_MEDIA_ITEM_ID), (C2528b) data.getParcelable(MediaBrowserProtocol.DATA_RESULT_RECEIVER), new ServiceCallbacksCompat(message.replyTo));
                    return;
                case 6:
                ...
                case 8:
                    ...
                    this.mServiceBinderImpl.search(data.getString(MediaBrowserProtocol.DATA_SEARCH_QUERY), bundle4, (C2528b) data.getParcelable(MediaBrowserProtocol.DATA_RESULT_RECEIVER), new ServiceCallbacksCompat(message.replyTo));
                    return;
                case 9:
                    Bundle bundle5 = data.getBundle(MediaBrowserProtocol.DATA_CUSTOM_ACTION_EXTRAS);
                    MediaSessionCompat.a(bundle5);
                    this.mServiceBinderImpl.sendCustomAction(data.getString(MediaBrowserProtocol.DATA_CUSTOM_ACTION), bundle5, (C2528b) data.getParcelable(MediaBrowserProtocol.DATA_RESULT_RECEIVER), new ServiceCallbacksCompat(message.replyTo));
                    return;
                default:
    ...
    void performCustomAction(String str, Bundle bundle, ConnectionRecord connectionRecord, final C2528b c2528b) {
    ...
    void performLoadItem(String str, ConnectionRecord connectionRecord, final C2528b c2528b) {
    ...
    void performSearch(String str, Bundle bundle, ConnectionRecord connectionRecord, final C2528b c2528b) {
