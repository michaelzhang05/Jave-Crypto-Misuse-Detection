...
public final class BorderModifierNode extends DelegatingNode {
    ...
    public /* synthetic */ BorderModifierNode(float f8, Brush brush, Shape shape, AbstractC3151p abstractC3151p) {
        this(f8, brush, shape);
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:23:0x00d8, code lost:
        ...
        if (androidx.compose.ui.graphics.ImageBitmapConfig.m3166equalsimpl(r14, r4) != false) goto L26;
     */
    /*
    ...
    */
    ...
    public final DrawResult m299drawRoundRectBorderJqoCqck(CacheDrawScope cacheDrawScope, Brush brush, Outline.Rounded rounded, long j8, long j9, boolean z8, float f8) {
        Path createRoundRectPath;
        if (RoundRectKt.isSimple(rounded.getRoundRect())) {
            return cacheDrawScope.onDrawWithContent(new BorderModifierNode$drawRoundRectBorder$1(z8, brush, rounded.getRoundRect().m2785getTopLeftCornerRadiuskKHJgLs(), f8 / 2, f8, j8, j9, new Stroke(f8, 0.0f, 0, 0, null, 30, null)));
        }
        if (this.borderCache == null) {
            this.borderCache = new BorderCache(null, null, null, null, 15, null);
        }
        BorderCache borderCache = this.borderCache;
        AbstractC3159y.f(borderCache);
    ...
    public final float m300getWidthD9Ej5fM() {
        return this.width;
    }

    public final void setBrush(Brush value) {
        AbstractC3159y.i(value, "value");
        if (!AbstractC3159y.d(this.brush, value)) {
            this.brush = value;
    ...
    public final void setShape(Shape value) {
        AbstractC3159y.i(value, "value");
        if (!AbstractC3159y.d(this.shape, value)) {
            this.shape = value;
            this.drawWithCacheModifierNode.invalidateDrawCache();
        }
    }
    ...
    public final void m301setWidth0680j_4(float f8) {
        if (!Dp.m5183equalsimpl0(this.width, f8)) {
            this.width = f8;
            this.drawWithCacheModifierNode.invalidateDrawCache();
        }
    }
    ...
    private BorderModifierNode(float f8, Brush brushParameter, Shape shapeParameter) {
        AbstractC3159y.i(brushParameter, "brushParameter");
        AbstractC3159y.i(shapeParameter, "shapeParameter");
        this.width = f8;
