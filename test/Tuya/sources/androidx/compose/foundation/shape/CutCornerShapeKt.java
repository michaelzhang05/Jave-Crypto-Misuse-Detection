...
public final class CutCornerShapeKt {
    ...
    public static final CutCornerShape m845CutCornerShape0680j_4(float f8) {
        return CutCornerShape(CornerSizeKt.m844CornerSize0680j_4(f8));
    }

    /* renamed from: CutCornerShape-a9UjIt4, reason: not valid java name */
    public static final CutCornerShape m846CutCornerShapea9UjIt4(float f8, float f9, float f10, float f11) {
        return new CutCornerShape(CornerSizeKt.m844CornerSize0680j_4(f8), CornerSizeKt.m844CornerSize0680j_4(f9), CornerSizeKt.m844CornerSize0680j_4(f10), CornerSizeKt.m844CornerSize0680j_4(f11));
    }

    /* renamed from: CutCornerShape-a9UjIt4$default, reason: not valid java name */
    public static /* synthetic */ CutCornerShape m847CutCornerShapea9UjIt4$default(float f8, float f9, float f10, float f11, int i8, Object obj) {
        if ((i8 & 1) != 0) {
        ...
        return m846CutCornerShapea9UjIt4(f8, f9, f10, f11);
    }
