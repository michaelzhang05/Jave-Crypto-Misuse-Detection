...
public final class LazyLayoutKt {
    ...
    public static final void LazyLayout(LazyLayoutItemProvider itemProvider, Modifier modifier, LazyLayoutPrefetchState lazyLayoutPrefetchState, n measurePolicy, Composer composer, int i8, int i9) {
        int i10;
        AbstractC3159y.i(itemProvider, "itemProvider");
        AbstractC3159y.i(measurePolicy, "measurePolicy");
    ...
    */
    public static final void LazyLayout(kotlin.jvm.functions.Function0 r14, androidx.compose.ui.Modifier r15, androidx.compose.foundation.lazy.layout.LazyLayoutPrefetchState r16, X5.n r17, androidx.compose.runtime.Composer r18, int r19, int r20) {
        /*
            Method dump skipped, instructions count: 233
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.lazy.layout.LazyLayoutKt.LazyLayout(kotlin.jvm.functions.Function0, androidx.compose.ui.Modifier, androidx.compose.foundation.lazy.layout.LazyLayoutPrefetchState, X5.n, androidx.compose.runtime.Composer, int, int):void");
    }
}
