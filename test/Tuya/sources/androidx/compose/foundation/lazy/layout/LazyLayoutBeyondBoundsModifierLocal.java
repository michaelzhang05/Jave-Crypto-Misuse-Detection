...
public final class LazyLayoutBeyondBoundsModifierLocal implements ModifierLocalProvider<BeyondBoundsLayout>, BeyondBoundsLayout {
    ...
    public <T> T mo752layouto7g1Pn8(final int i8, Function1 block) {
        ...
        if (this.state.getItemCount() > 0 && this.state.getHasVisibleItems()) {
            ...
            final T t8 = new T();
            t8.f33761a = this.beyondBoundsInfo.addInterval(firstPlacedIndex, firstPlacedIndex);
            T t9 = null;
            while (t9 == null && m749hasMoreContentFR3nfPY((LazyLayoutBeyondBoundsInfo.Interval) t8.f33761a, i8)) {
                LazyLayoutBeyondBoundsInfo.Interval m748addNextIntervalFR3nfPY = m748addNextIntervalFR3nfPY((LazyLayoutBeyondBoundsInfo.Interval) t8.f33761a, i8);
                this.beyondBoundsInfo.removeInterval((LazyLayoutBeyondBoundsInfo.Interval) t8.f33761a);
                t8.f33761a = m748addNextIntervalFR3nfPY;
                ...
                t9 = (T) block.invoke(new BeyondBoundsLayout.BeyondBoundsScope() { // from class: androidx.compose.foundation.lazy.layout.LazyLayoutBeyondBoundsModifierLocal$layout$2
                    ...
                    public boolean getHasMoreContent() {
                        ...
                        m749hasMoreContentFR3nfPY = LazyLayoutBeyondBoundsModifierLocal.this.m749hasMoreContentFR3nfPY((LazyLayoutBeyondBoundsInfo.Interval) t8.f33761a, i8);
