...
public final class LazyLayoutItemContentFactory$CachedItemContent$createContentLambda$1 extends AbstractC3160z implements n {
    ...
    public final void invoke(Composer composer, int i8) {
        ...
        if ((index >= lazyLayoutItemProvider.getItemCount() || !AbstractC3159y.d(lazyLayoutItemProvider.getKey(index), this.this$1.getKey())) && (index = lazyLayoutItemProvider.getIndex(this.this$1.getKey())) != -1) {
        ...
        if (z8) {
            ...
            LazyLayoutItemContentFactoryKt.m753SkippableItemJVlU9Rs(lazyLayoutItemProvider, StableValue.m761constructorimpl(saveableStateHolder), i9, StableValue.m761constructorimpl(cachedItemContent.getKey()), composer, 0);
        } else {
