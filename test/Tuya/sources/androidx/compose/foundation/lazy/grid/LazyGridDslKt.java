...
public final class LazyGridDslKt {
    ...
    */
    ...
    public static final <T> void items(LazyGridScope lazyGridScope, List<? extends T> items, Function1 function1, n nVar, Function1 contentType, p itemContent) {
        AbstractC3159y.i(lazyGridScope, "<this>");
        AbstractC3159y.i(items, "items");
        AbstractC3159y.i(contentType, "contentType");
        AbstractC3159y.i(itemContent, "itemContent");
        lazyGridScope.items(items.size(), function1 != null ? new LazyGridDslKt$items$2(function1, items) : null, nVar != null ? new LazyGridDslKt$items$3(nVar, items) : null, new LazyGridDslKt$items$4(contentType, items), ComposableLambdaKt.composableLambdaInstance(699646206, true, new LazyGridDslKt$items$5(itemContent, items)));
    }

    public static /* synthetic */ void items$default(LazyGridScope lazyGridScope, List items, Function1 function1, n nVar, Function1 contentType, p itemContent, int i8, Object obj) {
        if ((i8 & 2) != 0) {
            function1 = null;
        }
        if ((i8 & 4) != 0) {
    ...
    @ComposableInferredTarget(scheme = "[0[0]]")
    public static final <T> void itemsIndexed(LazyGridScope lazyGridScope, List<? extends T> items, n nVar, o oVar, n contentType, q itemContent) {
        AbstractC3159y.i(lazyGridScope, "<this>");
        AbstractC3159y.i(items, "items");
        AbstractC3159y.i(contentType, "contentType");
        AbstractC3159y.i(itemContent, "itemContent");
        lazyGridScope.items(items.size(), nVar != null ? new LazyGridDslKt$itemsIndexed$2(nVar, items) : null, oVar != null ? new LazyGridDslKt$itemsIndexed$3(oVar, items) : null, new LazyGridDslKt$itemsIndexed$4(contentType, items), ComposableLambdaKt.composableLambdaInstance(1229287273, true, new LazyGridDslKt$itemsIndexed$5(itemContent, items)));
    }

    public static /* synthetic */ void itemsIndexed$default(LazyGridScope lazyGridScope, List items, n nVar, o oVar, n contentType, q itemContent, int i8, Object obj) {
        if ((i8 & 2) != 0) {
            nVar = null;
        }
        if ((i8 & 4) != 0) {
    ...
    @Composable
    private static final n rememberColumnWidthSums(GridCells gridCells, Arrangement.Horizontal horizontal, PaddingValues paddingValues, Composer composer, int i8) {
    ...
    @Composable
    private static final n rememberRowHeightSums(GridCells gridCells, Arrangement.Vertical vertical, PaddingValues paddingValues, Composer composer, int i8) {
    ...
    @ComposableInferredTarget(scheme = "[0[0]]")
    public static final <T> void items(LazyGridScope lazyGridScope, T[] items, Function1 function1, n nVar, Function1 contentType, p itemContent) {
        AbstractC3159y.i(lazyGridScope, "<this>");
        AbstractC3159y.i(items, "items");
        AbstractC3159y.i(contentType, "contentType");
        AbstractC3159y.i(itemContent, "itemContent");
        lazyGridScope.items(items.length, function1 != null ? new LazyGridDslKt$items$7(function1, items) : null, nVar != null ? new LazyGridDslKt$items$8(nVar, items) : null, new LazyGridDslKt$items$9(contentType, items), ComposableLambdaKt.composableLambdaInstance(407562193, true, new LazyGridDslKt$items$10(itemContent, items)));
    }

    @ComposableInferredTarget(scheme = "[0[0]]")
    public static final <T> void itemsIndexed(LazyGridScope lazyGridScope, T[] items, n nVar, o oVar, n contentType, q itemContent) {
        AbstractC3159y.i(lazyGridScope, "<this>");
        AbstractC3159y.i(items, "items");
        AbstractC3159y.i(contentType, "contentType");
        AbstractC3159y.i(itemContent, "itemContent");
        lazyGridScope.items(items.length, nVar != null ? new LazyGridDslKt$itemsIndexed$7(nVar, items) : null, oVar != null ? new LazyGridDslKt$itemsIndexed$8(oVar, items) : null, new LazyGridDslKt$itemsIndexed$9(contentType, items), ComposableLambdaKt.composableLambdaInstance(-911455938, true, new LazyGridDslKt$itemsIndexed$10(itemContent, items)));
    }

    public static /* synthetic */ void items$default(LazyGridScope lazyGridScope, Object[] items, Function1 function1, n nVar, Function1 contentType, p itemContent, int i8, Object obj) {
        if ((i8 & 2) != 0) {
            function1 = null;
        }
        if ((i8 & 4) != 0) {
    ...
    public static /* synthetic */ void itemsIndexed$default(LazyGridScope lazyGridScope, Object[] items, n nVar, o oVar, n contentType, q itemContent, int i8, Object obj) {
        if ((i8 & 2) != 0) {
            nVar = null;
        }
        if ((i8 & 4) != 0) {
