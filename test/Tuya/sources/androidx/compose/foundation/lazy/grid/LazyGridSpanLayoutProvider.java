...
public final class LazyGridSpanLayoutProvider {
    ...
    public LazyGridSpanLayoutProvider(LazyGridIntervalContent gridContent) {
        AbstractC3159y.i(gridContent, "gridContent");
        ...
        this.previousDefaultSpans = AbstractC1246t.m();
    }
    ...
    private final List<GridItemSpan> getDefaultSpans(int i8) {
        ...
        for (int i9 = 0; i9 < i8; i9++) {
            arrayList.add(GridItemSpan.m713boximpl(LazyGridSpanKt.GridItemSpan(1)));
        }
    ...
    */
    ...
    public final int getLineIndexOfItem(int i8) {
        ...
        if (i8 < getTotalSize()) {
            ...
            int k8 = AbstractC1246t.k(this.buckets, 0, 0, new LazyGridSpanLayoutProvider$getLineIndexOfItem$lowerBoundBucket$1(i8), 3, null);
            int i11 = 2;
            if (k8 < 0) {
                k8 = (-k8) - 2;
            }
    ...
    public final int spanOf(int i8, int i9) {
        ...
        return GridItemSpan.m717getCurrentLineSpanimpl(((GridItemSpan) interval.getValue().getSpan().invoke(lazyGridItemSpanScopeImpl, Integer.valueOf(i8 - interval.getStartIndex()))).m720unboximpl());
    }
    ...
    public static final class Bucket {
        ...
        public /* synthetic */ Bucket(int i8, int i9, int i10, AbstractC3151p abstractC3151p) {
