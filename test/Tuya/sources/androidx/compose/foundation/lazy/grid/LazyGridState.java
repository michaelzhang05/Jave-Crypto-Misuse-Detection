    ...
    */
    ...
    private final void cancelPrefetchIfVisibleItemsChanged(LazyGridLayoutInfo lazyGridLayoutInfo) {
        ...
        if (this.lineToPrefetch != -1 && (!lazyGridLayoutInfo.getVisibleItemsInfo().isEmpty())) {
            if (this.wasScrollingForward) {
                LazyGridItemInfo lazyGridItemInfo = (LazyGridItemInfo) AbstractC1246t.y0(lazyGridLayoutInfo.getVisibleItemsInfo());
                if (this.isVertical) {
                ...
                LazyGridItemInfo lazyGridItemInfo2 = (LazyGridItemInfo) AbstractC1246t.m0(lazyGridLayoutInfo.getVisibleItemsInfo());
                if (this.isVertical) {
    ...
    private final void notifyPrefetch(float f8) {
        ...
        if (!layoutInfo.getVisibleItemsInfo().isEmpty()) {
            ...
            if (z8) {
                LazyGridItemInfo lazyGridItemInfo = (LazyGridItemInfo) AbstractC1246t.y0(layoutInfo.getVisibleItemsInfo());
                if (this.isVertical) {
                    column2 = lazyGridItemInfo.getRow();
                } else {
                    column2 = lazyGridItemInfo.getColumn();
                ...
                i8 = column2 + 1;
                index = ((LazyGridItemInfo) AbstractC1246t.y0(layoutInfo.getVisibleItemsInfo())).getIndex() + 1;
            } else {
                LazyGridItemInfo lazyGridItemInfo2 = (LazyGridItemInfo) AbstractC1246t.m0(layoutInfo.getVisibleItemsInfo());
                if (this.isVertical) {
                    column = lazyGridItemInfo2.getRow();
                } else {
                    column = lazyGridItemInfo2.getColumn();
                ...
                i8 = column - 1;
                index = ((LazyGridItemInfo) AbstractC1246t.m0(layoutInfo.getVisibleItemsInfo())).getIndex() - 1;
            }
            if (i8 != this.lineToPrefetch && index >= 0 && index < layoutInfo.getTotalItemsCount()) {
                ...
                for (int i10 = 0; i10 < size2; i10++) {
                    ...
                    this.currentLinePrefetchHandles.add(lazyLayoutPrefetchState.m757schedulePrefetch0kLqBqw(((Number) rVar.c()).intValue(), ((Constraints) rVar.d()).m5152unboximpl()));
                }
            }
        }
    }
    ...
    */
    public java.lang.Object scroll(androidx.compose.foundation.MutatePriority r6, X5.n r7, P5.d r8) {
        ...
        L6c:
            ...
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.lazy.grid.LazyGridState.scroll(androidx.compose.foundation.MutatePriority, X5.n, P5.d):java.lang.Object");
    }
    ...
    public /* synthetic */ LazyGridState(int i8, int i9, int i10, AbstractC3151p abstractC3151p) {
