...
public final class LazyStaggeredGridMeasureKt {
    ...
    private static final List<LazyStaggeredGridMeasuredItem> calculateExtraItems(LazyStaggeredGridMeasureContext lazyStaggeredGridMeasureContext, Function1 function1, Function1 function12) {
        ...
        for (int i8 = 0; i8 < size; i8++) {
            ...
            if (((Boolean) function12.invoke(Integer.valueOf(intValue))).booleanValue()) {
                ...
                function1.invoke(m786getAndMeasurejy6DScQ);
    ...
    private static final List<LazyStaggeredGridMeasuredItem> calculateVisibleItems(LazyStaggeredGridMeasureContext lazyStaggeredGridMeasureContext, C1238k[] c1238kArr, int[] iArr, int i8) {
        int i9;
        int i10 = 0;
        for (C1238k c1238k : c1238kArr) {
            i10 += c1238k.size();
        }
        ArrayList arrayList = new ArrayList(i10);
        while (true) {
            for (C1238k c1238k2 : c1238kArr) {
                if (!c1238k2.isEmpty()) {
                    int length = c1238kArr.length;
                    int i11 = -1;
                    int i12 = Integer.MAX_VALUE;
                    for (int i13 = 0; i13 < length; i13++) {
                        LazyStaggeredGridMeasuredItem lazyStaggeredGridMeasuredItem = (LazyStaggeredGridMeasuredItem) c1238kArr[i13].q();
                    ...
                    LazyStaggeredGridMeasuredItem lazyStaggeredGridMeasuredItem2 = (LazyStaggeredGridMeasuredItem) c1238kArr[i11].w();
                    if (lazyStaggeredGridMeasuredItem2.getLane() == i11) {
                        ...
                        if (lazyStaggeredGridMeasuredItem2.getPlaceablesCount() != 0) {
                            lazyStaggeredGridMeasuredItem2.position(m781maxInRangejy6DScQ, i14, i8);
                            arrayList.add(lazyStaggeredGridMeasuredItem2);
                            int i15 = (int) (m791constructorimpl & 4294967295L);
                            for (int i16 = (int) (m791constructorimpl >> 32); i16 < i15; i16++) {
                                iArr[i16] = lazyStaggeredGridMeasuredItem2.getSizeWithSpacings() + m781maxInRangejy6DScQ;
                            }
                        }
                    }
                }
    ...
    private static final String debugRender(C1238k[] c1238kArr) {
        return "";
    }
    ...
    private static final void m780forEachnIS5qE8(long j8, Function1 function1) {
    ...
    private static final int m781maxInRangejy6DScQ(int[] iArr, long j8) {
        int i8 = (int) (j8 & 4294967295L);
        int i9 = Integer.MIN_VALUE;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:352:0x033c, code lost:
        ...
        r40 = r14;
        r24 = r15;
        r14 = r9.m778getSpanRangelOCCd4c(r37.getItemProvider(), r4, r2);
        r0 = r37.getLaneInfo();
        r23 = r3;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:355:0x036d, code lost:
        ...
        r0.setLane(r4, r11);
        r0 = r37.getMeasuredItemProvider().m786getAndMeasurejy6DScQ(r4, r14);
        r11 = m781maxInRangejy6DScQ(r8, r14);
     */
    ...
    */
    ...
    public static final LazyStaggeredGridMeasureResult m782measureStaggeredGriddSVRQoE(LazyLayoutMeasureScope measureStaggeredGrid, LazyStaggeredGridState state, List<Integer> pinnedItems, LazyStaggeredGridItemProvider itemProvider, LazyStaggeredGridSlots resolvedSlots, long j8, boolean z8, boolean z9, long j9, int i8, int i9, int i10, int i11) {
        ?? r12;
        int i12;
        int m781maxInRangejy6DScQ;
        int i13;
        AbstractC3159y.i(measureStaggeredGrid, "$this$measureStaggeredGrid");
        ...
        try {
            ...
            try {
                ...
                if (updateScrollPositionIfTheFirstItemWasMoved$foundation_release.length == lazyStaggeredGridMeasureContext.getLaneCount()) {
                    ...
                    int i14 = 0;
                    while (i14 < laneCount) {
                        if (i14 >= updateScrollPositionIfTheFirstItemWasMoved$foundation_release.length || (m781maxInRangejy6DScQ = updateScrollPositionIfTheFirstItemWasMoved$foundation_release[i14]) == -1) {
                            if (i14 == 0) {
                                m781maxInRangejy6DScQ = 0;
                            } else {
                                i12 = 1;
                                m781maxInRangejy6DScQ = m781maxInRangejy6DScQ(iArr, SpanRange.m791constructorimpl(0, i14)) + 1;
                                iArr[i14] = m781maxInRangejy6DScQ;
                ...
                t8.f33761a = updateScrollPositionIfTheFirstItemWasMoved$foundation_release;
                ...
                return measure(lazyStaggeredGridMeasureContext, Z5.a.d(state.getScrollToBeConsumed$foundation_release()), (int[]) t8.f33761a, (int[]) t9.f33761a, r12);
            } catch (Throwable th) {
                createNonObservableSnapshot.restoreCurrent(makeCurrent);
                throw th;
            }
