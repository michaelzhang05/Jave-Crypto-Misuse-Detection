...
final class AndroidFlingSpline {
    ...
    public static final class FlingResult {
        ...
        public static final /* synthetic */ FlingResult m505boximpl(long j8) {
            return new FlingResult(j8);
        }

        /* renamed from: constructor-impl, reason: not valid java name */
        public static long m506constructorimpl(long j8) {
            return j8;
        }

        /* renamed from: equals-impl, reason: not valid java name */
        public static boolean m507equalsimpl(long j8, Object obj) {
            return (obj instanceof FlingResult) && j8 == ((FlingResult) obj).m513unboximpl();
        }

        /* renamed from: equals-impl0, reason: not valid java name */
        public static final boolean m508equalsimpl0(long j8, long j9) {
            return j8 == j9;
        }

        /* renamed from: getDistanceCoefficient-impl, reason: not valid java name */
        public static final float m509getDistanceCoefficientimpl(long j8) {
            r rVar = r.f33790a;
            return Float.intBitsToFloat((int) (j8 >> 32));
        }

        /* renamed from: getVelocityCoefficient-impl, reason: not valid java name */
        public static final float m510getVelocityCoefficientimpl(long j8) {
            r rVar = r.f33790a;
            return Float.intBitsToFloat((int) (j8 & 4294967295L));
        }

        /* renamed from: hashCode-impl, reason: not valid java name */
        public static int m511hashCodeimpl(long j8) {
            return androidx.collection.a.a(j8);
        }

        /* renamed from: toString-impl, reason: not valid java name */
        public static String m512toStringimpl(long j8) {
            return "FlingResult(packedValue=" + j8 + ')';
        }

        public boolean equals(Object obj) {
            return m507equalsimpl(this.packedValue, obj);
        }
    ...
    public final long m504flingPositionLfoxSSI(float f8) {
        float f9;
        float f10;
        float f11 = 100;
        int i8 = (int) (f11 * f8);
        ...
        return FlingResult.m506constructorimpl((Float.floatToIntBits(f10) & 4294967295L) | (Float.floatToIntBits(f9) << 32));
    }
}
