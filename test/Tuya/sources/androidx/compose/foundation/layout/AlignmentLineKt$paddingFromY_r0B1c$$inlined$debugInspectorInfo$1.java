...
public final class AlignmentLineKt$paddingFromY_r0B1c$$inlined$debugInspectorInfo$1 extends AbstractC3160z implements Function1 {
    ...
    public final void invoke(InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set("before", TextUnit.m5355boximpl(this.$before$inlined));
        inspectorInfo.getProperties().set("after", TextUnit.m5355boximpl(this.$after$inlined));
    }
}
