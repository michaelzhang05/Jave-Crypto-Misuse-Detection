...
public final class Arrangement {
    ...
    private static final Horizontal Start = new Horizontal() { // from class: androidx.compose.foundation.layout.Arrangement$Start$1
        ...
        public void arrange(Density density, int i8, int[] sizes, LayoutDirection layoutDirection, int[] outPositions) {
            ...
            AbstractC3159y.i(outPositions, "outPositions");
        ...
        public /* synthetic */ float mo520getSpacingD9Ej5fM() {
            return a.a(this);
        }
    ...
    private static final HorizontalOrVertical Center = new HorizontalOrVertical() { // from class: androidx.compose.foundation.layout.Arrangement$Center$1
        private final float spacing = Dp.m5178constructorimpl(0);
        ...
        /* renamed from: getSpacing-D9Ej5fM */
        public float mo520getSpacingD9Ej5fM() {
            return this.spacing;
        }
    ...
    public static final class Absolute {
        ...
        public final Horizontal aligned(Alignment.Horizontal alignment) {
            ...
            return new SpacedAligned(Dp.m5178constructorimpl(0), false, new Arrangement$Absolute$aligned$1(alignment), null);
        }
        ...
        public final HorizontalOrVertical m517spacedBy0680j_4(float f8) {
            return new SpacedAligned(f8, false, null, 0 == true ? 1 : 0);
        }

        @Stable
        /* renamed from: spacedBy-D5KLDUw, reason: not valid java name */
        public final Horizontal m518spacedByD5KLDUw(float f8, Alignment.Horizontal alignment) {
            AbstractC3159y.i(alignment, "alignment");
        ...
        @Stable
        /* renamed from: spacedBy-D5KLDUw, reason: not valid java name */
        public final Vertical m519spacedByD5KLDUw(float f8, Alignment.Vertical alignment) {
            AbstractC3159y.i(alignment, "alignment");
    ...
    public interface Horizontal {
        ...
        public static final class DefaultImpls {
            @Deprecated
            /* renamed from: getSpacing-D9Ej5fM, reason: not valid java name */
            public static float m521getSpacingD9Ej5fM(Horizontal horizontal) {
                float a8;
                a8 = a.a(horizontal);
                return a8;
            }
    ...
    public interface HorizontalOrVertical extends Horizontal, Vertical {
        ...
        public static final class DefaultImpls {
            @Deprecated
            /* renamed from: getSpacing-D9Ej5fM, reason: not valid java name */
            public static float m522getSpacingD9Ej5fM(HorizontalOrVertical horizontalOrVertical) {
                float a8;
    ...
    public static final class SpacedAligned implements HorizontalOrVertical {
        private final X5.n alignment;
        private final boolean rtlMirror;
        private final float space;
        private final float spacing;

        public /* synthetic */ SpacedAligned(float f8, boolean z8, X5.n nVar, AbstractC3151p abstractC3151p) {
            this(f8, z8, nVar);
        }

        /* renamed from: copy-8Feqmps$default, reason: not valid java name */
        public static /* synthetic */ SpacedAligned m523copy8Feqmps$default(SpacedAligned spacedAligned, float f8, boolean z8, X5.n nVar, int i8, Object obj) {
            if ((i8 & 1) != 0) {
            ...
            if ((i8 & 4) != 0) {
                nVar = spacedAligned.alignment;
            }
            return spacedAligned.m525copy8Feqmps(f8, z8, nVar);
        }
        ...
        public void arrange(Density density, int i8, int[] sizes, LayoutDirection layoutDirection, int[] outPositions) {
            ...
            int mo442roundToPx0680j_4 = density.mo442roundToPx0680j_4(this.space);
            ...
            if (!z8) {
                ...
                while (i11 < length) {
                    ...
                    int min2 = Math.min(mo442roundToPx0680j_4, (i8 - min) - i13);
                ...
                while (-1 < length2) {
                    ...
                    int min4 = Math.min(mo442roundToPx0680j_4, (i8 - min3) - i15);
            ...
            int i17 = i9 - i10;
            X5.n nVar = this.alignment;
            if (nVar == null || i17 >= i8) {
                return;
            }
            int intValue = ((Number) nVar.invoke(Integer.valueOf(i8 - i17), layoutDirection)).intValue();
        ...
        public final float m524component1D9Ej5fM() {
            return this.space;
        }
        ...
        public final SpacedAligned m525copy8Feqmps(float f8, boolean z8, X5.n nVar) {
            return new SpacedAligned(f8, z8, nVar, null);
        }
        ...
        public boolean equals(Object obj) {
            ...
            return Dp.m5183equalsimpl0(this.space, spacedAligned.space) && this.rtlMirror == spacedAligned.rtlMirror && AbstractC3159y.d(this.alignment, spacedAligned.alignment);
        }

        public final X5.n getAlignment() {
            return this.alignment;
        }
        ...
        public final float m526getSpaceD9Ej5fM() {
            return this.space;
        }
        ...
        /* JADX WARN: Multi-variable type inference failed */
        public int hashCode() {
            int m5184hashCodeimpl = Dp.m5184hashCodeimpl(this.space) * 31;
            boolean z8 = this.rtlMirror;
            int i8 = z8;
            if (z8 != 0) {
                i8 = 1;
            }
            int i9 = (m5184hashCodeimpl + i8) * 31;
            X5.n nVar = this.alignment;
        ...
        public String toString() {
            ...
            sb.append((Object) Dp.m5189toStringimpl(this.space));
            sb.append(", ");
        ...
        private SpacedAligned(float f8, boolean z8, X5.n nVar) {
            this.space = f8;
            this.rtlMirror = z8;
            this.alignment = nVar;
            this.spacing = f8;
    ...
    public interface Vertical {
        ...
        public static final class DefaultImpls {
            @Deprecated
            /* renamed from: getSpacing-D9Ej5fM, reason: not valid java name */
            public static float m527getSpacingD9Ej5fM(Vertical vertical) {
                float a8;
                a8 = c.a(vertical);
                return a8;
            }
    ...
    private final void forEachIndexed(int[] iArr, boolean z8, X5.n nVar) {
        if (!z8) {
            int length = iArr.length;
            int i8 = 0;
            int i9 = 0;
            while (i8 < length) {
                nVar.invoke(Integer.valueOf(i9), Integer.valueOf(iArr[i8]));
                i8++;
                i9++;
            }
            return;
    ...
    public final Horizontal aligned(Alignment.Horizontal alignment) {
        AbstractC3159y.i(alignment, "alignment");
        return new SpacedAligned(Dp.m5178constructorimpl(0), true, new Arrangement$aligned$1(alignment), null);
    }
    ...
    public final void placeSpaceBetween$foundation_layout_release(int i8, int[] size, int[] outPosition, boolean z8) {
        ...
        float max = (i8 - i10) / Math.max(AbstractC1239l.g0(size), 1);
        if (z8 && size.length == 1) {
            f8 = max;
        } else {
            f8 = 0.0f;
    ...
    @Stable
    /* renamed from: spacedBy-0680j_4, reason: not valid java name */
    public final HorizontalOrVertical m514spacedBy0680j_4(float f8) {
        return new SpacedAligned(f8, true, Arrangement$spacedBy$1.INSTANCE, null);
    }

    @Stable
    /* renamed from: spacedBy-D5KLDUw, reason: not valid java name */
    public final Horizontal m515spacedByD5KLDUw(float f8, Alignment.Horizontal alignment) {
        AbstractC3159y.i(alignment, "alignment");
    ...
    @Stable
    /* renamed from: spacedBy-D5KLDUw, reason: not valid java name */
    public final Vertical m516spacedByD5KLDUw(float f8, Alignment.Vertical alignment) {
        AbstractC3159y.i(alignment, "alignment");
    ...
    public final Vertical aligned(Alignment.Vertical alignment) {
        AbstractC3159y.i(alignment, "alignment");
        return new SpacedAligned(Dp.m5178constructorimpl(0), false, new Arrangement$aligned$2(alignment), null);
    }
}
