...
public final class ScrollExtensionsKt$animateScrollBy$2 extends l implements n {
    ...
    public static final class AnonymousClass1 extends AbstractC3160z implements n {
        ...
        public final void invoke(float f8, float f9) {
            ...
            float f10 = p8.f33758a;
            p8.f33758a = f10 + this.$$this$scroll.scrollBy(f8 - f10);
        }
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ScrollExtensionsKt$animateScrollBy$2(float f8, AnimationSpec<Float> animationSpec, P p8, P5.d dVar) {
        super(2, dVar);
        this.$value = f8;
    ...
    public final Object invoke(ScrollScope scrollScope, P5.d dVar) {
        return ((ScrollExtensionsKt$animateScrollBy$2) create(scrollScope, dVar)).invokeSuspend(I.f6487a);
    }
