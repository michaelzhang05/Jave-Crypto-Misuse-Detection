...
public final class TapGestureDetectorKt$awaitSecondDown$2 extends k implements n {
    ...
    public TapGestureDetectorKt$awaitSecondDown$2(PointerInputChange pointerInputChange, P5.d dVar) {
        super(2, dVar);
    ...
    public final Object invoke(AwaitPointerEventScope awaitPointerEventScope, P5.d dVar) {
        return ((TapGestureDetectorKt$awaitSecondDown$2) create(awaitPointerEventScope, dVar)).invokeSuspend(I.f6487a);
    }
