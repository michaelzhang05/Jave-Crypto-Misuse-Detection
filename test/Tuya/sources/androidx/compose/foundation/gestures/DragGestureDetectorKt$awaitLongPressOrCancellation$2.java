...
public final class DragGestureDetectorKt$awaitLongPressOrCancellation$2 extends k implements n {
    ...
    public DragGestureDetectorKt$awaitLongPressOrCancellation$2(T t8, T t9, P5.d dVar) {
        super(2, dVar);
        this.$currentDown = t8;
        this.$longPress = t9;
    }
    ...
    public final Object invoke(AwaitPointerEventScope awaitPointerEventScope, P5.d dVar) {
        return ((DragGestureDetectorKt$awaitLongPressOrCancellation$2) create(awaitPointerEventScope, dVar)).invokeSuspend(I.f6487a);
    }
