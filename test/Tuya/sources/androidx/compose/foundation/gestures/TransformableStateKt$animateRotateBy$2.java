...
final class TransformableStateKt$animateRotateBy$2 extends l implements n {
    ...
    public static final class AnonymousClass1 extends AbstractC3160z implements Function1 {
        ...
        public final void invoke(AnimationScope<Float, AnimationVector1D> animateTo) {
            ...
            d.a(this.$$this$transform, 0.0f, 0L, animateTo.getValue().floatValue() - this.$previous.f33758a, 3, null);
            this.$previous.f33758a = animateTo.getValue().floatValue();
        }
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public TransformableStateKt$animateRotateBy$2(P p8, float f8, AnimationSpec<Float> animationSpec, P5.d dVar) {
        super(2, dVar);
        this.$previous = p8;
        this.$degrees = f8;
    ...
    public final Object invoke(TransformScope transformScope, P5.d dVar) {
        return ((TransformableStateKt$animateRotateBy$2) create(transformScope, dVar)).invokeSuspend(I.f6487a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i8 != 0) {
            ...
            AnimationState AnimationState$default = AnimationStateKt.AnimationState$default(this.$previous.f33758a, 0.0f, 0L, 0L, false, 30, null);
