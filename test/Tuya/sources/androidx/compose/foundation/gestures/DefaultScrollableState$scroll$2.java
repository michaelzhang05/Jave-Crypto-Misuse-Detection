...
final class DefaultScrollableState$scroll$2 extends l implements n {
    ...
    public static final class AnonymousClass1 extends l implements n {
        ...
        AnonymousClass1(DefaultScrollableState defaultScrollableState, n nVar, P5.d dVar) {
            super(2, dVar);
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            try {
                if (i8 != 0) {
                    ...
                    n nVar = this.$block;
                    this.label = 1;
                    if (nVar.invoke(scrollScope, this) == e8) {
                        return e8;
                    }
                }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public DefaultScrollableState$scroll$2(DefaultScrollableState defaultScrollableState, MutatePriority mutatePriority, n nVar, P5.d dVar) {
        super(2, dVar);
        this.this$0 = defaultScrollableState;
    ...
    public final Object invoke(M m8, P5.d dVar) {
        return ((DefaultScrollableState$scroll$2) create(m8, dVar)).invokeSuspend(I.f6487a);
    }
