...
public final class TransformableKt {
    ...
    */
    public static final java.lang.Object detectZoom(androidx.compose.ui.input.pointer.AwaitPointerEventScope r29, androidx.compose.runtime.State<java.lang.Boolean> r30, k6.d r31, androidx.compose.runtime.State<? extends kotlin.jvm.functions.Function0> r32, P5.d r33) {
        /*
            Method dump skipped, instructions count: 738
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.gestures.TransformableKt.detectZoom(androidx.compose.ui.input.pointer.AwaitPointerEventScope, androidx.compose.runtime.State, k6.d, androidx.compose.runtime.State, P5.d):java.lang.Object");
    }
    ...
    public static final Modifier transformable(Modifier modifier, TransformableState state, Function0 canPan, boolean z8, boolean z9) {
        AbstractC3159y.i(modifier, "<this>");
        AbstractC3159y.i(state, "state");
        AbstractC3159y.i(canPan, "canPan");
