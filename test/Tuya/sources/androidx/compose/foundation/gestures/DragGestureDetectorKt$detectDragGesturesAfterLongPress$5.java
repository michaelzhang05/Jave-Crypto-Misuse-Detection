...
public final class DragGestureDetectorKt$detectDragGesturesAfterLongPress$5 extends k implements n {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public DragGestureDetectorKt$detectDragGesturesAfterLongPress$5(Function1 function1, Function0 function0, Function0 function02, n nVar, P5.d dVar) {
        super(2, dVar);
    ...
    public final Object invoke(AwaitPointerEventScope awaitPointerEventScope, P5.d dVar) {
        return ((DragGestureDetectorKt$detectDragGesturesAfterLongPress$5) create(awaitPointerEventScope, dVar)).invokeSuspend(I.f6487a);
    }
    ...
    */
    public final java.lang.Object invokeSuspend(java.lang.Object r12) {
        /*
            ...
            L5.t.b(r12)     // Catch: java.util.concurrent.CancellationException -> L19
            goto L86
        L19:
            r12 = move-exception
            goto Lbd
        ...
        L4d:
            ...
            long r4 = r12.m4014getIdJ3iCeTQ()     // Catch: java.util.concurrent.CancellationException -> L19
            r11.L$0 = r1     // Catch: java.util.concurrent.CancellationException -> L19
            r11.label = r3     // Catch: java.util.concurrent.CancellationException -> L19
            java.lang.Object r12 = androidx.compose.foundation.gestures.DragGestureDetectorKt.m388awaitLongPressOrCancellationrnUCldI(r1, r4, r11)     // Catch: java.util.concurrent.CancellationException -> L19
            if (r12 != r0) goto L5e
            return r0
        L5e:
            androidx.compose.ui.input.pointer.PointerInputChange r12 = (androidx.compose.ui.input.pointer.PointerInputChange) r12     // Catch: java.util.concurrent.CancellationException -> L19
            ...
            long r4 = r12.m4016getPositionF1C5BW0()     // Catch: java.util.concurrent.CancellationException -> L19
            androidx.compose.ui.geometry.Offset r4 = androidx.compose.ui.geometry.Offset.m2724boximpl(r4)     // Catch: java.util.concurrent.CancellationException -> L19
            r3.invoke(r4)     // Catch: java.util.concurrent.CancellationException -> L19
            long r3 = r12.m4014getIdJ3iCeTQ()     // Catch: java.util.concurrent.CancellationException -> L19
            ...
            X5.n r5 = r11.$onDrag     // Catch: java.util.concurrent.CancellationException -> L19
            ...
            java.lang.Object r12 = androidx.compose.foundation.gestures.DragGestureDetectorKt.m398dragjO51t88(r1, r3, r12, r11)     // Catch: java.util.concurrent.CancellationException -> L19
            if (r12 != r0) goto L85
            return r0
        L85:
            r0 = r1
