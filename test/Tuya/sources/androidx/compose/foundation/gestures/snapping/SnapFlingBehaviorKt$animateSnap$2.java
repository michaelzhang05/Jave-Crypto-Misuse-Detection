...
public final class SnapFlingBehaviorKt$animateSnap$2 extends AbstractC3160z implements Function1 {
    ...
    public final void invoke(AnimationScope<Float, AnimationVector1D> animateTo) {
        ...
        float f8 = coerceToTarget - this.$consumedUpToNow.f33758a;
        ...
        this.$consumedUpToNow.f33758a += scrollBy;
    }
}
