...
final class TransformableStateKt$animateZoomBy$3 extends l implements n {
    ...
    public static final class AnonymousClass1 extends AbstractC3160z implements Function1 {
        ...
        public final void invoke(AnimationScope<Float, AnimationVector1D> animateTo) {
            ...
            d.a(this.$$this$transform, this.$previous.f33758a == 0.0f ? 1.0f : animateTo.getValue().floatValue() / this.$previous.f33758a, 0L, 0.0f, 6, null);
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public TransformableStateKt$animateZoomBy$3(P p8, float f8, AnimationSpec<Float> animationSpec, P5.d dVar) {
        super(2, dVar);
        this.$previous = p8;
        this.$zoomFactor = f8;
    ...
    public final Object invoke(TransformScope transformScope, P5.d dVar) {
        return ((TransformableStateKt$animateZoomBy$3) create(transformScope, dVar)).invokeSuspend(I.f6487a);
    }
