...
final class AbstractClickableNode$onKeyEvent$2$1 extends l implements n {
    ...
    public final Object invoke(M m8, d dVar) {
        return ((AbstractClickableNode$onKeyEvent$2$1) create(m8, dVar)).invokeSuspend(I.f6487a);
    }
