...
public final class PressInteractionKt {
    @Composable
    public static final State<Boolean> collectIsPressedAsState(InteractionSource interactionSource, Composer composer, int i8) {
        AbstractC3159y.i(interactionSource, "<this>");
        composer.startReplaceableGroup(-1692965168);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1692965168, i8, -1, "androidx.compose.foundation.interaction.collectIsPressedAsState (PressInteraction.kt:83)");
        }
