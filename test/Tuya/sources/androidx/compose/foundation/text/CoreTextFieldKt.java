...
public final class CoreTextFieldKt {
    ...
    */
    ...
    public static final void CoreTextFieldRootBox(Modifier modifier, TextFieldSelectionManager textFieldSelectionManager, n nVar, Composer composer, int i8) {
        ...
        nVar.invoke(startRestartGroup, Integer.valueOf(((((i8 >> 3) & 112) | 8) >> 3) & 14));
        ...
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new CoreTextFieldKt$CoreTextFieldRootBox$2(modifier, textFieldSelectionManager, nVar, i8));
        }
    }
    ...
    public static final void SelectionToolbarAndHandles(TextFieldSelectionManager textFieldSelectionManager, boolean z8, Composer composer, int i8) {
        ...
        if (z8) {
            ...
            if (textLayoutResult != null) {
                if (!TextRange.m4686getCollapsedimpl(textFieldSelectionManager.getValue$foundation_release().m4929getSelectiond9O1mEE())) {
                    int originalToTransformed = textFieldSelectionManager.getOffsetMapping$foundation_release().originalToTransformed(TextRange.m4692getStartimpl(textFieldSelectionManager.getValue$foundation_release().m4929getSelectiond9O1mEE()));
                    int originalToTransformed2 = textFieldSelectionManager.getOffsetMapping$foundation_release().originalToTransformed(TextRange.m4687getEndimpl(textFieldSelectionManager.getValue$foundation_release().m4929getSelectiond9O1mEE()));
    ...
    public static final void TextFieldCursorHandle(TextFieldSelectionManager manager, Composer composer, int i8) {
        ...
        if (state$foundation_release != null && state$foundation_release.getShowCursorHandle()) {
            ...
            long m1083getCursorPositiontuRUvjQ$foundation_release = manager.m1083getCursorPositiontuRUvjQ$foundation_release((Density) startRestartGroup.consume(CompositionLocalsKt.getLocalDensity()));
            ...
            Offset m2724boximpl = Offset.m2724boximpl(m1083getCursorPositiontuRUvjQ$foundation_release);
            startRestartGroup.startReplaceableGroup(1157296644);
            boolean changed2 = startRestartGroup.changed(m2724boximpl);
            Object rememberedValue2 = startRestartGroup.rememberedValue();
            if (changed2 || rememberedValue2 == Composer.Companion.getEmpty()) {
                rememberedValue2 = new CoreTextFieldKt$TextFieldCursorHandle$2$1(m1083getCursorPositiontuRUvjQ$foundation_release);
                startRestartGroup.updateRememberedValue(rememberedValue2);
            }
            startRestartGroup.endReplaceableGroup();
            AndroidCursorHandle_androidKt.m855CursorHandleULxng0E(m1083getCursorPositiontuRUvjQ$foundation_release, SemanticsModifierKt.semantics$default(pointerInput, false, (Function1) rememberedValue2, 1, null), null, startRestartGroup, 384);
        }
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
    ...
    public static final Object bringSelectionEndIntoView(BringIntoViewRequester bringIntoViewRequester, TextFieldValue textFieldValue, TextDelegate textDelegate, TextLayoutResult textLayoutResult, OffsetMapping offsetMapping, d dVar) {
        Rect rect;
        int originalToTransformed = offsetMapping.originalToTransformed(TextRange.m4689getMaximpl(textFieldValue.m4929getSelectiond9O1mEE()));
