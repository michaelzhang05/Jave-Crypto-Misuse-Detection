...
public final class BasicTextKt$BasicText$5 extends AbstractC3160z implements n {
    ...
    public final void invoke(Composer composer, int i8) {
        BasicTextKt.m860BasicTextRWo7tUw(this.$text, this.$modifier, this.$style, this.$onTextLayout, this.$overflow, this.$softWrap, this.$maxLines, this.$minLines, this.$inlineContent, this.$color, composer, RecomposeScopeImplKt.updateChangedFlags(this.$$changed | 1), this.$$default);
    }
}
