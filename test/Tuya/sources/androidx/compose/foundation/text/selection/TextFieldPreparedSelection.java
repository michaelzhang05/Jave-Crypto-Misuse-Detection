...
public final class TextFieldPreparedSelection extends BaseTextPreparedSelection<TextFieldPreparedSelection> {
    ...
    public /* synthetic */ TextFieldPreparedSelection(TextFieldValue textFieldValue, OffsetMapping offsetMapping, TextLayoutResultProxy textLayoutResultProxy, TextPreparedSelectionState textPreparedSelectionState, int i8, AbstractC3151p abstractC3151p) {
    ...
    */
    private final int jumpByPagesOffset(androidx.compose.foundation.text.TextLayoutResultProxy r6, int r7) {
        ...
        L1b:
            ...
            long r3 = r1.m4929getSelectiond9O1mEE()
            int r1 = androidx.compose.ui.text.TextRange.m4687getEndimpl(r3)
            ...
            float r1 = r0.getLeft()
            float r0 = r0.getTop()
            long r2 = r2.m2768getSizeNHjbRc()
            float r2 = androidx.compose.ui.geometry.Size.m2801getHeightimpl(r2)
            float r7 = (float) r7
            float r2 = r2 * r7
            float r0 = r0 + r2
            ...
            int r6 = r6.m4664getOffsetForPositionk4lQ0M(r0)
    ...
    public final List<EditCommand> deleteIfSelectedOr(Function1 or) {
        ...
        if (TextRange.m4686getCollapsedimpl(m1008getSelectiond9O1mEE())) {
            EditCommand editCommand = (EditCommand) or.invoke(this);
            if (editCommand != null) {
                return AbstractC1246t.e(editCommand);
            }
            return null;
        }
        return AbstractC1246t.p(new CommitTextCommand("", 0), new SetSelectionCommand(TextRange.m4690getMinimpl(m1008getSelectiond9O1mEE()), TextRange.m4690getMinimpl(m1008getSelectiond9O1mEE())));
    }
    ...
    public final TextFieldValue getValue() {
        return TextFieldValue.m4924copy3r_uNRQ$default(this.currentValue, getAnnotatedString(), m1008getSelectiond9O1mEE(), (TextRange) null, 4, (Object) null);
    }
    ...
    public TextFieldPreparedSelection(TextFieldValue currentValue, OffsetMapping offsetMapping, TextLayoutResultProxy textLayoutResultProxy, TextPreparedSelectionState state) {
        super(currentValue.getAnnotatedString(), currentValue.m4929getSelectiond9O1mEE(), textLayoutResultProxy != null ? textLayoutResultProxy.getValue() : null, offsetMapping, state, null);
