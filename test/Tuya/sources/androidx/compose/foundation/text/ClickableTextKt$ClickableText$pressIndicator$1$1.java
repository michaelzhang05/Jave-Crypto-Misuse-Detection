...
final class ClickableTextKt$ClickableText$pressIndicator$1$1 extends l implements n {
    ...
    public static final class AnonymousClass1 extends AbstractC3160z implements Function1 {
        ...
        public /* bridge */ /* synthetic */ Object invoke(Object obj) {
            m869invokek4lQ0M(((Offset) obj).m2745unboximpl());
            return I.f6487a;
        }

        /* renamed from: invoke-k-4lQ0M, reason: not valid java name */
        public final void m869invokek4lQ0M(long j8) {
            TextLayoutResult value = this.$layoutResult.getValue();
            if (value != null) {
                this.$onClick.invoke(Integer.valueOf(value.m4664getOffsetForPositionk4lQ0M(j8)));
            }
        }
    }
    ...
    public final Object invoke(PointerInputScope pointerInputScope, d dVar) {
        return ((ClickableTextKt$ClickableText$pressIndicator$1$1) create(pointerInputScope, dVar)).invokeSuspend(I.f6487a);
    }
