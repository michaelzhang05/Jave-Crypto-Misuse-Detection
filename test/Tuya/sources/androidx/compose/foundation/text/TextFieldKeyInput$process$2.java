...
public final class TextFieldKeyInput$process$2 extends AbstractC3160z implements Function1 {
    final /* synthetic */ KeyCommand $command;
    final /* synthetic */ O $consumed;
    ...
    public static final class AnonymousClass1 extends AbstractC3160z implements Function1 {
        ...
        public final void invoke(TextFieldPreparedSelection collapseLeftOr) {
            AbstractC3159y.i(collapseLeftOr, "$this$collapseLeftOr");
    ...
    public static final class AnonymousClass2 extends AbstractC3160z implements Function1 {
        ...
        public final void invoke(TextFieldPreparedSelection collapseRightOr) {
            AbstractC3159y.i(collapseRightOr, "$this$collapseRightOr");
    ...
    public static final class AnonymousClass3 extends AbstractC3160z implements Function1 {
        ...
        public final EditCommand invoke(TextFieldPreparedSelection deleteIfSelectedOr) {
            AbstractC3159y.i(deleteIfSelectedOr, "$this$deleteIfSelectedOr");
            return new DeleteSurroundingTextCommand(TextRange.m4687getEndimpl(deleteIfSelectedOr.m1008getSelectiond9O1mEE()) - deleteIfSelectedOr.getPrecedingCharacterIndex(), 0);
        }
    }
    ...
    public static final class AnonymousClass4 extends AbstractC3160z implements Function1 {
        ...
        public final EditCommand invoke(TextFieldPreparedSelection deleteIfSelectedOr) {
            ...
            if (nextCharacterIndex != -1) {
                return new DeleteSurroundingTextCommand(0, nextCharacterIndex - TextRange.m4687getEndimpl(deleteIfSelectedOr.m1008getSelectiond9O1mEE()));
            }
            return null;
        }
    }
    ...
    public static final class AnonymousClass5 extends AbstractC3160z implements Function1 {
        ...
        public final EditCommand invoke(TextFieldPreparedSelection deleteIfSelectedOr) {
            ...
            return new DeleteSurroundingTextCommand(TextRange.m4687getEndimpl(deleteIfSelectedOr.m1008getSelectiond9O1mEE()) - previousWordOffset.intValue(), 0);
        }
    }
    ...
    /* loaded from: classes.dex */
    public static final class AnonymousClass6 extends AbstractC3160z implements Function1 {
        ...
        public final EditCommand invoke(TextFieldPreparedSelection deleteIfSelectedOr) {
            ...
            if (nextWordOffset != null) {
                return new DeleteSurroundingTextCommand(0, nextWordOffset.intValue() - TextRange.m4687getEndimpl(deleteIfSelectedOr.m1008getSelectiond9O1mEE()));
            }
            return null;
        }
    }
    ...
    /* loaded from: classes.dex */
    public static final class AnonymousClass7 extends AbstractC3160z implements Function1 {
        ...
        public final EditCommand invoke(TextFieldPreparedSelection deleteIfSelectedOr) {
            ...
            return new DeleteSurroundingTextCommand(TextRange.m4687getEndimpl(deleteIfSelectedOr.m1008getSelectiond9O1mEE()) - lineStartByOffset.intValue(), 0);
        }
    }
    ...
    /* loaded from: classes.dex */
    public static final class AnonymousClass8 extends AbstractC3160z implements Function1 {
        ...
        public final EditCommand invoke(TextFieldPreparedSelection deleteIfSelectedOr) {
            ...
            if (lineEndByOffset != null) {
                return new DeleteSurroundingTextCommand(0, lineEndByOffset.intValue() - TextRange.m4687getEndimpl(deleteIfSelectedOr.m1008getSelectiond9O1mEE()));
            }
            return null;
        }
    }
    ...
    public TextFieldKeyInput$process$2(KeyCommand keyCommand, TextFieldKeyInput textFieldKeyInput, O o8) {
        super(1);
    ...
    public final void invoke(TextFieldPreparedSelection commandExecutionContext) {
        ...
        AbstractC3159y.i(commandExecutionContext, "$this$commandExecutionContext");
        switch (WhenMappings.$EnumSwitchMapping$0[this.$command.ordinal()]) {
            ...
            case 26:
                ...
                Function1 onImeActionPerformed = this.this$0.getState().getOnImeActionPerformed();
                i8 = this.this$0.imeAction;
                onImeActionPerformed.invoke(ImeAction.m4852boximpl(i8));
                return;
            case 27:
                if (!this.this$0.getSingleLine()) {
