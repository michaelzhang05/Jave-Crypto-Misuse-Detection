...
public final class CoreTextFieldKt$CoreTextField$focusModifier$1 extends AbstractC3160z implements Function1 {
    ...
    public final void invoke(FocusState it) {
        ...
        if (this.$textInputService != null) {
            ...
            if (it.isFocused() && (layoutResult = this.$state.getLayoutResult()) != null) {
                AbstractC2829k.d(this.$coroutineScope, null, null, new CoreTextFieldKt$CoreTextField$focusModifier$1$1$1(this.$bringIntoViewRequester, this.$value, this.$state, layoutResult, this.$offsetMapping, null), 3, null);
            }
        }
        if (it.isFocused()) {
            return;
