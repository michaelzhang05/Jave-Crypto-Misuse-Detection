...
public final class PagerStateKt {
    ...
    private static final float DefaultPositionThreshold = Dp.m5178constructorimpl(56);
    private static final PagerLayoutInfo EmptyLayoutInfo = new PagerLayoutInfo() { // from class: androidx.compose.foundation.pager.PagerStateKt$EmptyLayoutInfo$1
        ...
        private final List<PageInfo> visiblePagesInfo = AbstractC1246t.m();
        private final long viewportSize = IntSize.Companion.m5349getZeroYbymL2g();
    ...
    public static final Object animateToNextPage(PagerState pagerState, d dVar) {
        if (pagerState.getCurrentPage() + 1 < pagerState.getPageCount()) {
            ...
            if (animateScrollToPage$default == Q5.b.e()) {
    ...
    public static final PagerState rememberPagerState(int i8, float f8, Function0 pageCount, Composer composer, int i9, int i10) {
        AbstractC3159y.i(pageCount, "pageCount");
        ...
        PagerStateImpl pagerStateImpl = (PagerStateImpl) RememberSaveableKt.m2583rememberSaveable(objArr, (Saver) saver, (String) null, (Function0) rememberedValue, composer, 72, 4);
