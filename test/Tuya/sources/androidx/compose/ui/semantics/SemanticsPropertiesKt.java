...
public final class SemanticsPropertiesKt {
    ...
    private static final <T extends InterfaceC1223g> SemanticsPropertyKey<AccessibilityAction<T>> ActionPropertyKey(String str) {
    ...
    public static final void dialog(SemanticsPropertyReceiver semanticsPropertyReceiver) {
        semanticsPropertyReceiver.set(SemanticsProperties.INSTANCE.getIsDialog(), I.f6487a);
    }

    public static final void disabled(SemanticsPropertyReceiver semanticsPropertyReceiver) {
        semanticsPropertyReceiver.set(SemanticsProperties.INSTANCE.getDisabled(), I.f6487a);
    }
    ...
    public static final int getImeAction(SemanticsPropertyReceiver semanticsPropertyReceiver) {
        return SemanticsProperties.INSTANCE.getImeAction().getValue(semanticsPropertyReceiver, $$delegatedProperties[16]).m4858unboximpl();
    }
    ...
    public static final int getLiveRegion(SemanticsPropertyReceiver semanticsPropertyReceiver) {
        return SemanticsProperties.INSTANCE.getLiveRegion().getValue(semanticsPropertyReceiver, $$delegatedProperties[3]).m4513unboximpl();
    }
    ...
    public static final int getRole(SemanticsPropertyReceiver semanticsPropertyReceiver) {
        return SemanticsProperties.INSTANCE.getRole().getValue(semanticsPropertyReceiver, $$delegatedProperties[10]).m4522unboximpl();
    }
    ...
    public static final long getTextSelectionRange(SemanticsPropertyReceiver semanticsPropertyReceiver) {
        return SemanticsProperties.INSTANCE.getTextSelectionRange().getValue(semanticsPropertyReceiver, $$delegatedProperties[15]).m4696unboximpl();
    }
    ...
    public static final void heading(SemanticsPropertyReceiver semanticsPropertyReceiver) {
        semanticsPropertyReceiver.set(SemanticsProperties.INSTANCE.getHeading(), I.f6487a);
    }
    ...
    public static final void invisibleToUser(SemanticsPropertyReceiver semanticsPropertyReceiver) {
        semanticsPropertyReceiver.set(SemanticsProperties.INSTANCE.getInvisibleToUser(), I.f6487a);
    }
    ...
    public static final void m4535onImeAction9UiTYpY(SemanticsPropertyReceiver semanticsPropertyReceiver, int i8, String str, Function0 function0) {
        semanticsPropertyReceiver.set(SemanticsProperties.INSTANCE.getImeAction(), ImeAction.m4852boximpl(i8));
    ...
    public static /* synthetic */ void m4536onImeAction9UiTYpY$default(SemanticsPropertyReceiver semanticsPropertyReceiver, int i8, String str, Function0 function0, int i9, Object obj) {
        if ((i9 & 2) != 0) {
            str = null;
        }
        m4535onImeAction9UiTYpY(semanticsPropertyReceiver, i8, str, function0);
    }
    ...
    public static final void password(SemanticsPropertyReceiver semanticsPropertyReceiver) {
        semanticsPropertyReceiver.set(SemanticsProperties.INSTANCE.getPassword(), I.f6487a);
    }
    ...
    public static final void popup(SemanticsPropertyReceiver semanticsPropertyReceiver) {
        semanticsPropertyReceiver.set(SemanticsProperties.INSTANCE.getIsPopup(), I.f6487a);
    }
    ...
    public static final void scrollBy(SemanticsPropertyReceiver semanticsPropertyReceiver, String str, n nVar) {
        semanticsPropertyReceiver.set(SemanticsActions.INSTANCE.getScrollBy(), new AccessibilityAction(str, nVar));
    }

    public static /* synthetic */ void scrollBy$default(SemanticsPropertyReceiver semanticsPropertyReceiver, String str, n nVar, int i8, Object obj) {
        if ((i8 & 1) != 0) {
            str = null;
        }
    ...
    public static final void selectableGroup(SemanticsPropertyReceiver semanticsPropertyReceiver) {
        semanticsPropertyReceiver.set(SemanticsProperties.INSTANCE.getSelectableGroup(), I.f6487a);
    }
    ...
    public static final void setContentDescription(SemanticsPropertyReceiver semanticsPropertyReceiver, String str) {
        semanticsPropertyReceiver.set(SemanticsProperties.INSTANCE.getContentDescription(), AbstractC1246t.e(str));
    }
    ...
    public static final void m4537setImeAction4L7nppU(SemanticsPropertyReceiver semanticsPropertyReceiver, int i8) {
        SemanticsProperties.INSTANCE.getImeAction().setValue(semanticsPropertyReceiver, $$delegatedProperties[16], ImeAction.m4852boximpl(i8));
    }

    /* renamed from: setLiveRegion-hR3wRGc, reason: not valid java name */
    public static final void m4538setLiveRegionhR3wRGc(SemanticsPropertyReceiver semanticsPropertyReceiver, int i8) {
        SemanticsProperties.INSTANCE.getLiveRegion().setValue(semanticsPropertyReceiver, $$delegatedProperties[3], LiveRegionMode.m4507boximpl(i8));
    }
    ...
    public static final void m4539setRolekuIjeqM(SemanticsPropertyReceiver semanticsPropertyReceiver, int i8) {
        SemanticsProperties.INSTANCE.getRole().setValue(semanticsPropertyReceiver, $$delegatedProperties[10], Role.m4516boximpl(i8));
    }
    ...
    public static final void setSelection(SemanticsPropertyReceiver semanticsPropertyReceiver, String str, o oVar) {
        semanticsPropertyReceiver.set(SemanticsActions.INSTANCE.getSetSelection(), new AccessibilityAction(str, oVar));
    }

    public static /* synthetic */ void setSelection$default(SemanticsPropertyReceiver semanticsPropertyReceiver, String str, o oVar, int i8, Object obj) {
        if ((i8 & 1) != 0) {
            str = null;
        }
    ...
    public static final void setText(SemanticsPropertyReceiver semanticsPropertyReceiver, AnnotatedString annotatedString) {
        semanticsPropertyReceiver.set(SemanticsProperties.INSTANCE.getText(), AbstractC1246t.e(annotatedString));
    }
    ...
    public static final void m4540setTextSelectionRangeFDrldGo(SemanticsPropertyReceiver semanticsPropertyReceiver, long j8) {
        SemanticsProperties.INSTANCE.getTextSelectionRange().setValue(semanticsPropertyReceiver, $$delegatedProperties[15], TextRange.m4680boximpl(j8));
    }
    ...
    public static final <T> SemanticsPropertyKey<T> AccessibilityKey(String str, n nVar) {
