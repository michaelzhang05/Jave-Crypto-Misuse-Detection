...
public final class ShadowKt$shadows4CzXII$$inlined$debugInspectorInfo$1 extends AbstractC3160z implements Function1 {
    ...
    public final void invoke(InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set("elevation", Dp.m5176boximpl(this.$elevation$inlined));
        ...
        inspectorInfo.getProperties().set("ambientColor", Color.m2961boximpl(this.$ambientColor$inlined));
        inspectorInfo.getProperties().set("spotColor", Color.m2961boximpl(this.$spotColor$inlined));
    }
}
