...
public final class FocusInvalidationManager$invalidateNodes$1 extends AbstractC3160z implements Function0 {
            ...
            if (!it.hasNext()) {
                ...
                for (FocusEventModifierNode focusEventModifierNode : set3) {
                    if (!focusEventModifierNode.getNode().isAttached()) {
                        ...
                        int m4343constructorimpl = NodeKind.m4343constructorimpl(i8);
                                    ...
                                    while (node2 != null) {
                                        if ((node2.getKindSet$ui_release() & m4343constructorimpl) != 0) {
                                            ...
                                            while (node2 != null) {
                                                ...
                                                } else if ((node2.getKindSet$ui_release() & m4343constructorimpl) != 0 && (node2 instanceof DelegatingNode)) {
                                                    Modifier.Node delegate$ui_release2 = ((DelegatingNode) node2).getDelegate$ui_release();
                                                    int i13 = 0;
                                                    while (delegate$ui_release2 != null) {
                                                        if ((delegate$ui_release2.getKindSet$ui_release() & m4343constructorimpl) != 0) {
                                                            i13++;
                                                            if (i13 == 1) {
            ...
            if (focusPropertiesModifierNode.getNode().isAttached()) {
                ...
                if (focusPropertiesModifierNode.getNode().isAttached()) {
                    ...
                    while (mutableVector5.isNotEmpty()) {
                        ...
                        if ((node4.getAggregateChildKindSet$ui_release() & m4343constructorimpl2) == 0) {
                            ...
                            while (true) {
                                ...
                                if ((node4.getKindSet$ui_release() & m4343constructorimpl2) != 0) {
                                    MutableVector mutableVector6 = null;
                                    while (node4 != null) {
                                        if (node4 instanceof FocusTargetNode) {
                                            set12 = focusInvalidationManager.focusTargetNodes;
                                            set12.add((FocusTargetNode) node4);
                                        } else if ((node4.getKindSet$ui_release() & m4343constructorimpl2) != 0 && (node4 instanceof DelegatingNode)) {
                                            int i15 = 0;
