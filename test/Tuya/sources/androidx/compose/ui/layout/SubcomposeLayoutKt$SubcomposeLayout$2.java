...
public final class SubcomposeLayoutKt$SubcomposeLayout$2 extends AbstractC3160z implements X5.n {
    ...
    public SubcomposeLayoutKt$SubcomposeLayout$2(Modifier modifier, X5.n nVar, int i8, int i9) {
        super(2);
