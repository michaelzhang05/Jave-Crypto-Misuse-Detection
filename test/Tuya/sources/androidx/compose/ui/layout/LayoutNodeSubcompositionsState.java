...
public final class LayoutNodeSubcompositionsState implements ComposeNodeLifecycleCallback {
    ...
    public final class PostLookaheadMeasureScopeImpl implements SubcomposeMeasureScope, MeasureScope {
        ...
        public List<Measurable> subcompose(Object obj, X5.n nVar) {
            ...
            if (list == null) {
                return LayoutNodeSubcompositionsState.this.postLookaheadSubcompose(obj, nVar);
            }
            return list;
        }
    ...
    public final class Scope implements SubcomposeMeasureScope {
        ...
        @Override // androidx.compose.ui.layout.SubcomposeMeasureScope
        public List<Measurable> subcompose(Object obj, X5.n nVar) {
            return LayoutNodeSubcompositionsState.this.subcompose(obj, nVar);
        }
    ...
    public final void disposeUnusedSlotsInPostLookahead() {
        AbstractC1246t.I(this.postLookaheadPrecomposeSlotHandleMap.entrySet(), new LayoutNodeSubcompositionsState$disposeUnusedSlotsInPostLookahead$1(this));
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public final List<Measurable> postLookaheadSubcompose(Object obj, X5.n nVar) {
        if (this.postLookaheadComposedSlotIds.getSize() >= this.currentPostLookaheadIndex) {
            ...
            if (!this.precomposeMap.containsKey(obj)) {
                this.postLookaheadPrecomposeSlotHandleMap.put(obj, precompose(obj, nVar));
    ...
    private final ReusableComposition subcomposeInto(ReusableComposition reusableComposition, LayoutNode layoutNode, boolean z8, CompositionContext compositionContext, X5.n nVar) {
        ...
        if (!z8) {
            reusableComposition.setContent(nVar);
        } else {
            reusableComposition.setContentWithReuse(nVar);
        }
    ...
    private final LayoutNode takeNodeFromReusables(Object obj) {
        ...
        while (true) {
            if (i11 >= i9) {
                if (AbstractC3159y.d(getSlotIdAtIndex(i11), obj)) {
                    i8 = i11;
                    break;
                }
                i11--;
    ...
    public final MeasurePolicy createMeasurePolicy(final X5.n nVar) {
        ...
        return new LayoutNode.NoIntrinsicsMeasurePolicy(str) { // from class: androidx.compose.ui.layout.LayoutNodeSubcompositionsState$createMeasurePolicy$1
            ...
            public MeasureResult mo132measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j8) {
                ...
                if (measureScope.isLookingAhead() || LayoutNodeSubcompositionsState.this.root.getLookaheadRoot$ui_release() == null) {
                    ...
                    final MeasureResult measureResult = (MeasureResult) nVar.invoke(LayoutNodeSubcompositionsState.this.scope, Constraints.m5134boximpl(j8));
                ...
                final MeasureResult measureResult2 = (MeasureResult) nVar2.invoke(postLookaheadMeasureScopeImpl, Constraints.m5134boximpl(j8));
    ...
    public final SubcomposeLayoutState.PrecomposedSlotHandle precompose(final Object obj, X5.n nVar) {
        if (!this.root.isAttached()) {
            return new SubcomposeLayoutState.PrecomposedSlotHandle() { // from class: androidx.compose.ui.layout.LayoutNodeSubcompositionsState$precompose$1
                ...
                public /* synthetic */ void mo4147premeasure0kLqBqw(int i8, long j8) {
                    o.b(this, i8, j8);
                }
            };
        }
        ...
        if (!this.slotIdToNode.containsKey(obj)) {
            ...
            subcompose(layoutNode, obj, nVar);
        }
        return new SubcomposeLayoutState.PrecomposedSlotHandle() { // from class: androidx.compose.ui.layout.LayoutNodeSubcompositionsState$precompose$2
            ...
            public void mo4147premeasure0kLqBqw(int i8, long j8) {
                HashMap hashMap2;
                hashMap2 = LayoutNodeSubcompositionsState.this.precomposeMap;
                LayoutNode layoutNode2 = (LayoutNode) hashMap2.get(obj);
                if (layoutNode2 != null && layoutNode2.isAttached()) {
                    ...
                    if (i8 >= 0 && i8 < size) {
                        if (!layoutNode2.isPlaced()) {
                            ...
                            LayoutNodeKt.requireOwner(layoutNode2).mo4399measureAndLayout0kLqBqw(layoutNode2.getChildren$ui_release().get(i8), j8);
    ...
    public final List<Measurable> subcompose(Object obj, X5.n nVar) {
        makeSureStateIsConsistent();
        ...
        if (AbstractC1246t.p0(this.root.getFoldedChildren$ui_release(), this.currentIndex) != layoutNode2) {
        ...
        this.currentIndex++;
        subcompose(layoutNode2, obj, nVar);
    ...
    public static final class NodeState {
        ...
        private X5.n content;
        private boolean forceRecompose;
        private boolean forceReuse;
        private Object slotId;

        public NodeState(Object obj, X5.n nVar, ReusableComposition reusableComposition) {
            this.slotId = obj;
            this.content = nVar;
        ...
        public /* synthetic */ NodeState(Object obj, X5.n nVar, ReusableComposition reusableComposition, int i8, AbstractC3151p abstractC3151p) {
            this(obj, nVar, (i8 & 4) != 0 ? null : reusableComposition);
        }
    }

    private final void subcompose(LayoutNode layoutNode, Object obj, X5.n nVar) {
        HashMap<LayoutNode, NodeState> hashMap = this.nodeToNodeState;
        NodeState nodeState = hashMap.get(layoutNode);
        if (nodeState == null) {
            nodeState = new NodeState(obj, ComposableSingletons$SubcomposeLayoutKt.INSTANCE.m4121getLambda1$ui_release(), null, 4, null);
            hashMap.put(layoutNode, nodeState);
        }
        NodeState nodeState2 = nodeState;
        ReusableComposition composition = nodeState2.getComposition();
        boolean hasInvalidations = composition != null ? composition.getHasInvalidations() : true;
        if (nodeState2.getContent() != nVar || hasInvalidations || nodeState2.getForceRecompose()) {
            nodeState2.setContent(nVar);
    ...
    private final void subcompose(LayoutNode layoutNode, NodeState nodeState) {
        ...
        try {
            ...
            try {
                LayoutNode layoutNode2 = this.root;
                LayoutNode.access$setIgnoreRemeasureRequests$p(layoutNode2, true);
                X5.n content = nodeState.getContent();
                ReusableComposition composition = nodeState.getComposition();
