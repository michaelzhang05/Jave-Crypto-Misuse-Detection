...
public final class Rgb extends ColorSpace {
    ...
    public static final class Companion {
        ...
        public final float[] xyPrimaries(float[] fArr) {
            ...
            if (fArr.length == 9) {
                ...
                AbstractC1239l.k(fArr, fArr2, 0, 0, 6, 6, null);
            }
            return fArr2;
        }
    ...
    public Rgb(String str, float[] fArr, WhitePoint whitePoint, float[] fArr2, DoubleFunction doubleFunction, DoubleFunction doubleFunction2, float f8, float f9, TransferParameters transferParameters, int i8) {
        super(str, ColorModel.Companion.m3362getRgbxdoWZVw(), i8, null);
    ...
    public static final double eotfFunc$lambda$1(Rgb rgb, double d8) {
        return rgb.eotfOrig.invoke(d6.m.i(d8, rgb.min, rgb.max));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final double oetfFunc$lambda$0(Rgb rgb, double d8) {
        return d6.m.i(rgb.oetfOrig.invoke(d8), rgb.min, rgb.max);
    }
    ...
    public boolean equals(Object obj) {
        ...
        Rgb rgb = (Rgb) obj;
        if (Float.compare(rgb.min, this.min) != 0 || Float.compare(rgb.max, this.max) != 0 || !AbstractC3159y.d(this.whitePoint, rgb.whitePoint) || !Arrays.equals(this.primaries, rgb.primaries)) {
            return false;
        }
        TransferParameters transferParameters = this.transferParameters;
        if (transferParameters != null) {
            return AbstractC3159y.d(transferParameters, rgb.transferParameters);
        }
        if (rgb.transferParameters == null) {
            return true;
        }
        if (!AbstractC3159y.d(this.oetfOrig, rgb.oetfOrig)) {
            return false;
        }
        return AbstractC3159y.d(this.eotfOrig, rgb.eotfOrig);
    }
    ...
    public final float[] getInverseTransform(@Size(min = 9) float[] fArr) {
        return AbstractC1239l.k(this.inverseTransform, fArr, 0, 0, 0, 14, null);
    }

    @Size(min = 6)
    public final float[] getPrimaries(@Size(min = 6) float[] fArr) {
        return AbstractC1239l.k(this.primaries, fArr, 0, 0, 0, 14, null);
    }

    @Size(min = 9)
    public final float[] getTransform(@Size(min = 9) float[] fArr) {
        return AbstractC1239l.k(this.transform, fArr, 0, 0, 0, 14, null);
    }
