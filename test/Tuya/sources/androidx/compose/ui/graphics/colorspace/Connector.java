...
public class Connector {
    ...
    public static final class Companion {
        ...
        public final float[] m3371computeTransformYBCOT_4(ColorSpace colorSpace, ColorSpace colorSpace2, int i8) {
            float[] d50Xyz$ui_graphics_release;
            float[] d50Xyz$ui_graphics_release2;
            if (!RenderIntent.m3376equalsimpl0(i8, RenderIntent.Companion.m3380getAbsoluteuksYyKA())) {
                return null;
            }
            long m3364getModelxdoWZVw = colorSpace.m3364getModelxdoWZVw();
            ColorModel.Companion companion = ColorModel.Companion;
            boolean m3355equalsimpl0 = ColorModel.m3355equalsimpl0(m3364getModelxdoWZVw, companion.m3362getRgbxdoWZVw());
            boolean m3355equalsimpl02 = ColorModel.m3355equalsimpl0(colorSpace2.m3364getModelxdoWZVw(), companion.m3362getRgbxdoWZVw());
            if (m3355equalsimpl0 && m3355equalsimpl02) {
                return null;
            }
            if (!m3355equalsimpl0 && !m3355equalsimpl02) {
                return null;
        ...
        public final Connector identity$ui_graphics_release(final ColorSpace colorSpace) {
            final int m3382getRelativeuksYyKA = RenderIntent.Companion.m3382getRelativeuksYyKA();
            return new Connector(colorSpace, m3382getRelativeuksYyKA) { // from class: androidx.compose.ui.graphics.colorspace.Connector$Companion$identity$1
                /* JADX INFO: Access modifiers changed from: package-private */
                {
                    super(colorSpace, colorSpace, m3382getRelativeuksYyKA, null);
                }
                ...
                public long mo3369transformToColorwmQWz5c$ui_graphics_release(float f8, float f9, float f10, float f11) {
    ...
    public static final class RgbConnector extends Connector {
        ...
        public /* synthetic */ RgbConnector(Rgb rgb, Rgb rgb2, int i8, AbstractC3151p abstractC3151p) {
            this(rgb, rgb2, i8);
        }

        /* renamed from: computeTransform-YBCOT_4, reason: not valid java name */
        private final float[] m3372computeTransformYBCOT_4(Rgb rgb, Rgb rgb2, int i8) {
            ...
            if (!ColorSpaceKt.compare(rgb2.getWhitePoint(), illuminant.getD50())) {
                ...
                AbstractC3159y.h(copyOf2, "copyOf(this, size)");
        ...
        private RgbConnector(Rgb rgb, Rgb rgb2, int i8) {
            ...
            this.mTransform = m3372computeTransformYBCOT_4(rgb, rgb2, i8);
        }
    }

    static {
        AbstractC3151p abstractC3151p = null;
        Companion companion = new Companion(abstractC3151p);
        Companion = companion;
        ...
        SrgbToOklabPerceptual = new Connector(srgb, oklab, companion2.m3381getPerceptualuksYyKA(), abstractC3151p);
        OklabToSrgbPerceptual = new Connector(colorSpaces.getOklab(), colorSpaces.getSrgb(), companion2.m3381getPerceptualuksYyKA(), abstractC3151p);
    }

    public /* synthetic */ Connector(ColorSpace colorSpace, ColorSpace colorSpace2, int i8, AbstractC3151p abstractC3151p) {
    ...
    public final int m3368getRenderIntentuksYyKA() {
    ...
    public long mo3369transformToColorwmQWz5c$ui_graphics_release(float f8, float f9, float f10, float f11) {
        ...
        return this.transformDestination.mo3365xyzaToColorJlNiLsg$ui_graphics_release(f13, f12, z$ui_graphics_release, f11, this.destination);
    }

    public /* synthetic */ Connector(ColorSpace colorSpace, ColorSpace colorSpace2, ColorSpace colorSpace3, ColorSpace colorSpace4, int i8, float[] fArr, AbstractC3151p abstractC3151p) {
    ...
    */
    private Connector(androidx.compose.ui.graphics.colorspace.ColorSpace r13, androidx.compose.ui.graphics.colorspace.ColorSpace r14, int r15) {
        /*
            r12 = this;
            long r0 = r13.m3364getModelxdoWZVw()
            ...
            long r3 = r2.m3362getRgbxdoWZVw()
            boolean r0 = androidx.compose.ui.graphics.colorspace.ColorModel.m3355equalsimpl0(r0, r3)
            r1 = 2
            r3 = 0
            if (r0 == 0) goto L1e
        ...
        L1e:
            r7 = r13
        L1f:
            long r4 = r14.m3364getModelxdoWZVw()
            long r8 = r2.m3362getRgbxdoWZVw()
            boolean r0 = androidx.compose.ui.graphics.colorspace.ColorModel.m3355equalsimpl0(r4, r8)
            if (r0 == 0) goto L39
            androidx.compose.ui.graphics.colorspace.Illuminant r0 = androidx.compose.ui.graphics.colorspace.Illuminant.INSTANCE
            androidx.compose.ui.graphics.colorspace.WhitePoint r0 = r0.getD50()
        ...
        L3a:
            ...
            float[] r10 = androidx.compose.ui.graphics.colorspace.Connector.Companion.m3370access$computeTransformYBCOT_4(r0, r13, r14, r15)
            r11 = 0
            r4 = r12
            r5 = r13
            r6 = r14
