...
public final class VectorPainterKt {
    ...
    public static final VectorPainter m3548configureVectorPainterT4PVSW8(VectorPainter vectorPainter, long j8, long j9, String str, ColorFilter colorFilter, boolean z8) {
        vectorPainter.m3544setSizeuvyYCjk$ui_release(j8);
        vectorPainter.setAutoMirror$ui_release(z8);
        vectorPainter.setIntrinsicColorFilter$ui_release(colorFilter);
        vectorPainter.m3545setViewportSizeuvyYCjk$ui_release(j9);
        vectorPainter.setName$ui_release(str);
        return vectorPainter;
    }

    /* renamed from: configureVectorPainter-T4PVSW8$default, reason: not valid java name */
    public static /* synthetic */ VectorPainter m3549configureVectorPainterT4PVSW8$default(VectorPainter vectorPainter, long j8, long j9, String str, ColorFilter colorFilter, boolean z8, int i8, Object obj) {
        String str2;
        boolean z9;
        if ((i8 & 4) != 0) {
            str2 = RootGroupName;
        ...
        return m3548configureVectorPainterT4PVSW8(vectorPainter, j8, j9, str2, colorFilter, z9);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: createColorFilter-xETnrds, reason: not valid java name */
    public static final ColorFilter m3550createColorFilterxETnrds(long j8, int i8) {
        if (j8 != Color.Companion.m3007getUnspecified0d7_KjU()) {
            return ColorFilter.Companion.m3015tintxETnrds(j8, i8);
        }
        return null;
    }
    ...
    public static final GroupComponent createGroupComponent(GroupComponent groupComponent, VectorGroup vectorGroup) {
        ...
        for (int i8 = 0; i8 < size; i8++) {
            ...
            if (vectorNode instanceof VectorPath) {
                ...
                pathComponent.m3529setPathFillTypeoQ8Xj4U(vectorPath.m3555getPathFillTypeRgk1Os());
                ...
                pathComponent.m3530setStrokeLineCapBeK7IIE(vectorPath.m3556getStrokeLineCapKaPHkGw());
                pathComponent.m3531setStrokeLineJoinWw9F2mQ(vectorPath.m3557getStrokeLineJoinLxFBmk8());
    ...
    public static final VectorPainter createVectorPainterFromImageVector(Density density, ImageVector imageVector, GroupComponent groupComponent) {
        long m3551obtainSizePxVpY3zN4 = m3551obtainSizePxVpY3zN4(density, imageVector.m3519getDefaultWidthD9Ej5fM(), imageVector.m3518getDefaultHeightD9Ej5fM());
        return m3548configureVectorPainterT4PVSW8(new VectorPainter(groupComponent), m3551obtainSizePxVpY3zN4, m3552obtainViewportSizePq9zytI(m3551obtainSizePxVpY3zN4, imageVector.getViewportWidth(), imageVector.getViewportHeight()), imageVector.getName(), m3550createColorFilterxETnrds(imageVector.m3521getTintColor0d7_KjU(), imageVector.m3520getTintBlendMode0nO6VwU()), imageVector.getAutoMirror());
    }
    ...
    private static final long m3551obtainSizePxVpY3zN4(Density density, float f8, float f9) {
        return SizeKt.Size(density.mo448toPx0680j_4(f8), density.mo448toPx0680j_4(f9));
    }

    /* renamed from: obtainViewportSize-Pq9zytI, reason: not valid java name */
    private static final long m3552obtainViewportSizePq9zytI(long j8, float f8, float f9) {
        if (Float.isNaN(f8)) {
            f8 = Size.m2804getWidthimpl(j8);
        }
        if (Float.isNaN(f9)) {
            f9 = Size.m2801getHeightimpl(j8);
        }
    ...
    public static final VectorPainter m3553rememberVectorPaintermlNsNFs(float f8, float f9, float f10, float f11, String str, long j8, int i8, p pVar, Composer composer, int i9, int i10) {
        float f12;
        float f13;
        String str2;
        long j9;
        ...
        if ((i10 & 64) != 0) {
            i11 = BlendMode.Companion.m2917getSrcIn0nO6VwU();
        } else {
            i11 = i8;
        }
        if (ComposerKt.isTraceInProgress()) {
        ...
        VectorPainter m3554rememberVectorPaintervIP8VLU = m3554rememberVectorPaintervIP8VLU(f8, f9, f12, f13, str2, j9, i11, false, pVar, composer, (i9 & 14) | 12582912 | (i9 & 112) | (i9 & 896) | (i9 & 7168) | (57344 & i9) | (458752 & i9) | (3670016 & i9) | ((i9 << 3) & 234881024), 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return m3554rememberVectorPaintervIP8VLU;
    }
    ...
    */
    public static final androidx.compose.ui.graphics.vector.VectorPainter m3554rememberVectorPaintervIP8VLU(float r16, float r17, float r18, float r19, java.lang.String r20, long r21, int r23, boolean r24, X5.p r25, androidx.compose.runtime.Composer r26, int r27, int r28) {
        /*
            Method dump skipped, instructions count: 324
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.graphics.vector.VectorPainterKt.m3554rememberVectorPaintervIP8VLU(float, float, float, float, java.lang.String, long, int, boolean, X5.p, androidx.compose.runtime.Composer, int, int):androidx.compose.ui.graphics.vector.VectorPainter");
    }
}
