...
public interface Modifier {
    ...
    public interface Element extends Modifier {
        ...
        public static final class DefaultImpls {
            ...
            @Deprecated
            public static <R> R foldIn(Element element, R r8, n nVar) {
                return (R) b.g(element, r8, nVar);
            }

            @Deprecated
            public static <R> R foldOut(Element element, R r8, n nVar) {
                return (R) b.h(element, r8, nVar);
            }
        ...
        @Override // androidx.compose.ui.Modifier
        <R> R foldIn(R r8, n nVar);

        @Override // androidx.compose.ui.Modifier
        <R> R foldOut(R r8, n nVar);
    }
    ...
    public static abstract class Node implements DelegatableNode {
        ...
        public final M getCoroutineScope() {
            M m8 = this.scope;
            if (m8 == null) {
                M a8 = N.a(DelegatableNodeKt.requireOwner(this).getCoroutineContext().plus(B0.a((InterfaceC2855x0) DelegatableNodeKt.requireOwner(this).getCoroutineContext().get(InterfaceC2855x0.f31809n0))));
                this.scope = a8;
                return a8;
            }
            return m8;
        ...
        public final boolean m2609isKindH91voCI$ui_release(int i8) {
