...
public final class DragAndDropNode$onMoved$$inlined$firstChildOrNull$1 extends AbstractC3160z implements Function1 {
    ...
    public final TraversableNode.Companion.TraverseDescendantsAction invoke(TraversableNode traversableNode) {
        if (traversableNode instanceof DragAndDropModifierNode) {
            ...
            if (DelegatableNodeKt.requireOwner(this.this$0).getDragAndDropManager().isInterestedNode(dragAndDropModifierNode) && DragAndDropNodeKt.m2622access$containsUv8p0NA(dragAndDropModifierNode, DragAndDrop_androidKt.getPositionInRoot(this.$event$inlined))) {
                this.$match.f33761a = traversableNode;
