...
public final class DragAndDropNode extends Modifier.Node implements TraversableNode, DragAndDropModifierNode {
    ...
    public static final class Companion {
        ...
        private final DragAndDropModifierNode firstChildOrNull(DragAndDropModifierNode dragAndDropModifierNode, Function1 function1) {
            ...
            return (DragAndDropModifierNode) t8.f33761a;
        }
    ...
    public boolean acceptDragAndDropTransfer(DragAndDropEvent dragAndDropEvent) {
        ...
        if (this.thisDragAndDropTarget == null) {
            ...
            if (!o8.f33757a && this.thisDragAndDropTarget == null) {
                return false;
            }
            return true;
        }
    ...
    public void mo2621drag12SF9DM(DragAndDropTransferData dragAndDropTransferData, long j8, Function1 function1) {
        DelegatableNodeKt.requireOwner(this).getDragAndDropManager().mo2620drag12SF9DM(dragAndDropTransferData, j8, function1);
    }
    ...
    */
    public void onMoved(androidx.compose.ui.draganddrop.DragAndDropEvent r5) {
        /*
            ...
            boolean r1 = androidx.compose.ui.draganddrop.DragAndDropNodeKt.m2622access$containsUv8p0NA(r0, r1)
            r2 = 1
            if (r1 != r2) goto L11
            r1 = r0
            goto L30
        ...
        L3f:
            ...
            goto L6c
        L4e:
            boolean r2 = kotlin.jvm.internal.AbstractC3159y.d(r1, r0)
            if (r2 != 0) goto L5f
            if (r0 == 0) goto L59
            r0.onExited(r5)
        L59:
