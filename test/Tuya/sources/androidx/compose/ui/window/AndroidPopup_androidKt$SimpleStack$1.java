        ...
        if (size != 0) {
            ...
            if (size != 1) {
                ...
                for (int i11 = 0; i11 < size2; i11++) {
                    arrayList.add(list.get(i11).mo4131measureBRTryo0(j8));
                }
            ...
            return MeasureScope.CC.q(measureScope, mo4131measureBRTryo0.getWidth(), mo4131measureBRTryo0.getHeight(), null, new AnonymousClass2(mo4131measureBRTryo0), 4, null);
        }
