...
public final class AndroidDialog_androidKt$Dialog$dialog$1$1$1 extends AbstractC3160z implements n {
    ...
    public static final class AnonymousClass2 extends AbstractC3160z implements n {
        ...
        AnonymousClass2(State<? extends n> state) {
            super(2);
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public AndroidDialog_androidKt$Dialog$dialog$1$1$1(State<? extends n> state) {
        super(2);
        this.$currentContent$delegate = state;
    }
