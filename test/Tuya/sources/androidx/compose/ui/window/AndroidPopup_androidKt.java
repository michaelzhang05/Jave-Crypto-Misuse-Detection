...
public final class AndroidPopup_androidKt {
    ...
    */
    public static final void Popup(androidx.compose.ui.window.PopupPositionProvider r35, kotlin.jvm.functions.Function0 r36, androidx.compose.ui.window.PopupProperties r37, X5.n r38, androidx.compose.runtime.Composer r39, int r40, int r41) {
        /*
            Method dump skipped, instructions count: 600
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.window.AndroidPopup_androidKt.Popup(androidx.compose.ui.window.PopupPositionProvider, kotlin.jvm.functions.Function0, androidx.compose.ui.window.PopupProperties, X5.n, androidx.compose.runtime.Composer, int, int):void");
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final n Popup$lambda$1(State<? extends n> state) {
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static final void m5432PopupK5zGePQ(androidx.compose.ui.Alignment r25, long r26, kotlin.jvm.functions.Function0 r28, androidx.compose.ui.window.PopupProperties r29, X5.n r30, androidx.compose.runtime.Composer r31, int r32, int r33) {
        /*
            Method dump skipped, instructions count: 337
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.window.AndroidPopup_androidKt.m5432PopupK5zGePQ(androidx.compose.ui.Alignment, long, kotlin.jvm.functions.Function0, androidx.compose.ui.window.PopupProperties, X5.n, androidx.compose.runtime.Composer, int, int):void");
    }

    @Composable
    @ComposableInferredTarget(scheme = "[0[0]]")
    public static final void PopupTestTag(String str, n nVar, Composer composer, int i8) {
        int i9;
        int i10;
        int i11;
        ...
        if ((i9 & 91) == 18 && startRestartGroup.getSkipping()) {
            ...
            CompositionLocalKt.CompositionLocalProvider(LocalPopupTestTag.provides(str), nVar, startRestartGroup, (i9 & 112) | ProvidedValue.$stable);
            if (ComposerKt.isTraceInProgress()) {
        ...
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new AndroidPopup_androidKt$PopupTestTag$1(str, nVar, i8));
        }
    }
    ...
    public static final boolean isPopupLayout(View view, String str) {
        if ((view instanceof PopupLayout) && (str == null || AbstractC3159y.d(str, ((PopupLayout) view).getTestTag()))) {
            return true;
        }
        return false;
    }
