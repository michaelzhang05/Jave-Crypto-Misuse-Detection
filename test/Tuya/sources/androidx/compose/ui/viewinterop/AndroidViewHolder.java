...
public class AndroidViewHolder extends ViewGroup implements NestedScrollingParent3, ComposeNodeLifecycleCallback, OwnerScope {
        ...
        layoutNode.setMeasurePolicy(new MeasurePolicy() { // from class: androidx.compose.ui.viewinterop.AndroidViewHolder$layoutNode$1$5
            ...
            public MeasureResult mo132measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j8) {
                ...
                if (AndroidViewHolder.this.getChildCount() == 0) {
                    return MeasureScope.CC.q(measureScope, Constraints.m5148getMinWidthimpl(j8), Constraints.m5147getMinHeightimpl(j8), null, AndroidViewHolder$layoutNode$1$5$measure$1.INSTANCE, 4, null);
                }
                if (Constraints.m5148getMinWidthimpl(j8) != 0) {
                    AndroidViewHolder.this.getChildAt(0).setMinimumWidth(Constraints.m5148getMinWidthimpl(j8));
                }
                if (Constraints.m5147getMinHeightimpl(j8) != 0) {
                    AndroidViewHolder.this.getChildAt(0).setMinimumHeight(Constraints.m5147getMinHeightimpl(j8));
                }
                AndroidViewHolder androidViewHolder = AndroidViewHolder.this;
                ...
                AbstractC3159y.f(layoutParams);
                obtainMeasureSpec = androidViewHolder.obtainMeasureSpec(m5148getMinWidthimpl, m5146getMaxWidthimpl, layoutParams.width);
                AndroidViewHolder androidViewHolder2 = AndroidViewHolder.this;
                ...
                AbstractC3159y.f(layoutParams2);
                obtainMeasureSpec2 = androidViewHolder2.obtainMeasureSpec(m5147getMinHeightimpl, m5145getMaxHeightimpl, layoutParams2.height);
    ...
    public boolean onNestedFling(View view, float f8, float f9, boolean z8) {
        ...
        AbstractC2825i.d(this.dispatcher.getCoroutineScope(), null, null, new AndroidViewHolder$onNestedFling$1(z8, this, VelocityKt.Velocity(AndroidViewHolder_androidKt.access$toComposeVelocity(f8), AndroidViewHolder_androidKt.access$toComposeVelocity(f9)), null), 3, null);
        return false;
    }
    ...
    public boolean onNestedPreFling(View view, float f8, float f9) {
        ...
        AbstractC2825i.d(this.dispatcher.getCoroutineScope(), null, null, new AndroidViewHolder$onNestedPreFling$1(this, VelocityKt.Velocity(AndroidViewHolder_androidKt.access$toComposeVelocity(f8), AndroidViewHolder_androidKt.access$toComposeVelocity(f9)), null), 3, null);
        return false;
    }
    ...
    public void onNestedPreScroll(View view, int i8, int i9, int[] iArr, int i10) {
        ...
        long m3914dispatchPreScrollOzD1aCk = this.dispatcher.m3914dispatchPreScrollOzD1aCk(OffsetKt.Offset(AndroidViewHolder_androidKt.access$toComposeOffset(i8), AndroidViewHolder_androidKt.access$toComposeOffset(i9)), AndroidViewHolder_androidKt.access$toNestedScrollSource(i10));
        iArr[0] = NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m2735getXimpl(m3914dispatchPreScrollOzD1aCk));
        iArr[1] = NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m2736getYimpl(m3914dispatchPreScrollOzD1aCk));
    }

    @Override // androidx.core.view.NestedScrollingParent3
    public void onNestedScroll(View view, int i8, int i9, int i10, int i11, int i12, int[] iArr) {
        if (isNestedScrollingEnabled()) {
            long m3912dispatchPostScrollDzOQY0M = this.dispatcher.m3912dispatchPostScrollDzOQY0M(OffsetKt.Offset(AndroidViewHolder_androidKt.access$toComposeOffset(i8), AndroidViewHolder_androidKt.access$toComposeOffset(i9)), OffsetKt.Offset(AndroidViewHolder_androidKt.access$toComposeOffset(i10), AndroidViewHolder_androidKt.access$toComposeOffset(i11)), AndroidViewHolder_androidKt.access$toNestedScrollSource(i12));
            iArr[0] = NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m2735getXimpl(m3912dispatchPostScrollDzOQY0M));
            iArr[1] = NestedScrollInteropConnectionKt.composeToViewOffset(Offset.m2736getYimpl(m3912dispatchPostScrollDzOQY0M));
        }
    }
    ...
    public void onNestedScroll(View view, int i8, int i9, int i10, int i11, int i12) {
        if (isNestedScrollingEnabled()) {
            this.dispatcher.m3912dispatchPostScrollDzOQY0M(OffsetKt.Offset(AndroidViewHolder_androidKt.access$toComposeOffset(i8), AndroidViewHolder_androidKt.access$toComposeOffset(i9)), OffsetKt.Offset(AndroidViewHolder_androidKt.access$toComposeOffset(i10), AndroidViewHolder_androidKt.access$toComposeOffset(i11)), AndroidViewHolder_androidKt.access$toNestedScrollSource(i12));
        }
    }
}
