...
public final class AndroidViewBindingKt {
    @Composable
    public static final <T extends ViewBinding> void AndroidViewBinding(o oVar, Modifier modifier, Function1 function1, Composer composer, int i8, int i9) {
        int i10;
        Composer startRestartGroup = composer.startRestartGroup(-1985291610);
        if ((i9 & 1) != 0) {
            i10 = i8 | 6;
        } else if ((i8 & 14) == 0) {
            i10 = (startRestartGroup.changedInstance(oVar) ? 4 : 2) | i8;
        } else {
            i10 = i8;
        }
        int i11 = i9 & 2;
        ...
        if ((i10 & 731) == 146 && startRestartGroup.getSkipping()) {
            ...
            AndroidViewBinding(oVar, modifier, null, null, function1, startRestartGroup, (i10 & 14) | 384 | (i10 & 112) | ((i10 << 6) & 57344), 8);
            if (ComposerKt.isTraceInProgress()) {
        ...
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new AndroidViewBindingKt$AndroidViewBinding$2(oVar, modifier2, function12, i8, i9));
        }
    }
    ...
    public static final <T extends ViewBinding> T getBinding(View view) {
        ...
        AbstractC3159y.g(tag, "null cannot be cast to non-null type T of androidx.compose.ui.viewinterop.AndroidViewBindingKt.getBinding");
        return (T) tag;
    }
    ...
    */
    public static final <T extends androidx.viewbinding.ViewBinding> void AndroidViewBinding(X5.o r16, androidx.compose.ui.Modifier r17, kotlin.jvm.functions.Function1 r18, kotlin.jvm.functions.Function1 r19, kotlin.jvm.functions.Function1 r20, androidx.compose.runtime.Composer r21, int r22, int r23) {
        /*
            Method dump skipped, instructions count: 402
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.viewinterop.AndroidViewBindingKt.AndroidViewBinding(X5.o, androidx.compose.ui.Modifier, kotlin.jvm.functions.Function1, kotlin.jvm.functions.Function1, kotlin.jvm.functions.Function1, androidx.compose.runtime.Composer, int, int):void");
    }
}
