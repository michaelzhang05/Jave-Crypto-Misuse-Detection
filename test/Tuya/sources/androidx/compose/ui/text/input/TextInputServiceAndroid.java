...
public final class TextInputServiceAndroid implements PlatformTextInputService {
    ...
    private final InterfaceC1227k baseInputConnection$delegate;
    ...
    public TextInputServiceAndroid(View view, PositionCalculator positionCalculator, InputMethodManager inputMethodManager, Executor executor) {
        ...
        this.state = new TextFieldValue("", TextRange.Companion.m4697getZerod9O1mEE(), (TextRange) null, 4, (AbstractC3151p) null);
        this.imeOptions = ImeOptions.Companion.getDefault();
        this.ics = new ArrayList();
        this.baseInputConnection$delegate = L5.l.a(L5.o.f6506c, new TextInputServiceAndroid$baseInputConnection$2(this));
    ...
    private final void processInputCommands() {
        ...
        if (AbstractC3159y.d(t8.f33761a, Boolean.TRUE)) {
            restartInputImmediately();
        }
        Boolean bool = (Boolean) t9.f33761a;
        if (bool != null) {
            setKeyboardVisibleImmediately(bool.booleanValue());
        }
        if (AbstractC3159y.d(t8.f33761a, Boolean.FALSE)) {
            restartInputImmediately();
        }
    }
    ...
    private static final void processInputCommands$applyToState(TextInputCommand textInputCommand, T t8, T t9) {
        ...
        if (i8 != 1) {
            if (i8 != 2) {
                if ((i8 == 3 || i8 == 4) && !AbstractC3159y.d(t8.f33761a, Boolean.FALSE)) {
                    if (textInputCommand != TextInputCommand.ShowKeyboard) {
                        z8 = false;
                    }
                    t9.f33761a = Boolean.valueOf(z8);
                    return;
                }
                return;
            }
        ...
        RecordingInputConnection recordingInputConnection = new RecordingInputConnection(this.state, new InputEventCallback2() { // from class: androidx.compose.ui.text.input.TextInputServiceAndroid$createInputConnection$1
            ...
            public void onConnectionClosed(RecordingInputConnection recordingInputConnection2) {
                ...
                for (int i8 = 0; i8 < size; i8++) {
                    ...
                    if (AbstractC3159y.d(((WeakReference) list2.get(i8)).get(), recordingInputConnection2)) {
            ...
            public void mo4883onImeActionKlQnJC8(int i8) {
                Function1 function1;
                function1 = TextInputServiceAndroid.this.onImeActionPerformed;
                function1.invoke(ImeAction.m4852boximpl(i8));
            }
    ...
    public void notifyFocusedRect(androidx.compose.ui.geometry.Rect rect) {
        Rect rect2;
        this.focusedRect = new Rect(Z5.a.d(rect.getLeft()), Z5.a.d(rect.getTop()), Z5.a.d(rect.getRight()), Z5.a.d(rect.getBottom()));
    ...
    public void updateState(TextFieldValue textFieldValue, TextFieldValue textFieldValue2) {
        boolean z8;
        int i8;
        if (TextRange.m4685equalsimpl0(this.state.m4929getSelectiond9O1mEE(), textFieldValue2.m4929getSelectiond9O1mEE()) && AbstractC3159y.d(this.state.m4928getCompositionMzsxiRA(), textFieldValue2.m4928getCompositionMzsxiRA())) {
            z8 = false;
        } else {
            z8 = true;
        }
        ...
        if (AbstractC3159y.d(textFieldValue, textFieldValue2)) {
            if (z8) {
                InputMethodManager inputMethodManager = this.inputMethodManager;
                int m4690getMinimpl = TextRange.m4690getMinimpl(textFieldValue2.m4929getSelectiond9O1mEE());
                int m4689getMaximpl = TextRange.m4689getMaximpl(textFieldValue2.m4929getSelectiond9O1mEE());
                TextRange m4928getCompositionMzsxiRA = this.state.m4928getCompositionMzsxiRA();
                int i10 = -1;
                ...
                TextRange m4928getCompositionMzsxiRA2 = this.state.m4928getCompositionMzsxiRA();
                if (m4928getCompositionMzsxiRA2 != null) {
                    i10 = TextRange.m4689getMaximpl(m4928getCompositionMzsxiRA2.m4696unboximpl());
                }
                inputMethodManager.updateSelection(m4690getMinimpl, m4689getMaximpl, i8, i10);
                return;
            }
            return;
        }
        if (textFieldValue != null && (!AbstractC3159y.d(textFieldValue.getText(), textFieldValue2.getText()) || (TextRange.m4685equalsimpl0(textFieldValue.m4929getSelectiond9O1mEE(), textFieldValue2.m4929getSelectiond9O1mEE()) && !AbstractC3159y.d(textFieldValue.m4928getCompositionMzsxiRA(), textFieldValue2.m4928getCompositionMzsxiRA())))) {
            restartInputImmediately();
            return;
        }
    ...
    public /* synthetic */ TextInputServiceAndroid(View view, PositionCalculator positionCalculator, InputMethodManager inputMethodManager, Executor executor, int i8, AbstractC3151p abstractC3151p) {
