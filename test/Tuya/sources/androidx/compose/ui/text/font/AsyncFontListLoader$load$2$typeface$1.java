...
public final class AsyncFontListLoader$load$2$typeface$1 extends kotlin.coroutines.jvm.internal.l implements Function1 {
    ...
    public AsyncFontListLoader$load$2$typeface$1(AsyncFontListLoader asyncFontListLoader, Font font, P5.d dVar) {
        super(1, dVar);
    ...
    public final Object invoke(P5.d dVar) {
        return ((AsyncFontListLoader$load$2$typeface$1) create(dVar)).invokeSuspend(I.f6487a);
    }
