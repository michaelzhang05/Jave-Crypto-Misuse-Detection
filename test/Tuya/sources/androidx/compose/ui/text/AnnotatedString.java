...
public final class AnnotatedString implements CharSequence {
    ...
    public static final class Builder implements Appendable {
        ...
        public static final class MutableRange<T> {
            ...
            public boolean equals(Object obj) {
                ...
                return AbstractC3159y.d(this.item, mutableRange.item) && this.start == mutableRange.start && this.end == mutableRange.end && AbstractC3159y.d(this.tag, mutableRange.tag);
            }
            ...
            public /* synthetic */ MutableRange(Object obj, int i8, int i9, String str, int i10, AbstractC3151p abstractC3151p) {
        ...
        public /* synthetic */ Builder(int i8, int i9, AbstractC3151p abstractC3151p) {
            this((i9 & 1) != 0 ? 16 : i8);
        }
    ...
    public AnnotatedString(String str, List<Range<SpanStyle>> list, List<Range<ParagraphStyle>> list2, List<? extends Range<? extends Object>> list3) {
        ...
        if (list2 == null || (P02 = AbstractC1246t.P0(list2, new Comparator() { // from class: androidx.compose.ui.text.AnnotatedString$special$$inlined$sortedBy$1
            /* JADX WARN: Multi-variable type inference failed */
            @Override // java.util.Comparator
            public final int compare(T t8, T t9) {
                return O5.a.a(Integer.valueOf(((AnnotatedString.Range) t8).getStart()), Integer.valueOf(((AnnotatedString.Range) t9).getStart()));
            }
        })) == null) {
            return;
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (AbstractC3159y.d(this.text, annotatedString.text) && AbstractC3159y.d(this.spanStylesOrNull, annotatedString.spanStylesOrNull) && AbstractC3159y.d(this.paragraphStylesOrNull, annotatedString.paragraphStylesOrNull) && AbstractC3159y.d(this.annotations, annotatedString.annotations)) {
            return true;
        }
        return false;
    }
    ...
    public final List<Range<String>> getStringAnnotations(String str, int i8, int i9) {
        ...
        if (list != null) {
            ...
            for (int i10 = 0; i10 < size; i10++) {
                ...
                if ((range2.getItem() instanceof String) && AbstractC3159y.d(str, range2.getTag()) && AnnotatedStringKt.intersect(i8, i9, range2.getStart(), range2.getEnd())) {
                    m8.add(range);
                }
            }
        } else {
        ...
        AbstractC3159y.g(m8, "null cannot be cast to non-null type kotlin.collections.List<androidx.compose.ui.text.AnnotatedString.Range<kotlin.String>>");
        return m8;
    }
    ...
    public final List<Range<TtsAnnotation>> getTtsAnnotations(int i8, int i9) {
        ...
        AbstractC3159y.g(m8, "null cannot be cast to non-null type kotlin.collections.List<androidx.compose.ui.text.AnnotatedString.Range<androidx.compose.ui.text.TtsAnnotation>>");
        return m8;
    }
    ...
    public final List<Range<UrlAnnotation>> getUrlAnnotations(int i8, int i9) {
        ...
        AbstractC3159y.g(m8, "null cannot be cast to non-null type kotlin.collections.List<androidx.compose.ui.text.AnnotatedString.Range<androidx.compose.ui.text.UrlAnnotation>>");
        return m8;
    }
    ...
    public final boolean hasStringAnnotations(String str, int i8, int i9) {
        ...
        for (int i10 = 0; i10 < size; i10++) {
            Range<? extends Object> range = list.get(i10);
            if ((range.getItem() instanceof String) && AbstractC3159y.d(str, range.getTag()) && AnnotatedStringKt.intersect(i8, i9, range.getStart(), range.getEnd())) {
                return true;
            }
        }
        return false;
    ...
    public final AnnotatedString m4558subSequence5zctL8(long j8) {
        return subSequence(TextRange.m4690getMinimpl(j8), TextRange.m4689getMaximpl(j8));
    }
    ...
    public static final class Range<T> {
        ...
        public boolean equals(Object obj) {
            ...
            return AbstractC3159y.d(this.item, range.item) && this.start == range.start && this.end == range.end && AbstractC3159y.d(this.tag, range.tag);
        }
    ...
    public /* synthetic */ AnnotatedString(String str, List list, List list2, List list3, int i8, AbstractC3151p abstractC3151p) {
        this(str, (i8 & 2) != 0 ? null : list, (i8 & 4) != 0 ? null : list2, (i8 & 8) != 0 ? null : list3);
    }

    public /* synthetic */ AnnotatedString(String str, List list, List list2, int i8, AbstractC3151p abstractC3151p) {
        this(str, (i8 & 2) != 0 ? AbstractC1246t.m() : list, (i8 & 4) != 0 ? AbstractC1246t.m() : list2);
    }
