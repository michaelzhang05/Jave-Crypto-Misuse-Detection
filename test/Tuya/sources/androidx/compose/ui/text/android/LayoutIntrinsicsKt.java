...
public final class LayoutIntrinsicsKt {
    public static final float minIntrinsicWidth(CharSequence charSequence, TextPaint textPaint) {
        ...
        PriorityQueue<L5.r> priorityQueue = new PriorityQueue(10, new Comparator() { // from class: androidx.compose.ui.text.android.d
            @Override // java.util.Comparator
            public final int compare(Object obj, Object obj2) {
                int minIntrinsicWidth$lambda$0;
                minIntrinsicWidth$lambda$0 = LayoutIntrinsicsKt.minIntrinsicWidth$lambda$0((L5.r) obj, (L5.r) obj2);
        ...
        while (next != -1) {
            if (priorityQueue.size() < 10) {
                priorityQueue.add(new L5.r(Integer.valueOf(i8), Integer.valueOf(next)));
            } else {
                L5.r rVar = (L5.r) priorityQueue.peek();
    ...
    public static final int minIntrinsicWidth$lambda$0(L5.r rVar, L5.r rVar2) {
