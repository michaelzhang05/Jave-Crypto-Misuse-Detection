...
public final class LayoutHelper {
    ...
    public LayoutHelper(Layout layout) {
        ...
        int i9 = 0;
        do {
            int R8 = g6.n.R(this.layout.getText(), '\n', i9, false, 4, null);
            if (R8 < 0) {
    ...
    private final float getDownstreamHorizontal(int i8, boolean z8) {
        int g8 = d6.m.g(i8, this.layout.getLineEnd(this.layout.getLineForOffset(i8)));
        if (z8) {
    ...
    */
        ...
        if (i9 != 0 && i9 != this.layout.getText().length()) {
            ...
            if (bidi != null && bidi.getRunCount() != 1) {
                ...
                if (i9 == lineStart) {
                    ...
                    if (i14 == AbstractC1239l.i0(bidiRunArr) && !isRtlParagraph) {
    ...
    public final int getParagraphForOffset(@IntRange(from = 0) int i8, boolean z8) {
        int i9;
        int l8 = AbstractC1246t.l(this.paragraphEnds, Integer.valueOf(i8), 0, 0, 6, null);
        if (l8 < 0) {
            i9 = -(l8 + 1);
        } else {
            i9 = l8 + 1;
    ...
    public final boolean isLineEndSpace(char c8) {
        if (c8 != ' ' && c8 != '\n' && c8 != 5760 && ((AbstractC3159y.k(c8, 8192) < 0 || AbstractC3159y.k(c8, 8202) > 0 || c8 == 8199) && c8 != 8287 && c8 != 12288)) {
            return false;
        }
        return true;
    }
