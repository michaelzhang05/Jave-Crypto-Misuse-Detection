...
public final class TextLayout {
    ...
    private final InterfaceC1227k layoutHelper$delegate;
    ...
    public TextLayout(CharSequence charSequence, float f8, TextPaint textPaint, int i8, TextUtils.TruncateAt truncateAt, int i9, float f9, @Px float f10, boolean z8, boolean z9, int i10, int i11, int i12, int i13, int i14, int i15, int[] iArr, int[] iArr2, LayoutIntrinsics layoutIntrinsics) {
        ...
        try {
            ...
            this.topPadding = Math.max(VerticalPaddings.m4744getTopPaddingimpl(verticalPaddings), VerticalPaddings.m4744getTopPaddingimpl(lineHeightPaddings));
            this.bottomPadding = Math.max(VerticalPaddings.m4743getBottomPaddingimpl(verticalPaddings), VerticalPaddings.m4743getBottomPaddingimpl(lineHeightPaddings));
            ...
            this.layoutHelper$delegate = L5.l.a(L5.o.f6506c, new TextLayout$layoutHelper$2(this));
        } catch (Throwable th) {
            Trace.endSection();
            throw th;
        }
    ...
    public final boolean isFallbackLinespacingApplied$ui_text_release() {
        if (this.isBoringLayout) {
            ...
            AbstractC3159y.g(layout, "null cannot be cast to non-null type android.text.BoringLayout");
        ...
        AbstractC3159y.g(layout2, "null cannot be cast to non-null type android.text.StaticLayout");
    ...
    */
    public /* synthetic */ TextLayout(java.lang.CharSequence r24, float r25, android.text.TextPaint r26, int r27, android.text.TextUtils.TruncateAt r28, int r29, float r30, float r31, boolean r32, boolean r33, int r34, int r35, int r36, int r37, int r38, int r39, int[] r40, int[] r41, androidx.compose.ui.text.android.LayoutIntrinsics r42, int r43, kotlin.jvm.internal.AbstractC3151p r44) {
        /*
