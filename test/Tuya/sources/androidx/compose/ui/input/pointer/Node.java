...
public final class Node extends NodeParent {
    ...
    private final boolean hasPositionChanged(PointerEvent pointerEvent, PointerEvent pointerEvent2) {
        ...
        for (int i8 = 0; i8 < size; i8++) {
            if (!Offset.m2732equalsimpl0(pointerEvent.getChanges().get(i8).m4016getPositionF1C5BW0(), pointerEvent2.getChanges().get(i8).m4016getPositionF1C5BW0())) {
                return true;
            }
        }
        return false;
    ...
    */
    ...
    public void cleanUpHits(InternalPointerEvent internalPointerEvent) {
        ...
        for (int i8 = 0; i8 < size; i8++) {
            ...
            if (!pointerInputChange.getPressed() && (!internalPointerEvent.m3945issuesEnterExitEvent0FcD4WY(pointerInputChange.m4014getIdJ3iCeTQ()) || !this.isIn)) {
                this.pointerIds.m4101remove0FcD4WY(pointerInputChange.m4014getIdJ3iCeTQ());
            }
        }
        this.isIn = false;
        this.hasExited = PointerEventType.m3965equalsimpl0(pointerEvent.m3958getType7fucELk(), PointerEventType.Companion.m3970getExit7fucELk());
    }
    ...
    public boolean dispatchFinalEventPass(InternalPointerEvent internalPointerEvent) {
        ...
        if (!this.relevantChanges.isEmpty() && this.modifierNode.isAttached()) {
            PointerEvent pointerEvent = this.pointerEvent;
            AbstractC3159y.f(pointerEvent);
            LayoutCoordinates layoutCoordinates = this.coordinates;
            AbstractC3159y.f(layoutCoordinates);
            long mo4138getSizeYbymL2g = layoutCoordinates.mo4138getSizeYbymL2g();
            DelegatingNode delegatingNode = this.modifierNode;
            int m4343constructorimpl = NodeKind.m4343constructorimpl(16);
            MutableVector mutableVector = null;
            while (delegatingNode != 0) {
                if (delegatingNode instanceof PointerInputModifierNode) {
                    ((PointerInputModifierNode) delegatingNode).mo265onPointerEventH0pRuoY(pointerEvent, PointerEventPass.Final, mo4138getSizeYbymL2g);
                } else if ((delegatingNode.getKindSet$ui_release() & m4343constructorimpl) != 0 && (delegatingNode instanceof DelegatingNode)) {
                    Modifier.Node delegate$ui_release = delegatingNode.getDelegate$ui_release();
                    int i9 = 0;
                    delegatingNode = delegatingNode;
    ...
    public boolean dispatchMainEventPass(LongSparseArray<PointerInputChange> longSparseArray, LayoutCoordinates layoutCoordinates, InternalPointerEvent internalPointerEvent, boolean z8) {
        ...
        AbstractC3159y.f(layoutCoordinates2);
        long mo4138getSizeYbymL2g = layoutCoordinates2.mo4138getSizeYbymL2g();
        DelegatingNode delegatingNode = this.modifierNode;
        int m4343constructorimpl = NodeKind.m4343constructorimpl(16);
        MutableVector mutableVector = null;
        while (delegatingNode != 0) {
            if (delegatingNode instanceof PointerInputModifierNode) {
                ((PointerInputModifierNode) delegatingNode).mo265onPointerEventH0pRuoY(pointerEvent, PointerEventPass.Initial, mo4138getSizeYbymL2g);
            } else if ((delegatingNode.getKindSet$ui_release() & m4343constructorimpl) != 0 && (delegatingNode instanceof DelegatingNode)) {
                Modifier.Node delegate$ui_release = delegatingNode.getDelegate$ui_release();
                int i8 = 0;
                delegatingNode = delegatingNode;
        ...
        if (this.modifierNode.isAttached() && (size = (children = getChildren()).getSize()) > 0) {
            ...
            do {
                ...
                AbstractC3159y.f(layoutCoordinates3);
        ...
        if (this.modifierNode.isAttached()) {
            ...
            int m4343constructorimpl2 = NodeKind.m4343constructorimpl(16);
            MutableVector mutableVector2 = null;
            while (delegatingNode2 != 0) {
                if (delegatingNode2 instanceof PointerInputModifierNode) {
                    ((PointerInputModifierNode) delegatingNode2).mo265onPointerEventH0pRuoY(pointerEvent, PointerEventPass.Main, mo4138getSizeYbymL2g);
                } else if ((delegatingNode2.getKindSet$ui_release() & m4343constructorimpl2) != 0 && (delegatingNode2 instanceof DelegatingNode)) {
