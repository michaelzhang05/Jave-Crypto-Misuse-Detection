...
public final class NodeCoordinator$speculativeHit$1 extends AbstractC3160z implements Function0 {
    ...
    public final void m4338invoke() {
        ...
        m4341nextUntilhw7D004 = NodeCoordinatorKt.m4341nextUntilhw7D004(this.$this_speculativeHit, this.$hitTestSource.mo4333entityTypeOLwlOKw(), NodeKind.m4343constructorimpl(2));
        nodeCoordinator.m4315speculativeHitJHbHoSQ(m4341nextUntilhw7D004, this.$hitTestSource, this.$pointerPosition, this.$hitTestResult, this.$isTouchEvent, this.$isInLayer, this.$distanceFromEdge);
    }
}
