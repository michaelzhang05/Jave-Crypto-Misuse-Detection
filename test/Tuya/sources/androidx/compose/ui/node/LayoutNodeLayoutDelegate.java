...
public final class LayoutNodeLayoutDelegate {
    ...
    public final class LookaheadPassDelegate extends Placeable implements Measurable, AlignmentLinesOwner {
        ...
        private long lastPosition = IntOffset.Companion.m5312getZeronOccac();
            ...
            if (size > 0) {
                ...
                do {
                    ...
                    if (layoutNode2.getLookaheadMeasurePending$ui_release() && layoutNode2.getMeasuredByParentInLookahead$ui_release() == LayoutNode.UsageByParent.InMeasureBlock) {
                        ...
                        AbstractC3159y.f(lookaheadPassDelegate$ui_release);
                        Constraints m4271getLastLookaheadConstraintsDWUhwKw = layoutNode2.getLayoutDelegate$ui_release().m4271getLastLookaheadConstraintsDWUhwKw();
                        AbstractC3159y.f(m4271getLastLookaheadConstraintsDWUhwKw);
                        if (lookaheadPassDelegate$ui_release.m4274remeasureBRTryo0(m4271getLastLookaheadConstraintsDWUhwKw.m5152unboximpl())) {
                ...
                if (size > 0) {
                    ...
                    do {
                        ...
                        if (mutableVector.getSize() <= i8) {
                            ...
                            AbstractC3159y.f(lookaheadPassDelegate$ui_release2);
        ...
        public final Constraints m4272getLastConstraintsDWUhwKw() {
        ...
        public final long m4273getLastPositionnOccac$ui_release() {
        ...
        */
        public androidx.compose.ui.layout.Placeable mo4131measureBRTryo0(long r4) {
            /*
                r3 = this;
            ...
            L51:
                r3.m4274remeasureBRTryo0(r4)
                return r3
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.node.LayoutNodeLayoutDelegate.LookaheadPassDelegate.mo4131measureBRTryo0(long):androidx.compose.ui.layout.Placeable");
        }
        ...
        public void mo4132placeAtf8xVGno(long j8, float f8, Function1 function1) {
            if (!LayoutNodeLayoutDelegate.this.layoutNode.isDeactivated()) {
                ...
                if (!IntOffset.m5301equalsimpl0(j8, this.lastPosition)) {
                ...
                if (!LayoutNodeLayoutDelegate.this.getLookaheadLayoutPending$ui_release() && isPlaced()) {
                    LookaheadDelegate lookaheadDelegate = LayoutNodeLayoutDelegate.this.getOuterCoordinator().getLookaheadDelegate();
                    AbstractC3159y.f(lookaheadDelegate);
                    lookaheadDelegate.m4288placeSelfApparentToRealOffsetgyyYBs$ui_release(j8);
        ...
        public final boolean m4274remeasureBRTryo0(long j8) {
            boolean z8;
            long IntSize;
            boolean z9;
            ...
            if (!LayoutNodeLayoutDelegate.this.layoutNode.isDeactivated()) {
                ...
                this.lookaheadConstraints = Constraints.m5134boximpl(j8);
                ...
                if (this.measuredOnce) {
                    IntSize = m4165getMeasuredSizeYbymL2g();
                } else {
                ...
                if (z9) {
                    LayoutNodeLayoutDelegate.this.m4268performLookaheadMeasureBRTryo0(j8);
                    m4167setMeasuredSizeozmzZPI(IntSizeKt.IntSize(lookaheadDelegate.getWidth(), lookaheadDelegate.getHeight()));
                    if (IntSize.m5344getWidthimpl(IntSize) != lookaheadDelegate.getWidth() || IntSize.m5343getHeightimpl(IntSize) != lookaheadDelegate.getHeight()) {
                        return true;
                    }
                    return false;
                }
        ...
        public final void replace() {
            ...
            try {
                ...
                if (this.placedOnce) {
                    this.onNodePlacedCalled = false;
                    boolean isPlaced = isPlaced();
                    mo4132placeAtf8xVGno(this.lastPosition, 0.0f, null);
    ...
    public final class MeasurePassDelegate extends Placeable implements Measurable, AlignmentLinesOwner {
        ...
        public MeasurePassDelegate() {
            ...
            this.lastPosition = companion.m5312getZeronOccac();
            this.parentDataDirty = true;
            ...
            this.placeOuterCoordinatorPosition = companion.m5312getZeronOccac();
        ...
        private final void markNodeAndSubtreeAsPlaced() {
            ...
            for (NodeCoordinator outerCoordinator$ui_release = layoutNode.getOuterCoordinator$ui_release(); !AbstractC3159y.d(outerCoordinator$ui_release, wrapped$ui_release) && outerCoordinator$ui_release != null; outerCoordinator$ui_release = outerCoordinator$ui_release.getWrapped$ui_release()) {
        ...
        private final void onBeforeLayoutChildren() {
            ...
            if (size > 0) {
                ...
                do {
                    LayoutNode layoutNode2 = content[i8];
                    if (layoutNode2.getMeasurePending$ui_release() && layoutNode2.getMeasuredByParent$ui_release() == LayoutNode.UsageByParent.InMeasureBlock && LayoutNode.m4251remeasure_Sx5XlM$ui_release$default(layoutNode2, null, 1, null)) {
        ...
        private final void m4277placeOuterCoordinatorf8xVGno(long j8, float f8, Function1 function1) {
            if (!LayoutNodeLayoutDelegate.this.layoutNode.isDeactivated()) {
                ...
                if (!LayoutNodeLayoutDelegate.this.getLayoutPending$ui_release() && isPlaced()) {
                    LayoutNodeLayoutDelegate.this.getOuterCoordinator().m4327placeSelfApparentToRealOffsetf8xVGno(j8, f8, function1);
                    onNodePlaced$ui_release();
                } else {
                    getAlignmentLines().setUsedByModifierLayout$ui_release(false);
                    LayoutNodeLayoutDelegate.this.setCoordinatesAccessedDuringModifierPlacement(false);
        ...
        /* renamed from: getLastConstraints-DWUhwKw, reason: not valid java name */
        public final Constraints m4278getLastConstraintsDWUhwKw() {
            if (this.measuredOnce) {
                return Constraints.m5134boximpl(m4166getMeasurementConstraintsmsEJaDk());
            }
            return null;
        }
        ...
        public Placeable mo4131measureBRTryo0(long j8) {
            ...
            if (LayoutNodeLayoutDelegateKt.isOutMostLookaheadRoot(LayoutNodeLayoutDelegate.this.layoutNode)) {
                ...
                lookaheadPassDelegate$ui_release.mo4131measureBRTryo0(j8);
            }
            trackMeasurementByParent(LayoutNodeLayoutDelegate.this.layoutNode);
            m4279remeasureBRTryo0(j8);
            return this;
        }
            ...
            if (parent$ui_release != null) {
                if (lookaheadPassDelegate$ui_release != null) {
                    if (lookaheadPassDelegate$ui_release.getMeasuredByParent$ui_release() == LayoutNode.UsageByParent.InMeasureBlock && parent$ui_release.getLayoutState$ui_release() == LayoutNode.LayoutState.Measuring) {
                        Constraints m4272getLastConstraintsDWUhwKw = lookaheadPassDelegate$ui_release.m4272getLastConstraintsDWUhwKw();
                        AbstractC3159y.f(m4272getLastConstraintsDWUhwKw);
                        mo4131measureBRTryo0(m4272getLastConstraintsDWUhwKw.m5152unboximpl());
                        return;
                    } else {
                        if (lookaheadPassDelegate$ui_release.getMeasuredByParent$ui_release() == LayoutNode.UsageByParent.InLayoutBlock && parent$ui_release.getLayoutState$ui_release() == LayoutNode.LayoutState.LayingOut) {
                            Constraints m4272getLastConstraintsDWUhwKw2 = lookaheadPassDelegate$ui_release.m4272getLastConstraintsDWUhwKw();
                            AbstractC3159y.f(m4272getLastConstraintsDWUhwKw2);
                            mo4131measureBRTryo0(m4272getLastConstraintsDWUhwKw2.m5152unboximpl());
                            return;
                        }
                        return;
                    }
        ...
        public void mo4132placeAtf8xVGno(long j8, float f8, Function1 function1) {
            ...
            if (LayoutNodeLayoutDelegateKt.isOutMostLookaheadRoot(LayoutNodeLayoutDelegate.this.layoutNode)) {
                ...
                Placeable.PlacementScope.place$default(placementScope2, lookaheadPassDelegate$ui_release, IntOffset.m5302getXimpl(j8), IntOffset.m5303getYimpl(j8), 0.0f, 4, null);
            }
            ...
            if (true ^ z8) {
                m4277placeOuterCoordinatorf8xVGno(j8, f8, function1);
                return;
            }
        ...
        public final void placeBasedOnLookahead() {
            LookaheadPassDelegate lookaheadPassDelegate$ui_release = LayoutNodeLayoutDelegate.this.getLookaheadPassDelegate$ui_release();
            if (lookaheadPassDelegate$ui_release != null) {
                mo4132placeAtf8xVGno(lookaheadPassDelegate$ui_release.m4273getLastPositionnOccac$ui_release(), lookaheadPassDelegate$ui_release.getLastZIndex$ui_release(), lookaheadPassDelegate$ui_release.getLastLayerBlock$ui_release());
                return;
            }
            throw new IllegalStateException("invalid lookaheadDelegate".toString());
        }
        ...
        public final boolean m4279remeasureBRTryo0(long j8) {
            ...
            if (!LayoutNodeLayoutDelegate.this.layoutNode.isDeactivated()) {
                ...
                layoutNode.setCanMultiMeasure$ui_release(z8);
                if (!LayoutNodeLayoutDelegate.this.layoutNode.getMeasurePending$ui_release() && Constraints.m5139equalsimpl0(m4166getMeasurementConstraintsmsEJaDk(), j8)) {
                ...
                this.measuredOnce = true;
                long mo4138getSizeYbymL2g = LayoutNodeLayoutDelegate.this.getOuterCoordinator().mo4138getSizeYbymL2g();
                m4168setMeasurementConstraintsBRTryo0(j8);
                LayoutNodeLayoutDelegate.this.m4269performMeasureBRTryo0(j8);
                if (IntSize.m5342equalsimpl0(LayoutNodeLayoutDelegate.this.getOuterCoordinator().mo4138getSizeYbymL2g(), mo4138getSizeYbymL2g) && LayoutNodeLayoutDelegate.this.getOuterCoordinator().getWidth() == getWidth() && LayoutNodeLayoutDelegate.this.getOuterCoordinator().getHeight() == getHeight()) {
                    z9 = false;
                }
                m4167setMeasuredSizeozmzZPI(IntSizeKt.IntSize(LayoutNodeLayoutDelegate.this.getOuterCoordinator().getWidth(), LayoutNodeLayoutDelegate.this.getOuterCoordinator().getHeight()));
                return z9;
            }
            throw new IllegalArgumentException("measure is called on a deactivated node".toString());
        }
        ...
        public final void replace() {
            ...
            try {
                ...
                if (this.placedOnce) {
                    boolean isPlaced = isPlaced();
                    m4277placeOuterCoordinatorf8xVGno(this.lastPosition, this.lastZIndex, this.lastLayerBlock);
                    if (isPlaced && !this.onNodePlacedCalled && (parent$ui_release = LayoutNodeLayoutDelegate.this.layoutNode.getParent$ui_release()) != null) {
                        LayoutNode.requestRelayout$ui_release$default(parent$ui_release, false, 1, null);
                    }
                    return;
    ...
    public final void m4268performLookaheadMeasureBRTryo0(long j8) {
    ...
    public final void m4269performMeasureBRTryo0(long j8) {
    ...
    /* renamed from: getLastConstraints-DWUhwKw, reason: not valid java name */
    public final Constraints m4270getLastConstraintsDWUhwKw() {
        return this.measurePassDelegate.m4278getLastConstraintsDWUhwKw();
    }

    /* renamed from: getLastLookaheadConstraints-DWUhwKw, reason: not valid java name */
    public final Constraints m4271getLastLookaheadConstraintsDWUhwKw() {
        LookaheadPassDelegate lookaheadPassDelegate = this.lookaheadPassDelegate;
        if (lookaheadPassDelegate != null) {
            return lookaheadPassDelegate.m4272getLastConstraintsDWUhwKw();
        }
        return null;
    }
