...
public final class ScaffoldKt {
    ...
    */
    public static final void m1320Scaffold27mzLpw(androidx.compose.ui.Modifier r41, androidx.compose.material.ScaffoldState r42, X5.n r43, X5.n r44, X5.o r45, X5.n r46, int r47, boolean r48, X5.o r49, boolean r50, androidx.compose.ui.graphics.Shape r51, float r52, long r53, long r55, long r57, long r59, long r61, X5.o r63, androidx.compose.runtime.Composer r64, int r65, int r66, int r67) {
        /*
            Method dump skipped, instructions count: 1275
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.ScaffoldKt.m1320Scaffold27mzLpw(androidx.compose.ui.Modifier, androidx.compose.material.ScaffoldState, X5.n, X5.n, X5.o, X5.n, int, boolean, X5.o, boolean, androidx.compose.ui.graphics.Shape, float, long, long, long, long, long, X5.o, androidx.compose.runtime.Composer, int, int, int):void");
    }
    ...
    public static final void m1321ScaffoldLayoutMDYNRJg(boolean z8, int i8, n nVar, o oVar, n nVar2, n nVar3, n nVar4, Composer composer, int i9) {
        int i10;
        Composer composer2;
        int i11;
        int i12;
        ...
        if ((3670016 & i9) == 0) {
            if (startRestartGroup.changedInstance(nVar4)) {
                i12 = 1048576;
            } else {
                i12 = 524288;
            }
        ...
        if ((2995931 & i10) == 599186 && startRestartGroup.getSkipping()) {
            ...
            Object[] objArr = {nVar, nVar2, nVar3, FabPosition.m1249boximpl(i8), Boolean.valueOf(z8), nVar4, oVar};
            ...
            if (!z9 && rememberedValue != Composer.Companion.getEmpty()) {
                ...
                composer2 = startRestartGroup;
                i11 = 1;
                ScaffoldKt$ScaffoldLayout$1$1 scaffoldKt$ScaffoldLayout$1$1 = new ScaffoldKt$ScaffoldLayout$1$1(nVar, nVar2, nVar3, i8, z8, nVar4, i10, oVar);
                composer2.updateRememberedValue(scaffoldKt$ScaffoldLayout$1$1);
                rememberedValue = scaffoldKt$ScaffoldLayout$1$1;
            }
            composer2.endReplaceableGroup();
            SubcomposeLayoutKt.SubcomposeLayout(null, (n) rememberedValue, composer2, 0, i11);
            if (ComposerKt.isTraceInProgress()) {
        ...
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new ScaffoldKt$ScaffoldLayout$2(z8, i8, nVar, oVar, nVar2, nVar3, nVar4, i9));
        }
    }
