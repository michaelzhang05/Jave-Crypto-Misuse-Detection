...
final class SwipeableKt$rememberSwipeableStateFor$1 extends l implements n {
    ...
    public final Object invoke(M m8, d dVar) {
        return ((SwipeableKt$rememberSwipeableStateFor$1) create(m8, dVar)).invokeSuspend(I.f6487a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i8 != 0) {
            ...
            if (!AbstractC3159y.d(this.$value, this.$swipeableState.getCurrentValue())) {
                ...
                T t8 = this.$value;
                this.label = 1;
                if (SwipeableState.animateTo$default(swipeableState, t8, null, this, 2, null) == e8) {
                    return e8;
                }
            }
        }
