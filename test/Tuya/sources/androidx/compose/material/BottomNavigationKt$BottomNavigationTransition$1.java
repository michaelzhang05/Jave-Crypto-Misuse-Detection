...
public final class BottomNavigationKt$BottomNavigationTransition$1 extends AbstractC3160z implements n {
    ...
    public BottomNavigationKt$BottomNavigationTransition$1(o oVar, int i8, State<Float> state) {
        super(2);
        this.$content = oVar;
        this.$$dirty = i8;
    ...
    public final void invoke(Composer composer, int i8) {
        ...
        oVar.invoke(Float.valueOf(BottomNavigationTransition_Klgx_Pg$lambda$3), composer, Integer.valueOf((this.$$dirty >> 6) & 112));
        if (ComposerKt.isTraceInProgress()) {
