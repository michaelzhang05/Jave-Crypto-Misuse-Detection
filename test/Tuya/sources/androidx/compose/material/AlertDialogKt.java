...
public final class AlertDialogKt {
    ...
    static {
        ...
        float f8 = 24;
        TitlePadding = PaddingKt.m604paddingqDBjuR0$default(companion, Dp.m5178constructorimpl(f8), 0.0f, Dp.m5178constructorimpl(f8), 0.0f, 10, null);
        TextPadding = PaddingKt.m604paddingqDBjuR0$default(companion, Dp.m5178constructorimpl(f8), 0.0f, Dp.m5178constructorimpl(f8), Dp.m5178constructorimpl(28), 2, null);
    ...
    public static final void AlertDialogBaselineLayout(ColumnScope columnScope, n nVar, n nVar2, Composer composer, int i8) {
        int i9;
        int i10;
        int i11;
        int i12;
        AbstractC3159y.i(columnScope, "<this>");
        ...
        if ((i9 & 731) == 146 && startRestartGroup.getSkipping()) {
            ...
            AlertDialogKt$AlertDialogBaselineLayout$2 alertDialogKt$AlertDialogBaselineLayout$2 = new MeasurePolicy() { // from class: androidx.compose.material.AlertDialogKt$AlertDialogBaselineLayout$2
                ...
                */
                public final androidx.compose.ui.layout.MeasureResult mo132measure3p2s80s(androidx.compose.ui.layout.MeasureScope r12, java.util.List<? extends androidx.compose.ui.layout.Measurable> r13, long r14) {
                    /*
                        Method dump skipped, instructions count: 321
                        To view this dump add '--comments-level debug' option
                    */
                    throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.AlertDialogKt$AlertDialogBaselineLayout$2.mo132measure3p2s80s(androidx.compose.ui.layout.MeasureScope, java.util.List, long):androidx.compose.ui.layout.MeasureResult");
                }
            ...
            o modifierMaterializerOf = LayoutKt.modifierMaterializerOf(weight);
            ...
            Updater.m2503setimpl(m2496constructorimpl, alertDialogKt$AlertDialogBaselineLayout$2, companion.getSetMeasurePolicy());
            ...
            if (nVar2 != null) {
                ...
                o modifierMaterializerOf3 = LayoutKt.modifierMaterializerOf(align2);
                if (!(startRestartGroup.getApplier() instanceof Applier)) {
                    ComposablesKt.invalidApplier();
                }
                startRestartGroup.startReusableNode();
                ...
                nVar2.invoke(startRestartGroup, 0);
                startRestartGroup.endReplaceableGroup();
                startRestartGroup.endNode();
                startRestartGroup.endReplaceableGroup();
                startRestartGroup.endReplaceableGroup();
        ...
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new AlertDialogKt$AlertDialogBaselineLayout$3(columnScope, nVar, nVar2, i8));
        }
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static final void m1095AlertDialogContentWMdw5o4(X5.n r25, androidx.compose.ui.Modifier r26, X5.n r27, X5.n r28, androidx.compose.ui.graphics.Shape r29, long r30, long r32, androidx.compose.runtime.Composer r34, int r35, int r36) {
        /*
            Method dump skipped, instructions count: 460
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.AlertDialogKt.m1095AlertDialogContentWMdw5o4(X5.n, androidx.compose.ui.Modifier, X5.n, X5.n, androidx.compose.ui.graphics.Shape, long, long, androidx.compose.runtime.Composer, int, int):void");
    }

    @Composable
    @ComposableInferredTarget(scheme = "[androidx.compose.ui.UiComposable[androidx.compose.ui.UiComposable]]")
    /* renamed from: AlertDialogFlowRow-ixp7dh8, reason: not valid java name */
    public static final void m1096AlertDialogFlowRowixp7dh8(final float f8, final float f9, n content, Composer composer, int i8) {
        int i9;
        int i10;
        int i11;
        int i12;
        ...
        if ((i9 & 731) == 146 && startRestartGroup.getSkipping()) {
            ...
            MeasurePolicy measurePolicy = new MeasurePolicy() { // from class: androidx.compose.material.AlertDialogKt$AlertDialogFlowRow$1
                ...
                private static final void measure_3p2s80s$startNewSequence(List<List<Placeable>> list, Q q8, MeasureScope measureScope, float f10, List<Placeable> list2, List<Integer> list3, Q q9, List<Integer> list4, Q q10, Q q11) {
                    ...
                    list.add(0, AbstractC1246t.W0(list2));
                ...
                public final MeasureResult mo132measure3p2s80s(MeasureScope Layout, List<? extends Measurable> measurables, long j8) {
                    ...
                    Q q12 = new Q();
                    Q q13 = new Q();
                    long Constraints$default = ConstraintsKt.Constraints$default(0, Constraints.m5146getMaxWidthimpl(j8), 0, 0, 13, null);
                    Iterator<? extends Measurable> it = measurables.iterator();
                    while (it.hasNext()) {
                        Placeable mo4131measureBRTryo0 = it.next().mo4131measureBRTryo0(Constraints$default);
                    ...
                    if (Constraints.m5146getMaxWidthimpl(j8) != Integer.MAX_VALUE) {
                        max = Constraints.m5146getMaxWidthimpl(j8);
                    } else {
                        max = Math.max(q10.f33759a, Constraints.m5148getMinWidthimpl(j8));
                    }
                    int i13 = max;
                    return MeasureScope.CC.q(Layout, i13, Math.max(q16.f33759a, Constraints.m5147getMinHeightimpl(j8)), null, new AlertDialogKt$AlertDialogFlowRow$1$measure$1(arrayList2, Layout, f8, i13, arrayList4), 4, null);
                }
