...
public final class NavigationRailKt$NavigationRailItem$styledLabel$1$1 extends AbstractC3160z implements n {
    ...
    public NavigationRailKt$NavigationRailItem$styledLabel$1$1(n nVar, int i8) {
        super(2);
        this.$label = nVar;
        this.$$dirty = i8;
    }
    ...
    public final void invoke(Composer composer, int i8) {
        ...
        TextKt.ProvideTextStyle(m4719copyv2rsoow, this.$label, composer, (this.$$dirty >> 12) & 112);
        if (ComposerKt.isTraceInProgress()) {
