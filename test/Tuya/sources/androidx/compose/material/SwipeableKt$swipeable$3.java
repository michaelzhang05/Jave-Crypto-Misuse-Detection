    ...
    public static final class AnonymousClass3 extends l implements n {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i8 != 0) {
                ...
                this.$state.setVelocityThreshold$material_release(this.$density.mo448toPx0680j_4(this.$velocityThreshold));
    ...
    public final Modifier invoke(Modifier composed, Composer composer, int i8) {
        ...
        if (!this.$anchors.isEmpty()) {
            if (AbstractC1246t.e0(this.$anchors.values()).size() == this.$anchors.size()) {
                ...
                Modifier draggable$default = DraggableKt.draggable$default(companion, draggableState$material_release, orientation, z8, mutableInteractionSource, isAnimationRunning, null, (o) rememberedValue, this.$reverseDirection, 32, null);
                if (ComposerKt.isTraceInProgress()) {
