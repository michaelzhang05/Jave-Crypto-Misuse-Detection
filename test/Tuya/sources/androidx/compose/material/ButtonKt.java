...
public final class ButtonKt {
    ...
    */
    public static final void Button(kotlin.jvm.functions.Function0 r36, androidx.compose.ui.Modifier r37, boolean r38, androidx.compose.foundation.interaction.MutableInteractionSource r39, androidx.compose.material.ButtonElevation r40, androidx.compose.ui.graphics.Shape r41, androidx.compose.foundation.BorderStroke r42, androidx.compose.material.ButtonColors r43, androidx.compose.foundation.layout.PaddingValues r44, X5.o r45, androidx.compose.runtime.Composer r46, int r47, int r48) {
        /*
            Method dump skipped, instructions count: 834
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.ButtonKt.Button(kotlin.jvm.functions.Function0, androidx.compose.ui.Modifier, boolean, androidx.compose.foundation.interaction.MutableInteractionSource, androidx.compose.material.ButtonElevation, androidx.compose.ui.graphics.Shape, androidx.compose.foundation.BorderStroke, androidx.compose.material.ButtonColors, androidx.compose.foundation.layout.PaddingValues, X5.o, androidx.compose.runtime.Composer, int, int):void");
    }
    ...
    public static final void OutlinedButton(Function0 onClick, Modifier modifier, boolean z8, MutableInteractionSource mutableInteractionSource, ButtonElevation buttonElevation, Shape shape, BorderStroke borderStroke, ButtonColors buttonColors, PaddingValues paddingValues, o content, Composer composer, int i8, int i9) {
        Modifier modifier2;
        boolean z9;
        ...
        if ((i9 & 128) != 0) {
            buttonColors2 = ButtonDefaults.INSTANCE.m1150outlinedButtonColorsRGew2ao(0L, 0L, 0L, composer, 3072, 7);
        } else {
    ...
    @Composable
    @ComposableInferredTarget(scheme = "[androidx.compose.ui.UiComposable[androidx.compose.ui.UiComposable][androidx.compose.ui.UiComposable]]")
    public static final void TextButton(Function0 onClick, Modifier modifier, boolean z8, MutableInteractionSource mutableInteractionSource, ButtonElevation buttonElevation, Shape shape, BorderStroke borderStroke, ButtonColors buttonColors, PaddingValues paddingValues, o content, Composer composer, int i8, int i9) {
        Modifier modifier2;
        boolean z9;
        MutableInteractionSource mutableInteractionSource2;
        ButtonElevation buttonElevation2;
        ...
        if ((i9 & 128) != 0) {
            buttonColors2 = ButtonDefaults.INSTANCE.m1151textButtonColorsRGew2ao(0L, 0L, 0L, composer, 3072, 7);
        } else {
            buttonColors2 = buttonColors;
        }
        if ((i9 & 256) != 0) {
