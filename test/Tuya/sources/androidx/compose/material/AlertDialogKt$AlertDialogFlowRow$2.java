...
public final class AlertDialogKt$AlertDialogFlowRow$2 extends AbstractC3160z implements n {
    ...
    public final void invoke(Composer composer, int i8) {
        AlertDialogKt.m1096AlertDialogFlowRowixp7dh8(this.$mainAxisSpacing, this.$crossAxisSpacing, this.$content, composer, RecomposeScopeImplKt.updateChangedFlags(this.$$changed | 1));
    }
}
