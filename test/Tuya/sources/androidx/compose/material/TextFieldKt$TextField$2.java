...
public final class TextFieldKt$TextField$2 extends AbstractC3160z implements o {
    ...
    public TextFieldKt$TextField$2(String str, boolean z8, boolean z9, VisualTransformation visualTransformation, MutableInteractionSource mutableInteractionSource, boolean z10, n nVar, n nVar2, n nVar3, n nVar4, TextFieldColors textFieldColors, int i8, int i9) {
        super(3);
        this.$value = str;
        this.$enabled = z8;
        this.$singleLine = z9;
