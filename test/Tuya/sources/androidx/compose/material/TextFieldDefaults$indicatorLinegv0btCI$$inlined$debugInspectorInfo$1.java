...
public final class TextFieldDefaults$indicatorLinegv0btCI$$inlined$debugInspectorInfo$1 extends AbstractC3160z implements Function1 {
    ...
    public final void invoke(InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set("focusedIndicatorLineThickness", Dp.m5176boximpl(this.$focusedIndicatorLineThickness$inlined));
        inspectorInfo.getProperties().set("unfocusedIndicatorLineThickness", Dp.m5176boximpl(this.$unfocusedIndicatorLineThickness$inlined));
    }
}
