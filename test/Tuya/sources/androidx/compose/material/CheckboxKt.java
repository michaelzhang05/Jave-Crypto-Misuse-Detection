...
public final class CheckboxKt {
    ...
    private static final float CheckboxRippleRadius = Dp.m5178constructorimpl(24);
    private static final float CheckboxSize = Dp.m5178constructorimpl(20);
    ...
    static {
        float f8 = 2;
        CheckboxDefaultPadding = Dp.m5178constructorimpl(f8);
        StrokeWidth = Dp.m5178constructorimpl(f8);
        RadiusSize = Dp.m5178constructorimpl(f8);
    }
    ...
    */
    ...
    public static final void m1158drawBox1wkBAMs(DrawScope drawScope, long j8, long j9, float f8, float f9) {
        float f10 = f9 / 2.0f;
        ...
        if (Color.m2972equalsimpl0(j8, j9)) {
            c.M(drawScope, j8, 0L, SizeKt.Size(m2804getWidthimpl, m2804getWidthimpl), CornerRadiusKt.CornerRadius$default(f8, 0.0f, 2, null), Fill.INSTANCE, 0.0f, null, 0, 226, null);
            return;
        }
        float f11 = m2804getWidthimpl - (2 * f9);
        ...
        float f12 = m2804getWidthimpl - f9;
    ...
    public static final void m1159drawCheck3IgeMak(DrawScope drawScope, long j8, float f8, float f9, float f10, CheckDrawingCache checkDrawingCache) {
        Stroke stroke = new Stroke(f10, 0.0f, StrokeCap.Companion.m3303getSquareKaPHkGw(), 0, null, 26, null);
        float m2804getWidthimpl = Size.m2804getWidthimpl(drawScope.mo3414getSizeNHjbRc());
        ...
        checkDrawingCache.getCheckPath().moveTo(0.2f * m2804getWidthimpl, lerp3 * m2804getWidthimpl);
        checkDrawingCache.getCheckPath().lineTo(lerp * m2804getWidthimpl, lerp2 * m2804getWidthimpl);
        checkDrawingCache.getCheckPath().lineTo(0.8f * m2804getWidthimpl, m2804getWidthimpl * lerp4);
