...
public final class TabRowDefaults {
    ...
    private static final float DividerThickness = Dp.m5178constructorimpl(1);
    private static final float IndicatorHeight = Dp.m5178constructorimpl(2);
    ...
    public final void m1378Divider9IZ8Weo(Modifier modifier, float f8, long j8, Composer composer, int i8, int i9) {
        Modifier modifier2;
        int i10;
        int i11;
        float f9;
        ...
        if ((i10 & 5851) == 1170 && startRestartGroup.getSkipping()) {
            ...
            if ((i8 & 1) != 0 && !startRestartGroup.getDefaultsInvalid()) {
                ...
                if ((i9 & 4) != 0) {
                    j9 = Color.m2970copywmQWz5c$default(((Color) startRestartGroup.consume(ContentColorKt.getLocalContentColor())).m2981unboximpl(), 0.12f, 0.0f, 0.0f, 0.0f, 14, null);
                    i10 &= -897;
                }
            }
            long j11 = j9;
            ...
            DividerKt.m1213DivideroMI9zvI(modifier3, j10, f10, 0.0f, startRestartGroup, (i16 & 14) | ((i16 >> 3) & 112) | ((i16 << 3) & 896), 8);
            if (ComposerKt.isTraceInProgress()) {
    ...
    */
    public final void m1379Indicator9IZ8Weo(androidx.compose.ui.Modifier r17, float r18, long r19, androidx.compose.runtime.Composer r21, int r22, int r23) {
        /*
            Method dump skipped, instructions count: 267
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.TabRowDefaults.m1379Indicator9IZ8Weo(androidx.compose.ui.Modifier, float, long, androidx.compose.runtime.Composer, int, int):void");
    }

    /* renamed from: getDividerThickness-D9Ej5fM, reason: not valid java name */
    public final float m1380getDividerThicknessD9Ej5fM() {
        return DividerThickness;
    }

    /* renamed from: getIndicatorHeight-D9Ej5fM, reason: not valid java name */
    public final float m1381getIndicatorHeightD9Ej5fM() {
        return IndicatorHeight;
    }

    /* renamed from: getScrollableTabRowPadding-D9Ej5fM, reason: not valid java name */
    public final float m1382getScrollableTabRowPaddingD9Ej5fM() {
