...
public final class SliderKt$RangeSlider$2 extends AbstractC3160z implements o {
    ...
    public final void invoke(BoxWithConstraintsScope BoxWithConstraints, Composer composer, int i8) {
        ...
        p8.f33758a = m5146getMaxWidthimpl - density.mo448toPx0680j_4(SliderKt.getThumbRadius());
        p9.f33758a = density.mo448toPx0680j_4(SliderKt.getThumbRadius());
        ...
        SliderKt.CorrectValueSideEffect(new AnonymousClass2(this.$valueRange, p9, p8), this.$valueRange, m.b(p9.f33758a, p8.f33758a), mutableFloatState, ((Number) this.$value.getStart()).floatValue(), composer, ((this.$$dirty >> 9) & 112) | 3072);
        SliderKt.CorrectValueSideEffect(new AnonymousClass3(this.$valueRange, p9, p8), this.$valueRange, m.b(p9.f33758a, p8.f33758a), mutableFloatState2, ((Number) this.$value.getEndInclusive()).floatValue(), composer, ((this.$$dirty >> 9) & 112) | 3072);
        ...
        float f8 = p8.f33758a - p9.f33758a;
