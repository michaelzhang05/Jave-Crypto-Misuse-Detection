...
final class TextFieldImplKt$CommonDecorationBox$3 extends AbstractC3160z implements r {
    ...
    public TextFieldImplKt$CommonDecorationBox$3(n nVar, n nVar2, String str, boolean z8, int i8, TextFieldColors textFieldColors, boolean z9, InteractionSource interactionSource, int i9, n nVar3, n nVar4, TextFieldType textFieldType, n nVar5, boolean z10, PaddingValues paddingValues, boolean z11, n nVar6) {
        super(6);
        this.$label = nVar;
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object obj, Object obj2, Object obj3, Object obj4, Object obj5, Object obj6) {
        m1405invokeRIQooxk(((Number) obj).floatValue(), ((Color) obj2).m2981unboximpl(), ((Color) obj3).m2981unboximpl(), ((Number) obj4).floatValue(), (Composer) obj5, ((Number) obj6).intValue());
        return I.f6487a;
    }
    ...
    public final void m1405invokeRIQooxk(float f8, long j8, long j9, float f9, Composer composer, int i8) {
        int i9;
        ?? r14;
        ...
        if (nVar != null) {
            r14 = 1;
            composableLambda = ComposableLambdaKt.composableLambda(composer, 362863774, true, new TextFieldImplKt$CommonDecorationBox$3$decoratedLabel$1$1(f8, j9, nVar, i14, this.$shouldOverrideTextStyleColor, j8));
        } else {
            r14 = 1;
        ...
        String m1351getString4foXLRw = Strings_androidKt.m1351getString4foXLRw(Strings.Companion.m1346getDefaultErrorMessageUdPEhr4(), composer, 6);
        Modifier.Companion companion = Modifier.Companion;
        Object valueOf = Boolean.valueOf(this.$isError);
        boolean z8 = this.$isError;
        composer.startReplaceableGroup(511388516);
        boolean changed = composer.changed(valueOf) | composer.changed(m1351getString4foXLRw);
        Object rememberedValue = composer.rememberedValue();
        if (changed || rememberedValue == Composer.Companion.getEmpty()) {
            rememberedValue = new TextFieldImplKt$CommonDecorationBox$3$decorationBoxModifier$1$1(z8, m1351getString4foXLRw);
        ...
        if (this.$colors instanceof TextFieldColorsWithIcons) {
            ...
            int i16 = this.$$dirty1;
            m2981unboximpl = textFieldColorsWithIcons.leadingIconColor(z9, z10, interactionSource, composer, ((i16 << 3) & 896) | i15 | ((i16 << 3) & 112)).getValue().m2981unboximpl();
            composer.endReplaceableGroup();
        } else {
            ...
            int i18 = this.$$dirty1;
            m2981unboximpl = textFieldColors.leadingIconColor(z11, z12, composer, i17 | ((i18 << 3) & 112) | ((i18 >> 3) & 896)).getValue().m2981unboximpl();
            composer.endReplaceableGroup();
        }
        n nVar2 = this.$leadingIcon;
        if (nVar2 != null) {
            composableLambda3 = ComposableLambdaKt.composableLambda(composer, 1505327088, r14, new TextFieldImplKt$CommonDecorationBox$3$decoratedLeading$1$1(m2981unboximpl, nVar2));
        } else {
        ...
        if (this.$colors instanceof TextFieldColorsWithIcons) {
            ...
            int i20 = this.$$dirty1;
            m2981unboximpl2 = textFieldColorsWithIcons2.trailingIconColor(z13, z14, interactionSource2, composer, ((i20 << 3) & 896) | i19 | ((i20 << 3) & 112)).getValue().m2981unboximpl();
            composer.endReplaceableGroup();
        } else {
            ...
            int i22 = this.$$dirty1;
            m2981unboximpl2 = textFieldColors2.trailingIconColor(z15, z16, composer, i21 | ((i22 << 3) & 112) | ((i22 >> 3) & 896)).getValue().m2981unboximpl();
            composer.endReplaceableGroup();
        }
        n nVar3 = this.$trailingIcon;
        if (nVar3 != null) {
            composableLambda4 = ComposableLambdaKt.composableLambda(composer, -1894727196, r14, new TextFieldImplKt$CommonDecorationBox$3$decoratedTrailing$1$1(m2981unboximpl2, nVar3));
        } else {
        ...
        if (i23 != r14) {
            if (i23 != 2) {
                ...
                OutlinedTextFieldKt.OutlinedTextFieldLayout(semantics$default, nVar4, composableLambda6, composableLambda7, composableLambda8, composableLambda4, z17, f8, function1, composableLambda5, paddingValues, composer, ((i24 >> 6) & 3670016) | ((i24 >> 3) & 112) | 805306368 | ((i14 << 21) & 29360128), (this.$$dirty1 >> 6) & 14);
                composer.endReplaceableGroup();
            }
        } else {
            ...
            int i25 = this.$$dirty;
            TextFieldKt.TextFieldLayout(semantics$default, nVar5, composableLambda, composableLambda2, composableLambda3, composableLambda4, z18, f8, paddingValues2, composer, ((i25 >> 6) & 3670016) | ((i25 >> 3) & 112) | ((i14 << 21) & 29360128) | ((this.$$dirty1 << 18) & 234881024));
            composer.endReplaceableGroup();
        }
        if (ComposerKt.isTraceInProgress()) {
