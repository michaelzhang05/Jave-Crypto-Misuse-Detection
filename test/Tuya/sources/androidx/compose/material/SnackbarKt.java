...
public final class SnackbarKt {
    ...
    private static final float SnackbarMinHeightOneLine = Dp.m5178constructorimpl(48);
    private static final float SnackbarMinHeightTwoLines = Dp.m5178constructorimpl(68);
    ...
    public static final void NewLineButtonSnackbar(n nVar, n nVar2, Composer composer, int i8) {
        int i9;
        int i10;
        int i11;
        ...
        if ((i9 & 91) == 18 && startRestartGroup.getSkipping()) {
            ...
            Modifier m604paddingqDBjuR0$default = PaddingKt.m604paddingqDBjuR0$default(fillMaxWidth$default, f8, 0.0f, f9, SeparateButtonExtraY, 2, null);
            ...
            Modifier m604paddingqDBjuR0$default2 = PaddingKt.m604paddingqDBjuR0$default(AlignmentLineKt.m488paddingFromBaselineVpY3zN4(companion, HeightToFirstLine, LongButtonVerticalOffset), 0.0f, 0.0f, f9, 0.0f, 11, null);
        ...
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new SnackbarKt$NewLineButtonSnackbar$2(nVar, nVar2, i8));
        }
    }
    ...
    @Composable
    @ComposableInferredTarget(scheme = "[androidx.compose.ui.UiComposable[androidx.compose.ui.UiComposable][androidx.compose.ui.UiComposable]]")
    public static final void OneRowSnackbar(n nVar, n nVar2, Composer composer, int i8) {
        int i9;
        int i10;
        int i11;
        ...
        if ((i9 & 91) == 18 && startRestartGroup.getSkipping()) {
            ...
            Modifier.Companion companion = Modifier.Companion;
            Modifier m604paddingqDBjuR0$default = PaddingKt.m604paddingqDBjuR0$default(companion, HorizontalSpacing, 0.0f, HorizontalSpacingButtonSide, 0.0f, 10, null);
            ...
            MeasurePolicy measurePolicy = new MeasurePolicy() { // from class: androidx.compose.material.SnackbarKt$OneRowSnackbar$2
                ...
                public final MeasureResult mo132measure3p2s80s(MeasureScope Layout, List<? extends Measurable> measurables, long j8) {
                    ...
                    for (Measurable measurable : list) {
                        if (AbstractC3159y.d(LayoutIdKt.getLayoutId(measurable), str3)) {
                            Placeable mo4131measureBRTryo0 = measurable.mo4131measureBRTryo0(j8);
                            int m5146getMaxWidthimpl = Constraints.m5146getMaxWidthimpl(j8) - mo4131measureBRTryo0.getWidth();
                            f8 = SnackbarKt.TextEndExtraSpacing;
                            int d8 = m.d(m5146getMaxWidthimpl - Layout.mo442roundToPx0680j_4(f8), Constraints.m5148getMinWidthimpl(j8));
                            String str4 = str2;
                            for (Measurable measurable2 : list) {
                                if (AbstractC3159y.d(LayoutIdKt.getLayoutId(measurable2), str4)) {
                                    Placeable mo4131measureBRTryo02 = measurable2.mo4131measureBRTryo0(Constraints.m5137copyZbe2FdA$default(j8, 0, d8, 0, 0, 9, null));
                                    int i14 = mo4131measureBRTryo02.get(androidx.compose.ui.layout.AlignmentLineKt.getFirstBaseline());
                                    if (i14 != Integer.MIN_VALUE) {
                                        int i15 = mo4131measureBRTryo02.get(androidx.compose.ui.layout.AlignmentLineKt.getLastBaseline());
                                        if (i15 != Integer.MIN_VALUE) {
                                            ...
                                            int m5146getMaxWidthimpl2 = Constraints.m5146getMaxWidthimpl(j8) - mo4131measureBRTryo0.getWidth();
                                            if (z8) {
                                                f11 = SnackbarKt.SnackbarMinHeightOneLine;
                                                i12 = Math.max(Layout.mo442roundToPx0680j_4(f11), mo4131measureBRTryo0.getHeight());
                                                int height2 = (i12 - mo4131measureBRTryo02.getHeight()) / 2;
                                                int i17 = mo4131measureBRTryo0.get(androidx.compose.ui.layout.AlignmentLineKt.getFirstBaseline());
                                                ...
                                                int mo442roundToPx0680j_4 = Layout.mo442roundToPx0680j_4(f9) - i14;
                                                f10 = SnackbarKt.SnackbarMinHeightTwoLines;
                                                int max = Math.max(Layout.mo442roundToPx0680j_4(f10), mo4131measureBRTryo02.getHeight() + mo442roundToPx0680j_4);
                                                i12 = max;
                                                i13 = mo442roundToPx0680j_4;
                                                height = (max - mo4131measureBRTryo0.getHeight()) / 2;
                                            }
                                            return MeasureScope.CC.q(Layout, Constraints.m5146getMaxWidthimpl(j8), i12, null, new SnackbarKt$OneRowSnackbar$2$measure$4(mo4131measureBRTryo02, i13, mo4131measureBRTryo0, m5146getMaxWidthimpl2, height), 4, null);
                                        }
        ...
        ScopeUpdateScope endRestartGroup = startRestartGroup.endRestartGroup();
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new SnackbarKt$OneRowSnackbar$3(nVar, nVar2, i8));
        }
    }
    ...
    */
    public static final void m1334Snackbar7zSek6w(androidx.compose.ui.Modifier r27, X5.n r28, boolean r29, androidx.compose.ui.graphics.Shape r30, long r31, long r33, float r35, X5.n r36, androidx.compose.runtime.Composer r37, int r38, int r39) {
        /*
            Method dump skipped, instructions count: 515
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.SnackbarKt.m1334Snackbar7zSek6w(androidx.compose.ui.Modifier, X5.n, boolean, androidx.compose.ui.graphics.Shape, long, long, float, X5.n, androidx.compose.runtime.Composer, int, int):void");
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static final void m1335SnackbarsPrSdHI(androidx.compose.material.SnackbarData r29, androidx.compose.ui.Modifier r30, boolean r31, androidx.compose.ui.graphics.Shape r32, long r33, long r35, long r37, float r39, androidx.compose.runtime.Composer r40, int r41, int r42) {
        /*
            Method dump skipped, instructions count: 588
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.SnackbarKt.m1335SnackbarsPrSdHI(androidx.compose.material.SnackbarData, androidx.compose.ui.Modifier, boolean, androidx.compose.ui.graphics.Shape, long, long, long, float, androidx.compose.runtime.Composer, int, int):void");
    }

    /* JADX INFO: Access modifiers changed from: private */
    @Composable
    @ComposableInferredTarget(scheme = "[androidx.compose.ui.UiComposable[androidx.compose.ui.UiComposable]]")
    public static final void TextOnlySnackbar(n nVar, Composer composer, int i8) {
        int i9;
        int i10;
        ...
        if ((i9 & 11) == 2 && startRestartGroup.getSkipping()) {
            ...
            SnackbarKt$TextOnlySnackbar$2 snackbarKt$TextOnlySnackbar$2 = new MeasurePolicy() { // from class: androidx.compose.material.SnackbarKt$TextOnlySnackbar$2
                ...
                public final MeasureResult mo132measure3p2s80s(MeasureScope Layout, List<? extends Measurable> measurables, long j8) {
                    ...
                    if (measurables.size() == 1) {
                        Placeable mo4131measureBRTryo0 = ((Measurable) AbstractC1246t.m0(measurables)).mo4131measureBRTryo0(j8);
                        int i11 = mo4131measureBRTryo0.get(androidx.compose.ui.layout.AlignmentLineKt.getFirstBaseline());
                        int i12 = mo4131measureBRTryo0.get(androidx.compose.ui.layout.AlignmentLineKt.getLastBaseline());
                        if (i11 != Integer.MIN_VALUE) {
                            if (i12 != Integer.MIN_VALUE) {
                                int max = Math.max(Layout.mo442roundToPx0680j_4(i11 == i12 ? SnackbarKt.SnackbarMinHeightOneLine : SnackbarKt.SnackbarMinHeightTwoLines), mo4131measureBRTryo0.getHeight());
                                return MeasureScope.CC.q(Layout, Constraints.m5146getMaxWidthimpl(j8), max, null, new SnackbarKt$TextOnlySnackbar$2$measure$4(max, mo4131measureBRTryo0), 4, null);
                            }
                            throw new IllegalArgumentException("No baselines for text".toString());
                        }
                        throw new IllegalArgumentException("No baselines for text".toString());
            ...
            Composer m2496constructorimpl = Updater.m2496constructorimpl(startRestartGroup);
            Updater.m2503setimpl(m2496constructorimpl, snackbarKt$TextOnlySnackbar$2, companion2.getSetMeasurePolicy());
            Updater.m2503setimpl(m2496constructorimpl, currentCompositionLocalMap, companion2.getSetResolvedCompositionLocals());
            n setCompositeKeyHash = companion2.getSetCompositeKeyHash();
            if (m2496constructorimpl.getInserting() || !AbstractC3159y.d(m2496constructorimpl.rememberedValue(), Integer.valueOf(currentCompositeKeyHash))) {
                m2496constructorimpl.updateRememberedValue(Integer.valueOf(currentCompositeKeyHash));
            ...
            modifierMaterializerOf.invoke(SkippableUpdater.m2485boximpl(SkippableUpdater.m2486constructorimpl(startRestartGroup)), startRestartGroup, 0);
            startRestartGroup.startReplaceableGroup(2058660585);
            Modifier m601paddingVpY3zN4 = PaddingKt.m601paddingVpY3zN4(companion, HorizontalSpacing, SnackbarVerticalPadding);
            startRestartGroup.startReplaceableGroup(733328855);
        ...
        ScopeUpdateScope endRestartGroup = startRestartGroup.endRestartGroup();
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new SnackbarKt$TextOnlySnackbar$3(nVar, i8));
        }
    }
}
