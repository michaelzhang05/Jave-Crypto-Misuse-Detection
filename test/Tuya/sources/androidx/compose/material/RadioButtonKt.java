...
public final class RadioButtonKt {
    ...
    private static final float RadioButtonRippleRadius = Dp.m5178constructorimpl(24);
    ...
    static {
        float f8 = 2;
        RadioButtonPadding = Dp.m5178constructorimpl(f8);
        float m5178constructorimpl = Dp.m5178constructorimpl(20);
        RadioButtonSize = m5178constructorimpl;
        RadioRadius = Dp.m5178constructorimpl(m5178constructorimpl / f8);
        RadioButtonDotSize = Dp.m5178constructorimpl(12);
        RadioStrokeWidth = Dp.m5178constructorimpl(f8);
    }
    ...
    */
    public static final void RadioButton(boolean r22, kotlin.jvm.functions.Function0 r23, androidx.compose.ui.Modifier r24, boolean r25, androidx.compose.foundation.interaction.MutableInteractionSource r26, androidx.compose.material.RadioButtonColors r27, androidx.compose.runtime.Composer r28, int r29, int r30) {
        /*
