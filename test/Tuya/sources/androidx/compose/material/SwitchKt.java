...
public final class SwitchKt {
    ...
    static {
        float m5178constructorimpl = Dp.m5178constructorimpl(34);
        TrackWidth = m5178constructorimpl;
        TrackStrokeWidth = Dp.m5178constructorimpl(14);
        float m5178constructorimpl2 = Dp.m5178constructorimpl(20);
        ThumbDiameter = m5178constructorimpl2;
        ThumbRippleRadius = Dp.m5178constructorimpl(24);
        DefaultSwitchPadding = Dp.m5178constructorimpl(2);
        SwitchWidth = m5178constructorimpl;
        SwitchHeight = m5178constructorimpl2;
        ThumbPathLength = Dp.m5178constructorimpl(m5178constructorimpl - m5178constructorimpl2);
        AnimationSpec = new TweenSpec<>(100, 0, null, 6, null);
        ThumbDefaultElevation = Dp.m5178constructorimpl(1);
        ThumbPressedElevation = Dp.m5178constructorimpl(6);
        SwitchVelocityThreshold = Dp.m5178constructorimpl(125);
    }
    ...
    */
    ...
    public static final void SwitchImpl(BoxScope boxScope, boolean z8, boolean z9, SwitchColors switchColors, Function0 function0, InteractionSource interactionSource, Composer composer, int i8) {
        ...
        if ((374491 & i9) == 74898 && startRestartGroup.getSkipping()) {
            ...
            startRestartGroup.endReplaceableGroup();
            EffectsKt.LaunchedEffect(interactionSource, (n) rememberedValue2, startRestartGroup, i16 | 64);
            ...
            float m5178constructorimpl = Dp.m5178constructorimpl(((Dp) startRestartGroup.consume(ElevationOverlayKt.getLocalAbsoluteElevation())).m5192unboximpl() + f9);
            startRestartGroup.startReplaceableGroup(-539243578);
            if (Color.m2972equalsimpl0(SwitchImpl$lambda$18(thumbColor), MaterialTheme.INSTANCE.getColors(startRestartGroup, 6).m1182getSurface0d7_KjU()) && elevationOverlay != null) {
                SwitchImpl$lambda$18 = elevationOverlay.mo1212apply7g2Lkgo(SwitchImpl$lambda$18(thumbColor), m5178constructorimpl, startRestartGroup, 0);
            } else {
                SwitchImpl$lambda$18 = SwitchImpl$lambda$18(thumbColor);
            }
            startRestartGroup.endReplaceableGroup();
            composer2 = startRestartGroup;
            State<Color> m187animateColorAsStateeuL9pac = SingleValueAnimationKt.m187animateColorAsStateeuL9pac(SwitchImpl$lambda$18, null, null, null, startRestartGroup, 0, 14);
            ...
            SpacerKt.Spacer(BackgroundKt.m281backgroundbw27NRU(ShadowKt.m2645shadows4CzXII$default(SizeKt.m639requiredSize3ABfNKs(IndicationKt.indication(OffsetKt.offset(align, (Function1) rememberedValue4), interactionSource, RippleKt.m1444rememberRipple9IZ8Weo(false, ThumbRippleRadius, 0L, composer2, 54, 4)), ThumbDiameter), f9, RoundedCornerShapeKt.getCircleShape(), false, 0L, 0L, 24, null), SwitchImpl$lambda$19(m187animateColorAsStateeuL9pac), RoundedCornerShapeKt.getCircleShape()), composer2, 0);
            if (ComposerKt.isTraceInProgress()) {
    ...
    public static final void m1367drawTrackRPmYEkk(DrawScope drawScope, long j8, float f8, float f9) {
        float f10 = f9 / 2;
        c.C(drawScope, j8, androidx.compose.ui.geometry.OffsetKt.Offset(f10, Offset.m2736getYimpl(drawScope.mo3413getCenterF1C5BW0())), androidx.compose.ui.geometry.OffsetKt.Offset(f8 - f10, Offset.m2736getYimpl(drawScope.mo3413getCenterF1C5BW0())), f9, StrokeCap.Companion.m3302getRoundKaPHkGw(), null, 0.0f, null, 0, 480, null);
    }
