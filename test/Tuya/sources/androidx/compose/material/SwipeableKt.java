    ...
    */
    public static final float computeTarget(float r3, float r4, java.util.Set<java.lang.Float> r5, X5.n r6, float r7, float r8) {
        ...
        L6c:
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.SwipeableKt.computeTarget(float, float, java.util.Set, X5.n, float, float):float");
    }
    ...
    public static final <T> Modifier m1363swipeablepPrIpRY(Modifier swipeable, SwipeableState<T> state, Map<Float, ? extends T> anchors, Orientation orientation, boolean z8, boolean z9, MutableInteractionSource mutableInteractionSource, n thresholds, ResistanceConfig resistanceConfig, float f8) {
    ...
    public static /* synthetic */ Modifier m1364swipeablepPrIpRY$default(Modifier modifier, SwipeableState swipeableState, Map map, Orientation orientation, boolean z8, boolean z9, MutableInteractionSource mutableInteractionSource, n nVar, ResistanceConfig resistanceConfig, float f8, int i8, Object obj) {
        boolean z10;
        boolean z11;
        ...
        if ((i8 & 256) != 0) {
            f9 = SwipeableDefaults.INSTANCE.m1362getVelocityThresholdD9Ej5fM();
        } else {
            f9 = f8;
        }
        return m1363swipeablepPrIpRY(modifier, swipeableState, map, orientation, z10, z11, mutableInteractionSource2, nVar2, resistanceConfig2, f9);
    }
}
