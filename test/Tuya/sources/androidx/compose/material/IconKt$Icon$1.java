...
public final class IconKt$Icon$1 extends AbstractC3160z implements n {
    ...
    public final void invoke(Composer composer, int i8) {
        IconKt.m1266Iconww6aTOc(this.$painter, this.$contentDescription, this.$modifier, this.$tint, composer, RecomposeScopeImplKt.updateChangedFlags(this.$$changed | 1), this.$$default);
    }
}
