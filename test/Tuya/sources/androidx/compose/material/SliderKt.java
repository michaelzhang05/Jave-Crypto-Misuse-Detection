...
public final class SliderKt {
    ...
    private static final float ThumbRadius = Dp.m5178constructorimpl(10);
    private static final float ThumbRippleRadius = Dp.m5178constructorimpl(24);
    private static final float ThumbDefaultElevation = Dp.m5178constructorimpl(1);
    private static final float ThumbPressedElevation = Dp.m5178constructorimpl(6);
    private static final float TrackHeight = Dp.m5178constructorimpl(4);
    ...
    @Composable
    public static final void CorrectValueSideEffect(Function1 function1, InterfaceC2561e interfaceC2561e, InterfaceC2561e interfaceC2561e2, MutableState<Float> mutableState, float f8, Composer composer, int i8) {
        int i9;
        int i10;
        int i11;
        int i12;
        ...
        if ((i8 & 112) == 0) {
            if (startRestartGroup.changed(interfaceC2561e)) {
                i13 = 32;
            } else {
                i13 = 16;
            }
        ...
        if ((i8 & 896) == 0) {
            if (startRestartGroup.changed(interfaceC2561e2)) {
                i12 = 256;
            } else {
                i12 = 128;
            }
        ...
        if ((i9 & 46811) == 9362 && startRestartGroup.getSkipping()) {
            ...
            Object[] objArr = {interfaceC2561e, function1, Float.valueOf(f8), mutableState, interfaceC2561e2};
            ...
            if (z8 || rememberedValue == Composer.Companion.getEmpty()) {
                rememberedValue = new SliderKt$CorrectValueSideEffect$1$1(interfaceC2561e, function1, f8, mutableState, interfaceC2561e2);
        ...
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new SliderKt$CorrectValueSideEffect$2(function1, interfaceC2561e, interfaceC2561e2, mutableState, f8, i8));
        }
    }
    ...
    */
    public static final void RangeSlider(d6.InterfaceC2561e r42, kotlin.jvm.functions.Function1 r43, androidx.compose.ui.Modifier r44, boolean r45, d6.InterfaceC2561e r46, int r47, kotlin.jvm.functions.Function0 r48, androidx.compose.material.SliderColors r49, androidx.compose.runtime.Composer r50, int r51, int r52) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.SliderKt.RangeSlider(d6.e, kotlin.jvm.functions.Function1, androidx.compose.ui.Modifier, boolean, d6.e, int, kotlin.jvm.functions.Function0, androidx.compose.material.SliderColors, androidx.compose.runtime.Composer, int, int):void");
    }
    ...
    public static final void RangeSliderImpl(boolean z8, float f8, float f9, List<Float> list, SliderColors sliderColors, float f10, MutableInteractionSource mutableInteractionSource, MutableInteractionSource mutableInteractionSource2, Modifier modifier, Modifier modifier2, Modifier modifier3, Composer composer, int i8, int i9) {
        ...
        String m1351getString4foXLRw = Strings_androidKt.m1351getString4foXLRw(companion.m1350getSliderRangeStartUdPEhr4(), startRestartGroup, 6);
        String m1351getString4foXLRw2 = Strings_androidKt.m1351getString4foXLRw(companion.m1349getSliderRangeEndUdPEhr4(), startRestartGroup, 6);
        ...
        float mo448toPx0680j_4 = density.mo448toPx0680j_4(TrackHeight);
        float f11 = ThumbRadius;
        float mo448toPx0680j_42 = density.mo448toPx0680j_4(f11);
        float mo444toDpu2uoSUM = density.mo444toDpu2uoSUM(f10);
        float m5178constructorimpl = Dp.m5178constructorimpl(f11 * 2);
        float m5178constructorimpl2 = Dp.m5178constructorimpl(mo444toDpu2uoSUM * f8);
        float m5178constructorimpl3 = Dp.m5178constructorimpl(mo444toDpu2uoSUM * f9);
        Modifier.Companion companion4 = Modifier.Companion;
        int i10 = i8 >> 9;
        int i11 = i8 << 6;
        Track(SizeKt.fillMaxSize$default(boxScopeInstance.align(companion4, companion2.getCenterStart()), 0.0f, 1, null), sliderColors, z8, f8, f9, list, mo448toPx0680j_42, mo448toPx0680j_4, startRestartGroup, (i10 & 112) | 262144 | (i11 & 896) | (i11 & 7168) | (i11 & 57344));
        startRestartGroup.startReplaceableGroup(1157296644);
        boolean changed = startRestartGroup.changed(m1351getString4foXLRw);
        Object rememberedValue = startRestartGroup.rememberedValue();
        if (changed || rememberedValue == Composer.Companion.getEmpty()) {
            rememberedValue = new SliderKt$RangeSliderImpl$1$2$1(m1351getString4foXLRw);
            startRestartGroup.updateRememberedValue(rememberedValue);
        }
        startRestartGroup.endReplaceableGroup();
        int i12 = i8 & 57344;
        int i13 = (i8 << 15) & 458752;
        m1325SliderThumbPcYyNuk(boxScopeInstance, FocusableKt.focusable(SemanticsModifierKt.semantics(companion4, true, (Function1) rememberedValue), true, mutableInteractionSource).then(modifier2), m5178constructorimpl2, mutableInteractionSource, sliderColors, z8, m5178constructorimpl, startRestartGroup, 1572870 | (i10 & 7168) | i12 | i13);
        startRestartGroup.startReplaceableGroup(1157296644);
        boolean changed2 = startRestartGroup.changed(m1351getString4foXLRw2);
        Object rememberedValue2 = startRestartGroup.rememberedValue();
        if (changed2 || rememberedValue2 == Composer.Companion.getEmpty()) {
            rememberedValue2 = new SliderKt$RangeSliderImpl$1$3$1(m1351getString4foXLRw2);
            startRestartGroup.updateRememberedValue(rememberedValue2);
        }
        startRestartGroup.endReplaceableGroup();
        m1325SliderThumbPcYyNuk(boxScopeInstance, FocusableKt.focusable(SemanticsModifierKt.semantics(companion4, true, (Function1) rememberedValue2), true, mutableInteractionSource2).then(modifier3), m5178constructorimpl3, mutableInteractionSource2, sliderColors, z8, m5178constructorimpl, startRestartGroup, 1572870 | ((i8 >> 12) & 7168) | i12 | i13);
        startRestartGroup.endReplaceableGroup();
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static final void Slider(float r38, kotlin.jvm.functions.Function1 r39, androidx.compose.ui.Modifier r40, boolean r41, d6.InterfaceC2561e r42, int r43, kotlin.jvm.functions.Function0 r44, androidx.compose.foundation.interaction.MutableInteractionSource r45, androidx.compose.material.SliderColors r46, androidx.compose.runtime.Composer r47, int r48, int r49) {
        /*
            Method dump skipped, instructions count: 726
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.SliderKt.Slider(float, kotlin.jvm.functions.Function1, androidx.compose.ui.Modifier, boolean, d6.e, int, kotlin.jvm.functions.Function0, androidx.compose.foundation.interaction.MutableInteractionSource, androidx.compose.material.SliderColors, androidx.compose.runtime.Composer, int, int):void");
    }
    ...
    public static final void SliderImpl(boolean z8, float f8, List<Float> list, SliderColors sliderColors, float f9, MutableInteractionSource mutableInteractionSource, Modifier modifier, Composer composer, int i8) {
        ...
        float mo448toPx0680j_42 = density.mo448toPx0680j_4(f10);
        float mo444toDpu2uoSUM = density.mo444toDpu2uoSUM(f9);
        float m5178constructorimpl = Dp.m5178constructorimpl(f10 * 2);
        float m5178constructorimpl2 = Dp.m5178constructorimpl(mo444toDpu2uoSUM * f8);
        Modifier.Companion companion2 = Modifier.Companion;
        int i9 = i8 >> 6;
        Track(SizeKt.fillMaxSize$default(companion2, 0.0f, 1, null), sliderColors, z8, 0.0f, f8, list, mo448toPx0680j_42, mo448toPx0680j_4, startRestartGroup, (i9 & 112) | 265222 | ((i8 << 6) & 896) | ((i8 << 9) & 57344));
        m1325SliderThumbPcYyNuk(boxScopeInstance, companion2, m5178constructorimpl2, mutableInteractionSource, sliderColors, z8, m5178constructorimpl, startRestartGroup, (i9 & 7168) | 1572918 | ((i8 << 3) & 57344) | ((i8 << 15) & 458752));
        startRestartGroup.endReplaceableGroup();
        startRestartGroup.endNode();
        startRestartGroup.endReplaceableGroup();
        startRestartGroup.endReplaceableGroup();
    ...
    public static final void m1325SliderThumbPcYyNuk(BoxScope boxScope, Modifier modifier, float f8, MutableInteractionSource mutableInteractionSource, SliderColors sliderColors, boolean z8, float f9, Composer composer, int i8) {
        int i9;
        float f10;
        ...
        if ((2995931 & i17) == 599186 && startRestartGroup.getSkipping()) {
            ...
            o modifierMaterializerOf = LayoutKt.modifierMaterializerOf(align);
            if (!(startRestartGroup.getApplier() instanceof Applier)) {
                ComposablesKt.invalidApplier();
            }
            startRestartGroup.startReusableNode();
            ...
            startRestartGroup.endReplaceableGroup();
            EffectsKt.LaunchedEffect(mutableInteractionSource, (n) rememberedValue2, startRestartGroup, i19 | 64);
            ...
            float f11 = f10;
            Modifier hoverable$default = HoverableKt.hoverable$default(IndicationKt.indication(SizeKt.m649sizeVpY3zN4(modifier, f9, f9), mutableInteractionSource, RippleKt.m1444rememberRipple9IZ8Weo(false, ThumbRippleRadius, 0L, startRestartGroup, 54, 4)), mutableInteractionSource, false, 2, null);
            if (z8) {
                m5178constructorimpl = f11;
            } else {
                m5178constructorimpl = Dp.m5178constructorimpl(0);
            }
            SpacerKt.Spacer(BackgroundKt.m281backgroundbw27NRU(ShadowKt.m2645shadows4CzXII$default(hoverable$default, m5178constructorimpl, RoundedCornerShapeKt.getCircleShape(), false, 0L, 0L, 24, null), sliderColors.thumbColor(z8, startRestartGroup, ((i17 >> 15) & 14) | (i18 & 112)).getValue().m2981unboximpl(), RoundedCornerShapeKt.getCircleShape()), startRestartGroup, 0);
            startRestartGroup.endReplaceableGroup();
            startRestartGroup.endNode();
            startRestartGroup.endReplaceableGroup();
            startRestartGroup.endReplaceableGroup();
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static final java.lang.Object m1328awaitSlop8vUncbI(androidx.compose.ui.input.pointer.AwaitPointerEventScope r8, long r9, int r11, P5.d r12) {
        /*
        ...
        L37:
            ...
            r2 = r9
            r4 = r11
            java.lang.Object r8 = androidx.compose.material.DragGestureDetectorCopyKt.m1214awaitHorizontalPointerSlopOrCancellationgDDlDlE(r1, r2, r4, r5, r6)
            if (r8 != r0) goto L52
            return r0
        L52:
            r7 = r12
        ...
        L65:
            return r8
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material.SliderKt.m1328awaitSlop8vUncbI(androidx.compose.ui.input.pointer.AwaitPointerEventScope, long, int, P5.d):java.lang.Object");
    }
