...
public final class BottomNavigationKt$BottomNavigation$1 extends AbstractC3160z implements n {
    final /* synthetic */ int $$dirty;
    final /* synthetic */ o $content;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public BottomNavigationKt$BottomNavigation$1(o oVar, int i8) {
        super(2);
        this.$content = oVar;
        this.$$dirty = i8;
    }
    ...
    public final void invoke(Composer composer, int i8) {
        ...
        Modifier selectableGroup = SelectableGroupKt.selectableGroup(SizeKt.m633height3ABfNKs(fillMaxWidth$default, f8));
