...
public interface ExposedDropdownMenuBoxScope {
    ...
    public abstract /* synthetic */ class CC {
        ...
        */
        public static void a(androidx.compose.material.ExposedDropdownMenuBoxScope r24, boolean r25, kotlin.jvm.functions.Function0 r26, androidx.compose.ui.Modifier r27, androidx.compose.foundation.ScrollState r28, X5.o r29, androidx.compose.runtime.Composer r30, int r31, int r32) {
            /*
    ...
    public static final class DefaultImpls {
        ...
        @Deprecated
        public static void ExposedDropdownMenu(ExposedDropdownMenuBoxScope exposedDropdownMenuBoxScope, boolean z8, Function0 onDismissRequest, Modifier modifier, ScrollState scrollState, o content, Composer composer, int i8, int i9) {
            AbstractC3159y.i(onDismissRequest, "onDismissRequest");
    ...
    @Composable
    @ComposableInferredTarget(scheme = "[androidx.compose.ui.UiComposable[androidx.compose.ui.UiComposable]]")
    void ExposedDropdownMenu(boolean z8, Function0 function0, Modifier modifier, ScrollState scrollState, o oVar, Composer composer, int i8, int i9);
