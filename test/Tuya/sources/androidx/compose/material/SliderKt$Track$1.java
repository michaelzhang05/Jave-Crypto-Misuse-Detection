...
public final class SliderKt$Track$1 extends AbstractC3160z implements Function1 {
    ...
    public final void invoke(DrawScope Canvas) {
        ...
        long Offset = OffsetKt.Offset(this.$thumbPx, Offset.m2736getYimpl(Canvas.mo3413getCenterF1C5BW0()));
        long Offset2 = OffsetKt.Offset(Size.m2804getWidthimpl(Canvas.mo3414getSizeNHjbRc()) - this.$thumbPx, Offset.m2736getYimpl(Canvas.mo3413getCenterF1C5BW0()));
        ...
        for (Map.Entry entry : linkedHashMap.entrySet()) {
            ...
            long j12 = j11;
            long j13 = j10;
            c.H(Canvas, arrayList, PointMode.Companion.m3254getPointsr_lszbg(), (booleanValue ? state : state2).getValue().m2981unboximpl(), f11, StrokeCap.Companion.m3302getRoundKaPHkGw(), null, 0.0f, null, 0, 480, null);
            f11 = f11;
            j11 = j12;
            j10 = j13;
        }
