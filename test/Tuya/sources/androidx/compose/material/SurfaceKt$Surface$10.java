...
public final class SurfaceKt$Surface$10 extends AbstractC3160z implements n {
    ...
    public SurfaceKt$Surface$10(Modifier modifier, Shape shape, long j8, float f8, int i8, BorderStroke borderStroke, float f9, boolean z8, MutableInteractionSource mutableInteractionSource, boolean z9, Function1 function1, n nVar, int i9) {
        super(2);
    ...
    public final void invoke(Composer composer, int i8) {
        ...
        Modifier m827toggleableO2vRcR0$default = ToggleableKt.m827toggleableO2vRcR0$default(m1359surface8ww4TTg, this.$checked, this.$interactionSource, RippleKt.m1444rememberRipple9IZ8Weo(false, 0.0f, 0L, composer, 0, 7), this.$enabled, null, this.$onCheckedChange, 16, null);
        n nVar = this.$content;
        int i9 = this.$$dirty1;
        ...
        o modifierMaterializerOf = LayoutKt.modifierMaterializerOf(m827toggleableO2vRcR0$default);
