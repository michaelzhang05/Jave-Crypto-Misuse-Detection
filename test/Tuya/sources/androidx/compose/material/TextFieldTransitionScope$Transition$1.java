...
public final class TextFieldTransitionScope$Transition$1 extends AbstractC3160z implements n {
    ...
    public final void invoke(Composer composer, int i8) {
        this.$tmp0_rcvr.m1412TransitionDTcfvLk(this.$inputState, this.$focusedTextStyleColor, this.$unfocusedTextStyleColor, this.$contentColor, this.$showLabel, this.$content, composer, RecomposeScopeImplKt.updateChangedFlags(this.$$changed | 1));
    }
}
