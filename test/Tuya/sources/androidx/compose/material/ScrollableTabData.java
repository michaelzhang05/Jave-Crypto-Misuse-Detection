...
final class ScrollableTabData {
    ...
    private final int calculateTabOffset(TabPosition tabPosition, Density density, int i8, List<TabPosition> list) {
        int mo442roundToPx0680j_4 = density.mo442roundToPx0680j_4(((TabPosition) AbstractC1246t.y0(list)).m1376getRightD9Ej5fM()) + i8;
        int maxValue = mo442roundToPx0680j_4 - this.scrollState.getMaxValue();
        return m.k(density.mo442roundToPx0680j_4(tabPosition.m1375getLeftD9Ej5fM()) - ((maxValue / 2) - (density.mo442roundToPx0680j_4(tabPosition.m1377getWidthD9Ej5fM()) / 2)), 0, m.d(mo442roundToPx0680j_4 - maxValue, 0));
    }
