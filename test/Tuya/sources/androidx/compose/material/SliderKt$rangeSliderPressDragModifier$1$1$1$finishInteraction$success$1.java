...
final class SliderKt$rangeSliderPressDragModifier$1$1$1$finishInteraction$success$1 extends AbstractC3160z implements Function1 {
    ...
    public SliderKt$rangeSliderPressDragModifier$1$1$1$finishInteraction$success$1(State<? extends n> state, O o8, boolean z8) {
        super(1);
        this.$onDrag = state;
