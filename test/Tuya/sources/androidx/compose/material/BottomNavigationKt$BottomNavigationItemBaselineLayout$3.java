...
public final class BottomNavigationKt$BottomNavigationItemBaselineLayout$3 extends AbstractC3160z implements n {
    ...
    public BottomNavigationKt$BottomNavigationItemBaselineLayout$3(n nVar, n nVar2, float f8, int i8) {
        super(2);
        this.$icon = nVar;
        this.$label = nVar2;
