...
public final class PrioritySet {
    ...
    public final int peek() {
        return ((Number) AbstractC1246t.m0(this.list)).intValue();
    }
    ...
    public final int takeMax() {
        ...
        if (z8) {
            ...
            while ((!this.list.isEmpty()) && this.list.get(0).intValue() == intValue2) {
                ...
                list.set(0, AbstractC1246t.y0(list));
    ...
    public /* synthetic */ PrioritySet(List list, int i8, AbstractC3151p abstractC3151p) {
