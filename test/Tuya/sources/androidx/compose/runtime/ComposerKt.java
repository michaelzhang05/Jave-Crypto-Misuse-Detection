...
public final class ComposerKt {
    ...
    public static final int InvalidationLocationAscending$lambda$15(Invalidation invalidation, Invalidation invalidation2) {
        return AbstractC3159y.k(invalidation.getLocation(), invalidation2.getLocation());
    }
    ...
    private static final int findLocation(List<Invalidation> list, int i8) {
        ...
        while (i9 <= size) {
            int i10 = (i9 + size) >>> 1;
            int k8 = AbstractC3159y.k(list.get(i10).getLocation(), i8);
            if (k8 < 0) {
                i9 = i10 + 1;
            } else if (k8 > 0) {
                size = i10 - 1;
    ...
    public static final Object getKey(Object obj, Object obj2, Object obj3) {
        ...
        if ((!AbstractC3159y.d(joinedKey.getLeft(), obj2) || !AbstractC3159y.d(joinedKey.getRight(), obj3)) && (obj = getKey(joinedKey.getLeft(), obj2, obj3)) == null) {
    ...
    public static final <K, V> V pop(HashMap<K, LinkedHashSet<V>> hashMap, K k8) {
        ...
        if (linkedHashSet != null && (v8 = (V) AbstractC1246t.n0(linkedHashSet)) != null) {
