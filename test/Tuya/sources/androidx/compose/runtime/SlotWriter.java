...
public final class SlotWriter {
    ...
    private final void clearSlotGap() {
        ...
        AbstractC1239l.t(this.slots, null, i8, this.slotsGapLen + i8);
    }
    ...
    private final List<Integer> dataIndexes(int[] iArr) {
        ...
        List G02 = AbstractC1246t.G0(AbstractC1246t.N0(dataAnchors$default, d6.m.s(0, this.groupGapStart)), AbstractC1246t.N0(dataAnchors$default, d6.m.s(this.groupGapStart + this.groupGapLen, iArr.length / 5)));
    ...
    public final void insertGroups(int i8) {
        ...
        if (i8 > 0) {
            ...
            if (i12 < i8) {
                ...
                int i15 = max - i13;
                AbstractC1239l.g(iArr, iArr2, 0, 0, i11 * 5);
                AbstractC1239l.g(iArr, iArr2, (i11 + i15) * 5, (i12 + i11) * 5, length * 5);
                this.groups = iArr2;
                i12 = i15;
            }
    ...
    public final void insertSlots(int i8, int i9) {
        if (i8 > 0) {
            ...
            if (i11 < i8) {
                ...
                int i14 = max - i12;
                AbstractC1239l.i(objArr, objArr2, 0, 0, i10);
                AbstractC1239l.i(objArr, objArr2, i10 + i14, i11 + i10, length);
                this.slots = objArr2;
                i11 = i14;
            }
    ...
    public final void moveGroupGapTo(int i8) {
        ...
        if (i10 != i8) {
            ...
            if (i9 > 0) {
                ...
                int i13 = i10 * 5;
                if (i8 < i10) {
                    AbstractC1239l.g(iArr, iArr, i12 + i11, i11, i13);
                } else {
                    AbstractC1239l.g(iArr, iArr, i13, i13 + i12, i11 + i12);
                }
            }
            if (i8 < i10) {
                i10 = i8 + i9;
    ...
    public final void moveSlotGapTo(int i8, int i9) {
        ...
        if (i11 != i8) {
            Object[] objArr = this.slots;
            if (i8 < i11) {
                AbstractC1239l.i(objArr, objArr, i8 + i10, i8, i11);
            } else {
                AbstractC1239l.i(objArr, objArr, i11, i11 + i10, i8 + i10);
            }
        }
    ...
    public final void removeSlots(int i8, int i9, int i10) {
        if (i9 > 0) {
            ...
            AbstractC1239l.t(this.slots, null, i8, i12);
    ...
    */
    ...
    public final void forEachData(int i8, n nVar) {
        int slotIndex = slotIndex(this.groups, groupIndexToAddress(i8));
        int dataIndex = dataIndex(this.groups, groupIndexToAddress(i8 + 1));
        for (int i9 = slotIndex; i9 < dataIndex; i9++) {
            nVar.invoke(Integer.valueOf(i9 - slotIndex), this.slots[dataIndexToDataAddress(i9)]);
        }
    }
    ...
    public final void moveGroup(int i8) {
        ...
        if (z8) {
            ...
            if (z9) {
                ...
                AbstractC1239l.g(iArr, iArr, groupIndexToAddress(i10) * 5, groupIndexToAddress, (groupSize * 5) + groupIndexToAddress);
                if (i17 > 0) {
                    Object[] objArr = this.slots;
                    AbstractC1239l.i(objArr, objArr, i15, dataIndexToDataAddress(dataIndex + i17), dataIndexToDataAddress(dataIndex2 + i17));
                }
    ...
    */
    ...
    private final void startGroup(int i8, Object obj, boolean z8, Object obj2) {
        ...
        if (z9) {
            ...
            if (!AbstractC3159y.d(obj2, Composer.Companion.getEmpty())) {
                if (z8) {
                    updateNode(obj2);
                } else {
                    updateAux(obj2);
