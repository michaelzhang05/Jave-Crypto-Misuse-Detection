...
public final class RecomposeScopeImpl implements ScopeUpdateScope, RecomposeScope {
    ...
    public final void compose(Composer composer) {
        ...
        if (recomposeScopeObserver != null && nVar != null) {
            ...
            public void dispose() {
                ...
                synchronized (obj2) {
                    try {
                        ...
                        if (AbstractC3159y.d(recomposeScopeObserver2, recomposeScopeObserver3)) {
    ...
    public final boolean recordRead(Object obj) {
        ...
        if (obj instanceof DerivedState) {
            ...
            if (mutableScatterMap == null) {
                mutableScatterMap = new MutableScatterMap<>(i8, i9, abstractC3151p);
    ...
    public void updateScope(n nVar) {
        this.block = nVar;
    }
}
