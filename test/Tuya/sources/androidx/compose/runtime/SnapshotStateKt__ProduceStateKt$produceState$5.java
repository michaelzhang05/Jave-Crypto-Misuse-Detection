...
public final class SnapshotStateKt__ProduceStateKt$produceState$5 extends kotlin.coroutines.jvm.internal.l implements n {
    ...
    public SnapshotStateKt__ProduceStateKt$produceState$5(n nVar, MutableState<T> mutableState, P5.d dVar) {
        super(2, dVar);
        this.$producer = nVar;
    ...
    public final Object invoke(M m8, P5.d dVar) {
        return ((SnapshotStateKt__ProduceStateKt$produceState$5) create(m8, dVar)).invokeSuspend(I.f6487a);
    }
