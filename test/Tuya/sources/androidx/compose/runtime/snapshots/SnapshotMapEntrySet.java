...
final class SnapshotMapEntrySet<K, V> extends SnapshotMapSet<K, V, Map.Entry<K, V>> {
    ...
    public boolean retainAll(Collection<? extends Object> collection) {
        ...
        Object obj2;
        Collection<? extends Object> collection2 = collection;
        LinkedHashMap linkedHashMap = new LinkedHashMap(m.d(Q.d(AbstractC1246t.x(collection2, 10)), 16));
        Iterator<T> it = collection2.iterator();
        while (it.hasNext()) {
        ...
        do {
            ...
            while (true) {
                ...
                if (!linkedHashMap.containsKey(next.getKey()) || !AbstractC3159y.d(linkedHashMap.get(next.getKey()), next.getValue())) {
            ...
            if (AbstractC3159y.d(build2, map$runtime_release)) {
                break;
            }
    ...
    public boolean contains(Map.Entry<K, V> entry) {
        return AbstractC3159y.d(getMap().get(entry.getKey()), entry.getValue());
    }
