...
public final class SnapshotStateList<T> implements StateObject, List<T>, RandomAccess, Y5.b {
    ...
    public static final class StateListStateRecord<T> extends StateRecord {
        ...
        public void assign(StateRecord stateRecord) {
            ...
            synchronized (obj) {
                AbstractC3159y.g(stateRecord, "null cannot be cast to non-null type androidx.compose.runtime.snapshots.SnapshotStateList.StateListStateRecord<T of androidx.compose.runtime.snapshots.SnapshotStateList.StateListStateRecord.assign$lambda$0>");
        ...
        do {
            ...
            synchronized (obj) {
                try {
                    ...
                    AbstractC3159y.g(firstStateRecord, "null cannot be cast to non-null type androidx.compose.runtime.snapshots.SnapshotStateList.StateListStateRecord<T of androidx.compose.runtime.snapshots.SnapshotStateList>");
            ...
            AbstractC3157w.a(1);
            AbstractC3159y.f(list$runtime_release);
            PersistentList<? extends T> persistentList = (PersistentList) function1.invoke(list$runtime_release);
            z9 = false;
            if (AbstractC3159y.d(persistentList, list$runtime_release)) {
                return false;
            }
            StateRecord firstStateRecord2 = getFirstStateRecord();
            AbstractC3159y.g(firstStateRecord2, "null cannot be cast to non-null type androidx.compose.runtime.snapshots.SnapshotStateList.StateListStateRecord<T of androidx.compose.runtime.snapshots.SnapshotStateList>");
    ...
    private final <R> R mutate(Function1 function1) {
        ...
        do {
            ...
            if (AbstractC3159y.d(build, list$runtime_release)) {
                break;
            }
            StateRecord firstStateRecord2 = getFirstStateRecord();
            AbstractC3159y.g(firstStateRecord2, "null cannot be cast to non-null type androidx.compose.runtime.snapshots.SnapshotStateList.StateListStateRecord<T of androidx.compose.runtime.snapshots.SnapshotStateList>");
    ...
    public boolean add(T t8) {
        ...
        do {
            ...
            z8 = false;
            if (AbstractC3159y.d(add, list$runtime_release)) {
                return false;
            }
            StateRecord firstStateRecord2 = getFirstStateRecord();
            AbstractC3159y.g(firstStateRecord2, "null cannot be cast to non-null type androidx.compose.runtime.snapshots.SnapshotStateList.StateListStateRecord<T of androidx.compose.runtime.snapshots.SnapshotStateList>");
    ...
    public void prependStateRecord(StateRecord stateRecord) {
        ...
        AbstractC3159y.g(stateRecord, "null cannot be cast to non-null type androidx.compose.runtime.snapshots.SnapshotStateList.StateListStateRecord<T of androidx.compose.runtime.snapshots.SnapshotStateList>");
    ...
    public boolean removeAll(Collection<? extends Object> collection) {
        ...
        do {
            ...
            z8 = false;
            if (AbstractC3159y.d(removeAll, list$runtime_release)) {
                return false;
            }
            StateRecord firstStateRecord2 = getFirstStateRecord();
            AbstractC3159y.g(firstStateRecord2, "null cannot be cast to non-null type androidx.compose.runtime.snapshots.SnapshotStateList.StateListStateRecord<T of androidx.compose.runtime.snapshots.SnapshotStateList>");
    ...
    public T removeAt(int i8) {
        ...
        do {
            ...
            if (AbstractC3159y.d(removeAt, list$runtime_release)) {
                break;
            }
            StateRecord firstStateRecord2 = getFirstStateRecord();
            AbstractC3159y.g(firstStateRecord2, "null cannot be cast to non-null type androidx.compose.runtime.snapshots.SnapshotStateList.StateListStateRecord<T of androidx.compose.runtime.snapshots.SnapshotStateList>");
    ...
    public boolean addAll(Collection<? extends T> collection) {
        ...
        do {
            ...
            z8 = false;
            if (AbstractC3159y.d(addAll, list$runtime_release)) {
                return false;
            }
            StateRecord firstStateRecord2 = getFirstStateRecord();
            AbstractC3159y.g(firstStateRecord2, "null cannot be cast to non-null type androidx.compose.runtime.snapshots.SnapshotStateList.StateListStateRecord<T of androidx.compose.runtime.snapshots.SnapshotStateList>");
    ...
    public boolean remove(Object obj) {
        ...
        do {
            ...
            z8 = false;
            if (AbstractC3159y.d(remove, list$runtime_release)) {
                return false;
            }
            StateRecord firstStateRecord2 = getFirstStateRecord();
            AbstractC3159y.g(firstStateRecord2, "null cannot be cast to non-null type androidx.compose.runtime.snapshots.SnapshotStateList.StateListStateRecord<T of androidx.compose.runtime.snapshots.SnapshotStateList>");
