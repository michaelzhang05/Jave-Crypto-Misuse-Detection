...
public final class SubList<T> implements List<T>, Y5.b {
    ...
    public int indexOf(Object obj) {
        ...
        while (it.hasNext()) {
            ...
            if (AbstractC3159y.d(obj, this.parentList.get(nextInt))) {
    ...
    public int lastIndexOf(Object obj) {
        ...
        } while (!AbstractC3159y.d(obj, this.parentList.get(size)));
