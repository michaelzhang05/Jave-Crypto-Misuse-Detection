...
public final class SubList$listIterator$1<T> implements ListIterator<T>, Y5.a {
    ...
    public boolean hasNext() {
        if (this.$current.f33759a < this.this$0.size() - 1) {
            return true;
        }
        return false;
    }
    ...
    @Override // java.util.ListIterator, java.util.Iterator
    public T next() {
        int i8 = this.$current.f33759a + 1;
        SnapshotStateListKt.validateRange(i8, this.this$0.size());
        this.$current.f33759a = i8;
        return this.this$0.get(i8);
    }

    @Override // java.util.ListIterator
    public int nextIndex() {
        return this.$current.f33759a + 1;
    }

    @Override // java.util.ListIterator
    public T previous() {
        int i8 = this.$current.f33759a;
        SnapshotStateListKt.validateRange(i8, this.this$0.size());
        this.$current.f33759a = i8 - 1;
        return this.this$0.get(i8);
    }

    @Override // java.util.ListIterator
    public int previousIndex() {
        return this.$current.f33759a;
    }
