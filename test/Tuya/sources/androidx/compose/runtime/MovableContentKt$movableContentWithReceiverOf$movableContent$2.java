...
final class MovableContentKt$movableContentWithReceiverOf$movableContent$2 extends AbstractC3160z implements o {
    final /* synthetic */ p $content;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public MovableContentKt$movableContentWithReceiverOf$movableContent$2(p pVar) {
        super(3);
        this.$content = pVar;
    }
