...
public final class CompositionKt {
    ...
    public static final P5.g getRecomposeCoroutineContext(ControlledComposition controlledComposition) {
        CompositionImpl compositionImpl;
        P5.g recomposeContext;
    ...
    @ExperimentalComposeApi
    public static final Composition Composition(Applier<?> applier, CompositionContext compositionContext, P5.g gVar) {
        return new CompositionImpl(compositionContext, applier, gVar);
    }

    @ExperimentalComposeApi
    public static final ControlledComposition ControlledComposition(Applier<?> applier, CompositionContext compositionContext, P5.g gVar) {
        return new CompositionImpl(compositionContext, applier, gVar);
    }
}
