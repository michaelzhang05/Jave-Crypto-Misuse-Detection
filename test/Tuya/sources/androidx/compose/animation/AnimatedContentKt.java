...
public final class AnimatedContentKt {
    ...
    */
    public static final <S> void AnimatedContent(S r19, androidx.compose.ui.Modifier r20, kotlin.jvm.functions.Function1 r21, androidx.compose.ui.Alignment r22, java.lang.String r23, kotlin.jvm.functions.Function1 r24, X5.p r25, androidx.compose.runtime.Composer r26, int r27, int r28) {
        /*
            Method dump skipped, instructions count: 377
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.animation.AnimatedContentKt.AnimatedContent(java.lang.Object, androidx.compose.ui.Modifier, kotlin.jvm.functions.Function1, androidx.compose.ui.Alignment, java.lang.String, kotlin.jvm.functions.Function1, X5.p, androidx.compose.runtime.Composer, int, int):void");
    }

    public static final SizeTransform SizeTransform(boolean z8, n sizeAnimationSpec) {
        AbstractC3159y.i(sizeAnimationSpec, "sizeAnimationSpec");
        return new SizeTransformImpl(z8, sizeAnimationSpec);
    }

    public static /* synthetic */ SizeTransform SizeTransform$default(boolean z8, n nVar, int i8, Object obj) {
        if ((i8 & 1) != 0) {
            z8 = true;
        }
        if ((i8 & 2) != 0) {
            nVar = AnimatedContentKt$SizeTransform$1.INSTANCE;
        }
        return SizeTransform(z8, nVar);
    }

    public static final ContentTransform togetherWith(EnterTransition enterTransition, ExitTransition exit) {
        AbstractC3159y.i(enterTransition, "<this>");
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static final <S> void AnimatedContent(androidx.compose.animation.core.Transition<S> r22, androidx.compose.ui.Modifier r23, kotlin.jvm.functions.Function1 r24, androidx.compose.ui.Alignment r25, kotlin.jvm.functions.Function1 r26, X5.p r27, androidx.compose.runtime.Composer r28, int r29, int r30) {
        /*
            Method dump skipped, instructions count: 974
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.animation.AnimatedContentKt.AnimatedContent(androidx.compose.animation.core.Transition, androidx.compose.ui.Modifier, kotlin.jvm.functions.Function1, androidx.compose.ui.Alignment, kotlin.jvm.functions.Function1, X5.p, androidx.compose.runtime.Composer, int, int):void");
    }
}
