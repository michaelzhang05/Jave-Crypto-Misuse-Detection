...
public final class SuspendAnimationKt {
    public static final Object animate(float f8, float f9, float f10, AnimationSpec<Float> animationSpec, n nVar, P5.d dVar) {
        Object animate = animate(VectorConvertersKt.getVectorConverter(r.f33790a), kotlin.coroutines.jvm.internal.b.b(f8), kotlin.coroutines.jvm.internal.b.b(f9), kotlin.coroutines.jvm.internal.b.b(f10), animationSpec, nVar, dVar);
        return animate == Q5.b.e() ? animate : I.f6487a;
    }

    public static /* synthetic */ Object animate$default(float f8, float f9, float f10, AnimationSpec animationSpec, n nVar, P5.d dVar, int i8, Object obj) {
        float f11 = (i8 & 4) != 0 ? 0.0f : f10;
        if ((i8 & 8) != 0) {
            animationSpec = AnimationSpecKt.spring$default(0.0f, 0.0f, null, 7, null);
        }
        return animate(f8, f9, f11, animationSpec, nVar, dVar);
    }

    public static final Object animateDecay(float f8, float f9, FloatDecayAnimationSpec floatDecayAnimationSpec, n nVar, P5.d dVar) {
        Object animate$default = animate$default(AnimationStateKt.AnimationState$default(f8, f9, 0L, 0L, false, 28, null), AnimationKt.DecayAnimation(floatDecayAnimationSpec, f8, f9), 0L, new SuspendAnimationKt$animateDecay$2(nVar), dVar, 2, null);
        return animate$default == Q5.b.e() ? animate$default : I.f6487a;
    }

    public static /* synthetic */ Object animateDecay$default(AnimationState animationState, DecayAnimationSpec decayAnimationSpec, boolean z8, Function1 function1, P5.d dVar, int i8, Object obj) {
        if ((i8 & 2) != 0) {
            z8 = false;
        }
        if ((i8 & 4) != 0) {
    ...
    public static final <T, V extends AnimationVector> Object animateTo(AnimationState<T, V> animationState, T t8, AnimationSpec<T> animationSpec, boolean z8, Function1 function1, P5.d dVar) {
        long j8;
    ...
    public static /* synthetic */ Object animateTo$default(AnimationState animationState, Object obj, AnimationSpec animationSpec, boolean z8, Function1 function1, P5.d dVar, int i8, Object obj2) {
        boolean z9;
        if ((i8 & 2) != 0) {
            animationSpec = AnimationSpecKt.spring$default(0.0f, 0.0f, null, 7, null);
        }
    ...
    public static final <R, T, V extends AnimationVector> Object callWithFrameNanos(Animation<T, V> animation, Function1 function1, P5.d dVar) {
    ...
    public static final float getDurationScale(P5.g gVar) {
        float f8;
    ...
    public static final <T, V extends AnimationVector> void updateState(AnimationScope<T, V> animationScope, AnimationState<T, V> state) {
        AbstractC3159y.i(animationScope, "<this>");
    ...
    public static final <T, V extends AnimationVector> Object animateDecay(AnimationState<T, V> animationState, DecayAnimationSpec<T> decayAnimationSpec, boolean z8, Function1 function1, P5.d dVar) {
    ...
    public static /* synthetic */ Object animate$default(AnimationState animationState, Animation animation, long j8, Function1 function1, P5.d dVar, int i8, Object obj) {
        if ((i8 & 2) != 0) {
            j8 = Long.MIN_VALUE;
        }
        long j9 = j8;
    ...
    public static final <T, V extends AnimationVector> Object animate(TwoWayConverter<T, V> twoWayConverter, T t8, T t9, T t10, AnimationSpec<T> animationSpec, n nVar, P5.d dVar) {
        ...
        Object animate$default = animate$default(new AnimationState(twoWayConverter, t8, newInstance, 0L, 0L, false, 56, null), new TargetBasedAnimation(animationSpec, twoWayConverter, t8, t9, newInstance), 0L, new SuspendAnimationKt$animate$3(nVar, twoWayConverter), dVar, 2, null);
        return animate$default == Q5.b.e() ? animate$default : I.f6487a;
    }
    ...
    */
    public static final <T, V extends androidx.compose.animation.core.AnimationVector> java.lang.Object animate(androidx.compose.animation.core.AnimationState<T, V> r25, androidx.compose.animation.core.Animation<T, V> r26, long r27, kotlin.jvm.functions.Function1 r29, P5.d r30) {
        /*
            Method dump skipped, instructions count: 324
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.animation.core.SuspendAnimationKt.animate(androidx.compose.animation.core.AnimationState, androidx.compose.animation.core.Animation, long, kotlin.jvm.functions.Function1, P5.d):java.lang.Object");
    }
}
