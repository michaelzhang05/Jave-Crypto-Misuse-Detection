...
public final class InfiniteTransition$run$1 extends l implements n {
    ...
    public static final class AnonymousClass1 extends AbstractC3160z implements Function1 {
        ...
        public final void invoke(long j8) {
            ...
            int i8 = 0;
            if (j9 == Long.MIN_VALUE || this.$durationScale.f33758a != SuspendAnimationKt.getDurationScale(this.$$this$LaunchedEffect.getCoroutineContext())) {
                ...
                this.$durationScale.f33758a = SuspendAnimationKt.getDurationScale(this.$$this$LaunchedEffect.getCoroutineContext());
            }
            if (this.$durationScale.f33758a == 0.0f) {
            ...
            this.this$0.onFrame(((float) (longValue - j10)) / this.$durationScale.f33758a);
        }
    }
    ...
    public static final class AnonymousClass3 extends l implements n {
        ...
        public final Object invoke(float f8, P5.d dVar) {
            return ((AnonymousClass3) create(Float.valueOf(f8), dVar)).invokeSuspend(I.f6487a);
        }
        ...
        public /* bridge */ /* synthetic */ Object invoke(Object obj, Object obj2) {
            return invoke(((Number) obj).floatValue(), (P5.d) obj2);
        }
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public InfiniteTransition$run$1(MutableState<State<Long>> mutableState, InfiniteTransition infiniteTransition, P5.d dVar) {
        super(2, dVar);
        this.$toolingOverride = mutableState;
        this.this$0 = infiniteTransition;
    }
    ...
    public final Object invoke(M m8, P5.d dVar) {
        return ((InfiniteTransition$run$1) create(m8, dVar)).invokeSuspend(I.f6487a);
    }
    ...
    */
    public final java.lang.Object invokeSuspend(java.lang.Object r8) {
        ...
        L56:
            ...
            r4.<init>(r8)
            l6.f r4 = androidx.compose.runtime.SnapshotStateKt.snapshotFlow(r4)
            ...
            r7.L$1 = r1
            r7.label = r2
            java.lang.Object r4 = l6.AbstractC3360h.v(r4, r5, r7)
            if (r4 != r0) goto L40
            return r0
        */
