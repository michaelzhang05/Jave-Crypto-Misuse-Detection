...
public final class Animatable$runAnimation$2 extends l implements Function1 {
    ...
    public static final class AnonymousClass1 extends AbstractC3160z implements Function1 {
        ...
        public final void invoke(AnimationScope<T, V> animate) {
            ...
            if (!AbstractC3159y.d(clampToBounds, animate.getValue())) {
                ...
                this.$clampingNeeded.f33757a = true;
                return;
            }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public Animatable$runAnimation$2(Animatable<T, V> animatable, T t8, Animation<T, V> animation, long j8, Function1 function1, P5.d dVar) {
        super(1, dVar);
        this.this$0 = animatable;
    ...
    public final Object invoke(P5.d dVar) {
        return ((Animatable$runAnimation$2) create(dVar)).invokeSuspend(I.f6487a);
    }
