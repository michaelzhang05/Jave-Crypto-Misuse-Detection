...
public final class AnimateAsStateKt {
    ...
    private static final SpringSpec<Dp> dpDefaultSpring = AnimationSpecKt.spring$default(0.0f, 0.0f, Dp.m5176boximpl(VisibilityThresholdsKt.getVisibilityThreshold(Dp.Companion)), 3, null);
    private static final SpringSpec<Size> sizeDefaultSpring = AnimationSpecKt.spring$default(0.0f, 0.0f, Size.m2792boximpl(VisibilityThresholdsKt.getVisibilityThreshold(Size.Companion)), 3, null);
    private static final SpringSpec<Offset> offsetDefaultSpring = AnimationSpecKt.spring$default(0.0f, 0.0f, Offset.m2724boximpl(VisibilityThresholdsKt.getVisibilityThreshold(Offset.Companion)), 3, null);
    ...
    private static final SpringSpec<Integer> intDefaultSpring = AnimationSpecKt.spring$default(0.0f, 0.0f, Integer.valueOf(VisibilityThresholdsKt.getVisibilityThreshold(C3158x.f33791a)), 3, null);
    private static final SpringSpec<IntOffset> intOffsetDefaultSpring = AnimationSpecKt.spring$default(0.0f, 0.0f, IntOffset.m5293boximpl(VisibilityThresholdsKt.getVisibilityThreshold(IntOffset.Companion)), 3, null);
    private static final SpringSpec<IntSize> intSizeDefaultSpring = AnimationSpecKt.spring$default(0.0f, 0.0f, IntSize.m5336boximpl(VisibilityThresholdsKt.getVisibilityThreshold(IntSize.Companion)), 3, null);

    @Composable
    /* renamed from: animateDpAsState-AjpBEmI */
    public static final State<Dp> m199animateDpAsStateAjpBEmI(float f8, AnimationSpec<Dp> animationSpec, String str, Function1 function1, Composer composer, int i8, int i9) {
        ...
        int i10 = i8 << 6;
        State<Dp> animateValueAsState = animateValueAsState(Dp.m5176boximpl(f8), VectorConvertersKt.getVectorConverter(Dp.Companion), animationSpec2, null, str2, function12, composer, (i8 & 14) | ((i8 << 3) & 896) | (57344 & i10) | (i10 & 458752), 8);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public static final /* synthetic */ State m200animateDpAsStateKz89ssw(float f8, AnimationSpec animationSpec, Function1 function1, Composer composer, int i8, int i9) {
        ...
        State animateValueAsState = animateValueAsState(Dp.m5176boximpl(f8), VectorConvertersKt.getVectorConverter(Dp.Companion), animationSpec2, null, null, function12, composer, (i8 & 14) | ((i8 << 3) & 896) | ((i8 << 9) & 458752), 24);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public static final State<Float> animateFloatAsState(float f8, AnimationSpec<Float> animationSpec, float f9, String str, Function1 function1, Composer composer, int i8, int i9) {
        ...
        composer.endReplaceableGroup();
        int i10 = i8 << 3;
        State<Float> animateValueAsState = animateValueAsState(Float.valueOf(f8), VectorConvertersKt.getVectorConverter(r.f33790a), animationSpec2, Float.valueOf(f10), str2, function12, composer, (i10 & 7168) | (i8 & 14) | (57344 & i10) | (i10 & 458752), 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public static final State<Integer> animateIntAsState(int i8, AnimationSpec<Integer> animationSpec, String str, Function1 function1, Composer composer, int i9, int i10) {
        ...
        int i11 = i9 << 6;
        State<Integer> animateValueAsState = animateValueAsState(Integer.valueOf(i8), VectorConvertersKt.getVectorConverter(C3158x.f33791a), animationSpec2, null, str2, function12, composer, (i9 & 14) | ((i9 << 3) & 896) | (57344 & i11) | (i11 & 458752), 8);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public static final /* synthetic */ State m201animateIntOffsetAsState8f6pmRE(long j8, AnimationSpec animationSpec, Function1 function1, Composer composer, int i8, int i9) {
        ...
        State animateValueAsState = animateValueAsState(IntOffset.m5293boximpl(j8), VectorConvertersKt.getVectorConverter(IntOffset.Companion), animationSpec2, null, null, function12, composer, (i8 & 14) | ((i8 << 3) & 896) | ((i8 << 9) & 458752), 24);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public static final State<IntOffset> m202animateIntOffsetAsStateHyPO7BM(long j8, AnimationSpec<IntOffset> animationSpec, String str, Function1 function1, Composer composer, int i8, int i9) {
        ...
        int i10 = i8 << 6;
        State<IntOffset> animateValueAsState = animateValueAsState(IntOffset.m5293boximpl(j8), VectorConvertersKt.getVectorConverter(IntOffset.Companion), animationSpec2, null, str2, function12, composer, (i8 & 14) | ((i8 << 3) & 896) | (57344 & i10) | (i10 & 458752), 8);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public static final State<IntSize> m203animateIntSizeAsState4goxYXU(long j8, AnimationSpec<IntSize> animationSpec, String str, Function1 function1, Composer composer, int i8, int i9) {
        ...
        int i10 = i8 << 6;
        State<IntSize> animateValueAsState = animateValueAsState(IntSize.m5336boximpl(j8), VectorConvertersKt.getVectorConverter(IntSize.Companion), animationSpec2, null, str2, function12, composer, (i8 & 14) | ((i8 << 3) & 896) | (57344 & i10) | (i10 & 458752), 8);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public static final /* synthetic */ State m204animateIntSizeAsStatezTRF_AQ(long j8, AnimationSpec animationSpec, Function1 function1, Composer composer, int i8, int i9) {
        AnimationSpec animationSpec2;
        Function1 function12;
        ...
        State animateValueAsState = animateValueAsState(IntSize.m5336boximpl(j8), VectorConvertersKt.getVectorConverter(IntSize.Companion), animationSpec2, null, null, function12, composer, (i8 & 14) | ((i8 << 3) & 896) | ((i8 << 9) & 458752), 24);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public static final State<Offset> m205animateOffsetAsState7362WCg(long j8, AnimationSpec<Offset> animationSpec, String str, Function1 function1, Composer composer, int i8, int i9) {
        ...
        int i10 = i8 << 6;
        State<Offset> animateValueAsState = animateValueAsState(Offset.m2724boximpl(j8), VectorConvertersKt.getVectorConverter(Offset.Companion), animationSpec2, null, str2, function12, composer, (i8 & 14) | ((i8 << 3) & 896) | (57344 & i10) | (i10 & 458752), 8);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public static final /* synthetic */ State m206animateOffsetAsStateN6fFfp4(long j8, AnimationSpec animationSpec, Function1 function1, Composer composer, int i8, int i9) {
        AnimationSpec animationSpec2;
        Function1 function12;
        ...
        State animateValueAsState = animateValueAsState(Offset.m2724boximpl(j8), VectorConvertersKt.getVectorConverter(Offset.Companion), animationSpec2, null, null, function12, composer, (i8 & 14) | ((i8 << 3) & 896) | ((i8 << 9) & 458752), 24);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public static final /* synthetic */ State m207animateSizeAsStateLjSzlW0(long j8, AnimationSpec animationSpec, Function1 function1, Composer composer, int i8, int i9) {
        AnimationSpec animationSpec2;
        Function1 function12;
        ...
        State animateValueAsState = animateValueAsState(Size.m2792boximpl(j8), VectorConvertersKt.getVectorConverter(Size.Companion), animationSpec2, null, null, function12, composer, (i8 & 14) | ((i8 << 3) & 896) | ((i8 << 9) & 458752), 24);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public static final State<Size> m208animateSizeAsStateYLp_XPw(long j8, AnimationSpec<Size> animationSpec, String str, Function1 function1, Composer composer, int i8, int i9) {
        ...
        int i10 = i8 << 6;
        State<Size> animateValueAsState = animateValueAsState(Size.m2792boximpl(j8), VectorConvertersKt.getVectorConverter(Size.Companion), animationSpec2, null, str2, function12, composer, (i8 & 14) | ((i8 << 3) & 896) | (57344 & i10) | (i10 & 458752), 8);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public static final <T, V extends AnimationVector> State<T> animateValueAsState(T t8, TwoWayConverter<T, V> typeConverter, AnimationSpec<T> animationSpec, T t9, String str, Function1 function1, Composer composer, int i8, int i9) {
        ...
        if (t10 != null && (animationSpec2 instanceof SpringSpec)) {
            ...
            if (!AbstractC3159y.d(springSpec.getVisibilityThreshold(), t10)) {
        ...
        if (rememberedValue4 == companion.getEmpty()) {
            rememberedValue4 = k6.g.b(-1, null, null, 6, null);
            composer.updateRememberedValue(rememberedValue4);
        }
        composer.endReplaceableGroup();
        k6.d dVar = (k6.d) rememberedValue4;
    ...
    public static final /* synthetic */ State animateIntAsState(int i8, AnimationSpec animationSpec, Function1 function1, Composer composer, int i9, int i10) {
        ...
        State animateValueAsState = animateValueAsState(Integer.valueOf(i8), VectorConvertersKt.getVectorConverter(C3158x.f33791a), animationSpec2, null, null, function12, composer, (i9 & 14) | ((i9 << 3) & 896) | ((i9 << 9) & 458752), 24);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
