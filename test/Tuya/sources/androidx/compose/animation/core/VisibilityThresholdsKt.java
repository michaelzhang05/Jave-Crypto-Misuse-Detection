...
public final class VisibilityThresholdsKt {
    ...
    static {
        ...
        r a11 = x.a(VectorConvertersKt.getVectorConverter(kotlin.jvm.internal.r.f33790a), Float.valueOf(0.01f));
    ...
    public static final int getVisibilityThreshold(C3158x c3158x) {
    ...
    public static final long getVisibilityThreshold(DpOffset.Companion companion) {
        ...
        return DpKt.m5199DpOffsetYgX7TsA(getVisibilityThreshold(companion2), getVisibilityThreshold(companion2));
    }
    ...
    public static final float getVisibilityThreshold(Dp.Companion companion) {
        AbstractC3159y.i(companion, "<this>");
        return Dp.m5178constructorimpl(0.1f);
    }
}
