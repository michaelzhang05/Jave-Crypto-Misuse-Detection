...
public final class Animatable<T, V extends AnimationVector> {
    ...
    public static /* synthetic */ Object animateDecay$default(Animatable animatable, Object obj, DecayAnimationSpec decayAnimationSpec, Function1 function1, P5.d dVar, int i8, Object obj2) {
        if ((i8 & 4) != 0) {
            function1 = null;
        }
    ...
    public static /* synthetic */ Object animateTo$default(Animatable animatable, Object obj, AnimationSpec animationSpec, Object obj2, Function1 function1, P5.d dVar, int i8, Object obj3) {
        if ((i8 & 2) != 0) {
    ...
    public final T clampToBounds(T t8) {
        if (AbstractC3159y.d(this.lowerBoundVector, this.negativeInfinityBounds) && AbstractC3159y.d(this.upperBoundVector, this.positiveInfinityBounds)) {
            return t8;
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public final Object runAnimation(Animation<T, V> animation, T t8, Function1 function1, P5.d dVar) {
    ...
    public final Object animateDecay(T t8, DecayAnimationSpec<T> decayAnimationSpec, Function1 function1, P5.d dVar) {
    ...
    public final Object animateTo(T t8, AnimationSpec<T> animationSpec, T t9, Function1 function1, P5.d dVar) {
    ...
    public final Object snapTo(T t8, P5.d dVar) {
        ...
        if (mutate$default == Q5.b.e()) {
            return mutate$default;
        }
        return I.f6487a;
    }

    public final Object stop(P5.d dVar) {
    ...
    public final void updateBounds(T t8, T t9) {
        ...
        if (!isRunning()) {
            ...
            if (!AbstractC3159y.d(clampToBounds, getValue())) {
                this.internalState.setValue$animation_core_release(clampToBounds);
            }
        }
    }

    public /* synthetic */ Animatable(Object obj, TwoWayConverter twoWayConverter, Object obj2, String str, int i8, AbstractC3151p abstractC3151p) {
        this(obj, twoWayConverter, (i8 & 4) != 0 ? null : obj2, (i8 & 8) != 0 ? "Animatable" : str);
    }

    public /* synthetic */ Animatable(Object obj, TwoWayConverter twoWayConverter, Object obj2, int i8, AbstractC3151p abstractC3151p) {
