...
public final class IconButtonKt {
    ...
    */
    public static final void FilledIconButton(kotlin.jvm.functions.Function0 r27, androidx.compose.ui.Modifier r28, boolean r29, androidx.compose.ui.graphics.Shape r30, androidx.compose.material3.IconButtonColors r31, androidx.compose.foundation.interaction.MutableInteractionSource r32, X5.n r33, androidx.compose.runtime.Composer r34, int r35, int r36) {
        /*
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static final void FilledIconToggleButton(boolean r31, kotlin.jvm.functions.Function1 r32, androidx.compose.ui.Modifier r33, boolean r34, androidx.compose.ui.graphics.Shape r35, androidx.compose.material3.IconToggleButtonColors r36, androidx.compose.foundation.interaction.MutableInteractionSource r37, X5.n r38, androidx.compose.runtime.Composer r39, int r40, int r41) {
        /*
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static final void FilledTonalIconButton(kotlin.jvm.functions.Function0 r27, androidx.compose.ui.Modifier r28, boolean r29, androidx.compose.ui.graphics.Shape r30, androidx.compose.material3.IconButtonColors r31, androidx.compose.foundation.interaction.MutableInteractionSource r32, X5.n r33, androidx.compose.runtime.Composer r34, int r35, int r36) {
        /*
            Method dump skipped, instructions count: 531
            To view this dump add '--comments-level debug' option
        */
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static final void FilledTonalIconToggleButton(boolean r31, kotlin.jvm.functions.Function1 r32, androidx.compose.ui.Modifier r33, boolean r34, androidx.compose.ui.graphics.Shape r35, androidx.compose.material3.IconToggleButtonColors r36, androidx.compose.foundation.interaction.MutableInteractionSource r37, X5.n r38, androidx.compose.runtime.Composer r39, int r40, int r41) {
        /*
            Method dump skipped, instructions count: 593
            To view this dump add '--comments-level debug' option
        */
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static final void IconButton(kotlin.jvm.functions.Function0 r27, androidx.compose.ui.Modifier r28, boolean r29, androidx.compose.material3.IconButtonColors r30, androidx.compose.foundation.interaction.MutableInteractionSource r31, X5.n r32, androidx.compose.runtime.Composer r33, int r34, int r35) {
        /*
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static final void IconToggleButton(boolean r29, kotlin.jvm.functions.Function1 r30, androidx.compose.ui.Modifier r31, boolean r32, androidx.compose.material3.IconToggleButtonColors r33, androidx.compose.foundation.interaction.MutableInteractionSource r34, X5.n r35, androidx.compose.runtime.Composer r36, int r37, int r38) {
        /*
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static final void OutlinedIconButton(kotlin.jvm.functions.Function0 r29, androidx.compose.ui.Modifier r30, boolean r31, androidx.compose.ui.graphics.Shape r32, androidx.compose.material3.IconButtonColors r33, androidx.compose.foundation.BorderStroke r34, androidx.compose.foundation.interaction.MutableInteractionSource r35, X5.n r36, androidx.compose.runtime.Composer r37, int r38, int r39) {
        /*
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static final void OutlinedIconToggleButton(boolean r32, kotlin.jvm.functions.Function1 r33, androidx.compose.ui.Modifier r34, boolean r35, androidx.compose.ui.graphics.Shape r36, androidx.compose.material3.IconToggleButtonColors r37, androidx.compose.foundation.BorderStroke r38, androidx.compose.foundation.interaction.MutableInteractionSource r39, X5.n r40, androidx.compose.runtime.Composer r41, int r42, int r43) {
        /*
