...
public final class IconKt {
    private static final Modifier DefaultIconSizeModifier = SizeKt.m647size3ABfNKs(Modifier.Companion, IconButtonTokens.INSTANCE.m2191getIconSizeD9Ej5fM());
    ...
    */
    public static final void m1670Iconww6aTOc(androidx.compose.ui.graphics.vector.ImageVector r17, java.lang.String r18, androidx.compose.ui.Modifier r19, long r20, androidx.compose.runtime.Composer r22, int r23, int r24) {
        /*
            Method dump skipped, instructions count: 273
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.IconKt.m1670Iconww6aTOc(androidx.compose.ui.graphics.vector.ImageVector, java.lang.String, androidx.compose.ui.Modifier, long, androidx.compose.runtime.Composer, int, int):void");
    }

    private static final Modifier defaultSizeFor(Modifier modifier, Painter painter) {
        Modifier modifier2;
        if (!Size.m2800equalsimpl0(painter.mo3508getIntrinsicSizeNHjbRc(), Size.Companion.m2812getUnspecifiedNHjbRc()) && !m1671isInfiniteuvyYCjk(painter.mo3508getIntrinsicSizeNHjbRc())) {
    ...
    private static final boolean m1671isInfiniteuvyYCjk(long j8) {
    ...
    @Composable
    /* renamed from: Icon-ww6aTOc, reason: not valid java name */
    public static final void m1668Iconww6aTOc(ImageBitmap bitmap, String str, Modifier modifier, long j8, Composer composer, int i8, int i9) {
        long j9;
        int i10;
        ...
        if ((i9 & 8) != 0) {
            j9 = ((Color) startRestartGroup.consume(ContentColorKt.getLocalContentColor())).m2981unboximpl();
            i10 = i8 & (-7169);
        } else {
            j9 = j8;
            i10 = i8;
        ...
        m1669Iconww6aTOc((BitmapPainter) rememberedValue, str, modifier2, j9, startRestartGroup, (i10 & 112) | 8 | (i10 & 896) | (i10 & 7168), 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    @Composable
    /* renamed from: Icon-ww6aTOc, reason: not valid java name */
    public static final void m1669Iconww6aTOc(Painter painter, String str, Modifier modifier, long j8, Composer composer, int i8, int i9) {
        long j9;
        int i10;
        Modifier modifier2;
