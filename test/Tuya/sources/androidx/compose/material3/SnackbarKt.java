...
public final class SnackbarKt {
    ...
    private static final float ContainerMaxWidth = Dp.m5178constructorimpl(600);
    private static final float HeightToFirstLine = Dp.m5178constructorimpl(30);
    private static final float HorizontalSpacing = Dp.m5178constructorimpl(16);
    private static final float SeparateButtonExtraY = Dp.m5178constructorimpl(2);
    private static final float SnackbarVerticalPadding = Dp.m5178constructorimpl(6);
    private static final float LongButtonVerticalOffset = Dp.m5178constructorimpl(12);

    static {
        float f8 = 8;
        HorizontalSpacingButtonSide = Dp.m5178constructorimpl(f8);
        TextEndExtraSpacing = Dp.m5178constructorimpl(f8);
    }
    ...
    public static final void m1770NewLineButtonSnackbarkKq0p4A(n nVar, n nVar2, n nVar3, TextStyle textStyle, long j8, long j9, Composer composer, int i8) {
        int i9;
        ...
        if ((374491 & i9) == 74898 && startRestartGroup.getSkipping()) {
            ...
            Modifier m604paddingqDBjuR0$default = PaddingKt.m604paddingqDBjuR0$default(SizeKt.fillMaxWidth$default(SizeKt.m654widthInVpY3zN4$default(companion, 0.0f, ContainerMaxWidth, 1, null), 0.0f, 1, null), HorizontalSpacing, 0.0f, 0.0f, SeparateButtonExtraY, 6, null);
            ...
            Modifier m488paddingFromBaselineVpY3zN4 = AlignmentLineKt.m488paddingFromBaselineVpY3zN4(companion, HeightToFirstLine, LongButtonVerticalOffset);
            float f8 = HorizontalSpacingButtonSide;
            Modifier m604paddingqDBjuR0$default2 = PaddingKt.m604paddingqDBjuR0$default(m488paddingFromBaselineVpY3zN4, 0.0f, 0.0f, f8, 0.0f, 11, null);
            ...
            if (nVar3 == null) {
                m5178constructorimpl = f8;
            } else {
                m5178constructorimpl = Dp.m5178constructorimpl(0);
            }
            Modifier m604paddingqDBjuR0$default3 = PaddingKt.m604paddingqDBjuR0$default(align, 0.0f, 0.0f, m5178constructorimpl, 0.0f, 11, null);
            startRestartGroup.startReplaceableGroup(733328855);
            ...
            o materializerOf3 = LayoutKt.materializerOf(m604paddingqDBjuR0$default3);
            if (!(startRestartGroup.getApplier() instanceof Applier)) {
                ComposablesKt.invalidApplier();
            }
            startRestartGroup.startReusableNode();
            ...
            Updater.m2503setimpl(m2496constructorimpl3, density3, companion3.getSetDensity());
            Updater.m2503setimpl(m2496constructorimpl3, layoutDirection3, companion3.getSetLayoutDirection());
            Updater.m2503setimpl(m2496constructorimpl3, viewConfiguration3, companion3.getSetViewConfiguration());
            startRestartGroup.enableReusing();
            ...
            Updater.m2503setimpl(m2496constructorimpl4, rowMeasurePolicy, companion3.getSetMeasurePolicy());
            Updater.m2503setimpl(m2496constructorimpl4, density4, companion3.getSetDensity());
            Updater.m2503setimpl(m2496constructorimpl4, layoutDirection4, companion3.getSetLayoutDirection());
            Updater.m2503setimpl(m2496constructorimpl4, viewConfiguration4, companion3.getSetViewConfiguration());
            startRestartGroup.enableReusing();
            ...
            CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m2961boximpl(j8)), TextKt.getLocalTextStyle().provides(textStyle)}, nVar2, startRestartGroup, (i9 & 112) | 8);
            if (nVar3 != null) {
                CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m2961boximpl(j9))}, nVar3, startRestartGroup, ((i9 >> 3) & 112) | 8);
            }
            startRestartGroup.endReplaceableGroup();
            startRestartGroup.endReplaceableGroup();
            startRestartGroup.endReplaceableGroup();
        ...
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new SnackbarKt$NewLineButtonSnackbar$2(nVar, nVar2, nVar3, textStyle, j8, j9, i8));
        }
    }
    ...
    public static final void m1771OneRowSnackbarkKq0p4A(n nVar, n nVar2, n nVar3, TextStyle textStyle, long j8, long j9, Composer composer, int i8) {
        int i9;
        float m5178constructorimpl;
        int i10;
        int i11;
        ...
        if ((374491 & i9) == 74898 && startRestartGroup.getSkipping()) {
            ...
            if (nVar3 == null) {
                m5178constructorimpl = HorizontalSpacingButtonSide;
            } else {
                m5178constructorimpl = Dp.m5178constructorimpl(0);
            }
            Modifier m604paddingqDBjuR0$default = PaddingKt.m604paddingqDBjuR0$default(companion, f8, 0.0f, m5178constructorimpl, 0.0f, 10, null);
            ...
            MeasurePolicy measurePolicy = new MeasurePolicy() { // from class: androidx.compose.material3.SnackbarKt$OneRowSnackbar$2
                ...
                public final MeasureResult mo132measure3p2s80s(MeasureScope Layout, List<? extends Measurable> measurables, long j10) {
                    float f9;
                    Placeable placeable;
                    Object obj;
                    ...
                    int m5146getMaxWidthimpl = Constraints.m5146getMaxWidthimpl(j10);
                    f9 = SnackbarKt.ContainerMaxWidth;
                    int min = Math.min(m5146getMaxWidthimpl, Layout.mo442roundToPx0680j_4(f9));
                    ...
                    while (true) {
                        ...
                        if (it.hasNext()) {
                            obj = it.next();
                            if (AbstractC3159y.d(LayoutIdKt.getLayoutId((Measurable) obj), str4)) {
                                break;
                            }
                        } else {
                            obj = null;
                    ...
                    if (measurable != null) {
                        placeable2 = measurable.mo4131measureBRTryo0(j10);
                    } else {
                        placeable2 = null;
                    }
                    String str5 = str2;
                    ...
                    while (true) {
                        if (it2.hasNext()) {
                            obj2 = it2.next();
                            if (AbstractC3159y.d(LayoutIdKt.getLayoutId((Measurable) obj2), str5)) {
                                break;
                            }
                        } else {
                            obj2 = null;
                    ...
                    if (measurable2 != null) {
                        placeable = measurable2.mo4131measureBRTryo0(j10);
                    }
                    ...
                    if (i18 == 0) {
                        ...
                        i20 = Layout.mo442roundToPx0680j_4(f11);
                    } else {
                        i20 = 0;
                    }
                    int d8 = m.d(((min - i16) - i18) - i20, Constraints.m5148getMinWidthimpl(j10));
                    String str6 = str3;
                    for (Measurable measurable3 : list) {
                        if (AbstractC3159y.d(LayoutIdKt.getLayoutId(measurable3), str6)) {
                            int i27 = i19;
                            Placeable mo4131measureBRTryo0 = measurable3.mo4131measureBRTryo0(Constraints.m5137copyZbe2FdA$default(j10, 0, d8, 0, 0, 9, null));
                            int i28 = mo4131measureBRTryo0.get(androidx.compose.ui.layout.AlignmentLineKt.getFirstBaseline());
                            if (i28 != Integer.MIN_VALUE) {
                                int i29 = mo4131measureBRTryo0.get(androidx.compose.ui.layout.AlignmentLineKt.getLastBaseline());
                                if (i29 != Integer.MIN_VALUE) {
                                    ...
                                    if (!z8) {
                                        ...
                                        int mo442roundToPx0680j_4 = Layout.mo442roundToPx0680j_4(f10) - i28;
                                        max = Math.max(Layout.mo442roundToPx0680j_4(SnackbarTokens.INSTANCE.m2370getTwoLinesContainerHeightD9Ej5fM()), mo4131measureBRTryo0.getHeight() + mo442roundToPx0680j_4);
                                        if (placeable2 != null) {
                                            i21 = (max - placeable2.getHeight()) / 2;
                                        } else {
                                            i21 = 0;
                                        }
                                        i22 = mo442roundToPx0680j_4;
                                        i23 = i21;
                                    } else {
                                        int max2 = Math.max(Layout.mo442roundToPx0680j_4(SnackbarTokens.INSTANCE.m2369getSingleLineContainerHeightD9Ej5fM()), Math.max(i17, i27));
                                        int height = (max2 - mo4131measureBRTryo0.getHeight()) / 2;
                                    ...
                                    return MeasureScope.CC.q(Layout, min, max, null, new SnackbarKt$OneRowSnackbar$2$measure$4(mo4131measureBRTryo0, i22, placeable3, i30, i24, placeable2, i31, i23), 4, null);
                                }
            ...
            Modifier m602paddingVpY3zN4$default = PaddingKt.m602paddingVpY3zN4$default(LayoutIdKt.layoutId(companion, MimeTypes.BASE_TYPE_TEXT), 0.0f, SnackbarVerticalPadding, 1, null);
            startRestartGroup.startReplaceableGroup(733328855);
            ...
            o materializerOf2 = LayoutKt.materializerOf(m602paddingVpY3zN4$default);
            if (!(startRestartGroup.getApplier() instanceof Applier)) {
                ComposablesKt.invalidApplier();
            }
            startRestartGroup.startReusableNode();
            ...
            if (nVar2 != null) {
                ...
                o materializerOf3 = LayoutKt.materializerOf(layoutId);
                if (!(startRestartGroup.getApplier() instanceof Applier)) {
                    ComposablesKt.invalidApplier();
                }
                startRestartGroup.startReusableNode();
            ...
            if (nVar3 != null) {
                ...
                o materializerOf4 = LayoutKt.materializerOf(layoutId2);
                if (!(startRestartGroup.getApplier() instanceof Applier)) {
                    ComposablesKt.invalidApplier();
                }
                startRestartGroup.startReusableNode();
                ...
                Updater.m2503setimpl(m2496constructorimpl4, density4, companion2.getSetDensity());
                Updater.m2503setimpl(m2496constructorimpl4, layoutDirection4, companion2.getSetLayoutDirection());
                Updater.m2503setimpl(m2496constructorimpl4, viewConfiguration4, companion2.getSetViewConfiguration());
                startRestartGroup.enableReusing();
                materializerOf4.invoke(SkippableUpdater.m2485boximpl(SkippableUpdater.m2486constructorimpl(startRestartGroup)), startRestartGroup, 0);
                startRestartGroup.startReplaceableGroup(2058660585);
                startRestartGroup.startReplaceableGroup(-2137368960);
        ...
        ScopeUpdateScope endRestartGroup = startRestartGroup.endRestartGroup();
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new SnackbarKt$OneRowSnackbar$3(nVar, nVar2, nVar3, textStyle, j8, j9, i8));
        }
    }
    ...
    */
    public static final void m1772SnackbareQBnUkQ(androidx.compose.ui.Modifier r25, X5.n r26, X5.n r27, boolean r28, androidx.compose.ui.graphics.Shape r29, long r30, long r32, long r34, long r36, X5.n r38, androidx.compose.runtime.Composer r39, int r40, int r41) {
        /*
            Method dump skipped, instructions count: 646
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.SnackbarKt.m1772SnackbareQBnUkQ(androidx.compose.ui.Modifier, X5.n, X5.n, boolean, androidx.compose.ui.graphics.Shape, long, long, long, long, X5.n, androidx.compose.runtime.Composer, int, int):void");
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static final void m1773SnackbarsDKtq54(androidx.compose.material3.SnackbarData r39, androidx.compose.ui.Modifier r40, boolean r41, androidx.compose.ui.graphics.Shape r42, long r43, long r45, long r47, long r49, long r51, androidx.compose.runtime.Composer r53, int r54, int r55) {
        /*
            Method dump skipped, instructions count: 690
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.SnackbarKt.m1773SnackbarsDKtq54(androidx.compose.material3.SnackbarData, androidx.compose.ui.Modifier, boolean, androidx.compose.ui.graphics.Shape, long, long, long, long, long, androidx.compose.runtime.Composer, int, int):void");
    }
}
