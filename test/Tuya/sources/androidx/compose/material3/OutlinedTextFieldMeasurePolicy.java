...
public final class OutlinedTextFieldMeasurePolicy implements MeasurePolicy {
    ...
    private final int intrinsicHeight(IntrinsicMeasureScope intrinsicMeasureScope, List<? extends IntrinsicMeasurable> list, int i8, n nVar) {
        ...
        int i12;
        int i13;
        int m1735calculateHeightO3s9Psw;
        ...
        for (Object obj6 : list2) {
            if (AbstractC3159y.d(TextFieldImplKt.getLayoutId((IntrinsicMeasurable) obj6), "TextField")) {
                ...
                m1735calculateHeightO3s9Psw = OutlinedTextFieldKt.m1735calculateHeightO3s9Psw(i11, i10, intValue, i9, i12, i13, TextFieldImplKt.getZeroConstraints(), intrinsicMeasureScope.getDensity(), this.paddingValues);
                return m1735calculateHeightO3s9Psw;
            }
        }
    ...
    private final int intrinsicWidth(IntrinsicMeasureScope intrinsicMeasureScope, List<? extends IntrinsicMeasurable> list, int i8, n nVar) {
        ...
        int i12;
        boolean z8;
        int m1736calculateWidthO3s9Psw;
        List<? extends IntrinsicMeasurable> list2 = list;
        for (Object obj5 : list2) {
            if (AbstractC3159y.d(TextFieldImplKt.getLayoutId((IntrinsicMeasurable) obj5), "TextField")) {
                ...
                m1736calculateWidthO3s9Psw = OutlinedTextFieldKt.m1736calculateWidthO3s9Psw(i11, i10, intValue, i9, i12, z8, TextFieldImplKt.getZeroConstraints(), intrinsicMeasureScope.getDensity(), this.paddingValues);
                return m1736calculateWidthO3s9Psw;
            }
        }
        throw new NoSuchElementException("Collection contains no element matching the predicate.");
    }
    ...
    public MeasureResult mo132measure3p2s80s(MeasureScope measure, List<? extends Measurable> measurables, long j8) {
        ...
        if (z8) {
            i8 = (-widthOrZero2) - mo442roundToPx0680j_42;
        } else {
            i8 = -mo442roundToPx0680j_42;
        }
        int i11 = -mo442roundToPx0680j_4;
        long m5162offsetNN6EwU = ConstraintsKt.m5162offsetNN6EwU(m5137copyZbe2FdA$default, i8, i11);
        ...
        int max3 = Math.max(TextFieldImplKt.heightOrZero(placeable3) / 2, measure.mo442roundToPx0680j_4(this.paddingValues.mo553calculateTopPaddingD9Ej5fM()));
        long m5137copyZbe2FdA$default2 = Constraints.m5137copyZbe2FdA$default(ConstraintsKt.m5162offsetNN6EwU(j8, -widthOrZero2, i11 - max3), 0, 0, 0, 0, 11, null);
        ...
        while (it4.hasNext()) {
            ...
            if (AbstractC3159y.d(LayoutIdKt.getLayoutId(measurable4), "TextField")) {
                ...
                long m5137copyZbe2FdA$default4 = Constraints.m5137copyZbe2FdA$default(ConstraintsKt.m5163offsetNN6EwU$default(m5137copyZbe2FdA$default, 0, -Math.max(max2, Math.max(TextFieldImplKt.heightOrZero(mo4131measureBRTryo0), TextFieldImplKt.heightOrZero(placeable4)) + max3 + mo442roundToPx0680j_4), 1, null), 0, 0, 0, 0, 11, null);
                ...
                if (measurable6 != null) {
                    placeable5 = measurable6.mo4131measureBRTryo0(m5137copyZbe2FdA$default4);
                } else {
                    placeable5 = null;
                }
                int heightOrZero = TextFieldImplKt.heightOrZero(placeable5);
                m1736calculateWidthO3s9Psw = OutlinedTextFieldKt.m1736calculateWidthO3s9Psw(TextFieldImplKt.widthOrZero(placeable), TextFieldImplKt.widthOrZero(placeable2), mo4131measureBRTryo0.getWidth(), TextFieldImplKt.widthOrZero(placeable3), TextFieldImplKt.widthOrZero(placeable4), z8, j8, measure.getDensity(), this.paddingValues);
                m1735calculateHeightO3s9Psw = OutlinedTextFieldKt.m1735calculateHeightO3s9Psw(TextFieldImplKt.heightOrZero(placeable), TextFieldImplKt.heightOrZero(placeable2), mo4131measureBRTryo0.getHeight(), TextFieldImplKt.heightOrZero(placeable3), TextFieldImplKt.heightOrZero(placeable4), TextFieldImplKt.heightOrZero(placeable5), j8, measure.getDensity(), this.paddingValues);
                int i12 = m1735calculateHeightO3s9Psw - heightOrZero;
                for (Measurable measurable7 : list) {
                    if (AbstractC3159y.d(LayoutIdKt.getLayoutId(measurable7), TextFieldImplKt.ContainerId)) {
                        if (m1736calculateWidthO3s9Psw != Integer.MAX_VALUE) {
                            i9 = m1736calculateWidthO3s9Psw;
                        } else {
                            i9 = 0;
                        }
                        ...
                        return MeasureScope.CC.q(measure, m1736calculateWidthO3s9Psw, m1735calculateHeightO3s9Psw, null, new OutlinedTextFieldMeasurePolicy$measure$2(m1735calculateHeightO3s9Psw, m1736calculateWidthO3s9Psw, placeable, placeable2, mo4131measureBRTryo0, placeable3, placeable4, measurable7.mo4131measureBRTryo0(ConstraintsKt.Constraints(i9, m1736calculateWidthO3s9Psw, i10, i12)), placeable5, this, measure), 4, null);
                    }
                }
                throw new NoSuchElementException("Collection contains no element matching the predicate.");
            }
