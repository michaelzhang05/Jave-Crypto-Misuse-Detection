...
final class ComposableSingletons$TabRowKt$lambda2$1 extends AbstractC3160z implements n {
    ...
    public final void invoke(Composer composer, int i8) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-713969278, i8, -1, "androidx.compose.material3.ComposableSingletons$TabRowKt.lambda-2.<anonymous> (TabRow.kt:232)");
        }
