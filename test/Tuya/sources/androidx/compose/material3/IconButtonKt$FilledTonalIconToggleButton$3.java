...
final class IconButtonKt$FilledTonalIconToggleButton$3 extends AbstractC3160z implements n {
    final /* synthetic */ int $$dirty;
    final /* synthetic */ n $content;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public IconButtonKt$FilledTonalIconToggleButton$3(n nVar, int i8) {
        super(2);
        this.$content = nVar;
        this.$$dirty = i8;
    }
    ...
    public final void invoke(Composer composer, int i8) {
        ...
        Modifier m647size3ABfNKs = SizeKt.m647size3ABfNKs(Modifier.Companion, FilledTonalIconButtonTokens.INSTANCE.m2172getContainerSizeD9Ej5fM());
