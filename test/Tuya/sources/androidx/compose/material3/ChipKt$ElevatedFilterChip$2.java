...
public final class ChipKt$ElevatedFilterChip$2 extends AbstractC3160z implements n {
    ...
    public ChipKt$ElevatedFilterChip$2(boolean z8, Function0 function0, n nVar, Modifier modifier, boolean z9, n nVar2, n nVar3, Shape shape, SelectableChipColors selectableChipColors, SelectableChipElevation selectableChipElevation, SelectableChipBorder selectableChipBorder, MutableInteractionSource mutableInteractionSource, int i8, int i9, int i10) {
        super(2);
        this.$selected = z8;
