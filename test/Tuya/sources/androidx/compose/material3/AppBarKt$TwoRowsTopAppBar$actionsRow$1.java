...
public final class AppBarKt$TwoRowsTopAppBar$actionsRow$1 extends AbstractC3160z implements n {
    final /* synthetic */ int $$dirty;
    final /* synthetic */ o $actions;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public AppBarKt$TwoRowsTopAppBar$actionsRow$1(o oVar, int i8) {
        super(2);
        this.$actions = oVar;
        this.$$dirty = i8;
    }
