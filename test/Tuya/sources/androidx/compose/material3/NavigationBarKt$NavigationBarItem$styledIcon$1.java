...
public final class NavigationBarKt$NavigationBarItem$styledIcon$1 extends AbstractC3160z implements n {
    ...
    public NavigationBarKt$NavigationBarItem$styledIcon$1(NavigationBarItemColors navigationBarItemColors, boolean z8, int i8, n nVar, boolean z9, n nVar2) {
        super(2);
    ...
    public final void invoke(Composer composer, int i8) {
        ...
        CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m2961boximpl(m1709invoke$lambda0(iconColor$material3_release)))}, nVar, composer, ((i10 >> 6) & 112) | 8);
