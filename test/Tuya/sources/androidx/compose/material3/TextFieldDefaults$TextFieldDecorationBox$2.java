...
public final class TextFieldDefaults$TextFieldDecorationBox$2 extends AbstractC3160z implements n {
    ...
    public TextFieldDefaults$TextFieldDecorationBox$2(TextFieldDefaults textFieldDefaults, String str, n nVar, boolean z8, boolean z9, VisualTransformation visualTransformation, InteractionSource interactionSource, boolean z10, n nVar2, n nVar3, n nVar4, n nVar5, n nVar6, Shape shape, TextFieldColors textFieldColors, PaddingValues paddingValues, n nVar7, int i8, int i9, int i10) {
        super(2);
