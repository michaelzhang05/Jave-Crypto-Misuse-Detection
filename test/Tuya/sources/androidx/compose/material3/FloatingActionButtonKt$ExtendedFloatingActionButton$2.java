...
public final class FloatingActionButtonKt$ExtendedFloatingActionButton$2 extends AbstractC3160z implements n {
    ...
    public FloatingActionButtonKt$ExtendedFloatingActionButton$2(o oVar, int i8) {
        super(2);
        this.$content = oVar;
        this.$$dirty = i8;
    }
    ...
    public final void invoke(Composer composer, int i8) {
        ...
        Modifier m651sizeInqDBjuR0$default = SizeKt.m651sizeInqDBjuR0$default(companion, f8, 0.0f, 0.0f, 0.0f, 14, null);
        f9 = FloatingActionButtonKt.ExtendedFabTextPadding;
        Modifier m602paddingVpY3zN4$default = PaddingKt.m602paddingVpY3zN4$default(m651sizeInqDBjuR0$default, f9, 0.0f, 2, null);
