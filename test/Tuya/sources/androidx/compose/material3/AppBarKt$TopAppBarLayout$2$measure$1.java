...
final class AppBarKt$TopAppBarLayout$2$measure$1 extends AbstractC3160z implements Function1 {
    ...
    public final void invoke(Placeable.PlacementScope layout) {
        ...
        if (AbstractC3159y.d(horizontal, arrangement.getCenter())) {
            max = (Constraints.m5146getMaxWidthimpl(this.$constraints) - this.$titlePlaceable.getWidth()) / 2;
        } else if (AbstractC3159y.d(horizontal, arrangement.getEnd())) {
            max = (Constraints.m5146getMaxWidthimpl(this.$constraints) - this.$titlePlaceable.getWidth()) - this.$actionIconsPlaceable.getWidth();
        } else {
            MeasureScope measureScope = this.$this_Layout;
            f8 = AppBarKt.TopAppBarTitleInset;
            max = Math.max(measureScope.mo442roundToPx0680j_4(f8), this.$navigationIconPlaceable.getWidth());
        }
        int i10 = max;
        Arrangement.Vertical vertical = this.$titleVerticalArrangement;
        if (AbstractC3159y.d(vertical, arrangement.getCenter())) {
            i9 = (this.$layoutHeight - this.$titlePlaceable.getHeight()) / 2;
        } else if (AbstractC3159y.d(vertical, arrangement.getBottom())) {
            ...
            Placeable.PlacementScope.placeRelative$default(layout, this.$actionIconsPlaceable, Constraints.m5146getMaxWidthimpl(this.$constraints) - this.$actionIconsPlaceable.getWidth(), (this.$layoutHeight - this.$actionIconsPlaceable.getHeight()) / 2, 0.0f, 4, null);
        }
        i8 = i9;
        Placeable.PlacementScope.placeRelative$default(layout, placeable2, i10, i8, 0.0f, 4, null);
        Placeable.PlacementScope.placeRelative$default(layout, this.$actionIconsPlaceable, Constraints.m5146getMaxWidthimpl(this.$constraints) - this.$actionIconsPlaceable.getWidth(), (this.$layoutHeight - this.$actionIconsPlaceable.getHeight()) / 2, 0.0f, 4, null);
