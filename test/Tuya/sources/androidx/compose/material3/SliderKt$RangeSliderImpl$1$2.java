...
public final class SliderKt$RangeSliderImpl$1$2 extends AbstractC3160z implements o {
    ...
    public final void invoke(BoxScope TempRangeSliderThumb, Composer composer, int i8) {
        ...
        int i9 = this.$$dirty;
        sliderDefaults.m1757Thumb9LiSoMs(mutableInteractionSource, then, sliderColors, z8, 0L, composer, ((i9 >> 18) & 14) | ProfileVerifier.CompilationStatus.RESULT_CODE_ERROR_CANT_WRITE_PROFILE_VERIFICATION_RESULT_CACHE_FILE | ((i9 >> 6) & 896) | ((i9 << 9) & 7168), 16);
        if (ComposerKt.isTraceInProgress()) {
