...
public final class TabPosition {
    ...
    public final float m1830getLeftD9Ej5fM() {
        return this.left;
    }

    /* renamed from: getRight-D9Ej5fM, reason: not valid java name */
    public final float m1831getRightD9Ej5fM() {
        return Dp.m5178constructorimpl(this.left + this.width);
    }

    /* renamed from: getWidth-D9Ej5fM, reason: not valid java name */
    public final float m1832getWidthD9Ej5fM() {
        return this.width;
    }
    ...
    public String toString() {
        return "TabPosition(left=" + ((Object) Dp.m5189toStringimpl(this.left)) + ", right=" + ((Object) Dp.m5189toStringimpl(m1831getRightD9Ej5fM())) + ", width=" + ((Object) Dp.m5189toStringimpl(this.width)) + ')';
    }
