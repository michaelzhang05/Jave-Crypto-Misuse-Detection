...
public final class TextFieldImplKt$CommonDecorationBox$3$containerWithId$1 extends AbstractC3160z implements n {
    final /* synthetic */ int $$dirty1;
    final /* synthetic */ n $container;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public TextFieldImplKt$CommonDecorationBox$3$containerWithId$1(n nVar, int i8) {
        super(2);
        this.$container = nVar;
        this.$$dirty1 = i8;
    }
    ...
    public final void invoke(Composer composer, int i8) {
        ...
        o materializerOf = LayoutKt.materializerOf(layoutId);
