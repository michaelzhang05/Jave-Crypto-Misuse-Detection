...
public final class MenuKt$DropdownMenuContent$2 extends AbstractC3160z implements n {
    ...
    public MenuKt$DropdownMenuContent$2(Modifier modifier, o oVar, int i8) {
        super(2);
    ...
    public final void invoke(Composer composer, int i8) {
        ...
        Modifier verticalScroll$default = ScrollKt.verticalScroll$default(IntrinsicKt.width(PaddingKt.m602paddingVpY3zN4$default(this.$modifier, 0.0f, MenuKt.getDropdownMenuVerticalPadding(), 1, null), IntrinsicSize.Max), ScrollKt.rememberScrollState(0, composer, 0, 1), false, null, false, 14, null);
        o oVar = this.$content;
