...
public final class SwipeableKt$PreUpPostDownNestedScrollConnection$1 implements NestedScrollConnection {
    ...
    */
    public java.lang.Object mo455onPostFlingRZ2iAVY(long r5, long r7, P5.d r9) {
        /*
            r4 = this;
        ...
        L33:
            ...
            float r0 = androidx.compose.ui.unit.Velocity.m5409getXimpl(r7)
            float r2 = androidx.compose.ui.unit.Velocity.m5410getYimpl(r7)
            ...
            return r9
        L53:
            androidx.compose.ui.unit.Velocity r5 = androidx.compose.ui.unit.Velocity.m5400boximpl(r7)
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.SwipeableKt$PreUpPostDownNestedScrollConnection$1.mo455onPostFlingRZ2iAVY(long, long, P5.d):java.lang.Object");
    }
    ...
    public long mo456onPostScrollDzOQY0M(long j8, long j9, int i8) {
        if (NestedScrollSource.m3918equalsimpl0(i8, NestedScrollSource.Companion.m3923getDragWNlRxjI())) {
            return toOffset(this.$this_PreUpPostDownNestedScrollConnection.performDrag$material3_release(toFloat(j9)));
        }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public java.lang.Object mo457onPreFlingQWom1Mo(long r7, P5.d r9) {
        /*
            r6 = this;
        ...
        L33:
            L5.t.b(r9)
            float r9 = androidx.compose.ui.unit.Velocity.m5409getXimpl(r7)
            float r2 = androidx.compose.ui.unit.Velocity.m5410getYimpl(r7)
        ...
        L72:
            ...
            long r7 = r7.m5420getZero9UxMQ8M()
        L78:
            androidx.compose.ui.unit.Velocity r7 = androidx.compose.ui.unit.Velocity.m5400boximpl(r7)
            return r7
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.SwipeableKt$PreUpPostDownNestedScrollConnection$1.mo457onPreFlingQWom1Mo(long, P5.d):java.lang.Object");
    }
    ...
    public long mo458onPreScrollOzD1aCk(long j8, int i8) {
        float f8 = toFloat(j8);
        if (f8 < 0.0f && NestedScrollSource.m3918equalsimpl0(i8, NestedScrollSource.Companion.m3923getDragWNlRxjI())) {
            return toOffset(this.$this_PreUpPostDownNestedScrollConnection.performDrag$material3_release(f8));
        }
        return Offset.Companion.m2751getZeroF1C5BW0();
    }
}
