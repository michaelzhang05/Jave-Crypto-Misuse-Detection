...
public final class ScaffoldKt {
    ...
    */
    public static final void m1753ScaffoldTvnljyQ(androidx.compose.ui.Modifier r29, X5.n r30, X5.n r31, X5.n r32, X5.n r33, int r34, long r35, long r37, androidx.compose.foundation.layout.WindowInsets r39, X5.o r40, androidx.compose.runtime.Composer r41, int r42, int r43) {
        /*
            Method dump skipped, instructions count: 656
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.ScaffoldKt.m1753ScaffoldTvnljyQ(androidx.compose.ui.Modifier, X5.n, X5.n, X5.n, X5.n, int, long, long, androidx.compose.foundation.layout.WindowInsets, X5.o, androidx.compose.runtime.Composer, int, int):void");
    }
    ...
    public static final void m1754ScaffoldLayoutFMILGgc(int i8, n nVar, o oVar, n nVar2, n nVar3, WindowInsets windowInsets, n nVar4, Composer composer, int i9) {
        int i10;
        Composer composer2;
        int i11;
        int i12;
        ...
        if ((2995931 & i10) == 599186 && startRestartGroup.getSkipping()) {
            ...
            Object[] objArr = {nVar, nVar2, windowInsets, nVar3, FabPosition.m1631boximpl(i8), nVar4, oVar};
            ...
            if (!z8 && rememberedValue != Composer.Companion.getEmpty()) {
                ...
                i11 = 1;
                i12 = 0;
                ScaffoldKt$ScaffoldLayout$1$1 scaffoldKt$ScaffoldLayout$1$1 = new ScaffoldKt$ScaffoldLayout$1$1(nVar, nVar2, nVar3, i8, windowInsets, nVar4, i10, oVar);
                composer2.updateRememberedValue(scaffoldKt$ScaffoldLayout$1$1);
                rememberedValue = scaffoldKt$ScaffoldLayout$1$1;
            }
            composer2.endReplaceableGroup();
            SubcomposeLayoutKt.SubcomposeLayout(null, (n) rememberedValue, composer2, i12, i11);
            if (ComposerKt.isTraceInProgress()) {
        ...
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new ScaffoldKt$ScaffoldLayout$2(i8, nVar, oVar, nVar2, nVar3, windowInsets, nVar4, i9));
        }
    }
