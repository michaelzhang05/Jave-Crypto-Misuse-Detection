...
public final class NavigationDrawerKt$NavigationDrawerItem$3 extends AbstractC3160z implements n {
    ...
    public NavigationDrawerKt$NavigationDrawerItem$3(n nVar, boolean z8, Function0 function0, Modifier modifier, n nVar2, n nVar3, Shape shape, NavigationDrawerItemColors navigationDrawerItemColors, MutableInteractionSource mutableInteractionSource, int i8, int i9) {
        super(2);
        this.$label = nVar;
        this.$selected = z8;
