...
final class MinimumTouchTargetModifier implements LayoutModifier {
    ...
    public /* synthetic */ MinimumTouchTargetModifier(long j8, AbstractC3151p abstractC3151p) {
        this(j8);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return DpSize.m5273equalsimpl0(this.size, minimumTouchTargetModifier.size);
    }
    ...
    public final long m1694getSizeMYxV2XQ() {
        return this.size;
    }
    ...
    public MeasureResult mo156measure3p2s80s(MeasureScope measure, Measurable measurable, long j8) {
        ...
        return MeasureScope.CC.q(measure, max, max2, null, new MinimumTouchTargetModifier$measure$1(max, mo4131measureBRTryo0, max2), 4, null);
    }
    ...
    private MinimumTouchTargetModifier(long j8) {
        this.size = j8;
    }
}
