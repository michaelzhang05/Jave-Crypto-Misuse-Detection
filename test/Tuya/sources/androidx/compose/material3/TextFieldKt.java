...
public final class TextFieldKt {
    private static final float FirstBaselineOffset = Dp.m5178constructorimpl(20);
    private static final float TextFieldBottomPadding = Dp.m5178constructorimpl(10);
    private static final float TextFieldTopPadding = Dp.m5178constructorimpl(4);
    ...
    */
    public static final void TextField(java.lang.String r88, kotlin.jvm.functions.Function1 r89, androidx.compose.ui.Modifier r90, boolean r91, boolean r92, androidx.compose.ui.text.TextStyle r93, X5.n r94, X5.n r95, X5.n r96, X5.n r97, X5.n r98, boolean r99, androidx.compose.ui.text.input.VisualTransformation r100, androidx.compose.foundation.text.KeyboardOptions r101, androidx.compose.foundation.text.KeyboardActions r102, boolean r103, int r104, androidx.compose.foundation.interaction.MutableInteractionSource r105, androidx.compose.ui.graphics.Shape r106, androidx.compose.material3.TextFieldColors r107, androidx.compose.runtime.Composer r108, int r109, int r110, int r111) {
        /*
            Method dump skipped, instructions count: 1509
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.TextFieldKt.TextField(java.lang.String, kotlin.jvm.functions.Function1, androidx.compose.ui.Modifier, boolean, boolean, androidx.compose.ui.text.TextStyle, X5.n, X5.n, X5.n, X5.n, X5.n, boolean, androidx.compose.ui.text.input.VisualTransformation, androidx.compose.foundation.text.KeyboardOptions, androidx.compose.foundation.text.KeyboardActions, boolean, int, androidx.compose.foundation.interaction.MutableInteractionSource, androidx.compose.ui.graphics.Shape, androidx.compose.material3.TextFieldColors, androidx.compose.runtime.Composer, int, int, int):void");
    }
    ...
    public static final void TextFieldLayout(Modifier modifier, n textField, n nVar, o oVar, n nVar2, n nVar3, boolean z8, float f8, n container, n nVar4, PaddingValues paddingValues, Composer composer, int i8, int i9) {
        int i10;
        int i11;
        int i12;
        int i13;
        ...
        if ((i10 & 1533916891) == 306783378 && (i11 & 11) == 2 && startRestartGroup.getSkipping()) {
            ...
            Updater.m2503setimpl(m2496constructorimpl, textFieldMeasurePolicy, companion.getSetMeasurePolicy());
            ...
            if (nVar2 != null) {
                ...
                nVar2.invoke(startRestartGroup, Integer.valueOf((i10 >> 12) & 14));
                startRestartGroup.endReplaceableGroup();
                startRestartGroup.endReplaceableGroup();
                startRestartGroup.endReplaceableGroup();
            ...
            if (nVar3 != null) {
                ...
                nVar3.invoke(startRestartGroup, Integer.valueOf((i10 >> 15) & 14));
                startRestartGroup.endReplaceableGroup();
                startRestartGroup.endReplaceableGroup();
                startRestartGroup.endReplaceableGroup();
                startRestartGroup.endNode();
            ...
            if (oVar != null) {
                oVar.invoke(LayoutIdKt.layoutId(companion2, "Hint").then(m604paddingqDBjuR0$default), startRestartGroup, Integer.valueOf((i10 >> 6) & 112));
            }
            startRestartGroup.endReplaceableGroup();
            ...
            if (nVar != null) {
                ...
                nVar.invoke(startRestartGroup, Integer.valueOf((i10 >> 6) & 14));
                startRestartGroup.endReplaceableGroup();
                startRestartGroup.endReplaceableGroup();
                startRestartGroup.endReplaceableGroup();
                startRestartGroup.endNode();
            ...
            o materializerOf5 = LayoutKt.materializerOf(then4);
            if (!(startRestartGroup.getApplier() instanceof Applier)) {
                ComposablesKt.invalidApplier();
            }
            startRestartGroup.startReusableNode();
            ...
            if (nVar4 != null) {
                ...
                nVar4.invoke(startRestartGroup, Integer.valueOf((i10 >> 27) & 14));
                startRestartGroup.endReplaceableGroup();
                startRestartGroup.endReplaceableGroup();
                startRestartGroup.endReplaceableGroup();
                startRestartGroup.endNode();
        ...
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new TextFieldKt$TextFieldLayout$2(modifier, textField, nVar, oVar, nVar2, nVar3, z8, f8, container, nVar4, paddingValues, i8, i9));
        }
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: calculateHeight-jCXOeKk, reason: not valid java name */
    public static final int m1871calculateHeightjCXOeKk(int i8, boolean z8, int i9, int i10, int i11, int i12, int i13, long j8, float f8, PaddingValues paddingValues) {
        float f9;
        ...
        return Math.max(Constraints.m5147getMinHeightimpl(j8), Math.max(i10, Math.max(i11, Z5.a.d(f9))) + i13);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: calculateWidth-VsPV1Ek, reason: not valid java name */
    public static final int m1872calculateWidthVsPV1Ek(int i8, int i9, int i10, int i11, int i12, long j8) {
    ...
    public static final Modifier drawIndicatorLine(Modifier modifier, BorderStroke indicatorBorder) {
        ...
        AbstractC3159y.i(indicatorBorder, "indicatorBorder");
        return DrawModifierKt.drawWithContent(modifier, new TextFieldKt$drawIndicatorLine$1(indicatorBorder.m308getWidthD9Ej5fM(), indicatorBorder));
    }
    ...
    public static final void placeWithLabel(Placeable.PlacementScope placementScope, int i8, int i9, Placeable placeable, Placeable placeable2, Placeable placeable3, Placeable placeable4, Placeable placeable5, Placeable placeable6, Placeable placeable7, boolean z8, int i10, int i11, float f8, float f9) {
        ...
        if (placeable2 != null) {
            if (z8) {
                ...
                d8 = Z5.a.d(TextFieldImplKt.getTextFieldPadding() * f9);
            }
            Placeable.PlacementScope.placeRelative$default(placementScope, placeable2, TextFieldImplKt.widthOrZero(placeable4), d8 - Z5.a.d((d8 - i10) * f8), 0.0f, 4, null);
        }
    ...
    public static final void placeWithoutLabel(Placeable.PlacementScope placementScope, int i8, int i9, Placeable placeable, Placeable placeable2, Placeable placeable3, Placeable placeable4, Placeable placeable5, Placeable placeable6, boolean z8, float f8, PaddingValues paddingValues) {
        int i10;
        Placeable.PlacementScope.m4169place70tqf50$default(placementScope, placeable5, IntOffset.Companion.m5312getZeronOccac(), 0.0f, 2, null);
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static final void TextField(androidx.compose.ui.text.input.TextFieldValue r88, kotlin.jvm.functions.Function1 r89, androidx.compose.ui.Modifier r90, boolean r91, boolean r92, androidx.compose.ui.text.TextStyle r93, X5.n r94, X5.n r95, X5.n r96, X5.n r97, X5.n r98, boolean r99, androidx.compose.ui.text.input.VisualTransformation r100, androidx.compose.foundation.text.KeyboardOptions r101, androidx.compose.foundation.text.KeyboardActions r102, boolean r103, int r104, androidx.compose.foundation.interaction.MutableInteractionSource r105, androidx.compose.ui.graphics.Shape r106, androidx.compose.material3.TextFieldColors r107, androidx.compose.runtime.Composer r108, int r109, int r110, int r111) {
        /*
            Method dump skipped, instructions count: 1509
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.TextFieldKt.TextField(androidx.compose.ui.text.input.TextFieldValue, kotlin.jvm.functions.Function1, androidx.compose.ui.Modifier, boolean, boolean, androidx.compose.ui.text.TextStyle, X5.n, X5.n, X5.n, X5.n, X5.n, boolean, androidx.compose.ui.text.input.VisualTransformation, androidx.compose.foundation.text.KeyboardOptions, androidx.compose.foundation.text.KeyboardActions, boolean, int, androidx.compose.foundation.interaction.MutableInteractionSource, androidx.compose.ui.graphics.Shape, androidx.compose.material3.TextFieldColors, androidx.compose.runtime.Composer, int, int, int):void");
    }
}
