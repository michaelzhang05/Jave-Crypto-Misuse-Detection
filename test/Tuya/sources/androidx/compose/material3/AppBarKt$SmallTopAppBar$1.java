...
public final class AppBarKt$SmallTopAppBar$1 extends AbstractC3160z implements n {
    ...
    public AppBarKt$SmallTopAppBar$1(n nVar, Modifier modifier, n nVar2, o oVar, WindowInsets windowInsets, TopAppBarColors topAppBarColors, TopAppBarScrollBehavior topAppBarScrollBehavior, int i8, int i9) {
        super(2);
        this.$title = nVar;
