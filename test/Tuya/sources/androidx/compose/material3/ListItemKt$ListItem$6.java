...
final class ListItemKt$ListItem$6 extends AbstractC3160z implements n {
    ...
    public ListItemKt$ListItem$6(float f8, PaddingValues paddingValues, o oVar, int i8) {
        super(2);
        this.$minHeight = f8;
    ...
    public final void invoke(Composer composer, int i8) {
        ...
        Modifier padding = PaddingKt.padding(SizeKt.m635heightInVpY3zN4$default(Modifier.Companion, this.$minHeight, 0.0f, 2, null), this.$paddingValues);
        o oVar = this.$content;
