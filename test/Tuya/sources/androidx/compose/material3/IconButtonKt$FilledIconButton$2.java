...
final class IconButtonKt$FilledIconButton$2 extends AbstractC3160z implements n {
    final /* synthetic */ int $$dirty;
    final /* synthetic */ n $content;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public IconButtonKt$FilledIconButton$2(n nVar, int i8) {
        super(2);
        this.$content = nVar;
        this.$$dirty = i8;
    }
    ...
    public final void invoke(Composer composer, int i8) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1560623888, i8, -1, "androidx.compose.material3.FilledIconButton.<anonymous> (IconButton.kt:212)");
        }
        Modifier m647size3ABfNKs = SizeKt.m647size3ABfNKs(Modifier.Companion, FilledIconButtonTokens.INSTANCE.m2156getContainerSizeD9Ej5fM());
        ...
        composer.startReplaceableGroup(30997674);
