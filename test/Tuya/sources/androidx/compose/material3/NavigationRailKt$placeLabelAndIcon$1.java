...
public final class NavigationRailKt$placeLabelAndIcon$1 extends AbstractC3160z implements Function1 {
    ...
    public NavigationRailKt$placeLabelAndIcon$1(Placeable placeable, boolean z8, float f8, Placeable placeable2, int i8, int i9, int i10, Placeable placeable3, int i11, int i12, Placeable placeable4, int i13, int i14, int i15, MeasureScope measureScope) {
        super(1);
    ...
    public final void invoke(Placeable.PlacementScope layout) {
        ...
        if (placeable != null) {
            ...
            Placeable.PlacementScope.placeRelative$default(layout, placeable, width, i10 + (i9 - measureScope.mo442roundToPx0680j_4(f8)), 0.0f, 4, null);
        }
