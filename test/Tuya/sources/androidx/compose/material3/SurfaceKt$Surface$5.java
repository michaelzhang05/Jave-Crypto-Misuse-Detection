...
public final class SurfaceKt$Surface$5 extends AbstractC3160z implements n {
    ...
    public SurfaceKt$Surface$5(Modifier modifier, Shape shape, long j8, float f8, int i8, BorderStroke borderStroke, float f9, boolean z8, MutableInteractionSource mutableInteractionSource, boolean z9, Function0 function0, n nVar, int i9) {
        super(2);
    ...
    public final void invoke(Composer composer, int i8) {
        ...
        Modifier m822selectableO2vRcR0 = SelectableKt.m822selectableO2vRcR0(m1809surface8ww4TTg, this.$selected, this.$interactionSource, RippleKt.m1444rememberRipple9IZ8Weo(false, 0.0f, 0L, composer, 0, 7), this.$enabled, Role.m4516boximpl(Role.Companion.m4529getTabo7Vup1c()), this.$onClick);
        n nVar = this.$content;
        ...
        o materializerOf = LayoutKt.materializerOf(m822selectableO2vRcR0);
