...
final class OutlinedTextFieldKt$OutlinedTextField$5 extends AbstractC3160z implements n {
    ...
    public static final class AnonymousClass2 extends AbstractC3160z implements o {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        AnonymousClass2(TextFieldValue textFieldValue, boolean z8, boolean z9, VisualTransformation visualTransformation, MutableInteractionSource mutableInteractionSource, boolean z10, n nVar, n nVar2, n nVar3, n nVar4, n nVar5, TextFieldColors textFieldColors, int i8, int i9, Shape shape) {
            super(3);
        ...
        public final void invoke(n innerTextField, Composer composer, int i8) {
            ...
            int i10 = this.$$dirty;
            int i11 = this.$$dirty1;
            textFieldDefaults.OutlinedTextFieldDecorationBox(text, innerTextField, z8, z9, visualTransformation, mutableInteractionSource, z10, nVar, nVar2, nVar3, nVar4, nVar5, textFieldColors, null, composableLambda, composer, ((i9 << 3) & 112) | ((i10 >> 3) & 896) | ((i11 >> 6) & 7168) | ((i11 << 6) & 57344) | (458752 & (i11 >> 6)) | ((i11 << 15) & 3670016) | ((i10 << 3) & 29360128) | ((i10 << 3) & 234881024) | ((i10 << 3) & 1879048192), ((i10 >> 27) & 14) | 221184 | ((i11 << 3) & 112) | ((i11 >> 21) & 896), 8192);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public OutlinedTextFieldKt$OutlinedTextField$5(n nVar, Modifier modifier, TextFieldColors textFieldColors, boolean z8, int i8, TextFieldValue textFieldValue, Function1 function1, boolean z9, boolean z10, TextStyle textStyle, KeyboardOptions keyboardOptions, KeyboardActions keyboardActions, boolean z11, int i9, VisualTransformation visualTransformation, MutableInteractionSource mutableInteractionSource, int i10, n nVar2, n nVar3, n nVar4, n nVar5, Shape shape) {
        super(2);
        this.$label = nVar;
