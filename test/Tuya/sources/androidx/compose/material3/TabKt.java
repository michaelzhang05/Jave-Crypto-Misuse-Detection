...
public final class TabKt {
    ...
    private static final float SmallTabHeight = PrimaryNavigationTabTokens.INSTANCE.m2349getContainerHeightD9Ej5fM();
    ...
    */
    public static final void m1824LeadingIconTabwqdebIU(boolean r24, kotlin.jvm.functions.Function0 r25, X5.n r26, X5.n r27, androidx.compose.ui.Modifier r28, boolean r29, long r30, long r32, androidx.compose.foundation.interaction.MutableInteractionSource r34, androidx.compose.runtime.Composer r35, int r36, int r37) {
        /*
            Method dump skipped, instructions count: 604
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.TabKt.m1824LeadingIconTabwqdebIU(boolean, kotlin.jvm.functions.Function0, X5.n, X5.n, androidx.compose.ui.Modifier, boolean, long, long, androidx.compose.foundation.interaction.MutableInteractionSource, androidx.compose.runtime.Composer, int, int):void");
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static final void m1825TabbogVsAg(boolean r23, kotlin.jvm.functions.Function0 r24, androidx.compose.ui.Modifier r25, boolean r26, long r27, long r29, androidx.compose.foundation.interaction.MutableInteractionSource r31, X5.o r32, androidx.compose.runtime.Composer r33, int r34, int r35) {
        /*
            Method dump skipped, instructions count: 554
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.TabKt.m1825TabbogVsAg(boolean, kotlin.jvm.functions.Function0, androidx.compose.ui.Modifier, boolean, long, long, androidx.compose.foundation.interaction.MutableInteractionSource, X5.o, androidx.compose.runtime.Composer, int, int):void");
    }
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public static final void m1826TabwqdebIU(boolean r27, kotlin.jvm.functions.Function0 r28, androidx.compose.ui.Modifier r29, boolean r30, X5.n r31, X5.n r32, long r33, long r35, androidx.compose.foundation.interaction.MutableInteractionSource r37, androidx.compose.runtime.Composer r38, int r39, int r40) {
        /*
            Method dump skipped, instructions count: 622
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.material3.TabKt.m1826TabwqdebIU(boolean, kotlin.jvm.functions.Function0, androidx.compose.ui.Modifier, boolean, X5.n, X5.n, long, long, androidx.compose.foundation.interaction.MutableInteractionSource, androidx.compose.runtime.Composer, int, int):void");
    }
        ...
        if ((i9 & 91) == 18 && startRestartGroup.getSkipping()) {
            ...
            MeasurePolicy measurePolicy = new MeasurePolicy() { // from class: androidx.compose.material3.TabKt$TabBaselineLayout$2
                ...
                public final MeasureResult mo132measure3p2s80s(MeasureScope Layout, List<? extends Measurable> measurables, long j8) {
                    ...
                    int max2 = Math.max(mo442roundToPx0680j_4, i14 + i15 + Layout.mo441roundToPxR2X_6o(j9));
                    if (placeable != null) {
    ...
    public static final void m1827TabTransitionKlgxPg(long j8, long j9, boolean z8, n nVar, Composer composer, int i8) {
        int i9;
        long j10;
        long j11;
        long j12;
        ...
        if ((i9 & 5851) == 1170 && startRestartGroup.getSkipping()) {
            ...
            startRestartGroup.endReplaceableGroup();
            startRestartGroup.endReplaceableGroup();
            CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>[]) new ProvidedValue[]{ContentColorKt.getLocalContentColor().provides(Color.m2961boximpl(m1828TabTransition_Klgx_Pg$lambda5(createTransitionAnimation)))}, nVar, startRestartGroup, (i14 & 112) | 8);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        }
    ...
    private static final long m1828TabTransition_Klgx_Pg$lambda5(State<Color> state) {
    ...
    public static final void placeTextAndIcon(Placeable.PlacementScope placementScope, Density density, Placeable placeable, Placeable placeable2, int i8, int i9, int i10, int i11) {
        ...
        int mo442roundToPx0680j_4 = density.mo442roundToPx0680j_4(f8) + density.mo442roundToPx0680j_4(PrimaryNavigationTabTokens.INSTANCE.m2347getActiveIndicatorHeightD9Ej5fM());
