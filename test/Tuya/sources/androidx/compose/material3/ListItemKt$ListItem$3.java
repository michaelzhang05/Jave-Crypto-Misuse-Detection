...
public final class ListItemKt$ListItem$3 extends AbstractC3160z implements o {
    ...
    public ListItemKt$ListItem$3(n nVar, ListItemColors listItemColors, int i8, n nVar2, n nVar3, n nVar4) {
        super(3);
    ...
    public final void invoke(RowScope ListItem, Composer composer, int i8) {
        ...
        long m2981unboximpl = listItemColors.overlineColor$material3_release(composer, (i10 >> 18) & 14).getValue().m2981unboximpl();
