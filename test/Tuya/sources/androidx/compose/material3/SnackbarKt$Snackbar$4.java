...
public final class SnackbarKt$Snackbar$4 extends AbstractC3160z implements n {
    ...
    public final void invoke(Composer composer, int i8) {
        SnackbarKt.m1773SnackbarsDKtq54(this.$snackbarData, this.$modifier, this.$actionOnNewLine, this.$shape, this.$containerColor, this.$contentColor, this.$actionColor, this.$actionContentColor, this.$dismissActionContentColor, composer, this.$$changed | 1, this.$$default);
    }
}
