...
final class ExposedDropdownMenuBoxScope$ExposedDropdownMenu$popupPositionProvider$1$1 extends AbstractC3160z implements n {
    ...
    public final void invoke(IntRect anchorBounds, IntRect menuBounds) {
        ...
        this.$transformOriginState.setValue(TransformOrigin.m3326boximpl(MenuKt.calculateTransformOrigin(anchorBounds, menuBounds)));
    }
}
