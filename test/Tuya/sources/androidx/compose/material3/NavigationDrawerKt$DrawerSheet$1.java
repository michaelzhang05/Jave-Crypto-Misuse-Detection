...
public final class NavigationDrawerKt$DrawerSheet$1 extends AbstractC3160z implements n {
    ...
    public NavigationDrawerKt$DrawerSheet$1(WindowInsets windowInsets, o oVar, int i8) {
        super(2);
    ...
    public final void invoke(Composer composer, int i8) {
        ...
        Modifier windowInsetsPadding = WindowInsetsPaddingKt.windowInsetsPadding(SizeKt.m651sizeInqDBjuR0$default(companion, f8, 0.0f, DrawerDefaults.INSTANCE.m1609getMaximumDrawerWidthD9Ej5fM(), 0.0f, 10, null), this.$windowInsets);
        o oVar = this.$content;
