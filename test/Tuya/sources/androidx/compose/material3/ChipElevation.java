...
public final class ChipElevation {
    ...
    public /* synthetic */ ChipElevation(float f8, float f9, float f10, float f11, float f12, float f13, AbstractC3151p abstractC3151p) {
    ...
    private final State<Dp> animateElevation(boolean z8, InteractionSource interactionSource, Composer composer, int i8) {
        ...
        if (!z8) {
            ...
            EffectsKt.LaunchedEffect(Dp.m5176boximpl(f9), new ChipElevation$animateElevation$2(animatable, f9, null), composer, 64);
            composer.endReplaceableGroup();
        } else {
            composer.startReplaceableGroup(-1373769286);
            EffectsKt.LaunchedEffect(Dp.m5176boximpl(f9), new ChipElevation$animateElevation$3(animatable, this, f9, interaction, null), composer, 64);
            composer.endReplaceableGroup();
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (Dp.m5183equalsimpl0(this.defaultElevation, chipElevation.defaultElevation) && Dp.m5183equalsimpl0(this.pressedElevation, chipElevation.pressedElevation) && Dp.m5183equalsimpl0(this.focusedElevation, chipElevation.focusedElevation) && Dp.m5183equalsimpl0(this.hoveredElevation, chipElevation.hoveredElevation) && Dp.m5183equalsimpl0(this.disabledElevation, chipElevation.disabledElevation)) {
            return true;
        }
        return false;
    }
