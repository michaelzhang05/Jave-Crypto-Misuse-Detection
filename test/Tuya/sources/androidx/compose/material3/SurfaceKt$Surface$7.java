...
public final class SurfaceKt$Surface$7 extends AbstractC3160z implements n {
    ...
    public SurfaceKt$Surface$7(Modifier modifier, Shape shape, long j8, float f8, int i8, BorderStroke borderStroke, float f9, boolean z8, MutableInteractionSource mutableInteractionSource, boolean z9, Function1 function1, n nVar, int i9) {
        super(2);
    ...
    public final void invoke(Composer composer, int i8) {
        ...
        m1810surfaceColorAtElevationCLU3JFs = SurfaceKt.m1810surfaceColorAtElevationCLU3JFs(this.$color, this.$absoluteElevation, composer, (this.$$changed >> 15) & 14);
        ...
        Modifier m826toggleableO2vRcR0 = ToggleableKt.m826toggleableO2vRcR0(m1809surface8ww4TTg, this.$checked, this.$interactionSource, RippleKt.m1444rememberRipple9IZ8Weo(false, 0.0f, 0L, composer, 0, 7), this.$enabled, Role.m4516boximpl(Role.Companion.m4528getSwitcho7Vup1c()), this.$onCheckedChange);
        n nVar = this.$content;
        ...
        o materializerOf = LayoutKt.materializerOf(m826toggleableO2vRcR0);
