...
public class InvalidationTracker {
    ...
    public static final class Companion {
        ...
        public final String getTriggerName$room_runtime_release(String tableName, String triggerType) {
            ...
            AbstractC3159y.i(triggerType, "triggerType");
    ...
    public static final class ObservedTableTracker {
        ...
        public final boolean onAdded(int... tableIds) {
            boolean z8;
            AbstractC3159y.i(tableIds, "tableIds");
            synchronized (this) {
                try {
                    z8 = false;
                    for (int i8 : tableIds) {
        ...
        */
        protected Observer(java.lang.String r3, java.lang.String... r4) {
            /*
                ...
                java.util.List r0 = M5.AbstractC1246t.c()
                r1 = r0
                java.util.Collection r1 = (java.util.Collection) r1
                M5.AbstractC1246t.E(r1, r4)
                r0.add(r3)
                java.util.List r3 = M5.AbstractC1246t.a(r0)
    ...
    public static final class ObserverWrapper {
        ...
        public final void notifyByTableInvalidStatus$room_runtime_release(Set<Integer> invalidatedTablesIds) {
            Set<String> f8;
            AbstractC3159y.i(invalidatedTablesIds, "invalidatedTablesIds");
        ...
        public final void notifyByTableNames$room_runtime_release(String[] tables) {
            ...
            if (length != 0) {
                if (length != 1) {
                    ...
                    while (true) {
                        if (i8 < length2) {
                            if (g6.n.s(tables[i8], this.tableNames[0], true)) {
                                f8 = this.singleTableSet;
                                break;
                            }
                            i8++;
    ...
    public InvalidationTracker(RoomDatabase database, Map<String, String> shadowTablesMap, Map<String, Set<String>> viewTables, String... tableNames) {
        String str;
        AbstractC3159y.i(database, "database");
        AbstractC3159y.i(shadowTablesMap, "shadowTablesMap");
        AbstractC3159y.i(viewTables, "viewTables");
        AbstractC3159y.i(tableNames, "tableNames");
        ...
        for (int i8 = 0; i8 < length; i8++) {
            ...
            if (str3 != null) {
                ...
                AbstractC3159y.h(str, "this as java.lang.String).toLowerCase(locale)");
            } else {
                str = null;
            }
            if (str != null) {
        ...
        for (Map.Entry<String, String> entry : this.shadowTablesMap.entrySet()) {
            ...
            if (this.tableIdLookup.containsKey(lowerCase2)) {
                ...
                AbstractC3159y.h(lowerCase3, "this as java.lang.String).toLowerCase(locale)");
    ...
    private final void startTrackingTable(SupportSQLiteDatabase supportSQLiteDatabase, int i8) {
        ...
        for (String str2 : TRIGGERS) {
            ...
            AbstractC3159y.h(str3, "StringBuilder().apply(builderAction).toString()");
    ...
    public void addObserver(Observer observer) {
        ...
        int[] V02 = AbstractC1246t.V0(arrayList);
        ...
        synchronized (this.observerMap) {
            try {
                ...
                while (it.hasNext()) {
                    ...
                    AbstractC3159y.h(entry, "(observer, wrapper)");
