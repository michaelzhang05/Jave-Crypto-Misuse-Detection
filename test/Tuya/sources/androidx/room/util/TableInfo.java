...
public final class TableInfo {
    ...
    public static final class ForeignKey {
        ...
        public ForeignKey(String referenceTable, String onDelete, String onUpdate, List<String> columnNames, List<String> referenceColumnNames) {
            AbstractC3159y.i(referenceTable, "referenceTable");
            AbstractC3159y.i(onDelete, "onDelete");
            AbstractC3159y.i(onUpdate, "onUpdate");
            AbstractC3159y.i(columnNames, "columnNames");
            AbstractC3159y.i(referenceColumnNames, "referenceColumnNames");
        ...
        public boolean equals(Object obj) {
            ...
            if (!AbstractC3159y.d(this.referenceTable, foreignKey.referenceTable) || !AbstractC3159y.d(this.onDelete, foreignKey.onDelete) || !AbstractC3159y.d(this.onUpdate, foreignKey.onUpdate) || !AbstractC3159y.d(this.columnNames, foreignKey.columnNames)) {
                return false;
            }
            return AbstractC3159y.d(this.referenceColumnNames, foreignKey.referenceColumnNames);
        }
    ...
    public TableInfo(String name, Map<String, Column> columns, Set<ForeignKey> foreignKeys, Set<Index> set) {
        ...
        AbstractC3159y.i(foreignKeys, "foreignKeys");
        this.name = name;
    ...
    public boolean equals(Object obj) {
        ...
        if (!AbstractC3159y.d(this.name, tableInfo.name) || !AbstractC3159y.d(this.columns, tableInfo.columns) || !AbstractC3159y.d(this.foreignKeys, tableInfo.foreignKeys)) {
            return false;
        }
        ...
        return AbstractC3159y.d(set2, set);
    }
    ...
    public /* synthetic */ TableInfo(String str, Map map, Set set, Set set2, int i8, AbstractC3151p abstractC3151p) {
    ...
    public static final class Column {
        ...
        public static final class Companion {
            ...
            public final boolean defaultValueEquals(String current, String str) {
                ...
                if (AbstractC3159y.d(current, str)) {
                    return true;
                }
                if (containsSurroundingParenthesis(current)) {
                    ...
                    return AbstractC3159y.d(n.M0(substring).toString(), str);
                }
                return false;
            }
        ...
        public boolean equals(Object obj) {
            ...
            if (!AbstractC3159y.d(this.name, column.name) || this.notNull != column.notNull) {
                return false;
            }
    ...
    public static final class Index {
        ...
        public Index(String name, boolean z8, List<String> columns, List<String> orders) {
            AbstractC3159y.i(name, "name");
            AbstractC3159y.i(columns, "columns");
            AbstractC3159y.i(orders, "orders");
            this.name = name;
            this.unique = z8;
            this.columns = columns;
            this.orders = orders;
        ...
        public boolean equals(Object obj) {
            ...
            if (this.unique != index.unique || !AbstractC3159y.d(this.columns, index.columns) || !AbstractC3159y.d(this.orders, index.orders)) {
                return false;
            }
            if (n.C(this.name, DEFAULT_PREFIX, false, 2, null)) {
                return n.C(index.name, DEFAULT_PREFIX, false, 2, null);
            }
            return AbstractC3159y.d(this.name, index.name);
        }
