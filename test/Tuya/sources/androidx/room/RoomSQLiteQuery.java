...
public final class RoomSQLiteQuery implements SupportSQLiteQuery, SupportSQLiteProgram {
    ...
    public static final class Companion {
        ...
        public final RoomSQLiteQuery acquire(String query, int i8) {
            ...
            synchronized (treeMap) {
                ...
                if (ceilingEntry != null) {
                    ...
                    AbstractC3159y.h(sqliteQuery, "sqliteQuery");
                    return sqliteQuery;
                }
                I i9 = I.f6487a;
        ...
        public final RoomSQLiteQuery copyFrom(SupportSQLiteQuery supportSQLiteQuery) {
            AbstractC3159y.i(supportSQLiteQuery, "supportSQLiteQuery");
        ...
        public final void prunePoolLocked$room_runtime_release() {
            ...
            if (treeMap.size() > 15) {
                ...
                AbstractC3159y.h(it, "queryPool.descendingKeySet().iterator()");
                while (true) {
                    int i8 = size - 1;
                    if (size > 0) {
                        it.next();
    ...
    public /* synthetic */ RoomSQLiteQuery(int i8, AbstractC3151p abstractC3151p) {
        this(i8);
    }
