...
public class CustomTabsClient {
    ...
    public CustomTabsClient(android.support.customtabs.b bVar, ComponentName componentName, Context context) {
        this.mService = bVar;
    ...
    private a.AbstractBinderC0264a createCallbackWrapper(@Nullable final CustomTabsCallback customTabsCallback) {
        return new a.AbstractBinderC0264a() { // from class: androidx.browser.customtabs.CustomTabsClient.2
            ...
            @Override // android.support.customtabs.a
            public void onActivityLayout(final int i8, final int i9, final int i10, final int i11, final int i12, @NonNull final Bundle bundle) throws RemoteException {
                if (customTabsCallback == null) {
                    return;
                }
                this.mHandler.post(new Runnable() { // from class: androidx.browser.customtabs.CustomTabsClient.2.8
                    @Override // java.lang.Runnable
                    public void run() {
                        customTabsCallback.onActivityLayout(i8, i9, i10, i11, i12, bundle);
                    }
                });
            }

            @Override // android.support.customtabs.a
            public void onActivityResized(final int i8, final int i9, @Nullable final Bundle bundle) throws RemoteException {
                if (customTabsCallback == null) {
                    return;
                }
                this.mHandler.post(new Runnable() { // from class: androidx.browser.customtabs.CustomTabsClient.2.6
                    @Override // java.lang.Runnable
                    public void run() {
                        customTabsCallback.onActivityResized(i8, i9, bundle);
                    }
                });
            }
            ...
            @Override // android.support.customtabs.a
            public void onNavigationEvent(final int i8, final Bundle bundle) {
                if (customTabsCallback == null) {
                    return;
                }
            ...
            @Override // android.support.customtabs.a
            public void onRelationshipValidationResult(final int i8, final Uri uri, final boolean z8, @Nullable final Bundle bundle) throws RemoteException {
                if (customTabsCallback == null) {
                    return;
                }
                this.mHandler.post(new Runnable() { // from class: androidx.browser.customtabs.CustomTabsClient.2.5
                    @Override // java.lang.Runnable
                    public void run() {
                        customTabsCallback.onRelationshipValidationResult(i8, uri, z8, bundle);
                    }
                });
            }
    ...
    private static PendingIntent createSessionId(Context context, int i8) {
        return PendingIntent.getActivity(context, i8, new Intent(), AccessibilityEventCompat.TYPE_VIEW_TARGETED_BY_SCROLL);
    }
    ...
    public static CustomTabsSession.PendingSession newPendingSession(@NonNull Context context, @Nullable CustomTabsCallback customTabsCallback, int i8) {
        return new CustomTabsSession.PendingSession(customTabsCallback, createSessionId(context, i8));
    }
    ...
    private CustomTabsSession newSessionInternal(@Nullable CustomTabsCallback customTabsCallback, @Nullable PendingIntent pendingIntent) {
        boolean newSession;
        a.AbstractBinderC0264a createCallbackWrapper = createCallbackWrapper(customTabsCallback);
        try {
    ...
    public boolean warmup(long j8) {
        try {
            return this.mService.warmup(j8);
        } catch (RemoteException unused) {
            return false;
        }
    }
    ...
    @Nullable
    public static String getPackageName(@NonNull Context context, @Nullable List<String> list, boolean z8) {
    ...
    @Nullable
    public CustomTabsSession newSession(@Nullable CustomTabsCallback customTabsCallback, int i8) {
        return newSessionInternal(customTabsCallback, createSessionId(this.mApplicationContext, i8));
    }
}
