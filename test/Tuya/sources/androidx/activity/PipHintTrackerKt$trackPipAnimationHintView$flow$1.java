...
final class PipHintTrackerKt$trackPipAnimationHintView$flow$1 extends kotlin.coroutines.jvm.internal.l implements n {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public PipHintTrackerKt$trackPipAnimationHintView$flow$1(View view, P5.d dVar) {
        super(2, dVar);
        this.$view = view;
    }
    ...
    public static final void invokeSuspend$lambda$0(s sVar, View view, int i8, int i9, int i10, int i11, int i12, int i13, int i14, int i15) {
        ...
        if (i8 != i12 || i10 != i14 || i9 != i13 || i11 != i15) {
            ...
            sVar.y(trackPipAnimationHintView$positionInWindow);
        }
    }
        ...
        if (i8 != 0) {
            ...
            ?? r32 = new View.OnAttachStateChangeListener() { // from class: androidx.activity.PipHintTrackerKt$trackPipAnimationHintView$flow$1$attachStateChangeListener$1
                ...
                public void onViewAttachedToWindow(View view3) {
                    ...
                    sVar2.y(trackPipAnimationHintView$positionInWindow2);
    ...
    public final Object invoke(s sVar, P5.d dVar) {
        return ((PipHintTrackerKt$trackPipAnimationHintView$flow$1) create(sVar, dVar)).invokeSuspend(I.f6487a);
    }
}
