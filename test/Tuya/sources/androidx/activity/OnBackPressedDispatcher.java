...
public final class OnBackPressedDispatcher {
    ...
    private final C1238k onBackPressedCallbacks;
    ...
    /* loaded from: classes.dex */
    static final class AnonymousClass3 extends AbstractC3160z implements Function0 {
        AnonymousClass3() {
            super(0);
        }
    ...
    public static final class Api33Impl {
        ...
        public static final void createOnBackInvokedCallback$lambda$0(Function0 onBackInvoked) {
            AbstractC3159y.i(onBackInvoked, "$onBackInvoked");
    ...
    public static final class Api34Impl {
        ...
        public final OnBackInvokedCallback createOnBackAnimationCallback(final Function1 onBackStarted, final Function1 onBackProgressed, final Function0 onBackInvoked, final Function0 onBackCancelled) {
            AbstractC3159y.i(onBackStarted, "onBackStarted");
            AbstractC3159y.i(onBackProgressed, "onBackProgressed");
            AbstractC3159y.i(onBackInvoked, "onBackInvoked");
            AbstractC3159y.i(onBackCancelled, "onBackCancelled");
    ...
    private final class LifecycleOnBackPressedCancellable implements LifecycleEventObserver, Cancellable {
        ...
        public LifecycleOnBackPressedCancellable(OnBackPressedDispatcher onBackPressedDispatcher, Lifecycle lifecycle, OnBackPressedCallback onBackPressedCallback) {
            ...
            AbstractC3159y.i(onBackPressedCallback, "onBackPressedCallback");
    ...
    public final class OnBackPressedCancellable implements Cancellable {
        ...
        public void cancel() {
            ...
            if (AbstractC3159y.d(this.this$0.inProgressCallback, this.onBackPressedCallback)) {
    ...
    public final void onBackCancelled() {
        ...
        if (onBackPressedCallback2 == null) {
            C1238k c1238k = this.onBackPressedCallbacks;
            ListIterator listIterator = c1238k.listIterator(c1238k.size());
            while (true) {
    ...
    public final void setOnBackInvokedDispatcher(OnBackInvokedDispatcher invoker) {
        AbstractC3159y.i(invoker, "invoker");
    ...
    public OnBackPressedDispatcher(Runnable runnable, Consumer<Boolean> consumer) {
        ...
        this.onBackPressedCallbacks = new C1238k();
    ...
    public /* synthetic */ OnBackPressedDispatcher(Runnable runnable, int i8, AbstractC3151p abstractC3151p) {
