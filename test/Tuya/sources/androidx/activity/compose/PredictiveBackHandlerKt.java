...
public final class PredictiveBackHandlerKt {
    @Composable
    public static final void PredictiveBackHandler(final boolean z8, n nVar, Composer composer, int i8, int i9) {
        Composer startRestartGroup = composer.startRestartGroup(-642000585);
        if ((i9 & 1) != 0) {
            z8 = true;
        }
        final State rememberUpdatedState = SnapshotStateKt.rememberUpdatedState(nVar, startRestartGroup, 8);
        startRestartGroup.startReplaceableGroup(-723524056);
        startRestartGroup.startReplaceableGroup(-3687241);
        Object rememberedValue = startRestartGroup.rememberedValue();
        Composer.Companion companion = Composer.Companion;
        if (rememberedValue == companion.getEmpty()) {
            CompositionScopedCoroutineScopeCanceller compositionScopedCoroutineScopeCanceller = new CompositionScopedCoroutineScopeCanceller(EffectsKt.createCompositionCoroutineScope(h.f7994a, startRestartGroup));
        ...
        if (rememberedValue2 == companion.getEmpty()) {
            rememberedValue2 = new OnBackPressedCallback(z8) { // from class: androidx.activity.compose.PredictiveBackHandlerKt$PredictiveBackHandler$backCallBack$1$1
                ...
                public void handleOnBackPressed() {
                    n PredictiveBackHandler$lambda$0;
                    OnBackInstance onBackInstance = this.onBackInstance;
                ...
                public void handleOnBackProgressed(BackEventCompat backEventCompat) {
                    ...
                    OnBackInstance onBackInstance = this.onBackInstance;
                    if (onBackInstance != null) {
                        k6.h.b(onBackInstance.m100sendJP2dKIU(backEventCompat));
                    }
                }
        ...
        if (current != null) {
            ...
            if (endRestartGroup != null) {
                endRestartGroup.updateScope(new PredictiveBackHandlerKt$PredictiveBackHandler$3(z8, nVar, i8, i9));
                return;
            }
            return;
        }
    ...
    public static final n PredictiveBackHandler$lambda$0(State<? extends n> state) {
