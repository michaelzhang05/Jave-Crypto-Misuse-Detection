...
public abstract class SpecialEffectsController {
    ...
    public static final class Companion {
        ...
        public final SpecialEffectsController getOrCreateController(ViewGroup container, FragmentManager fragmentManager) {
            ...
            AbstractC3159y.i(fragmentManager, "fragmentManager");
            SpecialEffectsControllerFactory specialEffectsControllerFactory = fragmentManager.getSpecialEffectsControllerFactory();
            AbstractC3159y.h(specialEffectsControllerFactory, "fragmentManager.specialEffectsControllerFactory");
        ...
        public final SpecialEffectsController getOrCreateController(ViewGroup container, SpecialEffectsControllerFactory factory) {
            ...
            AbstractC3159y.h(createController, "factory.createController(container)");
        ...
        */
        ...
        public void onStart() {
            if (getLifecycleImpact() == Operation.LifecycleImpact.ADDING) {
                ...
                AbstractC3159y.h(fragment, "fragmentStateManager.fragment");
                ...
                AbstractC3159y.h(requireView, "this.fragment.requireView()");
            ...
            if (getLifecycleImpact() == Operation.LifecycleImpact.REMOVING) {
                ...
                AbstractC3159y.h(fragment2, "fragmentStateManager.fragment");
                View requireView2 = fragment2.requireView();
                AbstractC3159y.h(requireView2, "fragment.requireView()");
                if (FragmentManager.isLoggingEnabled(2)) {
    ...
    public static class Operation {
        ...
        public Operation(State finalState, LifecycleImpact lifecycleImpact, Fragment fragment, CancellationSignal cancellationSignal) {
            AbstractC3159y.i(finalState, "finalState");
            AbstractC3159y.i(lifecycleImpact, "lifecycleImpact");
        ...
        public final void cancel() {
            ...
            Iterator it = AbstractC1246t.a1(this.specialEffectsSignals).iterator();
            while (it.hasNext()) {
        ...
        public final void setLifecycleImpact(LifecycleImpact lifecycleImpact) {
            AbstractC3159y.i(lifecycleImpact, "<set-?>");
            this.lifecycleImpact = lifecycleImpact;
        }
    ...
    private final Operation findPendingOperation(Fragment fragment) {
        ...
        while (true) {
            if (it.hasNext()) {
                ...
                if (AbstractC3159y.d(operation.getFragment(), fragment) && !operation.isCanceled()) {
                    break;
                }
            } else {
                obj = null;
    ...
    private final void updateFinalState() {
        for (Operation operation : this.pendingOperations) {
            if (operation.getLifecycleImpact() == Operation.LifecycleImpact.ADDING) {
                ...
                AbstractC3159y.h(requireView, "fragment.requireView()");
    ...
    public final void enqueueAdd(Operation.State finalState, FragmentStateManager fragmentStateManager) {
        AbstractC3159y.i(finalState, "finalState");
        AbstractC3159y.i(fragmentStateManager, "fragmentStateManager");
        if (FragmentManager.isLoggingEnabled(2)) {
        ...
        synchronized (this.pendingOperations) {
            try {
                if (!this.pendingOperations.isEmpty()) {
                    List<Operation> Z02 = AbstractC1246t.Z0(this.runningOperations);
                    ...
                    updateFinalState();
                    List<Operation> Z03 = AbstractC1246t.Z0(this.pendingOperations);
    ...
    public final void forceCompleteAllOperations() {
        ...
        synchronized (this.pendingOperations) {
            try {
                ...
                for (Operation operation : AbstractC1246t.Z0(this.runningOperations)) {
                    if (FragmentManager.isLoggingEnabled(2)) {
                ...
                for (Operation operation2 : AbstractC1246t.Z0(this.pendingOperations)) {
                    if (FragmentManager.isLoggingEnabled(2)) {
                        if (isAttachedToWindow) {
                            str = "";
                        } else {
