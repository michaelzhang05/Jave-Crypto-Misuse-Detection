...
public class MenuPopupHelper implements MenuHelper {
    ...
    private void showPopup(int i8, int i9, boolean z8, boolean z9) {
    ...
    public MenuPopupHelper(@NonNull Context context, @NonNull MenuBuilder menuBuilder, @NonNull View view, boolean z8, @AttrRes int i8) {
    ...
    public MenuPopupHelper(@NonNull Context context, @NonNull MenuBuilder menuBuilder, @NonNull View view, boolean z8, @AttrRes int i8, @StyleRes int i9) {
