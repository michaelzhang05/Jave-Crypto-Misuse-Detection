...
public class ToolbarWidgetWrapper implements DecorToolbar {
    ...
    public void setCollapsible(boolean z8) {
        this.mToolbar.setCollapsible(z8);
    }
    ...
    public void setNavigationMode(int i8) {
        ...
        if (i8 != i9) {
            if (i9 != 1) {
                if (i9 == 2 && (view = this.mTabView) != null) {
                    ViewParent parent = view.getParent();
                    Toolbar toolbar = this.mToolbar;
                    if (parent == toolbar) {
                        toolbar.removeView(this.mTabView);
    ...
    public ViewPropertyAnimatorCompat setupAnimatorToVisibility(final int i8, long j8) {
        ...
        return animate.alpha(f8).setDuration(j8).setListener(new ViewPropertyAnimatorListenerAdapter() { // from class: androidx.appcompat.widget.ToolbarWidgetWrapper.2
    ...
    public ToolbarWidgetWrapper(Toolbar toolbar, boolean z8, int i8, int i9) {
        Drawable drawable;
