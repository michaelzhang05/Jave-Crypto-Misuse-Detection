...
public final class e implements MeasurePolicy {
    ...
    private final float f36498b;

    /* renamed from: c, reason: collision with root package name */
    private final PaddingValues f36499c;
    ...
    static final class c extends AbstractC3160z implements Function1 {
        ...
        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ Placeable f36502a;
        ...
        final /* synthetic */ int f36506e;

        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ Placeable f36507f;

        /* renamed from: g, reason: collision with root package name */
        final /* synthetic */ Placeable f36508g;

        /* renamed from: h, reason: collision with root package name */
        final /* synthetic */ Placeable f36509h;

        /* renamed from: i, reason: collision with root package name */
        final /* synthetic */ Placeable f36510i;

        /* renamed from: j, reason: collision with root package name */
        final /* synthetic */ e f36511j;

        /* renamed from: k, reason: collision with root package name */
        final /* synthetic */ int f36512k;

        /* renamed from: l, reason: collision with root package name */
        final /* synthetic */ int f36513l;

        /* renamed from: m, reason: collision with root package name */
        final /* synthetic */ MeasureScope f36514m;
        ...
        c(Placeable placeable, int i8, int i9, int i10, int i11, Placeable placeable2, Placeable placeable3, Placeable placeable4, Placeable placeable5, e eVar, int i12, int i13, MeasureScope measureScope) {
            super(1);
            this.f36502a = placeable;
            this.f36503b = i8;
            this.f36504c = i9;
            this.f36505d = i10;
            this.f36506e = i11;
            this.f36507f = placeable2;
            this.f36508g = placeable3;
            this.f36509h = placeable4;
            this.f36510i = placeable5;
            this.f36511j = eVar;
            this.f36512k = i12;
            this.f36513l = i13;
            this.f36514m = measureScope;
        }
        ...
        public final void invoke(Placeable.PlacementScope layout) {
            ...
            if (this.f36502a == null) {
                o4.d.o(layout, this.f36505d, this.f36506e, this.f36507f, this.f36508g, this.f36509h, this.f36510i, this.f36511j.f36497a, this.f36514m.getDensity(), this.f36511j.f36499c);
                return;
            }
            int d8 = m.d(this.f36503b - this.f36504c, 0);
            o4.d.n(layout, this.f36505d, this.f36506e, this.f36507f, this.f36502a, this.f36508g, this.f36509h, this.f36510i, this.f36511j.f36497a, d8, this.f36513l + this.f36512k, this.f36511j.f36498b, this.f36514m.getDensity());
        }
    }
    ...
    static final class C0842e extends AbstractC3160z implements n {
        ...
        /* renamed from: a, reason: collision with root package name */
        public static final C0842e f36516a = new C0842e();
    ...
    private final int d(IntrinsicMeasureScope intrinsicMeasureScope, List list, int i8, n nVar) {
        ...
        for (int i17 = 0; i17 < size4; i17++) {
            ...
            if (AbstractC3159y.d(l8, "TextField")) {
                ...
                j8 = o4.d.j(intValue, z8, i12, i10, i11, i13, AbstractC3529a.d(), intrinsicMeasureScope.getDensity(), this.f36499c);
                return j8;
            }
        }
    ...
    public int maxIntrinsicHeight(IntrinsicMeasureScope intrinsicMeasureScope, List measurables, int i8) {
        ...
        return d(intrinsicMeasureScope, measurables, i8, a.f36500a);
    }
    ...
    public int maxIntrinsicWidth(IntrinsicMeasureScope intrinsicMeasureScope, List measurables, int i8) {
        AbstractC3159y.i(intrinsicMeasureScope, "<this>");
        AbstractC3159y.i(measurables, "measurables");
        return e(measurables, i8, b.f36501a);
    }
    ...
    public MeasureResult mo132measure3p2s80s(MeasureScope measure, List list, long j8) {
        ...
        AbstractC3159y.i(measurables, "measurables");
        int mo442roundToPx0680j_4 = measure.mo442roundToPx0680j_4(this.f36499c.mo553calculateTopPaddingD9Ej5fM());
        int mo442roundToPx0680j_42 = measure.mo442roundToPx0680j_4(this.f36499c.mo550calculateBottomPaddingD9Ej5fM());
        f8 = o4.d.f36486a;
        ...
        while (i17 < size4) {
            ...
            if (AbstractC3159y.d(LayoutIdKt.getLayoutId(measurable4), "TextField")) {
                ...
                j9 = o4.d.j(height, z8, max, m8, m9, m10, j8, measure.getDensity(), this.f36499c);
    ...
    public int minIntrinsicHeight(IntrinsicMeasureScope intrinsicMeasureScope, List measurables, int i8) {
        AbstractC3159y.i(intrinsicMeasureScope, "<this>");
        AbstractC3159y.i(measurables, "measurables");
        return d(intrinsicMeasureScope, measurables, i8, d.f36515a);
    }
    ...
    public int minIntrinsicWidth(IntrinsicMeasureScope intrinsicMeasureScope, List measurables, int i8) {
        AbstractC3159y.i(intrinsicMeasureScope, "<this>");
        AbstractC3159y.i(measurables, "measurables");
        return e(measurables, i8, C0842e.f36516a);
    }
}
