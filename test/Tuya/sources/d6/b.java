...
public final class b extends e {
    ...
    public String b(C6.b field) {
        ...
        switch (field) {
            case SharingNotice:
                String SHARING_NOTICE = AbstractC3824e.f38701b;
                AbstractC3159y.h(SHARING_NOTICE, "SHARING_NOTICE");
                return SHARING_NOTICE;
            case SaleOptOutNotice:
                String SALE_OPT_OUT_NOTICE = AbstractC3824e.f38702c;
            ...
            case TargetedAdvertisingOptOutNotice:
                String TARGETED_ADVERTISING_OPT_OUT_NOTICE = AbstractC3824e.f38703d;
            ...
            case SaleOptOut:
                String SALE_OPT_OUT = AbstractC3824e.f38704e;
                AbstractC3159y.h(SALE_OPT_OUT, "SALE_OPT_OUT");
                return SALE_OPT_OUT;
            case TargetedAdvertisingOptOut:
                String TARGETED_ADVERTISING_OPT_OUT = AbstractC3824e.f38705f;
            ...
            case SensitiveDataProcessing:
                String SENSITIVE_DATA_PROCESSING = AbstractC3824e.f38706g;
            ...
            case KnownChildSensitiveDataConsents:
                String KNOWN_CHILD_SENSITIVE_DATA_CONSENTS = AbstractC3824e.f38707h;
            ...
            case MspaCoveredTransaction:
                String MSPA_COVERED_TRANSACTION = AbstractC3824e.f38708i;
            ...
            case MspaOptOutOptionMode:
                String MSPA_OPT_OUT_OPTION_MODE = AbstractC3824e.f38709j;
            ...
            case MspaServiceProviderMode:
                String MSPA_SERVICE_PROVIDER_MODE = AbstractC3824e.f38710k;
