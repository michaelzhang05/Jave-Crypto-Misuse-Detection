...
public class k implements Q1.a {
    ...
    private final Q1.b f7743b = new Q1.b();
    ...
    public static byte[] o(String str) {
        byte[] bArr;
        if (str != null) {
            bArr = str.getBytes(Z1.m.f13247a);
        } else {
            bArr = null;
        }
        return l(bArr);
    ...
    private MessageDigest p() {
        ...
        try {
            if (a8 == null) {
                return MessageDigest.getInstance(this.f7742a);
            }
            return MessageDigest.getInstance(this.f7742a, a8);
