...
public class c0 {
    ...
    private static final long f17434i = TimeUnit.HOURS.toSeconds(8);

    /* renamed from: a, reason: collision with root package name */
    private final Context f17435a;

    /* renamed from: b, reason: collision with root package name */
    private final G f17436b;

    /* renamed from: c, reason: collision with root package name */
    private final B f17437c;

    /* renamed from: d, reason: collision with root package name */
    private final FirebaseMessaging f17438d;

    /* renamed from: f, reason: collision with root package name */
    private final ScheduledExecutorService f17440f;

    /* renamed from: h, reason: collision with root package name */
    private final a0 f17442h;

    /* renamed from: e, reason: collision with root package name */
    private final Map f17439e = new ArrayMap();
    ...
    private c0(FirebaseMessaging firebaseMessaging, G g8, a0 a0Var, B b8, Context context, ScheduledExecutorService scheduledExecutorService) {
        this.f17438d = firebaseMessaging;
        this.f17436b = g8;
        this.f17442h = a0Var;
        this.f17437c = b8;
        this.f17435a = context;
        this.f17440f = scheduledExecutorService;
    }
    ...
    private void c(String str) {
        b(this.f17437c.k(this.f17438d.i(), str));
    }

    private void d(String str) {
        b(this.f17437c.l(this.f17438d.i(), str));
    }
    ...
    private void j(Z z8) {
        synchronized (this.f17439e) {
            try {
                String e8 = z8.e();
                if (!this.f17439e.containsKey(e8)) {
                    return;
                }
                ArrayDeque arrayDeque = (ArrayDeque) this.f17439e.get(e8);
                C3679j c3679j = (C3679j) arrayDeque.poll();
                if (c3679j != null) {
                    c3679j.c(null);
                }
                if (arrayDeque.isEmpty()) {
                    this.f17439e.remove(e8);
                }
            } catch (Throwable th) {
                throw th;
            }
    ...
    */
    ...
    public void l(Runnable runnable, long j8) {
        this.f17440f.schedule(runnable, j8, TimeUnit.SECONDS);
    }
    ...
    */
    public boolean p() {
        ...
        L0:
            monitor-enter(r2)
            com.google.firebase.messaging.a0 r0 = r2.f17442h     // Catch: java.lang.Throwable -> L17
        ...
        L1c:
            ...
            return r0
        L25:
            com.google.firebase.messaging.a0 r1 = r2.f17442h
            r1.d(r0)
            r2.j(r0)
            goto L0
        L2e:
    ...
    public void q(long j8) {
        l(new d0(this, this.f17435a, this.f17436b, Math.min(Math.max(30L, 2 * j8), f17434i)), j8);
        m(true);
    }
}
