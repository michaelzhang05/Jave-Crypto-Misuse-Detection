...
public class o implements ScheduledExecutorService {
    ...
    private final ExecutorService f17248a;

    /* renamed from: b, reason: collision with root package name */
    private final ScheduledExecutorService f17249b;

    /* JADX INFO: Access modifiers changed from: package-private */
    public o(ExecutorService executorService, ScheduledExecutorService scheduledExecutorService) {
        this.f17248a = executorService;
        this.f17249b = scheduledExecutorService;
    }
    ...
    public /* synthetic */ void n(final Runnable runnable, final p.b bVar) {
        this.f17248a.execute(new Runnable() { // from class: com.google.firebase.concurrent.m
    ...
    public /* synthetic */ ScheduledFuture o(final Runnable runnable, long j8, TimeUnit timeUnit, final p.b bVar) {
        return this.f17249b.schedule(new Runnable() { // from class: com.google.firebase.concurrent.j
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public /* synthetic */ Future q(final Callable callable, final p.b bVar) {
        return this.f17248a.submit(new Runnable() { // from class: com.google.firebase.concurrent.n
            @Override // java.lang.Runnable
            public final void run() {
                o.p(callable, bVar);
            }
    ...
    public /* synthetic */ ScheduledFuture r(final Callable callable, long j8, TimeUnit timeUnit, final p.b bVar) {
        return this.f17249b.schedule(new Callable() { // from class: com.google.firebase.concurrent.k
    ...
    public /* synthetic */ void t(final Runnable runnable, final p.b bVar) {
        this.f17248a.execute(new Runnable() { // from class: com.google.firebase.concurrent.d
            @Override // java.lang.Runnable
            public final void run() {
                o.s(runnable, bVar);
            }
    ...
    public /* synthetic */ ScheduledFuture u(final Runnable runnable, long j8, long j9, TimeUnit timeUnit, final p.b bVar) {
        return this.f17249b.scheduleAtFixedRate(new Runnable() { // from class: com.google.firebase.concurrent.i
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public /* synthetic */ void v(final Runnable runnable, final p.b bVar) {
        this.f17248a.execute(new Runnable() { // from class: com.google.firebase.concurrent.e
            @Override // java.lang.Runnable
            public final void run() {
                o.x(runnable, bVar);
            }
    ...
    public /* synthetic */ ScheduledFuture w(final Runnable runnable, long j8, long j9, TimeUnit timeUnit, final p.b bVar) {
        return this.f17249b.scheduleWithFixedDelay(new Runnable() { // from class: com.google.firebase.concurrent.l
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public boolean awaitTermination(long j8, TimeUnit timeUnit) {
        return this.f17248a.awaitTermination(j8, timeUnit);
    }

    @Override // java.util.concurrent.Executor
    public void execute(Runnable runnable) {
        this.f17248a.execute(runnable);
    }

    @Override // java.util.concurrent.ExecutorService
    public List invokeAll(Collection collection) {
        return this.f17248a.invokeAll(collection);
    }

    @Override // java.util.concurrent.ExecutorService
    public Object invokeAny(Collection collection) {
        return this.f17248a.invokeAny(collection);
    }

    @Override // java.util.concurrent.ExecutorService
    public boolean isShutdown() {
        return this.f17248a.isShutdown();
    }

    @Override // java.util.concurrent.ExecutorService
    public boolean isTerminated() {
        return this.f17248a.isTerminated();
    }
    ...
    public Future submit(Runnable runnable, Object obj) {
        return this.f17248a.submit(runnable, obj);
    }

    @Override // java.util.concurrent.ExecutorService
    public Future submit(Runnable runnable) {
        return this.f17248a.submit(runnable);
    }
}
