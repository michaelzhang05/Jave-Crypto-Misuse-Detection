...
public class GoogleApiActivity extends Activity implements DialogInterface.OnCancelListener {
    ...
    private final void b() {
        ...
        if (pendingIntent != null) {
            try {
                ...
                if (extras.getBoolean("notify_manager", true)) {
                    C1939c.u(this).D(new C1258b(22, null), getIntent().getIntExtra("failing_client_id", -1));
                } else {
        ...
        C1263g.n().o(this, ((Integer) AbstractC1319p.l(num)).intValue(), 2, this);
        this.f15084a = 1;
    }
    ...
    protected final void onActivityResult(int i8, int i9, Intent intent) {
        ...
        if (i8 == 1) {
            ...
            setResult(i9, intent);
            if (booleanExtra) {
                C1939c u8 = C1939c.u(this);
                if (i9 != -1) {
                    if (i9 == 0) {
                        u8.D(new C1258b(13, null), getIntent().getIntExtra("failing_client_id", -1));
                    }
                } else {
                    u8.E();
                }
    ...
    protected final void onCreate(Bundle bundle) {
        ...
        if (bundle != null) {
            this.f15084a = bundle.getInt("resolution");
        }
        if (this.f15084a != 1) {
            b();
        }
    ...
    protected final void onSaveInstanceState(Bundle bundle) {
        bundle.putInt("resolution", this.f15084a);
