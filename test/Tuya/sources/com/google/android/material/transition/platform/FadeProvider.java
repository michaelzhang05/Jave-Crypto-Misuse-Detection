...
public final class FadeProvider implements VisibilityAnimatorProvider {
    ...
    private static Animator createFadeAnimator(final View view, final float f8, final float f9, @FloatRange(from = 0.0d, to = 1.0d) final float f10, @FloatRange(from = 0.0d, to = 1.0d) final float f11, final float f12) {
    ...
    public void setIncomingEndThreshold(float f8) {
        this.incomingEndThreshold = f8;
    }
}
