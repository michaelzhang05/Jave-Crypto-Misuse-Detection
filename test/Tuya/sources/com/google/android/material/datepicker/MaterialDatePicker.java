...
public final class MaterialDatePicker<S> extends DialogFragment {
    ...
    private void initHeaderToggle(Context context) {
        ...
        this.headerToggleButton.setOnClickListener(new View.OnClickListener() { // from class: com.google.android.material.datepicker.g
    ...
    public final View onCreateView(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle) {
        int i8;
        if (this.fullscreen) {
            i8 = com.google.android.material.R.layout.mtrl_picker_fullscreen;
        } else {
            i8 = com.google.android.material.R.layout.mtrl_picker_dialog;
        }
