...
public class FabTransformationScrimBehavior extends ExpandableTransformationBehavior {
    ...
    private void createScrimAnimation(@NonNull View view, boolean z8, boolean z9, @NonNull List<Animator> list, List<Animator.AnimatorListener> list2) {
    ...
    @NonNull
    protected AnimatorSet onCreateExpandedStateChangeAnimation(@NonNull View view, @NonNull final View view2, final boolean z8, boolean z9) {
