...
public abstract class BaseTransientBottomBar<B extends BaseTransientBottomBar<B>> {
    ...
    public void updateMargins() {
        ...
        if (getAnchorView() != null) {
            i8 = this.extraBottomMarginAnchorView;
        } else {
            i8 = this.extraBottomMarginWindowInset;
        }
        ViewGroup.MarginLayoutParams marginLayoutParams = (ViewGroup.MarginLayoutParams) layoutParams;
        int i9 = this.view.originalMargins.bottom + i8;
        ...
        if ((z8 || this.appliedBottomMarginGestureInset != this.extraBottomMarginGestureInset) && Build.VERSION.SDK_INT >= 29 && shouldUpdateGestureInset()) {
    ...
    */
    void onAttachedToWindow() {
        /*
            ...
            if (r0 == 0) goto L1b
            android.graphics.Insets r0 = androidx.core.view.v0.a(r0)
    ...
    @NonNull
    public B setGestureInsetBottomIgnored(boolean z8) {
    ...
    public BaseTransientBottomBar(@NonNull Context context, @NonNull ViewGroup viewGroup, @NonNull View view, @NonNull com.google.android.material.snackbar.ContentViewCallback contentViewCallback) {
        ...
        if (contentViewCallback != null) {
            ...
            this.animationFadeInDuration = MotionUtils.resolveThemeDuration(context, i8, 150);
