...
public class ExtendedFloatingActionButton extends MaterialButton implements CoordinatorLayout.AttachedBehavior {
    ...
    class ChangeSizeStrategy extends BaseMotionStrategy {
        ...
        public AnimatorSet createAnimator() {
            ...
            if (currentMotionSpec.hasPropertyValues("labelOpacity")) {
                ...
                propertyValues5[0].setFloatValues(f8, f9);
    ...
    protected static class ExtendedFloatingActionButtonBehavior<T extends ExtendedFloatingActionButton> extends CoordinatorLayout.Behavior<T> {
        ...
        protected void extendOrShow(@NonNull ExtendedFloatingActionButton extendedFloatingActionButton) {
            ...
            extendedFloatingActionButton.performMotion(i8, onChangedCallback);
        }
        ...
        final Size size2 = new Size() { // from class: com.google.android.material.floatingactionbutton.ExtendedFloatingActionButton.3
            ...
            public ViewGroup.LayoutParams getLayoutParams() {
                ...
                if (ExtendedFloatingActionButton.this.originalHeight != 0) {
                    i9 = ExtendedFloatingActionButton.this.originalHeight;
                } else {
                    i9 = -2;
                }
        ...
        Size size3 = new Size() { // from class: com.google.android.material.floatingactionbutton.ExtendedFloatingActionButton.4
            ...
            public ViewGroup.LayoutParams getLayoutParams() {
                ...
                if (ExtendedFloatingActionButton.this.originalWidth != 0) {
                    i9 = ExtendedFloatingActionButton.this.originalWidth;
                } else {
                    i9 = -2;
                }
                if (ExtendedFloatingActionButton.this.originalHeight != 0) {
                    i10 = ExtendedFloatingActionButton.this.originalHeight;
                }
