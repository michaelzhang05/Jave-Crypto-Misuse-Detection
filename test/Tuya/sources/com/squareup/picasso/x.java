...
public abstract class x {
    ...
    public static final class a {
        ...
        private final s.e f23414a;

        /* renamed from: b, reason: collision with root package name */
        private final Bitmap f23415b;

        /* renamed from: c, reason: collision with root package name */
        private final Z f23416c;
        ...
        public a(Bitmap bitmap, Z z8, s.e eVar, int i8) {
            if ((bitmap != null) != (z8 != null)) {
                this.f23415b = bitmap;
                this.f23416c = z8;
                this.f23414a = (s.e) C.e(eVar, "loadedFrom == null");
                this.f23417d = i8;
                return;
            }
    ...
    public static BitmapFactory.Options d(v vVar) {
        boolean z8;
        boolean c8 = vVar.c();
        if (vVar.f23382s != null) {
            z8 = true;
        } else {
            z8 = false;
        }
        if (!c8 && !z8 && !vVar.f23381r) {
            return null;
        }
        ...
        if (z8) {
            options.inPreferredConfig = vVar.f23382s;
        }
        return options;
    }
