...
public final class o extends p {
    ...
    public final String a() {
        if (this.f22632b == null) {
            ...
            try {
                ...
                arrayList.add(this.f22632b.getCampaign());
                String unitID = this.f22632b.getUnitID();
                ...
                ad.a("JSRewardVideoV1", "getEndScreenInfo success campaign = " + this.f22632b.getCampaign());
    ...
    public final void b(String str) {
        super.b(str);
        try {
            if (this.f22631a != null && !TextUtils.isEmpty(str)) {
                if (str.equals("landscape")) {
                    this.f22631a.setRequestedOrientation(0);
                } else if (str.equals("portrait")) {
                    this.f22631a.setRequestedOrientation(1);
                }
            }
        } catch (Throwable th) {
            th.printStackTrace();
    ...
    public final void c(String str) {
        ...
        super.c(str);
        try {
            if (this.f22631a != null && !TextUtils.isEmpty(str) && (mBridgeContainerView = this.f22632b) != null) {
    ...
    public final void notifyCloseBtn(int i8) {
        ...
        MBridgeContainerView mBridgeContainerView = this.f22632b;
    ...
    public final void a(String str) {
        ...
        super.a(str);
        try {
            if (this.f22631a == null || TextUtils.isEmpty(str) || !str.equals(CampaignEx.JSON_NATIVE_VIDEO_CLICK) || (mBridgeContainerView = this.f22632b) == null) {
                return;
            }
