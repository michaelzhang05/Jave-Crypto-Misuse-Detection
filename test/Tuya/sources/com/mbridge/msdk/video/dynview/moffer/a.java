...
public class a {
    ...
    private Map<String, SoftReference<MOfferModel>> f22191b = new ConcurrentHashMap();

    /* renamed from: c, reason: collision with root package name */
    private int f22192c = 500;
    ...
    public final void b() {
        ...
        try {
            Map<String, SoftReference<MOfferModel>> map = this.f22191b;
            if (map != null) {
    ...
    public final void a(final ViewGroup viewGroup, String str, com.mbridge.msdk.video.module.a.a aVar) {
        if (viewGroup == null || aVar == null || this.f22191b == null || TextUtils.isEmpty(str) || !this.f22191b.containsKey(str)) {
            return;
        }
        SoftReference<MOfferModel> softReference = this.f22191b.get(str);
    ...
    public final void a(CampaignEx campaignEx, int i8) {
        ...
        if (this.f22191b == null) {
            this.f22191b = new ConcurrentHashMap();
        }
        ...
        try {
            ...
            if (softReference.get() != null) {
                this.f22191b.put(str, softReference);
    ...
    public final boolean a(String str) {
        if (this.f22191b == null || TextUtils.isEmpty(str)) {
            return false;
        }
        return this.f22191b.containsKey(str);
    }
        ...
        if (mOfferModel.getECParentTemplateCode() == 1302) {
            try {
                ...
                if (viewGroup instanceof MBridgeNativeEndCardView) {
                    ...
                    new com.mbridge.msdk.video.dynview.h.b().a(arrayList, 0, ai.a(com.mbridge.msdk.foundation.controller.c.m().c(), 100.0f), aVar.f22192c);
                } else {
                    relativeLayout = null;
                }
            ...
            try {
                if (viewGroup instanceof MBridgeNativeEndCardView) {
                    ...
                    new com.mbridge.msdk.video.dynview.h.b().a(arrayList2, 0, ai.a(com.mbridge.msdk.foundation.controller.c.m().c(), 100.0f), aVar.f22192c);
                }
