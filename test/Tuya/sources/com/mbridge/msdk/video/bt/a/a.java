...
public class a {
    ...
    private static ConcurrentHashMap<String, LinkedHashMap<String, View>> f21740a = new ConcurrentHashMap<>();

    /* renamed from: b, reason: collision with root package name */
    private static LinkedHashMap<String, String> f21741b = new LinkedHashMap<>();

    /* renamed from: c, reason: collision with root package name */
    private static LinkedHashMap<String, CampaignEx> f21742c = new LinkedHashMap<>();

    /* renamed from: d, reason: collision with root package name */
    private static LinkedHashMap<String, com.mbridge.msdk.videocommon.d.c> f21743d = new LinkedHashMap<>();

    /* renamed from: e, reason: collision with root package name */
    private static LinkedHashMap<String, String> f21744e = new LinkedHashMap<>();

    /* renamed from: f, reason: collision with root package name */
    private static LinkedHashMap<String, Integer> f21745f = new LinkedHashMap<>();

    /* renamed from: g, reason: collision with root package name */
    private static LinkedHashMap<String, Activity> f21746g = new LinkedHashMap<>();

    /* renamed from: h, reason: collision with root package name */
    private static volatile int f21747h = 10000;

    /* renamed from: i, reason: collision with root package name */
    private static int f21748i = 0;

    /* renamed from: j, reason: collision with root package name */
    private static int f21749j = 1;

    /* renamed from: k, reason: collision with root package name */
    private static String f21750k = "";

    /* renamed from: l, reason: collision with root package name */
    private static int f21751l;

    /* renamed from: m, reason: collision with root package name */
    private static int f21752m;

    /* renamed from: n, reason: collision with root package name */
    private static int f21753n;

    /* renamed from: o, reason: collision with root package name */
    private static int f21754o;

    /* renamed from: p, reason: collision with root package name */
    private static int f21755p;

    private String h(String str) {
        if (f21741b.containsKey(str)) {
            return f21741b.get(str);
        }
        return "";
    }
    ...
    public final void A(Object obj, JSONObject jSONObject) {
        ...
        try {
            ...
            if (TextUtils.isEmpty(h8) && (windVaneWebView = ((com.mbridge.msdk.mbsignalcommon.windvane.a) obj).f20593b) != null) {
    ...
    public final void K(Object obj, JSONObject jSONObject) {
        ...
        try {
            ...
            LinkedHashMap<String, View> b8 = b(optString, str);
            if (b8.size() > 0 && f21744e.containsKey(optString2)) {
                View view = b8.get(optString2);
                if (view instanceof MBTempContainer) {
    ...
    public final String a() {
        f21747h++;
        return String.valueOf(f21747h);
    }

    public final String c(String str) {
        if (f21744e.containsKey(str)) {
            return f21744e.get(str);
        }
        return "";
    }
    ...
    public final int e(String str) {
        if (f21745f.containsKey(str)) {
            return f21745f.get(str).intValue();
        }
        return 2;
    }
    ...
    public final void f(String str) {
        ...
        if (f21743d.containsKey(str)) {
            f21743d.remove(str);
        }
        if (f21742c.containsKey(str)) {
            f21742c.remove(str);
        }
        if (f21741b.containsKey(str)) {
            f21741b.remove(str);
        ...
        try {
            ...
            if (b8.containsKey(optString3) && b8.containsKey(optString2)) {
                ...
                if (viewGroup != null && view != null) {
                    ...
                    if (view instanceof MBTempContainer) {
                        ad.b("OperateViews", "OperateViews setNotchString = " + String.format("%1$s-%2$s-%3$s-%4$s-%5$s", Integer.valueOf(f21751l), Integer.valueOf(f21752m), Integer.valueOf(f21753n), Integer.valueOf(f21754o), Integer.valueOf(f21755p)));
                        ((MBTempContainer) view).setNotchPadding(f21751l, f21752m, f21753n, f21754o, f21755p);
    ...
    public final void t(Object obj, JSONObject jSONObject) {
        ...
        try {
            ...
            String optString2 = jSONObject.optString("id");
            String h8 = h(optString2);
            if (TextUtils.isEmpty(h8) && (windVaneWebView = ((com.mbridge.msdk.mbsignalcommon.windvane.a) obj4).f20593b) != null) {
                h8 = windVaneWebView.getRid();
            }
            JSONObject optJSONObject = jSONObject.optJSONObject(DataSchemeDataSource.SCHEME_DATA);
            if (optJSONObject == null) {
    ...
    public final void d(Object obj, JSONObject jSONObject) {
        ...
        try {
            ...
            if (optJSONObject != null && !TextUtils.isEmpty(optString)) {
                ...
                if (TextUtils.isEmpty(str) && (windVaneWebView = ((com.mbridge.msdk.mbsignalcommon.windvane.a) obj).f20593b) != null) {
                    str = windVaneWebView.getRid();
                }
                LinkedHashMap<String, View> b8 = b(optString, str);
                String a9 = a();
                ...
                f21744e.put(a9, optString);
                f21742c.put(a9, parseCampaignWithBackData);
                f21743d.put(a9, a8);
                a(obj, a9);
    ...
    public final synchronized LinkedHashMap<String, View> b(String str, String str2) {
        if (f21740a.containsKey(str + "_" + str2)) {
            return f21740a.get(str + "_" + str2);
        }
        LinkedHashMap<String, View> linkedHashMap = new LinkedHashMap<>();
        f21740a.put(str + "_" + str2, linkedHashMap);
    ...
    public final void a(String str, String str2) {
        f21741b.put(str, str2);
    }

    public final void a(String str, Activity activity) {
        f21746g.put(str, activity);
    }

    public final void a(String str, int i8) {
        f21745f.put(str, Integer.valueOf(i8));
    }
    ...
    static /* synthetic */ void a(a aVar, String str, CampaignEx campaignEx) {
        if (com.mbridge.msdk.foundation.same.a.d.f19454j == null || TextUtils.isEmpty(campaignEx.getId())) {
            return;
        }
