...
public abstract class MBridgeH5EndCardViewDiff extends MBridgeBaseView implements i, b, h {
    ...
    public void open(String str) {
        try {
            String clickURL = this.f22255b.getClickURL();
            if (!TextUtils.isEmpty(str)) {
                this.f22255b.setClickURL(str);
                reportOpen(str);
            }
            a aVar = new a(getContext(), this.unitId);
            aVar.a(this);
            aVar.a(this.f22255b);
            this.f22255b.setClickURL(clickURL);
            this.f22258e.a(126, "");
        } catch (Exception e8) {
    ...
    public void reportOpen(String str) {
        ...
        if (mraidCampaign != null) {
            new com.mbridge.msdk.foundation.same.report.i(getContext()).a(mraidCampaign.getRequestId(), mraidCampaign.getRequestIdNotice(), mraidCampaign.getId(), this.unitId, str, this.f22255b.isBidCampaign());
        }
    }
