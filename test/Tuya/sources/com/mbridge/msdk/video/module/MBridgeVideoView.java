...
public class MBridgeVideoView extends MBridgeBaseView implements j {
    ...
    private static int f22442n = 0;

    /* renamed from: o, reason: collision with root package name */
    private static int f22443o = 0;

    /* renamed from: p, reason: collision with root package name */
    private static int f22444p = 0;

    /* renamed from: q, reason: collision with root package name */
    private static int f22445q = 0;

    /* renamed from: r, reason: collision with root package name */
    private static int f22446r = 0;

    /* renamed from: s, reason: collision with root package name */
    private static boolean f22447s = false;

    /* renamed from: A, reason: collision with root package name */
    private FeedBackButton f22448A;

    /* renamed from: B, reason: collision with root package name */
    private ImageView f22449B;

    /* renamed from: C, reason: collision with root package name */
    private MBridgeSegmentsProgressBar f22450C;

    /* renamed from: D, reason: collision with root package name */
    private com.mbridge.msdk.video.module.a.a f22451D;
    ...
    private com.mbridge.msdk.video.dynview.e.a f22454G;
    ...
    private FrameLayout f22457J;

    /* renamed from: K, reason: collision with root package name */
    private MBridgeClickCTAView f22458K;

    /* renamed from: L, reason: collision with root package name */
    private com.mbridge.msdk.video.signal.factory.b f22459L;
    ...
    /* renamed from: O, reason: collision with root package name */
    private RelativeLayout f22462O;
    ...
    /* renamed from: t, reason: collision with root package name */
    private PlayerView f22471t;

    /* renamed from: u, reason: collision with root package name */
    private SoundImageView f22472u;

    /* renamed from: v, reason: collision with root package name */
    private TextView f22473v;

    /* renamed from: w, reason: collision with root package name */
    private View f22474w;

    /* renamed from: x, reason: collision with root package name */
    private RelativeLayout f22475x;

    /* renamed from: y, reason: collision with root package name */
    private ImageView f22476y;

    /* renamed from: z, reason: collision with root package name */
    private ProgressBar f22477z;
    ...
    public final class AnonymousClass4 implements com.mbridge.msdk.foundation.same.c.c {
        ...
        public final void onSuccessLoad(final Bitmap bitmap, String str) {
            if (bitmap != null) {
                try {
                    if (!bitmap.isRecycled() && MBridgeVideoView.this.f22476y != null) {
                        com.mbridge.msdk.foundation.same.f.b.a().execute(new Runnable() { // from class: com.mbridge.msdk.video.module.MBridgeVideoView.4.1
                            ...
                            public final void run() {
                                try {
                                    ...
                                    MBridgeVideoView.this.f22476y.post(new Runnable() { // from class: com.mbridge.msdk.video.module.MBridgeVideoView.4.1.1
                                        @Override // java.lang.Runnable
                                        public final void run() {
                                            MBridgeVideoView.this.f22476y.setVisibility(0);
                                            MBridgeVideoView.this.f22476y.setImageBitmap(a8);
                                        }
                                    });
                                } catch (Exception e8) {
    ...
    public static class b {
        ...
        public final String toString() {
            return "ProgressData{curPlayPosition=" + this.f22509a + ", allDuration=" + this.f22510b + '}';
        }
    }
    ...
    public static final class c extends DefaultVideoPlayerStatusListener {
        ...
        /* renamed from: a, reason: collision with root package name */
        private MBridgeVideoView f22512a;
        ...
        /* renamed from: p, reason: collision with root package name */
        private boolean f22527p = false;

        public c(MBridgeVideoView mBridgeVideoView) {
            this.f22512a = mBridgeVideoView;
            if (mBridgeVideoView != null) {
                this.f22523l = mBridgeVideoView.getUnitId();
                this.f22524m = mBridgeVideoView.getCampaign();
            }
        }

        private void d() {
            MBridgeVideoView mBridgeVideoView = this.f22512a;
            if (mBridgeVideoView == null) {
                return;
            }
            RelativeLayout.LayoutParams layoutParams = (RelativeLayout.LayoutParams) mBridgeVideoView.f22473v.getLayoutParams();
            if (layoutParams != null) {
                layoutParams.width = -2;
                layoutParams.height = ai.a(com.mbridge.msdk.foundation.controller.c.m().c(), 25.0f);
                this.f22512a.f22473v.setLayoutParams(layoutParams);
            }
            int a8 = ai.a(com.mbridge.msdk.foundation.controller.c.m().c(), 5.0f);
            this.f22512a.f22473v.setPadding(a8, 0, a8, 0);
        }
        ...
        public final void c() {
            this.f22512a = null;
            boolean unused = MBridgeVideoView.f22447s = false;
        }
        ...
        public final void onBufferingEnd() {
            try {
                ...
                C4014b c4014b = this.f22517f;
                if (c4014b != null) {
                    c4014b.b();
                    ad.a("omsdk", "play:  videoEvents.bufferFinish()");
                }
                this.f22512a.f22258e.a(14, "");
            } catch (Exception e8) {
                e8.printStackTrace();
            }
        }
        ...
        public final void onPlayCompleted() {
            ...
            this.f22512a.aA = true;
            CampaignEx campaignEx = this.f22524m;
            if (campaignEx != null) {
                if (this.f22522k && campaignEx.getRewardTemplateMode() != null && this.f22524m.getRewardTemplateMode().f() == 5002010) {
                    this.f22512a.f22473v.setText(MBridgeConstans.ENDCARD_URL_TYPE_PL);
                } else {
                    this.f22512a.f22473v.setText(v.a(com.mbridge.msdk.foundation.controller.c.m().c(), "mbridge_reward_video_view_reward_time_complete", TypedValues.Custom.S_STRING));
                }
                this.f22524m.setVideoPlayProgress(100);
                if (this.f22524m.getAdSpaceT() == 2) {
                    this.f22512a.f22474w.setVisibility(4);
                    if (this.f22512a.f22448A != null) {
                        this.f22512a.f22448A.setClickable(false);
                    }
                    if (this.f22512a.f22472u != null) {
                        this.f22512a.f22472u.setClickable(false);
                    }
                }
            } else {
                this.f22512a.f22473v.setText(MBridgeConstans.ENDCARD_URL_TYPE_PL);
            ...
            this.f22512a.f22471t.setClickable(false);
            String b8 = this.f22512a.b(true);
            CampaignEx campaignEx2 = this.f22524m;
            if (campaignEx2 != null && campaignEx2.getRewardTemplateMode() != null && this.f22524m.getRewardTemplateMode().f() == 5002010) {
                this.f22512a.j();
            }
            CampaignEx campaignEx3 = this.f22524m;
            if (campaignEx3 != null && campaignEx3.getDynamicTempCode() == 5 && (mBridgeVideoView = this.f22512a) != null && mBridgeVideoView.f22454G != null) {
                MBridgeVideoView mBridgeVideoView2 = this.f22512a;
                if (mBridgeVideoView2.mCampaignSize > mBridgeVideoView2.mCurrPlayNum) {
                    HashMap hashMap = new HashMap();
                    hashMap.put("position", Integer.valueOf(this.f22512a.mCurrPlayNum));
                    int i8 = this.f22512a.mMuteSwitch;
                    if (i8 != 0) {
                        hashMap.put(CampaignEx.JSON_NATIVE_VIDEO_MUTE, Integer.valueOf(i8));
                    }
                    this.f22512a.f22454G.a(hashMap);
                    return;
                }
            }
            MBridgeVideoView mBridgeVideoView3 = this.f22512a;
            if (mBridgeVideoView3 != null) {
                mBridgeVideoView3.f22258e.a(121, "");
                this.f22512a.f22258e.a(11, b8);
            }
            int i9 = this.f22514c;
            this.f22513b = i9;
            this.f22512a.mCurrentPlayProgressTime = i9;
            boolean unused = MBridgeVideoView.f22447s = true;
        }
        ...
        public final void onPlayError(String str) {
            ...
            MBridgeVideoView mBridgeVideoView = this.f22512a;
            if (mBridgeVideoView != null) {
                mBridgeVideoView.f22258e.a(12, str);
            }
        }
        ...
        public final void onPlayProgress(int i8, int i9) {
            ...
            if (this.f22512a.f22259f) {
                ...
                if (campaignEx2 != null) {
                    ...
                    com.mbridge.msdk.foundation.d.b.a().b(this.f22524m.getCampaignUnitId() + "_1", i8);
                } else {
                    i11 = 0;
                }
                CampaignEx campaignEx3 = this.f22524m;
                String str3 = MBridgeConstans.ENDCARD_URL_TYPE_PL;
                if (campaignEx3 != null && campaignEx3.isDynamicView() && this.f22524m.getDynamicTempCode() == 5) {
                    try {
                        int i15 = this.f22512a.f22455H;
                        MBridgeVideoView mBridgeVideoView = this.f22512a;
                        if (mBridgeVideoView != null) {
                            ...
                            String str5 = (String) this.f22512a.getContext().getResources().getText(v.a(com.mbridge.msdk.foundation.controller.c.m().c(), "mbridge_reward_video_view_reward_time_left", TypedValues.Custom.S_STRING));
                            if (i11 >= 0) {
                                if (this.f22524m.getUseSkipTime() == 1) {
                                    int min = Math.min(this.f22512a.f22467T, i11);
                                    if (min < i11 && min > 0) {
                                        i13 = min - i8;
                                        if (i13 <= 0) {
                                            i13 = i11 - i8;
                                            if (this.f22522k) {
                                                this.f22512a.f22473v.setVisibility(4);
                                            }
                                        } else {
                                            str5 = (String) this.f22512a.getContext().getResources().getText(v.a(com.mbridge.msdk.foundation.controller.c.m().c(), "mbridge_reward_video_view_reward_time_left_skip_time", TypedValues.Custom.S_STRING));
                                        }
                                    } else {
                                        i13 = i11 - i8;
                                        if (this.f22522k) {
                                ...
                                if (i13 <= 0) {
                                    if (i11 <= 0) {
                                        this.f22518g.f22509a = i8;
                                        this.f22512a.f22473v.setText(str3);
                                        if (this.f22512a.f22477z != null && this.f22512a.f22477z.getVisibility() == 0) {
                                            this.f22512a.f22477z.setProgress(i8);
                                        }
                                        if (i13 < this.f22512a.aK && this.f22512a.aM != null && this.f22512a.f22465R) {
                                            this.f22512a.aM.onTimeLessThanReduce(i13);
                                        }
                                    }
                                } else {
                                    if (i11 <= 0) {
                            ...
                            this.f22518g.f22509a = i8;
                            this.f22512a.f22473v.setText(str3);
                            if (this.f22512a.f22477z != null) {
                                this.f22512a.f22477z.setProgress(i8);
                            }
                            if (i13 < this.f22512a.aK) {
                                this.f22512a.aM.onTimeLessThanReduce(i13);
                            }
                        }
                    } catch (Exception e8) {
                    ...
                    if (mBridgeVideoView2 != null) {
                        if (this.f22522k) {
                            ...
                            if (i12 <= 0) {
                                ...
                                if (i11 <= 0) {
                                    ...
                                    sb = new StringBuilder();
                                    sb.append(i12);
                                    sb.append((String) this.f22512a.getContext().getResources().getText(v.a(com.mbridge.msdk.foundation.controller.c.m().c(), "mbridge_reward_video_view_reward_time_left", TypedValues.Custom.S_STRING)));
                                }
                                str3 = sb.toString();
                                i14 = i12;
                            }
                            if (i14 < this.f22512a.aK && this.f22512a.aM != null && this.f22512a.f22465R) {
                                this.f22512a.aM.onTimeLessThanReduce(i14);
                            }
                            str2 = str3;
                        }
                        CampaignEx campaignEx4 = this.f22524m;
                        if (campaignEx4 != null && campaignEx4.getUseSkipTime() == 1) {
                            int min2 = Math.min(this.f22512a.f22467T, i9);
                            if (min2 < i11 && min2 >= 0) {
                                int i16 = min2 - i8;
                                if (i16 > 0) {
                                    str2 = i16 + ((String) this.f22512a.getContext().getResources().getText(v.a(com.mbridge.msdk.foundation.controller.c.m().c(), "mbridge_reward_video_view_reward_time_left_skip_time", TypedValues.Custom.S_STRING)));
                                } else if (this.f22522k && i16 == 0) {
                                    this.f22512a.f22473v.setVisibility(4);
                                }
                            } else {
                                int i17 = i11 - i8;
                                if (this.f22522k) {
                                    if (i17 > 0) {
                                        str2 = i17 + ((String) this.f22512a.getContext().getResources().getText(v.a(com.mbridge.msdk.foundation.controller.c.m().c(), "mbridge_reward_video_view_reward_time_left_skip_time", TypedValues.Custom.S_STRING)));
                                    } else if (i17 == 0) {
                                        this.f22512a.f22473v.setVisibility(4);
                                    }
                                }
                        ...
                        this.f22512a.f22473v.setText(str2);
                        if (this.f22512a.f22477z != null && this.f22512a.f22477z.getVisibility() == 0) {
                            this.f22512a.f22477z.setProgress(i8);
                        }
                    }
            ...
            b bVar = this.f22518g;
            bVar.f22510b = i9;
            bVar.f22511c = this.f22512a.aC;
            this.f22513b = i8;
            if (this.f22512a.f22449B != null) {
                this.f22512a.f22449B.setTag("" + this.f22513b);
            }
            MBridgeVideoView mBridgeVideoView3 = this.f22512a;
            mBridgeVideoView3.mCurrentPlayProgressTime = i8;
            mBridgeVideoView3.f22258e.a(15, this.f22518g);
            C4014b c4014b = this.f22517f;
            if (c4014b != null) {
                int i18 = (i8 * 100) / i9;
                int i19 = ((i8 + 1) * 100) / i9;
                if (i18 <= 25 && 25 < i19 && !this.f22519h) {
                    this.f22519h = true;
                    c4014b.h();
                    ad.a("omsdk", "play:  videoEvents.firstQuartile()");
                } else if (i18 <= 50 && 50 < i19 && !this.f22520i) {
                    this.f22520i = true;
                    c4014b.i();
                    ad.a("omsdk", "play:  videoEvents.midpoint()");
                } else if (i18 <= 75 && 75 < i19 && !this.f22521j) {
                    this.f22521j = true;
                    c4014b.n();
                    ad.a("omsdk", "play:  videoEvents.thirdQuartile()");
                }
            }
            if (this.f22512a.ao && !this.f22512a.aw && this.f22512a.at == com.mbridge.msdk.foundation.same.a.f19397H) {
                this.f22512a.e();
            }
            try {
                MBridgeVideoView mBridgeVideoView4 = this.f22512a;
                if (mBridgeVideoView4 != null && mBridgeVideoView4.f22450C != null) {
                    int i20 = (i8 * 100) / i9;
                    this.f22512a.f22450C.setProgress(i20, this.f22512a.mCurrPlayNum - 1);
                    this.f22524m.setVideoPlayProgress(i20);
                }
                MBridgeVideoView mBridgeVideoView5 = this.f22512a;
                if (mBridgeVideoView5 != null) {
                    int i21 = mBridgeVideoView5.f22461N != -5 ? this.f22512a.f22461N : this.f22512a.f22460M;
                    if (i21 != -1 && i8 == i21 && (campaignEx = this.f22512a.f22255b) != null && campaignEx.isDynamicView()) {
                        this.f22512a.setCTALayoutVisibleOrGone();
                    }
                }
            } catch (Throwable th) {
                ad.b("DefaultVideoPlayerStatusListener", th.getMessage());
            }
            int i22 = this.f22525n;
            if (i22 != 100 && !this.f22527p && i22 != 0) {
                if (this.f22526o > i22) {
                    this.f22526o = i22 / 2;
                }
                int i23 = this.f22526o;
                if (i23 >= 0 && i8 >= (i10 = (i23 * i9) / 100)) {
                    if (this.f22524m.getAdType() != 94 && this.f22524m.getAdType() != 287) {
                        str = this.f22524m.getId() + this.f22524m.getVideoUrlEncode() + this.f22524m.getBidToken();
                    } else {
                        str = this.f22524m.getRequestId() + this.f22524m.getId() + this.f22524m.getVideoUrlEncode();
                    }
                    com.mbridge.msdk.videocommon.download.a a8 = com.mbridge.msdk.videocommon.download.b.getInstance().a(this.f22523l, str);
                    if (a8 != null) {
                        a8.p();
                        this.f22527p = true;
        ...
        public final void onPlayStarted(int i8) {
            ...
            if (!this.f22516e) {
                MBridgeVideoView mBridgeVideoView2 = this.f22512a;
                if (mBridgeVideoView2 != null) {
                    mBridgeVideoView2.f22456I = true;
                    this.f22512a.f22258e.a(10, this.f22518g);
                }
                this.f22516e = true;
            }
            this.f22515d = i8;
            ...
            if (campaignEx2 != null) {
                ...
                if (this.f22524m.isDynamicView()) {
                    MBridgeVideoView mBridgeVideoView3 = this.f22512a;
                    if (mBridgeVideoView3 != null && mBridgeVideoView3.f22473v != null) {
                        if (this.f22524m.getDynamicTempCode() == 5) {
                            MBridgeVideoView mBridgeVideoView4 = this.f22512a;
                            if (mBridgeVideoView4.mCurrPlayNum > 1 && videoCompleteTime <= 0) {
                                mBridgeVideoView4.f22473v.setBackgroundResource(v.a(com.mbridge.msdk.foundation.controller.c.m().c(), "mbridge_reward_video_time_count_num_bg", "drawable"));
                                d();
                            }
                        }
                        if (videoCompleteTime > 0) {
                            if (!this.f22522k || this.f22524m.getDynamicTempCode() == 5) {
                                d();
                            }
                            str = "mbridge_reward_video_time_count_num_bg";
                        }
                        CampaignEx campaignEx3 = this.f22524m;
                        if (campaignEx3 != null && campaignEx3.getUseSkipTime() == 1 && this.f22522k) {
                            d();
                        }
                        this.f22512a.f22473v.setBackgroundResource(v.a(com.mbridge.msdk.foundation.controller.c.m().c(), str, "drawable"));
                    }
                } else if (videoCompleteTime > 0) {
                    this.f22512a.f22473v.setBackgroundResource(v.a(com.mbridge.msdk.foundation.controller.c.m().c(), "mbridge_reward_video_time_count_num_bg", "drawable"));
                    ...
                    this.f22512a.f22473v.setBackgroundResource(v.a(com.mbridge.msdk.foundation.controller.c.m().c(), "mbridge_reward_shape_progress", "drawable"));
                }
            }
            MBridgeVideoView mBridgeVideoView5 = this.f22512a;
            if (mBridgeVideoView5 != null && mBridgeVideoView5.f22477z != null) {
                this.f22512a.f22477z.setMax(i8);
            }
            MBridgeVideoView mBridgeVideoView6 = this.f22512a;
            if (mBridgeVideoView6 != null && mBridgeVideoView6.f22475x != null && (campaignEx = this.f22524m) != null && campaignEx.getAdSpaceT() == 2) {
                this.f22512a.f22475x.setVisibility(0);
            }
            MBridgeVideoView mBridgeVideoView7 = this.f22512a;
            if (mBridgeVideoView7 != null && mBridgeVideoView7.f22473v != null && this.f22512a.f22473v.getVisibility() == 0) {
                this.f22512a.m();
            }
            boolean unused = MBridgeVideoView.f22447s = false;
            MBridgeVideoView mBridgeVideoView8 = this.f22512a;
            if (mBridgeVideoView8 != null) {
                if (mBridgeVideoView8.f22461N != -5) {
                    if (this.f22512a.f22461N == 0) {
                        this.f22512a.setCTALayoutVisibleOrGone();
                    }
                } else if (this.f22512a.f22460M == 0) {
                    this.f22512a.setCTALayoutVisibleOrGone();
                }
            }
            MBridgeVideoView mBridgeVideoView9 = this.f22512a;
            if (mBridgeVideoView9 != null) {
                mBridgeVideoView9.showMoreOfferInPlayTemplate();
                this.f22512a.showBaitClickView();
                MBridgeVideoView.J(this.f22512a);
            }
        }

        public final void a(CampaignEx campaignEx) {
            this.f22524m = campaignEx;
        }
        ...
        */
        public final void a(int r3, int r4) {
            ...
            L15:
                ...
                int r4 = r2.f22526o
                if (r4 != 0) goto Lb0
                boolean r4 = r2.f22527p
                if (r4 != 0) goto Lb0
                if (r3 == 0) goto Lb0
                com.mbridge.msdk.foundation.entity.CampaignEx r3 = r2.f22524m
                if (r3 != 0) goto L2b
                goto Lb0
            L2b:
                ...
                r4 = 94
                if (r3 == r4) goto L65
                com.mbridge.msdk.foundation.entity.CampaignEx r3 = r2.f22524m     // Catch: java.lang.Exception -> L63
                int r3 = r3.getAdType()     // Catch: java.lang.Exception -> L63
            ...
            L3e:
                ...
                com.mbridge.msdk.foundation.entity.CampaignEx r4 = r2.f22524m     // Catch: java.lang.Exception -> L63
    ...
    public MBridgeVideoView(Context context) {
        ...
        this.aX = new Runnable() { // from class: com.mbridge.msdk.video.module.MBridgeVideoView.1
            @Override // java.lang.Runnable
            public final void run() {
                if (MBridgeVideoView.this.f22457J != null) {
                    MBridgeVideoView.this.f22457J.setVisibility(8);
                }
            }
        };
    ...
    static /* synthetic */ void D(MBridgeVideoView mBridgeVideoView) {
        ...
        if (collapsibleWebView != null && mBridgeVideoView.f22255b != null && TextUtils.isEmpty(collapsibleWebView.getUrl())) {
            mBridgeVideoView.aP.loadUrl(mBridgeVideoView.f22255b.getClickURL());
            mBridgeVideoView.aP.setToolBarTitle(mBridgeVideoView.f22255b.getAppName());
            ...
            mBridgeVideoView.aP.setPageLoadListener(new CollapsibleWebView.a() { // from class: com.mbridge.msdk.video.module.MBridgeVideoView.5
                ...
                public final void a(View view, String str) {
                    ...
                    MBridgeVideoView mBridgeVideoView2 = MBridgeVideoView.this;
                    com.mbridge.msdk.click.a.a(context, mBridgeVideoView2.f22255b, mBridgeVideoView2.getUnitId(), MBridgeVideoView.this.f22255b.getNoticeUrl(), true, false, com.mbridge.msdk.click.a.a.f18074i);
                    com.mbridge.msdk.video.module.b.b.d(com.mbridge.msdk.foundation.controller.c.m().c().getApplicationContext(), MBridgeVideoView.this.f22255b);
                    d dVar = new d();
                    dVar.a("result", 1);
                    if (MBridgeVideoView.this.f22451D != null) {
                        JSONObject jSONObject2 = null;
                        try {
                            jSONObject = new JSONObject();
                            try {
                                jSONObject.put(com.mbridge.msdk.foundation.same.a.f19422j, MBridgeVideoView.this.a(0));
                            } catch (JSONException e8) {
                                e = e8;
                                jSONObject2 = jSONObject;
                                e.printStackTrace();
                                jSONObject = jSONObject2;
                                MBridgeVideoView.this.f22451D.a(131, jSONObject);
                                MBridgeVideoView.this.f22255b.setClickType(1);
                                MBridgeVideoView.this.f22255b.setClickTempSource(1);
                                MBridgeVideoView.this.f22255b.setTriggerClickSource(2);
                                com.mbridge.msdk.foundation.same.report.d.c.a().a("2000149", MBridgeVideoView.this.f22255b);
                                dVar.a("type", 9);
                                ArrayList arrayList = new ArrayList();
                                arrayList.add("web_view");
                                dVar.a("click_path", arrayList.toString());
                                com.mbridge.msdk.foundation.same.report.d.c.a().a("2000150", MBridgeVideoView.this.f22255b, dVar);
                                dVar.a("url", str);
                                com.mbridge.msdk.foundation.same.report.d.c.a().a("m_webview_render", MBridgeVideoView.this.f22255b, dVar);
                            }
            ...
            mBridgeVideoView.aP.setCollapseListener(new CommonWebView.a() { // from class: com.mbridge.msdk.video.module.MBridgeVideoView.7
                ...
                public final void a() {
                    if (MBridgeVideoView.this.aQ != null) {
                        ...
                        com.mbridge.msdk.foundation.same.report.d.c.a().a("m_webview_zoom", MBridgeVideoView.this.f22255b, dVar);
                    }
    ...
    static /* synthetic */ void J(MBridgeVideoView mBridgeVideoView) {
        String e8;
        CampaignEx campaignEx = mBridgeVideoView.f22255b;
        if (campaignEx != null && campaignEx.isDynamicView() && !mBridgeVideoView.f22463P) {
            if (!TextUtils.isEmpty(mBridgeVideoView.f22255b.getMof_template_url())) {
                e8 = mBridgeVideoView.f22255b.getMof_template_url();
            } else if (mBridgeVideoView.f22255b.getRewardTemplateMode() != null) {
                e8 = mBridgeVideoView.f22255b.getRewardTemplateMode().e();
            } else {
                return;
            }
                    ...
                    if (i8 > 0 && i8 <= 2) {
                        ...
                        if (o8 == 0 || o8 > mBridgeVideoView.aI) {
                            ...
                            if (mBridgeVideoView.aI < p8) {
                                ...
                                arrayList.add(mBridgeVideoView.f22255b.getAppName());
                                String str = "US";
                                ...
                                mBridgeVideoView.aL = new AcquireRewardPopViewParameters.Builder("", mBridgeVideoView.ab, mBridgeVideoView.aH, str).setAutoDismissTime(mBridgeVideoView.aJ).setReduceTime(mBridgeVideoView.aK).setBehaviourListener(new AcquireRewardPopViewBehaviourListener() { // from class: com.mbridge.msdk.video.module.MBridgeVideoView.11
                                    ...
                                    public final void onOutOfContentClicked(float f8, float f9) {
                                        if (MBridgeVideoView.this.f22451D != null) {
                                            MBridgeVideoView.this.f22451D.a(105, "");
                                        }
                                    }

                                    @Override // com.mbridge.msdk.dycreator.baseview.rewardpopview.AcquireRewardPopViewBehaviourListener
                                    public final void onReceivedFail(String str2) {
                                        MBridgeVideoView.this.f22465R = false;
                                        if (com.mbridge.msdk.f.b.b()) {
                                            MBridgeVideoView.this.setCover(false);
                                        }
                                        MBridgeVideoView.this.h();
                                        MBridgeVideoView mBridgeVideoView2 = MBridgeVideoView.this;
                                        k.a(mBridgeVideoView2.f22255b, mBridgeVideoView2.ab, MBridgeVideoView.this.aH, 2, str2);
                                    }
                                    ...
                                    public final void onReceivedSuccess(int i10) {
                                        ...
                                        MBridgeVideoView.this.f22255b.setVideoCompleteTime(o9);
                                        MBridgeVideoView.this.h();
                                        com.mbridge.msdk.video.module.a.a aVar = MBridgeVideoView.this.f22258e;
                                        if (aVar != null) {
                                            aVar.a(TsExtractor.TS_STREAM_TYPE_HDMV_DTS, Integer.valueOf(o9));
                                        }
                                        MBridgeVideoView mBridgeVideoView2 = MBridgeVideoView.this;
                                        k.a(mBridgeVideoView2.f22255b, mBridgeVideoView2.ab, MBridgeVideoView.this.aH, 1, "");
                                    }
    ...
    public void closeVideoOperate(int i8, int i9) {
        if (i8 == 1) {
            ...
            try {
                ...
                com.mbridge.msdk.foundation.same.report.d.c.a().a("2000148", this.f22255b, dVar);
            } catch (Throwable th) {
    ...
    public void defaultShow() {
        super.defaultShow();
        this.ae = true;
        showVideoLocation(0, 0, ai.f(this.f22254a), ai.e(this.f22254a), 0, 0, 0, 0, 0);
        videoOperate(1);
        if (this.f22467T == 0) {
    ...
    public void dismissAllAlert() {
        MBAlertDialog mBAlertDialog = this.f22470W;
    ...
    public void gonePlayingCloseView() {
        if (this.f22259f && this.f22474w.getVisibility() != 8) {
            this.f22474w.setVisibility(8);
            this.ai = false;
        }
    ...
    public void hideAlertView(int i8) {
        if (this.f22464Q) {
            ...
            k.a(this.f22254a, this.f22255b, com.mbridge.msdk.videocommon.d.c.f22999a, this.ab, 1, i8, 1);
            if (i8 == 0) {
                h();
                if (this.ao) {
                    int i9 = this.at;
                    if (i9 == com.mbridge.msdk.foundation.same.a.f19397H || i9 == com.mbridge.msdk.foundation.same.a.f19396G) {
                        this.ax = true;
                        com.mbridge.msdk.video.module.a.a aVar = this.f22258e;
                        if (aVar != null) {
                            aVar.a(124, "");
                        ...
                        CampaignEx campaignEx = this.f22255b;
                        if (campaignEx != null && campaignEx.getRewardTemplateMode() != null && this.f22255b.getRewardTemplateMode().f() == 5002010) {
                            j();
                            return;
                        } else {
                            this.aC = true;
            ...
            this.ay = true;
            boolean z8 = this.ao;
            if (z8 && this.at == com.mbridge.msdk.foundation.same.a.f19397H) {
                h();
                return;
            }
            if (z8 && this.at == com.mbridge.msdk.foundation.same.a.f19396G) {
                com.mbridge.msdk.video.module.a.a aVar2 = this.f22258e;
                if (aVar2 != null) {
                    this.aU = true;
                    aVar2.a(2, b(this.aA));
                    return;
            ...
            com.mbridge.msdk.video.module.a.a aVar3 = this.f22258e;
            if (aVar3 != null) {
                this.aU = true;
                aVar3.a(2, "");
            }
    ...
    public boolean isH5Canvas() {
        if (getLayoutParams().height >= ai.e(this.f22254a.getApplicationContext())) {
            return false;
        }
        return true;
    }
    ...
    public void onBackPress() {
        boolean z8;
        if (this.ah || this.f22464Q || this.ax) {
            return;
        }
        CampaignEx campaignEx = this.f22255b;
        if (campaignEx != null && campaignEx.getRewardTemplateMode() != null && this.f22255b.getRewardTemplateMode().f() == 5002010 && (z8 = this.aA)) {
            com.mbridge.msdk.video.module.a.a aVar = this.f22258e;
            if (aVar != null) {
                this.aU = true;
                aVar.a(2, b(z8));
    ...
    public void onConfigurationChanged(Configuration configuration) {
        ...
        CampaignEx campaignEx = this.f22255b;
        if ((campaignEx == null || !campaignEx.isDynamicView()) && this.f22259f && this.ae) {
            k();
        }
    }
    ...
    public void preLoadData(com.mbridge.msdk.video.signal.factory.b bVar) {
        this.f22459L = bVar;
        if (this.f22259f) {
            if (!TextUtils.isEmpty(this.f22466S) && this.f22255b != null) {
                AbstractC3969b abstractC3969b = this.aq;
                if (abstractC3969b != null) {
                    abstractC3969b.d(this.f22471t);
                    SoundImageView soundImageView = this.f22472u;
                    if (soundImageView != null) {
                        this.aq.a(soundImageView, EnumC3975h.OTHER, null);
                    }
                    this.aq.a(this.f22473v, EnumC3975h.OTHER, null);
                    this.aq.a(this.f22474w, EnumC3975h.VIDEO_CONTROLS, null);
                }
                CampaignEx campaignEx = this.f22255b;
                if (campaignEx != null && an.b(campaignEx.getVideoResolution())) {
                    String videoResolution = this.f22255b.getVideoResolution();
                ...
                this.f22471t.initBufferIngParam(this.f22468U);
                this.f22471t.initVFPData(this.f22466S, this.f22255b.getVideoUrlEncode(), this.aV);
    ...
    public void progressBarOperate(int i8) {
        ...
        if (this.f22259f) {
            if (i8 == 1) {
                ProgressBar progressBar2 = this.f22477z;
            ...
            if (i8 == 2 && (progressBar = this.f22477z) != null) {
    ...
    public void progressOperate(int i8, int i9) {
        ...
        if (this.f22259f) {
            ...
            if (i8 > 0 && i8 <= i10 && this.f22471t != null) {
                ad.c(MBridgeBaseView.TAG, "progressOperate progress:" + i8);
                this.f22471t.seekTo(i8 * 1000);
            }
            if (i9 == 1) {
                this.f22473v.setVisibility(8);
            } else if (i9 == 2) {
                this.f22473v.setVisibility(0);
            }
            if (this.f22473v.getVisibility() == 0) {
                m();
            }
        }
    }
    ...
    public void setCTALayoutVisibleOrGone() {
        CampaignEx campaignEx = this.f22255b;
        if (campaignEx == null || !campaignEx.isDynamicView() || this.f22457J == null) {
            return;
        }
        if (this.f22255b.getRewardTemplateMode() != null && this.f22255b.getRewardTemplateMode().f() == 902) {
            return;
        }
        int i8 = this.f22461N;
        if (i8 != -5) {
            ...
            if (this.f22461N == -1) {
                if (this.f22457J.getVisibility() != 0) {
                    this.f22457J.setVisibility(0);
                    postDelayed(this.aX, 3000L);
                } else {
                    this.f22457J.setVisibility(8);
                    getHandler().removeCallbacks(this.aX);
                }
            }
            if (this.f22461N >= 0) {
    ...
    public void setCamPlayOrderCallback(com.mbridge.msdk.video.dynview.e.a aVar, List<CampaignEx> list, int i8, int i9) {
        ...
        if (campaignEx != null && campaignEx.getDynamicTempCode() == 5) {
            ...
            if (mBridgeSegmentsProgressBar2 != null && this.mCampOrderViewData != null) {
                if (this.mCampaignSize > 1) {
                    ...
                    for (int i10 = 0; i10 < this.mCampOrderViewData.size(); i10++) {
                        ...
                        if (videoPlayProgress > 0) {
                            this.f22450C.setProgress(videoPlayProgress, i10);
                        }
                ...
                if (campaignEx2 != null && campaignEx2.getProgressBarShow() == 1) {
                    MBridgeSegmentsProgressBar mBridgeSegmentsProgressBar3 = this.f22450C;
                    if (mBridgeSegmentsProgressBar3 != null) {
                        mBridgeSegmentsProgressBar3.init(1, 3);
                        this.f22450C.setVisibility(0);
                        return;
                    }
                    return;
                }
        ...
        if (campaignEx3 != null && campaignEx3.getProgressBarShow() == 1 && (mBridgeSegmentsProgressBar = this.f22450C) != null) {
    ...
    public void setInstDialogState(boolean z8) {
        ...
        this.aN = z8;
        if (com.mbridge.msdk.f.b.a() && (playerView = this.f22471t) != null) {
    ...
    public void setNotchPadding(final int i8, final int i9, final int i10, final int i11) {
        ...
        try {
            ...
            this.aT = i10;
            if (Math.max(Math.max(i12, i13), Math.max(i14, i15)) <= Math.max(Math.max(i8, i9), Math.max(i10, i11)) && (relativeLayout = this.f22475x) != null) {
                relativeLayout.postDelayed(new Runnable() { // from class: com.mbridge.msdk.video.module.MBridgeVideoView.3
                    @Override // java.lang.Runnable
                    public final void run() {
                        if (MBridgeVideoView.this.f22475x == null) {
                            return;
                        }
                        MBridgeVideoView.this.f22475x.setVisibility(0);
                        CampaignEx campaignEx = MBridgeVideoView.this.f22255b;
                        if (campaignEx != null && campaignEx.getAdSpaceT() != 2) {
                            MBridgeVideoView.this.f22475x.setPadding(i8, i10, i9, i11);
                            MBridgeVideoView.this.f22475x.startAnimation(MBridgeVideoView.this.aF);
                        }
                    }
                }, 200L);
            }
    ...
    public void setShowingAlertViewCover(boolean z8) {
        ...
        if (z8 && (mBAcquireRewardPopView = this.aM) != null && this.f22465R && this.f22464Q) {
            mBAcquireRewardPopView.onPause();
        }
        this.f22471t.setIsCovered(z8);
    }
    ...
    public void setVideoLayout(CampaignEx campaignEx) {
        if (campaignEx != null) {
            ...
            this.f22262i = campaignEx.isDynamicView();
        }
        if (this.f22262i) {
            ...
            com.mbridge.msdk.video.dynview.b.a().a(a8, new com.mbridge.msdk.video.dynview.e.g() { // from class: com.mbridge.msdk.video.module.MBridgeVideoView.12
                ...
                public final void a(com.mbridge.msdk.video.dynview.a aVar) {
                    if (aVar != null) {
                                ...
                                it.next().setOnClickListener(new com.mbridge.msdk.widget.a() { // from class: com.mbridge.msdk.video.module.MBridgeVideoView.12.1
                                    ...
                                    protected final void a(View view) {
                                        if (view instanceof TextView) {
                                            MBridgeVideoView.this.f22255b.setTriggerClickSource(1);
                                        } else {
                                            MBridgeVideoView.this.f22255b.setTriggerClickSource(2);
                                        }
                                        if (MBridgeVideoView.this.f22255b.getRewardTemplateMode() != null && MBridgeVideoView.this.f22255b.getRewardTemplateMode().f() == 902) {
                        ...
                        boolean unused = MBridgeVideoView.f22447s = false;
                        MBridgeVideoView mBridgeVideoView = MBridgeVideoView.this;
                        CampaignEx campaignEx2 = mBridgeVideoView.f22255b;
                        if (campaignEx2 != null) {
                            campaignEx2.setTemplateRenderSucc(mBridgeVideoView.aE);
                        }
                        MBridgeVideoView.this.f22460M = a8.j();
                        MBridgeVideoView.this.f22461N = a8.m();
                    }
                }
    ...
    public void showAlertView() {
        ...
        if (this.aa == null) {
            this.aa = new com.mbridge.msdk.widget.dialog.a() { // from class: com.mbridge.msdk.video.module.MBridgeVideoView.19
                ...
                public final void a() {
                    MBridgeVideoView.this.f22464Q = false;
                    MBridgeVideoView mBridgeVideoView = MBridgeVideoView.this;
                    mBridgeVideoView.setShowingAlertViewCover(mBridgeVideoView.f22464Q);
                    if (MBridgeVideoView.this.ao && (MBridgeVideoView.this.at == com.mbridge.msdk.foundation.same.a.f19397H || MBridgeVideoView.this.at == com.mbridge.msdk.foundation.same.a.f19396G)) {
                    ...
                    MBridgeVideoView.this.h();
                    MBridgeVideoView mBridgeVideoView2 = MBridgeVideoView.this;
                    k.a(mBridgeVideoView2.f22254a, mBridgeVideoView2.f22255b, mBridgeVideoView2.as, MBridgeVideoView.this.ab, 1, 0, 1);
                }
                ...
                public final void b() {
                    ...
                    mBridgeVideoView.setShowingAlertViewCover(mBridgeVideoView.f22464Q);
                    MBridgeVideoView mBridgeVideoView2 = MBridgeVideoView.this;
                    k.a(mBridgeVideoView2.f22254a, mBridgeVideoView2.f22255b, mBridgeVideoView2.as, MBridgeVideoView.this.ab, 1, 1, 1);
                    if (MBridgeVideoView.this.ao && MBridgeVideoView.this.at == com.mbridge.msdk.foundation.same.a.f19396G) {
                        MBridgeVideoView mBridgeVideoView3 = MBridgeVideoView.this;
                        if (mBridgeVideoView3.f22258e != null) {
                            mBridgeVideoView3.aU = true;
                            MBridgeVideoView mBridgeVideoView4 = MBridgeVideoView.this;
                            mBridgeVideoView4.f22258e.a(2, mBridgeVideoView4.b(mBridgeVideoView4.aA));
                            return;
                        }
                        return;
                    }
                    if (MBridgeVideoView.this.ao && MBridgeVideoView.this.at == com.mbridge.msdk.foundation.same.a.f19397H) {
                        MBridgeVideoView.this.h();
                        return;
                    }
                    MBridgeVideoView mBridgeVideoView5 = MBridgeVideoView.this;
                    if (mBridgeVideoView5.f22258e != null) {
                        mBridgeVideoView5.aU = true;
                        MBridgeVideoView.this.f22258e.a(2, "");
                    }
                }
        ...
        if (this.ao) {
            this.f22470W.makeIVAlertView(this.at, this.ab);
        } else {
            this.f22470W.makeRVAlertView(this.ab);
        }
        PlayerView playerView = this.f22471t;
        if (playerView != null) {
            if (!playerView.isComplete() || ((campaignEx = this.f22255b) != null && campaignEx.getRewardTemplateMode() != null && this.f22255b.getRewardTemplateMode().f() == 5002010)) {
                this.f22470W.show();
                this.aw = true;
                this.f22464Q = true;
                setShowingAlertViewCover(true);
                ...
                this.as = str;
                k.a(this.f22254a, this.f22255b, str, this.ab, 1, 1);
            }
        }
    }
    ...
    public void showBaitClickView() {
        ...
        CampaignEx campaignEx = this.f22255b;
        if (campaignEx == null || !campaignEx.isDynamicView() || this.f22255b.getRewardTemplateMode() == null) {
            return;
        }
        String e8 = this.f22255b.getRewardTemplateMode().e();
        if (TextUtils.isEmpty(e8)) {
            return;
        }
        try {
            ...
            if (!TextUtils.isEmpty(a8) && (parseInt = Integer.parseInt(a8)) != 0 && (mBridgeBaitClickView = this.aG) != null) {
                ...
                this.aG.setOnClickListener(new View.OnClickListener() { // from class: com.mbridge.msdk.video.module.MBridgeVideoView.10
                    ...
                    public final void onClick(View view) {
                        MBridgeVideoView mBridgeVideoView = MBridgeVideoView.this;
                        if (mBridgeVideoView.f22258e != null) {
                            mBridgeVideoView.f22255b.setTriggerClickSource(2);
    ...
    public void showMoreOfferInPlayTemplate() {
        CampaignEx campaignEx = this.f22255b;
        if (campaignEx == null || this.f22462O == null || !campaignEx.isDynamicView() || this.f22255b.getRewardTemplateMode() == null) {
            return;
        }
        String e8 = this.f22255b.getRewardTemplateMode().e();
        if (TextUtils.isEmpty(e8)) {
        ...
        try {
            ...
            if (!TextUtils.isEmpty(a8) && Integer.parseInt(a8) == 1) {
                com.mbridge.msdk.video.dynview.moffer.a.a().a(this.f22255b, this, new com.mbridge.msdk.video.module.a.a.i(this.f22451D), 1);
            }
        } catch (Exception e9) {
            ad.b(MBridgeBaseView.TAG, e9.getMessage());
        }
    ...
    public void showVideoLocation(int i8, int i9, int i10, int i11, int i12, int i13, int i14, int i15, int i16) {
        ...
        if (this.f22259f) {
            this.f22475x.setPadding(0, 0, 0, 0);
            setVisibility(0);
            if (this.f22475x.getVisibility() != 0) {
                this.f22475x.setVisibility(0);
            }
            if (this.f22473v.getVisibility() == 0) {
                m();
            }
            int f9 = ai.f(this.f22254a);
            int e8 = ai.e(this.f22254a);
            if (i10 > 0 && i11 > 0 && f9 >= i10 && e8 >= i11 && !this.ae) {
                ...
                if (i12 > 0) {
                    ...
                    if (i12 > 0) {
                        ...
                        this.f22471t.setBackground(gradientDrawable);
                        setClipToOutline(true);
                        this.f22471t.setClipToOutline(true);
                    }
                }
        ...
        if (this.f22259f) {
            if (i8 == 1) {
                if (getVisibility() == 0 && isfront()) {
                    ...
                    if ((relativeLayout == null || relativeLayout.getVisibility() == 0) && !this.f22464Q && !com.mbridge.msdk.foundation.d.b.f19164c) {
            ...
            if (i8 == 6 && !this.ag) {
                ...
                com.mbridge.msdk.foundation.same.report.d.c.a().a("2000146", this.f22255b, dVar2);
            }
        }
    }
    ...
    public int o() {
        ...
        if (this.f22255b.getDynamicTempCode() != 5 && i8 > p8) {
            i8 = p8;
        }
        if (i8 <= 0) {
            return p8;
    ...
    private int p() {
        try {
            ...
            return b8 == 0 ? this.f22255b.getVideoLength() : b8;
        } catch (Throwable th) {
            ad.b(MBridgeBaseView.TAG, th.getMessage());
            return 0;
        }
    ...
    public void soundOperate(int i8, int i9, String str) {
        ...
        if (this.f22259f) {
            this.ap = i8;
            if (i8 == 1) {
                SoundImageView soundImageView2 = this.f22472u;
                if (soundImageView2 != null) {
                    soundImageView2.setSoundStatus(false);
                }
                this.f22471t.closeSound();
                try {
                ...
                SoundImageView soundImageView3 = this.f22472u;
                if (soundImageView3 != null) {
                    soundImageView3.setSoundStatus(true);
                }
                this.f22471t.openSound();
                try {
            ...
            if (campaignEx != null && campaignEx.isDynamicView()) {
                SoundImageView soundImageView4 = this.f22472u;
                if (soundImageView4 != null) {
                    soundImageView4.setVisibility(0);
                }
            } else if (i9 == 1) {
                SoundImageView soundImageView5 = this.f22472u;
                if (soundImageView5 != null) {
                    soundImageView5.setVisibility(8);
                }
            } else if (i9 == 2 && (soundImageView = this.f22472u) != null) {
                soundImageView.setVisibility(0);
            }
        }
        if (str == null || !str.equals("2") || (aVar = this.f22258e) == null) {
            return;
        }
    ...
    public void b() {
        ...
        if (af.a().a("i_l_s_t_r_i", false) && (playerView = this.f22471t) != null) {
            playerView.setNotifyListener(new PlayerView.OnPlayerViewVisibleListener() { // from class: com.mbridge.msdk.video.module.MBridgeVideoView.14
                ...
                public final void playerViewVisibleCallback() {
                    if (!MBridgeVideoView.this.f22453F) {
                        MBridgeVideoView.this.f22453F = true;
                        MBridgeVideoView mBridgeVideoView = MBridgeVideoView.this;
                        if (mBridgeVideoView.f22258e != null && mBridgeVideoView.f22452E != null) {
                            MBridgeVideoView mBridgeVideoView2 = MBridgeVideoView.this;
                            mBridgeVideoView2.f22258e.a(20, mBridgeVideoView2.f22452E);
                        }
                    }
                }
            });
    ...
    */
    ...
    private boolean f() {
        try {
            this.f22471t = (PlayerView) findViewById(filterFindViewId(this.aE, "mbridge_vfpv"));
            this.f22472u = (SoundImageView) findViewById(filterFindViewId(this.aE, "mbridge_sound_switch"));
            this.f22473v = (TextView) findViewById(filterFindViewId(this.aE, "mbridge_tv_count"));
            View findViewById = findViewById(filterFindViewId(this.aE, "mbridge_rl_playing_close"));
            this.f22474w = findViewById;
            if (findViewById != null) {
                findViewById.setVisibility(4);
            }
            this.f22475x = (RelativeLayout) findViewById(filterFindViewId(this.aE, "mbridge_top_control"));
            this.f22476y = (ImageView) findViewById(filterFindViewId(this.aE, "mbridge_videoview_bg"));
            this.f22477z = (ProgressBar) findViewById(filterFindViewId(this.aE, "mbridge_video_progress_bar"));
            this.f22448A = (FeedBackButton) findViewById(filterFindViewId(this.aE, "mbridge_native_endcard_feed_btn"));
            this.f22449B = (ImageView) findViewById(filterFindViewId(this.aE, "mbridge_iv_link"));
            ...
            ai.a(1, this.f22449B, this.f22255b, this.f22254a, false, new com.mbridge.msdk.foundation.d.a() { // from class: com.mbridge.msdk.video.module.MBridgeVideoView.20
            ...
            this.f22450C = (MBridgeSegmentsProgressBar) findViewById(filterFindViewId(this.aE, "mbridge_reward_segment_progressbar"));
            this.f22457J = (FrameLayout) findViewById(filterFindViewId(this.aE, "mbridge_reward_cta_layout"));
            this.aG = (MBridgeBaitClickView) findViewById(filterFindViewId(this.aE, "mbridge_animation_click_view"));
            this.f22462O = (RelativeLayout) findViewById(filterFindViewId(this.aE, "mbridge_reward_moreoffer_layout"));
            this.aM = (MBAcquireRewardPopView) findViewById(filterFindViewId(this.aE, "mbridge_reward_popview"));
            return isNotNULL(this.f22471t, this.f22472u, this.f22473v, this.f22474w);
        } catch (Throwable th) {
            ad.a(MBridgeBaseView.TAG, th.getMessage(), th);
            return false;
        }
    ...
    public void g() {
        ...
        try {
            ...
            if (playerView != null) {
                ...
                if (com.mbridge.msdk.f.b.a()) {
                    PlayerView playerView2 = this.f22471t;
                    if (!this.aN && !this.f22464Q && !this.f22465R) {
                        z8 = false;
                ...
                CampaignEx campaignEx2 = this.f22255b;
                if (campaignEx2 != null && campaignEx2.getNativeVideoTracking() != null && !this.f22255b.isHasReportAdTrackPause()) {
    ...
    public void h() {
        ...
        try {
            CampaignEx campaignEx2 = this.f22255b;
            if (campaignEx2 == null || campaignEx2.getRewardTemplateMode() == null || this.f22255b.getRewardTemplateMode().f() != 5002010 || (relativeLayout = this.aQ) == null || relativeLayout.getVisibility() == 0) {
                if (!this.af) {
                    try {
                        if (this.ar != null) {
                            float duration = this.f22471t.getDuration();
                            if (duration == 0.0f && (campaignEx = this.f22255b) != null) {
                    ...
                    boolean playVideo = this.f22471t.playVideo();
                    CampaignEx campaignEx3 = this.f22255b;
                ...
                MBAcquireRewardPopView mBAcquireRewardPopView = this.aM;
                if (mBAcquireRewardPopView != null && this.f22465R) {
                    mBAcquireRewardPopView.onResume();
                }
                if (this.f22465R) {
                    return;
                ...
                if (com.mbridge.msdk.f.b.a()) {
                    if (this.aN || this.f22464Q) {
                        return;
                    }
                    this.f22471t.setIsCovered(false);
                    i();
                    return;
                }
                i();
    ...
    private void i() {
        if (this.aA) {
            if (!this.aB) {
                this.f22471t.seekToEndFrame();
            }
            this.aB = true;
        } else {
            this.f22471t.onResume();
        }
        CampaignEx campaignEx = this.f22255b;
        if (campaignEx != null && !campaignEx.isRewardPopViewShowed) {
            post(this.aY);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void j() {
        if (!this.f22259f || this.f22474w.getVisibility() == 0) {
            return;
        }
        if (!this.f22262i || this.f22456I) {
            this.f22474w.setVisibility(0);
        }
        this.ai = true;
    }
    ...
    */
    ...
    private void l() {
        try {
            ...
            if (isLandscape() || !this.f22259f) {
                return;
            }
            FrameLayout.LayoutParams layoutParams = (FrameLayout.LayoutParams) this.f22471t.getLayoutParams();
            int f8 = ai.f(this.f22254a);
    ...
    public void m() {
        ...
        if (campaignEx != null) {
            ...
            com.mbridge.msdk.foundation.d.b.a().a(this.ab + "_1", this.f22255b);
        }
        if (com.mbridge.msdk.foundation.d.b.a().b()) {
            if (this.f22448A != null) {
                com.mbridge.msdk.foundation.d.b.a().a(this.ab + "_1", this.f22448A);
                return;
            }
            return;
        }
        FeedBackButton feedBackButton = this.f22448A;
    ...
    private void n() {
        ...
        if (this.f22458K == null) {
            ...
            this.f22458K = mBridgeClickCTAView;
            mBridgeClickCTAView.setCampaign(this.f22255b);
            this.f22458K.setUnitId(this.ab);
            com.mbridge.msdk.video.module.a.a aVar = this.f22451D;
            if (aVar != null) {
                this.f22458K.setNotifyListener(new com.mbridge.msdk.video.module.a.a.i(aVar));
            }
            this.f22458K.preLoadData(this.f22459L);
        }
        this.f22457J.addView(this.f22458K);
    }
    ...
    protected final void c() {
        ...
        if (this.f22259f) {
            if (this.f22262i) {
                if (com.mbridge.msdk.video.dynview.i.a.a(this.f22255b) == -1 || com.mbridge.msdk.video.dynview.i.a.a(this.f22255b) == 100) {
                    this.f22471t.setOnClickListener(new View.OnClickListener() { // from class: com.mbridge.msdk.video.module.MBridgeVideoView.15
                        @Override // android.view.View.OnClickListener
                        public final void onClick(View view) {
                            if (MBridgeVideoView.this.f22258e != null) {
                                JSONObject jSONObject = new JSONObject();
                                try {
                                    jSONObject.put(com.mbridge.msdk.foundation.same.a.f19422j, MBridgeVideoView.this.f22471t.buildH5JsonObject(0));
                                } catch (Exception e8) {
                                    e8.printStackTrace();
                                }
                                MBridgeVideoView.this.f22255b.setClickTempSource(1);
                                MBridgeVideoView.this.f22255b.setTriggerClickSource(2);
                                MBridgeVideoView.this.f22258e.a(1, jSONObject);
                            }
                ...
                this.f22471t.setOnClickListener(new View.OnClickListener() { // from class: com.mbridge.msdk.video.module.MBridgeVideoView.16
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view) {
                        if (MBridgeVideoView.this.f22258e != null) {
                            JSONObject jSONObject = new JSONObject();
            ...
            if (soundImageView != null) {
                soundImageView.setOnClickListener(new View.OnClickListener() { // from class: com.mbridge.msdk.video.module.MBridgeVideoView.17
                    ...
                    public final void onClick(View view) {
                        Integer num = 2;
                        if (MBridgeVideoView.this.f22471t != null && MBridgeVideoView.this.f22471t.isSilent()) {
                            num = 1;
                        }
                        if (num.intValue() == 1) {
            ...
            this.f22474w.setOnClickListener(new View.OnClickListener() { // from class: com.mbridge.msdk.video.module.MBridgeVideoView.18
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    try {
                        d dVar = new d();
                        dVar.a("type", 1);
                        com.mbridge.msdk.foundation.same.report.d.c.a().a("2000152", dVar);
                        com.mbridge.msdk.foundation.same.report.d.c.a().a("2000148", MBridgeVideoView.this.f22255b, dVar);
                    } catch (Exception e8) {
                        if (MBridgeConstans.DEBUG) {
                            e8.printStackTrace();
                        }
                    ...
                    if (MBridgeVideoView.this.ao) {
                        ...
                        CampaignEx campaignEx = MBridgeVideoView.this.f22255b;
                        if (campaignEx != null && campaignEx.getRewardTemplateMode() != null && MBridgeVideoView.this.f22255b.getRewardTemplateMode().f() == 5002010 && MBridgeVideoView.this.aA) {
                            MBridgeVideoView mBridgeVideoView = MBridgeVideoView.this;
                            if (mBridgeVideoView.f22258e != null) {
                                mBridgeVideoView.aU = true;
                                MBridgeVideoView mBridgeVideoView2 = MBridgeVideoView.this;
                                mBridgeVideoView2.f22258e.a(2, mBridgeVideoView2.b(mBridgeVideoView2.aA));
                                return;
                            }
                            return;
                        }
                    ...
                    CampaignEx campaignEx2 = MBridgeVideoView.this.f22255b;
                    if (campaignEx2 == null || campaignEx2.getRewardTemplateMode() == null || MBridgeVideoView.this.f22255b.getRewardTemplateMode().f() != 5002010 || !MBridgeVideoView.this.aA) {
                        MBridgeVideoView.this.e();
                        return;
                    }
                    MBridgeVideoView mBridgeVideoView3 = MBridgeVideoView.this;
    ...
    public String b(boolean z8) {
        ...
        try {
            JSONObject jSONObject = new JSONObject();
            if (!this.aw) {
                jSONObject.put("Alert_window_status", com.mbridge.msdk.foundation.same.a.f19395F);
            }
            if (this.ay) {
                jSONObject.put("Alert_window_status", com.mbridge.msdk.foundation.same.a.f19393D);
            }
            if (this.ax) {
                jSONObject.put("Alert_window_status", com.mbridge.msdk.foundation.same.a.f19394E);
            }
    ...
    */
    static /* synthetic */ void a(com.mbridge.msdk.video.module.MBridgeVideoView r9, java.lang.String r10) {
        /*
            com.mbridge.msdk.video.module.a.a r0 = r9.f22451D
            if (r0 == 0) goto L9c
            com.mbridge.msdk.foundation.entity.CampaignEx r0 = r9.f22255b
            if (r0 == 0) goto L55
            r1 = 1
            r0.setClickTempSource(r1)
            com.mbridge.msdk.foundation.entity.CampaignEx r0 = r9.f22255b     // Catch: java.lang.Exception -> L2b
        ...
        L2b:
            ...
            goto L52
        L2d:
            android.content.Context r0 = r9.f22254a     // Catch: java.lang.Exception -> L2b
            com.mbridge.msdk.foundation.entity.CampaignEx r1 = r9.f22255b     // Catch: java.lang.Exception -> L2b
        ...
        L55:
            ...
            java.lang.String r10 = com.mbridge.msdk.foundation.same.a.f19422j     // Catch: org.json.JSONException -> L66
            r1 = 0
        ...
        L6c:
            r10.printStackTrace()
        L6f:
            com.mbridge.msdk.video.module.a.a r10 = r9.f22451D
            ...
            com.mbridge.msdk.foundation.entity.CampaignEx r9 = r9.f22255b     // Catch: java.lang.Exception -> L92
    ...
    static /* synthetic */ void b(MBridgeVideoView mBridgeVideoView) {
        CampaignEx campaignEx = mBridgeVideoView.f22255b;
        if (campaignEx == null || !campaignEx.isDynamicView() || mBridgeVideoView.f22457J == null) {
            return;
        }
        if (mBridgeVideoView.f22458K == null) {
            mBridgeVideoView.n();
        }
        if (mBridgeVideoView.f22457J.getVisibility() != 0) {
            mBridgeVideoView.f22457J.setVisibility(0);
            mBridgeVideoView.postDelayed(mBridgeVideoView.aX, 3000L);
        } else {
            mBridgeVideoView.f22457J.setVisibility(8);
