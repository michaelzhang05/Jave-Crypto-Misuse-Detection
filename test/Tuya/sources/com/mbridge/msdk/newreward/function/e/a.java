...
public final class a {
    ...
    private SQLiteDatabase f21165a;

    /* renamed from: b, reason: collision with root package name */
    private final Object f21166b = new Object();

    public a(SQLiteDatabase sQLiteDatabase) {
        this.f21165a = sQLiteDatabase;
    }
    ...
    public final void b(int i8, String str, String str2, String str3, boolean z8, String str4, long j8) {
        ...
        Cursor query;
        if (!DatabaseUtils.isDatabaseAvailable(this.f21165a)) {
        ...
        synchronized (this.f21166b) {
            try {
                try {
                    query = this.f21165a.query("campaign", null, "ad_type=? and app_id=? and placement_id=? and unit_id=? and local_id=?", new String[]{String.valueOf(i8), com.mbridge.msdk.foundation.controller.c.m().k(), str, str2, str3}, null, null, null);
                } catch (Exception e8) {
                    if (MBridgeConstans.DEBUG) {
                        ad.a("CampaignTable", "insert: ", e8);
                    }
                    sQLiteDatabase = this.f21165a;
                }
                if (query != null && query.getCount() > 0) {
                    ...
                    DatabaseUtils.endTransaction(this.f21165a);
                    return;
                }
                DatabaseUtils.beginTransaction(this.f21165a);
                ...
                long insert = this.f21165a.insert("campaign", null, contentValues);
                if (MBridgeConstans.DEBUG) {
                    ad.a("CampaignTable", "insert result:  " + insert);
                }
                DatabaseUtils.setTransactionSuccessful(this.f21165a);
                sQLiteDatabase = this.f21165a;
    ...
    public final void c(int i8, String str, String str2) {
        ...
        synchronized (this.f21166b) {
            try {
                try {
                    DatabaseUtils.beginTransaction(this.f21165a);
                    int delete = this.f21165a.delete("campaign", "ad_type=? and app_id=? and placement_id=? and unit_id=? and state in (0,405,401,404);", new String[]{String.valueOf(i8), com.mbridge.msdk.foundation.controller.c.m().k(), str, str2});
                    if (MBridgeConstans.DEBUG) {
    ...
    public final void d(int i8, String str, String str2) {
        ...
        synchronized (this.f21166b) {
            try {
                try {
                    DatabaseUtils.beginTransaction(this.f21165a);
                    int delete = this.f21165a.delete("campaign", a(), new String[]{String.valueOf(i8), com.mbridge.msdk.foundation.controller.c.m().k(), str, str2, String.valueOf(System.currentTimeMillis())});
                    if (MBridgeConstans.DEBUG) {
    ...
    public final List<String> e(int i8, String str, String str2) {
        ...
        synchronized (this.f21166b) {
            try {
                try {
                    try {
                        query = this.f21165a.query("campaign", null, a(), new String[]{String.valueOf(i8), com.mbridge.msdk.foundation.controller.c.m().k(), str, str2, String.valueOf(System.currentTimeMillis())}, null, null, null, null);
                    } catch (Throwable th) {
                        throw th;
                    }
                } catch (Exception e8) {
    ...
    public final List<com.mbridge.msdk.newreward.function.d.a.b> a(int i8, String str, String str2, boolean z8) {
        ...
        synchronized (this.f21166b) {
            try {
                cursor = this.f21165a.query("campaign", null, "ad_type=? and app_id=? and placement_id=? and unit_id=? and header_bidding=? and state in (401,404,405)", new String[]{String.valueOf(i8), com.mbridge.msdk.foundation.controller.c.m().k(), str, str2, String.valueOf(z8 ? 1 : 0)}, null, null, "load_start_time desc");
                try {
                    try {
            ...
            synchronized (this.f21166b) {
                try {
                    try {
                        ...
                        long update = this.f21165a.update("campaign", contentValues, "ad_type=? and app_id=? and placement_id=? and unit_id=? and local_id=?", new String[]{String.valueOf(bVar.a()), com.mbridge.msdk.foundation.controller.c.m().k(), bVar.b(), bVar.c(), bVar.e()});
                        if (MBridgeConstans.DEBUG) {
        ...
        synchronized (this.f21166b) {
            try {
                try {
                    ...
                    int update = this.f21165a.update("campaign", contentValues, "ad_type=? and app_id=? and placement_id=? and unit_id=? and local_id=?", new String[]{String.valueOf(i8), com.mbridge.msdk.foundation.controller.c.m().k(), str, str2, str3});
                    if (MBridgeConstans.DEBUG) {
