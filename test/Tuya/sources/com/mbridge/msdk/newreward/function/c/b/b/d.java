...
public final class d {
    ...
    private int f20967a = 0;

    /* renamed from: b, reason: collision with root package name */
    private long f20968b = 0;
    ...
    public static /* synthetic */ class AnonymousClass2 {
        ...
        static {
            ...
            try {
                f20972a[com.mbridge.msdk.newreward.function.c.e.REPORT_V3_RETRY_END.ordinal()] = 2;
    ...
    */
    ...
    public void a(com.mbridge.msdk.newreward.function.c.e eVar, e eVar2, String str, boolean z8) {
        ...
        try {
            Map a8 = d8.a("retry_count", Integer.valueOf(this.f20967a), "type", 3);
            int i8 = AnonymousClass2.f20972a[eVar.ordinal()];
            if (i8 == 1) {
            ...
            a8.put(TypedValues.TransitionType.S_DURATION, Long.valueOf(System.currentTimeMillis() - this.f20968b));
            if (!z8) {
                a8.put("reason", str);
            }
