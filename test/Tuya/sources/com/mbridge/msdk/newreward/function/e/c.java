...
public class c {
    ...
    private static volatile c f21204a;

    /* renamed from: b, reason: collision with root package name */
    private a f21205b = new a();

    /* renamed from: c, reason: collision with root package name */
    private com.mbridge.msdk.newreward.function.e.a f21206c;
    ...
    private SQLiteDatabase c() {
        try {
            return this.f21205b.getWritableDatabase();
    ...
    public final com.mbridge.msdk.newreward.function.e.a b() {
        if (this.f21206c == null) {
            this.f21206c = new com.mbridge.msdk.newreward.function.e.a(c());
        }
        return this.f21206c;
    }
}
