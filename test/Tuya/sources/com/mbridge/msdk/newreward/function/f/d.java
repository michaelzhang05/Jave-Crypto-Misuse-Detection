...
public final class d {
    ...
    private volatile boolean f21237a = false;

    /* renamed from: b, reason: collision with root package name */
    private volatile boolean f21238b = false;
    ...
    private static class a implements com.mbridge.msdk.newreward.a.b.b {
        ...
        /* renamed from: a, reason: collision with root package name */
        private com.mbridge.msdk.newreward.function.d.a.b f21239a;

        /* renamed from: b, reason: collision with root package name */
        private d f21240b;

        /* renamed from: c, reason: collision with root package name */
        private com.mbridge.msdk.newreward.a.b.b f21241c;
        ...
        public final void a(Object obj) {
            com.mbridge.msdk.newreward.function.d.a.b bVar = this.f21239a;
            com.mbridge.msdk.newreward.a.b.b bVar2 = this.f21241c;
            if (d.a(this.f21240b) && bVar.x()) {
                this.f21240b.f21237a = true;
        ...
        public final void a(com.mbridge.msdk.foundation.c.b bVar) {
            com.mbridge.msdk.newreward.function.d.a.b bVar2 = this.f21239a;
            com.mbridge.msdk.newreward.a.b.b bVar3 = this.f21241c;
            if (d.a(this.f21240b)) {
                if (bVar2.x()) {
                    this.f21240b.f21237a = true;
    ...
    static /* synthetic */ boolean a(d dVar) {
        return (dVar.f21237a || dVar.f21238b) ? false : true;
    }
}
