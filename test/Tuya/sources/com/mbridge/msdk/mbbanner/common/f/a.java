...
public abstract class a extends f<JSONObject> {
    ...
    public void onError(com.mbridge.msdk.foundation.same.net.b.a aVar) {
        ad.c(f20439a, "onFailed errorCode = " + aVar.f19601a);
    ...
    public void onSuccess(k<JSONObject> kVar) {
        ...
        List<b> list = kVar.f19760b.f19656b;
        final JSONObject jSONObject = kVar.f19761c;
        ad.c(f20439a, "parseLoad content = " + jSONObject);
            ...
            com.mbridge.msdk.foundation.same.f.b.b().execute(new Runnable() { // from class: com.mbridge.msdk.mbbanner.common.f.a.1
                ...
                public final void run() {
                    ...
                    if ("v5".equals(optString)) {
                        parseCampaignUnit = com.mbridge.msdk.foundation.entity.b.parseV5CampaignUnit(jSONObject.optJSONObject(DataSchemeDataSource.SCHEME_DATA), a.this.f20440b);
                    } else {
                        parseCampaignUnit = com.mbridge.msdk.foundation.entity.b.parseCampaignUnit(jSONObject.optJSONObject(DataSchemeDataSource.SCHEME_DATA), a.this.f20440b);
                    }
                    com.mbridge.msdk.foundation.same.f.b.e().post(new Runnable() { // from class: com.mbridge.msdk.mbbanner.common.f.a.1.1
                        ...
                        public final void run() {
                            ...
                            if (campaignUnit != null && campaignUnit.getAds() != null && parseCampaignUnit.getAds().size() > 0) {
                                ...
                                if (!TextUtils.isEmpty(a.this.f20440b)) {
