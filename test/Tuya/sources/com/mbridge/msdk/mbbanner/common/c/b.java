...
public class b {
    ...
    private com.mbridge.msdk.mbbanner.common.a.c f20341d;

    /* renamed from: e, reason: collision with root package name */
    private com.mbridge.msdk.mbbanner.common.util.a f20342e;

    /* renamed from: f, reason: collision with root package name */
    private com.mbridge.msdk.mbbanner.common.b.b f20343f;

    /* renamed from: g, reason: collision with root package name */
    private com.mbridge.msdk.mbbanner.common.b.d f20344g;

    /* renamed from: c, reason: collision with root package name */
    private int f20340c = 0;

    /* renamed from: h, reason: collision with root package name */
    private volatile boolean f20345h = false;

    /* renamed from: i, reason: collision with root package name */
    private Timer f20346i = new Timer();

    /* renamed from: j, reason: collision with root package name */
    private volatile List<String> f20347j = new ArrayList();

    /* renamed from: k, reason: collision with root package name */
    private volatile boolean f20348k = false;

    /* renamed from: l, reason: collision with root package name */
    private volatile boolean f20349l = false;

    /* renamed from: m, reason: collision with root package name */
    private volatile boolean f20350m = false;
    ...
    public static class a implements com.mbridge.msdk.foundation.same.c.c {
        ...
        /* renamed from: c, reason: collision with root package name */
        private CampaignEx f20365c;

        public a(b bVar, String str, CampaignEx campaignEx) {
            this.f20363a = bVar;
            this.f20364b = str;
            this.f20365c = campaignEx;
        }

        @Override // com.mbridge.msdk.foundation.same.c.c
        public final void onFailedLoad(String str, String str2) {
            if (MBridgeConstans.DEBUG) {
                ad.c(b.f20338a, "DownloadImageListener campaign image fail");
            }
            b bVar = this.f20363a;
            if (bVar != null) {
                bVar.a(this.f20364b, 1, str2, false, this.f20365c);
            }
        }
        ...
        public final void onSuccessLoad(Bitmap bitmap, String str) {
            if (MBridgeConstans.DEBUG) {
                ad.c(b.f20338a, "DownloadImageListener campaign image success");
            }
            b bVar = this.f20363a;
            if (bVar != null) {
                bVar.a(this.f20364b, 1, str, true, this.f20365c);
            }
        }
    }
    ...
    private int b(String str) {
        try {
            int b8 = this.f20341d.b();
            if (b8 > this.f20341d.c()) {
                return 0;
            }
            return b8;
        } catch (Exception e8) {
    ...
    private void a(String str) {
        ...
        if ((this.f20348k || this.f20349l) && this.f20347j.size() == 0) {
            ad.c(f20338a, "在子线程处理业务逻辑 完成");
            this.f20345h = true;
            this.f20350m = true;
            this.f20346i.cancel();
            this.f20342e.a(this.f20343f, str);
            this.f20344g.a(str);
        }
    }
    ...
    public final void a(String str, int i8, String str2, boolean z8, CampaignEx campaignEx) {
        if (z8) {
            if (i8 == 1) {
                ad.c(f20338a, "downloadResource--> Success Image");
                synchronized (this) {
                    try {
                        this.f20347j.remove(str2);
            ...
            if (i8 == 2) {
                ad.c(f20338a, "downloadResource--> Success banner_html");
                this.f20349l = true;
                a(str);
                return;
            } else {
                if (i8 == 3) {
                    ad.c(f20338a, "downloadResource--> Success banner_url");
                    this.f20348k = true;
                    a(str);
                    return;
                }
        ...
        if (i8 == -1) {
            ad.b(f20338a, " unitId =" + str + " --> time out!");
        }
        this.f20346i.cancel();
        String str3 = f20338a;
        ...
        bVar.a(mBridgeIds);
        bVar.a(campaignEx);
        this.f20342e.b(this.f20343f, bVar);
        this.f20344g.a(str);
    }
    ...
    public final void a(String str, String str2, com.mbridge.msdk.mbbanner.common.a.b bVar, com.mbridge.msdk.mbbanner.common.b.d dVar) {
        boolean z8;
        try {
            ad.c(f20338a, "requestCampaign--> started");
            this.f20344g = dVar;
            com.mbridge.msdk.mbbanner.common.f.a aVar = new com.mbridge.msdk.mbbanner.common.f.a() { // from class: com.mbridge.msdk.mbbanner.common.c.b.2
                ...
                public final void a(CampaignUnit campaignUnit) {
                    try {
                        ad.c(b.f20338a, "requestCampaign--> Succeed");
                        b.this.f20342e.a(b.this.f20343f, campaignUnit, this.unitId);
                        b.a(b.this, this.unitId, campaignUnit);
                    } catch (Exception e8) {
                        ad.c(b.f20338a, "requestCampaign--> Fail with exception = " + e8.getMessage());
                        ...
                        b.this.f20342e.a(b.this.f20343f, bVar2);
                        b.this.f20344g.a(this.unitId);
                    }
                }

                @Override // com.mbridge.msdk.mbbanner.common.f.a
                public final void a(int i8, String str3) {
                    ad.c(b.f20338a, "requestCampaign--> Fail errorCode:" + i8 + " msg:" + str3);
            ...
            aVar.setAdType(296);
            com.mbridge.msdk.mbbanner.common.e.a aVar2 = new com.mbridge.msdk.mbbanner.common.e.a(this.f20339b);
            this.f20340c = b(str2);
            e a8 = com.mbridge.msdk.mbbanner.common.a.d.a(false, this.f20339b, str2, this.f20341d.a(), this.f20340c, bVar);
            String d8 = ai.d(str2);
        ...
        if (campaignUnit != null) {
            try {
                if (campaignUnit.getAds() != null && campaignUnit.getAds().size() > 0) {
                    ...
                    ad.c(f20338a, "getNeedShowList 总共返回的campaign有：" + ads.size());
                    for (int i8 = 0; i8 < ads.size(); i8++) {
                        ...
                        if (campaignEx != null) {
                            if (campaignEx.getOfferType() != 99) {
                                ...
                                if (ai.c(campaignEx)) {
                                    campaignEx.setRtinsType(ai.c(this.f20339b, campaignEx.getPackageName()) ? 1 : 2);
                                }
                                if (com.mbridge.msdk.foundation.same.c.a(this.f20339b, campaignEx)) {
                                    arrayList.add(campaignEx);
                                } else {
                                    ai.a(str, campaignEx, com.mbridge.msdk.foundation.same.a.f19436x);
                                    this.f20351n = "APP ALREADY INSTALLED";
                                }
                                final Context context = this.f20339b;
                                try {
                    ...
                    ad.c(f20338a, "getNeedShowList 返回有以下带有视频素材的campaign：" + arrayList.size());
                }
            } catch (Exception e9) {
                e9.printStackTrace();
            }
    ...
    private void a(String str, List<CampaignEx> list) {
        ...
        for (CampaignEx campaignEx : list) {
            if (!TextUtils.isEmpty(campaignEx.getImageUrl())) {
                this.f20347j.add(campaignEx.getImageUrl());
                com.mbridge.msdk.foundation.same.c.b.a(this.f20339b).a(campaignEx.getImageUrl(), new a(this, str, campaignEx));
            }
        }
    }
    ...
    static /* synthetic */ void a(b bVar, final String str, final CampaignUnit campaignUnit) {
        ...
        if (campaignUnit == null) {
            ...
            mBridgeIds.setUnitId(str);
            bVar3.a(mBridgeIds);
            bVar.f20342e.a(bVar.f20343f, bVar3);
            bVar.f20344g.a(str);
            return;
        }
        ...
        new Thread(new Runnable() { // from class: com.mbridge.msdk.mbbanner.common.c.b.4
            ...
            public final void run() {
                ad.c(b.f20338a, "在单独子线程保存数据库 开始");
                k.a(h.a(b.this.f20339b)).a();
                CampaignUnit campaignUnit2 = campaignUnit;
                if (campaignUnit2 != null && campaignUnit2.getAds() != null && campaignUnit.getAds().size() > 0) {
                    BannerUtils.uisList(b.this.f20339b, campaignUnit.getAds());
                }
                ad.c(b.f20338a, "在单独子线程保存数据库 完成");
            }
        }).start();
        int i8 = 0;
        if (a8 != null && a8.size() != 0) {
            ...
            bVar.f20346i.schedule(new TimerTask() { // from class: com.mbridge.msdk.mbbanner.common.c.b.1
            ...
            bVar.f20341d.a(campaignUnit.getSessionId());
            int i9 = bVar.f20340c;
            try {
                if (a8.size() > 0) {
                    i9 += a8.size();
                }
                if (i9 > bVar.f20341d.c()) {
        ...
        ad.c(f20338a, "tryDownloadOnLoadSuccess 返回的campaign 没有符合下载规则的");
        if (bVar.f20351n.contains("INSTALLED")) {
        ...
        bVar.f20342e.a(bVar.f20343f, bVar2);
        bVar.f20344g.a(str);
    }
}
