...
public class Campaign extends BaseCampaign {
    ...
    @Override // com.mbridge.msdk.out.BaseCampaign
    public /* bridge */ /* synthetic */ void setAdchoiceSizeHeight(int i8) {
        super.setAdchoiceSizeHeight(i8);
    }

    @Override // com.mbridge.msdk.out.BaseCampaign
    public /* bridge */ /* synthetic */ void setAdchoiceSizeWidth(int i8) {
        super.setAdchoiceSizeWidth(i8);
    }
    ...
    @Override // com.mbridge.msdk.out.BaseCampaign
    public /* bridge */ /* synthetic */ void setCreativeId(long j8) {
        super.setCreativeId(j8);
    }
    ...
    @Override // com.mbridge.msdk.out.BaseCampaign
    public /* bridge */ /* synthetic */ void setNumberRating(int i8) {
        super.setNumberRating(i8);
    }
    ...
    @Override // com.mbridge.msdk.out.BaseCampaign
    public /* bridge */ /* synthetic */ void setRating(double d8) {
        super.setRating(d8);
    }
    ...
    @Override // com.mbridge.msdk.out.BaseCampaign
    public /* bridge */ /* synthetic */ void setTimestamp(long j8) {
        super.setTimestamp(j8);
    }

    @Override // com.mbridge.msdk.out.BaseCampaign
    public /* bridge */ /* synthetic */ void setType(int i8) {
        super.setType(i8);
    }

    @Override // com.mbridge.msdk.out.BaseCampaign
    public /* bridge */ /* synthetic */ void setVideoLength(int i8) {
        super.setVideoLength(i8);
    }
}
