...
public final class g extends com.mbridge.msdk.e.a.a.a {
    ...
    private final SSLSocketFactory f18763b;

    /* loaded from: classes4.dex */
    static class a extends FilterInputStream {

        /* renamed from: a, reason: collision with root package name */
        private final HttpURLConnection f18764a;

        a(HttpURLConnection httpURLConnection) {
            super(g.b(httpURLConnection));
            this.f18764a = httpURLConnection;
        }

        @Override // java.io.FilterInputStream, java.io.InputStream, java.io.Closeable, java.lang.AutoCloseable
        public final void close() throws IOException {
            super.close();
            this.f18764a.disconnect();
        }
    }
    ...
    public final f a(p<?> pVar, Map<String, String> map) throws IOException {
        ...
        if ("https".equals(url.getProtocol()) && (sSLSocketFactory = this.f18763b) != null) {
