...
public class h {
    ...
    private static final String f18142a = "h";

    /* renamed from: b, reason: collision with root package name */
    private com.mbridge.msdk.c.g f18143b;
    ...
    private final int f18146e = 3145728;

    /* renamed from: f, reason: collision with root package name */
    private com.mbridge.msdk.click.entity.a f18147f;
    ...
    public h() {
        ...
        if (b8 == null) {
            ...
            this.f18143b = com.mbridge.msdk.c.i.a();
        }
    }
    ...
    public final com.mbridge.msdk.click.entity.a a(String str, boolean z8, boolean z9, CampaignEx campaignEx) {
        ...
        this.f18147f = new com.mbridge.msdk.click.entity.a();
        try {
        ...
        try {
            ...
            if (this.f18143b.aI() && !TextUtils.isEmpty(this.f18144c)) {
                httpURLConnection.setRequestProperty("referer", this.f18144c);
            }
            ...
            this.f18147f.f18121a = httpURLConnection.getHeaderField("Location");
            this.f18147f.f18124d = httpURLConnection.getHeaderField("Referer");
            this.f18147f.f18126f = httpURLConnection.getResponseCode();
            this.f18147f.f18122b = httpURLConnection.getContentType();
            this.f18147f.f18125e = httpURLConnection.getContentLength();
            this.f18147f.f18123c = httpURLConnection.getContentEncoding();
            boolean equalsIgnoreCase = "gzip".equalsIgnoreCase(this.f18147f.f18123c);
            com.mbridge.msdk.click.entity.a aVar = this.f18147f;
            if (aVar.f18126f == 200 && this.f18145d && (i8 = aVar.f18125e) > 0 && i8 < 3145728 && !TextUtils.isEmpty(replace)) {
                try {
                    ...
                    if (!TextUtils.isEmpty(a8)) {
                        ...
                        if (bytes.length > 0 && bytes.length < 3145728) {
                            this.f18147f.f18127g = a8.trim();
                        }
                    }
                } catch (Throwable th2) {
                    ad.b(f18142a, th2.getMessage());
                }
            }
            this.f18144c = replace;
            ...
            try {
                this.f18147f.f18128h = th.getMessage();
                return this.f18147f;
            } finally {
    ...
    */
    private java.lang.String a(java.io.InputStream r4, boolean r5) {
        ...
        L31:
            r4 = move-exception
            java.lang.String r5 = com.mbridge.msdk.click.h.f18142a
            java.lang.String r4 = r4.getMessage()
            com.mbridge.msdk.foundation.tools.ad.b(r5, r4)
            goto L5b
        L3c:
            com.mbridge.msdk.click.entity.a r5 = r3.f18147f     // Catch: java.lang.Throwable -> Lf
            if (r5 != 0) goto L4d
            ...
            r3.f18147f = r5     // Catch: java.lang.Throwable -> Lf
            java.lang.String r2 = r4.getMessage()     // Catch: java.lang.Throwable -> Lf
            r5.f18128h = r2     // Catch: java.lang.Throwable -> Lf
        L4d:
            java.lang.String r5 = com.mbridge.msdk.click.h.f18142a     // Catch: java.lang.Throwable -> Lf
        ...
        L66:
            r5 = move-exception
            java.lang.String r0 = com.mbridge.msdk.click.h.f18142a
