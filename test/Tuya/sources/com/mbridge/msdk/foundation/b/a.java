...
public class a {
    ...
    public static int f19002b = 4;

    /* renamed from: c, reason: collision with root package name */
    private static String f19003c = "BaseCandidateCache";

    /* renamed from: a, reason: collision with root package name */
    protected com.mbridge.msdk.foundation.db.c f19004a;

    /* renamed from: d, reason: collision with root package name */
    private JSONArray f19005d;

    /* renamed from: e, reason: collision with root package name */
    private JSONObject f19006e;
    ...
    public final JSONObject a(String str) {
        JSONArray jSONArray = this.f19005d;
        if (jSONArray == null) {
            return null;
        }
        if (jSONArray.length() > 1) {
            ...
            for (int i8 = 0; i8 < this.f19005d.length(); i8++) {
                try {
                    JSONObject optJSONObject = this.f19005d.optJSONObject(i8);
                    if (optJSONObject != null && str.equals(optJSONObject.getString("g"))) {
                        this.f19006e = optJSONObject;
        ...
        return this.f19005d.optJSONObject(0);
    }

    public final String b(String str) {
        c c8 = c(str);
        if (c8 != null && c8.g() != c.f19023c && c8.g() != c.f19021a) {
                ...
                if (list.size() > 0) {
                    Collections.sort(list, new Comparator<C0395a>() { // from class: com.mbridge.msdk.foundation.b.a.1
                        ...
                        public final /* synthetic */ int compare(C0395a c0395a, C0395a c0395a2) {
                            return Double.compare(c0395a.f19010b, c0395a2.f19010b);
                        }
                    });
                    int size = list.size() - i8;
                    if (size > 0) {
                        List<C0395a> subList = list.subList(0, size);
                        if (this.f19004a == null || subList.size() <= 0) {
                            return;
                        }
                        for (int i9 = 0; i9 < subList.size(); i9++) {
                            b bVar = subList.get(i9).f19009a;
                            this.f19004a.a(this.f19007f, bVar.e(), bVar.d());
                            a(f19002b, 1, null, true, bVar.e(), bVar.d(), -1, this.f19007f);
                        }
                    }
                }
            } catch (Exception e8) {
    ...
    public final long a(List<CampaignEx> list, String str) {
        ...
        try {
            ...
            com.mbridge.msdk.foundation.db.c cVar = this.f19004a;
            if (cVar == null || optInt <= 0) {
                return -1L;
            }
            return cVar.a(list, this.f19007f);
        } catch (Exception e8) {
            e8.printStackTrace();
            return -1L;
        }
    ...
    public final void a(String str, String str2, int i8, String str3) {
        try {
            if (this.f19004a == null || TextUtils.isEmpty(str3)) {
                return;
            }
            if (i8 == 1) {
                this.f19004a.a(str2, str, this.f19007f, i8);
                a(f19002b, 3, null, true, str2, str, -1, this.f19007f);
            } else if (i8 == 2) {
                this.f19004a.a(this.f19007f, str2, str);
                a(f19002b, 1, null, true, str2, str, -1, this.f19007f);
            } else if (i8 == 3) {
                this.f19004a.b(str2, str, this.f19007f);
                a(f19002b, 4, null, true, str2, str, -1, this.f19007f);
            }
        } catch (Exception e8) {
            e8.printStackTrace();
        }
    ...
    */
    ...
    public final List<b> a(int i8, long j8) {
        ...
        if (i8 >= 0 && (cVar = this.f19004a) != null) {
            cVar.a(this.f19007f, i8);
            a(f19002b, 1, null, true, "", "", i8, this.f19007f);
        }
        com.mbridge.msdk.foundation.db.c cVar2 = this.f19004a;
        if (cVar2 != null) {
            return cVar2.a(this.f19007f, 0, j8);
        }
        return null;
    }
}
