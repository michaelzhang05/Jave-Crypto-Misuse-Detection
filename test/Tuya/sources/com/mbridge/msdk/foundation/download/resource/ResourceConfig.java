...
public class ResourceConfig {
    ...
    public static class Builder {
        ...
        public Builder addMaxStorageSpace(DownloadResourceType downloadResourceType, long j8) {
            if (this.maxStorageSpacePerResourceType == null) {
                this.maxStorageSpacePerResourceType = new HashMap();
            }
            this.maxStorageSpacePerResourceType.put(downloadResourceType.name(), Long.valueOf(j8));
            return this;
        }

        public Builder addMaxStorageTime(DownloadResourceType downloadResourceType, long j8) {
            if (this.maxStorageTimePerResourceType == null) {
                this.maxStorageTimePerResourceType = new HashMap();
            }
            this.maxStorageTimePerResourceType.put(downloadResourceType.name(), Long.valueOf(j8));
            return this;
        }
        ...
        public Builder setMaxStorageSpace(long j8) {
            this.maxStorageSpace = j8;
            return this;
        }

        public Builder setMaxStorageTime(long j8) {
            this.maxStorageTime = j8;
            return this;
        }
    }
