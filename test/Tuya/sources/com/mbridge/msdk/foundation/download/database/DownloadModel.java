...
public class DownloadModel {
    ...
    public static DownloadModel create(String str, String str2, String str3, String str4, String str5, String str6, long j8, long j9, int i8, int i9, DownloadResourceType downloadResourceType, int i10) {
        ...
        downloadModel.setTotalBytes(j8);
        downloadModel.setLastModifiedTime(System.currentTimeMillis());
        downloadModel.setUsageCounter(i9);
        downloadModel.setDownloadRate(i8);
    ...
    public void setDownloadedBytes(long j8) {
    ...
    public void setUnZipResourceByte(long j8) {
        this.unZipResourceByte = j8;
    }
    ...
    public void setUsageCounter(int i8) {
        this.usageCounter = i8;
    }

    public static DownloadModel create(String str, String str2, String str3, String str4, String str5, String str6, long j8, long j9, int i8, int i9, DownloadResourceType downloadResourceType) {
        DownloadModel downloadModel = new DownloadModel();
        downloadModel.setDownloadId(str);
        downloadModel.setDownloadUrl(str2);
        downloadModel.setResourceUrl(str3);
