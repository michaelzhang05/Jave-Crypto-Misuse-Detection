...
public class MBDownloadConfig {
    ...
    public static final class Builder {
        ...
        public final Builder setDefaultConnectTimeout(long j8) {
            this.defaultConnectTimeout = j8;
            return this;
        }

        public final Builder setDefaultPingInterval(long j8) {
            this.defaultPingInterval = j8;
            return this;
        }

        public final Builder setDefaultReadTimeout(long j8) {
            this.defaultReadTimeout = j8;
            return this;
        }

        public final Builder setDefaultWriteTimeout(long j8) {
            this.defaultWriteTimeout = j8;
            return this;
        }
        ...
        public final Builder setMaxRequests(int i8) {
            this.maxRequests = i8;
            return this;
        }

        public final Builder setMaxRequestsPerHost(int i8) {
