...
public class d implements Thread.UncaughtExceptionHandler {
    ...
    private static volatile d f19823b;

    /* renamed from: a, reason: collision with root package name */
    Handler f19824a = new Handler() { // from class: com.mbridge.msdk.foundation.same.report.b.d.1
        @Override // android.os.Handler
        public final void handleMessage(Message message) {
            Context context;
            HashMap hashMap;
            super.handleMessage(message);
            if (message.what != 101 || (context = (Context) d.this.f19825c.get()) == null) {
                return;
            }
    ...
    private final WeakReference<Context> f19825c;

    /* renamed from: d, reason: collision with root package name */
    private Throwable f19826d;

    /* renamed from: e, reason: collision with root package name */
    private Thread.UncaughtExceptionHandler f19827e;

    private d(Context context) {
        this.f19825c = new WeakReference<>(context);
    }
    ...
    private HashMap<String, Object> c() {
        ...
        try {
            ...
            printWriter.println(a(this.f19826d, format));
            printWriter.println("====");
            this.f19826d.printStackTrace(printWriter);
            printWriter.close();
    ...
    public final JSONObject b(String str) throws JSONException {
        ...
        Context context = this.f19825c.get();
        if (context == null) {
            return null;
        }
    ...
    public static String a() {
        try {
            ...
            String U7 = b8.U();
            return TextUtils.isEmpty(U7) ? "<mvpackage>mbridge</mvpackage>" : U7;
        } catch (Exception unused) {
    ...
    public final void b() {
        this.f19827e = Thread.getDefaultUncaughtExceptionHandler();
    ...
    private void a(String str, String str2, Throwable th, Thread thread) {
        if (str.contains(str2)) {
            ...
            obtain.obj = hashMap;
            obtain.what = 101;
            this.f19824a.sendMessage(obtain);
            a(thread, th);
            return;
        }
        Thread.UncaughtExceptionHandler uncaughtExceptionHandler = this.f19827e;
