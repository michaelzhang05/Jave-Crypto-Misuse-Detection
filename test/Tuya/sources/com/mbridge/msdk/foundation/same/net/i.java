...
public abstract class i<T> implements Comparable<i<T>> {
    ...
    private static final String f19739c = "i";

    /* renamed from: a, reason: collision with root package name */
    protected ConcurrentHashMap<String, String> f19740a;

    /* renamed from: b, reason: collision with root package name */
    protected e<T> f19741b;
    ...
    private Integer f19748j;

    /* renamed from: k, reason: collision with root package name */
    private int f19749k;

    public i(int i8, String str, e<T> eVar) {
        this.f19740a = new ConcurrentHashMap<>();
        this.f19745g = false;
        this.f19749k = 2;
        this.f19743e = str;
        this.f19742d = i8;
    ...
    public /* synthetic */ int compareTo(Object obj) {
        ...
        int b9 = iVar.b();
        if (b8 == b9) {
            return this.f19748j.intValue() - iVar.f19748j.intValue();
        }
        return b9 - b8;
    }
    ...
    public String toString() {
        ...
        sb.append(str);
        sb.append(this.f19743e);
        sb.append(" ");
        sb.append(b());
        sb.append(" ");
        sb.append(this.f19748j);
        return sb.toString();
    }
    ...
    public final i<?> b(int i8) {
        this.f19748j = Integer.valueOf(i8);
        return this;
    }
    ...
    public final void a(String str, String str2) {
        this.f19740a.remove(str);
        this.f19740a.put(str, str2);
    }
}
