        ...
        public void callEnd(Call call) {
            ...
            if (this.isReportHttpStatus && this.httpStatus != null) {
                try {
                    ...
                    bVar.f19801k = 0;
                    bVar.f19800j = this.method;
                    bVar.f19791a = currentTimeMillis;
                    bVar.f19799i = this.hostName;
                    bVar.f19796f = this.dnsDuring;
                    bVar.f19797g = this.dnsResult;
                    bVar.f19793c = this.connectDuring;
                    bVar.f19795e = this.connectionDuring;
            ...
            if (this.isReportHttpStatus && this.httpStatus != null) {
                try {
                    ...
                    if (!TextUtils.isEmpty(this.connectErrorMessage)) {
                        c.b bVar = this.httpStatus;
                        bVar.f19801k = 1;
                        bVar.f19794d = this.connectErrorMessage;
                    } else {
                        this.httpStatus.f19801k = 2;
                    }
                    ...
                    bVar3.f19791a = this.callDuring;
                    bVar3.f19799i = this.hostName;
                    bVar3.f19800j = this.method;
                    bVar3.f19796f = this.dnsDuring;
                    bVar3.f19797g = this.dnsResult;
                    bVar3.f19793c = this.connectDuring;
                    bVar3.f19795e = this.connectionDuring;
                    c.a().a(this.httpStatus);
                } catch (Exception e8) {
                    ad.b("OkHttpStack", e8.getMessage());
                }
