...
public final class e {
    ...
    public static File b(c cVar) {
        try {
            if (a() == null || a().f19483c == null || a().f19483c.size() <= 0) {
                return null;
            }
            Iterator<a> it = a().f19483c.iterator();
            while (it.hasNext()) {
                a next = it.next();
                if (next.f19485b.equals(cVar)) {
                    return next.f19484a;
                }
            }
            return null;
    ...
    public static synchronized e a() {
        ...
        synchronized (e.class) {
            try {
                if (f19481a == null && com.mbridge.msdk.foundation.controller.c.m().c() != null) {
    ...
    private boolean a(com.mbridge.msdk.foundation.same.b.a aVar) {
        ...
        this.f19483c.add(new a(aVar.d(), file));
