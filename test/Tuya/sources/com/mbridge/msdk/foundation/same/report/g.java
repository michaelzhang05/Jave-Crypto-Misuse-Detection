...
public class g {
    ...
    private static volatile g f19896a;

    /* renamed from: b, reason: collision with root package name */
    private Executor f19897b = Executors.newSingleThreadExecutor(new ThreadFactory() { // from class: com.mbridge.msdk.foundation.same.report.g.1
    ...
    private volatile com.mbridge.msdk.e.m f19898c;
    ...
    private w e() {
        ...
        try {
            ...
            if (a13 == 1) {
                oVar = new com.mbridge.msdk.e.o(new n((byte) 2), com.mbridge.msdk.foundation.same.net.g.d.f().f19702i, com.mbridge.msdk.foundation.same.net.g.d.f().f19706m);
            } else {
    ...
    public final com.mbridge.msdk.e.m d() {
        if (this.f19898c == null) {
            this.f19898c = com.mbridge.msdk.e.m.a("mtg_sdk", com.mbridge.msdk.foundation.controller.c.m().c(), e());
            this.f19898c.a(c.a());
            this.f19898c.a();
        }
        return this.f19898c;
