...
public final class C2401a {
    ...
    private static byte[] f19966b = new byte[32];

    /* renamed from: a, reason: collision with root package name */
    private static byte[] f19965a = new byte[16];

    /* renamed from: com.mbridge.msdk.foundation.tools.a$a, reason: collision with other inner class name */
    /* loaded from: classes4.dex */
    public static class C0404a extends Provider {
        public C0404a() {
    ...
    static {
        if (!TextUtils.isEmpty("ebmclXzZOhtU2sRlZxGL8A")) {
            try {
                ...
                System.arraycopy(digest, 0, f19966b, 0, 32);
                System.arraycopy(digest, 32, f19965a, 0, 16);
            } catch (Exception e8) {
                e8.printStackTrace();
            }
        }
    ...
    private static String a(String str, byte[] bArr, byte[] bArr2) {
        try {
            ...
            Security.addProvider(new C0404a());
