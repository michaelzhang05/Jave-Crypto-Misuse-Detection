...
public final class ah extends l {
    ...
    public static char[] f20000a = {'a', 'n', 'd', 'r', 'o', 'i', 'd', 'c', 'o', 'n', 't', 'e', 'n', 't', 'p', 'm', 'g', 'e', 't', 'C', 'o', 'n', 't', 'e', 'x', 't'};

    /* renamed from: b, reason: collision with root package name */
    public static boolean f20001b = false;

    /* renamed from: c, reason: collision with root package name */
    public static LinearLayout f20002c;
    ...
    public static void a(Campaign campaign, ViewGroup viewGroup) {
        if (campaign != null) {
            ...
            if (campaignEx.getLinkType() == 8 && campaignEx.getAabEntity() != null && campaignEx.getAabEntity().getHlp() == 1) {
                ...
                try {
                    LinearLayout linearLayout = f20002c;
                ...
                try {
                    if (f20002c == null) {
                        ...
                        if (c8 instanceof Activity) {
                            f20002c = (LinearLayout) LayoutInflater.from(c8.getApplicationContext()).inflate(v.a(c8.getApplicationContext(), "mbridge_cm_loading_layout", TtmlNode.TAG_LAYOUT), (ViewGroup) null);
                        } else {
                            f20002c = (LinearLayout) LayoutInflater.from(c8).inflate(v.a(c8, "mbridge_cm_loading_layout", TtmlNode.TAG_LAYOUT), (ViewGroup) null);
                        }
                    }
                    ...
                    if (viewGroup instanceof FrameLayout) {
                        ...
                        ar.a(f20002c);
                        viewGroup.addView(f20002c, layoutParams);
                        return;
                    }
                    ...
                    ar.a(f20002c);
                    viewGroup.addView(f20002c, layoutParams2);
                } catch (Exception e8) {
                    e8.printStackTrace();
                }
            }
