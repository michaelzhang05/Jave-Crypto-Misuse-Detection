...
public class CampaignEx extends DomainCampaignEx implements NoProGuard, Serializable {
    ...
    public static final class a implements Serializable {
        ...
        private static a a(JSONObject jSONObject) {
            ...
            try {
                a aVar2 = new a();
                try {
                    aVar2.f19223c = jSONObject.optString("adchoice_icon");
                    aVar2.f19224d = jSONObject.optString("adchoice_link");
                    String optString = jSONObject.optString("adchoice_size");
                    aVar2.f19225e = optString;
                    aVar2.f19221a = jSONObject.optString("ad_logo_link");
                    aVar2.f19228h = jSONObject.optString("adv_logo");
                    aVar2.f19229i = jSONObject.optString("adv_name");
                    aVar2.f19230j = jSONObject.optString("platform_logo");
                    aVar2.f19231k = jSONObject.optString("platform_name");
                    aVar2.f19226f = c(optString);
                    aVar2.f19227g = d(optString);
                    aVar2.f19222b = jSONObject.toString();
                    return aVar2;
                } catch (Exception e8) {
                    e = e8;
                    aVar = aVar2;
    ...
    public static final class b implements Serializable {
        ...
        /* renamed from: a, reason: collision with root package name */
        public Map<Integer, String> f19232a;
        ...
        /* renamed from: e, reason: collision with root package name */
        public boolean f19236e = false;

        /* renamed from: f, reason: collision with root package name */
        public boolean f19237f = false;

        /* renamed from: g, reason: collision with root package name */
        public boolean f19238g = false;

        /* renamed from: h, reason: collision with root package name */
        public boolean f19239h = false;

        /* renamed from: i, reason: collision with root package name */
        public boolean f19240i = false;

        /* renamed from: j, reason: collision with root package name */
        public boolean f19241j = false;

        /* renamed from: k, reason: collision with root package name */
        public boolean f19242k = false;

        /* renamed from: l, reason: collision with root package name */
        public boolean f19243l = false;
    }
    ...
    public static final class c implements Serializable {
        ...
        public static final class a implements Serializable {
            ...
            /* renamed from: a, reason: collision with root package name */
            public List<String> f19250a = new ArrayList();
        ...
        public static c a(JSONObject jSONObject) {
            ...
            try {
                ...
                cVar.f19249f = jSONObject.optInt("video_template", 1);
                cVar.f19248e = jSONObject.optString("template_url");
                cVar.f19245b = jSONObject.optInt("orientation");
                cVar.f19246c = jSONObject.optString("paused_url");
                ...
                if (optJSONObject != null) {
                    ...
                    while (keys != null && keys.hasNext()) {
                        ...
                        if (b8 != null && b8.size() > 0) {
                            a aVar = new a();
                            aVar.f19251b = next;
                            aVar.f19250a.addAll(b8);
                            arrayList.add(aVar);
                        }
                    }
                    cVar.f19244a = arrayList;
                }
                return cVar;
            } catch (Throwable unused) {
                return null;
    ...
    public void setendcard_url(String str) {
        ...
        if (TextUtils.isEmpty(this.mof_template_url) && (((cVar = this.rewardTemplateMode) == null || TextUtils.isEmpty(cVar.f19248e)) && !TextUtils.isEmpty(str) && str.contains(KEY_IS_CMPT_ENTRY))) {
            setCMPTEntryUrl(str);
        }
