...
public final class MpegAudioReader implements ElementaryStreamReader {
    ...
    private void findHeader(ParsableByteArray parsableByteArray) {
        ...
        for (int position = parsableByteArray.getPosition(); position < limit; position++) {
            ...
            if (this.lastByteWasFF && (b8 & 224) == 224) {
                z9 = true;
            } else {
                z9 = false;
            }
    ...
    private void readHeaderRemainder(ParsableByteArray parsableByteArray) {
        ...
        if (!this.hasOutputFormat) {
            ...
            this.frameDurationUs = (mpegAudioHeader.samplesPerFrame * 1000000) / i9;
            this.output.format(Format.createAudioSampleFormat(this.formatId, mpegAudioHeader.mimeType, null, -1, 4096, mpegAudioHeader.channels, i9, null, null, 0, this.language));
