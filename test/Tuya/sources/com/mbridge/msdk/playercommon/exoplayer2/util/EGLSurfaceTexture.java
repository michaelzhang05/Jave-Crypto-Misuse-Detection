...
public final class EGLSurfaceTexture implements SurfaceTexture.OnFrameAvailableListener, Runnable {
    ...
    private static EGLContext createEGLContext(EGLDisplay eGLDisplay, EGLConfig eGLConfig, int i8) {
        int[] iArr;
        if (i8 == 0) {
    ...
    private static EGLSurface createEGLSurface(EGLDisplay eGLDisplay, EGLConfig eGLConfig, EGLContext eGLContext, int i8) {
        int[] iArr;
    ...
    public final void init(int i8) {
        ...
        EGLContext createEGLContext = createEGLContext(this.display, chooseEGLConfig, i8);
        this.context = createEGLContext;
        this.surface = createEGLSurface(this.display, chooseEGLConfig, createEGLContext, i8);
