...
public final class j {
    ...
    private com.mbridge.msdk.videocommon.listener.a f23135e;

    /* renamed from: g, reason: collision with root package name */
    private ConcurrentHashMap<String, com.mbridge.msdk.videocommon.listener.a> f23137g;

    /* renamed from: j, reason: collision with root package name */
    private Context f23140j;

    /* renamed from: k, reason: collision with root package name */
    private ExecutorService f23141k;

    /* renamed from: m, reason: collision with root package name */
    private String f23143m;

    /* renamed from: n, reason: collision with root package name */
    private com.mbridge.msdk.videocommon.d.c f23144n;
    ...
    private boolean f23148r;

    /* renamed from: c, reason: collision with root package name */
    private List<CampaignEx> f23133c = new ArrayList();
    ...
    private c f23138h = new c() { // from class: com.mbridge.msdk.videocommon.download.j.1
    ...
    private CopyOnWriteArrayList<Map<String, a>> f23139i = new CopyOnWriteArrayList<>();

    /* renamed from: l, reason: collision with root package name */
    private long f23142l = 3600;

    /* renamed from: o, reason: collision with root package name */
    private int f23145o = 1;
    ...
    public j(Context context, List<CampaignEx> list, ExecutorService executorService, String str, int i8) {
        this.f23146p = 1;
        try {
            boolean a8 = h.a.f23119a.a(i8);
            this.f23148r = a8;
            if (a8) {
                this.f23143m = str;
                this.f23146p = i8;
                this.f23147q = new i(list, str, i8);
                return;
            }
        ...
        this.f23140j = com.mbridge.msdk.foundation.controller.c.m().c();
        List<CampaignEx> list2 = this.f23133c;
    ...
    private void d() {
        ...
        if ((this.f23148r && this.f23147q != null) || af.a().a("u_n_c_e_d", true) || (copyOnWriteArrayList = this.f23139i) == null) {
            return;
        }
        try {
            synchronized (copyOnWriteArrayList) {
                try {
                    ...
                    int i8 = 0;
                    while (i8 < this.f23139i.size()) {
                        Map<String, a> map = this.f23139i.get(i8);
                        Iterator<Map.Entry<String, a>> it = map.entrySet().iterator();
                        while (it.hasNext()) {
                            a value = it.next().getValue();
                            if (value != null) {
                                if (currentTimeMillis - value.g() > this.f23142l * 1000 && value.k() == 1) {
                                    value.b(MBridgeError.ERROR_MESSAGE_DOWNLOAD_DOWNLOAD_TIMEOUT);
                                    value.a(this.f23145o);
                                    value.s();
                                    this.f23139i.remove(map);
                                    i8--;
                                }
    ...
    private void e() {
        CopyOnWriteArrayList<Map<String, a>> copyOnWriteArrayList = this.f23139i;
    ...
    public final CopyOnWriteArrayList<Map<String, a>> c() {
        i iVar;
        if (this.f23148r && (iVar = this.f23147q) != null) {
            return iVar.d();
        }
        return this.f23139i;
    }
    ...
    */
    ...
    public final void a(String str, com.mbridge.msdk.videocommon.listener.a aVar) {
        ...
        if (this.f23137g == null) {
            this.f23137g = new ConcurrentHashMap<>();
        }
        if (aVar == null || TextUtils.isEmpty(str)) {
            return;
        }
        this.f23137g.put(str, aVar);
    }
        ...
        try {
            if (campaignEx.getAdType() == 298) {
                if (this.f23132b == null) {
                    this.f23132b = com.mbridge.msdk.c.h.a().c(com.mbridge.msdk.foundation.controller.c.m().k(), this.f23143m);
                }
                return this.f23132b.p();
            }
            if (campaignEx.getAdType() == 42) {
                return d(null);
            }
            if (this.f23144n == null) {
                this.f23144n = com.mbridge.msdk.videocommon.d.b.a().a(com.mbridge.msdk.foundation.controller.c.m().k(), this.f23143m, false);
            }
            return this.f23144n.r();
        } catch (Throwable th) {
    ...
    public final void a(CampaignEx campaignEx) {
        ...
        List<CampaignEx> list = this.f23133c;
    ...
    */
    ...
    public j(Context context, CampaignEx campaignEx, ExecutorService executorService, String str, int i8) {
        ...
        try {
            ...
            if (a8) {
                this.f23143m = str;
                this.f23146p = i8;
                this.f23147q = new i(campaignEx, str, i8);
                return;
            }
        } catch (Exception unused) {
            this.f23147q = null;
    ...
    public final void b() {
        CopyOnWriteArrayList<Map<String, a>> copyOnWriteArrayList;
        if ((!this.f23148r || this.f23147q == null) && (copyOnWriteArrayList = this.f23139i) != null) {
            try {
                synchronized (copyOnWriteArrayList) {
                    try {
                        Iterator<Map<String, a>> it = this.f23139i.iterator();
                        while (it.hasNext()) {
    ...
    public final void b(String str) {
        ...
        try {
            synchronized (this.f23139i) {
                try {
                    if (!TextUtils.isEmpty(str) && (copyOnWriteArrayList = this.f23139i) != null && copyOnWriteArrayList.size() > 0) {
                        Iterator<Map<String, a>> it = this.f23139i.iterator();
                        while (it.hasNext()) {
                            Map<String, a> next = it.next();
                            if (next != null) {
    ...
    public final boolean a(List<CampaignEx> list, String str) {
        ...
        for (int i8 = 0; i8 < list.size(); i8++) {
            ...
            if (campaignEx == null || !a(new a(com.mbridge.msdk.foundation.controller.c.m().c(), campaignEx, str, this.f23145o), b(campaignEx), false) || !a(campaignEx.getendcard_url(), campaignEx)) {
                return false;
            }
        }
        return true;
