...
public class DomainMBCommonActivity extends Activity {
    ...
    private final BrowserView.a f17859b = new BrowserView.a() { // from class: com.mbridge.msdk.activity.DomainMBCommonActivity.1
    ...
    public void onCreate(Bundle bundle) {
        ...
        this.f17858a = stringExtra;
        if (!TextUtils.isEmpty(stringExtra)) {
            this.f17860c = (CampaignEx) getIntent().getSerializableExtra("mvcommon");
            if (com.mbridge.msdk.foundation.webview.b.f20201a.containsKey(this.f17858a)) {
                BrowserView browserView = com.mbridge.msdk.foundation.webview.b.f20201a.get(this.f17858a);
                this.browserView = browserView;
                if (browserView != null) {
                    browserView.setListener(this.f17859b);
                }
            } else {
                BrowserView browserView2 = new BrowserView(this, this.f17860c);
                this.browserView = browserView2;
                browserView2.setListener(this.f17859b);
                this.browserView.loadUrl(this.f17858a);
            }
