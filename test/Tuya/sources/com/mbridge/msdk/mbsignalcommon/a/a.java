...
public class a {
    ...
    private static final String f20468c = "a";

    /* renamed from: d, reason: collision with root package name */
    private String f20471d = "handlerNativeResult";
    ...
    private static final class C0408a {
        ...
        /* renamed from: a, reason: collision with root package name */
        private static a f20473a = new a();
    }

    public static a a() {
        return C0408a.f20473a;
    }
    ...
    public final void a(Object obj, String str, JSONArray jSONArray, int i8) {
        ...
        try {
            ...
            ad.a(f20468c, th.getMessage());
            a(this.f20470b, "exception: " + th.getMessage(), obj);
        }
        if (jSONArray == null) {
            a(this.f20470b, "called reporter failed, params empty", obj);
            return;
        }
        ...
        if ("reportMessageR".equalsIgnoreCase(str)) {
            ...
            if (c8 != null && !TextUtils.isEmpty(stringBuffer2)) {
                try {
                    new com.mbridge.msdk.foundation.same.report.e.a(c8).post(0, d.f().f19696c, k.a(stringBuffer2, c8), new b() { // from class: com.mbridge.msdk.mbsignalcommon.a.a.1
                    ...
                    ad.b(f20468c, e8.getMessage());
                }
            }
            a(this.f20469a, "called reporter success", obj);
            return;
        }
