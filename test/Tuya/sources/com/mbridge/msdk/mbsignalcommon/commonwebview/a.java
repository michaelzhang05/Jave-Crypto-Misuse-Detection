...
public final class a extends WebChromeClient {
    ...
    private CopyOnWriteArrayList<WebChromeClient> f20545a = new CopyOnWriteArrayList<>();

    public final void a(WebChromeClient webChromeClient) {
        this.f20545a.add(webChromeClient);
    }

    public final void b(WebChromeClient webChromeClient) {
        this.f20545a.remove(webChromeClient);
    }
    ...
    public final void onCloseWindow(WebView webView) {
        Iterator<WebChromeClient> it = this.f20545a.iterator();
        while (it.hasNext()) {
