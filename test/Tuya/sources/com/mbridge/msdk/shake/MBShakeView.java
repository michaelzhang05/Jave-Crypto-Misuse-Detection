...
public class MBShakeView extends LinearLayout {
    ...
    protected void onAttachedToWindow() {
        ...
        this.f21729a = rotateAnimation;
        rotateAnimation.setDuration(100L);
        this.f21729a.setRepeatMode(2);
        this.f21729a.setRepeatCount(-1);
        this.f21730b.startAnimation(this.f21729a);
    }
    ...
    public void initView(String str, boolean z8) {
        ...
        this.f21730b = new ImageView(getContext());
        ...
        this.f21730b.setLayoutParams(layoutParams);
        this.f21730b.setImageResource(getResources().getIdentifier("mbridge_cm_btn_shake", "drawable", c.m().g()));
        FrameLayout frameLayout = new FrameLayout(getContext());
        frameLayout.setLayoutParams(new LinearLayout.LayoutParams(-2, -2));
        frameLayout.addView(imageView);
        frameLayout.addView(this.f21730b);
