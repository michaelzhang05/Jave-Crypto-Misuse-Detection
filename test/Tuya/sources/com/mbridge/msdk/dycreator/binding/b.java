...
public final class b {
    ...
    private static volatile b f18590a;

    /* renamed from: b, reason: collision with root package name */
    private d f18591b = (d) com.mbridge.msdk.dycreator.d.a.a().a(a.EnumC0393a.VIEW_OBSERVER);

    /* renamed from: c, reason: collision with root package name */
    private com.mbridge.msdk.dycreator.g.c f18592c = (com.mbridge.msdk.dycreator.g.c) com.mbridge.msdk.dycreator.d.a.a().a(a.EnumC0393a.CLICK_OBSERVER);

    /* renamed from: d, reason: collision with root package name */
    private f f18593d = (f) com.mbridge.msdk.dycreator.d.a.a().a(a.EnumC0393a.EFFECT_OBSERVER);

    /* renamed from: e, reason: collision with root package name */
    private h f18594e = (h) com.mbridge.msdk.dycreator.d.a.a().a(a.EnumC0393a.REPORT_OBSERVER);

    /* renamed from: f, reason: collision with root package name */
    private BaseViewModel f18595f;

    /* renamed from: g, reason: collision with root package name */
    private com.mbridge.msdk.shake.b f18596g;
                ...
                if (view instanceof InterBase) {
                    ...
                    if (!TextUtils.isEmpty(actionDes)) {
                        if (actionDes.startsWith(CampaignEx.JSON_NATIVE_VIDEO_CLICK)) {
                            ...
                            int id = view.getId();
                            com.mbridge.msdk.dycreator.g.c cVar = this.f18592c;
                            if (cVar != null) {
                                cVar.a(bVar, id);
                            }
    ...
    public final void a(BaseViewModel baseViewModel) {
        this.f18595f = baseViewModel;
        if (baseViewModel != null) {
            baseViewModel.setClickSubject(this.f18592c);
            this.f18595f.setConcreteSubject(this.f18591b);
            this.f18595f.setEffectSubject(this.f18593d);
            this.f18595f.setReportSubject(this.f18594e);
        }
    }
    ...
    private com.mbridge.msdk.shake.b a(final View view, final MBSplashData mBSplashData) {
        if (mBSplashData != null) {
            try {
                ...
                if (dyOption != null && dyOption.isShakeVisible() && this.f18596g == null) {
                    this.f18596g = new com.mbridge.msdk.shake.b(dyOption.getShakeStrenght(), dyOption.getShakeTime() * 1000) { // from class: com.mbridge.msdk.dycreator.binding.b.7
                            ...
                            if (view2 != null) {
                                try {
                                    if (view2.getGlobalVisibleRect(new Rect())) {
                                        ...
                                        com.mbridge.msdk.shake.a.a().b(b.this.f18596g);
                                    }
                                } catch (Exception e8) {
                                    ad.b("MBDataBinding", e8.getMessage());
                                }
                ...
                if (effectDes != null) {
                    if (effectDes.equals("wobble") && (viewGroup instanceof MBSplashShakeView)) {
                        if (aVar.getEffectData().isShakeVisible()) {
                            if (bVar.f18596g != null) {
                                com.mbridge.msdk.shake.a.a().b(bVar.f18596g);
                            }
                            com.mbridge.msdk.shake.a.a().a(bVar.a(viewGroup, (MBSplashData) aVar));
                        } else if (bVar.f18596g != null) {
                            com.mbridge.msdk.shake.a.a().b(bVar.f18596g);
                        }
                    }
