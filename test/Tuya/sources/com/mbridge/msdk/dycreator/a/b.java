...
public class b {
    ...
    private static volatile b f18246g;

    /* renamed from: a, reason: collision with root package name */
    private SoftReference<HashMap<String, c>> f18247a;

    /* renamed from: b, reason: collision with root package name */
    private SoftReference<HashMap<String, String>> f18248b;

    /* renamed from: c, reason: collision with root package name */
    private SoftReference<HashMap<String, c>> f18249c;
    ...
    public final HashMap b() {
        SoftReference<HashMap<String, c>> softReference = this.f18247a;
        if (softReference == null || softReference.get() == null) {
            ...
            this.f18247a = new SoftReference<>(hashMap);
        }
        return this.f18247a.get();
    }

    public final HashMap<String, c> c() {
        SoftReference<HashMap<String, c>> softReference = this.f18249c;
        if (softReference == null || softReference.get() == null) {
            ...
            this.f18249c = new SoftReference<>(hashMap);
        }
    ...
    public final int d(String str) {
        if (this.f18252f != null) {
            ...
            if (TextUtils.isEmpty(g8)) {
                g8 = this.f18252f.getPackageName();
            }
    ...
    public final String e(String str) {
        if (!TextUtils.isEmpty(str)) {
            ...
            SoftReference<HashMap<String, String>> softReference = this.f18248b;
            if (softReference == null || softReference.get() == null) {
                this.f18248b = new SoftReference<>(d());
            }
            String substring = str.substring(8);
            if (this.f18248b.get() != null && this.f18248b.get().size() > 0) {
                String str2 = this.f18248b.get().get(substring);
    ...
    public final void a(Context context, String str) {
        try {
            if (g.f18687a) {
                this.f18250d = context.getFilesDir().toString();
            } else {
                this.f18250d = str;
            }
            if (e.a(context).heightPixels > 320 && !g.f18687a) {
                this.f18251e = "/drawable-hdpi/";
                this.f18252f = context;
                com.mbridge.msdk.dycreator.e.b.f18684a = a().d();
            }
            this.f18251e = "/drawable-mdpi/";
            this.f18252f = context;
            com.mbridge.msdk.dycreator.e.b.f18684a = a().d();
        } catch (Exception e8) {
            ad.b("MBResource", e8.getMessage());
    ...
    private HashMap<String, String> d() {
        ...
        try {
            inputStream = this.f18252f.getAssets().open("rv_binddatas.xml");
    ...
    public final int b(String str) {
        try {
            ...
            if (str.contains("d")) {
                return (int) TypedValue.applyDimension(1, parseInt, this.f18252f.getResources().getDisplayMetrics());
            }
            str.contains("s");
            return parseInt;
        }
    ...
    public final void a(String str, ImageView imageView) {
        Context context;
        if (str == null || !str.startsWith("@drawable/") || (context = this.f18252f) == null) {
            return;
        }
        try {
