...
public class MBScrollView extends ScrollView implements InterBase {
    ...
    private Map<String, String> f18370a;

    /* renamed from: b, reason: collision with root package name */
    private Map<String, Boolean> f18371b;
    ...
    public static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            try {
                f18373a[c.background.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f18373a[c.contentDescription.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f18373a[c.fadingEdge.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f18373a[c.visibility.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f18373a[c.layout_marginBottom.ordinal()] = 6;
    ...
    public MBScrollView(Context context, AttributeSet attributeSet) {
        super(context);
        this.f18372c = "";
        this.f18370a = com.mbridge.msdk.dycreator.e.c.a(context, attributeSet);
        setAttributeSet(attributeSet);
        setLayoutParams(generateLayoutParams(attributeSet));
        com.mbridge.msdk.dycreator.e.c.a(this.f18370a, this);
    }

    @Override // com.mbridge.msdk.dycreator.baseview.inter.InterBase
    public String getActionDes() {
        Map<String, String> map = this.f18370a;
        if (map != null && map.containsKey("mbridgeAction")) {
            return this.f18370a.get("mbridgeAction");
        }
        return "";
    }
    ...
    public String getBindDataDes() {
        ...
        if (map != null && map.containsKey("mbridgeData")) {
            return this.f18370a.get("mbridgeData");
        }
        return "";
    }
    ...
    public String getEffectDes() {
        ...
        if (map != null && map.containsKey("mbridgeEffect")) {
            return this.f18370a.get("mbridgeEffect");
        }
        return "";
    }
    ...
    public String getReportDes() {
        ...
        if (map != null && map.containsKey("mbridgeReport")) {
            return this.f18370a.get("mbridgeReport");
        }
        return "";
    }
    ...
    public String getStrategyDes() {
        ...
        if (map != null && map.containsKey("mbridgeStrategy")) {
            return this.f18370a.get("mbridgeStrategy");
        }
        return "";
    }
    ...
    protected void onAttachedToWindow() {
        ...
        Map<String, Boolean> map = this.f18371b;
        if (map != null && map.containsKey("mbridgeAttached") && this.f18371b.get("mbridgeAttached").booleanValue()) {
            new m.a("mbridgeAttached").a().a(this.f18372c);
        }
    }
    ...
    protected void onDetachedFromWindow() {
        ...
        Map<String, Boolean> map = this.f18371b;
        if (map != null && map.containsKey("mbridgeDetached") && this.f18371b.get("mbridgeDetached").booleanValue()) {
            new m.a("mbridgeDetached").a().a(this.f18372c);
        }
    }
    ...
    public void setAttributeSet(AttributeSet attributeSet) {
        ...
        for (int i8 = 0; i8 < attributeCount; i8++) {
            ...
            if (cVar != null) {
                int i9 = AnonymousClass1.f18373a[cVar.ordinal()];
                if (i9 != 1) {
                    if (i9 != 2) {
                        if (i9 == 3) {
    ...
    public void setDynamicReport(String str, CampaignEx campaignEx) {
        this.f18371b = com.mbridge.msdk.dycreator.e.c.a(str);
        if (campaignEx != null) {
            this.f18372c = campaignEx.getCampaignUnitId();
        }
    }
