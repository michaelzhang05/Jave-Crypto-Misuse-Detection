...
public class j {
    ...
    private static final String f18021a = "j";

    /* JADX INFO: Access modifiers changed from: private */
    public void b(final Context context, final String str, final String str2) {
        if (!com.mbridge.msdk.foundation.same.net.g.d.f().a()) {
            try {
                if (com.mbridge.msdk.foundation.same.net.g.d.f().f19710q) {
                    return;
                }
                com.mbridge.msdk.foundation.same.net.g.d.f().f19710q = true;
                if (System.currentTimeMillis() >= com.mbridge.msdk.foundation.a.a.a.a().b("mkey_spare_host_ts").longValue() + 86400000) {
                    ...
                    if (!TextUtils.isEmpty(a8)) {
                        for (String str3 : a8.split("\n")) {
                            if (!TextUtils.isEmpty(str3.trim()) && !com.mbridge.msdk.foundation.same.net.g.d.f().f19713t.contains(str3.trim())) {
                                com.mbridge.msdk.foundation.same.net.g.d.f().f19713t.add(str3.trim());
                                com.mbridge.msdk.foundation.same.net.g.d.f().f19716w.add(str3.trim());
                            }
                        }
                        b(context, str, str2);
                        return;
                ...
                new com.mbridge.msdk.foundation.same.net.h.c(context.getApplicationContext()).get(0, com.mbridge.msdk.foundation.same.net.g.d.f().f19695b, new com.mbridge.msdk.foundation.same.net.h.e(), new com.mbridge.msdk.foundation.same.net.c.a() { // from class: com.mbridge.msdk.c.j.2
                    @Override // com.mbridge.msdk.foundation.same.net.c.a
                    public final void a(String str4) {
                        com.mbridge.msdk.foundation.same.net.g.d.f().f19710q = false;
                        ad.a(j.f18021a, "fetch CNDSettingHost failed, errorCode = " + str4);
                    }

                    @Override // com.mbridge.msdk.foundation.same.net.c.a
                    public final void b(String str4) {
                        ad.a(j.f18021a, "fetch CNDSettingHost success, content = " + str4);
                        if (!TextUtils.isEmpty(str4)) {
                            ...
                            for (String str5 : str4.split("\n")) {
                                if (!TextUtils.isEmpty(str5.trim()) && !com.mbridge.msdk.foundation.same.net.g.d.f().f19713t.contains(str5.trim())) {
                                    com.mbridge.msdk.foundation.same.net.g.d.f().f19713t.add(str5.trim());
                                    com.mbridge.msdk.foundation.same.net.g.d.f().f19716w.add(str5.trim());
                                }
                            }
    ...
    public final void a(final Context context, final String str, final String str2) {
        ...
        if (com.mbridge.msdk.foundation.same.net.g.d.f().f19710q) {
            eVar.a("st_net", com.mbridge.msdk.foundation.same.net.g.d.f().f19712s + "");
        }
        com.mbridge.msdk.foundation.same.net.h.d dVar = new com.mbridge.msdk.foundation.same.net.h.d() { // from class: com.mbridge.msdk.c.j.1
                    ...
                    if (ai.a(jSONObject)) {
                        ...
                        if (com.mbridge.msdk.foundation.same.net.g.d.f().f19711r) {
                            if (TextUtils.isEmpty(jSONObject.optString("hst_st_t"))) {
                                jSONObject.put("hst_st_t", com.mbridge.msdk.foundation.same.net.g.d.f().f19705l);
                            }
                        } else if (TextUtils.isEmpty(jSONObject.optString("hst_st"))) {
                            jSONObject.put("hst_st", com.mbridge.msdk.foundation.same.net.g.d.f().f19701h);
                        }
            ...
            public final void a(String str3) {
                ...
                if (!com.mbridge.msdk.foundation.same.net.g.d.f().f19711r) {
                    com.mbridge.msdk.foundation.same.net.g.d.f().f19714u++;
                } else {
                    com.mbridge.msdk.foundation.same.net.g.d.f().f19715v++;
                }
                j.this.b(context, str, str2);
                j.a(j.this);
                ad.b(j.f18021a, "get app setting error" + str3);
            }
        };
        com.mbridge.msdk.c.a.c cVar = new com.mbridge.msdk.c.a.c(context);
        String str3 = com.mbridge.msdk.foundation.same.net.g.d.f().f19674G;
        try {
            if (com.mbridge.msdk.foundation.same.net.g.d.f().f19711r && com.mbridge.msdk.foundation.same.net.g.d.f().f19710q && com.mbridge.msdk.foundation.same.net.g.d.f().f19715v < com.mbridge.msdk.foundation.same.net.g.d.f().f19716w.size()) {
                String str4 = com.mbridge.msdk.foundation.same.net.g.d.f().f19716w.get(com.mbridge.msdk.foundation.same.net.g.d.f().f19715v);
                if (!TextUtils.isEmpty(str4)) {
    ...
    private String b() {
        String str = com.mbridge.msdk.foundation.same.net.g.d.f().f19711r ? com.mbridge.msdk.foundation.same.net.g.d.f().f19675H : com.mbridge.msdk.foundation.same.net.g.d.f().f19674G;
        try {
            if (!com.mbridge.msdk.foundation.same.net.g.d.f().f19711r || !com.mbridge.msdk.foundation.same.net.g.d.f().f19710q || com.mbridge.msdk.foundation.same.net.g.d.f().f19715v >= com.mbridge.msdk.foundation.same.net.g.d.f().f19716w.size()) {
                return str;
            }
            String str2 = com.mbridge.msdk.foundation.same.net.g.d.f().f19716w.get(com.mbridge.msdk.foundation.same.net.g.d.f().f19715v);
    ...
    public final void a(Context context, final String str, String str2, final String str3) {
        ...
        if (h.a().e(str3, str) && h.a().a(str, 2, str3)) {
            ...
            dVar.setUnitId(str3);
            new com.mbridge.msdk.c.a.c(context).get(1, com.mbridge.msdk.foundation.same.net.g.d.f().f19674G, eVar, dVar);
            a(3, 1, "");
        }
    }
    ...
    public void a(int i8, int i9, String str) {
        ...
        try {
            ...
            dVar.a("st_net", Integer.valueOf(com.mbridge.msdk.foundation.same.net.g.d.f().f19712s));
            dVar.a("result", Integer.valueOf(i8));
            dVar.a("type", Integer.valueOf(i9));
            if (i9 == 0) {
                str2 = b();
            } else {
                str2 = com.mbridge.msdk.foundation.same.net.g.d.f().f19711r ? com.mbridge.msdk.foundation.same.net.g.d.f().f19675H : com.mbridge.msdk.foundation.same.net.g.d.f().f19674G;
            }
            dVar.a("url", str2);
            dVar.a("reason", str);
            bVar.a("2000112", dVar);
