...
public class a {
    ...
    private String c() {
        try {
            ...
            ad.a("MraidJSController", e8.getMessage());
            return "";
        }
    }
    ...
    public final String b() {
        try {
            ...
            if (TextUtils.isEmpty(this.f17938c)) {
                ...
                if (b8 != null && !TextUtils.isEmpty(b8.T())) {
                    a(com.mbridge.msdk.foundation.controller.c.m().c(), b8.T());
                }
                return f17936a;
            }
            return this.f17938c;
    ...
    public final void a(Context context, final String str) {
        ...
        String a8 = com.mbridge.msdk.foundation.a.a.a.a().a("MraidJSController");
        if (TextUtils.isEmpty(a8) || !a8.equals(str)) {
            try {
                new com.mbridge.msdk.c.a.a(context).get(0, str, null, new com.mbridge.msdk.foundation.same.net.c.a() { // from class: com.mbridge.msdk.c.b.a.1
                    @Override // com.mbridge.msdk.foundation.same.net.c.a
                    public final void a(String str2) {
                        ad.a("MraidJSController", "fail request mraid js. " + str2);
                    }
                ...
                ad.b("MraidJSController", e8.getMessage());
            }
        }
    }
