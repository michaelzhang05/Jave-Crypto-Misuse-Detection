...
abstract class c {
    ...
    public static a a(ECParameterSpec eCParameterSpec) {
        ...
        ECParameterSpec eCParameterSpec2 = f8659a;
        ...
        ECParameterSpec eCParameterSpec3 = f8660b;
        ...
        ECParameterSpec eCParameterSpec4 = f8661c;
        ...
        ECParameterSpec eCParameterSpec5 = f8662d;
    ...
    public static ECParameterSpec b(a aVar) {
        if (a.f8627d.equals(aVar)) {
            return f8659a;
        }
        if (a.f8628e.equals(aVar)) {
            return f8660b;
        }
        if (a.f8630g.equals(aVar)) {
            return f8661c;
        }
        if (a.f8631h.equals(aVar)) {
            return f8662d;
        }
        return null;
    }
