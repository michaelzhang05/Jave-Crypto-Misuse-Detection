...
final class e0 implements h.c {
    ...
    public static final e0 f13318a = new e0();
    ...
    public List c(Y2.d metadata, H0 sharedDataSpec, X2.h transformSpecToElements) {
        ...
        m4.G g8 = null;
        Object[] objArr = 0;
        if (d0.f13312a.c(metadata)) {
            m8 = AbstractC1246t.e(new e4.u0(g8, b4.n.f14763y0, 1, (AbstractC3151p) (objArr == true ? 1 : 0)));
        } else {
            m8 = AbstractC1246t.m();
        }
    ...
    public X2.g d(H0 sharedDataSpec) {
        AbstractC3159y.i(sharedDataSpec, "sharedDataSpec");
        return new X2.g(d0.f13312a, sharedDataSpec, b4.n.f14739m0, b4.k.f14646C, false, null, 48, null);
    }
