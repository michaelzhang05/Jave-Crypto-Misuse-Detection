...
final class C1527j implements h.c {

    /* renamed from: a, reason: collision with root package name */
    public static final C1527j f13335a = new C1527j();
    ...
    public List c(Y2.d metadata, H0 sharedDataSpec, X2.h transformSpecToElements) {
        ...
        m4.G g8 = null;
        Object[] objArr = 0;
        if (C1526i.f13331a.c(metadata)) {
            m8 = AbstractC1246t.e(new e4.u0(g8, b4.n.f14716b, 1, (AbstractC3151p) (objArr == true ? 1 : 0)));
        } else {
            m8 = AbstractC1246t.m();
        }
    ...
    public X2.g d(H0 sharedDataSpec) {
        AbstractC3159y.i(sharedDataSpec, "sharedDataSpec");
        return new X2.g(C1526i.f13331a, sharedDataSpec, b4.n.f14703P, b4.k.f14664i, false, null, 48, null);
    }
