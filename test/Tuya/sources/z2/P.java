...
final class P implements h.c {
    ...
    public static final P f13279a = new P();
    ...
    public List c(Y2.d metadata, H0 sharedDataSpec, X2.h transformSpecToElements) {
        ...
        m4.G g8 = null;
        Object[] objArr = 0;
        if (O.f13276a.c(metadata)) {
            m8 = AbstractC1246t.e(new C2628p0(g8, 0, 3, (AbstractC3151p) (objArr == true ? 1 : 0)));
        } else {
            m8 = AbstractC1246t.m();
        }
    ...
    public X2.g d(H0 sharedDataSpec) {
        AbstractC3159y.i(sharedDataSpec, "sharedDataSpec");
        return new X2.g(O.f13276a, sharedDataSpec, b4.n.f14725f0, b4.k.f14677v, false, AbstractC3984c.a(b4.n.f14686B), 16, null);
    }
