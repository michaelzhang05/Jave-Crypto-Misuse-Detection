...
public final class d implements ViewBinding {
    ...
    private final LinearLayout f3104a;

    /* renamed from: b, reason: collision with root package name */
    public final LinearLayout f3105b;

    /* renamed from: c, reason: collision with root package name */
    public final ShippingInfoWidget f3106c;

    /* renamed from: d, reason: collision with root package name */
    public final CardMultilineWidget f3107d;
    ...
    private d(LinearLayout linearLayout, LinearLayout linearLayout2, ShippingInfoWidget shippingInfoWidget, CardMultilineWidget cardMultilineWidget) {
        ...
        this.f3105b = linearLayout2;
        this.f3106c = shippingInfoWidget;
        this.f3107d = cardMultilineWidget;
    }

    public static d a(View view) {
        LinearLayout linearLayout = (LinearLayout) view;
        int i8 = AbstractC3049A.f32769d;
        ShippingInfoWidget shippingInfoWidget = (ShippingInfoWidget) ViewBindings.findChildViewById(view, i8);
        if (shippingInfoWidget != null) {
            i8 = AbstractC3049A.f32781j;
    ...
    public static d c(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z8) {
        View inflate = layoutInflater.inflate(AbstractC3051C.f32805d, viewGroup, false);
        if (z8) {
