...
public abstract class c {
    ...
    public static final byte[] f3220a;

    /* renamed from: c, reason: collision with root package name */
    public static final A f3222c;

    /* renamed from: d, reason: collision with root package name */
    public static final y f3223d;

    /* renamed from: b, reason: collision with root package name */
    public static final String[] f3221b = new String[0];

    /* renamed from: e, reason: collision with root package name */
    private static final C1282h f3224e = C1282h.d("efbbbf");

    /* renamed from: f, reason: collision with root package name */
    private static final C1282h f3225f = C1282h.d("feff");

    /* renamed from: g, reason: collision with root package name */
    private static final C1282h f3226g = C1282h.d("fffe");

    /* renamed from: h, reason: collision with root package name */
    private static final C1282h f3227h = C1282h.d("0000ffff");

    /* renamed from: i, reason: collision with root package name */
    private static final C1282h f3228i = C1282h.d("ffff0000");

    /* renamed from: j, reason: collision with root package name */
    public static final Charset f3229j = Charset.forName(C.UTF8_NAME);

    /* renamed from: k, reason: collision with root package name */
    public static final Charset f3230k = Charset.forName("ISO-8859-1");

    /* renamed from: l, reason: collision with root package name */
    private static final Charset f3231l = Charset.forName("UTF-16BE");

    /* renamed from: m, reason: collision with root package name */
    private static final Charset f3232m = Charset.forName("UTF-16LE");

    /* renamed from: n, reason: collision with root package name */
    private static final Charset f3233n = Charset.forName("UTF-32BE");

    /* renamed from: o, reason: collision with root package name */
    private static final Charset f3234o = Charset.forName("UTF-32LE");

    /* renamed from: p, reason: collision with root package name */
    public static final TimeZone f3235p = DesugarTimeZone.getTimeZone("GMT");

    /* renamed from: q, reason: collision with root package name */
    public static final Comparator f3236q = new a();

    /* renamed from: r, reason: collision with root package name */
    private static final Pattern f3237r = Pattern.compile("([0-9a-fA-F]*:[0-9a-fA-F:.]*)|([\\d.]+)");
    ...
    final class b implements ThreadFactory {
        ...
        public Thread newThread(Runnable runnable) {
            Thread thread = new Thread(runnable, this.f3238a);
            thread.setDaemon(this.f3239b);
            return thread;
        }
    }
    ...
    static {
        ...
        f3220a = bArr;
        f3222c = A.e(null, bArr);
        f3223d = y.c(null, bArr);
    }
    ...
    public static boolean D(String str) {
        return f3237r.matcher(str).matches();
    }
    ...
    */
    private static java.net.InetAddress j(java.lang.String r12, int r13, int r14) {
        ...
        L8f:
            ...
            throw r12
        */
        throw new UnsupportedOperationException("Method not decompiled: G6.c.j(java.lang.String, int, int):java.net.InetAddress");
    }
    ...
    private static String u(byte[] bArr) {
        ...
        while (i9 < bArr.length) {
            if (i9 == i8) {
                ...
                c1279e.writeHexadecimalUnsignedLong(((bArr[i9] & 255) << 8) | (bArr[i9 + 1] & 255));
                i9 += 2;
            }
        }
